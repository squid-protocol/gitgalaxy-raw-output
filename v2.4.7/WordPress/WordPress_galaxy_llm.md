...
| **Timestamp** | `2026-08-07T03:52:57.665308+00:00` |
| **Scan Duration** | `13.04s` |
| **Git Branch** | `master` |
...
> **Architectural Drift Z-Score:** `7.055`
...
|---|---|---|
| file_cluster_8 | 2157 | 81.5% |
| file_cluster_13 | 237 | 9.0% |
| file_cluster_2 | 69 | 2.6% |
| file_cluster_0 | 30 | 1.1% |
| file_cluster_17 | 25 | 0.9% |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 0.0 | 100.0 | 27.2 | 24.2 | 5.0 |
| Error & Exception Exposure | 0.0 | 100.0 | 53.4 | 69.8 | 0.0 |
| Tech Debt Exposure | 0.0 | 100.0 | 25.2 | 0.0 | 0.0 |
| Testing Exposure | 0.0 | 80.0 | 18.6 | 2.3 | 2.3 |
...
| Documentation Exposure | 0.0 | 100.0 | 20.0 | 14.9 | 11.9 |
...
- `step` (@ `wp-includes/html-api/class-wp-html-processor.php`) -> Impact: **1773.4** | LOC: 1973
...
- `QuicktimeParseAtom` (@ `wp-includes/ID3/module.audio-video.quicktime.php`) -> Impact: **1142.3** | LOC: 1203
- `factory` (@ `wp-includes/js/jquery/ui/datepicker.js`) -> Impact: **1135.0** | LOC: 1579
- `rest_ensure_response` (@ `wp-includes/rest-api.php`) -> Impact: **974.5** | LOC: 1735
- `_updateDatepicker` (@ `wp-includes/js/jquery/ui/datepicker.js`) -> Impact: **942.0** | LOC: 1279
- `get_custom_logo` (@ `wp-includes/general-template.php`) -> Impact: **889.4** | LOC: 1596
...
|---|---|---|---|---|
| `wp-includes` | 249 | 94097.06 | 30.88% | 52.44% |
| `wp-admin/includes` | 105 | 44692.82 | 36.03% | 48.45% |
| `wp-includes/js` | 47 | 27672.55 | 39.66% | 60.31% |
| `wp-admin/js` | 49 | 19158.14 | 29.22% | 57.88% |
| `wp-includes/js/jquery/ui` | 36 | 18524.84 | 56.31% | 45.16% |
| `wp-content/themes/twentytwentyfive/patterns` | 92 | 15324.52 | 51.55% | 0.0% |
| `wp-admin` | 91 | 12202.19 | 40.77% | 4.03% |
| `wp-includes/js/plupload` | 5 | 11490.42 | 33.36% | 79.99% |
| `wp-includes/rest-api/endpoints` | 45 | 9493.86 | 22.93% | 40.7% |
| `wp-includes/ID3` | 17 | 8511.3 | 36.11% | 26.03% |
...
- `wp-admin/js/customize-controls.js` -> **23** Orphaned Functions | **76** Duplicates
...
14. **`wp-admin/includes/image-edit.php`** -> AI Confidence: **99.48%**
15. **`wp-admin/includes/image.php`** -> AI Confidence: **99.48%**
16. **`wp-admin/includes/meta-boxes.php`** -> AI Confidence: **99.48%**
17. **`wp-admin/includes/plugin-install.php`** -> AI Confidence: **99.48%**
18. **`wp-admin/includes/theme-install.php`** -> AI Confidence: **99.48%**
19. **`wp-admin/includes/update-core.php`** -> AI Confidence: **99.48%**
20. **`wp-admin/install.php`** -> AI Confidence: **99.48%**
21. **`wp-admin/media-upload.php`** -> AI Confidence: **99.48%**
22. **`wp-admin/network.php`** -> AI Confidence: **99.48%**
23. **`wp-admin/options-general.php`** -> AI Confidence: **99.48%**
24. **`wp-admin/options-permalink.php`** -> AI Confidence: **99.48%**
25. **`wp-admin/options.php`** -> AI Confidence: **99.48%**
26. **`wp-admin/plugins.php`** -> AI Confidence: **99.48%**
27. **`wp-admin/themes.php`** -> AI Confidence: **99.48%**
28. **`wp-admin/upgrade.php`** -> AI Confidence: **99.48%**
29. **`wp-admin/user-new.php`** -> AI Confidence: **99.48%**
30. **`wp-content/themes/twentyeleven/functions.php`** -> AI Confidence: **99.48%**
31. **`wp-content/themes/twentyfifteen/index.php`** -> AI Confidence: **99.48%**
32. **`wp-content/themes/twentyfourteen/index.php`** -> AI Confidence: **99.48%**
33. **`wp-content/themes/twentysixteen/index.php`** -> AI Confidence: **99.48%**
34. **`wp-includes/ID3/module.audio-video.quicktime.php`** -> AI Confidence: **99.48%**
35. **`wp-includes/ID3/module.audio-video.riff.php`** -> AI Confidence: **99.48%**
36. **`wp-includes/ID3/module.audio.ac3.php`** -> AI Confidence: **99.48%**
37. **`wp-includes/SimplePie/src/IRI.php`** -> AI Confidence: **99.48%**
38. **`wp-includes/block-supports/duotone.php`** -> AI Confidence: **99.48%**
39. **`wp-includes/blocks/blocks-json.php`** -> AI Confidence: **99.48%**
40. **`wp-includes/blocks/term-template.php`** -> AI Confidence: **99.48%**
41. **`wp-includes/cache-compat.php`** -> AI Confidence: **99.48%**
42. **`wp-includes/class-IXR.php`** -> AI Confidence: **99.48%**
43. **`wp-includes/class-walker-page.php`** -> AI Confidence: **99.48%**
44. **`wp-includes/class-wp-comment-query.php`** -> AI Confidence: **99.48%**
45. **`wp-includes/class-wp-editor.php`** -> AI Confidence: **99.48%**
46. **`wp-includes/class-wp-meta-query.php`** -> AI Confidence: **99.48%**
47. **`wp-includes/default-filters.php`** -> AI Confidence: **99.48%**
48. **`wp-includes/default-widgets.php`** -> AI Confidence: **99.48%**
49. **`wp-includes/feed-rss2-comments.php`** -> AI Confidence: **99.48%**
50. **`wp-includes/html-api/class-wp-html-doctype-info.php`** -> AI Confidence: **99.48%**
51. **`wp-login.php`** -> AI Confidence: **99.48%**
52. **`wp-signup.php`** -> AI Confidence: **99.48%**
53. **`wp-admin/includes/class-wp-automatic-updater.php`** -> AI Confidence: **99.39%**
54. **`wp-admin/includes/class-wp-ms-themes-list-table.php`** -> AI Confidence: **99.39%**
55. **`wp-admin/includes/class-wp-posts-list-table.php`** -> AI Confidence: **99.39%**
...
### 3. `wp-includes/js/backbone.js` (JAVASCRIPT) -> Cumulative Risk: **635.62**
- **Archetype:** `file_cluster_11` (Distance: 14.648 IQR)
...
### 5. `wp-admin/themes.php` (PHP) -> Cumulative Risk: **611.83**
- **Archetype:** `file_cluster_8` (Distance: 11.661 IQR)
- **Magnitude:** 529.32 | **LOC:** 1330 | **CtrlFlow:** 83.0% | **Authorship Centralization:** 100.0%
...
### 6. `wp-includes/html-api/class-wp-html-open-elements.php` (PHP) -> Cumulative Risk: **602.1**
- **Archetype:** `file_cluster_8` (Distance: 12.621 IQR)
- **Magnitude:** 416.98 | **LOC:** 854 | **CtrlFlow:** 63.6% | **Authorship Centralization:** 50.0%
...
### 7. `wp-includes/js/tinymce/plugins/media/plugin.js` (JAVASCRIPT) -> Cumulative Risk: **601.15**
...
### 10. `wp-admin/includes/class-wp-internal-pointers.php` (PHP) -> Cumulative Risk: **594.63**
- **Archetype:** `file_cluster_8` (Distance: 13.096 IQR)
...
- **Top Global Matches:** file_cluster_8: 13.473, file_cluster_7: 13.64, file_cluster_11: 13.786
- **Magnitude:** 6041.76 | **LOC:** 6746 | **CtrlFlow:** 70.4% | **Authorship Centralization:** 75.0%
- **Risk Profile:** Cognitive Load (48.8468%), Tech Debt (29.9551%)
**Top Internal Functions/Classes:**
  * `step` (Impact: 1773.4)
  ...
  * `step_in_cell` (Impact: 616.6)
    * *Intent:* /* * > A character token that is one of U+0009 CHARACTER TABULATION,
  * `step_in_head` (Impact: 355.2)
    * *Intent:* * Ensures internal accounting is maintained for HTML semantic rules while * the underlying Tag Proce...
...
* *Risk/State:* `safety_bypasses: 38`, `high_risk_execution: 1`, `state_mutation: 715`, `planned_debt: 26`, `orphaned_logic: 7`
* *Architecture:* `api: 27`
* *Defense:* `safety: 37`, `doc: 163`, `test: 8`, `immutability_locks: 7`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` 'STYLE', `TR`, true )
		) 
			_doing_it_wrong(
				__METHOD__, and of any
	 * other section in an HTML document which cannot contain HTML markup (DATA).
	 *
	 * If a token has no modifiable text then an empty string is returned to
	 * avoid needless crashing or type errors. An empty string does not mean
	 * that a token has modifiable text, the HTML `<table><td>` stops at tags `TABLE`, they are limited and require
	 * a name. They should not be created with programmatically-made
	 * names, * `TBODY`, of TEXTAREA tags...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Top Global Matches:** file_cluster_8: 13.331, file_cluster_15: 13.403, file_cluster_7: 13.511
- **Magnitude:** 5825.06 | **LOC:** 9390 | **CtrlFlow:** 68.1% | **Authorship Centralization:** 100.0%
...
- **Global Archetype:** `file_cluster_11` (Drift: 14.541 IQR)
- **Local Micro-Species:** `Cluster 4: Heavily Documented Core Functions` (Drift: 4.247 IQR)
- **Top Global Matches:** file_cluster_11: 14.541, file_cluster_0: 14.567, file_cluster_13: 14.595
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` PropertyValue, Selector, MediaQuery, SelectorSubPart, Tokens, Combinator, Pseudos, PropertyValueIterator...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Global Archetype:** `file_cluster_8` (Drift: 16.463 IQR)
- **Top Global Matches:** file_cluster_8: 16.463, file_cluster_7: 16.499, file_cluster_13: 16.624
- **Magnitude:** 4171.64 | **LOC:** 4905 | **CtrlFlow:** 64.5% | **Authorship Centralization:** 35.7%
- **Risk Profile:** Cognitive Load (47.1304%), Tech Debt (44.5227%)
**Top Internal Functions/Classes:**
  * `get_attachment_link` (Impact: 777.2)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 447`, `structural_boundaries: 246`, `args: 99`, `func_start: 99`
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` $post_type, $scheme = null ) 
	$orig_scheme = $scheme, $feed, 
	return apply_filters( 'includes_url', $link, $format, $scheme, rss2...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` d fields are indicated, s HTTPS, admin-footer.php', but not to update the user.', >
											<p class="description" id="new_application_password_name_desc"><?php _e( 'Required to create an Application Password, admin.php', admin-header.php', which is not enabled on this site.'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/general-template.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.39%)
- **Global Archetype:** `file_cluster_8` (Drift: 15.611 IQR)
- **Top Global Matches:** file_cluster_8: 15.611, file_cluster_7: 15.702, file_cluster_13: 15.833
- **Magnitude:** 3411.66 | **LOC:** 5438 | **CtrlFlow:** 72.1% | **Authorship Centralization:** 47.1%
- **Risk Profile:** Cognitive Load (47.0207%), Tech Debt (26.231%)
**Top Internal Functions/Classes:**
  * `get_custom_logo` (Impact: 889.4)
    * *Intent:* * @since 3.0.0 * @since 6.6.0 Added `required_username` and `required_password` arguments. * * @para...
  * `wp_get_archives` (Impact: 140.0)
  * `paginate_links` (Impact: 138.4)
...
* *Risk/State:* `high_risk_execution: 17`, `state_mutation: 1390`, `orphaned_logic: 23`
* *Architecture:* `io: 4`, `import: 1`
* *Defense:* `safety: 34`, `doc: 334`, `immutability_locks: 2`, `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` 'id_password'       => 'user_pass', $link, *                                      'step', 'xhtml', $name, 
	return apply_filters( 'wp_required_field_indicator', esc_html( $args['label_password'] ), 'true'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/functions.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.31%)
- **Global Archetype:** `file_cluster_8` (Drift: 15.415 IQR)
- **Top Global Matches:** file_cluster_8: 15.415, file_cluster_7: 15.513, file_cluster_13: 15.598
- **Magnitude:** 3350.04 | **LOC:** 9285 | **CtrlFlow:** 65.4% | **Authorship Centralization:** 30.8%
- **Risk Profile:** Cognitive Load (38.2542%), Tech Debt (80.5011%)
**Top Internal Functions/Classes:**
  * `do_enclose` (Impact: 302.1)
  ...
  * `_wp_upload_dir` (Impact: 72.8)
    * *Intent:* /** * Retrieves a modified URL query string. * * You can rebuild the URL and append query variables ...
...
* *Risk/State:* `safety_bypasses: 31`, `high_risk_execution: 1`, `state_mutation: 1400`, `dead_code: 3`, `planned_debt: 3`, `fragile_debt: 2`, `orphaned_logic: 58`
* *Architecture:* `io: 15`, `api: 2`, `concurrency: 30`, `import: 4`
* *Defense:* `safety: 68`, `doc: 494`, `test: 4`, `cleanup: 5`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` ), version.php', $feed, 410 => 'Gone', 'error' => false, $callback_args = array(), a genitive case, 407 => 'Proxy Authentication Required'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/formatting.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.31%)
- **Global Archetype:** `file_cluster_8` (Drift: 15.709 IQR)
- **Top Global Matches:** file_cluster_8: 15.709, file_cluster_7: 15.794, file_cluster_13: 15.887
- **Magnitude:** 3019.48 | **LOC:** 6297 | **CtrlFlow:** 59.0% | **Authorship Centralization:** 33.3%
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` site_url(), ), in UTC or GMT timezone.
 * @param string $format      The format string for the returned date. Default 'Y-m-d H:i:s'.
 * @return string Formatted version of the date, s and returns a date in the Y-m-d H:i:s format.
 * Return format can be overridden using the $format parameter.
 *
 * @since 1.2.0
 *
 * @param string $date_string The date to be converted, 
	$content_type = apply_filters( 'wp_mail_content_type', $url, ( $quote_style & ENT_XML1 ) ? 'xml' : 'html',  11 characters: End of $text.
 *...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/media.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.39%)
- **Global Archetype:** `file_cluster_8` (Drift: 14.967 IQR)
- **Top Global Matches:** file_cluster_8: 14.967, file_cluster_7: 15.056, file_cluster_13: 15.108
- **Magnitude:** 3013.42 | **LOC:** 6450 | **CtrlFlow:** 71.0% | **Authorship Centralization:** 42.1%
- **Risk Profile:** Cognitive Load (46.4576%), Tech Debt (8.6492%)
**Top Internal Functions/Classes:**
  * `wp_prepare_attachment_for_js` (Impact: 454.0)
  * `wp_audio_shortcode` (Impact: 380.0)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 360`, `structural_boundaries: 147`, `args: 36`, `func_start: 36`
* *Risk/State:* `safety_bypasses: 100`, `high_risk_execution: 20`, `state_mutation: 781`, `dead_code: 1`, `fragile_debt: 1`
* *Architecture:* `io: 4`, `api: 16`, `import: 2`
* *Defense:* `safety: 58`, `doc: 254`, `test: 5`, `cleanup: 7`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` 'months'            => $months, ), ] ) ) 
		$args[, :
	 *
	 *  - `next_image_link`
	 *  - `previous_image_link`
	 ...
	 * @param string|int[] $size    Requested image size. Can be any registered image size name, 'nonce'             => array(
			'sendToEditor'           => wp_create_nonce( 'media-send-to-editor' ), 2048, s the 'auto' keyword, 
		return apply_filters( 'wp_get_loading_optimization_attributes'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` browser.js, timers, promise-polyfill
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/rest-api.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.31%)
- **Global Archetype:** `file_cluster_8` (Drift: 14.663 IQR)
- **Top Global Matches:** file_cluster_8: 14.663, file_cluster_7: 14.773, file_cluster_13: 14.873
- **Magnitude:** 2864.9 | **LOC:** 3508 | **CtrlFlow:** 53.7% | **Authorship Centralization:** 46.7%
- **Risk Profile:** Cognitive Load (46.8713%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `rest_ensure_response` (Impact: 974.5)
  * `rest_validate_value_from_schema` (Impact: 116.5)
  * `rest_preload_api_request` (Impact: 103.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 441`, `structural_boundaries: 380`, `args: 65`, `func_start: 64`
* *Risk/State:* `safety_bypasses: 4`, `state_mutation: 653`
* *Architecture:* `io: 5`, `api: 21`
* *Defense:* `safety: 113`, `doc: 251`, `immutability_locks: 1`, `cleanup: 2`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` determine whether the provided field should be included
 * in the response body.
 *
 * If a parent field is passed in, use %3$s, $param ), ), $request, 'default'  => '', code>', $name...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Magnitude:** 2834.74 | **LOC:** 7229 | **CtrlFlow:** 58.7% | **Authorship Centralization:** 83.3%
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` *                     'parent', 'wp.getMediaLibrary', 'wp.editTerm', 'mt.supportedTextFilters', 'metaWeblog.newPost', 'mt.publishPost', 'blogger.newPost', 'wp.getMediaItem'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/class-wp-theme-json.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.31%)
- **Global Archetype:** `file_cluster_8` (Drift: 14.828 IQR)
- **Top Global Matches:** file_cluster_8: 14.828, file_cluster_7: 14.988, file_cluster_13: 15.001
- **Magnitude:** 2790.22 | **LOC:** 4835 | **CtrlFlow:** 64.8% | **Authorship Centralization:** 22.7%
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` s that format.
	 *
	 * For example, $valid_display_modes, $node['selector'], assuming the given prefix is '--wp'
	 * and the token is '--', *       'nestedProperty': 
	 *         'sub-property': 'value'
	 *       
	 *     
	 *
	 ...
	 *
	 *     
	 *       '--wp--some-property': 'value', _variations      = $options['include_block_style_variations'] ?? false, 
	protected static function scope_style_node_selectors( $scope, $nested_selector )
					: static::append_to_selector( $selector...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-admin/includes/media.php` (PHP | Tier 2 | 🚨 AI THREAT: 99.39%)
- **Global Archetype:** `file_cluster_8` (Drift: 14.992 IQR)
- **Top Global Matches:** file_cluster_8: 14.992, file_cluster_13: 15.12, file_cluster_7: 15.163
- **Magnitude:** 2673.14 | **LOC:** 3905 | **CtrlFlow:** 73.3% | **Authorship Centralization:** 46.7%
- **Risk Profile:** Cognitive Load (41.4737%), Tech Debt (8.7985%)
**Top Internal Functions/Classes:**
  ...
  * `media_handle_upload` (Impact: 81.3)
    * *Intent:* /** * Filters the image HTML markup to send to the editor when inserting an image. * * @since 2.5.0 ...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 855`, `structural_boundaries: 311`, `args: 51`, `func_start: 45`
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` $media_dims, d'      => false, $form_action_url, tr>\n", image-edit.php', 
	$media_dims = apply_filters( 'media_meta', 
	$form_fields = apply_filters( 'attachment_fields_to_edit', d'] = true...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `wp-includes/js/media-views.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 99.06%)
- **Global Archetype:** `file_cluster_15` (Drift: 14.29 IQR)
- **Local Micro-Species:** `Cluster 4: Heavily Documented Core Functions` (Drift: 3.908 IQR)
- **Top Global Matches:** file_cluster_15: 14.29, file_cluster_8: 14.402, file_cluster_11: 14.426
- **Magnitude:** 2632.16 | **LOC:** 10605 | **CtrlFlow:** 56.7% | **Authorship Centralization:** 66.7%
- **Risk Profile:** Cognitive Load (45.2428%), Tech Debt (99.9946%)
**Top Internal Functions/Classes:**
  * `activate` (Impact: 230.8)
    * *Intent:* /**
  * `toggleSelectionHandler` (Impact: 68.1)
    * *Intent:* /** * wp.media.controller.Embed * * A state for embedding media from a URL. * * @memberOf wp.media.c...
  * `constrainTabbing` (Impact: 66.5)
  * `setAriaHiddenOnBodyChildren` (Impact: 63.2)
  * `switchTabs` (Impact: 34.0)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 264`, `structural_boundaries: 202`, `args: 187`, `func_start: 171`
* *Risk/State:* `safety_bypasses: 2`, `state_mutation: 1315`, `dead_code: 1`, `planned_debt: 3`, `duplicate_logic: 70`
* *Architecture:* `io: 4`, `api: 50`, `concurrency: 7`
* *Defense:* `safety: 49`, `doc: 393`, `test: 6`, `cleanup: 24`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.341
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` None
...
- **Global Archetype:** `file_cluster_2` (Drift: 14.682 IQR)
- **Top Global Matches:** file_cluster_2: 14.682, file_cluster_8: 14.702, file_cluster_13: 14.723
- **Magnitude:** 2571.98 | **LOC:** 2843 | **CtrlFlow:** 67.9% | **Authorship Centralization:** 41.7%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` 
		$name    = esc_html( apply_filters( 'the_category', 'reading', *                           'general', code>'
			), primary, class-wp-internal-pointers.php', template.php, class-walker-category-checklist.php'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Local Micro-Species:** `Cluster 3: Pure View Layer Components (UI)` (Drift: 4.382 IQR)
- **Top Global Matches:** file_cluster_8: 13.699, file_cluster_11: 13.857, file_cluster_17: 13.897
- **Magnitude:** 2505.0 | **LOC:** 2149 | **CtrlFlow:** 31.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (99.9794%)
**Top Internal Functions/Classes:**
  * `createTextBlock` (Impact: 37.0)
  * `findNextCaretContainer` (Impact: 32.8)
  * `mergeLiElements` (Impact: 29.7)
  * `getSelectedTextBlocks` (Impact: 28.1)
  * `resolveBookmark` (Impact: 26.3)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 368`, `structural_boundaries: 789`, `args: 313`, `func_start: 328`
* *Risk/State:* `safety_bypasses: 1`, `high_risk_execution: 1`, `state_mutation: 1151`, `duplicate_logic: 91`
* *Architecture:* `io: 2`, `api: 14`
...
- `wp-admin/includes/schema.php` (PHP) | Magnitude: 201.54 | Delta: **0.004 IQR** | Secondary Pull: `file_cluster_8`
...
- `wp-includes/js/media-grid.js` (JAVASCRIPT) | Magnitude: 160.28 | Delta: **0.049 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_tabs: 135, state_mutation: 89, doc: 50, args: 20

### Mixed-Responsibility Refactoring Targets for: file_cluster_17
- `wp-includes/ID3/module.audio.mp3.php` (PHP) | Magnitude: 1221.94 | Delta: **0.005 IQR** | Secondary Pull: `file_cluster_0`
...
- `wp-admin/includes/class-wp-ms-themes-list-table.php` (PHP) | Magnitude: 526.8 | Delta: **0.016 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_tabs: 295, state_mutation: 214, branch: 85, doc: 48
- `wp-admin/includes/comment.php` (PHP) | Magnitude: 165.06 | Delta: **0.016 IQR** | Secondary Pull: `file_cluster_13`
...
- `wp-admin/includes/template.php` (PHP) | Magnitude: 2571.98 | Delta: **0.02 IQR** | Secondary Pull: `file_cluster_8`
...
- `wp-includes/html-api/class-wp-html-active-formatting-elements.php` (PHP) | Magnitude: 108.56 | Delta: **0.079 IQR** | Secondary Pull: `file_cluster_8`
...
- `wp-includes/script-loader.php` (PHP) | Magnitude: 636.08 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_tabs: 457, branch: 151, func_start: 71, structural_boundaries: 69
...
- `wp-includes/sodium_compat/src/Core32/Curve25519/Ge/P3.php` (PHP) | Magnitude: 63.98 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_7`
  * Top Architectural Signatures: state_mutation: 46, indent_spaces: 28, doc: 14, structural_boundaries: 7
- `wp-includes/class-wp-site-query.php` (PHP) | Magnitude: 380.14 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_17`
...
- `wp-includes/PHPMailer/POP3.php` (PHP) | Magnitude: 86.6 | Delta: **0.215 IQR** | Secondary Pull: `file_cluster_17`
...
- `wp-admin/js/customize-controls.js` -> **joedolson** (100.0% isolated ownership) | Magnitude: 5825.06
- `wp-includes/js/codemirror/csslint.js` -> **Weston Ruter** (100.0% isolated ownership) | Magnitude: 5159.28
- `wp-includes/class-wp-xmlrpc-server.php` -> **Weston Ruter** (83.3% isolated ownership) | Magnitude: 2834.74
- `wp-includes/js/codemirror/esprima.js` -> **Weston Ruter** (100.0% isolated ownership) | Magnitude: 2235.4
- `wp-includes/sodium_compat/src/Compat.php` -> **Sergey Biryukov** (100.0% isolated ownership) | Magnitude: 1981.18
...
- `wp-includes/php-ai-client/src/Common/Contracts/AiClientExceptionInterface.php` -> **Severity: 205.741** (Blast Radius: 18.466 * Doc Risk: 11.1416%)
- `wp-includes/php-ai-client/src/Common/Exception/InvalidArgumentException.php` -> **Severity: 168.662** (Blast Radius: 15.138 * Doc Risk: 11.1416%)
- `wp-includes/php-ai-client/src/Common/AbstractEnum.php` -> **Severity: 150.464** (Blast Radius: 8.415 * Doc Risk: 17.8804%)
- `wp-includes/php-ai-client/src/Common/AbstractDataTransferObject.php` -> **Severity: 106.871** (Blast Radius: 5.977 * Doc Risk: 17.8804%)
- `wp-includes/php-ai-client/src/Common/Exception/RuntimeException.php` -> **Severity: 68.409** (Blast Radius: 6.14 * Doc Risk: 11.1416%)
