# ARCHITECTURAL_BRIEF: node-html-markdown
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/node-html-markdown` |
| **Timestamp** | `2026-08-07T05:15:32.252017+00:00` |
| **Scan Duration** | `0.06s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 6.9 | **LOC:** 345 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
