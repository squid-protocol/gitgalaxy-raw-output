# ARCHITECTURAL_BRIEF: @sentry_node-core
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@sentry_node-core` |
| **Timestamp** | `2026-08-07T05:13:05.403879+00:00` |
| **Scan Duration** | `0.09s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 3.14 | **LOC:** 157 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
