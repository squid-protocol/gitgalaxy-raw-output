...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/pypi_top_200/awscli` |
| **Timestamp** | `2026-08-07T05:21:27.229301+00:00` |
| **Scan Duration** | `2.26s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Binary Anomalies (X-Ray):** `1043` (High entropy, packed payloads, or magic byte mismatches).
