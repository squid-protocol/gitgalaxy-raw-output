...
| **Timestamp** | `2026-08-07T04:20:18.271637+00:00` |
| **Scan Duration** | `0.46s` |
| **Git Branch** | `main` |
...
| Error & Exception Exposure | 0.0 | 80.0 | 8.8 | 0.0 | 0.0 |
| Tech Debt Exposure | 0.0 | 100.0 | 3.1 | 0.0 | 0.0 |
| Testing Exposure | 0.0 | 80.0 | 2.3 | 1.5 | 2.3 |
...
| Documentation Exposure | 0.0 | 100.0 | 14.2 | 11.9 | 17.9 |
...
- `TSTypeAliasDeclaration` (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **23.2** | LOC: 39
...
- `indentsUptoIndex` (@ `lint-processors/jsdoc-codeblocks.js`) -> Impact: **13.1** | LOC: 21
  * *Intent:* /**
- `checkExportedType` (@ `lint-rules/require-exported-types.js`) -> Impact: **12.1** | LOC: 34
...
### 2. `lint-rules/validate-jsdoc-codeblocks.js` (JAVASCRIPT) -> Cumulative Risk: **333.4**
- **Archetype:** `file_cluster_8` (Distance: 10.029 IQR)
- **Magnitude:** 91.66 | **LOC:** 421 | **CtrlFlow:** 70.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Verification (80.0%), Churn (73.74%), Safety Score (43.5497%)
- **Heaviest Functions:** `create` (Impact: 28.3), `TSTypeAliasDeclaration` (Impact: 23.2), `parseCompilerOptions` (Impact: 13.5)

### 3. `lint-rules/require-export.js` (JAVASCRIPT) -> Cumulative Risk: **305.38**
- **Archetype:** `file_cluster_8` (Distance: 8.84 IQR)
- **Magnitude:** 27.8 | **LOC:** 47 | **CtrlFlow:** 46.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (82.8696%), Safety Score (57.9568%), State Flux (43.0454%)
- **Heaviest Functions:** `create` (Impact: 11.4), `ExportNamedDeclaration` (Impact: 6.0), `fix` (Impact: 1.6)

### 4. `lint-rules/require-exported-types.js` (JAVASCRIPT) -> Cumulative Risk: **268.09**
- **Archetype:** `file_cluster_8` (Distance: 9.788 IQR)
- **Magnitude:** 64.64 | **LOC:** 143 | **CtrlFlow:** 64.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Verification (80.0%), Safety Score (49.7049%), Cognitive Load (18.2072%)
- **Heaviest Functions:** `create` (Impact: 39.5), `checkExportedType` (Impact: 12.1)
...
### 6. `source/words.d.ts` (TYPESCRIPT) -> Cumulative Risk: **248.13**
...
### 7. `lint-processors/jsdoc-codeblocks.js` (JAVASCRIPT) -> Cumulative Risk: **245.87**
- **Archetype:** `file_cluster_8` (Distance: 11.914 IQR)
- **Magnitude:** 64.38 | **LOC:** 173 | **CtrlFlow:** 76.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (44.1073%), Churn (41.63%), Cognitive Load (23.3134%)
- **Heaviest Functions:** `preprocess` (Impact: 36.8), `indentsUptoIndex` (Impact: 13.1)

### 8. `xo.config.js` (JAVASCRIPT) -> Cumulative Risk: **245.4**
- **Archetype:** `file_cluster_1` (Distance: 8.395 IQR)
- **Magnitude:** 21.88 | **LOC:** 155 | **CtrlFlow:** 5.6% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (67.89%), Safety Score (49.5153%), Documentation (17.8804%)

### 9. `source/set-readonly.d.ts` (TYPESCRIPT) -> Cumulative Risk: **244.28**
- **Archetype:** `file_cluster_13` (Distance: 11.546 IQR)
- **Magnitude:** 1.83 | **LOC:** 41 | **CtrlFlow:** 10.5% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (59.7969%), Churn (52.53%), Safety Score (20.7236%)

### 10. `source/fixed-length-array.d.ts` (TYPESCRIPT) -> Cumulative Risk: **243.1**
...
- **Global Archetype:** `file_cluster_8` (Drift: 10.029 IQR)
- **Local Micro-Species:** `Cluster 8: Declarative Glue & Inert Types` (Drift: 4.719 IQR)
- **Top Global Matches:** file_cluster_8: 10.029, file_cluster_13: 10.276, file_cluster_7: 10.523
- **Magnitude:** 91.66 | **LOC:** 421 | **CtrlFlow:** 70.2% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (13.8199%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `create` (Impact: 28.3)
  * `TSTypeAliasDeclaration` (Impact: 23.2)
  * `parseCompilerOptions` (Impact: 13.5)
  * `getJSDocNode` (Impact: 11.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Top Global Matches:** file_cluster_8: 9.788, file_cluster_13: 9.944, file_cluster_17: 10.24
- **Magnitude:** 64.64 | **LOC:** 143 | **CtrlFlow:** 64.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (18.2072%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `create` (Impact: 39.5)
  * `checkExportedType` (Impact: 12.1)
    * *Intent:* // Helper function to check exported type/interface
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `preprocess` (Impact: 36.8)
  * `indentsUptoIndex` (Impact: 13.1)
    * *Intent:* /**
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` is-unknown.d.ts, unknown-array.d.ts, type-fest, index.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `lint-rules/require-export.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 98.96%)
- **Global Archetype:** `file_cluster_8` (Drift: 8.84 IQR)
- **Local Micro-Species:** `Cluster 3: Pure View Layer Components (UI)` (Drift: 3.218 IQR)
- **Top Global Matches:** file_cluster_8: 8.84, file_cluster_7: 9.361, file_cluster_1: 9.692
- **Magnitude:** 27.8 | **LOC:** 47 | **CtrlFlow:** 46.2% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` source-files-extension.js, typescript-eslint, require-exported-types.js, xo, require-export.js, validate-jsdoc-codeblocks.js, import-path.js, jsdoc-codeblocks.js
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` words.d.ts, literal-to-primitive.d.ts, is-integer.d.ts, union-to-intersection.d.ts, array-length.d.ts, writable.d.ts, partial-on-undefined-deep.d.ts, async-return-type.d.ts...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Magnitude:** 16.44 | **LOC:** 58 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
...
- **Local Micro-Species:** `Cluster 8: Declarative Glue & Inert Types` (Drift: 4.428 IQR)
- **Top Global Matches:** file_cluster_8: 7.978, file_cluster_7: 8.62, file_cluster_13: 8.661
- **Magnitude:** 14.16 | **LOC:** 43 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
...
* *Risk/State:* `safety_bypasses: 2`
* *Architecture:* `io: 3`, `api: 3`, `import: 1`
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` unknown-array.d.ts, is-never.d.ts, type-fest, if.d.ts, union-to-intersection.d.ts, is-any.d.ts, primitive.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` keys-of-union.d.ts, required-keys-of.d.ts, optional-keys-of.d.ts, keys.d.ts, type.d.ts, is-never.d.ts, merge.d.ts, type-fest...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` type-fest, is-integer.d.ts, is-float.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` keys.d.ts, type.d.ts, object.d.ts, array.d.ts, tuple.d.ts, numeric.d.ts, string.d.ts, enforce-optional.d.ts...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` numeric.d.ts, tuple-of.d.ts, characters.d.ts, trim.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` optional-keys-of.d.ts, type.d.ts, is-never.d.ts, unknown-array.d.ts, if.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` is-lowercase.d.ts, is-uppercase.d.ts, type-fest, index.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` type-fest, tagged.d.ts, primitive.d.ts, numeric.d.ts, index.d.ts, is-never.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` conditional-simplify-deep.d.ts, non-empty-tuple.d.ts, unknown-record.d.ts, type-fest, merge.d.ts, simplify-deep.d.ts, omit-index-signature.d.ts, index.d.ts...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 4.63
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` numeric.d.ts, is-never.d.ts, type.d.ts, unknown-array.d.ts
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `source/globals/observable-like.d.ts` (TYPESCRIPT) | Magnitude: 1.04 | Delta: **0.006 IQR** | Secondary Pull: `file_cluster_2`
...
- `lint-rules/require-exported-types.js` (JAVASCRIPT) | Magnitude: 64.64 | Delta: **0.156 IQR** | Secondary Pull: `file_cluster_13`
...
- `lint-rules/validate-jsdoc-codeblocks.js` -> **Som Shekhar Mukherjee** (100.0% isolated ownership) | Magnitude: 91.66
...
- `lint-rules/require-export.js` -> **Severity: 383.686** (Blast Radius: 4.63 * Doc Risk: 82.8696%)
- `source/internal/index.d.ts` -> **Severity: 308.663** (Blast Radius: 4.63 * Doc Risk: 66.6659%)
- `lint-rules/source-files-extension.js` -> **Severity: 284.431** (Blast Radius: 4.63 * Doc Risk: 61.4322%)
- `source/set-readonly.d.ts` -> **Severity: 276.86** (Blast Radius: 4.63 * Doc Risk: 59.7969%)
