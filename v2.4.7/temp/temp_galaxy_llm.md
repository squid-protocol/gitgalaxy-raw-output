...
| **Timestamp** | `2026-08-07T03:51:22.546273+00:00` |
| **Scan Duration** | `0.36s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 0.0 | 70.2 | 27.0 | 21.5 | 11.9 |
...
- `UPDATE-POLICY-DB2-INFO` (@ `cics-genapp/base/src/lgupdb01.cbl`) -> Impact: **45.1** | LOC: 102
  * *Intent:* ******************************************************************
- `MAINLINE` (@ `cics-genapp/base/src/lgwebst5.cbl`) -> Impact: **38.0** | LOC: 448
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp4.cbl`) -> Impact: **33.9** | LOC: 197
- `MAINLINE` (@ `cics-genapp/base/src/lgicvs01.cbl`) -> Impact: **30.2** | LOC: 124
- `MAINLINE` (@ `cics-genapp/base/src/lgapdb01.cbl`) -> Impact: **29.1** | LOC: 83
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp1.cbl`) -> Impact: **27.0** | LOC: 201
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp2.cbl`) -> Impact: **27.0** | LOC: 189
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp3.cbl`) -> Impact: **27.0** | LOC: 185
- `MAINLINE` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **24.2** | LOC: 64
- `A-GAIN` (@ `cics-genapp/base/src/lgtestc1.cbl`) -> Impact: **23.9** | LOC: 157

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `cics-genapp/base/src` | 47 | 3898.84 | 61.04% | 35.54% |
| `cics-genapp/base/cntl` | 30 | 521.22 | 2.94% | 0.0% |
...
### 1. `cics-genapp/base/src/lgupdb01.cbl` (COBOL) -> Cumulative Risk: **589.18**
...
### 2. `cics-genapp/base/src/lgacdb01.cbl` (COBOL) -> Cumulative Risk: **584.3**
...
### 3. `cics-genapp/base/src/lgicvs01.cbl` (COBOL) -> Cumulative Risk: **583.7**
...
### 4. `cics-genapp/base/src/lgapdb01.cbl` (COBOL) -> Cumulative Risk: **563.18**
...
### 5. `cics-genapp/base/src/lgtestc1.cbl` (COBOL) -> Cumulative Risk: **562.1**
...
### 6. `cics-genapp/base/src/lgstsq.cbl` (COBOL) -> Cumulative Risk: **553.06**
...
### 7. `cics-genapp/base/src/lgipdb01.cbl` (COBOL) -> Cumulative Risk: **552.05**
...
### 8. `cics-genapp/base/src/lgacus01.cbl` (COBOL) -> Cumulative Risk: **543.69**
...
### 9. `cics-genapp/base/src/lgtestp3.cbl` (COBOL) -> Cumulative Risk: **540.97**
...
### 10. `cics-genapp/base/src/lgtestp2.cbl` (COBOL) -> Cumulative Risk: **540.14**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` LGCMAREA, LGPOLICY, SQLCA
...
### `cics-genapp/base/src/lgstsq.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 98.85%)
...
### `cics-genapp/base/src/lgapol01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
- `cics-genapp/base/src/lgucus01.cbl` (COBOL) | Magnitude: 56.22 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 96, state_mutation: 36, structural_boundaries: 12, branch: 11

### Mixed-Responsibility Refactoring Targets for: file_cluster_11
- `cics-genapp/base/src/lgipdb01.cbl` (COBOL) | Magnitude: 518.08 | Delta: **0.002 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 739, state_mutation: 341, branch: 117, safety: 34
- `cics-genapp/base/src/lgicdb01.cbl` (COBOL) | Magnitude: 90.72 | Delta: **0.004 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 141, state_mutation: 61, branch: 18, structural_boundaries: 13
- `cics-genapp/base/src/lgapol01.cbl` (COBOL) | Magnitude: 51.88 | Delta: **0.013 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: indent_spaces: 89, state_mutation: 34, structural_boundaries: 11, branch: 10
- `cics-genapp/base/src/lgdpol01.cbl` (COBOL) | Magnitude: 63.92 | Delta: **0.029 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_spaces: 101, state_mutation: 39, branch: 16, structural_boundaries: 12
- `cics-genapp/base/src/lgapdb01.cbl` (COBOL) | Magnitude: 222.06 | Delta: **0.031 IQR** | Secondary Pull: `file_cluster_0`
...
- `cics-genapp/base/src/lgacdb02.cbl` (COBOL) | Magnitude: 72.72 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 126, state_mutation: 46, branch: 16, structural_boundaries: 13
- `cics-genapp/base/src/lgucdb01.cbl` (COBOL) | Magnitude: 74.42 | Delta: **0.074 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 141, state_mutation: 48, branch: 15, structural_boundaries: 13
- `cics-genapp/base/src/lgipol01.cbl` (COBOL) | Magnitude: 45.24 | Delta: **0.09 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 82, state_mutation: 30, structural_boundaries: 11, branch: 8

### Mixed-Responsibility Refactoring Targets for: file_cluster_4
- `cics-genapp/base/src/lgicvs01.cbl` (COBOL) | Magnitude: 116.9 | Delta: **0.116 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 180, state_mutation: 69, io: 30, branch: 23

### Mixed-Responsibility Refactoring Targets for: file_cluster_8
- `cics-genapp/base/src/lgacdb01.cbl` (COBOL) | Magnitude: 113.36 | Delta: **0.009 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 213, state_mutation: 72, branch: 24, reflection_metaprogramming: 18
- `cics-genapp/base/src/lgupol01.cbl` (COBOL) | Magnitude: 91.84 | Delta: **0.041 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 117, state_mutation: 60, branch: 21, structural_boundaries: 12
- `cics-genapp/base/src/lgstsq.cbl` (COBOL) | Magnitude: 51.9 | Delta: **0.087 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_spaces: 85, state_mutation: 38, io: 15, structural_boundaries: 11
- `cics-genapp/base/src/lgtestp1.cbl` (COBOL) | Magnitude: 220.98 | Delta: **0.203 IQR** | Secondary Pull: `file_cluster_2`
  * Top Architectural Signatures: indent_spaces: 259, state_mutation: 175, reflection_metaprogramming: 26, branch: 22
- `cics-genapp/base/src/lgtestp3.cbl` (COBOL) | Magnitude: 206.52 | Delta: **0.205 IQR** | Secondary Pull: `file_cluster_12`
...
- `cics-genapp/base/cntl/itpentr.jcl` -> **Severity: 544.239** (Blast Radius: 7.752 * Doc Risk: 70.2063%)
- `cics-genapp/base/cntl/itpll.jcl` -> **Severity: 506.087** (Blast Radius: 7.752 * Doc Risk: 65.2847%)
- `cics-genapp/base/cntl/samptsq.jcl` -> **Severity: 495.129** (Blast Radius: 7.752 * Doc Risk: 63.8711%)
- `cics-genapp/base/src/soaic01.cpy` -> **Severity: 475.419** (Blast Radius: 7.752 * Doc Risk: 61.3285%)
- `cics-genapp/base/src/soaiph1.cpy` -> **Severity: 440.485** (Blast Radius: 7.752 * Doc Risk: 56.8221%)
