...
| **Timestamp** | `2026-08-07T05:11:09.748695+00:00` |
| **Scan Duration** | `0.08s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 0.8 | 93.2 | 8.5 | 1.6 | 1.6 |
...
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **1.9** | LOC: 4
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **1.9** | LOC: 4
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **1.9** | LOC: 4
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **1.9** | LOC: 4
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **1.9** | LOC: 4
...
### 1. `package/crypto.d.ts` (TYPESCRIPT) -> Cumulative Risk: **458.94**
- **Archetype:** `file_cluster_8` (Distance: 8.834 IQR)
- **Magnitude:** 6.88 | **LOC:** 109 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), Concurrency (99.9994%), Documentation (93.1718%)
- **Heaviest Functions:** `generateKeyPair` (Impact: 1.9), `generateKeyPair` (Impact: 1.9), `generateKeyPair` (Impact: 1.9)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` util, crypto
...
- **Top Global Matches:** file_cluster_8: 8.834, file_cluster_16: 9.134, file_cluster_2: 9.338
- **Magnitude:** 6.88 | **LOC:** 109 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (100.0%)
**Top Internal Functions/Classes:**
  * `generateKeyPair` (Impact: 1.9)
  * `generateKeyPair` (Impact: 1.9)
  * `generateKeyPair` (Impact: 1.9)
  * `generateKeyPair` (Impact: 1.9)
  * `generateKeyPair` (Impact: 1.9)
...
- `package/crypto.d.ts` (TYPESCRIPT) | Magnitude: 6.88 | Delta: **0.3 IQR** | Secondary Pull: `file_cluster_16`
...
- `package/crypto.d.ts` -> **Severity: 4131.797** (Blast Radius: 44.346 * Doc Risk: 93.1718%)
