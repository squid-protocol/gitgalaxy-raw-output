...
| **Timestamp** | `2026-08-07T05:16:47.585926+00:00` |
| **Scan Duration** | `0.08s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 74.7 | 84.4 | 79.6 | 79.6 | 74.7 |
| Error & Exception Exposure | 79.5 | 98.1 | 88.8 | 88.8 | 79.5 |
...
| Documentation Exposure | 14.4 | 15.4 | 14.9 | 14.9 | 15.4 |
...
- `fstat` (@ `package/index.js`) -> Impact: **11.0** | LOC: 12
- `futimes` (@ `package/index.js`) -> Impact: **11.0** | LOC: 13
- `onstatref` (@ `package/index.js`) -> Impact: **10.8** | LOC: 8
- `fstat` (@ `package/index.js`) -> Impact: **9.2** | LOC: 10
- `futimes` (@ `package/index.js`) -> Impact: **9.2** | LOC: 10
- `close` (@ `package/index.js`) -> Impact: **8.9** | LOC: 4
- `statref` (@ `package/index.js`) -> Impact: **7.4** | LOC: 10
- `exports` (@ `package/index.js`) -> Impact: **6.5** | LOC: 11

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package` | 3 | 418.0 | 28.14% | 33.33% |
| `package/bin` | 1 | 31.72 | 74.71% | 0.0% |
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **676.42**
- **Archetype:** `file_cluster_11` (Distance: 15.152 IQR)
- **Magnitude:** 415.94 | **LOC:** 225 | **CtrlFlow:** 69.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9985%), Safety Score (98.1042%)
- **Heaviest Functions:** `onopen` (Impact: 23.4), `validOpts` (Impact: 21.4), `fstat` (Impact: 11.0)

### 2. `package/bin/nodetouch.js` (JAVASCRIPT) -> Cumulative Risk: **450.2**
- **Archetype:** `file_cluster_8` (Distance: 10.814 IQR)
- **Magnitude:** 31.72 | **LOC:** 113 | **CtrlFlow:** 88.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (90.9153%), Safety Score (79.4974%), Cognitive Load (74.7124%)
- **Heaviest Functions:** `usage` (Impact: 3.8)

## 12. SCANNED ARTIFACTS HITLIST (Top 25 Heaviest Files)
> *Note: 'Magnitude' represents the file's total Structural Magnitude and impact within the system. It is independent of its Risk Profile. High magnitude implies high structural importance and centralization.*

### `package/index.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 99.14%)
- **Global Archetype:** `file_cluster_11` (Drift: 15.152 IQR)
- **Local Micro-Species:** `Cluster 2: Procedural Core & Safety Wrappers` (Drift: 5.651 IQR)
- **Top Global Matches:** file_cluster_11: 15.152, file_cluster_13: 15.188, file_cluster_4: 15.235
- **Magnitude:** 415.94 | **LOC:** 225 | **CtrlFlow:** 69.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (84.4203%), Tech Debt (99.9985%)
**Top Internal Functions/Classes:**
  * `onopen` (Impact: 23.4)
  * `validOpts` (Impact: 21.4)
  * `fstat` (Impact: 11.0)
  * `futimes` (Impact: 11.0)
  * `onstatref` (Impact: 10.8)
...
- **Magnitude:** 31.72 | **LOC:** 113 | **CtrlFlow:** 88.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (74.7124%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `usage` (Impact: 3.8)
**Structural Signatures (Net Mitigated Signals):**
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 415.94 | Delta: **0.036 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: state_mutation: 241, indent_spaces: 171, branch: 65, args: 29

### Mixed-Responsibility Refactoring Targets for: file_cluster_8
- `package/bin/nodetouch.js` (JAVASCRIPT) | Magnitude: 31.72 | Delta: **0.463 IQR** | Secondary Pull: `file_cluster_17`
...
- `package/bin/nodetouch.js` -> **Severity: 3850.1** (Blast Radius: 250.0 * Doc Risk: 15.4004%)
- `package/index.js` -> **Severity: 3602.7** (Blast Radius: 250.0 * Doc Risk: 14.4108%)
