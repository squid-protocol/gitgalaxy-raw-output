...
| **Timestamp** | `2026-08-07T05:27:13.554292+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 0.0 | 98.8 | 35.5 | 18.2 | 0.0 |
| Tech Debt Exposure | 0.0 | 86.7 | 14.9 | 0.0 | 0.0 |
| Testing Exposure | 0.0 | 2.4 | 0.9 | 0.0 | 0.0 |
...
| Documentation Exposure | 0.0 | 96.6 | 12.3 | 0.0 | 0.0 |
...
- `_compile_identity_check_function` (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **20.0** | LOC: 19
- `_compile_isinstance_check_function` (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **18.3** | LOC: 19
- `allowed_qualifiers` (@ `typing_inspection-0.4.2/src/typing_inspection/introspection.py`) -> Impact: **14.8** | LOC: 18
- `test_literal_values_type_check` (@ `typing_inspection-0.4.2/tests/introspection/test_literal_values.py`) -> Impact: **5.7** | LOC: 11
- `_literal_type_check` (@ `typing_inspection-0.4.2/src/typing_inspection/introspection.py`) -> Impact: **5.6** | LOC: 8
- `is_namedtuple` (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **5.4** | LOC: 4
- `test_annotation_source_invalid_qualifier` (@ `typing_inspection-0.4.2/tests/introspection/test_inspect_annotation.py`) -> Impact: **5.4** | LOC: 4
- `test_bare_qualifier` (@ `typing_inspection-0.4.2/tests/introspection/test_inspect_annotation.py`) -> Impact: **4.0** | LOC: 11
- `is_union_origin` (@ `typing_inspection-0.4.2/src/typing_inspection/introspection.py`) -> Impact: **3.7** | LOC: 4
- `is_typealiastype` (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **3.6** | LOC: 2

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `typing_inspection-0.4.2/src/typing_inspection` | 4 | 382.41 | 8.68% | 40.95% |
| `typing_inspection-0.4.2/tests/introspection` | 4 | 77.42 | 5.76% | 0.0% |
...
### 1. `typing_inspection-0.4.2/src/typing_inspection/introspection.py` (PYTHON) -> Cumulative Risk: **393.93**
- **Archetype:** `file_cluster_13` (Distance: 10.891 IQR)
- **Magnitude:** 66.3 | **LOC:** 588 | **CtrlFlow:** 54.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Tech Debt (86.7036%), Spec Match (86.6667%), Safety Score (80.0%), Stability (50.0%)
- **Heaviest Functions:** `allowed_qualifiers` (Impact: 14.8), `_literal_type_check` (Impact: 5.6), `is_union_origin` (Impact: 3.7)

### 2. `typing_inspection-0.4.2/Makefile` (MAKEFILE) -> Cumulative Risk: **266.94**
- **Archetype:** `file_cluster_8` (Distance: 7.371 IQR)
- **Magnitude:** 42.6 | **LOC:** 40 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (96.6431%), Stability (50.0%), Api Exposure (13.8139%)

### 3. `typing_inspection-0.4.2/tests/introspection/test_is_union_origin.py` (PYTHON) -> Cumulative Risk: **246.64**
...
### 4. `typing_inspection-0.4.2/src/typing_inspection/typing_objects.pyi` (PYTHON) -> Cumulative Risk: **243.51**
- **Archetype:** `file_cluster_16` (Distance: 11.339 IQR)
- **Magnitude:** 239.67 | **LOC:** 418 | **CtrlFlow:** 4.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (98.7933%), Stability (50.0%), Spec Match (41.9355%), Tech Debt (24.4136%)

### 5. `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py` (PYTHON) -> Cumulative Risk: **210.73**
- **Archetype:** `file_cluster_13` (Distance: 10.891 IQR)
- **Magnitude:** 65.92 | **LOC:** 608 | **CtrlFlow:** 47.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (75.0237%), Tech Debt (52.6634%), Stability (50.0%), Documentation (11.9203%)
- **Heaviest Functions:** `_compile_identity_check_function` (Impact: 20.0), `_compile_isinstance_check_function` (Impact: 18.3), `is_namedtuple` (Impact: 5.4)

### 6. `typing_inspection-0.4.2/tests/typing_objects/test_member_checks.py` (PYTHON) -> Cumulative Risk: **196.37**
- **Archetype:** `file_cluster_0` (Distance: 11.653 IQR)
- **Magnitude:** 58.0 | **LOC:** 210 | **CtrlFlow:** 19.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Safety Score (27.371%), Api Exposure (10.12%)
- **Heaviest Functions:** `test_is_typealiastype` (Impact: 2.2), `test_identity_member_check` (Impact: 2.1), `test_is_namedtuple` (Impact: 2.1)

### 7. `typing_inspection-0.4.2/tests/introspection/test_literal_values.py` (PYTHON) -> Cumulative Risk: **180.22**
- **Archetype:** `file_cluster_13` (Distance: 11.066 IQR)
- **Magnitude:** 23.92 | **LOC:** 80 | **CtrlFlow:** 15.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Safety Score (18.1922%), Api Exposure (8.8562%)
- **Heaviest Functions:** `test_literal_values_type_check` (Impact: 5.7), `test_literal_values_skip_aliases_type_ch` (Impact: 3.6), `test_literal_values_unpack_type_aliases` (Impact: 2.1)

### 8. `typing_inspection-0.4.2/tests/introspection/test_inspect_annotation.py` (PYTHON) -> Cumulative Risk: **168.57**
- **Archetype:** `file_cluster_8` (Distance: 10.317 IQR)
- **Magnitude:** 36.5 | **LOC:** 207 | **CtrlFlow:** 9.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Safety Score (10.6115%), Api Exposure (5.5465%)
- **Heaviest Functions:** `test_annotation_source_invalid_qualifier` (Impact: 5.4), `test_bare_qualifier` (Impact: 4.0), `test_annotation_source_valid_qualifiers` (Impact: 3.6)

### 9. `typing_inspection-0.4.2/src/typing_inspection/__init__.py` (PYTHON) -> Cumulative Risk: **64.99**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` types, typing, sys, typing_extensions
...
**Top Internal Functions/Classes:**
  * `allowed_qualifiers` (Impact: 14.8)
  * `_literal_type_check` (Impact: 5.6)
  * `is_union_origin` (Impact: 3.7)
  * `__init__` (Impact: 2.1)
  * `is_union_origin` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` sys, typing_inspection, , types, enum, typing_extensions, typing, collections.abc...
...
**Top Internal Functions/Classes:**
  * `_compile_identity_check_function` (Impact: 20.0)
  * `_compile_isinstance_check_function` (Impact: 18.3)
  * `is_namedtuple` (Impact: 5.4)
  * `is_typealiastype` (Impact: 3.6)
  * `is_newtype` (Impact: 1.8)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 64.309
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, warnings, textwrap, contextlib, types, typing_extensions, typing, collections.abc...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `test_is_typealiastype` (Impact: 2.2)
  * `test_identity_member_check` (Impact: 2.1)
  * `test_is_namedtuple` (Impact: 2.1)
  * `test_is_newtype` (Impact: 2.1)
  * `test_is_paramspec` (Impact: 2.1)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 64.309
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` sys, warnings, typing_inspection, collections, types, typing_extensions, pytest, typing...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Global Archetype:** `file_cluster_8` (Drift: 10.317 IQR)
- **Local Micro-Species:** `Cluster 1: Declarative Glue & Initialization` (Drift: 4.983 IQR)
- **Top Global Matches:** file_cluster_8: 10.317, file_cluster_13: 10.411, file_cluster_0: 10.422
- **Magnitude:** 36.5 | **LOC:** 207 | **CtrlFlow:** 9.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (2.4131%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_annotation_source_invalid_qualifier` (Impact: 5.4)
  * `test_bare_qualifier` (Impact: 4.0)
  * `test_annotation_source_valid_qualifiers` (Impact: 3.6)
  * `test_nested_metadata_and_qualifiers` (Impact: 2.2)
  * `test_unknown_repr` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` sys, typing_inspection.introspection, textwrap, typing_extensions, pytest, typing, dataclasses
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `test_literal_values_type_check` (Impact: 5.7)
  * `test_literal_values_skip_aliases_type_ch` (Impact: 3.6)
  * `test_literal_values_unpack_type_aliases` (Impact: 2.1)
  * `test_literal_values_skip_aliases_no_type` (Impact: 1.9)
  * `test_literal_values_unpack_type_aliases_` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 64.309
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` sys, typing_inspection.introspection, typing_inspection, textwrap, typing_extensions, pytest, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `test_is_union_origin` (Impact: 2.1)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 64.309
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` sys, typing_inspection.introspection, typing_extensions, types, pytest, typing
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py` (PYTHON) | Magnitude: 65.92 | Delta: **0.113 IQR** | Secondary Pull: `file_cluster_7`
  * Top Architectural Signatures: indent_spaces: 123, doc: 74, encapsulation: 71, structural_boundaries: 36
- `typing_inspection-0.4.2/src/typing_inspection/introspection.py` (PYTHON) | Magnitude: 66.3 | Delta: **0.134 IQR** | Secondary Pull: `file_cluster_16`
  * Top Architectural Signatures: indent_spaces: 210, branch: 75, structural_boundaries: 63, doc: 50
- `typing_inspection-0.4.2/tests/introspection/test_literal_values.py` (PYTHON) | Magnitude: 23.92 | Delta: **0.258 IQR** | Secondary Pull: `file_cluster_16`
...
- `typing_inspection-0.4.2/tests/introspection/test_inspect_annotation.py` (PYTHON) | Magnitude: 36.5 | Delta: **0.094 IQR** | Secondary Pull: `file_cluster_13`
...
- `typing_inspection-0.4.2/Makefile` -> **Severity: 6215.021** (Blast Radius: 64.309 * Doc Risk: 96.6431%)
...
- `typing_inspection-0.4.2/src/typing_inspection/__init__.py` -> **Severity: 204.162** (Blast Radius: 64.309 * Doc Risk: 3.1747%)
