...
| **Timestamp** | `2026-08-07T05:12:58.433811+00:00` |
| **Scan Duration** | `0.09s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 23.0 | 97.5 | 71.2 | 80.0 | 97.5 |
| Tech Debt Exposure | 0.0 | 100.0 | 52.7 | 61.2 | 0.0 |
| Testing Exposure | 0.3 | 80.0 | 11.9 | 2.6 | 2.6 |
...
| Documentation Exposure | 3.0 | 25.4 | 13.1 | 11.9 | 11.9 |
...
- `constructor` (@ `package/types/index.d.ts`) -> Impact: **18.1** | LOC: 16
  * *Intent:* /**
- `createPersistenceQueue` (@ `package/index.d.ts`) -> Impact: **10.8** | LOC: 15
- `assert` (@ `package/cjs/loosely-validate-event/index.js`) -> Impact: **9.8** | LOC: 17
- `assert` (@ `package/esm/loosely-validate-event/index.js`) -> Impact: **9.8** | LOC: 17
- `formatLogData` (@ `package/cjs/Logger.js`) -> Impact: **9.6** | LOC: 18
- `formatLogData` (@ `package/esm/Logger.js`) -> Impact: **9.6** | LOC: 18
- `createPersistenceQueue` (@ `package/types/index.d.ts`) -> Impact: **9.6** | LOC: 12
- `validateGenericEvent` (@ `package/cjs/loosely-validate-event/index.js`) -> Impact: **7.8** | LOC: 17
  * *Intent:* /** * Validation rules. */

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package/cjs` | 1 | 124.64 | 65.74% | 0.0% |
| `package/esm` | 1 | 124.64 | 65.74% | 0.0% |
| `package/cjs/loosely-validate-event` | 1 | 89.94 | 28.39% | 99.96% |
| `package/esm/loosely-validate-event` | 1 | 89.94 | 28.39% | 99.96% |
| `package` | 5 | 18.64 | 2.46% | 6.0% |
| `package/types` | 2 | 8.18 | 14.71% | 95.81% |
| `package/types/loosely-validate-event` | 1 | 1.62 | 0.0% | 0.0% |

## 10. TARGETED RISK VECTORS (Top 5 by Exposure)
### Highest Tech Debt (Fragile/Planned)
- `package/cjs/loosely-validate-event/index.js` -> **99.9626%** Exposure
- `package/esm/loosely-validate-event/index.js` -> **99.9626%** Exposure
...
- `package/cjs/loosely-validate-event/index.js` -> **0** Orphaned Functions | **3** Duplicates
- `package/esm/loosely-validate-event/index.js` -> **0** Orphaned Functions | **3** Duplicates
...
### 1. `package/types/Logger.d.ts` (TYPESCRIPT) -> Cumulative Risk: **487.69**
...
### 2. `package/types/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **455.74**
- **Archetype:** `file_cluster_8` (Distance: 10.99 IQR)
- **Magnitude:** 7.12 | **LOC:** 254 | **CtrlFlow:** 87.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.2151%), Safety Score (80.0%), Verification (80.0%)
- **Heaviest Functions:** `constructor` (Impact: 18.1), `createPersistenceQueue` (Impact: 9.6), `group` (Impact: 7.5)

### 3. `package/cjs/loosely-validate-event/index.js` (JAVASCRIPT) -> Cumulative Risk: **444.8**
- **Archetype:** `file_cluster_13` (Distance: 12.149 IQR)
- **Magnitude:** 89.94 | **LOC:** 107 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9894%), Tech Debt (99.9626%), Stability (50.0%)
- **Heaviest Functions:** `looselyValidateEvent` (Impact: 18.4), `assert` (Impact: 9.8), `validateGenericEvent` (Impact: 7.8)

### 4. `package/esm/loosely-validate-event/index.js` (JAVASCRIPT) -> Cumulative Risk: **444.8**
- **Archetype:** `file_cluster_13` (Distance: 12.149 IQR)
- **Magnitude:** 89.94 | **LOC:** 107 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9894%), Tech Debt (99.9626%), Stability (50.0%)
- **Heaviest Functions:** `looselyValidateEvent` (Impact: 18.4), `assert` (Impact: 9.8), `validateGenericEvent` (Impact: 7.8)

### 5. `package/cjs/Logger.js` (JAVASCRIPT) -> Cumulative Risk: **433.23**
- **Archetype:** `file_cluster_8` (Distance: 14.229 IQR)
- **Magnitude:** 124.64 | **LOC:** 89 | **CtrlFlow:** 34.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.4716%), Cognitive Load (65.74%)
- **Heaviest Functions:** `formatLogData` (Impact: 9.6), `log` (Impact: 3.8), `info` (Impact: 3.8)

### 6. `package/esm/Logger.js` (JAVASCRIPT) -> Cumulative Risk: **433.23**
- **Archetype:** `file_cluster_8` (Distance: 14.229 IQR)
- **Magnitude:** 124.64 | **LOC:** 89 | **CtrlFlow:** 34.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.4716%), Cognitive Load (65.74%)
- **Heaviest Functions:** `formatLogData` (Impact: 9.6), `log` (Impact: 3.8), `info` (Impact: 3.8)

### 7. `package/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **252.33**
- **Archetype:** `file_cluster_8` (Distance: 10.69 IQR)
- **Magnitude:** 2.06 | **LOC:** 304 | **CtrlFlow:** 74.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Tech Debt (30.004%), Safety Score (22.9588%)
- **Heaviest Functions:** `createPersistenceQueue` (Impact: 10.8), `flush` (Impact: 4.4)

### 8. `package/types/loosely-validate-event/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **152.42**
- **Archetype:** `file_cluster_8` (Distance: 13.857 IQR)
- **Magnitude:** 1.62 | **LOC:** 6 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (80.0%), Stability (50.0%), Spec Match (13.3333%), Api Exposure (5.7813%)
...
- **Global Archetype:** `file_cluster_13` (Drift: 12.149 IQR)
- **Local Micro-Species:** `Cluster 4: Heavily Documented Core Functions` (Drift: 4.81 IQR)
- **Top Global Matches:** file_cluster_13: 12.149, file_cluster_8: 12.191, file_cluster_17: 12.504
- **Magnitude:** 89.94 | **LOC:** 107 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (28.3881%), Tech Debt (99.9626%)
**Top Internal Functions/Classes:**
  * `looselyValidateEvent` (Impact: 18.4)
  * `assert` (Impact: 9.8)
  * `validateGenericEvent` (Impact: 7.8)
    * *Intent:* /** * Validation rules. */
  * `assert` (Impact: 7.5)
  * `validateTrackEvent` (Impact: 3.7)
    * *Intent:* /**
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 17`, `structural_boundaries: 17`, `args: 9`, `func_start: 22`
* *Risk/State:* `state_mutation: 22`, `duplicate_logic: 3`
...
**Top Internal Functions/Classes:**
  * `constructor` (Impact: 18.1)
    * *Intent:* /**
  * `createPersistenceQueue` (Impact: 9.6)
  * `group` (Impact: 7.5)
  ...
  * `page` (Impact: 7.5)
    * *Intent:* * { * queueName: string = rudderEventsQueue, * prefix: string = rudder * isMultiProcessor: booloean ...
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `createPersistenceQueue` (Impact: 10.8)
  * `flush` (Impact: 4.4)
    * *Intent:* /**
**Structural Signatures (Net Mitigated Signals):**
...
- `package/cjs/loosely-validate-event/index.js` (JAVASCRIPT) | Magnitude: 89.94 | Delta: **0.042 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 53, func_start: 22, state_mutation: 22, branch: 17
- `package/esm/loosely-validate-event/index.js` (JAVASCRIPT) | Magnitude: 89.94 | Delta: **0.042 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 53, func_start: 22, state_mutation: 22, branch: 17

### Mixed-Responsibility Refactoring Targets for: file_cluster_8
- `package/cjs/Logger.js` (JAVASCRIPT) | Magnitude: 124.64 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_12`
  * Top Architectural Signatures: state_mutation: 86, indent_spaces: 69, structural_boundaries: 21, reflection_metaprogramming: 13
- `package/esm/Logger.js` (JAVASCRIPT) | Magnitude: 124.64 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_12`
  * Top Architectural Signatures: state_mutation: 86, indent_spaces: 69, structural_boundaries: 21, reflection_metaprogramming: 13
...
- `package/types/index.d.ts` (TYPESCRIPT) | Magnitude: 7.12 | Delta: **0.171 IQR** | Secondary Pull: `file_cluster_7`
  * Top Architectural Signatures: indent_spaces: 104, doc: 78, branch: 55, safety_bypasses: 20
- `package/index.d.ts` (TYPESCRIPT) | Magnitude: 2.06 | Delta: **0.193 IQR** | Secondary Pull: `file_cluster_7`
...
- `package/types/Logger.d.ts` -> **Severity: 2116.483** (Blast Radius: 83.333 * Doc Risk: 25.3979%)
- `package/cjs/Logger.js` -> **Severity: 1197.229** (Blast Radius: 83.333 * Doc Risk: 14.3668%)
- `package/esm/Logger.js` -> **Severity: 1197.229** (Blast Radius: 83.333 * Doc Risk: 14.3668%)
- `package/cjs/loosely-validate-event/index.js` -> **Severity: 993.354** (Blast Radius: 83.333 * Doc Risk: 11.9203%)
- `package/esm/loosely-validate-event/index.js` -> **Severity: 993.354** (Blast Radius: 83.333 * Doc Risk: 11.9203%)
