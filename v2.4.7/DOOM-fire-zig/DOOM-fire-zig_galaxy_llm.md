...
| **Timestamp** | `2026-08-07T04:29:06.979568+00:00` |
| **Scan Duration** | `0.14s` |
| **Git Branch** | `master` |
...
| Error & Exception Exposure | 40.6 | 40.6 | 40.6 | 40.6 | 40.6 |
...
| Documentation Exposure | 41.0 | 41.0 | 41.0 | 41.0 | 41.0 |
...
- `checkTermSz` (@ `src/main.zig`) -> Impact: **184.5** | LOC: 470
...
- `emit` (@ `src/main.zig`) -> Impact: **20.9** | LOC: 17
  * *Intent:* // print
- `pause` (@ `src/main.zig`) -> Impact: **8.7** | LOC: 14
  * *Intent:* ///////////////// // doom-fire /////////////////
...
- `initRNG` (@ `src/main.zig`) -> Impact: **3.5** | LOC: 9
  * *Intent:* //// functions // seed & prep for rng

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `src` | 1 | 427.84 | 31.14% | 14.39% |
...
### 1. `src/main.zig` (ZIG) -> Cumulative Risk: **327.26**
- **Archetype:** `file_cluster_11` (Distance: 14.046 IQR)
- **Magnitude:** 427.84 | **LOC:** 954 | **CtrlFlow:** 76.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (80.4743%), Documentation (40.9759%), Safety Score (40.6461%)
- **Heaviest Functions:** `checkTermSz` (Impact: 184.5), `emit` (Impact: 20.9), `pause` (Impact: 8.7)
...
- `src/main.zig` (ZIG) | Magnitude: 427.84 | Delta: **0.027 IQR** | Secondary Pull: `file_cluster_0`
...
- `src/main.zig` -> **Severity: 13658.62** (Blast Radius: 333.333 * Doc Risk: 40.9759%)
