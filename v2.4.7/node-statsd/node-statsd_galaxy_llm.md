...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/node-statsd` |
| **Timestamp** | `2026-08-07T05:16:05.572614+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Magnitude:** 11.52 | **LOC:** 1 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- `package/index.js` -> **Severity: 264.9** (Blast Radius: 333.333 * Doc Risk: 0.7947%)
