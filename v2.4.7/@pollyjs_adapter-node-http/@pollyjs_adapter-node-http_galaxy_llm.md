...
| **Timestamp** | `2026-08-07T05:12:43.454698+00:00` |
| **Scan Duration** | `0.08s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- `urlToOptions` (@ `package/src/utils/url-to-options.js`) -> Impact: **13.3** | LOC: 24
...
- `mergeChunks` (@ `package/src/utils/merge-chunks.js`) -> Impact: **7.6** | LOC: 14
  * *Intent:* /**
- `setupNock` (@ `package/src/index.js`) -> Impact: **5.4** | LOC: 24
- `resolve` (@ `package/src/index.js`) -> Impact: **2.3** | LOC: 6
...
|---|---|---|---|---|
| `package/src` | 1 | 50.1 | 20.46% | 90.35% |
| `package/src/utils` | 3 | 28.18 | 11.44% | 32.9% |
...
### 1. `package/src/index.js` (JAVASCRIPT) -> Cumulative Risk: **424.9**
- **Archetype:** `file_cluster_13` (Distance: 9.861 IQR)
- **Magnitude:** 50.1 | **LOC:** 338 | **CtrlFlow:** 29.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (90.351%), Safety Score (58.7777%), State Flux (50.8946%)
- **Heaviest Functions:** `getChunksFromBody` (Impact: 11.1), `getBodyFromChunks` (Impact: 10.4), `setupNock` (Impact: 5.4)

### 2. `package/src/utils/get-url-from-options.js` (JAVASCRIPT) -> Cumulative Risk: **296.74**
- **Archetype:** `file_cluster_8` (Distance: 10.468 IQR)
- **Magnitude:** 2.54 | **LOC:** 35 | **CtrlFlow:** 75.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (98.6851%), Stability (50.0%), Documentation (23.6877%)
- **Heaviest Functions:** `getUrlFromOptions` (Impact: 1.1)

### 3. `package/src/utils/url-to-options.js` (JAVASCRIPT) -> Cumulative Risk: **224.86**
- **Archetype:** `file_cluster_8` (Distance: 8.479 IQR)
- **Magnitude:** 15.86 | **LOC:** 32 | **CtrlFlow:** 77.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (58.0035%), Stability (50.0%), Cognitive Load (11.1595%)
- **Heaviest Functions:** `urlToOptions` (Impact: 13.3)

### 4. `package/src/utils/merge-chunks.js` (JAVASCRIPT) -> Cumulative Risk: **156.53**
- **Archetype:** `file_cluster_8` (Distance: 10.206 IQR)
- **Magnitude:** 9.78 | **LOC:** 23 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (60.0%), Stability (50.0%), Documentation (32.9106%), Api Exposure (6.9137%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 3):` merge-chunks, nock, get-url-from-options, url, http, common, adapter, url-to-options...
...
- `package/src/index.js` (JAVASCRIPT) | Magnitude: 50.1 | Delta: **0.384 IQR** | Secondary Pull: `file_cluster_8`
...
- `package/src/utils/url-to-options.js` (JAVASCRIPT) | Magnitude: 15.86 | Delta: **0.658 IQR** | Secondary Pull: `file_cluster_7`
...
- `package/src/utils/url-to-options.js` -> **Severity: 9482.528** (Blast Radius: 163.482 * Doc Risk: 58.0035%)
- `package/src/utils/merge-chunks.js` -> **Severity: 5380.291** (Blast Radius: 163.482 * Doc Risk: 32.9106%)
- `package/src/utils/get-url-from-options.js` -> **Severity: 3872.513** (Blast Radius: 163.482 * Doc Risk: 23.6877%)
