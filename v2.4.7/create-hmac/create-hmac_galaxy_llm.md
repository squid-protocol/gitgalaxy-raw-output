...
| **Timestamp** | `2026-08-07T05:14:25.984576+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 0.0 | 96.7 | 63.8 | 94.7 | 94.7 |
...
### 1. `package/browser.js` (JAVASCRIPT) -> Cumulative Risk: **552.57**
- **Archetype:** `file_cluster_13` (Distance: 14.896 IQR)
- **Magnitude:** 97.72 | **LOC:** 63 | **CtrlFlow:** 40.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (98.7417%), Safety Score (94.6508%)
- **Heaviest Functions:** `Hmac` (Impact: 18.7), `createHmac` (Impact: 7.4), `_final` (Impact: 3.7)

### 2. `package/legacy.js` (JAVASCRIPT) -> Cumulative Risk: **460.91**
- **Archetype:** `file_cluster_13` (Distance: 13.711 IQR)
- **Magnitude:** 61.1 | **LOC:** 47 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.7476%), Cognitive Load (92.5137%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` safe-buffer, inherits, md5, cipher-base, sha.js, ripemd160, legacy
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` safe-buffer, cipher-base, inherits
...
- `package/legacy.js` -> **Severity: 24.187** (Embedded: 0.25 * Error Risk: 96.7476%)
