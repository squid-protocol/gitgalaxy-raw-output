# ARCHITECTURAL_BRIEF: prosemirror-trailing-node
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/prosemirror-trailing-node` |
| **Timestamp** | `2026-08-07T05:16:24.187110+00:00` |
| **Scan Duration** | `0.06s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
1. **package.json** (`package/package.json`) — 0 inbound connections
2. **readme.md** (`package/readme.md`) — 0 inbound connections

### Top 5 Orchestrators (Highest 'Imports' / Fragility Index)
These files pull in the most external dependencies. They are highly coupled and fragile to API changes.

1. **package.json** (`package/package.json`) — 0 outbound dependencies
...
### 1. `package/package.json` (PLAINTEXT) -> Cumulative Risk: **0.0**
