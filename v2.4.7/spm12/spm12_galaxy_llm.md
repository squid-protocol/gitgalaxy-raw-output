...
| **Timestamp** | `2026-08-07T05:37:29.062950+00:00` |
| **Scan Duration** | `11.5s` |
| **Git Branch** | `main` |
...
| file_cluster_17 | 1426 | 33.8% |
| file_cluster_9 | 156 | 3.7% |
| file_cluster_13 | 61 | 1.4% |
| file_cluster_11 | 57 | 1.4% |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 0.0 | 100.0 | 60.9 | 75.5 | 5.0 |
| Error & Exception Exposure | 0.0 | 100.0 | 92.8 | 97.5 | 0.0 |
| Tech Debt Exposure | 0.0 | 100.0 | 30.4 | 0.0 | 0.0 |
| Testing Exposure | 0.0 | 80.0 | 4.4 | 2.3 | 2.3 |
...
| Documentation Exposure | 0.0 | 100.0 | 21.7 | 13.5 | 11.9 |
...
- `cdfbin` (@ `@nifti/private/nifti_stats.c`) -> Impact: **360.5** | LOC: 253
- `serialize_jsonld` (@ `spm_provenance.m`) -> Impact: **356.9** | LOC: 579
- `cdfbet` (@ `@nifti/private/nifti_stats.c`) -> Impact: **344.5** | LOC: 250
- `cdfnbn` (@ `@nifti/private/nifti_stats.c`) -> Impact: **344.3** | LOC: 246
- `mrqcof` (@ `src/spm_brainwarp.c`) -> Impact: **344.0** | LOC: 316
- `E0000` (@ `@nifti/private/nifti_stats.c`) -> Impact: **315.4** | LOC: 172
- `bratio` (@ `@nifti/private/nifti_stats.c`) -> Impact: **280.8** | LOC: 186
- `cdff` (@ `@nifti/private/nifti_stats.c`) -> Impact: **259.2** | LOC: 205
- `cdffnc` (@ `@nifti/private/nifti_stats.c`) -> Impact: **237.7** | LOC: 201
  * *Intent:* #undef atol #undef tol #undef zero #undef inf #undef one } /* END */ /***=====================================================================***/
- `E0001` (@ `@nifti/private/nifti_stats.c`) -> Impact: **234.5** | LOC: 147

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `__monolith__` | 741 | 156477.2 | 66.96% | 26.66% |
| `toolbox/DEM` | 264 | 34357.53 | 53.0% | 31.17% |
| `src` | 72 | 31119.52 | 54.77% | 22.65% |
| `config` | 117 | 20600.64 | 45.64% | 52.47% |
| `toolbox/dcm_meeg` | 107 | 14575.85 | 60.69% | 51.22% |
| `toolbox/FieldMap` | 37 | 11424.9 | 61.81% | 21.51% |
| `@nifti/private` | 21 | 11220.73 | 66.06% | 33.93% |
| `toolbox/MEEGtools` | 30 | 9403.12 | 74.03% | 35.56% |
| `toolbox/DAiSS` | 74 | 8958.84 | 56.72% | 46.49% |
| `toolbox/mci/inference` | 43 | 7881.81 | 62.94% | 15.12% |
...
- `tests/test_spm_cat_struct.m` -> **6** Orphaned Functions | **0** Duplicates
...
268. **`bin/spm12-matlab`** -> AI Confidence: **99.29%**
269. **`bin/spm12-mcr`** -> AI Confidence: **99.29%**
270. **`src/spm_mesh_reduce.cpp`** -> AI Confidence: **99.29%**
271. **`external/fieldtrip/src/read_24bit.c`** -> AI Confidence: **99.23%**
272. **`src/spm_mex.h`** -> AI Confidence: **99.23%**
273. **`external/fieldtrip/src/compiler.h`** -> AI Confidence: **99.23%**
274. **`src/shoot_multiscale.c`** -> AI Confidence: **99.2%**
275. **`src/spm_cat.c`** -> AI Confidence: **99.2%**
276. **`@file_array/file_array.m`** -> AI Confidence: **99.17%**
277. **`@file_array/private/fname.m`** -> AI Confidence: **99.17%**
278. **`@file_array/private/permission.m`** -> AI Confidence: **99.17%**
279. **`@file_array/private/scl_inter.m`** -> AI Confidence: **99.17%**
280. **`@file_array/private/scl_slope.m`** -> AI Confidence: **99.17%**
281. **`@file_array/reshape.m`** -> AI Confidence: **99.17%**
282. **`@gifti/gifti.m`** -> AI Confidence: **99.17%**
283. **`@gifti/private/read_freesurfer_file.m`** -> AI Confidence: **99.17%**
284. **`@gifti/private/zstream.m`** -> AI Confidence: **99.17%**
285. **`@meeg/fiducials.m`** -> AI Confidence: **99.17%**
286. **`@meeg/meeg.m`** -> AI Confidence: **99.17%**
287. **`@meeg/montage.m`** -> AI Confidence: **99.17%**
288. **`@meeg/save.m`** -> AI Confidence: **99.17%**
289. **`@meeg/transformtype.m`** -> AI Confidence: **99.17%**
290. **`@meeg/type.m`** -> AI Confidence: **99.17%**
291. **`@nifti/private/M2Q.m`** -> AI Confidence: **99.17%**
292. **`@slover/private/mars_struct.m`** -> AI Confidence: **99.17%**
293. **`@xmltree/private/xml_findstr.m`** -> AI Confidence: **99.17%**
294. **`@xmltree/save.m`** -> AI Confidence: **99.17%**
295. **`@xmltree/xmltree.m`** -> AI Confidence: **99.17%**
296. **`compat/spm_resss.m`** -> AI Confidence: **99.17%**
297. **`config/spm_cfg_dcm_est.m`** -> AI Confidence: **99.17%**
298. **`config/spm_cfg_eeg_channel_selector.m`** -> AI Confidence: **99.17%**
299. **`config/spm_cfg_eeg_dipfit.m`** -> AI Confidence: **99.17%**
300. **`config/spm_cfg_eeg_inv_headmodelhelmet.m`** -> AI Confidence: **99.17%**
301. **`config/spm_cfg_eeg_inv_post.m`** -> AI Confidence: **99.17%**
302. **`config/spm_cfg_eeg_momentfit.m`** -> AI Confidence: **99.17%**
303. **`config/spm_cfg_eeg_spatial_confounds.m`** -> AI Confidence: **99.17%**
304. **`config/spm_cfg_eeg_tf_rescale.m`** -> AI Confidence: **99.17%**
305. **`config/spm_cfg_imcalc.m`** -> AI Confidence: **99.17%**
306. **`config/spm_cfg_minc.m`** -> AI Confidence: **99.17%**
307. **`config/spm_run_results.m`** -> AI Confidence: **99.17%**
308. **`external/fieldtrip/besa2fieldtrip.m`** -> AI Confidence: **99.17%**
309. **`external/fieldtrip/connectivity/ft_connectivity_mim.m`** -> AI Confidence: **99.17%**
310. **`external/fieldtrip/connectivity/private/ft_platform_supports.m`** -> AI Confidence: **99.17%**
311. **`external/fieldtrip/connectivity/private/ft_warning.m`** -> AI Confidence: **99.17%**
312. **`external/fieldtrip/connectivity/private/istrue.m`** -> AI Confidence: **99.17%**
313. **`external/fieldtrip/external/images/rgb2hsv.m`** -> AI Confidence: **99.17%**
314. **`external/fieldtrip/external/signal/butter.m`** -> AI Confidence: **99.17%**
315. **`external/fieldtrip/external/signal/private/bilinear.m`** -> AI Confidence: **99.17%**
316. **`external/fieldtrip/external/signal/triang.m`** -> AI Confidence: **99.17%**
317. **`external/fieldtrip/external/stats/betapdf.m`** -> AI Confidence: **99.17%**
318. **`external/fieldtrip/fileio/ft_chantype.m`** -> AI Confidence: **99.17%**
319. **`external/fieldtrip/fileio/ft_flush_data.m`** -> AI Confidence: **99.17%**
320. **`external/fieldtrip/fileio/ft_flush_event.m`** -> AI Confidence: **99.17%**
321. **`external/fieldtrip/fileio/ft_flush_header.m`** -> AI Confidence: **99.17%**
322. **`external/fieldtrip/fileio/ft_write_mri.m`** -> AI Confidence: **99.17%**
323. **`external/fieldtrip/fileio/ft_write_sens.m`** -> AI Confidence: **99.17%**
324. **`external/fieldtrip/fileio/private/bounding_mesh.m`** -> AI Confidence: **99.17%**
325. **`external/fieldtrip/fileio/private/cstructdecode.m`** -> AI Confidence: **99.17%**
326. **`external/fieldtrip/fileio/private/db_select.m`** -> AI Confidence: **99.17%**
327. **`external/fieldtrip/fileio/private/decode_nifti1.m`** -> AI Confidence: **99.17%**
328. **`external/fieldtrip/fileio/private/fixdimord.m`** -> AI Confidence: **99.17%**
329. **`external/fieldtrip/fileio/private/ft_convert_units.m`** -> AI Confidence: **99.17%**
330. **`external/fieldtrip/fileio/private/ft_datatype_headmodel.m`** -> AI Confidence: **99.17%**
331. **`external/fieldtrip/fileio/private/ft_datatype_sens.m`** -> AI Confidence: **99.17%**
332. **`external/fieldtrip/fileio/private/ft_estimate_units.m`** -> AI Confidence: **99.17%**
333. **`external/fieldtrip/fileio/private/ft_headcoordinates.m`** -> AI Confidence: **99.17%**
334. **`external/fieldtrip/fileio/private/ft_headmodeltype.m`** -> AI Confidence: **99.17%**
335. **`external/fieldtrip/fileio/private/ft_platform_supports.m`** -> AI Confidence: **99.17%**
336. **`external/fieldtrip/fileio/private/ft_warning.m`** -> AI Confidence: **99.17%**
337. **`external/fieldtrip/fileio/private/getdimord.m`** -> AI Confidence: **99.17%**
338. **`external/fieldtrip/fileio/private/hasyokogawa.m`** -> AI Confidence: **99.17%**
339. **`external/fieldtrip/fileio/private/istrue.m`** -> AI Confidence: **99.17%**
340. **`external/fieldtrip/fileio/private/loadvar.m`** -> AI Confidence: **99.17%**
341. **`external/fieldtrip/fileio/private/neuralynx_timestamp.m`** -> AI Confidence: **99.17%**
342. **`external/fieldtrip/fileio/private/normals.m`** -> AI Confidence: **99.17%**
343. **`external/fieldtrip/fileio/private/np_readdata.m`** -> AI Confidence: **99.17%**
344. **`external/fieldtrip/fileio/private/read_asa_bnd.m`** -> AI Confidence: **99.17%**
345. **`external/fieldtrip/fileio/private/read_asa_elc.m`** -> AI Confidence: **99.17%**
346. **`external/fieldtrip/fileio/private/read_asa_mri.m`** -> AI Confidence: **99.17%**
347. **`external/fieldtrip/fileio/private/read_asa_msr.m`** -> AI Confidence: **99.17%**
348. **`external/fieldtrip/fileio/private/read_biff.m`** -> AI Confidence: **99.17%**
349. **`external/fieldtrip/fileio/private/read_eyelink_asc.m`** -> AI Confidence: **99.17%**
350. **`external/fieldtrip/fileio/private/read_micromed_event.m`** -> AI Confidence: **99.17%**
351. **`external/fieldtrip/fileio/private/read_micromed_trc.m`** -> AI Confidence: **99.17%**
352. **`external/fieldtrip/fileio/private/read_neuralynx_nts.m`** -> AI Confidence: **99.17%**
353. **`external/fieldtrip/fileio/private/read_neuromag_hc.m`** -> AI Confidence: **99.17%**
354. **`external/fieldtrip/fileio/private/read_neuroshare.m`** -> AI Confidence: **99.17%**
355. **`external/fieldtrip/fileio/private/read_nifti2_hdr.m`** -> AI Confidence: **99.17%**
356. **`external/fieldtrip/fileio/private/read_tdt_sev.m`** -> AI Confidence: **99.17%**
357. **`external/fieldtrip/fileio/private/read_tdt_tev.m`** -> AI Confidence: **99.17%**
358. **`external/fieldtrip/fileio/private/timestamp_neuralynx.m`** -> AI Confidence: **99.17%**
359. **`external/fieldtrip/fileio/private/write_gdf.m`** -> AI Confidence: **99.17%**
360. **`external/fieldtrip/fileio/private/write_ply.m`** -> AI Confidence: **99.17%**
361. **`external/fieldtrip/fileio/private/write_vtk.m`** -> AI Confidence: **99.17%**
362. **`external/fieldtrip/forward/ft_convert_units.m`** -> AI Confidence: **99.17%**
363. **`external/fieldtrip/forward/ft_estimate_units.m`** -> AI Confidence: **99.17%**
364. **`external/fieldtrip/forward/ft_headmodel_openmeeg.m`** -> AI Confidence: **99.17%**
365. **`external/fieldtrip/forward/ft_headmodel_singleshell.m`** -> AI Confidence: **99.17%**
366. **`external/fieldtrip/forward/ft_headmodeltype.m`** -> AI Confidence: **99.17%**
367. **`external/fieldtrip/forward/private/bounding_mesh.m`** -> AI Confidence: **99.17%**
368. **`external/fieldtrip/forward/private/eeg_leadfield4.m`** -> AI Confidence: **99.17%**
369. **`external/fieldtrip/forward/private/ft_datatype_headmodel.m`** -> AI Confidence: **99.17%**
370. **`external/fieldtrip/forward/private/ft_datatype_sens.m`** -> AI Confidence: **99.17%**
371. **`external/fieldtrip/forward/private/ft_headcoordinates.m`** -> AI Confidence: **99.17%**
372. **`external/fieldtrip/forward/private/ft_platform_supports.m`** -> AI Confidence: **99.17%**
373. **`external/fieldtrip/forward/private/ft_warning.m`** -> AI Confidence: **99.17%**
374. **`external/fieldtrip/forward/private/getdimord.m`** -> AI Confidence: **99.17%**
375. **`external/fieldtrip/forward/private/hasyokogawa.m`** -> AI Confidence: **99.17%**
376. **`external/fieldtrip/forward/private/headsurface.m`** -> AI Confidence: **99.17%**
377. **`external/fieldtrip/forward/private/istrue.m`** -> AI Confidence: **99.17%**
378. **`external/fieldtrip/forward/private/mesh2edge.m`** -> AI Confidence: **99.17%**
379. **`external/fieldtrip/forward/private/normals.m`** -> AI Confidence: **99.17%**
380. **`external/fieldtrip/forward/private/surfaceorientation.m`** -> AI Confidence: **99.17%**
381. **`external/fieldtrip/ft_appendfreq.m`** -> AI Confidence: **99.17%**
382. **`external/fieldtrip/ft_connectivityanalysis.m`** -> AI Confidence: **99.17%**
383. **`external/fieldtrip/ft_denoise_dssp.m`** -> AI Confidence: **99.17%**
384. **`external/fieldtrip/ft_freqsimulation.m`** -> AI Confidence: **99.17%**
385. **`external/fieldtrip/ft_meshrealign.m`** -> AI Confidence: **99.17%**
386. **`external/fieldtrip/ft_prepare_mesh.m`** -> AI Confidence: **99.17%**
387. **`external/fieldtrip/ft_singleplotTFR.m`** -> AI Confidence: **99.17%**
388. **`external/fieldtrip/ft_sourceanalysis.m`** -> AI Confidence: **99.17%**
389. **`external/fieldtrip/ft_sourcedescriptives.m`** -> AI Confidence: **99.17%**
390. **`external/fieldtrip/ft_sourceplot.m`** -> AI Confidence: **99.17%**
391. **`external/fieldtrip/ft_statistics_montecarlo.m`** -> AI Confidence: **99.17%**
392. **`external/fieldtrip/ft_statistics_stats.m`** -> AI Confidence: **99.17%**
393. **`external/fieldtrip/ft_volumerealign.m`** -> AI Confidence: **99.17%**
394. **`external/fieldtrip/ft_volumewrite.m`** -> AI Confidence: **99.17%**
395. **`external/fieldtrip/inverse/private/SAM_costfun.m`** -> AI Confidence: **99.17%**
396. **`external/fieldtrip/inverse/private/bounding_mesh.m`** -> AI Confidence: **99.17%**
397. **`external/fieldtrip/inverse/private/calctangent.m`** -> AI Confidence: **99.17%**
398. **`external/fieldtrip/inverse/private/fixdipole.m`** -> AI Confidence: **99.17%**
399. **`external/fieldtrip/inverse/private/ft_headmodeltype.m`** -> AI Confidence: **99.17%**
400. **`external/fieldtrip/inverse/private/ft_inv.m`** -> AI Confidence: **99.17%**
401. **`external/fieldtrip/inverse/private/ft_platform_supports.m`** -> AI Confidence: **99.17%**
402. **`external/fieldtrip/inverse/private/ft_warning.m`** -> AI Confidence: **99.17%**
403. **`external/fieldtrip/inverse/private/hasyokogawa.m`** -> AI Confidence: **99.17%**
404. **`external/fieldtrip/inverse/private/headsurface.m`** -> AI Confidence: **99.17%**
405. **`external/fieldtrip/plotting/ft_plot_axes.m`** -> AI Confidence: **99.17%**
406. **`external/fieldtrip/plotting/ft_plot_crosshair.m`** -> AI Confidence: **99.17%**
407. **`external/fieldtrip/plotting/ft_plot_mesh.m`** -> AI Confidence: **99.17%**
408. **`external/fieldtrip/plotting/ft_plot_montage.m`** -> AI Confidence: **99.17%**
409. **`external/fieldtrip/plotting/private/ft_convert_units.m`** -> AI Confidence: **99.17%**
410. **`external/fieldtrip/plotting/private/ft_datatype_sens.m`** -> AI Confidence: **99.17%**
411. **`external/fieldtrip/plotting/private/ft_estimate_units.m`** -> AI Confidence: **99.17%**
412. **`external/fieldtrip/plotting/private/ft_headmodeltype.m`** -> AI Confidence: **99.17%**
413. **`external/fieldtrip/plotting/private/ft_platform_supports.m`** -> AI Confidence: **99.17%**
414. **`external/fieldtrip/plotting/private/ft_warning.m`** -> AI Confidence: **99.17%**
415. **`external/fieldtrip/plotting/private/headsurface.m`** -> AI Confidence: **99.17%**
416. **`external/fieldtrip/plotting/private/istrue.m`** -> AI Confidence: **99.17%**
417. **`external/fieldtrip/plotting/private/mesh2edge.m`** -> AI Confidence: **99.17%**
...
### 1. `matlabbatch/cfg_basicio/cfg_vout_runjobs.m` (MATLAB) -> Cumulative Risk: **679.47**
- **Archetype:** `file_cluster_4` (Distance: 17.959 IQR)
- **Magnitude:** 34.52 | **LOC:** 29 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.999%)
- **Heaviest Functions:** `cfg_vout_runjobs` (Impact: 3.2)

### 2. `@xmltree/private/xml_findstr.c` (C) -> Cumulative Risk: **672.21**
- **Archetype:** `file_cluster_8` (Distance: 13.626 IQR)
- **Magnitude:** 177.66 | **LOC:** 111 | **CtrlFlow:** 96.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.4022%), Tech Debt (98.3978%)
- **Heaviest Functions:** `mexFunction` (Impact: 71.3)

### 3. `external/fieldtrip/src/ft_getopt.c` (C) -> Cumulative Risk: **657.82**
- **Archetype:** `file_cluster_13` (Distance: 14.655 IQR)
- **Magnitude:** 0.15 | **LOC:** 127 | **CtrlFlow:** 94.3% | **Authorship Centralization:** 0.0%
...
### 4. `@gifti/private/zstream.c` (C) -> Cumulative Risk: **622.91**
- **Archetype:** `file_cluster_13` (Distance: 12.573 IQR)
- **Magnitude:** 96.32 | **LOC:** 87 | **CtrlFlow:** 95.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (95.265%), Safety Score (91.6181%)
- **Heaviest Functions:** `mexFunction` (Impact: 50.3)

### 5. `src/spm_hist2.c` (C) -> Cumulative Risk: **616.5**
- **Archetype:** `file_cluster_13` (Distance: 12.126 IQR)
- **Magnitude:** 84.24 | **LOC:** 53 | **CtrlFlow:** 95.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (92.0369%), Cognitive Load (90.1696%)
- **Heaviest Functions:** `mexFunction` (Impact: 53.5)

### 6. `matlabbatch/@cfg_item/showdoc.m` (MATLAB) -> Cumulative Risk: **615.76**
- **Archetype:** `file_cluster_17` (Distance: 21.864 IQR)
- **Magnitude:** 22.7 | **LOC:** 31 | **CtrlFlow:** 44.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9996%), Cognitive Load (97.6645%)
- **Heaviest Functions:** `showdoc` (Impact: 4.4)

### 7. `src/spm_brainwarp.c` (C) -> Cumulative Risk: **611.26**
- **Archetype:** `file_cluster_8` (Distance: 14.495 IQR)
- **Magnitude:** 1265.02 | **LOC:** 688 | **CtrlFlow:** 95.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.9496%), Documentation (84.2994%)
- **Heaviest Functions:** `mrqcof` (Impact: 344.0), `mexFunction` (Impact: 115.3), `matmul` (Impact: 11.2)

### 8. `external/fieldtrip/src/solid_angle.c` (C) -> Cumulative Risk: **610.14**
- **Archetype:** `file_cluster_13` (Distance: 13.451 IQR)
- **Magnitude:** 0.14 | **LOC:** 69 | **CtrlFlow:** 90.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.3434%), Documentation (86.839%)
- **Heaviest Functions:** `mexFunction` (Impact: 50.1)

### 9. `src/spm_dilate_erode.c` (C) -> Cumulative Risk: **608.1**
- **Archetype:** `file_cluster_13` (Distance: 13.94 IQR)
- **Magnitude:** 310.28 | **LOC:** 177 | **CtrlFlow:** 92.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (99.796%), Safety Score (99.483%)
- **Heaviest Functions:** `mexFunction` (Impact: 64.8), `do_it` (Impact: 34.3), `get_index` (Impact: 8.5)

### 10. `matlabbatch/@cfg_choice/showmydoc.m` (MATLAB) -> Cumulative Risk: **602.87**
- **Archetype:** `file_cluster_17` (Distance: 20.64 IQR)
- **Magnitude:** 25.04 | **LOC:** 32 | **CtrlFlow:** 60.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9978%), Safety Score (97.5809%)
- **Heaviest Functions:** `showmydoc` (Impact: 2.7)
...
- **Magnitude:** 9501.36 | **LOC:** 11278 | **CtrlFlow:** 80.7% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` string.h, stdio.h, ctype.h, stdlib.h, math.h, nifti1.h
...
- **Global Archetype:** `file_cluster_8` (Drift: 14.564 IQR)
- **Local Micro-Species:** `Cluster 2: Inert Headers & Declarative Structures` (Drift: 3.677 IQR)
- **Top Global Matches:** file_cluster_8: 14.564, file_cluster_13: 14.811, file_cluster_7: 14.884
- **Magnitude:** 2495.1 | **LOC:** 1565 | **CtrlFlow:** 86.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (64.6703%), Tech Debt (9.0367%)
**Top Internal Functions/Classes:**
  * `dartel_mexFunction` (Impact: 50.5)
  * `exp_mexFunction` (Impact: 26.4)
  * `unwrap` (Impact: 24.6)
  * `iteration` (Impact: 21.6)
  * `smalldef_objfun_mn` (Impact: 21.5)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 191`, `structural_boundaries: 29`, `args: 3`, `func_start: 20`
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.234
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 4):` shoot_boundary.h, stdio.h, shoot_regularisers.h, shoot_optim3d.h, math.h, shoot_diffeo3d.h, mex.h
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Local Micro-Species:** `Cluster 2: Inert Headers & Declarative Structures` (Drift: 5.106 IQR)
- **Top Global Matches:** file_cluster_8: 13.986, file_cluster_13: 14.154, file_cluster_7: 14.313
- **Magnitude:** 2197.92 | **LOC:** 1180 | **CtrlFlow:** 93.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (86.5705%), Tech Debt (8.6936%)
**Top Internal Functions/Classes:**
  * `mexFunction` (Impact: 173.5)
  * `comp_mexFunction` (Impact: 98.8)
  * `pushc_grads_mexFunction` (Impact: 87.1)
  * `fmg3_mexFunction` (Impact: 85.2)
  * `push_mexFunction` (Impact: 69.4)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 469`, `structural_boundaries: 33`, `args: 23`, `func_start: 24`
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.234
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 8):` spm_openmp.h, shoot_dartel.h, string.h, shoot_boundary.h, shoot_regularisers.h, shoot_optim3d.h, math.h, shoot_multiscale.h...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Magnitude:** 2027.98 | **LOC:** 1659 | **CtrlFlow:** 91.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (29.8997%), Tech Debt (10.5297%)
**Top Internal Functions/Classes:**
  * `relax_all` (Impact: 35.0)
  * `relax_be` (Impact: 33.7)
  * `sumsq` (Impact: 26.0)
  * `relax_le` (Impact: 24.8)
  * `relax_me` (Impact: 23.9)
    * *Intent:* /************************************************************************************************/ /...
**Structural Signatures (Net Mitigated Signals):**
...
- **Magnitude:** 1833.52 | **LOC:** 1268 | **CtrlFlow:** 85.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (63.8054%), Tech Debt (33.6455%)
**Top Internal Functions/Classes:**
  * `pushc_grads` (Impact: 35.1)
  * `pushpull` (Impact: 29.9)
  * `grad1` (Impact: 29.4)
    * *Intent:* #define LOG(x) (((x)>0) ? log(x+0.001): -6.9078)
  * `composition_stuff` (Impact: 24.5)
    * *Intent:* /* Compute Lie bracket */
  * `def2jac_neuman` (Impact: 21.4)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.234
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 4):` shoot_expm3.h, shoot_boundary.h, stdio.h, shoot_optim3d.h, spm_mex.h, math.h
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Global Archetype:** `file_cluster_17` (Drift: 16.793 IQR)
- **Top Global Matches:** file_cluster_17: 16.793, file_cluster_11: 16.859, file_cluster_0: 16.924
- **Magnitude:** 1563.3 | **LOC:** 1982 | **CtrlFlow:** 63.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (77.8384%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `spm_dicom_convert` (Impact: 63.7)
    * *Intent:* % Convert DICOM images into something that SPM can use (e.g. NIfTI) % FORMAT out = spm_dicom_convert...
  * `ReadSliceNormalVector` (Impact: 32.8)
    * *Intent:* %========================================================================== % function nrm = ReadSli...
  * `SelectTomographicImages` (Impact: 1.5)
...
- **Global Archetype:** `file_cluster_17` (Drift: 14.43 IQR)
- **Top Global Matches:** file_cluster_17: 14.43, file_cluster_8: 14.565, file_cluster_11: 14.566
- **Magnitude:** 1444.9 | **LOC:** 1862 | **CtrlFlow:** 63.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (76.5571%), Tech Debt (11.4314%)
**Top Internal Functions/Classes:**
  * `local_cd` (Impact: 14.2)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `cfg_util` (Impact: 12.7)
    * *Intent:* % This is the command line interface to the batch system. It manages the % following structures: % *...
  * `local_addtojob` (Impact: 7.7)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `local_delfromjob` (Impact: 5.6)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `fprintf` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 330`, `structural_boundaries: 193`, `args: 29`, `func_start: 18`
...
### `spm_regions.m` (MATLAB | Tier 2 | 🚨 AI THREAT: 99.06%)
- **Global Archetype:** `file_cluster_17` (Drift: 14.056 IQR)
- **Top Global Matches:** file_cluster_17: 14.056, file_cluster_8: 14.154, file_cluster_11: 14.283
- **Magnitude:** 1386.15 | **LOC:** 325 | **CtrlFlow:** 63.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (81.6754%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 63`, `structural_boundaries: 37`, `args: 2`, `func_start: 2`
* *Risk/State:* `state_mutation: 183`, `dead_code: 1`
* *Architecture:* `io: 2`
* *Defense:* `safety: 24`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.234
...
### `toolbox/dcm_meeg/spm_dcm_erp.m` (MATLAB | Tier 2 | 🚨 AI THREAT: 99.06%)
- **Global Archetype:** `file_cluster_8` (Drift: 14.664 IQR)
- **Top Global Matches:** file_cluster_8: 14.664, file_cluster_17: 14.825, file_cluster_11: 14.869
- **Magnitude:** 1325.87 | **LOC:** 424 | **CtrlFlow:** 63.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (80.9507%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 60`, `structural_boundaries: 35`, `args: 1`, `func_start: 1`
* *Risk/State:* `safety_bypasses: 1`, `state_mutation: 341`
* *Architecture:* `io: 2`
* *Defense:* `safety: 33`, `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.234
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` None
...
- **Global Archetype:** `file_cluster_17` (Drift: 16.208 IQR)
- **Top Global Matches:** file_cluster_17: 16.208, file_cluster_11: 16.28, file_cluster_0: 16.312
- **Magnitude:** 1320.34 | **LOC:** 1114 | **CtrlFlow:** 50.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (94.9269%), Tech Debt (13.088%)
**Top Internal Functions/Classes:**
  * `serialize_jsonld` (Impact: 356.9)
  * `serialize_json` (Impact: 18.5)
  * `get_namespace` (Impact: 3.6)
  * `add_namespace` (Impact: 2.1)
  * `serialize_dot` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 277`, `structural_boundaries: 267`, `args: 57`, `func_start: 54`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 1`, `state_mutation: 914`, `dead_code: 25`, `fragile_debt: 1`, `orphaned_logic: 1`
...
### `toolbox/DARTEL/tbx_cfg_dartel.m` (MATLAB | Tier 2 | 🚨 AI THREAT: 99.17%)
- **Global Archetype:** `file_cluster_8` (Drift: 13.604 IQR)
- **Top Global Matches:** file_cluster_8: 13.604, file_cluster_7: 14.114, file_cluster_13: 14.178
- **Magnitude:** 1313.68 | **LOC:** 1369 | **CtrlFlow:** 76.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (60.2915%), Tech Debt (9.2416%)
**Top Internal Functions/Classes:**
  * `vout_norm` (Impact: 12.4)
    * *Intent:* %_______________________________________________________________________ %__________________________...
  * `check_norm_fun` (Impact: 9.3)
    * *Intent:* %_______________________________________________________________________ %__________________________...
  * `check_norm` (Impact: 7.1)
    * *Intent:* %_______________________________________________________________________ %__________________________...
  * `tbx_cfg_dartel` (Impact: 2.9)
    * *Intent:* % Configuration file for toolbox 'Dartel Tools' %___________________________________________________...
  * `vout_dartel_warp` (Impact: 2.4)
    * *Intent:* %_______________________________________________________________________ %__________________________...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 104`, `structural_boundaries: 32`, `args: 13`, `func_start: 14`
* *Risk/State:* `high_risk_execution: 1`, `state_mutation: 1254`, `orphaned_logic: 1`
* *Architecture:* None
* *Defense:* `safety: 7`, `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.234
...
### `toolbox/DAiSS/private/champagne_aug2015.m` (MATLAB | Tier 2 | 🚨 AI THREAT: 99.06%)
- **Global Archetype:** `file_cluster_8` (Drift: 13.853 IQR)
- **Top Global Matches:** file_cluster_8: 13.853, file_cluster_17: 13.928, file_cluster_11: 14.091
- **Magnitude:** 1296.84 | **LOC:** 311 | **CtrlFlow:** 58.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (70.3988%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 42`, `structural_boundaries: 30`, `args: 3`, `func_start: 3`
* *Risk/State:* `state_mutation: 324`, `dead_code: 1`
* *Architecture:* None
* *Defense:* `safety: 4`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.234
...
- **Top Global Matches:** file_cluster_8: 14.495, file_cluster_13: 14.695, file_cluster_7: 14.793
- **Magnitude:** 1265.02 | **LOC:** 688 | **CtrlFlow:** 95.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (74.4142%), Tech Debt (62.0895%)
**Top Internal Functions/Classes:**
  * `mrqcof` (Impact: 344.0)
  * `mexFunction` (Impact: 115.3)
  * `matmul` (Impact: 11.2)
  * `scale` (Impact: 4.3)
  * `transform_grads` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 117`, `structural_boundaries: 6`, `args: 7`, `func_start: 5`
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.234
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` mex.h, math.h, spm_mapping.h
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `matlabbatch/cfg_job.m` (MATLAB) | Magnitude: 48.12 | Delta: **0.205 IQR** | Secondary Pull: `file_cluster_17`
...
- `spm_uw_estimate.m` (MATLAB) | Magnitude: 631.7 | Delta: **0.0 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: state_mutation: 585, indent_spaces: 222, scientific: 124, branch: 95
- `@gifti/private/mvtk_write.m` (MATLAB) | Magnitude: 377.86 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: state_mutation: 348, indent_spaces: 275, branch: 122, structural_boundaries: 55
- `external/fieldtrip/specest/ft_specest_mtmconvol.m` (MATLAB) | Magnitude: 0.26 | Delta: **0.002 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: state_mutation: 258, indent_spaces: 149, branch: 69, scientific: 48

### Mixed-Responsibility Refactoring Targets for: file_cluster_12
- `bin/spm12-matlab` (SHELL) | Magnitude: 91.78 | Delta: **0.033 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: branch: 39, state_mutation: 39, indent_spaces: 24, reflection_metaprogramming: 21
- `bin/spm12-mcr` (SHELL) | Magnitude: 54.36 | Delta: **0.05 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: branch: 33, indent_spaces: 21, reflection_metaprogramming: 13, state_mutation: 12
- `@nifti/private/nifti_stats.c` (C) | Magnitude: 9501.36 | Delta: **0.141 IQR** | Secondary Pull: `file_cluster_8`
...
- `external/fieldtrip/src/meg_leadfield1.c` (C) | Magnitude: 0.12 | Delta: **0.022 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: state_mutation: 76, indent_spaces: 62, branch: 13, api: 8
- `@file_array/private/file2mat.c` (C) | Magnitude: 733.84 | Delta: **0.031 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: state_mutation: 443, indent_spaces: 437, branch: 110, pointers: 109
- `@gifti/private/zstream.c` (C) | Magnitude: 96.32 | Delta: **0.039 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: state_mutation: 36, branch: 20, indent_spaces: 15, api: 9
- `src/spm_mapping.c` (C) | Magnitude: 1023.98 | Delta: **0.04 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: state_mutation: 588, indent_spaces: 461, branch: 186, api: 68

### Mixed-Responsibility Refactoring Targets for: file_cluster_17
- `external/fieldtrip/connectivity/ft_connectivity_pdc.m` (MATLAB) | Magnitude: 0.09 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_11`
...
- `external/fieldtrip/utilities/ft_trackusage.m` (MATLAB) | Magnitude: 0.1 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: state_mutation: 65, indent_spaces: 65, structural_boundaries: 30, branch: 18
- `spm_get_dataset.m` (MATLAB) | Magnitude: 150.44 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_8`
...
- `spm_jobman.m` (MATLAB) | Magnitude: 351.54 | Delta: **0.145 IQR** | Secondary Pull: `file_cluster_17`
...
- `matlabbatch/@cfg_item/subsasgn_check.m` (MATLAB) | Magnitude: 35.38 | Delta: **0.032 IQR** | Secondary Pull: `file_cluster_11`
...
- `spm_LAPF.m` (MATLAB) | Magnitude: 676.76 | Delta: **0.002 IQR** | Secondary Pull: `file_cluster_17`
...
- `external/fieldtrip/src/splint_gh.c` (C) | Magnitude: 0.23 | Delta: **0.002 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: state_mutation: 153, indent_spaces: 90, api: 25, branch: 20

### Mixed-Responsibility Refactoring Targets for: file_cluster_9
- `matlabbatch/@cfg_const/showdetail.m` (MATLAB) | Magnitude: 6.18 | Delta: **0.0 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: state_mutation: 3, dead_code: 2, structural_boundaries: 1, args: 1
- `matlabbatch/@cfg_const/showdoc.m` (MATLAB) | Magnitude: 5.7 | Delta: **0.004 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: state_mutation: 3, dead_code: 2, structural_boundaries: 1, args: 1
...
- `src/spm_vol_access.h` -> **Severity: 198.9** (Blast Radius: 1.989 * Doc Risk: 99.9998%)
- `external/fieldtrip/src/geometry.h` -> **Severity: 130.32** (Blast Radius: 1.629 * Doc Risk: 79.9999%)
- `src/spm_mapping.h` -> **Severity: 114.295** (Blast Radius: 1.928 * Doc Risk: 59.2815%)
- `external/fieldtrip/src/compiler.h` -> **Severity: 85.637** (Blast Radius: 1.297 * Doc Risk: 66.0269%)
- `src/bsplines.h` -> **Severity: 73.196** (Blast Radius: 0.732 * Doc Risk: 99.995%)
