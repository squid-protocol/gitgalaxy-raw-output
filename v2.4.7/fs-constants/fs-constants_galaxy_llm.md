...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/fs-constants` |
| **Timestamp** | `2026-08-07T05:14:44.569745+00:00` |
| **Scan Duration** | `0.06s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
2. **browser.js** (`package/browser.js`) — 0 inbound connections
...
### 1. `package/browser.js` (JAVASCRIPT) -> Cumulative Risk: **68.4**
...
- **Archetype:** `file_cluster_13` (Distance: 6.812 IQR)
- **Magnitude:** 11.52 | **LOC:** 2 | **CtrlFlow:** 100.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (6.6667%), Api Exposure (5.7813%), Cognitive Load (5.0%)
...
- **Global Archetype:** `file_cluster_13` (Drift: 6.812 IQR)
- **Local Micro-Species:** `Cluster 8: Declarative Glue & Inert Types` (Drift: 5.833 IQR)
- **Top Global Matches:** file_cluster_13: 6.812, file_cluster_8: 7.955, file_cluster_7: 8.852
- **Magnitude:** 11.52 | **LOC:** 2 | **CtrlFlow:** 100.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (5.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1`
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 250.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` fs, constants
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `package/browser.js` (JAVASCRIPT) | Magnitude: 11.52 | Delta: **0.407 IQR** | Secondary Pull: `file_cluster_8`
...
- `package/browser.js` -> **Severity: 198.675** (Blast Radius: 250.0 * Doc Risk: 0.7947%)
