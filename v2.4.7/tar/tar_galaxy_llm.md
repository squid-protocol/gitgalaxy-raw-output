...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/tar` |
| **Timestamp** | `2026-08-07T05:16:45.897580+00:00` |
| **Scan Duration** | `0.08s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 24.5 | **LOC:** 1225 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None

### 3. `package/package.json` (PLAINTEXT) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 5.96 | **LOC:** 298 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
