# ARCHITECTURAL_BRIEF: @module-federation_node
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@module-federation_node` |
| **Timestamp** | `2026-08-07T05:11:59.963572+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Magnitude:** 4.72 | **LOC:** 236 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None

### 2. `package/package.json` (PLAINTEXT) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 2.64 | **LOC:** 132 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
