...
| **Timestamp** | `2026-08-07T05:14:15.568964+00:00` |
| **Scan Duration** | `0.09s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 76.4 | 76.4 | 76.4 | 76.4 | 76.4 |
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **442.92**
- **Archetype:** `file_cluster_8` (Distance: 12.702 IQR)
- **Magnitude:** 18.1 | **LOC:** 142 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Cognitive Load (99.3307%), Safety Score (76.4498%)
