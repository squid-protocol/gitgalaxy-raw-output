...
| **Timestamp** | `2026-08-07T05:15:27.155809+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 5.0 | 72.0 | 27.3 | 5.0 | 5.0 |
| Error & Exception Exposure | 0.0 | 92.1 | 54.0 | 69.8 | 69.8 |
...
- `verbose` (@ `package/bin.js`) -> Impact: **4.2** | LOC: 3
...
### 1. `package/bin.js` (JAVASCRIPT) -> Cumulative Risk: **583.73**
- **Archetype:** `file_cluster_13` (Distance: 13.079 IQR)
- **Magnitude:** 78.3 | **LOC:** 85 | **CtrlFlow:** 54.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), State Flux (99.9989%), Verification (80.0%)
- **Heaviest Functions:** `build` (Impact: 15.1), `hasFlag` (Impact: 8.4), `exec` (Impact: 6.8)
...
- **Local Micro-Species:** `Cluster 2: Procedural Core & Safety Wrappers` (Drift: 5.835 IQR)
- **Top Global Matches:** file_cluster_13: 13.079, file_cluster_11: 13.117, file_cluster_8: 13.381
- **Magnitude:** 78.3 | **LOC:** 85 | **CtrlFlow:** 54.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (71.9676%), Tech Debt (100.0%)
...
* *Risk/State:* `high_risk_execution: 2`, `state_mutation: 24`, `planned_debt: 1`, `duplicate_logic: 5`
* *Architecture:* `io: 4`, `import: 4`
* *Defense:* `safety: 12`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 166.667
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` os, path, package.json, child_process
...
- `package/bin.js` (JAVASCRIPT) | Magnitude: 78.3 | Delta: **0.038 IQR** | Secondary Pull: `file_cluster_11`
