...
| **Timestamp** | `2026-08-07T03:51:26.832791+00:00` |
| **Scan Duration** | `0.15s` |
| **Git Branch** | `main` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 0.0 | 100.0 | 26.5 | 5.6 | 0.0 |
| Error & Exception Exposure | 0.0 | 100.0 | 46.3 | 75.7 | 0.0 |
...
| Documentation Exposure | 8.7 | 90.0 | 36.0 | 32.9 | 27.5 |
...
- `100-PROCESS-TRANSACTIONS` (@ `COBOL/SAM1.cbl`) -> Impact: **24.6** | LOC: 31
- `100-VALIDATE-TRAN` (@ `COBOL/SAM2.cbl`) -> Impact: **20.6** | LOC: 31
- `200-PROCESS-UPDATE-TRAN` (@ `COBOL/SAM1.cbl`) -> Impact: **18.2** | LOC: 18
- `200-PROCESS-TRAN` (@ `COBOL/SAM2.cbl`) -> Impact: **16.4** | LOC: 29
- `710-READ-TRAN-FILE` (@ `COBOL/SAM1.cbl`) -> Impact: **13.0** | LOC: 20
- `210-PROCESS-ADD-TRAN` (@ `COBOL/SAM1.cbl`) -> Impact: **11.9** | LOC: 19
- `REPORT-FILE` (@ `COBOL/SAM1.cbl`) -> Impact: **10.3** | LOC: 27
- `730-READ-CUSTOMER-FILE` (@ `COBOL/SAM1.cbl`) -> Impact: **9.8** | LOC: 16
- `000-MAIN` (@ `COBOL/SAM2.cbl`) -> Impact: **9.7** | LOC: 14
- `CURRENT-SECOND` (@ `COBOL/SAM1.cbl`) -> Impact: **9.2** | LOC: 25

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `COBOL` | 2 | 516.42 | 80.76% | 96.88% |
| `JCL` | 8 | 202.16 | 1.52% | 0.0% |
| `__monolith__` | 5 | 72.66 | 4.47% | 0.0% |
| `zowe` | 4 | 67.5 | 99.25% | 99.96% |
| `JCLPROC` | 1 | 25.18 | 0.0% | 0.0% |
...
### 1. `zowe/zowecli-cobol-clean.sh` (SHELL) -> Cumulative Risk: **719.9**
- **Archetype:** `file_cluster_12` (Distance: 20.776 IQR)
- **Magnitude:** 15.3 | **LOC:** 26 | **CtrlFlow:** 100.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9996%)
- **Heaviest Functions:** `__global_context__` (Impact: 3.0)

### 2. `zowe/zowecli-cobol-upload-run-simple.sh` (SHELL) -> Cumulative Risk: **714.26**
- **Archetype:** `file_cluster_12` (Distance: 19.078 IQR)
- **Magnitude:** 6.84 | **LOC:** 30 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Tech Debt (99.9978%), State Flux (99.9333%)
- **Heaviest Functions:** `__global_context__` (Impact: 2.5)

### 3. `zowe/zowecli-cobol-upload-run-tutorial.sh` (SHELL) -> Cumulative Risk: **668.57**
- **Archetype:** `file_cluster_17` (Distance: 16.421 IQR)
- **Magnitude:** 34.36 | **LOC:** 55 | **CtrlFlow:** 72.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), State Flux (100.0%), Spec Match (100.0%), Safety Score (99.9936%)
- **Heaviest Functions:** `Anonymous_Block` (Impact: 5.3), `Anonymous_Block` (Impact: 5.3), `__global_context__` (Impact: 3.0)

### 4. `COBOL/SAM2.cbl` (COBOL) -> Cumulative Risk: **581.32**
- **Archetype:** `file_cluster_8` (Distance: 14.061 IQR)
- **Magnitude:** 180.78 | **LOC:** 159 | **CtrlFlow:** 84.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.5379%), Tech Debt (94.0032%)
- **Heaviest Functions:** `100-VALIDATE-TRAN` (Impact: 20.6), `200-PROCESS-TRAN` (Impact: 16.4), `000-MAIN` (Impact: 9.7)

### 5. `COBOL/SAM1.cbl` (COBOL) -> Cumulative Risk: **553.36**
- **Archetype:** `file_cluster_8` (Distance: 12.455 IQR)
- **Magnitude:** 335.64 | **LOC:** 505 | **CtrlFlow:** 79.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.7632%), Safety Score (84.9146%)
- **Heaviest Functions:** `100-PROCESS-TRANSACTIONS` (Impact: 24.6), `200-PROCESS-UPDATE-TRAN` (Impact: 18.2), `710-READ-TRAN-FILE` (Impact: 13.0)

### 6. `zowe/zowecli-create-profiles.sh` (SHELL) -> Cumulative Risk: **535.94**
...
### 7. `JCL/ALLOCATE.jcl` (JCL) -> Cumulative Risk: **339.46**
- **Archetype:** `file_cluster_8` (Distance: 6.399 IQR)
- **Magnitude:** 18.78 | **LOC:** 90 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Safety Score (76.0598%), Documentation (37.953%)

### 8. `JCL/INCLUDE.jcl` (JCL) -> Cumulative Risk: **321.86**
- **Archetype:** `file_cluster_8` (Distance: 7.407 IQR)
- **Magnitude:** 17.5 | **LOC:** 25 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (76.8525%), State Flux (75.026%), Documentation (55.5328%)

### 9. `JCL/RUN.jcl` (JCL) -> Cumulative Risk: **304.42**
- **Archetype:** `file_cluster_8` (Distance: 7.031 IQR)
- **Magnitude:** 40.66 | **LOC:** 168 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (81.9955%), Churn (63.09%), State Flux (28.8559%)

### 10. `JCL/RUNASAM1.jcl` (JCL) -> Cumulative Risk: **295.97**
- **Archetype:** `file_cluster_8` (Distance: 8.101 IQR)
- **Magnitude:** 31.64 | **LOC:** 76 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (90.6674%), State Flux (75.026%), Documentation (27.9414%)
...
**Top Internal Functions/Classes:**
  * `100-PROCESS-TRANSACTIONS` (Impact: 24.6)
  * `200-PROCESS-UPDATE-TRAN` (Impact: 18.2)
  * `710-READ-TRAN-FILE` (Impact: 13.0)
  * `210-PROCESS-ADD-TRAN` (Impact: 11.9)
  * `REPORT-FILE` (Impact: 10.3)
...
**Top Internal Functions/Classes:**
  * `100-VALIDATE-TRAN` (Impact: 20.6)
  * `200-PROCESS-TRAN` (Impact: 16.4)
  * `000-MAIN` (Impact: 9.7)
  * `310-CRUNCH-LOOP` (Impact: 7.5)
  * `300-PROCESS-CPU-CRUNCH` (Impact: 3.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `file_cluster_8` (Drift: 7.031 IQR)
- **Top Global Matches:** file_cluster_8: 7.031, file_cluster_7: 8.146, file_cluster_1: 8.336
- **Magnitude:** 40.66 | **LOC:** 168 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &LINKLIB, &HLQ..SAMPLE.COBOL(SAM1), &HLQ..SAMPLE.CUSTOUT, &HLQ..SAMPLE.COPY, &HLQ..SAMPLE.CUSTFILE, &CMPLLIB, &HLQ..SAMPLE.CUSTRPT, &HLQ..SAMPLE.COPYLIB...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.PLI.CUSTRPT, &LINKLIB, &HLQ..SAMPLE.PLI(PSAM2), &HLQ..SAMPLE.PLI(PSAM1), &HLQ..SAMPLE.PLI.CUSTFILE, &HLQ..SAMPLE.PLI.TRANFILE, &HLQ..SAMPLE.PLILOAD, &HLQ..SAMPLE.PLIOBJ(PSAM1)...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.ASMLOAD, &HLQ..SAMPLE.ASMCOPY, &MODGEN, &MACLIB, &SCEEMAC, &HLQ..SAMPLE.ASMOBJ(ASAM1), &HLQ..SAMPLE.ASM.FILEIN, &HLQ..SAMPLE.ASM.FILEOUT...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `JCLPROC/COMPROC.jcl` (JCL | Tier 2 | 🚨 AI THREAT: 98.84%)
- **Global Archetype:** `file_cluster_8` (Drift: 5.702 IQR)
- **Top Global Matches:** file_cluster_8: 5.702, file_cluster_7: 7.108, file_cluster_1: 7.252
- **Magnitude:** 25.18 | **LOC:** 52 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &CMPLLIB, &HLQ..SAMPLE.OBJ(SAM2), &HLQ..SAMPLE.COPY, &HLQ..SAMPLE.COBOL(SAM2)
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.PLI.CUSTFILE, &HLQ..SAMPLE.PLI.TRANFILE, &HLQ..SAMPLE.PLILOAD, &HLQ..SAMPLE.PLIOBJ, &HLQ..SAMPLE.PLINC, &HLQ..SAMPLE.PLI, &HLQ..SAMPLE.PLI.INCLLIB
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.COPY, &HLQ..SAMPLE.COPYLIB, &HLQ..SAMPLE.COBOL, &HLQ..SAMPLE.TRANFILE, &HLQ..SAMPLE.CUSTFILE, &HLQ..SAMPLE.OBJ, &HLQ..SAMPLE.LOAD
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.ASMLOAD, &HLQ..SAMPLE.ASMCOPY, &HLQ..SAMPLE.ASM.FILEIN, &HLQ..SAMPLE.ASM, &HLQ..SAMPLE.ASMOBJ
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.094
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` &HLQ..SAMPLE.REXX.FILEIN1, &HLQ..SAMPLE.REXX.FILEOUT, &HLQ..SAMPLE.REXX.FILEIN2, &HLQ..SAMPLE.REXX
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `COBOL/SAM2.cbl` (COBOL) | Magnitude: 180.78 | Delta: **0.115 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: state_mutation: 120, indent_spaces: 119, branch: 54, safety: 17
- `COBOL/SAM1.cbl` (COBOL) | Magnitude: 335.64 | Delta: **0.307 IQR** | Secondary Pull: `file_cluster_13`
...
- `zowe/zowecli-cobol-clean.sh` -> **Severity: 2257.652** (Blast Radius: 25.094 * Doc Risk: 89.9678%)
- `zowe/zowecli-cobol-upload-run-simple.sh` -> **Severity: 2138.839** (Blast Radius: 25.094 * Doc Risk: 85.2331%)
- `ASMCOPY/REGISTRS.asm` -> **Severity: 1561.999** (Blast Radius: 25.094 * Doc Risk: 62.2459%)
- `JCL/INCLUDE.jcl` -> **Severity: 1393.54** (Blast Radius: 25.094 * Doc Risk: 55.5328%)
- `JCLPROC/COMPROC.jcl` -> **Severity: 1324.233** (Blast Radius: 25.094 * Doc Risk: 52.7709%)
