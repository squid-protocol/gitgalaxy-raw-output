...
| **Timestamp** | `2026-08-07T05:23:41.979796+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 0.0 | 52.9 | 4.8 | 0.0 | 0.0 |
| Tech Debt Exposure | 0.0 | 75.2 | 6.8 | 0.0 | 0.0 |
| Testing Exposure | 0.0 | 2.8 | 1.8 | 2.3 | 2.3 |
...
| Documentation Exposure | 0.0 | 41.1 | 17.7 | 18.8 | 0.0 |
...
- `_schemas` (@ `jsonschema_specifications-2025.9.1/jsonschema_specifications/_core.py`) -> Impact: **14.9** | LOC: 21
- `docs` (@ `jsonschema_specifications-2025.9.1/noxfile.py`) -> Impact: **7.9** | LOC: 20
- `requirements` (@ `jsonschema_specifications-2025.9.1/noxfile.py`) -> Impact: **7.6** | LOC: 13
- `test_it_copes_with_dotfiles` (@ `jsonschema_specifications-2025.9.1/jsonschema_specifications/tests/test_jsonschema_specifications.py`) -> Impact: **5.9** | LOC: 14
...
- `build` (@ `jsonschema_specifications-2025.9.1/noxfile.py`) -> Impact: **3.8** | LOC: 7
- `_session` (@ `jsonschema_specifications-2025.9.1/noxfile.py`) -> Impact: **3.7** | LOC: 4
- `docs_style` (@ `jsonschema_specifications-2025.9.1/noxfile.py`) -> Impact: **2.2** | LOC: 9
...
|---|---|---|---|---|
| `jsonschema_specifications-2025.9.1` | 2 | 52.44 | 2.37% | 37.59% |
| `jsonschema_specifications-2025.9.1/jsonschema_specifications` | 2 | 29.36 | 9.75% | 0.0% |
| `jsonschema_specifications-2025.9.1/jsonschema_specifications/tests` | 2 | 23.7 | 3.6% | 0.0% |
...
### 1. `jsonschema_specifications-2025.9.1/noxfile.py` (PYTHON) -> Cumulative Risk: **330.99**
- **Archetype:** `file_cluster_8` (Distance: 9.394 IQR)
- **Magnitude:** 51.44 | **LOC:** 150 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (75.1802%), Safety Score (52.8559%), Stability (50.0%)
- **Heaviest Functions:** `docs` (Impact: 7.9), `requirements` (Impact: 7.6), `session` (Impact: 4.3)

### 2. `jsonschema_specifications-2025.9.1/jsonschema_specifications/_core.py` (PYTHON) -> Cumulative Risk: **183.32**
- **Archetype:** `file_cluster_13` (Distance: 9.385 IQR)
- **Magnitude:** 16.28 | **LOC:** 39 | **CtrlFlow:** 44.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Documentation (14.7353%), Cognitive Load (14.5067%)
- **Heaviest Functions:** `_schemas` (Impact: 14.9)

### 3. `jsonschema_specifications-2025.9.1/jsonschema_specifications/tests/test_jsonschema_specifications.py` (PYTHON) -> Cumulative Risk: **156.63**
- **Archetype:** `file_cluster_13` (Distance: 11.702 IQR)
- **Magnitude:** 13.18 | **LOC:** 42 | **CtrlFlow:** 11.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Api Exposure (4.4229%), Cognitive Load (2.21%)
- **Heaviest Functions:** `test_it_copes_with_dotfiles` (Impact: 5.9), `test_it_contains_metaschemas` (Impact: 2.0), `test_it_is_crawled` (Impact: 1.8)

### 4. `jsonschema_specifications-2025.9.1/jsonschema_specifications/__init__.py` (PYTHON) -> Cumulative Risk: **96.63**
- **Archetype:** `file_cluster_13` (Distance: 8.48 IQR)
- **Magnitude:** 13.08 | **LOC:** 13 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (26.6667%), Documentation (13.6041%), Cognitive Load (5.0%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` nox, tempfile, pathlib, os
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` json, importlib.resources, referencing, importlib_resources
...
**Top Internal Functions/Classes:**
  * `test_it_copes_with_dotfiles` (Impact: 5.9)
    * *Intent:* """ Ignore files like .DS_Store if someone has actually caused one to exist. We test here through th...
  * `test_it_contains_metaschemas` (Impact: 2.0)
  * `test_it_is_crawled` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 77.821
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` jsonschema_specifications, pathlib, collections.abc, pytest
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `jsonschema_specifications-2025.9.1/jsonschema_specifications/tests/test_jsonschema_specifications.py` (PYTHON) | Magnitude: 13.18 | Delta: **0.352 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: structural_boundaries: 15, indent_spaces: 15, test: 9, safety: 7
- `jsonschema_specifications-2025.9.1/jsonschema_specifications/_core.py` (PYTHON) | Magnitude: 16.28 | Delta: **0.454 IQR** | Secondary Pull: `file_cluster_8`
...
- `jsonschema_specifications-2025.9.1/noxfile.py` (PYTHON) | Magnitude: 51.44 | Delta: **0.083 IQR** | Secondary Pull: `file_cluster_13`
...
- `jsonschema_specifications-2025.9.1/jsonschema_specifications/_core.py` -> **Severity: 2121.426** (Blast Radius: 143.969 * Doc Risk: 14.7353%)
- `jsonschema_specifications-2025.9.1/noxfile.py` -> **Severity: 1068.319** (Blast Radius: 77.821 * Doc Risk: 13.7279%)
- `jsonschema_specifications-2025.9.1/jsonschema_specifications/__init__.py` -> **Severity: 1058.685** (Blast Radius: 77.821 * Doc Risk: 13.6041%)
