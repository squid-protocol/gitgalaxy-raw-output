...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/corpus_cobol/otterkit` |
| **Timestamp** | `2026-08-07T03:51:20.521465+00:00` |
| **Scan Duration** | `0.08s` |
| **Git Branch** | `main` |
| **Git Commit** | `bb4eea98a1f371fa41a5d12281712fdcd2199849` |
| **Git Remote** | `https://github.com/otterkit/otterkit.git` |
...
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 54 |
| Total LOC | 0 |
| Volatility Index | 0.0 |
| % Scanned of codebase = | 5.3% |
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 3 | 100.0% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 54*

**Composition by Extension & Reason:**
- `.c`: 25x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
- `.h`: 13x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
- `.dll`: 1x Excluded (Explicitly Denied Extension: '.dll')
...
1. **NOTICE** (`NOTICE`) — 0 inbound connections
...
1. **NOTICE** (`NOTICE`) — 0 outbound dependencies
2. **README.md** (`README.md`) — 0 outbound dependencies
3. **SECURITY.md** (`SECURITY.md`) — 0 outbound dependencies
...
### 1. `NOTICE` (PLAINTEXT) -> Cumulative Risk: **0.0**
...
### 2. `README.md` (MARKDOWN) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 1.0 | **LOC:** 16 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None

### 3. `SECURITY.md` (MARKDOWN) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
...
### `NOTICE` (PLAINTEXT | Tier 1 | AI Safe: 0.0%)
...
### `SECURITY.md` (MARKDOWN | Tier 1 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 1.0 | **LOC:** 14 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
