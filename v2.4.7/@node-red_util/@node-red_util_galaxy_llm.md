...
| **Timestamp** | `2026-08-07T05:12:26.777905+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- `init` (@ `package/index.js`) -> Impact: **1.6** | LOC: 4
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **171.02**
- **Archetype:** `file_cluster_8` (Distance: 9.277 IQR)
- **Magnitude:** 2.96 | **LOC:** 82 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Documentation (11.9203%), Cognitive Load (3.6027%)
- **Heaviest Functions:** `init` (Impact: 1.6)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` util, exec, events, hooks, i18n, log
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 2.96 | Delta: **0.02 IQR** | Secondary Pull: `file_cluster_13`
