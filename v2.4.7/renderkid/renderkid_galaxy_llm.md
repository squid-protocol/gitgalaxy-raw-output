...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/renderkid` |
| **Timestamp** | `2026-08-07T05:16:29.216363+00:00` |
| **Scan Duration** | `0.07s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 3.8 | **LOC:** 190 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None

### 3. `package/SECURITY.md` (MARKDOWN) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
