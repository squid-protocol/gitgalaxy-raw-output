...
> **Composition Archetype:** `Hub-Coupled App` (z -0.47; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 32%, Large Core Modules 25%, Many-Argument Workhorses Files 9%, Compute Cores Files 8%, Data / Markup / Trivial 6%
...
- **Composition Archetype:** `Compute Cores Files` (z +1.07)
...
- **Heaviest Functions:** `Anonymous_Block` (Compute Cores, Impact: 23.4), `__global_context__` (I/O & Config Routines, Impact: 16.1), `bool` (Compute Cores, Impact: 8.8)
...
- **Heaviest Functions:** `lock_it` (Many-Argument Workhorses, Impact: 66.6), `fcntl_setlk` (Many-Argument Workhorses, Impact: 45.7), `copy_flock` (Many-Argument Workhorses, Impact: 39.5)
...
- **Heaviest Functions:** `sys_adjtimex` (Compute Cores, Impact: 49.5), `sys_settimeofday` (Compute Cores, Impact: 14.3), `set_rtc_mmss` (Compute Cores, Impact: 13.3)
...
- **Heaviest Functions:** `do_open` (Many-Argument Workhorses, Impact: 26.4), `sys_fchown` (C Struct Operations, Impact: 25.3), `sys_chown` (Many-Argument Workhorses, Impact: 21.5)

### 5. `fs/sysv/ialloc.c` (C) -> Cumulative Risk: **661.19**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `C Struct Operations Files` (z +1.81)
...
- **Heaviest Functions:** `sysv_new_inode` (C Struct Operations, Impact: 23.5), `sysv_free_inode` (C Struct Operations, Impact: 16.6), `sysv_count_free_inodes` (Compute Cores, Impact: 16.3)

### 6. `drivers/scsi/hosts.c` (C) -> Cumulative Risk: **660.63**
- **Archetype:** `file_cluster_5` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +1.33)
...
- **Heaviest Functions:** `scsi_init` (Compute Cores, Impact: 16.0), `scsi_unregister` (C Struct Operations, Impact: 9.5), `scsi_register` (C Struct Operations, Impact: 8.5)
...
- **Heaviest Functions:** `sys_setpriority` (Compute Cores, Impact: 29.4), `sys_setpgid` (C Struct Operations, Impact: 28.0), `sys_reboot` (Compute Cores, Impact: 20.8)

### 8. `fs/read_write.c` (C) -> Cumulative Risk: **658.69**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `C Struct Operations Files` (z +1.74)
...
- **Heaviest Functions:** `sys_lseek` (Compute Cores, Impact: 27.6), `sys_read` (C Struct Operations, Impact: 18.9), `sys_write` (C Struct Operations, Impact: 18.9)

### 9. `drivers/sound/dev_table.c` (C) -> Cumulative Risk: **651.45**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +0.83)
...
- **Heaviest Functions:** `sound_setup` (Compute Cores, Impact: 21.6), `sound_chconf` (Many-Argument Workhorses, Impact: 18.8), `sndtable_init_card` (Compute Cores, Impact: 11.7)

### 10. `kernel/sched.c` (C) -> Cumulative Risk: **651.19**
- **Archetype:** `file_cluster_5` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +1.65)
...
- **Heaviest Functions:** `do_timer` (Compute Cores, Impact: 58.1), `schedule` (Compute Cores, Impact: 27.4), `show_task` (Compute Cores, Impact: 25.8)
...
**Top Internal Functions/Classes:**
  * `sbpcd_ioctl` **(Many-Argument Workhorses)** (Impact: 176.6)
    * *Intent:* /*==========================================================================*/ /*===================...
  * `sbpcd_init` **(Compute Cores)** (Impact: 59.4)
    * *Intent:* /*==========================================================================*/ /* * Test for presenc...
  * `prepare` **(Compute Cores)** (Impact: 50.6)
    * *Intent:* /*==========================================================================*/ /* * called always if...
  * `sbp_data` **(Compute Cores)** (Impact: 50.0)
    * *Intent:* /*==========================================================================*/ /* * Check the comple...
  * `xx_SetVolume` **(Compute Cores)** (Impact: 49.4)
    * *Intent:* /*==========================================================================*/
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `guswave_patchmgr` **(Compute Cores)** (Impact: 74.1)
    * *Intent:* #endif
...
**Top Internal Functions/Classes:**
  ...
  * `con_init` **(Compute Cores)** (Impact: 24.8)
...
**Top Internal Functions/Classes:**
  ...
  * `eraser` **(Compute Cores)** (Impact: 72.4)
  ...
  * `release_dev` **(Compute Cores)** (Impact: 48.2)
...
**Top Internal Functions/Classes:**
  * `set_serial_info` **(Compute Cores)** (Impact: 69.1)
...
**Top Internal Functions/Classes:**
  ...
  * `tape_qic02_open` **(Compute Cores)** (Impact: 73.6)
...
**Top Internal Functions/Classes:**
  * `NCR5380_information_transfer` **(Compute Cores)** (Impact: 186.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-05 | `Ripple Effect (Closeness):` 0.005464
...
**Top Internal Functions/Classes:**
  ...
  * `scan_scsis` **(Compute Cores)** (Impact: 82.5)
...
**Top Internal Functions/Classes:**
  * `do_options` **(Compute Cores)** (Impact: 71.4)
...
**Top Internal Functions/Classes:**
  ...
  * `load_aout_binary` **(Compute Cores)** (Impact: 41.1)
...
**Top Internal Functions/Classes:**
  ...
  * `depca_tx` **(Compute Cores)** (Impact: 23.5)
    * *Intent:* /*
  * `DevicePresent` **(Compute Cores)** (Impact: 22.4)
...
**Top Internal Functions/Classes:**
  * `reg_store_single` **(Compute Cores)** (Impact: 55.3)
    * *Intent:* /* Put a float into user memory */
  * `reg_store_double` **(Compute Cores)** (Impact: 53.6)
  ...
  * `write_to_extended` **(Compute Cores)** (Impact: 25.5)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
- `include/linux/sched.h` -> **Severity: 2.513** (Bridge: 0.0256 * Flux: 98.1204%)
- `drivers/sound/os.h` -> **Severity: 0.501** (Bridge: 0.005 * Flux: 99.9987%)
