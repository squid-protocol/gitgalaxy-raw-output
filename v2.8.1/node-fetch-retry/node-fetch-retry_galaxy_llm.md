...
- `sleep` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **1.6** | LOC: 3
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **593.18**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (98.7872%), State Flux (91.6827%), Tech Debt (73.1059%)
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 25.4), `sleep` (Interface Declarations, Impact: 1.6)
...
- **Magnitude:** 40.48 | **LOC:** 29 | **CtrlFlow:** 54.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (60.8259%), Tech Debt (73.1059%)
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 25.4)
  * `sleep` **(Interface Declarations)** (Impact: 1.6)
