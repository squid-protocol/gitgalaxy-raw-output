...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +2.28; from the repo's file-archetype mix)
> **File Composition:** Callbacks & Closures Files 24%, State Mutators Files 23%, Defensive Guards Files 17%, Declarative / Non-Code 13%, Data / Markup / Trivial 7%
...
- `processRelativeTime` **(Compute Cores)** (@ `locale/sl.js`) -> Impact: **225.5** | LOC: 83
  * *Intent:* //! moment.js locale configuration
- `processRelativeTime` **(Compute Cores)** (@ `src/locale/sl.js`) -> Impact: **225.5** | LOC: 83
...
- `processRelativeTime$9` **(Compute Cores)** (@ `min/locales.js`) -> Impact: **103.2** | LOC: 83
  * *Intent:* //! moment.js locale configuration
- `processRelativeTime$9` **(Compute Cores)** (@ `min/moment-with-locales.js`) -> Impact: **103.2** | LOC: 83
  * *Intent:* //! moment.js locale configuration
...
- **Heaviest Functions:** `set` (Many-Argument Workhorses, Impact: 42.0), `get` (Compute Cores, Impact: 36.1), `stringSet` (Defensive Guards, Impact: 9.5)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 15.5)
...
- **Heaviest Functions:** `exports` (Callbacks & Closures, Impact: 54.9), `transpile` (Defensive Guards, Impact: 12.6), `generateLocales` (Defensive Guards, Impact: 11.6)
...
- **Heaviest Functions:** `localeMonthsParse` (Many-Argument Workhorses, Impact: 38.6), `handleStrictParse` (Defensive Guards, Impact: 32.3), `setMonth` (Defensive Guards, Impact: 15.2)
...
- **Heaviest Functions:** `configFromArray` (Defensive Guards, Impact: 38.3), `dayOfYearFromWeekInfo` (Compute Cores, Impact: 31.3), `currentDateArray` (Interface Declarations, Impact: 3.4)
...
- **Heaviest Functions:** `handleStrictParse` (Defensive Guards, Impact: 53.6), `localeWeekdaysParse` (Many-Argument Workhorses, Impact: 51.3), `weekdaysRegex` (Compute Cores, Impact: 13.7)
...
- **Heaviest Functions:** `configFromStringAndFormat` (Compute Cores, Impact: 31.3), `meridiemFixWrap` (Many-Argument Workhorses, Impact: 21.2), `ISO_8601` (Callbacks & Closures, Impact: 1.1)
...
- **Heaviest Functions:** `getSetOffset` (Defensive Guards, Impact: 42.1), `offsetFromString` (Defensive Guards, Impact: 12.9), `cloneWithOffset` (Compute Cores, Impact: 9.5)
...
- **Heaviest Functions:** `createDuration` (Many-Argument Workhorses, Impact: 43.4), `getSetOffset` (Defensive Guards, Impact: 42.1), `checkOverflow` (Defensive Guards, Impact: 38.9)
...
- **Heaviest Functions:** `defineLocale` (Compute Cores, Impact: 26.9), `updateLocale` (Compute Cores, Impact: 24.7), `getSetGlobalLocale` (Defensive Guards, Impact: 16.8)
...
**Top Internal Functions/Classes:**
  * `processRelativeTime$9` **(Compute Cores)** (Impact: 103.2)
    * *Intent:* //! moment.js locale configuration
...
**Top Internal Functions/Classes:**
  ...
  * `getEraName` **(Interface Declarations)** (Impact: 7.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `currentDateArray` **(Interface Declarations)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 34 instances
...
**Top Internal Functions/Classes:**
  ...
  * `tester` **(Tests & Verification)** (Impact: 6.2)
  * `tester` **(Tests & Verification)** (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `stringGet` **(Interface Declarations)** (Impact: 3.2)
    * *Intent:* // MOMENTS
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 12 instances
...
**Top Internal Functions/Classes:**
  ...
  * `createFromConfig` **(Interface Declarations)** (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 19 instances
