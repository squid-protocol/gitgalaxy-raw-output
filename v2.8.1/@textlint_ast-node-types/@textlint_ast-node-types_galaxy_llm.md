...
### 1. `package/src/ASTNodeTypes.ts` (TYPESCRIPT) -> Cumulative Risk: **243.24**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.19)
- **Magnitude:** 18.08 | **LOC:** 74 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (54.4477%), Stability (50.0%), Api Exposure (20.5056%)

### 2. `package/src/NodeType.ts` (TYPESCRIPT) -> Cumulative Risk: **238.96**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.64)
- **Magnitude:** 63.18 | **LOC:** 266 | **CtrlFlow:** 6.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Api Exposure (83.581%), Stability (50.0%), Cognitive Load (3.0807%)

### 3. `package/src/TypeofTxtNode.ts` (TYPESCRIPT) -> Cumulative Risk: **85.33**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.76)
- **Magnitude:** 18.62 | **LOC:** 146 | **CtrlFlow:** 38.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Cognitive Load (17.2212%), Api Exposure (15.815%), Verification (2.2977%)

### 4. `package/src/index.ts` (TYPESCRIPT) -> Cumulative Risk: **59.35**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.05)
