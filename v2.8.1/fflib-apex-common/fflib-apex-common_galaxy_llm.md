...
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 72 |
| Total LOC | 35 |
| Volatility Index | 0.0 |
| % Scanned of codebase = | 6.5% |
| Dominant Lang | JSON |
...
*Total Excluded Artifacts: 72*

**Composition by Extension & Reason:**
- `.cls`: 32x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
- `.xml`: 32x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
5. **fflib-Apex-Common-CustomLabels.labels-meta.xml** (`sfdx-source/apex-common/main/labels/fflib-Apex-Common-CustomLabels.labels-meta.xml`) — 0 outbound dependencies
...
|---|---|---|---|---|
| `config` | 2 | 29.98 | 0.0% | 0.0% |
| `__monolith__` | 2 | 16.5 | 0.0% | 0.0% |
| `sfdx-source/apex-common/main/labels` | 1 | 10.52 | 0.0% | 0.0% |
...
### 1. `config/multicurrency-scratch-def.json` (JSON) -> Cumulative Risk: **2.3**
...
### 2. `config/project-scratch-def.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 14.68 | **LOC:** 10 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 3. `sfdx-project.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 15.22 | **LOC:** 12 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 4. `sfdx-source/apex-common/main/labels/fflib-Apex-Common-CustomLabels.labels-meta.xml` (XML) -> Cumulative Risk: **2.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 10.52 | **LOC:** 87 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 5. `README.md` (MARKDOWN) -> Cumulative Risk: **0.0**
...
### `sfdx-source/apex-common/main/labels/fflib-Apex-Common-CustomLabels.labels-meta.xml` (XML | Tier 2 | AI Safe: 0.0%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 200.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` patternsturning.png, 202105-new-domain-structure.md
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
