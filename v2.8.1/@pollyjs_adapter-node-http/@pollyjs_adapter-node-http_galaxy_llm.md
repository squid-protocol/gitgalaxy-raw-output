...
> **File Composition:** Data / Markup / Trivial 43%, Defensive Guards Files 43%, Large Core Modules 14%
...
- `getChunksFromBody` **(Many-Argument Workhorses)** (@ `package/src/index.js`) -> Impact: **11.1** | LOC: 22
...
- `onRequest` **(Callbacks & Closures)** (@ `package/src/index.js`) -> Impact: **9.3** | LOC: 16
...
- `patchOverriddenMethods` **(Interface Declarations)** (@ `package/src/index.js`) -> Impact: **6.1** | LOC: 61
...
- **Heaviest Functions:** `onRespond` (Compute Cores, Impact: 13.0), `getChunksFromBody` (Many-Argument Workhorses, Impact: 11.1), `getBodyFromChunks` (Defensive Guards, Impact: 10.4)
...
- **Heaviest Functions:** `getUrlFromOptions` (Defensive Guards, Impact: 18.2)
...
- **Heaviest Functions:** `urlToOptions` (Defensive Guards, Impact: 11.1)
...
- **Heaviest Functions:** `mergeChunks` (Defensive Guards, Impact: 6.4)
...
**Top Internal Functions/Classes:**
  ...
  * `getChunksFromBody` **(Many-Argument Workhorses)** (Impact: 11.1)
  * `getBodyFromChunks` **(Defensive Guards)** (Impact: 10.4)
  * `onRequest` **(Callbacks & Closures)** (Impact: 9.3)
  * `patchOverriddenMethods` **(Interface Declarations)** (Impact: 6.1)
