...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **234.41**
...
- **Primary Risk Drivers:** State Flux (91.6827%), Safety Score (73.6639%), Stability (50.0%), Cognitive Load (13.2389%)

### 2. `package/browser.js` (JAVASCRIPT) -> Cumulative Risk: **137.19**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
...
- **Magnitude:** 20.12 | **LOC:** 10 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (13.2389%), Tech Debt (0.0%)
