...
> **File Composition:** Data / Markup / Trivial 60%, Interface Declarations Files 30%, Defensive Guards Files 10%
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 50.0 | 28.6 | 50.0 | 50.0 |
...
- `shimUtilPromisify` **(Interface Declarations)** (@ `package/shim.js`) -> Impact: **2.6** | LOC: 12
- `promisify` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **1.6** | LOC: 4
...
### 1. `package/implementation.js` (JAVASCRIPT) -> Cumulative Risk: **646.05**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.81)
- **Magnitude:** 65.7 | **LOC:** 123 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.8409%), Tech Debt (97.2149%), Cognitive Load (90.5779%)
- **Heaviest Functions:** `promisify` (Defensive Guards, Impact: 23.6), `fn` (Callbacks & Closures, Impact: 8.0), `value` (Interface Declarations, Impact: 1.1)

### 2. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **360.32**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (73.1059%), Safety Score (64.5656%), Stability (50.0%)
- **Heaviest Functions:** `promisify` (Interface Declarations, Impact: 1.6)

### 3. `package/shim.js` (JAVASCRIPT) -> Cumulative Risk: **349.91**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.10)
- **Magnitude:** 6.9 | **LOC:** 18 | **CtrlFlow:** 6.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (64.5656%), State Flux (50.0%), Stability (50.0%)
- **Heaviest Functions:** `shimUtilPromisify` (Interface Declarations, Impact: 2.6)

### 4. `package/polyfill.js` (JAVASCRIPT) -> Cumulative Risk: **338.83**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.00)
- **Magnitude:** 7.48 | **LOC:** 12 | **CtrlFlow:** 22.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (56.3934%), State Flux (50.0%), Stability (50.0%)
- **Heaviest Functions:** `getPolyfill` (Defensive Guards, Impact: 3.3)

### 5. `package/auto.js` (JAVASCRIPT) -> Cumulative Risk: **52.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Magnitude:** 65.7 | **LOC:** 123 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (90.5779%), Tech Debt (97.2149%)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 7.48 | **LOC:** 12 | **CtrlFlow:** 22.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (8.6274%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  * `shimUtilPromisify` **(Interface Declarations)** (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `promisify` **(Interface Declarations)** (Impact: 1.6)
    * *Intent:* /* eslint-disable no-unused-vars */
**Structural Signatures (Net Mitigated Signals):**
