...
- `listenDevicesPollingSkip` **(Interface Declarations)** (@ `package/src/TransportNodeHid.ts`) -> Impact: **3.2** | LOC: 24
...
- **Heaviest Functions:** `poll` (I/O & Config Routines, Impact: 10.9), `attachDetected` (Callbacks & Closures, Impact: 1.9), `detachDetected` (Callbacks & Closures, Impact: 1.8)
...
- **Heaviest Functions:** `listen` (Callbacks & Closures, Impact: 5.3), `onRemove` (Callbacks & Closures, Impact: 4.9), `onAdd` (Callbacks & Closures, Impact: 4.8)
...
**Top Internal Functions/Classes:**
  ...
  * `open` **(Callbacks & Closures)** (Impact: 4.8)
    * *Intent:* /** * if path="" is not provided, the library will take the first device */
  * `listenDevicesPollingSkip` **(Interface Declarations)** (Impact: 3.2)
...
**Top Internal Functions/Classes:**
  ...
  * `getDeviceByPaths` **(Interface Declarations)** (Impact: 1.7)
