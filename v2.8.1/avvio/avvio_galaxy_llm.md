...
> **File Composition:** Data / Markup / Trivial 50%, Large Core Modules 33%, State Mutators Files 17%
...
- **Heaviest Functions:** `Boot` (Many-Argument Workhorses, Impact: 38.6), `closeWithCbOrNextTick` (Defensive Guards, Impact: 27.6), `encapsulateThreeParam` (Defensive Guards, Impact: 27.6)
...
- **Heaviest Functions:** `avvio` (Generic / Templated Code, Impact: 34.5), `avvio` (Interface Declarations, Impact: 2.9), `override` (Generic / Templated Code, Impact: 2.4)
...
- **Heaviest Functions:** `a` (Callbacks & Closures, Impact: 6.2), `b` (Callbacks & Closures, Impact: 6.2), `c` (Callbacks & Closures, Impact: 6.2)
...
**Top Internal Functions/Classes:**
  ...
  * `avvio` **(Interface Declarations)** (Impact: 2.9)
