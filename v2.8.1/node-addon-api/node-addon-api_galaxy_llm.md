...
> **File Composition:** Data / Markup / Trivial 39%, Declarative / Non-Code 39%, Large Core Modules 11%, Defensive Guards Files 6%, Interface Declarations Files 6%
...
- `WrapVoidCallback` **(Many-Argument Workhorses)** (@ `package/napi-inl.h`) -> Impact: **45.0** | LOC: 380
  * *Intent:* #ifdef NODE_ADDON_API_CPP_EXCEPTIONS_ALL
...
- `TypedArrayTypeForPrimitiveType` **(Compute Cores)** (@ `package/napi.h`) -> Impact: **19.4** | LOC: 20
...
- `convertFile` **(Callbacks & Closures)** (@ `package/tools/conversion.js`) -> Impact: **5.7** | LOC: 11
...
- **Heaviest Functions:** `checkFile` (Defensive Guards, Impact: 21.6), `recurse` (Defensive Guards, Impact: 12.6), `checkFileUNIX` (Defensive Guards, Impact: 7.7)
...
- **Heaviest Functions:** `listFiles` (Defensive Guards, Impact: 9.5), `convertFile` (Callbacks & Closures, Impact: 5.7), `convert` (Parameter Forwarders, Impact: 3.8)
...
- **Heaviest Functions:** `WrapCallback` (Many-Argument Workhorses, Impact: 191.1), `WrapVoidCallback` (Many-Argument Workhorses, Impact: 45.0), `AttachData` (Defensive Guards, Impact: 12.5)
...
- **Heaviest Functions:** `TypedArrayTypeForPrimitiveType` (Compute Cores, Impact: 19.4), `asyncprogressworker` (Interface Declarations, Impact: 1.1), `data` (Interface Declarations, Impact: 1.1)
...
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.47)
...
**Top Internal Functions/Classes:**
  * `WrapCallback` **(Many-Argument Workhorses)** (Impact: 191.1)
    * *Intent:* #ifdef NODE_ADDON_API_CPP_EXCEPTIONS_ALL
  * `WrapVoidCallback` **(Many-Argument Workhorses)** (Impact: 45.0)
    * *Intent:* #ifdef NODE_ADDON_API_CPP_EXCEPTIONS_ALL
...
**Top Internal Functions/Classes:**
  * `TypedArrayTypeForPrimitiveType` **(Compute Cores)** (Impact: 19.4)
