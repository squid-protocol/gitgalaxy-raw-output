...
| guards | 86 | 27 | 2 | `base/src/lgipdb01.cbl` |
...
| ui | 52 | 9 | 0 | `base/src/lgtestp1.cbl` |
...
### 1. `base/src/lgicvs01.cbl` (COBOL) -> Cumulative Risk: **549.11**
...
### 2. `base/src/lgacdb01.cbl` (COBOL) -> Cumulative Risk: **539.92**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9859%), Secrets Risk (99.0093%), Safety Score (81.6612%)
...
### 3. `base/src/lgapdb01.cbl` (COBOL) -> Cumulative Risk: **526.11**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9942%), Safety Score (83.9459%), Verification (80.0%)
...
### 4. `base/src/lgipdb01.cbl` (COBOL) -> Cumulative Risk: **523.82**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (90.4906%), Verification (80.0%)
...
### 5. `base/src/lgstsq.cbl` (COBOL) -> Cumulative Risk: **508.68**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
### 6. `base/src/lgtestc1.cbl` (COBOL) -> Cumulative Risk: **492.96**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Cognitive Load (99.3398%), Safety Score (95.1668%)
...
### 7. `base/src/lgapol01.cbl` (COBOL) -> Cumulative Risk: **489.45**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
### 8. `base/src/lgacus01.cbl` (COBOL) -> Cumulative Risk: **483.96**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
### 9. `base/src/lgicus01.cbl` (COBOL) -> Cumulative Risk: **482.57**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
### 10. `base/src/lgdpol01.cbl` (COBOL) -> Cumulative Risk: **478.06**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.93)
- **Magnitude:** 59.02 | **LOC:** 187 | **CtrlFlow:** 7.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9998%), Cognitive Load (90.8631%), Safety Score (89.3997%)
