...
> **File Composition:** Data / Markup / Trivial 50%, Compute Cores Files 25%, Defensive Guards Files 25%
...
- **Heaviest Functions:** `usage` (Compute Cores, Impact: 50.7)
...
- **Heaviest Functions:** `onopen` (Defensive Guards, Impact: 23.4), `validOpts` (Many-Argument Workhorses, Impact: 21.5), `onstatref` (Compute Cores, Impact: 8.9)
