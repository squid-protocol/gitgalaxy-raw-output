...
> **File Composition:** Data / Markup / Trivial 61%, Declarative / Non-Code 28%, Defensive Guards Files 11%
...
- **Heaviest Functions:** `checkString` (Defensive Guards, Impact: 13.3), `runTests` (Callbacks & Closures, Impact: 2.5)
...
- **Heaviest Functions:** `checkFiles` (Defensive Guards, Impact: 11.3), `runTests` (Callbacks & Closures, Impact: 2.5)
