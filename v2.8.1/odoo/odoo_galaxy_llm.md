...
> **File Composition:** Data / Markup / Trivial 48%, Declarative / Non-Code 11%, Interface Declarations Files 11%, Large Core Modules 9%, Callbacks & Closures Files 4%
...
| connectivity | 50008 | 9393 | 5 | `addons/web/static/lib/pdfjs/web/viewer.css` |
...
| threat | 8904 | 2826 | 1 | `addons/web/static/lib/ace/ace.js` |
...
- `DateTime` **(Compute Cores)** (@ `addons/web/static/lib/luxon/luxon.js`) -> Impact: **505.9** | LOC: 2284
...
- `TextInput` **(Compute Cores)** (@ `addons/web/static/lib/ace/ace.js`) -> Impact: **431.0** | LOC: 688
- `Lame` **(Compute Cores)** (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **413.4** | LOC: 1827
- `PsyModel` **(Compute Cores)** (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **380.2** | LOC: 1704
  * *Intent:* */ //package mp3; //import java.util.Arrays;
- `createDOMPurify` **(Compute Cores)** (@ `addons/web/static/lib/dompurify/DOMpurify.js`) -> Impact: **366.9** | LOC: 1259
- `Quantize` **(Compute Cores)** (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **345.6** | LOC: 1432
...
- `attachmentThumbnailToLinkImg` **(Compute Cores)** (@ `addons/mail/static/src/views/web/fields/html_mail_field/convert_inline.js`) -> Impact: **341.2** | LOC: 941
...
- **Heaviest Functions:** `onPropsUpdated` (Defensive Guards, Impact: 10.8), `_delete` (Defensive Guards, Impact: 5.8), `_addNewCondition` (State Mutators, Impact: 5.6)
...
- **Heaviest Functions:** `_offer` (Compute Cores, Impact: 22.8), `on_datachannel` (Compute Cores, Impact: 16.9), `on_message` (Compute Cores, Impact: 16.5)
...
- **Heaviest Functions:** `_toggleTheme` (Many-Argument Workhorses, Impact: 54.8), `prepareRecord` (Compute Cores, Impact: 45.7), `customizeWebsiteColors` (Compute Cores, Impact: 24.3)
...
- **Heaviest Functions:** `add_device` (Compute Cores, Impact: 21.3), `update_iot_devices` (Compute Cores, Impact: 11.1), `remove_device` (Compute Cores, Impact: 7.3)

### 5. `addons/sale_timesheet/models/product_template.py` (PYTHON) -> Cumulative Risk: **760.93**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.90)
- **Magnitude:** 143.38 | **LOC:** 103 | **CtrlFlow:** 38.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9509%)
- **Heaviest Functions:** `_get_onchange_service_policy_updates` (Compute Cores, Impact: 17.5), `write` (Compute Cores, Impact: 12.5), `_onchange_service_fields` (Compute Cores, Impact: 11.8)

### 6. `addons/point_of_sale/static/src/app/services/barcode_reader_service.js` (JAVASCRIPT) -> Cumulative Risk: **757.68**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +0.63)
...
- **Heaviest Functions:** `_scan` (Defensive Guards, Impact: 21.8), `start` (Many-Argument Workhorses, Impact: 12.8), `register` (Callbacks & Closures, Impact: 9.4)

### 7. `odoo/service/server.py` (PYTHON) -> Cumulative Risk: **757.27**
...
- **Heaviest Functions:** `run` (Many-Argument Workhorses, Impact: 38.9), `start` (Compute Cores, Impact: 37.8), `cron_thread` (Compute Cores, Impact: 35.0)

### 8. `addons/web/static/src/views/fields/x2many/x2many_field.js` (JAVASCRIPT) -> Cumulative Risk: **754.7**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
...
- **Heaviest Functions:** `rendererProps` (Callbacks & Closures, Impact: 16.1), `setup` (Callbacks & Closures, Impact: 16.0), `switchToForm` (Defensive Guards, Impact: 12.8)

### 9. `addons/website/static/src/builder/website_builder.js` (JAVASCRIPT) -> Cumulative Risk: **748.75**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
...
- **Heaviest Functions:** `builderProps` (Callbacks & Closures, Impact: 12.3), `discard` (Callbacks & Closures, Impact: 7.9), `setup` (Callbacks & Closures, Impact: 7.0)

### 10. `addons/stock/static/src/fields/stock_move_line_x2_many_field.js` (JAVASCRIPT) -> Cumulative Risk: **747.62**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z +0.98)
...
- **Heaviest Functions:** `updateDirtyQuantsData` (Compute Cores, Impact: 18.1), `onAdd` (Compute Cores, Impact: 14.8), `selectRecord` (Callbacks & Closures, Impact: 6.8)
...
**Top Internal Functions/Classes:**
  ...
  * `TextInput` **(Compute Cores)** (Impact: 431.0)
...
**Top Internal Functions/Classes:**
  ...
  * `guessEncoding` **(Compute Cores)** (Impact: 129.2)
...
**Top Internal Functions/Classes:**
  * `Lame` **(Compute Cores)** (Impact: 413.4)
  * `PsyModel` **(Compute Cores)** (Impact: 380.2)
    * *Intent:* */ //package mp3; //import java.util.Arrays;
  * `Quantize` **(Compute Cores)** (Impact: 345.6)
    * *Intent:* * * You should have received a copy of the GNU Lesser General Public * License along with this libra...
  * `lamejs` **(Compute Cores)** (Impact: 336.4)
...
**Top Internal Functions/Classes:**
  ...
  * `generateTicks$1` **(Compute Cores)** (Impact: 45.0)
  * `_computeGridLineItems` **(Compute Cores)** (Impact: 42.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `onKeyDown` **(Compute Cores)** (Impact: 191.9)
  ...
  * `_getPageAdvance` **(Compute Cores)** (Impact: 65.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
**Top Internal Functions/Classes:**
  ...
  * `callback` **(Tests & Verification)** (Impact: 99.6)
  * `doActionButton` **(Tests & Verification)** (Impact: 83.1)
  * `extractProps` **(Tests & Verification)** (Impact: 67.7)
  * `getServerValue` **(Tests & Verification)** (Impact: 35.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `DateTime` **(Compute Cores)** (Impact: 505.9)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `name` **(Tests & Verification)** (Impact: 44.4)
  * `p` **(Tests & Verification)** (Impact: 40.2)
  * `doActionButton` **(Tests & Verification)** (Impact: 35.0)
  * `getServerValue` **(Tests & Verification)** (Impact: 31.8)
...
**Top Internal Functions/Classes:**
  ...
  * `parseComponent` **(Compute Cores)** (Impact: 78.8)
  * `buildTree` **(Many-Argument Workhorses)** (Impact: 72.9)
  * `compileComponent` **(Compute Cores)** (Impact: 65.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `selectRecord` **(Tests & Verification)** (Impact: 127.5)
  * `selectRecord` **(Tests & Verification)** (Impact: 67.7)
  * `createRecord` **(Tests & Verification)** (Impact: 63.5)
  * `createRecord` **(Tests & Verification)** (Impact: 55.9)
  * `createRecord` **(Tests & Verification)** (Impact: 29.7)
**Contextual Mitigations & Amplifications:**
