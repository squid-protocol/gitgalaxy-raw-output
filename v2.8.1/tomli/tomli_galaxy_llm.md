...
> **File Composition:** Data / Markup / Trivial 60%, Large Core Modules 40%
...
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +4.72)
...
- **Heaviest Functions:** `match_to_datetime` (Type Conversions, Impact: 17.3), `match_to_number` (Type Conversions, Impact: 10.6), `match_to_localtime` (Type Conversions, Impact: 10.1)
