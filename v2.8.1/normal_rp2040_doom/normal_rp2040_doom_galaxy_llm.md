...
> **Composition Archetype:** `Hub-Coupled App` (z +0.32; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 34%, Large Core Modules 31%, Data / Markup / Trivial 11%, Compute Cores Files 10%, Interface Declarations Files 6%
...
- **Heaviest Functions:** `saveg_read_mobj_t` (Compute Cores, Impact: 24.5), `saveg_read_player_t` (Compute Cores, Impact: 18.2), `saveg_write_player_t` (Compute Cores, Impact: 18.2)
...
- **Heaviest Functions:** `P_UnArchiveSpecials` (I/O & Config Routines, Impact: 20.4), `saveg_read_player_t` (Compute Cores, Impact: 20.1), `saveg_write_player_t` (Compute Cores, Impact: 20.1)
...
- **Heaviest Functions:** `lookup_texture` (Compute Cores, Impact: 12.5), `R_InitColormaps` (I/O & Config Routines, Impact: 6.2), `R_DrawColumnInCache` (Encapsulated Accessors, Impact: 4.9)
...
- **Heaviest Functions:** `P_CheckAmmo` (Compute Cores, Impact: 51.2), `A_FireSigil` (Many-Argument Workhorses, Impact: 28.9), `A_WeaponReady` (Compute Cores, Impact: 23.4)
...
- **Heaviest Functions:** `P_NewChaseDir` (Compute Cores, Impact: 54.5), `A_Chase` (Compute Cores, Impact: 50.5), `A_BossDeath` (Compute Cores, Impact: 43.1)

### 6. `src/pico/i_system.c` (C) -> Cumulative Risk: **671.49**
- **Archetype:** `file_cluster_8` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z -1.25)
...
- **Heaviest Functions:** `handle_exit_key_down` (Many-Argument Workhorses, Impact: 133.8), `AutoAllocMemory` (Many-Argument Workhorses, Impact: 41.8), `I_GetMemoryValue` (Many-Argument Workhorses, Impact: 35.9)
...
- **Heaviest Functions:** `P_CheckAmmo` (Compute Cores, Impact: 52.1), `A_WeaponReady` (Compute Cores, Impact: 23.5), `P_SetPsprite` (Many-Argument Workhorses, Impact: 18.4)

### 8. `src/strife/hu_stuff.c` (C) -> Cumulative Risk: **667.27**
- **Archetype:** `file_cluster_8` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.88)
...
- **Heaviest Functions:** `HU_Responder` (Compute Cores, Impact: 69.2), `HU_addMessage` (Many-Argument Workhorses, Impact: 35.1), `HU_Ticker` (Compute Cores, Impact: 24.6)
...
- **Heaviest Functions:** `A_BossDeath` (Compute Cores, Impact: 71.0), `P_NewChaseDir` (Compute Cores, Impact: 54.7), `P_LookForPlayers` (Compute Cores, Impact: 54.5)
...
- **Heaviest Functions:** `SV_MapTeleport` (Many-Argument Workhorses, Impact: 62.3), `StreamOutMobjSpecials` (Compute Cores, Impact: 34.7), `StreamInMobjSpecials` (Compute Cores, Impact: 21.8)
...
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 232.7)
    * *Intent:* #endif
  * `convert_textures` **(Compute Cores)** (Impact: 207.4)
...
**Top Internal Functions/Classes:**
  * `pd_end_frame` **(Compute Cores)** (Impact: 200.8)
...
**Top Internal Functions/Classes:**
  ...
  * `G_Ticker` **(Compute Cores)** (Impact: 77.8)
  ...
  * `G_DoCompleted` **(Compute Cores)** (Impact: 57.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `P_LookForPlayers` **(Compute Cores)** (Impact: 54.5)
...
**Top Internal Functions/Classes:**
  ...
  * `commit_slot_update` **(Compute Cores)** (Impact: 43.2)
  * `calc_envelope` **(Many-Argument Workhorses)** (Impact: 38.0)
...
**Top Internal Functions/Classes:**
  * `P_DamageMobj` **(Many-Argument Workhorses)** (Impact: 318.0)
    * *Intent:* */
  * `P_TouchSpecialThing` **(Compute Cores)** (Impact: 174.9)
    * *Intent:* //--------------------------------------------------------------------------- // // PROC P_TouchSpec...
  * `P_KillMobj` **(Compute Cores)** (Impact: 142.7)
...
**Top Internal Functions/Classes:**
  ...
  * `G_Responder` **(Compute Cores)** (Impact: 68.3)
    * *Intent:* */
  * `G_Ticker` **(Compute Cores)** (Impact: 55.8)
    * *Intent:* //========================================================================== // // G_Ticker // //===...
...
**Top Internal Functions/Classes:**
  ...
  * `G_Ticker` **(Compute Cores)** (Impact: 54.2)
    * *Intent:* // // G_Ticker // Make ticcmd_ts for the players. //
  * `G_CheckSpot` **(Compute Cores)** (Impact: 16.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `StreamInMobjSpecials` **(Compute Cores)** (Impact: 21.8)
    * *Intent:* // // mobj_t //
  * `CopyFile` **(Many-Argument Workhorses)** (Impact: 18.7)
    * *Intent:* //========================================================================== // // CopyFile // // Th...
  * `StreamIn_player_t` **(Compute Cores)** (Impact: 18.2)
    * *Intent:* // // player_t //
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `saveg_write_mobj_t` **(Compute Cores)** (Impact: 97.3)
  * `saveg_read_mobj_t` **(Compute Cores)** (Impact: 77.9)
    * *Intent:* // // mobj_t //
  * `P_SaveGameWriteFlashSlot` **(Many-Argument Workhorses)** (Impact: 33.2)
  * `P_UnArchiveWorld` **(Compute Cores)** (Impact: 31.8)
...
**Top Internal Functions/Classes:**
  ...
  * `G_Responder` **(Compute Cores)** (Impact: 68.3)
    * *Intent:* */
  * `G_Ticker` **(Compute Cores)** (Impact: 52.2)
    * *Intent:* */
...
**Top Internal Functions/Classes:**
  ...
  * `T_PolyDoor` **(Compute Cores)** (Impact: 42.7)
    * *Intent:* //========================================================================== // // T_PolyDoor // //=...
  * `CheckMobjBlocking` **(Compute Cores)** (Impact: 35.9)
...
**Top Internal Functions/Classes:**
  ...
  * `P_UseArtifact` **(Compute Cores)** (Impact: 109.7)
...
**Top Internal Functions/Classes:**
  ...
  * `AM_clipMline` **(Compute Cores)** (Impact: 65.7)
  ...
  * `PUTDOT` **(Many-Argument Workhorses)** (Impact: 37.9)
...
**Top Internal Functions/Classes:**
  ...
  * `M_DrawNetFoyer` **(Compute Cores)** (Impact: 19.2)
