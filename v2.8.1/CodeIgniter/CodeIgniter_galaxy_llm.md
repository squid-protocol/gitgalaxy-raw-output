...
> **File Composition:** Data / Markup / Trivial 30%, Interface Declarations Files 19%, Large Core Modules 19%, Declarative / Non-Code 15%, Compute Cores Files 5%
...
- `create_captcha` **(Compute Cores)** (@ `system/helpers/captcha_helper.php`) -> Impact: **93.8** | LOC: 321
...
- **Heaviest Functions:** `protect_identifiers` (Many-Argument Workhorses, Impact: 95.4), `query` (Many-Argument Workhorses, Impact: 63.0), `escape_identifiers` (Compute Cores, Impact: 32.1)
...
- **Heaviest Functions:** `show_php_error` (Many-Argument Workhorses, Impact: 19.9), `show_error` (Many-Argument Workhorses, Impact: 19.6), `show_exception` (Compute Cores, Impact: 11.8)

### 3. `system/database/drivers/mssql/mssql_driver.php` (PHP) -> Cumulative Risk: **509.13**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.39)
...
- **Heaviest Functions:** `_limit` (Compute Cores, Impact: 19.0), `db_connect` (Compute Cores, Impact: 12.9), `field_data` (Compute Cores, Impact: 6.9)
...
- **Heaviest Functions:** `__construct` (Compute Cores, Impact: 35.0), `field_data` (Compute Cores, Impact: 15.1), `_limit` (Defensive Guards, Impact: 6.4)

### 5. `system/database/drivers/mysqli/mysqli_driver.php` (PHP) -> Cumulative Risk: **502.79**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.64)
...
- **Heaviest Functions:** `db_connect` (Defensive Guards, Impact: 47.0), `field_data` (Compute Cores, Impact: 5.5), `db_select` (Compute Cores, Impact: 5.0)
...
- **Heaviest Functions:** `_like` (Many-Argument Workhorses, Impact: 53.0), `_wh` (Many-Argument Workhorses, Impact: 41.8), `join` (Many-Argument Workhorses, Impact: 41.7)
...
- **Heaviest Functions:** `order_by` (Many-Argument Workhorses, Impact: 13.2), `_update_batch` (Many-Argument Workhorses, Impact: 11.4), `field_data` (Compute Cores, Impact: 6.9)
...
- **Heaviest Functions:** `_limit` (Compute Cores, Impact: 19.0), `__construct` (Defensive Guards, Impact: 12.7), `db_connect` (Defensive Guards, Impact: 8.2)
...
- **Heaviest Functions:** `set_cookie` (Many-Argument Workhorses, Impact: 89.8), `ip_address` (I/O & Config Routines, Impact: 35.4), `_fetch_from_array` (Many-Argument Workhorses, Impact: 28.6)
...
- **Heaviest Functions:** `_uri_to_assoc` (Many-Argument Workhorses, Impact: 24.9), `__construct` (Compute Cores, Impact: 21.7), `_set_uri_string` (Compute Cores, Impact: 20.2)
...
**Top Internal Functions/Classes:**
  ...
  * `compile_binds` **(Compute Cores)** (Impact: 20.1)
...
**Top Internal Functions/Classes:**
  ...
  * `_ci_load` **(Compute Cores)** (Impact: 34.9)
...
**Top Internal Functions/Classes:**
  ...
  * `_attr_default` **(Defensive Guards)** (Impact: 22.5)
    * *Intent:* // -------------------------------------------------------------------- /** * Field attribute DEFAUL...
  * `_create_table` **(Many-Argument Workhorses)** (Impact: 18.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Create Table * * @para...
  * `_attr_unsigned` **(Compute Cores)** (Impact: 17.1)
...
**Top Internal Functions/Classes:**
  ...
  * `entity_decode` **(Compute Cores)** (Impact: 22.9)
...
**Top Internal Functions/Classes:**
  * `_display` **(Compute Cores)** (Impact: 40.4)
  ...
  * `_display_cache` **(Compute Cores)** (Impact: 27.6)
...
**Top Internal Functions/Classes:**
  ...
  * `human_to_unix` **(Compute Cores)** (Impact: 18.7)
...
**Top Internal Functions/Classes:**
  * `word_wrap` **(Compute Cores)** (Impact: 30.0)
...
**Top Internal Functions/Classes:**
  ...
  * `_set_uri_string` **(Compute Cores)** (Impact: 20.2)
    * *Intent:* // -------------------------------------------------------------------- /** * Set URI String * * @pa...
  * `_parse_request_uri` **(Defensive Guards)** (Impact: 15.4)
...
**Top Internal Functions/Classes:**
  ...
  * `get_config` **(Compute Cores)** (Impact: 12.0)
...
**Top Internal Functions/Classes:**
  * `create_captcha` **(Compute Cores)** (Impact: 93.8)
    * *Intent:* /** * Create CAPTCHA * * @param array $data Data for the CAPTCHA * @return array */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `order_by` **(Many-Argument Workhorses)** (Impact: 13.2)
    * *Intent:* // -------------------------------------------------------------------- /** * ORDER BY * * @param st...
  * `insert_id` **(I/O & Config Routines)** (Impact: 11.8)
    * *Intent:* // -------------------------------------------------------------------- /** * Insert ID * * @return ...
  * `_update_batch` **(Many-Argument Workhorses)** (Impact: 11.4)
...
**Top Internal Functions/Classes:**
  ...
  * `ci_set_config` **(Compute Cores)** (Impact: 9.8)
    * *Intent:* // --------------------------------------------------------------------
  * `setExpectedException` **(Many-Argument Workhorses)** (Impact: 8.7)
...
**Top Internal Functions/Classes:**
  * `_limit` **(Compute Cores)** (Impact: 20.8)
    * *Intent:* // -------------------------------------------------------------------- /** * LIMIT * * Generates a ...
  ...
  * `field_data` **(Compute Cores)** (Impact: 6.9)
    * *Intent:* // -------------------------------------------------------------------- /** * Returns an object with...
  * `_insert_batch` **(Encapsulated Accessors)** (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `_limit` **(Compute Cores)** (Impact: 19.0)
    * *Intent:* // -------------------------------------------------------------------- /** * LIMIT * * Generates a ...
