...
> **File Composition:** Parameter Forwarders Files 67%, Data / Markup / Trivial 22%, I/O & Config Routines Files 11%
...
- `g4` **(Many-Argument Workhorses)** (@ `old/pillman0.asm`) -> Impact: **7.5** | LOC: 29
...
- **Heaviest Functions:** `move_ghost` (Many-Argument Workhorses, Impact: 10.9), `g9` (Many-Argument Workhorses, Impact: 8.4), `g4` (Many-Argument Workhorses, Impact: 7.5)

### 2. `pillman.asm` (ASSEMBLY) -> Cumulative Risk: **404.69**
- **Archetype:** `file_cluster_1` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.81)
...
- **Heaviest Functions:** `move_sprite` (Many-Argument Workhorses, Impact: 11.7), `ds4` (Parameter Forwarders, Impact: 7.4), `game_loop` (Parameter Forwarders, Impact: 5.8)
...
- **Heaviest Functions:** `move_sprite` (Many-Argument Workhorses, Impact: 11.5), `ds4` (Parameter Forwarders, Impact: 7.4), `game_loop` (Parameter Forwarders, Impact: 7.0)
...
- **Heaviest Functions:** `move_sprite` (Many-Argument Workhorses, Impact: 11.5), `ds4` (Parameter Forwarders, Impact: 7.4), `clock_wait` (Parameter Forwarders, Impact: 5.8)

### 5. `old/pillman4.asm` (ASSEMBLY) -> Cumulative Risk: **386.72**
- **Archetype:** `file_cluster_1` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.62)
...
- **Heaviest Functions:** `move_sprite` (Many-Argument Workhorses, Impact: 11.5), `ds4` (Parameter Forwarders, Impact: 7.4), `game_loop` (Parameter Forwarders, Impact: 5.8)

### 6. `old/pillman1.asm` (ASSEMBLY) -> Cumulative Risk: **383.11**
- **Archetype:** `file_cluster_1` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +1.06)
...
- **Heaviest Functions:** `move_sprite` (Many-Argument Workhorses, Impact: 11.4), `in2` (Parameter Forwarders, Impact: 7.4), `clock_wait` (Parameter Forwarders, Impact: 5.8)
...
- **Heaviest Functions:** `pillman.com` (I/O & Config Routines, Impact: 1.2), `clean` (I/O & Config Routines, Impact: 1.2), `rundosbox` (I/O & Config Routines, Impact: 1.2)
...
**Top Internal Functions/Classes:**
  ...
  * `g4` **(Many-Argument Workhorses)** (Impact: 7.5)
...
**Top Internal Functions/Classes:**
  ...
  * `ms9` **(Interface Declarations)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `clock_wait` **(Parameter Forwarders)** (Impact: 5.8)
  * `g9` **(Many-Argument Workhorses)** (Impact: 5.8)
  * `ms9` **(Parameter Forwarders)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
