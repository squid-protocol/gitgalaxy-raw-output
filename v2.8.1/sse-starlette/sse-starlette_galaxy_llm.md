...
> **File Composition:** Data / Markup / Trivial 33%, Defensive Guards Files 27%, Interface Declarations Files 20%, Large Core Modules 20%
...
- `encode` **(Compute Cores)** (@ `sse_starlette-3.3.4/sse_starlette/event.py`) -> Impact: **14.1** | LOC: 28
...
- `_stream_response` **(Compute Cores)** (@ `sse_starlette-3.3.4/sse_starlette/sse.py`) -> Impact: **10.0** | LOC: 27
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 46.2), `_stream_response` (Compute Cores, Impact: 10.0), `_ping` (Compute Cores, Impact: 10.0)
...
- **Heaviest Functions:** `encode` (Compute Cores, Impact: 14.1), `__init__` (Generic / Templated Code, Impact: 9.3), `__init__` (Many-Argument Workhorses, Impact: 7.7)
...
- **Heaviest Functions:** `test_response_send_whenValidInput_thenGeneratesExpectedOutput` (Many-Argument Workhorses, Impact: 13.8), `test_eventSourceResponse_whenUsingMemoryChannel_thenHandlesAsyncQueueCorrectly` (Many-Argument Workhorses, Impact: 12.8), `app` (Many-Argument Workhorses, Impact: 11.6)
...
- **Heaviest Functions:** `test_shutdownGracePeriod_whenGeneratorExitsInTime_thenCleanShutdown` (Defensive Guards, Impact: 13.0), `mock_send` (Defensive Guards, Impact: 10.7), `test_shutdownGracePeriod_whenGeneratorIgnoresEvent_thenForceCancelAfterTimeout` (Defensive Guards, Impact: 6.9)

### 5. `sse_starlette-3.3.4/tests/conftest.py` (PYTHON) -> Cumulative Risk: **430.52**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.39)
...
- **Heaviest Functions:** `reset_shutdown_state` (Interface Declarations, Impact: 4.0), `app` (Interface Declarations, Impact: 3.9), `endless` (Defensive Guards, Impact: 3.6)

### 6. `sse_starlette-3.3.4/tests/anyio_compat.py` (PYTHON) -> Cumulative Risk: **395.13**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z -0.56)
...
- **Heaviest Functions:** `collapse_excgroups` (Defensive Guards, Impact: 4.5)

### 7. `sse_starlette-3.3.4/tests/test_multi_loop.py` (PYTHON) -> Cumulative Risk: **391.17**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +2.10)
...
- **Heaviest Functions:** `test_thread_isolation` (Defensive Guards, Impact: 7.4), `test_handle_exit_wakes_multiple_waiting_tasks` (Defensive Guards, Impact: 5.8), `test_all_tasks_share_same_shutdown_state` (Defensive Guards, Impact: 5.3)

### 8. `sse_starlette-3.3.4/tests/test_issue152.py` (PYTHON) -> Cumulative Risk: **378.1**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z -0.91)
...
- **Heaviest Functions:** `test_watcher_broadcasts_to_all_events` (Defensive Guards, Impact: 8.7), `test_single_watcher_per_thread` (Defensive Guards, Impact: 6.3), `test_event_removal_during_broadcast_is_safe` (Defensive Guards, Impact: 5.6)

### 9. `sse_starlette-3.3.4/tests/test_issue132.py` (PYTHON) -> Cumulative Risk: **326.07**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.87)
...
- **Heaviest Functions:** `test_detects_uvicorn_server_should_exit` (Interface Declarations, Impact: 2.7), `test_detects_appstatus_should_exit` (Interface Declarations, Impact: 2.4), `test_fallback_when_no_uvicorn_server` (Interface Declarations, Impact: 2.4)

### 10. `sse_starlette-3.3.4/tests/test_event.py` (PYTHON) -> Cumulative Risk: **289.66**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z -0.60)
...
- **Heaviest Functions:** `test_server_sent_event` (Defensive Guards, Impact: 5.5), `test_multiline_data` (Defensive Guards, Impact: 2.2), `test_json_server_sent_event` (Defensive Guards, Impact: 1.8)
...
**Top Internal Functions/Classes:**
  ...
  * `test_all_tasks_share_same_shutdown_state` **(Defensive Guards)** (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  * `test_detects_uvicorn_server_should_exit` **(Interface Declarations)** (Impact: 2.7)
    * *Intent:* """Should detect when uvicorn Server.should_exit is set (Issue #132)."""
  * `test_detects_appstatus_should_exit` **(Interface Declarations)** (Impact: 2.4)
    * *Intent:* """Should detect when AppStatus.should_exit is set (monkey-patch worked)."""
  * `test_fallback_when_no_uvicorn_server` **(Interface Declarations)** (Impact: 2.4)
    * *Intent:* """Should work when _get_uvicorn_server returns None."""
  * `test_returns_server_when_handler_is_bound_method` **(Tests & Verification)** (Impact: 2.0)
    * *Intent:* """Should extract Server from bound method handler."""
  * `test_returns_none_when_self_lacks_should_exit` **(Tests & Verification)** (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `reset_shutdown_state` **(Interface Declarations)** (Impact: 4.0)
  ...
  * `httpx_client` **(Interface Declarations)** (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Generic / Templated Code)** (Impact: 9.3)
