...
### 1. `prepare_release.sh` (SHELL) -> Cumulative Risk: **176.55**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.53)
- **Magnitude:** 8.2 | **LOC:** 13 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (91.0053%), State Flux (83.2018%), Verification (2.3419%)
