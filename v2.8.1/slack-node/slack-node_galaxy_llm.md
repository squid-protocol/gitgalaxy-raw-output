...
### 1. `package/example/api.postMessage.js` (JAVASCRIPT) -> Cumulative Risk: **218.99**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.18)
- **Magnitude:** 25.24 | **LOC:** 16 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (98.7872%), Safety Score (70.2063%), Stability (50.0%)

### 2. `package/example/emoji.js` (JAVASCRIPT) -> Cumulative Risk: **120.21**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.04)
- **Magnitude:** 19.4 | **LOC:** 26 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (70.2063%), Stability (50.0%)

### 3. `package/example/webhook.js` (JAVASCRIPT) -> Cumulative Risk: **120.21**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
