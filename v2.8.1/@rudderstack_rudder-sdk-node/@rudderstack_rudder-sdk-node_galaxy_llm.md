...
> **File Composition:** Data / Markup / Trivial 42%, State Mutators Files 25%, Callbacks & Closures Files 17%, Interface Declarations Files 8%, Large Core Modules 8%
...
- **Heaviest Functions:** `createPersistenceQueue` (Compute Cores, Impact: 16.2), `identify` (Compute Cores, Impact: 14.3), `group` (Compute Cores, Impact: 14.3)
...
- **Heaviest Functions:** `formatLogData` (Defensive Guards, Impact: 9.6), `outputLog` (Callbacks & Closures, Impact: 3.8), `Logger` (Defensive Guards, Impact: 3.1)
...
- **Heaviest Functions:** `constructor` (State Mutators, Impact: 2.9), `outputLog` (Parameter Forwarders, Impact: 1.8), `formatLogData` (State Mutators, Impact: 1.8)
...
- **Heaviest Functions:** `createPersistenceQueue` (Compute Cores, Impact: 19.9), `constructor` (State Mutators, Impact: 3.5), `identify` (State Mutators, Impact: 3.5)
...
- **Heaviest Functions:** `looselyValidateEvent` (Compute Cores, Impact: 18.4), `validateGenericEvent` (Defensive Guards, Impact: 6.5), `validateTrackEvent` (State Mutators, Impact: 3.0)
...
- **Heaviest Functions:** `looselyValidateEvent` (Parameter Forwarders, Impact: 1.8)
...
**Top Internal Functions/Classes:**
  ...
  * `identify` **(State Mutators)** (Impact: 3.5)
    * *Intent:* /** * Send an identify `message`. * * @param {Object} message * @param {String=} message.userId (opt...
  * `group` **(State Mutators)** (Impact: 3.5)
    * *Intent:* /** * Send a group `message`. * * @param {Object} message * @param {String} message.groupId * @param...
  * `track` **(State Mutators)** (Impact: 3.5)
    * *Intent:* /** * Send a track `message`. * * @param {Object} message * @param {String} message.event * @param {...
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `log` **(Interface Declarations)** (Impact: 1.5)
  * `info` **(Interface Declarations)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
