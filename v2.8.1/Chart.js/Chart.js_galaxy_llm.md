...
> **File Composition:** Declarative / Non-Code 51%, Data / Markup / Trivial 20%, Callbacks & Closures Files 11%, Large Core Modules 5%, Interface Declarations Files 4%
...
- `_computeLabelItems` **(Compute Cores)** (@ `src/core/core.scale.js`) -> Impact: **96.8** | LOC: 183
  * *Intent:* /** * @private */
...
- `_computeGridLineItems` **(Compute Cores)** (@ `src/core/core.scale.js`) -> Impact: **43.3** | LOC: 130
  * *Intent:* /** * @private */
...
- **Heaviest Functions:** `color` (Compute Cores, Impact: 12.3), `constructor` (Many-Argument Workhorses, Impact: 12.1), `tick` (Compute Cores, Impact: 11.3)
...
- **Heaviest Functions:** `_createAnimations` (Compute Cores, Impact: 21.2), `configure` (Callbacks & Closures, Impact: 12.6), `resolveTargetOptions` (Compute Cores, Impact: 7.7)
...
- **Heaviest Functions:** `getMaximumSize` (Many-Argument Workhorses, Impact: 35.4), `retinaScale` (Many-Argument Workhorses, Impact: 21.8), `getContainerSize` (Many-Argument Workhorses, Impact: 17.3)
...
- **Heaviest Functions:** `_computeLabelItems` (Compute Cores, Impact: 96.8), `_computeGridLineItems` (Compute Cores, Impact: 43.3), `_getYAxisLabelAlignment` (Defensive Guards, Impact: 38.7)
...
- **Heaviest Functions:** `minMaxDecimation` (Many-Argument Workhorses, Impact: 37.2), `beforeElementsUpdate` (Many-Argument Workhorses, Impact: 24.6), `lttbDecimation` (Many-Argument Workhorses, Impact: 21.0)
...
- **Heaviest Functions:** `_getStartAndCountOfVisiblePoints` (Many-Argument Workhorses, Impact: 24.4), `_textX` (Callbacks & Closures, Impact: 9.4), `_scaleRangesChanged` (Compute Cores, Impact: 8.1)
...
- **Heaviest Functions:** `addIfString` (Defensive Guards, Impact: 9.4), `parse` (Defensive Guards, Impact: 7.4), `findOrAddLabel` (Defensive Guards, Impact: 7.1)
...
- **Heaviest Functions:** `fill` (Compute Cores, Impact: 17.5), `clipBounds` (Many-Argument Workhorses, Impact: 17.3), `clipVertical` (Many-Argument Workhorses, Impact: 13.4)
...
- **Heaviest Functions:** `_draw` (I/O & Config Routines, Impact: 32.8), `drawLegendBox` (Many-Argument Workhorses, Impact: 25.1), `handleEvent` (Defensive Guards, Impact: 15.4)
...
- **Heaviest Functions:** `generateTicks` (Many-Argument Workhorses, Impact: 75.3), `setMax` (Defensive Guards, Impact: 16.8), `handleTickRangeOptions` (Defensive Guards, Impact: 13.6)
...
**Top Internal Functions/Classes:**
  * `_computeLabelItems` **(Compute Cores)** (Impact: 96.8)
    * *Intent:* /** * @private */
  * `_computeGridLineItems` **(Compute Cores)** (Impact: 43.3)
    * *Intent:* /** * @private */
...
**Top Internal Functions/Classes:**
  ...
  * `buildOrUpdateScales` **(Callbacks & Closures)** (Impact: 15.2)
    * *Intent:* /** * Builds a map of scale ID to scale object for future lookup. */
  * `_resize` **(Compute Cores)** (Impact: 13.4)
  * `updateHoverStyle` **(Many-Argument Workhorses)** (Impact: 12.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_calculateBarValuePixels` **(Compute Cores)** (Impact: 26.1)
...
**Top Internal Functions/Classes:**
  ...
  * `determineLimits` **(Many-Argument Workhorses)** (Impact: 15.6)
...
**Top Internal Functions/Classes:**
  * `_tickFormatFunction` **(Many-Argument Workhorses)** (Impact: 21.0)
...
**Top Internal Functions/Classes:**
  ...
  * `addStyle` **(Many-Argument Workhorses)** (Impact: 14.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `getRatioAndOffset` **(Many-Argument Workhorses)** (Impact: 9.3)
...
**Top Internal Functions/Classes:**
  ...
  * `getPositionedStyle` **(Compute Cores)** (Impact: 10.6)
...
**Top Internal Functions/Classes:**
  * `getContext` **(Tests & Verification)** (Impact: 18.5)
  * `testSlice` **(Defensive Guards)** (Impact: 8.4)
  * `recursive` **(Tests & Verification)** (Impact: 6.7)
...
**Top Internal Functions/Classes:**
  * `color` **(Tests & Verification)** (Impact: 7.3)
  * `iterateOptions` **(State Mutators)** (Impact: 2.3)
  * `onResize` **(State Mutators)** (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  ...
  * `cleanDecimatedDataset` **(Interface Declarations)** (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
