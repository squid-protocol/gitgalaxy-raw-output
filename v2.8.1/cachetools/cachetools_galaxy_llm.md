...
> **File Composition:** Large Core Modules 45%, Interface Declarations Files 15%, Data / Markup / Trivial 10%, Parameter Forwarders Files 10%, Callbacks & Closures Files 5%
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 87.1 | 100.0 | 100.0 |
...
- `_wrapper` **(Many-Argument Workhorses)** (@ `cachetools-7.0.5/src/cachetools/_cachedmethod.py`) -> Impact: **41.0** | LOC: 27
- `__get__` **(Defensive Guards)** (@ `cachetools-7.0.5/src/cachetools/_cachedmethod.py`) -> Impact: **21.9** | LOC: 39
- `__init__` **(Many-Argument Workhorses)** (@ `cachetools-7.0.5/src/cachetools/_cachedmethod.py`) -> Impact: **17.4** | LOC: 9
- `expire` **(Compute Cores)** (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **16.7** | LOC: 23
  * *Intent:* """Remove expired items from the cache and return an iterable of the expired `(key, value)` pairs. """
- `cached` **(Many-Argument Workhorses)** (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **16.1** | LOC: 29
...
### 1. `cachetools-7.0.5/src/cachetools/__init__.py` (PYTHON) -> Cumulative Risk: **700.76**
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.3082%), Tech Debt (94.8231%)
- **Heaviest Functions:** `expire` (Compute Cores, Impact: 16.7), `cached` (Many-Argument Workhorses, Impact: 16.1), `cachedmethod` (Defensive Guards, Impact: 15.8)

### 2. `cachetools-7.0.5/src/cachetools/_cached.py` (PYTHON) -> Cumulative Risk: **661.16**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.72)
- **Magnitude:** 232.16 | **LOC:** 260 | **CtrlFlow:** 7.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.415%)
- **Heaviest Functions:** `_wrapper` (Many-Argument Workhorses, Impact: 46.5), `_condition_info` (Many-Argument Workhorses, Impact: 4.7), `_locked_info` (Many-Argument Workhorses, Impact: 4.2)

### 3. `cachetools-7.0.5/src/cachetools/_cachedmethod.py` (PYTHON) -> Cumulative Risk: **651.95**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z -0.33)
- **Magnitude:** 364.82 | **LOC:** 420 | **CtrlFlow:** 9.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Tech Debt (99.8275%)
- **Heaviest Functions:** `_wrapper` (Many-Argument Workhorses, Impact: 41.0), `__get__` (Defensive Guards, Impact: 21.9), `__init__` (Many-Argument Workhorses, Impact: 17.4)

### 4. `cachetools-7.0.5/src/cachetools/func.py` (PYTHON) -> Cumulative Risk: **519.4**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.022%), Verification (80.0%), Safety Score (73.0548%)
- **Heaviest Functions:** `ttl_cache` (Many-Argument Workhorses, Impact: 9.5), `rr_cache` (Compute Cores, Impact: 8.6), `fifo_cache` (Compute Cores, Impact: 7.5)

### 5. `cachetools-7.0.5/tests/test_threading.py` (PYTHON) -> Cumulative Risk: **486.89**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +2.85)
- **Magnitude:** 67.52 | **LOC:** 63 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (78.3421%)
- **Heaviest Functions:** `test_cached_stampede` (Compute Cores, Impact: 6.3), `test_cachedmethod_stampede` (Compute Cores, Impact: 6.3), `func` (Interface Declarations, Impact: 3.4)

### 6. `cachetools-7.0.5/src/cachetools/keys.py` (PYTHON) -> Cumulative Risk: **478.05**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.58)
- **Magnitude:** 58.96 | **LOC:** 67 | **CtrlFlow:** 21.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (89.3377%), Stability (50.0%)
- **Heaviest Functions:** `typedkey` (Type Conversions, Impact: 9.2), `hashkey` (Type Conversions, Impact: 5.5), `__hash__` (Encapsulated Accessors, Impact: 3.7)

### 7. `cachetools-7.0.5/tests/test_classmethod.py` (PYTHON) -> Cumulative Risk: **430.56**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.19)
- **Magnitude:** 82.42 | **LOC:** 152 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.7393%), Safety Score (70.329%)
- **Heaviest Functions:** `test` (Interface Declarations, Impact: 2.7), `test_typed` (Interface Declarations, Impact: 2.6), `test_locked` (Interface Declarations, Impact: 2.0)

### 8. `cachetools-7.0.5/tests/test_lfu.py` (PYTHON) -> Cumulative Risk: **381.64**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.42)
- **Magnitude:** 45.7 | **LOC:** 91 | **CtrlFlow:** 3.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (84.4765%), Stability (50.0%)
- **Heaviest Functions:** `test_lfu` (Compute Cores, Impact: 5.3), `test_lfu_clear` (State Mutators, Impact: 2.6), `test_lfu_getsizeof` (Callbacks & Closures, Impact: 2.5)

### 9. `cachetools-7.0.5/tests/__init__.py` (PYTHON) -> Cumulative Risk: **377.38**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.12)
- **Magnitude:** 191.16 | **LOC:** 384 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (85.6036%), Stability (50.0%)
- **Heaviest Functions:** `test_missing` (Compute Cores, Impact: 15.6), `test_pickle` (Compute Cores, Impact: 6.9), `test_insert` (Compute Cores, Impact: 6.5)

### 10. `cachetools-7.0.5/tests/test_tlru.py` (PYTHON) -> Cumulative Risk: **364.91**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.19)
- **Magnitude:** 127.04 | **LOC:** 330 | **CtrlFlow:** 0.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (78.5477%), Stability (50.0%)
- **Heaviest Functions:** `test_ttu` (Type Conversions, Impact: 5.2), `test_ttu_heap_cleanup` (State Mutators, Impact: 4.2), `test_ttu_expire` (Type Conversions, Impact: 3.9)
...
- **Magnitude:** 818.28 | **LOC:** 773 | **CtrlFlow:** 13.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (46.0089%), Tech Debt (94.8231%)
**Top Internal Functions/Classes:**
  * `expire` **(Compute Cores)** (Impact: 16.7)
    * *Intent:* """Remove expired items from the cache and return an iterable of the expired `(key, value)` pairs. "...
  * `cached` **(Many-Argument Workhorses)** (Impact: 16.1)
    * *Intent:* """Decorator to wrap a function with a memoizing callable that saves results in a cache. """
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 364.82 | **LOC:** 420 | **CtrlFlow:** 9.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (84.5024%), Tech Debt (99.8275%)
**Top Internal Functions/Classes:**
  * `_wrapper` **(Many-Argument Workhorses)** (Impact: 41.0)
  * `__get__` **(Defensive Guards)** (Impact: 21.9)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 17.4)
  * `__set_name__` **(Compute Cores)** (Impact: 8.4)
  * `_condition_info` **(Many-Argument Workhorses)** (Impact: 4.9)
...
- **Risk Profile:** Cognitive Load (17.1249%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_decorator_cond_info` **(I/O & Config Routines)** (Impact: 6.7)
  * `test_decorator_lock_cond_info` **(I/O & Config Routines)** (Impact: 6.7)
  * `test_decorator_lock_info` **(Compute Cores)** (Impact: 6.3)
  * `test_decorator_info` **(Compute Cores)** (Impact: 5.5)
  * `test_decorator_immutable_dict` **(Callbacks & Closures)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 232.16 | **LOC:** 260 | **CtrlFlow:** 7.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (82.8021%), Tech Debt (99.415%)
**Top Internal Functions/Classes:**
  * `_wrapper` **(Many-Argument Workhorses)** (Impact: 46.5)
  * `_condition_info` **(Many-Argument Workhorses)** (Impact: 4.7)
    * *Intent:* # At least for now, the implementation prefers clarity and performance # over ease of maintenance, t...
  * `_locked_info` **(Many-Argument Workhorses)** (Impact: 4.2)
  * `_condition` **(Defensive Guards)** (Impact: 4.0)
  * `_unlocked_info` **(Defensive Guards)** (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 16 instances
...
- **Magnitude:** 191.16 | **LOC:** 384 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (31.2485%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_missing` **(Compute Cores)** (Impact: 15.6)
  * `test_pickle` **(Compute Cores)** (Impact: 6.9)
  * `test_insert` **(Compute Cores)** (Impact: 6.5)
  * `test_pickle_maxsize` **(Interface Declarations)** (Impact: 4.8)
  * `_test_getsizeof` **(Many-Argument Workhorses)** (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (17.9103%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `test_decorator_lock_info` **(State Mutators)** (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 127.04 | **LOC:** 330 | **CtrlFlow:** 0.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (27.0266%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_ttu` **(Type Conversions)** (Impact: 5.2)
  * `test_ttu_heap_cleanup` **(State Mutators)** (Impact: 4.2)
  * `test_ttu_expire` **(Type Conversions)** (Impact: 3.9)
  * `__call__` **(Interface Declarations)** (Impact: 3.0)
  * `test_ttu_lru` **(State Mutators)** (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test` **(Interface Declarations)** (Impact: 2.7)
  * `test_typed` **(Interface Declarations)** (Impact: 2.6)
  * `test_locked` **(Interface Declarations)** (Impact: 2.0)
  * `test_condition` **(Interface Declarations)** (Impact: 2.0)
  * `test_clear` **(Interface Declarations)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 76.44 | **LOC:** 106 | **CtrlFlow:** 29.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (26.9696%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ttl_cache` **(Many-Argument Workhorses)** (Impact: 9.5)
...
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 67.52 | **LOC:** 63 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.9347%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_cached_stampede` **(Compute Cores)** (Impact: 6.3)
  * `test_cachedmethod_stampede` **(Compute Cores)** (Impact: 6.3)
  * `func` **(Interface Declarations)** (Impact: 3.4)
  * `meth` **(Interface Declarations)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 58.96 | **LOC:** 67 | **CtrlFlow:** 21.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (43.2836%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (12.3579%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_decorator_needs_rlock` **(Callbacks & Closures)** (Impact: 4.2)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 45.7 | **LOC:** 91 | **CtrlFlow:** 3.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (39.2431%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_lfu` **(Compute Cores)** (Impact: 5.3)
  * `test_lfu_clear` **(State Mutators)** (Impact: 2.6)
  * `test_lfu_getsizeof` **(Callbacks & Closures)** (Impact: 2.5)
  * `test_lfu_update_existing` **(Interface Declarations)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_rr` **(State Mutators)** (Impact: 2.6)
  * `test_rr_getsizeof` **(Callbacks & Closures)** (Impact: 2.5)
  * `test_rr_bad_choice` **(Interface Declarations)** (Impact: 2.1)
  * `test_rr_update_existing` **(Interface Declarations)** (Impact: 2.0)
  * `test_rr_default_choice` **(Tests & Verification)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_lru` **(State Mutators)** (Impact: 2.6)
  * `test_lru_getsizeof` **(Callbacks & Closures)** (Impact: 2.5)
  * `test_lru_clear` **(State Mutators)** (Impact: 2.4)
  * `test_lru_update_existing` **(Interface Declarations)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_fifo` **(State Mutators)** (Impact: 2.6)
  * `test_fifo_getsizeof` **(Callbacks & Closures)** (Impact: 2.5)
  * `test_fifo_update_existing` **(Interface Declarations)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (11.4804%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
