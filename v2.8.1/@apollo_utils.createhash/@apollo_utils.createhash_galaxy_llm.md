...
- `createHash` **(Interface Declarations)** (@ `package/src/index.ts`) -> Impact: **4.9** | LOC: 14
...
### 1. `package/src/index.ts` (TYPESCRIPT) -> Cumulative Risk: **311.4**
...
- **Heaviest Functions:** `createHash` (Interface Declarations, Impact: 4.9)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 6.04 | **LOC:** 17 | **CtrlFlow:** 28.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (5.5201%), Tech Debt (50.0%)
**Top Internal Functions/Classes:**
  * `createHash` **(Interface Declarations)** (Impact: 4.9)
**Structural Signatures (Net Mitigated Signals):**
