...
> **Composition Archetype:** `Small Flat Repo` (z +0.22; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 58%, Data / Markup / Trivial 16%, Many-Argument Workhorses Files 9%, Defensive Guards Files 7%, Large Core Modules 5%
...
- **Heaviest Functions:** `ndarray_upcast_dtype` (Compute Cores, Impact: 43.1), `ulab_tools_inspect_out` (Many-Argument Workhorses, Impact: 20.9), `ndarray_get_float_index` (Defensive Guards, Impact: 18.7)
...
- **Heaviest Functions:** `ndarray_unary_op` (Many-Argument Workhorses, Impact: 214.8), `ndarray_binary_op` (Many-Argument Workhorses, Impact: 210.9), `ndarray_assign_from_boolean_index` (Many-Argument Workhorses, Impact: 137.6)
...
- **Heaviest Functions:** `run_tests` (Many-Argument Workhorses, Impact: 159.4), `run_micropython` (Many-Argument Workhorses, Impact: 103.8), `run_one_test` (Compute Cores, Impact: 47.6)

### 4. `code/numpy/create.c` (C) -> Cumulative Risk: **633.67**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z +1.02)
...
- **Heaviest Functions:** `create_take` (Many-Argument Workhorses, Impact: 111.5), `create_meshgrid` (Many-Argument Workhorses, Impact: 84.0), `create_concatenate` (Many-Argument Workhorses, Impact: 67.7)

### 5. `code/ndarray_properties.c` (C) -> Cumulative Risk: **609.07**
- **Archetype:** `file_cluster_7` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z -0.42)
...
- **Heaviest Functions:** `ndarray_properties_attr` (Many-Argument Workhorses, Impact: 67.9)
...
- **Heaviest Functions:** `ndarray_binary_more` (Many-Argument Workhorses, Impact: 326.7), `ndarray_binary_logical` (Many-Argument Workhorses, Impact: 294.9), `ndarray_binary_equality` (Many-Argument Workhorses, Impact: 243.8)
...
- **Heaviest Functions:** `carray_binary_subtract` (Many-Argument Workhorses, Impact: 108.3), `carray_binary_equal_not_equal` (Many-Argument Workhorses, Impact: 92.5), `carray_binary_add` (Many-Argument Workhorses, Impact: 84.5)
...
- **Heaviest Functions:** `__getitem__` (Defensive Guards, Impact: 28.9), `__len__` (Interface Declarations, Impact: 1.5)

### 9. `code/numpy/ndarray/ndarray_iter.c` (C) -> Cumulative Risk: **573.83**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.13)
...
- **Heaviest Functions:** `ndarray_flatiter_next` (Defensive Guards, Impact: 6.6), `ndarray_new_flatiterator` (Defensive Guards, Impact: 2.2), `ndarray_get_flatiterator` (Parameter Forwarders, Impact: 1.9)
...
- **Heaviest Functions:** `numerical_sum_mean_std_ndarray` (Many-Argument Workhorses, Impact: 126.4), `numerical_all_any` (Many-Argument Workhorses, Impact: 125.6), `numerical_argmin_argmax_ndarray` (Many-Argument Workhorses, Impact: 92.8)
...
**Top Internal Functions/Classes:**
  ...
  * `create_logspace` **(Defensive Guards)** (Impact: 40.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `io_save` **(Compute Cores)** (Impact: 43.4)
...
**Top Internal Functions/Classes:**
  ...
  * `convert_regex_escapes` **(Compute Cores)** (Impact: 10.7)
...
**Top Internal Functions/Classes:**
  ...
  * `vector_generic_vector` **(Compute Cores)** (Impact: 29.9)
    * *Intent:* #else
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `integrate_tanhsinh` **(Many-Argument Workhorses)** (Impact: 14.1)
...
**Top Internal Functions/Classes:**
  ...
  * `transform_size` **(Many-Argument Workhorses)** (Impact: 13.7)
...
**Top Internal Functions/Classes:**
  ...
  * `utils_from_int16_buffer` **(Defensive Guards)** (Impact: 2.1)
    * *Intent:* #ifdef ULAB_UTILS_HAS_FROM_INT16_BUFFER
  * `utils_from_uint16_buffer` **(Defensive Guards)** (Impact: 2.1)
    * *Intent:* #endif #ifdef ULAB_UTILS_HAS_FROM_UINT16_BUFFER
  * `utils_from_int32_buffer` **(Defensive Guards)** (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  ...
  * `random_uniform` **(Many-Argument Workhorses)** (Impact: 22.6)
...
**Top Internal Functions/Classes:**
  ...
  * `optimize_bisect` **(Many-Argument Workhorses)** (Impact: 20.2)
  ...
  * `optimize_newton` **(Many-Argument Workhorses)** (Impact: 13.9)
    * *Intent:* //| ) -> float: //| """ //| :param callable f: The function to bisect //| :param float x0: The initi...
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `poly_eval` **(Encapsulated Accessors)** (Impact: 4.4)
