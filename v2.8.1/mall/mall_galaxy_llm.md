...
> **Composition Archetype:** `Flat Modular Platform` (z +0.99; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 26%, Annotated Framework Methods Files 18%, Interface Declarations Files 15%, State Mutators Files 14%, Large Core Modules 12%
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 53.0 | 92.9 | 100.0 |
...
- `getCouponOrderItemByRelation` **(Compute Cores)** (@ `mall-portal/src/main/java/com/macro/mall/portal/service/impl/OmsPortalOrderServiceImpl.java`) -> Impact: **33.5** | LOC: 29
...
- **Heaviest Functions:** `updateRole` (Generic / Templated Code, Impact: 11.4), `update` (Compute Cores, Impact: 9.6), `login` (Defensive Guards, Impact: 8.0)
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.35)
...
- **Heaviest Functions:** `updateStatus` (Compute Cores, Impact: 13.7), `list` (Annotated Framework Methods, Impact: 2.2), `delete` (Annotated Framework Methods, Impact: 1.7)

### 3. `mall-admin/src/main/java/com/macro/mall/service/impl/OmsOrderServiceImpl.java` (JAVA) -> Cumulative Risk: **574.94**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.64)
...
- **Heaviest Functions:** `close` (Generic / Templated Code, Impact: 4.4), `updateNote` (Annotated Framework Methods, Impact: 2.8), `updateReceiverInfo` (Annotated Framework Methods, Impact: 2.6)
...
- **Composition Archetype:** `Large Core Modules` (z +1.83)
...
- **Heaviest Functions:** `Criterion` (Defensive Guards, Impact: 8.6), `addCriterion` (Encapsulated Accessors, Impact: 7.0), `addCriterion` (Encapsulated Accessors, Impact: 6.3)

### 5. `mall-mbg/src/main/java/com/macro/mall/model/CmsPrefrenceAreaProductRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +1.82)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Defensive Guards, Impact: 8.6), `addCriterion` (Encapsulated Accessors, Impact: 7.0), `addCriterion` (Encapsulated Accessors, Impact: 6.3)
...
**Top Internal Functions/Classes:**
  * `Criterion` **(Defensive Guards)** (Impact: 8.6)
  * `addCriterion` **(Encapsulated Accessors)** (Impact: 7.0)
  * `addCriterion` **(Encapsulated Accessors)** (Impact: 6.3)
  * `addCriterion` **(Interface Declarations)** (Impact: 4.5)
  * `Criterion` **(State Mutators)** (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  * `addCriterionForJDBCDate` **(Generic / Templated Code)** (Impact: 8.6)
  * `Criterion` **(Defensive Guards)** (Impact: 8.6)
  * `addCriterion` **(Encapsulated Accessors)** (Impact: 7.0)
...
**Top Internal Functions/Classes:**
  ...
  * `getCouponOrderItemByRelation` **(Compute Cores)** (Impact: 33.5)
  ...
  * `getUseIntegrationAmount` **(Many-Argument Workhorses)** (Impact: 12.4)
