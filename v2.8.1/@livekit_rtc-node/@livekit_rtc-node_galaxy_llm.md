...
> **Composition Archetype:** `Small Flat Repo` (z +0.15; from the repo's file-archetype mix)
> **File Composition:** Interface Declarations Files 18%, Large Core Modules 16%, Data / Markup / Trivial 13%, Declarative / Non-Code 13%, Generic / Templated Code Files 13%
...
- `processFfiEvent` **(Compute Cores)** (@ `package/src/room.ts`) -> Impact: **212.9** | LOC: 298
...
- **Composition Archetype:** `Defensive Guards Files` (z +1.11)
...
- **Heaviest Functions:** `close` (Defensive Guards, Impact: 4.5), `close` (Defensive Guards, Impact: 4.5), `createAudioTrack` (Generic / Templated Code, Impact: 4.1)
...
- **Heaviest Functions:** `processFfiEvent` (Compute Cores, Impact: 212.9), `handleStreamHeader` (Defensive Guards, Impact: 41.6), `connect` (Many-Argument Workhorses, Impact: 34.8)
...
- **Heaviest Functions:** `captureFrame` (Compute Cores, Impact: 14.7), `constructor` (Many-Argument Workhorses, Impact: 5.2), `clearQueue` (I/O & Config Routines, Impact: 2.8)
...
- **Heaviest Functions:** `getContribution` (Compute Cores, Impact: 25.1), `mixAudio` (Compute Cores, Impact: 21.5), `mixer` (I/O & Config Routines, Impact: 20.4)
...
- **Heaviest Functions:** `streamBytes` (Defensive Guards, Impact: 41.7), `streamText` (Defensive Guards, Impact: 32.6), `handleRpcMethodInvocation` (Many-Argument Workhorses, Impact: 31.4)
...
- **Heaviest Functions:** `captureFrame` (Many-Argument Workhorses, Impact: 7.0), `constructor` (Defensive Guards, Impact: 6.3), `close` (State Mutators, Impact: 1.2)
...
- **Heaviest Functions:** `constructor` (Many-Argument Workhorses, Impact: 38.2), `onEvent` (Defensive Guards, Impact: 18.6), `constructor` (State Mutators, Impact: 6.3)

### 8. `package/src/async_queue.ts` (TYPESCRIPT) -> Cumulative Risk: **587.77**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.31)
...
- **Heaviest Functions:** `put` (Compute Cores, Impact: 8.0), `waitForItem` (Interface Declarations, Impact: 3.3), `get` (Interface Declarations, Impact: 2.4)
...
- **Heaviest Functions:** `constructor` (Generic / Templated Code, Impact: 4.3), `close` (Interface Declarations, Impact: 2.2), `write` (Interface Declarations, Impact: 1.6)

### 10. `package/src/data_streams/stream_reader.ts` (TYPESCRIPT) -> Cumulative Risk: **577.9**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.42)
...
- **Heaviest Functions:** `handleChunkReceived` (Defensive Guards, Impact: 7.7), `handleChunkReceived` (Defensive Guards, Impact: 4.6), `[Symbol.asyncIterator]` (Interface Declarations, Impact: 4.5)
...
**Top Internal Functions/Classes:**
  * `processFfiEvent` **(Compute Cores)** (Impact: 212.9)
  ...
  * `requireParticipantByIdentity` **(Defensive Guards)** (Impact: 8.9)
...
**Top Internal Functions/Classes:**
  ...
  * `mixAudio` **(Compute Cores)** (Impact: 21.5)
  ...
  * `getNextFrame` **(Interface Declarations)** (Impact: 6.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `handleChunkReceived` **(Defensive Guards)** (Impact: 7.7)
  * `handleChunkReceived` **(Defensive Guards)** (Impact: 4.6)
  * `[Symbol.asyncIterator]` **(Interface Declarations)** (Impact: 4.5)
    * *Intent:* /** * Async iterator implementation to allow usage of `for await...of` syntax. * Yields structured c...
  * `constructor` **(State Mutators)** (Impact: 4.4)
...
**Top Internal Functions/Classes:**
  ...
  * `exportKey` **(Compute Cores)** (Impact: 6.2)
  * `ratchetKey` **(Compute Cores)** (Impact: 6.2)
...
**Top Internal Functions/Classes:**
  ...
  * `protoInfo` **(I/O & Config Routines)** (Impact: 9.3)
    * *Intent:* /** @internal */
  * `getPlane` **(Interface Declarations)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `constructor` **(State Mutators)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `constructor` **(Many-Argument Workhorses)** (Impact: 3.1)
  ...
  * `fromOwnedInfo` **(Interface Declarations)** (Impact: 2.0)
    * *Intent:* /** @internal */
...
**Top Internal Functions/Classes:**
  ...
  * `dispose` **(Annotated Framework Methods)** (Impact: 4.9)
  * `livekit_copy_buffer` **(Annotated Framework Methods)** (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `waitFor` **(Callbacks & Closures)** (Impact: 3.4)
...
**Top Internal Functions/Classes:**
  ...
  * `close` **(Interface Declarations)** (Impact: 2.2)
...
**Top Internal Functions/Classes:**
  ...
  * `fromProto` **(Interface Declarations)** (Impact: 1.6)
  * `toProto` **(Interface Declarations)** (Impact: 1.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
