...
- **Heaviest Functions:** `constructor` (Defensive Guards, Impact: 34.9), `slice` (Many-Argument Workhorses, Impact: 24.2), `toIterator` (Defensive Guards, Impact: 13.2)

### 2. `package/from.js` (JAVASCRIPT) -> Cumulative Risk: **544.53**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -0.39)
...
- **Heaviest Functions:** `createTemporaryBlob` (Defensive Guards, Impact: 8.1), `constructor` (State Mutators, Impact: 3.3), `fromFile` (Many-Argument Workhorses, Impact: 2.9)
...
- **Heaviest Functions:** `createTemporaryBlob` (Generic / Templated Code, Impact: 5.3), `createTemporaryFile` (Generic / Templated Code, Impact: 4.2), `blobFromSync` (Compute Cores, Impact: 3.5)
...
- **Heaviest Functions:** `constructor` (Defensive Guards, Impact: 10.8), `name` (Interface Declarations, Impact: 1.1), `lastModified` (Interface Declarations, Impact: 1.1)
...
**Top Internal Functions/Classes:**
  ...
  * `pull` **(Interface Declarations)** (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  ...
  * `constructor` **(State Mutators)** (Impact: 3.3)
    * *Intent:* #path #start
  * `fromFile` **(Many-Argument Workhorses)** (Impact: 2.9)
    * *Intent:* // @ts-ignore
  * `createTemporaryFile` **(C Struct Operations)** (Impact: 2.8)
