...
> **File Composition:** Data / Markup / Trivial 80%, Defensive Guards Files 20%
...
- **Heaviest Functions:** `build` (Defensive Guards, Impact: 6.0), `exec` (Defensive Guards, Impact: 5.0), `preinstall` (Callbacks & Closures, Impact: 3.4)
