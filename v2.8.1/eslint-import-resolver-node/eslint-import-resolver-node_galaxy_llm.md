...
| Doc Surface (formerly Documentation Exposure) | 67.7 | 67.7 | 67.7 | 67.7 | 67.7 |
...
- `identity` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **1.5** | LOC: 1
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **509.6**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9986%), Safety Score (73.6201%), Documentation (67.665%)
- **Heaviest Functions:** `packageFilter` (Defensive Guards, Impact: 17.1), `resolve` (Defensive Guards, Impact: 7.0), `cachedFilter` (Callbacks & Closures, Impact: 4.0)
...
- **Magnitude:** 54.32 | **LOC:** 69 | **CtrlFlow:** 16.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (67.1347%), Tech Debt (43.3433%)
**Top Internal Functions/Classes:**
  ...
  * `identity` **(Interface Declarations)** (Impact: 1.5)
