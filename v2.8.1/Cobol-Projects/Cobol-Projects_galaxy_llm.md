...
> **Composition Archetype:** `Mainframe / COBOL & Config` (z -1.06; from the repo's file-archetype mix)
> **File Composition:** I/O & Config Routines Files 44%, Data / Markup / Trivial 26%, Declarative / Non-Code 26%, Interface Declarations Files 5%, Large Core Modules 0%
...
- `2000-Process` **(Compute Cores)** (@ `Mainframe/ZOS/ECBAP/cbl/TABLE1.cbl`) -> Impact: **70.1** | LOC: 322
...
- `2120-Calculate-Inst-Price` **(Compute Cores)** (@ `Mainframe/ZOS/ECBAP/cbl/WS81C.cbl`) -> Impact: **36.6** | LOC: 73
...
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.72)
...
- **Heaviest Functions:** `2120-Calculate-Inst-Price` (Compute Cores, Impact: 36.6), `5100-Read-RFPIN` (I/O & Config Routines, Impact: 6.7), `2110-Move-Fixed-Fields` (I/O & Config Routines, Impact: 6.2)
...
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.04)
...
### 5. `pgm_templates/CICS/basecics.cbl` (COBOL) -> Cumulative Risk: **617.57**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.31)
...
- **Heaviest Functions:** `WCM-A-HOURLY-WAGE` (I/O & Config Routines, Impact: 16.2), `0000-MAINLINE` (I/O & Config Routines, Impact: 6.8), `5500-COMPUTE-RESULTS` (I/O & Config Routines, Impact: 6.3)
...
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.00)
...
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.86)
...
- **Heaviest Functions:** `100-MAINLINE` (I/O & Config Routines, Impact: 20.9), `FILE-CONTROL` (I/O & Config Routines, Impact: 10.5), `WS-OUTPUT-REC` (I/O & Config Routines, Impact: 3.9)

### 9. `Mainframe/MVS/herc03/cbl/BDS0704.cbl` (COBOL) -> Cumulative Risk: **540.71**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.76)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 2.8), `5010-DISPLAYVALUES` (I/O & Config Routines, Impact: 2.4), `1000-BEGIN-JOB` (I/O & Config Routines, Impact: 2.2)

### 10. `Mainframe/ZOS/Normal/cbl/BDS1003.cbl` (COBOL) -> Cumulative Risk: **539.34**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.94)
...
- **Heaviest Functions:** `2000-Process` (I/O & Config Routines, Impact: 6.5), `2300-TryToInsert` (I/O & Config Routines, Impact: 5.8), `2200-TryToApplyToMaster` (I/O & Config Routines, Impact: 5.5)
...
**Top Internal Functions/Classes:**
  * `2120-Calculate-Inst-Price` **(Compute Cores)** (Impact: 36.6)
...
**Top Internal Functions/Classes:**
  * `6135-Display-Ins-Type-Messages` **(I/O & Config Routines)** (Impact: 10.1)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 7.0)
...
**Top Internal Functions/Classes:**
  * `2000-Process` **(Compute Cores)** (Impact: 70.1)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 28.9)
  * `1015-Load-Type` **(I/O & Config Routines)** (Impact: 7.0)
  * `1099-Verify-Type-Table` **(I/O & Config Routines)** (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  ...
  * `2110-Move-Fixed-Fields` **(I/O & Config Routines)** (Impact: 6.2)
  * `2130-Calculate-Shipping` **(I/O & Config Routines)** (Impact: 5.6)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 10.5)
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 10.0)
...
**Top Internal Functions/Classes:**
  ...
  * `0500-NORMAL-PROCESSING` **(I/O & Config Routines)** (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `2120-Move-Fixed-Fields` **(I/O & Config Routines)** (Impact: 5.8)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  * `2000-Process` **(Compute Cores)** (Impact: 35.8)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 17.0)
  * `1015-Load-Type` **(I/O & Config Routines)** (Impact: 7.0)
  * `1099-Verify-Type-Table` **(I/O & Config Routines)** (Impact: 4.7)
  * `1010-Load-Type-Table` **(I/O & Config Routines)** (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 13.3)
  ...
  * `1019-Verify-Emp-Table` **(I/O & Config Routines)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 12 instances
* *State Mutation (weighted view):* 55
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.0)
  * `6100-Write-R1` **(I/O & Config Routines)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
