...
> **File Composition:** Generic / Templated Code Files 34%, Large Core Modules 27%, Data / Markup / Trivial 11%, Interface Declarations Files 9%, Parameter Forwarders Files 6%
...
- `WraptFunctionWrapperBase_descr_get` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **65.2** | LOC: 145
  * *Intent:* /* ------------------------------------------------------------------------- */
...
- `WraptBoundFunctionWrapper_call` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **60.1** | LOC: 203
  * *Intent:* /* ------------------------------------------------------------------------- */
- `WraptFunctionWrapper_init` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **59.9** | LOC: 118
  * *Intent:* /* ------------------------------------------------------------------------- */
...
- `WraptFunctionWrapperBase_call` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **44.5** | LOC: 91
  * *Intent:* /* ------------------------------------------------------------------------- */
...
- **Heaviest Functions:** `wrap_object` (Generic / Templated Code, Impact: 2.8), `wrap_object_attribute` (Generic / Templated Code, Impact: 2.8), `__init__` (Generic / Templated Code, Impact: 2.5)
...
- **Heaviest Functions:** `decorator` (Many-Argument Workhorses, Impact: 62.2), `_wrapper` (Many-Argument Workhorses, Impact: 39.7), `_build` (Many-Argument Workhorses, Impact: 17.6)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 34.9), `__call__` (Compute Cores, Impact: 26.0), `__setattr__` (Defensive Guards, Impact: 18.2)
...
- **Heaviest Functions:** `find_spec` (Many-Argument Workhorses, Impact: 13.2), `find_module` (Many-Argument Workhorses, Impact: 11.9), `register_post_import_hook` (Many-Argument Workhorses, Impact: 10.8)
...
- **Heaviest Functions:** `resolve_path` (Compute Cores, Impact: 16.4), `lookup_attribute` (Compute Cores, Impact: 10.8), `_wrapper` (Defensive Guards, Impact: 9.9)
...
- **Heaviest Functions:** `__wrapped_setattr_fixups__` (Defensive Guards, Impact: 51.7), `__new__` (Many-Argument Workhorses, Impact: 50.8), `__new__` (Compute Cores, Impact: 44.2)

### 7. `wrapt-2.1.2/src/wrapt/_wrappers.c` (C) -> Cumulative Risk: **572.94**
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
...
- **Heaviest Functions:** `WraptFunctionWrapperBase_descr_get` (Many-Argument Workhorses, Impact: 65.2), `WraptBoundFunctionWrapper_call` (Many-Argument Workhorses, Impact: 60.1), `WraptFunctionWrapper_init` (Many-Argument Workhorses, Impact: 59.9)

### 8. `wrapt-2.1.2/src/wrapt/arguments.py` (PYTHON) -> Cumulative Risk: **530.98**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z -0.34)
...
- **Heaviest Functions:** `formatargspec` (Many-Argument Workhorses, Impact: 47.1)
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z +2.81)
...
- **Heaviest Functions:** `test_import_deadlock_3` (Annotated Framework Methods, Impact: 2.9), `test_before_and_after_import` (Annotated Framework Methods, Impact: 2.6), `test_import_deadlock_1` (Annotated Framework Methods, Impact: 2.5)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 12.8), `__call__` (Compute Cores, Impact: 11.8), `_weak_function_proxy_callback` (Compute Cores, Impact: 6.6)
...
- **Magnitude:** 1958.66 | **LOC:** 4098 | **CtrlFlow:** 16.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (36.1195%), Tech Debt (8.1957%)
**Top Internal Functions/Classes:**
  * `WraptFunctionWrapperBase_descr_get` **(Many-Argument Workhorses)** (Impact: 65.2)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptBoundFunctionWrapper_call` **(Many-Argument Workhorses)** (Impact: 60.1)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptFunctionWrapper_init` **(Many-Argument Workhorses)** (Impact: 59.9)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptFunctionWrapperBase_call` **(Many-Argument Workhorses)** (Impact: 44.5)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptObjectProxy_raw_init` **(Compute Cores)** (Impact: 30.1)
    * *Intent:* /* ------------------------------------------------------------------------- */
...
**Top Internal Functions/Classes:**
  * `test_self_keyword_argument_on_class_init_overloaded_2a` **(Compute Cores)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_overloaded_2b` **(Compute Cores)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_1` **(Compute Cores)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_2` **(Compute Cores)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_overloaded_2` **(Compute Cores)** (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `__call__` **(Compute Cores)** (Impact: 26.0)
  ...
  * `__call__` **(Compute Cores)** (Impact: 15.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_inplace_matmul` **(Interface Declarations)** (Impact: 4.3)
  * `test_inplace_matmul_immutable` **(Interface Declarations)** (Impact: 4.3)
  * `__eq__` **(Defensive Guards)** (Impact: 3.7)
  * `__eq__` **(Defensive Guards)** (Impact: 3.7)
  * `test_inplace_add_integer` **(Interface Declarations)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_boolean_dynamic_guard_on_decorator` **(Annotated Framework Methods)** (Impact: 3.1)
  * `test_guard_on_instancemethod` **(Annotated Framework Methods)** (Impact: 3.1)
  * `test_re_bind_after_none` **(Defensive Guards)** (Impact: 3.1)
  * `test_double_binding` **(Defensive Guards)** (Impact: 3.0)
  * `test_function_guard_on_decorator` **(Annotated Framework Methods)** (Impact: 2.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_patch_function_module_name_enabled_callable` **(Interface Declarations)** (Impact: 3.1)
  * `test_transient_function_wrapper_instance_method` **(Annotated Framework Methods)** (Impact: 2.9)
  * `test_function_wrapper_instance_method` **(Annotated Framework Methods)** (Impact: 2.8)
...
**Top Internal Functions/Classes:**
  ...
  * `test_class_call_function_nested` **(Annotated Framework Methods)** (Impact: 2.9)
...
**Top Internal Functions/Classes:**
  ...
  * `_self_set_loader` **(Defensive Guards)** (Impact: 8.2)
...
**Top Internal Functions/Classes:**
  * `test_call_semantics_for_assorted_decorator_use_cases` **(C Struct Operations)** (Impact: 4.6)
  * `test_decorated_function_as_instance_attribute` **(Annotated Framework Methods)** (Impact: 3.5)
  * `test_decorated_function_as_class_attribute` **(Annotated Framework Methods)** (Impact: 3.4)
  * `test_call_semantics_for_assorted_wrapped_descriptor_use_cases` **(C Struct Operations)** (Impact: 3.3)
  * `test_decorated_builtin_as_class_attribute` **(C Struct Operations)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_class_call_function_nested_decorators` **(Annotated Framework Methods)** (Impact: 2.8)
    * *Intent:* # Test calling classmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _deco...
  * `test_instance_call_function_nested_decorators` **(Annotated Framework Methods)** (Impact: 2.8)
    * *Intent:* # Test calling classmethod via class instance. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt....
  * `test_class_call_function` **(Annotated Framework Methods)** (Impact: 2.7)
    * *Intent:* # Test calling classmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _deco...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
**Top Internal Functions/Classes:**
  ...
  * `_wrapper` **(Defensive Guards)** (Impact: 9.9)
  * `_wrapper` **(Many-Argument Workhorses)** (Impact: 9.4)
  * `transient_function_wrapper` **(Defensive Guards)** (Impact: 8.6)
...
**Top Internal Functions/Classes:**
  ...
  * `test_synchronized_instancemethod` **(Compute Cores)** (Impact: 4.6)
...
**Top Internal Functions/Classes:**
  ...
  * `test_entry_point_hook_exception_handling` **(Tests & Verification)** (Impact: 3.7)
    * *Intent:* """Test that exceptions in entry point hooks are properly propagated"""
  * `test_entry_point_load_failure` **(Tests & Verification)** (Impact: 3.5)
    * *Intent:* """Test handling of entry point load failures"""
  * `setup_method` **(Interface Declarations)** (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  ...
  * `test_instance_object_qualname` **(Defensive Guards)** (Impact: 3.3)
    * *Intent:* # Test preservation of instance method __qualname__ attribute. try: __qualname__ = Original().origin...
  * `test_class_call_function_nested_decorator` **(Annotated Framework Methods)** (Impact: 2.8)
    * *Intent:* # Test calling staticmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _dec...
  * `test_instance_call_function_nested_decorator` **(Annotated Framework Methods)** (Impact: 2.8)
...
**Top Internal Functions/Classes:**
  ...
  * `test_next` **(Defensive Guards)** (Impact: 2.5)
  * `test_await` **(Interface Declarations)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_instancemethod_delete_function` **(Interface Declarations)** (Impact: 2.7)
  * `test_instancemethod_delete_function_and_instance` **(Interface Declarations)** (Impact: 2.7)
  * `test_classmethod` **(Tests & Verification)** (Impact: 2.7)
  * `test_instancemethod_delete_instance` **(Interface Declarations)** (Impact: 2.6)
  * `test_staticmethod` **(Tests & Verification)** (Impact: 2.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_dynamic_adapter_classmethod` **(Annotated Framework Methods)** (Impact: 3.7)
  * `test_dynamic_adapter_instancemethod` **(Annotated Framework Methods)** (Impact: 3.6)
  * `test_dynamic_adapter_function` **(Annotated Framework Methods)** (Impact: 3.2)
  * `_adapter1` **(Generic / Templated Code)** (Impact: 2.7)
  * `_adapter2` **(Generic / Templated Code)** (Impact: 2.7)
...
**Top Internal Functions/Classes:**
  * `test_update_qualname_modified_on_original` **(Interface Declarations)** (Impact: 2.5)
  * `test_delete_qualname_modified_on_original` **(Interface Declarations)** (Impact: 2.4)
  * `test_delete_annotations_modified_on_original` **(Interface Declarations)** (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test_dynamic_adapter_classmethod` **(Annotated Framework Methods)** (Impact: 3.3)
  * `test_dynamic_adapter_instancemethod` **(Annotated Framework Methods)** (Impact: 3.2)
  * `test_dynamic_adapter_function` **(Annotated Framework Methods)** (Impact: 2.8)
...
**Top Internal Functions/Classes:**
  * `_decorator` **(Many-Argument Workhorses)** (Impact: 7.4)
  * `_decorator` **(Many-Argument Workhorses)** (Impact: 7.4)
  * `test_class_call_function` **(Annotated Framework Methods)** (Impact: 6.4)
    * *Intent:* # Test calling classmethod. Prior to Python 3.9, the instance # and class passed to the wrapper will...
  * `test_instance_call_function` **(Annotated Framework Methods)** (Impact: 6.3)
...
**Top Internal Functions/Classes:**
  * `test_import_deadlock_3` **(Annotated Framework Methods)** (Impact: 2.9)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_before_and_after_import` **(Annotated Framework Methods)** (Impact: 2.6)
  * `test_import_deadlock_1` **(Annotated Framework Methods)** (Impact: 2.5)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_import_deadlock_2` **(Annotated Framework Methods)** (Impact: 2.5)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_remove_from_sys_modules` **(Tests & Verification)** (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
