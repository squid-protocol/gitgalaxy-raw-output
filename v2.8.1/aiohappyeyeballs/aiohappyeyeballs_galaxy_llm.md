...
> **File Composition:** Data / Markup / Trivial 27%, Interface Declarations Files 27%, Declarative / Non-Code 13%, Generic / Templated Code Files 13%, I/O & Config Routines Files 7%
...
- `_interleave_addrinfos` **(Generic / Templated Code)** (@ `aiohappyeyeballs-2.6.1/src/aiohappyeyeballs/impl.py`) -> Impact: **11.6** | LOC: 25
- `pop_addr_infos_interleave` **(Generic / Templated Code)** (@ `aiohappyeyeballs-2.6.1/src/aiohappyeyeballs/utils.py`) -> Impact: **11.5** | LOC: 22
- `test_ipv64_laddr_bind_fails_eyeballs_first_ipv6_fails` **(Compute Cores)** (@ `aiohappyeyeballs-2.6.1/tests/test_impl.py`) -> Impact: **11.2** | LOC: 83
- `test_uvloop_mixing_os_and_runtime_error` **(Compute Cores)** (@ `aiohappyeyeballs-2.6.1/tests/test_impl.py`) -> Impact: **10.1** | LOC: 88
- `test_ipv64_laddr_bind_fails_eyeballs_interleave_first__ipv6_fails` **(Defensive Guards)** (@ `aiohappyeyeballs-2.6.1/tests/test_impl.py`) -> Impact: **9.8** | LOC: 83
...
- **Heaviest Functions:** `start_connection` (Many-Argument Workhorses, Impact: 81.1), `_connect_sock` (Many-Argument Workhorses, Impact: 46.1), `_interleave_addrinfos` (Generic / Templated Code, Impact: 11.6)
...
- **Heaviest Functions:** `staggered_race` (Many-Argument Workhorses, Impact: 41.8), `_wait_one` (Defensive Guards, Impact: 7.9), `run_one_coro` (Generic / Templated Code, Impact: 3.3)
...
- **Heaviest Functions:** `remove_addr_infos` (Generic / Templated Code, Impact: 17.0), `pop_addr_infos_interleave` (Generic / Templated Code, Impact: 11.5), `addr_to_addr_infos` (Generic / Templated Code, Impact: 9.7)
...
- **Heaviest Functions:** `test_ipv64_laddr_bind_fails_eyeballs_first_ipv6_fails` (Compute Cores, Impact: 11.2), `test_uvloop_mixing_os_and_runtime_error` (Compute Cores, Impact: 10.1), `test_ipv64_laddr_bind_fails_eyeballs_interleave_first__ipv6_fails` (Defensive Guards, Impact: 9.8)

### 5. `aiohappyeyeballs-2.6.1/tests/test_staggered_cpython_eager_task_factory.py` (PYTHON) -> Cumulative Risk: **450.05**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.72)
...
- **Heaviest Functions:** `set_event_loop` (Compute Cores, Impact: 6.3), `setUp` (Interface Declarations, Impact: 3.3), `test_staggered_race_with_eager_tasks` (Callbacks & Closures, Impact: 2.6)
...
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Stability (50.0%)
- **Heaviest Functions:** `test_long_delay_early_failure` (Callbacks & Closures, Impact: 3.9), `test_first_error_second_successful` (Callbacks & Closures, Impact: 3.8), `test_first_timeout_second_successful` (Callbacks & Closures, Impact: 3.8)
...
- **Heaviest Functions:** `test_multiple_winners_eager_task_factory` (Interface Declarations, Impact: 3.5), `test_multiple_winners` (Defensive Guards, Impact: 3.1), `test_one_winners` (Defensive Guards, Impact: 3.0)
...
- **Heaviest Functions:** `verify_no_lingering_tasks` (Compute Cores, Impact: 8.0), `get_scheduled_timer_handles` (Generic / Templated Code, Impact: 1.6), `long_repr_strings` (Interface Declarations, Impact: 1.6)
...
- **Heaviest Functions:** `test_init` (Tests & Verification, Impact: 1.1)
...
- **Heaviest Functions:** `test_addr_to_addr_infos` (I/O & Config Routines, Impact: 4.0), `test_remove_addr_infos_slow_path` (I/O & Config Routines, Impact: 3.9), `test_pop_addr_infos_interleave` (I/O & Config Routines, Impact: 2.8)
...
**Top Internal Functions/Classes:**
  * `test_ipv64_laddr_bind_fails_eyeballs_first_ipv6_fails` **(Compute Cores)** (Impact: 11.2)
  * `test_uvloop_mixing_os_and_runtime_error` **(Compute Cores)** (Impact: 10.1)
  * `test_ipv64_laddr_bind_fails_eyeballs_interleave_first__ipv6_fails` **(Defensive Guards)** (Impact: 9.8)
  * `test_ipv64_laddr_bind_fails_all_eyeballs_interleave_first__ipv6_fails` **(Compute Cores)** (Impact: 9.7)
  * `test_ipv64_laddr_socket_blocking_fails` **(Compute Cores)** (Impact: 9.6)
...
**Top Internal Functions/Classes:**
  ...
  * `_interleave_addrinfos` **(Generic / Templated Code)** (Impact: 11.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_wait_one` **(Defensive Guards)** (Impact: 7.9)
  * `run_one_coro` **(Generic / Templated Code)** (Impact: 3.3)
  * `_set_result` **(Generic / Templated Code)** (Impact: 3.0)
    * *Intent:* """Set the result of a future if it is not already done."""
  * `_on_completion` **(Generic / Templated Code)** (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_multiple_winners_eager_task_factory` **(Interface Declarations)** (Impact: 3.5)
  ...
  * `coro` **(Interface Declarations)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_addr_tuple_to_ip_address` **(Generic / Templated Code)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `coro` **(Interface Declarations)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `setUp` **(Interface Declarations)** (Impact: 3.3)
...
**Top Internal Functions/Classes:**
  ...
  * `long_repr_strings` **(Interface Declarations)** (Impact: 1.6)
    * *Intent:* """Increase reprlib maxstring and maxother to 300."""
  * `verify_threads_ended` **(Interface Declarations)** (Impact: 1.3)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_callable_import_from_typing` **(Interface Declarations)** (Impact: 1.4)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_init` **(Tests & Verification)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
