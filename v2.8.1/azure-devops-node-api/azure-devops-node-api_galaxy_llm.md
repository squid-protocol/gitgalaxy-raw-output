...
> **File Composition:** Declarative / Non-Code 40%, Generic / Templated Code Files 28%, Data / Markup / Trivial 10%, Compute Cores Files 8%, Parameter Forwarders Files 6%
...
- **Composition Archetype:** `Compute Cores Files` (z +1.24)
...
- **Heaviest Functions:** `constructor` (Many-Argument Workhorses, Impact: 53.2), `_getResourceAreaUrl` (Defensive Guards, Impact: 16.9), `getHandlerFromToken` (Defensive Guards, Impact: 7.3)
...
- **Heaviest Functions:** `replaceRouteValues` (Compute Cores, Impact: 44.7), `autoNegotiateApiVersion` (Compute Cores, Impact: 38.9), `queryParamsToStringHelper` (Defensive Guards, Impact: 24.1)

### 3. `package/TaskAgentApi.js` (JAVASCRIPT) -> Cumulative Risk: **604.71**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.25)
...
- **Heaviest Functions:** `_getAccountUrl` (Defensive Guards, Impact: 22.6), `getTaskContentZip` (Many-Argument Workhorses, Impact: 14.5), `getTaskDefinition` (Many-Argument Workhorses, Impact: 14.5)
...
- **Heaviest Functions:** `createType3Message` (Many-Argument Workhorses, Impact: 13.4), `parseType2Message` (Compute Cores, Impact: 12.0), `createType1Message` (Compute Cores, Impact: 6.3)

### 5. `package/ClientApiBases.js` (JAVASCRIPT) -> Cumulative Risk: **569.04**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -0.05)
...
- **Heaviest Functions:** `extractRateLimitHeaders` (Compute Cores, Impact: 16.8), `createAcceptHeader` (Parameter Forwarders, Impact: 3.6), `constructor` (State Mutators, Impact: 2.6)

### 6. `package/Serialization.js` (JAVASCRIPT) -> Cumulative Risk: **559.52**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.48)
...
- **Heaviest Functions:** `_getTranslatedField` (Many-Argument Workhorses, Impact: 91.5), `_getTranslatedEnumValue` (Defensive Guards, Impact: 32.0), `_getTranslatedArray` (Many-Argument Workhorses, Impact: 17.0)
...
- **Heaviest Functions:** `sendStream` (Generic / Templated Code, Impact: 4.5), `post` (Generic / Templated Code, Impact: 4.0), `patch` (Generic / Templated Code, Impact: 4.0)
...
- **Heaviest Functions:** `getProfile` (Compute Cores, Impact: 15.9), `getProfile` (Compute Cores, Impact: 15.9), `getProfileAttributes` (Compute Cores, Impact: 13.3)
...
- **Primary Risk Drivers:** Tech Debt (100.0%), Concurrency (100.0%), Spec Match (100.0%), Verification (80.0%)
- **Heaviest Functions:** `getAlerts` (Compute Cores, Impact: 17.0), `getAlerts` (Compute Cores, Impact: 17.0), `getBranches` (Compute Cores, Impact: 14.2)
...
- **Primary Risk Drivers:** Tech Debt (100.0%), Concurrency (100.0%), Spec Match (100.0%), Verification (80.0%)
- **Heaviest Functions:** `getAcquisitionOptions` (Compute Cores, Impact: 19.8), `getAcquisitionOptions` (Compute Cores, Impact: 19.8), `getStates` (Compute Cores, Impact: 11.2)
...
**Top Internal Functions/Classes:**
  ...
  * `deleteTaskDefinition` **(Callbacks & Closures)** (Impact: 9.6)
