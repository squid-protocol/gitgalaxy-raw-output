...
> **Composition Archetype:** `Guard/Validation-Heavy` (z -0.97; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 94%, Defensive Guards Files 4%, Callbacks & Closures Files 1%, Large Core Modules 1%, State Mutators Files 0%
...
- `exports` **(Compute Cores)** (@ `package/core/network/10-mqtt.js`) -> Impact: **637.5** | LOC: 1323
...
- `MQTTBrokerNode` **(Compute Cores)** (@ `package/core/network/10-mqtt.js`) -> Impact: **505.8** | LOC: 1036
...
- `exports` **(Defensive Guards)** (@ `package/core/network/21-httprequest.js`) -> Impact: **403.9** | LOC: 838
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
- `exports` **(Compute Cores)** (@ `package/core/network/31-tcpin.js`) -> Impact: **379.5** | LOC: 887
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
...
- **Composition Archetype:** `Callbacks & Closures Files` (z +1.63)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 214.1), `DelayNode` (Defensive Guards, Impact: 208.8), `maxKeptMsgsCount` (Defensive Guards, Impact: 6.3)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 27.8), `XMLNode` (Defensive Guards, Impact: 27.5)
...
- **Heaviest Functions:** `exports` (Compute Cores, Impact: 99.9), `BatchNode` (Defensive Guards, Impact: 52.0), `concat_msg` (Many-Argument Workhorses, Impact: 24.1)
...
- **Heaviest Functions:** `exports` (Compute Cores, Impact: 135.1), `WebSocketListenerNode` (Compute Cores, Impact: 72.1), `WebSocketOutNode` (Compute Cores, Impact: 29.0)

### 5. `package/core/sequence/18-sort.js` (JAVASCRIPT) -> Cumulative Risk: **644.08**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.00)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 76.1), `SortNode` (Defensive Guards, Impact: 70.3), `processMessage` (Defensive Guards, Impact: 20.9)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 28.3), `WatchNode` (Defensive Guards, Impact: 27.9), `close` (Callbacks & Closures, Impact: 1.1)

### 7. `package/core/function/10-function.js` (JAVASCRIPT) -> Cumulative Risk: **626.11**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z +0.13)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 146.6), `FunctionNode` (Defensive Guards, Impact: 108.4), `sendResults` (Defensive Guards, Impact: 50.8)

### 8. `package/core/function/89-trigger.js` (JAVASCRIPT) -> Cumulative Risk: **622.21**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z -0.47)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 184.2), `TriggerNode` (Defensive Guards, Impact: 183.9), `processMessage` (Defensive Guards, Impact: 108.4)

### 9. `package/core/network/32-udp.js` (JAVASCRIPT) -> Cumulative Risk: **618.12**
- **Archetype:** `file_cluster_7` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z -0.49)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 129.4), `UDPout` (Defensive Guards, Impact: 80.4), `UDPin` (Defensive Guards, Impact: 49.5)
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 75.5), `InjectNode` (Defensive Guards, Impact: 60.9), `evaluateProperty` (Defensive Guards, Impact: 22.2)
...
**Top Internal Functions/Classes:**
  ...
  * `exports` **(Compute Cores)** (Impact: 637.5)
  ...
  * `setOptions` **(Many-Argument Workhorses)** (Impact: 607.1)
    * *Intent:* /** @type {mqtt.MqttClient}*/ this.client;
  * `MQTTBrokerNode` **(Compute Cores)** (Impact: 505.8)
    * *Intent:* //#endregion "Supporting functions" //#region "Broker node"
...
**Top Internal Functions/Classes:**
  * `exports` **(Compute Cores)** (Impact: 379.5)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `TcpGet` **(Compute Cores)** (Impact: 174.0)
...
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 244.7)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `SwitchNode` **(Compute Cores)** (Impact: 107.1)
...
**Top Internal Functions/Classes:**
  * `oneditprepare` **(Compute Cores)** (Impact: 65.7)
...
**Top Internal Functions/Classes:**
  * `exports` **(Compute Cores)** (Impact: 165.9)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `HTTPOut` **(Defensive Guards)** (Impact: 53.2)
  * `HTTPIn` **(Compute Cores)** (Impact: 50.0)
...
**Top Internal Functions/Classes:**
  ...
  * `oneditprepare` **(Callbacks & Closures)** (Impact: 36.7)
...
**Top Internal Functions/Classes:**
  ...
  * `oneditprepare` **(Compute Cores)** (Impact: 58.9)
...
**Top Internal Functions/Classes:**
  ...
  * `sortMessageProperty` **(Callbacks & Closures)** (Impact: 10.6)
**Contextual Mitigations & Amplifications:**
