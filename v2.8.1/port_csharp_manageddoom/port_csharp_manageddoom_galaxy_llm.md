...
> **File Composition:** Declarative / Non-Code 28%, State Mutators Files 24%, Large Core Modules 20%, Tests & Verification Files 11%, Many-Argument Workhorses Files 5%
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 99.6 | 100.0 | 100.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 67.6 | 100.0 | 100.0 |
...
- `DoLocalDoor` **(Compute Cores)** (@ `ManagedDoom/src/Doom/World/SectorAction.cs`) -> Impact: **96.3** | LOC: 160
...
### 1. `ManagedDoom/src/Silk/SilkMusic.cs` (CSHARP) -> Cumulative Risk: **671.45**
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.2287%)
- **Heaviest Functions:** `SendEvents` (Compute Cores, Impact: 56.1), `ReadSingleEvent` (I/O & Config Routines, Impact: 27.4), `OnGetData` (Compute Cores, Impact: 14.7)

### 2. `ManagedDoom/src/Doom/World/WeaponBehavior.cs` (CSHARP) -> Cumulative Risk: **635.95**
- **Archetype:** `file_cluster_10` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +1.30)
- **Magnitude:** 369.98 | **LOC:** 698 | **CtrlFlow:** 13.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9934%), Tech Debt (86.361%)
- **Heaviest Functions:** `CheckAmmo` (Compute Cores, Impact: 38.4), `RecursiveSound` (Many-Argument Workhorses, Impact: 29.5), `WeaponReady` (Compute Cores, Impact: 14.7)

### 3. `ManagedDoom/src/Video/Renderer.cs` (CSHARP) -> Cumulative Risk: **606.49**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.17)
- **Magnitude:** 204.58 | **LOC:** 379 | **CtrlFlow:** 13.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9762%), Churn (85.53%)
- **Heaviest Functions:** `RenderGame` (Compute Cores, Impact: 26.6), `GetPaletteNumber` (Compute Cores, Impact: 18.1), `Render` (Many-Argument Workhorses, Impact: 15.6)

### 4. `ManagedDoom/src/Doom/Doom.cs` (CSHARP) -> Cumulative Risk: **591.49**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +0.62)
- **Magnitude:** 404.74 | **LOC:** 557 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (92.6958%)
- **Heaviest Functions:** `CheckFunctionKey` (Compute Cores, Impact: 51.3), `Update` (I/O & Config Routines, Impact: 28.5), `Doom` (Many-Argument Workhorses, Impact: 19.5)

### 5. `ManagedDoom/src/Doom/Opening/OpeningSequence.cs` (CSHARP) -> Cumulative Risk: **590.56**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +0.38)
- **Magnitude:** 196.68 | **LOC:** 263 | **CtrlFlow:** 27.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (95.0767%)
- **Heaviest Functions:** `Update` (Compute Cores, Impact: 62.3), `OpeningSequence` (Compute Cores, Impact: 4.4), `StartTitleScreen` (State Mutators, Impact: 3.7)

### 6. `ManagedDoom/src/Doom/World/MonsterBehavior.cs` (CSHARP) -> Cumulative Risk: **587.59**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.65)
- **Magnitude:** 1024.06 | **LOC:** 2015 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9726%), Documentation (90.2655%), Safety Score (82.3761%)
- **Heaviest Functions:** `BossDeath` (Compute Cores, Impact: 80.8), `NewChaseDir` (Compute Cores, Impact: 54.0), `SpawnFly` (Compute Cores, Impact: 38.2)

### 7. `ManagedDoom/src/Doom/World/AutoMap.cs` (CSHARP) -> Cumulative Risk: **586.8**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +1.08)
- **Magnitude:** 280.72 | **LOC:** 339 | **CtrlFlow:** 23.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (95.5628%)
- **Heaviest Functions:** `DoEvent` (Compute Cores, Impact: 68.7), `Update` (I/O & Config Routines, Impact: 20.3), `AutoMap` (Compute Cores, Impact: 11.0)

### 8. `ManagedDoom/src/Silk/SilkUserInput.cs` (CSHARP) -> Cumulative Risk: **584.36**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z -0.27)
- **Magnitude:** 567.52 | **LOC:** 581 | **CtrlFlow:** 48.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9976%), Cognitive Load (95.8557%)
- **Heaviest Functions:** `SilkToDoom` (Compute Cores, Impact: 150.6), `DoomToSilk` (Compute Cores, Impact: 145.4), `BuildTicCmd` (Compute Cores, Impact: 49.8)

### 9. `ManagedDoom/src/Doom/Intermission/Finale.cs` (CSHARP) -> Cumulative Risk: **581.07**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.72)
- **Magnitude:** 524.38 | **LOC:** 567 | **CtrlFlow:** 28.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.4493%)
- **Heaviest Functions:** `UpdateCast` (Compute Cores, Impact: 71.8), `Finale` (Compute Cores, Impact: 67.1), `Update` (I/O & Config Routines, Impact: 16.1)

### 10. `ManagedDoom/src/Doom/World/World.cs` (CSHARP) -> Cumulative Risk: **576.79**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +0.47)
- **Magnitude:** 237.38 | **LOC:** 398 | **CtrlFlow:** 12.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9993%), Documentation (91.3043%), Safety Score (88.2573%)
- **Heaviest Functions:** `LoadThings` (Compute Cores, Impact: 18.8), `DoEvent` (Compute Cores, Impact: 14.7), `World` (Many-Argument Workhorses, Impact: 13.8)
...
- **Risk Profile:** Cognitive Load (77.0877%), Tech Debt (9.5047%)
...
- **Risk Profile:** Cognitive Load (62.0014%), Tech Debt (25.4629%)
**Top Internal Functions/Classes:**
  * `DoLocalDoor` **(Compute Cores)** (Impact: 96.3)
    * *Intent:* /// <summary> /// Open a door manually, no tag value. /// </summary>
  ...
  * `DoFloor` **(Compute Cores)** (Impact: 88.4)
...
- **Magnitude:** 1024.06 | **LOC:** 2015 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (62.2586%), Tech Debt (58.8708%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (43.0407%), Tech Debt (11.3878%)
**Top Internal Functions/Classes:**
  ...
  * `ShootSpecialLine` **(Compute Cores)** (Impact: 24.8)
    * *Intent:* //////////////////////////////////////////////////////////// // Line shoot /////////////////////////...
  * `UseTraverse` **(Compute Cores)** (Impact: 7.2)
  * `UseLines` **(Interface Declarations)** (Impact: 2.2)
...
- **Risk Profile:** Cognitive Load (77.9723%), Tech Debt (13.0657%)
**Top Internal Functions/Classes:**
  * `ArchiveSpecials` **(Compute Cores)** (Impact: 40.9)
...
- **Risk Profile:** Cognitive Load (33.0284%), Tech Debt (16.777%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (62.694%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `UpdateNetGameStats` **(Compute Cores)** (Impact: 59.6)
...
- **Risk Profile:** Cognitive Load (45.7397%), Tech Debt (9.2293%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_11` (Drift: 0.0 IQR)
- **Magnitude:** 524.38 | **LOC:** 567 | **CtrlFlow:** 28.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (75.6785%), Tech Debt (22.5638%)
**Top Internal Functions/Classes:**
  * `UpdateCast` **(Compute Cores)** (Impact: 71.8)
  * `Finale` **(Compute Cores)** (Impact: 67.1)
  * `Update` **(I/O & Config Routines)** (Impact: 16.1)
  * `BunnyScroll` **(I/O & Config Routines)** (Impact: 8.8)
  * `DoEvent` **(Compute Cores)** (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
- **Magnitude:** 483.8 | **LOC:** 646 | **CtrlFlow:** 19.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (86.2949%), Tech Debt (9.5349%)
**Top Internal Functions/Classes:**
  * `SendEvents` **(Compute Cores)** (Impact: 56.1)
  * `ReadSingleEvent` **(I/O & Config Routines)** (Impact: 27.4)
  * `OnGetData` **(Compute Cores)** (Impact: 14.7)
  * `ReadData` **(Compute Cores)** (Impact: 13.7)
  * `ReadSingleEventGroup` **(I/O & Config Routines)** (Impact: 10.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (69.7059%), Tech Debt (21.6747%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (64.3126%), Tech Debt (22.7606%)
**Top Internal Functions/Classes:**
  ...
  * `SetParam` **(Compute Cores)** (Impact: 14.1)
  * `GetPitch` **(Compute Cores)** (Impact: 13.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (33.3101%), Tech Debt (39.1247%)
**Top Internal Functions/Classes:**
  * `CheckSpot` **(Compute Cores)** (Impact: 42.5)
  ...
  * `GetMissileSpeed` **(Compute Cores)** (Impact: 12.3)
...
- **Risk Profile:** Cognitive Load (25.5741%), Tech Debt (12.825%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (33.2963%), Tech Debt (8.9903%)
**Top Internal Functions/Classes:**
  * `ProcessBlock` **(Many-Argument Workhorses)** (Impact: 54.5)
  * `GetBlockType` **(Compute Cores)** (Impact: 38.1)
  * `ProcessBexStringsBlock` **(Compute Cores)** (Impact: 14.8)
  * `ProcessBexParsBlock` **(Compute Cores)** (Impact: 14.6)
  * `ProcessLines` **(Compute Cores)** (Impact: 13.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (35.0897%), Tech Debt (17.613%)
**Top Internal Functions/Classes:**
  * `PlayerThink` **(Compute Cores)** (Impact: 57.1)
...
- **Global Archetype:** `file_cluster_11` (Drift: 0.0 IQR)
- **Magnitude:** 404.74 | **LOC:** 557 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (90.2317%), Tech Debt (24.3721%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (16.2627%), Tech Debt (29.5855%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 369.98 | **LOC:** 698 | **CtrlFlow:** 13.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (76.1545%), Tech Debt (86.361%)
**Top Internal Functions/Classes:**
  * `CheckAmmo` **(Compute Cores)** (Impact: 38.4)
  * `RecursiveSound` **(Many-Argument Workhorses)** (Impact: 29.5)
  * `WeaponReady` **(Compute Cores)** (Impact: 14.7)
...
- **Risk Profile:** Cognitive Load (57.5032%), Tech Debt (80.8839%)
**Top Internal Functions/Classes:**
  * `NightmareTest` **(Tests & Verification)** (Impact: 5.5)
  * `BarrelTest` **(Tests & Verification)** (Impact: 5.5)
  * `ZombiemanTest` **(Tests & Verification)** (Impact: 5.5)
  * `ZombiemanTest2` **(Tests & Verification)** (Impact: 5.5)
  * `ShotgunguyTest` **(Tests & Verification)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (39.9632%), Tech Debt (9.3655%)
**Top Internal Functions/Classes:**
  * `DrawNumber` **(Many-Argument Workhorses)** (Impact: 22.7)
  * `Render` **(Compute Cores)** (Impact: 18.4)
  * `DrawSuitablePatch` **(Many-Argument Workhorses)** (Impact: 17.7)
  * `DrawDeathmatchStats` **(Compute Cores)** (Impact: 17.5)
  * `DrawTime` **(Many-Argument Workhorses)** (Impact: 15.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (57.7297%), Tech Debt (10.1988%)
**Top Internal Functions/Classes:**
  * `Render` **(Compute Cores)** (Impact: 31.8)
  * `DrawNumber` **(Compute Cores)** (Impact: 18.9)
  * `Patches` **(Compute Cores)** (Impact: 12.5)
  * `StatusBarRenderer` **(Many-Argument Workhorses)** (Impact: 6.0)
  * `DrawPercent` **(State Mutators)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (65.4753%), Tech Debt (10.2784%)
**Top Internal Functions/Classes:**
  * `DoPowerUp` **(Compute Cores)** (Impact: 21.0)
  * `CheckBuffer` **(I/O & Config Routines)** (Impact: 12.2)
  * `ChangeMusic` **(Compute Cores)** (Impact: 10.0)
  * `ChangeLevel` **(Compute Cores)** (Impact: 9.9)
  * `GiveWeapons` **(I/O & Config Routines)** (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
