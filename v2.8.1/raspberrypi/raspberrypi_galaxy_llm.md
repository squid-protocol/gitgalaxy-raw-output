...
> **Composition Archetype:** `Small Flat Repo` (z +1.51; from the repo's file-archetype mix)
> **File Composition:** Interface Declarations Files 27%, Data / Markup / Trivial 26%, I/O & Config Routines Files 20%, Parameter Forwarders Files 11%, Declarative / Non-Code 6%
...
- `assemble` **(Compute Cores)** (@ `tas/tas.c`) -> Impact: **720.5** | LOC: 1513
  * *Intent:* //-------------------------------------------------------------------
...
- **Heaviest Functions:** `zlibCompileFlags` (Compute Cores, Impact: 32.1), `zcalloc` (Many-Argument Workhorses, Impact: 13.2), `zcfree` (Compute Cores, Impact: 9.7)
...
- **Composition Archetype:** `C Struct Operations Files` (z +1.51)
...
- **Heaviest Functions:** `inflate` (Many-Argument Workhorses, Impact: 392.7), `inflateInit2_` (Many-Argument Workhorses, Impact: 26.6), `inflateCopy` (C Struct Operations, Impact: 23.1)
...
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `C Struct Operations Files` (z +1.52)
...
- **Heaviest Functions:** `floatXAdd` (Compute Cores, Impact: 52.0), `floatXToFloat32` (Compute Cores, Impact: 45.0), `roundFloatXTo24` (Compute Cores, Impact: 25.9)
...
- **Heaviest Functions:** `deflate` (Many-Argument Workhorses, Impact: 206.1), `deflateInit2_` (Many-Argument Workhorses, Impact: 95.4), `longest_match` (Compute Cores, Impact: 78.1)
...
**Top Internal Functions/Classes:**
  * `assemble` **(Compute Cores)** (Impact: 720.5)
    * *Intent:* //-------------------------------------------------------------------
...
**Top Internal Functions/Classes:**
  ...
  * `deflateInit2_` **(Many-Argument Workhorses)** (Impact: 95.4)
    * *Intent:* /* ========================================================================= */
  * `longest_match` **(Compute Cores)** (Impact: 78.1)
...
**Top Internal Functions/Classes:**
  ...
  * `inflateCopy` **(C Struct Operations)** (Impact: 23.1)
  * `updatewindow` **(Compute Cores)** (Impact: 21.5)
    * *Intent:* */
...
**Top Internal Functions/Classes:**
  ...
  * `roundFloatXTo24` **(Compute Cores)** (Impact: 25.9)
    * *Intent:* //static flag le64( bits64X a, bits64X b ) //{ //return ( a.a0 < b.a0 ) || ( ( a.a0 == b.a0 ) && ( a...
  * `roundFloatXTo53` **(Compute Cores)** (Impact: 25.9)
  * `floatXToInt32` **(Compute Cores)** (Impact: 21.6)
