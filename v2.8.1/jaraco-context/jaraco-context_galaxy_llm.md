...
> **File Composition:** Generic / Templated Code Files 50%, Data / Markup / Trivial 25%, Interface Declarations Files 25%
...
- `tarball` **(Many-Argument Workhorses)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **5.5** | LOC: 41
...
- `make_tarball_with` **(Interface Declarations)** (@ `jaraco_context-6.1.2/tests/test_safety.py`) -> Impact: **3.4** | LOC: 11
...
- **Heaviest Functions:** `repo_context` (Many-Argument Workhorses, Impact: 12.5), `__exit__` (Generic / Templated Code, Impact: 9.5), `remove_readonly` (Generic / Templated Code, Impact: 8.8)
...
- **Heaviest Functions:** `log_message` (Generic / Templated Code, Impact: 2.1), `tarfile_served` (Tests & Verification, Impact: 2.1), `start_server` (Generic / Templated Code, Impact: 1.7)
...
- **Heaviest Functions:** `make_tarball_with` (Interface Declarations, Impact: 3.4), `test_zipslip_exploit` (Parameter Forwarders, Impact: 2.2), `tarfile_case` (Interface Declarations, Impact: 1.7)
...
**Top Internal Functions/Classes:**
  ...
  * `tarball` **(Many-Argument Workhorses)** (Impact: 5.5)
...
**Top Internal Functions/Classes:**
  * `make_tarball_with` **(Interface Declarations)** (Impact: 3.4)
  ...
  * `tarfile_case` **(Interface Declarations)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `tarfile_served` **(Tests & Verification)** (Impact: 2.1)
