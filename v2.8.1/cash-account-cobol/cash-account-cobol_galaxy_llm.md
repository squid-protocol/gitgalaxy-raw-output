...
> **File Composition:** I/O & Config Routines Files 57%, Declarative / Non-Code 29%, Data / Markup / Trivial 14%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 90.4 | 38.1 | 30.7 | 0.0 |
...
### 1. `COBOL/CASH00.cbl` (COBOL) -> Cumulative Risk: **486.39**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Cognitive Load (91.2079%)
- **Heaviest Functions:** `CASH-ACCT-CREDIT` (I/O & Config Routines, Impact: 4.5), `CASH-ACCT-DEBIT` (I/O & Config Routines, Impact: 4.5), `CASH-ACCT-UPDATE` (I/O & Config Routines, Impact: 4.0)
...
- **Heaviest Functions:** `BIND` (I/O & Config Routines, Impact: 3.1)
...
- **Heaviest Functions:** `CRTABS` (I/O & Config Routines, Impact: 2.4), `CREATE` (I/O & Config Routines, Impact: 2.2), `CRINDX` (I/O & Config Routines, Impact: 1.9)
...
- **Heaviest Functions:** `STEPNAME` (I/O & Config Routines, Impact: 1.6)

### 5. `COBOL/DCLCASH.cpy` (COBOL) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.67)
