...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +1.98; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 26%, Tests & Verification Files 23%, Annotated Framework Methods Files 19%, Interface Declarations Files 9%, Large Core Modules 7%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 76.4 | 2.9 | 0.0 | 0.0 |
...
- `getAuthHeaderWhenAuthForDockerDomain` **(Tests & Verification)** (@ `buildpack/spring-boot-buildpack-platform/src/test/java/org/springframework/boot/buildpack/platform/docker/configuration/DockerRegistryConfigAuthenticationTests.java`) -> Impact: **131.5** | LOC: 367
- `loadWhenBindingClasspathPatternToResourceArrayShouldBindMultipleValues` **(Annotated Framework Methods)** (@ `core/spring-boot/src/test/java/org/springframework/boot/context/properties/ConfigurationPropertiesTests.java`) -> Impact: **125.7** | LOC: 2074
- `getAuthHeaderWhenAuthForLegacyDockerDomain` **(Tests & Verification)** (@ `buildpack/spring-boot-buildpack-platform/src/test/java/org/springframework/boot/buildpack/platform/docker/configuration/DockerRegistryConfigAuthenticationTests.java`) -> Impact: **115.7** | LOC: 334
...
- `getAuthHeaderWhenAuthForCustomDomainWithLegacyFormat` **(Tests & Verification)** (@ `buildpack/spring-boot-buildpack-platform/src/test/java/org/springframework/boot/buildpack/platform/docker/configuration/DockerRegistryConfigAuthenticationTests.java`) -> Impact: **100.8** | LOC: 290
...
- `getAuthHeaderWhenUsingHelperFromCredsStore` **(Tests & Verification)** (@ `buildpack/spring-boot-buildpack-platform/src/test/java/org/springframework/boot/buildpack/platform/docker/configuration/DockerRegistryConfigAuthenticationTests.java`) -> Impact: **87.4** | LOC: 248
- `getAuthHeaderWhenUsingHelperFromCredsStoreAndUseEmailFromAuth` **(Tests & Verification)** (@ `buildpack/spring-boot-buildpack-platform/src/test/java/org/springframework/boot/buildpack/platform/docker/configuration/DockerRegistryConfigAuthenticationTests.java`) -> Impact: **68.9** | LOC: 218
...
- `SslBundleSource` **(Many-Argument Workhorses)** (@ `core/spring-boot-testcontainers/src/main/java/org/springframework/boot/testcontainers/service/connection/SslBundleSource.java`) -> Impact: **61.5** | LOC: 104
...
- **Heaviest Functions:** `update` (Compute Cores, Impact: 11.2), `getLocationsJson` (Compute Cores, Impact: 9.6), `synchronized` (Compute Cores, Impact: 9.4)
...
- **Heaviest Functions:** `uncaughtException` (Defensive Guards, Impact: 7.6), `isJvmExiting` (Compute Cores, Impact: 6.1), `setup` (Defensive Guards, Impact: 3.2)
...
- **Heaviest Functions:** `isMultiRelease` (I/O & Config Routines, Impact: 5.8), `synchronized` (I/O & Config Routines, Impact: 4.5), `gc` (Defensive Guards, Impact: 3.9)
...
- **Heaviest Functions:** `get` (Annotated Framework Methods, Impact: 3.7), `remove` (Tests & Verification, Impact: 2.0), `registerDestructionCallback` (Annotated Framework Methods, Impact: 1.9)
...
- **Heaviest Functions:** `NettyWebServer` (Annotated Framework Methods, Impact: 7.9), `startHttpServer` (Callbacks & Closures, Impact: 7.9), `getStartedOnMessage` (Callbacks & Closures, Impact: 7.4)
...
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.08)
...
- **Heaviest Functions:** `save` (Annotated Framework Methods, Impact: 3.3), `findMessage` (Annotated Framework Methods, Impact: 1.6), `deleteMessage` (Annotated Framework Methods, Impact: 1.6)
...
- **Heaviest Functions:** `getStorageDelegate` (Compute Cores, Impact: 10.8), `onApplicationEvent` (Defensive Guards, Impact: 8.2), `synchronized` (I/O & Config Routines, Impact: 6.6)
...
- **Heaviest Functions:** `streamHello` (Defensive Guards, Impact: 4.5), `sayHello` (Annotated Framework Methods, Impact: 4.0)
