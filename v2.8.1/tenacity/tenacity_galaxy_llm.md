...
> **Composition Archetype:** `Typed Library` (z +2.17; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 71%, Generic / Templated Code Files 18%, Large Core Modules 5%, Interface Declarations Files 3%, Declarative / Non-Code 2%
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 23.9 | 0.0 | 0.0 |
...
- `__init__` **(Compute Cores)** (@ `tenacity-9.1.4/tenacity/retry.py`) -> Impact: **31.5** | LOC: 30
...
### 1. `tenacity-9.1.4/tenacity/asyncio/__init__.py` (PYTHON) -> Cumulative Risk: **771.46**
...
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.9989%)
- **Heaviest Functions:** `__call__` (Defensive Guards, Impact: 19.1), `__anext__` (Defensive Guards, Impact: 9.1), `_run_wait` (Generic / Templated Code, Impact: 5.5)

### 2. `tenacity-9.1.4/tenacity/asyncio/retry.py` (PYTHON) -> Cumulative Risk: **748.44**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9704%)
- **Heaviest Functions:** `__call__` (Generic / Templated Code, Impact: 9.2), `__call__` (Generic / Templated Code, Impact: 7.3), `__call__` (Generic / Templated Code, Impact: 7.3)

### 3. `tenacity-9.1.4/tenacity/stop.py` (PYTHON) -> Cumulative Risk: **727.45**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.1362%)
- **Heaviest Functions:** `__call__` (Generic / Templated Code, Impact: 3.8), `__call__` (Generic / Templated Code, Impact: 3.7), `__call__` (Generic / Templated Code, Impact: 3.6)

### 4. `tenacity-9.1.4/tenacity/retry.py` (PYTHON) -> Cumulative Risk: **716.07**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9934%), State Flux (99.9469%)
- **Heaviest Functions:** `__init__` (Compute Cores, Impact: 31.5), `__call__` (Defensive Guards, Impact: 9.3), `__call__` (Compute Cores, Impact: 9.2)

### 5. `tenacity-9.1.4/tenacity/__init__.py` (PYTHON) -> Cumulative Risk: **713.52**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9792%), Safety Score (94.8813%), Documentation (90.4762%)
- **Heaviest Functions:** `retry` (Defensive Guards, Impact: 22.5), `__call__` (Defensive Guards, Impact: 14.6), `wrap` (Defensive Guards, Impact: 13.8)

### 6. `tenacity-9.1.4/tenacity/_utils.py` (PYTHON) -> Cumulative Risk: **628.88**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.95%), Tech Debt (99.7748%), Safety Score (95.4473%)
- **Heaviest Functions:** `find_ordinal` (Compute Cores, Impact: 10.6), `is_coroutine_callable` (Defensive Guards, Impact: 7.5), `get_callback_name` (Defensive Guards, Impact: 6.8)

### 7. `tenacity-9.1.4/tenacity/wait.py` (PYTHON) -> Cumulative Risk: **538.45**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9886%), Safety Score (78.992%)
- **Heaviest Functions:** `__call__` (Generic / Templated Code, Impact: 5.6), `__radd__` (Generic / Templated Code, Impact: 3.7), `__call__` (Generic / Templated Code, Impact: 3.6)

### 8. `tenacity-9.1.4/tenacity/tornadoweb.py` (PYTHON) -> Cumulative Risk: **525.0**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.37)
- **Magnitude:** 33.82 | **LOC:** 64 | **CtrlFlow:** 14.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9665%), Safety Score (95.2574%)
- **Heaviest Functions:** `__call__` (Defensive Guards, Impact: 14.6), `__init__` (Generic / Templated Code, Impact: 2.4)

### 9. `tenacity-9.1.4/tests/test_issue_478.py` (PYTHON) -> Cumulative Risk: **486.16**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z +0.62)
- **Magnitude:** 107.34 | **LOC:** 118 | **CtrlFlow:** 11.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (80.248%)
- **Heaviest Functions:** `test_issue` (Defensive Guards, Impact: 10.8), `test_async` (Defensive Guards, Impact: 10.8), `do_retry` (Defensive Guards, Impact: 6.5)

### 10. `tenacity-9.1.4/tenacity/before_sleep.py` (PYTHON) -> Cumulative Risk: **481.25**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9994%), Safety Score (86.4295%), Documentation (66.6667%)
- **Heaviest Functions:** `before_sleep_log` (Many-Argument Workhorses, Impact: 22.3), `log_it` (Compute Cores, Impact: 14.4), `before_sleep_nothing` (Generic / Templated Code, Impact: 1.5)
...
- **Risk Profile:** Cognitive Load (20.2838%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `make_retry_state` **(Many-Argument Workhorses)** (Impact: 12.7)
  * `test_wait_chain` **(Compute Cores)** (Impact: 12.2)
  * `_make_unset_exception` **(Compute Cores)** (Impact: 7.3)
  * `test_wait_random_exponential` **(Compute Cores)** (Impact: 7.1)
  * `test_random_sleep` **(Compute Cores)** (Impact: 6.5)
...
- **Risk Profile:** Cognitive Load (47.1831%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 434.46 | **LOC:** 751 | **CtrlFlow:** 9.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (64.8868%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `_post_stop_check_actions` **(Generic / Templated Code)** (Impact: 10.1)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 223.4 | **LOC:** 211 | **CtrlFlow:** 11.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.9989%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__call__` **(Defensive Guards)** (Impact: 19.1)
  * `__anext__` **(Defensive Guards)** (Impact: 9.1)
  * `_run_wait` **(Generic / Templated Code)** (Impact: 5.5)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 5.2)
  * `_portable_async_sleep` **(Interface Declarations)** (Impact: 5.0)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 189.38 | **LOC:** 283 | **CtrlFlow:** 23.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (48.9211%), Tech Debt (99.9934%)
**Top Internal Functions/Classes:**
  * `__init__` **(Compute Cores)** (Impact: 31.5)
  * `__call__` **(Defensive Guards)** (Impact: 9.3)
  * `__call__` **(Compute Cores)** (Impact: 9.2)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 107.42 | **LOC:** 126 | **CtrlFlow:** 18.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.9964%), Tech Debt (99.131%)
**Top Internal Functions/Classes:**
...
- **Magnitude:** 97.0 | **LOC:** 274 | **CtrlFlow:** 4.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (48.6222%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 65.78 | **LOC:** 114 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (58.5718%), Tech Debt (99.7748%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 63.42 | **LOC:** 131 | **CtrlFlow:** 8.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.9194%), Tech Debt (100.0%)
**Top Internal Functions/Classes:**
...
- **Magnitude:** 59.96 | **LOC:** 72 | **CtrlFlow:** 23.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (38.7394%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (15.5727%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_01_default` **(Compute Cores)** (Impact: 5.5)
    * *Intent:* """Test log formatting."""
  * `test_02_custom_sec_format` **(Tests & Verification)** (Impact: 5.4)
...
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 33.82 | **LOC:** 64 | **CtrlFlow:** 14.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.0001%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__call__` **(Defensive Guards)** (Impact: 14.6)
...
- **Risk Profile:** Cognitive Load (6.1734%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_old_tornado` **(Tests & Verification)** (Impact: 2.1)
  * `test_stop_after_attempt` **(Defensive Guards)** (Impact: 1.8)
  * `test_retry` **(Defensive Guards)** (Impact: 1.7)
  * `_retryable_coroutine` **(Interface Declarations)** (Impact: 1.6)
  * `_retryable_coroutine_with_2_attempts` **(Interface Declarations)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Risk Profile:** Cognitive Load (8.5111%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
