...
> **File Composition:** Data / Markup / Trivial 28%, Interface Declarations Files 20%, Declarative / Non-Code 19%, Parameter Forwarders Files 16%, I/O & Config Routines Files 8%
...
- **Heaviest Functions:** `print_char` (Many-Argument Workhorses, Impact: 33.6), `kprint_at` (Many-Argument Workhorses, Impact: 11.0), `clear_screen` (I/O & Config Routines, Impact: 2.5)
...
- **Heaviest Functions:** `print_char` (Many-Argument Workhorses, Impact: 28.9), `kprint_at` (Many-Argument Workhorses, Impact: 11.0), `clear_screen` (I/O & Config Routines, Impact: 2.5)
...
- **Heaviest Functions:** `kmalloc` (Many-Argument Workhorses, Impact: 8.7), `memory_copy` (Parameter Forwarders, Impact: 4.3), `memory_set` (Parameter Forwarders, Impact: 4.2)

### 8. `23-fixes/libc/mem.c` (C) -> Cumulative Risk: **560.66**
- **Archetype:** `file_cluster_5` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +1.10)
- **Magnitude:** 44.64 | **LOC:** 34 | **CtrlFlow:** 22.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (98.9013%)
- **Heaviest Functions:** `kmalloc` (Defensive Guards, Impact: 8.7), `memory_copy` (Parameter Forwarders, Impact: 4.3), `memory_set` (Parameter Forwarders, Impact: 4.2)
...
- **Heaviest Functions:** `hex_to_ascii` (Compute Cores, Impact: 14.8), `int_to_ascii` (Compute Cores, Impact: 9.3), `strcmp` (Compute Cores, Impact: 5.5)
...
**Top Internal Functions/Classes:**
  ...
  * `set_cursor_offset` **(Interface Declarations)** (Impact: 1.8)
...
**Top Internal Functions/Classes:**
  * `irq_common_stub` **(Compute Cores)** (Impact: 5.6)
    * *Intent:* ; Common IRQ code. Identical to ISR code except for the 'call' ; and the 'pop ebx'
  * `isr_common_stub` **(Interface Declarations)** (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  * `irq_common_stub` **(Compute Cores)** (Impact: 5.7)
    * *Intent:* ; Common IRQ code. Identical to ISR code except for the 'call' ; and the 'pop ebx'
  * `isr_common_stub` **(Interface Declarations)** (Impact: 2.7)
    * *Intent:* ; Defined in isr.c ; Common ISR code
  * `isr0` **(Interface Declarations)** (Impact: 1.2)
    * *Intent:* ; 0: Divide By Zero Exception
  * `isr1` **(Interface Declarations)** (Impact: 1.2)
...
**Top Internal Functions/Classes:**
  ...
  * `reverse` **(Interface Declarations)** (Impact: 3.2)
    * *Intent:* /* K&R */
  * `strlen` **(Interface Declarations)** (Impact: 3.1)
    * *Intent:* /* K&R */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `keyboard_callback` **(Interface Declarations)** (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `isr_common_stub` **(Interface Declarations)** (Impact: 4.7)
    * *Intent:* ; Defined in isr.c ; Common ISR code
  * `isr0` **(Interface Declarations)** (Impact: 1.2)
    * *Intent:* ; 0: Divide By Zero Exception
  * `isr1` **(Interface Declarations)** (Impact: 1.2)
