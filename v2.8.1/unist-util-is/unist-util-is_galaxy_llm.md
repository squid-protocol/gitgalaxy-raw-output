...
### 1. `package/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **60.48**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 0.8 | **LOC:** 5 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Api Exposure (8.1867%), Verification (2.2977%)

### 2. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **55.82**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
