...
> **Composition Archetype:** `Small Flat Repo` (z +0.39; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 47%, Declarative / Non-Code 22%, Callbacks & Closures Files 7%, Compute Cores Files 6%, Defensive Guards Files 5%
...
- `shortestCommonSupersequence` **(Compute Cores)** (@ `src/algorithms/sets/shortest-common-supersequence/shortestCommonSupersequence.js`) -> Impact: **30.9** | LOC: 63
...
- `longestCommonSubsequence` **(Compute Cores)** (@ `src/algorithms/sets/longest-common-subsequence/longestCommonSubsequence.js`) -> Impact: **27.0** | LOC: 55
  * *Intent:* /** * @param {string[]} set1 * @param {string[]} set2 * @return {string[]} */
- `findLowEnergySeam` **(Compute Cores)** (@ `src/algorithms/image-processing/seam-carving/resizeImageWidth.js`) -> Impact: **26.9** | LOC: 87
...
- **Composition Archetype:** `Tests & Verification Files` (z +2.61)
...
- **Heaviest Functions:** `compareCallback` (Tests & Verification, Impact: 6.0), `compareCallback` (Defensive Guards, Impact: 5.8), `testSortWithCustomComparator` (Tests & Verification, Impact: 5.1)
...
- **Heaviest Functions:** `pixelsDiff` (Defensive Guards, Impact: 11.2), `pngLoad` (Callbacks & Closures, Impact: 1.6), `Parsed` (State Mutators, Impact: 1.5)

### 3. `src/data-structures/graph/Graph.js` (JAVASCRIPT) -> Cumulative Risk: **437.71**
...
- **Heaviest Functions:** `addEdge` (Compute Cores, Impact: 11.7), `deleteEdge` (Compute Cores, Impact: 5.0), `findEdge` (Parameter Forwarders, Impact: 3.9)
...
- **Heaviest Functions:** `getKey` (Interface Declarations, Impact: 2.6), `constructor` (State Mutators, Impact: 2.5), `reverse` (Interface Declarations, Impact: 1.4)

### 5. `src/data-structures/heap/MaxHeapAdhoc.js` (JAVASCRIPT) -> Cumulative Risk: **432.75**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.20)
...
- **Heaviest Functions:** `heapifyDown` (I/O & Config Routines, Impact: 12.5), `heapifyUp` (Interface Declarations, Impact: 3.5), `poll` (Interface Declarations, Impact: 2.4)
...
- **Heaviest Functions:** `heapifyDown` (I/O & Config Routines, Impact: 12.6), `heapifyUp` (Interface Declarations, Impact: 3.5), `poll` (Interface Declarations, Impact: 2.4)

### 7. `src/algorithms/image-processing/seam-carving/resizeImageWidth.js` (JAVASCRIPT) -> Cumulative Risk: **425.82**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +2.03)
...
- **Heaviest Functions:** `findLowEnergySeam` (Compute Cores, Impact: 26.9), `calculateEnergyMap` (Compute Cores, Impact: 10.0), `getPixelEnergy` (Many-Argument Workhorses, Impact: 7.5)

### 8. `src/algorithms/sorting/merge-sort/MergeSort.js` (JAVASCRIPT) -> Cumulative Risk: **425.23**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +2.63)
...
- **Heaviest Functions:** `mergeSortedArrays` (Compute Cores, Impact: 10.4), `sort` (I/O & Config Routines, Impact: 3.9)
...
- **Heaviest Functions:** `inconsistent` (Tests & Verification, Impact: 3.4), `noLabels` (Callbacks & Closures, Impact: 1.4), `noClassification` (Callbacks & Closures, Impact: 1.4)
...
- **Heaviest Functions:** `solveZeroOneKnapsackProblem` (I/O & Config Routines, Impact: 20.4), `solveUnboundedKnapsackProblem` (I/O & Config Routines, Impact: 7.3), `compareCallback` (Defensive Guards, Impact: 5.6)
...
**Top Internal Functions/Classes:**
  ...
  * `find` **(Compute Cores)** (Impact: 11.0)
  ...
  * `deleteHead` **(Interface Declarations)** (Impact: 4.8)
    * *Intent:* /** * @return {LinkedListNode} */
...
**Top Internal Functions/Classes:**
  * `delete` **(Compute Cores)** (Impact: 16.6)
...
**Top Internal Functions/Classes:**
  * `findLowEnergySeam` **(Compute Cores)** (Impact: 26.9)
...
**Top Internal Functions/Classes:**
  * `remove` **(Compute Cores)** (Impact: 15.8)
  ...
  * `poll` **(Interface Declarations)** (Impact: 3.9)
    * *Intent:* /** * @return {*} */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `isNodeColored` **(Interface Declarations)** (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  ...
  * `append` **(State Mutators)** (Impact: 6.9)
...
**Top Internal Functions/Classes:**
  ...
  * `add` **(Interface Declarations)** (Impact: 1.9)
    * *Intent:* /** * @param {ComplexNumber|number} addend * @return {ComplexNumber} */
  * `subtract` **(Interface Declarations)** (Impact: 1.9)
...
**Top Internal Functions/Classes:**
  * `shortestCommonSupersequence` **(Compute Cores)** (Impact: 30.9)
    * *Intent:* /** * @param {string[]} set1 * @param {string[]} set2 * @return {string[]} */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `longestCommonSubsequence` **(Compute Cores)** (Impact: 27.0)
    * *Intent:* /** * @param {string[]} set1 * @param {string[]} set2 * @return {string[]} */
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 15 instances
* *State Mutation (weighted view):* 45
...
**Top Internal Functions/Classes:**
  ...
  * `zAlgorithm` **(Many-Argument Workhorses)** (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `mayContain` **(Interface Declarations)** (Impact: 4.9)
    * *Intent:* /** * @param {string} item * @return {boolean} */
  * `createStore` **(Interface Declarations)** (Impact: 3.8)
    * *Intent:* /** * Creates the data store for our filter. * We use this method to generate the store in order to ...
  * `hash1` **(Interface Declarations)** (Impact: 3.4)
    * *Intent:* /** * @param {string} item * @return {number} */
  * `hash3` **(Interface Declarations)** (Impact: 3.4)
    * *Intent:* /** * @param {string} item * @return {number} */
  * `hash2` **(Interface Declarations)** (Impact: 3.3)
    * *Intent:* /** * @param {string} item * @return {number} */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `longestCommonSubstring` **(Compute Cores)** (Impact: 20.4)
...
**Top Internal Functions/Classes:**
  ...
  * `poll` **(Interface Declarations)** (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  ...
  * `addVertex` **(Interface Declarations)** (Impact: 3.4)
...
**Top Internal Functions/Classes:**
  * `compareCallback` **(Tests & Verification)** (Impact: 6.0)
  * `compareCallback` **(Defensive Guards)** (Impact: 5.8)
  * `testSortWithCustomComparator` **(Tests & Verification)** (Impact: 5.1)
  * `testSortStability` **(Callbacks & Closures)** (Impact: 5.0)
