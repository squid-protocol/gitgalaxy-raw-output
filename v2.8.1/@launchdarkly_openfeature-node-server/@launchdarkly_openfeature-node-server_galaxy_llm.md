...
1. **CONTRIBUTING.md** (`package/CONTRIBUTING.md`) — 1 inbound connections
...
3. **CONTRIBUTING.md** (`package/CONTRIBUTING.md`) — 0 outbound dependencies
...
### 1. `package/release-please-config.json` (JSON) -> Cumulative Risk: **52.3**
...
### 2. `package/typedoc.json` (JSON) -> Cumulative Risk: **52.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 14.16 | **LOC:** 9 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Verification (2.2977%)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` CONTRIBUTING.md
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
