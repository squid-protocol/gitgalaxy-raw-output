...
> **File Composition:** Data / Markup / Trivial 53%, Large Core Modules 20%, Interface Declarations Files 7%, Many-Argument Workhorses Files 5%, Compute Cores Files 4%
...
- `read_PIC` **(Many-Argument Workhorses)** (@ `Bio/PDB/PICIO.py`) -> Impact: **443.5** | LOC: 775
  * *Intent:* # @profile
- `test_P04439` **(Compute Cores)** (@ `Tests/test_SwissProt.py`) -> Impact: **332.6** | LOC: 2891
...
- **Heaviest Functions:** `record_end` (Compute Cores, Impact: 37.8), `feature_qualifier` (Many-Argument Workhorses, Impact: 21.9), `reference_bases` (Compute Cores, Impact: 15.8)

### 2. `Bio/PDB/PDBList.py` (PYTHON) -> Cumulative Risk: **621.71**
- **Archetype:** `file_cluster_10` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z +0.45)
...
- **Heaviest Functions:** `retrieve_pdb_file` (Many-Argument Workhorses, Impact: 69.9), `retrieve_assembly_file` (Many-Argument Workhorses, Impact: 46.0), `update_pdb` (Many-Argument Workhorses, Impact: 31.1)
...
- **Heaviest Functions:** `elementDecl` (Many-Argument Workhorses, Impact: 63.7), `startElementHandler` (Many-Argument Workhorses, Impact: 60.3), `parse` (Defensive Guards, Impact: 30.3)
...
- **Heaviest Functions:** `_read_next_alignment` (Many-Argument Workhorses, Impact: 80.0)
...
- **Heaviest Functions:** `elucidate` (Compute Cores, Impact: 40.1), `search` (Defensive Guards, Impact: 23.5), `show_only_between` (Many-Argument Workhorses, Impact: 23.3)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 22.4), `__init__` (Defensive Guards, Impact: 16.9), `_get_seq_string` (Defensive Guards, Impact: 7.5)

### 7. `Bio/Nexus/cnexus.c` (C) -> Cumulative Risk: **598.93**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +3.06)
...
- **Heaviest Functions:** `cnexus_scanfile` (Compute Cores, Impact: 61.4), `PyInit_cnexus` (Interface Declarations, Impact: 1.2)

### 8. `Bio/Align/emboss.py` (PYTHON) -> Cumulative Risk: **596.33**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z +1.59)
...
- **Heaviest Functions:** `_read_next_alignment` (Many-Argument Workhorses, Impact: 109.7), `_read_header` (Compute Cores, Impact: 24.2)
...
- **Heaviest Functions:** `_extract_fields` (Many-Argument Workhorses, Impact: 88.8), `_search_index` (Many-Argument Workhorses, Impact: 75.5), `_create_alignment` (Many-Argument Workhorses, Impact: 72.4)

### 10. `Bio/Align/_codonaligner.c` (C) -> Cumulative Risk: **590.35**
- **Archetype:** `file_cluster_10` (Distance: N/A IQR)
- **Composition Archetype:** `Encapsulated Accessors Files` (z +0.00)
...
- **Heaviest Functions:** `Aligner_align` (Many-Argument Workhorses, Impact: 92.8), `Aligner_score` (Many-Argument Workhorses, Impact: 55.5), `PathGenerator_next` (Compute Cores, Impact: 53.6)
...
**Top Internal Functions/Classes:**
  ...
  * `_cmp` **(Compute Cores)** (Impact: 72.1)
...
**Top Internal Functions/Classes:**
  ...
  * `_matrix` **(Compute Cores)** (Impact: 82.5)
    * *Intent:* """Create a matrix for NEXUS object (PRIVATE)."""
  * `_format` **(Compute Cores)** (Impact: 69.2)
...
**Top Internal Functions/Classes:**
  ...
  * `test_gap_here_only_2` **(Interface Declarations)** (Impact: 5.7)
    * *Intent:* # Force a bad alignment. # # Forces a bad alignment by having a very expensive gap penalty # where o...
  * `test_gap_here_only_local_2` **(Interface Declarations)** (Impact: 5.7)
    * *Intent:* # Force a bad alignment. # # Forces a bad alignment by having a very expensive gap penalty # where o...
  * `test_gap_here_only_local_1` **(Interface Declarations)** (Impact: 5.6)
  * `test_gap_here_only_1` **(Interface Declarations)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_nexus1` **(Compute Cores)** (Impact: 10.7)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Many-Argument Workhorses)** (Impact: 64.1)
  * `__getitem__` **(Compute Cores)** (Impact: 51.6)
...
**Top Internal Functions/Classes:**
  * `test_record_parser_07` **(Compute Cores)** (Impact: 52.8)
  * `test_record_parser_14` **(Compute Cores)** (Impact: 30.3)
...
**Top Internal Functions/Classes:**
  ...
  * `_mod2` **(Compute Cores)** (Impact: 18.6)
...
**Top Internal Functions/Classes:**
  ...
  * `parse_features` **(Compute Cores)** (Impact: 42.4)
...
**Top Internal Functions/Classes:**
  * `test_P04439` **(Compute Cores)** (Impact: 332.6)
    * *Intent:* """Parsing SwissProt file P04439.txt."""
  * `test_P62258` **(Compute Cores)** (Impact: 58.4)
    * *Intent:* """Parsing SwissProt file P62258."""
  * `test_P16235` **(Compute Cores)** (Impact: 54.5)
    * *Intent:* """Parsing SwissProt file P16235.txt."""
  * `test_O95832` **(Compute Cores)** (Impact: 43.9)
    * *Intent:* """Parsing SwissProt file O95832.txt."""
  * `test_Q13454` **(Compute Cores)** (Impact: 37.8)
...
**Top Internal Functions/Classes:**
  ...
  * `_parse` **(Compute Cores)** (Impact: 44.8)
...
**Top Internal Functions/Classes:**
  ...
  * `_end_query_frame` **(Compute Cores)** (Impact: 16.5)
  * `_end_hit_frame` **(Compute Cores)** (Impact: 16.3)
...
**Top Internal Functions/Classes:**
  ...
  * `py_pca` **(Compute Cores)** (Impact: 37.3)
...
**Top Internal Functions/Classes:**
  ...
  * `draw_cross_link` **(Compute Cores)** (Impact: 46.1)
...
**Top Internal Functions/Classes:**
  ...
  * `sequence_converter` **(Compute Cores)** (Impact: 29.3)
