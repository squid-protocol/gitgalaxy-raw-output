...
> **File Composition:** Data / Markup / Trivial 43%, Generic / Templated Code Files 29%, Defensive Guards Files 14%, Large Core Modules 14%
...
- `import_state` **(Defensive Guards)** (@ `editables-0.5/tests/test_editable.py`) -> Impact: **8.1** | LOC: 21
...
- `find_spec` **(Defensive Guards)** (@ `editables-0.5/src/editables/redirector.py`) -> Impact: **7.4** | LOC: 13
...
- **Composition Archetype:** `Generic / Templated Code Files` (z -0.57)
...
- **Heaviest Functions:** `map` (Generic / Templated Code, Impact: 12.6), `files` (Generic / Templated Code, Impact: 6.0), `pth_file` (Type Conversions, Impact: 4.6)
...
- **Heaviest Functions:** `find_spec` (Defensive Guards, Impact: 7.4), `install` (Generic / Templated Code, Impact: 6.0), `map_module` (Generic / Templated Code, Impact: 2.1)
...
- **Heaviest Functions:** `import_state` (Defensive Guards, Impact: 8.1), `build_project` (Defensive Guards, Impact: 7.5), `test_simple_pth` (Defensive Guards, Impact: 4.0)
...
- **Heaviest Functions:** `build` (Defensive Guards, Impact: 7.3), `save_import_state` (Type Conversions, Impact: 5.0), `test_redirects` (Defensive Guards, Impact: 2.7)
...
**Top Internal Functions/Classes:**
  * `import_state` **(Defensive Guards)** (Impact: 8.1)
...
**Top Internal Functions/Classes:**
  ...
  * `test_double_install` **(Interface Declarations)** (Impact: 1.3)
...
**Top Internal Functions/Classes:**
  * `find_spec` **(Defensive Guards)** (Impact: 7.4)
