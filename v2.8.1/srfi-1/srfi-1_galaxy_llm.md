...
> **File Composition:** Data / Markup / Trivial 50%, Large Core Modules 50%
...
- `append` **(Compute Cores)** (@ `srfi-1-reference.scm`) -> Impact: **30.1** | LOC: 117
...
- **Heaviest Functions:** `unfold-right` (Many-Argument Workhorses, Impact: 204.7), `really-append-map` (Many-Argument Workhorses, Impact: 137.0), `make-list` (Many-Argument Workhorses, Impact: 83.2)
...
**Top Internal Functions/Classes:**
  ...
  * `iota` **(Many-Argument Workhorses)** (Impact: 61.4)
    * *Intent:* ;;; IOTA count [start step] (start start+step ... start+(count-1)*step)
  * `append` **(Compute Cores)** (Impact: 30.1)
    * *Intent:* ;;; append! append-reverse append-reverse! concatenate concatenate! ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;...
**Structural Signatures (Net Mitigated Signals):**
