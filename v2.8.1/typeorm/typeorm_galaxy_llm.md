...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +0.93; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 71%, Data / Markup / Trivial 10%, State Mutators Files 4%, Interface Declarations Files 4%, Callbacks & Closures Files 3%
...
- `prepareHydratedValue` **(Compute Cores)** (@ `src/driver/cockroachdb/CockroachDriver.ts`) -> Impact: **482.0** | LOC: 807
  * *Intent:* /** * Prepares given value to a value to be persisted, based on its column type or metadata. * * @param value * @param columnMetadata */
...
- `createOrderByExpression` **(Compute Cores)** (@ `src/query-builder/SelectQueryBuilder.ts`) -> Impact: **346.1** | LOC: 1381
...
- `loadTables` **(Compute Cores)** (@ `src/driver/cockroachdb/CockroachQueryRunner.ts`) -> Impact: **246.1** | LOC: 1160
...
- **Heaviest Functions:** `fillLoadMap` (Many-Argument Workhorses, Impact: 37.8), `transform` (Compute Cores, Impact: 32.5), `constructor` (State Mutators, Impact: 7.3)
...
- **Heaviest Functions:** `broadcastBeforeUpdateEvent` (Many-Argument Workhorses, Impact: 41.9), `broadcastAfterUpdateEvent` (Many-Argument Workhorses, Impact: 41.8), `broadcastBeforeRemoveEvent` (Many-Argument Workhorses, Impact: 36.4)
...
- **Heaviest Functions:** `query` (Many-Argument Workhorses, Impact: 24.4), `loadTableRecords` (Compute Cores, Impact: 9.6), `getStmt` (Compute Cores, Impact: 8.1)
...
- **Heaviest Functions:** `buildForSubjectRelation` (Many-Argument Workhorses, Impact: 52.2), `build` (Callbacks & Closures, Impact: 2.5), `constructor` (State Mutators, Impact: 1.5)

### 5. `src/driver/mysql/MysqlQueryRunner.ts` (TYPESCRIPT) -> Cumulative Risk: **660.47**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z -1.66)
...
- **Heaviest Functions:** `loadTables` (Compute Cores, Impact: 140.1), `changeColumn` (Many-Argument Workhorses, Impact: 124.3), `buildCreateColumnSql` (Compute Cores, Impact: 58.7)
...
- **Heaviest Functions:** `add` (Defensive Guards, Impact: 18.6), `set` (Defensive Guards, Impact: 15.6), `remove` (Defensive Guards, Impact: 10.9)
...
- **Heaviest Functions:** `changeColumn` (Many-Argument Workhorses, Impact: 272.2), `loadTables` (Compute Cores, Impact: 204.6), `getSchemaFromKey` (Many-Argument Workhorses, Impact: 201.1)
...
- **Heaviest Functions:** `getSchemaFromKey` (Many-Argument Workhorses, Impact: 351.4), `loadTables` (Compute Cores, Impact: 246.1), `changeColumn` (Many-Argument Workhorses, Impact: 213.7)
...
- **Heaviest Functions:** `loadTables` (Compute Cores, Impact: 158.9), `getSchemaFromKey` (Many-Argument Workhorses, Impact: 157.5), `changeColumn` (Many-Argument Workhorses, Impact: 148.5)
...
- **Heaviest Functions:** `getSchemaFromKey` (Compute Cores, Impact: 122.6), `loadTables` (Compute Cores, Impact: 118.7), `changeColumn` (Many-Argument Workhorses, Impact: 80.8)
...
**Top Internal Functions/Classes:**
  ...
  * `loadTables` **(Compute Cores)** (Impact: 246.1)
    * *Intent:* /** * Loads all tables (with given names) from the database and creates a Table from them. * * @para...
...
**Top Internal Functions/Classes:**
  ...
  * `generateConnections` **(Interface Declarations)** (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `createOrderByExpression` **(Compute Cores)** (Impact: 346.1)
    * *Intent:* /** * Creates "ORDER BY" part of SQL query. */
...
**Top Internal Functions/Classes:**
  * `getSchemaFromKey` **(Compute Cores)** (Impact: 122.6)
  ...
  * `dropColumn` **(Many-Argument Workhorses)** (Impact: 54.2)
    * *Intent:* /** * Drops column in the table. * * @param tableOrName * @param columnOrName * @param ifExists */
  * `createTableSql` **(Compute Cores)** (Impact: 43.5)
...
**Top Internal Functions/Classes:**
  ...
  * `buildCreateColumnSql` **(Compute Cores)** (Impact: 58.7)
  ...
  * `dropColumn` **(Many-Argument Workhorses)** (Impact: 51.3)
    * *Intent:* /** * Drops column in the table. * * @param tableOrName * @param columnOrName * @param ifExists */
  * `createTableSql` **(Compute Cores)** (Impact: 48.1)
...
**Top Internal Functions/Classes:**
  ...
  * `resolveExplainTimeoutOptions` **(Compute Cores)** (Impact: 14.4)
...
**Top Internal Functions/Classes:**
  ...
  * `dropColumn` **(Many-Argument Workhorses)** (Impact: 46.5)
    * *Intent:* /** * Drops column in the table. * * @param tableOrName * @param columnOrName * @param ifExists */
  * `createTableSql` **(Compute Cores)** (Impact: 31.7)
    * *Intent:* /** * Builds and returns SQL for create table. * * @param table * @param createForeignKeys */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `dropColumn` **(Many-Argument Workhorses)** (Impact: 46.3)
    * *Intent:* /** * Drops column in the table. * * @param tableOrName * @param columnOrName * @param ifExists */
  * `buildCreateColumnSql` **(Compute Cores)** (Impact: 46.1)
    * *Intent:* /** * Builds a part of query to create/change a column. * * @param column * @param skipPrimary * @pa...
  * `createTableSql` **(Compute Cores)** (Impact: 42.4)
    * *Intent:* /** * Builds create table sql * * @param table * @param createForeignKeys */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `buildCreateColumnSql` **(Compute Cores)** (Impact: 36.5)
...
**Top Internal Functions/Classes:**
  ...
  * `query` **(Many-Argument Workhorses)** (Impact: 44.1)
    * *Intent:* /** * Executes a given SQL query. * * @param query * @param parameters * @param useStructuredResult ...
  * `createTableSql` **(Compute Cores)** (Impact: 31.6)
    * *Intent:* /** * Builds create table sql. * * @param table * @param createForeignKeys */
...
**Top Internal Functions/Classes:**
  * `prepareHydratedValue` **(Compute Cores)** (Impact: 482.0)
    * *Intent:* /** * Prepares given value to a value to be persisted, based on its column type or metadata. * * @pa...
  ...
  * `preparePersistentValue` **(Compute Cores)** (Impact: 41.8)
    * *Intent:* /** * Prepares given value to a value to be persisted, based on its column type and metadata. * * @p...
  * `createPool` **(Many-Argument Workhorses)** (Impact: 12.8)
...
**Top Internal Functions/Classes:**
  ...
  * `getWherePredicateCondition` **(Compute Cores)** (Impact: 38.8)
...
- `test/utils/test-utils.ts` -> **Severity: 18.938** (Embedded: 0.2548 * Error Risk: 74.3341%)
- `src/util/ObjectUtils.ts` -> **Severity: 18.656** (Embedded: 0.2662 * Error Risk: 70.0864%)
- `src/decorator/columns/Column.ts` -> **Severity: 18.037** (Embedded: 0.2111 * Error Risk: 85.4312%)
- `src/query-builder/SelectQueryBuilder.ts` -> **Severity: 15.992** (Embedded: 0.1988 * Error Risk: 80.4357%)
- `src/metadata/ColumnMetadata.ts` -> **Severity: 15.506** (Embedded: 0.1637 * Error Risk: 94.6952%)
