...
> **File Composition:** Defensive Guards Files 71%, Data / Markup / Trivial 14%, Large Core Modules 14%
...
- `byteSwapAllFields` **(Defensive Guards)** (@ `zip.zig`) -> Impact: **20.9** | LOC: 36
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 9.0), `consoleCtrlHandler` (Defensive Guards, Impact: 7.0), `SetConsoleCtrlHandler` (State Mutators, Impact: 1.9)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 14.5), `cmdlineArgs` (Defensive Guards, Impact: 5.8), `fatal` (Generic / Templated Code, Impact: 1.9)
...
- **Heaviest Functions:** `byteSwapAllFields` (Defensive Guards, Impact: 20.9), `writeZip` (Many-Argument Workhorses, Impact: 17.3), `main` (Defensive Guards, Impact: 16.6)
...
- **Heaviest Functions:** `main2` (Defensive Guards, Impact: 56.9), `verifyPathLink` (Defensive Guards, Impact: 35.4), `cleanCompilers` (Defensive Guards, Impact: 28.3)
...
- **Heaviest Functions:** `copyEnvDir` (Many-Argument Workhorses, Impact: 46.0), `main` (Defensive Guards, Impact: 41.2), `isCompilerFilesEntry` (Defensive Guards, Impact: 12.0)
...
- **Heaviest Functions:** `deleteTree` (Defensive Guards, Impact: 15.0), `deleteTreeAbsolute` (Defensive Guards, Impact: 3.2)
...
**Top Internal Functions/Classes:**
  * `byteSwapAllFields` **(Defensive Guards)** (Impact: 20.9)
  * `writeZip` **(Many-Argument Workhorses)** (Impact: 17.3)
  * `main` **(Defensive Guards)** (Impact: 16.6)
  * `Zipper` **(Defensive Guards)** (Impact: 8.7)
