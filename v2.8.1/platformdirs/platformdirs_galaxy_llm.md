...
> **File Composition:** Generic / Templated Code Files 29%, Defensive Guards Files 18%, Declarative / Non-Code 12%, Large Core Modules 12%, Tests & Verification Files 12%
...
- `test_windows` **(Compute Cores)** (@ `platformdirs-4.9.4/tests/test_windows.py`) -> Impact: **24.8** | LOC: 45
...
- `_append_parts` **(Compute Cores)** (@ `platformdirs-4.9.4/src/platformdirs/windows.py`) -> Impact: **14.7** | LOC: 14
...
- **Heaviest Functions:** `_append_parts` (Compute Cores, Impact: 14.7), `get_win_folder_via_ctypes` (Compute Cores, Impact: 14.1), `get_win_folder_if_csidl_name_not_env_var` (Compute Cores, Impact: 13.1)
...
- **Heaviest Functions:** `_site_data_dirs` (Generic / Templated Code, Impact: 5.9), `_site_config_dirs` (Generic / Templated Code, Impact: 5.9), `_site_applications_dirs` (Generic / Templated Code, Impact: 5.9)

### 3. `platformdirs-4.9.4/src/platformdirs/android.py` (PYTHON) -> Cumulative Risk: **534.43**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z +1.04)
...
- **Heaviest Functions:** `_android_folder` (I/O & Config Routines, Impact: 15.2), `user_log_dir` (Generic / Templated Code, Impact: 3.2), `user_runtime_dir` (Generic / Templated Code, Impact: 3.2)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 6.4), `_append_app_name_and_version` (Type Conversions, Impact: 5.6), `_first_item_as_path_if_multipath` (Generic / Templated Code, Impact: 3.7)
...
- **Heaviest Functions:** `user_runtime_dir` (Compute Cores, Impact: 7.8), `_get_user_dirs_folder` (Compute Cores, Impact: 6.7), `site_runtime_dir` (Compute Cores, Impact: 5.0)

### 6. `platformdirs-4.9.4/src/platformdirs/__init__.py` (PYTHON) -> Cumulative Risk: **447.52**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Many-Argument Workhorses Files` (z +1.90)
...
- **Heaviest Functions:** `_set_platform_dir_class` (Interface Declarations, Impact: 6.7), `user_data_dir` (Many-Argument Workhorses, Impact: 3.9), `user_config_dir` (Many-Argument Workhorses, Impact: 3.9)
...
- **Heaviest Functions:** `main` (I/O & Config Routines, Impact: 6.3)

### 8. `platformdirs-4.9.4/tests/test_comp_with_appdirs.py` (PYTHON) -> Cumulative Risk: **378.9**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Tests & Verification Files` (z +2.22)
...
- **Heaviest Functions:** `test_compatibility` (Defensive Guards, Impact: 11.5), `test_has_all_functions` (Tests & Verification, Impact: 4.3), `test_has_all_properties` (Callbacks & Closures, Impact: 3.4)

### 9. `platformdirs-4.9.4/tests/test_android.py` (PYTHON) -> Cumulative Risk: **362.44**
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.02)
...
- **Heaviest Functions:** `test_android` (Many-Argument Workhorses, Impact: 26.1), `test_android_folder_from_jnius` (Defensive Guards, Impact: 6.5), `test_android_ensure_exists_creates_opinion_subdir` (Defensive Guards, Impact: 3.1)
...
- **Heaviest Functions:** `test_android_active` (Many-Argument Workhorses, Impact: 27.8), `wrap` (Defensive Guards, Impact: 9.3), `mock_import` (Defensive Guards, Impact: 7.9)
...
**Top Internal Functions/Classes:**
  * `_append_parts` **(Compute Cores)** (Impact: 14.7)
...
**Top Internal Functions/Classes:**
  ...
  * `_append_app_name_and_version` **(Type Conversions)** (Impact: 5.6)
  * `_first_item_as_path_if_multipath` **(Generic / Templated Code)** (Impact: 3.7)
  * `_optionally_create_directory` **(Generic / Templated Code)** (Impact: 3.6)
...
**Top Internal Functions/Classes:**
  * `test_windows` **(Compute Cores)** (Impact: 24.8)
  * `_setup_ctypes_mocks` **(Defensive Guards)** (Impact: 7.4)
  ...
  * `test_get_win_folder_via_ctypes_null_result` **(Tests & Verification)** (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 14 instances
...
**Top Internal Functions/Classes:**
  * `_set_platform_dir_class` **(Interface Declarations)** (Impact: 6.7)
...
**Top Internal Functions/Classes:**
  * `_func_to_path` **(Compute Cores)** (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  * `_site_data_dirs` **(Generic / Templated Code)** (Impact: 5.9)
  * `_site_config_dirs` **(Generic / Templated Code)** (Impact: 5.9)
  * `_site_applications_dirs` **(Generic / Templated Code)** (Impact: 5.9)
...
**Top Internal Functions/Classes:**
  ...
  * `mock_import` **(Defensive Guards)** (Impact: 7.9)
  * `_fake_import` **(Generic / Templated Code)** (Impact: 5.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test_android_ensure_exists_creates_opinion_subdir` **(Defensive Guards)** (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  ...
  * `test_has_all_functions` **(Tests & Verification)** (Impact: 4.3)
  ...
  * `test_has_backward_compatible_class` **(Tests & Verification)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
