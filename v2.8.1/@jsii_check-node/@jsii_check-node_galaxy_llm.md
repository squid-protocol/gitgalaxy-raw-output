...
### 1. `package/jest.config.mjs` (JAVASCRIPT) -> Cumulative Risk: **77.49**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.21)
...
### 2. `package/run.js` (JAVASCRIPT) -> Cumulative Risk: **52.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
