...
| Doc Surface (formerly Documentation Exposure) | 48.1 | 48.1 | 48.1 | 48.1 | 48.1 |
...
- `parse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **6.0** | LOC: 1
- `parse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **6.0** | LOC: 1
- `unparse` **(State Mutators)** (@ `node-uuid/index.d.ts`) -> Impact: **3.5** | LOC: 1
...
### 1. `node-uuid/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **351.38**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +2.42)
- **Magnitude:** 5.11 | **LOC:** 56 | **CtrlFlow:** 140.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Verification (80.0%), Stability (50.0%), Safety Score (48.8216%)
- **Heaviest Functions:** `v1` (Compute Cores, Impact: 8.1), `v4` (Compute Cores, Impact: 8.1), `v1` (Compute Cores, Impact: 8.1)
