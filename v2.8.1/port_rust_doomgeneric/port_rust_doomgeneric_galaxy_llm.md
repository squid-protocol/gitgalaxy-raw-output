...
> **File Composition:** Data / Markup / Trivial 40%, Compute Cores Files 20%, Large Core Modules 20%, State Mutators Files 20%
...
- `from_char` **(State Mutators)** (@ `src/input.rs`) -> Impact: **4.6** | LOC: 7
- `DG_DrawFrame` **(Defensive Guards)** (@ `src/game.rs`) -> Impact: **3.4** | LOC: 8
- `DG_SetWindowTitle` **(Annotated Framework Methods)** (@ `src/game.rs`) -> Impact: **3.3** | LOC: 9
...
- `DG_SleepMs` **(Annotated Framework Methods)** (@ `src/game.rs`) -> Impact: **1.6** | LOC: 4
...
- **Heaviest Functions:** `DG_GetKey` (Defensive Guards, Impact: 13.0), `DG_DrawFrame` (Defensive Guards, Impact: 3.4), `DG_SetWindowTitle` (Annotated Framework Methods, Impact: 3.3)
...
- **Heaviest Functions:** `main` (Compute Cores, Impact: 15.8)
...
- **Heaviest Functions:** `from_char` (State Mutators, Impact: 4.6)
...
**Top Internal Functions/Classes:**
  ...
  * `DG_SetWindowTitle` **(Annotated Framework Methods)** (Impact: 3.3)
...
**Top Internal Functions/Classes:**
  * `from_char` **(State Mutators)** (Impact: 4.6)
**Structural Signatures (Net Mitigated Signals):**
