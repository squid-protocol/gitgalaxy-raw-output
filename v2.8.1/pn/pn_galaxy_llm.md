...
> **Composition Archetype:** `Small Flat Repo` (z +5.34; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 53%, Callbacks & Closures Files 45%, Defensive Guards Files 3%
...
- **Heaviest Functions:** `exports` (Defensive Guards, Impact: 19.6), `deferred` (Callbacks & Closures, Impact: 16.5)
...
- **Heaviest Functions:** `getOrSetPromise` (Interface Declarations, Impact: 3.0)
...
- **Heaviest Functions:** `bind` (Callbacks & Closures, Impact: 3.5)

### 4. `package/http2.js` (JAVASCRIPT) -> Cumulative Risk: **344.49**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z -0.42)
...
**Top Internal Functions/Classes:**
  * `getOrSetPromise` **(Interface Declarations)** (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
