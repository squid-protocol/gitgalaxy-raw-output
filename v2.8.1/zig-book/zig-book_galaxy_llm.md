...
> **Composition Archetype:** `Guard/Validation-Heavy` (z -0.27; from the repo's file-archetype mix)
> **File Composition:** Defensive Guards Files 42%, Data / Markup / Trivial 30%, State Mutators Files 17%, Interface Declarations Files 7%, Large Core Modules 2%
...
- **Heaviest Functions:** `decode` (Defensive Guards, Impact: 15.6), `encode` (Many-Argument Workhorses, Impact: 14.0), `_calc_decode_length` (Defensive Guards, Impact: 8.0)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 13.6), `print_matrix` (Defensive Guards, Impact: 5.7)
...
- **Heaviest Functions:** `increment` (Defensive Guards, Impact: 2.2), `main` (Defensive Guards, Impact: 2.0)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 3.8)
...
- **Heaviest Functions:** `main` (Interface Declarations, Impact: 3.5)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 11.6)

### 7. `ZigExamples/data-structures/stack.zig` (ZIG) -> Cumulative Risk: **481.59**
- **Archetype:** `file_cluster_5` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.63)
...
- **Heaviest Functions:** `push` (Defensive Guards, Impact: 4.1), `pop` (Interface Declarations, Impact: 3.1), `init` (Defensive Guards, Impact: 2.2)

### 8. `ZigExamples/data-structures/generic_stack.zig` (ZIG) -> Cumulative Risk: **475.9**
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.26)
...
- **Heaviest Functions:** `Stack` (Defensive Guards, Impact: 6.4), `push` (Defensive Guards, Impact: 4.1), `pop` (Interface Declarations, Impact: 3.1)

### 9. `ZigExamples/threads/cancel_thread.zig` (ZIG) -> Cumulative Risk: **473.31**
- **Archetype:** `file_cluster_3` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +1.03)
...
- **Heaviest Functions:** `work` (Defensive Guards, Impact: 7.8), `do_more_work` (State Mutators, Impact: 1.6), `main` (State Mutators, Impact: 1.6)

### 10. `ZigExamples/allocators/fixed_buffer_alloc.zig` (ZIG) -> Cumulative Risk: **472.52**
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.69)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 2.5)
...
**Top Internal Functions/Classes:**
  ...
  * `save_png` **(Defensive Guards)** (Impact: 7.3)
  * `_read_data_to_buffer` **(Parameter Forwarders)** (Impact: 3.8)
  * `get_image_header` **(Interface Declarations)** (Impact: 3.6)
...
**Top Internal Functions/Classes:**
  ...
  * `get_image_header` **(Interface Declarations)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `pop` **(Interface Declarations)** (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  ...
  * `do_more_work` **(State Mutators)** (Impact: 1.6)
  * `main` **(State Mutators)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `main` **(Interface Declarations)** (Impact: 1.8)
