...
| Doc Surface (formerly Documentation Exposure) | 85.6 | 85.6 | 85.6 | 85.6 | 85.6 |
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **319.73**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -0.03)
- **Magnitude:** 5.2 | **LOC:** 16 | **CtrlFlow:** 10.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (85.6215%), Tech Debt (73.1059%), Stability (50.0%)
- **Heaviest Functions:** `pad` (Parameter Forwarders, Impact: 4.0)
...
- **Magnitude:** 5.2 | **LOC:** 16 | **CtrlFlow:** 10.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (5.1174%), Tech Debt (73.1059%)
