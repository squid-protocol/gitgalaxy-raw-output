...
> **Composition Archetype:** `Typed Library` (z -0.21; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 66%, Generic / Templated Code Files 17%, Defensive Guards Files 6%, Large Core Modules 3%, Declarative / Non-Code 3%
...
- `create_nested_marker` **(Compute Cores)** (@ `poetry_core-2.3.2/src/poetry/core/packages/utils/utils.py`) -> Impact: **85.1** | LOC: 109
...
- **Composition Archetype:** `Generic / Templated Code Files` (z +0.69)
...
- **Heaviest Functions:** `_merge_single_markers` (Many-Argument Workhorses, Impact: 75.0), `__init__` (Many-Argument Workhorses, Impact: 71.1), `intersect_simplify` (Defensive Guards, Impact: 39.5)

### 2. `poetry_core-2.3.2/src/poetry/core/version/pep440/version.py` (PYTHON) -> Cumulative Risk: **705.35**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z -0.11)
...
- **Heaviest Functions:** `next_prerelease` (Defensive Guards, Impact: 18.2), `to_string` (Defensive Guards, Impact: 9.5), `next_postrelease` (Defensive Guards, Impact: 7.7)
...
- **Heaviest Functions:** `_is_wildcard_candidate` (Many-Argument Workhorses, Impact: 40.0), `_single_wildcard_range_string` (Type Conversions, Impact: 11.2), `allows` (Generic / Templated Code, Impact: 1.8)

### 4. `poetry_core-2.3.2/src/poetry/core/packages/specification.py` (PYTHON) -> Cumulative Risk: **676.0**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z -0.53)
...
- **Heaviest Functions:** `is_same_source_as` (Compute Cores, Impact: 40.8), `__init__` (Many-Argument Workhorses, Impact: 10.3), `_normalize_source_url` (Generic / Templated Code, Impact: 7.4)
...
- **Heaviest Functions:** `difference` (Defensive Guards, Impact: 40.5), `of` (Defensive Guards, Impact: 28.3), `excludes_single_wildcard_range` (Compute Cores, Impact: 15.1)

### 6. `poetry_core-2.3.2/src/poetry/core/constraints/generic/union_constraint.py` (PYTHON) -> Cumulative Risk: **670.75**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.68)
...
- **Heaviest Functions:** `union` (Defensive Guards, Impact: 59.3), `intersect` (Defensive Guards, Impact: 45.0), `invert` (Defensive Guards, Impact: 10.4)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 20.7), `_base_pep_508_name` (Compute Cores, Impact: 13.1), `pretty_constraint` (Compute Cores, Impact: 7.8)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 45.1), `file` (Generic / Templated Code, Impact: 4.5), `name` (Generic / Templated Code, Impact: 1.5)
...
- **Heaviest Functions:** `normalize_url` (Compute Cores, Impact: 24.0), `url` (Compute Cores, Impact: 11.6), `get_ignored_files` (Generic / Templated Code, Impact: 11.2)
...
- **Heaviest Functions:** `dependencies_for_locking` (Compute Cores, Impact: 23.3), `_enrich_dependency` (Many-Argument Workhorses, Impact: 21.8), `dependencies` (Compute Cores, Impact: 18.1)
...
**Top Internal Functions/Classes:**
  ...
  * `test_intersection_avoids_combinatorial_explosion` **(Compute Cores)** (Impact: 26.5)
  ...
  * `test_complex_union` **(Compute Cores)** (Impact: 18.6)
...
**Top Internal Functions/Classes:**
  ...
  * `marker` **(Compute Cores)** (Impact: 31.5)
  * `_make_file_or_dir_dep` **(Many-Argument Workhorses)** (Impact: 20.4)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 13.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_nested_marker` **(Compute Cores)** (Impact: 85.1)
...
**Top Internal Functions/Classes:**
  * `difference` **(Defensive Guards)** (Impact: 53.1)
...
**Top Internal Functions/Classes:**
  * `find_packages` **(Compute Cores)** (Impact: 43.6)
...
**Top Internal Functions/Classes:**
  ...
  * `find_excluded_files` **(Compute Cores)** (Impact: 29.5)
...
**Top Internal Functions/Classes:**
  * `_build` **(Defensive Guards)** (Impact: 19.7)
  * `build` **(Compute Cores)** (Impact: 18.1)
  * `_add_pth` **(Defensive Guards)** (Impact: 11.2)
  * `_add_file` **(Many-Argument Workhorses)** (Impact: 10.6)
...
**Top Internal Functions/Classes:**
  ...
  * `test_package_url_groups_optional` **(Defensive Guards)** (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_make_x_constraint_range` **(Many-Argument Workhorses)** (Impact: 19.5)
...
**Top Internal Functions/Classes:**
  ...
  * `_enrich_dependency` **(Many-Argument Workhorses)** (Impact: 21.8)
  * `dependencies` **(Compute Cores)** (Impact: 18.1)
  * `remove_dependency` **(Compute Cores)** (Impact: 9.6)
  * `_resolve_included_dependency_groups` **(Generic / Templated Code)** (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `clear_samples_build` **(Interface Declarations)** (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `executable` **(I/O & Config Routines)** (Impact: 8.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_normalize_source_url` **(Generic / Templated Code)** (Impact: 7.4)
