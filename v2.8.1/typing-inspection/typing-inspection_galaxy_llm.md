...
> **File Composition:** Data / Markup / Trivial 36%, Generic / Templated Code Files 29%, Large Core Modules 14%, Defensive Guards Files 7%, I/O & Config Routines Files 7%
...
- `_compile_identity_check_function` **(Many-Argument Workhorses)** (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **20.8** | LOC: 35
...
- `_compile_isinstance_check_function` **(Defensive Guards)** (@ `typing_inspection-0.4.2/src/typing_inspection/typing_objects.py`) -> Impact: **18.4** | LOC: 22
...
- `create_module` **(Compute Cores)** (@ `typing_inspection-0.4.2/tests/conftest.py`) -> Impact: **12.3** | LOC: 38
- `allowed_qualifiers` **(Compute Cores)** (@ `typing_inspection-0.4.2/src/typing_inspection/introspection.py`) -> Impact: **12.2** | LOC: 17
  * *Intent:* """The allowed [type qualifiers][type qualifier] for this annotation source."""
- `_extract_source_code_from_function` **(Compute Cores)** (@ `typing_inspection-0.4.2/tests/conftest.py`) -> Impact: **7.8** | LOC: 14
- `_unpack_annotated` **(Generic / Templated Code)** (@ `typing_inspection-0.4.2/src/typing_inspection/introspection.py`) -> Impact: **7.4** | LOC: 10
...
- **Heaviest Functions:** `inspect_annotation` (Many-Argument Workhorses, Impact: 54.1), `get_literal_values` (Many-Argument Workhorses, Impact: 49.5), `_unpack_annotated_inner` (Many-Argument Workhorses, Impact: 25.2)
...
- **Heaviest Functions:** `run` (Many-Argument Workhorses, Impact: 13.7), `create_module` (Compute Cores, Impact: 12.3), `_extract_source_code_from_function` (Compute Cores, Impact: 7.8)
...
- **Heaviest Functions:** `_compile_identity_check_function` (Many-Argument Workhorses, Impact: 20.8), `_compile_isinstance_check_function` (Defensive Guards, Impact: 18.4), `is_namedtuple` (Defensive Guards, Impact: 5.2)
...
- **Heaviest Functions:** `test_identity_member_check` (Generic / Templated Code, Impact: 2.1), `test_is_typealiastype` (Defensive Guards, Impact: 1.7), `test_is_namedtuple` (Generic / Templated Code, Impact: 1.5)
...
- **Composition Archetype:** `Generic / Templated Code Files` (z -0.05)
...
- **Heaviest Functions:** `test_is_union_origin` (Generic / Templated Code, Impact: 1.5)
...
- **Heaviest Functions:** `is_annotated` (Generic / Templated Code, Impact: 1.5), `is_any` (Generic / Templated Code, Impact: 1.5), `is_classvar` (Generic / Templated Code, Impact: 1.5)

### 7. `typing_inspection-0.4.2/tests/introspection/test_literal_values.py` (PYTHON) -> Cumulative Risk: **304.22**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Tests & Verification Files` (z +1.13)
...
- **Heaviest Functions:** `test_literal_values_skip_aliases_no_type_check` (Generic / Templated Code, Impact: 1.9), `test_literal_values_type_check` (Tests & Verification, Impact: 1.6), `test_literal_values_unpack_type_aliases_undefined` (Generic / Templated Code, Impact: 1.5)

### 8. `typing_inspection-0.4.2/tests/introspection/test_inspect_annotation.py` (PYTHON) -> Cumulative Risk: **292.8**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.60)
...
- **Heaviest Functions:** `test_annotation_source_invalid_qualifiers` (Generic / Templated Code, Impact: 3.7), `test_annotation_source_valid_qualifiers` (Generic / Templated Code, Impact: 3.6), `test_bare_qualifier` (Defensive Guards, Impact: 2.3)
...
- **Heaviest Functions:** `.uv` (I/O & Config Routines, Impact: 2.2), `install` (I/O & Config Routines, Impact: 1.2), `test` (Tests & Verification, Impact: 1.2)
...
**Top Internal Functions/Classes:**
  ...
  * `allowed_qualifiers` **(Compute Cores)** (Impact: 12.2)
    * *Intent:* """The allowed [type qualifiers][type qualifier] for this annotation source."""
  * `_unpack_annotated` **(Generic / Templated Code)** (Impact: 7.4)
    * *Intent:* # This could eventually be made public:
...
**Top Internal Functions/Classes:**
  * `_compile_identity_check_function` **(Many-Argument Workhorses)** (Impact: 20.8)
    * *Intent:* """Create a function checking that the function argument is the (unparameterized) typing `member`. T...
  * `_compile_isinstance_check_function` **(Defensive Guards)** (Impact: 18.4)
...
**Top Internal Functions/Classes:**
  ...
  * `create_module` **(Compute Cores)** (Impact: 12.3)
  * `_extract_source_code_from_function` **(Compute Cores)** (Impact: 7.8)
  * `_create_module_file` **(Generic / Templated Code)** (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  * `test_literal_values_skip_aliases_no_type_check` **(Generic / Templated Code)** (Impact: 1.9)
  * `test_literal_values_type_check` **(Tests & Verification)** (Impact: 1.6)
  * `test_literal_values_unpack_type_aliases_undefined` **(Generic / Templated Code)** (Impact: 1.5)
  * `test_literal_values_unpack_type_aliases` **(Tests & Verification)** (Impact: 1.4)
  * `test_literal_values_skip_aliases_type_check` **(Tests & Verification)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
