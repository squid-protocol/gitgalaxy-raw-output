...
> **Composition Archetype:** `Mainframe / COBOL & Config` (z -0.30; from the repo's file-archetype mix)
> **File Composition:** I/O & Config Routines Files 58%, Data / Markup / Trivial 19%, Declarative / Non-Code 16%, Defensive Guards Files 2%, Interface Declarations Files 2%
...
### 1. `src/main/cobol/ZUTZCPC.CBL` (COBOL) -> Cumulative Risk: **657.19**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.69)
...
- **Heaviest Functions:** `4200-PROCESS-KEYWORDS` (I/O & Config Routines, Impact: 26.6), `4900-PROCESS-MOCK-FILE-SPEC` (I/O & Config Routines, Impact: 23.2), `DEFAULT-CICS-STATEMENT-VALUES` (I/O & Config Routines, Impact: 18.5)

### 2. `src/main/cobol/INVDATE.CBL` (COBOL) -> Cumulative Risk: **570.98**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.61)
...
- **Heaviest Functions:** `2000-NEXT-INVOICE-DATE` (I/O & Config Routines, Impact: 5.5), `2100-HANDLE-FEBRUARY` (I/O & Config Routines, Impact: 3.5), `0000-MAIN` (Interface Declarations, Impact: 1.2)
...
- **Heaviest Functions:** `UT-ASSERT-ACCESSES` (I/O & Config Routines, Impact: 18.1), `UT-LOOKUP-MOCK` (I/O & Config Routines, Impact: 13.9), `UT-SET-MOCK` (I/O & Config Routines, Impact: 6.8)
...
- **Heaviest Functions:** `2200-IDENTIFY-CARD-TYPE` (I/O & Config Routines, Impact: 13.3), `9999-END` (I/O & Config Routines, Impact: 1.1)
...
- **Heaviest Functions:** `1000-PROCESS-NUMBER` (I/O & Config Routines, Impact: 10.6), `0000-MAIN` (I/O & Config Routines, Impact: 3.6), `0500-INITIALIZE` (I/O & Config Routines, Impact: 1.4)

### 6. `src/main/cobol/VIZZBUZZ.CBL` (COBOL) -> Cumulative Risk: **533.16**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z -0.01)
...
- **Heaviest Functions:** `1000-PROCESS-NUMBER` (I/O & Config Routines, Impact: 7.9), `0000-MAIN` (I/O & Config Routines, Impact: 3.6), `0500-INITIALIZE` (I/O & Config Routines, Impact: 1.2)
...
- **Heaviest Functions:** `2200-IDENTIFY-CARD-TYPE` (I/O & Config Routines, Impact: 13.3), `FILE-CONTROL` (I/O & Config Routines, Impact: 5.8), `9100-OPEN-FILES` (I/O & Config Routines, Impact: 2.6)
...
- **Heaviest Functions:** `2000-SPEAK` (I/O & Config Routines, Impact: 3.4), `FILE-CONTROL` (Interface Declarations, Impact: 1.4), `9999-END` (I/O & Config Routines, Impact: 1.1)

### 9. `src/main/cobol/CONVER2.CBL` (COBOL) -> Cumulative Risk: **475.59**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.09)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 4.7), `1000-PROCESS-INPUT` (I/O & Config Routines, Impact: 4.7), `2200-LOOKUP-STATE-NAME` (I/O & Config Routines, Impact: 3.5)
...
- **Heaviest Functions:** `2200-IDENTIFY-CARD-TYPE` (I/O & Config Routines, Impact: 12.4), `FILE-CONTROL` (I/O & Config Routines, Impact: 6.2), `9100-OPEN-FILES` (I/O & Config Routines, Impact: 2.6)
...
* *Risk/State:* `safety_bypasses: 1`, `state_mutation: 785`, `dead_code: 15`, `unreferenced_by_name: 3`
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.7)
  ...
  * `0500-INITIALIZE` **(I/O & Config Routines)** (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.7)
  * `2300-CONVERT-TEXT-FIELD-2` **(State Mutators)** (Impact: 3.9)
...
**Top Internal Functions/Classes:**
  ...
  * `0500-INITIALIZE` **(I/O & Config Routines)** (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 5.8)
  * `9100-OPEN-FILES` **(I/O & Config Routines)** (Impact: 2.6)
  * `2000-IDENTIFY-CARD-TYPES` **(I/O & Config Routines)** (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 6.2)
  * `9100-OPEN-FILES` **(I/O & Config Routines)** (Impact: 2.6)
  * `2000-IDENTIFY-CARD-TYPES` **(I/O & Config Routines)** (Impact: 2.2)
...
**Top Internal Functions/Classes:**
  ...
  * `0000-MAIN` **(I/O & Config Routines)** (Impact: 3.6)
  * `0500-INITIALIZE` **(I/O & Config Routines)** (Impact: 1.4)
...
**Top Internal Functions/Classes:**
  ...
  * `0000-MAIN` **(I/O & Config Routines)** (Impact: 3.6)
  * `0500-INITIALIZE` **(I/O & Config Routines)** (Impact: 1.2)
...
- **Risk Profile:** Cognitive Load (52.063%), Tech Debt (24.5297%)
**Top Internal Functions/Classes:**
  * `file-control` **(I/O & Config Routines)** (Impact: 6.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
* *State Mutation (weighted view):* 34
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(Interface Declarations)** (Impact: 1.4)
  * `9999-END` **(I/O & Config Routines)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 2.7)
