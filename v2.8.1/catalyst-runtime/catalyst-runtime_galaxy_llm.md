...
> **Composition Archetype:** `Small Flat Repo` (z +0.47; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 48%, Annotated Framework Methods Files 15%, Tests & Verification Files 10%, Interface Declarations Files 8%, Compute Cores Files 5%
...
- `run_tests` **(Compute Cores)** (@ `t/aggregate/live_component_controller_action_chained.t`) -> Impact: **279.4** | LOC: 1147
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_visit.t`) -> Impact: **62.0** | LOC: 259
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_go.t`) -> Impact: **57.1** | LOC: 242
- `run_tests` **(I/O & Config Routines)** (@ `t/aggregate/live_component_controller_action_auto.t`) -> Impact: **40.0** | LOC: 160
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_action.t`) -> Impact: **37.1** | LOC: 242
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_forward.t`) -> Impact: **36.7** | LOC: 234
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_local.t`) -> Impact: **28.3** | LOC: 126
- `run_test_for` **(Compute Cores)** (@ `t/aggregate/live_component_controller_args.t`) -> Impact: **26.2** | LOC: 43
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_default.t`) -> Impact: **22.6** | LOC: 71
- `run_tests` **(Tests & Verification)** (@ `t/aggregate/live_component_controller_action_path.t`) -> Impact: **21.9** | LOC: 138
...
- **Heaviest Functions:** `prove` (Compute Cores, Impact: 9.3), `wait_port_timeout` (Parameter Forwarders, Impact: 2.1)
...
- **Heaviest Functions:** `root` (Annotated Framework Methods, Impact: 2.0), `a` (Interface Declarations, Impact: 1.1), `b` (Interface Declarations, Impact: 1.1)

### 3. `t/class_traits_CAR_bug.t` (PERL) -> Cumulative Risk: **528.91**
- **Archetype:** `file_cluster_1` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.21)
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z +1.91)
...
- **Heaviest Functions:** `main` (Annotated Framework Methods, Impact: 10.7), `handle_unicode_encoding_exception` (Parameter Forwarders, Impact: 2.4)

### 5. `t/aggregate/live_component_controller_args.t` (PERL) -> Cumulative Risk: **478.15**
- **Archetype:** `file_cluster_17` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +1.99)
...
- **Heaviest Functions:** `run_test_for` (Compute Cores, Impact: 26.2), `run_tests` (Interface Declarations, Impact: 2.1)

### 6. `t/useless_set_headers.t` (PERL) -> Cumulative Risk: **476.68**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.45)
...
- **Heaviest Functions:** `get_header_ok` (Annotated Framework Methods, Impact: 3.7), `set_header_nok` (Annotated Framework Methods, Impact: 3.7), `warn` (Interface Declarations, Impact: 1.5)

### 7. `t/forward_instances.t` (PERL) -> Cumulative Risk: **475.89**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z +3.07)
...
- **Heaviest Functions:** `custom` (Type Conversions, Impact: 4.2), `test_forward` (Annotated Framework Methods, Impact: 3.7), `test_custom` (Annotated Framework Methods, Impact: 3.7)
...
- **Heaviest Functions:** `main` (Annotated Framework Methods, Impact: 6.2), `as_psgi` (Callbacks & Closures, Impact: 2.5), `new` (Type Conversions, Impact: 2.4)

### 9. `t/accept_context_regression.t` (PERL) -> Cumulative Risk: **467.42**
- **Archetype:** `file_cluster_13` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z +2.10)
...
- **Heaviest Functions:** `test_model` (Annotated Framework Methods, Impact: 3.7), `ACCEPT_CONTEXT` (Type Conversions, Impact: 2.2)

### 10. `t/bad_warnings.t` (PERL) -> Cumulative Risk: **466.62**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.29)
...
- **Heaviest Functions:** `test` (Annotated Framework Methods, Impact: 3.7), `infinity` (Annotated Framework Methods, Impact: 3.7), `midpoint` (Annotated Framework Methods, Impact: 3.7)
...
**Top Internal Functions/Classes:**
  * `run_tests` **(Compute Cores)** (Impact: 279.4)
...
**Top Internal Functions/Classes:**
  ...
  * `user_object` **(Annotated Framework Methods)** (Impact: 8.2)
...
**Top Internal Functions/Classes:**
  * `stream_body_fh2` **(Annotated Framework Methods)** (Impact: 9.1)
    * *Intent:* # If you pull the file contents into a var, NOW you need to specify the # IO encoding on the FH. Ult...
  * `stream_body_fh` **(Annotated Framework Methods)** (Impact: 7.3)
    * *Intent:* # Stream a file with utf8 chars directly, you don't need to decode
  * `argend` **(Many-Argument Workhorses)** (Impact: 4.8)
  * `file_upload` **(Annotated Framework Methods)** (Impact: 4.4)
  * `file_upload_utf8_param` **(Annotated Framework Methods)** (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `filehandle` **(Annotated Framework Methods)** (Impact: 8.3)
...
**Top Internal Functions/Classes:**
  * `a` **(Annotated Framework Methods)** (Impact: 6.3)
  * `b` **(Annotated Framework Methods)** (Impact: 6.3)
  * `root` **(Annotated Framework Methods)** (Impact: 5.6)
  * `d` **(Annotated Framework Methods)** (Impact: 5.6)
  * `root` **(Annotated Framework Methods)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `run_tests` **(Tests & Verification)** (Impact: 62.0)
  * `_begin` **(Interface Declarations)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `run_tests` **(Tests & Verification)** (Impact: 57.1)
  * `_begin` **(Interface Declarations)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 5 instances
* *State Mutation (weighted view):* 16
...
**Top Internal Functions/Classes:**
  ...
  * `COMPONENT` **(Interface Declarations)** (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `is_http` **(Annotated Framework Methods)** (Impact: 3.7)
  * `is_https` **(Annotated Framework Methods)** (Impact: 3.7)
  * `is_http_chain` **(Annotated Framework Methods)** (Impact: 3.7)
  * `is_https_chain` **(Annotated Framework Methods)** (Impact: 3.7)
  * `uri_for1` **(Annotated Framework Methods)** (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `two` **(Tests & Verification)** (Impact: 4.4)
  * `auto` **(Annotated Framework Methods)** (Impact: 3.9)
  * `end` **(Tests & Verification)** (Impact: 3.9)
  * `begin` **(Annotated Framework Methods)** (Impact: 3.7)
  * `base` **(Annotated Framework Methods)** (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `from_psgi_app` **(Annotated Framework Methods)** (Impact: 3.8)
  * `from_catalyst` **(Annotated Framework Methods)** (Impact: 3.7)
  * `classic_error` **(Annotated Framework Methods)** (Impact: 3.7)
  * `just_die` **(Annotated Framework Methods)** (Impact: 3.7)
  * `end` **(Annotated Framework Methods)** (Impact: 3.0)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `run_tests` **(Tests & Verification)** (Impact: 36.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 6
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `run_tests` **(Tests & Verification)** (Impact: 37.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `string_types` **(Annotated Framework Methods)** (Impact: 2.0)
  * `as_ref` **(Annotated Framework Methods)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  * `default` **(Annotated Framework Methods)** (Impact: 5.4)
  * `author` **(Annotated Framework Methods)** (Impact: 4.3)
  * `story` **(Annotated Framework Methods)** (Impact: 3.8)
  * `top` **(Annotated Framework Methods)** (Impact: 3.7)
  * `root` **(Annotated Framework Methods)** (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
**Top Internal Functions/Classes:**
  ...
  * `testRestart` **(Tests & Verification)** (Impact: 2.2)
  * `opthash` **(I/O & Config Routines)** (Impact: 1.6)
