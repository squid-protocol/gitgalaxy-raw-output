...
> **File Composition:** Data / Markup / Trivial 75%, Callbacks & Closures Files 8%, Large Core Modules 8%, State Mutators Files 8%
...
- **Heaviest Functions:** `resolveAsyncConfigs` (Defensive Guards, Impact: 11.2), `iterate` (Defensive Guards, Impact: 10.8), `asyncConfig` (Callbacks & Closures, Impact: 5.6)

### 2. `package/parser.js` (JAVASCRIPT) -> Cumulative Risk: **543.46**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z +1.83)
...
- **Heaviest Functions:** `tsParser` (Compute Cores, Impact: 13.3), `yamlParser` (Defensive Guards, Impact: 13.1), `setFilesOrder` (Defensive Guards, Impact: 9.3)
...
- **Heaviest Functions:** `asyncConfig` (Generic / Templated Code, Impact: 1.5), `asyncConfig` (Generic / Templated Code, Impact: 1.5), `resolveAsyncConfigs` (Generic / Templated Code, Impact: 1.5)

### 4. `package/types/parser.d.ts` (TYPESCRIPT) -> Cumulative Risk: **318.06**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z -0.17)
...
- **Heaviest Functions:** `setFilesOrder` (State Mutators, Impact: 3.5), `getFilesOrder` (State Mutators, Impact: 2.9), `parse` (State Mutators, Impact: 1.8)
...
- **Heaviest Functions:** `deferConfig` (Callbacks & Closures, Impact: 2.0)
...
- **Heaviest Functions:** `raw` (Callbacks & Closures, Impact: 1.6)
...
- **Heaviest Functions:** `raw` (Interface Declarations, Impact: 1.7)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `raw` **(Interface Declarations)** (Impact: 1.7)
...
**Top Internal Functions/Classes:**
  * `setFilesOrder` **(State Mutators)** (Impact: 3.5)
    * *Intent:* /** * @param {string|string[]} name * @param {number=} newIndex * @returns {string[]} */
  * `getFilesOrder` **(State Mutators)** (Impact: 2.9)
