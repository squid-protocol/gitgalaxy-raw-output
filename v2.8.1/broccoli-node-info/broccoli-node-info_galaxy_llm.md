...
- `InvalidNodeError` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **1.9** | LOC: 9
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **509.31**
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Cognitive Load (85.9425%), Safety Score (81.1666%)
- **Heaviest Functions:** `getNodeInfo` (Defensive Guards, Impact: 30.5), `InvalidNodeError` (Interface Declarations, Impact: 1.9), `instantiationStack` (Interface Declarations, Impact: 1.1)
...
- **Magnitude:** 80.4 | **LOC:** 142 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (85.9425%), Tech Debt (34.1213%)
**Top Internal Functions/Classes:**
  * `getNodeInfo` **(Defensive Guards)** (Impact: 30.5)
  * `InvalidNodeError` **(Interface Declarations)** (Impact: 1.9)
