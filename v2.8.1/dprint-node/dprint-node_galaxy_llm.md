...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 78.9 | 39.5 | 39.5 | 78.9 |
...
- `format` **(State Mutators)** (@ `package/index.d.ts`) -> Impact: **4.0** | LOC: 1
...
### 1. `package/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **289.14**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 0.25 | **LOC:** 4 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (78.916%), Tech Debt (50.0%), Stability (50.0%)
- **Heaviest Functions:** `format` (State Mutators, Impact: 4.0)

### 2. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **280.11**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.89)
- **Magnitude:** 31.28 | **LOC:** 16 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (99.9932%), Safety Score (75.2927%), Stability (50.0%), Cognitive Load (49.0001%)
...
**Top Internal Functions/Classes:**
  * `format` **(State Mutators)** (Impact: 4.0)
**Structural Signatures (Net Mitigated Signals):**
