...
> **File Composition:** I/O & Config Routines Files 57%, Declarative / Non-Code 14%, Large Core Modules 14%, State Mutators Files 14%
...
- `MAIN-PROCEDURE` **(I/O & Config Routines)** (@ `recursion.cbl`) -> Impact: **11.2** | LOC: 25
...
- `EVALUATE-CURRENT-COMMAND` **(I/O & Config Routines)** (@ `lisp.cbl`) -> Impact: **7.5** | LOC: 10
...
- `FORMAT-PAREN-SPACE-PROCEDURE` **(I/O & Config Routines)** (@ `tokenizer.cbl`) -> Impact: **6.5** | LOC: 10
- `FILE-CONTROL` **(I/O & Config Routines)** (@ `tokenizer.cbl`) -> Impact: **6.1** | LOC: 61
...
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.97)
...
- **Heaviest Functions:** `FORMAT-LISP-PROCEDURE` (I/O & Config Routines, Impact: 8.8), `FILE-HANDLING-PROCEDURE` (I/O & Config Routines, Impact: 8.2), `CALC-LISP-LENGTH` (I/O & Config Routines, Impact: 8.0)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (I/O & Config Routines, Impact: 6.5), `FILE-CONTROL` (Interface Declarations, Impact: 1.9), `LOG-INIT-PROCEDURE` (I/O & Config Routines, Impact: 1.4)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (I/O & Config Routines, Impact: 11.2), `EVALUATE-CURRENT-COMMAND` (I/O & Config Routines, Impact: 7.5), `EVALUATE-CURRENT-VALUES` (I/O & Config Routines, Impact: 7.0)

### 4. `cisp.cbl` (COBOL) -> Cumulative Risk: **463.4**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z -0.05)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 4.5), `READ-CMD-LINE-PROCEDURE` (Interface Declarations, Impact: 1.5), `MAIN-PROCEDURE` (Interface Declarations, Impact: 1.4)

### 5. `recursion.cbl` (COBOL) -> Cumulative Risk: **460.0**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +2.65)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (I/O & Config Routines, Impact: 11.2), `PRINT-CALL-STACK-PROCEDURE` (I/O & Config Routines, Impact: 4.8), `FILE-CONTROL` (I/O & Config Routines, Impact: 4.0)

### 6. `cisp-error.cbl` (COBOL) -> Cumulative Risk: **416.09**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.63)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (I/O & Config Routines, Impact: 3.2), `THROW-ERROR-PROCEDURE` (I/O & Config Routines, Impact: 2.5), `CLOSE-OPEN-FILES-PROCEDURE` (Interface Declarations, Impact: 2.5)

### 7. `bin/cisp.bat` (BATCH) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.42)
...
**Top Internal Functions/Classes:**
  ...
  * `FORMAT-PAREN-SPACE-PROCEDURE` **(I/O & Config Routines)** (Impact: 6.5)
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 6.1)
...
**Top Internal Functions/Classes:**
  * `MAIN-PROCEDURE` **(I/O & Config Routines)** (Impact: 11.2)
  * `EVALUATE-CURRENT-COMMAND` **(I/O & Config Routines)** (Impact: 7.5)
  * `EVALUATE-CURRENT-VALUES` **(I/O & Config Routines)** (Impact: 7.0)
  * `INIT-RECURSION-OBJECT-PROCEDURE` **(Interface Declarations)** (Impact: 3.9)
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 4.5)
...
**Top Internal Functions/Classes:**
  ...
  * `FILE-CONTROL` **(Interface Declarations)** (Impact: 1.9)
...
**Top Internal Functions/Classes:**
  * `MAIN-PROCEDURE` **(I/O & Config Routines)** (Impact: 3.2)
  * `THROW-ERROR-PROCEDURE` **(I/O & Config Routines)** (Impact: 2.5)
  * `CLOSE-OPEN-FILES-PROCEDURE` **(Interface Declarations)** (Impact: 2.5)
