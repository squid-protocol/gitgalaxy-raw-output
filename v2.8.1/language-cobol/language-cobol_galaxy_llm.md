...
| mutation | 0 | 0 | 0 | - |
| dead_code | 0 | 0 | 0 | - |
| credential | 2 | 1 | 0 | `grammars/cobol.json` |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
| ui | 0 | 0 | 0 | - |
...
|---|---|---|---|---|
| `grammars` | 2 | 41.14 | 0.0% | 0.0% |
| `__monolith__` | 3 | 17.48 | 0.0% | 0.0% |
| `settings` | 1 | 15.24 | 0.0% | 0.0% |
| `snippets` | 1 | 14.16 | 0.0% | 0.0% |
...
### 1. `.eslintrc` (JSON) -> Cumulative Risk: **2.3**
...
### 2. `grammars/cobol.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 25.16 | **LOC:** 509 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 3. `grammars/jcl.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 15.98 | **LOC:** 50 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 4. `settings/language-cobol.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
- **Magnitude:** 15.24 | **LOC:** 13 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Verification (2.2977%)

### 5. `snippets/language-cobol.json` (JSON) -> Cumulative Risk: **2.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
