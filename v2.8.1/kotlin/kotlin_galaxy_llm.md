...
> **Composition Archetype:** `Flat Modular Platform` (z +1.97; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 54%, Interface Declarations Files 20%, Declarative / Non-Code 5%, Annotated Framework Methods Files 4%, Generic / Templated Code Files 4%
...
| connectivity | 90808 | 18086 | 1 | `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java` |
...
| threat | 67705 | 16350 | 1 | `libraries/tools/kotlin-gradle-plugin-integration-tests/src/test/resources/testProject/commonizeSQLiteAndCurlInterop/libs/sqlite3.h` |
...
- `irSetSlotUncertain` **(Compute Cores)** (@ `plugins/compose/compiler-hosted/src/main/java/androidx/compose/compiler/plugins/kotlin/lower/ComposableFunctionBodyTransformer.kt`) -> Impact: **320.9** | LOC: 1610
...
- `translateExtensions` **(Many-Argument Workhorses)** (@ `native/objcexport-header-generator/impl/k1/src/org/jetbrains/kotlin/backend/konan/objcexport/ObjCExportTranslator.kt`) -> Impact: **276.8** | LOC: 1067
- `singleExpressionImpl` **(Compute Cores)** (@ `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java`) -> Impact: **259.6** | LOC: 724
...
- **Composition Archetype:** `Parameter Forwarders Files` (z +2.31)
...
- **Heaviest Functions:** `test` (Compute Cores, Impact: 217.1), `ordinaryNoninlineAcceptsVCString` (Parameter Forwarders, Impact: 1.9), `ordinaryNoninlineAcceptsVCStringNullable` (Parameter Forwarders, Impact: 1.9)

### 2. `compiler/testData/codegen/box/coroutines/suspendFunctionAsCoroutine/operators.kt` (KOTLIN) -> Cumulative Risk: **765.99**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z -0.22)
...
- **Heaviest Functions:** `foo9` (Interface Declarations, Impact: 4.2), `minusAssign` (Callbacks & Closures, Impact: 3.1), `foo2` (Interface Declarations, Impact: 2.2)
...
- **Heaviest Functions:** `testFoo` (Compute Cores, Impact: 81.2), `box` (Defensive Guards, Impact: 12.7), `testFunInterface` (Compute Cores, Impact: 5.7)
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z +1.73)
...
- **Heaviest Functions:** `equals` (Type Conversions, Impact: 9.0), `computeValue` (Generic / Templated Code, Impact: 6.9), `printStackTrace` (Compute Cores, Impact: 6.3)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `fooCallableReferenceIndirectRecursion` (Interface Declarations, Impact: 7.6), `foo` (Compute Cores, Impact: 7.5), `foo2` (Compute Cores, Impact: 7.5)

### 6. `native/swift/swift-export-standalone-integration-tests/coroutines/testData/generation/coroutines/golden_result/KotlinxCoroutinesCore/KotlinxCoroutinesCore.kt` (KOTLIN) -> Cumulative Risk: **723.37**
- **Archetype:** `file_cluster_15` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.66)
- **Magnitude:** 0.11 | **LOC:** 188 | **CtrlFlow:** 14.0% | **Authorship Centralization:** 40.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.4533%), Concurrency (96.3708%)
- **Heaviest Functions:** `kotlinx_coroutines_flow_FlowCollector_emit__TypesOfArguments__Swift_Optional_anyU20KotlinRuntimeSupport__KotlinBridgeable___` (Many-Argument Workhorses, Impact: 13.8), `kotlinx_coroutines_flow_MutableSharedFlow_emit__TypesOfArguments__Swift_Optional_anyU20KotlinRuntimeSupport__KotlinBridgeable___` (Many-Argument Workhorses, Impact: 13.8), `kotlinx_coroutines_flow_MutableStateFlow_compareAndSet__TypesOfArguments__Swift_Optional_anyU20KotlinRuntimeSupport__KotlinBridgeable__Swift_Optional_anyU20KotlinRuntimeSupport__KotlinBridgeable___` (Compute Cores, Impact: 10.4)

### 7. `compiler/testData/ir/irText/expressions/callableReferences/caoWithAdaptationForSuspend.kt` (KOTLIN) -> Cumulative Risk: **716.67**
- **Archetype:** `file_cluster_12` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.78)
...
- **Heaviest Functions:** `test4` (Defensive Guards, Impact: 3.1), `set` (Parameter Forwarders, Impact: 1.8), `set` (Parameter Forwarders, Impact: 1.8)

### 8. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda1.kt` (KOTLIN) -> Cumulative Risk: **713.3**
...
- **Heaviest Functions:** `runControllers` (Compute Cores, Impact: 12.9), `box` (I/O & Config Routines, Impact: 4.5), `builder` (Interface Declarations, Impact: 1.9)

### 9. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda3.kt` (KOTLIN) -> Cumulative Risk: **710.72**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
### 10. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda2.kt` (KOTLIN) -> Cumulative Risk: **709.3**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Risk Profile:** Cognitive Load (41.5293%), Tech Debt (99.9657%)
**Top Internal Functions/Classes:**
  * `singleExpressionImpl` **(Compute Cores)** (Impact: 259.6)
...
**Top Internal Functions/Classes:**
  * `irSetSlotUncertain` **(Compute Cores)** (Impact: 320.9)
...
**Top Internal Functions/Classes:**
  ...
  * `convertFunctionDeclaration` **(Compute Cores)** (Impact: 71.2)
  ...
  * `convertClass` **(Compute Cores)** (Impact: 63.0)
...
**Top Internal Functions/Classes:**
  ...
  * `getRendererForDiagnostic` **(Annotated Framework Methods)** (Impact: 6.2)
  * `render` **(Defensive Guards)** (Impact: 4.7)
  * `getMap` **(Annotated Framework Methods)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `wrapException` **(Compute Cores)** (Impact: 237.1)
  ...
  * `evaluateOperatorCall` **(Compute Cores)** (Impact: 25.4)
...
**Top Internal Functions/Classes:**
  ...
  * `analyze` **(Compute Cores)** (Impact: 55.6)
  * `visitCall` **(Many-Argument Workhorses)** (Impact: 48.2)
  * `dfgNodeToConstraintNode` **(Defensive Guards)** (Impact: 41.0)
...
**Top Internal Functions/Classes:**
  * `convertCallExpression` **(Compute Cores)** (Impact: 33.8)
  ...
  * `convertWhenExpression` **(Compute Cores)** (Impact: 28.9)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinExpressionParsing.parseWhen * @see org.jetbrains.kotli...
  * `wrapExpressionIfNeeded` **(Defensive Guards)** (Impact: 28.5)
...
**Top Internal Functions/Classes:**
  ...
  * `mapElement` **(Defensive Guards)** (Impact: 40.7)
  * `addTypeOperatorStatements` **(Compute Cores)** (Impact: 32.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (23.9399%), Tech Debt (51.6441%)
**Top Internal Functions/Classes:**
  ...
  * `visitBinaryExpression` **(Compute Cores)** (Impact: 49.9)
...
**Top Internal Functions/Classes:**
  ...
  * `buildDrains` **(Compute Cores)** (Impact: 41.4)
  * `computeLifetimes` **(Compute Cores)** (Impact: 28.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `toDoubleHighPrecision` **(Compute Cores)** (Impact: 65.9)
  * `addHighPrecision` **(Many-Argument Workhorses)** (Impact: 35.7)
  * `compareHighPrecision` **(Many-Argument Workhorses)** (Impact: 34.7)
...
**Top Internal Functions/Classes:**
  * `updateLvtAccordingToLiveness` **(Defensive Guards)** (Impact: 83.3)
...
**Top Internal Functions/Classes:**
  * `constructor` **(Compute Cores)** (Impact: 204.6)
  ...
  * `toString` **(Compute Cores)** (Impact: 27.2)
