...
> **File Composition:** Declarative / Non-Code 33%, Large Core Modules 24%, Data / Markup / Trivial 19%, Interface Declarations Files 14%, Callbacks & Closures Files 10%
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 39.1 | 0.0 | 0.0 |
...
- `extract_params` **(Compute Cores)** (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **24.8** | LOC: 16
...
- `fore` **(Many-Argument Workhorses)** (@ `colorama-0.4.6/colorama/winterm.py`) -> Impact: **9.4** | LOC: 10
- `back` **(Many-Argument Workhorses)** (@ `colorama-0.4.6/colorama/winterm.py`) -> Impact: **9.4** | LOC: 10
...
### 1. `colorama-0.4.6/colorama/ansitowin32.py` (PYTHON) -> Cumulative Risk: **644.79**
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (95.9504%), Documentation (90.9091%)
- **Heaviest Functions:** `extract_params` (Compute Cores, Impact: 24.8), `__init__` (Many-Argument Workhorses, Impact: 24.0), `call_win32` (Many-Argument Workhorses, Impact: 17.0)

### 2. `colorama-0.4.6/colorama/winterm.py` (PYTHON) -> Cumulative Risk: **636.33**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z -0.42)
- **Magnitude:** 245.56 | **LOC:** 196 | **CtrlFlow:** 18.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.3348%)
- **Heaviest Functions:** `erase_screen` (Many-Argument Workhorses, Impact: 15.6), `erase_line` (Many-Argument Workhorses, Impact: 13.2), `fore` (Many-Argument Workhorses, Impact: 9.4)

### 3. `colorama-0.4.6/colorama/ansi.py` (PYTHON) -> Cumulative Risk: **600.4**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +3.12)
- **Magnitude:** 84.36 | **LOC:** 103 | **CtrlFlow:** 2.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (96.584%)
- **Heaviest Functions:** `__init__` (Compute Cores, Impact: 4.6), `POS` (Type Conversions, Impact: 2.1), `UP` (Type Conversions, Impact: 1.8)

### 4. `colorama-0.4.6/colorama/initialise.py` (PYTHON) -> Cumulative Risk: **566.9**
...
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.7494%)
- **Heaviest Functions:** `init` (Many-Argument Workhorses, Impact: 19.2), `just_fix_windows_console` (I/O & Config Routines, Impact: 8.1), `wrap_stream` (Many-Argument Workhorses, Impact: 7.7)

### 5. `colorama-0.4.6/colorama/win32.py` (PYTHON) -> Cumulative Risk: **556.6**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.96)
- **Magnitude:** 123.58 | **LOC:** 181 | **CtrlFlow:** 4.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (95.3556%), Documentation (90.4762%)
- **Heaviest Functions:** `SetConsoleCursorPosition` (Many-Argument Workhorses, Impact: 8.8), `SetConsoleMode` (Parameter Forwarders, Impact: 3.7), `GetConsoleMode` (Interface Declarations, Impact: 3.1)

### 6. `colorama-0.4.6/demos/demo06.py` (PYTHON) -> Cumulative Risk: **446.28**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z -0.53)
- **Magnitude:** 13.22 | **LOC:** 43 | **CtrlFlow:** 11.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (98.2014%), Safety Score (73.6639%)
- **Heaviest Functions:** `main` (Callbacks & Closures, Impact: 3.7)

### 7. `colorama-0.4.6/demos/demo09.py` (PYTHON) -> Cumulative Risk: **351.51**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z +1.92)
...
- **Heaviest Functions:** `find` (Parameter Forwarders, Impact: 1.8), `format` (Callbacks & Closures, Impact: 1.5)

### 8. `colorama-0.4.6/colorama/tests/utils.py` (PYTHON) -> Cumulative Risk: **346.99**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (85.8149%), Stability (50.0%)
- **Heaviest Functions:** `replace_by` (Interface Declarations, Impact: 1.8), `replace_original_by` (Interface Declarations, Impact: 1.8), `osname` (Interface Declarations, Impact: 1.7)

### 9. `colorama-0.4.6/demos/demo07.py` (PYTHON) -> Cumulative Risk: **298.38**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z -0.02)
- **Magnitude:** 6.9 | **LOC:** 28 | **CtrlFlow:** 6.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (68.9974%), Safety Score (66.1183%), Stability (50.0%)
- **Heaviest Functions:** `main` (Interface Declarations, Impact: 1.6)

### 10. `colorama-0.4.6/demos/demo01.py` (PYTHON) -> Cumulative Risk: **199.3**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Declarative / Non-Code` (z +0.34)
- **Magnitude:** 19.56 | **LOC:** 49 | **CtrlFlow:** 14.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (68.9974%), Safety Score (66.5013%), Stability (50.0%), Cognitive Load (11.5067%)
...
- **Magnitude:** 283.24 | **LOC:** 278 | **CtrlFlow:** 29.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (66.7983%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `extract_params` **(Compute Cores)** (Impact: 24.8)
...
**Top Internal Functions/Classes:**
  ...
  * `fore` **(Many-Argument Workhorses)** (Impact: 9.4)
  * `back` **(Many-Argument Workhorses)** (Impact: 9.4)
...
- **Magnitude:** 132.16 | **LOC:** 122 | **CtrlFlow:** 24.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (72.3893%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `init` **(Many-Argument Workhorses)** (Impact: 19.2)
  * `just_fix_windows_console` **(I/O & Config Routines)** (Impact: 8.1)
  * `wrap_stream` **(Many-Argument Workhorses)** (Impact: 7.7)
...
- **Magnitude:** 123.58 | **LOC:** 181 | **CtrlFlow:** 4.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (68.4686%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `SetConsoleCursorPosition` **(Many-Argument Workhorses)** (Impact: 8.8)
  * `SetConsoleMode` **(Parameter Forwarders)** (Impact: 3.7)
  * `GetConsoleMode` **(Interface Declarations)** (Impact: 3.1)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 84.36 | **LOC:** 103 | **CtrlFlow:** 2.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (78.4618%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  * `replace_by` **(Interface Declarations)** (Impact: 1.8)
  * `replace_original_by` **(Interface Declarations)** (Impact: 1.8)
  * `osname` **(Interface Declarations)** (Impact: 1.7)
  * `isatty` **(Interface Declarations)** (Impact: 1.5)
  * `isatty` **(Interface Declarations)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
### `colorama-0.4.6/demos/demo.bat` (BATCH | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 13.22 | **LOC:** 43 | **CtrlFlow:** 11.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (18.5427%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
