...
### 1. `package/README.md` (MARKDOWN) -> Cumulative Risk: **100.0**
...
### 2. `package/tsconfig.json` (JSON) -> Cumulative Risk: **52.3**
...
### 3. `package/CODE_OF_CONDUCT.md` (MARKDOWN) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Composition Archetype:** `Data / Markup / Trivial` (z +0.00)
