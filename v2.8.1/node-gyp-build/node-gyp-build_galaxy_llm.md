...
> **File Composition:** Data / Markup / Trivial 83%, Defensive Guards Files 17%
...
### 1. `package/bin.js` (JAVASCRIPT) -> Cumulative Risk: **419.08**
...
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (98.8537%), Safety Score (53.3284%), Stability (50.0%)
- **Heaviest Functions:** `build` (Defensive Guards, Impact: 6.1), `exec` (Defensive Guards, Impact: 5.0), `preinstall` (Callbacks & Closures, Impact: 3.4)
...
- **Magnitude:** 35.4 | **LOC:** 85 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (31.617%), Tech Debt (32.8653%)
