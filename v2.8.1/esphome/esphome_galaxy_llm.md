...
| Analyzed Artifacts (Scanned) | 7213 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 285 |
| Total LOC | 462316 |
...
|---|---|---|
| Modularity | 0.5729 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +1.17; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 46%, Interface Declarations Files 22%, Large Core Modules 11%, Declarative / Non-Code 5%, Compute Cores Files 5%
...
| connectivity | 14458 | 2647 | 5 | `esphome/components/http_request/httplib.h` |
...
| mutation | 132921 | 3752 | 49 | `esphome/const.py` |
...
- `MCP2515::set_bitrate_` **(Compute Cores)** (@ `esphome/components/mcp2515/mcp2515.cpp`) -> Impact: **242.7** | LOC: 316
...
- `SpeakerMediaPlayer::watch_media_commands_` **(Compute Cores)** (@ `esphome/components/speaker/media_player/speaker_media_player.cpp`) -> Impact: **196.9** | LOC: 499
...
- **Heaviest Functions:** `process_lambda` (Many-Argument Workhorses, Impact: 41.0), `safe_exp` (Defensive Guards, Impact: 30.6), `templatable` (Many-Argument Workhorses, Impact: 17.3)

### 2. `esphome/components/alarm_control_panel/__init__.py` (PYTHON) -> Cumulative Risk: **807.52**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -1.26)
- **Magnitude:** 367.04 | **LOC:** 295 | **CtrlFlow:** 6.0% | **Authorship Centralization:** 75.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `setup_alarm_control_panel_core_` (Compute Cores, Impact: 17.6), `alarm_control_panel_schema` (Many-Argument Workhorses, Impact: 6.9), `alarm_action_arm_away_to_code` (Parameter Forwarders, Impact: 4.8)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `setup_sensor_core_` (Compute Cores, Impact: 19.0), `_mat_inverse` (Compute Cores, Impact: 15.8), `validate_calibrate_linear` (Compute Cores, Impact: 13.7)
...
- **Heaviest Functions:** `validate_automation` (Defensive Guards, Impact: 28.5), `has_non_synchronous_actions` (Defensive Guards, Impact: 13.7), `register_action` (Many-Argument Workhorses, Impact: 12.8)

### 5. `esphome/components/dfplayer/__init__.py` (PYTHON) -> Cumulative Risk: **787.0**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -1.05)
- **Magnitude:** 425.66 | **LOC:** 382 | **CtrlFlow:** 1.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `dfplayer_play_folder_to_code` (Many-Argument Workhorses, Impact: 7.3), `dfplayer_play_to_code` (Parameter Forwarders, Impact: 4.9), `to_code` (Interface Declarations, Impact: 3.3)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `widget_focus` (Many-Argument Workhorses, Impact: 30.8), `obj_refresh_to_code` (Defensive Guards, Impact: 21.1), `lvgl_update` (Compute Cores, Impact: 20.0)

### 7. `esphome/components/remote_base/__init__.py` (PYTHON) -> Cumulative Risk: **783.23**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -0.71)
- **Magnitude:** 1775.4 | **LOC:** 2234 | **CtrlFlow:** 2.4% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `abbwelcome_action` (Many-Argument Workhorses, Impact: 12.2), `validate_rc_switch_code` (Defensive Guards, Impact: 12.1), `validate_rc_switch_raw_code` (Defensive Guards, Impact: 12.1)

### 8. `esphome/components/binary_sensor/__init__.py` (PYTHON) -> Cumulative Risk: **777.44**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.02)
- **Magnitude:** 586.38 | **LOC:** 674 | **CtrlFlow:** 9.5% | **Authorship Centralization:** 66.7%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `parse_multi_click_timing_str` (Defensive Guards, Impact: 20.9), `_build_binary_sensor_automations` (Compute Cores, Impact: 20.1), `validate_multi_click_timing` (Compute Cores, Impact: 20.0)

### 9. `esphome/components/text_sensor/__init__.py` (PYTHON) -> Cumulative Risk: **774.75**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z -0.91)
- **Magnitude:** 230.48 | **LOC:** 253 | **CtrlFlow:** 6.5% | **Authorship Centralization:** 70.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `text_sensor_schema` (Many-Argument Workhorses, Impact: 10.9), `setup_text_sensor_core_` (Compute Cores, Impact: 7.7), `_build_text_sensor_automations` (Encapsulated Accessors, Impact: 5.6)

### 10. `esphome/components/cover/__init__.py` (PYTHON) -> Cumulative Risk: **767.2**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.11)
- **Magnitude:** 330.52 | **LOC:** 340 | **CtrlFlow:** 7.5% | **Authorship Centralization:** 40.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `setup_cover_core_` (Compute Cores, Impact: 20.7), `cover_control_to_code` (Many-Argument Workhorses, Impact: 12.0), `cover_schema` (Many-Argument Workhorses, Impact: 7.7)
...
**Top Internal Functions/Classes:**
  * `date_time` **(Compute Cores)** (Impact: 55.0)
  * `validator` **(Compute Cores)** (Impact: 33.6)
  ...
  * `require_framework_version` **(Many-Argument Workhorses)** (Impact: 28.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002206 | `Ripple Effect (Closeness):` 0.1269
...
- **Risk Profile:** Cognitive Load (53.506%), Tech Debt (98.0439%)
**Top Internal Functions/Classes:**
  * `WebServer::handleRequest` **(Compute Cores)** (Impact: 87.2)
  * `WebServer::canHandle` **(Compute Cores)** (Impact: 60.8)
    * *Intent:* #endif
  * `WebServer::climate_json_` **(Compute Cores)** (Impact: 58.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2.2e-05 | `Ripple Effect (Closeness):` 0.136112
...
**Top Internal Functions/Classes:**
  ...
  * `parse_args` **(Compute Cores)** (Impact: 48.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5e-06 | `Ripple Effect (Closeness):` 0.000672
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 4.1e-05 | `Ripple Effect (Closeness):` 0.002848
...
**Top Internal Functions/Classes:**
  * `HonClimate::process_status_message_` **(Compute Cores)** (Impact: 168.9)
    * *Intent:* #endif // USE_SWITCH
  * `HonClimate::process_phase` **(Compute Cores)** (Impact: 101.5)
  * `HonClimate::fill_control_messages_queue_` **(Compute Cores)** (Impact: 81.6)
  * `HonClimate::get_control_message` **(Compute Cores)** (Impact: 76.9)
...
**Top Internal Functions/Classes:**
  ...
  * `ThermostatClimate::switch_to_action_` **(Compute Cores)** (Impact: 75.1)
  * `ThermostatClimate::switch_to_fan_mode_` **(Compute Cores)** (Impact: 52.0)
  * `ThermostatClimate::dump_config` **(Compute Cores)** (Impact: 39.0)
...
**Top Internal Functions/Classes:**
  * `WaveshareEPaperTypeA::display` **(Compute Cores)** (Impact: 68.1)
...
**Top Internal Functions/Classes:**
  ...
  * `convert_keys` **(Defensive Guards)** (Impact: 40.3)
  * `add_referenced_recursive` **(Many-Argument Workhorses)** (Impact: 38.2)
  * `shrink` **(Compute Cores)** (Impact: 35.4)
...
**Top Internal Functions/Classes:**
  * `to_code` **(Compute Cores)** (Impact: 137.7)
  ...
  * `_validate_partition` **(Defensive Guards)** (Impact: 30.3)
...
**Top Internal Functions/Classes:**
  * `MCP2515::set_bitrate_` **(Compute Cores)** (Impact: 242.7)
...
- **Risk Profile:** Cognitive Load (93.7485%), Tech Debt (97.9853%)
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  ...
  * `ToshibaClimate::transmit_rac_pt1411hwru_` **(Compute Cores)** (Impact: 51.1)
...
**Top Internal Functions/Classes:**
  * `WiFiComponent::loop` **(Compute Cores)** (Impact: 66.3)
...
**Top Internal Functions/Classes:**
  ...
  * `Sprinkler::fsm_transition_from_valve_run_` **(Compute Cores)** (Impact: 19.5)
  * `Sprinkler::next_valve_number_` **(Many-Argument Workhorses)** (Impact: 19.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5.6e-05 | `Ripple Effect (Closeness):` 0.151787
...
- `esphome/const.py` -> **Severity: 13.59** (Embedded: 0.1361 * Error Risk: 99.8466%)
- `esphome/core/helpers.h` -> **Severity: 11.624** (Embedded: 0.1518 * Error Risk: 76.5831%)
- `esphome/config_validation.py` -> **Severity: 11.111** (Embedded: 0.1269 * Error Risk: 87.5542%)
- `esphome/core/log.h` -> **Severity: 7.895** (Embedded: 0.1461 * Error Risk: 54.0452%)
- `esphome/components/json/json_util.h` -> **Severity: 7.778** (Embedded: 0.0837 * Error Risk: 92.9699%)
