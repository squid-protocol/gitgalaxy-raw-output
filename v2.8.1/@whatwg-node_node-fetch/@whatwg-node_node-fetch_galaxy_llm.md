...
> **Composition Archetype:** `Small Flat Repo` (z +0.28; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 21%, State Mutators Files 17%, Interface Declarations Files 15%, Generic / Templated Code Files 13%, Large Core Modules 13%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 95.9 | 51.2 | 60.6 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 91.0 | 100.0 | 100.0 |
...
### 1. `package/cjs/ReadableStream.js` (JAVASCRIPT) -> Cumulative Risk: **730.77**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.8865%), Concurrency (98.9468%)
- **Heaviest Functions:** `constructor` (Defensive Guards, Impact: 31.7), `createController` (Defensive Guards, Impact: 15.9), `destroy` (Defensive Guards, Impact: 9.6)

### 2. `package/cjs/FormData.js` (JAVASCRIPT) -> Cumulative Risk: **721.86**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9918%), Safety Score (81.6247%)
- **Heaviest Functions:** `getStreamFromFormData` (Defensive Guards, Impact: 32.6), `handleNextEntry` (Defensive Guards, Impact: 12.8), `pull` (Callbacks & Closures, Impact: 9.5)

### 3. `package/esm/ReadableStream.js` (JAVASCRIPT) -> Cumulative Risk: **720.97**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.64)
- **Magnitude:** 235.8 | **LOC:** 242 | **CtrlFlow:** 18.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.8105%), Concurrency (99.0449%)
- **Heaviest Functions:** `constructor` (Defensive Guards, Impact: 31.7), `createController` (Defensive Guards, Impact: 15.9), `destroy` (Defensive Guards, Impact: 9.6)

### 4. `package/esm/FormData.js` (JAVASCRIPT) -> Cumulative Risk: **711.44**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +1.42)
- **Magnitude:** 164.98 | **LOC:** 146 | **CtrlFlow:** 20.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9783%), Verification (80.0%)
- **Heaviest Functions:** `getStreamFromFormData` (Defensive Guards, Impact: 32.6), `handleNextEntry` (Defensive Guards, Impact: 12.8), `pull` (Callbacks & Closures, Impact: 9.5)

### 5. `package/cjs/Body.js` (JAVASCRIPT) -> Cumulative Risk: **706.05**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.72)
- **Magnitude:** 441.42 | **LOC:** 530 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9965%), Concurrency (98.6618%)
- **Heaviest Functions:** `formData` (Defensive Guards, Impact: 40.6), `processBodyInit` (Compute Cores, Impact: 28.2), `complete` (Defensive Guards, Impact: 24.5)

### 6. `package/esm/Body.js` (JAVASCRIPT) -> Cumulative Risk: **701.99**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Large Core Modules` (z +0.72)
- **Magnitude:** 436.34 | **LOC:** 526 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9957%), Concurrency (98.7218%)
- **Heaviest Functions:** `formData` (Defensive Guards, Impact: 40.6), `processBodyInit` (Compute Cores, Impact: 28.2), `complete` (Defensive Guards, Impact: 24.5)

### 7. `package/cjs/Blob.js` (JAVASCRIPT) -> Cumulative Risk: **701.47**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.82)
- **Magnitude:** 318.6 | **LOC:** 292 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (99.9998%), State Flux (99.9987%), Documentation (96.2963%)
- **Heaviest Functions:** `buffer` (Callbacks & Closures, Impact: 17.8), `constructor` (Defensive Guards, Impact: 16.0), `stream` (Callbacks & Closures, Impact: 13.1)

### 8. `package/esm/Blob.js` (JAVASCRIPT) -> Cumulative Risk: **698.17**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.81)
- **Magnitude:** 307.36 | **LOC:** 280 | **CtrlFlow:** 27.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (99.9999%), State Flux (99.9968%), Documentation (97.1429%)
- **Heaviest Functions:** `buffer` (Callbacks & Closures, Impact: 17.8), `constructor` (Defensive Guards, Impact: 16.0), `stream` (Callbacks & Closures, Impact: 13.1)

### 9. `package/cjs/fetchNodeHttp.js` (JAVASCRIPT) -> Cumulative Risk: **694.95**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z +1.26)
- **Magnitude:** 158.78 | **LOC:** 156 | **CtrlFlow:** 33.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9739%), Safety Score (87.3364%)
- **Heaviest Functions:** `fetchNodeHttp` (Compute Cores, Impact: 74.5), `onError` (Callbacks & Closures, Impact: 23.7), `getRequestFnForProtocol` (Compute Cores, Impact: 7.5)

### 10. `package/esm/fetchNodeHttp.js` (JAVASCRIPT) -> Cumulative Risk: **691.87**
- **Archetype:** `file_cluster_4` (Distance: N/A IQR)
- **Composition Archetype:** `Compute Cores Files` (z -0.07)
- **Magnitude:** 149.2 | **LOC:** 152 | **CtrlFlow:** 30.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9743%), Safety Score (87.4481%)
- **Heaviest Functions:** `fetchNodeHttp` (Compute Cores, Impact: 66.0), `onError` (Compute Cores, Impact: 23.7), `getRequestFnForProtocol` (Compute Cores, Impact: 7.5)
...
- **Magnitude:** 441.42 | **LOC:** 530 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (93.0181%), Tech Debt (28.567%)
**Top Internal Functions/Classes:**
  * `formData` **(Defensive Guards)** (Impact: 40.6)
  * `processBodyInit` **(Compute Cores)** (Impact: 28.2)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 436.34 | **LOC:** 526 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (92.5522%), Tech Debt (28.8177%)
**Top Internal Functions/Classes:**
  * `formData` **(Defensive Guards)** (Impact: 40.6)
  * `processBodyInit` **(Compute Cores)** (Impact: 28.2)
  * `complete` **(Defensive Guards)** (Impact: 24.5)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 318.6 | **LOC:** 292 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (89.725%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 307.36 | **LOC:** 280 | **CtrlFlow:** 27.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (89.1377%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `buffer` **(Callbacks & Closures)** (Impact: 17.8)
  * `constructor` **(Defensive Guards)** (Impact: 16.0)
  * `stream` **(Callbacks & Closures)** (Impact: 13.1)
...
- **Risk Profile:** Cognitive Load (69.8908%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (66.9447%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getMap` **(Defensive Guards)** (Impact: 27.1)
    * *Intent:* // perf: Build the map of headers lazily, only when we need to access all headers or write to it. //...
  * `_get` **(Defensive Guards)** (Impact: 26.3)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 240.88 | **LOC:** 246 | **CtrlFlow:** 18.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (67.2896%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `handleStart` **(Callbacks & Closures)** (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 235.8 | **LOC:** 242 | **CtrlFlow:** 18.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (63.7994%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 31.7)
  * `createController` **(Defensive Guards)** (Impact: 15.9)
  * `destroy` **(Defensive Guards)** (Impact: 9.6)
...
- **Risk Profile:** Cognitive Load (98.2748%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 96.7)
  * `url` **(Interface Declarations)** (Impact: 4.5)
  * `parsedUrl` **(Interface Declarations)** (Impact: 4.5)
...
- **Risk Profile:** Cognitive Load (98.0365%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 96.7)
  * `url` **(Interface Declarations)** (Impact: 4.5)
  * `parsedUrl` **(Interface Declarations)** (Impact: 4.5)
...
- **Global Archetype:** `file_cluster_0` (Drift: 0.0 IQR)
- **Magnitude:** 171.08 | **LOC:** 151 | **CtrlFlow:** 19.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (70.943%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `append` **(Many-Argument Workhorses)** (Impact: 6.5)
**Contextual Mitigations & Amplifications:**
...
- **Magnitude:** 158.78 | **LOC:** 156 | **CtrlFlow:** 33.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (75.5815%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `fetchNodeHttp` **(Compute Cores)** (Impact: 74.5)
  * `onError` **(Callbacks & Closures)** (Impact: 23.7)
...
- **Risk Profile:** Cognitive Load (86.4344%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  ...
  * `onError` **(Compute Cores)** (Impact: 23.7)
  * `getRequestFnForProtocol` **(Compute Cores)** (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 13 instances
...
- **Risk Profile:** Cognitive Load (84.9511%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `json` **(Defensive Guards)** (Impact: 47.8)
  * `constructor` **(Defensive Guards)** (Impact: 31.8)
  * `redirect` **(Compute Cores)** (Impact: 5.7)
...
- **Risk Profile:** Cognitive Load (35.3056%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  ...
  * `onAbort` **(State Mutators)** (Impact: 2.5)
...
- **Risk Profile:** Cognitive Load (31.9647%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `fetchCurl` **(Defensive Guards)** (Impact: 56.2)
  * `streamListener` **(Defensive Guards)** (Impact: 21.6)
  * `errorListener` **(Defensive Guards)** (Impact: 9.3)
...
- **Risk Profile:** Cognitive Load (53.1775%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (55.5738%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `flatMap` **(Callbacks & Closures)** (Impact: 9.4)
  * `take` **(Interface Declarations)** (Impact: 4.8)
  * `filter` **(Interface Declarations)** (Impact: 4.7)
  * `drop` **(Interface Declarations)** (Impact: 4.7)
  * `some` **(Interface Declarations)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 12 instances
* *State Mutation (weighted view):* 40
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (51.1536%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `flatMap` **(Callbacks & Closures)** (Impact: 9.4)
  * `take` **(Interface Declarations)** (Impact: 4.8)
  * `filter` **(Interface Declarations)** (Impact: 4.7)
...
- **Risk Profile:** Cognitive Load (29.8881%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `pipeThrough` **(Defensive Guards)** (Impact: 14.9)
  * `getHeadersObj` **(Compute Cores)** (Impact: 9.0)
  * `shouldRedirect` **(Defensive Guards)** (Impact: 7.2)
...
- **Risk Profile:** Cognitive Load (34.3187%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 18.2)
  * `write` **(Defensive Guards)** (Impact: 8.9)
  * `getWriter` **(Interface Declarations)** (Impact: 6.8)
  * `final` **(Callbacks & Closures)** (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (29.0922%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 18.2)
  * `write` **(Defensive Guards)** (Impact: 8.9)
  * `getWriter` **(Interface Declarations)** (Impact: 6.8)
...
- **Risk Profile:** Cognitive Load (74.7299%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
