...
> **Composition Archetype:** `Mainframe / COBOL & Config` (z -0.81; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 45%, I/O & Config Routines Files 45%, Interface Declarations Files 5%, Declarative / Non-Code 4%, Defensive Guards Files 1%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 95.8 | 33.9 | 0.0 | 0.0 |
...
- `LIST-ALL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB21.cbl`) -> Impact: **6.0** | LOC: 19
  * *Intent:* ***************************************************** * LIST ALL CLIENTS * *****************************************************...
- `GET-ALL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB22.cbl`) -> Impact: **6.0** | LOC: 19
  * *Intent:* *
- `GET-SPECIFIC` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB22.cbl`) -> Impact: **6.0** | LOC: 19
  * *Intent:* *
- `GET-ALL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB23.cbl`) -> Impact: **6.0** | LOC: 19
- `GET-SPECIFIC` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB23.cbl`) -> Impact: **6.0** | LOC: 19
- `PAYMENT-WEEKLY` **(I/O & Config Routines)** (@ `COBOL Programming Course #4 - Testing/Labs/cbl/EMPPAY.CBL`) -> Impact: **5.5** | LOC: 10
- `FILE-CONTROL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Challenges/Debugging/cbl/CBL0106.cbl`) -> Impact: **5.0** | LOC: 109
- `FILE-CONTROL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Challenges/Debugging/cbl/CBL0106C.cbl`) -> Impact: **5.0** | LOC: 110
- `FILE-CONTROL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB21.cbl`) -> Impact: **5.0** | LOC: 73
- `FILE-CONTROL` **(I/O & Config Routines)** (@ `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB22.cbl`) -> Impact: **5.0** | LOC: 97
...
### 1. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/SRCHSER.cobol` (COBOL) -> Cumulative Risk: **500.4**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.35)
...
- **Heaviest Functions:** `SEARCH-RECORD` (I/O & Config Routines, Impact: 4.3), `FILE-CONTROL` (I/O & Config Routines, Impact: 3.6), `LOAD-TABLES` (I/O & Config Routines, Impact: 3.4)

### 2. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/SRCHBIN.cobol` (COBOL) -> Cumulative Risk: **497.97**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 3.7), `LOAD-TABLES` (I/O & Config Routines, Impact: 3.4), `SEARCH-RECORD` (I/O & Config Routines, Impact: 3.3)

### 3. `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB21.cbl` (COBOL) -> Cumulative Risk: **487.37**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (98.699%), Safety Score (69.0648%)
- **Heaviest Functions:** `LIST-ALL` (I/O & Config Routines, Impact: 6.0), `FILE-CONTROL` (I/O & Config Routines, Impact: 5.0), `SQL-ERROR-HANDLING` (Interface Declarations, Impact: 4.7)

### 4. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/CBL0001.cobol` (COBOL) -> Cumulative Risk: **486.72**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 3.5), `READ-NEXT-RECORD` (I/O & Config Routines, Impact: 2.6), `READ-RECORD` (I/O & Config Routines, Impact: 2.2)

### 5. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/CBL0002.cobol` (COBOL) -> Cumulative Risk: **486.71**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.24)
- **Magnitude:** 21.32 | **LOC:** 80 | **CtrlFlow:** 3.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.2438%), State Flux (97.0734%)
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 2.8), `READ-NEXT-RECORD` (I/O & Config Routines, Impact: 2.4), `READ-RECORD` (I/O & Config Routines, Impact: 2.2)

### 6. `COBOL Programming Course #3 - Advanced Topics/Challenges/Debugging/cbl/CBL0106C.cbl` (COBOL) -> Cumulative Risk: **484.38**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 5.0), `IS-OVERLIMIT` (I/O & Config Routines, Impact: 3.8), `WRITE-OVERLIMIT` (I/O & Config Routines, Impact: 3.5)

### 7. `COBOL Programming Course #3 - Advanced Topics/Labs/cbl/CBLDB22.cbl` (COBOL) -> Cumulative Risk: **483.77**
...
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.7546%), Safety Score (72.7713%)
- **Heaviest Functions:** `GET-ALL` (I/O & Config Routines, Impact: 6.0), `GET-SPECIFIC` (I/O & Config Routines, Impact: 6.0), `FILE-CONTROL` (I/O & Config Routines, Impact: 5.0)

### 8. `COBOL Programming Course #3 - Advanced Topics/Challenges/Debugging/cbl/CBL0106.cbl` (COBOL) -> Cumulative Risk: **483.52**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.10)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 5.0), `WRITE-OVERLIMIT` (I/O & Config Routines, Impact: 3.5), `READ-NEXT-RECORD` (I/O & Config Routines, Impact: 2.5)

### 9. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/CBL0012.cobol` (COBOL) -> Cumulative Risk: **483.11**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
...
- **Heaviest Functions:** `FILE-CONTROL` (I/O & Config Routines, Impact: 3.5), `READ-NEXT-RECORD` (I/O & Config Routines, Impact: 2.4), `READ-RECORD` (I/O & Config Routines, Impact: 2.2)

### 10. `COBOL Programming Course #2 - Learning COBOL/Labs/cbl/CBL0033.cobol` (COBOL) -> Cumulative Risk: **481.27**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +1.21)
- **Magnitude:** 38.14 | **LOC:** 131 | **CtrlFlow:** 4.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9967%), State Flux (87.9769%)
- **Heaviest Functions:** `2300-READ-NEXT-RECORDS` (I/O & Config Routines, Impact: 3.2), `FILE-CONTROL` (I/O & Config Routines, Impact: 2.9), `2100-READ-TEN-RECORDS` (Interface Declarations, Impact: 2.2)
...
**Top Internal Functions/Classes:**
  * `GET-ALL` **(I/O & Config Routines)** (Impact: 6.0)
    * *Intent:* *
  * `GET-SPECIFIC` **(I/O & Config Routines)** (Impact: 6.0)
    * *Intent:* *
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 5.0)
  * `SQL-ERROR-HANDLING` **(Interface Declarations)** (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  ...
  * `WRITE-OVERLIMIT` **(I/O & Config Routines)** (Impact: 3.5)
    * *Intent:* *
  * `READ-NEXT-RECORD` **(I/O & Config Routines)** (Impact: 2.5)
    * *Intent:* *
...
**Top Internal Functions/Classes:**
  * `LIST-ALL` **(I/O & Config Routines)** (Impact: 6.0)
    * *Intent:* ***************************************************** * LIST ALL CLIENTS * *************************...
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 5.0)
  * `SQL-ERROR-HANDLING` **(Interface Declarations)** (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  ...
  * `READ-NEXT-RECORD` **(I/O & Config Routines)** (Impact: 2.4)
    * *Intent:* *
  * `READ-RECORD` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* *
...
**Top Internal Functions/Classes:**
  * `SEARCH-RECORD` **(I/O & Config Routines)** (Impact: 4.3)
    * *Intent:* *
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 3.6)
  * `LOAD-TABLES` **(I/O & Config Routines)** (Impact: 3.4)
    * *Intent:* *
  * `READ-RECORD` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* *
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` **(I/O & Config Routines)** (Impact: 3.7)
  * `LOAD-TABLES` **(I/O & Config Routines)** (Impact: 3.4)
    * *Intent:* *
  * `SEARCH-RECORD` **(I/O & Config Routines)** (Impact: 3.3)
    * *Intent:* *
  * `READ-RECORD` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* *
  * `OPEN-FILES` **(I/O & Config Routines)** (Impact: 1.1)
