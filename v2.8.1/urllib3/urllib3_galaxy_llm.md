...
> **Composition Archetype:** `Typed Library` (z -0.19; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 33%, Large Core Modules 22%, Defensive Guards Files 11%, Many-Argument Workhorses Files 11%, Data / Markup / Trivial 9%
...
- **Heaviest Functions:** `pyodide_upload` (Interface Declarations, Impact: 10.0), `encodingrequest` (Interface Declarations, Impact: 7.0), `upload` (Interface Declarations, Impact: 6.4)
...
- **Heaviest Functions:** `start_response_handler` (Many-Argument Workhorses, Impact: 19.7), `assert_header_received` (Defensive Guards, Impact: 14.3), `socket_handler` (Defensive Guards, Impact: 12.6)
...
- **Heaviest Functions:** `send_request` (Compute Cores, Impact: 22.1), `send_jspi_request` (Many-Argument Workhorses, Impact: 21.1), `send` (Many-Argument Workhorses, Impact: 19.1)
...
- **Heaviest Functions:** `__init__` (Compute Cores, Impact: 10.9), `__init__` (Generic / Templated Code, Impact: 4.2), `pool` (Generic / Templated Code, Impact: 3.3)
...
- **Heaviest Functions:** `read` (Many-Argument Workhorses, Impact: 51.7), `read1` (Many-Argument Workhorses, Impact: 45.5), `read_chunked` (Many-Argument Workhorses, Impact: 44.1)

### 6. `urllib3-2.6.3/src/urllib3/http2/connection.py` (PYTHON) -> Cumulative Risk: **684.36**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z +0.92)
...
- **Heaviest Functions:** `request` (Many-Argument Workhorses, Impact: 36.7), `send` (Defensive Guards, Impact: 28.2), `putrequest` (Many-Argument Workhorses, Impact: 19.4)
...
- **Heaviest Functions:** `absolute_uri` (Many-Argument Workhorses, Impact: 11.0), `__call__` (Defensive Guards, Impact: 9.4), `connect` (Defensive Guards, Impact: 7.2)
...
- **Heaviest Functions:** `run_hypercorn_in_thread` (Defensive Guards, Impact: 11.4), `_create_urllib3_sockets` (Compute Cores, Impact: 8.2), `_retry_create_urllib3_sockets` (Defensive Guards, Impact: 6.2)
...
- **Heaviest Functions:** `makefile` (Many-Argument Workhorses, Impact: 42.2), `_ssl_io_loop` (Many-Argument Workhorses, Impact: 26.4), `_wrap_ssl_read` (Defensive Guards, Impact: 8.4)
...
- **Heaviest Functions:** `set_and_release` (Many-Argument Workhorses, Impact: 9.6), `acquire_and_get` (Defensive Guards, Impact: 5.6), `_values` (Generic / Templated Code, Impact: 3.0)
...
**Top Internal Functions/Classes:**
  * `pyodide_upload` **(Interface Declarations)** (Impact: 10.0)
  * `encodingrequest` **(Interface Declarations)** (Impact: 7.0)
  * `upload` **(Interface Declarations)** (Impact: 6.4)
  * `_get_pyodide_template` **(Compute Cores)** (Impact: 5.6)
...
**Top Internal Functions/Classes:**
  ...
  * `connect` **(Compute Cores)** (Impact: 33.7)
...
**Top Internal Functions/Classes:**
  ...
  * `_get_conn` **(Defensive Guards)** (Impact: 14.0)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Defensive Guards)** (Impact: 10.5)
...
**Top Internal Functions/Classes:**
  ...
  * `_is_bpo_43522_fixed` **(Many-Argument Workhorses)** (Impact: 13.2)
  * `_ssl_wrap_socket_impl` **(Many-Argument Workhorses)** (Impact: 9.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_normalize_host` **(Compute Cores)** (Impact: 29.1)
  * `_encode_invalid_chars` **(Compute Cores)** (Impact: 17.3)
  * `_remove_path_dot_segments` **(Compute Cores)** (Impact: 14.1)
...
**Top Internal Functions/Classes:**
  ...
  * `putrequest` **(Many-Argument Workhorses)** (Impact: 19.4)
...
**Top Internal Functions/Classes:**
  ...
  * `consume_request` **(Compute Cores)** (Impact: 8.7)
...
**Top Internal Functions/Classes:**
  ...
  * `_ssl_io_loop` **(Many-Argument Workhorses)** (Impact: 26.4)
  * `_wrap_ssl_read` **(Defensive Guards)** (Impact: 8.4)
...
**Top Internal Functions/Classes:**
  ...
  * `_render_parts` **(Generic / Templated Code)** (Impact: 10.2)
...
**Top Internal Functions/Classes:**
  ...
  * `connect` **(Defensive Guards)** (Impact: 7.2)
  * `_read_body` **(Type Conversions)** (Impact: 6.2)
...
**Top Internal Functions/Classes:**
  ...
  * `_start_server` **(Compute Cores)** (Impact: 8.1)
  * `_has_ipv6` **(Defensive Guards)** (Impact: 5.3)
    * *Intent:* """Returns True if the system can bind an IPv6 address."""
  * `_resolves_to_ipv6` **(Defensive Guards)** (Impact: 4.8)
...
**Top Internal Functions/Classes:**
  ...
  * `_ipaddress_match` **(Generic / Templated Code)** (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  ...
  * `urlopen` **(Many-Argument Workhorses)** (Impact: 3.7)
...
**Top Internal Functions/Classes:**
  ...
  * `_create_urllib3_sockets` **(Compute Cores)** (Impact: 8.2)
  * `_retry_create_urllib3_sockets` **(Defensive Guards)** (Impact: 6.2)
  ...
  * `_start_server` **(Generic / Templated Code)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_set_socket_options` **(Generic / Templated Code)** (Impact: 5.6)
  * `_has_ipv6` **(Defensive Guards)** (Impact: 5.3)
    * *Intent:* """Returns True if the system can bind an IPv6 address."""
  * `allowed_gai_family` **(Interface Declarations)** (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  ...
  * `poll_wait_for_socket` **(Many-Argument Workhorses)** (Impact: 14.6)
  * `wait_for_socket` **(Many-Argument Workhorses)** (Impact: 7.5)
  * `do_poll` **(Generic / Templated Code)** (Impact: 3.0)
    * *Intent:* # For some reason, poll() takes timeout in milliseconds
  * `_have_working_poll` **(Interface Declarations)** (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  * `_validate_timeout` **(Defensive Guards)** (Impact: 20.0)
  ...
  * `connect_timeout` **(Compute Cores)** (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `set_and_release` **(Many-Argument Workhorses)** (Impact: 9.6)
...
**Top Internal Functions/Classes:**
  ...
  * `choose_boundary` **(Interface Declarations)** (Impact: 1.2)
