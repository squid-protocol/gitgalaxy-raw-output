...
> **Composition Archetype:** `Typed Library` (z +2.38; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 59%, Data / Markup / Trivial 18%, Declarative / Non-Code 5%, Defensive Guards Files 5%, Large Core Modules 4%
...
- **Heaviest Functions:** `__exit__` (Generic / Templated Code, Impact: 2.4), `__aexit__` (Generic / Templated Code, Impact: 2.4), `__exit__` (Generic / Templated Code, Impact: 2.4)
...
- **Heaviest Functions:** `check_arg_kinds` (Compute Cores, Impact: 47.8), `deserialize` (Many-Argument Workhorses, Impact: 36.1), `serialize` (Compute Cores, Impact: 30.2)
...
- **Heaviest Functions:** `__call__` (Generic / Templated Code, Impact: 3.5), `__new__` (Generic / Templated Code, Impact: 3.3), `__call__` (Generic / Templated Code, Impact: 3.3)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 36.9), `deserialize_type` (Defensive Guards, Impact: 16.9), `compute_rtype_alignment` (Defensive Guards, Impact: 16.6)
...
- **Heaviest Functions:** `make_for_loop_generator` (Many-Argument Workhorses, Impact: 142.8), `get_expr_length` (Defensive Guards, Impact: 58.6), `sequence_from_generator_preallocate_helper` (Many-Argument Workhorses, Impact: 40.0)
...
- **Heaviest Functions:** `run_analysis` (Many-Argument Workhorses, Impact: 90.9), `get_cfg` (Defensive Guards, Impact: 22.9), `cleanup_cfg` (Compute Cores, Impact: 12.6)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 14.9), `__init__` (Many-Argument Workhorses, Impact: 12.6), `__init__` (Many-Argument Workhorses, Impact: 11.7)
...
- **Heaviest Functions:** `__aexit__` (Generic / Templated Code, Impact: 2.4), `__init__` (Generic / Templated Code, Impact: 2.0), `__init__` (Generic / Templated Code, Impact: 2.0)
...
- **Heaviest Functions:** `sendto` (Generic / Templated Code, Impact: 2.6), `sendfile` (Generic / Templated Code, Impact: 2.5), `recvfrom` (Generic / Templated Code, Impact: 2.4)
...
- **Heaviest Functions:** `choices` (Generic / Templated Code, Impact: 2.8), `sample` (Generic / Templated Code, Impact: 2.4), `randrange` (Generic / Templated Code, Impact: 2.3)
...
**Top Internal Functions/Classes:**
  ...
  * `visit_decorator` **(Compute Cores)** (Impact: 77.8)
...
**Top Internal Functions/Classes:**
  ...
  * `visit_call_expr_inner` **(Defensive Guards)** (Impact: 129.5)
...
**Top Internal Functions/Classes:**
  ...
  * `visit_callable_type` **(Compute Cores)** (Impact: 76.7)
...
**Top Internal Functions/Classes:**
  ...
  * `_check_ifstmt_for_overloads` **(Defensive Guards)** (Impact: 32.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `visit_instance` **(Defensive Guards)** (Impact: 124.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test_stubs` **(Compute Cores)** (Impact: 65.8)
...
**Top Internal Functions/Classes:**
  ...
  * `process_typeddict` **(Many-Argument Workhorses)** (Impact: 52.7)
  * `_get_func_return` **(Many-Argument Workhorses)** (Impact: 48.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
**Top Internal Functions/Classes:**
  * `__new__` **(Many-Argument Workhorses)** (Impact: 4.0)
  * `__new__` **(Generic / Templated Code)** (Impact: 3.8)
  * `__new__` **(Generic / Templated Code)** (Impact: 3.8)
  * `__new__` **(Generic / Templated Code)** (Impact: 3.6)
  * `open` **(Many-Argument Workhorses)** (Impact: 3.5)
...
**Top Internal Functions/Classes:**
  * `visit_instance` **(Defensive Guards)** (Impact: 155.7)
  ...
  * `build_constraints_for_simple_unpack` **(Defensive Guards)** (Impact: 54.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `transform_name_expr` **(Compute Cores)** (Impact: 56.5)
