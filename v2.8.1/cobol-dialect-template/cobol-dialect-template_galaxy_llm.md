...
> **Composition Archetype:** `Small Flat Repo` (z +0.55; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 48%, Annotated Framework Methods Files 13%, State Mutators Files 13%, Callbacks & Closures Files 6%, Many-Argument Workhorses Files 6%
...
- `accept` **(Callbacks & Closures)** (@ `server/dialect-example/src/main/java/org/broadcom/cobol/dialects/cobolExample/processor/ProcessLevel100Node.java`) -> Impact: **9.9** | LOC: 25
...
- `checkSubordinatesIdentifier2` **(Many-Argument Workhorses)** (@ `server/dialect-example/src/main/java/org/broadcom/cobol/dialects/cobolExample/processor/ProcessRpcNode.java`) -> Impact: **7.6** | LOC: 17
...
- `getInputMismatchMessage` **(Many-Argument Workhorses)** (@ `server/dialect-example/src/main/java/org/broadcom/cobol/dialects/cobolExample/ErrorMessageHelper.java`) -> Impact: **7.1** | LOC: 7
...
- **Composition Archetype:** `State Mutators Files` (z +2.10)
...
- **Heaviest Functions:** `activate` (Compute Cores, Impact: 5.6), `deactivate` (State Mutators, Impact: 1.1)
...
- **Composition Archetype:** `Many-Argument Workhorses Files` (z +1.41)
...
- **Heaviest Functions:** `accept` (Many-Argument Workhorses, Impact: 16.8), `checkSubordinatesIdentifier2` (Many-Argument Workhorses, Impact: 7.6), `getVariableUsageNode` (Callbacks & Closures, Impact: 2.3)
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z +1.66)
...
- **Heaviest Functions:** `visitInjectStatement` (Annotated Framework Methods, Impact: 2.2), `addTreeNode` (Generic / Templated Code, Impact: 2.0), `aggregateResult` (Generic / Templated Code, Impact: 1.9)
...
- **Archetype:** `file_cluster_14` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z +0.99)
...
- **Heaviest Functions:** `reportError` (Defensive Guards, Impact: 14.8), `reportUnrecognizedException` (Encapsulated Accessors, Impact: 3.7), `reportMissingToken` (Annotated Framework Methods, Impact: 3.5)
...
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z +1.32)
...
- **Heaviest Functions:** `visitRpcParseStatement` (Callbacks & Closures, Impact: 9.8), `visitUnsetStatement` (Callbacks & Closures, Impact: 2.3), `visitDataDescriptionEntry100` (Callbacks & Closures, Impact: 2.2)
...
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Parameter Forwarders Files` (z +0.75)
...
- **Heaviest Functions:** `addReplacementContext` (Parameter Forwarders, Impact: 2.2), `addReplacementContext` (Parameter Forwarders, Impact: 2.2), `constructLocality` (Parameter Forwarders, Impact: 2.1)
...
- **Heaviest Functions:** `RpcNode` (Many-Argument Workhorses, Impact: 4.1)
...
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Callbacks & Closures Files` (z +2.02)
...
- **Heaviest Functions:** `accept` (Callbacks & Closures, Impact: 7.8), `ProcessUnsetNode` (State Mutators, Impact: 1.6)
...
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z -0.20)
...
- **Heaviest Functions:** `UnsetNode` (State Mutators, Impact: 1.9)
...
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.45)
...
- **Heaviest Functions:** `generate` (I/O & Config Routines, Impact: 3.2)
...
**Top Internal Functions/Classes:**
  ...
  * `visitBitwiseShiftstatement` **(Annotated Framework Methods)** (Impact: 2.0)
  * `addTreeNode` **(Generic / Templated Code)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `checkSubordinatesIdentifier2` **(Many-Argument Workhorses)** (Impact: 7.6)
  * `getVariableUsageNode` **(Callbacks & Closures)** (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  * `getInputMismatchMessage` **(Many-Argument Workhorses)** (Impact: 7.1)
  ...
  * `removeIdentifierTokens` **(Generic / Templated Code)** (Impact: 3.1)
  * `collectErrorTokens` **(Generic / Templated Code)** (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `reportMissingToken` **(Annotated Framework Methods)** (Impact: 3.5)
  * `reportUnwantedToken` **(Annotated Framework Methods)** (Impact: 3.3)
  * `reportInputMismatch` **(Annotated Framework Methods)** (Impact: 2.1)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `accept` **(Callbacks & Closures)** (Impact: 9.9)
  * `registerVariable` **(Callbacks & Closures)** (Impact: 2.4)
  * `addError` **(Encapsulated Accessors)** (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  ...
  * `constructRange` **(Interface Declarations)** (Impact: 1.9)
  * `constructRange` **(Interface Declarations)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `retrieveInjects` **(Defensive Guards)** (Impact: 3.1)
  * `createCommand` **(Defensive Guards)** (Impact: 2.1)
  * `collectCommandsOrActions` **(Callbacks & Closures)** (Impact: 1.9)
    * *Intent:* /** * Create a list of commands or code actions according to the diagnostic's type. May be empty if ...
  * `toCodeAction` **(Defensive Guards)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `visitInjectStatement` **(Annotated Framework Methods)** (Impact: 2.2)
  * `addTreeNode` **(Generic / Templated Code)** (Impact: 2.0)
  * `aggregateResult` **(Generic / Templated Code)** (Impact: 1.9)
  * `InjectRuleVisitor` **(State Mutators)** (Impact: 1.6)
  * `defaultResult` **(Annotated Framework Methods)** (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
