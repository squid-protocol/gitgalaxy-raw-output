...
> **Composition Archetype:** `Hub-Coupled App` (z -0.39; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 44%, Large Core Modules 18%, Declarative / Non-Code 15%, Defensive Guards Files 7%, Callbacks & Closures Files 3%
...
- **Heaviest Functions:** `getGroupValue` (Compute Cores, Impact: 65.5), `alignmentContaining` (Compute Cores, Impact: 10.8), `getTag` (Defensive Guards, Impact: 8.9)

### 2. `js/feature/baseFeatureSource.js` (JAVASCRIPT) -> Cumulative Risk: **770.94**
- **Archetype:** `file_cluster_11` (Distance: N/A IQR)
- **Composition Archetype:** `State Mutators Files` (z +0.82)
...
- **Heaviest Functions:** `nextFeature` (Many-Argument Workhorses, Impact: 51.8), `compare` (Compute Cores, Impact: 22.5), `constructor` (State Mutators, Impact: 1.6)
...
- **Heaviest Functions:** `loadROI` (Defensive Guards, Impact: 16.7), `renderROISet` (Compute Cores, Impact: 16.3), `createRegionElement` (Many-Argument Workhorses, Impact: 10.3)
...
- **Heaviest Functions:** `draw` (Compute Cores, Impact: 48.9), `paintAxis` (Many-Argument Workhorses, Impact: 42.3), `postInit` (I/O & Config Routines, Impact: 26.1)
...
- **Heaviest Functions:** `draw` (Compute Cores, Impact: 68.1), `yScale` (Compute Cores, Impact: 67.5), `getFeatures` (Many-Argument Workhorses, Impact: 38.0)
...
- **Heaviest Functions:** `draw` (Defensive Guards, Impact: 74.7), `postInit` (Compute Cores, Impact: 27.6), `sortSamplesByGenotype` (Defensive Guards, Impact: 24.2)
...
- **Heaviest Functions:** `draw` (Compute Cores, Impact: 36.0), `contextMenuItemList` (Compute Cores, Impact: 21.7), `constructor` (Defensive Guards, Impact: 13.5)
...
- **Heaviest Functions:** `getTrackConfig` (Compute Cores, Impact: 44.1), `getGenomeConfig` (Compute Cores, Impact: 33.8), `loadHub` (Defensive Guards, Impact: 20.4)
...
- **Heaviest Functions:** `draw` (Compute Cores, Impact: 34.8), `drawEqtls` (Compute Cores, Impact: 31.4), `dialogPresentationHandler` (Defensive Guards, Impact: 30.5)
...
- **Heaviest Functions:** `loadFeatures` (Many-Argument Workhorses, Impact: 56.8), `constructor` (Defensive Guards, Impact: 47.6), `getFeatures` (Compute Cores, Impact: 25.9)
...
**Top Internal Functions/Classes:**
  * `loadSessionObject` **(Compute Cores)** (Impact: 79.0)
  ...
  * `loadGenome` **(Compute Cores)** (Impact: 38.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.048749 | `Ripple Effect (Closeness):` 0.112434
...
**Top Internal Functions/Classes:**
  ...
  * `contextMenuItemList` **(Compute Cores)** (Impact: 77.1)
  * `getAlignmentColor` **(Compute Cores)** (Impact: 56.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002153 | `Ripple Effect (Closeness):` 0.063204
...
**Top Internal Functions/Classes:**
  * `drawProportional` **(Compute Cores)** (Impact: 70.4)
  ...
  * `init` **(Compute Cores)** (Impact: 37.1)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000723 | `Ripple Effect (Closeness):` 0.08092
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000671 | `Ripple Effect (Closeness):` 0.051949
...
**Top Internal Functions/Classes:**
  ...
  * `arc` **(Many-Argument Workhorses)** (Impact: 28.7)
    * *Intent:* /** * Arc command! */
  * `drawImage` **(Defensive Guards)** (Impact: 26.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000976 | `Ripple Effect (Closeness):` 0.046307
...
**Top Internal Functions/Classes:**
  ...
  * `postInit` **(Compute Cores)** (Impact: 27.6)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00056 | `Ripple Effect (Closeness):` 0.081157
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003081 | `Ripple Effect (Closeness):` 0.080684
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.004127 | `Ripple Effect (Closeness):` 0.059989
...
**Top Internal Functions/Classes:**
  ...
  * `packFull` **(Compute Cores)** (Impact: 28.5)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 2.462
  * `Choke Point (Betweenness):` 0.000934 | `Ripple Effect (Closeness):` 0.046346
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000719 | `Ripple Effect (Closeness):` 0.064755
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001116 | `Ripple Effect (Closeness):` 0.081755
...
**Top Internal Functions/Classes:**
  ...
  * `extractPopupData` **(Compute Cores)** (Impact: 42.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002527 | `Ripple Effect (Closeness):` 0.119719
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000768 | `Ripple Effect (Closeness):` 0.080567
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001327 | `Ripple Effect (Closeness):` 0.080802
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002538 | `Ripple Effect (Closeness):` 0.082485
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000282 | `Ripple Effect (Closeness):` 0.066623
...
**Top Internal Functions/Classes:**
  * `draw` **(Compute Cores)** (Impact: 68.1)
  * `yScale` **(Compute Cores)** (Impact: 67.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003522 | `Ripple Effect (Closeness):` 0.081635
...
**Top Internal Functions/Classes:**
  ...
  * `parseHeader` **(Compute Cores)** (Impact: 48.7)
  ...
  * `parseTrackLine` **(Compute Cores)** (Impact: 34.9)
  * `constructor` **(State Mutators)** (Impact: 11.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003799 | `Ripple Effect (Closeness):` 0.049097
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 4e-06 | `Ripple Effect (Closeness):` 0.080684
...
**Top Internal Functions/Classes:**
  ...
  * `parseTrackLine` **(Compute Cores)** (Impact: 21.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `readHeader` **(Compute Cores)** (Impact: 20.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.010847 | `Ripple Effect (Closeness):` 0.058968
...
- `js/browser.js` -> **Severity: 4.875** (Bridge: 0.0487 * Flux: 99.9992%)
- `js/trackFactory.js` -> **Severity: 3.43** (Bridge: 0.0348 * Flux: 98.6166%)
- `js/index.js` -> **Severity: 1.457** (Bridge: 0.0901 * Flux: 16.1747%)
- `js/bam/bamTrack.js` -> **Severity: 1.145** (Bridge: 0.0115 * Flux: 99.9962%)
- `js/feature/featureFileReader.js` -> **Severity: 1.085** (Bridge: 0.0108 * Flux: 100.0%)
