...
> **File Composition:** Data / Markup / Trivial 28%, Large Core Modules 14%, Interface Declarations Files 13%, State Mutators Files 12%, Annotated Framework Methods Files 8%
...
| connectivity | 113491 | 9860 | 16 | `benchmarks/SubtypeTestCache/dart/SubtypeTestCache.dart` |
...
- `RegExpDisjunction::RationalizeConsecutiveAtoms` **(Compute Cores)** (@ `runtime/vm/regexp/regexp-compiler-tonode.cc`) -> Impact: **450.7** | LOC: 1377
...
- **Composition Archetype:** `Annotated Framework Methods Files` (z +0.93)
- **Magnitude:** 1680.9 | **LOC:** 934 | **CtrlFlow:** 5.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%)
- **Heaviest Functions:** `generateNumbersSyncStarManyYields` (Compute Cores, Impact: 11.9), `generateNumbersAsyncStarManyYields` (Compute Cores, Impact: 11.9), `performAwaitAsyncCallsInstanceTargetPolymorphicManyAwaits` (Compute Cores, Impact: 10.7)
...
- **Heaviest Functions:** `webServerControlCallback` (Defensive Guards, Impact: 9.1), `listFilesCallback` (Generic / Templated Code, Impact: 6.6), `_registerSignalHandler` (Interface Declarations, Impact: 6.0)
...
- **Heaviest Functions:** `getSamplingRate` (Defensive Guards, Impact: 20.2), `getBufferSize` (Defensive Guards, Impact: 14.7), `_rateToInteger` (Compute Cores, Impact: 12.1)
...
- **Heaviest Functions:** `_variableDeclarationStatement` (Compute Cores, Impact: 17.8), `_assignmentExpression` (Many-Argument Workhorses, Impact: 11.4), `compute` (Defensive Guards, Impact: 9.8)
...
- **Heaviest Functions:** `compute` (Defensive Guards, Impact: 28.2), `compute` (Defensive Guards, Impact: 25.1), `_constructorDeclaration` (Defensive Guards, Impact: 22.2)
...
- **Heaviest Functions:** `_fromMap` (Compute Cores, Impact: 164.5), `_update` (Many-Argument Workhorses, Impact: 101.0), `stringToInstanceKind` (Compute Cores, Impact: 68.3)

### 7. `pkg/analysis_server/lib/src/lsp/handlers/custom/handler_get_widget_previews.dart` (DART) -> Cumulative Risk: **750.01**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Annotated Framework Methods Files` (z -0.12)
...
- **Heaviest Functions:** `handle` (Many-Argument Workhorses, Impact: 31.4), `handle` (Many-Argument Workhorses, Impact: 22.3), `SharedMessageHandler` (Callbacks & Closures, Impact: 19.1)
...
- **Heaviest Functions:** `calculate` (Compute Cores, Impact: 167.2), `preprocessUri` (Many-Argument Workhorses, Impact: 42.8), `findInScope` (Defensive Guards, Impact: 39.9)
...
- **Heaviest Functions:** `main` (Defensive Guards, Impact: 29.4), `report` (Defensive Guards, Impact: 20.3), `tempDir.delete` (Interface Declarations, Impact: 1.5)
...
- **Heaviest Functions:** `ObservatoryApplication` (Compute Cores, Impact: 17.9), `_switchVM` (Compute Cores, Impact: 15.7), `_visit` (Compute Cores, Impact: 15.0)
...
**Top Internal Functions/Classes:**
  * `InferenceVisitor` **(Compute Cores)** (Impact: 277.6)
...
**Top Internal Functions/Classes:**
  * `ExpressionVisitor` **(Compute Cores)** (Impact: 309.6)
...
**Top Internal Functions/Classes:**
  * `Compiler` **(Compute Cores)** (Impact: 313.9)
