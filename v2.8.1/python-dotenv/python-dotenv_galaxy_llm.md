...
> **File Composition:** Data / Markup / Trivial 35%, Defensive Guards Files 27%, Large Core Modules 15%, Generic / Templated Code Files 12%, Declarative / Non-Code 4%
...
- `find_dotenv` **(Defensive Guards)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **28.4** | LOC: 49
- `get_cli_string` **(Many-Argument Workhorses)** (@ `python_dotenv-1.2.2/src/dotenv/__init__.py`) -> Impact: **21.0** | LOC: 28
- `run` **(Compute Cores)** (@ `python_dotenv-1.2.2/src/dotenv/cli.py`) -> Impact: **16.9** | LOC: 18
...
- **Heaviest Functions:** `read_regex` (Compute Cores, Impact: 14.2), `parse_value` (Compute Cores, Impact: 7.7), `parse_binding` (Defensive Guards, Impact: 7.4)
...
- **Heaviest Functions:** `parse_variables` (Compute Cores, Impact: 12.2), `resolve` (Generic / Templated Code, Impact: 8.9), `__ne__` (Generic / Templated Code, Impact: 3.7)
...
- **Heaviest Functions:** `set_key` (Many-Argument Workhorses, Impact: 39.4), `find_dotenv` (Defensive Guards, Impact: 28.4), `rewrite` (Defensive Guards, Impact: 16.6)

### 4. `python_dotenv-1.2.2/src/dotenv/__init__.py` (PYTHON) -> Cumulative Risk: **545.74**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Generic / Templated Code Files` (z +2.27)
...
- **Heaviest Functions:** `get_cli_string` (Many-Argument Workhorses, Impact: 21.0), `load_ipython_extension` (Generic / Templated Code, Impact: 1.6)
...
- **Heaviest Functions:** `run` (Compute Cores, Impact: 16.9), `list_values` (Compute Cores, Impact: 14.7), `set_value` (Many-Argument Workhorses, Impact: 6.8)

### 6. `python_dotenv-1.2.2/tests/test_fifo_dotenv.py` (PYTHON) -> Cumulative Risk: **407.73**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +1.78)
...
- **Heaviest Functions:** `test_load_dotenv_from_fifo` (Defensive Guards, Impact: 2.7), `writer` (Interface Declarations, Impact: 1.1)
...
- **Heaviest Functions:** `dotenv` (Defensive Guards, Impact: 2.3), `load_ipython_extension` (Interface Declarations, Impact: 1.6)
...
- **Heaviest Functions:** `setup_zipfile` (Type Conversions, Impact: 7.6), `test_load_dotenv_outside_zip_file_when_called_in_zipfile` (I/O & Config Routines, Impact: 6.5), `walk_to_root` (Interface Declarations, Impact: 3.2)
...
- **Heaviest Functions:** `dotenv_path` (Interface Declarations, Impact: 1.6), `cli` (Interface Declarations, Impact: 1.2)
...
- **Heaviest Functions:** `clean-build` (I/O & Config Routines, Impact: 1.4), `clean-pyc` (I/O & Config Routines, Impact: 1.2), `test` (Tests & Verification, Impact: 1.2)
...
**Top Internal Functions/Classes:**
  ...
  * `find_dotenv` **(Defensive Guards)** (Impact: 28.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test_get_key_no_file` **(Tests & Verification)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `parse_value` **(Compute Cores)** (Impact: 7.7)
...
**Top Internal Functions/Classes:**
  * `test_list` **(Many-Argument Workhorses)** (Impact: 5.5)
...
**Top Internal Functions/Classes:**
  * `_remove_ps_attributes` **(Defensive Guards)** (Impact: 5.5)
    * *Intent:* """Helper to remove ps1/ps2 attributes if they exist."""
  * `_mock_main_import` **(Encapsulated Accessors)** (Impact: 4.5)
    * *Intent:* """Helper to mock __main__ module import."""
  * `mock_import` **(Parameter Forwarders)** (Impact: 4.2)
  * `mock_import` **(Parameter Forwarders)** (Impact: 4.2)
  * `_mock_main_import_error` **(Encapsulated Accessors)** (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  ...
  * `walk_to_root` **(Interface Declarations)** (Impact: 3.2)
  * `test_load_dotenv_gracefully_handles_zip_imports_when_no_env_file` **(I/O & Config Routines)** (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test` **(Tests & Verification)** (Impact: 1.2)
...
**Top Internal Functions/Classes:**
  ...
  * `load_ipython_extension` **(Interface Declarations)** (Impact: 1.6)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dotenv_path` **(Interface Declarations)** (Impact: 1.6)
