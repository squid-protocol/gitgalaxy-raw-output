...
> **Composition Archetype:** `Hub-Coupled App` (z +0.84; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules 41%, Data / Markup / Trivial 23%, Callbacks & Closures Files 13%, Defensive Guards Files 10%, State Mutators Files 8%
...
- `isPrintstr` **(Compute Cores)** (@ `package/polyfills/crypto-browserify.js`) -> Impact: **220.5** | LOC: 648
...
- **Heaviest Functions:** `Zlib` (Defensive Guards, Impact: 65.5), `_processChunk` (Many-Argument Workhorses, Impact: 37.2), `params` (Defensive Guards, Impact: 27.4)
...
- **Heaviest Functions:** `levelFilesystem` (Defensive Guards, Impact: 340.7), `levelBlobs` (Many-Argument Workhorses, Impact: 134.1), `makeConstructor` (Many-Argument Workhorses, Impact: 114.4)
...
- **Heaviest Functions:** `readableAddChunk` (Many-Argument Workhorses, Impact: 75.8), `read` (Defensive Guards, Impact: 47.4), `pipe` (Many-Argument Workhorses, Impact: 44.7)
...
- **Heaviest Functions:** `clearInterval` (Defensive Guards, Impact: 6.0), `clearTimeout` (Defensive Guards, Impact: 6.0), `active` (Interface Declarations, Impact: 4.8)
...
- **Heaviest Functions:** `relative` (Defensive Guards, Impact: 17.6), `normalizeArray` (Defensive Guards, Impact: 16.8), `resolve` (Defensive Guards, Impact: 10.4)
...
- **Heaviest Functions:** `clearBuffer` (Compute Cores, Impact: 23.6), `writeOrBuffer` (Many-Argument Workhorses, Impact: 23.4), `end` (Defensive Guards, Impact: 19.1)
...
- **Heaviest Functions:** `parse` (Many-Argument Workhorses, Impact: 178.5), `resolveObject` (Compute Cores, Impact: 174.6), `format` (Defensive Guards, Impact: 53.7)
...
- **Heaviest Functions:** `isPrintstr` (Compute Cores, Impact: 220.5), `decode` (Defensive Guards, Impact: 96.3), `encode` (Defensive Guards, Impact: 82.8)
...
- **Heaviest Functions:** `formatValue` (Many-Argument Workhorses, Impact: 71.5), `formatProperty` (Many-Argument Workhorses, Impact: 58.4), `format` (Defensive Guards, Impact: 21.6)
...
- **Heaviest Functions:** `runInContext` (Callbacks & Closures, Impact: 16.8), `forEach` (Compute Cores, Impact: 7.3), `indexOf` (Defensive Guards, Impact: 7.3)
...
**Top Internal Functions/Classes:**
  * `isPrintstr` **(Compute Cores)** (Impact: 220.5)
...
**Top Internal Functions/Classes:**
  ...
  * `arrayIndexOf` **(Defensive Guards)** (Impact: 61.5)
...
**Top Internal Functions/Classes:**
  ...
  * `emit` **(Compute Cores)** (Impact: 31.7)
...
**Top Internal Functions/Classes:**
  * `runInContext` **(Callbacks & Closures)** (Impact: 16.8)
...
**Top Internal Functions/Classes:**
  ...
  * `join` **(Callbacks & Closures)** (Impact: 4.6)
  * `push` **(Callbacks & Closures)** (Impact: 4.5)
  * `shift` **(Defensive Guards)** (Impact: 4.3)
  * `unshift` **(Callbacks & Closures)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 17 instances
...
**Top Internal Functions/Classes:**
  ...
  * `active` **(Interface Declarations)** (Impact: 4.8)
