...
> **Composition Archetype:** `Hub-Coupled App` (z +3.77; from the repo's file-archetype mix)
> **File Composition:** Interface Declarations Files 56%, Large Core Modules 11%, Data / Markup / Trivial 8%, Defensive Guards Files 7%, Tests & Verification Files 7%
...
- `normalize` **(Defensive Guards)** (@ `src/Monolog/Formatter/NormalizerFormatter.php`) -> Impact: **38.3** | LOC: 74
...
- **Composition Archetype:** `Interface Declarations Files` (z +0.58)
...
- **Heaviest Functions:** `__construct` (Many-Argument Workhorses, Impact: 18.1), `write` (State Mutators, Impact: 2.3), `setFormatter` (Interface Declarations, Impact: 1.8)
...
- **Heaviest Functions:** `rotate` (I/O & Config Routines, Impact: 12.7), `setDateFormat` (Compute Cores, Impact: 9.1), `write` (Compute Cores, Impact: 8.0)
...
- **Heaviest Functions:** `format` (Compute Cores, Impact: 5.2), `formatBatch` (Interface Declarations, Impact: 3.3), `__construct` (Interface Declarations, Impact: 1.6)
...
- **Heaviest Functions:** `getSocket` (I/O & Config Routines, Impact: 5.0), `close` (Interface Declarations, Impact: 2.4), `__construct` (Parameter Forwarders, Impact: 2.0)
...
- **Heaviest Functions:** `setTag` (Compute Cores, Impact: 7.6), `addTag` (Compute Cores, Impact: 4.7), `__construct` (Many-Argument Workhorses, Impact: 4.5)

### 6. `src/Monolog/LogRecord.php` (PHP) -> Cumulative Risk: **469.55**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.96)
...
- **Heaviest Functions:** `offsetSet` (Compute Cores, Impact: 7.9), `offsetGet` (Compute Cores, Impact: 6.9), `with` (Defensive Guards, Impact: 4.6)

### 7. `src/Monolog/Handler/BufferHandler.php` (PHP) -> Cumulative Risk: **465.34**
- **Archetype:** `file_cluster_2` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.14)
...
- **Heaviest Functions:** `handle` (Compute Cores, Impact: 12.8), `setFormatter` (Defensive Guards, Impact: 3.3), `__construct` (Many-Argument Workhorses, Impact: 2.8)

### 8. `src/Monolog/Handler/SlackHandler.php` (PHP) -> Cumulative Risk: **462.46**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +0.30)
...
- **Heaviest Functions:** `__construct` (Many-Argument Workhorses, Impact: 26.2), `prepareContentData` (Defensive Guards, Impact: 6.2), `finalizeWrite` (Interface Declarations, Impact: 2.4)
...
- **Heaviest Functions:** `send` (Compute Cores, Impact: 13.2), `addHeader` (Compute Cores, Impact: 7.6), `setContentType` (Interface Declarations, Impact: 4.7)
...
- **Heaviest Functions:** `isDuplicate` (Compute Cores, Impact: 15.2), `flush` (I/O & Config Routines, Impact: 13.9), `collectLogs` (I/O & Config Routines, Impact: 11.8)
...
**Top Internal Functions/Classes:**
  ...
  * `testReset` **(Tests & Verification)** (Impact: 4.6)
  ...
  * `testTimezoneIsRespectedInOtherTimezone` **(Interface Declarations)** (Impact: 3.9)
    * *Intent:* /** * @covers Logger::setTimezone * @covers JsonSerializableDateTimeImmutable::__construct */
...
**Top Internal Functions/Classes:**
  * `format` **(Compute Cores)** (Impact: 23.9)
    * *Intent:* /** * @inheritDoc */
  * `formatException` **(Defensive Guards)** (Impact: 15.8)
  ...
  * `stacktracesParser` **(Defensive Guards)** (Impact: 9.6)
  * `replaceNewlines` **(Compute Cores)** (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `removeExcludedFields` **(Compute Cores)** (Impact: 10.9)
  ...
  * `setUserIcon` **(Interface Declarations)** (Impact: 4.7)
    * *Intent:* /** * @return $this */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `normalize` **(Defensive Guards)** (Impact: 38.3)
    * *Intent:* /** * @return null|scalar|array<mixed[]|scalar|null> */
  ...
  * `formatDate` **(Defensive Guards)** (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  ...
  * `testIgnoresRecursiveObjectReferences` **(Interface Declarations)** (Impact: 3.4)
    * *Intent:* /** * Test issue #137 */
  * `testExceptionTraceWithArgs` **(Defensive Guards)** (Impact: 3.4)
  * `testToJsonIgnoresInvalidTypes` **(Interface Declarations)** (Impact: 3.2)
...
**Top Internal Functions/Classes:**
  * `writeToSocket` **(Compute Cores)** (Impact: 18.4)
  * `__construct` **(Many-Argument Workhorses)** (Impact: 16.2)
    * *Intent:* /** * @param string $connectionString Socket connection string * @param bool $persistent Flag to ena...
  * `writingIsTimedOut` **(Compute Cores)** (Impact: 8.3)
  * `createSocketResource` **(Interface Declarations)** (Impact: 4.6)
  * `streamSetChunkSize` **(Interface Declarations)** (Impact: 3.6)
...
**Top Internal Functions/Classes:**
  ...
  * `write` **(Compute Cores)** (Impact: 21.8)
    * *Intent:* /** * @inheritDoc */
  * `createDir` **(Compute Cores)** (Impact: 10.9)
  * `getDirFromStream` **(Compute Cores)** (Impact: 6.3)
  * `getInodeFromUrl` **(Interface Declarations)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `handleError` **(Many-Argument Workhorses)** (Impact: 21.4)
  * `handleException` **(Defensive Guards)** (Impact: 11.2)
...
**Top Internal Functions/Classes:**
  * `handleCustomStyles` **(Compute Cores)** (Impact: 11.7)
  * `generateScript` **(Interface Declarations)** (Impact: 8.1)
  * `dump` **(Callbacks & Closures)** (Impact: 7.8)
    * *Intent:* /** * @param mixed[] $dict * @return mixed[] */
  * `getResponseFormatFromContentType` **(Compute Cores)** (Impact: 6.4)
    * *Intent:* /** * @return string One of 'js', 'html' or 'unknown' * @phpstan-return self::FORMAT_* */
  * `send` **(Interface Declarations)** (Impact: 5.8)
...
**Top Internal Functions/Classes:**
  ...
  * `testTextEqualsFormatterOutput` **(Tests & Verification)** (Impact: 2.5)
  ...
  * `testStringify` **(Annotated Framework Methods)** (Impact: 2.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `buildContent` **(Compute Cores)** (Impact: 10.5)
  * `write` **(Interface Declarations)** (Impact: 3.4)
  * `buildHeader` **(Interface Declarations)** (Impact: 1.9)
  * `generateDataStream` **(Interface Declarations)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testRegisterSyscallRestartingSignalHandler` **(Tests & Verification)** (Impact: 10.4)
  ...
  * `setSignalHandler` **(Compute Cores)** (Impact: 5.6)
  ...
  * `testRegisterCallablePreviousSignalHandler` **(Tests & Verification)** (Impact: 5.1)
...
**Top Internal Functions/Classes:**
  ...
  * `handleBatch` **(Compute Cores)** (Impact: 9.5)
    * *Intent:* /** * @inheritDoc */
  * `sendCurl` **(Compute Cores)** (Impact: 8.7)
  * `send` **(Compute Cores)** (Impact: 6.3)
    * *Intent:* /** * Send request to @link https://api.telegram.org/bot on SendMessage action. */
  * `setParseMode` **(Interface Declarations)** (Impact: 4.7)
    * *Intent:* /** * @return $this */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `getRecordTags` **(Defensive Guards)** (Impact: 12.4)
    * *Intent:* /** * @return array{string, mixed[]} */
  * `handleErrorRecord` **(Defensive Guards)** (Impact: 7.7)
  * `write` **(Defensive Guards)** (Impact: 7.6)
...
**Top Internal Functions/Classes:**
  * `testMaxLevelNameLength` **(Annotated Framework Methods)** (Impact: 4.5)
  ...
  * `testDefFormatWithExceptionAndStacktraceParserCustom` **(Interface Declarations)** (Impact: 2.8)
  * `providerMaxLevelNameLength` **(Interface Declarations)** (Impact: 2.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `setDateFormat` **(Compute Cores)** (Impact: 9.1)
  * `write` **(Compute Cores)** (Impact: 8.0)
    * *Intent:* /** * @inheritDoc */
...
**Top Internal Functions/Classes:**
  ...
  * `prepareContentData` **(Defensive Guards)** (Impact: 6.2)
    * *Intent:* /** * @return string[] */
  * `finalizeWrite` **(Interface Declarations)** (Impact: 2.4)
  ...
  * `setFormatter` **(Interface Declarations)** (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `flushBuffer` **(Callbacks & Closures)** (Impact: 3.8)
...
**Top Internal Functions/Classes:**
  * `isDuplicate` **(Compute Cores)** (Impact: 15.2)
  ...
  * `buildDeduplicationStoreEntry` **(Interface Declarations)** (Impact: 1.6)
...
**Top Internal Functions/Classes:**
  * `rrmdir` **(Compute Cores)** (Impact: 9.5)
  * `testRotation` **(Tests & Verification)** (Impact: 5.4)
  * `testRotationWithFolderByDate` **(Tests & Verification)** (Impact: 5.4)
  * `tearDown` **(Interface Declarations)** (Impact: 4.9)
  * `assertErrorWasTriggered` **(Defensive Guards)** (Impact: 4.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
...
**Top Internal Functions/Classes:**
  ...
  * `getGraylog2Priority` **(Interface Declarations)** (Impact: 3.5)
