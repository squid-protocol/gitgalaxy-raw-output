...
> **File Composition:** Data / Markup / Trivial 53%, Generic / Templated Code Files 22%, Defensive Guards Files 7%, Large Core Modules 7%, Declarative / Non-Code 4%
...
- `_validate_aud` **(Defensive Guards)** (@ `pyjwt-2.12.1/jwt/api_jwt.py`) -> Impact: **44.9** | LOC: 49
- `_validate_claims` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jwt.py`) -> Impact: **44.5** | LOC: 41
- `from_jwk` **(Compute Cores)** (@ `pyjwt-2.12.1/jwt/algorithms.py`) -> Impact: **41.8** | LOC: 72
...
- `from_jwk` **(Compute Cores)** (@ `pyjwt-2.12.1/jwt/algorithms.py`) -> Impact: **30.4** | LOC: 70
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 47.1), `__init__` (Defensive Guards, Impact: 11.5), `__getitem__` (Generic / Templated Code, Impact: 7.2)
...
- **Heaviest Functions:** `from_jwk` (Compute Cores, Impact: 41.8), `from_jwk` (Compute Cores, Impact: 30.4), `to_jwk` (Defensive Guards, Impact: 24.6)
...
- **Heaviest Functions:** `force_bytes` (Defensive Guards, Impact: 6.0), `to_base64url_uint` (Generic / Templated Code, Impact: 5.7), `raw_to_der_signature` (Generic / Templated Code, Impact: 4.0)
...
- **Heaviest Functions:** `__init__` (Many-Argument Workhorses, Impact: 22.8), `get_signing_keys` (Compute Cores, Impact: 9.9), `get_jwk_set` (Defensive Guards, Impact: 9.8)

### 5. `pyjwt-2.12.1/tests/test_advisory.py` (PYTHON) -> Cumulative Risk: **505.46**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `I/O & Config Routines Files` (z +0.30)
...
- **Heaviest Functions:** `test_ghsa_ffqj_6fqr_9h24` (I/O & Config Routines, Impact: 3.9)
...
- **Heaviest Functions:** `put` (Generic / Templated Code, Impact: 5.5), `is_expired` (Generic / Templated Code, Impact: 4.6), `get` (Generic / Templated Code, Impact: 4.5)
...
- **Heaviest Functions:** `encode` (Many-Argument Workhorses, Impact: 70.5), `decode_complete` (Many-Argument Workhorses, Impact: 39.3), `_verify_signature` (Many-Argument Workhorses, Impact: 33.6)

### 8. `pyjwt-2.12.1/jwt/help.py` (PYTHON) -> Cumulative Risk: **476.66**
- **Archetype:** `file_cluster_6` (Distance: N/A IQR)
- **Composition Archetype:** `Interface Declarations Files` (z +2.10)
...
- **Heaviest Functions:** `info` (I/O & Config Routines, Impact: 7.2), `main` (Interface Declarations, Impact: 1.1)
...
- **Heaviest Functions:** `__init__` (Generic / Templated Code, Impact: 1.8), `__str__` (Generic / Templated Code, Impact: 1.5)

### 10. `pyjwt-2.12.1/jwt/api_jwt.py` (PYTHON) -> Cumulative Risk: **464.64**
- **Archetype:** `file_cluster_0` (Distance: N/A IQR)
- **Composition Archetype:** `Defensive Guards Files` (z +0.98)
...
- **Heaviest Functions:** `_validate_aud` (Defensive Guards, Impact: 44.9), `_validate_claims` (Many-Argument Workhorses, Impact: 44.5), `decode_complete` (Many-Argument Workhorses, Impact: 37.9)
...
**Top Internal Functions/Classes:**
  ...
  * `test_ec_jwk_fails_on_invalid_json` **(Tests & Verification)** (Impact: 7.2)
...
**Top Internal Functions/Classes:**
  * `from_jwk` **(Compute Cores)** (Impact: 41.8)
  * `from_jwk` **(Compute Cores)** (Impact: 30.4)
...
**Top Internal Functions/Classes:**
  ...
  * `test_decode_strict_aud_forbids_list_claim` **(Many-Argument Workhorses)** (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Type Conversions)** (Impact: 12.9)
  * `_validate_crit` **(Defensive Guards)** (Impact: 12.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_validate_aud` **(Defensive Guards)** (Impact: 44.9)
  ...
  * `_validate_iss` **(Defensive Guards)** (Impact: 19.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_from_dict_should_throw_exception_if_arg_is_invalid` **(Tests & Verification)** (Impact: 3.5)
  * `test_keyset_iterator` **(Defensive Guards)** (Impact: 3.4)
  * `test_keyset_should_index_by_kid` **(Tests & Verification)** (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  ...
  * `get_signing_keys` **(Compute Cores)** (Impact: 9.9)
...
**Top Internal Functions/Classes:**
  ...
  * `raw_to_der_signature` **(Generic / Templated Code)** (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  ...
  * `load_hmac_key` **(Interface Declarations)** (Impact: 1.2)
  * `load_rsa_pub_key` **(Interface Declarations)** (Impact: 1.1)
