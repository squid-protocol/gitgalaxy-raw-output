...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/rimraf` |
| **Timestamp** | `2026-08-03T21:14:11.246335+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 5.12 | **LOC:** 256 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
