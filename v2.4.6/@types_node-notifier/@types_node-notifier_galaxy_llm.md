...
| **Timestamp** | `2026-08-03T21:11:00.049003+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Testing Exposure | 2.6 | 3.5 | 3.2 | 3.3 | 2.6 |
...
| Documentation Exposure | 11.9 | 12.0 | 11.9 | 11.9 | 11.9 |
| Algorithmic DoS Exposure | 2.0 | 2.2 | 2.2 | 2.2 | 2.2 |
...
- `notify` (@ `node-notifier/notifiers/notificationcenter.d.ts`) -> Impact: **37.4** | LOC: 27
- `notify` (@ `node-notifier/notifiers/notifysend.d.ts`) -> Impact: **29.6** | LOC: 20
- `notify` (@ `node-notifier/notifiers/growl.d.ts`) -> Impact: **24.3** | LOC: 19
- `notify` (@ `node-notifier/notifiers/balloon.d.ts`) -> Impact: **24.2** | LOC: 16
- `notify` (@ `node-notifier/notifiers/toaster.d.ts`) -> Impact: **21.6** | LOC: 17
- `notify` (@ `node-notifier/index.d.ts`) -> Impact: **19.0** | LOC: 16
...
|---|---|---|---|---|
| `node-notifier/notifiers` | 5 | 14.39 | 11.43% | 95.15% |
| `node-notifier` | 3 | 4.38 | 5.85% | 0.0% |
...
- `node-notifier/notifiers/toaster.d.ts` -> **2.2473%** Exposure
- `node-notifier/notifiers/balloon.d.ts` -> **2.2377%** Exposure
- `node-notifier/notifiers/growl.d.ts` -> **2.2189%** Exposure
- `node-notifier/notifiers/notifysend.d.ts` -> **2.2189%** Exposure
- `node-notifier/notifiers/notificationcenter.d.ts` -> **2.1832%** Exposure
...
### 1. `node-notifier/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **293.35**
- **Archetype:** `file_cluster_13` (Distance: 9.83 IQR)
- **Magnitude:** 2.38 | **LOC:** 54 | **CtrlFlow:** 60.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (61.2336%), Stability (50.0%), Safety Score (44.5779%)
- **Heaviest Functions:** `notify` (Impact: 19.0)

### 2. `node-notifier/notifiers/toaster.d.ts` (TYPESCRIPT) -> Cumulative Risk: **281.41**
- **Archetype:** `file_cluster_8` (Distance: 9.612 IQR)
- **Magnitude:** 2.29 | **LOC:** 29 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (98.4733%), Stability (50.0%), Documentation (11.9203%)
- **Heaviest Functions:** `notify` (Impact: 21.6)

### 3. `node-notifier/notifiers/balloon.d.ts` (TYPESCRIPT) -> Cumulative Risk: **281.04**
- **Archetype:** `file_cluster_8` (Distance: 8.826 IQR)
- **Magnitude:** 2.55 | **LOC:** 23 | **CtrlFlow:** 52.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (97.7023%), Stability (50.0%), Documentation (11.9861%)
- **Heaviest Functions:** `notify` (Impact: 24.2)

### 4. `node-notifier/notifiers/notifysend.d.ts` (TYPESCRIPT) -> Cumulative Risk: **278.66**
- **Archetype:** `file_cluster_8` (Distance: 9.059 IQR)
- **Magnitude:** 3.1 | **LOC:** 27 | **CtrlFlow:** 61.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (95.5022%), Stability (50.0%), Documentation (11.9203%)
- **Heaviest Functions:** `notify` (Impact: 29.6)

### 5. `node-notifier/notifiers/growl.d.ts` (TYPESCRIPT) -> Cumulative Risk: **278.53**
- **Archetype:** `file_cluster_8` (Distance: 8.924 IQR)
- **Magnitude:** 2.57 | **LOC:** 26 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (95.5022%), Stability (50.0%), Documentation (11.9787%)
- **Heaviest Functions:** `notify` (Impact: 24.3)

### 6. `node-notifier/notifiers/notificationcenter.d.ts` (TYPESCRIPT) -> Cumulative Risk: **271.16**
- **Archetype:** `file_cluster_8` (Distance: 9.309 IQR)
- **Magnitude:** 3.88 | **LOC:** 46 | **CtrlFlow:** 60.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (88.5488%), Stability (50.0%), Documentation (11.9203%)
- **Heaviest Functions:** `notify` (Impact: 37.4)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 125.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` notifysend, toaster, notificationcenter, balloon, growl
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `node-notifier/index.d.ts` (TYPESCRIPT) | Magnitude: 2.38 | Delta: **0.251 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 33, branch: 24, structural_boundaries: 16, args: 6

### Mixed-Responsibility Refactoring Targets for: file_cluster_8
- `node-notifier/notifiers/toaster.d.ts` (TYPESCRIPT) | Magnitude: 2.29 | Delta: **0.234 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 9, branch: 8, structural_boundaries: 8, doc: 5
- `node-notifier/notifiers/notificationcenter.d.ts` (TYPESCRIPT) | Magnitude: 3.88 | Delta: **0.282 IQR** | Secondary Pull: `file_cluster_7`
  * Top Architectural Signatures: indent_spaces: 16, branch: 12, structural_boundaries: 8, doc: 8
- `node-notifier/notifiers/notifysend.d.ts` (TYPESCRIPT) | Magnitude: 3.1 | Delta: **0.328 IQR** | Secondary Pull: `file_cluster_7`
  * Top Architectural Signatures: indent_spaces: 12, branch: 11, structural_boundaries: 7, doc: 5
- `node-notifier/notifiers/growl.d.ts` (TYPESCRIPT) | Magnitude: 2.57 | Delta: **0.385 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 12, branch: 9, structural_boundaries: 9, class_start: 3
- `node-notifier/notifiers/balloon.d.ts` (TYPESCRIPT) | Magnitude: 2.55 | Delta: **0.404 IQR** | Secondary Pull: `file_cluster_7`
...
- `node-notifier/notifiers/balloon.d.ts` -> **Severity: 1498.263** (Blast Radius: 125.0 * Doc Risk: 11.9861%)
- `node-notifier/notifiers/growl.d.ts` -> **Severity: 1497.338** (Blast Radius: 125.0 * Doc Risk: 11.9787%)
