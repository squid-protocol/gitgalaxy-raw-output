...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/node-schedule` |
| **Timestamp** | `2026-08-03T21:13:33.490459+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
3. **UPGRADING.md** (`package/UPGRADING.md`) — 0 inbound connections
...
1. **`package/index.js`** -> AI Confidence: **98.88%**
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **176.75**
- **Archetype:** `file_cluster_8` (Distance: 5.779 IQR)
- **Magnitude:** 16.3 | **LOC:** 18 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Documentation (11.9203%), Cognitive Load (7.8228%)

## 12. SCANNED ARTIFACTS HITLIST (Top 25 Heaviest Files)
> *Note: 'Magnitude' represents the file's total Structural Magnitude and impact within the system. It is independent of its Risk Profile. High magnitude implies high structural importance and centralization.*

### `package/index.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 98.88%)
- **Global Archetype:** `file_cluster_8` (Drift: 5.779 IQR)
- **Local Micro-Species:** `Cluster 8: Declarative Glue & Inert Types` (Drift: 4.457 IQR)
- **Top Global Matches:** file_cluster_8: 5.779, file_cluster_13: 6.564, file_cluster_7: 7.119
- **Magnitude:** 16.3 | **LOC:** 18 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (7.8228%), Tech Debt (0.0%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` Job, schedule, Invocation
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 16.3 | Delta: **0.785 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 9, import: 3, immutability_locks: 3, api: 1
