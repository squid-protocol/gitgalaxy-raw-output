...
| **Timestamp** | `2026-08-03T21:09:02.820940+00:00` |
| **Scan Duration** | `0.14s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
### 1. `package/bins/linux-armv7l/_nlcBuildMetadata.json` (JSON) -> Cumulative Risk: **68.49**
...
- `package/bins/linux-armv7l/_nlcBuildMetadata.json` -> **Severity: 2222.231** (Blast Radius: 333.333 * Doc Risk: 6.6667%)
