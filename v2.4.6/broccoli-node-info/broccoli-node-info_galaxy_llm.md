...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/broccoli-node-info` |
| **Timestamp** | `2026-08-03T21:11:34.478617+00:00` |
| **Scan Duration** | `0.13s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 99.3 | 99.3 | 99.3 | 99.3 | 99.3 |
| Error & Exception Exposure | 22.1 | 22.1 | 22.1 | 22.1 | 22.1 |
...
3. **index.js** (`package/index.js`) — 0 outbound dependencies
4. **package.json** (`package/package.json`) — 0 outbound dependencies

## 8. CORE FUNCTION HITLIST (Heaviest Functions)
> *Note: The 'Impact' metric below represents Structural Magnitude (complexity, arguments, and length), NOT operational risk. These are the load-bearing pillars of the logic.*

- `fn` (@ `package/index.js`) -> Impact: **3.5** | LOC: 9
- `InvalidNodeError` (@ `package/index.js`) -> Impact: **2.2** | LOC: 9

## 8.5 ALGORITHMIC & DATABASE BOTTLENECKS
> Highlights the most computationally expensive and database-heavy functions across the repository.

### Highest Data Gravity (Database Complexity)
- `InvalidNodeError` (@ `package/index.js`) -> DB Complexity: **5**

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package` | 4 | 21.44 | 24.83% | 0.0% |
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **388.57**
- **Archetype:** `file_cluster_8` (Distance: 12.702 IQR)
- **Magnitude:** 18.1 | **LOC:** 142 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Cognitive Load (99.3307%), Stability (50.0%)
- **Heaviest Functions:** `fn` (Impact: 3.5), `InvalidNodeError` (Impact: 2.2)
...
- **Local Micro-Species:** `Cluster 2: Procedural Core & Safety Wrappers` (Drift: 3.831 IQR)
- **Top Global Matches:** file_cluster_8: 12.702, file_cluster_12: 12.837, file_cluster_11: 13.075
- **Magnitude:** 18.1 | **LOC:** 142 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 5
- **Risk Profile:** Cognitive Load (99.3307%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `fn` (Impact: 3.5 | O(N^1))
  * `InvalidNodeError` (Impact: 2.2 | O(N^1) | DB: 5)
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 18.1 | Delta: **0.135 IQR** | Secondary Pull: `file_cluster_12`
  * Top Architectural Signatures: indent_spaces: 13, state_mutation: 11, structural_boundaries: 4, reflection_metaprogramming: 4
