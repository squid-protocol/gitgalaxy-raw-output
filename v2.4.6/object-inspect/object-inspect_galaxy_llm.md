...
| **Timestamp** | `2026-08-03T21:13:53.369093+00:00` |
| **Scan Duration** | `0.18s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 0.0 | 80.0 | 16.7 | 14.2 | 0.0 |
...
| Algorithmic DoS Exposure | 0.0 | 89.0 | 9.9 | 0.0 | 0.0 |
...
- `arrObjKeys` (@ `package/index.js`) -> Impact: **101.5** | LOC: 39
- `getIndent` (@ `package/index.js`) -> Impact: **16.3** | LOC: 14
- `singleLineValues` (@ `package/index.js`) -> Impact: **10.8** | LOC: 8
...
- `arrObjKeys` (@ `package/index.js`) -> **O(N^4)**
- `singleLineValues` (@ `package/index.js`) -> **O(N^3)**

### Highest Data Gravity (Database Complexity)
- `arrObjKeys` (@ `package/index.js`) -> DB Complexity: **11**
- `wrapQuotes` (@ `package/index.js`) -> DB Complexity: **2**
- `getIndent` (@ `package/index.js`) -> DB Complexity: **1**
- `singleLineValues` (@ `package/index.js`) -> DB Complexity: **1**
- `collectionOf` (@ `package/index.js`) -> DB Complexity: **1**
- `indentedJoin` (@ `package/index.js`) -> DB Complexity: **1**

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package` | 8 | 401.74 | 15.23% | 12.43% |
...
- `package/index.js` -> **89.0121%** Exposure
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **750.96**
- **Archetype:** `file_cluster_8` (Distance: 16.1 IQR)
- **Magnitude:** 331.18 | **LOC:** 545 | **CtrlFlow:** 54.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Logic Bomb (100.0%), Cognitive Load (99.9107%)
- **Heaviest Functions:** `arrObjKeys` (Impact: 101.5), `getIndent` (Impact: 16.3), `singleLineValues` (Impact: 10.8)

### 2. `package/example/all.js` (JAVASCRIPT) -> Cumulative Risk: **191.08**
- **Archetype:** `file_cluster_8` (Distance: 9.163 IQR)
- **Magnitude:** 19.4 | **LOC:** 24 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Cognitive Load (26.8941%), Safety Score (14.1851%)

### 3. `package/example/inspect.js` (JAVASCRIPT) -> Cumulative Risk: **175.0**
- **Archetype:** `file_cluster_13` (Distance: 10.333 IQR)
- **Magnitude:** 15.12 | **LOC:** 11 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Safety Score (80.0%), Stability (50.0%), Spec Match (40.0%), Cognitive Load (5.0%)

### 4. `package/example/circular.js` (JAVASCRIPT) -> Cumulative Risk: **105.7**
- **Archetype:** `file_cluster_13` (Distance: 10.554 IQR)
- **Magnitude:** 14.6 | **LOC:** 7 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (33.3333%), Safety Score (17.3647%), Cognitive Load (5.0%)

### 5. `package/example/fn.js` (JAVASCRIPT) -> Cumulative Risk: **99.91**
- **Archetype:** `file_cluster_13` (Distance: 11.962 IQR)
- **Magnitude:** 3.88 | **LOC:** 6 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (26.6667%), Safety Score (18.2426%), Cognitive Load (5.0%)
...
**Top Internal Functions/Classes:**
  * `arrObjKeys` (Impact: 101.5 | O(N^4) | DB: 11)
  * `getIndent` (Impact: 16.3 | O(N^2) | DB: 1)
  * `singleLineValues` (Impact: 10.8 | O(N^3) | DB: 1)
  * `canTrustToString` (Impact: 7.1 | O(N^1))
  * `collectionOf` (Impact: 4.7 | O(N^1) | DB: 1)
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 331.18 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_11`
...
- `package/example/inspect.js` -> **Severity: 7.273** (Embedded: 0.0909 * Error Risk: 80.0%)
