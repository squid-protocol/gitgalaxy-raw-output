...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/corpus_cobol/temp` |
| **Timestamp** | `2026-08-03T19:29:13.789619+00:00` |
| **Scan Duration** | `0.43s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 0.0 | 99.1 | 58.6 | 63.7 | 75.5 |
...
- `cics-genapp/base/src/lgsetup.cbl` (Hits: 55)
- `cics-genapp/base/cntl/db2cre.jcl` (Hits: 54)
- `cics-genapp/base/cntl/sampwui.jcl` (Hits: 51)

### Top 5 Structural Pillars (Highest 'Imported By' / Blast Radius)
These are the most interconnected files relative to the rest of this repository. On a repo with dense internal coupling, that means core load-bearing infrastructure -- changes carry real cascading-break risk. On a repo with a flatter internal architecture, the gap between #1 and #5 may be small, and this list is a weaker signal accordingly; compare the connection counts below before treating it as a verdict.

1. **Changes.md** (`cics-genapp/Changes.md`) — 0 inbound connections
2. **MAINTAINERS.md** (`cics-genapp/MAINTAINERS.md`) — 0 inbound connections
3. **README.md** (`cics-genapp/README.md`) — 0 inbound connections
4. **Building.md** (`cics-genapp/base/Building.md`) — 0 inbound connections
5. **Installation.md** (`cics-genapp/base/Installation.md`) — 0 inbound connections

### Top 5 Orchestrators (Highest 'Imports' / Fragility Index)
These files pull in the most external dependencies. They are highly coupled and fragile to API changes.

1. **lgacdb01.cbl** (`cics-genapp/base/src/lgacdb01.cbl`) — 3 outbound dependencies
2. **lgapdb01.cbl** (`cics-genapp/base/src/lgapdb01.cbl`) — 3 outbound dependencies
3. **lgicdb01.cbl** (`cics-genapp/base/src/lgicdb01.cbl`) — 3 outbound dependencies
4. **lgipdb01.cbl** (`cics-genapp/base/src/lgipdb01.cbl`) — 3 outbound dependencies
5. **lgucdb01.cbl** (`cics-genapp/base/src/lgucdb01.cbl`) — 3 outbound dependencies

## 8. CORE FUNCTION HITLIST (Heaviest Functions)
> *Note: The 'Impact' metric below represents Structural Magnitude (complexity, arguments, and length), NOT operational risk. These are the load-bearing pillars of the logic.*

- `UPDATE-POLICY-DB2-INFO` (@ `cics-genapp/base/src/lgupdb01.cbl`) -> Impact: **125.1** | LOC: 102
  * *Intent:* ******************************************************************
- `MAINLINE` (@ `cics-genapp/base/src/lgwebst5.cbl`) -> Impact: **100.5** | LOC: 448
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp4.cbl`) -> Impact: **93.8** | LOC: 197
- `MAINLINE` (@ `cics-genapp/base/src/lgicvs01.cbl`) -> Impact: **90.2** | LOC: 124
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp1.cbl`) -> Impact: **72.0** | LOC: 201
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp2.cbl`) -> Impact: **72.0** | LOC: 189
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp3.cbl`) -> Impact: **72.0** | LOC: 185
- `GET-ENDOW-DB2-INFO` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **70.8** | LOC: 87
- `GET-Commercial-DB2-INFO-3` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **67.3** | LOC: 27
- `GET-Commercial-DB2-INFO-5` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **67.3** | LOC: 26

## 8.5 ALGORITHMIC & DATABASE BOTTLENECKS
> Highlights the most computationally expensive and database-heavy functions across the repository.

### Highest Time Complexity (Big-O)
- `GET-Commercial-DB2-INFO-3` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> **O(2^N) [Recursive]**
- `GET-Commercial-DB2-INFO-5` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> **O(2^N) [Recursive]**
- `INSERT-CUSTOMER` (@ `cics-genapp/base/src/lgacdb01.cbl`) -> **O(N^6)**
  * *Intent:* *----------------------------------------------------------------* * Process incoming commarea * *----------------------------------------------------...
- `MAINLINE` (@ `cics-genapp/base/src/lgacdb01.cbl`) -> **O(N^6)**
  * *Intent:* *----------------------------------------------------------------* * Definitions required for data manipulation * *-----------------------------------...
- `Obtain-CUSTOMER-Number` (@ `cics-genapp/base/src/lgacdb01.cbl`) -> **O(N^6)**
  * *Intent:* *----------------------------------------------------------------* * Common code * *----------------------------------------------------------------* ...
- `INSERT-CUSTOMER-PASSWORD` (@ `cics-genapp/base/src/lgacdb02.cbl`) -> **O(N^6)**
- `INSERT-CUSTOMER` (@ `cics-genapp/base/src/lgacus01.cbl`) -> **O(N^6)**
- `A-EXIT` (@ `cics-genapp/base/src/lgacvs01.cbl`) -> **O(N^6)**
  * *Intent:* *----------------------------------------------------------------* *****************************************************************
- `INSERT-COMMERCIAL` (@ `cics-genapp/base/src/lgapdb01.cbl`) -> **O(N^6)**
- `INSERT-POLICY` (@ `cics-genapp/base/src/lgapdb01.cbl`) -> **O(N^6)**

### Highest Data Gravity (Database Complexity)
- `MAINLINE` (@ `cics-genapp/base/src/lgwebst5.cbl`) -> DB Complexity: **226**
- `MAINLINE` (@ `cics-genapp/base/src/lgsetup.cbl`) -> DB Complexity: **133**
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp1.cbl`) -> DB Complexity: **87**
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp4.cbl`) -> DB Complexity: **81**
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp2.cbl`) -> DB Complexity: **80**
- `MAINLINE` (@ `cics-genapp/base/src/lgicvs01.cbl`) -> DB Complexity: **79**
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp3.cbl`) -> DB Complexity: **75**
- `UPDATE-POLICY-DB2-INFO` (@ `cics-genapp/base/src/lgupdb01.cbl`) -> DB Complexity: **65**
  * *Intent:* ******************************************************************
- `A-GAIN` (@ `cics-genapp/base/src/lgtestc1.cbl`) -> DB Complexity: **58**
- `ERROR-OUT` (@ `cics-genapp/base/src/lgtestc1.cbl`) -> DB Complexity: **47**

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `cics-genapp/base/src` | 47 | 5582.44 | 61.04% | 35.54% |
| `cics-genapp/base/cntl` | 30 | 581.22 | 5.42% | 0.0% |
| `cics-genapp/base/wsim` | 39 | 79.64 | 0.0% | 0.0% |
| `cics-genapp/base` | 5 | 9.46 | 0.0% | 0.0% |
| `cics-genapp/base/bin` | 1 | 6.24 | 100.0% | 100.0% |
...
- `cics-genapp/base/bin/install.sh` -> **99.9978%** Exposure
- `cics-genapp/base/src/lgicus01.cbl` -> **87.2926%** Exposure
- `cics-genapp/base/src/lgtestp3.cbl` -> **79.219%** Exposure
- `cics-genapp/base/src/lgstsq.cbl` -> **78.9768%** Exposure
- `cics-genapp/base/src/lgtestp2.cbl` -> **78.4314%** Exposure
### Highest State Flux (Mutation/Volatility)
- `cics-genapp/base/src/lgacus01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgapvs01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgdpdb01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgicdb01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgicus01.cbl` -> **100.0%** Exposure
### Highest Design Slop (Dead & Duplicated Logic)
- `cics-genapp/base/src/lgipdb01.cbl` -> **10** Orphaned Functions | **0** Duplicates
- `cics-genapp/base/src/lgtestp1.cbl` -> **8** Orphaned Functions | **0** Duplicates
- `cics-genapp/base/src/lgtestp2.cbl` -> **8** Orphaned Functions | **0** Duplicates
- `cics-genapp/base/src/lgtestp3.cbl` -> **8** Orphaned Functions | **0** Duplicates
- `cics-genapp/base/src/lgtestp4.cbl` -> **8** Orphaned Functions | **0** Duplicates

## 10.5 AI THREAT INTELLIGENCE (XGBoost)
> **CRITICAL THREATS DETECTED.** The following files possess the structural signatures of known vulnerabilities.

1. **`cics-genapp/base/src/lgipdb01.cbl`** -> AI Confidence: **99.32%**
2. **`cics-genapp/base/src/lgupdb01.cbl`** -> AI Confidence: **99.32%**
3. **`cics-genapp/base/src/lgtestp4.cbl`** -> AI Confidence: **99.29%**
4. **`cics-genapp/base/src/lgapdb01.cbl`** -> AI Confidence: **99.2%**
5. **`cics-genapp/base/src/lgtestc1.cbl`** -> AI Confidence: **99.17%**
6. **`cics-genapp/base/src/lgtestp1.cbl`** -> AI Confidence: **99.17%**
7. **`cics-genapp/base/src/lgtestp2.cbl`** -> AI Confidence: **99.17%**
8. **`cics-genapp/base/src/lgtestp3.cbl`** -> AI Confidence: **99.17%**
9. **`cics-genapp/base/src/lgacdb01.cbl`** -> AI Confidence: **99.09%**
10. **`cics-genapp/base/src/lgicdb01.cbl`** -> AI Confidence: **99.09%**

## 10.6 WEAPONIZABLE SURFACE EXPOSURES (RULE-BASED SAST)
> Secondary Evidence: The following files tripped specific static threat signatures. Use these to explain *why* the XGBoost model flagged the files above.

### Exploit Generation Surface
- `cics-genapp/base/cntl/adef121.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/asmmap.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/cobol.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/db2cre.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/defdrep.jcl` -> **100.0%** Exposure
### Weaponizable Injection Vectors
- `cics-genapp/base/cntl/adef121.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/asmmap.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/cdef121.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/cdef122.jcl` -> **100.0%** Exposure
- `cics-genapp/base/cntl/cdef123.jcl` -> **100.0%** Exposure
### Hardcoded Payload Artifacts
- `cics-genapp/base/src/lgacdb01.cbl` -> **99.0093%** Exposure
### Algorithmic DoS Exposure
- `cics-genapp/base/src/lgacdb01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgacdb02.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgacus01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgacvs01.cbl` -> **100.0%** Exposure
- `cics-genapp/base/src/lgapdb01.cbl` -> **100.0%** Exposure
...
### 1. `cics-genapp/base/src/lgicvs01.cbl` (COBOL) -> Cumulative Risk: **780.62**
...
### 2. `cics-genapp/base/src/lgtestc1.cbl` (COBOL) -> Cumulative Risk: **774.58**
...
### 3. `cics-genapp/base/src/lgupol01.cbl` (COBOL) -> Cumulative Risk: **751.1**
- **Archetype:** `file_cluster_8` (Distance: 12.917 IQR)
- **Magnitude:** 132.84 | **LOC:** 202 | **CtrlFlow:** 63.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Algorithmic Dos (100.0%), Documentation (94.6745%)
- **Heaviest Functions:** `MAINLINE` (Impact: 45.0), `UPDATE-POLICY-DB2-INFO` (Impact: 22.9), `MAINLINE-EXIT` (Impact: 1.6)

### 4. `cics-genapp/base/src/lgtestp3.cbl` (COBOL) -> Cumulative Risk: **729.84**
...
### 5. `cics-genapp/base/src/lgtestp2.cbl` (COBOL) -> Cumulative Risk: **728.82**
...
### 6. `cics-genapp/base/src/lgapvs01.cbl` (COBOL) -> Cumulative Risk: **728.76**
- **Archetype:** `file_cluster_8` (Distance: 11.807 IQR)
- **Magnitude:** 142.22 | **LOC:** 189 | **CtrlFlow:** 51.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Algorithmic Dos (100.0%), Documentation (92.2985%)
- **Heaviest Functions:** `MAINLINE` (Impact: 35.5), `A-EXIT` (Impact: 22.8)

### 7. `cics-genapp/base/src/lgacdb01.cbl` (COBOL) -> Cumulative Risk: **727.03**
...
### 8. `cics-genapp/base/src/lgtestp1.cbl` (COBOL) -> Cumulative Risk: **722.69**
...
### 9. `cics-genapp/base/src/lgupvs01.cbl` (COBOL) -> Cumulative Risk: **722.14**
- **Archetype:** `file_cluster_8` (Distance: 11.943 IQR)
- **Magnitude:** 160.24 | **LOC:** 207 | **CtrlFlow:** 56.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Algorithmic Dos (100.0%), Cognitive Load (91.8321%)
- **Heaviest Functions:** `MAINLINE` (Impact: 45.2), `A-EXIT` (Impact: 22.8)

### 10. `cics-genapp/base/src/lgupdb01.cbl` (COBOL) -> Cumulative Risk: **719.62**
...
### `cics-genapp/base/src/lgipdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.32%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` LGPOLICY, LGCMAREA, SQLCA
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `cics-genapp/base/src/lgwebst5.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 98.85%)
...
### `cics-genapp/base/src/lgupdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.32%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 7.752
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` LGCMAREA, SQLCA, LGPOLICY
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `cics-genapp/base/src/lgapdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.2%)
...
### `cics-genapp/base/src/lgtestp4.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.29%)
...
### `cics-genapp/base/src/lgtestp1.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.17%)
...
### `cics-genapp/base/src/lgtestp2.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.17%)
...
### `cics-genapp/base/src/lgtestc1.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.17%)
...
### `cics-genapp/base/src/lgtestp3.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.17%)
...
### `cics-genapp/base/src/lgacdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.09%)
...
### `cics-genapp/base/src/lgicvs01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgupvs01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgapvs01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgupol01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgicdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.09%)
...
### `cics-genapp/base/src/lgdpdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 7.752
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` LGCMAREA, SQLCA
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `cics-genapp/base/src/lgucdb01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.09%)
...
### `cics-genapp/base/src/lgacdb02.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 7.752
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` SQLCA, LGPOLICY
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `cics-genapp/base/src/lgdpol01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgipvs01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 98.96%)
...
### `cics-genapp/base/src/lgacus01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 7.752
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` LGCMAREA, LGPOLICY
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `cics-genapp/base/src/lgicus01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgucus01.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/src/lgastat1.cbl` (COBOL | Tier 2 | 🚨 AI THREAT: 99.06%)
...
### `cics-genapp/base/cntl/adef121.jcl` (JCL | Tier 2 | 🚨 AI THREAT: 98.82%)
...
- `cics-genapp/base/src/lgucus01.cbl` (COBOL) | Magnitude: 78.72 | Delta: **0.001 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 96, state_mutation: 36, structural_boundaries: 12, branch: 11

### Mixed-Responsibility Refactoring Targets for: file_cluster_11
- `cics-genapp/base/src/lgipdb01.cbl` (COBOL) | Magnitude: 854.28 | Delta: **0.002 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 739, state_mutation: 341, branch: 117, safety: 34
- `cics-genapp/base/src/lgicdb01.cbl` (COBOL) | Magnitude: 130.22 | Delta: **0.004 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 141, state_mutation: 61, branch: 18, structural_boundaries: 13
- `cics-genapp/base/src/lgapol01.cbl` (COBOL) | Magnitude: 75.98 | Delta: **0.013 IQR** | Secondary Pull: `file_cluster_17`
  * Top Architectural Signatures: indent_spaces: 89, state_mutation: 34, structural_boundaries: 11, branch: 10
- `cics-genapp/base/src/lgdpol01.cbl` (COBOL) | Magnitude: 97.02 | Delta: **0.029 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_spaces: 101, state_mutation: 39, branch: 16, structural_boundaries: 12
- `cics-genapp/base/src/lgapdb01.cbl` (COBOL) | Magnitude: 340.06 | Delta: **0.031 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_spaces: 408, state_mutation: 136, branch: 51, reflection_metaprogramming: 31

### Mixed-Responsibility Refactoring Targets for: file_cluster_12
- `cics-genapp/base/bin/install.sh` (SHELL) | Magnitude: 6.24 | Delta: **0.31 IQR** | Secondary Pull: `file_cluster_8`
...
- `cics-genapp/base/src/lgacdb02.cbl` (COBOL) | Magnitude: 104.62 | Delta: **0.003 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 126, state_mutation: 46, branch: 16, structural_boundaries: 13
- `cics-genapp/base/src/lgucdb01.cbl` (COBOL) | Magnitude: 112.32 | Delta: **0.074 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 141, state_mutation: 48, branch: 15, structural_boundaries: 13
- `cics-genapp/base/src/lgipol01.cbl` (COBOL) | Magnitude: 64.34 | Delta: **0.09 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 82, state_mutation: 30, structural_boundaries: 11, branch: 8

### Mixed-Responsibility Refactoring Targets for: file_cluster_4
- `cics-genapp/base/src/lgicvs01.cbl` (COBOL) | Magnitude: 177.4 | Delta: **0.116 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: indent_spaces: 180, state_mutation: 69, io: 30, branch: 23

### Mixed-Responsibility Refactoring Targets for: file_cluster_8
- `cics-genapp/base/src/lgacdb01.cbl` (COBOL) | Magnitude: 181.46 | Delta: **0.009 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 213, state_mutation: 72, branch: 24, reflection_metaprogramming: 18
- `cics-genapp/base/src/lgupol01.cbl` (COBOL) | Magnitude: 132.84 | Delta: **0.041 IQR** | Secondary Pull: `file_cluster_11`
  * Top Architectural Signatures: indent_spaces: 117, state_mutation: 60, branch: 21, structural_boundaries: 12
- `cics-genapp/base/src/lgstsq.cbl` (COBOL) | Magnitude: 66.4 | Delta: **0.087 IQR** | Secondary Pull: `file_cluster_0`
  * Top Architectural Signatures: indent_spaces: 85, state_mutation: 38, io: 15, structural_boundaries: 11
- `cics-genapp/base/src/lgtestp1.cbl` (COBOL) | Magnitude: 279.08 | Delta: **0.203 IQR** | Secondary Pull: `file_cluster_2`
  * Top Architectural Signatures: indent_spaces: 259, state_mutation: 175, reflection_metaprogramming: 26, branch: 22
- `cics-genapp/base/src/lgtestp3.cbl` (COBOL) | Magnitude: 264.62 | Delta: **0.205 IQR** | Secondary Pull: `file_cluster_12`
...
- `cics-genapp/base/cntl/itpentr.jcl` -> **Severity: 767.978** (Blast Radius: 7.752 * Doc Risk: 99.0684%)
- `cics-genapp/base/src/lgdpvs01.cbl` -> **Severity: 764.267** (Blast Radius: 7.752 * Doc Risk: 98.5897%)
- `cics-genapp/base/src/lgucvs01.cbl` -> **Severity: 764.175** (Blast Radius: 7.752 * Doc Risk: 98.5778%)
- `cics-genapp/base/src/soaic01.cpy` -> **Severity: 757.26** (Blast Radius: 7.752 * Doc Risk: 97.6857%)
- `cics-genapp/base/cntl/itpll.jcl` -> **Severity: 753.671** (Blast Radius: 7.752 * Doc Risk: 97.2228%)
