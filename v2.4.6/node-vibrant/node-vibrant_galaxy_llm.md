...
| **Timestamp** | `2026-08-03T21:13:49.414587+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 2.4 | 61.4 | 28.7 | 26.7 | 26.7 |
...
### 1. `package/src/pipeline/index.ts` (TYPESCRIPT) -> Cumulative Risk: **196.52**
- **Archetype:** `file_cluster_13` (Distance: 7.319 IQR)
- **Magnitude:** 1.62 | **LOC:** 14 | **CtrlFlow:** 54.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (73.3333%), Documentation (61.3829%), Stability (50.0%), Api Exposure (5.1192%)

### 2. `package/src/node.ts` (TYPESCRIPT) -> Cumulative Risk: **141.33**
- **Archetype:** `file_cluster_13` (Distance: 7.134 IQR)
- **Magnitude:** 1.41 | **LOC:** 9 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (40.0%), Documentation (39.6274%), Api Exposure (5.7813%)

### 3. `package/src/configs/config.ts` (TYPESCRIPT) -> Cumulative Risk: **128.13**
- **Archetype:** `file_cluster_8` (Distance: 6.707 IQR)
- **Magnitude:** 1.36 | **LOC:** 8 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (33.3333%), Documentation (33.2509%), Api Exposure (5.7813%)

### 4. `package/src/throw.ts` (TYPESCRIPT) -> Cumulative Risk: **118.11**
- **Archetype:** `file_cluster_8` (Distance: 10.067 IQR)
- **Magnitude:** 1.41 | **LOC:** 6 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (26.6667%), Documentation (26.6667%), Api Exposure (9.1631%)

### 5. `package/src/browser.ts` (TYPESCRIPT) -> Cumulative Risk: **114.72**
- **Archetype:** `file_cluster_13` (Distance: 6.759 IQR)
- **Magnitude:** 1.31 | **LOC:** 7 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (26.6667%), Documentation (26.6577%), Api Exposure (5.7813%)

### 6. `package/src/configs/browser.ts` (TYPESCRIPT) -> Cumulative Risk: **114.72**
- **Archetype:** `file_cluster_13` (Distance: 7.302 IQR)
- **Magnitude:** 1.31 | **LOC:** 7 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (26.6667%), Documentation (26.6577%), Api Exposure (5.7813%)

### 7. `package/src/worker.ts` (TYPESCRIPT) -> Cumulative Risk: **86.14**
- **Archetype:** `file_cluster_13` (Distance: 7.93 IQR)
- **Magnitude:** 1.3 | **LOC:** 3 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Stability (50.0%), Spec Match (13.3333%), Documentation (13.3333%), Api Exposure (9.1631%)

### 8. `package/src/worker.worker.ts` (TYPESCRIPT) -> Cumulative Risk: **77.84**
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 63.694
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` quantizer-mmcq, core, generator-default
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 63.694
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` pipeline, browser
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 63.694
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` image-browser, config
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- `package/src/configs/config.ts` -> **Severity: 5718.29** (Blast Radius: 171.974 * Doc Risk: 33.2509%)
- `package/src/pipeline/index.ts` -> **Severity: 3909.722** (Blast Radius: 63.694 * Doc Risk: 61.3829%)
- `package/src/node.ts` -> **Severity: 2524.028** (Blast Radius: 63.694 * Doc Risk: 39.6274%)
- `package/src/throw.ts` -> **Severity: 1698.509** (Blast Radius: 63.694 * Doc Risk: 26.6667%)
- `package/src/browser.ts` -> **Severity: 1697.936** (Blast Radius: 63.694 * Doc Risk: 26.6577%)
