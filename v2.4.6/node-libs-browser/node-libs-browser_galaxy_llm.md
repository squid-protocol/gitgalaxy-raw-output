# ARCHITECTURAL_BRIEF: node-libs-browser
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/node-libs-browser` |
| **Timestamp** | `2026-08-03T21:13:07.828791+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **477.95**
- **Archetype:** `file_cluster_8` (Distance: 6.395 IQR)
- **Magnitude:** 53.76 | **LOC:** 39 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- **Global Archetype:** `file_cluster_8` (Drift: 6.395 IQR)
- **Local Micro-Species:** `Cluster 8: Declarative Glue & Inert Types` (Drift: 5.355 IQR)
- **Top Global Matches:** file_cluster_8: 6.395, file_cluster_7: 7.349, file_cluster_1: 7.621
- **Magnitude:** 53.76 | **LOC:** 39 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (5.7896%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
* *Architecture:* `io: 8`, `api: 38`
* *Defense:* `test: 2`
* *Network Topology:*
...
- `package/index.js` -> **Severity: 33333.3** (Blast Radius: 333.333 * Doc Risk: 100.0%)
