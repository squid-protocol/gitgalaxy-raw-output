...
| **Timestamp** | `2026-08-03T21:10:50.216850+00:00` |
| **Scan Duration** | `0.12s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Tech Debt Exposure | 60.2 | 100.0 | 80.1 | 80.1 | 100.0 |
| Testing Exposure | 3.1 | 80.0 | 41.5 | 41.5 | 3.1 |
...
| Documentation Exposure | 11.9 | 99.4 | 55.7 | 55.7 | 99.4 |
| Algorithmic DoS Exposure | 20.1 | 100.0 | 60.1 | 60.1 | 20.1 |
...
- `fetch` (@ `node-fetch/index.d.ts`) -> Impact: **19.6** | LOC: 33
- `listener` (@ `node-fetch/externals.d.ts`) -> Impact: **17.6** | LOC: 6
- `arrayBuffer` (@ `node-fetch/index.d.ts`) -> Impact: **14.9** | LOC: 16
- `constructor` (@ `node-fetch/index.d.ts`) -> Impact: **14.4** | LOC: 11
- `clone` (@ `node-fetch/index.d.ts`) -> Impact: **14.1** | LOC: 27
- `listener` (@ `node-fetch/externals.d.ts`) -> Impact: **10.6** | LOC: 4
- `values` (@ `node-fetch/index.d.ts`) -> Impact: **4.7** | LOC: 10
- `raw` (@ `node-fetch/index.d.ts`) -> Impact: **1.5** | LOC: 1

## 8.5 ALGORITHMIC & DATABASE BOTTLENECKS
> Highlights the most computationally expensive and database-heavy functions across the repository.

### Highest Time Complexity (Big-O)
- `fetch` (@ `node-fetch/index.d.ts`) -> **O(2^N) [Recursive]**
- `arrayBuffer` (@ `node-fetch/index.d.ts`) -> **O(2^N) [Recursive]**
- `constructor` (@ `node-fetch/index.d.ts`) -> **O(2^N) [Recursive]**
- `listener` (@ `node-fetch/externals.d.ts`) -> **O(N^3)**
- `listener` (@ `node-fetch/externals.d.ts`) -> **O(N^3)**

### Highest Data Gravity (Database Complexity)
- `fetch` (@ `node-fetch/index.d.ts`) -> DB Complexity: **9**

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `node-fetch` | 4 | 16.3 | 6.03% | 40.04% |

## 10. TARGETED RISK VECTORS (Top 5 by Exposure)
### Highest Tech Debt (Fragile/Planned)
- `node-fetch/externals.d.ts` -> **100.0%** Exposure
- `node-fetch/index.d.ts` -> **60.1716%** Exposure
### Highest Design Slop (Dead & Duplicated Logic)
- `node-fetch/index.d.ts` -> **1** Orphaned Functions | **2** Duplicates
...
- `node-fetch/index.d.ts` -> **99.9792%** Exposure
- `node-fetch/externals.d.ts` -> **20.1232%** Exposure
...
### 1. `node-fetch/index.d.ts` (TYPESCRIPT) -> Cumulative Risk: **563.94**
- **Archetype:** `file_cluster_8` (Distance: 8.86 IQR)
- **Magnitude:** 10.65 | **LOC:** 240 | **CtrlFlow:** 42.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (99.9999%), Algorithmic Dos (99.9792%), Verification (80.0%)
- **Heaviest Functions:** `clone` (Impact: 20.2), `fetch` (Impact: 19.6), `arrayBuffer` (Impact: 14.9)

### 2. `node-fetch/externals.d.ts` (TYPESCRIPT) -> Cumulative Risk: **420.94**
- **Archetype:** `file_cluster_8` (Distance: 10.078 IQR)
- **Magnitude:** 2.97 | **LOC:** 33 | **CtrlFlow:** 37.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), Documentation (99.4066%), Stability (50.0%)
- **Heaviest Functions:** `listener` (Impact: 17.6), `listener` (Impact: 10.6)
...
- **Local Micro-Species:** `Cluster 5: Declarative Glue & Inert Types` (Drift: 3.785 IQR)
- **Top Global Matches:** file_cluster_8: 8.86, file_cluster_13: 9.473, file_cluster_16: 9.538
- **Magnitude:** 10.65 | **LOC:** 240 | **CtrlFlow:** 42.4% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(2^N) [Recursive] | **DB Complexity:** 9
- **Risk Profile:** Cognitive Load (13.5776%), Tech Debt (60.1716%)
**Top Internal Functions/Classes:**
  * `clone` (Impact: 20.2 | O(N^1))
  * `fetch` (Impact: 19.6 | O(2^N) | DB: 9)
  * `arrayBuffer` (Impact: 14.9 | O(2^N))
  * `constructor` (Impact: 14.4 | O(2^N))
  * `clone` (Impact: 14.1 | O(N^1))
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 42`, `structural_boundaries: 57`, `args: 34`, `func_start: 32`, `class_start: 12`
* *Risk/State:* `safety_bypasses: 2`, `duplicate_logic: 2`, `orphaned_logic: 1`
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` http, url, |, form-data, externals
...
**Top Internal Functions/Classes:**
  * `listener` (Impact: 17.6 | O(N^3))
  * `listener` (Impact: 10.6 | O(N^3))
**Structural Signatures (Net Mitigated Signals):**
...
- `node-fetch/externals.d.ts` (TYPESCRIPT) | Magnitude: 2.97 | Delta: **0.497 IQR** | Secondary Pull: `file_cluster_1`
  * Top Architectural Signatures: indent_spaces: 21, structural_boundaries: 10, safety_bypasses: 8, branch: 6
- `node-fetch/index.d.ts` (TYPESCRIPT) | Magnitude: 10.65 | Delta: **0.613 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 163, structural_boundaries: 57, branch: 42, args: 34
...
- `node-fetch/externals.d.ts` -> **Severity: 24851.65** (Blast Radius: 250.0 * Doc Risk: 99.4066%)
