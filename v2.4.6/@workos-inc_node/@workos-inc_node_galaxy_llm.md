# ARCHITECTURAL_BRIEF: @workos-inc_node
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@workos-inc_node` |
| **Timestamp** | `2026-08-03T21:11:19.890114+00:00` |
| **Scan Duration** | `0.13s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 2.0 | **LOC:** 100 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
