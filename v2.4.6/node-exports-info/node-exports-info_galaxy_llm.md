...
| **Timestamp** | `2026-08-03T21:12:48.273721+00:00` |
| **Scan Duration** | `0.14s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Error & Exception Exposure | 0.0 | 64.8 | 11.9 | 0.0 | 0.0 |
...
- `getCategory` (@ `package/getCategory.js`) -> DB Complexity: **4**
  * *Intent:* /** @type {import('./getCategory')} */
- `getConditionsForCategory` (@ `package/getConditionsForCategory.js`) -> DB Complexity: **3**
  * *Intent:* /** @type {import('./getConditionsForCategory')} */
- `getRange` (@ `package/getRange.js`) -> DB Complexity: **3**
  * *Intent:* /** @type {import('./getRange')} */
- `getCategoriesForRange` (@ `package/getCategoriesForRange.js`) -> DB Complexity: **2**
  * *Intent:* /** @type {import('./getCategoriesForRange')} */
- `getCategoryInfo` (@ `package/getCategoryInfo.js`) -> DB Complexity: **2**
  * *Intent:* /** @type {import('./getCategoryInfo')} */
- `isCategory` (@ `package/isCategory.js`) -> DB Complexity: **2**
  * *Intent:* /** @type {import('./isCategory')} */

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package` | 25 | 310.01 | 13.34% | 0.0% |
...
### 1. `package/getCategory.js` (JAVASCRIPT) -> Cumulative Risk: **383.42**
- **Archetype:** `file_cluster_13` (Distance: 13.178 IQR)
- **Magnitude:** 29.62 | **LOC:** 22 | **CtrlFlow:** 30.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (64.7941%), Stability (50.0%)
- **Heaviest Functions:** `getCategory` (Impact: 9.3)

### 2. `package/getCategoriesForRange.js` (JAVASCRIPT) -> Cumulative Risk: **349.02**
- **Archetype:** `file_cluster_13` (Distance: 12.919 IQR)
- **Magnitude:** 16.3 | **LOC:** 21 | **CtrlFlow:** 11.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Stability (50.0%), Cognitive Load (44.7051%)
- **Heaviest Functions:** `getCategoriesForRange` (Impact: 4.0)

### 3. `package/getConditionsForCategory.js` (JAVASCRIPT) -> Cumulative Risk: **329.65**
- **Archetype:** `file_cluster_13` (Distance: 13.301 IQR)
- **Magnitude:** 87.02 | **LOC:** 127 | **CtrlFlow:** 45.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Stability (50.0%), Cognitive Load (43.9351%)
- **Heaviest Functions:** `getConditionsForCategory` (Impact: 36.0)

### 4. `package/getRange.js` (JAVASCRIPT) -> Cumulative Risk: **314.55**
- **Archetype:** `file_cluster_13` (Distance: 13.671 IQR)
- **Magnitude:** 23.78 | **LOC:** 20 | **CtrlFlow:** 30.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (93.3333%), Stability (50.0%), Safety Score (45.4246%)
- **Heaviest Functions:** `getRange` (Impact: 7.5)

### 5. `package/getCategoryFlags.js` (JAVASCRIPT) -> Cumulative Risk: **292.29**
- **Archetype:** `file_cluster_8` (Distance: 9.819 IQR)
- **Magnitude:** 11.84 | **LOC:** 57 | **CtrlFlow:** 14.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (92.2864%), Stability (50.0%), Cognitive Load (20.8715%)
- **Heaviest Functions:** `getCategoryFlags` (Impact: 4.0)

### 6. `package/isCategory.js` (JAVASCRIPT) -> Cumulative Risk: **276.08**
- **Archetype:** `file_cluster_13` (Distance: 13.59 IQR)
- **Magnitude:** 16.92 | **LOC:** 16 | **CtrlFlow:** 28.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (73.3333%), Stability (50.0%), Safety Score (29.3445%)
- **Heaviest Functions:** `isCategory` (Impact: 5.7)

### 7. `package/getCategoryInfo.js` (JAVASCRIPT) -> Cumulative Risk: **262.37**
- **Archetype:** `file_cluster_13` (Distance: 13.229 IQR)
- **Magnitude:** 13.86 | **LOC:** 12 | **CtrlFlow:** 16.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (53.3333%), Stability (50.0%), Safety Score (37.7205%)
- **Heaviest Functions:** `getCategoryInfo` (Impact: 3.7)

### 8. `package/eslint.config.mjs` (JAVASCRIPT) -> Cumulative Risk: **238.92**
- **Archetype:** `file_cluster_8` (Distance: 8.077 IQR)
- **Magnitude:** 17.26 | **LOC:** 15 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (86.6667%), State Flux (68.9316%), Stability (50.0%), Safety Score (10.9984%)

### 9. `package/getRangePairs.js` (JAVASCRIPT) -> Cumulative Risk: **225.14**
- **Archetype:** `file_cluster_13` (Distance: 12.086 IQR)
- **Magnitude:** 6.02 | **LOC:** 11 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (99.9984%), Stability (50.0%), Spec Match (40.0%), Safety Score (15.5271%)
...
**Top Internal Functions/Classes:**
  * `getConditionsForCategory` (Impact: 36.0 | O(N^1) | DB: 3)
    * *Intent:* /** @type {import('./getConditionsForCategory')} */
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` isCategory, getConditionsForCategory, type, range
...
**Top Internal Functions/Classes:**
  * `getCategory` (Impact: 9.3 | O(N^1) | DB: 4)
    * *Intent:* /** @type {import('./getCategory')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` semver, getCategory, object.entries, ranges, range
...
**Top Internal Functions/Classes:**
  * `getRange` (Impact: 7.5 | O(N^1) | DB: 3)
    * *Intent:* /** @type {import('./getRange')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 24.622
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` ranges, object.entries, getRange, range
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Risk Profile:** Cognitive Load (5.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `isCategory` (Impact: 5.7 | O(N^1) | DB: 2)
    * *Intent:* /** @type {import('./isCategory')} */
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `getCategoriesForRange` (Impact: 4.0 | O(N^1) | DB: 2)
    * *Intent:* /** @type {import('./getCategoriesForRange')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 24.622
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` semver, getCategoriesForRange, object.entries, ranges, array.prototype.flatmap, types
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
- **Risk Profile:** Cognitive Load (5.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getCategoryInfo` (Impact: 3.7 | O(N^1) | DB: 2)
    * *Intent:* /** @type {import('./getCategoryInfo')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 24.622
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 2):` getCategoryInfo, getConditionsForCategory, getCategoryFlags
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `getCategoryFlags` (Impact: 4.0 | O(N^1))
    * *Intent:* /** @type {import('./getCategoryFlags')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` types, getCategoryFlags, isCategory, range
  * `Imported By (In-Degree: 2):` (Excluded from Brief to save tokens)
...
- **Risk Profile:** Cognitive Load (5.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getRangePairs` (Impact: 1.9 | O(N^1))
    * *Intent:* /** @type {import('./getRangePairs')} */
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` ranges, getRangePairs, object.entries
  * `Imported By (In-Degree: 1):` (Excluded from Brief to save tokens)
...
- `package/isCategory.js` -> **Severity: 3.26** (Embedded: 0.1111 * Error Risk: 29.3445%)
- `package/getRangePairs.js` -> **Severity: 1.47** (Embedded: 0.0947 * Error Risk: 15.5271%)
- `package/getCategoryFlags.js` -> **Severity: 0.787** (Embedded: 0.0833 * Error Risk: 9.4435%)
- `package/getConditionsForCategory.js` -> **Severity: 0.7** (Embedded: 0.0417 * Error Risk: 16.7889%)
