...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@node-red_util` |
| **Timestamp** | `2026-08-03T21:09:26.592339+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 3.6 | 3.6 | 3.6 | 3.6 | 3.6 |
...
| Algorithmic DoS Exposure | 2.2 | 2.2 | 2.2 | 2.2 | 2.2 |
...
- `init` (@ `package/index.js`) -> Impact: **4.4** | LOC: 4
...
- `init` (@ `package/index.js`) -> **O(2^N) [Recursive]**
  * *Intent:* /*! * Copyright JS Foundation and other contributors, http://js.foundation * * Licensed under the Apache License, Version 2.0 (the "License"); * you m...

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `package` | 3 | 7.76 | 1.2% | 0.0% |
...
- `package/index.js` -> **2.2189%** Exposure
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **173.34**
- **Archetype:** `file_cluster_8` (Distance: 9.277 IQR)
- **Magnitude:** 5.76 | **LOC:** 82 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Stability (50.0%), Documentation (11.9203%), Cognitive Load (3.6027%)
- **Heaviest Functions:** `init` (Impact: 4.4)

## 12. SCANNED ARTIFACTS HITLIST (Top 25 Heaviest Files)
> *Note: 'Magnitude' represents the file's total Structural Magnitude and impact within the system. It is independent of its Risk Profile. High magnitude implies high structural importance and centralization.*

### `package/index.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 98.84%)
- **Global Archetype:** `file_cluster_8` (Drift: 9.277 IQR)
- **Local Micro-Species:** `Cluster 4: Heavily Documented Core Functions` (Drift: 6.329 IQR)
- **Top Global Matches:** file_cluster_8: 9.277, file_cluster_13: 9.297, file_cluster_7: 9.571
- **Magnitude:** 5.76 | **LOC:** 82 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(2^N) [Recursive] | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (3.6027%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `init` (Impact: 4.4 | O(2^N))
...
* *Defense:* `doc: 9`, `immutability_locks: 6`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 333.333
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` log, exec, hooks, i18n, util, events
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 5.76 | Delta: **0.02 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 10, doc: 9, import: 6, immutability_locks: 6
