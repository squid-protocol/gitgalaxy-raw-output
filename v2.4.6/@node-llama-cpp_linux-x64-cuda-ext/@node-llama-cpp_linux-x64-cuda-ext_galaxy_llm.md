# ARCHITECTURAL_BRIEF: @node-llama-cpp_linux-x64-cuda-ext
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@node-llama-cpp_linux-x64-cuda-ext` |
| **Timestamp** | `2026-08-03T21:09:06.932433+00:00` |
| **Scan Duration** | `0.13s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- `.so`: 1x Excluded (File size exceeds absolute 250MB safety ceiling)
