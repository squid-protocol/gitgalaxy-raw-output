...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/node-fingerprint` |
| **Timestamp** | `2026-08-03T21:12:52.195265+00:00` |
| **Scan Duration** | `0.1s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| API Exposure | 4.9 | 4.9 | 4.9 | 4.9 | 4.9 |
...
1. **`package/index.js`** -> AI Confidence: **98.82%**
...
### 1. `package/index.js` (JAVASCRIPT) -> Cumulative Risk: **136.04**
- **Archetype:** `file_cluster_8` (Distance: 7.313 IQR)
- **Magnitude:** 46.2 | **LOC:** 16 | **CtrlFlow:** 20.0% | **Authorship Centralization:** 0.0%
...
### `package/index.js` (JAVASCRIPT | Tier 2 | 🚨 AI THREAT: 98.82%)
- **Global Archetype:** `file_cluster_8` (Drift: 7.313 IQR)
- **Local Micro-Species:** `Cluster 3: Pure View Layer Components (UI)` (Drift: 6.353 IQR)
- **Top Global Matches:** file_cluster_8: 7.313, file_cluster_13: 7.79, file_cluster_17: 8.175
- **Magnitude:** 46.2 | **LOC:** 16 | **CtrlFlow:** 20.0% | **Authorship Centralization:** 0.0%
...
- `package/index.js` (JAVASCRIPT) | Magnitude: 46.2 | Delta: **0.477 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: immutability_locks: 5, structural_boundaries: 4, args: 3, indent_spaces: 3
...
- `package/index.js` -> **Severity: 2648.964** (Blast Radius: 333.333 * Doc Risk: 7.9469%)
