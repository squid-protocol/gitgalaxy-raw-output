# ARCHITECTURAL_BRIEF: @univerjs_rpc-node
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@univerjs_rpc-node` |
| **Timestamp** | `2026-08-03T21:11:15.709844+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 1.36 | **LOC:** 68 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
