# ARCHITECTURAL_BRIEF: @rollup_wasm-node
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@rollup_wasm-node` |
| **Timestamp** | `2026-08-03T21:09:56.274692+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
### 1. `package/LICENSE.md` (MARKDOWN) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 13.6 | **LOC:** 680 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None

### 2. `package/package.json` (PLAINTEXT) -> Cumulative Risk: **0.0**
- **Archetype:** `Static: Literature & Documentation` (Distance: N/A IQR)
- **Magnitude:** 3.56 | **LOC:** 178 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** None
