# ARCHITECTURAL_BRIEF: @tsconfig_node16
...
| **Target Path** | `/srv/storage_16tb/projects/gitgalaxy/data/npm_top_200/@tsconfig_node16` |
| **Timestamp** | `2026-08-03T21:10:41.808571+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 10.3 | 10.3 | 10.3 | 10.3 | 10.3 |
...
3. **tsconfig.json** (`package/tsconfig.json`) — 0 inbound connections
...
3. **tsconfig.json** (`package/tsconfig.json`) — 0 outbound dependencies
...
### 1. `package/tsconfig.json` (JSON) -> Cumulative Risk: **153.99**
- **Archetype:** `file_cluster_8` (Distance: 4.447 IQR)
- **Magnitude:** 15.26 | **LOC:** 16 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (86.6667%), Stability (50.0%), Documentation (10.3309%), Cognitive Load (5.0%)
...
- `package/tsconfig.json` -> **Severity: 3443.63** (Blast Radius: 333.333 * Doc Risk: 10.3309%)
