...
| **Timestamp** | `2026-08-03T21:10:30.129557+00:00` |
| **Scan Duration** | `0.13s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
| Documentation Exposure | 11.9 | 99.9 | 49.5 | 43.1 | 11.9 |
...
### 1. `package/src/NodeType.ts` (TYPESCRIPT) -> Cumulative Risk: **268.98**
- **Archetype:** `file_cluster_16` (Distance: 8.113 IQR)
- **Magnitude:** 6.32 | **LOC:** 266 | **CtrlFlow:** 7.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (99.8964%), Stability (50.0%), Api Exposure (13.7049%)

### 2. `package/src/index.ts` (TYPESCRIPT) -> Cumulative Risk: **238.74**
- **Archetype:** `file_cluster_8` (Distance: 5.641 IQR)
- **Magnitude:** 1.87 | **LOC:** 40 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (74.2372%), Stability (50.0%), Api Exposure (7.4661%)
...
- `package/src/NodeType.ts` -> **Severity: 16649.433** (Blast Radius: 166.667 * Doc Risk: 99.8964%)
- `package/src/index.ts` -> **Severity: 12372.891** (Blast Radius: 166.667 * Doc Risk: 74.2372%)
