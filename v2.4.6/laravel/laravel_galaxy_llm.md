...
| **Timestamp** | `2026-08-03T21:04:47.138186+00:00` |
| **Scan Duration** | `0.23s` |
| **Git Branch** | `13.x` |
...
| Testing Exposure | 0.0 | 2.5 | 1.8 | 2.3 | 2.3 |
...
| Documentation Exposure | 0.0 | 100.0 | 33.6 | 19.1 | 17.9 |
| Algorithmic DoS Exposure | 0.0 | 48.9 | 6.5 | 0.0 | 0.0 |
...
- `up` (@ `database/migrations/0001_01_01_000002_create_jobs_table.php`) -> Impact: **5.2** | LOC: 35
  * *Intent:* /**
- `up` (@ `database/migrations/0001_01_01_000000_create_users_table.php`) -> Impact: **4.8** | LOC: 27
  * *Intent:* /**
- `up` (@ `database/migrations/0001_01_01_000001_create_cache_table.php`) -> Impact: **4.2** | LOC: 14
  * *Intent:* /**
- `run` (@ `database/seeders/DatabaseSeeder.php`) -> Impact: **3.9** | LOC: 9
  * *Intent:* /** * Seed the application's database. */
- `casts` (@ `app/Models/User.php`) -> Impact: **3.8** | LOC: 7
  * *Intent:* /**
- `unverified` (@ `database/factories/UserFactory.php`) -> Impact: **3.8** | LOC: 6
  * *Intent:* /** * The current password being used by the factory.
- `down` (@ `database/migrations/0001_01_01_000000_create_users_table.php`) -> Impact: **2.9** | LOC: 6
- `down` (@ `database/migrations/0001_01_01_000002_create_jobs_table.php`) -> Impact: **2.9** | LOC: 6
- `down` (@ `database/migrations/0001_01_01_000001_create_cache_table.php`) -> Impact: **2.8** | LOC: 5
- `tailwindcss` (@ `vite.config.js`) -> Impact: **2.4** | LOC: 7

## 8.5 ALGORITHMIC & DATABASE BOTTLENECKS
> Highlights the most computationally expensive and database-heavy functions across the repository.

### Highest Time Complexity (Big-O)
- `casts` (@ `app/Models/User.php`) -> **O(N^3)**
  * *Intent:* /**
- `unverified` (@ `database/factories/UserFactory.php`) -> **O(N^3)**
  * *Intent:* /** * The current password being used by the factory.
- `up` (@ `database/migrations/0001_01_01_000000_create_users_table.php`) -> **O(N^3)**
  * *Intent:* /**
- `up` (@ `database/migrations/0001_01_01_000001_create_cache_table.php`) -> **O(N^3)**
  * *Intent:* /**
- `up` (@ `database/migrations/0001_01_01_000002_create_jobs_table.php`) -> **O(N^3)**
  * *Intent:* /**
- `run` (@ `database/seeders/DatabaseSeeder.php`) -> **O(N^3)**
  * *Intent:* /** * Seed the application's database. */
- `tailwindcss` (@ `vite.config.js`) -> **O(N^3)**
- `laravel` (@ `vite.config.js`) -> **O(N^3)**

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Cog Load | Avg Debt |
|---|---|---|---|---|
| `config` | 10 | 1614.4 | 24.39% | 0.0% |
| `__monolith__` | 7 | 55.4 | 2.08% | 0.0% |
| `database/migrations` | 3 | 30.98 | 3.69% | 82.06% |
...
- `database/migrations/0001_01_01_000001_create_cache_table.php` -> **0.0014%** Exposure
- `database/migrations/0001_01_01_000000_create_users_table.php` -> **0.0012%** Exposure
- `database/migrations/0001_01_01_000002_create_jobs_table.php` -> **0.0011%** Exposure
### Algorithmic DoS Exposure
- `database/migrations/0001_01_01_000001_create_cache_table.php` -> **48.9287%** Exposure
- `database/migrations/0001_01_01_000000_create_users_table.php` -> **41.3124%** Exposure
- `database/migrations/0001_01_01_000002_create_jobs_table.php` -> **37.2757%** Exposure
- `database/factories/UserFactory.php` -> **22.3222%** Exposure
- `vite.config.js` -> **21.9863%** Exposure
...
### 1. `database/migrations/0001_01_01_000001_create_cache_table.php` (PHP) -> Cumulative Risk: **392.52**
- **Archetype:** `file_cluster_8` (Distance: 8.185 IQR)
- **Magnitude:** 9.5 | **LOC:** 36 | **CtrlFlow:** 8.3% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (97.0688%), Algorithmic Dos (48.9287%)
- **Heaviest Functions:** `up` (Impact: 4.2), `down` (Impact: 2.8)

### 2. `config/session.php` (PHP) -> Cumulative Risk: **389.49**
...
### 3. `config/cache.php` (PHP) -> Cumulative Risk: **383.44**
...
### 4. `config/mail.php` (PHP) -> Cumulative Risk: **382.09**
- **Archetype:** `file_cluster_8` (Distance: 15.897 IQR)
- **Magnitude:** 163.68 | **LOC:** 119 | **CtrlFlow:** 71.4% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.9999%), Cognitive Load (48.649%)

### 5. `config/logging.php` (PHP) -> Cumulative Risk: **378.64**
- **Archetype:** `file_cluster_13` (Distance: 14.637 IQR)
- **Magnitude:** 164.24 | **LOC:** 133 | **CtrlFlow:** 30.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.9703%), Cognitive Load (40.5967%)

### 6. `config/app.php` (PHP) -> Cumulative Risk: **356.49**
- **Archetype:** `file_cluster_8` (Distance: 14.222 IQR)
- **Magnitude:** 89.56 | **LOC:** 127 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.883%), Cognitive Load (42.3873%)

### 7. `database/migrations/0001_01_01_000002_create_jobs_table.php` (PHP) -> Cumulative Risk: **329.33**
- **Archetype:** `file_cluster_8` (Distance: 7.359 IQR)
- **Magnitude:** 11.02 | **LOC:** 58 | **CtrlFlow:** 7.7% | **Authorship Centralization:** 75.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (68.1542%), Documentation (64.3992%), Churn (47.63%)
- **Heaviest Functions:** `up` (Impact: 5.2), `down` (Impact: 2.9)

### 8. `database/seeders/DatabaseSeeder.php` (PHP) -> Cumulative Risk: **296.98**
- **Archetype:** `file_cluster_8` (Distance: 7.366 IQR)
- **Magnitude:** 5.3 | **LOC:** 26 | **CtrlFlow:** 11.1% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (55.0%), Algorithmic Dos (21.0232%)
- **Heaviest Functions:** `run` (Impact: 3.9)

### 9. `database/migrations/0001_01_01_000000_create_users_table.php` (PHP) -> Cumulative Risk: **290.47**
- **Archetype:** `file_cluster_8` (Distance: 7.532 IQR)
- **Magnitude:** 10.46 | **LOC:** 50 | **CtrlFlow:** 7.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (80.9593%), Documentation (56.6511%), Algorithmic Dos (41.3124%)
- **Heaviest Functions:** `up` (Impact: 4.8), `down` (Impact: 2.9)

### 10. `app/Models/User.php` (PHP) -> Cumulative Risk: **273.94**
- **Archetype:** `file_cluster_13` (Distance: 13.623 IQR)
- **Magnitude:** 4.22 | **LOC:** 33 | **CtrlFlow:** 7.1% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.0462%), Churn (28.78%), Dead Code (23.1475%)
- **Heaviest Functions:** `casts` (Impact: 3.8)
...
- **Top Global Matches:** file_cluster_13: 14.637, file_cluster_8: 14.646, file_cluster_11: 15.131
- **Magnitude:** 164.24 | **LOC:** 133 | **CtrlFlow:** 30.0% | **Authorship Centralization:** 100.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (40.5967%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 3`, `structural_boundaries: 7`
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` 'processors' => [PsrLogMessageProcessor::class], ', 'handler_with' => [
                'host' => env('PAPERTRAIL_URL'), 'port' => env('PAPERTRAIL_PORT'), ':boom:'), 'channels' => explode(', 'critical'), "slack"...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` 'log', 'log' => [
            'transport' => 'log', 2525), "sendmail", "log", 'name' => env('MAIL_FROM_NAME', 'local_domain' => env('MAIL_EHLO_DOMAIN', 'path' => env('MAIL_SENDMAIL_PATH'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` Illuminate\Foundation\Application, $maintenance, app.php', Illuminate\Http\Request, autoload.php'
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` app.php', Illuminate\Foundation\Application, autoload.php', Symfony\Component\Console\Input\ArgvInput
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` Illuminate\Foundation\Configuration\Exceptions, Illuminate\Foundation\Configuration\Middleware, Illuminate\Foundation\Application
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` a great default configuration has been defined for you
    ...
    | confirmation screen. By default, 

    'providers' => [
        'users' => [
            'driver' => 'eloquent', 

    'password_timeout' => env('AUTH_PASSWORD_TIMEOUT', you may define every authentication guard for your application.
    | Of course, 'expire' => 60,      'table' => 'users'...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 17.386
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` Illuminate\Support\Facades\Artisan, Illuminate\Foundation\Inspiring
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
### `bootstrap/providers.php` (PHP | Tier 2 | 🚨 AI THREAT: 98.89%)
- **Global Archetype:** `file_cluster_8` (Drift: 5.56 IQR)
- **Top Global Matches:** file_cluster_8: 5.56, file_cluster_13: 6.22, file_cluster_7: 7.077
- **Magnitude:** 12.6 | **LOC:** 8 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 100.0%
- **Algorithmic:** O(N) | **DB Complexity:** 0
- **Risk Profile:** Cognitive Load (5.0%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `register` (Impact: 1.9 | O(N^1))
    * *Intent:* /**
  * `boot` (Impact: 1.9 | O(N^1))
**Structural Signatures (Net Mitigated Signals):**
...
- `config/logging.php` (PHP) | Magnitude: 164.24 | Delta: **0.009 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: state_mutation: 148, indent_spaces: 55, bitwise_ops: 11, structural_boundaries: 7
- `database/factories/UserFactory.php` (PHP) | Magnitude: 5.12 | Delta: **0.031 IQR** | Secondary Pull: `file_cluster_8`
  * Top Architectural Signatures: structural_boundaries: 9, indent_spaces: 7, import: 4, doc: 3
- `app/Models/User.php` (PHP) | Magnitude: 4.22 | Delta: **0.277 IQR** | Secondary Pull: `file_cluster_0`
...
- `database/seeders/DatabaseSeeder.php` (PHP) | Magnitude: 5.3 | Delta: **0.173 IQR** | Secondary Pull: `file_cluster_13`
  * Top Architectural Signatures: indent_spaces: 12, structural_boundaries: 8, import: 4, branch: 1
- `vite.config.js` (JAVASCRIPT) | Magnitude: 5.94 | Delta: **0.174 IQR** | Secondary Pull: `file_cluster_13`
...
- `app/Providers/AppServiceProvider.php` -> **Severity: 2550.311** (Blast Radius: 32.165 * Doc Risk: 79.2884%)
- `database/migrations/0001_01_01_000001_create_cache_table.php` -> **Severity: 1738.6** (Blast Radius: 17.386 * Doc Risk: 100.0%)
- `database/seeders/DatabaseSeeder.php` -> **Severity: 1738.6** (Blast Radius: 17.386 * Doc Risk: 100.0%)
