...
| **Timestamp** | `2026-08-03T21:13:00.037311+00:00` |
| **Scan Duration** | `0.11s` |
| **Git Branch** | `N/A` |
| **Git Commit** | `N/A` |
| **Git Remote** | `N/A` |
...
|---|---|---|---|---|---|
| Cognitive Load Exposure | 5.0 | 73.1 | 27.7 | 5.0 | 5.0 |
| Error & Exception Exposure | 0.0 | 80.0 | 31.3 | 13.9 | 13.9 |
...
- `build` (@ `package/bin.js`) -> DB Complexity: **6**
...
|---|---|---|---|---|
| `package` | 5 | 95.7 | 16.62% | 20.0% |

## 10. TARGETED RISK VECTORS (Top 5 by Exposure)
### Highest Tech Debt (Fragile/Planned)
- `package/bin.js` -> **99.9978%** Exposure
...
### 1. `package/bin.js` (JAVASCRIPT) -> Cumulative Risk: **451.63**
- **Archetype:** `file_cluster_13` (Distance: 12.888 IQR)
- **Magnitude:** 67.36 | **LOC:** 83 | **CtrlFlow:** 57.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9978%), State Flux (99.9958%), Cognitive Load (73.1059%)
...
- **Local Micro-Species:** `Cluster 2: Procedural Core & Safety Wrappers` (Drift: 5.396 IQR)
- **Top Global Matches:** file_cluster_13: 12.888, file_cluster_11: 12.941, file_cluster_8: 13.178
- **Magnitude:** 67.36 | **LOC:** 83 | **CtrlFlow:** 57.6% | **Authorship Centralization:** 0.0%
- **Algorithmic:** O(2^N) [Recursive] | **DB Complexity:** 6
- **Risk Profile:** Cognitive Load (73.1059%), Tech Debt (99.9978%)
**Top Internal Functions/Classes:**
  * `build` (Impact: 15.0 | O(N^1) | DB: 6)
  ...
  * `preinstall` (Impact: 4.3 | O(2^N))
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 19`, `structural_boundaries: 14`, `args: 9`, `func_start: 10`
* *Risk/State:* `safety_bypasses: 1`, `high_risk_execution: 1`, `state_mutation: 21`, `planned_debt: 1`, `duplicate_logic: 2`
* *Architecture:* `io: 4`, `import: 4`
* *Defense:* `safety: 11`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 200.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` path, child_process, os, package.json
...
- `package/bin.js` (JAVASCRIPT) | Magnitude: 67.36 | Delta: **0.053 IQR** | Secondary Pull: `file_cluster_11`
