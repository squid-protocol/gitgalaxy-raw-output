...
## 1. EXECUTIVE SUMMARY
- **Scope:** 49 analyzed artifact(s), 6562 LOC.
- **Load-bearing artifact:** `CODE_OF_CONDUCT.md` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `README.md` -- pulls in 3 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `dataStructures/lruCache.zig` at magnitude 899.08 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.008`
> **Composition Archetype:** `Small Flat Repo` (z +1.01; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 24%, Large Core Modules (3) 14%, Compute Cores Files 10%, Data / Markup / Trivial 10%, State Mutators Files 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 69.3 | 100.0 | 100.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (68.3%), Guard Balance (formerly Safety Score) (54.4%)
- **Documentation Coverage:** 81.1966% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.5%), Concurrency Surface (formerly Concurrency) (69.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (26.1%), Guard Balance (formerly Safety Score) (23.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `remove` **(Many-Argument Workhorses)** (Impact: 25.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (31.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (72.7%), Complexity Load (formerly Cognitive Load) (21.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (15.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (13.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.1%), Guard Balance (formerly Safety Score) (63.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `pushBack` **(Defensive Guards)** (Impact: 5.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (31.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `commitUpTo` **(Type Conversions)** (Impact: 5.9)
  ...
  * `init` **(Compute Cores)** (Impact: 5.5)
    * *Intent:* /// Initialize VSR replica
  * `prepare` **(Type Conversions)** (Impact: 5.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (90.7%), Guard Balance (formerly Safety Score) (29.3%), Debt Markers (formerly Tech Debt) (14.6%), Connectivity (formerly Api Exposure) (9.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.1%), Guard Balance (formerly Safety Score) (55.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `insert` **(Defensive Guards)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.9%), Guard Balance (formerly Safety Score) (28.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (11.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.7%), Guard Balance (formerly Safety Score) (29.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (11.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `commit` **(Compute Cores)** (Impact: 3.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (11.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `init` **(I/O & Config Routines)** (Impact: 1.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.1%), Guard Balance (formerly Safety Score) (48.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (11.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `tick` **(Many-Argument Workhorses)** (Impact: 11.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.6%), Guard Balance (formerly Safety Score) (59.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (11.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.9%), Debt Markers (formerly Tech Debt) (72.4%), Guard Balance (formerly Safety Score) (37.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.1%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.9%), Guard Balance (formerly Safety Score) (15.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `peek` **(Parameter Forwarders)** (Impact: 3.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (47.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.9%), Guard Balance (formerly Safety Score) (8.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (36.5%), Connectivity (formerly Api Exposure) (8.0%), Guard Balance (formerly Safety Score) (7.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Guard Balance (formerly Safety Score) (55.1%), Complexity Load (formerly Cognitive Load) (37.5%), Connectivity (formerly Api Exposure) (2.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.0%), Guard Balance (formerly Safety Score) (30.2%), Complexity Load (formerly Cognitive Load) (20.5%), Connectivity (formerly Api Exposure) (5.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `countingSort` **(Type Conversions)** (Impact: 10.8)
  * `sort` **(Defensive Guards)** (Impact: 7.0)
  * `max` **(Compute Cores)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.4%), Guard Balance (formerly Safety Score) (38.2%), Complexity Load (formerly Cognitive Load) (22.1%), Connectivity (formerly Api Exposure) (3.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `merge` **(Many-Argument Workhorses)** (Impact: 10.5)
  * `splitMerge` **(Parameter Forwarders)** (Impact: 4.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (90.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.9%), Guard Balance (formerly Safety Score) (22.1%), Complexity Load (formerly Cognitive Load) (17.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (78.1%), Complexity Load (formerly Cognitive Load) (38.7%), Connectivity (formerly Api Exposure) (3.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (47.9%), Complexity Load (formerly Cognitive Load) (37.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (15.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 20.06; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (54.3%), Complexity Load (formerly Cognitive Load) (39.2%), Connectivity (formerly Api Exposure) (3.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
