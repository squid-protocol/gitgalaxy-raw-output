...
- **Heaviest artifact:** `package/src/index.ts` at magnitude 14.12 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 6.4 | 6.4 | 6.4 | 6.4 | 6.4 |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 1 | 1 | 1 | `package/src/index.ts` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- **Magnitude:** 14.12 | **LOC:** 13 | **CtrlFlow:** 66.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (6.4%), Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.3%)
