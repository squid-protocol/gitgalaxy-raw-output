...
## 1. EXECUTIVE SUMMARY
- **Scope:** 138 analyzed artifact(s), 3511 LOC.
- **Load-bearing artifact:** `ZigExamples/calling-c/user.h` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `ZigExamples/http_server/src/main.zig` -- pulls in 4 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `ZigExamples/calling-c/c.zig` at magnitude 1171.9 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.567`
> **Composition Archetype:** `Small Flat Repo` (z +1.57; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 47%, Data / Markup / Trivial 30%, State Mutators Files 13%, Type Conversions Files 2%, Declarative / Non-Code 1%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 82.8 | 100.0 | 100.0 |
...
- `decode` **(Defensive Guards)** (@ `ZigExamples/base64/base64_basic.zig`) -> Impact: **15.6** | LOC: 31
- `encode` **(Many-Argument Workhorses)** (@ `ZigExamples/base64/base64_basic.zig`) -> Impact: **14.0** | LOC: 40
- `main` **(Defensive Guards)** (@ `ZigExamples/vectors/src/main.zig`) -> Impact: **13.6** | LOC: 45
- `main` **(Defensive Guards)** (@ `ZigExamples/vectors/src/main2.zig`) -> Impact: **11.6** | LOC: 34
- `testOne` **(Defensive Guards)** (@ `ZigExamples/hello_world/src/main.zig`) -> Impact: **10.0** | LOC: 26
- `save_png` **(Defensive Guards)** (@ `ZigExamples/image_filter/src/test.zig`) -> Impact: **9.6** | LOC: 19
- `read_png` **(Defensive Guards)** (@ `ZigExamples/image_filter/src/image_filter.zig`) -> Impact: **8.3** | LOC: 27
- `_calc_decode_length` **(Defensive Guards)** (@ `ZigExamples/base64/base64_basic.zig`) -> Impact: **8.0** | LOC: 19
- `work` **(Defensive Guards)** (@ `ZigExamples/threads/cancel_thread.zig`) -> Impact: **7.8** | LOC: 14
- `_char_index` **(Compute Cores)** (@ `ZigExamples/base64/base64_basic.zig`) -> Impact: **7.7** | LOC: 15
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 12.928; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.0%), Debt Markers (formerly Tech Debt) (9.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `renameat` **(State Mutators)** (Impact: 2.3)
  * `setvbuf` **(State Mutators)** (Impact: 2.3)
  * `snprintf` **(State Mutators)** (Impact: 2.3)
  * `vsnprintf` **(State Mutators)** (Impact: 2.3)
  * `__getdelim` **(State Mutators)** (Impact: 2.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (64.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decode` **(Defensive Guards)** (Impact: 15.6)
  * `encode` **(Many-Argument Workhorses)** (Impact: 14.0)
  * `_calc_decode_length` **(Defensive Guards)** (Impact: 8.0)
  * `_char_index` **(Compute Cores)** (Impact: 7.7)
  * `_calc_encode_length` **(Defensive Guards)** (Impact: 3.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.7%), Mutation Surface (formerly State Flux) (59.3%), Debt Markers (formerly Tech Debt) (16.4%), Dead Code Surface (formerly Dead Code) (11.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `read_png` **(Defensive Guards)** (Impact: 8.3)
  * `save_png` **(Type Conversions)** (Impact: 7.3)
  * `_read_data_to_buffer` **(Parameter Forwarders)** (Impact: 3.8)
  * `get_image_header` **(Compute Cores)** (Impact: 3.6)
  * `apply_image_filter` **(Compute Cores)** (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (82.0%), Guard Balance (formerly Safety Score) (74.6%), Complexity Load (formerly Cognitive Load) (65.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Defensive Guards)** (Impact: 13.6)
  * `print_matrix` **(Defensive Guards)** (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.8%), Debt Markers (formerly Tech Debt) (78.2%), Guard Balance (formerly Safety Score) (68.8%), Complexity Load (formerly Cognitive Load) (18.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `save_png` **(Defensive Guards)** (Impact: 9.6)
  * `main` **(Defensive Guards)** (Impact: 5.1)
  * `apply_image_filter` **(Defensive Guards)** (Impact: 4.0)
  * `read_data_to_buffer` **(Parameter Forwarders)** (Impact: 3.8)
  * `get_image_header` **(Parameter Forwarders)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Guard Balance (formerly Safety Score) (44.3%), Debt Markers (formerly Tech Debt) (40.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Stack` **(Defensive Guards)** (Impact: 6.4)
  * `push` **(Defensive Guards)** (Impact: 4.1)
  * `pop` **(Compute Cores)** (Impact: 3.1)
  * `init` **(Defensive Guards)** (Impact: 2.2)
  * `main` **(Defensive Guards)** (Impact: 2.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (76.9%), Complexity Load (formerly Cognitive Load) (61.8%), Debt Markers (formerly Tech Debt) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Defensive Guards)** (Impact: 11.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (44.3%), Guard Balance (formerly Safety Score) (44.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `push` **(Defensive Guards)** (Impact: 4.1)
  * `pop` **(Compute Cores)** (Impact: 3.1)
  ...
  * `deinit` **(State Mutators)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 4 instances
* *Amplified Cascading Flux:* 2 instances
* *Memory Alloc (weighted view):* 1
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 8.968; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (50.7%), Mutation Surface (formerly State Flux) (35.2%), Guard Balance (formerly Safety Score) (27.6%), Complexity Load (formerly Cognitive Load) (7.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `read_request` **(Defensive Guards)** (Impact: 4.5)
  * `parse_request` **(Defensive Guards)** (Impact: 3.3)
  * `is_supported` **(Defensive Guards)** (Impact: 3.2)
  * `read_next_line` **(Defensive Guards)** (Impact: 2.4)
  * `init` **(Parameter Forwarders)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (75.3%), Complexity Load (formerly Cognitive Load) (19.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Debt Markers (formerly Tech Debt) (50.0%), Mutation Surface (formerly State Flux) (50.0%), Guard Balance (formerly Safety Score) (35.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `reader` **(Defensive Guards)** (Impact: 6.5)
  * `writer` **(Defensive Guards)** (Impact: 5.6)
  * `main` **(Defensive Guards)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (50.0%), Mutation Surface (formerly State Flux) (50.0%), Concurrency Surface (formerly Concurrency) (45.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `work` **(Defensive Guards)** (Impact: 7.8)
  * `do_more_work` **(Defensive Guards)** (Impact: 1.6)
  * `main` **(Defensive Guards)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 6.988; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (48.8%), Guard Balance (formerly Safety Score) (22.0%), Complexity Load (formerly Cognitive Load) (6.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `testOne` **(Defensive Guards)** (Impact: 10.0)
  * `main` **(Defensive Guards)** (Impact: 4.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Test Surface (formerly Verification) (2.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Magnitude:** 15.3 | **LOC:** 15 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Test Surface (formerly Verification) (2.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (84.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (50.0%), Mutation Surface (formerly State Flux) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `increment` **(Defensive Guards)** (Impact: 2.2)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 18.869; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (50.0%), Mutation Surface (formerly State Flux) (50.0%), Guard Balance (formerly Safety Score) (43.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `increment` **(Defensive Guards)** (Impact: 3.8)
  * `main` **(Defensive Guards)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.1%), Guard Balance (formerly Safety Score) (72.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Debt Markers (formerly Tech Debt) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Defensive Guards)** (Impact: 3.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 6.988; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Guard Balance (formerly Safety Score) (60.6%), Debt Markers (formerly Tech Debt) (50.0%), Mutation Surface (formerly State Flux) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `distance` **(Parameter Forwarders)** (Impact: 2.0)
  * `main` **(I/O & Config Routines)** (Impact: 1.8)
  * `double` **(State Mutators)** (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
