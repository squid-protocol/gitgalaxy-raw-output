...
## 1. EXECUTIVE SUMMARY
- **Scope:** 21 analyzed artifact(s), 1377 LOC.
- **Load-bearing artifact:** `deprecated-1.3.1/deprecated/classic.py` -- 5 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `deprecated-1.3.1/deprecated/classic.py` -- pulls in 8 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `deprecated-1.3.1/tests/test_sphinx.py` at magnitude 178.74 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 24%, Parameter Forwarders Files 24%, Type Conversions Files 14%, Compute Cores Files 5%, Declarative / Non-Code 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 59.9 | 85.7 | 100.0 |
...
- `area` **(Stateful Encapsulated Methods)** (@ `deprecated-1.3.1/tests/deprecated_params/test_demo_area.py`) -> Impact: **9.4** | LOC: 15
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (38.3%), Complexity Load (formerly Cognitive Load) (16.3%), Connectivity (formerly Api Exposure) (11.9%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 231.084; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (50.6%)
- **Documentation Coverage:** 23.8095% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (38.7%), Complexity Load (formerly Cognitive Load) (16.3%), Connectivity (formerly Api Exposure) (13.0%)
...
**Top Internal Functions/Classes:**
  * `test_classic_deprecated_class_method__warns` **(Defensive Guards)** (Impact: 7.7)
    * *Intent:* # noinspection PyShadowingNames
  * `classic_deprecated_static_method` **(Annotated & Test Methods)** (Impact: 5.2)
  * `classic_deprecated_class_method` **(Annotated & Test Methods)** (Impact: 5.2)
  * `classic_deprecated_method` **(Annotated & Test Methods)** (Impact: 5.1)
  * `classic_deprecated_function` **(Annotated & Test Methods)** (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **3**; blast radius 143.787; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Connectivity (formerly Api Exposure) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (43.5%), Complexity Load (formerly Cognitive Load) (42.6%), Connectivity (formerly Api Exposure) (10.8%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__call__` **(Parameter Forwarders)** (Impact: 4.2)
  * `test_with_singleton_metaclass` **(Annotated & Test Methods)** (Impact: 3.4)
  * `with_metaclass` **(Parameter Forwarders)** (Impact: 2.5)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **5**; blast radius 132.147; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.0%), Connectivity (formerly Api Exposure) (64.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `populate_messages` **(Defensive Guards)** (Impact: 10.4)
  * `check_params` **(Compute Cores)** (Impact: 6.9)
  * `__call__` **(Parameter Forwarders)** (Impact: 4.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (31.9%), Connectivity (formerly Api Exposure) (12.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_class_deprecation_using_wrapper` **(Defensive Guards)** (Impact: 2.4)
    * *Intent:* # stream is used to store the deprecation message for testing stream = io.StringIO() class MyBaseCla...
  * `test_class_deprecation_using_a_simple_decorator` **(Annotated & Test Methods)** (Impact: 2.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (27.0%), Connectivity (formerly Api Exposure) (12.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_class_deprecation_using_a_simple_decorator` **(Annotated & Test Methods)** (Impact: 2.4)
    * *Intent:* # stream is used to store the deprecation message for testing stream = io.StringIO() # To deprecated...
  * `wrapped_new` **(Parameter Forwarders)** (Impact: 2.1)
  * `simple_decorator` **(Parameter Forwarders)** (Impact: 1.9)
    * *Intent:* # To deprecated the class, we use a simple decorator # which patches the original ``__new__`` method...
  * `test_subclass_deprecation_using_deprecated_decorator` **(Annotated & Test Methods)** (Impact: 1.9)
  * `test_class_deprecation_using_deprecated_decorator` **(Annotated & Test Methods)** (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (15.4%), Connectivity (formerly Api Exposure) (5.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_paragraph` **(Type Conversions)** (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (67.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (8.0%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_sphinx_adapter` **(Defensive Guards)** (Impact: 3.0)
  * `test_sphinx_adapter__empty_docstring` **(Defensive Guards)** (Impact: 2.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (74.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.1%), Complexity Load (formerly Cognitive Load) (6.7%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (43.2%), Complexity Load (formerly Cognitive Load) (5.7%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `area` **(Stateful Encapsulated Methods)** (Impact: 9.4)
  * `test_area` **(Type Conversions)** (Impact: 4.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.0%), Guard Balance (formerly Safety Score) (66.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
...
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.1%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `coverage` **(I/O & Config Routines)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (72.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (2.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 27.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (67.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.4%), Complexity Load (formerly Cognitive Load) (4.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_pow2` **(Type Conversions)** (Impact: 4.3)
