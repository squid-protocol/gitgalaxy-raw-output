...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2228 analyzed artifact(s), 387074 LOC.
- **Load-bearing artifact:** `tests/assets/wpt/wai-aria/scripts/manual.css` -- 159 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `packages/playwright-core/src/utils.ts` -- pulls in 44 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/playwright-test/watch.spec.ts` at magnitude 7811.05 (structural weight, not risk).
...
| Avg Path Length | 4.7669 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `5.929`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +5.93; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 33%, Declarative / Non-Code 26%, Large Core Modules (3) 11%, Callbacks & Closures Files 8%, Large Core Modules (2) 8%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 37.4 | 37.7 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 3.8 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 10.2 | 0.0 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 14.8 | 3.5 | 0.0 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 8.2 | 0.9 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 12.1 | 0.0 | 0.0 |
...
| credential | 296 | 18 | 0 | `packages/playwright/bundles/expect/package-lock.json` |
| threat | 1499 | 194 | 0 | `tests/assets/reading-list/vue_2.6.14.js` |
...
- `parseAttribute` **(Many-Argument Workhorses)** (@ `tests/assets/reading-list/vue_3.1.5.js`) -> Impact: **719.2** | LOC: 1359
- `baseCreateRenderer` **(Many-Argument Workhorses)** (@ `tests/assets/reading-list/vue_3.1.5.js`) -> Impact: **614.7** | LOC: 1175
  * *Intent:* // implementation
- `renderEnum` **(Many-Argument Workhorses)** (@ `utils/doclint/generateDotnetApi.js`) -> Impact: **398.2** | LOC: 690
  * *Intent:* /** */
- `createPatchFunction` **(Compute Cores)** (@ `tests/assets/reading-list/vue_2.6.14.js`) -> Impact: **351.2** | LOC: 717
- `tokenize` **(Compute Cores)** (@ `packages/playwright-core/src/utils/isomorphic/cssTokenizer.ts`) -> Impact: **338.9** | LOC: 470
- `ChildReconciler` **(Defensive Guards)** (@ `tests/assets/reading-list/react-dom_18.1.0.js`) -> Impact: **330.9** | LOC: 933
...
- `ChildReconciler` **(Defensive Guards)** (@ `tests/assets/reading-list/react-dom_17.0.2.js`) -> Impact: **317.9** | LOC: 927
  * *Intent:* // to be able to optimize each path individually by branching early. This needs // a compiler or we can do it manually. Helpers that don't need this b...
- `ChildReconciler` **(Defensive Guards)** (@ `tests/assets/reading-list/react-dom_16.14.0.js`) -> Impact: **314.9** | LOC: 924
  * *Intent:* // to be able to optimize each path individually by branching early. This needs // a compiler or we can do it manually. Helpers that don't need this b...
- `frameSnapshotStreamer` **(Stateful Encapsulated Methods)** (@ `packages/playwright-core/src/server/trace/recorder/snapshotterInjected.ts`) -> Impact: **297.9** | LOC: 624
- `completeWork` **(Many-Argument Workhorses)** (@ `tests/assets/reading-list/react-dom_18.1.0.js`) -> Impact: **286.1** | LOC: 643
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (43.6%), Guard Balance (formerly Safety Score) (28.7%), Connectivity (formerly Api Exposure) (9.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (32.6%), Guard Balance (formerly Safety Score) (25.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (26.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.8%), Guard Balance (formerly Safety Score) (18.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (19.0%), Complexity Load (formerly Cognitive Load) (14.9%), Connectivity (formerly Api Exposure) (11.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.1%), Guard Balance (formerly Safety Score) (41.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (17.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.6%), Guard Balance (formerly Safety Score) (23.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (46.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (25.6%), Guard Balance (formerly Safety Score) (24.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (51.8%), Complexity Load (formerly Cognitive Load) (20.1%), Connectivity (formerly Api Exposure) (11.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (23.6%), Guard Balance (formerly Safety Score) (11.9%), Connectivity (formerly Api Exposure) (8.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 3055.78 | **LOC:** 3550 | **CtrlFlow:** 3.0% | **Authorship Centralization:** 35.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (77.4%), Complexity Load (formerly Cognitive Load) (49.8%), Guard Balance (formerly Safety Score) (15.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `showReport` **(Defensive Guards)** (Impact: 17.2)
  * `calculateTotalTestDuration` **(Compute Cores)** (Impact: 9.2)
  * `execGit` **(Parameter Forwarders)** (Impact: 3.8)
  * `ghaCommitEnv` **(Interface Declarations)** (Impact: 2.4)
  * `ghaPullRequestEnv` **(Parameter Forwarders)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.5%), Guard Balance (formerly Safety Score) (37.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- `packages/playwright-core/src/client/page.ts` -> Churn: **98.46%** | Cog Load: 98.498% | Debt: 0.0%
- `packages/playwright-core/src/server/page.ts` -> Churn: **98.46%** | Cog Load: 98.8826% | Debt: 8.9808%
- `packages/playwright-core/src/server/dispatchers/pageDispatcher.ts` -> Churn: **96.82%** | Cog Load: 100.0% | Debt: 8.8674%
- `packages/playwright/src/program.ts` -> Churn: **89.69%** | Cog Load: 94.7743% | Debt: 10.6691%
...
- `tests/playwright-test/fixtures.spec.ts` -> **Joan Rieu** (100.0% isolated ownership) | Magnitude: 2081.88
...
- `tests/page/pageTest.ts` -> **Severity: 0.197** (Bridge: 0.002 * Flux: 100.0%)
- `tests/config/utils.ts` -> **Severity: 0.193** (Bridge: 0.0019 * Flux: 100.0%)
- `packages/playwright-core/src/server/frames.ts` -> **Severity: 0.17** (Bridge: 0.0017 * Flux: 99.6354%)
- `packages/playwright-core/src/server/dispatchers/browserContextDispatcher.ts` -> **Severity: 0.146** (Bridge: 0.0015 * Flux: 94.3346%)
- `packages/playwright-core/src/client/connection.ts` -> **Severity: 0.128** (Bridge: 0.0013 * Flux: 100.0%)

### 🃏 House of Cards (Closeness * Error Risk)
These files are deeply embedded (1 or 2 hops from the entire codebase) but possess high error exposure. A runtime exception here will cascade instantly across the application.

- `tests/config/utils.ts` -> **Severity: 8.236** (Embedded: 0.0938 * Error Risk: 87.7611%)
- `packages/playwright-core/src/utils/isomorphic/locatorGenerators.ts` -> **Severity: 6.577** (Embedded: 0.0778 * Error Risk: 84.5165%)
- `packages/playwright-core/src/utils/isomorphic/trace/traceModel.ts` -> **Severity: 6.532** (Embedded: 0.0677 * Error Risk: 96.4174%)
- `packages/playwright-core/src/utils/isomorphic/selectorParser.ts` -> **Severity: 6.334** (Embedded: 0.0668 * Error Risk: 94.8904%)
- `packages/playwright-core/src/utils/isomorphic/stringUtils.ts` -> **Severity: 5.982** (Embedded: 0.0707 * Error Risk: 84.6465%)
