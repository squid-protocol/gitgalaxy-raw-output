...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3254 analyzed artifact(s), 782965 LOC.
- **Load-bearing artifact:** `scipy-1.17.1/subprojects/xsf/include/xsf/numpy.h` -- 791 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/rational.hpp` -- pulls in 119 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `scipy-1.17.1/subprojects/xsf/include/xsf/specfun/specfun.h` at magnitude 11762.3 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 3254 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 1034 |
| Total LOC | 782965 |
...
|---|---|---|
| Modularity | 0.7599 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Architectural Drift Z-Score:** `3.63`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +3.63; from the repo's file-archetype mix)
> **File Composition:** Many-Argument Workhorses Files 21%, Declarative / Non-Code 17%, Large Core Modules (3) 14%, Data / Markup / Trivial 13%, Parameter Forwarders Files 13%
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 100.0 | 34.9 | 34.6 | 0.0 |
...
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 53.1 | 83.2 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 68.4 | 100.0 | 100.0 |
...
| connectivity | 28349 | 1991 | 19 | `scipy-1.17.1/scipy/stats/tests/test_distributions.py` |
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **2**; blast radius 0.26; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `cv0` **(Many-Argument Workhorses)** (Impact: 268.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 0.161; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (54.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **27**; blast radius 0.194; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (95.7%), Complexity Load (formerly Cognitive Load) (62.3%)
- **Documentation Coverage:** 96.3997% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000251 | `Ripple Effect (Closeness):` 0.001825
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.111; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `dinvr` **(Many-Argument Workhorses)** (Impact: 120.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.6%), Connectivity (formerly Api Exposure) (14.0%)
- **Documentation Coverage:** 98.2829% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  ...
  * `HPresolve::detectParallelRowsAndCols` **(Many-Argument Workhorses)** (Impact: 350.1)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `DODMN` **(I/O & Config Routines)** (Impact: 183.2)
    * *Intent:* *DODMN
  * `DODPC1` **(I/O & Config Routines)** (Impact: 154.8)
    * *Intent:* *DODPC1
  * `DODPC3` **(I/O & Config Routines)** (Impact: 113.0)
    * *Intent:* *DODPC3
  * `DODCHK` **(I/O & Config Routines)** (Impact: 103.0)
    * *Intent:* *DODCHK
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **25**; blast radius 0.398; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (52.2%)
- **Documentation Coverage:** 62.6984% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2.3e-05 | `Ripple Effect (Closeness):` 0.005029
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (84.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (39.4%), Connectivity (formerly Api Exposure) (14.0%)
- **Documentation Coverage:** 97.1793% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **19**; blast radius 0.154; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.5%)
- **Documentation Coverage:** 98.308% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_quadrature` **(Many-Argument Workhorses)** (Impact: 43.9)
    * *Intent:* ## Algorithms
  * `_make_distribution_rv_generic` **(Stateful Encapsulated Methods)** (Impact: 41.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **19**; blast radius 0.143; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.6%), Connectivity (formerly Api Exposure) (70.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.2%)
- **Documentation Coverage:** 98.3471% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_minmax_axis` **(I/O & Config Routines)** (Impact: 29.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Complexity Load (formerly Cognitive Load) (80.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 0.122; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (50.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.5%)
- **Documentation Coverage:** 13.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.7%), Guard Balance (formerly Safety Score) (98.0%), Debt Markers (formerly Tech Debt) (94.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `HEkk::returnFromSolve` **(Defensive Guards)** (Impact: 60.8)
**Contextual Mitigations & Amplifications:**
...
- **Documentation Coverage:** 74.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `qh_matchdupridge` **(Many-Argument Workhorses)** (Impact: 197.7)
    * *Intent:* */
  * `qh_checkpolygon` **(Many-Argument Workhorses)** (Impact: 123.7)
    * *Intent:* */
  * `qh_checklists` **(Many-Argument Workhorses)** (Impact: 93.5)
    * *Intent:* */
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **22**; blast radius 0.181; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Debt Markers (formerly Tech Debt) (92.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 51.1156% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_dirichlet_check_input` **(Stateful Encapsulated Methods)** (Impact: 33.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 6.2e-05 | `Ripple Effect (Closeness):` 0.001229
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `Highs::multiobjectiveSolve` **(I/O & Config Routines)** (Impact: 71.5)
**Contextual Mitigations & Amplifications:**
...
- `scipy-1.17.1/subprojects/xsf/include/xsf/numpy.h` -> **Severity: 15.145** (Embedded: 0.2445 * Error Risk: 61.9323%)
- `scipy-1.17.1/subprojects/xsf/include/xsf/dual.h` -> **Severity: 12.252** (Embedded: 0.1275 * Error Risk: 96.1034%)
- `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/utility.hpp` -> **Severity: 11.706** (Embedded: 0.187 * Error Risk: 62.5811%)
- `scipy-1.17.1/subprojects/xsf/include/xsf/error.h` -> **Severity: 9.281** (Embedded: 0.1437 * Error Risk: 64.5656%)
- `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/config.hpp` -> **Severity: 8.676** (Embedded: 0.1608 * Error Risk: 53.9717%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/config.hpp` -> **Severity: 9565.6** (Blast Radius: 95.656 * Doc Risk: 100.0%)
- `scipy-1.17.1/subprojects/xsf/include/xsf/numpy.h` -> **Severity: 5918.7** (Blast Radius: 59.187 * Doc Risk: 100.0%)
- `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/utility.hpp` -> **Severity: 3058.9** (Blast Radius: 30.589 * Doc Risk: 100.0%)
- `scipy-1.17.1/subprojects/xsf/include/xsf/error.h` -> **Severity: 1691.2** (Blast Radius: 16.912 * Doc Risk: 100.0%)
- `scipy-1.17.1/subprojects/boost_math/math/include/boost/math/tools/tuple.hpp` -> **Severity: 1309.7** (Blast Radius: 13.097 * Doc Risk: 100.0%)
