...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 3 LOC.
...
| Connectivity (formerly API Exposure) | 3.5 | 5.6 | 4.6 | 4.6 | 5.6 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 3 | 2 | 2 | `package/index.d.ts` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| debt | 0 | 0 | 0 | - |
| mutation | 1 | 1 | 1 | `package/index.d.ts` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 381.443; role: Pure Producer (Foundation)
