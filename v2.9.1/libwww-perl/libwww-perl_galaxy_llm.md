...
## 1. EXECUTIVE SUMMARY
- **Scope:** 60 analyzed artifact(s), 3961 LOC.
- **Load-bearing artifact:** `t/base/simple.t` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `bin/lwp-request` -- pulls in 20 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `t/local/http.t` at magnitude 740.68 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.846`
> **Composition Archetype:** `Small Flat Repo` (z +3.85; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 60%, Data / Markup / Trivial 13%, Parameter Forwarders Files 7%, Many-Argument Workhorses Files 5%, Large Core Modules 3%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 91.2 | 39.5 | 51.1 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 26.8 | 0.0 | 0.0 |
...
- `_test` **(Annotated & Test Methods)** (@ `t/local/http.t`) -> Impact: **177.6** | LOC: 431
...
- `_test` **(Annotated & Test Methods)** (@ `t/robot/ua-get.t`) -> Impact: **36.0** | LOC: 60
- `request` **(Many-Argument Workhorses)** (@ `t/local/protosub.t`) -> Impact: **21.9** | LOC: 15
- `_test` **(Annotated & Test Methods)** (@ `t/robot/ua.t`) -> Impact: **19.8** | LOC: 56
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Complexity Load (formerly Cognitive Load) (82.7%), Guard Balance (formerly Safety Score) (66.6%), Connectivity (formerly Api Exposure) (41.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `daemonize` **(Many-Argument Workhorses)** (Impact: 371.5)
  * `_test` **(Annotated & Test Methods)** (Impact: 177.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (81.8%), Complexity Load (formerly Cognitive Load) (54.7%), Debt Markers (formerly Tech Debt) (11.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.6%), Complexity Load (formerly Cognitive Load) (71.9%), Connectivity (formerly Api Exposure) (4.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `daemonize` **(Many-Argument Workhorses)** (Impact: 41.5)
  * `_test` **(Annotated & Test Methods)** (Impact: 36.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.2%), Complexity Load (formerly Cognitive Load) (65.8%), Dead Code Surface (formerly Dead Code) (6.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fduration` **(Type Conversions)** (Impact: 6.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.7%), Guard Balance (formerly Safety Score) (67.6%), Complexity Load (formerly Cognitive Load) (30.2%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Complexity Load (formerly Cognitive Load) (62.1%), Connectivity (formerly Api Exposure) (4.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `daemonize` **(Many-Argument Workhorses)** (Impact: 41.5)
  * `_test` **(Annotated & Test Methods)** (Impact: 19.8)
  * `url` **(Interface Declarations)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Mitigated Memory Allocs:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (88.1%), Guard Balance (formerly Safety Score) (71.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 16.434; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.1%), Complexity Load (formerly Cognitive Load) (40.5%), Debt Markers (formerly Tech Debt) (33.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.2%), Mutation Surface (formerly State Flux) (85.0%), Complexity Load (formerly Cognitive Load) (73.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (53.2%), Mutation Surface (formerly State Flux) (21.3%), Connectivity (formerly Api Exposure) (11.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `new` **(Type Conversions)** (Impact: 1.6)
  * `format_request` **(Parameter Forwarders)** (Impact: 1.6)
  * `syswrite` **(Parameter Forwarders)** (Impact: 1.6)
  * `read_response_headers` **(Parameter Forwarders)** (Impact: 1.6)
  * `read_entity_body` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (70.0%), Complexity Load (formerly Cognitive Load) (67.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (33.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.2%), Guard Balance (formerly Safety Score) (57.2%), Complexity Load (formerly Cognitive Load) (51.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (9.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.3%), Dead Code Surface (formerly Dead Code) (52.6%), Complexity Load (formerly Cognitive Load) (14.2%), Connectivity (formerly Api Exposure) (6.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `request` **(Many-Argument Workhorses)** (Impact: 21.9)
  * `new` **(Annotated & Test Methods)** (Impact: 3.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (73.7%), Complexity Load (formerly Cognitive Load) (31.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Complexity Load (formerly Cognitive Load) (60.8%), Guard Balance (formerly Safety Score) (52.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (56.4%), Complexity Load (formerly Cognitive Load) (30.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (72.0%), Complexity Load (formerly Cognitive Load) (23.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (75.6%), Guard Balance (formerly Safety Score) (44.9%), Complexity Load (formerly Cognitive Load) (30.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.7%), Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (62.6%), Complexity Load (formerly Cognitive Load) (17.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (47.9%), Complexity Load (formerly Cognitive Load) (15.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 6
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (75.3%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (37.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.3%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (15.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 16.434; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.1%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (14.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
