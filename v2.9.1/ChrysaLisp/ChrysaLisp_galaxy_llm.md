...
## 1. EXECUTIVE SUMMARY
- **Scope:** 319 analyzed artifact(s), 24624 LOC.
- **Load-bearing artifact:** `funcs.ps1` -- 7 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `LLM.md` -- pulls in 52 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/host/gui_fb.c` at magnitude 1017.26 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.663`
> **Composition Archetype:** `Mid Flat Project` (z +4.66; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 78%, Data / Markup / Trivial 18%, Large Core Modules (3) 2%, Callbacks & Closures Files 0%, Compute Cores Files 0%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 3.2 | 0.0 | 0.0 |
...
- `get_event_timeout` **(Many-Argument Workhorses)** (@ `src/host/gui_fb.c`) -> Impact: **53.0** | LOC: 90
...
- `main` **(Many-Argument Workhorses)** (@ `src/host/main.cpp`) -> Impact: **33.3** | LOC: 77
  * *Intent:* #endif
- `open_framebuffer` **(I/O & Config Routines)** (@ `src/host/gui_fb.c`) -> Impact: **26.9** | LOC: 98
  * *Intent:* /* open linux framebuffer*/
- `pii_mprotect` **(Compute Cores)** (@ `src/host/pii_windows.cpp`) -> Impact: **22.9** | LOC: 18
- `read_mouse` **(Stateful Encapsulated Methods)** (@ `src/host/gui_fb.c`) -> Impact: **21.8** | LOC: 33
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_event_timeout` **(Many-Argument Workhorses)** (Impact: 53.0)
    * *Intent:* /* msec timeout 0 to poll, timeout -1 to block */
  * `host_gui_create_texture` **(Many-Argument Workhorses)** (Impact: 49.2)
    * *Intent:* /* allocate drawable for passed data and return a handle to it */
  * `open_framebuffer` **(I/O & Config Routines)** (Impact: 26.9)
    * *Intent:* /* open linux framebuffer*/
  * `read_mouse` **(Stateful Encapsulated Methods)** (Impact: 21.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.87; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `walk_directory` **(Many-Argument Workhorses)** (Impact: 17.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (94.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (94.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `walk_directory` **(Compute Cores)** (Impact: 19.5)
    * *Intent:* */ #define FOLDER_PRE 0 #define FOLDER_POST 1
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **1**; blast radius 19.946; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Debt Markers (formerly Tech Debt) (96.2%), Complexity Load (formerly Cognitive Load) (81.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (85.7%), Debt Markers (formerly Tech Debt) (10.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); blast radius 19.946; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.8%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.9%), Complexity Load (formerly Cognitive Load) (65.8%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (65.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.0%), Guard Balance (formerly Safety Score) (91.8%), Complexity Load (formerly Cognitive Load) (49.9%), Debt Markers (formerly Tech Debt) (20.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (88.8%), Guard Balance (formerly Safety Score) (52.4%), Complexity Load (formerly Cognitive Load) (8.7%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (61.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.87; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.2%), Mutation Surface (formerly State Flux) (56.3%), Complexity Load (formerly Cognitive Load) (16.0%), Test Surface (formerly Verification) (2.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `host_audio_change_sfx` **(Compute Cores)** (Impact: 20.5)
  * `host_audio_add_sfx` **(Compute Cores)** (Impact: 5.1)
  * `host_audio_init` **(I/O & Config Routines)** (Impact: 3.8)
  * `host_audio_remove_sfx` **(Compute Cores)** (Impact: 3.4)
  * `host_audio_play_sfx` **(Parameter Forwarders)** (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.4%), Complexity Load (formerly Cognitive Load) (59.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.4%), Mutation Surface (formerly State Flux) (9.5%), Complexity Load (formerly Cognitive Load) (7.5%), Test Surface (formerly Verification) (2.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.6%), Mutation Surface (formerly State Flux) (57.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%), Complexity Load (formerly Cognitive Load) (10.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 5 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.9%), Mutation Surface (formerly State Flux) (14.9%), Complexity Load (formerly Cognitive Load) (6.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.5%), Complexity Load (formerly Cognitive Load) (57.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (63.6%), Test Surface (formerly Verification) (2.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.3%), Test Surface (formerly Verification) (2.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.1%), Mutation Surface (formerly State Flux) (23.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.9%), Complexity Load (formerly Cognitive Load) (17.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.87; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.8%), Complexity Load (formerly Cognitive Load) (55.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.4%), Complexity Load (formerly Cognitive Load) (9.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
* *Memory Alloc (weighted view):* 0
