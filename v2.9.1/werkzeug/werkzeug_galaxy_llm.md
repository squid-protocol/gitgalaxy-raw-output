...
## 1. EXECUTIVE SUMMARY
- **Scope:** 189 analyzed artifact(s), 20758 LOC.
- **Load-bearing artifact:** `werkzeug-3.1.8/src/werkzeug/wsgi.py` -- 25 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `werkzeug-3.1.8/src/werkzeug/serving.py` -- pulls in 35 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `werkzeug-3.1.8/src/werkzeug/http.py` at magnitude 918.04 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.599`
> **Composition Archetype:** `Small Flat Repo (2)` (z +2.60; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 35%, Generic / Templated Code Files 17%, Parameter Forwarders Files 16%, Large Core Modules (2) 12%, Declarative / Non-Code 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 47.9 | 51.9 | 0.0 |
...
- `_compile_builder` **(Stateful Encapsulated Methods)** (@ `werkzeug-3.1.8/src/werkzeug/routing/rules.py`) -> Impact: **58.6** | LOC: 99
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **14**; blast radius 3.642; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (60.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `parse_accept_header` **(Many-Argument Workhorses)** (Impact: 19.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.553; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (39.8%), Guard Balance (formerly Safety Score) (20.6%), Connectivity (formerly Api Exposure) (12.5%)
- **Documentation Coverage:** 95.7895% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **35**; blast radius 15.959; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.1%)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **10**; blast radius 10.056; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (88.7%), Guard Balance (formerly Safety Score) (85.6%)
- **Documentation Coverage:** 74.8899% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **13**; blast radius 4.833; role: Transceiver (Middle-Tier)
...
- **Documentation Coverage:** 68.8525% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_compile_builder` **(Stateful Encapsulated Methods)** (Impact: 58.6)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **20**; blast radius 9.867; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 1.553; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.8%), Connectivity (formerly Api Exposure) (12.8%), Guard Balance (formerly Safety Score) (7.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 1.553; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (23.9%), Connectivity (formerly Api Exposure) (12.6%), Guard Balance (formerly Safety Score) (7.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_new_response_iterator_behavior` **(Defensive Guards)** (Impact: 4.8)
  * `test_base_response` **(Defensive Guards)** (Impact: 4.3)
  * `test_common_response_descriptors` **(Defensive Guards)** (Impact: 4.3)
  * `test_base_request` **(Defensive Guards)** (Impact: 3.2)
  * `test_type_forcing` **(Defensive Guards)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **28**; blast radius 10.723; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (63.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `__get__` **(Compute Cores)** (Impact: 15.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 1.553; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.1%), Complexity Load (formerly Cognitive Load) (53.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.553; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (48.7%), Guard Balance (formerly Safety Score) (12.8%)
- **Documentation Coverage:** 98.4375% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_basic_local` **(Callbacks & Closures)** (Impact: 5.3)
  * `test_proxy_aiter` **(Interface Declarations)** (Impact: 4.3)
  * `test_proxy_numeric` **(Defensive Guards)** (Impact: 4.0)
  * `test_proxy_attributes` **(Defensive Guards)** (Impact: 4.0)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **17**; blast radius 5.815; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (66.1%)
- **Documentation Coverage:** 54.4304% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 2.162; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (61.8%)
- **Documentation Coverage:** 74.0385% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 3.966; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.9%)
- **Documentation Coverage:** 64.557% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 25.8)
  * `_set_property` **(Stateful Encapsulated Methods)** (Impact: 13.2)
  * `_clean_status` **(Stateful Encapsulated Methods)** (Impact: 10.1)
...
- **Blast Radius:** changing it is visible to **19** in-repo importer(s); it depends on **13**; blast radius 17.032; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Connectivity (formerly Api Exposure) (94.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `get_response` **(Generic / Templated Code)** (Impact: 7.2)
  * `__init__` **(Compute Cores)** (Impact: 7.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **15**; blast radius 4.706; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Concurrency Surface (formerly Concurrency) (89.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 65.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_find_stat_paths` **(Stateful Encapsulated Methods)** (Impact: 19.8)
  ...
  * `_find_common_roots` **(Stateful Encapsulated Methods)** (Impact: 11.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 7.033; role: Pure Producer (Foundation)
...
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `next_event` **(Stateful Encapsulated Methods)** (Impact: 50.9)
  * `_parse_data` **(Stateful Encapsulated Methods)** (Impact: 37.6)
  * `send_event` **(Defensive Guards)** (Impact: 29.3)
  * `_last_partial_boundary_index` **(Stateful Encapsulated Methods)** (Impact: 9.8)
    * *Intent:* # Find the last index following which a partial boundary # could be present in the data. This will b...
  * `receive_data` **(Generic / Templated Code)** (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **25** in-repo importer(s); it depends on **8**; blast radius 162.424; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Connectivity (formerly Api Exposure) (55.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 71.9298% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 10.9)
  * `_next` **(Stateful Encapsulated Methods)** (Impact: 9.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **9**; blast radius 7.007; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 75.4098% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 27.3)
  * `__get__` **(Defensive Guards)** (Impact: 13.3)
  * `__init__` **(Generic / Templated Code)** (Impact: 11.4)
  * `__init__` **(Type Conversions)** (Impact: 7.5)
  * `__delattr__` **(Type Conversions)** (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.553; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (16.9%), Connectivity (formerly Api Exposure) (12.4%), Guard Balance (formerly Safety Score) (2.9%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **7**; blast radius 3.082; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `match` **(Many-Argument Workhorses)** (Impact: 121.8)
  * `_match` **(Many-Argument Workhorses)** (Impact: 76.4)
  * `add` **(Compute Cores)** (Impact: 12.9)
  * `update` **(Stateful Encapsulated Methods)** (Impact: 4.9)
    * *Intent:* # For every state the dynamic transitions should be sorted by # the weight of the transition state =...
  * `_update_state` **(Encapsulated Accessors)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 2.872; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.4%), Complexity Load (formerly Cognitive Load) (51.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 1.685; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (96.1%), Guard Balance (formerly Safety Score) (86.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 59.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_value_matches` **(Stateful Encapsulated Methods)** (Impact: 31.9)
  ...
  * `_best_single_match` **(Stateful Encapsulated Methods)** (Impact: 9.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **12**; blast radius 19.588; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `_parse_urlencoded` **(Stateful Encapsulated Methods)** (Impact: 10.8)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **7**; blast radius 8.567; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  ...
  * `_always_update` **(Stateful Encapsulated Methods)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
