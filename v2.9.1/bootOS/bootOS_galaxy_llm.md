...
## 1. EXECUTIVE SUMMARY
- **Scope:** 8 analyzed artifact(s), 1086 LOC.
...
- **Heaviest artifact:** `os.asm` at magnitude 145.6 (structural weight, not risk).
...
> **File Composition:** Parameter Forwarders Files 62%, Data / Markup / Trivial 25%, Large Core Modules 12%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 64.3 | 50.0 | 50.0 |
...
- `.loop` **(Parameter Forwarders)** (@ `patch/sokoban.asm`) -> Impact: **10.5** | LOC: 15
- `ClearScreen` **(Compute Cores)** (@ `patch/mine.asm`) -> Impact: **9.6** | LOC: 13
...
### `os.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 145.6 | **LOC:** 656 | **CtrlFlow:** 6.5% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (62.0%), Debt Markers (formerly Tech Debt) (52.0%), Mutation Surface (formerly State Flux) (22.5%)
...
### `patch/mine.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 128.86 | **LOC:** 405 | **CtrlFlow:** 11.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (36.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ClearScreen` **(Compute Cores)** (Impact: 9.6)
...
### `patch/sokoban.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 123.72 | **LOC:** 398 | **CtrlFlow:** 10.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (64.0%), Mutation Surface (formerly State Flux) (59.2%), Debt Markers (formerly Tech Debt) (23.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
### `patch/snake.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 101.3 | **LOC:** 242 | **CtrlFlow:** 8.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (89.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.1%), Mutation Surface (formerly State Flux) (28.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
### `counter.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 20.18 | **LOC:** 91 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (74.3%), Debt Markers (formerly Tech Debt) (70.9%), Mutation Surface (formerly State Flux) (57.7%), Complexity Load (formerly Cognitive Load) (11.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (9.1%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
