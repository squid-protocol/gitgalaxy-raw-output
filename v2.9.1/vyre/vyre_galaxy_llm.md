...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4128 analyzed artifact(s), 753480 LOC.
- **Load-bearing artifact:** `scripts/lib/cargo_runner.sh` -- 30 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `vyre-driver-cuda/src/lib.rs` -- pulls in 197 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `xtask/src/release_completion_audit.rs` at magnitude 3609.02 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.543`
> **Composition Archetype:** `Flat Modular Platform` (z +3.54; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 19%, Large Core Modules (3) 15%, State Mutators Files 14%, Data / Markup / Trivial 13%, Many-Argument Workhorses Files 9%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 56.1 | 56.7 | 100.0 |
...
- `reference_typed_kind` **(Many-Argument Workhorses)** (@ `vyre-libs/src/parsing/c/parse/vast/ref_typedef/typed_kind.rs`) -> Impact: **348.4** | LOC: 351
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 0.237; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.1%), Complexity Load (formerly Cognitive Load) (30.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (59.5%), Complexity Load (formerly Cognitive Load) (23.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (55.5%), Mutation Surface (formerly State Flux) (53.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.0%), Complexity Load (formerly Cognitive Load) (39.0%), Connectivity (formerly Api Exposure) (1.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `main` **(Many-Argument Workhorses)** (Impact: 43.5)
    * *Intent:* /* * */
  * `dump_element` **(Stateful Encapsulated Methods)** (Impact: 34.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (47.4%), Guard Balance (formerly Safety Score) (46.6%)
- **Documentation Coverage:** 23.7624% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (96.5%), Complexity Load (formerly Cognitive Load) (86.6%), Connectivity (formerly Api Exposure) (5.8%), Dead Code Surface (formerly Dead Code) (5.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (92.7%), Guard Balance (formerly Safety Score) (91.3%), Connectivity (formerly Api Exposure) (29.8%), Dead Code Surface (formerly Dead Code) (5.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.2%), Complexity Load (formerly Cognitive Load) (47.6%), Connectivity (formerly Api Exposure) (0.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `main` **(Many-Argument Workhorses)** (Impact: 87.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (92.0%), Guard Balance (formerly Safety Score) (85.2%), Dead Code Surface (formerly Dead Code) (6.6%), Connectivity (formerly Api Exposure) (1.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `selected_conf` **(Many-Argument Workhorses)** (Impact: 120.4)
  ...
  * `main` **(Many-Argument Workhorses)** (Impact: 26.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.8%), Complexity Load (formerly Cognitive Load) (18.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **12**; blast radius 0.237; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (99.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (72.4%), Mutation Surface (formerly State Flux) (58.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.234; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (87.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.6%), Complexity Load (formerly Cognitive Load) (26.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `inspect_vyrecob2_sections` **(Type Conversions)** (Impact: 42.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.234; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.7%), Complexity Load (formerly Cognitive Load) (46.6%), Concurrency Surface (formerly Concurrency) (15.1%), Dead Code Surface (formerly Dead Code) (5.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `do_sort` **(Many-Argument Workhorses)** (Impact: 87.6)
    * *Intent:* #endif
  * `do_file` **(Many-Argument Workhorses)** (Impact: 66.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (93.0%), Complexity Load (formerly Cognitive Load) (86.5%), Dead Code Surface (formerly Dead Code) (5.9%), Connectivity (formerly Api Exposure) (2.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `print_symbol_for_c` **(Stateful Encapsulated Methods)** (Impact: 28.0)
  * `conf_touch_deps` **(I/O & Config Routines)** (Impact: 27.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (75.9%), Guard Balance (formerly Safety Score) (55.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.9%), Debt Markers (formerly Tech Debt) (25.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.4%), Mutation Surface (formerly State Flux) (55.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.7%), Complexity Load (formerly Cognitive Load) (87.5%), Connectivity (formerly Api Exposure) (0.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (86.6%), Complexity Load (formerly Cognitive Load) (83.7%), Connectivity (formerly Api Exposure) (0.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `change_sym_value` **(C Struct Operations)** (Impact: 29.3)
    * *Intent:* /* Change the value of a symbol and update the tree */
  * `main` **(Compute Cores)** (Impact: 26.8)
    * *Intent:* /* Main */
  * `on_treeview2_key_press_event` **(C Struct Operations)** (Impact: 23.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (95.7%), Connectivity (formerly Api Exposure) (6.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `get_prompt_str` **(Many-Argument Workhorses)** (Impact: 32.9)
  * `menu_dump` **(I/O & Config Routines)** (Impact: 28.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.6%), Complexity Load (formerly Cognitive Load) (20.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `check_4_cross_dialect_reachthrough` **(I/O & Config Routines)** (Impact: 34.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (96.5%), Complexity Load (formerly Cognitive Load) (78.8%), Connectivity (formerly Api Exposure) (6.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (95.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (81.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.8%), Complexity Load (formerly Cognitive Load) (59.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `function_argument_prescan_macros` **(Many-Argument Workhorses)** (Impact: 78.8)
  * `macro_use_statement_ranges` **(Many-Argument Workhorses)** (Impact: 55.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.234; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.7%), Complexity Load (formerly Cognitive Load) (51.2%), Connectivity (formerly Api Exposure) (0.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolve_fqns` **(Many-Argument Workhorses)** (Impact: 35.5)
  * `process_exported_symbols` **(C Struct Operations)** (Impact: 27.9)
  * `___process_structure_type` **(Stateful Encapsulated Methods)** (Impact: 25.1)
