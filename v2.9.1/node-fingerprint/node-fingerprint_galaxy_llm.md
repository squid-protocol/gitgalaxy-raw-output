# ARCHITECTURAL_BRIEF: node-fingerprint
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 10 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 5.2 (structural weight, not risk).
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 85.6 | 85.6 | 85.6 | 85.6 | 85.6 |
...
- `pad` **(Parameter Forwarders)** (@ `package/index.js`) -> Impact: **4.0** | LOC: 10
...
- **Magnitude:** 5.2 | **LOC:** 16 | **CtrlFlow:** 10.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 333.333; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (73.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (5.1%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 85.6215% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pad` **(Parameter Forwarders)** (Impact: 4.0)
...
- `package/index.js` -> **Severity: 28540.471** (Blast Radius: 333.333 * Doc Risk: 85.6215%)
