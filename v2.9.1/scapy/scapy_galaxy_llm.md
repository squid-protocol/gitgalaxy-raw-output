...
## 1. EXECUTIVE SUMMARY
- **Scope:** 434 analyzed artifact(s), 162733 LOC.
- **Load-bearing artifact:** `scapy/packet.py` -- 245 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `scapy/utils.py` -- pulls in 53 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `doc/notebooks/tls/raw_data/pki/srv_cert.pem` at magnitude 5000.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.298`
> **Composition Archetype:** `Hub-Coupled App` (z +2.30; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 26%, Large Core Modules (3) 23%, Data / Markup / Trivial 18%, Declarative / Non-Code 13%, Large Core Modules (2) 8%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 6.2 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 63.7 | 89.5 | 100.0 |
...
- **Blast Radius:** changing it is visible to **82** in-repo importer(s); it depends on **53**; blast radius 44.62; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.7%), Connectivity (formerly Api Exposure) (84.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 94.2211% of unit weight undocumented
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **37**; blast radius 1.135; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (89.4%), Guard Balance (formerly Safety Score) (88.0%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **211** in-repo importer(s); it depends on **29**; blast radius 35.563; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (97.7%), Guard Balance (formerly Safety Score) (93.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `_build_config_representation` **(Stateful Encapsulated Methods)** (Impact: 33.3)
...
- **Blast Radius:** changing it is visible to **39** in-repo importer(s); it depends on **25**; blast radius 4.435; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.1%), Guard Balance (formerly Safety Score) (96.5%)
- **Documentation Coverage:** 85.1003% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **245** in-repo importer(s); it depends on **24**; blast radius 101.581; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.359% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **103** in-repo importer(s); it depends on **41**; blast radius 11.363; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 85.3175% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **15** in-repo importer(s); it depends on **23**; blast radius 1.794; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.2%), Connectivity (formerly Api Exposure) (81.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (81.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `_up_pkt` **(Many-Argument Workhorses)** (Impact: 36.7)
  ...
  * `tcp_reassemble` **(Compute Cores)** (Impact: 20.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **22**; blast radius 0.866; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Debt Markers (formerly Tech Debt) (95.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 87.8049% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `build` **(Many-Argument Workhorses)** (Impact: 30.9)
  * `tls_session_update` **(Many-Argument Workhorses)** (Impact: 30.7)
...
- **Blast Radius:** changing it is visible to **24** in-repo importer(s); it depends on **23**; blast radius 6.653; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.9%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **22**; blast radius 0.621; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (81.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (55.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `show` **(Many-Argument Workhorses)** (Impact: 43.6)
...
- **Blast Radius:** changing it is visible to **21** in-repo importer(s); it depends on **26**; blast radius 3.821; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Complexity Load (formerly Cognitive Load) (93.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 1590.84 | **LOC:** 2029 | **CtrlFlow:** 20.6% | **Authorship Centralization:** 40.0%
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **28**; blast radius 1.026; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Guard Balance (formerly Safety Score) (91.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 71.7742% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **31**; blast radius 0.728; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.2%)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **30**; blast radius 1.172; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (98.8%), Guard Balance (formerly Safety Score) (97.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 69.0141% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `fill_and_store` **(Stateful Encapsulated Methods)** (Impact: 28.4)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **21**; blast radius 0.842; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (79.0%), Guard Balance (formerly Safety Score) (77.8%)
- **Documentation Coverage:** 91.8129% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `computeSMBSessionKeys` **(Many-Argument Workhorses)** (Impact: 30.8)
...
- `scapy/layers/kerberos.py` -> Churn: **89.36%** | Cog Load: 76.7494% | Debt: 21.5698%
- `scapy/layers/msrpce/rpcclient.py` -> Churn: **85.44%** | Cog Load: 67.7707% | Debt: 0.0%
- `scapy/layers/dcerpc.py` -> Churn: **81.39%** | Cog Load: 70.222% | Debt: 79.9585%
- `scapy/layers/windows/registry.py` -> Churn: **77.13%** | Cog Load: 36.3454% | Debt: 68.7945%
