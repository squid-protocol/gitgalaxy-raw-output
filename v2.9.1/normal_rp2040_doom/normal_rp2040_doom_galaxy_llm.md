...
## 1. EXECUTIVE SUMMARY
- **Scope:** 672 analyzed artifact(s), 196203 LOC.
- **Load-bearing artifact:** `src/i_system.h` -- 150 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/strife/d_main.c` -- pulls in 47 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/whd_gen/lodepng.cpp` at magnitude 7954.74 (structural weight, not risk).
...
| Avg Path Length | 1.5715 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `2.748`
> **Composition Archetype:** `Hub-Coupled App` (z +2.75; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 35%, Large Core Modules (3) 20%, Data / Markup / Trivial 11%, Compute Cores Files 9%, Many-Argument Workhorses Files 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 57.9 | 100.0 | 100.0 |
...
- `P_UseSpecialLine` **(Many-Argument Workhorses)** (@ `src/strife/p_switch.c`) -> Impact: **473.4** | LOC: 629
  * *Intent:* // // P_UseSpecialLine // Called when a thing uses a special line. // Only the front sides of lines are usable. //
- `P_CrossSpecialLine` **(Many-Argument Workhorses)** (@ `src/strife/p_spec.c`) -> Impact: **372.9** | LOC: 818
  * *Intent:* // // P_CrossSpecialLine - TRIGGER // Called every time a thing origin is about // to cross a line with a non 0 special. //
- `P_DamageMobj` **(Many-Argument Workhorses)** (@ `src/hexen/p_inter.c`) -> Impact: **318.0** | LOC: 367
  * *Intent:* */
- `P_ExecuteLineSpecial` **(Many-Argument Workhorses)** (@ `src/hexen/p_spec.c`) -> Impact: **276.2** | LOC: 332
  * *Intent:* */ //============================================================================ // // P_ExecuteLineSpecial // // Invoked when crossing a linedef. Th...
- `G_BuildTiccmd` **(Many-Argument Workhorses)** (@ `src/hexen/g_game.c`) -> Impact: **264.4** | LOC: 472
- `P_UseSpecialLine` **(Many-Argument Workhorses)** (@ `src/doom/p_switch.c`) -> Impact: **262.9** | LOC: 379
  * *Intent:* // // P_UseSpecialLine // Called when a thing uses a special line. // Only the front sides of lines are usable. //
- `MN_Responder` **(Compute Cores)** (@ `src/hexen/mn_menu.c`) -> Impact: **257.6** | LOC: 570
  * *Intent:* //--------------------------------------------------------------------------- // // FUNC MN_Responder // //-------------------------------------------...
- `M_Responder` **(Compute Cores)** (@ `src/doom/m_menu.c`) -> Impact: **256.7** | LOC: 551
  * *Intent:* // // CONTROL PANEL // // // M_Responder //
- `P_DamageMobj` **(Many-Argument Workhorses)** (@ `src/strife/p_inter.c`) -> Impact: **253.9** | LOC: 337
...
- `M_Responder` **(Compute Cores)** (@ `src/strife/m_menu.c`) -> Impact: **249.0** | LOC: 568
  * *Intent:* // // CONTROL PANEL // // // M_Responder //
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Complexity Load (formerly Cognitive Load) (85.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 92.5764% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 232.7)
    * *Intent:* #endif
  * `convert_textures` **(Many-Argument Workhorses)** (Impact: 207.4)
  * `optimize_column` **(Many-Argument Workhorses)** (Impact: 197.6)
  * `convert_vpatch` **(Many-Argument Workhorses)** (Impact: 196.4)
    * *Intent:* // use_runs = true to do runs of pixels, false to use 0 as transparent color
  * `convert_sidedefs` **(Many-Argument Workhorses)** (Impact: 151.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `DragonSeek` **(Many-Argument Workhorses)** (Impact: 60.1)
    * *Intent:* //============================================================================ // // DragonSeek // /...
  * `A_SorcBallOrbit` **(Compute Cores)** (Impact: 57.6)
    * *Intent:* // // A_SorcBallOrbit() ========================================== //
  * `A_Chase` **(Compute Cores)** (Impact: 57.4)
    * *Intent:* */
  * `P_NewChaseDir` **(Compute Cores)** (Impact: 55.2)
  * `A_FastChase` **(Compute Cores)** (Impact: 50.3)
    * *Intent:* //============================================================================ // Class Bosses //===...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Complexity Load (formerly Cognitive Load) (81.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pd_end_frame` **(Many-Argument Workhorses)** (Impact: 200.8)
  * `draw_composite_columns` **(Many-Argument Workhorses)** (Impact: 176.7)
  * `draw_patch_columns` **(Many-Argument Workhorses)** (Impact: 108.0)
  * `get_patch_decoder` **(Many-Argument Workhorses)** (Impact: 85.3)
  * `push_down_x_guts` **(Many-Argument Workhorses)** (Impact: 80.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_XYMovement` **(Compute Cores)** (Impact: 162.2)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_XYMoveme...
  * `P_ZMovement` **(Compute Cores)** (Impact: 118.2)
    * *Intent:* */
  * `P_SpawnMapThing` **(Compute Cores)** (Impact: 98.1)
    * *Intent:* //========================================================================== // // P_SpawnMapThing /...
  * `P_FloorBounceMissile` **(Compute Cores)** (Impact: 44.1)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_FloorBou...
  * `P_MobjThinker` **(Compute Cores)** (Impact: 43.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `G_BuildTiccmd` **(Many-Argument Workhorses)** (Impact: 175.3)
    * *Intent:* // // G_BuildTiccmd // Builds a ticcmd from all of the available inputs // or reads it from the demo...
  * `G_InitNew` **(Many-Argument Workhorses)** (Impact: 88.3)
  * `G_Ticker` **(I/O & Config Routines)** (Impact: 77.8)
    * *Intent:* // // G_Ticker // Make ticcmd_ts for the players. //
  * `G_Responder` **(Compute Cores)** (Impact: 72.7)
    * *Intent:* // // G_Responder // Get info needed to make ticcmd_ts for the players. //
  * `G_DoCompleted` **(I/O & Config Routines)** (Impact: 57.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.0%), Guard Balance (formerly Safety Score) (96.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.1%)
- **Documentation Coverage:** 96.4706% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `OPL_writeReg` **(Many-Argument Workhorses)** (Impact: 114.8)
  * `OPL_calc_buffer_linear` **(Many-Argument Workhorses)** (Impact: 88.2)
    * *Intent:* // this produces stereo
  * `commit_slot_update` **(Stateful Encapsulated Methods)** (Impact: 43.2)
  * `calc_envelope` **(Stateful Encapsulated Methods)** (Impact: 38.0)
  * `update_output` **(Compute Cores)** (Impact: 33.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_DamageMobj` **(Many-Argument Workhorses)** (Impact: 318.0)
    * *Intent:* */
  * `P_TouchSpecialThing` **(Many-Argument Workhorses)** (Impact: 174.9)
    * *Intent:* //--------------------------------------------------------------------------- // // PROC P_TouchSpec...
  * `P_KillMobj` **(Many-Argument Workhorses)** (Impact: 142.7)
    * *Intent:* //--------------------------------------------------------------------------- // // PROC P_KillMobj ...
  * `TryPickupWeapon` **(Many-Argument Workhorses)** (Impact: 73.8)
    * *Intent:* //========================================================================== // // TryPickupWeapon /...
  * `TryPickupWeaponPiece` **(Many-Argument Workhorses)** (Impact: 57.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (92.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `G_BuildTiccmd` **(Many-Argument Workhorses)** (Impact: 264.4)
  * `G_Responder` **(Compute Cores)** (Impact: 68.3)
    * *Intent:* */
  * `G_Ticker` **(I/O & Config Routines)** (Impact: 55.8)
    * *Intent:* //========================================================================== // // G_Ticker // //===...
  * `G_DoReborn` **(Compute Cores)** (Impact: 28.7)
    * *Intent:* //========================================================================== // // G_DoReborn // //=...
  * `G_InitNew` **(Many-Argument Workhorses)** (Impact: 19.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (91.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `G_BuildTiccmd` **(Many-Argument Workhorses)** (Impact: 176.0)
    * *Intent:* // // G_BuildTiccmd // Builds a ticcmd from all of the available inputs // or reads it from the demo...
  * `G_Responder` **(Compute Cores)** (Impact: 71.0)
    * *Intent:* // // G_Responder // Get info needed to make ticcmd_ts for the players. //
  * `G_InitNew` **(Many-Argument Workhorses)** (Impact: 62.8)
    * *Intent:* // // G_InitNew // // haleyjd 20100824: [STRIFE]: // * Added riftdest initialization // * Removed ep...
  * `G_Ticker` **(I/O & Config Routines)** (Impact: 54.2)
    * *Intent:* // // G_Ticker // Make ticcmd_ts for the players. //
  * `G_CheckSpot` **(Many-Argument Workhorses)** (Impact: 16.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Dead Code Surface (formerly Dead Code) (91.0%), Complexity Load (formerly Cognitive Load) (84.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `SV_MapTeleport` **(Many-Argument Workhorses)** (Impact: 62.3)
    * *Intent:* //========================================================================== // // SV_MapTeleport //...
  * `StreamOutMobjSpecials` **(Compute Cores)** (Impact: 34.7)
  * `StreamInMobjSpecials` **(Stateful Encapsulated Methods)** (Impact: 21.8)
    * *Intent:* // // mobj_t //
  * `CopyFile` **(Many-Argument Workhorses)** (Impact: 18.7)
    * *Intent:* //========================================================================== // // CopyFile // // Th...
  * `StreamIn_player_t` **(I/O & Config Routines)** (Impact: 18.2)
    * *Intent:* // // player_t //
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Dead Code Surface (formerly Dead Code) (83.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `saveg_write_mobj_t` **(Many-Argument Workhorses)** (Impact: 97.3)
  * `saveg_read_mobj_t` **(I/O & Config Routines)** (Impact: 77.9)
    * *Intent:* // // mobj_t //
  * `P_SaveGameWriteFlashSlot` **(Many-Argument Workhorses)** (Impact: 33.2)
  * `P_UnArchiveWorld` **(I/O & Config Routines)** (Impact: 31.8)
    * *Intent:* // // P_UnArchiveWorld //
  * `P_ArchiveWorld` **(I/O & Config Routines)** (Impact: 26.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.67; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CHolySeekerMissile` **(Many-Argument Workhorses)** (Impact: 35.6)
    * *Intent:* //============================================================================ // // CHolySeekerMiss...
  * `P_CheckMana` **(Compute Cores)** (Impact: 29.4)
    * *Intent:* //--------------------------------------------------------------------------- // // FUNC P_CheckMana...
  * `A_ShedShard` **(Compute Cores)** (Impact: 29.3)
  * `A_FAxeAttack` **(Many-Argument Workhorses)** (Impact: 22.8)
    * *Intent:* //============================================================================ // // A_FAxeAttack //...
  * `A_LightningClip` **(Compute Cores)** (Impact: 22.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (89.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `G_BuildTiccmd` **(Many-Argument Workhorses)** (Impact: 200.5)
  * `G_Responder` **(Compute Cores)** (Impact: 68.3)
    * *Intent:* */
  * `G_Ticker` **(I/O & Config Routines)** (Impact: 52.2)
    * *Intent:* */
  * `G_InitNew` **(Many-Argument Workhorses)** (Impact: 34.1)
  * `G_RecordDemo` **(Many-Argument Workhorses)** (Impact: 18.6)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.6%), Debt Markers (formerly Tech Debt) (87.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_NewChaseDir` **(Compute Cores)** (Impact: 55.2)
  * `A_Chase` **(Compute Cores)** (Impact: 54.3)
    * *Intent:* */
  * `P_LookForPlayers` **(Compute Cores)** (Impact: 32.4)
    * *Intent:* */
  * `A_NoBlocking` **(Compute Cores)** (Impact: 23.3)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC A_NoBlocki...
  * `P_RecursiveSound` **(Compute Cores)** (Impact: 21.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `SpawnPolyobj` **(Many-Argument Workhorses)** (Impact: 58.0)
    * *Intent:* //========================================================================== // // SpawnPolyobj // /...
  * `EV_RotatePoly` **(Many-Argument Workhorses)** (Impact: 46.9)
    * *Intent:* //========================================================================== // // EV_RotatePoly // ...
  * `T_PolyDoor` **(Compute Cores)** (Impact: 42.7)
    * *Intent:* //========================================================================== // // T_PolyDoor // //=...
  * `CheckMobjBlocking` **(Many-Argument Workhorses)** (Impact: 35.9)
    * *Intent:* //========================================================================== // // CheckMobjBlocking...
  * `PO_MovePolyobj` **(Many-Argument Workhorses)** (Impact: 34.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_PlayerThink` **(Compute Cores)** (Impact: 166.4)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_PlayerTh...
  * `P_UseArtifact` **(Many-Argument Workhorses)** (Impact: 109.7)
    * *Intent:* //========================================================================== // // P_UseArtifact // ...
  * `P_MovePlayer` **(Compute Cores)** (Impact: 55.3)
    * *Intent:* */
  * `P_DeathThink` **(Compute Cores)** (Impact: 52.6)
    * *Intent:* //========================================================================== // // P_DeathThink // /...
  * `P_BlastMobj` **(Many-Argument Workhorses)** (Impact: 42.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `AM_Responder` **(Compute Cores)** (Impact: 97.3)
  * `AM_clipMline` **(Many-Argument Workhorses)** (Impact: 65.7)
    * *Intent:* // Based on Cohen-Sutherland clipping algorithm but with a slightly // faster reject and precalculat...
  * `DrawWuLine` **(Many-Argument Workhorses)** (Impact: 54.8)
  * `AM_drawFline` **(Compute Cores)** (Impact: 49.1)
    * *Intent:* #undef DOOUTCODE // Classic Bresenham w/ whatever optimizations I need for speed
  * `PUTDOT` **(Stateful Encapsulated Methods)** (Impact: 37.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `AM_Responder` **(Compute Cores)** (Impact: 96.5)
  * `AM_clipMline` **(Many-Argument Workhorses)** (Impact: 65.7)
    * *Intent:* // Based on Cohen-Sutherland clipping algorithm but with a slightly // faster reject and precalculat...
  * `DrawWuLine` **(Many-Argument Workhorses)** (Impact: 54.8)
  * `AM_drawFline` **(Many-Argument Workhorses)** (Impact: 49.1)
    * *Intent:* #undef DOOUTCODE // Classic Bresenham w/ whatever optimizations I need for speed
  * `PUTDOT` **(Stateful Encapsulated Methods)** (Impact: 37.9)
    * *Intent:* /* Wu antialiased line drawer. * (X0,Y0),(X1,Y1) = line to draw * BaseColor = color # of first color...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.8%), Complexity Load (formerly Cognitive Load) (88.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `M_Responder` **(Compute Cores)** (Impact: 256.7)
    * *Intent:* // // CONTROL PANEL // // // M_Responder //
  * `M_Drawer` **(I/O & Config Routines)** (Impact: 30.5)
    * *Intent:* // // M_Drawer // Called after the view has been rendered, // but before it has been blitted. //
  * `M_DrawNetFoyer` **(I/O & Config Routines)** (Impact: 19.2)
  * `M_WriteText` **(Many-Argument Workhorses)** (Impact: 16.1)
    * *Intent:* // // Write a string using the hu_font //
  * `M_Init` **(I/O & Config Routines)** (Impact: 14.2)
    * *Intent:* // // M_Init //
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_XYMovement` **(Compute Cores)** (Impact: 110.0)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_XYMoveme...
  * `P_SpawnMapThing` **(Compute Cores)** (Impact: 73.6)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_SpawnMap...
  * `P_ZMovement` **(Compute Cores)** (Impact: 70.1)
    * *Intent:* */
  * `P_MobjThinker` **(Compute Cores)** (Impact: 47.5)
    * *Intent:* //---------------------------------------------------------------------------- // // PROC P_MobjThin...
  * `P_SpawnMobj` **(Many-Argument Workhorses)** (Impact: 35.3)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (90.0%), Debt Markers (formerly Tech Debt) (83.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `V_DrawPatchList` **(Compute Cores)** (Impact: 93.8)
    * *Intent:* #pragma GCC push_options #if PICO_ON_DEVICE #pragma GCC optimize("O3") #endif
  * `V_DrawPatchN` **(Many-Argument Workhorses)** (Impact: 46.1)
  * `WritePNGfile` **(Many-Argument Workhorses)** (Impact: 34.4)
  * `V_DrawPatchFlipped` **(Many-Argument Workhorses)** (Impact: 31.1)
    * *Intent:* // // V_DrawPatchFlipped // Masks a column based masked pic to the screen. // Flips horizontally, e....
  * `V_CopyRect` **(Many-Argument Workhorses)** (Impact: 29.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `OPL3_WriteReg` **(Many-Argument Workhorses)** (Impact: 76.9)
  * `OPL3_EnvelopeCalc` **(Compute Cores)** (Impact: 75.2)
  * `OPL3_Generate` **(Many-Argument Workhorses)** (Impact: 48.1)
  * `OPL3_ChannelUpdateRhythm` **(Many-Argument Workhorses)** (Impact: 30.5)
  * `OPL3_ChannelSetupAlg` **(Compute Cores)** (Impact: 30.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.67; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.6%), Complexity Load (formerly Cognitive Load) (90.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `M_Responder` **(Compute Cores)** (Impact: 249.0)
    * *Intent:* // // CONTROL PANEL // // // M_Responder //
  * `M_DialogDimMsg` **(Many-Argument Workhorses)** (Impact: 48.4)
    * *Intent:* // // M_DialogDimMsg // // [STRIFE] New function // haleyjd 09/04/10: Painstakingly transformed from...
  * `M_WriteText` **(Many-Argument Workhorses)** (Impact: 22.9)
  ...
  * `M_Drawer` **(I/O & Config Routines)** (Impact: 15.2)
    * *Intent:* // // M_Drawer // Called after the view has been rendered, // but before it has been blitted. //
  * `M_SaveGame` **(Compute Cores)** (Impact: 10.1)
...
- `src/d_event.h` -> **Severity: 0.004** (Bridge: 0.0001 * Flux: 31.0026%)
