...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 5 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 11.52 (structural weight, not risk).
...
| Connectivity (formerly API Exposure) | 3.5 | 8.2 | 5.9 | 5.9 | 8.2 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 5 | 2 | 4 | `package/index.d.ts` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| events | 0 | 0 | 0 | - |
| tests | 0 | 0 | 0 | - |
| docs | 1 | 1 | 1 | `package/index.js` |
| debt | 0 | 0 | 0 | - |
| mutation | 3 | 1 | 3 | `package/index.d.ts` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 0.8 | **LOC:** 5 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 170.94; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (8.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
