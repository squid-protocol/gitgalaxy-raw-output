...
## 1. EXECUTIVE SUMMARY
- **Scope:** 329 analyzed artifact(s), 29993 LOC.
- **Load-bearing artifact:** `tests/data/ignore_directory_gitignore_tests/abc.py` -- 25 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `tests/test_black.py` -- pulls in 40 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/black/trans.py` at magnitude 1989.46 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.224`
> **Composition Archetype:** `Mid Flat Project` (z +2.22; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 26%, Declarative / Non-Code 24%, Generic / Templated Code Files 14%, Interface Declarations Files 12%, Parameter Forwarders Files 9%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 62.4 | 4.6 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 47.2 | 40.0 | 0.0 |
...
- `get_features_used` **(Many-Argument Workhorses)** (@ `src/black/__init__.py`) -> Impact: **127.9** | LOC: 168
- `_maybe_empty_lines_for_class_or_def` **(Many-Argument Workhorses)** (@ `src/black/lines.py`) -> Impact: **95.6** | LOC: 79
- `_maybe_empty_lines` **(Many-Argument Workhorses)** (@ `src/black/lines.py`) -> Impact: **91.2** | LOC: 92
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **15**; blast radius 5.021; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.6%)
- **Documentation Coverage:** 47.4747% of unit weight undocumented
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **18**; blast radius 2.712; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (55.2%)
...
- **Magnitude:** 1716.8 | **LOC:** 3302 | **CtrlFlow:** 4.3% | **Authorship Centralization:** 33.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (75.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.4%), Complexity Load (formerly Cognitive Load) (29.3%), Concurrency Surface (formerly Concurrency) (25.9%)
- **Documentation Coverage:** 92.8375% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `tracefunc` **(Generic / Templated Code)** (Impact: 9.1)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 1423.88 | **LOC:** 1704 | **CtrlFlow:** 23.9% | **Authorship Centralization:** 41.7%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (60.6%)
- **Documentation Coverage:** 79.0323% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 311.8)
  * `get_features_used` **(Many-Argument Workhorses)** (Impact: 127.9)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **12**; blast radius 3.369; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (59.8%)
- **Documentation Coverage:** 28.3951% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_maybe_empty_lines_for_class_or_def` **(Many-Argument Workhorses)** (Impact: 95.6)
  * `_maybe_empty_lines` **(Many-Argument Workhorses)** (Impact: 91.2)
  * `can_omit_invisible_parens` **(Many-Argument Workhorses)** (Impact: 74.2)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **10**; blast radius 10.548; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (84.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.7%)
- **Documentation Coverage:** 22.6087% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **9**; blast radius 3.369; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.7%)
- **Documentation Coverage:** 53.125% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (66.6%), Complexity Load (formerly Cognitive Load) (50.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (19.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_blackd_format_code_limits_executor_queue` **(Type Conversions)** (Impact: 6.9)
  * `test_preserves_line_endings` **(Generic / Templated Code)** (Impact: 3.2)
  * `test_blackd_main` **(Generic / Templated Code)** (Impact: 3.1)
  * `test_normalizes_line_endings` **(Generic / Templated Code)** (Impact: 3.1)
  * `test_blackd_python_variant` **(Generic / Templated Code)** (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **8**; blast radius 14.564; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (71.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `_iterative_matches` **(Stateful Encapsulated Methods)** (Impact: 20.5)
  ...
  * `_submatch` **(Stateful Encapsulated Methods)** (Impact: 19.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `simplify_dfa` **(Generic / Templated Code)** (Impact: 11.4)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **6**; blast radius 6.122; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (41.7%)
- **Documentation Coverage:** 70.8333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_convert_unchanged_line_by_line` **(Stateful Encapsulated Methods)** (Impact: 37.2)
    * *Intent:* """Converts unchanged to STANDALONE_COMMENT line by line."""
  * `adjusted_lines` **(Many-Argument Workhorses)** (Impact: 21.9)
  * `_get_line_range` **(Stateful Encapsulated Methods)** (Impact: 18.2)
  ...
  * `_convert_nodes_to_standalone_comment` **(Stateful Encapsulated Methods)** (Impact: 15.3)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **6**; blast radius 5.718; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (57.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `normalize_unicode_escape_sequences` **(Defensive Guards)** (Impact: 12.8)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **21**; blast radius 2.912; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (44.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `strip_specifier_set` **(Type Conversions)** (Impact: 12.5)
    * *Intent:* """Strip minor versions for some specifiers in the specifier set. For background on version specifie...
  * `path_is_excluded` **(Type Conversions)** (Impact: 12.4)
  * `_path_is_ignored` **(Stateful Encapsulated Methods)** (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **13**; blast radius 3.233; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.0%)
- **Documentation Coverage:** 75.8621% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_tokens` **(Many-Argument Workhorses)** (Impact: 37.5)
    * *Intent:* """Parse a series of tokens and return the syntax tree."""
  * `_partially_consume_prefix` **(Stateful Encapsulated Methods)** (Impact: 21.4)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 3.298; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (58.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `mark` **(Many-Argument Workhorses)** (Impact: 28.9)
  ...
  * `maybe_decrement_after_for_loop_variable` **(Generic / Templated Code)** (Impact: 9.3)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **15**; blast radius 4.308; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (52.9%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `visit_Expr` **(Many-Argument Workhorses)** (Impact: 21.1)
    * *Intent:* """Look for magics in body of cell. For examples, !ls !!ls ?ls ??ls
  * `visit_Assign` **(Many-Argument Workhorses)** (Impact: 13.7)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **21**; blast radius 4.546; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.9%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `maybe_use_uvloop` **(Defensive Guards)** (Impact: 3.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 3.026; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (43.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `determine_route` **(Generic / Templated Code)** (Impact: 10.7)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 270.86 | **LOC:** 335 | **CtrlFlow:** 11.1% | **Authorship Centralization:** 33.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (95.7%), Guard Balance (formerly Safety Score) (87.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **18**; blast radius 8.536; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.5%), Connectivity (formerly Api Exposure) (56.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.6%), Complexity Load (formerly Cognitive Load) (23.5%)
- **Documentation Coverage:** 87.0968% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `assert_format` **(Many-Argument Workhorses)** (Impact: 40.1)
  * `_assert_format_equal` **(Stateful Encapsulated Methods)** (Impact: 17.3)
  * `_assert_format_inner` **(Stateful Encapsulated Methods)** (Impact: 17.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.59; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Complexity Load (formerly Cognitive Load) (43.5%), Debt Markers (formerly Tech Debt) (17.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.59; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Complexity Load (formerly Cognitive Load) (62.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `comment_details` **(Generic / Templated Code)** (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.59; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (33.4%), Complexity Load (formerly Cognitive Load) (16.7%), Connectivity (formerly Api Exposure) (11.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (11.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_unable_to_replace_magics` **(Callbacks & Closures)** (Impact: 3.2)
  * `test_ipynb_and_pyi_flags` **(Defensive Guards)** (Impact: 2.8)
  * `test_cache_isnt_written_if_no_jupyter_deps_single` **(Type Conversions)** (Impact: 2.7)
  * `test_cache_isnt_written_if_no_jupyter_deps_dir` **(Type Conversions)** (Impact: 2.7)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **12**; blast radius 3.592; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (74.7%), Complexity Load (formerly Cognitive Load) (53.0%), Connectivity (formerly Api Exposure) (24.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `get_grammars` **(Generic / Templated Code)** (Impact: 11.3)
  ...
  * `_unwrap_tuples` **(Encapsulated Accessors)** (Impact: 6.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **6**; blast radius 4.936; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `tokenize` **(Many-Argument Workhorses)** (Impact: 50.7)
  * `transform_whitespace` **(Many-Argument Workhorses)** (Impact: 15.8)
  * `emit_stashed_lazy` **(Generic / Templated Code)** (Impact: 6.4)
...
- `src/black/__init__.py` -> Churn: **59.44%** | Cog Load: 51.8425% | Debt: 12.9322%
