...
## 1. EXECUTIVE SUMMARY
- **Scope:** 191 analyzed artifact(s), 19641 LOC.
- **Load-bearing artifact:** `openpyxl-3.1.5/openpyxl/descriptors/serialisable.py` -- 108 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `openpyxl-3.1.5/openpyxl/workbook/workbook.py` -- pulls in 31 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `openpyxl-3.1.5/openpyxl/pivot/table.py` at magnitude 833.56 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.928`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.93; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 40%, Large Core Modules (3) 16%, Many-Argument Workhorses Files 15%, Data / Markup / Trivial 11%, Large Core Modules (2) 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 69.4 | 93.2 | 100.0 |
...
- `parse_cell` **(Many-Argument Workhorses)** (@ `openpyxl-3.1.5/openpyxl/worksheet/_reader.py`) -> Impact: **37.4** | LOC: 56
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 1.958; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.6%)
- **Documentation Coverage:** 81.6327% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_write_rels` **(Stateful Encapsulated Methods)** (Impact: 6.8)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **26**; blast radius 5.283; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 26.1682% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `append` **(Stateful Encapsulated Methods)** (Impact: 23.1)
    * *Intent:* """Appends a group of values at the bottom of the current sheet. * If it's a list: all values are ad...
  * `__getitem__` **(Defensive Guards)** (Impact: 22.7)
  ...
  * `_move_cells` **(Stateful Encapsulated Methods)** (Impact: 20.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 2.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (96.6%), Mutation Surface (formerly State Flux) (85.0%), Complexity Load (formerly Cognitive Load) (80.7%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **30**; blast radius 2.388; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (62.8%)
- **Documentation Coverage:** 85.1852% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_cell` **(Many-Argument Workhorses)** (Impact: 37.4)
  * `parse_row` **(Type Conversions)** (Impact: 16.7)
  ...
  * `parse` **(I/O & Config Routines)** (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 2.603; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (80.7%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 5.301; role: Pure Producer (Foundation)
...
- **Documentation Coverage:** 13.7931% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_parse_string` **(Stateful Encapsulated Methods)** (Impact: 22.6)
    * *Intent:* """ Parse a "-delimited string or '-delimited link. The offset must be pointing to either a single q...
  * `_parse_operator` **(Stateful Encapsulated Methods)** (Impact: 20.2)
    * *Intent:* """ Consume the characters constituting an operator. Returns the number of characters consumed. (Doe...
  * `_parse` **(Stateful Encapsulated Methods)** (Impact: 17.5)
  ...
  * `_parse_separator` **(Stateful Encapsulated Methods)** (Impact: 9.7)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **17**; blast radius 3.876; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (54.6%)
- **Documentation Coverage:** 62.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_write` **(Stateful Encapsulated Methods)** (Impact: 18.6)
    * *Intent:* """ create required structure and the serialise """
  * `_blip_rels` **(Stateful Encapsulated Methods)** (Impact: 12.2)
    * *Intent:* """ Get relationship information for each blip and bind anchor to it Images that are not part of the...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 8.0)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **6**; blast radius 2.616; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.8%)
- **Documentation Coverage:** 77.1429% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 20.1)
  * `to_tree` **(Compute Cores)** (Impact: 7.0)
  * `_guess_operator` **(Stateful Encapsulated Methods)** (Impact: 6.4)
  * `convert` **(Type Conversions)** (Impact: 4.8)
    * *Intent:* """Convert to more specific filter"""
  * `_get_subtype` **(Stateful Encapsulated Methods)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **108** in-repo importer(s); it depends on **7**; blast radius 76.719; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Connectivity (formerly Api Exposure) (87.7%), Complexity Load (formerly Cognitive Load) (86.9%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **17**; blast radius 1.957; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.2%)
- **Documentation Coverage:** 69.5652% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 1.833; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.3%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 34.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `active` **(Stateful Encapsulated Methods)** (Impact: 11.3)
    * *Intent:* """Set the active sheet"""
  * `_add_sheet` **(Stateful Encapsulated Methods)** (Impact: 10.7)
    * *Intent:* """Add an worksheet (at an optional index)."""
  * `_duplicate_name` **(Stateful Encapsulated Methods)** (Impact: 9.3)
  ...
  * `create_sheet` **(Compute Cores)** (Impact: 8.9)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **7**; blast radius 4.832; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (70.4%)
- **Documentation Coverage:** 32.3944% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_check_title` **(Stateful Encapsulated Methods)** (Impact: 7.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **24**; blast radius 2.353; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (52.6%)
- **Documentation Coverage:** 95.8333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `read_worksheets` **(Compute Cores)** (Impact: 29.1)
  * `_validate_archive` **(Stateful Encapsulated Methods)** (Impact: 12.9)
  ...
  * `_find_workbook_part` **(Stateful Encapsulated Methods)** (Impact: 7.8)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **18**; blast radius 2.082; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.4%)
- **Documentation Coverage:** 62.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 20.0)
  * `_normalise_numbers` **(Stateful Encapsulated Methods)** (Impact: 12.6)
  ...
  * `_expand_named_style` **(Stateful Encapsulated Methods)** (Impact: 11.8)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **6**; blast radius 6.021; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (74.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 1.958; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_initialise_columns` **(Stateful Encapsulated Methods)** (Impact: 6.3)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **9**; blast radius 2.505; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.1%)
- **Documentation Coverage:** 65.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 2.259; role: Pure Consumer (Orchestrator)
...
- **Documentation Coverage:** 37.2093% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_bind_value` **(Stateful Encapsulated Methods)** (Impact: 20.5)
    * *Intent:* """Given a value, infer the correct data type"""
  * `hyperlink` **(Stateful Encapsulated Methods)** (Impact: 11.1)
  ...
  * `comment` **(Stateful Encapsulated Methods)** (Impact: 9.3)
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **10**; blast radius 4.033; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Complexity Load (formerly Cognitive Load) (76.5%), Connectivity (formerly Api Exposure) (51.7%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **6**; blast radius 5.531; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Compute Cores)** (Impact: 9.4)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **8**; blast radius 4.2; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.3%), Complexity Load (formerly Cognitive Load) (77.6%), Connectivity (formerly Api Exposure) (57.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 2.861; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.3%), Complexity Load (formerly Cognitive Load) (77.2%), Connectivity (formerly Api Exposure) (51.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **15**; blast radius 1.896; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 66.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_write_worksheets` **(Stateful Encapsulated Methods)** (Impact: 17.9)
  * `_write_comment` **(Stateful Encapsulated Methods)** (Impact: 8.0)
  * `write_data` **(Compute Cores)** (Impact: 7.8)
  * `_merge_vba` **(Stateful Encapsulated Methods)** (Impact: 7.8)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **5**; blast radius 3.622; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **5**; blast radius 30.391; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.3%)
