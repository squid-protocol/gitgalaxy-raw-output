...
## 1. EXECUTIVE SUMMARY
- **Scope:** 32 analyzed artifact(s), 1954 LOC.
- **Load-bearing artifact:** `watchfiles-1.1.1/watchfiles/main.py` -- 7 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `watchfiles-1.1.1/watchfiles/run.py` -- pulls in 23 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `watchfiles-1.1.1/watchfiles/run.py` at magnitude 297.14 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.962`
> **Composition Archetype:** `Small Flat Repo (2)` (z +3.96; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 56%, Large Core Modules (2) 19%, Generic / Templated Code Files 6%, Parameter Forwarders Files 6%, Declarative / Non-Code 3%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 63.3 | 75.0 | 100.0 |
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **23**; blast radius 38.49; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (89.9%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **14**; blast radius 162.255; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.7%), Guard Balance (formerly Safety Score) (92.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `awatch` **(Many-Argument Workhorses)** (Impact: 70.4)
  * `watch` **(Many-Argument Workhorses)** (Impact: 53.6)
  * `_prep_changes` **(Stateful Encapsulated Methods)** (Impact: 9.1)
  * `_log_changes` **(Stateful Encapsulated Methods)** (Impact: 8.9)
  * `_calc_async_timeout` **(Stateful Encapsulated Methods)** (Impact: 7.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (50.0%), Guard Balance (formerly Safety Score) (47.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (45.2%), Complexity Load (formerly Cognitive Load) (26.8%), Connectivity (formerly Api Exposure) (11.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (48.4%), Connectivity (formerly Api Exposure) (10.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **13**; blast radius 45.966; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.8%), Complexity Load (formerly Cognitive Load) (51.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 55.613; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (78.8%), Guard Balance (formerly Safety Score) (76.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (33.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_dir` **(I/O & Config Routines)** (Impact: 4.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (20.7%), Connectivity (formerly Api Exposure) (10.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_args` **(Defensive Guards)** (Impact: 3.3)
  * `test_ignore_paths` **(I/O & Config Routines)** (Impact: 3.1)
  * `test_filter_all` **(Defensive Guards)** (Impact: 3.0)
  * `test_args_command` **(Type Conversions)** (Impact: 3.0)
  * `test_function` **(Type Conversions)** (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
* *High Risk Execution (weighted view):* 0
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **6**; blast radius 118.979; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (71.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (17.1%), Connectivity (formerly Api Exposure) (8.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_default_force_polling_wsl` **(Defensive Guards)** (Impact: 5.6)
  * `test_default_force_polling` **(Defensive Guards)** (Impact: 5.2)
  * `test_watch_polling_env` **(Parameter Forwarders)** (Impact: 3.9)
  * `test_watch_polling_env_with_custom_delay` **(Parameter Forwarders)** (Impact: 3.9)
  * `test_watch_polling_not_env` **(Parameter Forwarders)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (13.9%), Connectivity (formerly Api Exposure) (10.7%), Guard Balance (formerly Safety Score) (8.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__call__` **(Generic / Templated Code)** (Impact: 4.1)
...
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.5%), Test Surface (formerly Verification) (2.4%), Complexity Load (formerly Cognitive Load) (2.1%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **1**; blast radius 119.419; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (69.1%), Connectivity (formerly Api Exposure) (64.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 17.025; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (25.0%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 33.666; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (21.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 17.025; role: Pure Consumer (Orchestrator)
