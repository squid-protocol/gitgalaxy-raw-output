...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 283 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 239.74 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 50%, Compute Cores Files 25%, Large Core Modules (2) 25%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 69.0 | 100.0 | 84.5 | 84.5 | 100.0 |
...
- `usage` **(Compute Cores)** (@ `package/bin/nodetouch.js`) -> Impact: **50.7** | LOC: 109
- `onopen` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **23.4** | LOC: 18
- `validOpts` **(Many-Argument Workhorses)** (@ `package/index.js`) -> Impact: **21.5** | LOC: 30
- `onstatref` **(Compute Cores)** (@ `package/index.js`) -> Impact: **8.9** | LOC: 8
- `exports` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **6.7** | LOC: 13
- `ftouch` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **6.7** | LOC: 13
- `fstat` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **5.5** | LOC: 10
- `futimes` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **5.5** | LOC: 10
- `constructor` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **5.2** | LOC: 19
- `onfstat` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **4.7** | LOC: 9
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 381.443; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Complexity Load (formerly Cognitive Load) (93.8%), Guard Balance (formerly Safety Score) (75.1%)
- **Documentation Coverage:** 68.992% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onopen` **(Defensive Guards)** (Impact: 23.4)
  * `validOpts` **(Many-Argument Workhorses)** (Impact: 21.5)
  * `onstatref` **(Compute Cores)** (Impact: 8.9)
  * `exports` **(Defensive Guards)** (Impact: 6.7)
  * `ftouch` **(Defensive Guards)** (Impact: 6.7)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.7%), Complexity Load (formerly Cognitive Load) (95.3%), Guard Balance (formerly Safety Score) (94.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `usage` **(Compute Cores)** (Impact: 50.7)
**Contextual Mitigations & Amplifications:**
