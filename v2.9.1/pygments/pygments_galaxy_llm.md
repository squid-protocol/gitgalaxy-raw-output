...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1456 analyzed artifact(s), 102032 LOC.
- **Load-bearing artifact:** `pygments/token.py` -- 294 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `tests/examplefiles/rust/eval.rs` -- pulls in 37 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/examplefiles/tads3/tads3_example.t` at magnitude 7880.24 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 1456 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 1253 |
| Total LOC | 102032 |
| Volatility Index | 0.001 |
| % Scanned of codebase = | 53.7% |
...
|---|---|---|---|
| PLAINTEXT | 781 | 2 | 53.6% |
| PYTHON | 377 | 77559 | 25.9% |
| HTML | 140 | 1322 | 9.6% |
| SCALA | 26 | 433 | 1.8% |
...
> **Architectural Drift Z-Score:** `4.137`
> **Composition Archetype:** `Mid Flat Project` (z +4.14; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 67%, Declarative / Non-Code 16%, Compute Cores Files 5%, Parameter Forwarders Files 3%, Large Core Modules (3) 3%
...
|---|---|---|
| Unclassified | 673 | 46.2% |
| Unknown | 2 | 0.1% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 780 | 53.6% |
| Static: Minified & Vendor Opaque Mass | 1 | 0.1% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 1253*
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 100.0 | 10.9 | 2.8 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.9 | 47.6 | 63.8 | 0.0 |
...
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 41.8 | 0.0 | 0.0 |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 54.0 | 8.4 | 13.4 | 13.4 |
...
| cleanup | 87 | 26 | 0 | `tests/examplefiles/make/Makefile` |
| guards | 1965 | 217 | 2 | `tests/examplefiles/cpp/functions.cpp` |
| danger | 1478 | 225 | 2 | `tests/examplefiles/fish/example.fish` |
| concurrency | 759 | 125 | 0 | `pygments/lexers/webmisc.py` |
| connectivity | 2525 | 413 | 4 | `pygments/lexers/templates.py` |
| io | 1350 | 181 | 2 | `tests/examplefiles/tcsh/test.tcsh` |
| crypto | 0 | 0 | 0 | - |
| ipc | 53 | 12 | 0 | `tests/examplefiles/cobol/example.cob` |
...
| debt | 884 | 134 | 0 | `tests/examplefiles/rb/pleac.in.rb` |
| mutation | 25739 | 614 | 36 | `tests/examplefiles/c/ceval.c` |
| dead_code | 1269 | 195 | 1 | `pygments/styles/monokai.py` |
...
- `ASBeautifier::beautify` **(Many-Argument Workhorses)** (@ `tests/examplefiles/cpp/example.cpp`) -> Impact: **605.1** | LOC: 1155
...
- `get_tokens_unprocessed` **(Many-Argument Workhorses)** (@ `pygments/lexers/pascal.py`) -> Impact: **224.2** | LOC: 223
...
- `tests/examplefiles/cobol/example.cob` -> **49** Orphaned Functions | **3** Duplicates
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.6%), Complexity Load (formerly Cognitive Load) (8.0%), Dead Code Surface (formerly Dead Code) (5.4%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.535
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.0%), Complexity Load (formerly Cognitive Load) (49.0%), Dead Code Surface (formerly Dead Code) (5.1%), Connectivity (formerly Api Exposure) (3.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `PyEval_EvalFrameEx` **(Many-Argument Workhorses)** (Impact: 901.3)
  * `Py_MakePendingCalls` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `dump_tsc` **(Many-Argument Workhorses)** (Impact: 6.7)
    * *Intent:* #endif
  * `Py_AddPendingCall` **(Stateful Encapsulated Methods)** (Impact: 6.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.2%), Complexity Load (formerly Cognitive Load) (4.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (34.5%), Dead Code Surface (formerly Dead Code) (7.0%), Connectivity (formerly Api Exposure) (1.1%)
- **Documentation Coverage:** 30.9524% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ASBeautifier::beautify` **(Many-Argument Workhorses)** (Impact: 605.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.4%), Complexity Load (formerly Cognitive Load) (45.9%), Concurrency Surface (formerly Concurrency) (16.4%), Dead Code Surface (formerly Dead Code) (9.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.2%), Complexity Load (formerly Cognitive Load) (30.7%), Connectivity (formerly Api Exposure) (3.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (45.1%), Dead Code Surface (formerly Dead Code) (6.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `from_roman` **(I/O & Config Routines)** (Impact: 34.2)
  * `what_about_that_array` **(I/O & Config Routines)** (Impact: 33.1)
...
- **Magnitude:** 1021.7 | **LOC:** 2621 | **CtrlFlow:** 9.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Credential Material (formerly Secrets Risk) (93.4%), Guard Balance (formerly Safety Score) (86.5%), Complexity Load (formerly Cognitive Load) (37.5%), Dead Code Surface (formerly Dead Code) (5.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `202-Show-And-Change-Switches` **(I/O & Config Routines)** (Impact: 45.9)
  ...
  * `REPOSITORY` **(I/O & Config Routines)** (Impact: 16.5)
  * `213-Run-Compiler` **(I/O & Config Routines)** (Impact: 15.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 201 instances
* *State Mutation (weighted view):* 647
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 189`, `structural_boundaries: 198`, `args: 16`, `func_start: 74`, `class_start: 4`
* *Risk/State:* `safety_bypasses: 2`, `state_mutation: 245`, `dead_code: 2`, `fragile_debt: 1`, `duplicate_logic: 3`, `unreferenced_by_name: 49`
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 0.762; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.8%), Connectivity (formerly Api Exposure) (68.9%), Debt Markers (formerly Tech Debt) (64.1%)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.762
  * `Choke Point (Betweenness):` 7e-06 | `Ripple Effect (Closeness):` 0.000686
...
- **Blast Radius:** changing it is visible to **227** in-repo importer(s); it depends on **9**; blast radius 51.486; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Connectivity (formerly Api Exposure) (80.5%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_preprocess_lexer_input` **(Stateful Encapsulated Methods)** (Impact: 31.7)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 51.486
  * `Choke Point (Betweenness):` 0.000332 | `Ripple Effect (Closeness):` 0.156102
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 0.632; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.632
  * `Choke Point (Betweenness):` 1e-06 | `Ripple Effect (Closeness):` 0.001235
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **2**; blast radius 0.93; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.4%)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.004614
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.535; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (93.4%), Complexity Load (formerly Cognitive Load) (37.4%), Concurrency Surface (formerly Concurrency) (15.9%), Dead Code Surface (formerly Dead Code) (5.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **19**; blast radius 1.141; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `_print_list` **(Stateful Encapsulated Methods)** (Impact: 23.7)
  * `_print_list_as_json` **(Stateful Encapsulated Methods)** (Impact: 14.9)
  * `_parse_options` **(Stateful Encapsulated Methods)** (Impact: 9.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1.1e-05 | `Ripple Effect (Closeness):` 0.001373
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **6**; blast radius 0.845; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (41.3%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_process_declaration` **(Stateful Encapsulated Methods)** (Impact: 53.9)
  ...
  * `_process_declarations` **(Stateful Encapsulated Methods)** (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 0.845
  * `Choke Point (Betweenness):` 5e-06 | `Ripple Effect (Closeness):` 0.002246
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 0.556; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_tokenize` **(Stateful Encapsulated Methods)** (Impact: 22.8)
  * `_tokenize` **(Stateful Encapsulated Methods)** (Impact: 16.7)
  * `_tokenize` **(Stateful Encapsulated Methods)** (Impact: 13.7)
  * `_variable_state` **(Stateful Encapsulated Methods)** (Impact: 12.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.000686
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 0.556; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.6%), Complexity Load (formerly Cognitive Load) (87.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_tokens_unprocessed` **(Many-Argument Workhorses)** (Impact: 224.2)
  * `__init__` **(Type Conversions)** (Impact: 13.1)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.556
  * `Choke Point (Betweenness):` 1e-06 | `Ripple Effect (Closeness):` 0.000686
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 0.753; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (81.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (43.8%)
- **Documentation Coverage:** 93.1034% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_handle_sourcecode` **(Stateful Encapsulated Methods)** (Impact: 48.7)
  * `_handle_codeblock` **(Stateful Encapsulated Methods)** (Impact: 39.4)
  * `_handle_codeblock` **(Stateful Encapsulated Methods)** (Impact: 27.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1.2e-05 | `Ripple Effect (Closeness):` 0.001544
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 0.626; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (35.8%)
- **Documentation Coverage:** 25.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 21.3)
  * `_create_mac` **(Stateful Encapsulated Methods)** (Impact: 21.2)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **5**; blast radius 0.846; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (50.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_make_begin_state` **(Many-Argument Workhorses)** (Impact: 93.4)
  * `get_tokens_unprocessed` **(Many-Argument Workhorses)** (Impact: 41.1)
  * `_make_label_state` **(Stateful Encapsulated Methods)** (Impact: 23.2)
  * `_make_follow_state` **(Stateful Encapsulated Methods)** (Impact: 19.9)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 0.846
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **6**; blast radius 0.677; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (80.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (45.0%)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2e-06 | `Ripple Effect (Closeness):` 0.002059
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **5**; blast radius 1.211; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (44.0%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_get_lexer` **(Stateful Encapsulated Methods)** (Impact: 14.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 6e-06 | `Ripple Effect (Closeness):` 0.00353
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 0.629; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.1%)
- **Documentation Coverage:** 80.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_tokens_unprocessed` **(Many-Argument Workhorses)** (Impact: 88.6)
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 0.629
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.000915
...
- `pygments/token.py` -> **Severity: 17.854** (Embedded: 0.2015 * Error Risk: 88.6135%)
- `pygments/lexer.py` -> **Severity: 15.434** (Embedded: 0.1561 * Error Risk: 98.871%)
- `pygments/util.py` -> **Severity: 9.379** (Embedded: 0.1006 * Error Risk: 93.2787%)
- `pygments/regexopt.py` -> **Severity: 8.159** (Embedded: 0.0829 * Error Risk: 98.4327%)
- `pygments/filter.py` -> **Severity: 5.512** (Embedded: 0.0829 * Error Risk: 66.5013%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `pygments/token.py` -> **Severity: 6745.069** (Blast Radius: 88.529 * Doc Risk: 76.1905%)
- `pygments/lexer.py` -> **Severity: 2845.281** (Blast Radius: 51.486 * Doc Risk: 55.2632%)
- `pygments/style.py` -> **Severity: 1224.1** (Blast Radius: 12.241 * Doc Risk: 100.0%)
- `pygments/filter.py` -> **Severity: 676.841** (Blast Radius: 11.603 * Doc Risk: 58.3333%)
- `pygments/util.py` -> **Severity: 535.833** (Blast Radius: 22.505 * Doc Risk: 23.8095%)
