...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4627 analyzed artifact(s), 951463 LOC.
- **Load-bearing artifact:** `ext/POSIX/lib/POSIX.pm` -- 80 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `perl.h` -- pulls in 110 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `pod/perlsub.pod` at magnitude 44417.32 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 4627 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 2319 |
| Total LOC | 951463 |
...
|---|---|---|
| Modularity | 0.7792 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| Avg Path Length | 2.1067 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 220 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PERL | 4025 | 710652 | 87.0% |
| C | 242 | 219540 | 5.2% |
| PLAINTEXT | 156 | 7 | 3.4% |
| SHELL | 107 | 15038 | 2.3% |
| XML | 33 | 0 | 0.7% |
...
> **Architectural Drift Z-Score:** `4.474`
> **Composition Archetype:** `Flat Modular Platform` (z +4.47; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 42%, Interface Declarations Files 13%, Data / Markup / Trivial 12%, Large Core Modules (3) 12%, Compute Cores Files 6%
...
|---|---|---|
| Unclassified | 4457 | 96.3% |
| Unknown | 7 | 0.2% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 161 | 3.5% |
| Static: Minified & Vendor Opaque Mass | 2 | 0.0% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 2319*

**Composition by Extension & Reason:**
- `no_extension`: 833x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 161x Unsupported Format (.undeterminable), 1x Excluded (Machine-Generated Source Code Signature: 26272 LOC)
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 49.8 | 58.5 | 0.0 |
...
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 54.2 | 53.5 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 42.9 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 61459 | 2027 | 13 | `op.c` |
| cleanup | 4566 | 1040 | 3 | `t/op/write.t` |
| guards | 27686 | 3447 | 8 | `sv.c` |
| danger | 23191 | 2271 | 11 | `t/op/signatures.t` |
| concurrency | 2071 | 369 | 0 | `pod/perlthrtut.pod` |
| connectivity | 20283 | 2242 | 10 | `lib/B/Deparse.pm` |
| io | 16227 | 1472 | 7 | `Makefile.SH` |
| crypto | 0 | 0 | 0 | - |
| ipc | 1613 | 448 | 0 | `pod/perlipc.pod` |
| time | 2843 | 597 | 1 | `Porting/epigraphs.pod` |
| serialization | 11 | 7 | 0 | `cpan/CPAN-Meta-YAML/t/21_yamlpm_compat.t` |
| regex | 26235 | 1972 | 12 | `t/re/subst.t` |
| events | 1803 | 501 | 1 | `cpan/CPAN/lib/CPAN/Distribution.pm` |
| tests | 54806 | 2480 | 27 | `cpan/Unicode-Collate/t/loc_cjkc.t` |
| docs | 14029 | 1064 | 1 | `Porting/epigraphs.pod` |
| debt | 23935 | 2294 | 12 | `t/comp/proto.t` |
| mutation | 155647 | 3710 | 63 | `vms/vms.c` |
| dead_code | 6380 | 1136 | 2 | `lib/B/Deparse.pm` |
| credential | 37 | 17 | 0 | `cpan/ExtUtils-MakeMaker/lib/ExtUtils/MM_Unix.pm` |
| threat | 17530 | 2538 | 6 | `perl.h` |
| ml_ai | 5308 | 585 | 1 | `cpan/Math-BigInt/lib/Math/BigInt.pm` |
| ui | 359 | 134 | 0 | `cpan/CPAN/lib/CPAN/Distribution.pm` |
...
1. **POSIX.pm** (`ext/POSIX/lib/POSIX.pm`) — 80 inbound connections
...
|---|---|---|---|---|
| `pod` | 147 | 287603.92 | 15.0% | 40.1% |
| `__monolith__` | 152 | 161893.82 | 49.5% | 18.03% |
...
| `Porting` | 72 | 16934.98 | 45.23% | 19.09% |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.7%), Guard Balance (formerly Safety Score) (68.2%), Complexity Load (formerly Cognitive Load) (28.2%), Connectivity (formerly Api Exposure) (12.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **62**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Complexity Load (formerly Cognitive Load) (96.8%), Guard Balance (formerly Safety Score) (94.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.8%), Guard Balance (formerly Safety Score) (60.6%), Complexity Load (formerly Cognitive Load) (36.1%), Connectivity (formerly Api Exposure) (10.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.3%), Guard Balance (formerly Safety Score) (59.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (27.6%), Complexity Load (formerly Cognitive Load) (18.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Mutation Surface (formerly State Flux) (80.9%), Guard Balance (formerly Safety Score) (77.7%), Complexity Load (formerly Cognitive Load) (46.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (68.6%), Guard Balance (formerly Safety Score) (62.7%), Complexity Load (formerly Cognitive Load) (31.6%), Concurrency Surface (formerly Concurrency) (14.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.8%), Guard Balance (formerly Safety Score) (54.0%), Complexity Load (formerly Cognitive Load) (53.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (19.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Magnitude:** 15103.76 | **LOC:** 18761 | **CtrlFlow:** 29.4% | **Authorship Centralization:** 31.7%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.1%), Guard Balance (formerly Safety Score) (93.8%), Debt Markers (formerly Tech Debt) (81.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `Perl_sv_clear` **(Many-Argument Workhorses)** (Impact: 790.5)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Complexity Load (formerly Cognitive Load) (95.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.4413% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `store_pipelocs` **(Many-Argument Workhorses)** (Impact: 556.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.177; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (77.1%), Guard Balance (formerly Safety Score) (64.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (16.7%), Debt Markers (formerly Tech Debt) (11.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 14140.24 | **LOC:** 17650 | **CtrlFlow:** 33.9% | **Authorship Centralization:** 29.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Complexity Load (formerly Cognitive Load) (82.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 49.8469% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_8` (Drift: 0.0 IQR)
- **Magnitude:** 13319.06 | **LOC:** 16628 | **CtrlFlow:** 28.8% | **Authorship Centralization:** 90.9%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.4%), Guard Balance (formerly Safety Score) (94.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (94.8%), Complexity Load (formerly Cognitive Load) (83.9%)
- **Documentation Coverage:** 49.6711% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `yyl_word_or_keyword` **(Many-Argument Workhorses)** (Impact: 863.4)
  * `S_scan_const` **(Many-Argument Workhorses)** (Impact: 455.8)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **48**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.7%), Mutation Surface (formerly State Flux) (43.6%), Debt Markers (formerly Tech Debt) (37.4%), Concurrency Surface (formerly Concurrency) (14.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 5 instances
...
- **Global Archetype:** `file_cluster_8` (Drift: 0.0 IQR)
- **Magnitude:** 9769.5 | **LOC:** 12653 | **CtrlFlow:** 30.4% | **Authorship Centralization:** 63.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (97.0%), Guard Balance (formerly Safety Score) (96.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **90**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.6%)
- **Documentation Coverage:** 39.2442% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.177; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (45.9%), Complexity Load (formerly Cognitive Load) (15.8%), Mutation Surface (formerly State Flux) (13.2%), Debt Markers (formerly Tech Debt) (13.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.0%), Mutation Surface (formerly State Flux) (43.3%), Concurrency Surface (formerly Concurrency) (18.3%), Complexity Load (formerly Cognitive Load) (14.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (97.0%), Guard Balance (formerly Safety Score) (91.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (63.6%)
- **Documentation Coverage:** 8.134% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (82.7%), Guard Balance (formerly Safety Score) (69.1%), Complexity Load (formerly Cognitive Load) (63.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.9%), Complexity Load (formerly Cognitive Load) (41.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `displayMessages` **(I/O & Config Routines)** (Impact: 101.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (46.7%), Debt Markers (formerly Tech Debt) (36.3%), Concurrency Surface (formerly Concurrency) (22.9%), Mutation Surface (formerly State Flux) (14.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (76.8%), Complexity Load (formerly Cognitive Load) (31.5%), Concurrency Surface (formerly Concurrency) (12.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.177; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.6%), Mutation Surface (formerly State Flux) (57.7%), Complexity Load (formerly Cognitive Load) (16.2%), Concurrency Surface (formerly Concurrency) (15.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 2 instances
* *Amplified Cascading Flux:* 19 instances
...
- `toke.c` -> Churn: **94.84%** | Cog Load: 83.8528% | Debt: 38.6092%
- `pod/perldelta.pod` -> Churn: **87.69%** | Cog Load: 8.1707% | Debt: 100.0%
- `numeric.c` -> Churn: **80.57%** | Cog Load: 86.4884% | Debt: 76.8921%
- `op.c` -> Churn: **73.59%** | Cog Load: 82.811% | Debt: 73.6831%
- `sv.c` -> Churn: **71.57%** | Cog Load: 96.0705% | Debt: 81.7422%
...
- `regcomp.c` -> **Karl Williamson** (90.9% isolated ownership) | Magnitude: 13319.06
...
- `ext/POSIX/lib/POSIX.pm` -> **Severity: 1.164** (Embedded: 0.0172 * Error Risk: 67.6494%)
- `perl.h` -> **Severity: 0.796** (Embedded: 0.0141 * Error Risk: 56.3529%)
- `t/op/inc.t` -> **Severity: 0.748** (Embedded: 0.0076 * Error Risk: 98.6485%)
...
- `ext/POSIX/lib/POSIX.pm` -> **Severity: 888.3** (Blast Radius: 8.883 * Doc Risk: 100.0%)
- `cpan/Test-Harness/t/errors.t` -> **Severity: 560.6** (Blast Radius: 5.606 * Doc Risk: 100.0%)
- `cpan/IO-Compress/t/compress/any.pl` -> **Severity: 345.4** (Blast Radius: 3.454 * Doc Risk: 100.0%)
- `cpan/Pod-Simple/t/lib/helpers.pm` -> **Severity: 291.1** (Blast Radius: 2.911 * Doc Risk: 100.0%)
- `perl.h` -> **Severity: 199.8** (Blast Radius: 3.996 * Doc Risk: 50.0%)
