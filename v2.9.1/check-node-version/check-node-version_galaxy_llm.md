...
## 1. EXECUTIVE SUMMARY
- **Scope:** 10 analyzed artifact(s), 402 LOC.
- **Load-bearing artifact:** `package/tools.js` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/cli.js` -- pulls in 7 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/index.js` at magnitude 148.82 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 50%, Parameter Forwarders Files 20%, Compute Cores Files 10%, Declarative / Non-Code 10%, Large Core Modules (2) 10%
...
- `normalizeWanted` **(Compute Cores)** (@ `package/index.js`) -> Impact: **3.6** | LOC: 16
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 70.809; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.6%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 100.903; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Guard Balance (formerly Safety Score) (89.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.5%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `optionsFromVolta` **(Defensive Guards)** (Impact: 3.2)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 216.764; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (84.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (35.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getInstallInstructions` **(Parameter Forwarders)** (Impact: 3.2)
  * `hasNvm` **(Defensive Guards)** (Impact: 1.7)
  * `getInstallInstructions` **(Parameter Forwarders)** (Impact: 1.6)
  * `getInstallInstructions` **(Parameter Forwarders)** (Impact: 1.6)
  * `getInstallInstructions` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 100.903; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (6.0%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 70.809; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 156.576; role: Pure Producer (Foundation)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (39.3%), Mutation Surface (formerly State Flux) (16.8%), Complexity Load (formerly Cognitive Load) (4.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `check` **(Parameter Forwarders)** (Impact: 1.8)
  * `check` **(Parameter Forwarders)** (Impact: 1.5)
    * *Intent:* /** * Checks package versions. * */
**Structural Signatures (Net Mitigated Signals):**
