...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 76 LOC.
...
- **Heaviest artifact:** `package/bin.js` at magnitude 27.16 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 80%, Large Core Modules (2) 20%
...
- `build` **(Defensive Guards)** (@ `package/bin.js`) -> Impact: **6.0** | LOC: 20
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 170.94; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (75.6%), Guard Balance (formerly Safety Score) (51.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Debt Markers (formerly Tech Debt) (34.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `build` **(Defensive Guards)** (Impact: 6.0)
