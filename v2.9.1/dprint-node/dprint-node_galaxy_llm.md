# ARCHITECTURAL_BRIEF: dprint-node
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 16 LOC.
...
- **Top orchestrator:** `package/index.d.ts` -- pulls in 1 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/index.js` at magnitude 31.28 (structural weight, not risk).
...
- `.node`: 7x Excluded (Unsupported Extension: '.node')
- `no_extension`: 1x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
- `.ts`: 1x Excluded (Machine-Generated Source Code Signature: 478 LOC)

## 6. STRUCTURAL SURFACE PROFILE (formerly Risk Exposure) ANALYSIS (0-100%)
| Structural Surface Vector | Min | Max | Mean | Med | Mode |
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 4.3 | 49.0 | 26.7 | 26.7 | 4.3 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 75.3 | 37.6 | 37.6 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 50.0 | 25.0 | 25.0 | 50.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 78.9 | 39.5 | 39.5 | 78.9 |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 6 | 1 | 6 | `package/index.js` |
| dead_code | 1 | 1 | 1 | `package/index.d.ts` |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
| ui | 0 | 0 | 0 | - |
...
- `format` **(Compute Cores)** (@ `package/index.d.ts`) -> Impact: **4.0** | LOC: 1
...
- **Magnitude:** 31.28 | **LOC:** 16 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (75.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (49.0%)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` detect-libc
...
- **Magnitude:** 0.25 | **LOC:** 4 | **CtrlFlow:** 50.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.3%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 78.916% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `format` **(Compute Cores)** (Impact: 4.0)
**Structural Signatures (Net Mitigated Signals):**
...
- `package/index.d.ts` -> **Severity: 19729.0** (Blast Radius: 250.0 * Doc Risk: 78.916%)
