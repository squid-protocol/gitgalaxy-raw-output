...
## 1. EXECUTIVE SUMMARY
- **Scope:** 9 analyzed artifact(s), 1645 LOC.
...
- **Top orchestrator:** `package/files/handler.js` -- pulls in 14 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/files/handler.js` at magnitude 856.36 (structural weight, not risk).
...
> **File Composition:** Large Core Modules (2) 33%, Data / Markup / Trivial 22%, Callbacks & Closures Files 11%, Compute Cores Files 11%, Declarative / Non-Code 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 93.1 | 43.0 | 55.8 | 0.0 |
...
- `sirv` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **76.6** | LOC: 77
- `parseSetCookie` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **38.3** | LOC: 73
- `parseString` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **35.7** | LOC: 56
- `find` **(Defensive Guards)** (@ `package/files/index.js`) -> Impact: **34.2** | LOC: 26
- `get_raw_body` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **32.1** | LOC: 87
  * *Intent:* /** */
- `splitCookiesString` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **29.1** | LOC: 72
  * *Intent:* */
- `parse$1` **(Defensive Guards)** (@ `package/files/index.js`) -> Impact: **28.3** | LOC: 26
  * *Intent:* /** */
- `use` **(Defensive Guards)** (@ `package/files/index.js`) -> Impact: **25.8** | LOC: 32
- `setResponse` **(Defensive Guards)** (@ `package/files/handler.js`) -> Impact: **24.4** | LOC: 73
  * *Intent:* /** */ // TODO 3.0 make the signature synchronous?
- `send` **(Many-Argument Workhorses)** (@ `package/files/handler.js`) -> Impact: **23.9** | LOC: 37
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (71.3%), Concurrency Surface (formerly Concurrency) (57.4%)
- **Documentation Coverage:** 62.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sirv` **(Defensive Guards)** (Impact: 76.6)
  * `parseSetCookie` **(Defensive Guards)** (Impact: 38.3)
  * `parseString` **(Defensive Guards)** (Impact: 35.7)
  * `get_raw_body` **(Defensive Guards)** (Impact: 32.1)
    * *Intent:* /** */
  * `splitCookiesString` **(Defensive Guards)** (Impact: 29.1)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.5%), Guard Balance (formerly Safety Score) (90.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 90.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find` **(Defensive Guards)** (Impact: 34.2)
  * `parse$1` **(Defensive Guards)** (Impact: 28.3)
    * *Intent:* /** */
  * `use` **(Defensive Guards)** (Impact: 25.8)
  * `handler` **(Defensive Guards)** (Impact: 21.1)
  * `onError` **(Defensive Guards)** (Impact: 16.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.3%), Guard Balance (formerly Safety Score) (56.7%), Mutation Surface (formerly State Flux) (55.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 55.8336% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `adapt` **(Compute Cores)** (Impact: 17.4)
  * `instrumentation` **(Callbacks & Closures)** (Impact: 1.2)
  * `read` **(Callbacks & Closures)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.7%), Connectivity (formerly Api Exposure) (3.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `timeout_env` **(Defensive Guards)** (Impact: 9.9)
    * *Intent:* /** * Check the environment for a timeout value (non-negative integer) in seconds. */
  * `env` **(Compute Cores)** (Impact: 5.4)
    * *Intent:* /** */
  * `parsing_error` **(State Mutators)** (Impact: 4.2)
    * *Intent:* /** * Throw a consistently-structured parsing error for environment variables. */
**Structural Signatures (Net Mitigated Signals):**
...
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.0%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `installPolyfills` **(I/O & Config Routines)** (Impact: 3.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (5.9%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 93.056% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `plugin` **(Compute Cores)** (Impact: 2.9)
**Structural Signatures (Net Mitigated Signals):**
