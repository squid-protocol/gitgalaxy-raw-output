...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 32 LOC.
...
- **Heaviest artifact:** `package/range.js` at magnitude 51.64 (structural weight, not risk).
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 88.5 | 88.5 | 88.5 | 88.5 | 88.5 |
...
- `map` **(Parameter Forwarders)** (@ `package/range.js`) -> Impact: **3.2** | LOC: 7
- `forEach` **(Parameter Forwarders)** (@ `package/range.js`) -> Impact: **3.1** | LOC: 6
- `forEachAsync` **(Parameter Forwarders)** (@ `package/range.js`) -> Impact: **3.1** | LOC: 5
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.0%), Debt Markers (formerly Tech Debt) (73.1%), Complexity Load (formerly Cognitive Load) (69.0%)
- **Documentation Coverage:** 88.45% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `range` **(Compute Cores)** (Impact: 13.6)
  * `untilB` **(Parameter Forwarders)** (Impact: 3.6)
  * `map` **(Parameter Forwarders)** (Impact: 3.2)
  * `forEach` **(Parameter Forwarders)** (Impact: 3.1)
  * `forEachAsync` **(Parameter Forwarders)** (Impact: 3.1)
