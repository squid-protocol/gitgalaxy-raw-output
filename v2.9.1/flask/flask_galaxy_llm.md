...
## 1. EXECUTIVE SUMMARY
- **Scope:** 123 analyzed artifact(s), 10796 LOC.
- **Load-bearing artifact:** `tests/test_apps/cliapp/inner1/inner2/flask.py` -- 47 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/flask/app.py` -- pulls in 37 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/test_apps/.env` at magnitude 5000.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.533`
> **Composition Archetype:** `Small Flat Repo (2)` (z +2.53; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 46%, Generic / Templated Code Files 13%, Large Core Modules (2) 11%, Large Core Modules (3) 11%, Parameter Forwarders Files 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 52.2 | 59.9 | 0.0 |
...
| connectivity | 1755 | 83 | 37 | `tests/test_basic.py` |
...
- `routes_command` **(Many-Argument Workhorses)** (@ `src/flask/cli.py`) -> Impact: **38.7** | LOC: 47
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (61.1%), Complexity Load (formerly Cognitive Load) (28.1%), Guard Balance (formerly Safety Score) (21.5%), Connectivity (formerly Api Exposure) (14.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_error_handler_after_processor_error` **(Defensive Guards)** (Impact: 8.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 55.6818% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **33**; blast radius 12.286; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.8%)
- **Documentation Coverage:** 61.9718% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `routes_command` **(Many-Argument Workhorses)** (Impact: 38.7)
    * *Intent:* """Show all registered routes with endpoints and methods."""
  ...
  * `_validate_key` **(Stateful Encapsulated Methods)** (Impact: 21.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.2%), Guard Balance (formerly Safety Score) (15.5%), Connectivity (formerly Api Exposure) (14.6%), Complexity Load (formerly Cognitive Load) (13.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_context_processing` **(Defensive Guards)** (Impact: 7.1)
  * `test_nested_callback_order` **(Annotated & Test Methods)** (Impact: 5.6)
  * `test_templates_and_static` **(Defensive Guards)** (Impact: 5.1)
  * `test_nested_blueprint` **(Annotated & Test Methods)** (Impact: 4.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 4.665; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.2%)
- **Documentation Coverage:** 76.4063% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_merge_blueprint_funcs` **(Stateful Encapsulated Methods)** (Impact: 21.6)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **24**; blast radius 12.691; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (75.2%)
- **Documentation Coverage:** 59.3358% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `add_url_rule` **(Many-Argument Workhorses)** (Impact: 39.9)
  * `_find_error_handler` **(Stateful Encapsulated Methods)** (Impact: 17.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (35.5%), Complexity Load (formerly Cognitive Load) (22.2%), Guard Balance (formerly Safety Score) (20.4%), Connectivity (formerly Api Exposure) (13.3%)
- **Documentation Coverage:** 94.3662% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_sort` **(Defensive Guards)** (Impact: 6.7)
  * `test_find_best_app` **(Annotated & Test Methods)** (Impact: 5.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (13.9%), Guard Balance (formerly Safety Score) (4.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **16**; blast radius 10.947; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.9%)
- **Documentation Coverage:** 45.1492% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_find_package_path` **(Stateful Encapsulated Methods)** (Impact: 19.1)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **16**; blast radius 23.299; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (70.7%), Connectivity (formerly Api Exposure) (62.5%)
- **Documentation Coverage:** 60.4167% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_flashed_messages` **(Many-Argument Workhorses)** (Impact: 14.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 12.942; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Connectivity (formerly Api Exposure) (80.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 74.2424% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `register` **(Many-Argument Workhorses)** (Impact: 15.0)
  * `_untag_scan` **(Stateful Encapsulated Methods)** (Impact: 9.2)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **14**; blast radius 13.629; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Complexity Load (formerly Cognitive Load) (56.9%), Connectivity (formerly Api Exposure) (37.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `_copy_environ` **(Encapsulated Accessors)** (Impact: 3.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.2%), Complexity Load (formerly Cognitive Load) (25.3%), Guard Balance (formerly Safety Score) (19.1%), Connectivity (formerly Api Exposure) (13.2%)
- **Documentation Coverage:** 97.8723% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_session_transaction_needs_cookies` **(Parameter Forwarders)** (Impact: 3.1)
  * `test_test_client_context_binding` **(Defensive Guards)** (Impact: 3.1)
  * `test_redirect_session` **(Annotated & Test Methods)** (Impact: 2.8)
  * `test_client_pop_all_preserved` **(Annotated & Test Methods)** (Impact: 2.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (44.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.2%), Complexity Load (formerly Cognitive Load) (15.4%), Guard Balance (formerly Safety Score) (15.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_streaming_with_context_and_custom_close` **(C Struct Operations)** (Impact: 3.5)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **19**; blast radius 15.136; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (88.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 47.619% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pop` **(Many-Argument Workhorses)** (Impact: 15.1)
    * *Intent:* """Pop this context so that it is no longer the active context. Then call teardown functions and sig...
  * `push` **(Stateful Encapsulated Methods)** (Impact: 7.1)
  ...
  * `_get_session` **(Encapsulated Accessors)** (Impact: 6.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.16; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.0%), Connectivity (formerly Api Exposure) (8.2%), Complexity Load (formerly Cognitive Load) (6.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (37.6%), Complexity Load (formerly Cognitive Load) (16.0%), Connectivity (formerly Api Exposure) (11.5%)
- **Documentation Coverage:** 91.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_json_customization` **(Defensive Guards)** (Impact: 8.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (24.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.4%), Connectivity (formerly Api Exposure) (14.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_view_decorators` **(Defensive Guards)** (Impact: 2.7)
  * `test_view_provide_automatic_options_attr_enable` **(Generic / Templated Code)** (Impact: 2.6)
  * `test_multiple_inheritance` **(Defensive Guards)** (Impact: 2.6)
  * `test_remove_method_from_parent` **(Defensive Guards)** (Impact: 2.6)
  * `test_view_inheritance` **(Parameter Forwarders)** (Impact: 2.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **9**; blast radius 13.432; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (49.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `_dump_loader_info` **(Stateful Encapsulated Methods)** (Impact: 12.1)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **12**; blast radius 18.518; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (70.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.7%), Guard Balance (formerly Safety Score) (42.0%), Complexity Load (formerly Cognitive Load) (19.5%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_session_dynamic_cookie_name` **(Annotated & Test Methods)** (Impact: 5.5)
  ...
  * `test_proper_test_request_context` **(Annotated & Test Methods)** (Impact: 3.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (13.9%), Guard Balance (formerly Safety Score) (7.2%), Complexity Load (formerly Cognitive Load) (4.4%)
- **Documentation Coverage:** 93.2584% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_error_handler_no_match` **(Defensive Guards)** (Impact: 5.9)
  * `report_error` **(Parameter Forwarders)** (Impact: 3.8)
  * `test_default_error_handler` **(Annotated & Test Methods)** (Impact: 3.6)
  * `test_error_handler_subclass` **(Annotated & Test Methods)** (Impact: 3.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.16; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.2%), Guard Balance (formerly Safety Score) (33.9%), Complexity Load (formerly Cognitive Load) (16.9%), Connectivity (formerly Api Exposure) (12.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_context_refcounts` **(Defensive Guards)** (Impact: 2.9)
  * `test_app_tearing_down_with_handled_exception_by_app_handler` **(Annotated & Test Methods)** (Impact: 2.8)
