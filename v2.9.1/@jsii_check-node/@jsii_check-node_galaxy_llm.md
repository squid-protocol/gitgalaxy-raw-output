...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 12 LOC.
...
- **Top orchestrator:** `package/jest.config.mjs` -- pulls in 1 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/jest.config.mjs` at magnitude 16.22 (structural weight, not risk).
...
| Connectivity (formerly API Exposure) | 0.0 | 20.1 | 10.0 | 10.0 | 20.1 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 1 | 1 | 1 | `package/jest.config.mjs` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| regex | 0 | 0 | 0 | - |
| events | 0 | 0 | 0 | - |
| tests | 1 | 1 | 1 | `package/jest.config.mjs` |
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 0 | 0 | 0 | - |
| dead_code | 0 | 0 | 0 | - |
...
### `package/jest.config.mjs` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 16.22 | **LOC:** 14 | **CtrlFlow:** 9.1% | **Authorship Centralization:** 0.0%
...
### `package/run.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
