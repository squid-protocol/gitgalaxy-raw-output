...
## 1. EXECUTIVE SUMMARY
- **Scope:** 37 analyzed artifact(s), 6005 LOC.
- **Load-bearing artifact:** `CHANGELOG.md` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/walk.rs` -- pulls in 39 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/tests.rs` at magnitude 317.38 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.997`
> **Composition Archetype:** `Small Flat Repo` (z +2.00; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 32%, Large Core Modules (3) 19%, State Mutators Files 14%, Declarative / Non-Code 11%, Large Core Modules (2) 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 57.2 | 60.5 | 0.0 |
...
- `get_absolute_root_path` **(Many-Argument Workhorses)** (@ `tests/tests.rs`) -> Impact: **128.3** | LOC: 2044
...
- `absolute_path` **(Annotated & Test Methods)** (@ `src/filesystem.rs`) -> Impact: **33.5** | LOC: 133
...
- `build_walker` **(Many-Argument Workhorses)** (@ `src/walk.rs`) -> Impact: **23.7** | LOC: 58
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (55.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (51.7%), Complexity Load (formerly Cognitive Load) (2.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (2.4%)
- **Documentation Coverage:** 71.0526% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_absolute_root_path` **(Many-Argument Workhorses)** (Impact: 128.3)
  * `test_exec_batch` **(I/O & Config Routines)** (Impact: 7.0)
  * `test_exec_batch_multi` **(I/O & Config Routines)** (Impact: 5.3)
  * `test_exec_batch_with_limit` **(Annotated & Test Methods)** (Impact: 4.8)
  * `test_max_results` **(Annotated & Test Methods)** (Impact: 3.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (99.7%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (51.4%), Guard Balance (formerly Safety Score) (48.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `poll` **(Compute Cores)** (Impact: 25.2)
    * *Intent:* /// Wait for a result or state change.
  * `build_walker` **(Many-Argument Workhorses)** (Impact: 23.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (44.2%), Mutation Surface (formerly State Flux) (28.0%)
- **Documentation Coverage:** 96.1538% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `augment_args` **(I/O & Config Routines)** (Impact: 20.5)
  * `search_paths` **(Compute Cores)** (Impact: 12.6)
  * `normalize_path` **(Compute Cores)** (Impact: 9.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 24.318; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (86.5%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (72.8%), Guard Balance (formerly Safety Score) (66.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.2%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (34.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `token_from_pattern_id` **(Compute Cores)** (Impact: 3.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (69.7%), Connectivity (formerly Api Exposure) (9.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (9.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (4.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `normalize_output` **(Generic / Templated Code)** (Impact: 9.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (76.3%), Mutation Surface (formerly State Flux) (52.9%), Guard Balance (formerly Safety Score) (43.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `print_entry_colorized` **(Many-Argument Workhorses)** (Impact: 27.1)
    * *Intent:* // TODO: this function is performance critical and can probably be optimized
  * `print_entry_uncolorized` **(Compute Cores)** (Impact: 10.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (9.8%), Complexity Load (formerly Cognitive Load) (6.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (37.8%), Complexity Load (formerly Cognitive Load) (21.5%), Connectivity (formerly Api Exposure) (12.6%), Test Surface (formerly Verification) (2.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.3%), Debt Markers (formerly Tech Debt) (14.9%), Connectivity (formerly Api Exposure) (11.2%), Complexity Load (formerly Cognitive Load) (4.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `absolute_path` **(Annotated & Test Methods)** (Impact: 33.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (55.2%), Connectivity (formerly Api Exposure) (38.5%), Mutation Surface (formerly State Flux) (35.4%), Complexity Load (formerly Cognitive Load) (11.8%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.1%), Debt Markers (formerly Tech Debt) (20.8%), Mutation Surface (formerly State Flux) (11.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.6%)
- **Documentation Coverage:** 92.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `from_str` **(Defensive Guards)** (Impact: 16.5)
  * `is_time_filter_applicable` **(I/O & Config Routines)** (Impact: 6.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (44.8%), Debt Markers (formerly Tech Debt) (30.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.6%), Complexity Load (formerly Cognitive Load) (7.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `filter_ignore` **(Generic / Templated Code)** (Impact: 4.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (49.2%), Debt Markers (formerly Tech Debt) (39.5%), Complexity Load (formerly Cognitive Load) (9.8%), Connectivity (formerly Api Exposure) (5.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_opt` **(Defensive Guards)** (Impact: 27.2)
  * `is_within` **(State Mutators)** (Impact: 3.8)
  * `from_string` **(Generic / Templated Code)** (Impact: 3.0)
  * `is_within_less_than` **(Annotated & Test Methods)** (Impact: 1.2)
  * `is_within_less_than_equal` **(Annotated & Test Methods)** (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (58.9%), Debt Markers (formerly Tech Debt) (34.3%), Connectivity (formerly Api Exposure) (14.7%), Dead Code Surface (formerly Dead Code) (12.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (76.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.0%), Complexity Load (formerly Cognitive Load) (4.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `pattern_has_uppercase_char_simple` **(Annotated & Test Methods)** (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (26.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.0%), Complexity Load (formerly Cognitive Load) (8.2%), Connectivity (formerly Api Exposure) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fmt` **(Generic / Templated Code)** (Impact: 7.3)
  * `fmt` **(Generic / Templated Code)** (Impact: 5.5)
  * `encode` **(Generic / Templated Code)** (Impact: 4.4)
  * `new` **(Encapsulated Accessors)** (Impact: 3.0)
  * `host` **(Annotated & Test Methods)** (Impact: 2.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 44.987; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (53.2%), Guard Balance (formerly Safety Score) (50.9%), Connectivity (formerly Api Exposure) (29.9%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (92.0%), Guard Balance (formerly Safety Score) (43.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.6%), Connectivity (formerly Api Exposure) (6.1%)
- **Documentation Coverage:** 77.7778% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exit` **(Compute Cores)** (Impact: 4.9)
  ...
  * `general_error_if_at_least_one_error` **(Annotated & Test Methods)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 24.318; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (13.9%), Connectivity (formerly Api Exposure) (6.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `basename` **(Defensive Guards)** (Impact: 1.6)
    * *Intent:* /// Removes the parent component of the path
  * `correct` **(State Mutators)** (Impact: 1.6)
  * `dirname_root` **(Annotated & Test Methods)** (Impact: 1.3)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 62.558; role: Pure Producer (Foundation)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 24.318; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.7%), Mutation Surface (formerly State Flux) (69.0%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(I/O & Config Routines)** (Impact: 2.5)
  * `enter` **(State Mutators)** (Impact: 2.0)
  * `type` **(Parameter Forwarders)** (Impact: 1.6)
