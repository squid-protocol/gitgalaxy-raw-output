...
## 1. EXECUTIVE SUMMARY
- **Scope:** 108 analyzed artifact(s), 17144 LOC.
- **Load-bearing artifact:** `src/zap.zig` -- 42 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `facil.io/tests/slowloris.c` -- pulls in 28 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/deps/cimport.zig` at magnitude 6134.76 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.2`
> **Composition Archetype:** `Small Flat Repo (2)` (z +1.20; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 32%, Data / Markup / Trivial 28%, Encapsulated Accessors Files 11%, Large Core Modules (3) 7%, State Mutators Files 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 68.3 | 97.4 | 100.0 |
...
- `main` **(Many-Argument Workhorses)** (@ `facil.io/tests/slowloris.c`) -> Impact: **55.3** | LOC: 102
  * *Intent:* ***************************************************************************** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (29.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.5%), Complexity Load (formerly Cognitive Load) (34.3%), Connectivity (formerly Api Exposure) (2.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `load_words` **(I/O & Config Routines)** (Impact: 14.3)
  ...
  * `test_hash_function` **(Stateful Encapsulated Methods)** (Impact: 11.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); blast radius 65.914; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Dead Code Surface (formerly Dead Code) (15.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (38.6%), Dead Code Surface (formerly Dead Code) (6.7%), Connectivity (formerly Api Exposure) (0.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `run_test` **(Stateful Encapsulated Methods)** (Impact: 21.5)
  * `compute_pvalue` **(Compute Cores)** (Impact: 18.8)
    * *Intent:* #endif
  * `scan_batch` **(Stateful Encapsulated Methods)** (Impact: 13.3)
    * *Intent:* #else
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 23.891; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (68.6%), Mutation Surface (formerly State Flux) (56.8%), Guard Balance (formerly Safety Score) (36.7%)
- **Documentation Coverage:** 18.2796% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **2**; blast radius 36.205; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (68.3%), Guard Balance (formerly Safety Score) (15.0%), Debt Markers (formerly Tech Debt) (14.1%), Dead Code Surface (formerly Dead Code) (13.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 23.891; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (61.0%), Mutation Surface (formerly State Flux) (36.9%), Guard Balance (formerly Safety Score) (35.3%), Dead Code Surface (formerly Dead Code) (20.6%)
- **Documentation Coverage:** 49.3671% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `onRequest` **(Defensive Guards)** (Impact: 21.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.3%), Concurrency Surface (formerly Concurrency) (53.6%), Complexity Load (formerly Cognitive Load) (30.5%), Connectivity (formerly Api Exposure) (0.2%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 55.3)
    * *Intent:* ***************************************************************************** */
  * `test_server` **(Compute Cores)** (Impact: 28.4)
    * *Intent:* ***************************************************************************** */
  * `attack_server` **(Compute Cores)** (Impact: 25.4)
    * *Intent:* ***************************************************************************** */
  * `wait__internal` **(C Struct Operations)** (Impact: 18.6)
    * *Intent:* ***************************************************************************** */ /** Waits for socke...
  * `test_server_task` **(Stateful Encapsulated Methods)** (Impact: 15.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (46.3%), Concurrency Surface (formerly Concurrency) (25.0%), Connectivity (formerly Api Exposure) (4.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **3**; blast radius 26.013; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (65.4%), Guard Balance (formerly Safety Score) (26.7%), Dead Code Surface (formerly Dead Code) (15.4%), Mutation Surface (formerly State Flux) (14.2%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 11.012; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (82.6%), Complexity Load (formerly Cognitive Load) (29.6%), Connectivity (formerly Api Exposure) (13.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mustache_test_callback` **(Many-Argument Workhorses)** (Impact: 37.3)
  * `mustache_print_instructions` **(Stateful Encapsulated Methods)** (Impact: 21.9)
  * `mustache_on_section_test` **(Stateful Encapsulated Methods)** (Impact: 12.1)
  * `mustache_test` **(I/O & Config Routines)** (Impact: 10.0)
  * `save2file` **(Stateful Encapsulated Methods)** (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.2%), Complexity Load (formerly Cognitive Load) (29.3%), Connectivity (formerly Api Exposure) (0.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `seek_memchr` **(Stateful Encapsulated Methods)** (Impact: 6.6)
  * `seek1` **(Stateful Encapsulated Methods)** (Impact: 6.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.281; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (60.9%), Guard Balance (formerly Safety Score) (34.6%), Dead Code Surface (formerly Dead Code) (13.3%), Complexity Load (formerly Cognitive Load) (4.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `internal_subscription_on_message` **(Type Conversions)** (Impact: 7.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.4%), Mutation Surface (formerly State Flux) (65.2%), Complexity Load (formerly Cognitive Load) (41.8%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 5.19; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.5%), Connectivity (formerly Api Exposure) (55.3%), Complexity Load (formerly Cognitive Load) (17.5%), Dead Code Surface (formerly Dead Code) (2.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `on_http_request` **(Stateful Encapsulated Methods)** (Impact: 5.4)
    * *Intent:* ***************************************************************************** */
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
* *Amplified Cascading Flux:* 11 instances
...
- **Blast Radius:** changing it is visible to **42** in-repo importer(s); it depends on **14**; blast radius 230.738; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (71.0%), Debt Markers (formerly Tech Debt) (48.8%), Guard Balance (formerly Safety Score) (35.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (66.7%), Guard Balance (formerly Safety Score) (55.2%), Complexity Load (formerly Cognitive Load) (30.7%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 5.19; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (71.8%), Complexity Load (formerly Cognitive Load) (24.2%), Connectivity (formerly Api Exposure) (0.6%)
- **Documentation Coverage:** 91.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `initialize_cli` **(Many-Argument Workhorses)** (Impact: 31.8)
    * *Intent:* ***************************************************************************** */
  * `on_http_upgrade` **(Stateful Encapsulated Methods)** (Impact: 23.6)
    * *Intent:* /* HTTP upgrade callback */
  * `main` **(Compute Cores)** (Impact: 8.5)
  * `initialize_redis` **(Stateful Encapsulated Methods)** (Impact: 4.8)
    * *Intent:* ***************************************************************************** */
  * `ws_on_message` **(Stateful Encapsulated Methods)** (Impact: 2.6)
    * *Intent:* ***************************************************************************** */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.9%), Complexity Load (formerly Cognitive Load) (40.6%), Connectivity (formerly Api Exposure) (0.2%)
- **Documentation Coverage:** 78.5714% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 22.6)
    * *Intent:* */
  * `answer_http_upgrade` **(Stateful Encapsulated Methods)** (Impact: 14.4)
  * `handle_websocket_messages` **(Stateful Encapsulated Methods)** (Impact: 11.2)
  * `redis_initialize` **(Stateful Encapsulated Methods)** (Impact: 5.8)
  * `logger_publish` **(Encapsulated Accessors)** (Impact: 2.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 6.5; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (71.3%), Complexity Load (formerly Cognitive Load) (46.0%), Connectivity (formerly Api Exposure) (9.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `update` **(Defensive Guards)** (Impact: 10.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.281; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.6%), Connectivity (formerly Api Exposure) (59.4%), Guard Balance (formerly Safety Score) (42.0%), Dead Code Surface (formerly Dead Code) (15.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.281; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.0%), Complexity Load (formerly Cognitive Load) (49.1%), Dead Code Surface (formerly Dead Code) (2.7%), Connectivity (formerly Api Exposure) (0.2%)
- **Documentation Coverage:** 84.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 32.6)
    * *Intent:* ***************************************************************************** */
  * `on_connect` **(Stateful Encapsulated Methods)** (Impact: 4.4)
  * `on_data` **(Stateful Encapsulated Methods)** (Impact: 4.2)
    * *Intent:* ***************************************************************************** */
  * `repl_on_data` **(Stateful Encapsulated Methods)** (Impact: 4.0)
    * *Intent:* ***************************************************************************** */
  * `on_shutdown` **(Encapsulated Accessors)** (Impact: 2.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.281; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.4%), Guard Balance (formerly Safety Score) (40.6%), Debt Markers (formerly Tech Debt) (26.2%)
- **Documentation Coverage:** 17.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
