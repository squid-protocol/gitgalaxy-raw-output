...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2680 analyzed artifact(s), 572466 LOC.
- **Load-bearing artifact:** `wp-includes/php-ai-client/src/Common/Exception/InvalidArgumentException.php` -- 38 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `wp-includes/blocks/blocks-json.php` -- pulls in 1031 dependencies, the widest assembly point in the scan.
...
> **Architectural Drift Z-Score:** `4.624`
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 8.8 | 0.0 | 0.0 |
...
| connectivity | 8810 | 729 | 10 | `wp-content/themes/twentytwentyone/style-rtl.css` |
...
- `parseEBML` **(Many-Argument Workhorses)** (@ `wp-includes/ID3/module.audio-video.matroska.php`) -> Impact: **559.9** | LOC: 733
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **121**; blast radius 0.338; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Debt Markers (formerly Tech Debt) (85.6%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **225**; blast radius 0.338; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (39.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **116**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **138**; blast radius 0.338; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (46.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `wp_prepare_attachment_for_js` **(Many-Argument Workhorses)** (Impact: 81.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **93**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (75.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.338; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (85.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `Analyze` **(I/O & Config Routines)** (Impact: 108.6)
    * *Intent:* /** * @return bool */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 0.338; role: Pure Consumer (Orchestrator)
...
**Top Internal Functions/Classes:**
  ...
  * `parse_tax_query` **(Many-Argument Workhorses)** (Impact: 77.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **50**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.6%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (31.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **64**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **141**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **77**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **51**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **115**; blast radius 0.338; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **69**; blast radius 0.338; role: Isolated/Orphan
