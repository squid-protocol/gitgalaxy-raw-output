...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2196 analyzed artifact(s), 809711 LOC.
- **Load-bearing artifact:** `numpy-2.4.4/doc/source/_static/numpy.css` -- 440 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `numpy-2.4.4/numpy/_core/src/multiarray/multiarraymodule.c` -- pulls in 60 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `numpy-2.4.4/numpy/linalg/lapack_lite/f2c_blas.c` at magnitude 37170.98 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.0`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.00; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 20%, Data / Markup / Trivial 16%, Parameter Forwarders Files 12%, Generic / Templated Code Files 12%, Large Core Modules (3) 9%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 62.1 | 97.1 | 100.0 |
...
| connectivity | 27960 | 1468 | 30 | `numpy-2.4.4/numpy/_core/tests/test_multiarray.py` |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 68.2% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.2%)
- **Documentation Coverage:** 68.2% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.4%)
- **Documentation Coverage:** 68.2% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.0%), Connectivity (formerly Api Exposure) (14.1%)
- **Documentation Coverage:** 98.811% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.24; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (89.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 76.1538% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `analyzevars` **(Many-Argument Workhorses)** (Impact: 241.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.7%)
- **Documentation Coverage:** 16.9216% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__setitem__` **(Stateful Encapsulated Methods)** (Impact: 47.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.1%)
- **Documentation Coverage:** 93.1148% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **16**; blast radius 0.496; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.6%)
- **Documentation Coverage:** 49.7561% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (96.6%), Guard Balance (formerly Safety Score) (94.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.8198% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.7%), Connectivity (formerly Api Exposure) (13.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_loss_of_precision` **(Many-Argument Workhorses)** (Impact: 30.5)
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **16**; blast radius 1.399; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.9%), Complexity Load (formerly Cognitive Load) (85.3%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **54**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (95.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 94.544% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **60**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Complexity Load (formerly Cognitive Load) (80.6%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **49**; blast radius 0.292; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.5%)
- **Documentation Coverage:** 81.9355% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_compiler_detection` **(Defensive Guards)** (Impact: 71.6)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (94.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Complexity Load (formerly Cognitive Load) (89.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.8912% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **30**; blast radius 0.445; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (96.6%)
- **Documentation Coverage:** 97.1631% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `log` **(Many-Argument Workhorses)** (Impact: 97.5)
    * *Intent:* """Log a single test case."""
  * `parse_line` **(Many-Argument Workhorses)** (Impact: 88.3)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 71.5)
  * `_run_tests` **(Many-Argument Workhorses)** (Impact: 51.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (84.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.4%), Connectivity (formerly Api Exposure) (13.0%)
- **Documentation Coverage:** 99.4318% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_inplace_division_scalar_type` **(Defensive Guards)** (Impact: 8.9)
    * *Intent:* # Test of inplace division othertypes, uint8data = self._create_otherdata() with warnings.catch_warn...
  * `test_eq_ne_structured_extra` **(I/O & Config Routines)** (Impact: 8.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Complexity Load (formerly Cognitive Load) (89.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **30**; blast radius 3.0; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (73.3%)
- **Documentation Coverage:** 84.264% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_paths` **(Many-Argument Workhorses)** (Impact: 44.7)
  * `calc_info` **(Compute Cores)** (Impact: 38.5)
  * `_parse_env_order` **(Many-Argument Workhorses)** (Impact: 31.8)
  ...
  * `calc_info` **(I/O & Config Routines)** (Impact: 27.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
