...
## 1. EXECUTIVE SUMMARY
- **Scope:** 18 analyzed artifact(s), 874 LOC.
- **Load-bearing artifact:** `package/src/app/context.ts` -- 9 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/src/app/analytics-node.ts` -- pulls in 11 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/plugins/segmentio/publisher.ts` at magnitude 206.74 (structural weight, not risk).
...
| Avg Path Length | 1.6429 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **File Composition:** Data / Markup / Trivial 39%, Declarative / Non-Code 17%, Large Core Modules (2) 17%, Callbacks & Closures Files 6%, Generic / Templated Code Files 6%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 70.8 | 14.6 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 44.0 | 10.4 | 0.0 |
...
- `send` **(Compute Cores)** (@ `package/src/plugins/segmentio/publisher.ts`) -> Impact: **41.3** | LOC: 119
- `constructor` **(Defensive Guards)** (@ `package/src/plugins/segmentio/publisher.ts`) -> Impact: **22.6** | LOC: 36
- `constructor` **(Defensive Guards)** (@ `package/src/app/analytics-node.ts`) -> Impact: **18.8** | LOC: 37
- `enqueue` **(Defensive Guards)** (@ `package/src/plugins/segmentio/publisher.ts`) -> Impact: **17.1** | LOC: 59
  * *Intent:* /** * Enqueues the context for future delivery. */
- `flush` **(Defensive Guards)** (@ `package/src/app/analytics-node.ts`) -> Impact: **12.8** | LOC: 30
...
- `dispatchAndEmit` **(Many-Argument Workhorses)** (@ `package/src/app/dispatch-emit.ts`) -> Impact: **12.6** | LOC: 28
  * *Intent:* /* Dispatch function, but swallow promise rejections and use event emitter instead */
- `page` **(Defensive Guards)** (@ `package/src/app/analytics-node.ts`) -> Impact: **11.5** | LOC: 22
  * *Intent:* /** * The page method lets you record page views on your website, along with optional extra information about the page being viewed. */
- `screen` **(Defensive Guards)** (@ `package/src/app/analytics-node.ts`) -> Impact: **11.5** | LOC: 23
...
- `flush` **(Defensive Guards)** (@ `package/src/plugins/segmentio/publisher.ts`) -> Impact: **9.9** | LOC: 29
- `_dispatch` **(Stateful Encapsulated Methods)** (@ `package/src/app/analytics-node.ts`) -> Impact: **7.8** | LOC: 18
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 39.435; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.0%)
- **Documentation Coverage:** 83.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(Compute Cores)** (Impact: 41.3)
  * `constructor` **(Defensive Guards)** (Impact: 22.6)
  * `enqueue` **(Defensive Guards)** (Impact: 17.1)
    * *Intent:* /** * Enqueues the context for future delivery. */
  * `flush` **(Defensive Guards)** (Impact: 9.9)
  * `createBatch` **(Stateful Encapsulated Methods)** (Impact: 4.8)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 63.596; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.5%), Mutation Surface (formerly State Flux) (84.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (52.1%)
- **Documentation Coverage:** 20.8333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 18.8)
  * `flush` **(Defensive Guards)** (Impact: 12.8)
    * *Intent:* /** * Call this method to flush all existing events.. * This method also waits for any event method-...
  * `page` **(Defensive Guards)** (Impact: 11.5)
    * *Intent:* /** * The page method lets you record page views on your website, along with optional extra informat...
  * `screen` **(Defensive Guards)** (Impact: 11.5)
    * *Intent:* /** * Records screen views on your app, along with optional extra information * about the screen vie...
  * `_dispatch` **(Stateful Encapsulated Methods)** (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 41.902; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (35.1%), Mutation Surface (formerly State Flux) (34.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `tryAdd` **(Compute Cores)** (Impact: 7.1)
  * `constructor` **(State Mutators)** (Impact: 1.6)
  * `calculateSize` **(Encapsulated Accessors)** (Impact: 1.6)
  * `getEvents` **(Interface Declarations)** (Impact: 1.2)
  * `length` **(Interface Declarations)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 39.738; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (76.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (31.8%), Complexity Load (formerly Cognitive Load) (15.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dispatchAndEmit` **(Many-Argument Workhorses)** (Impact: 12.6)
    * *Intent:* /* Dispatch function, but swallow promise rejections and use event emitter instead */
  * `normalizeDispatchCb` **(Callbacks & Closures)** (Impact: 3.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 56.848; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (56.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **5**; blast radius 70.877; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (36.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 30.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Concurrency Surface (formerly Concurrency) (48.2%), Debt Markers (formerly Tech Debt) (41.5%), Complexity Load (formerly Cognitive Load) (8.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `normalizeEvent` **(State Mutators)** (Impact: 3.3)
  * `createNodePlugin` **(Callbacks & Closures)** (Impact: 2.4)
  * `createConfiguredNodePlugin` **(Callbacks & Closures)** (Impact: 2.2)
  * `action` **(Generic / Templated Code)** (Impact: 1.6)
  * `isLoaded` **(Callbacks & Closures)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 30.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 39.435; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 30.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Dead Code Surface (formerly Dead Code) (30.8%), Connectivity (formerly Api Exposure) (5.6%), Complexity Load (formerly Cognitive Load) (5.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 39.738; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (56.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Dead Code Surface (formerly Dead Code) (30.8%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `screen` **(Generic / Templated Code)** (Impact: 2.1)
  * `onFinishedEvent` **(Callbacks & Closures)** (Impact: 1.7)
  * `page` **(Generic / Templated Code)** (Impact: 1.5)
  * `constructor` **(Callbacks & Closures)** (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 39.435; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 50.997; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (34.1%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getAttempts` **(Defensive Guards)** (Impact: 4.4)
    * *Intent:* // do not use an internal "seen" map
  * `updateAttempts` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **3**; blast radius 112.087; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (35.3%), Complexity Load (formerly Cognitive Load) (3.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `validateSettings` **(Defensive Guards)** (Impact: 3.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **2**; blast radius 212.831; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (40.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `system` **(Interface Declarations)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 39.435; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (54.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (13.4%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- `package/src/app/event-queue.ts` -> **Severity: 9.201** (Embedded: 0.1765 * Error Risk: 52.1415%)
- `package/src/app/analytics-node.ts` -> **Severity: 8.165** (Embedded: 0.1569 * Error Risk: 52.0536%)
- `package/src/plugins/segmentio/context-batch.ts` -> **Severity: 4.657** (Embedded: 0.0784 * Error Risk: 59.3812%)
- `package/src/plugins/segmentio/publisher.ts` -> **Severity: 4.164** (Embedded: 0.0588 * Error Risk: 70.7879%)
