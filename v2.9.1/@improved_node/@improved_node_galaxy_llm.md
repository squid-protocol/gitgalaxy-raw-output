...
## 1. EXECUTIVE SUMMARY
- **Scope:** 20 analyzed artifact(s), 195 LOC.
- **Load-bearing artifact:** `package/assert.js` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/crypto.js` -- pulls in 2 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/crypto.js` at magnitude 23.64 (structural weight, not risk).
...
- `.map`: 6x Unresolved Ambiguity (No Retainable Structure)
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 67.8 | 16.0 | 0.0 | 0.0 |
...
- `scrypt` **(Generic / Templated Code)** (@ `package/crypto.d.ts`) -> Impact: **2.5** | LOC: 6
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 64.799; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.2%), Guard Balance (formerly Safety Score) (72.0%), Connectivity (formerly Api Exposure) (55.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 64.799
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 35.026; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (31.8%), Mutation Surface (formerly State Flux) (31.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 35.026
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 64.799; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (21.5%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 13.56 | **LOC:** 4 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 35.026; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 35.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Debt Markers (formerly Tech Debt) (43.2%), Connectivity (formerly Api Exposure) (13.3%)
- **Documentation Coverage:** 67.822% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pbkdf2` **(Generic / Templated Code)** (Impact: 2.9)
  * `scrypt` **(Generic / Templated Code)** (Impact: 2.5)
...
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 35.026
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.6%), Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (10.6%)
- **Documentation Coverage:** 67.822% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (88.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.6%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 67.822% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decode` **(Parameter Forwarders)** (Impact: 1.5)
...
- `package/crypto.js` -> **Severity: 2.879** (Embedded: 0.04 * Error Risk: 71.9676%)
- `package/assert.js` -> **Severity: 2.583** (Embedded: 0.04 * Error Risk: 64.5656%)
- `package/fs.js` -> **Severity: 2.583** (Embedded: 0.04 * Error Risk: 64.5656%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `package/crypto.d.ts` -> **Severity: 2375.533** (Blast Radius: 35.026 * Doc Risk: 67.822%)
- `package/process.d.ts` -> **Severity: 2375.533** (Blast Radius: 35.026 * Doc Risk: 67.822%)
- `package/punycode-ucs2.d.ts` -> **Severity: 2375.533** (Blast Radius: 35.026 * Doc Risk: 67.822%)
- `package/stream.d.ts` -> **Severity: 2375.533** (Blast Radius: 35.026 * Doc Risk: 67.822%)
