...
## 1. EXECUTIVE SUMMARY
- **Scope:** 103 analyzed artifact(s), 24426 LOC.
- **Load-bearing artifact:** `CONTRIBUTING.md` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `tests/client.rs` -- pulls in 70 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/proto/h1/role.rs` at magnitude 1187.36 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.504`
> **Composition Archetype:** `Small Flat Repo` (z +1.50; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 25%, Large Core Modules (3) 18%, Data / Markup / Trivial 17%, Encapsulated Accessors Files 11%, State Mutators Files 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 56.0 | 50.0 | 100.0 |
...
- `poll_write` **(Many-Argument Workhorses)** (@ `src/proto/h1/dispatch.rs`) -> Impact: **72.2** | LOC: 94
...
- `poll_read` **(Many-Argument Workhorses)** (@ `src/proto/h1/dispatch.rs`) -> Impact: **41.9** | LOC: 75
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (55.8%)
- **Documentation Coverage:** 96.7033% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **66**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (89.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (86.1%), Complexity Load (formerly Cognitive Load) (17.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run_test` **(Compute Cores)** (Impact: 15.6)
  * `h2_connect_multiplex` **(I/O & Config Routines)** (Impact: 15.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **70**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (86.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Connectivity (formerly Api Exposure) (47.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_try_send_request` **(I/O & Config Routines)** (Impact: 12.1)
  * `http2_detect_conn_eof` **(I/O & Config Routines)** (Impact: 7.0)
  * `connect_method` **(Annotated & Test Methods)** (Impact: 6.5)
  * `upgrade` **(Annotated & Test Methods)** (Impact: 6.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.7%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Guard Balance (formerly Safety Score) (61.5%)
- **Documentation Coverage:** 98.4127% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `poll_read_head` **(Many-Argument Workhorses)** (Impact: 37.4)
  * `poll_read_body` **(Many-Argument Workhorses)** (Impact: 29.2)
  * `maybe_notify` **(Compute Cores)** (Impact: 17.9)
  * `write_trailers` **(Stateful Encapsulated Methods)** (Impact: 16.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **35**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (82.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decode` **(Many-Argument Workhorses)** (Impact: 41.1)
  * `read_body` **(Many-Argument Workhorses)** (Impact: 17.4)
  * `test_read_chunk_size` **(Annotated & Test Methods)** (Impact: 16.8)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (61.1%), Guard Balance (formerly Safety Score) (55.0%), Mutation Surface (formerly State Flux) (41.6%)
- **Documentation Coverage:** 91.4894% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `poll_write` **(Many-Argument Workhorses)** (Impact: 72.2)
  * `poll_read` **(Many-Argument Workhorses)** (Impact: 41.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (69.0%), Guard Balance (formerly Safety Score) (51.2%), Connectivity (formerly Api Exposure) (35.0%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `poll_flush` **(Stateful Encapsulated Methods)** (Impact: 24.3)
  ...
  * `buffer` **(Stateful Encapsulated Methods)** (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (98.8%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Concurrency Surface (formerly Concurrency) (93.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (52.2%)
- **Documentation Coverage:** 93.75% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `poll` **(Many-Argument Workhorses)** (Impact: 50.9)
  * `poll` **(Generic / Templated Code)** (Impact: 13.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (75.0%), Complexity Load (formerly Cognitive Load) (42.2%), Connectivity (formerly Api Exposure) (11.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `async_test` **(Compute Cores)** (Impact: 32.0)
  * `naive_proxy` **(Compute Cores)** (Impact: 20.4)
  * `__run_test` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.2%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (76.1%), Guard Balance (formerly Safety Score) (68.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `record_data` **(Stateful Encapsulated Methods)** (Impact: 17.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.8%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (71.5%), Guard Balance (formerly Safety Score) (47.0%)
- **Documentation Coverage:** 44.1176% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.5%), Mutation Surface (formerly State Flux) (36.1%), Connectivity (formerly Api Exposure) (34.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `encode_trailers` **(Many-Argument Workhorses)** (Impact: 26.8)
  * `encode` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `encode_and_end` **(Stateful Encapsulated Methods)** (Impact: 8.2)
  * `advance` **(Parameter Forwarders)** (Impact: 4.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (78.0%), Guard Balance (formerly Safety Score) (60.7%), Connectivity (formerly Api Exposure) (46.6%), Mutation Surface (formerly State Flux) (14.9%)
- **Documentation Coverage:** 83.6364% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `poll_frame` **(Compute Cores)** (Impact: 18.5)
  * `h2` **(Stateful Encapsulated Methods)** (Impact: 7.0)
  * `size_hint` **(Annotated & Test Methods)** (Impact: 6.8)
  * `new_channel` **(Stateful Encapsulated Methods)** (Impact: 6.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (44.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (25.9%)
- **Documentation Coverage:** 75.2688% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find_source` **(Stateful Encapsulated Methods)** (Impact: 4.8)
  * `description` **(Annotated & Test Methods)** (Impact: 4.8)
  * `new_h2` **(Stateful Encapsulated Methods)** (Impact: 4.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (80.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (47.4%), Mutation Surface (formerly State Flux) (16.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.7%), Complexity Load (formerly Cognitive Load) (30.0%), Connectivity (formerly Api Exposure) (2.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.8%), Debt Markers (formerly Tech Debt) (99.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (44.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (92.4%), Concurrency Surface (formerly Concurrency) (87.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.8%)
- **Documentation Coverage:** 86.4407% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `giver_queue_throughput` **(Generic / Templated Code)** (Impact: 8.2)
  * `poll` **(Generic / Templated Code)** (Impact: 6.8)
  * `drop` **(Defensive Guards)** (Impact: 6.5)
  * `can_send` **(Compute Cores)** (Impact: 6.3)
  * `try_send` **(Encapsulated Accessors)** (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (68.3%), Guard Balance (formerly Safety Score) (34.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `poll` **(Generic / Templated Code)** (Impact: 7.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (89.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (50.2%), Guard Balance (formerly Safety Score) (41.3%)
- **Documentation Coverage:** 50.9434% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.4%), Complexity Load (formerly Cognitive Load) (35.8%), Connectivity (formerly Api Exposure) (1.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `read_cb` **(C Struct Operations)** (Impact: 9.9)
  * `write_cb` **(C Struct Operations)** (Impact: 9.9)
  * `free_conn_data` **(Stateful Encapsulated Methods)** (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.4%), Concurrency Surface (formerly Concurrency) (94.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `http2_parallel_x10_req_10mb` **(Generic / Templated Code)** (Impact: 2.0)
  * `http2_parallel_x10_req_10kb_100_chunks_adaptive_window` **(Generic / Templated Code)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 13
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **22**; blast radius 10.049; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (85.4%), Connectivity (formerly Api Exposure) (39.8%), Complexity Load (formerly Cognitive Load) (34.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `main` **(I/O & Config Routines)** (Impact: 8.3)
  * `http2_server` **(I/O & Config Routines)** (Impact: 7.2)
  * `http1_server` **(I/O & Config Routines)** (Impact: 6.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 9.474; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (99.6%), Connectivity (formerly Api Exposure) (60.3%), Guard Balance (formerly Safety Score) (54.2%)
