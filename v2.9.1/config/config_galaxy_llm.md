...
## 1. EXECUTIVE SUMMARY
- **Scope:** 12 analyzed artifact(s), 321 LOC.
- **Load-bearing artifact:** `package/defer.js` -- 3 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/async.js` -- pulls in 4 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/parser.js` at magnitude 212.92 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 75%, Large Core Modules (2) 17%, State Mutators Files 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 25.0 | 3.0 | 0.0 | 0.0 |
...
- `tsParser` **(Compute Cores)** (@ `package/parser.js`) -> Impact: **13.3** | LOC: 23
  * *Intent:* /** */
- `yamlParser` **(Defensive Guards)** (@ `package/parser.js`) -> Impact: **13.1** | LOC: 20
  * *Intent:* /** */
- `resolveAsyncConfigs` **(Defensive Guards)** (@ `package/async.js`) -> Impact: **11.2** | LOC: 27
  * *Intent:* /** * Do not use `config.get` before executing this method, it will freeze the config object. */
- `iterate` **(Defensive Guards)** (@ `package/async.js`) -> Impact: **10.8** | LOC: 19
- `setFilesOrder` **(Defensive Guards)** (@ `package/parser.js`) -> Impact: **9.3** | LOC: 13
  * *Intent:* /** */
- `jsParser` **(Callbacks & Closures)** (@ `package/parser.js`) -> Impact: **9.1** | LOC: 8
  * *Intent:* /** */
- `coffeeParser` **(Defensive Guards)** (@ `package/parser.js`) -> Impact: **6.7** | LOC: 31
  * *Intent:* /** */
- `xmlParser` **(Defensive Guards)** (@ `package/parser.js`) -> Impact: **5.8** | LOC: 12
  * *Intent:* /** */
- `csonParser` **(Defensive Guards)** (@ `package/parser.js`) -> Impact: **5.7** | LOC: 10
  * *Intent:* /** */
- `asyncConfig` **(Callbacks & Closures)** (@ `package/async.js`) -> Impact: **5.6** | LOC: 28
  * *Intent:* /** */ /** * the promise will determine a property's value once resolved * can also be a function to defer which resolves to a promise */...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 68.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (89.7%), Guard Balance (formerly Safety Score) (85.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 2.381% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `tsParser` **(Compute Cores)** (Impact: 13.3)
    * *Intent:* /** */
  * `yamlParser` **(Defensive Guards)** (Impact: 13.1)
    * *Intent:* /** */
  * `setFilesOrder` **(Defensive Guards)** (Impact: 9.3)
    * *Intent:* /** */
  * `jsParser` **(Callbacks & Closures)** (Impact: 9.1)
    * *Intent:* /** */
  * `coffeeParser` **(Defensive Guards)** (Impact: 6.7)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 68.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.0%), Debt Markers (formerly Tech Debt) (63.9%)
- **Documentation Coverage:** 25.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolveAsyncConfigs` **(Defensive Guards)** (Impact: 11.2)
    * *Intent:* /** * Do not use `config.get` before executing this method, it will freeze the config object. */
  * `iterate` **(Defensive Guards)** (Impact: 10.8)
  * `asyncConfig` **(Callbacks & Closures)** (Impact: 5.6)
    * *Intent:* /** */ /** * the promise will determine a property's value once resolved * can also be a function to...
  * `prepare` **(Callbacks & Closures)** (Impact: 4.5)
  * `registerRelease` **(State Mutators)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **3**; blast radius 243.986; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (65.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (34.1%), Mutation Surface (formerly State Flux) (31.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deferConfig` **(Callbacks & Closures)** (Impact: 2.0)
    * *Intent:* /** */
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 68.729; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (65.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (5.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `raw` **(Parameter Forwarders)** (Impact: 1.7)
    * *Intent:* /** */
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (50.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (12.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setFilesOrder` **(Compute Cores)** (Impact: 3.5)
    * *Intent:* /** */
  * `getFilesOrder` **(Compute Cores)** (Impact: 2.9)
    * *Intent:* /** */
  * `parse` **(State Mutators)** (Impact: 1.8)
    * *Intent:* /** */
  * `xmlParser` **(State Mutators)** (Impact: 1.8)
    * *Intent:* /** */
  * `jsParser` **(State Mutators)** (Impact: 1.8)
    * *Intent:* /** */
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 68.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (90.6%), Guard Balance (formerly Safety Score) (57.8%), Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `asyncConfig` **(Generic / Templated Code)** (Impact: 1.5)
    * *Intent:* /** */
  * `asyncConfig` **(Generic / Templated Code)** (Impact: 1.5)
    * *Intent:* /** */
  * `resolveAsyncConfigs` **(Generic / Templated Code)** (Impact: 1.5)
    * *Intent:* /** * Do not use `config.get` before executing this method, it will freeze the config object. */
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 68.729; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 68.729; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (63.8%), Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `raw` **(Callbacks & Closures)** (Impact: 1.6)
    * *Intent:* /** */
**Structural Signatures (Net Mitigated Signals):**
