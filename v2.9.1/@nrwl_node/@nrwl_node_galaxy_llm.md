...
## 1. EXECUTIVE SUMMARY
- **Scope:** 6 analyzed artifact(s), 35 LOC.
...
- **Heaviest artifact:** `package/executors.json` at magnitude 15.52 (structural weight, not risk).
...
| Connectivity (formerly API Exposure) | 0.0 | 3.5 | 0.9 | 0.0 | 0.0 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 1 | 1 | 0 | `package/index.d.ts` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 1 | 1 | 0 | `package/index.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
