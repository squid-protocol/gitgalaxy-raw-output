...
## 1. EXECUTIVE SUMMARY
- **Scope:** 197 analyzed artifact(s), 15994 LOC.
- **Load-bearing artifact:** `test/support/utils.js` -- 9 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `examples/README.md` -- pulls in 25 dependencies, the widest assembly point in the scan.
...
> **Architectural Drift Z-Score:** `3.425`
> **Composition Archetype:** `Mid Flat Project` (z +3.42; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 42%, Data / Markup / Trivial 30%, Callbacks & Closures Files 12%, Large Core Modules (2) 7%, State Mutators Files 4%
...
- `send` **(Defensive Guards)** (@ `lib/response.js`) -> Impact: **45.7** | LOC: 94
  * *Intent:* /** * Send a response. * * Examples: * * res.send(Buffer.from('wahoo')); * res.send({ some: 'json' }); * res.send('<p>some html</p>'); * */...
...
- `stringify` **(Defensive Guards)** (@ `lib/response.js`) -> Impact: **23.6** | LOC: 25
  * *Intent:* /** * Stringify JSON, like JSON.stringify, but v8 optimized, with the * ability to escape characters that can trigger HTML sniffing. * */
- `render` **(Many-Argument Workhorses)** (@ `lib/application.js`) -> Impact: **22.7** | LOC: 54
  * *Intent:* * rendered template string. * * Example: * * app.render('email', { name: 'Tobi' }, function(err, html){ * // ... * }) * */
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **16**; blast radius 10.057; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (40.0%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 10.057; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.8%), Complexity Load (formerly Cognitive Load) (42.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `defaultConfiguration` **(I/O & Config Routines)** (Impact: 7.6)
    * *Intent:* /** * Initialize application configuration. */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.1%), Complexity Load (formerly Cognitive Load) (13.5%), Concurrency Surface (formerly Concurrency) (13.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.2%), Concurrency Surface (formerly Concurrency) (13.2%), Complexity Load (formerly Cognitive Load) (12.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 19.416; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (75.6%), Connectivity (formerly Api Exposure) (66.6%), Complexity Load (formerly Cognitive Load) (37.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `compileETag` **(Defensive Guards)** (Impact: 13.9)
    * *Intent:* /** * Compile "etag" value to function. * */
  * `compileQueryParser` **(Defensive Guards)** (Impact: 13.9)
    * *Intent:* /** * Compile "query parser" value to function. * */
  ...
  * `compileTrust` **(Defensive Guards)** (Impact: 9.5)
    * *Intent:* /** * Compile "proxy trust" value to function. * */
  * `setCharset` **(Compute Cores)** (Impact: 5.9)
    * *Intent:* /** * Set the charset in a given Content-Type string. * */
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 17 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.5%), Concurrency Surface (formerly Concurrency) (29.2%), Complexity Load (formerly Cognitive Load) (12.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createApp` **(Callbacks & Closures)** (Impact: 5.1)
  * `verify` **(Defensive Guards)** (Impact: 4.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.8%), Complexity Load (formerly Cognitive Load) (25.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (18.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.7%), Concurrency Surface (formerly Concurrency) (13.9%), Complexity Load (formerly Cognitive Load) (11.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (30.5%), Concurrency Surface (formerly Concurrency) (22.2%), Complexity Load (formerly Cognitive Load) (4.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 10.057; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.4%), Complexity Load (formerly Cognitive Load) (43.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `header` **(Defensive Guards)** (Impact: 12.3)
  * `host` **(Defensive Guards)** (Impact: 6.7)
  ...
  * `hostname` **(Defensive Guards)** (Impact: 4.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.6%), Complexity Load (formerly Cognitive Load) (45.3%), Connectivity (formerly Api Exposure) (29.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `resolve` **(Compute Cores)** (Impact: 9.6)
    * *Intent:* /** * Resolve the file within the given directory. * */
  * `render` **(Compute Cores)** (Impact: 6.5)
    * *Intent:* /** * Render with the given options. * */
  * `lookup` **(Compute Cores)** (Impact: 5.2)
    * *Intent:* /** * Lookup view by the given `name` * */
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 8.164; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (64.7%), Connectivity (formerly Api Exposure) (17.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.1%), Complexity Load (formerly Cognitive Load) (15.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.0%), Complexity Load (formerly Cognitive Load) (21.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test` **(Callbacks & Closures)** (Impact: 6.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (35.8%), Concurrency Surface (formerly Concurrency) (28.0%), Connectivity (formerly Api Exposure) (13.1%), Complexity Load (formerly Cognitive Load) (7.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (22.2%), Complexity Load (formerly Cognitive Load) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fn1` **(State Mutators)** (Impact: 2.2)
  * `fn2` **(State Mutators)** (Impact: 2.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.2%), Complexity Load (formerly Cognitive Load) (9.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 11 instances
* *State Mutation (weighted view):* 45
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (25.4%), Complexity Load (formerly Cognitive Load) (4.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (17.7%), Complexity Load (formerly Cognitive Load) (4.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.7%), Complexity Load (formerly Cognitive Load) (51.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.9%), Connectivity (formerly Api Exposure) (2.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.413; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (49.5%), Complexity Load (formerly Cognitive Load) (6.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (88.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.413; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.0%), Complexity Load (formerly Cognitive Load) (9.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
