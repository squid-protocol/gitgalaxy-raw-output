...
## 1. EXECUTIVE SUMMARY
- **Scope:** 7 analyzed artifact(s), 297 LOC.
- **Load-bearing artifact:** `editables-0.5/src/editables/redirector.py` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `editables-0.5/tests/test_editable.py` -- pulls in 9 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `editables-0.5/tests/test_editable.py` at magnitude 122.46 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 43%, Generic / Templated Code Files 29%, Large Core Modules (2) 29%
...
- `map` **(Generic / Templated Code)** (@ `editables-0.5/src/editables/__init__.py`) -> Impact: **12.6** | LOC: 12
- `import_state` **(Type Conversions)** (@ `editables-0.5/tests/test_editable.py`) -> Impact: **8.1** | LOC: 21
  * *Intent:* # to test in-process: # Put stuff in somedir # sys.path.append("somedir") # site.addsitedir("somedir") # Check stuff is visible
- `build_project` **(Defensive Guards)** (@ `editables-0.5/tests/test_editable.py`) -> Impact: **7.5** | LOC: 11
- `find_spec` **(Generic / Templated Code)** (@ `editables-0.5/src/editables/redirector.py`) -> Impact: **7.4** | LOC: 13
- `build` **(Defensive Guards)** (@ `editables-0.5/tests/test_redirects.py`) -> Impact: **7.3** | LOC: 8
- `files` **(Generic / Templated Code)** (@ `editables-0.5/src/editables/__init__.py`) -> Impact: **6.0** | LOC: 7
- `install` **(Generic / Templated Code)** (@ `editables-0.5/src/editables/redirector.py`) -> Impact: **6.0** | LOC: 6
- `save_import_state` **(Type Conversions)** (@ `editables-0.5/tests/test_redirects.py`) -> Impact: **5.0** | LOC: 19
- `pth_file` **(Type Conversions)** (@ `editables-0.5/src/editables/__init__.py`) -> Impact: **4.6** | LOC: 7
- `__init__` **(Generic / Templated Code)** (@ `editables-0.5/src/editables/__init__.py`) -> Impact: **4.5** | LOC: 9
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 114.942; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (29.2%), Connectivity (formerly Api Exposure) (9.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `import_state` **(Type Conversions)** (Impact: 8.1)
    * *Intent:* # to test in-process: # Put stuff in somedir # sys.path.append("somedir") # site.addsitedir("somedir...
  * `build_project` **(Defensive Guards)** (Impact: 7.5)
  * `test_simple_pth` **(Defensive Guards)** (Impact: 4.0)
  * `test_make_project` **(Defensive Guards)** (Impact: 4.0)
  * `test_subpackage_pth` **(Defensive Guards)** (Impact: 4.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 114.942; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Complexity Load (formerly Cognitive Load) (67.4%), Connectivity (formerly Api Exposure) (66.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `map` **(Generic / Templated Code)** (Impact: 12.6)
  * `files` **(Generic / Templated Code)** (Impact: 6.0)
  * `pth_file` **(Type Conversions)** (Impact: 4.6)
  * `__init__` **(Generic / Templated Code)** (Impact: 4.5)
  * `bootstrap_file` **(Generic / Templated Code)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 114.942; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (69.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (41.8%), Connectivity (formerly Api Exposure) (9.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `build` **(Defensive Guards)** (Impact: 7.3)
  * `save_import_state` **(Type Conversions)** (Impact: 5.0)
  * `test_redirects` **(Defensive Guards)** (Impact: 2.7)
  * `test_double_install` **(Defensive Guards)** (Impact: 1.3)
  * `test_cache_invalidation` **(Interface Declarations)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 310.345; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (78.3%), Complexity Load (formerly Cognitive Load) (60.8%), Connectivity (formerly Api Exposure) (55.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find_spec` **(Generic / Templated Code)** (Impact: 7.4)
  * `install` **(Generic / Templated Code)** (Impact: 6.0)
  * `map_module` **(Generic / Templated Code)** (Impact: 2.1)
  * `invalidate_caches` **(Generic / Templated Code)** (Impact: 1.7)
