# ARCHITECTURAL_BRIEF: git-node-fs
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 6 LOC.
...
- **Top orchestrator:** `package/mixins/fs-db.js` -- pulls in 2 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/mixins/fs-db.js` at magnitude 5.02 (structural weight, not risk).
...
| Guard Balance (formerly Error & Exception Exposure) | 66.5 | 66.5 | 66.5 | 66.5 | 66.5 |
...
| Mutation Surface (formerly State Flux Exposure) | 31.0 | 31.0 | 31.0 | 31.0 | 31.0 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 1 | 1 | 1 | `package/mixins/fs-db.js` |
| io | 2 | 1 | 2 | `package/mixins/fs-db.js` |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 4 | 1 | 4 | `package/mixins/fs-db.js` |
| dead_code | 1 | 1 | 1 | `package/mixins/fs-db.js` |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
| ui | 0 | 0 | 0 | - |
...
- `package/mixins/fs-db.js` (Hits: 2)
...
1. **fs-db.js** (`package/mixins/fs-db.js`) — 2 outbound dependencies
...
- `exports` **(Callbacks & Closures)** (@ `package/mixins/fs-db.js`) -> Impact: **1.9** | LOC: 4
...
|---|---|---|---|---|
| `package/mixins` | 1 | 5.02 | 0.0% | 73.11% |
| `package` | 2 | 2.0 | 0.0% | 0.0% |

## 10. TARGETED STRUCTURAL SURFACE VECTORS (formerly Risk Vectors, Top 5 by Surface)
### Highest Debt Markers (formerly Tech Debt; Fragile/Planned)
- `package/mixins/fs-db.js` -> **73.1059%** Exposure
### Highest Mutation Surface (formerly State Flux; Mutation/Volatility)
- `package/mixins/fs-db.js` -> **31.0026%** Exposure
### Highest Design Slop (Dead & Duplicated Logic)
- `package/mixins/fs-db.js` -> **1** Orphaned Functions | **0** Duplicates
...
### `package/mixins/fs-db.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 5.02 | **LOC:** 8 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 333.333; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (66.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Callbacks & Closures)** (Impact: 1.9)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` node-fs, fs-db
...
- `package/mixins/fs-db.js` -> **Severity: 33333.3** (Blast Radius: 333.333 * Doc Risk: 100.0%)
