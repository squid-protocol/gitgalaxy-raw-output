...
## 1. EXECUTIVE SUMMARY
- **Scope:** 69 analyzed artifact(s), 5786 LOC.
- **Load-bearing artifact:** `tqdm-4.67.3/tqdm/std.py` -- 21 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `tqdm-4.67.3/tqdm/std.py` -- pulls in 25 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tqdm-4.67.3/tqdm/std.py` at magnitude 1778.6 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.946`
> **Composition Archetype:** `Small Flat Repo (2)` (z +1.95; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 23%, Large Core Modules (3) 20%, Large Core Modules (2) 19%, Parameter Forwarders Files 14%, Declarative / Non-Code 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 28.1 | 11.1 | 0.0 |
...
- **Blast Radius:** changing it is visible to **21** in-repo importer(s); it depends on **25**; blast radius 236.361; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (72.1%)
- **Documentation Coverage:** 48.9051% of unit weight undocumented
...
- **Blast Radius:** changing it is visible to **14** in-repo importer(s); it depends on **17**; blast radius 48.49; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (92.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (49.2%), Concurrency Surface (formerly Concurrency) (39.3%)
- **Documentation Coverage:** 17.6768% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **10**; blast radius 13.594; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.5%), Guard Balance (formerly Safety Score) (98.9%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (97.7%), Guard Balance (formerly Safety Score) (97.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (21.1%)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **12**; blast radius 27.875; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (61.1%)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **18**; blast radius 81.687; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.5%), Debt Markers (formerly Tech Debt) (75.0%), Connectivity (formerly Api Exposure) (56.4%)
- **Documentation Coverage:** 64.7887% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `disp_trim` **(Type Conversions)** (Impact: 12.8)
  ...
  * `_screen_shape_windows` **(Stateful Encapsulated Methods)** (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (54.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (25.0%)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **8**; blast radius 76.147; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (54.4%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 7.146; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.7%)
- **Documentation Coverage:** 81.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 55.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 23.4)
    * *Intent:* # TODO: @classmethod: write()? """ This class accepts the following parameters *in addition* to the ...
  * `close` **(Stateful Encapsulated Methods)** (Impact: 11.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (66.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (23.9%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **4**; blast radius 28.914; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Connectivity (formerly Api Exposure) (71.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (25.7%), Complexity Load (formerly Cognitive Load) (14.3%), Connectivity (formerly Api Exposure) (9.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (14.7%), Connectivity (formerly Api Exposure) (8.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_pandas_apply_args_deprecation` **(Defensive Guards)** (Impact: 2.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 5.014; role: Pure Consumer (Orchestrator)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 10.0)
    * *Intent:* # TODO: @classmethod: write()? """ This class accepts the following parameters *in addition* to the ...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (26.3%), Connectivity (formerly Api Exposure) (12.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `write` **(Parameter Forwarders)** (Impact: 2.1)
  * `write` **(Parameter Forwarders)** (Impact: 2.1)
  * `test_should_not_swallow_certain_exceptions` **(Parameter Forwarders)** (Impact: 2.1)
  * `test_should_format_message` **(Defensive Guards)** (Impact: 2.0)
  * `test_should_call_handle_error_if_exception_was_thrown` **(Defensive Guards)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (68.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (2.9%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **4**; blast radius 72.595; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.3%), Complexity Load (formerly Cognitive Load) (55.9%), Connectivity (formerly Api Exposure) (52.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 2.5)
  * `report` **(Parameter Forwarders)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (79.9%), Guard Balance (formerly Safety Score) (76.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (94.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.9%), Complexity Load (formerly Cognitive Load) (4.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.7%), Connectivity (formerly Api Exposure) (6.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `update_to` **(Compute Cores)** (Impact: 4.8)
    * *Intent:* """ b : int, optional Number of blocks transferred so far [default: 1]. bsize : int, optional Size o...
  * `my_hook` **(Compute Cores)** (Impact: 4.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.0%), Complexity Load (formerly Cognitive Load) (94.0%), Guard Balance (formerly Safety Score) (84.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (49.6%), Complexity Load (formerly Cognitive Load) (13.5%), Connectivity (formerly Api Exposure) (8.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `incr` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (23.5%), Connectivity (formerly Api Exposure) (9.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `source` **(Parameter Forwarders)** (Impact: 3.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 5.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (82.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `display` **(Parameter Forwarders)** (Impact: 3.2)
