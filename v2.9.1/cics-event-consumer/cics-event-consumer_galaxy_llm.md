...
## 1. EXECUTIVE SUMMARY
- **Scope:** 52 analyzed artifact(s), 6671 LOC.
- **Load-bearing artifact:** `CHANGELOG.md` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java` -- pulls in 48 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java` at magnitude 2290.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.021`
> **Composition Archetype:** `Small Flat Repo` (z +2.02; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 42%, Large Core Modules (3) 23%, Interface Declarations Files 10%, Large Core Modules (2) 8%, Many-Argument Workhorses Files 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 23.0 | 0.0 | 0.0 |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **48**; blast radius 25.515; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.7%), Dead Code Surface (formerly Dead Code) (7.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (97.7%), Guard Balance (formerly Safety Score) (86.3%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `setEpcx__strucid` **(Compute Cores)** (Impact: 4.8)
    * *Intent:* /** * @generated */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (98.7%), Guard Balance (formerly Safety Score) (87.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `evaluateFormula` **(Many-Argument Workhorses)** (Impact: 62.0)
    * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more a...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (86.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `evaluateFormula` **(Many-Argument Workhorses)** (Impact: 62.0)
    * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more a...
  ...
  * `evaluateMap` **(Type Conversions)** (Impact: 6.6)
    * *Intent:* /** * @generated * evaluateMap */
  * `setEpde__dataname` **(Compute Cores)** (Impact: 4.8)
    * *Intent:* /** * @generated */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (97.3%), Guard Balance (formerly Safety Score) (91.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `evaluateFormula` **(Many-Argument Workhorses)** (Impact: 62.0)
    * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more a...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.9%), Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (91.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `evaluateFormula` **(Many-Argument Workhorses)** (Impact: 62.0)
    * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more a...
  ...
  * `evaluateMap` **(Type Conversions)** (Impact: 6.6)
    * *Intent:* /** * @generated * evaluateMap */
  * `setEpap__strucid` **(Compute Cores)** (Impact: 4.8)
    * *Intent:* /** * @generated */
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 27 instances
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 25.515; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (44.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.8%), Complexity Load (formerly Cognitive Load) (40.9%), Debt Markers (formerly Tech Debt) (17.3%)
- **Documentation Coverage:** 28.5714% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 51.5)
  * `getMessageSummary` **(I/O & Config Routines)** (Impact: 17.8)
  ...
  * `validForEmission` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.0%), Debt Markers (formerly Tech Debt) (92.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Concurrency Surface (formerly Concurrency) (99.4%), Guard Balance (formerly Safety Score) (90.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (82.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.1%), Debt Markers (formerly Tech Debt) (27.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `getMessageSummary` **(Stateful Encapsulated Methods)** (Impact: 4.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (35.5%)
- **Documentation Coverage:** 57.1429% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 27.1)
  * `CICSQueue` **(Defensive Guards)** (Impact: 19.1)
  * `getMessageSummary` **(Stateful Encapsulated Methods)** (Impact: 14.2)
    * *Intent:* /** * Return a short summary of the contents to be written to the queue. * * @return short summary o...
  * `validForEmission` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Return true if we should attempt to emit * * @return true if the entries in EmitProperties are...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Debt Markers (formerly Tech Debt) (42.7%), Complexity Load (formerly Cognitive Load) (39.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `getMessageSummary` **(Stateful Encapsulated Methods)** (Impact: 7.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Guard Balance (formerly Safety Score) (81.2%), Debt Markers (formerly Tech Debt) (26.3%), Complexity Load (formerly Cognitive Load) (24.3%)
- **Documentation Coverage:** 28.5714% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 28.9)
  * `getMessageSummary` **(Stateful Encapsulated Methods)** (Impact: 13.1)
    * *Intent:* /** * Return a short summary of the contents to be written to the queue. * * @return short summary o...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 17.905; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Complexity Load (formerly Cognitive Load) (29.1%), Debt Markers (formerly Tech Debt) (19.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (90.1%), Complexity Load (formerly Cognitive Load) (26.1%), Debt Markers (formerly Tech Debt) (15.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.8%), Guard Balance (formerly Safety Score) (69.2%), Debt Markers (formerly Tech Debt) (28.9%), Complexity Load (formerly Cognitive Load) (19.9%)
- **Documentation Coverage:** 37.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 25.8)
  * `getMessageSummary` **(Stateful Encapsulated Methods)** (Impact: 6.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (66.6%), Guard Balance (formerly Safety Score) (60.9%), Mutation Surface (formerly State Flux) (48.5%), Complexity Load (formerly Cognitive Load) (14.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 10.0)
  * `getMessageSummary` **(Compute Cores)** (Impact: 8.4)
  * `XMPP` **(Defensive Guards)** (Impact: 3.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (78.3%), Guard Balance (formerly Safety Score) (56.2%), Connectivity (formerly Api Exposure) (8.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setEventname` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Sets the value of the eventname property. * * @param value * allowed object is * {@link String...
  * `setUsertag` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Sets the value of the usertag property. * * @param value * allowed object is * {@link String }...
  * `setNetworkapplid` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Sets the value of the networkapplid property. * * @param value * allowed object is * {@link St...
  * `setTimestamp` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Sets the value of the timestamp property. * * @param value * allowed object is * {@link XMLGre...
  * `setBindingname` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (72.3%), Debt Markers (formerly Tech Debt) (59.8%), Complexity Load (formerly Cognitive Load) (17.1%)
- **Documentation Coverage:** 28.5714% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `send` **(I/O & Config Routines)** (Impact: 9.8)
  * `getMessageSummary` **(Encapsulated Accessors)** (Impact: 3.1)
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.4%), Complexity Load (formerly Cognitive Load) (54.0%), Connectivity (formerly Api Exposure) (7.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (74.0%), Connectivity (formerly Api Exposure) (1.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 17.905; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.6%), Guard Balance (formerly Safety Score) (52.1%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (7.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setContextInfo` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** * Sets the value of the contextInfo property. * * @param value * allowed object is * {@link Cont...
  * `setPayloadData` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (5.6%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
