# ARCHITECTURAL_BRIEF: broccoli-node-info
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 95 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 80.4 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 85.9 | 85.9 | 85.9 | 85.9 | 85.9 |
| Guard Balance (formerly Error & Exception Exposure) | 81.2 | 81.2 | 81.2 | 81.2 | 81.2 |
| Debt Markers (formerly Tech Debt Exposure) | 34.1 | 34.1 | 34.1 | 34.1 | 34.1 |
...
| memory | 0 | 0 | 0 | - |
| cleanup | 0 | 0 | 0 | - |
| guards | 13 | 1 | 13 | `package/index.js` |
| danger | 6 | 1 | 6 | `package/index.js` |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 3 | 1 | 3 | `package/index.js` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| mutation | 28 | 1 | 28 | `package/index.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 4 | 1 | 4 | `package/index.js` |
| ml_ai | 0 | 0 | 0 | - |
| ui | 0 | 0 | 0 | - |
...
- `getNodeInfo` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **30.5** | LOC: 72
- `InvalidNodeError` **(Parameter Forwarders)** (@ `package/index.js`) -> Impact: **1.9** | LOC: 9
- `instantiationStack` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **1.1** | LOC: 3
  * *Intent:* // lazily return the original instantiation stack // this avoids eagerly accessing the stacks, which is costly
...
|---|---|---|---|---|
| `package` | 4 | 83.74 | 21.49% | 8.53% |

## 10. TARGETED STRUCTURAL SURFACE VECTORS (formerly Risk Vectors, Top 5 by Surface)
### Highest Debt Markers (formerly Tech Debt; Fragile/Planned)
- `package/index.js` -> **34.1213%** Exposure
...
- **Magnitude:** 80.4 | **LOC:** 142 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (85.9%), Guard Balance (formerly Safety Score) (81.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getNodeInfo` **(Defensive Guards)** (Impact: 30.5)
  * `InvalidNodeError` **(Parameter Forwarders)** (Impact: 1.9)
  * `instantiationStack` **(Interface Declarations)** (Impact: 1.1)
    * *Intent:* // lazily return the original instantiation stack // this avoids eagerly accessing the stacks, which...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 12 instances
* *State Mutation (weighted view):* 42
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 23`, `structural_boundaries: 16`, `args: 9`, `func_start: 3`
