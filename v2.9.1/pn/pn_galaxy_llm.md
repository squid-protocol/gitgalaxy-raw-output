...
## 1. EXECUTIVE SUMMARY
- **Scope:** 38 analyzed artifact(s), 626 LOC.
- **Load-bearing artifact:** `package/_promisify.js` -- 18 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/child_process.js` -- pulls in 2 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/_promisify.js` at magnitude 66.12 (structural weight, not risk).
...
| Avg Path Length | 1.4865 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `3.341`
> **Composition Archetype:** `Small Flat Repo (2)` (z +3.34; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 53%, Callbacks & Closures Files 45%, Large Core Modules (2) 3%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 50.0 | 27.0 | 50.0 | 50.0 |
...
- `exports` **(Defensive Guards)** (@ `package/_promisify.js`) -> Impact: **19.6** | LOC: 34
- `deferred` **(Callbacks & Closures)** (@ `package/_promisify.js`) -> Impact: **16.5** | LOC: 19
  * *Intent:* // deferred gets its own scope to prevent inadvertent capture in the closure
- `bind` **(Callbacks & Closures)** (@ `package/child_process.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/cluster.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/crypto.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/dgram.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/dns.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/domain.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/fs.js`) -> Impact: **3.5** | LOC: 1
- `bind` **(Callbacks & Closures)** (@ `package/http.js`) -> Impact: **3.5** | LOC: 1
...
- **Blast Radius:** changing it is visible to **18** in-repo importer(s); it depends on **1**; blast radius 242.725; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.9%), Guard Balance (formerly Safety Score) (76.6%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 19.6)
  * `deferred` **(Callbacks & Closures)** (Impact: 16.5)
    * *Intent:* // deferred gets its own scope to prevent inadvertent capture in the closure
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 221.195; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.8%), Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (73.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getOrSetPromise` **(Parameter Forwarders)** (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 14.891; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (20.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (25.4%), Connectivity (formerly Api Exposure) (20.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (53.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%), Complexity Load (formerly Cognitive Load) (11.5%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (17.6%), Complexity Load (formerly Cognitive Load) (6.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (17.9%), Complexity Load (formerly Cognitive Load) (6.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 14.891; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (31.8%), Complexity Load (formerly Cognitive Load) (7.4%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bind` **(Callbacks & Closures)** (Impact: 3.5)
**Structural Signatures (Net Mitigated Signals):**
