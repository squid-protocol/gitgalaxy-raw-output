...
## 1. EXECUTIVE SUMMARY
- **Scope:** 108 analyzed artifact(s), 6863 LOC.
...
- **Top orchestrator:** `bin/rexify` -- pulls in 29 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `bin/rexify` at magnitude 418.0 (structural weight, not risk).
...
> **Composition Archetype:** `Small Flat Repo` (z +4.86; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 73%, Data / Markup / Trivial 14%, Compute Cores Files 3%, Interface Declarations Files 3%, Large Core Modules (3) 2%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 32.7 | 31.6 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 14.1 | 0.0 | 0.0 |
...
- `resolve_deps` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **54.3** | LOC: 125
- `download_recipe` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **28.4** | LOC: 58
- `install_perl_module` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **20.7** | LOC: 47
- `_rex` **(Compute Cores)** (@ `share/rex-tab-completion.bash`) -> Impact: **20.7** | LOC: 46
  * *Intent:* # bash completion for rex
- `get` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **19.6** | LOC: 24
- `_setup_test` **(Compute Cores)** (@ `t/load_rexfile.t`) -> Impact: **17.6** | LOC: 41
- `test_rsync` **(Many-Argument Workhorses)** (@ `t/rsync.t`) -> Impact: **17.2** | LOC: 65
- `print_found` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **16.2** | LOC: 12
- `Anonymous_Block` **(Unclassified)** (@ `misc/create_pod.sh`) -> Impact: **12.0** | LOC: 98
- `download_recipe_git` **(Compute Cores)** (@ `bin/rexify`) -> Impact: **11.2** | LOC: 26
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (96.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (35.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolve_deps` **(Compute Cores)** (Impact: 54.3)
  * `download_recipe` **(Compute Cores)** (Impact: 28.4)
  * `install_perl_module` **(Compute Cores)** (Impact: 20.7)
  * `get` **(Compute Cores)** (Impact: 19.6)
  * `print_found` **(Compute Cores)** (Impact: 16.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Guard Balance (formerly Safety Score) (46.3%), Complexity Load (formerly Cognitive Load) (21.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (87.4%), Complexity Load (formerly Cognitive Load) (13.7%), Guard Balance (formerly Safety Score) (4.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (77.8%), Concurrency Surface (formerly Concurrency) (27.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_rex` **(Compute Cores)** (Impact: 20.7)
    * *Intent:* # bash completion for rex
  * `_rex_fix_colon_reply` **(I/O & Config Routines)** (Impact: 2.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Complexity Load (formerly Cognitive Load) (84.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (73.3%), Complexity Load (formerly Cognitive Load) (58.9%), Connectivity (formerly Api Exposure) (7.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `expected_params` **(Compute Cores)** (Impact: 8.2)
  * `before_hook` **(Parameter Forwarders)** (Impact: 2.6)
  * `after_change_hook` **(Parameter Forwarders)** (Impact: 2.5)
  * `after_hook` **(Parameter Forwarders)** (Impact: 2.5)
  * `before_change_hook` **(Parameter Forwarders)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (69.5%), Complexity Load (formerly Cognitive Load) (44.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Guard Balance (formerly Safety Score) (49.2%), Complexity Load (formerly Cognitive Load) (24.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (94.9%), Guard Balance (formerly Safety Score) (74.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.0%), Complexity Load (formerly Cognitive Load) (59.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Complexity Load (formerly Cognitive Load) (64.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_setup_test` **(Compute Cores)** (Impact: 17.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Complexity Load (formerly Cognitive Load) (28.5%), Guard Balance (formerly Safety Score) (23.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (87.2%), Guard Balance (formerly Safety Score) (12.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (54.4%), Test Surface (formerly Verification) (2.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__global_context__` **(I/O & Config Routines)** (Impact: 10.7)
  * `Anonymous_Block` **(I/O & Config Routines)** (Impact: 4.5)
  * `_rex_hosts` **(Interface Declarations)** (Impact: 3.2)
    * *Intent:* # return hosts managed by rex or any other host availabe via zsh's _hosts function
  * `_hostgroups` **(Interface Declarations)** (Impact: 2.2)
  * `_envs` **(Interface Declarations)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.1%), Complexity Load (formerly Cognitive Load) (43.4%), Connectivity (formerly Api Exposure) (3.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_rsync` **(Many-Argument Workhorses)** (Impact: 17.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (44.4%), Mutation Surface (formerly State Flux) (21.9%), Connectivity (formerly Api Exposure) (7.5%), Complexity Load (formerly Cognitive Load) (7.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `git_last_commit_message_ok` **(Parameter Forwarders)** (Impact: 4.1)
  * `prepare_test_repo` **(I/O & Config Routines)** (Impact: 3.1)
  * `init_test` **(I/O & Config Routines)** (Impact: 2.9)
  * `git_branch_ok` **(Type Conversions)** (Impact: 2.3)
  * `git_repo_ok` **(Parameter Forwarders)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.4%), Guard Balance (formerly Safety Score) (41.1%), Complexity Load (formerly Cognitive Load) (16.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.4%), Complexity Load (formerly Cognitive Load) (72.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Guard Balance (formerly Safety Score) (57.3%), Complexity Load (formerly Cognitive Load) (25.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 5 instances
* *State Mutation (weighted view):* 21
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Complexity Load (formerly Cognitive Load) (69.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
* *State Mutation (weighted view):* 21
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.6%), Mutation Surface (formerly State Flux) (93.1%), Concurrency Surface (formerly Concurrency) (84.8%), Complexity Load (formerly Cognitive Load) (24.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Anonymous_Block` **(Unclassified)** (Impact: 12.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (76.9%), Complexity Load (formerly Cognitive Load) (45.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (91.4%), Mutation Surface (formerly State Flux) (86.2%), Guard Balance (formerly Safety Score) (65.2%), Complexity Load (formerly Cognitive Load) (34.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_summary` **(Compute Cores)** (Impact: 8.7)
  * `create_tasks` **(Callbacks & Closures)** (Impact: 6.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.259; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.4%), Complexity Load (formerly Cognitive Load) (55.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
