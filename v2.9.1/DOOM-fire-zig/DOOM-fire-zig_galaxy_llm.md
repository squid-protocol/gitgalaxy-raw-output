...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 554 LOC.
...
- **Heaviest artifact:** `src/main.zig` at magnitude 353.98 (structural weight, not risk).
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 81.8 | 81.8 | 81.8 | 81.8 | 81.8 |
...
- `emit` **(Type Conversions)** (@ `src/main.zig`) -> Impact: **7.9** | LOC: 17
  * *Intent:* // print
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (33.8%), Complexity Load (formerly Cognitive Load) (31.8%), Guard Balance (formerly Safety Score) (24.6%)
