...
## 1. EXECUTIVE SUMMARY
- **Scope:** 385 analyzed artifact(s), 249287 LOC.
- **Load-bearing artifact:** `zellij-utils/src/envs.rs` -- 7 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `zellij-utils/src/plugin_api/plugin_command.rs` -- pulls in 225 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `zellij-server/src/tab/mod.rs` at magnitude 3744.2 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.717`
> **Composition Archetype:** `Mid Flat Project` (z +1.72; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (3) 28%, Data / Markup / Trivial 18%, Declarative / Non-Code 9%, State Mutators Files 9%, Generic / Templated Code Files 8%
...
- `try_from` **(Many-Argument Workhorses)** (@ `zellij-utils/src/plugin_api/plugin_command.rs`) -> Impact: **384.1** | LOC: 951
- `actions_from_cli` **(Many-Argument Workhorses)** (@ `zellij-utils/src/input/actions.rs`) -> Impact: **348.1** | LOC: 1001
- `try_from` **(Many-Argument Workhorses)** (@ `zellij-utils/src/plugin_api/action.rs`) -> Impact: **344.6** | LOC: 952
- `update` **(Many-Argument Workhorses)** (@ `default-plugins/fixture-plugin-for-tests/src/main.rs`) -> Impact: **310.0** | LOC: 866
- `try_from` **(Many-Argument Workhorses)** (@ `zellij-utils/src/ipc/protobuf_conversion.rs`) -> Impact: **299.1** | LOC: 919
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **88**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.5%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.6%), Mutation Surface (formerly State Flux) (54.3%)
- **Documentation Coverage:** 99.6974% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.1%)
- **Documentation Coverage:** 92.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **104**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (83.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.3%), Mutation Surface (formerly State Flux) (64.6%)
- **Documentation Coverage:** 82.243% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **66**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.8%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (69.9%), Guard Balance (formerly Safety Score) (66.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `to_kdl` **(Many-Argument Workhorses)** (Impact: 178.5)
  * `try_from` **(Many-Argument Workhorses)** (Impact: 111.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.0%), Debt Markers (formerly Tech Debt) (34.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `create_plugin_thread_with_background_jobs_receiver` **(Generic / Templated Code)** (Impact: 13.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (50.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (35.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **80**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (76.6%), Guard Balance (formerly Safety Score) (75.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (74.6%), Mutation Surface (formerly State Flux) (27.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `integration_scrollback_from_pre_subscription_pty_bytes` **(I/O & Config Routines)** (Impact: 10.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.2%), Debt Markers (formerly Tech Debt) (32.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.5%), Guard Balance (formerly Safety Score) (67.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.7%), Complexity Load (formerly Cognitive Load) (26.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mirrored_sessions` **(I/O & Config Routines)** (Impact: 39.5)
  * `watcher_client_functionality` **(I/O & Config Routines)** (Impact: 33.6)
  * `multiple_users_in_different_tabs` **(I/O & Config Routines)** (Impact: 31.9)
  * `multiple_users_in_different_panes_and_same_tab` **(I/O & Config Routines)** (Impact: 27.8)
  * `multiple_users_in_same_pane_and_tab` **(I/O & Config Routines)** (Impact: 26.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **65**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (66.1%), Debt Markers (formerly Tech Debt) (30.8%), Mutation Surface (formerly State Flux) (12.5%)
- **Documentation Coverage:** 99.1903% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `non_overlapping_highlights_from_different_layers_coexist` **(I/O & Config Routines)** (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **204**; blast radius 4.482; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (74.6%), Guard Balance (formerly Safety Score) (49.4%), Connectivity (formerly Api Exposure) (23.8%)
- **Documentation Coverage:** 99.5516% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `host_run_plugin_command` **(I/O & Config Routines)** (Impact: 70.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (81.7%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (62.6%), Guard Balance (formerly Safety Score) (58.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `toggle_pane_fullscreen` **(Many-Argument Workhorses)** (Impact: 23.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **55**; blast radius 2.423; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (75.9%), Mutation Surface (formerly State Flux) (72.2%), Guard Balance (formerly Safety Score) (57.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (91.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (75.9%), Guard Balance (formerly Safety Score) (53.2%)
- **Documentation Coverage:** 96.8051% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `new` **(Many-Argument Workhorses)** (Impact: 29.0)
  * `from_cli` **(Many-Argument Workhorses)** (Impact: 22.6)
  * `from_config` **(Many-Argument Workhorses)** (Impact: 22.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (98.5%), Mutation Surface (formerly State Flux) (88.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (62.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 2.423; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (52.9%), Mutation Surface (formerly State Flux) (50.3%), Guard Balance (formerly Safety Score) (48.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (78.0%), Debt Markers (formerly Tech Debt) (57.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.4%), Debt Markers (formerly Tech Debt) (63.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (86.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (61.6%), Debt Markers (formerly Tech Debt) (40.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (55.2%), Guard Balance (formerly Safety Score) (47.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.2%)
- **Documentation Coverage:** 97.8261% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `determine_mouse_action` **(Many-Argument Workhorses)** (Impact: 137.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **35**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (82.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.5%), Debt Markers (formerly Tech Debt) (46.7%), Concurrency Surface (formerly Concurrency) (12.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `toggle_focused_pane_fullscreen` **(I/O & Config Routines)** (Impact: 10.2)
  * `toggle_focused_pane_fullscreen_with_stacked_resizes` **(I/O & Config Routines)** (Impact: 8.2)
...
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (75.9%), Connectivity (formerly Api Exposure) (16.6%), Complexity Load (formerly Cognitive Load) (2.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `as_str_name` **(I/O & Config Routines)** (Impact: 4.3)
    * *Intent:* /// String value of the enum field names used in the ProtoBuf definition. /// /// The values are not...
  * `from_str_name` **(I/O & Config Routines)** (Impact: 4.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **75**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.8%), Mutation Surface (formerly State Flux) (59.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **91**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (77.8%), Complexity Load (formerly Cognitive Load) (8.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `try_from` **(Many-Argument Workhorses)** (Impact: 299.1)
  * `try_from` **(Defensive Guards)** (Impact: 42.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 2.423; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `handle_new_session_key` **(Many-Argument Workhorses)** (Impact: 29.5)
**Contextual Mitigations & Amplifications:**
