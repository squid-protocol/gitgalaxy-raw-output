...
## 1. EXECUTIVE SUMMARY
- **Scope:** 57835 analyzed artifact(s), 3537194 LOC.
- **Load-bearing artifact:** `crates/swc_ecma_minifier/benches/full/react.js` -- 402 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `crates/swc_ecma_ast/src/lib.rs` -- pulls in 441 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `crates/swc_ecma_minifier/benches/full/lodash.js` at magnitude 480917.15 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 57835 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 24751 |
| Total LOC | 3537194 |
...
|---|---|---|
| Modularity | 0.8451 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.2954 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.1% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.093 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 101 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| JAVASCRIPT | 28478 | 848968 | 49.2% |
| JSON | 19417 | 1969836 | 33.6% |
| TYPESCRIPT | 6666 | 191564 | 11.5% |
| CSS | 1337 | 151530 | 2.3% |
...
> **Architectural Drift Z-Score:** `6.62`
> **Composition Archetype:** `Flat Modular Platform` (z +6.62; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 70%, Declarative / Non-Code 8%, State Mutators Files 6%, Callbacks & Closures Files 5%, Interface Declarations Files 3%
...
|---|---|---|
| Unclassified | 57472 | 99.4% |
| Unknown | 1 | 0.0% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 349 | 0.6% |
| Static: Minified & Vendor Opaque Mass | 13 | 0.0% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 24751*
...
- `.map`: 15x Excluded (Saturation: Line 1 exceeds 500 chars), 10x Excluded (Saturation: Line 2 exceeds 500 chars), 1x Excluded (Saturation: Line 11 exceeds 500 chars)

## 6. STRUCTURAL SURFACE PROFILE (formerly Risk Exposure) ANALYSIS (0-100%)
| Structural Surface Vector | Min | Max | Mean | Med | Mode |
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 100.0 | 2.9 | 0.0 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 15.2 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 30.9 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 15150 | 1720 | 0 | `crates/swc_ecma_parser/src/parser/typescript.rs` |
| cleanup | 797 | 159 | 0 | `crates/swc_ecma_minifier/tests/benches-full/three.js` |
| guards | 73170 | 6369 | 1 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
| danger | 41495 | 5620 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
| concurrency | 16283 | 2456 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| connectivity | 37131 | 9064 | 1 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| io | 3394 | 560 | 0 | `crates/swc_bundler/tests/fixture/deno-9591/output/entry.inlined.ts` |
| crypto | 3 | 3 | 0 | `crates/swc/tests/fixture/issues-1xxx/1545/case1/input/index.js` |
| ipc | 139 | 43 | 0 | `crates/swc_ecma_minifier/tests/fixture/issues/quagga2/1.4.2/1/input.js` |
| time | 1687 | 344 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| serialization | 674 | 263 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| regex | 3017 | 312 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| events | 5126 | 412 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| tests | 12038 | 1719 | 0 | `crates/swc_ecma_minifier/tests/exec.rs` |
| docs | 26678 | 2094 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| debt | 22401 | 9001 | 1 | `crates/swc_ecma_minifier/tests/fixture/next/wrap-contracts/output.js` |
| mutation | 345892 | 21658 | 5 | `crates/swc_ecma_minifier/tests/fixture/next/asmjs/1/input.js` |
| dead_code | 25365 | 9086 | 1 | `crates/swc_ecma_minifier/tests/benches-full/d3.js` |
| credential | 35 | 21 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| threat | 21769 | 3627 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
...
3. **test_util.ts** (`crates/swc/tests/deno-unit/test_util.ts`) — 71 inbound connections
...
- `r1` **(Many-Argument Workhorses)** (@ `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js`) -> Impact: **1400.7** | LOC: 873
...
- `parse` **(Defensive Guards)** (@ `crates/swc_ecma_minifier/tests/benches-full/terser.js`) -> Impact: **806.7** | LOC: 823
...
- **Unknown Dependencies:** `24937` packages imported that bypass the Zero-Trust whitelist.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (43.6%), Concurrency Surface (formerly Concurrency) (26.3%)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.9%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.0%), Connectivity (formerly Api Exposure) (78.1%), Complexity Load (formerly Cognitive Load) (48.1%), Concurrency Surface (formerly Concurrency) (13.3%)
- **Documentation Coverage:** 96.0667% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `earcutLinked` **(Many-Argument Workhorses)** (Impact: 290.7)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (85.3%), Complexity Load (formerly Cognitive Load) (48.4%), Concurrency Surface (formerly Concurrency) (16.2%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.9%), Complexity Load (formerly Cognitive Load) (64.4%), Concurrency Surface (formerly Concurrency) (31.2%), Dead Code Surface (formerly Dead Code) (5.5%)
- **Documentation Coverage:** 62.5483% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `applyDirectivesToNode` **(Many-Argument Workhorses)** (Impact: 352.5)
    * *Intent:* * scope argument is auto-generated to the new * child of the transcluded parent scope. * argument ha...
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.6%)
- **Documentation Coverage:** 62.3711% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (81.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.9%)
- **Documentation Coverage:** 80.6835% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createPatchFunction` **(Compute Cores)** (Impact: 351.2)
  * `parseHTML` **(Many-Argument Workhorses)** (Impact: 149.4)
  * `patchVnode` **(Many-Argument Workhorses)** (Impact: 98.9)
  * `enter` **(Many-Argument Workhorses)** (Impact: 97.6)
    * *Intent:* /* */
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (84.3%), Complexity Load (formerly Cognitive Load) (50.2%), Concurrency Surface (formerly Concurrency) (38.2%), Dead Code Surface (formerly Dead Code) (5.8%)
- **Documentation Coverage:** 55.7983% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.8%), Connectivity (formerly Api Exposure) (39.1%), Complexity Load (formerly Cognitive Load) (32.9%), Concurrency Surface (formerly Concurrency) (21.7%)
- **Documentation Coverage:** 94.0334% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse` **(Defensive Guards)** (Impact: 806.7)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.9%), Concurrency Surface (formerly Concurrency) (65.3%), Connectivity (formerly Api Exposure) (44.8%), Complexity Load (formerly Cognitive Load) (37.1%)
- **Documentation Coverage:** 77.4% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ast` **(Defensive Guards)** (Impact: 380.4)
    * *Intent:* /* */ var ref$1 = (baseCompile = function(template, options) {
  * `patch` **(Defensive Guards)** (Impact: 296.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.017; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (91.5%), Concurrency Surface (formerly Concurrency) (85.7%), Connectivity (formerly Api Exposure) (39.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.9%), Complexity Load (formerly Cognitive Load) (53.2%), Concurrency Surface (formerly Concurrency) (34.7%), Dead Code Surface (formerly Dead Code) (5.2%)
- **Documentation Coverage:** 41.1552% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `addModule` **(Many-Argument Workhorses)** (Impact: 160.3)
    * *Intent:* * with regard to the position of the trigger module. * This should be one of three values: `before`,...
  * `parseUA` **(Many-Argument Workhorses)** (Impact: 130.3)
    * *Intent:* * these fields can have. */ /** * Static method on `YUI.Env` for parsing a UA string. Called at inst...
  ...
  * `resolve` **(Many-Argument Workhorses)** (Impact: 114.3)
    * *Intent:* * * var Y = YUI(); * var loader = new Y.Loader({ * filter: 'debug', * base: '../../', * root: 'build...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (59.2%)
- **Documentation Coverage:** 31.6456% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `addModule` **(Many-Argument Workhorses)** (Impact: 159.5)
    * *Intent:* * with regard to the position of the trigger module. * This should be one of three values: `before`,...
  * `parseUA` **(Many-Argument Workhorses)** (Impact: 130.6)
    * *Intent:* * these fields can have. */ /** * Static method on `YUI.Env` for parsing a UA string. Called at inst...
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Concurrency Surface (formerly Concurrency) (15.8%), Dead Code Surface (formerly Dead Code) (5.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Complexity Load (formerly Cognitive Load) (98.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.9%)
- **Documentation Coverage:** 99.6109% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **97**; blast radius 0.017; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.4%), Connectivity (formerly Api Exposure) (82.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.3%)
- **Documentation Coverage:** 94.9416% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_export_decl` **(Many-Argument Workhorses)** (Impact: 139.8)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (95.0%), Concurrency Surface (formerly Concurrency) (15.0%), Dead Code Surface (formerly Dead Code) (5.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `matchNode` **(Many-Argument Workhorses)** (Impact: 462.5)
  * `search` **(Many-Argument Workhorses)** (Impact: 264.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.6%), Complexity Load (formerly Cognitive Load) (32.4%), Concurrency Surface (formerly Concurrency) (31.6%), Dead Code Surface (formerly Dead Code) (5.1%)
- **Documentation Coverage:** 35.6863% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `getRequires` **(Compute Cores)** (Impact: 107.8)
    * *Intent:* /** * Returns an object containing properties for all modules required * in order to load the reques...
  * `resolve` **(Defensive Guards)** (Impact: 102.7)
    * *Intent:* * * var Y = YUI(); * var loader = new Y.Loader({ * filter: 'debug', * base: '../../', * root: 'build...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.0%), Mutation Surface (formerly State Flux) (29.7%)
- **Documentation Coverage:** 36.3057% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.017; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (80.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (62.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_appropriate_place_for_inserting_node` **(Many-Argument Workhorses)** (Impact: 75.5)
...
- `crates/swc_ecma_minifier/benches/full/react.js` -> **Severity: 0.4** (Embedded: 0.0069 * Error Risk: 57.5285%)
- `crates/swc/tests/deno-unit/test_util.ts` -> **Severity: 0.083** (Embedded: 0.0012 * Error Risk: 67.5663%)
- `crates/swc_node_bundler/tests/pass/deno-001/full/input/io/bufio.ts` -> **Severity: 0.058** (Embedded: 0.0007 * Error Risk: 84.7938%)
- `crates/swc_node_bundler/tests/pass/deno-001/full/input/bytes/mod.ts` -> **Severity: 0.041** (Embedded: 0.0005 * Error Risk: 89.9505%)
- `crates/swc_bundler/tests/deno-exec/deno-8224/haystack-core/input/filter/Node.ts` -> **Severity: 0.04** (Embedded: 0.0005 * Error Risk: 84.655%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `crates/swc_ecma_minifier/benches/full/react.js` -> **Severity: 445.394** (Blast Radius: 5.753 * Doc Risk: 77.4194%)
- `crates/swc/tests/deno-unit/test_util.ts` -> **Severity: 49.323** (Blast Radius: 1.023 * Doc Risk: 48.2143%)
- `crates/swc/tests/projects/issue-655/ts.ts` -> **Severity: 43.1** (Blast Radius: 0.431 * Doc Risk: 100.0%)
