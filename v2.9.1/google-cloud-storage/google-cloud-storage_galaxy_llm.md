...
## 1. EXECUTIVE SUMMARY
- **Scope:** 171 analyzed artifact(s), 59026 LOC.
- **Load-bearing artifact:** `google_cloud_storage-3.10.1/google/cloud/storage/exceptions.py` -- 38 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `google_cloud_storage-3.10.1/tests/unit/test_blob.py` -- pulls in 35 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `google_cloud_storage-3.10.1/tests/unit/gapic/storage_v2/test_storage.py` at magnitude 5643.32 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.828`
> **Composition Archetype:** `Small Flat Repo (2)` (z +1.83; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 22%, Large Core Modules (2) 18%, Large Core Modules (3) 14%, Declarative / Non-Code 13%, Parameter Forwarders Files 13%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 47.6 | 43.8 | 0.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (23.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **35**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.8%), Connectivity (formerly Api Exposure) (70.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (41.5%), Connectivity (formerly Api Exposure) (11.6%)
- **Documentation Coverage:** 98.6278% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_generate_signed_url_helper` **(Many-Argument Workhorses)** (Impact: 55.2)
  * `_rename_blob_helper` **(Many-Argument Workhorses)** (Impact: 19.0)
  * `_make_one` **(Stateful Encapsulated Methods)** (Impact: 14.2)
  * `_generate_upload_policy_helper` **(Stateful Encapsulated Methods)** (Impact: 10.4)
  * `_make_public_w_future_helper` **(Stateful Encapsulated Methods)** (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.8%)
- **Documentation Coverage:** 71.5596% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 67.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **18**; blast radius 5.763; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 85.2941% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **27**; blast radius 5.756; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.5%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 35.8974% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (41.1%), Connectivity (formerly Api Exposure) (10.4%)
- **Documentation Coverage:** 99.2674% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_prepare_conditions` **(Stateful Encapsulated Methods)** (Impact: 5.2)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **22**; blast radius 6.237; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (74.3%)
- **Documentation Coverage:** 23.0508% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **26**; blast radius 6.094; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (52.1%)
- **Documentation Coverage:** 66.1017% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (90.7%), Guard Balance (formerly Safety Score) (72.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (9.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_mock_response` **(Stateful Encapsulated Methods)** (Impact: 9.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (96.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (27.3%), Connectivity (formerly Api Exposure) (10.0%)
- **Documentation Coverage:** 55.1598% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `bucket_set_iam_policy` **(Compute Cores)** (Impact: 6.7)
  * `bucket_rename_blob` **(Compute Cores)** (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (31.9%), Guard Balance (formerly Safety Score) (17.0%), Connectivity (formerly Api Exposure) (11.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (25.5%), Connectivity (formerly Api Exposure) (10.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (53.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (42.9%)
- **Documentation Coverage:** 85.4167% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_read_unfinalized_appendable_object_with_generation` **(Stateful Encapsulated Methods)** (Impact: 4.8)
  ...
  * `test_basic_wrd_x_region` **(Stateful Encapsulated Methods)** (Impact: 4.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **19**; blast radius 4.527; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (11.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Debt Markers (formerly Tech Debt) (73.3%), Complexity Load (formerly Cognitive Load) (51.4%)
- **Documentation Coverage:** 35.2941% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_prepare_initiate_request` **(Stateful Encapsulated Methods)** (Impact: 27.7)
  ...
  * `_process_resumable_response` **(Stateful Encapsulated Methods)** (Impact: 18.9)
    * *Intent:* """Process the response from an HTTP request. This is everything that must be done after a request t...
  * `_process_recover_response` **(Stateful Encapsulated Methods)** (Impact: 15.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Concurrency Surface (formerly Concurrency) (42.0%), Complexity Load (formerly Cognitive Load) (37.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_upload_many_with_filenames` **(I/O & Config Routines)** (Impact: 5.2)
  * `test_upload_many_with_file_objs` **(I/O & Config Routines)** (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (44.1%), Connectivity (formerly Api Exposure) (10.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_make_credentials` **(Encapsulated Accessors)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (59.7%), Guard Balance (formerly Safety Score) (55.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (46.9%), Complexity Load (formerly Cognitive Load) (38.4%)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **17**; blast radius 10.457; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 51.5152% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `append` **(Many-Argument Workhorses)** (Impact: 41.9)
  * `open` **(Stateful Encapsulated Methods)** (Impact: 34.0)
  * `send_and_recv_generator` **(Stateful Encapsulated Methods)** (Impact: 27.2)
  * `_is_write_retryable` **(Stateful Encapsulated Methods)** (Impact: 17.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (47.6%), Guard Balance (formerly Safety Score) (28.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 3.115; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (50.0%), Guard Balance (formerly Safety Score) (45.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **14**; blast radius 5.757; role: Transceiver (Middle-Tier)
...
- **Documentation Coverage:** 30.4348% of unit weight undocumented
**Top Internal Functions/Classes:**
