# ARCHITECTURAL_BRIEF: fs-constants
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 2 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 14.52 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 8.0 | 4.0 | 4.0 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 64.6 | 68.4 | 66.5 | 66.5 | 64.6 |
...
| Mutation Surface (formerly State Flux Exposure) | 16.8 | 50.0 | 33.4 | 33.4 | 16.8 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 2 | 2 | 1 | `package/browser.js` |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 2 | 2 | 1 | `package/browser.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- **Magnitude:** 14.52 | **LOC:** 2 | **CtrlFlow:** 100.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 250.0; role: Isolated/Orphan
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` constants, fs
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 250.0
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` constants
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
