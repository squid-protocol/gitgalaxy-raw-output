...
## 1. EXECUTIVE SUMMARY
- **Scope:** 23827 analyzed artifact(s), 1268147 LOC.
- **Load-bearing artifact:** `dev/tests/integration/framework/Magento/TestFramework/Helper/Bootstrap.php` -- 2532 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `dev/tests/integration/testsuite/Magento/Framework/GraphQl/_files/schema_response_sdl_description.php` -- pulls in 344 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `app/code/Magento/Downloadable/view/adminhtml/templates/product/edit/downloadable/links.phtml` at magnitude 7994.77 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `5.413`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +5.41; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 28%, Declarative / Non-Code 17%, Parameter Forwarders Files 10%, Encapsulated Accessors Files 10%, Interface Declarations Files 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 3.1 | 0.0 | 0.0 |
...
| connectivity | 55057 | 13741 | 5 | `app/code/Magento/Sales/Model/Order.php` |
...
| threat | 751 | 401 | 0 | `app/code/Magento/Customer/Setup/CustomerSetup.php` |
...
- `scan` **(I/O & Config Routines)** (@ `setup/src/Magento/Setup/Module/Di/Code/Reader/FileScanner.php`) -> Impact: **86.3** | LOC: 347
  * *Intent:* /** * @inheritDoc */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.027; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.5%), Complexity Load (formerly Cognitive Load) (75.7%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **60**; blast radius 0.035; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (40.6%), Connectivity (formerly Api Exposure) (14.1%)
- **Documentation Coverage:** 67.1233% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_formShipmentRequest` **(Many-Argument Workhorses)** (Impact: 56.9)
  * `_formShipmentRestRequest` **(Many-Argument Workhorses)** (Impact: 54.4)
...
- **Blast Radius:** changing it is visible to **26** in-repo importer(s); it depends on **53**; blast radius 0.182; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.4%), Complexity Load (formerly Cognitive Load) (37.1%), Connectivity (formerly Api Exposure) (21.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `formatStockDataForRow` **(Stateful Encapsulated Methods)** (Impact: 21.1)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Complexity Load (formerly Cognitive Load) (36.7%), Debt Markers (formerly Tech Debt) (12.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **238** in-repo importer(s); it depends on **44**; blast radius 1.663; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (99.0%), Guard Balance (formerly Safety Score) (71.0%), Complexity Load (formerly Cognitive Load) (22.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `registerCancellation` **(Many-Argument Workhorses)** (Impact: 21.3)
    * *Intent:* /** * Prepare order totals to cancellation * * @param string $comment * @param bool $graceful * @ret...
  * `_canReorder` **(Stateful Encapsulated Methods)** (Impact: 15.9)
    * *Intent:* /** * Retrieve order reorder availability * * @param bool $ignoreSalable * @return bool * @SuppressW...
  * `canCancel` **(Compute Cores)** (Impact: 14.8)
    * *Intent:* /** * Retrieve order cancel availability * * @return bool * @SuppressWarnings(PHPMD.CyclomaticComple...
  * `canCreditmemoForZeroTotal` **(Stateful Encapsulated Methods)** (Impact: 13.8)
...
- **Blast Radius:** changing it is visible to **94** in-repo importer(s); it depends on **26**; blast radius 1.396; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.2%), Connectivity (formerly Api Exposure) (47.9%), Complexity Load (formerly Cognitive Load) (36.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.6%), Complexity Load (formerly Cognitive Load) (39.1%), Debt Markers (formerly Tech Debt) (16.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_getSpecificTypeData` **(Stateful Encapsulated Methods)** (Impact: 29.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **15**; blast radius 0.046; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Complexity Load (formerly Cognitive Load) (36.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `capItemsPerPageByAttributeCount` **(Stateful Encapsulated Methods)** (Impact: 17.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **21**; blast radius 0.039; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.9%), Complexity Load (formerly Cognitive Load) (41.5%), Connectivity (formerly Api Exposure) (28.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_formIntlShipmentRequest` **(Many-Argument Workhorses)** (Impact: 74.5)
  ...
  * `_formUsSignatureConfirmationShipmentRequest` **(Many-Argument Workhorses)** (Impact: 43.7)
    * *Intent:* /** * Form XML for US Signature Confirmation request * As integration guide it is important to follo...
  * `_parseXmlResponse` **(Defensive Guards)** (Impact: 39.5)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **21**; blast radius 0.064; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.5%), Complexity Load (formerly Cognitive Load) (37.0%), Connectivity (formerly Api Exposure) (25.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_prepareCustomerAddress` **(Stateful Encapsulated Methods)** (Impact: 25.0)
    * *Intent:* /** * Create customer address and save it in the quote so that it can be used to persist later. * * ...
  * `_setQuoteAddress` **(Many-Argument Workhorses)** (Impact: 23.3)
...
- **Blast Radius:** changing it is visible to **208** in-repo importer(s); it depends on **22**; blast radius 1.782; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.1%), Connectivity (formerly Api Exposure) (79.3%), Complexity Load (formerly Cognitive Load) (37.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **18** in-repo importer(s); it depends on **4**; blast radius 0.246; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **162** in-repo importer(s); blast radius 1.145; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Guard Balance (formerly Safety Score) (35.2%), Complexity Load (formerly Cognitive Load) (3.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **18**; blast radius 0.181; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **32**; blast radius 0.043; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.9%), Complexity Load (formerly Cognitive Load) (35.6%), Connectivity (formerly Api Exposure) (20.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_formShipmentRequest` **(I/O & Config Routines)** (Impact: 31.7)
  ...
  * `_prepareRateResponse` **(Stateful Encapsulated Methods)** (Impact: 19.6)
...
- **Blast Radius:** changing it is visible to **516** in-repo importer(s); it depends on **15**; blast radius 4.708; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (90.8%), Guard Balance (formerly Safety Score) (86.3%), Complexity Load (formerly Cognitive Load) (43.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__toArray` **(Callbacks & Closures)** (Impact: 9.0)
...
- **Blast Radius:** changing it is visible to **48** in-repo importer(s); it depends on **28**; blast radius 0.354; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (94.7%), Guard Balance (formerly Safety Score) (80.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `updateOrder` **(Stateful Encapsulated Methods)** (Impact: 30.3)
  ...
  * `processAction` **(Stateful Encapsulated Methods)** (Impact: 22.1)
    * *Intent:* /** * Perform actions based on passed action name * * @param string $action * @param Order $order * ...
  * `refund` **(I/O & Config Routines)** (Impact: 21.8)
...
- **Blast Radius:** changing it is visible to **101** in-repo importer(s); it depends on **47**; blast radius 0.655; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (51.1%), Connectivity (formerly Api Exposure) (46.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `beforeSave` **(Defensive Guards)** (Impact: 19.3)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 0.033; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `correctText` **(Stateful Encapsulated Methods)** (Impact: 39.8)
  ...
  * `correctLines` **(Stateful Encapsulated Methods)** (Impact: 33.9)
...
- **Blast Radius:** changing it is visible to **19** in-repo importer(s); it depends on **71**; blast radius 0.153; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.3%), Complexity Load (formerly Cognitive Load) (47.3%), Connectivity (formerly Api Exposure) (37.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `initiatePasswordReset` **(Many-Argument Workhorses)** (Impact: 19.6)
    * *Intent:* /** * @inheritdoc */
  * `validateResetPasswordToken` **(Stateful Encapsulated Methods)** (Impact: 11.6)
    * *Intent:* /** * Validate the Reset Password Token for a customer. * * @param int $customerId * @param string $...
  * `makeRequiredCharactersCheck` **(Stateful Encapsulated Methods)** (Impact: 11.2)
...
- **Blast Radius:** changing it is visible to **33** in-repo importer(s); it depends on **13**; blast radius 0.413; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.3%), Connectivity (formerly Api Exposure) (57.5%), Complexity Load (formerly Cognitive Load) (22.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **62**; blast radius 0.094; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.1%), Connectivity (formerly Api Exposure) (23.3%), Complexity Load (formerly Cognitive Load) (22.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `getSchemaDataHandler` **(Stateful Encapsulated Methods)** (Impact: 27.7)
  ...
  * `installOrderIncrementPrefix` **(Stateful Encapsulated Methods)** (Impact: 17.0)
...
- **Blast Radius:** changing it is visible to **34** in-repo importer(s); it depends on **25**; blast radius 0.313; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.5%), Connectivity (formerly Api Exposure) (38.4%), Complexity Load (formerly Cognitive Load) (37.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `checkSelectionsIsSale` **(Stateful Encapsulated Methods)** (Impact: 23.4)
    * *Intent:* /** * Check if selection is salable * * @param \Magento\Bundle\Model\ResourceModel\Selection\Collect...
  * `getQty` **(Stateful Encapsulated Methods)** (Impact: 20.8)
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (78.8%), Complexity Load (formerly Cognitive Load) (37.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%), Connectivity (formerly Api Exposure) (5.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `updateProduct` **(Stateful Encapsulated Methods)** (Impact: 15.5)
    * *Intent:* /** * Update product * * @param array $product * @param string|null $token * @return array|bool|floa...
  * `saveProduct` **(Stateful Encapsulated Methods)** (Impact: 15.4)
...
- **Blast Radius:** changing it is visible to **52** in-repo importer(s); it depends on **16**; blast radius 0.421; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Connectivity (formerly Api Exposure) (85.6%), Guard Balance (formerly Safety Score) (79.3%), Complexity Load (formerly Cognitive Load) (12.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
