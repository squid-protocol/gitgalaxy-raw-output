...
## 1. EXECUTIVE SUMMARY
- **Scope:** 580 analyzed artifact(s), 38137 LOC.
- **Load-bearing artifact:** `package/index.js` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/core/network/21-httprequest.js` -- pulls in 14 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/core/network/10-mqtt.js` at magnitude 3926.98 (structural weight, not risk).
...
> **Composition Archetype:** `Mid Flat Project` (z +4.60; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 94%, Large Core Modules (2) 4%, Callbacks & Closures Files 1%, Large Core Modules (3) 0%, Compute Cores Files 0%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 9.9 | 0.0 | 0.0 |
...
| credential | 4 | 1 | 0 | `package/locales/zh-TW/messages.json` |
| threat | 63 | 20 | 0 | `package/core/function/10-function.js` |
| ml_ai | 0 | 0 | 0 | - |
...
- `createLWT` **(Many-Argument Workhorses)** (@ `package/core/network/10-mqtt.js`) -> Impact: **661.3** | LOC: 739
- `exports` **(Defensive Guards)** (@ `package/core/network/10-mqtt.js`) -> Impact: **637.5** | LOC: 1323
...
- `setOptions` **(Many-Argument Workhorses)** (@ `package/core/network/10-mqtt.js`) -> Impact: **607.1** | LOC: 1022
- `MQTTBrokerNode` **(Defensive Guards)** (@ `package/core/network/10-mqtt.js`) -> Impact: **505.8** | LOC: 1036
  * *Intent:* //#endregion "Supporting functions" //#region "Broker node"
- `exports` **(Defensive Guards)** (@ `package/core/parsers/70-CSV.js`) -> Impact: **493.3** | LOC: 674
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
- `exports` **(Defensive Guards)** (@ `package/core/network/21-httprequest.js`) -> Impact: **403.9** | LOC: 838
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
- `exports` **(Defensive Guards)** (@ `package/core/network/31-tcpin.js`) -> Impact: **379.5** | LOC: 887
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
- `exports` **(Defensive Guards)** (@ `package/core/sequence/17-split.js`) -> Impact: **373.7** | LOC: 799
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
- `HTTPRequest` **(Defensive Guards)** (@ `package/core/network/21-httprequest.js`) -> Impact: **356.8** | LOC: 687
- `exports` **(Defensive Guards)** (@ `package/core/function/10-switch.js`) -> Impact: **244.7** | LOC: 510
  * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except in compliance with the License. * You may obtai...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.1%)
- **Documentation Coverage:** 40.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createLWT` **(Many-Argument Workhorses)** (Impact: 661.3)
  * `exports` **(Defensive Guards)** (Impact: 637.5)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `setOptions` **(Many-Argument Workhorses)** (Impact: 607.1)
  * `MQTTBrokerNode` **(Defensive Guards)** (Impact: 505.8)
    * *Intent:* //#endregion "Supporting functions" //#region "Broker node"
  * `MQTTInNode` **(Defensive Guards)** (Impact: 100.5)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.5%), Guard Balance (formerly Safety Score) (94.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 373.7)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `JoinNode` **(Defensive Guards)** (Impact: 208.5)
  * `SplitNode` **(Defensive Guards)** (Impact: 112.4)
  * `completeSend` **(Defensive Guards)** (Impact: 38.3)
  * `reduceMessage` **(Many-Argument Workhorses)** (Impact: 28.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.719; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.8%), Complexity Load (formerly Cognitive Load) (77.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 493.3)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `hasTemplate` **(Defensive Guards)** (Impact: 151.8)
  * `CSVNode` **(Defensive Guards)** (Impact: 84.9)
  * `clean` **(Defensive Guards)** (Impact: 64.6)
    * *Intent:* // pass in an array of column names to be trimmed, de-quoted and retrimmed
  * `addQuotes` **(Compute Cores)** (Impact: 12.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Concurrency Surface (formerly Concurrency) (90.1%), Complexity Load (formerly Cognitive Load) (83.0%)
- **Documentation Coverage:** 54.5455% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 379.5)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `TcpGet` **(Defensive Guards)** (Impact: 174.0)
  * `TcpOut` **(Defensive Guards)** (Impact: 95.2)
  * `TcpIn` **(Defensive Guards)** (Impact: 94.0)
  * `setupTcpClient` **(Defensive Guards)** (Impact: 29.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (91.5%), Guard Balance (formerly Safety Score) (78.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 73.6842% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 403.9)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `HTTPRequest` **(Defensive Guards)** (Impact: 356.8)
  * `updateKey` **(Many-Argument Workhorses)** (Impact: 82.4)
  * `buildDigestHeader` **(Many-Argument Workhorses)** (Impact: 49.2)
  * `ha1Compute` **(Many-Argument Workhorses)** (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (82.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (40.1%)
- **Documentation Coverage:** 70.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 223.8)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `ChangeNode` **(Defensive Guards)** (Impact: 223.5)
  * `applyRule` **(Defensive Guards)** (Impact: 119.8)
  * `callback` **(Defensive Guards)** (Impact: 36.3)
  * `getToValue` **(Defensive Guards)** (Impact: 33.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.1%), Complexity Load (formerly Cognitive Load) (76.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 81.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 180.4)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `FileNode` **(Defensive Guards)** (Impact: 102.7)
  * `processMsg2` **(Many-Argument Workhorses)** (Impact: 96.2)
  * `FileInNode` **(Defensive Guards)** (Impact: 75.0)
  * `processMsg2` **(Many-Argument Workhorses)** (Impact: 73.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (95.9%), Guard Balance (formerly Safety Score) (91.2%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 184.2)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `TriggerNode` **(Defensive Guards)** (Impact: 183.9)
  * `processMessage` **(Defensive Guards)** (Impact: 108.4)
  * `processMessageQueue` **(Defensive Guards)** (Impact: 7.0)
  * `stat` **(Defensive Guards)** (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.2%), Guard Balance (formerly Safety Score) (68.0%)
- **Documentation Coverage:** 88.2353% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 244.7)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `SwitchNode` **(Defensive Guards)** (Impact: 107.1)
  * `getV1` **(Defensive Guards)** (Impact: 40.8)
  * `processMessage` **(Compute Cores)** (Impact: 29.4)
  * `getV2` **(Defensive Guards)** (Impact: 28.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.8%), Complexity Load (formerly Cognitive Load) (96.7%), Guard Balance (formerly Safety Score) (95.4%)
- **Documentation Coverage:** 81.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 214.1)
    * *Intent:* * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file except...
  * `DelayNode` **(Defensive Guards)** (Impact: 208.8)
  * `maxKeptMsgsCount` **(Defensive Guards)** (Impact: 6.3)
  * `clearDelayList` **(Callbacks & Closures)** (Impact: 6.0)
  * `sendMsgFromBuffer` **(I/O & Config Routines)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (97.7%), Guard Balance (formerly Safety Score) (77.8%)
- **Documentation Coverage:** 78.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 146.6)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `FunctionNode` **(Defensive Guards)** (Impact: 108.4)
  * `sendResults` **(Defensive Guards)** (Impact: 50.8)
  * `processMessage` **(Defensive Guards)** (Impact: 39.5)
  * `updateErrorInfo` **(Compute Cores)** (Impact: 7.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (90.3%), Guard Balance (formerly Safety Score) (67.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onpaletteadd` **(Defensive Guards)** (Impact: 108.5)
  * `handleDebugMessage` **(Defensive Guards)** (Impact: 48.8)
  * `requestDebugNodeList` **(Defensive Guards)** (Impact: 39.6)
  * `oneditprepare` **(Defensive Guards)** (Impact: 34.0)
  * `getNodeLabel` **(Defensive Guards)** (Impact: 33.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (97.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (68.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `addItem` **(Many-Argument Workhorses)** (Impact: 179.1)
  * `oneditprepare` **(Defensive Guards)** (Impact: 107.3)
  * `exportRule` **(Defensive Guards)** (Impact: 32.5)
  * `outputLabels` **(Defensive Guards)** (Impact: 24.9)
  * `validate` **(Defensive Guards)** (Impact: 20.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.9%), Concurrency Surface (formerly Concurrency) (84.6%), Complexity Load (formerly Cognitive Load) (82.0%)
- **Documentation Coverage:** 65.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Compute Cores)** (Impact: 135.1)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `WebSocketListenerNode` **(Compute Cores)** (Impact: 72.1)
    * *Intent:* // A node red node that sets up a local websocket server
  * `WebSocketOutNode` **(Compute Cores)** (Impact: 29.0)
  * `handleConnection` **(Callbacks & Closures)** (Impact: 18.6)
  * `handleEvent` **(Defensive Guards)** (Impact: 18.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `oneditprepare` **(I/O & Config Routines)** (Impact: 65.7)
  * `label` **(Defensive Guards)** (Impact: 55.1)
  * `oneditsave` **(Compute Cores)** (Impact: 43.1)
  * `doInject` **(Compute Cores)** (Impact: 18.7)
    * *Intent:* /** Perform inject, optionally sending a custom msg (refactored for re-use in the form inject button...
  * `outputLabels` **(Defensive Guards)** (Impact: 17.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (82.3%), Guard Balance (formerly Safety Score) (82.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 73.913% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 165.9)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `HTTPOut` **(Defensive Guards)** (Impact: 53.2)
  * `HTTPIn` **(Defensive Guards)** (Impact: 50.0)
  * `rawBodyParser` **(Defensive Guards)** (Impact: 46.1)
  * `createRequestWrapper` **(Defensive Guards)** (Impact: 11.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.8%), Concurrency Surface (formerly Concurrency) (76.3%), Guard Balance (formerly Safety Score) (50.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 159.3)
  * `DebugNode` **(Defensive Guards)** (Impact: 117.6)
  * `prepareStatus` **(Defensive Guards)** (Impact: 18.8)
  * `prepareValue` **(Defensive Guards)** (Impact: 13.1)
  * `setNodeState` **(State Mutators)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Complexity Load (formerly Cognitive Load) (91.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 84.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Compute Cores)** (Impact: 99.9)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `BatchNode` **(Defensive Guards)** (Impact: 52.0)
  * `concat_msg` **(Many-Argument Workhorses)** (Impact: 24.1)
  * `add_to_topic_group` **(Many-Argument Workhorses)** (Impact: 12.1)
  * `try_concat` **(Compute Cores)** (Impact: 9.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.3%), Guard Balance (formerly Safety Score) (56.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (24.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `oneditprepare` **(Defensive Guards)** (Impact: 58.5)
  * `setUpSection` **(Compute Cores)** (Impact: 41.9)
  * `oneditsave` **(Defensive Guards)** (Impact: 20.1)
  * `oneditprepare` **(I/O & Config Routines)** (Impact: 17.5)
  * `saveV5Message` **(Defensive Guards)** (Impact: 15.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 37 instances
* *Concurrency (weighted view):* 9
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.7%), Complexity Load (formerly Cognitive Load) (83.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 129.4)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `UDPout` **(Defensive Guards)** (Impact: 80.4)
    * *Intent:* // The Output Node
  * `UDPin` **(Defensive Guards)** (Impact: 49.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `addItem` **(Many-Argument Workhorses)** (Impact: 50.5)
  * `prepareLibraryConfig` **(Defensive Guards)** (Impact: 40.9)
  * `oneditprepare` **(I/O & Config Routines)** (Impact: 36.7)
  * `buildEditor` **(Many-Argument Workhorses)** (Impact: 15.6)
  * `onchange` **(Compute Cores)** (Impact: 13.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (93.3%), Guard Balance (formerly Safety Score) (91.7%), Complexity Load (formerly Cognitive Load) (86.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 109.1)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `ExecNode` **(Defensive Guards)** (Impact: 108.6)
  * `cleanup` **(Callbacks & Closures)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.4%), Complexity Load (formerly Cognitive Load) (64.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `addItem` **(Many-Argument Workhorses)** (Impact: 67.1)
  * `oneditprepare` **(I/O & Config Routines)** (Impact: 58.9)
  * `validate` **(Defensive Guards)** (Impact: 29.1)
  * `label` **(Defensive Guards)** (Impact: 23.7)
  * `createPropertyValue` **(Defensive Guards)** (Impact: 12.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 33 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (88.2%), Guard Balance (formerly Safety Score) (69.4%)
- **Documentation Coverage:** 80.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 76.1)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `SortNode` **(Defensive Guards)** (Impact: 70.3)
    * *Intent:* // function get_context_val(node, name, dval) { // var context = node.context(); // var val = contex...
  * `processMessage` **(Defensive Guards)** (Impact: 20.9)
  * `sortMessageGroup` **(Callbacks & Closures)** (Impact: 10.7)
  * `sortMessageProperty` **(Defensive Guards)** (Impact: 10.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.719; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (95.1%), Guard Balance (formerly Safety Score) (89.4%), Complexity Load (formerly Cognitive Load) (87.7%)
- **Documentation Coverage:** 57.1429% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 75.5)
    * *Intent:* * * Licensed under the Apache License, Version 2.0 (the "License"); * you may not use this file exce...
  * `InjectNode` **(Defensive Guards)** (Impact: 60.9)
  * `evaluateProperty` **(Defensive Guards)** (Impact: 22.2)
  * `repeaterSetup` **(Callbacks & Closures)** (Impact: 6.6)
  * `close` **(Callbacks & Closures)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
