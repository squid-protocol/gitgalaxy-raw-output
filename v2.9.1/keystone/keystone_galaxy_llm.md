...
## 1. EXECUTIVE SUMMARY
- **Scope:** 579 analyzed artifact(s), 65689 LOC.
- **Load-bearing artifact:** `include/keystone/keystone.h` -- 76 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `llvm/lib/MC/MCParser/AsmParser.cpp` -- pulls in 33 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `llvm/lib/MC/MCParser/AsmParser.cpp` at magnitude 4588.08 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.892`
> **Composition Archetype:** `Hub-Coupled App` (z +1.89; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 17%, Declarative / Non-Code 17%, Parameter Forwarders Files 14%, Large Core Modules (3) 12%, Large Core Modules (2) 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 60.2 | 89.4 | 100.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (95.9%), Guard Balance (formerly Safety Score) (91.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 40.7643% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Debt Markers (formerly Tech Debt) (96.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 94.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.1%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 76.5625% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 1.049; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.2%), Complexity Load (formerly Cognitive Load) (92.3%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Debt Markers (formerly Tech Debt) (92.4%), Guard Balance (formerly Safety Score) (80.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Complexity Load (formerly Cognitive Load) (83.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `p_ere_exp` **(Compute Cores)** (Impact: 86.3)
    * *Intent:* */
  * `p_simp_re` **(Many-Argument Workhorses)** (Impact: 76.6)
    * *Intent:* */
  * `findmust` **(Many-Argument Workhorses)** (Impact: 45.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Debt Markers (formerly Tech Debt) (96.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Debt Markers (formerly Tech Debt) (85.7%), Complexity Load (formerly Cognitive Load) (81.9%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (96.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (62.9%), Complexity Load (formerly Cognitive Load) (50.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Guard Balance (formerly Safety Score) (86.9%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 1.601; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (53.1%)
- **Documentation Coverage:** 51.0638% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (95.3%), Guard Balance (formerly Safety Score) (86.1%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `ks_asm` **(Many-Argument Workhorses)** (Impact: 42.7)
    * *Intent:* */
  * `ks_option` **(Many-Argument Workhorses)** (Impact: 37.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 0.947; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.2%), Connectivity (formerly Api Exposure) (53.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Debt Markers (formerly Tech Debt) (91.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 48.1481% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `StringRef::getAsInteger` **(Many-Argument Workhorses)** (Impact: 47.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.7%), Guard Balance (formerly Safety Score) (95.0%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **7**; blast radius 3.709; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (71.0%), Guard Balance (formerly Safety Score) (23.4%), Debt Markers (formerly Tech Debt) (8.7%)
- **Documentation Coverage:** 1.0363% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.1%), Debt Markers (formerly Tech Debt) (57.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.7%), Guard Balance (formerly Safety Score) (88.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `llvm_ks::ARM::getFPUFeatures` **(Many-Argument Workhorses)** (Impact: 56.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (88.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.5%), Debt Markers (formerly Tech Debt) (68.2%)
- **Documentation Coverage:** 92.1053% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `COFFAsmParser::ParseSectionFlags` **(Many-Argument Workhorses)** (Impact: 72.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.7%), Guard Balance (formerly Safety Score) (95.5%), Complexity Load (formerly Cognitive Load) (94.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `SourceMgr::getLineAndColumn` **(Many-Argument Workhorses)** (Impact: 19.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.9%)
- **Documentation Coverage:** 89.5833% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `raw_ostream::write_escaped` **(Compute Cores)** (Impact: 29.8)
  * `raw_fd_ostream::write_impl` **(Many-Argument Workhorses)** (Impact: 26.6)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **15**; blast radius 6.837; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (68.6%), Complexity Load (formerly Cognitive Load) (32.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (95.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (71.4%)
- **Documentation Coverage:** 93.6364% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MCStreamer::visitUsedExpr` **(Type Conversions)** (Impact: 18.2)
  * `MCStreamer::EmitIntValue` **(Compute Cores)** (Impact: 15.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.865; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (64.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MCObjectFileInfo::initELFMCObjectFileInfo` **(Compute Cores)** (Impact: 76.9)
  * `MCObjectFileInfo::initMachOMCObjectFileInfo` **(I/O & Config Routines)** (Impact: 33.5)
  * `MCObjectFileInfo::InitMCObjectFileInfo` **(Compute Cores)** (Impact: 24.8)
  * `MCObjectFileInfo::initCOFFMCObjectFileInfo` **(I/O & Config Routines)** (Impact: 16.3)
