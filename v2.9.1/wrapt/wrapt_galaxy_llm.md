...
## 1. EXECUTIVE SUMMARY
- **Scope:** 82 analyzed artifact(s), 11562 LOC.
- **Load-bearing artifact:** `wrapt-2.1.2/src/wrapt/__wrapt__.py` -- 6 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `wrapt-2.1.2/README.md` -- pulls in 16 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `wrapt-2.1.2/src/wrapt/_wrappers.c` at magnitude 1958.66 (structural weight, not risk).
...
| Avg Path Length | 1.5854 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `0.958`
> **Composition Archetype:** `Small Flat Repo` (z +0.96; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 34%, Parameter Forwarders Files 34%, Data / Markup / Trivial 11%, Encapsulated Accessors Files 9%, Large Core Modules (3) 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 73.7 | 90.3 | 100.0 |
...
| connectivity | 1509 | 75 | 37 | `wrapt-2.1.2/tests/core/test_object_proxy.py` |
...
| dead_code | 576 | 50 | 14 | `wrapt-2.1.2/tests/core/test_object_proxy.py` |
| credential | 0 | 0 | 0 | - |
...
- `WraptFunctionWrapperBase_descr_get` **(Stateful Encapsulated Methods)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **65.2** | LOC: 145
  * *Intent:* /* ------------------------------------------------------------------------- */
- `decorator` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/decorators.py`) -> Impact: **62.2** | LOC: 261
...
- `WraptBoundFunctionWrapper_call` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **60.1** | LOC: 203
  * *Intent:* /* ------------------------------------------------------------------------- */
- `WraptFunctionWrapper_init` **(Stateful Encapsulated Methods)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **59.9** | LOC: 118
  * *Intent:* /* ------------------------------------------------------------------------- */
- `__wrapped_setattr_fixups__` **(Defensive Guards)** (@ `wrapt-2.1.2/src/wrapt/proxies.py`) -> Impact: **51.7** | LOC: 73
  * *Intent:* """Adjusts special dunder methods on the class as needed based on the wrapped object, when `__wrapped__` is changed. """
- `__new__` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/proxies.py`) -> Impact: **50.8** | LOC: 56
  * *Intent:* """Injects special dunder methods into a dynamically created subclass as needed based on the wrapped object. """
- `formatargspec` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/arguments.py`) -> Impact: **47.1** | LOC: 44
- `WraptFunctionWrapperBase_call` **(Stateful Encapsulated Methods)** (@ `wrapt-2.1.2/src/wrapt/_wrappers.c`) -> Impact: **44.5** | LOC: 91
  * *Intent:* /* ------------------------------------------------------------------------- */
- `__new__` **(Compute Cores)** (@ `wrapt-2.1.2/src/wrapt/proxies.py`) -> Impact: **44.2** | LOC: 53
  * *Intent:* """Injects special dunder methods into a dynamically created subclass as needed based on the wrapped object. """
- `_wrapper` **(Many-Argument Workhorses)** (@ `wrapt-2.1.2/src/wrapt/decorators.py`) -> Impact: **39.7** | LOC: 167
...
| `wrapt-2.1.2/src/wrapt` | 11 | 3933.54 | 44.54% | 18.59% |
...
- **Magnitude:** 1958.66 | **LOC:** 4098 | **CtrlFlow:** 16.6% | **Authorship Centralization:** 0.0%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 38.246; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (90.5%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `WraptFunctionWrapperBase_descr_get` **(Stateful Encapsulated Methods)** (Impact: 65.2)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptBoundFunctionWrapper_call` **(Many-Argument Workhorses)** (Impact: 60.1)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptFunctionWrapper_init` **(Stateful Encapsulated Methods)** (Impact: 59.9)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptFunctionWrapperBase_call` **(Stateful Encapsulated Methods)** (Impact: 44.5)
    * *Intent:* /* ------------------------------------------------------------------------- */
  * `WraptObjectProxy_raw_init` **(Stateful Encapsulated Methods)** (Impact: 30.1)
    * *Intent:* /* ------------------------------------------------------------------------- */
...
* *Risk/State:* `safety_bypasses: 155`, `state_mutation: 223`, `dead_code: 9`, `unreferenced_by_name: 2`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (65.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (44.5%), Concurrency Surface (formerly Concurrency) (26.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_self_keyword_argument_on_class_init_overloaded_2a` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_overloaded_2b` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_1` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_2` **(Stateful Encapsulated Methods)** (Impact: 8.6)
  * `test_self_keyword_argument_on_class_init_overloaded_2` **(Stateful Encapsulated Methods)** (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 38.246; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.8%), Complexity Load (formerly Cognitive Load) (80.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.3%)
- **Documentation Coverage:** 94.4882% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 34.9)
    * *Intent:* """ Initialize the `FunctionWrapper` with the `wrapped` callable, the `wrapper` function, and an opt...
  * `__call__` **(Many-Argument Workhorses)** (Impact: 26.0)
  * `__setattr__` **(Defensive Guards)** (Impact: 18.2)
  * `__get__` **(Many-Argument Workhorses)** (Impact: 17.8)
    * *Intent:* # This method is actually doing double duty for both unbound and bound # derived wrapper classes. It...
  * `__call__` **(Stateful Encapsulated Methods)** (Impact: 15.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (28.4%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_inplace_matmul` **(Parameter Forwarders)** (Impact: 4.3)
  * `test_inplace_matmul_immutable` **(Parameter Forwarders)** (Impact: 4.3)
  * `__eq__` **(Defensive Guards)** (Impact: 3.7)
  * `__eq__` **(Defensive Guards)** (Impact: 3.7)
  * `test_inplace_add_integer` **(Parameter Forwarders)** (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 11.379; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (12.1%), Complexity Load (formerly Cognitive Load) (11.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_boolean_dynamic_guard_on_decorator` **(Annotated & Test Methods)** (Impact: 3.1)
  * `test_guard_on_instancemethod` **(Annotated & Test Methods)** (Impact: 3.1)
  * `test_re_bind_after_none` **(Defensive Guards)** (Impact: 3.1)
  * `test_double_binding` **(Defensive Guards)** (Impact: 3.0)
  * `test_function_guard_on_decorator` **(Annotated & Test Methods)** (Impact: 2.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (91.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.1%), Connectivity (formerly Api Exposure) (13.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_patch_function_module_name_enabled_callable` **(Annotated & Test Methods)** (Impact: 3.1)
  * `test_transient_function_wrapper_instance_method` **(Annotated & Test Methods)** (Impact: 2.9)
  * `test_function_wrapper_instance_method` **(Annotated & Test Methods)** (Impact: 2.8)
  * `__call__` **(Parameter Forwarders)** (Impact: 2.8)
  * `__call__` **(Parameter Forwarders)** (Impact: 2.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 16.214; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.3%), Complexity Load (formerly Cognitive Load) (82.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.8889% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decorator` **(Many-Argument Workhorses)** (Impact: 62.2)
    * *Intent:* # Decorator for creating other decorators. This decorator and the # wrappers which they use are desi...
  * `_wrapper` **(Many-Argument Workhorses)** (Impact: 39.7)
    * *Intent:* # The wrapper has been provided so return the final decorator. # The decorator is itself one of our ...
  * `_build` **(Many-Argument Workhorses)** (Impact: 17.6)
    * *Intent:* # Helper function for creating wrapper of the appropriate # time when we need it down below.
  * `synchronized` **(Stateful Encapsulated Methods)** (Impact: 15.1)
    * *Intent:* # Decorator for implementing thread synchronization. It can be used as a # decorator, in which case ...
  * `_synchronized_wrapper` **(Stateful Encapsulated Methods)** (Impact: 7.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (55.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (27.0%), Connectivity (formerly Api Exposure) (9.0%)
- **Documentation Coverage:** 92.5926% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_class_object_qualname` **(Defensive Guards)** (Impact: 3.3)
    * *Intent:* # Test preservation of instance method __qualname__ attribute. try: __qualname__ = OldClass1o.origin...
  * `test_instance_object_qualname` **(Defensive Guards)** (Impact: 3.3)
  ...
  * `test_class_call_function_nested` **(Encapsulated Accessors)** (Impact: 2.9)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **16**; blast radius 28.321; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.5%), Concurrency Surface (formerly Concurrency) (69.1%), Complexity Load (formerly Cognitive Load) (58.7%)
- **Documentation Coverage:** 79.5455% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find_spec` **(Many-Argument Workhorses)** (Impact: 13.2)
    * *Intent:* # Since Python 3.4, you are meant to implement find_spec() method # instead of find_module() and sin...
  * `find_module` **(Many-Argument Workhorses)** (Impact: 11.9)
    * *Intent:* # If the module being imported is not one we have registered # post import hooks for, we can return ...
  * `register_post_import_hook` **(Many-Argument Workhorses)** (Impact: 10.8)
    * *Intent:* """ Register a post import hook for the target module `name`. The `hook` function will be called onc...
  * `_self_set_loader` **(Stateful Encapsulated Methods)** (Impact: 8.2)
    * *Intent:* # Set module's loader to self.__wrapped__ unless it's already set to # something else. Import machin...
  * `__init__` **(Defensive Guards)** (Impact: 7.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.8%), Connectivity (formerly Api Exposure) (10.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_call_semantics_for_assorted_decorator_use_cases` **(Annotated & Test Methods)** (Impact: 4.6)
  * `test_decorated_function_as_instance_attribute` **(C Struct Operations)** (Impact: 3.5)
  * `test_decorated_function_as_class_attribute` **(Annotated & Test Methods)** (Impact: 3.4)
  * `test_call_semantics_for_assorted_wrapped_descriptor_use_cases` **(Annotated & Test Methods)** (Impact: 3.3)
  * `test_decorated_builtin_as_class_attribute` **(Annotated & Test Methods)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `wrap_object` **(Generic / Templated Code)** (Impact: 2.8)
  * `wrap_object_attribute` **(Generic / Templated Code)** (Impact: 2.8)
    * *Intent:* # wrap_object_attribute()
  * `__init__` **(Generic / Templated Code)** (Impact: 2.5)
  * `__exit__` **(Generic / Templated Code)** (Impact: 2.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (63.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (36.9%), Connectivity (formerly Api Exposure) (7.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_class_call_function_nested_decorators` **(Encapsulated Accessors)** (Impact: 2.8)
    * *Intent:* # Test calling classmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _deco...
  * `test_instance_call_function_nested_decorators` **(Encapsulated Accessors)** (Impact: 2.8)
    * *Intent:* # Test calling classmethod via class instance. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt....
  * `test_class_call_function` **(Encapsulated Accessors)** (Impact: 2.7)
    * *Intent:* # Test calling classmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _deco...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 11.379; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  * `resolve_path` **(Compute Cores)** (Impact: 16.4)
    * *Intent:* # Helper functions for applying wrappers to existing functions. """ Resolves the dotted path supplie...
  * `lookup_attribute` **(Compute Cores)** (Impact: 10.8)
    * *Intent:* # We can't just always use getattr() because in doing # that on a class it will cause binding to occ...
  * `_wrapper` **(Stateful Encapsulated Methods)** (Impact: 9.9)
  * `_wrapper` **(Stateful Encapsulated Methods)** (Impact: 9.4)
  * `transient_function_wrapper` **(Stateful Encapsulated Methods)** (Impact: 8.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.967; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (85.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (50.0%), Dead Code Surface (formerly Dead Code) (11.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_synchronized_outer_classmethod` **(Compute Cores)** (Impact: 14.7)
    * *Intent:* # Prior to Python 3.9 this isn't detected as a class method # call, as the classmethod decorator doe...
  * `test_synchronized_instancemethod` **(I/O & Config Routines)** (Impact: 4.6)
  * `test_synchronized_inner_classmethod` **(Defensive Guards)** (Impact: 4.0)
  * `test_synchronized_type_new_style` **(Defensive Guards)** (Impact: 4.0)
  * `test_synchronized_type_old_style` **(Defensive Guards)** (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.967; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (79.8%), Guard Balance (formerly Safety Score) (76.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.7%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_threading_safety_with_entry_points` **(Defensive Guards)** (Impact: 5.9)
    * *Intent:* """Test that entry point discovery is thread-safe"""
  * `test_entry_point_hook_exception_handling` **(Parameter Forwarders)** (Impact: 3.7)
    * *Intent:* """Test that exceptions in entry point hooks are properly propagated"""
  * `test_entry_point_load_failure` **(Parameter Forwarders)** (Impact: 3.5)
    * *Intent:* """Test handling of entry point load failures"""
  * `setup_method` **(Parameter Forwarders)** (Impact: 3.1)
    * *Intent:* """Clean up modules and hooks before each test"""
  * `test_discover_post_import_hooks_python38_style` **(Defensive Guards)** (Impact: 3.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (35.7%), Connectivity (formerly Api Exposure) (7.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_instance_object_qualname` **(Defensive Guards)** (Impact: 3.3)
    * *Intent:* # Test preservation of instance method __qualname__ attribute. try: __qualname__ = Original().origin...
  * `test_class_call_function_nested_decorator` **(Encapsulated Accessors)** (Impact: 2.8)
    * *Intent:* # Test calling staticmethod. _args = (1, 2) _kwargs = {"one": 1, "two": 2} @wrapt.decorator def _dec...
  * `test_instance_call_function_nested_decorator` **(Encapsulated Accessors)** (Impact: 2.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (49.8%), Guard Balance (formerly Safety Score) (22.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_descriptor` **(Defensive Guards)** (Impact: 5.2)
  * `test_aiter` **(Defensive Guards)** (Impact: 4.4)
  * `__get__` **(Defensive Guards)** (Impact: 4.3)
  * `test_next` **(C Struct Operations)** (Impact: 2.5)
  * `test_await` **(Defensive Guards)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (16.8%), Connectivity (formerly Api Exposure) (13.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_instancemethod_delete_function` **(Parameter Forwarders)** (Impact: 2.7)
  * `test_instancemethod_delete_function_and_instance` **(Parameter Forwarders)** (Impact: 2.7)
  * `test_classmethod` **(Annotated & Test Methods)** (Impact: 2.7)
  * `test_instancemethod_delete_instance` **(Parameter Forwarders)** (Impact: 2.6)
  * `test_staticmethod` **(Annotated & Test Methods)** (Impact: 2.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (29.7%), Connectivity (formerly Api Exposure) (6.6%)
- **Documentation Coverage:** 89.7436% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_dynamic_adapter_classmethod` **(Encapsulated Accessors)** (Impact: 3.7)
  * `test_dynamic_adapter_instancemethod` **(Encapsulated Accessors)** (Impact: 3.6)
  * `test_dynamic_adapter_function` **(Encapsulated Accessors)** (Impact: 3.2)
  * `_adapter1` **(Encapsulated Accessors)** (Impact: 2.7)
  * `_adapter2` **(Encapsulated Accessors)** (Impact: 2.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.3%), Complexity Load (formerly Cognitive Load) (7.5%)
- **Documentation Coverage:** 94.4444% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_update_qualname_modified_on_original` **(Parameter Forwarders)** (Impact: 2.5)
  * `test_delete_qualname_modified_on_original` **(Parameter Forwarders)** (Impact: 2.4)
  * `test_delete_annotations_modified_on_original` **(Parameter Forwarders)** (Impact: 2.4)
  * `passthru_decorator` **(Parameter Forwarders)** (Impact: 2.3)
  * `wrapper` **(Parameter Forwarders)** (Impact: 2.3)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (27.0%), Connectivity (formerly Api Exposure) (8.0%)
- **Documentation Coverage:** 72.2222% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pytest_pycollect_makemodule` **(Compute Cores)** (Impact: 16.7)
  * `pytest_collect_file` **(Defensive Guards)** (Impact: 11.5)
    * *Intent:* """ Hook that allows adding our MypyPairCollector when pytest collects files. We attach the collecto...
  * `collect` **(Compute Cores)** (Impact: 9.7)
    * *Intent:* # Only run this custom collection on Python 3.10+ if version < (3, 10): return # Skip mypy tests if ...
  * `runtest` **(Defensive Guards)** (Impact: 6.7)
    * *Intent:* # Try to run mypy; if it's not found, skip the test try: actual_output = run_custom_action(self.py_p...
  * `construct_dummy` **(Defensive Guards)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 15 instances
* *State Mutation (weighted view):* 54
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.967; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (85.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (38.4%), Connectivity (formerly Api Exposure) (7.5%)
- **Documentation Coverage:** 94.5946% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_object_qualname` **(Defensive Guards)** (Impact: 3.3)
    * *Intent:* # Test preservation of function __qualname__ attribute. try: __qualname__ = function1o.__qualname__ ...
  * `test_dynamic_adapter_classmethod` **(C Struct Operations)** (Impact: 3.3)
  * `test_dynamic_adapter_instancemethod` **(C Struct Operations)** (Impact: 3.2)
  * `test_dynamic_adapter_function` **(Encapsulated Accessors)** (Impact: 2.8)
  * `_adapter` **(Encapsulated Accessors)** (Impact: 2.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.967; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (33.3%), Dead Code Surface (formerly Dead Code) (10.2%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_decorator` **(Stateful Encapsulated Methods)** (Impact: 7.4)
  * `_decorator` **(Stateful Encapsulated Methods)** (Impact: 7.4)
  * `test_class_call_function` **(Stateful Encapsulated Methods)** (Impact: 6.4)
    * *Intent:* # Test calling classmethod. Prior to Python 3.9, the instance # and class passed to the wrapper will...
  * `test_instance_call_function` **(Stateful Encapsulated Methods)** (Impact: 6.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 9.967; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (84.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (29.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_import_deadlock_3` **(Annotated & Test Methods)** (Impact: 2.9)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_before_and_after_import` **(Annotated & Test Methods)** (Impact: 2.6)
  * `test_import_deadlock_1` **(Annotated & Test Methods)** (Impact: 2.5)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_import_deadlock_2` **(Annotated & Test Methods)** (Impact: 2.5)
    * *Intent:* # This tries to verify that we haven't created a deadlock situation when # code executed from a post...
  * `test_remove_from_sys_modules` **(Annotated & Test Methods)** (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
