...
## 1. EXECUTIVE SUMMARY
- **Scope:** 738 analyzed artifact(s), 80574 LOC.
- **Load-bearing artifact:** `src/engine/math/vector.ts` -- 96 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/engine/index.ts` -- pulls in 67 dependencies, the widest assembly point in the scan.
...
> **Architectural Drift Z-Score:** `3.095`
> **Composition Archetype:** `Hub-Coupled App` (z +3.10; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 26%, Declarative / Non-Code 26%, Large Core Modules (3) 16%, Callbacks & Closures Files 8%, State Mutators Files 7%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 46.1 | 56.4 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 4.2 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 11.6 | 0.0 | 0.0 |
...
- `constructor` **(Many-Argument Workhorses)** (@ `src/engine/engine.ts`) -> Impact: **116.7** | LOC: 270
...
- `constructor` **(Defensive Guards)** (@ `src/engine/actor.ts`) -> Impact: **72.5** | LOC: 120
  * *Intent:* // #endregion /** * */
...
- `FindContactSeparation` **(Many-Argument Workhorses)** (@ `src/engine/collision/colliders/collision-jump-table.ts`) -> Impact: **61.5** | LOC: 86
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 1.4; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.9%), Debt Markers (formerly Tech Debt) (96.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.757; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (61.3%), Complexity Load (formerly Cognitive Load) (46.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.6%), Guard Balance (formerly Safety Score) (33.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (9.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **41** in-repo importer(s); it depends on **37**; blast radius 18.866; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.5%), Connectivity (formerly Api Exposure) (90.0%), Guard Balance (formerly Safety Score) (80.7%)
- **Documentation Coverage:** 21.9895% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Many-Argument Workhorses)** (Impact: 116.7)
  ...
  * `_initialize` **(Stateful Encapsulated Methods)** (Impact: 18.5)
  ...
  * `useCanvas2DFallback` **(I/O & Config Routines)** (Impact: 15.1)
    * *Intent:* /** * Switches the engine's graphics context to the 2D Canvas. */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **25**; blast radius 2.191; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (96.4%), Guard Balance (formerly Safety Score) (89.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 62.7329% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `debug` **(Many-Argument Workhorses)** (Impact: 30.6)
  * `constructor` **(Defensive Guards)** (Impact: 20.7)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (34.4%), Complexity Load (formerly Cognitive Load) (28.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.757; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (42.7%), Guard Balance (formerly Safety Score) (27.3%), Complexity Load (formerly Cognitive Load) (3.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.5%), Guard Balance (formerly Safety Score) (30.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (59.6%)
- **Documentation Coverage:** 52.2059% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_setResolutionAndViewportByDisplayMode` **(I/O & Config Routines)** (Impact: 15.4)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **17**; blast radius 1.308; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (97.9%), Guard Balance (formerly Safety Score) (94.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 35.5072% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `update` **(Many-Argument Workhorses)** (Impact: 26.8)
  * `action` **(Stateful Encapsulated Methods)** (Impact: 25.2)
  ...
  * `_initialize` **(I/O & Config Routines)** (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 1.083; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Concurrency Surface (formerly Concurrency) (93.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 74.5455% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `arrayToImage` **(Defensive Guards)** (Impact: 28.2)
  * `lzwDecode` **(Many-Argument Workhorses)** (Impact: 26.0)
...
- **Blast Radius:** changing it is visible to **20** in-repo importer(s); it depends on **32**; blast radius 4.806; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.0%), Guard Balance (formerly Safety Score) (83.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.757; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.1%), Guard Balance (formerly Safety Score) (20.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **8**; blast radius 0.903; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (53.3%)
- **Documentation Coverage:** 30.303% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **17**; blast radius 1.606; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (52.6%)
- **Documentation Coverage:** 18.9189% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `triangulate` **(I/O & Config Routines)** (Impact: 27.9)
    * *Intent:* /** * Triangulate the polygon collider using the "Ear Clipping" algorithm. */
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **26**; blast radius 2.129; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.0%), Mutation Surface (formerly State Flux) (95.0%), Connectivity (formerly Api Exposure) (81.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (80.3%), Guard Balance (formerly Safety Score) (48.1%), Complexity Load (formerly Cognitive Load) (8.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **30**; blast radius 3.607; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.3%), Connectivity (formerly Api Exposure) (92.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (68.5%)
- **Documentation Coverage:** 28.3133% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 72.5)
    * *Intent:* // #endregion /** * */
  * `draggable` **(Compute Cores)** (Impact: 10.7)
  * `contains` **(Compute Cores)** (Impact: 9.1)
    * *Intent:* // #region Collision /** * Tests whether the x/y specified are contained in the actor */
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 0.8; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (45.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `isDataWithId` **(C Struct Operations)** (Impact: 16.5)
    * *Intent:* /** * Return true if obj implement DataWithId interface */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **14**; blast radius 1.953; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (76.4%)
- **Documentation Coverage:** 16.3934% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `use` **(Defensive Guards)** (Impact: 14.9)
    * *Intent:* /** * * Optionally override the stored options */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.757; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (55.8%), Complexity Load (formerly Cognitive Load) (22.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **8**; blast radius 1.592; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (73.6%)
- **Documentation Coverage:** 35.4839% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `goToScene` **(Defensive Guards)** (Impact: 48.6)
    * *Intent:* /** * Go to a specific scene, and optionally override loaders and transitions */
  ...
  * `playTransition` **(Defensive Guards)** (Impact: 20.3)
    * *Intent:* /** * Plays a transition in the current scene and does book keeping for input. */
  * `getSceneName` **(Compute Cores)** (Impact: 19.7)
    * *Intent:* /** * Returns the name of the registered scene, null if none can be found */
...
- **Blast Radius:** changing it is visible to **40** in-repo importer(s); it depends on **9**; blast radius 24.824; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 30.8943% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 21.8)
  ...
  * `addComponent` **(Type Conversions)** (Impact: 15.4)
    * *Intent:* /** * Adds a component to the entity */
  * `hasChild` **(Compute Cores)** (Impact: 11.2)
    * *Intent:* /** * Check if a child entity exists on the parent entity */
  * `_getClassHierarchyRoot` **(Stateful Encapsulated Methods)** (Impact: 9.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **16**; blast radius 1.532; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Mutation Surface (formerly State Flux) (85.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `draw` **(Many-Argument Workhorses)** (Impact: 147.0)
  * `_transformFragmentSource` **(Stateful Encapsulated Methods)** (Impact: 14.7)
  * `_addImageAsTexture` **(Stateful Encapsulated Methods)** (Impact: 8.4)
  * `_getTextureIdForImage` **(Stateful Encapsulated Methods)** (Impact: 6.0)
  * `_bindTextures` **(Stateful Encapsulated Methods)** (Impact: 4.6)
**Contextual Mitigations & Amplifications:**
...
- `src/engine/math/vector.ts` -> **Severity: 13.734** (Embedded: 0.1806 * Error Risk: 76.0642%)
- `src/engine/util/log.ts` -> **Severity: 12.166** (Embedded: 0.1258 * Error Risk: 96.6876%)
- `src/engine/event-emitter.ts` -> **Severity: 10.86** (Embedded: 0.1123 * Error Risk: 96.7048%)
- `src/engine/color.ts` -> **Severity: 10.403** (Embedded: 0.1326 * Error Risk: 78.4379%)
- `src/engine/util/util.ts` -> **Severity: 9.718** (Embedded: 0.1106 * Error Risk: 87.8857%)
