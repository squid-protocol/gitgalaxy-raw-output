# ARCHITECTURAL_BRIEF: @snowplow_node-tracker
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2 analyzed artifact(s), 148 LOC.
...
- **Heaviest artifact:** `package/README.md` at magnitude 1.74 (structural weight, not risk).
...
- **Magnitude:** 1.74 | **LOC:** 87 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
