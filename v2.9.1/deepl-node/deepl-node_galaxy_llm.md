# ARCHITECTURAL_BRIEF: deepl-node
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 1414 LOC.
- **Load-bearing artifact:** `package/CONTRIBUTING.md` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/README.md` -- pulls in 3 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/README.md` at magnitude 17.02 (structural weight, not risk).
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 5 | 100.0% |
...
1. **README.md** (`package/README.md`) — 3 outbound dependencies
2. **CONTRIBUTING.md** (`package/CONTRIBUTING.md`) — 2 outbound dependencies
...
- **Magnitude:** 17.02 | **LOC:** 851 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 170.94; role: Pure Consumer (Orchestrator)
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 1):` CONTRIBUTING.md, upgrade_to_multilingual_glossaries.md, upgrading_to_multilingual_glossaries.md
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `package/CHANGELOG.md` (MARKDOWN | Tier 1 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 7.88 | **LOC:** 394 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 1.44 | **LOC:** 72 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 316.239; role: Pure Producer (Foundation)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` CODE_OF_CONDUCT.md, LICENSE
