...
## 1. EXECUTIVE SUMMARY
- **Scope:** 7 analyzed artifact(s), 178 LOC.
...
- **Heaviest artifact:** `game-of-life.cob` at magnitude 72.34 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 43%, Compute Cores Files 14%, Declarative / Non-Code 14%, Interface Declarations Files 14%, Large Core Modules 14%
...
- `print-world` **(Compute Cores)** (@ `game-of-life.cob`) -> Impact: **5.2** | LOC: 5
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.6%), Complexity Load (formerly Cognitive Load) (77.7%), Test Surface (formerly Verification) (2.6%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `check-neighbours` **(I/O & Config Routines)** (Impact: 15.2)
  * `print-world` **(Compute Cores)** (Impact: 5.2)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Complexity Load (formerly Cognitive Load) (59.9%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Complexity Load (formerly Cognitive Load) (53.0%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (75.3%), Debt Markers (formerly Tech Debt) (62.2%), Mutation Surface (formerly State Flux) (16.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
