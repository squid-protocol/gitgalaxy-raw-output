...
## 1. EXECUTIVE SUMMARY
- **Scope:** 15 analyzed artifact(s), 10498 LOC.
...
- **Top orchestrator:** `more_itertools-11.0.1/tests/test_more.py` -- pulls in 25 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `more_itertools-11.0.1/tests/test_more.py` at magnitude 4375.42 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 53%, Generic / Templated Code Files 13%, Large Core Modules (3) 13%, Type Conversions Files 13%, Large Core Modules 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 45.3 | 43.7 | 0.0 |
...
- `_islice_helper` **(Many-Argument Workhorses)** (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **72.8** | LOC: 106
...
- `_get_slice` **(Stateful Encapsulated Methods)** (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **32.4** | LOC: 25
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (82.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (31.2%), Connectivity (formerly Api Exposure) (14.7%)
- **Documentation Coverage:** 88.1356% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_elements_lifecycle` **(I/O & Config Routines)** (Impact: 14.0)
  ...
  * `_target` **(Stateful Encapsulated Methods)** (Impact: 11.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (52.0%)
- **Documentation Coverage:** 37.3563% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (14.1%), Complexity Load (formerly Cognitive Load) (12.0%)
- **Documentation Coverage:** 64.8276% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_vs_statistics_median_windowed` **(Type Conversions)** (Impact: 9.0)
  * `test_vs_statistics_median` **(Compute Cores)** (Impact: 8.0)
  * `test_multiple` **(Type Conversions)** (Impact: 6.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (53.6%)
- **Documentation Coverage:** 12.8205% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.3%), Connectivity (formerly Api Exposure) (82.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (83.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (71.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (11.7%), Test Surface (formerly Verification) (2.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (71.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 66.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 4`
