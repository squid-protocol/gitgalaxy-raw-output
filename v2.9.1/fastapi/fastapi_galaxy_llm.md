...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1158 analyzed artifact(s), 84520 LOC.
- **Load-bearing artifact:** `fastapi/testclient.py` -- 445 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `fastapi/routing.py` -- pulls in 35 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `fastapi/routing.py` at magnitude 2034.8 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.1`
> **Composition Archetype:** `Hub-Coupled App` (z +2.10; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 32%, Data / Markup / Trivial 30%, Parameter Forwarders Files 17%, Generic / Templated Code Files 9%, Interface Declarations Files 5%
...
- `app` **(Stateful Encapsulated Methods)** (@ `fastapi/routing.py`) -> Impact: **90.8** | LOC: 346
...
- **Blast Radius:** changing it is visible to **15** in-repo importer(s); it depends on **35**; blast radius 4.595; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Concurrency Surface (formerly Concurrency) (98.4%), Guard Balance (formerly Safety Score) (84.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.8596% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `app` **(Stateful Encapsulated Methods)** (Impact: 90.8)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **30**; blast radius 1.787; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Concurrency Surface (formerly Concurrency) (94.9%), Complexity Load (formerly Cognitive Load) (88.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `request_params_to_args` **(Many-Argument Workhorses)** (Impact: 40.5)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **23**; blast radius 1.227; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.0%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 5.399; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Complexity Load (formerly Cognitive Load) (50.8%), Connectivity (formerly Api Exposure) (46.1%)
- **Documentation Coverage:** 32.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `replace_header_permalinks` **(Generic / Templated Code)** (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Complexity Load (formerly Cognitive Load) (59.1%), Debt Markers (formerly Tech Debt) (46.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `remove_unused_docs_src` **(I/O & Config Routines)** (Impact: 38.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **33**; blast radius 0.595; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (61.0%), Connectivity (formerly Api Exposure) (47.4%)
- **Documentation Coverage:** 96.9697% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 110.7)
  * `setup` **(Generic / Templated Code)** (Impact: 19.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.2%), Concurrency Surface (formerly Concurrency) (19.4%), Connectivity (formerly Api Exposure) (8.1%), Complexity Load (formerly Cognitive Load) (3.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `dep0` **(Parameter Forwarders)** (Impact: 1.5)
  * `dep1` **(Parameter Forwarders)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (61.0%), Complexity Load (formerly Cognitive Load) (50.0%), Connectivity (formerly Api Exposure) (14.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `noop_wrap_async` **(Compute Cores)** (Impact: 14.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.8%), Complexity Load (formerly Cognitive Load) (64.4%), Debt Markers (formerly Tech Debt) (41.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `translate_lang` **(Generic / Templated Code)** (Impact: 11.2)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **12**; blast radius 1.336; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.9%), Mutation Surface (formerly State Flux) (83.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (49.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **20**; blast radius 3.452; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (14.3%), Guard Balance (formerly Safety Score) (4.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (13.0%), Complexity Load (formerly Cognitive Load) (8.9%), Guard Balance (formerly Safety Score) (6.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_path_param_ge_2` **(Defensive Guards)** (Impact: 2.7)
  * `test_path_param_le_42` **(Defensive Guards)** (Impact: 2.7)
  * `test_path_param_le_ge_4` **(Defensive Guards)** (Impact: 2.7)
  * `test_path_param_le_int_42` **(Defensive Guards)** (Impact: 2.7)
  * `test_path_param_ge_int_2` **(Defensive Guards)** (Impact: 2.7)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.544; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Complexity Load (formerly Cognitive Load) (57.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.9%)
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (28.0%), Connectivity (formerly Api Exposure) (13.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (1.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_openapi_schema` **(I/O & Config Routines)** (Impact: 7.5)
  * `test_response_model_none_annotation_return_submodel_with_extra_data` **(Defensive Guards)** (Impact: 1.5)
  * `test_invalid_response_model_field` **(Annotated & Test Methods)** (Impact: 1.5)
  * `test_response_model_none_annotation_return_dict_with_extra_data` **(Defensive Guards)** (Impact: 1.4)
  * `test_response_model_list_of_model_no_annotation` **(Defensive Guards)** (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.2%), Connectivity (formerly Api Exposure) (10.6%), Complexity Load (formerly Cognitive Load) (3.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **11**; blast radius 0.935; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (62.9%), Connectivity (formerly Api Exposure) (37.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (13.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.8%), Guard Balance (formerly Safety Score) (5.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.8%), Complexity Load (formerly Cognitive Load) (30.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.7%), Connectivity (formerly Api Exposure) (13.2%)
- **Documentation Coverage:** 84.8485% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.544; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Debt Markers (formerly Tech Debt) (78.5%), Complexity Load (formerly Cognitive Load) (70.2%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.544; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.0%), Complexity Load (formerly Cognitive Load) (72.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.8%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(I/O & Config Routines)** (Impact: 44.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (64.4%), Complexity Load (formerly Cognitive Load) (36.1%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 84.8485% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `wrapped_app` **(Parameter Forwarders)** (Impact: 4.5)
  * `make_app` **(Parameter Forwarders)** (Impact: 3.8)
  * `websocket_middleware` **(Parameter Forwarders)** (Impact: 3.8)
    * *Intent:* """ Helper to create a Starlette pure websocket middleware """
  * `middleware_constructor` **(Annotated & Test Methods)** (Impact: 3.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.544; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.7%), Guard Balance (formerly Safety Score) (16.8%), Connectivity (formerly Api Exposure) (13.6%), Complexity Load (formerly Cognitive Load) (8.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_bench_post_json` **(Stateful Encapsulated Methods)** (Impact: 2.8)
  * `_bench_get` **(Encapsulated Accessors)** (Impact: 2.5)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **21**; blast radius 4.04; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.7%), Guard Balance (formerly Safety Score) (84.1%), Connectivity (formerly Api Exposure) (40.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (18.7%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `jsonable_encoder` **(Many-Argument Workhorses)** (Impact: 116.2)
  * `decimal_encoder` **(Type Conversions)** (Impact: 6.8)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **13**; blast radius 2.047; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__call__` **(Compute Cores)** (Impact: 16.3)
  * `__call__` **(Compute Cores)** (Impact: 16.3)
  * `__call__` **(Defensive Guards)** (Impact: 11.3)
  * `__call__` **(Generic / Templated Code)** (Impact: 10.8)
