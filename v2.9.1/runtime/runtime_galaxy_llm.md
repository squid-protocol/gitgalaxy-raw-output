...
## 1. EXECUTIVE SUMMARY
- **Scope:** 41176 analyzed artifact(s), 7663510 LOC.
- **Load-bearing artifact:** `src/libraries/System.Runtime.InteropServices/tests/LibraryImportGenerator.UnitTests/Diagnostics.cs` -- 5789 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/coreclr/vm/common.h` -- pulls in 104 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/tests/JIT/Directed/cmov/Int_Xor_Op.cs` at magnitude 47930.02 (structural weight, not risk).
...
|---|---|---|
| Modularity | 0.6458 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| PLAINTEXT | 812 | 5 | 2.0% |
| MARKDOWN | 368 | 0 | 0.9% |
| ASSEMBLY | 295 | 45082 | 0.7% |
| YAML | 185 | 11798 | 0.4% |
| SHELL | 185 | 18842 | 0.4% |
| TYPESCRIPT | 181 | 28465 | 0.4% |
| JSON | 166 | 5987 | 0.4% |
| MAKEFILE | 72 | 6515 | 0.2% |
| PYTHON | 59 | 15005 | 0.1% |
...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.06; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 18%, State Mutators Files 14%, Encapsulated Accessors Files 14%, Data / Markup / Trivial 11%, Large Core Modules (3) 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 73.2 | 100.0 | 100.0 |
...
|---|---|---|---|---|
| memory | 556842 | 14860 | 12 | `src/coreclr/pal/prebuilt/inc/corprof.h` |
| cleanup | 13761 | 3931 | 0 | `src/libraries/System.Private.Xml.Linq/tests/xNodeBuilder/CommonTests.cs` |
| guards | 619359 | 28380 | 29 | `src/tests/JIT/Directed/nullabletypes/isinstvaluetype.cs` |
| danger | 141919 | 11648 | 5 | `src/libraries/System.Runtime.Intrinsics/ref/System.Runtime.Intrinsics.cs` |
| concurrency | 91449 | 4579 | 1 | `src/libraries/System.Net.Http/tests/FunctionalTests/HttpClientHandlerTest.Http2.cs` |
| connectivity | 563959 | 34413 | 26 | `src/libraries/System.Runtime.Intrinsics/ref/System.Runtime.Intrinsics.cs` |
...
| debt | 91021 | 8107 | 3 | `src/libraries/System.Runtime/ref/System.Runtime.cs` |
| mutation | 1895769 | 31823 | 92 | `src/tests/JIT/Directed/cmov/Double_And_Op.cs` |
| dead_code | 195702 | 26640 | 11 | `src/libraries/System.Numerics.Vectors/tests/GenericVectorTests.cs` |
| credential | 1359 | 262 | 0 | `src/libraries/Common/tests/System/Security/Cryptography/AlgorithmImplementations/RSA/RSAXml.cs` |
| threat | 72281 | 8714 | 2 | `src/coreclr/pal/prebuilt/inc/corprof.h` |
| ml_ai | 21424 | 2185 | 0 | `src/libraries/System.Runtime.Numerics/tests/ComplexTests.GenericMath.cs` |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.014; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (93.5%), Connectivity (formerly Api Exposure) (2.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Sub_Funclet_0` **(I/O & Config Routines)** (Impact: 23.4)
  * `Sub_Funclet_1` **(I/O & Config Routines)** (Impact: 23.4)
  * `Sub_Funclet_2` **(I/O & Config Routines)** (Impact: 23.4)
  * `Sub_Funclet_3` **(I/O & Config Routines)** (Impact: 23.4)
  * `Sub_Funclet_4` **(I/O & Config Routines)** (Impact: 23.4)
...
- **Blast Radius:** changing it is visible to **722** in-repo importer(s); it depends on **1**; blast radius 5.599; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (50.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.9%), Connectivity (formerly Api Exposure) (19.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Create` **(Generic / Templated Code)** (Impact: 8.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.017522
...
- **Blast Radius:** changing it is visible to **137** in-repo importer(s); blast radius 0.764; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (71.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (59.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ExecuteAssembly` **(Defensive Guards)** (Impact: 9.1)
  * `FileStream` **(State Mutators)** (Impact: 7.5)
  * `FileStream` **(State Mutators)** (Impact: 6.9)
  * `FileStream` **(State Mutators)** (Impact: 6.2)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 0.764
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (93.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.8%)
- **Documentation Coverage:** 7.5949% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.1%)
- **Documentation Coverage:** 27.2401% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `emitter::getInsExecutionCharacteristics` **(Many-Argument Workhorses)** (Impact: 1021.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (88.6%), Guard Balance (formerly Safety Score) (81.1%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `emitter::getInsExecutionCharacteristics` **(Many-Argument Workhorses)** (Impact: 620.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.014; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.0%), Complexity Load (formerly Cognitive Load) (17.3%), Connectivity (formerly Api Exposure) (16.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **52**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Complexity Load (formerly Cognitive Load) (92.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.1477% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mono_aot_parse_options` **(Many-Argument Workhorses)** (Impact: 350.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **55**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (95.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.5223% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Debt Markers (formerly Tech Debt) (16.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (95.5%), Guard Balance (formerly Safety Score) (93.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `process_bb` **(Many-Argument Workhorses)** (Impact: 1127.6)
  * `process_call` **(Many-Argument Workhorses)** (Impact: 351.0)
  * `emit_method_inner` **(Many-Argument Workhorses)** (Impact: 304.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.8%), Guard Balance (formerly Safety Score) (67.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `Compiler::fgValueNumberTree` **(Many-Argument Workhorses)** (Impact: 259.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **62**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (93.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.8372% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (71.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (30.7%), Complexity Load (formerly Cognitive Load) (29.1%), Connectivity (formerly Api Exposure) (8.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (90.2%), Guard Balance (formerly Safety Score) (81.3%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `Compiler::lookupNamedIntrinsic` **(Many-Argument Workhorses)** (Impact: 686.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **45**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.2%), Debt Markers (formerly Tech Debt) (80.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 70.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.014; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (81.2%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (79.1%)
- **Documentation Coverage:** 94.3262% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Compiler::fgMorphSmpOp` **(Many-Argument Workhorses)** (Impact: 826.6)
    * *Intent:* //------------------------------------------------------------------------ // fgMorphSmpOp: morph a ...
  * `Compiler::fgOptimizeHWIntrinsic` **(Many-Argument Workhorses)** (Impact: 341.7)
    * *Intent:* // fgOptimizeHWIntrinsic: optimize a HW intrinsic node // // Arguments: // node - HWIntrinsic node t...
  * `Compiler::fgMorphPotentialTailCall` **(Many-Argument Workhorses)** (Impact: 198.6)
...
- `src/libraries/System.Runtime.InteropServices/ref/System.Runtime.InteropServices.cs` -> **Severity: 8.11** (Embedded: 0.1592 * Error Risk: 50.9475%)
...
- `src/libraries/System.Diagnostics.Process/tests/Interop.cs` -> **Severity: 4.352** (Embedded: 0.0724 * Error Risk: 60.0647%)
...
- `src/libraries/System.Runtime.InteropServices/ref/System.Runtime.InteropServices.cs` -> **Severity: 5046.8** (Blast Radius: 50.468 * Doc Risk: 100.0%)
- `src/libraries/System.Runtime.InteropServices/tests/LibraryImportGenerator.UnitTests/Diagnostics.cs` -> **Severity: 3898.9** (Blast Radius: 38.989 * Doc Risk: 100.0%)
