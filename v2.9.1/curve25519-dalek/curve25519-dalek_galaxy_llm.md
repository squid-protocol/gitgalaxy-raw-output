...
## 1. EXECUTIVE SUMMARY
- **Scope:** 96 analyzed artifact(s), 31610 LOC.
- **Load-bearing artifact:** `CONTRIBUTING.md` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `curve25519-dalek/src/edwards.rs` -- pulls in 73 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `curve25519-dalek/src/edwards.rs` at magnitude 527.38 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.096`
> **Composition Archetype:** `Small Flat Repo` (z +2.10; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 23%, State Mutators Files 19%, Large Core Modules (3) 16%, Declarative / Non-Code 15%, Generic / Templated Code Files 9%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 40.4 | 43.4 | 0.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **73**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (77.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.7%), Guard Balance (formerly Safety Score) (42.7%), Mutation Surface (formerly State Flux) (32.1%)
- **Documentation Coverage:** 55.0562% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deserialize` **(Generic / Templated Code)** (Impact: 11.5)
  * `visit_seq` **(Generic / Templated Code)** (Impact: 11.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.5%), Mutation Surface (formerly State Flux) (53.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%), Guard Balance (formerly Safety Score) (36.5%)
- **Documentation Coverage:** 62.0968% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `non_adjacent_form` **(Many-Argument Workhorses)** (Impact: 16.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **58**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.3%), Guard Balance (formerly Safety Score) (43.6%)
- **Documentation Coverage:** 69.9029% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deserialize` **(Generic / Templated Code)** (Impact: 11.5)
  * `visit_seq` **(Generic / Templated Code)** (Impact: 11.1)
  * `deserialize` **(Generic / Templated Code)** (Impact: 10.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (74.1%), Debt Markers (formerly Tech Debt) (46.4%), Complexity Load (formerly Cognitive Load) (42.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `iterated_mul_matches_serial` **(Annotated & Test Methods)** (Impact: 5.2)
  * `iterated_u32_mul_matches_serial` **(Annotated & Test Methods)** (Impact: 5.2)
  * `blend_lanes` **(Many-Argument Workhorses)** (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (86.8%), Guard Balance (formerly Safety Score) (78.0%), Complexity Load (formerly Cognitive Load) (20.8%)
- **Documentation Coverage:** 34.8837% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `sub` **(Type Conversions)** (Impact: 4.2)
    * *Intent:* /// Compute `a - b` (mod l).
  * `conditional_add_l` **(Stateful Encapsulated Methods)** (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.4%), Guard Balance (formerly Safety Score) (82.9%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `carry` **(Annotated & Test Methods)** (Impact: 5.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Debt Markers (formerly Tech Debt) (90.6%), Guard Balance (formerly Safety Score) (70.8%), Complexity Load (formerly Cognitive Load) (15.2%)
- **Documentation Coverage:** 34.8837% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `from_bytes_wide` **(Compute Cores)** (Impact: 5.7)
    * *Intent:* /// Reduce a 64 byte / 512 bit scalar mod l
  * `from_bytes` **(Type Conversions)** (Impact: 5.3)
    * *Intent:* /// Unpack a 32 byte / 256 bit scalar into 5 52-bit limbs.
  * `add` **(Compute Cores)** (Impact: 4.2)
    * *Intent:* /// Compute `a + b` (mod l)
  * `sub` **(Type Conversions)** (Impact: 4.2)
    * *Intent:* /// Compute `a - b` (mod l)
  * `conditional_add_l` **(Stateful Encapsulated Methods)** (Impact: 4.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.6%), Complexity Load (formerly Cognitive Load) (19.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (72.2%), Guard Balance (formerly Safety Score) (32.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.9%)
- **Documentation Coverage:** 46.5517% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `raw_verify_prehashed` **(Stateful Encapsulated Methods)** (Impact: 10.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Dead Code Surface (formerly Dead Code) (6.9%), Connectivity (formerly Api Exposure) (3.8%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (95.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.0%)
- **Documentation Coverage:** 43.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pow2k` **(Type Conversions)** (Impact: 12.3)
    * *Intent:* /// Given `k > 0`, return `self^(2^k)`.
  * `mul` **(Type Conversions)** (Impact: 6.7)
  * `to_bytes` **(Type Conversions)** (Impact: 5.6)
    * *Intent:* /// Serialize this `FieldElement51` to a 32-byte array. The /// encoding is canonical.
  * `add_assign` **(Generic / Templated Code)** (Impact: 3.7)
  * `reduce` **(Compute Cores)** (Impact: 3.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.5%), Test Surface (formerly Verification) (80.0%), Dead Code Surface (formerly Dead Code) (66.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%)
- **Documentation Coverage:** 40.3509% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `raw_sign_byupdate` **(Stateful Encapsulated Methods)** (Impact: 7.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (72.8%), Mutation Surface (formerly State Flux) (46.6%), Guard Balance (formerly Safety Score) (44.7%)
- **Documentation Coverage:** 25.641% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `blend_lanes` **(Type Conversions)** (Impact: 6.6)
  * `reduce` **(I/O & Config Routines)** (Impact: 6.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **18**; blast radius 18.272; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (77.6%), Connectivity (formerly Api Exposure) (55.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%), Concurrency Surface (formerly Concurrency) (18.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `against_reference_implementation` **(I/O & Config Routines)** (Impact: 5.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Dead Code Surface (formerly Dead Code) (7.0%), Connectivity (formerly Api Exposure) (4.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 4`
* *Risk/State:* `dead_code: 1`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (52.8%), Guard Balance (formerly Safety Score) (40.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (23.6%), Mutation Surface (formerly State Flux) (13.7%)
- **Documentation Coverage:** 43.9024% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `from_bytes_wide` **(Annotated & Test Methods)** (Impact: 4.5)
  * `sqrt_ratio_i` **(Stateful Encapsulated Methods)** (Impact: 4.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (70.8%), Guard Balance (formerly Safety Score) (42.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%), Mutation Surface (formerly State Flux) (19.0%)
- **Documentation Coverage:** 43.4783% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mul_bits_be` **(Type Conversions)** (Impact: 6.6)
    * *Intent:* /// Given `self` \\( = u\_0(P) \\), and a big-endian bit representation of an integer /// \\(n\\), r...
  * `elligator_encode` **(Compute Cores)** (Impact: 6.1)
  ...
  * `montgomery_mul_bits_be_twist` **(Annotated & Test Methods)** (Impact: 3.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (53.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%), Complexity Load (formerly Cognitive Load) (7.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `vartime_precomputed_helper` **(Compute Cores)** (Impact: 9.2)
  * `scalar_arith` **(Callbacks & Closures)** (Impact: 8.5)
  * `vartime_precomputed_pure_static` **(Generic / Templated Code)** (Impact: 7.0)
  * `vartime_multiscalar_mul` **(Generic / Templated Code)** (Impact: 6.8)
  * `consttime_multiscalar_mul` **(Generic / Templated Code)** (Impact: 6.7)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (28.2%)
- **Documentation Coverage:** 14.7059% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (93.3%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (66.1%), Guard Balance (formerly Safety Score) (51.7%)
- **Documentation Coverage:** 83.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `serial_add` **(Compute Cores)** (Impact: 5.0)
  * `double` **(I/O & Config Routines)** (Impact: 4.4)
    * *Intent:* /// Compute the double of this point.
  * `mul_by_pow_2` **(Parameter Forwarders)** (Impact: 3.8)
  * `serial_double` **(Compute Cores)** (Impact: 3.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.7%), Debt Markers (formerly Tech Debt) (72.0%), Guard Balance (formerly Safety Score) (60.8%), Complexity Load (formerly Cognitive Load) (10.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Dead Code Surface (formerly Dead Code) (52.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.1%), Mutation Surface (formerly State Flux) (82.5%), Guard Balance (formerly Safety Score) (59.7%), Complexity Load (formerly Cognitive Load) (19.0%)
- **Documentation Coverage:** 91.3043% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mul_by_pow_2` **(Parameter Forwarders)** (Impact: 3.8)
  * `double` **(Compute Cores)** (Impact: 3.4)
  * `from` **(Generic / Templated Code)** (Impact: 3.3)
  * `from` **(Generic / Templated Code)** (Impact: 3.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (42.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (11.2%), Connectivity (formerly Api Exposure) (9.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 9.877; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (94.4%), Guard Balance (formerly Safety Score) (48.7%), Mutation Surface (formerly State Flux) (9.0%), Connectivity (formerly Api Exposure) (9.0%)
