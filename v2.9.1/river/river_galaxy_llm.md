...
## 1. EXECUTIVE SUMMARY
- **Scope:** 69 analyzed artifact(s), 10963 LOC.
- **Load-bearing artifact:** `river/util.zig` -- 44 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `river/Seat.zig` -- pulls in 26 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `river/Window.zig` at magnitude 584.34 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.609`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.61; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 36%, State Mutators Files 26%, Data / Markup / Trivial 22%, Large Core Modules (3) 6%, Type Conversions Files 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 71.8 | 87.5 | 100.0 |
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **14**; blast radius 39.718; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (99.9%), Connectivity (formerly Api Exposure) (74.5%), Guard Balance (formerly Safety Score) (64.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `renderStart` **(I/O & Config Routines)** (Impact: 17.7)
...
- **Blast Radius:** changing it is visible to **21** in-repo importer(s); it depends on **26**; blast radius 59.897; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (85.0%), Connectivity (formerly Api Exposure) (80.8%), Guard Balance (formerly Safety Score) (46.8%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **17**; blast radius 10.801; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.0%), Mutation Surface (formerly State Flux) (73.4%), Guard Balance (formerly Safety Score) (51.3%), Connectivity (formerly Api Exposure) (45.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `handleRequestSetCursor` **(Defensive Guards)** (Impact: 15.7)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **7**; blast radius 10.462; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.1%), Connectivity (formerly Api Exposure) (34.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (30.3%), Complexity Load (formerly Cognitive Load) (16.1%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 5.945; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (72.4%), Guard Balance (formerly Safety Score) (53.8%), Connectivity (formerly Api Exposure) (43.1%)
- **Documentation Coverage:** 97.0588% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `renderFinish` **(Defensive Guards)** (Impact: 29.3)
...
- **Blast Radius:** changing it is visible to **14** in-repo importer(s); it depends on **8**; blast radius 36.078; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.8%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.2%), Guard Balance (formerly Safety Score) (60.9%)
- **Documentation Coverage:** 91.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 5.945; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.4%), Guard Balance (formerly Safety Score) (61.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.4%), Connectivity (formerly Api Exposure) (33.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 8.101; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (58.7%), Concurrency Surface (formerly Concurrency) (14.7%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **9**; blast radius 12.607; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (85.6%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (46.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `handleCommit` **(Type Conversions)** (Impact: 19.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 12.826; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.9%), Mutation Surface (formerly State Flux) (62.0%), Connectivity (formerly Api Exposure) (46.1%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **25**; blast radius 6.642; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (94.6%), Mutation Surface (formerly State Flux) (35.3%), Guard Balance (formerly Safety Score) (25.8%), Connectivity (formerly Api Exposure) (24.8%)
- **Documentation Coverage:** 63.1579% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `allowlist` **(Defensive Guards)** (Impact: 16.3)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **8**; blast radius 22.229; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (69.4%), Connectivity (formerly Api Exposure) (61.4%), Guard Balance (formerly Safety Score) (45.7%)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **10**; blast radius 25.53; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (63.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.1%), Guard Balance (formerly Safety Score) (57.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `deinit` **(Defensive Guards)** (Impact: 8.4)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **7**; blast radius 13.74; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (92.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (59.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `handleSetSizeHints` **(Defensive Guards)** (Impact: 9.4)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 6.652; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (45.7%), Connectivity (formerly Api Exposure) (42.3%), Mutation Surface (formerly State Flux) (34.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 5.677; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (64.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (46.0%), Guard Balance (formerly Safety Score) (21.9%), Debt Markers (formerly Tech Debt) (17.3%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 11.304; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (56.9%), Connectivity (formerly Api Exposure) (36.7%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **7**; blast radius 11.966; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (78.9%), Guard Balance (formerly Safety Score) (65.8%), Connectivity (formerly Api Exposure) (45.7%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 5.945; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.5%), Guard Balance (formerly Safety Score) (53.6%), Connectivity (formerly Api Exposure) (33.3%), Complexity Load (formerly Cognitive Load) (10.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `handleUnlock` **(Defensive Guards)** (Impact: 4.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 8.37; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (46.3%), Guard Balance (formerly Safety Score) (34.8%), Connectivity (formerly Api Exposure) (34.6%), Mutation Surface (formerly State Flux) (17.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 5.945; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.2%), Guard Balance (formerly Safety Score) (54.7%), Connectivity (formerly Api Exposure) (29.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (23.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handleNewSurface` **(Many-Argument Workhorses)** (Impact: 17.9)
  * `checkExclusiveFocus` **(Defensive Guards)** (Impact: 14.3)
  * `handleRequest` **(Type Conversions)** (Impact: 13.7)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 9.052; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.9%), Guard Balance (formerly Safety Score) (65.0%), Connectivity (formerly Api Exposure) (35.8%), Complexity Load (formerly Cognitive Load) (21.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **7**; blast radius 16.953; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (46.3%), Connectivity (formerly Api Exposure) (43.4%), Guard Balance (formerly Safety Score) (36.1%), Mutation Surface (formerly State Flux) (27.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `newInputMethod` **(Defensive Guards)** (Impact: 6.3)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **1**; blast radius 13.595; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (56.5%), Mutation Surface (formerly State Flux) (51.8%), Debt Markers (formerly Tech Debt) (10.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `remove` **(Defensive Guards)** (Impact: 4.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 12.441; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (84.2%), Guard Balance (formerly Safety Score) (56.7%), Connectivity (formerly Api Exposure) (37.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (30.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sendConfigures` **(Many-Argument Workhorses)** (Impact: 16.4)
  * `manageStart` **(I/O & Config Routines)** (Impact: 7.0)
