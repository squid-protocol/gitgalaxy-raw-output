...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3544 analyzed artifact(s), 292646 LOC.
- **Load-bearing artifact:** `code/addons/vitest/src/node/vitest.ts` -- 381 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `code/core/src/components/index.ts` -- pulls in 76 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `code/renderers/react/src/componentManifest/componentMeta/componentMetaExtractor.props.test.ts` at magnitude 8183.09 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `5.315`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +5.32; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 30%, Declarative / Non-Code 21%, Callbacks & Closures Files 15%, Large Core Modules (2) 9%, Generic / Templated Code Files 7%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.2 | 28.4 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 6.7 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 2.9 | 2.3 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 48.6 | 46.2 | 0.0 |
...
- `parse` **(I/O & Config Routines)** (@ `code/core/src/csf-tools/CsfFile.ts`) -> Impact: **193.3** | LOC: 546
...
- `TestProviderRender` **(Many-Argument Workhorses)** (@ `code/addons/vitest/src/components/TestProviderRender.tsx`) -> Impact: **148.3** | LOC: 393
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (49.8%), Complexity Load (formerly Cognitive Load) (26.8%), Guard Balance (formerly Safety Score) (19.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (80.5%), Guard Balance (formerly Safety Score) (31.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (51.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.4%), Connectivity (formerly Api Exposure) (10.5%), Complexity Load (formerly Cognitive Load) (3.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (53.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (37.2%), Connectivity (formerly Api Exposure) (10.5%), Complexity Load (formerly Cognitive Load) (3.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 0.212; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (78.5%), Complexity Load (formerly Cognitive Load) (25.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (89.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.1%), Guard Balance (formerly Safety Score) (38.6%), Mutation Surface (formerly State Flux) (19.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (53.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (33.4%), Connectivity (formerly Api Exposure) (10.2%), Complexity Load (formerly Cognitive Load) (3.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.8%), Guard Balance (formerly Safety Score) (45.9%), Mutation Surface (formerly State Flux) (39.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `gatedImportFn` **(I/O & Config Routines)** (Impact: 8.9)
  * `createAndRenderPreview` **(Callbacks & Closures)** (Impact: 4.9)
  * `play` **(Defensive Guards)** (Impact: 4.3)
  * `text` **(Callbacks & Closures)** (Impact: 4.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (97.0%), Complexity Load (formerly Cognitive Load) (60.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (45.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (70.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.4%), Mutation Surface (formerly State Flux) (25.1%), Guard Balance (formerly Safety Score) (24.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (64.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.1%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (28.8%), Connectivity (formerly Api Exposure) (12.1%), Complexity Load (formerly Cognitive Load) (5.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (28.8%), Concurrency Surface (formerly Concurrency) (25.3%), Connectivity (formerly Api Exposure) (7.2%), Complexity Load (formerly Cognitive Load) (7.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.4%), Guard Balance (formerly Safety Score) (31.8%), Mutation Surface (formerly State Flux) (10.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (58.8%), Complexity Load (formerly Cognitive Load) (43.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.3%), Guard Balance (formerly Safety Score) (40.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.8%), Complexity Load (formerly Cognitive Load) (18.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (74.5%), Guard Balance (formerly Safety Score) (39.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (28.8%), Mutation Surface (formerly State Flux) (17.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (31.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%), Connectivity (formerly Api Exposure) (11.1%), Mutation Surface (formerly State Flux) (10.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.6%), Guard Balance (formerly Safety Score) (45.8%), Complexity Load (formerly Cognitive Load) (23.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (49.2%), Mutation Surface (formerly State Flux) (28.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (89.6%), Guard Balance (formerly Safety Score) (38.0%), Mutation Surface (formerly State Flux) (18.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.7%), Guard Balance (formerly Safety Score) (39.1%), Complexity Load (formerly Cognitive Load) (20.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.154; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (76.0%), Guard Balance (formerly Safety Score) (37.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (37.2%), Complexity Load (formerly Cognitive Load) (12.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- `code/addons/vitest/src/node/vitest.ts` -> **Severity: 3.855** (Embedded: 0.0879 * Error Risk: 43.8458%)
- `code/core/src/preview-api/modules/addons/main.ts` -> **Severity: 3.411** (Embedded: 0.0403 * Error Risk: 84.7391%)
- `code/addons/vitest/src/node/test-manager.ts` -> **Severity: 3.248** (Embedded: 0.0521 * Error Risk: 62.3454%)
- `scripts/ecosystem-ci/test.sh` -> **Severity: 3.248** (Embedded: 0.0519 * Error Risk: 62.5811%)
- `code/core/src/bin/core.ts` -> **Severity: 2.357** (Embedded: 0.0248 * Error Risk: 95.032%)
