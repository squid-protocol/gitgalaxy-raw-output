...
## 1. EXECUTIVE SUMMARY
- **Scope:** 317 analyzed artifact(s), 61157 LOC.
- **Load-bearing artifact:** `lxml-6.0.2/doc/html/apidoc/_modules/lxml.html` -- 44 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `lxml-6.0.2/src/lxml/tests/test_etree.py` -- pulls in 19 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `lxml-6.0.2/doc/html/pubkey.asc` at magnitude 5000.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.28`
> **Composition Archetype:** `Hub-Coupled App` (z +3.28; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 52%, Parameter Forwarders Files 14%, Large Core Modules (3) 12%, State Mutators Files 5%, Declarative / Non-Code 4%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 49.0 | 50.0 | 0.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (89.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (38.7%), Connectivity (formerly Api Exposure) (13.9%)
- **Documentation Coverage:** 99.5386% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_parse_error_logging` **(Defensive Guards)** (Impact: 16.6)
  * `_test_python_error_logging` **(Stateful Encapsulated Methods)** (Impact: 14.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.2%), Connectivity (formerly Api Exposure) (13.2%)
- **Documentation Coverage:** 99.3481% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_canonicalize` **(Stateful Encapsulated Methods)** (Impact: 12.7)
  * `_canonicalize` **(Stateful Encapsulated Methods)** (Impact: 12.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 1.661; role: Pure Consumer (Orchestrator)
...
- **Documentation Coverage:** 54.6419% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.661; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (97.9%), Guard Balance (formerly Safety Score) (97.7%), Complexity Load (formerly Cognitive Load) (81.9%)
- **Documentation Coverage:** 87.6106% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Debt Markers (formerly Tech Debt) (80.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Debt Markers (formerly Tech Debt) (87.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 55.3097% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Debt Markers (formerly Tech Debt) (96.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 65.9341% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 2.014; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 25.8)
  * `copyToBuffer` **(Stateful Encapsulated Methods)** (Impact: 24.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 307 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (77.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (38.0%), Connectivity (formerly Api Exposure) (13.5%)
- **Documentation Coverage:** 99.1091% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 1.661; role: Isolated/Orphan
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `_connectEvents` **(Stateful Encapsulated Methods)** (Impact: 24.6)
    * *Intent:* """Wrap original SAX2 callbacks to collect parse events without parser target. """
  * `_connectTarget` **(Stateful Encapsulated Methods)** (Impact: 21.3)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Debt Markers (formerly Tech Debt) (98.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 85.9649% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 47.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (20.8%), Connectivity (formerly Api Exposure) (12.7%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **12**; blast radius 3.074; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (54.7%)
- **Documentation Coverage:** 45.7447% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Debt Markers (formerly Tech Debt) (9.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **17**; blast radius 2.668; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.0%)
- **Documentation Coverage:** 43.2203% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.661; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `__getbuffer__` **(Stateful Encapsulated Methods)** (Impact: 25.6)
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 22.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 2.367; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (82.4%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **11**; blast radius 6.604; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (82.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 89.899% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `main` **(Defensive Guards)** (Impact: 18.0)
    * *Intent:* ############################################################ # Main program ########################...
  * `__init__` **(Many-Argument Workhorses)** (Impact: 17.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.661; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Debt Markers (formerly Tech Debt) (97.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 56.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_receiveGenericError` **(Many-Argument Workhorses)** (Impact: 64.7)
  * `_setError` **(Stateful Encapsulated Methods)** (Impact: 22.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `get_parser` **(Compute Cores)** (Impact: 18.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.661; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 81.7204% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_html__get` **(Stateful Encapsulated Methods)** (Impact: 14.3)
    * *Intent:* """ Gives the parsed HTML of element's content. May return an HtmlElement (from lxml.html) or an XHT...
  * `_html__set` **(Stateful Encapsulated Methods)** (Impact: 11.8)
  ...
  * `lookup` **(Compute Cores)** (Impact: 10.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 1.944; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (90.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
