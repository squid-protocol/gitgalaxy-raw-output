...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5000 analyzed artifact(s), 987348 LOC.
- **Load-bearing artifact:** `lib-python/2.7/os.py` -- 935 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `pypy/module/imp/test/test_import.py` -- pulls in 92 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `rpython/jit/metainterp/test/test_ajit.py` at magnitude 5868.26 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.422`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +3.42; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 27%, Large Core Modules (2) 19%, Data / Markup / Trivial 18%, Large Core Modules (3) 16%, Declarative / Non-Code 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 71.9 | 100.0 | 100.0 |
...
| connectivity | 95602 | 4160 | 51 | `rpython/annotator/test/test_annrpython.py` |
...
- `make_formatting_class` **(Stateful Encapsulated Methods)** (@ `pypy/objspace/std/newformat.py`) -> Impact: **360.9** | LOC: 770
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.5%), Complexity Load (formerly Cognitive Load) (30.5%), Connectivity (formerly Api Exposure) (13.7%), Dead Code Surface (formerly Dead Code) (5.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_retrace_ending_up_retracing_another_loop` **(Defensive Guards)** (Impact: 22.8)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **10**; blast radius 0.175; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.5%)
- **Documentation Coverage:** 14.578% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__new__` **(Stateful Encapsulated Methods)** (Impact: 95.2)
    * *Intent:* # Generally, the value of the Decimal instance is given by # (-1)**_sign * _int * 10**_exp # Special...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 78.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **28**; blast radius 0.104; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (87.3%), Guard Balance (formerly Safety Score) (71.4%), Complexity Load (formerly Cognitive Load) (42.2%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 99.3478% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **2**; blast radius 0.132; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (65.2%), Connectivity (formerly Api Exposure) (7.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_if_` **(Stateful Encapsulated Methods)** (Impact: 47.3)
  * `_enclosed` **(Stateful Encapsulated Methods)** (Impact: 41.6)
  * `_repetition` **(Stateful Encapsulated Methods)** (Impact: 41.0)
  * `_productionargs` **(Stateful Encapsulated Methods)** (Impact: 36.1)
  * `_arguments` **(Stateful Encapsulated Methods)** (Impact: 34.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **39**; blast radius 0.201; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.9%), Connectivity (formerly Api Exposure) (90.5%), Complexity Load (formerly Cognitive Load) (35.0%), Dead Code Surface (formerly Dead Code) (5.0%)
- **Documentation Coverage:** 99.5122% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_floats_and_guards` **(Many-Argument Workhorses)** (Impact: 37.6)
  * `test_jump` **(Defensive Guards)** (Impact: 37.1)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **31**; blast radius 0.116; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (85.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.4657% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **24** in-repo importer(s); it depends on **10**; blast radius 1.773; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.8%)
- **Documentation Coverage:** 77.3852% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (94.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (96.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `mult` **(Many-Argument Workhorses)** (Impact: 48.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.9%), Complexity Load (formerly Cognitive Load) (46.8%), Connectivity (formerly Api Exposure) (12.8%), Dead Code Surface (formerly Dead Code) (4.8%)
- **Documentation Coverage:** 99.4083% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_basic_inheritance` **(Many-Argument Workhorses)** (Impact: 32.4)
    * *Intent:* # Testing inheritance from basic types... class hexint(int): def __repr__(self): return hex(self) de...
  * `test_set_class` **(Compute Cores)** (Impact: 26.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Complexity Load (formerly Cognitive Load) (82.7%), Guard Balance (formerly Safety Score) (80.0%)
- **Documentation Coverage:** 99.6303% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.0%), Complexity Load (formerly Cognitive Load) (41.2%), Connectivity (formerly Api Exposure) (13.1%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 99.4444% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_test_bitfield_details` **(Defensive Guards)** (Impact: 33.6)
  * `_test_wchar_variant` **(Defensive Guards)** (Impact: 30.7)
  * `test_buffer` **(Defensive Guards)** (Impact: 23.4)
...
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (41.5%), Connectivity (formerly Api Exposure) (13.8%), Guard Balance (formerly Safety Score) (10.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **46**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.2%), Complexity Load (formerly Cognitive Load) (20.9%), Connectivity (formerly Api Exposure) (14.8%), Dead Code Surface (formerly Dead Code) (5.1%)
...
- **Blast Radius:** changing it is visible to **81** in-repo importer(s); it depends on **10**; blast radius 2.354; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.6%), Guard Balance (formerly Safety Score) (94.4%)
- **Documentation Coverage:** 10.2167% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `search` **(Many-Argument Workhorses)** (Impact: 39.1)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 30.3)
  * `_options` **(Stateful Encapsulated Methods)** (Impact: 27.3)
    * *Intent:* """Internal function."""
  * `_grid_configure` **(Stateful Encapsulated Methods)** (Impact: 20.6)
    * *Intent:* """Internal function."""
  * `_stringify` **(Stateful Encapsulated Methods)** (Impact: 19.7)
    * *Intent:* """Internal function."""
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **31**; blast radius 0.129; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Connectivity (formerly Api Exposure) (81.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 48.7047% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **26**; blast radius 0.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Complexity Load (formerly Cognitive Load) (88.8%)
- **Documentation Coverage:** 98.9101% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `record_coerce` **(Many-Argument Workhorses)** (Impact: 37.6)
  * `make_integer_min_dtype` **(Type Conversions)** (Impact: 33.2)
  * `_coerce` **(Stateful Encapsulated Methods)** (Impact: 26.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.0%)
- **Documentation Coverage:** 23.2295% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pen` **(Stateful Encapsulated Methods)** (Impact: 59.7)
    * *Intent:* """Return or set the pen's attributes. Arguments: pen -- a dictionary with some or all of the below ...
  * `_undogoto` **(Stateful Encapsulated Methods)** (Impact: 39.6)
    * *Intent:* """Reverse a _goto. Used for undo() """
  * `_drawturtle` **(Stateful Encapsulated Methods)** (Impact: 32.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (93.7%), Complexity Load (formerly Cognitive Load) (43.1%), Connectivity (formerly Api Exposure) (14.3%), Dead Code Surface (formerly Dead Code) (5.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.063; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **24**; blast radius 0.326; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.4%), Connectivity (formerly Api Exposure) (93.3%), Debt Markers (formerly Tech Debt) (79.9%)
- **Documentation Coverage:** 86.7857% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_safe_find_or_count` **(Stateful Encapsulated Methods)** (Impact: 32.9)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **34**; blast radius 0.099; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.4%), Complexity Load (formerly Cognitive Load) (85.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.2617% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **15**; blast radius 0.183; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (61.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `_minor_collection` **(I/O & Config Routines)** (Impact: 44.4)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **8**; blast radius 0.203; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Complexity Load (formerly Cognitive Load) (92.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.5816% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **21**; blast radius 0.341; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Connectivity (formerly Api Exposure) (60.5%), Complexity Load (formerly Cognitive Load) (38.5%)
- **Documentation Coverage:** 38.7097% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_extract_member` **(Stateful Encapsulated Methods)** (Impact: 34.0)
