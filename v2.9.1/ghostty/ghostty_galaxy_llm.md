...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1120 analyzed artifact(s), 218839 LOC.
- **Load-bearing artifact:** `src/quirks.zig` -- 113 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/terminal/main.zig` -- pulls in 40 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/stb/stb_image.h` at magnitude 9036.34 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.364`
> **Composition Archetype:** `Hub-Coupled App` (z +2.36; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 27%, Declarative / Non-Code 21%, Data / Markup / Trivial 16%, Large Core Modules (3) 9%, State Mutators Files 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 37.4 | 21.7 | 0.0 |
...
- `findSurface` **(Stateful Encapsulated Methods)** (@ `macos/Sources/Ghostty/Ghostty.App.swift`) -> Impact: **579.1** | LOC: 1372
...
- `Stream` **(Many-Argument Workhorses)** (@ `src/terminal/stream.zig`) -> Impact: **406.9** | LOC: 1321
...
- `SplitTree` **(Many-Argument Workhorses)** (@ `src/datastruct/split_tree.zig`) -> Impact: **235.5** | LOC: 1315
...
- `Renderer` **(Many-Argument Workhorses)** (@ `src/renderer/generic.zig`) -> Impact: **223.0** | LOC: 1631
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **13**; blast radius 0.834; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.5%)
...
- **Blast Radius:** changing it is visible to **14** in-repo importer(s); it depends on **15**; blast radius 2.739; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.8%), Connectivity (formerly Api Exposure) (74.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (21.4%), Guard Balance (formerly Safety Score) (14.5%)
- **Documentation Coverage:** 22.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (68.2%), Concurrency Surface (formerly Concurrency) (62.6%), Guard Balance (formerly Safety Score) (36.6%)
- **Documentation Coverage:** 87.619% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `findSurface` **(Stateful Encapsulated Methods)** (Impact: 579.1)
  ...
  * `gotoWindow` **(Many-Argument Workhorses)** (Impact: 36.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.426; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (69.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.5%), Mutation Surface (formerly State Flux) (58.0%), Guard Balance (formerly Safety Score) (18.5%)
- **Documentation Coverage:** 29.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 0.834; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **15** in-repo importer(s); it depends on **29**; blast radius 7.559; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (90.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (75.3%), Mutation Surface (formerly State Flux) (30.8%), Debt Markers (formerly Tech Debt) (14.5%)
- **Documentation Coverage:** 42.3729% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `finalize` **(Defensive Guards)** (Impact: 72.2)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **17**; blast radius 0.804; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.7%), Debt Markers (formerly Tech Debt) (56.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.6%)
- **Documentation Coverage:** 85.6% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `csiDispatch` **(Many-Argument Workhorses)** (Impact: 484.2)
  * `Stream` **(Many-Argument Workhorses)** (Impact: 406.9)
  ...
  * `nextNonUtf8` **(Many-Argument Workhorses)** (Impact: 29.1)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **22**; blast radius 0.855; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.9%), Connectivity (formerly Api Exposure) (57.6%), Guard Balance (formerly Safety Score) (46.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (18.4%)
- **Documentation Coverage:** 27.2727% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `rebuildRow` **(Many-Argument Workhorses)** (Impact: 301.4)
  * `Renderer` **(Many-Argument Workhorses)** (Impact: 223.0)
...
- **Blast Radius:** changing it is visible to **18** in-repo importer(s); it depends on **24**; blast radius 2.866; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (72.0%), Connectivity (formerly Api Exposure) (71.4%), Mutation Surface (formerly State Flux) (34.4%)
- **Documentation Coverage:** 9.0164% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `cursorLeft` **(Many-Argument Workhorses)** (Impact: 36.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **36**; blast radius 1.415; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (90.5%), Mutation Surface (formerly State Flux) (64.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.8%), Guard Balance (formerly Safety Score) (36.5%)
- **Documentation Coverage:** 63.3166% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (96.6%), Debt Markers (formerly Tech Debt) (95.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.0282% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **21**; blast radius 2.722; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (70.7%), Mutation Surface (formerly State Flux) (48.5%), Debt Markers (formerly Tech Debt) (9.6%), Dead Code Surface (formerly Dead Code) (8.3%)
- **Documentation Coverage:** 17.3554% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Debt Markers (formerly Tech Debt) (99.5%), Concurrency Surface (formerly Concurrency) (86.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.0795% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.5%), Debt Markers (formerly Tech Debt) (62.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (61.7%), Concurrency Surface (formerly Concurrency) (58.5%)
- **Documentation Coverage:** 87.6404% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.426; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.9%), Connectivity (formerly Api Exposure) (80.7%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (36.9%)
- **Documentation Coverage:** 10.4348% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **38**; blast radius 2.93; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (82.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (61.2%), Guard Balance (formerly Safety Score) (30.8%), Mutation Surface (formerly State Flux) (18.4%)
- **Documentation Coverage:** 73.2955% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (64.3%), Concurrency Surface (formerly Concurrency) (63.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `ghosttyConfigDidChange` **(I/O & Config Routines)** (Impact: 36.9)
  * `applicationShouldTerminate` **(Compute Cores)** (Impact: 28.3)
  * `application` **(Many-Argument Workhorses)** (Impact: 27.9)
  * `applicationDidFinishLaunching` **(I/O & Config Routines)** (Impact: 21.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.426; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (64.0%), Mutation Surface (formerly State Flux) (50.5%), Guard Balance (formerly Safety Score) (17.5%), Debt Markers (formerly Tech Debt) (8.7%)
- **Documentation Coverage:** 44.186% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `SplitTree` **(Many-Argument Workhorses)** (Impact: 235.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **16**; blast radius 0.768; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (61.0%), Mutation Surface (formerly State Flux) (50.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.6%), Guard Balance (formerly Safety Score) (10.6%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **15**; blast radius 1.525; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (92.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (33.2%), Guard Balance (formerly Safety Score) (29.8%), Mutation Surface (formerly State Flux) (28.3%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **3**; blast radius 0.974; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (76.9%), Guard Balance (formerly Safety Score) (39.7%)
- **Documentation Coverage:** 65.1685% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `init` **(Type Conversions)** (Impact: 6.1)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 1.967; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (72.2%), Mutation Surface (formerly State Flux) (23.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (13.1%), Dead Code Surface (formerly Dead Code) (8.3%)
- **Documentation Coverage:** 34.2466% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **29**; blast radius 2.254; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (75.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (42.5%), Guard Balance (formerly Safety Score) (37.6%)
- **Documentation Coverage:** 65.1786% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `syncAppearance` **(I/O & Config Routines)** (Impact: 18.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.426; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.7%), Guard Balance (formerly Safety Score) (49.2%), Debt Markers (formerly Tech Debt) (17.4%), Complexity Load (formerly Cognitive Load) (16.5%)
- **Documentation Coverage:** 26.7857% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `focusTarget` **(Defensive Guards)** (Impact: 40.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 0.465; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (67.5%), Connectivity (formerly Api Exposure) (47.8%), Guard Balance (formerly Safety Score) (47.6%), Complexity Load (formerly Cognitive Load) (12.5%)
- **Documentation Coverage:** 79.3144% of unit weight undocumented
**Top Internal Functions/Classes:**
