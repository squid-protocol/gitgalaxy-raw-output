...
## 1. EXECUTIVE SUMMARY
- **Scope:** 37157 analyzed artifact(s), 8689288 LOC.
- **Load-bearing artifact:** `usr/src/lib/Makefile.lib.64` -- 1518 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `usr/src/boot/efi/libefi/env.c` -- pulls in 145 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `usr/src/uts/common/io/fibre-channel/fca/qlc/ql_api.c` at magnitude 19597.26 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 37157 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 11566 |
| Total LOC | 8689288 |
...
| Articulation Pts | 1710 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| C | 23927 | 8054556 | 64.4% |
| MAKEFILE | 5911 | 137479 | 15.9% |
...
> **Architectural Drift Z-Score:** `4.616`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.62; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 25%, Data / Markup / Trivial 18%, Many-Argument Workhorses Files 13%, Large Core Modules (3) 11%, Large Core Modules 9%
...
|---|---|---|
| Unclassified | 34783 | 93.6% |
| Unknown | 10 | 0.0% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 2360 | 6.4% |
| Static: Minified & Vendor Opaque Mass | 4 | 0.0% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 11566*

**Composition by Extension & Reason:**
- `no_extension`: 1555x Unsupported Format (.undeterminable), 282x Excluded (Binary Format Detected), 122x Unresolved Ambiguity (No Retainable Structure)
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 29.7 | 0.2 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 0.3 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 65.2 | 100.0 | 100.0 |
...
|---|---|---|---|---|
| memory | 2813101 | 21085 | 186 | `usr/src/contrib/mDNSResponder/mDNSCore/mDNS.c` |
| cleanup | 35489 | 5385 | 1 | `usr/src/lib/libscf/common/scf_tmpl.c` |
| guards | 359028 | 20251 | 26 | `usr/src/test/util-tests/tests/demangle/gcc-libstdc++.c` |
| danger | 194052 | 12898 | 13 | `usr/src/contrib/ast/src/cmd/INIT/package.sh` |
| concurrency | 8147 | 1602 | 0 | `usr/src/cmd/svc/configd/rc_node.c` |
| connectivity | 286504 | 28186 | 18 | `usr/src/uts/common/nfs/nfs4_kprot.h` |
| io | 48952 | 5164 | 2 | `usr/src/contrib/ast/src/cmd/INIT/package.sh` |
| crypto | 0 | 0 | 0 | - |
| ipc | 7487 | 1974 | 0 | `usr/src/uts/common/io/pcic.c` |
| time | 4579 | 1404 | 0 | `usr/src/cmd/cron/cron.c` |
| serialization | 175 | 101 | 0 | `usr/src/cmd/ipf/tools/Makefile` |
| regex | 4234 | 844 | 0 | `usr/src/cmd/ypcmd/yp2lscripts/ypmap2src.sh` |
| events | 14178 | 2678 | 0 | `usr/src/lib/libstmf/common/store.c` |
| tests | 2294 | 371 | 0 | `usr/src/cmd/perl/contrib/Sun/Solaris/Lgrp/t/Lgrp.t` |
| docs | 34215 | 4058 | 1 | `usr/src/boot/efi/include/Uefi/UefiPxe.h` |
| debt | 78476 | 7967 | 3 | `usr/src/cmd/cxgbetool/cudbg_view.c` |
| mutation | 2169913 | 24119 | 152 | `usr/src/uts/common/io/fibre-channel/fca/qlc/ql_api.c` |
| dead_code | 80131 | 16190 | 6 | `usr/src/uts/common/io/sfxge/common/efx_regs_mcdi.h` |
| credential | 103 | 44 | 0 | `usr/src/cmd/ldap/ns_ldap/idsconfig.sh` |
| threat | 109097 | 10890 | 7 | `usr/src/uts/common/io/cxgbe/firmware/t4fw_interface.h` |
| ml_ai | 12150 | 2931 | 0 | `usr/src/uts/common/inet/ip/ip_if.c` |
| ui | 117 | 41 | 0 | `usr/src/cmd/tsol/misc/txzonemgr.sh` |
...
1. **Makefile.lib.64** (`usr/src/lib/Makefile.lib.64`) — 1518 inbound connections
...
- `usr/src/cmd/fs.d/smbclnt/fksmbcl/Makefile` -> **100.0%** Exposure
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.8%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (95.6%), Guard Balance (formerly Safety Score) (92.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **72**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **58**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Complexity Load (formerly Cognitive Load) (81.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mptsas_do_passthru` **(Many-Argument Workhorses)** (Impact: 241.5)
  * `mptsas_handle_event` **(Many-Argument Workhorses)** (Impact: 208.8)
  ...
  * `mptsas_handle_event_sync` **(Many-Argument Workhorses)** (Impact: 187.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fp_fciocmd` **(Many-Argument Workhorses)** (Impact: 980.1)
    * *Intent:* /* * One heck of a function to serve userland. */
  * `fp_job_handler` **(Many-Argument Workhorses)** (Impact: 164.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **89**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `fcp_complete_pkt` **(Many-Argument Workhorses)** (Impact: 140.5)
  * `fcp_send_scsi_ioctl` **(Many-Argument Workhorses)** (Impact: 140.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Complexity Load (formerly Cognitive Load) (82.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **46**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Complexity Load (formerly Cognitive Load) (88.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Complexity Load (formerly Cognitive Load) (82.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Complexity Load (formerly Cognitive Load) (97.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **53**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.9%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **44**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.5%), Complexity Load (formerly Cognitive Load) (82.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_partition` **(Many-Argument Workhorses)** (Impact: 615.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.4%)
- **Documentation Coverage:** 99.2308% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `rstfiles` **(Many-Argument Workhorses)** (Impact: 161.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **53**; blast radius 0.013; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `usr/src/cmd/mv/mv.c` -> Churn: **57.94%** | Cog Load: 83.5376% | Debt: 8.2086%
...
- `usr/src/uts/common/sys/model.h` -> **Severity: 2.347** (Embedded: 0.0399 * Error Risk: 58.7964%)
- `usr/src/uts/common/sys/ddi_hp_impl.h` -> **Severity: 2.149** (Embedded: 0.0236 * Error Risk: 91.1339%)
- `usr/src/uts/common/sys/rwstlock.h` -> **Severity: 1.872** (Embedded: 0.0299 * Error Risk: 62.5811%)
- `usr/src/uts/common/sys/vnode.h` -> **Severity: 1.724** (Embedded: 0.0378 * Error Risk: 45.672%)
- `usr/src/uts/common/sys/dditypes.h` -> **Severity: 1.715** (Embedded: 0.0349 * Error Risk: 49.0742%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `usr/src/uts/Makefile.uts` -> **Severity: 494.0** (Blast Radius: 4.94 * Doc Risk: 100.0%)
