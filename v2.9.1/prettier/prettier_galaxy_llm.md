...
## 1. EXECUTIVE SUMMARY
- **Scope:** 7044 analyzed artifact(s), 129378 LOC.
- **Load-bearing artifact:** `src/document/index.js` -- 120 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `website/data/users.yml` -- pulls in 81 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/format/js/export-default/parentheses/format.test.js` at magnitude 1741.48 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `6.461`
> **Composition Archetype:** `Flat Modular Platform` (z +6.46; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 67%, Declarative / Non-Code 15%, Large Core Modules (2) 6%, State Mutators Files 3%, Parameter Forwarders Files 2%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.9 | 15.0 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 23.2 | 0.0 | 0.0 |
...
- `print` **(Many-Argument Workhorses)** (@ `src/language-handlebars/printer-glimmer.js`) -> Impact: **231.2** | LOC: 385
  * *Intent:* // https://github.com/glimmerjs/glimmer-vm/blob/master/packages/%40glimmer/syntax/lib/generation/print.ts
...
- `printTernary` **(Many-Argument Workhorses)** (@ `src/language-js/print/ternary.js`) -> Impact: **212.8** | LOC: 276
  * *Intent:* /** * The following is the shared logic for * ternary operators, namely ConditionalExpression, * ConditionalTypeAnnotation and TSConditionalType */
...
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (93.4%), Concurrency Surface (formerly Concurrency) (65.4%), Guard Balance (formerly Safety Score) (39.7%), Connectivity (formerly Api Exposure) (17.1%)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **14**; blast radius 0.314; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (46.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.7%), Mutation Surface (formerly State Flux) (17.8%), Connectivity (formerly Api Exposure) (14.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `isPathInForStatementInitializer` **(Defensive Guards)** (Impact: 7.7)
    * *Intent:* /** */
  * `endsWithRightBracket` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
* *State Mutation (weighted view):* 18
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.123; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (84.7%), Guard Balance (formerly Safety Score) (63.0%), Complexity Load (formerly Cognitive Load) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `clean` **(I/O & Config Routines)** (Impact: 38.8)
  * `runCliWithoutGitignore` **(Parameter Forwarders)** (Impact: 5.2)
  * `resolveDir` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 0.176; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (71.1%), Connectivity (formerly Api Exposure) (25.3%), Complexity Load (formerly Cognitive Load) (14.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (36.0%), Complexity Load (formerly Cognitive Load) (35.6%), Guard Balance (formerly Safety Score) (33.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.123; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (27.4%), Complexity Load (formerly Cognitive Load) (8.5%), Connectivity (formerly Api Exposure) (6.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.123; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.5%), Complexity Load (formerly Cognitive Load) (13.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.5%), Guard Balance (formerly Safety Score) (41.4%)
- **Documentation Coverage:** 94.8718% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `print` **(Many-Argument Workhorses)** (Impact: 231.2)
    * *Intent:* // https://github.com/glimmerjs/glimmer-vm/blob/master/packages/%40glimmer/syntax/lib/generation/pri...
  ...
  * `printInverse` **(Defensive Guards)** (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 0.152; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (63.1%), Guard Balance (formerly Safety Score) (28.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.123; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.2%), Complexity Load (formerly Cognitive Load) (9.7%), Connectivity (formerly Api Exposure) (6.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **23**; blast radius 0.181; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (52.1%), Mutation Surface (formerly State Flux) (26.3%), Complexity Load (formerly Cognitive Load) (16.0%), Guard Balance (formerly Safety Score) (14.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (19.3%), Complexity Load (formerly Cognitive Load) (19.0%), Mutation Surface (formerly State Flux) (18.2%), Guard Balance (formerly Safety Score) (14.9%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (28.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.7%), Complexity Load (formerly Cognitive Load) (20.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **18**; blast radius 0.228; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (86.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (31.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (28.5%)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (84.8%), Guard Balance (formerly Safety Score) (23.6%), Connectivity (formerly Api Exposure) (11.8%), Complexity Load (formerly Cognitive Load) (10.6%)
- **Documentation Coverage:** 6.25% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `tagOpenAttributeValueUnquoted` **(Defensive Guards)** (Impact: 15.3)
    * *Intent:* /** * In unquoted attribute value. * * ```markdown * > | a <b c=d> e * ^ * ``` * */
  * `tagOpenBetween` **(Defensive Guards)** (Impact: 11.1)
    * *Intent:* /** * In opening tag, after tag name. * * ```markdown * > | a <b> c * ^ * ``` * */
  * `tagOpen` **(Defensive Guards)** (Impact: 9.3)
    * *Intent:* /** * After `<x`, in opening tag name. * * ```markdown * > | a <b> c * ^ * ``` * */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 2.278; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (41.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (99.6%), Complexity Load (formerly Cognitive Load) (89.2%), Guard Balance (formerly Safety Score) (56.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `formatStdin` **(Defensive Guards)** (Impact: 12.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 0.228; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (53.7%), Guard Balance (formerly Safety Score) (49.0%), Complexity Load (formerly Cognitive Load) (39.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **12**; blast radius 0.23; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.9%), Guard Balance (formerly Safety Score) (83.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **15**; blast radius 0.24; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (79.6%), Complexity Load (formerly Cognitive Load) (73.9%), Connectivity (formerly Api Exposure) (30.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (44.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (30.3%), Guard Balance (formerly Safety Score) (30.0%)
- **Documentation Coverage:** 80.7692% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 0.207; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (84.5%), Guard Balance (formerly Safety Score) (63.8%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handleFormatMessage` **(Defensive Guards)** (Impact: 29.0)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (49.1%), Guard Balance (formerly Safety Score) (45.3%), Connectivity (formerly Api Exposure) (22.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.123; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (64.0%), Complexity Load (formerly Cognitive Load) (55.4%), Connectivity (formerly Api Exposure) (28.1%)
