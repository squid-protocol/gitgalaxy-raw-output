...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 43 LOC.
...
- **Top orchestrator:** `package/example/api.postMessage.js` -- pulls in 1 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/example/api.postMessage.js` at magnitude 25.24 (structural weight, not risk).
...
> **File Composition:** Declarative / Non-Code 60%, Data / Markup / Trivial 40%
...
| Guard Balance (formerly Error & Exception Exposure) | 70.2 | 70.2 | 70.2 | 70.2 | 70.2 |
...
| guards | 0 | 0 | 0 | - |
| danger | 0 | 0 | 0 | - |
| concurrency | 1 | 1 | 1 | `package/example/api.postMessage.js` |
| connectivity | 0 | 0 | 0 | - |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 1 | 1 | 1 | `package/example/api.postMessage.js` |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
| regex | 0 | 0 | 0 | - |
| events | 0 | 0 | 0 | - |
| tests | 0 | 0 | 0 | - |
| docs | 0 | 0 | 0 | - |
| debt | 5 | 3 | 2 | `package/example/api.postMessage.js` |
| mutation | 21 | 3 | 7 | `package/example/api.postMessage.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- `package/example/emoji.js` (Hits: 0)
...
|---|---|---|---|---|
| `package/example` | 3 | 63.86 | 0.0% | 0.0% |
...
### `package/example/api.postMessage.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 25.24 | **LOC:** 16 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 200.0; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.8%), Guard Balance (formerly Safety Score) (70.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
### `package/example/emoji.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 19.4 | **LOC:** 26 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 200.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 1`, `args: 2`
* *Risk/State:* `state_mutation: 4`
...
### `package/example/webhook.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 19.22 | **LOC:** 14 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 200.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
