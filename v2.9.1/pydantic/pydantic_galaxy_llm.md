...
## 1. EXECUTIVE SUMMARY
- **Scope:** 266 analyzed artifact(s), 74867 LOC.
- **Load-bearing artifact:** `pydantic-2.12.5/pydantic/warnings.py` -- 41 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `pydantic-2.12.5/pydantic/_internal/_generate_schema.py` -- pulls in 58 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `pydantic-2.12.5/pydantic/json_schema.py` at magnitude 2372.3 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.595`
> **Composition Archetype:** `Hub-Coupled App` (z +1.59; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 36%, Large Core Modules (2) 26%, Data / Markup / Trivial 12%, Declarative / Non-Code 11%, Large Core Modules (3) 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 66.3 | 87.0 | 100.0 |
...
- `_type_analysis` **(Defensive Guards)** (@ `pydantic-2.12.5/pydantic/v1/fields.py`) -> Impact: **103.6** | LOC: 176
...
- **Blast Radius:** changing it is visible to **22** in-repo importer(s); it depends on **31**; blast radius 18.258; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (77.4%)
- **Documentation Coverage:** 29.4872% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `generate_inner` **(Many-Argument Workhorses)** (Impact: 50.3)
  ...
  * `decimal_schema` **(Many-Argument Workhorses)** (Impact: 36.6)
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **58**; blast radius 8.218; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (59.9%)
- **Documentation Coverage:** 68.5535% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (14.5%), Guard Balance (formerly Safety Score) (10.5%), Complexity Load (formerly Cognitive Load) (6.4%)
- **Documentation Coverage:** 96.2482% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_constraints_arbitrary_type` **(I/O & Config Routines)** (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (25.2%), Connectivity (formerly Api Exposure) (14.5%), Complexity Load (formerly Cognitive Load) (6.0%)
- **Documentation Coverage:** 92.4357% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_callable_type` **(Defensive Guards)** (Impact: 12.3)
  * `test_advanced_generic_schema` **(Annotated & Test Methods)** (Impact: 11.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (21.6%), Connectivity (formerly Api Exposure) (15.0%), Guard Balance (formerly Safety Score) (8.3%)
- **Documentation Coverage:** 91.215% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_validate_python_from_attributes` **(Defensive Guards)** (Impact: 10.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (29.5%), Connectivity (formerly Api Exposure) (15.2%), Complexity Load (formerly Cognitive Load) (12.0%)
- **Documentation Coverage:** 92.9204% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `validate_b` **(Compute Cores)** (Impact: 6.2)
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **17**; blast radius 28.725; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.9%)
- **Documentation Coverage:** 73.2394% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_type_analysis` **(Defensive Guards)** (Impact: 103.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (22.7%), Complexity Load (formerly Cognitive Load) (19.1%), Connectivity (formerly Api Exposure) (14.6%)
- **Documentation Coverage:** 90.7514% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `validate_error` **(Generic / Templated Code)** (Impact: 14.3)
  * `test_generic` **(Annotated & Test Methods)** (Impact: 13.4)
  * `test_replace_types_with_user_defined_generic_type_field` **(Annotated & Test Methods)** (Impact: 8.2)
  ...
  * `test_value_validation` **(Annotated & Test Methods)** (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (52.0%)
- **Documentation Coverage:** 31.4815% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **21**; blast radius 17.955; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.8%), Complexity Load (formerly Cognitive Load) (86.3%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (20.6%), Connectivity (formerly Api Exposure) (14.7%), Complexity Load (formerly Cognitive Load) (10.8%)
- **Documentation Coverage:** 85.4586% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `lazy_cases_for_dataclass_equality_checks` **(Annotated & Test Methods)** (Impact: 8.1)
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **27**; blast radius 22.483; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (53.7%), Connectivity (formerly Api Exposure) (53.1%)
- **Documentation Coverage:** 51.5789% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 30.8)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **21**; blast radius 5.216; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.1%)
- **Documentation Coverage:** 59.1549% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (14.5%), Complexity Load (formerly Cognitive Load) (8.6%), Guard Balance (formerly Safety Score) (8.3%)
- **Documentation Coverage:** 94.7514% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__get_pydantic_core_schema__` **(Defensive Guards)** (Impact: 13.7)
  * `test_custom_generic_validators` **(Defensive Guards)** (Impact: 10.4)
  * `_validate` **(Stateful Encapsulated Methods)** (Impact: 9.1)
  * `validate` **(Defensive Guards)** (Impact: 7.7)
  * `test_abstractmethod_missing_for_all_decorators` **(Annotated & Test Methods)** (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **30**; blast radius 2.332; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `_setattr_handler` **(Many-Argument Workhorses)** (Impact: 34.6)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **28**; blast radius 4.42; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.8%), Connectivity (formerly Api Exposure) (72.2%), Debt Markers (formerly Tech Debt) (66.3%)
- **Documentation Coverage:** 69.863% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.6%)
- **Documentation Coverage:** 58.5859% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **21**; blast radius 12.525; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Debt Markers (formerly Tech Debt) (91.5%)
- **Documentation Coverage:** 95.3488% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `validate` **(Defensive Guards)** (Impact: 24.4)
  * `__new__` **(Type Conversions)** (Impact: 16.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **30**; blast radius 2.572; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.0%)
- **Documentation Coverage:** 73.75% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (18.3%), Complexity Load (formerly Cognitive Load) (17.0%), Connectivity (formerly Api Exposure) (14.4%)
- **Documentation Coverage:** 96.4744% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_forward_ref_for_serializers` **(Defensive Guards)** (Impact: 11.0)
  * `_serialize` **(Encapsulated Accessors)** (Impact: 8.9)
  * `test_model_serializer_plain_json_return_type` **(Defensive Guards)** (Impact: 6.5)
  * `test_serializer_allow_reuse_inheritance_override` **(Annotated & Test Methods)** (Impact: 6.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.8%), Guard Balance (formerly Safety Score) (13.7%), Complexity Load (formerly Cognitive Load) (5.4%)
- **Documentation Coverage:** 88.7417% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **16**; blast radius 3.425; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.5%)
- **Documentation Coverage:** 76.6423% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_apply_constraint` **(Defensive Guards)** (Impact: 165.9)
  * `_apply_parse` **(Stateful Encapsulated Methods)** (Impact: 25.3)
  * `_apply_step` **(Stateful Encapsulated Methods)** (Impact: 16.4)
  * `_apply_transform` **(Stateful Encapsulated Methods)** (Impact: 13.1)
  * `_check_func` **(Stateful Encapsulated Methods)** (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **17** in-repo importer(s); it depends on **20**; blast radius 28.53; role: Transceiver (Middle-Tier)
...
- **Documentation Coverage:** 55.9633% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_normalize_indexes` **(Stateful Encapsulated Methods)** (Impact: 35.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.505; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (71.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.8%), Complexity Load (formerly Cognitive Load) (12.5%)
- **Documentation Coverage:** 95.6522% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_args` **(Defensive Guards)** (Impact: 9.4)
  * `test_json_schema` **(Annotated & Test Methods)** (Impact: 9.1)
  * `test_func_type` **(Defensive Guards)** (Impact: 6.2)
  * `test_eval_type_backport` **(Annotated & Test Methods)** (Impact: 5.7)
  * `test_validate_class` **(Annotated & Test Methods)** (Impact: 5.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.505; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (14.0%), Connectivity (formerly Api Exposure) (14.0%), Complexity Load (formerly Cognitive Load) (5.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `pytest_raises_user_error_for_undefined_type` **(Parameter Forwarders)** (Impact: 4.2)
