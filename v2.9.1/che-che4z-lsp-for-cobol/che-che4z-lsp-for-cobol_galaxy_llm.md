...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3127 analyzed artifact(s), 678798 LOC.
- **Load-bearing artifact:** `server/test/src/main/java/org/eclipse/lsp/cobol/test/engine/UseCaseEngine.java` -- 579 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `server/engine/src/main/java/org/eclipse/lsp/cobol/cli/di/CliModule.java` -- pulls in 63 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `clients/cobol-lsp-vscode-extension/.npmrc` at magnitude 5000.0 (structural weight, not risk).
...
> **File Composition:** Declarative / Non-Code 34%, Data / Markup / Trivial 16%, Interface Declarations Files 12%, Encapsulated Accessors Files 8%, Large Core Modules (3) 7%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 34.9 | 0.0 | 0.0 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 7.8 | 0.4 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 1.4 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 58.0 | 90.9 | 100.0 |
...
| connectivity | 7092 | 1336 | 4 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2314.2.cbl` |
| io | 66202 | 703 | 67 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2154.2.cbl` |
| crypto | 0 | 0 | 0 | - |
...
| mutation | 137415 | 2166 | 152 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2024.2.cbl` |
| dead_code | 15159 | 1114 | 8 | `tests/test_files/Cobol85PositiveTestsSuite/positive/NC2184.2.cbl` |
...
| ui | 388 | 29 | 0 | `tests/test_files/cicsGenApp/copybooks/ssmap.bms` |
...
- `definition` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2154.2.cbl`) -> Impact: **628.2** | LOC: 3224
...
- `definition` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1084.2.cbl`) -> Impact: **231.6** | LOC: 1771
...
- `definition` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1094.2.cbl`) -> Impact: **178.4** | LOC: 1289
- `phrase` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2024.2.cbl`) -> Impact: **173.1** | LOC: 2022
- `definition` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2054.2.cbl`) -> Impact: **166.3** | LOC: 1127
- `definition` **(I/O & Config Routines)** (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1054.2.cbl`) -> Impact: **164.9** | LOC: 1079
...
|---|---|---|---|---|
| `tests/test_files/Cobol85PositiveTestsSuite/positive` | 233 | 145435.32 | 36.6% | 0.0% |
| `tests/test_files/Cobol85PositiveTestsSuite/compileListing` | 233 | 102560.04 | 20.59% | 0.0% |
| `tests/test_files/aws-mainframe-modernization-carddemo/positive` | 26 | 10190.0 | 38.97% | 0.0% |
...
| `clients/analysis/src/__tests__/__resources__/cfgraph` | 321 | 4359.66 | 1.55% | 21.22% |
...
| `tests/test_files/Cobol85PositiveTestsSuite/compileListing/snapshot` | 139 | 2823.0 | 0.5% | 0.0% |
...
- `tests/test_files/Cobol85PositiveTestsSuite/positive/NC2184.2.cbl` -> **246** Orphaned Functions | **0** Duplicates
- `tests/test_files/Cobol85PositiveTestsSuite/positive/NC2234.2.cbl` -> **199** Orphaned Functions | **0** Duplicates
- `tests/test_files/Cobol85PositiveTestsSuite/positive/NC1244.2.cbl` -> **196** Orphaned Functions | **0** Duplicates
- `tests/test_files/Cobol85PositiveTestsSuite/negative/NC1074.2.cbl` -> **190** Orphaned Functions | **0** Duplicates
- `tests/test_files/Cobol85PositiveTestsSuite/positive/NC1074.2.cbl` -> **190** Orphaned Functions | **0** Duplicates
...
- **Magnitude:** 2965.42 | **LOC:** 2415 | **CtrlFlow:** 11.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (32.2%), Dead Code Surface (formerly Dead Code) (4.9%)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 276`, `structural_boundaries: 583`, `func_start: 340`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 161`, `high_risk_execution: 1`, `state_mutation: 1347`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 164`
* *Architecture:* `io: 252`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2731.08 | **LOC:** 2217 | **CtrlFlow:** 6.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (42.2%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  ...
  * `PRINT-DETAIL` **(I/O & Config Routines)** (Impact: 5.6)
  * `HEAD-ROUTINE` **(Compute Cores)** (Impact: 5.2)
  * `COLUMN-NAMES-ROUTINE` **(Interface Declarations)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 239 instances
* *State Mutation (weighted view):* 2047
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 130`, `structural_boundaries: 355`, `func_start: 433`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 263`, `high_risk_execution: 1`, `state_mutation: 1569`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 164`
* *Architecture:* `io: 339`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2728.06 | **LOC:** 2135 | **CtrlFlow:** 12.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (32.8%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 261`, `structural_boundaries: 513`, `func_start: 294`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 125`, `high_risk_execution: 1`, `state_mutation: 1211`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 148`
* *Architecture:* `io: 184`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Magnitude:** 2716.82 | **LOC:** 3265 | **CtrlFlow:** 4.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (27.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2583.32 | **LOC:** 2803 | **CtrlFlow:** 17.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (46.3%), Dead Code Surface (formerly Dead Code) (5.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 464`, `structural_boundaries: 399`, `func_start: 218`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 258`, `high_risk_execution: 1`, `state_mutation: 963`, `dead_code: 3`, `fragile_debt: 6`, `unreferenced_by_name: 56`
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2536.62 | **LOC:** 3301 | **CtrlFlow:** 8.6% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (30.3%)
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2425.32 | **LOC:** 1969 | **CtrlFlow:** 53.3% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.5%), Complexity Load (formerly Cognitive Load) (44.8%), Dead Code Surface (formerly Dead Code) (5.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1006`, `structural_boundaries: 550`, `func_start: 411`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 147`, `high_risk_execution: 1`, `state_mutation: 341`, `dead_code: 1`, `fragile_debt: 28`, `unreferenced_by_name: 156`
* *Architecture:* `io: 401`
...
- **Magnitude:** 2404.64 | **LOC:** 3636 | **CtrlFlow:** 13.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.5%), Complexity Load (formerly Cognitive Load) (33.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `definition` **(I/O & Config Routines)** (Impact: 628.2)
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2336.68 | **LOC:** 2902 | **CtrlFlow:** 9.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (30.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2211.38 | **LOC:** 2531 | **CtrlFlow:** 11.5% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.1%), Complexity Load (formerly Cognitive Load) (32.2%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 281`, `structural_boundaries: 591`, `func_start: 359`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 173`, `high_risk_execution: 1`, `state_mutation: 822`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 167`
* *Architecture:* `io: 264`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.175; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.4%), Complexity Load (formerly Cognitive Load) (46.1%), Dead Code Surface (formerly Dead Code) (6.3%), Connectivity (formerly Api Exposure) (1.7%)
- **Documentation Coverage:** 98.8235% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2195.42 | **LOC:** 3074 | **CtrlFlow:** 9.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (43.2%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 282`, `structural_boundaries: 597`, `func_start: 598`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 420`, `high_risk_execution: 1`, `state_mutation: 779`, `dead_code: 1`, `fragile_debt: 8`, `unreferenced_by_name: 246`
* *Architecture:* `io: 544`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 2079.58 | **LOC:** 2854 | **CtrlFlow:** 13.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (32.6%), Dead Code Surface (formerly Dead Code) (5.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `XXXXX055` **(I/O & Config Routines)** (Impact: 8.0)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 279`, `structural_boundaries: 342`, `func_start: 244`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 161`, `high_risk_execution: 1`, `state_mutation: 769`, `dead_code: 5`, `fragile_debt: 3`, `unreferenced_by_name: 72`
* *Architecture:* `io: 838`
* *Defense:* `cleanup: 8`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_12` (Drift: 0.0 IQR)
- **Magnitude:** 2026.54 | **LOC:** 2352 | **CtrlFlow:** 15.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (97.5%), Complexity Load (formerly Cognitive Load) (33.6%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 367`, `structural_boundaries: 780`, `func_start: 317`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 83`, `high_risk_execution: 1`, `state_mutation: 760`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 196`
* *Architecture:* `io: 93`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_12` (Drift: 0.0 IQR)
- **Magnitude:** 1935.34 | **LOC:** 2216 | **CtrlFlow:** 13.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.6%), Complexity Load (formerly Cognitive Load) (33.0%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 278`, `structural_boundaries: 500`, `func_start: 252`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 82`, `high_risk_execution: 1`, `state_mutation: 758`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 162`
* *Architecture:* `io: 118`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_12` (Drift: 0.0 IQR)
- **Magnitude:** 1882.56 | **LOC:** 2213 | **CtrlFlow:** 12.9% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.6%), Complexity Load (formerly Cognitive Load) (32.9%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 273`, `structural_boundaries: 492`, `func_start: 259`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 92`, `high_risk_execution: 1`, `state_mutation: 745`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 156`
* *Architecture:* `io: 128`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_12` (Drift: 0.0 IQR)
- **Magnitude:** 1880.72 | **LOC:** 2266 | **CtrlFlow:** 13.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (33.0%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 287`, `structural_boundaries: 520`, `func_start: 267`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 95`, `high_risk_execution: 1`, `state_mutation: 748`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 164`
* *Architecture:* `io: 132`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1852.24 | **LOC:** 1864 | **CtrlFlow:** 14.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.4%), Complexity Load (formerly Cognitive Load) (34.1%), Dead Code Surface (formerly Dead Code) (5.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 263`, `structural_boundaries: 454`, `func_start: 246`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 95`, `high_risk_execution: 1`, `state_mutation: 661`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 145`
* *Architecture:* `io: 124`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1838.9 | **LOC:** 2077 | **CtrlFlow:** 11.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.1%), Complexity Load (formerly Cognitive Load) (32.4%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 237`, `structural_boundaries: 468`, `func_start: 276`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 126`, `high_risk_execution: 1`, `state_mutation: 686`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 130`
* *Architecture:* `io: 184`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1787.2 | **LOC:** 2013 | **CtrlFlow:** 12.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.8%), Complexity Load (formerly Cognitive Load) (33.0%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `WRITE-LINE` **(I/O & Config Routines)** (Impact: 6.8)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 246`, `structural_boundaries: 470`, `func_start: 265`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 93`, `high_risk_execution: 1`, `state_mutation: 689`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 162`
* *Architecture:* `io: 136`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1729.36 | **LOC:** 2634 | **CtrlFlow:** 9.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.4%), Complexity Load (formerly Cognitive Load) (26.0%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 234`, `structural_boundaries: 706`, `func_start: 471`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 307`, `high_risk_execution: 1`, `state_mutation: 656`, `dead_code: 1`, `fragile_debt: 4`, `unreferenced_by_name: 161`
* *Architecture:* `io: 615`
* *Defense:* `safety: 1`, `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1723.7 | **LOC:** 2720 | **CtrlFlow:** 4.3% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (98.4%), Complexity Load (formerly Cognitive Load) (41.6%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` **(I/O & Config Routines)** (Impact: 8.3)
  * `PRINT-DETAIL` **(I/O & Config Routines)** (Impact: 5.6)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 112`, `structural_boundaries: 393`, `func_start: 472`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 272`, `high_risk_execution: 1`, `state_mutation: 876`, `dead_code: 1`, `fragile_debt: 3`, `unreferenced_by_name: 182`
* *Architecture:* `io: 375`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 1686.7 | **LOC:** 2354 | **CtrlFlow:** 14.5% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (33.7%), Credential Material (formerly Secrets Risk) (12.8%), Dead Code Surface (formerly Dead Code) (5.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 261`, `structural_boundaries: 287`, `func_start: 181`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 123`, `high_risk_execution: 1`, `state_mutation: 602`, `dead_code: 4`, `fragile_debt: 3`, `unreferenced_by_name: 55`
* *Architecture:* `io: 633`
* *Defense:* `cleanup: 8`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.175
