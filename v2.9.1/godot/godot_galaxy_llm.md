...
## 1. EXECUTIVE SUMMARY
- **Scope:** 11407 analyzed artifact(s), 2904396 LOC.
- **Load-bearing artifact:** `core/object/class_db.h` -- 850 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `scene/register_scene_types.cpp` -- pulls in 313 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `thirdparty/basis_universal/transcoder/basisu_transcoder.cpp` at magnitude 21940.92 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.934`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.93; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 24%, Declarative / Non-Code 23%, Large Core Modules (3) 19%, Parameter Forwarders Files 8%, Interface Declarations Files 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 51.4 | 73.4 | 0.0 |
...
- `componentName` **(Many-Argument Workhorses)** (@ `thirdparty/vulkan/include/vulkan/vulkan_format_traits.hpp`) -> Impact: **2273.5** | LOC: 1683
  * *Intent:* // The name of the component
- `componentNumericFormat` **(Many-Argument Workhorses)** (@ `thirdparty/vulkan/include/vulkan/vulkan_format_traits.hpp`) -> Impact: **2169.2** | LOC: 1606
  * *Intent:* // The numeric format of the component
- `componentBits` **(Many-Argument Workhorses)** (@ `thirdparty/vulkan/include/vulkan/vulkan_format_traits.hpp`) -> Impact: **2018.9** | LOC: 1511
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Complexity Load (formerly Cognitive Load) (91.1%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.1%), Guard Balance (formerly Safety Score) (89.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CompilerMSL::emit_instruction` **(Many-Argument Workhorses)** (Impact: 641.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (95.8%), Guard Balance (formerly Safety Score) (88.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CompilerGLSL::emit_instruction` **(Many-Argument Workhorses)** (Impact: 1016.2)
  ...
  * `CompilerGLSL::emit_block_chain_inner` **(Many-Argument Workhorses)** (Impact: 360.8)
  * `CompilerGLSL::builtin_to_glsl` **(Many-Argument Workhorses)** (Impact: 317.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Complexity Load (formerly Cognitive Load) (96.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.0%), Guard Balance (formerly Safety Score) (92.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `TGlslangToSpvTraverser::visitAggregate` **(Many-Argument Workhorses)** (Impact: 1287.0)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 0.032; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.7%), Guard Balance (formerly Safety Score) (93.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (82.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `TParseContext::updateStandaloneQualifierDefaults` **(Many-Argument Workhorses)** (Impact: 399.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Complexity Load (formerly Cognitive Load) (86.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.6418% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 0.059; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (22.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `componentName` **(Many-Argument Workhorses)** (Impact: 2273.5)
    * *Intent:* // The name of the component
  * `componentNumericFormat` **(Many-Argument Workhorses)** (Impact: 2169.2)
    * *Intent:* // The numeric format of the component
  * `componentBits` **(Many-Argument Workhorses)** (Impact: 2018.9)
    * *Intent:* // The number of bits in this component, if not compressed, otherwise 0.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Complexity Load (formerly Cognitive Load) (93.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 97.9866% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Complexity Load (formerly Cognitive Load) (93.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.8115% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.7%), Complexity Load (formerly Cognitive Load) (94.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `RichTextLabel::_draw_line` **(Many-Argument Workhorses)** (Impact: 1058.9)
  * `RichTextLabel::append_text` **(Many-Argument Workhorses)** (Impact: 756.6)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **20**; blast radius 0.06; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (82.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.4%)
- **Documentation Coverage:** 90.7205% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **26**; blast radius 0.057; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **48** in-repo importer(s); it depends on **4**; blast radius 0.851; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (43.1%), Connectivity (formerly Api Exposure) (9.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (2.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **84**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (97.3%), Complexity Load (formerly Cognitive Load) (90.4%), Guard Balance (formerly Safety Score) (89.1%)
- **Documentation Coverage:** 99.2032% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Node3DEditorViewport::_sinput` **(Compute Cores)** (Impact: 670.2)
  * `Node3DEditorViewport::_notification` **(Many-Argument Workhorses)** (Impact: 262.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (93.4%), Guard Balance (formerly Safety Score) (91.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.3023% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `TextEdit::_notification` **(Many-Argument Workhorses)** (Impact: 719.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Complexity Load (formerly Cognitive Load) (92.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 89.193% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `GLTFDocument::_parse_meshes` **(Many-Argument Workhorses)** (Impact: 203.5)
  * `GLTFDocument::export_object_model_property` **(Many-Argument Workhorses)** (Impact: 195.0)
  * `GLTFDocument::import_object_model_property` **(Many-Argument Workhorses)** (Impact: 189.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (93.6%), Guard Balance (formerly Safety Score) (92.1%), Debt Markers (formerly Tech Debt) (91.4%)
- **Documentation Coverage:** 85.42% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.0%), Complexity Load (formerly Cognitive Load) (82.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.0403% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (95.9%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `GDScriptAnalyzer::reduce_subscript` **(Many-Argument Workhorses)** (Impact: 367.9)
  * `GDScriptAnalyzer::reduce_identifier` **(Many-Argument Workhorses)** (Impact: 209.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (92.1%), Guard Balance (formerly Safety Score) (90.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.7%)
- **Documentation Coverage:** 98.6971% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `AnimationTrackEditor::_edit_menu_pressed` **(Many-Argument Workhorses)** (Impact: 357.9)
