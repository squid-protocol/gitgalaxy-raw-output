...
## 1. EXECUTIVE SUMMARY
- **Scope:** 41 analyzed artifact(s), 10447 LOC.
- **Load-bearing artifact:** `beautifulsoup4-4.14.3/bs4/element.py` -- 18 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `beautifulsoup4-4.14.3/bs4/__init__.py` -- pulls in 17 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `beautifulsoup4-4.14.3/bs4/element.py` at magnitude 2130.78 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.956`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.96; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 37%, Generic / Templated Code Files 24%, Data / Markup / Trivial 10%, Declarative / Non-Code 7%, Large Core Modules 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 73.8 | 90.0 | 100.0 |
...
- **Blast Radius:** changing it is visible to **18** in-repo importer(s); it depends on **14**; blast radius 234.856; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Connectivity (formerly Api Exposure) (86.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 55.4007% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.3%), Connectivity (formerly Api Exposure) (13.9%), Guard Balance (formerly Safety Score) (10.3%)
- **Documentation Coverage:** 95.5882% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **13**; blast radius 36.972; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `_sub_ms_char` **(Stateful Encapsulated Methods)** (Impact: 24.2)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **8**; blast radius 66.56; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.7%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (62.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `_make_match_rules` **(Many-Argument Workhorses)** (Impact: 28.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (28.5%), Complexity Load (formerly Cognitive Load) (18.7%), Connectivity (formerly Api Exposure) (12.0%)
- **Documentation Coverage:** 77.4436% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 10.902; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.7%), Complexity Load (formerly Cognitive Load) (66.2%), Connectivity (formerly Api Exposure) (65.9%)
- **Documentation Coverage:** 80.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `appendChild` **(Many-Argument Workhorses)** (Impact: 30.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (63.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (23.9%), Guard Balance (formerly Safety Score) (13.8%), Connectivity (formerly Api Exposure) (11.3%)
- **Documentation Coverage:** 97.5904% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (21.8%), Complexity Load (formerly Cognitive Load) (18.9%), Connectivity (formerly Api Exposure) (12.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_assert_warning` **(Stateful Encapsulated Methods)** (Impact: 6.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 8.495; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (18.9%), Complexity Load (formerly Cognitive Load) (16.3%), Connectivity (formerly Api Exposure) (13.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 18.123; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.1%), Complexity Load (formerly Cognitive Load) (62.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 11.0)
  * `feed` **(Defensive Guards)** (Impact: 9.9)
  * `_prefix_for_namespace` **(Stateful Encapsulated Methods)** (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **9**; blast radius 17.04; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.7%), Connectivity (formerly Api Exposure) (57.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (17.9%), Connectivity (formerly Api Exposure) (12.1%), Guard Balance (formerly Safety Score) (11.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_html5_entity` **(Defensive Guards)** (Impact: 4.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.6%), Guard Balance (formerly Safety Score) (94.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 54.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `rword` **(Generic / Templated Code)** (Impact: 6.3)
    * *Intent:* """Generate a random word-like string. :meta private: """
  * `benchmark_parsers` **(Defensive Guards)** (Impact: 5.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (28.5%), Guard Balance (formerly Safety Score) (23.6%), Connectivity (formerly Api Exposure) (11.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (14.7%), Connectivity (formerly Api Exposure) (12.0%), Guard Balance (formerly Safety Score) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (43.4%), Connectivity (formerly Api Exposure) (10.5%), Complexity Load (formerly Cognitive Load) (8.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (11.3%), Guard Balance (formerly Safety Score) (6.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (35.3%), Complexity Load (formerly Cognitive Load) (22.6%), Connectivity (formerly Api Exposure) (11.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `test_feed_raises_correct_exception_on_rejected_input` **(Parameter Forwarders)** (Impact: 2.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 42.49; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.7%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (78.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_ns` **(Stateful Encapsulated Methods)** (Impact: 6.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (28.0%), Complexity Load (formerly Cognitive Load) (18.1%), Connectivity (formerly Api Exposure) (9.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **6**; blast radius 46.101; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (28.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 15.3)
  * `_default` **(Stateful Encapsulated Methods)** (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (25.9%), Connectivity (formerly Api Exposure) (10.1%), Guard Balance (formerly Safety Score) (3.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 8.495; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (12.1%), Connectivity (formerly Api Exposure) (10.0%), Dead Code Surface (formerly Dead Code) (9.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
