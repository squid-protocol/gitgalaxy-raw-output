...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 839 LOC.
...
- **Top orchestrator:** `package/src/main.js` -- pulls in 5 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/main.js` at magnitude 1107.46 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 60%, Large Core Modules (3) 20%, State Mutators Files 20%
...
- `render` **(I/O & Config Routines)** (@ `package/src/main.js`) -> Impact: **53.6** | LOC: 292
- `run` **(I/O & Config Routines)** (@ `package/bin/cli.js`) -> Impact: **30.1** | LOC: 103
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.4%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `queryUser` **(Many-Argument Workhorses)** (Impact: 340.5)
  * `handleKeypress` **(Many-Argument Workhorses)** (Impact: 143.2)
  * `render` **(I/O & Config Routines)** (Impact: 53.6)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (90.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (47.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run` **(I/O & Config Routines)** (Impact: 30.1)
