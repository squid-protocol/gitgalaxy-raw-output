...
## 1. EXECUTIVE SUMMARY
- **Scope:** 453 analyzed artifact(s), 44357 LOC.
- **Load-bearing artifact:** `retrofit/src/main/java/retrofit2/Retrofit.java` -- 133 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `retrofit/java-test/src/test/java/retrofit2/RequestFactoryTest.java` -- pulls in 49 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `retrofit/android-test/debug.keystore` at magnitude 5000.0 (structural weight, not risk).
...
| Avg Path Length | 1.8962 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `2.583`
> **Composition Archetype:** `Hub-Coupled App` (z +2.58; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 26%, Declarative / Non-Code 23%, Data / Markup / Trivial 22%, Large Core Modules (3) 7%, State Mutators Files 6%
...
| Connectivity (formerly API Exposure) | 0.0 | 93.1 | 8.6 | 5.6 | 0.0 |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 23.5 | 0.3 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 67.1 | 100.0 | 100.0 |
...
| connectivity | 2615 | 288 | 15 | `retrofit/java-test/src/test/java/retrofit2/RequestFactoryTest.java` |
...
| dead_code | 1274 | 239 | 8 | `retrofit/java-test/src/test/java/retrofit2/RequestFactoryTest.java` |
| credential | 0 | 0 | 0 | - |
...
- `parseParameterAnnotation` **(Many-Argument Workhorses)** (@ `retrofit/src/main/java/retrofit2/RequestFactory.java`) -> Impact: **349.3** | LOC: 457
- `resolve` **(Many-Argument Workhorses)** (@ `retrofit/src/main/java/retrofit2/Utils.java`) -> Impact: **69.5** | LOC: 71
- `equals` **(Defensive Guards)** (@ `retrofit/src/main/java/retrofit2/Utils.java`) -> Impact: **38.6** | LOC: 44
  * *Intent:* /** Returns true if {@code a} and {@code b} are equal. */
- `parseMethodAnnotation` **(Defensive Guards)** (@ `retrofit/src/main/java/retrofit2/RequestFactory.java`) -> Impact: **37.2** | LOC: 37
- `getGenericSupertype` **(Compute Cores)** (@ `retrofit/src/main/java/retrofit2/Utils.java`) -> Impact: **33.5** | LOC: 31
...
- `parseParameter` **(Stateful Encapsulated Methods)** (@ `retrofit/src/main/java/retrofit2/RequestFactory.java`) -> Impact: **28.7** | LOC: 37
- `request` **(Compute Cores)** (@ `retrofit-adapters/rxjava/src/main/java/retrofit2/adapter/rxjava/CallArbiter.java`) -> Impact: **25.5** | LOC: 30
- `emitResponse` **(Compute Cores)** (@ `retrofit-adapters/rxjava/src/main/java/retrofit2/adapter/rxjava/CallArbiter.java`) -> Impact: **24.0** | LOC: 27
- `enqueue` **(Generic / Templated Code)** (@ `retrofit-mock/src/main/java/retrofit2/mock/BehaviorCall.java`) -> Impact: **22.8** | LOC: 60
- `parseHeaders` **(Stateful Encapsulated Methods)** (@ `retrofit/src/main/java/retrofit2/RequestFactory.java`) -> Impact: **22.0** | LOC: 24
...
| `retrofit/src/main/java/retrofit2` | 28 | 2604.22 | 28.35% | 36.09% |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (42.7%), Connectivity (formerly Api Exposure) (12.5%), Complexity Load (formerly Cognitive Load) (9.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `multipartPartMapWithEncoding` **(Annotated & Test Methods)** (Impact: 7.7)
  * `multipartWithEncoding` **(Annotated & Test Methods)** (Impact: 7.6)
  * `malformedAnnotationRelativeUrlThrows` **(Annotated & Test Methods)** (Impact: 6.8)
  * `malformedParameterRelativeUrlThrows` **(Annotated & Test Methods)** (Impact: 6.8)
  * `headersDoNotOverwriteEachOther` **(Annotated & Test Methods)** (Impact: 6.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **45**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.9%), Guard Balance (formerly Safety Score) (76.0%), Complexity Load (formerly Cognitive Load) (62.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.5%)
- **Documentation Coverage:** 92.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parseParameterAnnotation` **(Many-Argument Workhorses)** (Impact: 349.3)
  * `parseMethodAnnotation` **(Defensive Guards)** (Impact: 37.2)
  * `parseParameter` **(Stateful Encapsulated Methods)** (Impact: 28.7)
  * `parseHeaders` **(Stateful Encapsulated Methods)** (Impact: 22.0)
  * `boxIfPrimitive` **(Stateful Encapsulated Methods)** (Impact: 16.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **45**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (77.7%), Guard Balance (formerly Safety Score) (33.6%), Complexity Load (formerly Cognitive Load) (18.0%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 99.1031% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `unresolvableResponseTypeThrows` **(Defensive Guards)** (Impact: 16.1)
  * `unresolvableParameterTypeThrows` **(Defensive Guards)** (Impact: 16.1)
  * `callAdapterFactoryQueriedCanDelegateTwiceWithoutRecursion` **(Annotated & Test Methods)** (Impact: 14.9)
  * `callAdapterFactoryQueriedCanDelegate` **(Annotated & Test Methods)** (Impact: 12.2)
  * `callAdapterFactoryQueried` **(Annotated & Test Methods)** (Impact: 11.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (36.1%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `conversionProblemIncomingMaskedByConverterIsUnwrapped` **(Annotated & Test Methods)** (Impact: 3.8)
  * `fatalErrorsAreNotCaughtEnqueue` **(Annotated & Test Methods)** (Impact: 3.5)
  * `requestThrowingBeforeEnqueueFailsEnqueue` **(Annotated & Test Methods)** (Impact: 3.4)
  * `requestThrowingNonFatalErrorBeforeEnqueueFailsEnqueue` **(Annotated & Test Methods)** (Impact: 3.4)
  * `requestAfterEnqueueFailingThrows` **(Annotated & Test Methods)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.7%), Mutation Surface (formerly State Flux) (30.8%), Complexity Load (formerly Cognitive Load) (19.9%), Connectivity (formerly Api Exposure) (13.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.8%), Mutation Surface (formerly State Flux) (31.7%), Complexity Load (formerly Cognitive Load) (18.6%), Connectivity (formerly Api Exposure) (14.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 6
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.2%), Mutation Surface (formerly State Flux) (37.2%), Complexity Load (formerly Cognitive Load) (23.8%), Connectivity (formerly Api Exposure) (14.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 6
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 1.203; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.7%), Complexity Load (formerly Cognitive Load) (59.6%)
- **Documentation Coverage:** 87.2727% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolve` **(Many-Argument Workhorses)** (Impact: 69.5)
  * `equals` **(Defensive Guards)** (Impact: 38.6)
    * *Intent:* /** Returns true if {@code a} and {@code b} are equal. */
  * `getGenericSupertype` **(Compute Cores)** (Impact: 33.5)
    * *Intent:* /** * Returns the generic supertype for {@code supertype}. For example, given a class {@code * Integ...
  * `hasUnresolvableType` **(Defensive Guards)** (Impact: 18.5)
  * `getRawType` **(Defensive Guards)** (Impact: 17.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **133** in-repo importer(s); it depends on **25**; blast radius 99.57; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (91.8%), Connectivity (formerly Api Exposure) (79.1%), Complexity Load (formerly Cognitive Load) (46.1%)
- **Documentation Coverage:** 16.9492% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `loadServiceMethod` **(Defensive Guards)** (Impact: 21.6)
  * `validateServiceInterface` **(Stateful Encapsulated Methods)** (Impact: 18.5)
  * `invoke` **(Compute Cores)** (Impact: 12.7)
  * `nextRequestBodyConverter` **(Defensive Guards)** (Impact: 11.8)
    * *Intent:* /** * Returns a {@link Converter} for {@code type} to {@link RequestBody} from the available * {@lin...
  * `nextResponseBodyConverter` **(I/O & Config Routines)** (Impact: 11.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.203; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.1%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (54.2%), Complexity Load (formerly Cognitive Load) (25.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `apply` **(Compute Cores)** (Impact: 17.3)
  * `apply` **(Compute Cores)** (Impact: 17.3)
  * `apply` **(Generic / Templated Code)** (Impact: 13.5)
  * `apply` **(Generic / Templated Code)** (Impact: 13.1)
  * `apply` **(Generic / Templated Code)** (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (94.6%), Debt Markers (formerly Tech Debt) (88.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `canonicalizeForPath` **(Stateful Encapsulated Methods)** (Impact: 21.1)
  * `RequestBuilder` **(Many-Argument Workhorses)** (Impact: 19.6)
  * `get` **(I/O & Config Routines)** (Impact: 16.9)
  * `addQueryParam` **(Compute Cores)** (Impact: 14.9)
  * `addHeader` **(Defensive Guards)** (Impact: 12.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 1.51; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (56.6%), Complexity Load (formerly Cognitive Load) (43.0%), Connectivity (formerly Api Exposure) (34.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `togglePlatformDependent` **(Defensive Guards)** (Impact: 20.1)
  * `handleAnchor` **(Callbacks & Closures)** (Impact: 15.4)
  * `setItem` **(Defensive Guards)** (Impact: 8.9)
  * `searchForContentTarget` **(Callbacks & Closures)** (Impact: 8.8)
  * `scrollToElementInContent` **(Callbacks & Closures)** (Impact: 8.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (82.9%), Connectivity (formerly Api Exposure) (10.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.8)
  * `bodyThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
  * `responseThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (84.2%), Connectivity (formerly Api Exposure) (10.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.8)
  * `bodyThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.4)
  * `responseThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 12 instances
* *Amplified Cascading Flux:* 14 instances
* *Concurrency (weighted view):* 77
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (89.1%), Connectivity (formerly Api Exposure) (9.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `bodyThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.4)
  * `responseThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 12 instances
* *Amplified Cascading Flux:* 14 instances
* *Concurrency (weighted view):* 77
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (90.4%), Connectivity (formerly Api Exposure) (9.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
  * `bodyThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.3)
  * `responseThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 12 instances
* *Amplified Cascading Flux:* 14 instances
* *Concurrency (weighted view):* 77
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (89.4%), Connectivity (formerly Api Exposure) (9.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (90.6%), Connectivity (formerly Api Exposure) (9.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (49.5%), Connectivity (formerly Api Exposure) (9.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setUp` **(Annotated & Test Methods)** (Impact: 3.1)
  * `asyncCanBeCanceled` **(Annotated & Test Methods)** (Impact: 2.8)
  * `asyncCanBeCanceledBeforeStart` **(Annotated & Test Methods)** (Impact: 2.6)
  * `asyncFailureTriggersFailureAfterDelay` **(Annotated & Test Methods)** (Impact: 2.5)
  * `asyncSuccessCalledAfterDelay` **(Annotated & Test Methods)** (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 12 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (72.8%), Complexity Load (formerly Cognitive Load) (41.8%), Connectivity (formerly Api Exposure) (11.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 5.8)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 5.8)
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 5.0)
  * `bodyThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.7)
  * `responseThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (78.2%), Complexity Load (formerly Cognitive Load) (42.9%), Connectivity (formerly Api Exposure) (11.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.9)
  * `bodyThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
  * `responseThrowingInOnCompleteDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.203; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (84.1%), Complexity Load (formerly Cognitive Load) (53.5%), Connectivity (formerly Api Exposure) (10.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resultThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 5.0)
  * `bodyThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `responseThrowingInOnErrorDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 4.8)
  * `bodyThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
  * `responseThrowingInOnSuccessDeliveredToPlugin` **(Annotated & Test Methods)** (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
* *Amplified Cascading Flux:* 8 instances
* *Concurrency (weighted view):* 37
