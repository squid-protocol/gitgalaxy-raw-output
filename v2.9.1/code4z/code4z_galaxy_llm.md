...
- **Heaviest artifact:** `prepare_release.sh` at magnitude 8.2 (structural weight, not risk).
...
| Mutation Surface (formerly State Flux Exposure) | 83.2 | 83.2 | 83.2 | 83.2 | 83.2 |
...
| memory | 0 | 0 | 0 | - |
| cleanup | 0 | 0 | 0 | - |
| guards | 1 | 1 | 1 | `prepare_release.sh` |
| danger | 6 | 1 | 6 | `prepare_release.sh` |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 0 | 0 | 0 | - |
| io | 2 | 1 | 2 | `prepare_release.sh` |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
| regex | 1 | 1 | 1 | `prepare_release.sh` |
| events | 0 | 0 | 0 | - |
| tests | 0 | 0 | 0 | - |
| docs | 0 | 0 | 0 | - |
| debt | 1 | 1 | 1 | `prepare_release.sh` |
| mutation | 10 | 1 | 10 | `prepare_release.sh` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- `__global_context__` **(Unclassified)** (@ `prepare_release.sh`) -> Impact: **3.0** | LOC: 12
...
|---|---|---|---|---|
| `__monolith__` | 4 | 13.82 | 0.0% | 0.0% |

## 10. TARGETED STRUCTURAL SURFACE VECTORS (formerly Risk Vectors, Top 5 by Surface)
### Highest Mutation Surface (formerly State Flux; Mutation/Volatility)
- `prepare_release.sh` -> **83.2018%** Exposure
...
### `prepare_release.sh` (SHELL | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_14` (Drift: 0.0 IQR)
- **Magnitude:** 8.2 | **LOC:** 13 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (91.0%), Mutation Surface (formerly State Flux) (83.2%), Test Surface (formerly Verification) (2.3%)
