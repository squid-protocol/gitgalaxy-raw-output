...
## 1. EXECUTIVE SUMMARY
- **Scope:** 54 analyzed artifact(s), 8364 LOC.
- **Load-bearing artifact:** `joblib-1.5.3/joblib/externals/loky/backend/context.py` -- 11 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `joblib-1.5.3/joblib/parallel.py` -- pulls in 30 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `joblib-1.5.3/joblib/parallel.py` at magnitude 1282.66 (structural weight, not risk).
...
> **File Composition:** Large Core Modules (3) 31%, Data / Markup / Trivial 17%, Encapsulated Accessors Files 13%, Declarative / Non-Code 9%, Large Core Modules (2) 9%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 51.5 | 63.8 | 0.0 |
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **30**; blast radius 15.031; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Concurrency Surface (formerly Concurrency) (95.9%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `__call__` **(Stateful Encapsulated Methods)** (Impact: 32.9)
    * *Intent:* """Main function to dispatch parallel tasks."""
  * `_get_outputs` **(Stateful Encapsulated Methods)** (Impact: 25.9)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **27**; blast radius 41.612; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (56.6%)
- **Documentation Coverage:** 65.3543% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **28**; blast radius 18.7; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.5%)
- **Documentation Coverage:** 87.3418% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_on_queue_feeder_error` **(Stateful Encapsulated Methods)** (Impact: 15.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **19**; blast radius 6.844; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 65.6566% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **9**; blast radius 20.42; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 30.9)
  ...
  * `_read_block` **(Stateful Encapsulated Methods)** (Impact: 21.4)
  ...
  * `_fill_buffer` **(Stateful Encapsulated Methods)** (Impact: 9.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **13**; blast radius 6.844; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **17**; blast radius 8.973; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (52.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `compute_batch_size` **(Stateful Encapsulated Methods)** (Impact: 15.6)
    * *Intent:* """Determine the optimal batch size"""
  * `configure` **(Many-Argument Workhorses)** (Impact: 13.2)
  * `_prepare_worker_env` **(Stateful Encapsulated Methods)** (Impact: 10.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 8.193; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (76.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `_clean_win_chars` **(Stateful Encapsulated Methods)** (Impact: 6.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **16**; blast radius 8.383; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.6%), Complexity Load (formerly Cognitive Load) (80.9%)
- **Documentation Coverage:** 89.7959% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 36.8)
  * `_to_func_args` **(Many-Argument Workhorses)** (Impact: 21.9)
  * `maybe_to_futures` **(Defensive Guards)** (Impact: 16.2)
  * `effective_n_jobs` **(Defensive Guards)** (Impact: 9.9)
  * `_collect` **(Stateful Encapsulated Methods)** (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 11 instances
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **18**; blast radius 8.783; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (57.7%)
- **Documentation Coverage:** 7.0175% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 42.774; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 21.4)
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **13**; blast radius 171.869; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.6%), Mutation Surface (formerly State Flux) (85.0%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 35.4839% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_cpu_count_cgroup` **(Stateful Encapsulated Methods)** (Impact: 15.8)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **13**; blast radius 9.797; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.6%), Complexity Load (formerly Cognitive Load) (68.4%), Concurrency Surface (formerly Concurrency) (58.5%)
- **Documentation Coverage:** 65.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Many-Argument Workhorses)** (Impact: 58.8)
    * *Intent:* """Run resource tracker."""
  * `_launch` **(Stateful Encapsulated Methods)** (Impact: 12.4)
    * *Intent:* # This is the overridden part of the resource tracker, which launches # loky's version, which is com...
  * `_ensure_running_and_write` **(Stateful Encapsulated Methods)** (Impact: 11.8)
  ...
  * `_unlink_resources` **(Stateful Encapsulated Methods)** (Impact: 7.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 6.253; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (99.1%), Debt Markers (formerly Tech Debt) (95.1%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 13.381; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.5%)
- **Documentation Coverage:** 84.6154% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_reusable_executor` **(Many-Argument Workhorses)** (Impact: 77.5)
  * `_resize` **(Stateful Encapsulated Methods)** (Impact: 19.0)
  * `_wait_job_completion` **(Stateful Encapsulated Methods)** (Impact: 7.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 6.844; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.3%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 7.0)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 8.433; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.2%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_make_methods` **(Stateful Encapsulated Methods)** (Impact: 8.9)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **14**; blast radius 56.411; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.1%), Guard Balance (formerly Safety Score) (97.1%), Complexity Load (formerly Cognitive Load) (90.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `_set_dispatch_table` **(Stateful Encapsulated Methods)** (Impact: 6.2)
  * `_reduce_method` **(Encapsulated Accessors)** (Impact: 4.5)
    * *Intent:* ############################################################################### # Registers extra pi...
  * `_reduce_partial` **(Encapsulated Accessors)** (Impact: 2.9)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 14.26; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  ...
  * `_is_numpy_array_byte_order_mismatch` **(Stateful Encapsulated Methods)** (Impact: 18.1)
    * *Intent:* """Check if numpy array is having byte order mismatch"""
  * `_read_bytes` **(Stateful Encapsulated Methods)** (Impact: 14.2)
    * *Intent:* """Read from file-like object until size bytes are read. TODO python2_drop: is it still needed? The ...
  * `_detect_compressor` **(Stateful Encapsulated Methods)** (Impact: 11.4)
    * *Intent:* ############################################################################### # Cache file utiliti...
  * `_write_fileobject` **(Stateful Encapsulated Methods)** (Impact: 5.9)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 44.761; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (98.1%), Complexity Load (formerly Cognitive Load) (94.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_feed` **(Many-Argument Workhorses)** (Impact: 44.4)
    * *Intent:* # Overload the _feed methods to use our custom pickling strategy.
  * `_start_thread` **(Stateful Encapsulated Methods)** (Impact: 6.6)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **7**; blast radius 30.212; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.2%), Debt Markers (formerly Tech Debt) (86.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.4615% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_cmp` **(Stateful Encapsulated Methods)** (Impact: 11.0)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 7.708; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (44.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **12**; blast radius 29.281; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (98.6%), Complexity Load (formerly Cognitive Load) (96.7%), Guard Balance (formerly Safety Score) (79.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_launch` **(Many-Argument Workhorses)** (Impact: 14.8)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 29.281; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (89.0%), Complexity Load (formerly Cognitive Load) (66.2%)
- **Documentation Coverage:** 41.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 10.1)
  * `get_command_line` **(Compute Cores)** (Impact: 6.8)
  ...
  * `is_forking` **(Compute Cores)** (Impact: 6.0)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **9**; blast radius 20.365; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Guard Balance (formerly Safety Score) (94.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 65.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 6.5)
    * *Intent:* """ Parameters ---------- depth: int, optional The depth of objects printed. name: str, optional The...
  * `_squeeze_time` **(Encapsulated Accessors)** (Impact: 4.7)
