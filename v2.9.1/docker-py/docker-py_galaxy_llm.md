...
## 1. EXECUTIVE SUMMARY
- **Scope:** 154 analyzed artifact(s), 21301 LOC.
- **Load-bearing artifact:** `tests/helpers.py` -- 20 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `docker/api/client.py` -- pulls in 30 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/ssh/config/client/id_rsa` at magnitude 5000.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.876`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.88; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 33%, Parameter Forwarders Files 23%, Data / Markup / Trivial 18%, Many-Argument Workhorses Files 7%, Declarative / Non-Code 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 66.3 | 96.1 | 100.0 |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 7.247; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.2%), Complexity Load (formerly Cognitive Load) (89.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (45.0%), Complexity Load (formerly Cognitive Load) (41.1%), Concurrency Surface (formerly Concurrency) (22.0%), Connectivity (formerly Api Exposure) (12.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_remove_link` **(Defensive Guards)** (Impact: 10.4)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 6.692; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (41.3%), Guard Balance (formerly Safety Score) (40.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.5%), Connectivity (formerly Api Exposure) (11.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_update_service_with_defaults_endpoint_spec` **(Defensive Guards)** (Impact: 18.4)
  * `_update_service` **(Stateful Encapsulated Methods)** (Impact: 12.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 4.275; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (55.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `_convert_port_binding` **(Stateful Encapsulated Methods)** (Impact: 18.3)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 5.027; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `_set_auth_headers` **(Stateful Encapsulated Methods)** (Impact: 18.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 4.275; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `_merge_task_template` **(Stateful Encapsulated Methods)** (Impact: 14.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (18.6%), Connectivity (formerly Api Exposure) (12.7%), Complexity Load (formerly Cognitive Load) (8.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **21**; blast radius 19.457; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (91.6%), Guard Balance (formerly Safety Score) (52.0%), Concurrency Surface (formerly Concurrency) (48.4%), Complexity Load (formerly Cognitive Load) (39.2%)
...
**Top Internal Functions/Classes:**
  ...
  * `fake_resp` **(Compute Cores)** (Impact: 9.4)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 4.886; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (63.2%)
- **Documentation Coverage:** 16.1765% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_host_volume_from_bind` **(Stateful Encapsulated Methods)** (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **30**; blast radius 5.053; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.6%)
- **Documentation Coverage:** 68.2927% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 71.6)
  * `_read_from_socket` **(Stateful Encapsulated Methods)** (Impact: 18.3)
    * *Intent:* """Consume all data from the socket, close the response and return the data. If stream=True, then a ...
  * `_stream_helper` **(Stateful Encapsulated Methods)** (Impact: 17.0)
    * *Intent:* """Generator for data coming from a chunked-encoded HTTP response."""
  * `_post_json` **(Stateful Encapsulated Methods)** (Impact: 16.4)
    * *Intent:* # Go <1.1 can't unserialize null to a string # so we do this disgusting thing here. data2 = {} if da...
  * `_get_result_tty` **(Stateful Encapsulated Methods)** (Impact: 14.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.5%), Complexity Load (formerly Cognitive Load) (27.9%), Connectivity (formerly Api Exposure) (10.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_build_with_dockerignore` **(Compute Cores)** (Impact: 6.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.7%), Complexity Load (formerly Cognitive Load) (28.0%), Connectivity (formerly Api Exposure) (10.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_build_with_cache_from` **(Defensive Guards)** (Impact: 10.2)
  * `test_build_squash` **(Defensive Guards)** (Impact: 6.8)
  * `build_squashed` **(Compute Cores)** (Impact: 6.2)
  * `test_build_with_extra_hosts` **(Defensive Guards)** (Impact: 5.6)
  * `test_build_with_dockerignore` **(Compute Cores)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 57 instances
* *State Mutation (weighted view):* 242
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.917; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.3%), Complexity Load (formerly Cognitive Load) (42.1%), Concurrency Surface (formerly Concurrency) (29.4%), Connectivity (formerly Api Exposure) (12.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 4.275; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.7%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.6%)
- **Documentation Coverage:** 48.7179% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_import_image_params` **(Stateful Encapsulated Methods)** (Impact: 15.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 44 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.917; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `_resolve_authconfig_credstore` **(Stateful Encapsulated Methods)** (Impact: 15.3)
