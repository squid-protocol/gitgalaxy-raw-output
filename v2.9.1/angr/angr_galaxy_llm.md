...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1792 analyzed artifact(s), 229737 LOC.
- **Load-bearing artifact:** `angr/concretization_strategies/logging.py` -- 441 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `angr/analyses/decompiler/peephole_optimizations/__init__.py` -- pulls in 63 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `angr/analyses/cfg/cfg_fast.py` at magnitude 5851.88 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.41`
> **Composition Archetype:** `Hub-Coupled App` (z +2.41; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 29%, Large Core Modules (2) 17%, Parameter Forwarders Files 16%, Large Core Modules (3) 9%, Encapsulated Accessors Files 8%
...
| connectivity | 12192 | 1361 | 16 | `tests/analyses/decompiler/test_decompiler.py` |
...
- `_unify_local_variables` **(Many-Argument Workhorses)** (@ `angr/analyses/decompiler/ail_simplifier.py`) -> Impact: **264.3** | LOC: 449
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **39**; blast radius 0.635; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.5%)
- **Documentation Coverage:** 68.6047% of unit weight undocumented
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **29**; blast radius 0.904; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.4%), Complexity Load (formerly Cognitive Load) (82.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 95.0495% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **21**; blast radius 1.182; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Complexity Load (formerly Cognitive Load) (80.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.5897% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_find_node_going_to_dst` **(Stateful Encapsulated Methods)** (Impact: 124.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **83** in-repo importer(s); it depends on **19**; blast radius 21.863; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.1%), Guard Balance (formerly Safety Score) (95.6%), Connectivity (formerly Api Exposure) (85.9%)
- **Documentation Coverage:** 90.297% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.274; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (44.2%), Complexity Load (formerly Cognitive Load) (28.6%), Connectivity (formerly Api Exposure) (12.4%)
- **Documentation Coverage:** 93.6123% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_decompiling_rep_stosq` **(Many-Argument Workhorses)** (Impact: 36.2)
  * `_check_rep_stosq` **(Stateful Encapsulated Methods)** (Impact: 34.0)
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **47**; blast radius 0.967; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.1%)
- **Documentation Coverage:** 82.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 188.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.274; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Debt Markers (formerly Tech Debt) (97.7%), Complexity Load (formerly Cognitive Load) (93.8%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **34**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.6%)
- **Documentation Coverage:** 21.7054% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 123.7)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **28**; blast radius 0.395; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (83.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 35.5372% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_graph_traversal_handler` **(Many-Argument Workhorses)** (Impact: 212.9)
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 197.7)
...
- **Blast Radius:** changing it is visible to **57** in-repo importer(s); it depends on **13**; blast radius 10.085; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.7%), Guard Balance (formerly Safety Score) (97.0%), Connectivity (formerly Api Exposure) (93.2%)
- **Documentation Coverage:** 89.6057% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **22**; blast radius 0.333; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.2%)
- **Documentation Coverage:** 58.046% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `assembly` **(Many-Argument Workhorses)** (Impact: 63.8)
    * *Intent:* """ :return: """
  * `_initialize` **(Stateful Encapsulated Methods)** (Impact: 58.7)
    * *Intent:* # # Private methods #
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **8**; blast radius 1.285; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (87.3%), Connectivity (formerly Api Exposure) (80.3%)
- **Documentation Coverage:** 98.4925% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **32**; blast radius 0.416; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (86.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.5246% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_unify_local_variables` **(Many-Argument Workhorses)** (Impact: 264.3)
    * *Intent:* # # Unifying local variables # """ Find variables that are definitely equivalent and then eliminate ...
  * `_remove_dead_assignments` **(Defensive Guards)** (Impact: 130.3)
  ...
  * `_fold_call_exprs` **(Many-Argument Workhorses)** (Impact: 64.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 0.339; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.8%)
- **Documentation Coverage:** 74.1573% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **31**; blast radius 0.326; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.7%)
...
- **Blast Radius:** changing it is visible to **140** in-repo importer(s); it depends on **13**; blast radius 24.42; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.2%), Complexity Load (formerly Cognitive Load) (92.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **18** in-repo importer(s); it depends on **31**; blast radius 1.55; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (61.1%)
- **Documentation Coverage:** 63.2743% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 120.7)
  ...
  * `_rust_fmt_node` **(Stateful Encapsulated Methods)** (Impact: 33.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **12**; blast radius 0.333; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.4%)
- **Documentation Coverage:** 43.038% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_get_block_matches` **(Many-Argument Workhorses)** (Impact: 94.5)
  * `_compute_diff` **(Stateful Encapsulated Methods)** (Impact: 66.2)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **24**; blast radius 0.325; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Complexity Load (formerly Cognitive Load) (80.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 89.9225% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **19**; blast radius 0.489; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (90.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.124% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `render` **(Many-Argument Workhorses)** (Impact: 139.4)
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 80.8)
  * `_render` **(Many-Argument Workhorses)** (Impact: 74.7)
  ...
  * `_render` **(Stateful Encapsulated Methods)** (Impact: 43.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **24**; blast radius 0.966; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **10**; blast radius 0.389; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (41.9%)
- **Documentation Coverage:** 42.2018% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_handle_operation` **(Stateful Encapsulated Methods)** (Impact: 38.4)
  * `_track` **(Stateful Encapsulated Methods)** (Impact: 36.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.274; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Complexity Load (formerly Cognitive Load) (95.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.2906% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_handle_stmt_Return` **(Many-Argument Workhorses)** (Impact: 50.2)
  * `_handle_binop_Shr` **(Stateful Encapsulated Methods)** (Impact: 46.7)
  * `_handle_binop_Sar` **(Stateful Encapsulated Methods)** (Impact: 46.7)
  * `_handle_binop_Shl` **(Stateful Encapsulated Methods)** (Impact: 46.5)
  * `_handle_binop_Add` **(Stateful Encapsulated Methods)** (Impact: 41.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 225 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.274; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 79.4872% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **22** in-repo importer(s); it depends on **21**; blast radius 1.625; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (79.7%)
