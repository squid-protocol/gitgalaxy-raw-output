...
## 1. EXECUTIVE SUMMARY
- **Scope:** 13 analyzed artifact(s), 621 LOC.
- **Load-bearing artifact:** `http-structs.cpy` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `webserver.cbl` -- pulls in 3 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `url-decode.cbl` at magnitude 169.24 (structural weight, not risk).
...
> **File Composition:** Large Core Modules 46%, Data / Markup / Trivial 23%, Declarative / Non-Code 23%, State Mutators Files 8%
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 55.7 | 17.3 | 10.2 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 50.0 | 29.2 | 50.0 | 50.0 |
...
| dead_code | 11 | 6 | 2 | `http-handler.cbl` |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
...
- `DECODE-HEX-CHAR` **(I/O & Config Routines)** (@ `url-decode.cbl`) -> Impact: **48.8** | LOC: 76
...
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `file-ops.cbl`) -> Impact: **23.7** | LOC: 94
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `mime-types.cbl`) -> Impact: **22.9** | LOC: 58
  * *Intent:* *> Main MIME type detection logic
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `path-utils.cbl`) -> Impact: **14.6** | LOC: 72
  * *Intent:* *> Main path validation and sanitization logic
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `http-handler.cbl`) -> Impact: **13.9** | LOC: 99
  * *Intent:* *> Main HTTP request processing logic
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `url-decode.cbl`) -> Impact: **9.5** | LOC: 50
  * *Intent:* *> Main URL decoding logic
- `INIT-SOCKET` **(I/O & Config Routines)** (@ `webserver.cbl`) -> Impact: **7.8** | LOC: 55
  * *Intent:* *> Create and configure a TCP socket for the web server
- `HANDLE-REQUEST` **(I/O & Config Routines)** (@ `webserver.cbl`) -> Impact: **6.5** | LOC: 31
  * *Intent:* *> Read HTTP request from client and generate response
- `MAIN-LOGIC` **(I/O & Config Routines)** (@ `webserver.cbl`) -> Impact: **4.0** | LOC: 19
  * *Intent:* *> Main program entry point
- `BUILD-200-RESPONSE` **(I/O & Config Routines)** (@ `http-handler.cbl`) -> Impact: **3.0** | LOC: 37
...
- `file-ops.cbl` -> **1** Orphaned Functions | **0** Duplicates
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `DECODE-HEX-CHAR` **(I/O & Config Routines)** (Impact: 48.8)
    * *Intent:* *> Convert two-character hex code to actual character *> Handles common URL-encoded special characte...
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 9.5)
    * *Intent:* *> Main URL decoding logic
...
- **Magnitude:** 82.58 | **LOC:** 130 | **CtrlFlow:** 19.1% | **Authorship Centralization:** 100.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Guard Balance (formerly Safety Score) (95.9%), Complexity Load (formerly Cognitive Load) (68.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 23.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 17 instances
* *State Mutation (weighted view):* 56
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 18`, `structural_boundaries: 20`, `args: 2`, `func_start: 1`, `class_start: 1`
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Complexity Load (formerly Cognitive Load) (79.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 22.9)
    * *Intent:* *> Main MIME type detection logic
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 68.027; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (78.0%), Complexity Load (formerly Cognitive Load) (43.9%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 13.9)
    * *Intent:* *> Main HTTP request processing logic
  * `BUILD-200-RESPONSE` **(I/O & Config Routines)** (Impact: 3.0)
    * *Intent:* *> Build HTTP 200 OK response with file content
  * `BUILD-404-RESPONSE` **(I/O & Config Routines)** (Impact: 1.5)
    * *Intent:* *> Build HTTP 404 Not Found response
  * `BUILD-403-RESPONSE` **(I/O & Config Routines)** (Impact: 1.5)
    * *Intent:* *> Build HTTP 403 Forbidden response (for security violations)
  * `BUILD-413-RESPONSE` **(I/O & Config Routines)** (Impact: 1.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Guard Balance (formerly Safety Score) (93.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 14.6)
    * *Intent:* *> Main path validation and sanitization logic
  * `LS-RETURN-CODE` **(State Mutators)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 68.027; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Guard Balance (formerly Safety Score) (83.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `INIT-SOCKET` **(I/O & Config Routines)** (Impact: 7.8)
    * *Intent:* *> Create and configure a TCP socket for the web server
  * `HANDLE-REQUEST` **(I/O & Config Routines)** (Impact: 6.5)
    * *Intent:* *> Read HTTP request from client and generate response
  * `MAIN-LOGIC` **(I/O & Config Routines)** (Impact: 4.0)
    * *Intent:* *> Main program entry point
  * `ACCEPT-LOOP` **(Interface Declarations)** (Impact: 2.8)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Connectivity (formerly Api Exposure) (8.2%), Test Surface (formerly Verification) (2.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (0.2%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `url-decode.o` **(I/O & Config Routines)** (Impact: 1.3)
  * `run` **(I/O & Config Routines)** (Impact: 1.2)
    * *Intent:* # Run the server
  * `all` **(State Mutators)** (Impact: 1.1)
    * *Intent:* # Default target
  * `path-utils.o` **(I/O & Config Routines)** (Impact: 1.1)
    * *Intent:* # Compile modules to object files
  * `mime-types.o` **(I/O & Config Routines)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.1%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 116.213; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 87.302; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 96.939; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (94.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
- `file-ops.cbl` -> Churn: **100.0%** | Cog Load: 68.2646% | Debt: 28.8177%
...
- `file-ops.cbl` -> **Jms Dnns** (100.0% isolated ownership) | Magnitude: 82.58
