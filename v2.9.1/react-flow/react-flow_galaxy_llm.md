...
## 1. EXECUTIVE SUMMARY
- **Scope:** 652 analyzed artifact(s), 36464 LOC.
- **Load-bearing artifact:** `tooling/tsconfig/react.json` -- 240 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `examples/react/src/App/routes.ts` -- pulls in 65 dependencies, the widest assembly point in the scan.
...
> **Composition Archetype:** `Hub-Coupled App` (z +3.98; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 39%, Declarative / Non-Code 19%, Callbacks & Closures Files 11%, Generic / Templated Code Files 9%, Large Core Modules (2) 7%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 96.4 | 17.3 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 99.7 | 3.3 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 5.2 | 2.3 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 44.0 | 0.0 | 0.0 |
...
- `createStore` **(Defensive Guards)** (@ `packages/svelte/src/lib/store/index.ts`) -> Impact: **146.7** | LOC: 389
...
- `Pane` **(Defensive Guards)** (@ `packages/react/src/container/Pane/index.tsx`) -> Impact: **99.3** | LOC: 232
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.042; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (80.0%), Complexity Load (formerly Cognitive Load) (38.9%)
...
- **Magnitude:** 478.12 | **LOC:** 601 | **CtrlFlow:** 26.3% | **Authorship Centralization:** 45.5%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (85.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (78.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (94.9%), Mutation Surface (formerly State Flux) (84.9%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (79.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createStore` **(Defensive Guards)** (Impact: 146.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.042; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.0%), Complexity Load (formerly Cognitive Load) (83.3%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `getResizeDirection` **(Compute Cores)** (Impact: 13.8)
    * *Intent:* /** * Get all connecting edges for a given set of nodes */
  * `getControlDirection` **(Compute Cores)** (Impact: 4.9)
    * *Intent:* /** * Parses the control position that is being dragged to dimensions that are being resized */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.042; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.4%), Guard Balance (formerly Safety Score) (26.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 2.748; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (87.9%), Mutation Surface (formerly State Flux) (84.9%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (78.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 1.928; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (43.5%), Mutation Surface (formerly State Flux) (35.2%), Guard Balance (formerly Safety Score) (31.9%), Complexity Load (formerly Cognitive Load) (13.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (85.2%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (43.5%), Mutation Surface (formerly State Flux) (36.1%)
- **Documentation Coverage:** 70.3704% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parsePaddings` **(Defensive Guards)** (Impact: 41.4)
    * *Intent:* /** * Parses the paddings to an object with top, right, bottom, left, x and y paddings */
  ...
  * `evaluateAbsolutePosition` **(Many-Argument Workhorses)** (Impact: 22.9)
    * *Intent:* /** * Convert child position to absolute position * */
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 1.928; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.7%), Complexity Load (formerly Cognitive Load) (61.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `nodeToParentExtent` **(Parameter Forwarders)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 1.928; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.1%), Concurrency Surface (formerly Concurrency) (70.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **4**; blast radius 2.498; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.5%), Guard Balance (formerly Safety Score) (46.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.042; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.5%), Guard Balance (formerly Safety Score) (25.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 1.091; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (87.6%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (43.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (42.3%)
- **Documentation Coverage:** 89.6552% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `useSvelteFlow` **(I/O & Config Routines)** (Impact: 28.0)
    * *Intent:* /** * Hook for accessing the SvelteFlow instance. * */
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **8**; blast radius 2.098; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (69.8%), Connectivity (formerly Api Exposure) (65.0%), Guard Balance (formerly Safety Score) (50.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.8%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (64.1%), Guard Balance (formerly Safety Score) (52.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Pane` **(Defensive Guards)** (Impact: 99.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (74.5%), Guard Balance (formerly Safety Score) (44.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `updateNodeInternals` **(Defensive Guards)** (Impact: 13.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 1.928; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (45.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onPointerDown` **(Many-Argument Workhorses)** (Impact: 68.4)
  * `isValidHandle` **(Many-Argument Workhorses)** (Impact: 41.6)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 4.375; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (90.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (35.9%), Connectivity (formerly Api Exposure) (24.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `XYPanZoom` **(Defensive Guards)** (Impact: 79.8)
  * `update` **(I/O & Config Routines)** (Impact: 22.4)
    * *Intent:* // public functions
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.042; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (34.2%), Mutation Surface (formerly State Flux) (33.3%), Guard Balance (formerly Safety Score) (32.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `onPointerDown` **(Generic / Templated Code)** (Impact: 9.9)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (48.4%), Mutation Surface (formerly State Flux) (15.0%), Complexity Load (formerly Cognitive Load) (9.7%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- `packages/react/src/store/index.ts` -> Churn: **100.0%** | Cog Load: 21.6798% | Debt: 74.4868%
- `packages/system/src/utils/store.ts` -> Churn: **100.0%** | Cog Load: 56.2166% | Debt: 0.0%
- `packages/svelte/src/lib/store/initial-store.svelte.ts` -> Churn: **78.31%** | Cog Load: 87.9296% | Debt: 0.0%
- `packages/svelte/src/lib/container/Pane/Pane.svelte` -> Churn: **56.24%** | Cog Load: 60.4817% | Debt: 0.0%
- `packages/react/src/components/SelectionListener/index.tsx` -> Churn: **50.74%** | Cog Load: 22.0296% | Debt: 92.7444%
...
- `packages/react/src/utils/changes.ts` -> **Severity: 0.444** (Embedded: 0.0046 * Error Risk: 96.396%)
- `examples/react/cypress/support/ControlledFlow.tsx` -> **Severity: 0.434** (Embedded: 0.0061 * Error Risk: 70.6822%)
- `packages/react/src/hooks/useReactFlow.ts` -> **Severity: 0.352** (Embedded: 0.0069 * Error Risk: 50.8988%)
- `packages/react/src/hooks/useKeyPress.ts` -> **Severity: 0.293** (Embedded: 0.0061 * Error Risk: 47.6124%)
- `packages/react/src/components/Edges/SimpleBezierEdge.tsx` -> **Severity: 0.247** (Embedded: 0.0046 * Error Risk: 53.6107%)
