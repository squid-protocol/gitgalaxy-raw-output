# ARCHITECTURAL_BRIEF: node-schedule
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 15 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 17.3 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 80%, Declarative / Non-Code 20%
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 1 | 1 | 1 | `package/index.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
4. **UPGRADING.md** (`package/UPGRADING.md`) — 0 outbound dependencies
...
- **Magnitude:** 17.3 | **LOC:** 18 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` Invocation, Job, schedule
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `package/README.md` (MARKDOWN | Tier 1 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 6.1 | **LOC:** 305 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
### `package/UPGRADING.md` (MARKDOWN | Tier 1 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
