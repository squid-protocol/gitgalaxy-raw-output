...
## 1. EXECUTIVE SUMMARY
- **Scope:** 434 analyzed artifact(s), 144899 LOC.
- **Load-bearing artifact:** `src/stdx/stdx.zig` -- 139 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/clients/go/bindings.go` -- pulls in 102 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/vsr/replica.zig` at magnitude 3835.3 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.935`
> **Composition Archetype:** `Hub-Coupled App` (z +1.94; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (3) 25%, Large Core Modules (2) 24%, Data / Markup / Trivial 16%, Declarative / Non-Code 9%, Parameter Forwarders Files 7%
...
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 17.4 | 2.3 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 68.5 | 84.2 | 100.0 |
...
- `GridType` **(Many-Argument Workhorses)** (@ `src/vsr/grid.zig`) -> Impact: **227.5** | LOC: 1410
...
- `MessageBusType` **(Many-Argument Workhorses)** (@ `src/message_bus.zig`) -> Impact: **215.6** | LOC: 1201
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **14**; blast radius 2.818; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (61.5%), Guard Balance (formerly Safety Score) (53.6%)
- **Documentation Coverage:** 66.113% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (79.4%), Connectivity (formerly Api Exposure) (60.9%), Guard Balance (formerly Safety Score) (59.4%)
- **Documentation Coverage:** 88.6076% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `StateMachineType` **(Many-Argument Workhorses)** (Impact: 156.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.716; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (90.0%), Concurrency Surface (formerly Concurrency) (76.2%), Guard Balance (formerly Safety Score) (63.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.2%)
- **Documentation Coverage:** 86.5546% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `testAccountTransfers` **(I/O & Config Routines)** (Impact: 32.4)
  * `testQueryTransfers` **(I/O & Config Routines)** (Impact: 17.5)
  * `testQueryAccounts` **(I/O & Config Routines)** (Impact: 16.6)
  * `Server` **(Compute Cores)** (Impact: 11.5)
  * `testConcurrentQueries` **(Annotated & Test Methods)** (Impact: 11.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 2.296; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.9%), Connectivity (formerly Api Exposure) (56.9%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **9**; blast radius 1.287; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.1%), Connectivity (formerly Api Exposure) (57.9%)
- **Documentation Coverage:** 82.4324% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CompactionType` **(Many-Argument Workhorses)** (Impact: 261.1)
  * `compaction_dispatch` **(Many-Argument Workhorses)** (Impact: 66.5)
  ...
  * `half_bar_complete` **(I/O & Config Routines)** (Impact: 34.6)
    * *Intent:* /// Apply the changes that have been accumulated in memory to the manifest and remove any /// tables...
  * `merge_advance_position` **(I/O & Config Routines)** (Impact: 29.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.716; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.8%), Mutation Surface (formerly State Flux) (99.4%), Complexity Load (formerly Cognitive Load) (73.1%), Debt Markers (formerly Tech Debt) (44.9%)
- **Documentation Coverage:** 89.5652% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `TestGetAccountTransfers` **(I/O & Config Routines)** (Impact: 30.1)
  * `ConcurrencyTest` **(Compute Cores)** (Impact: 21.7)
  * `TestQueryTransfers` **(I/O & Config Routines)** (Impact: 18.5)
  * `TestQueryAccounts` **(I/O & Config Routines)** (Impact: 18.0)
  * `ConcurrentLinkedChainTest` **(Callbacks & Closures)** (Impact: 13.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **14**; blast radius 1.007; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.9%), Guard Balance (formerly Safety Score) (52.8%), Mutation Surface (formerly State Flux) (46.6%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 0.759; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (61.9%), Connectivity (formerly Api Exposure) (38.0%)
- **Documentation Coverage:** 75.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `WorkloadType` **(Many-Argument Workhorses)** (Impact: 169.0)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **8**; blast radius 1.338; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (65.4%), Connectivity (formerly Api Exposure) (61.9%), Guard Balance (formerly Safety Score) (48.9%)
- **Documentation Coverage:** 70.5128% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **5**; blast radius 2.43; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (95.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (43.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (29.4%)
- **Documentation Coverage:** 87.7778% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **10**; blast radius 0.985; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (67.5%), Connectivity (formerly Api Exposure) (60.0%), Guard Balance (formerly Safety Score) (41.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.0%)
- **Documentation Coverage:** 59.322% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 2.262; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (85.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (44.3%), Mutation Surface (formerly State Flux) (8.5%)
- **Documentation Coverage:** 1.6484% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (95.8%), Complexity Load (formerly Cognitive Load) (94.8%), Guard Balance (formerly Safety Score) (65.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.6%), Guard Balance (formerly Safety Score) (46.6%), Complexity Load (formerly Cognitive Load) (38.1%)
...
- **Blast Radius:** changing it is visible to **20** in-repo importer(s); it depends on **11**; blast radius 6.603; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (78.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (58.3%), Guard Balance (formerly Safety Score) (42.4%)
- **Documentation Coverage:** 56.1644% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GridType` **(Many-Argument Workhorses)** (Impact: 227.5)
  ...
  * `read_block_tick_callback` **(Defensive Guards)** (Impact: 22.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 1.21; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (54.5%), Connectivity (formerly Api Exposure) (21.3%), Complexity Load (formerly Cognitive Load) (19.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (18.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **7**; blast radius 3.332; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (73.7%), Mutation Surface (formerly State Flux) (59.2%), Guard Balance (formerly Safety Score) (41.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (36.2%)
- **Documentation Coverage:** 75.8929% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `target_update` **(Many-Argument Workhorses)** (Impact: 30.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.7%), Guard Balance (formerly Safety Score) (57.3%), Connectivity (formerly Api Exposure) (48.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (41.1%)
- **Documentation Coverage:** 72.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MessageBusType` **(Many-Argument Workhorses)** (Impact: 215.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 0.918; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.8%), Connectivity (formerly Api Exposure) (67.1%), Mutation Surface (formerly State Flux) (43.9%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 0.918; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (61.8%), Guard Balance (formerly Safety Score) (54.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.8%), Mutation Surface (formerly State Flux) (35.2%)
- **Documentation Coverage:** 69.4118% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `complete` **(Many-Argument Workhorses)** (Impact: 83.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (89.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (55.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.8%)
- **Documentation Coverage:** 64.5833% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(I/O & Config Routines)** (Impact: 53.8)
  * `pending` **(Defensive Guards)** (Impact: 30.0)
  * `tick_requests` **(Compute Cores)** (Impact: 26.7)
    * *Intent:* /// Maybe send a request from one of the cluster's clients.
  * `options_swarm` **(I/O & Config Routines)** (Impact: 26.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **18**; blast radius 0.838; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (60.2%), Guard Balance (formerly Safety Score) (43.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.8%), Complexity Load (formerly Cognitive Load) (5.9%)
- **Documentation Coverage:** 72.093% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ClusterType` **(Many-Argument Workhorses)** (Impact: 182.9)
  * `init` **(Many-Argument Workhorses)** (Impact: 59.1)
  * `log_replica` **(Many-Argument Workhorses)** (Impact: 50.1)
  * `tick` **(Defensive Guards)** (Impact: 25.5)
  * `deinit` **(I/O & Config Routines)** (Impact: 21.2)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **4**; blast radius 0.8; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (58.1%), Mutation Surface (formerly State Flux) (50.6%), Connectivity (formerly Api Exposure) (38.8%), Guard Balance (formerly Safety Score) (32.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.716; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.6%), Guard Balance (formerly Safety Score) (27.5%), Complexity Load (formerly Cognitive Load) (26.9%), Connectivity (formerly Api Exposure) (9.0%)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **5**; blast radius 4.607; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (82.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (73.9%), Guard Balance (formerly Safety Score) (58.9%)
- **Documentation Coverage:** 76.1194% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `SuperBlockType` **(Many-Argument Workhorses)** (Impact: 98.9)
    * *Intent:* /// /// checkpoint seq seq seq /// a a a /// a a+1 /// a a+1 a+1 /// a+1 a+1 a+1 Read quorum; verify...
  * `read_header_callback` **(I/O & Config Routines)** (Impact: 29.6)
  * `monotonic` **(Compute Cores)** (Impact: 17.1)
  * `assert_internally_consistent` **(I/O & Config Routines)** (Impact: 16.0)
