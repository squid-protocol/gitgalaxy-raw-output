...
## 1. EXECUTIVE SUMMARY
- **Scope:** 616 analyzed artifact(s), 48095 LOC.
- **Load-bearing artifact:** `bootloader01/ser.h` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `jtagproxy/ft232rl/parport.c` -- pulls in 12 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tas/tas.c` at magnitude 4005.52 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.626`
> **Composition Archetype:** `Mid Flat Project` (z +1.63; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules 28%, Data / Markup / Trivial 26%, Parameter Forwarders Files 20%, Interface Declarations Files 7%, Declarative / Non-Code 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 85.7 | 100.0 | 100.0 |
...
- `assemble` **(Many-Argument Workhorses)** (@ `tas/tas.c`) -> Impact: **720.5** | LOC: 1513
  * *Intent:* //-------------------------------------------------------------------
- `inflate` **(Many-Argument Workhorses)** (@ `twain/inflate.c`) -> Impact: **392.7** | LOC: 648
  * *Intent:* */
- `inflate` **(Many-Argument Workhorses)** (@ `zlib/inflate.c`) -> Impact: **392.7** | LOC: 648
  * *Intent:* */
- `inflate` **(Many-Argument Workhorses)** (@ `zlib/thumb/inflate.c`) -> Impact: **392.7** | LOC: 648
  * *Intent:* */
- `dissassemble` **(Many-Argument Workhorses)** (@ `tas/tas.c`) -> Impact: **295.9** | LOC: 597
  * *Intent:* //-------------------------------------------------------------------
- `deflate` **(Many-Argument Workhorses)** (@ `twain/deflate.c`) -> Impact: **206.1** | LOC: 312
  * *Intent:* /* ========================================================================= */
- `deflate` **(Many-Argument Workhorses)** (@ `zlib/deflate.c`) -> Impact: **206.1** | LOC: 312
  * *Intent:* /* ========================================================================= */
- `deflate` **(Many-Argument Workhorses)** (@ `zlib/thumb/deflate.c`) -> Impact: **206.1** | LOC: 312
  * *Intent:* /* ========================================================================= */
- `_tr_flush_block` **(Many-Argument Workhorses)** (@ `twain/trees.c`) -> Impact: **129.9** | LOC: 318
  * *Intent:* /* =========================================================================== * Determine the best encoding for the current block: dynamic trees, sta...
- `_tr_flush_block` **(Many-Argument Workhorses)** (@ `zlib/thumb/trees.c`) -> Impact: **129.9** | LOC: 318
  * *Intent:* /* =========================================================================== * Determine the best encoding for the current block: dynamic trees, sta...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (94.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `assemble` **(Many-Argument Workhorses)** (Impact: 720.5)
    * *Intent:* //-------------------------------------------------------------------
  * `dissassemble` **(Many-Argument Workhorses)** (Impact: 295.9)
    * *Intent:* //-------------------------------------------------------------------
  * `main` **(Many-Argument Workhorses)** (Impact: 95.3)
    * *Intent:* //-------------------------------------------------------------------
  * `parse_immed` **(Compute Cores)** (Impact: 32.4)
    * *Intent:* //-------------------------------------------------------------------
  * `parse_low_reg` **(Compute Cores)** (Impact: 19.8)
    * *Intent:* //-------------------------------------------------------------------
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Complexity Load (formerly Cognitive Load) (80.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deflate` **(Many-Argument Workhorses)** (Impact: 206.1)
    * *Intent:* /* ========================================================================= */
  * `deflateInit2_` **(Many-Argument Workhorses)** (Impact: 95.4)
    * *Intent:* /* ========================================================================= */
  * `longest_match` **(Many-Argument Workhorses)** (Impact: 78.1)
    * *Intent:* #ifndef FASTEST /* =========================================================================== * Set...
  * `deflate_slow` **(Many-Argument Workhorses)** (Impact: 59.9)
    * *Intent:* #ifndef FASTEST /* =========================================================================== * Sam...
  * `deflate_rle` **(Compute Cores)** (Impact: 50.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (80.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deflate` **(Many-Argument Workhorses)** (Impact: 206.1)
    * *Intent:* /* ========================================================================= */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (96.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `inflate` **(Many-Argument Workhorses)** (Impact: 392.7)
    * *Intent:* */
  * `inflateInit2_` **(Many-Argument Workhorses)** (Impact: 26.6)
  * `inflateCopy` **(Compute Cores)** (Impact: 23.1)
  * `updatewindow` **(Many-Argument Workhorses)** (Impact: 21.5)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (86.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `inflate` **(Many-Argument Workhorses)** (Impact: 392.7)
    * *Intent:* */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_tr_flush_block` **(Many-Argument Workhorses)** (Impact: 129.9)
    * *Intent:* /* =========================================================================== * Determine the best ...
  * `send_tree` **(Many-Argument Workhorses)** (Impact: 44.3)
    * *Intent:* /* =========================================================================== * Send a literal or d...
  * `scan_tree` **(Many-Argument Workhorses)** (Impact: 36.0)
    * *Intent:* /* =========================================================================== * Scan a literal or d...
  * `gen_bitlen` **(Many-Argument Workhorses)** (Impact: 29.9)
    * *Intent:* /* =========================================================================== * Compute the optimal...
  * `build_tree` **(Many-Argument Workhorses)** (Impact: 24.9)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 1223.6 | **LOC:** 1225 | **CtrlFlow:** 21.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_tr_flush_block` **(Many-Argument Workhorses)** (Impact: 129.9)
...
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `floatXAdd` **(Compute Cores)** (Impact: 52.0)
  * `floatXToFloat32` **(Compute Cores)** (Impact: 45.0)
  * `roundFloatXTo24` **(Stateful Encapsulated Methods)** (Impact: 25.9)
    * *Intent:* //static flag le64( bits64X a, bits64X b ) //{ //return ( a.a0 < b.a0 ) || ( ( a.a0 == b.a0 ) && ( a...
  * `roundFloatXTo53` **(Stateful Encapsulated Methods)** (Impact: 25.9)
  * `floatXToInt32` **(Stateful Encapsulated Methods)** (Impact: 21.6)
