...
## 1. EXECUTIVE SUMMARY
- **Scope:** 84 analyzed artifact(s), 2772 LOC.
- **Load-bearing artifact:** `fonttools-4.62.1/Doc/man/man1/ttx.1` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `fonttools-4.62.1/setup.py` -- pulls in 23 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `fonttools-4.62.1/Tests/ttLib/tables/data/C_F_F_.bin` at magnitude 500.0 (structural weight, not risk).
...
> **Composition Archetype:** `Small Flat Repo` (z +4.16; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 69%, Declarative / Non-Code 10%, Large Core Modules (3) 6%, Compute Cores Files 5%, Large Core Modules (2) 4%
...
- `write_checksum` **(Many-Argument Workhorses)** (@ `fonttools-4.62.1/Snippets/checksum.py`) -> Impact: **51.0** | LOC: 68
- `approx` **(Defensive Guards)** (@ `fonttools-4.62.1/Tests/pens/utils.py`) -> Impact: **35.5** | LOC: 29
- `bumpversion` **(Many-Argument Workhorses)** (@ `fonttools-4.62.1/setup.py`) -> Impact: **32.9** | LOC: 22
...
- `find_fonts` **(Many-Argument Workhorses)** (@ `fonttools-4.62.1/Snippets/ttf2otf.py`) -> Impact: **29.8** | LOC: 36
- `_repr_pen_commands` **(Stateful Encapsulated Methods)** (@ `fonttools-4.62.1/Tests/pens/utils.py`) -> Impact: **28.0** | LOC: 50
  * *Intent:* """ >>> print(_repr_pen_commands([ ... ('moveTo', tuple(), {}), ... ('lineTo', ((1.0, 0.1),), {}), ... ('curveTo', ((1.0, 0.1), (2.0, 0.2), (3.0, 0.3)...
- `main` **(Compute Cores)** (@ `fonttools-4.62.1/Snippets/ttf2otf.py`) -> Impact: **27.8** | LOC: 131
...
- `main` **(Compute Cores)** (@ `fonttools-4.62.1/Snippets/rename-fonts.py`) -> Impact: **23.7** | LOC: 50
- `roundTrip` **(Many-Argument Workhorses)** (@ `fonttools-4.62.1/MetaTools/roundTrip.py`) -> Impact: **20.1** | LOC: 41
- `AddGlyphVariations` **(Many-Argument Workhorses)** (@ `fonttools-4.62.1/Snippets/interpolate.py`) -> Impact: **19.4** | LOC: 30
- `py` **(Compute Cores)** (@ `fonttools-4.62.1/Tests/ufoLib/testSupport.py`) -> Impact: **18.2** | LOC: 25
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 11.554; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 37.875% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find_fonts` **(Many-Argument Workhorses)** (Impact: 29.8)
  * `main` **(Compute Cores)** (Impact: 27.8)
    * *Intent:* """ Convert TrueType flavored fonts to CFF flavored fonts. INPUT_PATH argument can be a file or a di...
  * `build_otf` **(Many-Argument Workhorses)** (Impact: 16.9)
  * `get_hmtx_values` **(Generic / Templated Code)** (Impact: 11.5)
  * `quadratics_to_cubics` **(Many-Argument Workhorses)** (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 11.554; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (78.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (14.1%), Connectivity (formerly Api Exposure) (5.3%)
- **Documentation Coverage:** 82.6087% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `py` **(Compute Cores)** (Impact: 18.2)
  * `_writePointPenCommand` **(Stateful Encapsulated Methods)** (Impact: 14.0)
  * `_dictToString` **(Stateful Encapsulated Methods)** (Impact: 13.7)
  * `_listToString` **(Stateful Encapsulated Methods)** (Impact: 12.2)
  * `_tupleToString` **(Stateful Encapsulated Methods)** (Impact: 12.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 21.375; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (24.1%), Connectivity (formerly Api Exposure) (11.4%)
- **Documentation Coverage:** 49.0909% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `approx` **(Defensive Guards)** (Impact: 35.5)
  * `_repr_pen_commands` **(Stateful Encapsulated Methods)** (Impact: 28.0)
    * *Intent:* """ >>> print(_repr_pen_commands([ ... ('moveTo', tuple(), {}), ... ('lineTo', ((1.0, 0.1),), {}), ....
  * `addPoint` **(Type Conversions)** (Impact: 8.2)
  * `__eq__` **(Defensive Guards)** (Impact: 5.5)
    * *Intent:* """Return True if 'other' glyph's outline is the same as self."""
  * `draw` **(Compute Cores)** (Impact: 5.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.3%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Compute Cores)** (Impact: 23.7)
  * `add_family_suffix` **(Compute Cores)** (Impact: 15.2)
  * `get_current_family_name` **(Compute Cores)** (Impact: 9.5)
  * `insert_suffix` **(Compute Cores)** (Impact: 6.5)
    * *Intent:* # check whether family_name is a substring start = string.find(family_name) if start != -1: # insert...
  * `rename_file` **(Compute Cores)** (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.4%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `write_checksum` **(Many-Argument Workhorses)** (Impact: 51.0)
  * `check_checksum` **(Compute Cores)** (Impact: 17.8)
  * `_read_binary` **(Encapsulated Accessors)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 21 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (51.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 54.54% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `AddGlyphVariations` **(Many-Argument Workhorses)** (Impact: 19.4)
  * `GetCoordinates` **(Compute Cores)** (Impact: 11.8)
    * *Intent:* """font, glyphName --> glyph coordinates as expected by "gvar" table The result includes four "phant...
  * `AddFontVariations` **(Defensive Guards)** (Impact: 3.9)
  * `AddName` **(Parameter Forwarders)** (Impact: 3.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (90.0%), Complexity Load (formerly Cognitive Load) (87.6%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `visitLeaf` **(Defensive Guards)** (Impact: 14.8)
  * `visit` **(Defensive Guards)** (Impact: 7.7)
  * `visitList` **(Many-Argument Workhorses)** (Impact: 7.3)
  * `visitDict` **(Many-Argument Workhorses)** (Impact: 7.3)
  * `visitAttr` **(Parameter Forwarders)** (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (63.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Compute Cores)** (Impact: 13.4)
  * `otf_to_ttf` **(Defensive Guards)** (Impact: 10.1)
  * `update_hmtx` **(Defensive Guards)** (Impact: 5.4)
  * `glyphs_to_quadratic` **(Parameter Forwarders)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Complexity Load (formerly Cognitive Load) (56.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(I/O & Config Routines)** (Impact: 14.7)
  * `write_csv` **(Generic / Templated Code)** (Impact: 5.3)
  * `flatten` **(Generic / Templated Code)** (Impact: 4.3)
  * `woff_size` **(Generic / Templated Code)** (Impact: 2.0)
  * `pct` **(Generic / Templated Code)** (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (73.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Complexity Load (formerly Cognitive Load) (76.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ProcessTable` **(Compute Cores)** (Impact: 15.5)
  * `ProcessFont` **(Compute Cores)** (Impact: 7.8)
  * `ProcessFiles` **(Compute Cores)** (Impact: 6.2)
  * `main` **(I/O & Config Routines)** (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (25.5%)
- **Documentation Coverage:** 77.9143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_args` **(Defensive Guards)** (Impact: 9.6)
  * `main` **(Compute Cores)** (Impact: 8.7)
  * `svg2glif` **(Many-Argument Workhorses)** (Impact: 3.9)
    * *Intent:* """Convert an SVG outline to a UFO glyph with given 'name', advance 'width' and 'height' (int), and ...
  * `unicode_hex_list` **(Defensive Guards)** (Impact: 3.1)
  * `transform_list` **(Defensive Guards)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (78.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.8%), Complexity Load (formerly Cognitive Load) (55.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `roundTrip` **(Many-Argument Workhorses)** (Impact: 20.1)
  * `main` **(Defensive Guards)** (Impact: 7.1)
  * `usage` **(Interface Declarations)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (48.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Complexity Load (formerly Cognitive Load) (56.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 11.554; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.6%), Complexity Load (formerly Cognitive Load) (63.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 90.9% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 11.554; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.6%), Complexity Load (formerly Cognitive Load) (57.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
