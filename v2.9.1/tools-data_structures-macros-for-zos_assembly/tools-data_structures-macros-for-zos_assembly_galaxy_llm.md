# ARCHITECTURAL_BRIEF: tools-data_structures-macros-for-zos_assembly
...
| **Git Remote** | `https://github.com/tobiaslinke/tools-data_structures-macros-for-zos_assembly.git` |
...
- `no_extension`: 16x Unsupported Format (.undeterminable), 1x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 1x Unresolved Ambiguity (No Retainable Structure)
