...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 142 LOC.
...
- **Top orchestrator:** `package/tests/index.js` -- pulls in 2 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/index.js` at magnitude 69.28 (structural weight, not risk).
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 49.9 | 49.6 | 0.0 |
...
- `asPromise` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **15.5** | LOC: 32
  * *Intent:* */ /** * Returns a promise from a node-style callback function. */
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (98.8%), Debt Markers (formerly Tech Debt) (95.3%), Guard Balance (formerly Safety Score) (90.7%)
- **Documentation Coverage:** 49.5896% of unit weight undocumented
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (93.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (48.7%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Concurrency Surface (formerly Concurrency) (28.2%), Mutation Surface (formerly State Flux) (16.8%)
