...
## 1. EXECUTIVE SUMMARY
- **Scope:** 69 analyzed artifact(s), 46744 LOC.
- **Load-bearing artifact:** `src/sokol/sokol.zig` -- 21 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/sokol/c/sokol_app.h` -- pulls in 46 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/sokol/c/sokol_gfx.h` at magnitude 18140.32 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.477`
> **Composition Archetype:** `Small Flat Repo (2)` (z +2.48; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules 26%, Declarative / Non-Code 25%, Data / Markup / Trivial 20%, State Mutators Files 14%, Large Core Modules (3) 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 56.9 | 100.0 | 100.0 |
...
- `_sg_d3d11_create_view` **(Many-Argument Workhorses)** (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **113.0** | LOC: 216
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **28**; blast radius 27.859; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (94.5%), Guard Balance (formerly Safety Score) (86.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_sg_validate_shader_desc` **(Compute Cores)** (Impact: 113.9)
  * `_sg_d3d11_create_view` **(Many-Argument Workhorses)** (Impact: 113.0)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **46**; blast radius 26.087; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (90.8%), Guard Balance (formerly Safety Score) (87.2%), Connectivity (formerly Api Exposure) (87.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 10.34; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (86.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (77.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 12.153; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_sfetch_channel_thread_func` **(Compute Cores)** (Impact: 214.8)
    * *Intent:* #if _SFETCH_PLATFORM_WINDOWS
  * `_sfetch_channel_dowork` **(Many-Argument Workhorses)** (Impact: 52.5)
    * *Intent:* /* per-frame channel stuff: move requests in and out of the IO threads, call response callbacks */
  * `_sfetch_request_handler` **(Many-Argument Workhorses)** (Impact: 49.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **22**; blast radius 12.153; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (78.5%), Connectivity (formerly Api Exposure) (68.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_saudio_wasapi_backend_init` **(I/O & Config Routines)** (Impact: 16.9)
  * `_saudio_n3ds_cb` **(Compute Cores)** (Impact: 15.1)
    * *Intent:* // ███████ ██████ ███████ // ██ ██ ██ ██ // ██████ ██ ██ ███████ // ██ ██ ██ ██ // ███████ ██████ ██...
  * `_saudio_alsa_backend_init` **(I/O & Config Routines)** (Impact: 13.2)
  * `_saudio_log` **(Stateful Encapsulated Methods)** (Impact: 12.9)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 10.945; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (88.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sshape_build_box` **(Many-Argument Workhorses)** (Impact: 53.4)
  * `sshape_build_cylinder` **(Many-Argument Workhorses)** (Impact: 22.8)
  * `sshape_build_sphere` **(Many-Argument Workhorses)** (Impact: 22.6)
    * *Intent:* */
  * `sshape_build_torus` **(Many-Argument Workhorses)** (Impact: 18.7)
    * *Intent:* */
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **10**; blast radius 62.878; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (63.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.528; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.6%), Guard Balance (formerly Safety Score) (44.8%), Debt Markers (formerly Tech Debt) (14.9%)
- **Documentation Coverage:** 65.0407% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 23.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.8%), Debt Markers (formerly Tech Debt) (16.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.2%)
- **Documentation Coverage:** 74.6835% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `asRange` **(Defensive Guards)** (Impact: 10.9)
    * *Intent:* // helper function to convert "anything" to a Range struct
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 23.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.3%)
- **Documentation Coverage:** 98.9474% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `cStrToZig` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **1**; blast radius 44.774; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (81.7%), Guard Balance (formerly Safety Score) (64.6%), Complexity Load (formerly Cognitive Load) (27.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mul` **(Defensive Guards)** (Impact: 5.8)
  * `norm` **(Compute Cores)** (Impact: 4.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 12.153; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Guard Balance (formerly Safety Score) (73.9%), Connectivity (formerly Api Exposure) (62.0%), Complexity Load (formerly Cognitive Load) (25.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `stm_round_to_common_refresh_rate` **(Compute Cores)** (Impact: 6.3)
  * `stm_diff` **(Compute Cores)** (Impact: 5.6)
  * `stm_now` **(Compute Cores)** (Impact: 5.0)
  * `stm_setup` **(Compute Cores)** (Impact: 4.8)
    * *Intent:* #endif
  * `stm_laptime` **(Compute Cores)** (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 23.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (58.6%), Guard Balance (formerly Safety Score) (52.4%), Debt Markers (formerly Tech Debt) (26.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.6%), Complexity Load (formerly Cognitive Load) (17.3%), Connectivity (formerly Api Exposure) (6.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `init` **(I/O & Config Routines)** (Impact: 9.0)
  * `recreateOffscreenAttachments` **(Many-Argument Workhorses)** (Impact: 5.5)
    * *Intent:* // helper function to create or re-create attachment resources
  * `event` **(Generic / Templated Code)** (Impact: 3.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 18.233; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.7%), Connectivity (formerly Api Exposure) (50.2%), Complexity Load (formerly Cognitive Load) (46.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `sglue_environment` **(I/O & Config Routines)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (82.0%), Complexity Load (formerly Cognitive Load) (54.2%), Connectivity (formerly Api Exposure) (6.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.4%), Complexity Load (formerly Cognitive Load) (17.4%), Connectivity (formerly Api Exposure) (6.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `input` **(State Mutators)** (Impact: 6.2)
  * `init` **(I/O & Config Routines)** (Impact: 4.5)
  * `frame` **(I/O & Config Routines)** (Impact: 4.5)
  * `main` **(I/O & Config Routines)** (Impact: 1.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 23.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (51.1%), Debt Markers (formerly Tech Debt) (28.1%), Dead Code Surface (formerly Dead Code) (20.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.9%)
- **Documentation Coverage:** 5.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (74.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.5%), Connectivity (formerly Api Exposure) (6.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (57.7%), Complexity Load (formerly Cognitive Load) (10.6%), Connectivity (formerly Api Exposure) (5.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 23.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (54.9%), Test Surface (formerly Verification) (2.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `cStrToZig` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* // helper function to convert a C string to a Zig string slice
  * `since` **(Parameter Forwarders)** (Impact: 1.6)
  * `laptime` **(Parameter Forwarders)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (72.3%), Complexity Load (formerly Cognitive Load) (15.8%), Connectivity (formerly Api Exposure) (6.1%), Dead Code Surface (formerly Dead Code) (2.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (70.2%), Complexity Load (formerly Cognitive Load) (14.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.5%), Connectivity (formerly Api Exposure) (6.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (63.0%), Connectivity (formerly Api Exposure) (6.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 8.528; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.8%), Complexity Load (formerly Cognitive Load) (48.7%), Connectivity (formerly Api Exposure) (7.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `frame` **(I/O & Config Routines)** (Impact: 5.7)
  * `init` **(I/O & Config Routines)** (Impact: 1.5)
  * `main` **(I/O & Config Routines)** (Impact: 1.5)
  * `cleanup` **(State Mutators)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
