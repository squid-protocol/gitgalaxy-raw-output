...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2679 analyzed artifact(s), 573264 LOC.
- **Load-bearing artifact:** `wp-includes/php-ai-client/src/Common/Exception/InvalidArgumentException.php` -- 40 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `wp-includes/blocks/blocks-json.php` -- pulls in 1033 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `wp-includes/js/wplink.js` at magnitude 13482.89 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 2679 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 2488 |
| Total LOC | 573264 |
| Volatility Index | 0.0 |
| % Scanned of codebase = | 51.8% |
| Dominant Lang | PHP |
...
| Assortativity | -0.1965 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.1% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.3858 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 19 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| PHP | 1691 | 339071 | 63.1% |
| CSS | 454 | 91612 | 16.9% |
| JAVASCRIPT | 219 | 119438 | 8.2% |
| JSON | 168 | 22777 | 6.3% |
| HTML | 59 | 350 | 2.2% |
| PLAINTEXT | 52 | 3 | 1.9% |
| XML | 33 | 13 | 1.2% |
...
> **Architectural Drift Z-Score:** `4.619`
> **Composition Archetype:** `Flat Modular Platform` (z +4.62; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 34%, Data / Markup / Trivial 22%, Large Core Modules (3) 12%, Large Core Modules (2) 9%, Large Core Modules 7%
...
| Static: Minified & Vendor Opaque Mass | 12 | 0.4% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 2488*

**Composition by Extension & Reason:**
- `.css`: 543x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 14x Excluded (Machine-Generated Source Code Signature: 801 LOC), 4x Excluded (Saturation: Line 6 exceeds 500 chars)
...
- `.php`: 154x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 4x Excluded (Saturation: Line 36 exceeds 500 chars), 2x Excluded (Saturation: Line 26 exceeds 500 chars)
...
- `.json`: 4x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 2x Excluded (Static Asset Blob without Intent: 1726 LOC), 1x Excluded (Massive Static Asset Blob: 6791 LOC)
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 2.4 | 0.4 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 3.8 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 8.9 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 8076 | 750 | 6 | `wp-includes/class-wp-xmlrpc-server.php` |
| cleanup | 1421 | 380 | 1 | `wp-includes/ID3/module.tag.id3v2.php` |
| guards | 25179 | 1288 | 23 | `wp-includes/js/codemirror/esprima.js` |
| danger | 5457 | 588 | 4 | `wp-includes/ID3/module.tag.id3v2.php` |
| concurrency | 747 | 120 | 0 | `wp-includes/js/tinymce/plugins/paste/plugin.js` |
| connectivity | 8825 | 732 | 10 | `wp-content/themes/twentytwentyone/style-rtl.css` |
| io | 5557 | 620 | 4 | `wp-admin/includes/ajax-actions.php` |
| crypto | 0 | 0 | 0 | - |
| ipc | 117 | 47 | 0 | `wp-admin/includes/misc.php` |
| time | 729 | 190 | 0 | `wp-includes/js/jquery/ui/datepicker.js` |
| serialization | 238 | 121 | 0 | `wp-admin/js/image-edit.js` |
| regex | 2321 | 350 | 1 | `wp-includes/js/codemirror/esprima.js` |
| events | 3894 | 227 | 0 | `wp-includes/js/tinymce/themes/modern/theme.js` |
| tests | 90 | 13 | 0 | `wp-includes/js/codemirror/esprima.js` |
| docs | 26862 | 1966 | 25 | `wp-includes/js/media-views.js` |
| debt | 5859 | 796 | 5 | `wp-admin/includes/meta-boxes.php` |
| mutation | 130736 | 1772 | 105 | `wp-includes/js/tinymce/themes/inlite/theme.js` |
| dead_code | 5686 | 838 | 5 | `wp-includes/deprecated.php` |
| credential | 30 | 20 | 0 | `wp-includes/pluggable.php` |
| threat | 1699 | 275 | 1 | `wp-includes/js/codemirror/esprima.js` |
| ml_ai | 85 | 33 | 0 | `wp-login.php` |
| ui | 3625 | 513 | 2 | `wp-content/themes/twentytwentyone/style-rtl.css` |
...
- `QuicktimeParseAtom` **(Many-Argument Workhorses)** (@ `wp-includes/ID3/module.audio-video.quicktime.php`) -> Impact: **1168.4** | LOC: 1037
...
- `parseEBML` **(Many-Argument Workhorses)** (@ `wp-includes/ID3/module.audio-video.matroska.php`) -> Impact: **563.0** | LOC: 738
...
- `ParseID3v2Frame` **(Many-Argument Workhorses)** (@ `wp-includes/ID3/module.tag.id3v2.php`) -> Impact: **500.7** | LOC: 1161
  * *Intent:* /** * @param array $parsedFrame * * @return bool */
- `get_posts` **(I/O & Config Routines)** (@ `wp-includes/class-wp-query.php`) -> Impact: **470.7** | LOC: 1774
...
- `xmlEncode` **(Many-Argument Workhorses)** (@ `wp-includes/js/plupload/plupload.js`) -> Impact: **367.6** | LOC: 1695
  * *Intent:* /** * Encodes the specified string. * */
...
|---|---|---|---|---|
| `wp-includes` | 250 | 136604.02 | 31.24% | 50.2% |
| `wp-admin/includes` | 104 | 55872.0 | 38.07% | 52.12% |
| `wp-includes/js` | 47 | 33464.61 | 46.26% | 28.0% |
| `wp-admin/js` | 49 | 21842.1 | 37.38% | 18.88% |
| `wp-includes/ID3` | 17 | 20659.38 | 57.72% | 13.91% |
| `wp-includes/rest-api/endpoints` | 45 | 15981.68 | 32.2% | 31.92% |
| `wp-includes/js/codemirror` | 4 | 13334.48 | 55.89% | 6.19% |
| `wp-includes/SimplePie/src` | 22 | 13069.72 | 35.64% | 60.15% |
| `wp-includes/js/jquery/ui` | 36 | 12058.22 | 58.85% | 32.53% |
| `wp-admin` | 92 | 9896.5 | 33.76% | 1.87% |
...
- **Unknown Dependencies:** `12976` packages imported that bypass the Zero-Trust whitelist.
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.5%), Concurrency Surface (formerly Concurrency) (85.6%), Complexity Load (formerly Cognitive Load) (82.7%)
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.6%)
- **Documentation Coverage:** 47.5059% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `init` **(Many-Argument Workhorses)** (Impact: 420.1)
    * *Intent:* // initialization
  * `prototype` **(I/O & Config Routines)** (Impact: 297.2)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.5%), Guard Balance (formerly Safety Score) (86.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `recalc` **(Defensive Guards)** (Impact: 94.9)
  * `recalc` **(Defensive Guards)** (Impact: 67.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.7%), Complexity Load (formerly Cognitive Load) (88.3%), Concurrency Surface (formerly Concurrency) (65.3%)
- **Documentation Coverage:** 99.7118% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.3%), Guard Balance (formerly Safety Score) (85.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `recalc` **(Defensive Guards)** (Impact: 94.9)
  * `recalc` **(Defensive Guards)** (Impact: 67.4)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.3%)
- **Documentation Coverage:** 65.4517% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `XMLHttpRequest` **(I/O & Config Routines)** (Impact: 132.0)
  * `HTML5Image` **(I/O & Config Routines)** (Impact: 98.4)
  * `XMLHttpRequest` **(Defensive Guards)** (Impact: 93.0)
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 5478.56 | **LOC:** 9285 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 36.4%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **121**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Debt Markers (formerly Tech Debt) (85.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 51.5982% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *State Mutation (weighted view):* 2902
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1112`, `structural_boundaries: 672`, `args: 252`, `func_start: 214`, `class_start: 12`
* *Risk/State:* `safety_bypasses: 22`, `high_risk_execution: 12`, `state_mutation: 1042`, `dead_code: 4`, `planned_debt: 4`, `fragile_debt: 4`, `unreferenced_by_name: 113`
* *Architecture:* `io: 30`, `concurrency: 5`, `import: 11`
* *Defense:* `safety: 147`, `doc: 295`, `cleanup: 10`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4859.82 | **LOC:** 9390 | **CtrlFlow:** 18.9% | **Authorship Centralization:** 100.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (41.0%)
- **Documentation Coverage:** 29.4479% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `save` **(Many-Argument Workhorses)** (Impact: 88.1)
    * *Intent:* * Updates to the changeset are transactional. If any of the settings * are invalid then none of them...
  * `initialize` **(Many-Argument Workhorses)** (Impact: 65.5)
    * *Intent:* */
  * `submit` **(I/O & Config Routines)** (Impact: 58.0)
  * `initStickyHeaders` **(I/O & Config Routines)** (Impact: 51.2)
    * *Intent:* /* * Sticky header feature. */
  * `requestChangesetUpdate` **(Many-Argument Workhorses)** (Impact: 44.1)
    * *Intent:* * * * If not provided, then the changes will still be obtained from unsaved dirty settings. */...
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4817.1 | **LOC:** 8705 | **CtrlFlow:** 22.1% | **Authorship Centralization:** 40.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **225**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (45.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_pages` **(Many-Argument Workhorses)** (Impact: 51.3)
...
* *Amplified Cascading Flux:* 822 instances
* *Memory Alloc (weighted view):* 15
* *State Mutation (weighted view):* 2568
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 885`, `structural_boundaries: 563`, `args: 148`, `func_start: 145`
* *Risk/State:* `safety_bypasses: 6`, `state_mutation: 924`, `dead_code: 1`, `planned_debt: 1`
* *Architecture:* `io: 1`, `api: 70`, `import: 10`
* *Defense:* `safety: 156`, `doc: 259`, `cleanup: 8`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4719.2 | **LOC:** 7229 | **CtrlFlow:** 23.4% | **Authorship Centralization:** 83.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **116**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (36.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mw_newPost` **(Many-Argument Workhorses)** (Impact: 173.3)
    * *Intent:* * * @since 1.5.0 * * @param array $args { * Method arguments. Note: arguments must be ordered as doc...
  * `mw_editPost` **(Many-Argument Workhorses)** (Impact: 166.8)
    * *Intent:* * * @since 1.5.0 * * @param array $args { * Method arguments. Note: arguments must be ordered as doc...
  ...
  * `pingback_ping` **(Many-Argument Workhorses)** (Impact: 63.1)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 910`, `structural_boundaries: 790`, `args: 107`, `func_start: 106`, `class_start: 1`
...
- **Magnitude:** 4493.1 | **LOC:** 6450 | **CtrlFlow:** 27.6% | **Authorship Centralization:** 47.1%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **133**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (45.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `wp_get_loading_optimization_attributes` **(Many-Argument Workhorses)** (Impact: 94.3)
    * *Intent:* * * If any of these attributes are already present in the given attributes, they will not be modifie...
  * `wp_prepare_attachment_for_js` **(Many-Argument Workhorses)** (Impact: 86.2)
...
* *State Mutation (weighted view):* 2582
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 850`, `structural_boundaries: 389`, `args: 98`, `func_start: 94`, `class_start: 2`
* *Risk/State:* `safety_bypasses: 5`, `high_risk_execution: 1`, `state_mutation: 912`, `dead_code: 1`, `planned_debt: 2`, `fragile_debt: 3`
* *Architecture:* `io: 2`, `api: 32`, `import: 16`
* *Defense:* `safety: 172`, `doc: 180`, `cleanup: 15`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4142.36 | **LOC:** 6297 | **CtrlFlow:** 24.5% | **Authorship Centralization:** 47.1%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **93**; blast radius 0.337; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (75.3%)
- **Documentation Coverage:** 22.314% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *State Mutation (weighted view):* 2469
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 748`, `structural_boundaries: 341`, `args: 128`, `func_start: 120`
* *Risk/State:* `safety_bypasses: 3`, `high_risk_execution: 1`, `state_mutation: 897`, `dead_code: 4`, `planned_debt: 2`, `fragile_debt: 4`, `unreferenced_by_name: 66`
* *Architecture:* `io: 5`
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4066.84 | **LOC:** 3213 | **CtrlFlow:** 34.7% | **Authorship Centralization:** 66.7%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.337; role: Isolated/Orphan
...
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `QuicktimeParseAtom` **(Many-Argument Workhorses)** (Impact: 1168.4)
    * *Intent:* /** * @param string $atomname * @param int $atomsize * @param string $atom_data * @param int $baseof...
  * `Analyze` **(I/O & Config Routines)** (Impact: 108.7)
    * *Intent:* /** * @return bool */
...
* *Amplified Cascading Flux:* 626 instances
* *Memory Alloc (weighted view):* 3
* *State Mutation (weighted view):* 2504
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 870`, `structural_boundaries: 93`, `args: 25`, `func_start: 24`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 85`, `high_risk_execution: 1`, `state_mutation: 1252`, `dead_code: 45`, `planned_debt: 1`, `fragile_debt: 6`, `unreferenced_by_name: 2`
* *Architecture:* `io: 5`, `api: 26`
* *Defense:* `safety: 89`, `doc: 27`, `cleanup: 15`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 3993.06 | **LOC:** 5114 | **CtrlFlow:** 31.9% | **Authorship Centralization:** 33.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 0.337; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_posts` **(I/O & Config Routines)** (Impact: 470.7)
    * *Intent:* /** * Retrieves an array of posts based on query variables. * * There are a few filters and actions ...
  * `parse_query` **(Many-Argument Workhorses)** (Impact: 238.3)
    * *Intent:* * @type array $tax_query An associative array of WP_Tax_Query arguments. * See WP_Tax_Query::__const...
  * `parse_tax_query` **(Many-Argument Workhorses)** (Impact: 78.8)
  ...
  * `parse_search` **(Many-Argument Workhorses)** (Impact: 40.9)
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 847`, `structural_boundaries: 235`, `args: 71`, `func_start: 68`, `class_start: 1`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **50**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.8%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (46.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 3801.66 | **LOC:** 10605 | **CtrlFlow:** 12.9% | **Authorship Centralization:** 66.7%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.9%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (31.2%)
- **Documentation Coverage:** 38.4462% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Amplified Cascading Flux:* 482 instances
* *Concurrency (weighted view):* 16
* *State Mutation (weighted view):* 1826
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 763`, `structural_boundaries: 548`, `args: 515`, `func_start: 433`
...
* *Defense:* `safety: 144`, `doc: 592`, `cleanup: 26`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` None
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 3703.44 | **LOC:** 5438 | **CtrlFlow:** 28.4% | **Authorship Centralization:** 50.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **141**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `wp_get_code_editor_settings` **(Many-Argument Workhorses)** (Impact: 134.8)
    * *Intent:* * * @param array $args { * Args. * * @type string $type The MIME type of the file to be edited. * @t...
  * `get_bloginfo` **(Many-Argument Workhorses)** (Impact: 109.1)
    * *Intent:* * These options will trigger the _deprecated_argument() function. * * Deprecated arguments include: ...
  * `get_calendar` **(Many-Argument Workhorses)** (Impact: 82.1)
  ...
  * `paginate_links` **(Compute Cores)** (Impact: 79.0)
    * *Intent:* * Default 1. * @type int $mid_size How many numbers to either side of the current pages. Default 2. ...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 723 instances
* *State Mutation (weighted view):* 2242
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 732`, `structural_boundaries: 271`, `args: 97`, `func_start: 94`
* *Risk/State:* `high_risk_execution: 4`, `state_mutation: 796`, `unreferenced_by_name: 49`
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 3700.98 | **LOC:** 4905 | **CtrlFlow:** 29.0% | **Authorship Centralization:** 33.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **64**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (53.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 579`, `structural_boundaries: 290`, `args: 117`, `func_start: 117`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **77**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Debt Markers (formerly Tech Debt) (82.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `wp_ajax_replyto_comment` **(I/O & Config Routines)** (Impact: 51.5)
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 3439.86 | **LOC:** 4835 | **CtrlFlow:** 26.3% | **Authorship Centralization:** 22.7%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **51**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (47.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_styles_for_block` **(Many-Argument Workhorses)** (Impact: 85.9)
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 3274.64 | **LOC:** 6163 | **CtrlFlow:** 23.1% | **Authorship Centralization:** 66.7%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **115**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (48.1%)
- **Documentation Coverage:** 0.4405% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `import_theme_starter_content` **(Defensive Guards)** (Impact: 218.8)
    * *Intent:* /** * Imports theme starter content into the customized state. * * @since 4.7.0 * * @param array $st...
  * `save_changeset_post` **(Many-Argument Workhorses)** (Impact: 124.5)
...
- **Magnitude:** 3269.78 | **LOC:** 6536 | **CtrlFlow:** 19.4% | **Authorship Centralization:** 33.3%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **76**; blast radius 0.337; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 0.4115% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_wp_theme_json_webfonts_handler` **(I/O & Config Routines)** (Impact: 88.7)
...
* *Defense:* `safety: 79`, `doc: 276`, `immutability_locks: 14`, `cleanup: 4`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.337
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` "__return_true" )', h2>\n\t<ul>\n", $context, $crop = false, $dest_path = null, $fullsize = false, $image, $include_unapproved = false ) 
...
- `wp-admin/js/customize-controls.js` -> **joedolson** (100.0% isolated ownership) | Magnitude: 4859.82
- `wp-includes/class-wp-xmlrpc-server.php` -> **Weston Ruter** (83.3% isolated ownership) | Magnitude: 4719.2
...
- `wp-includes/php-ai-client/src/Providers/DTO/ProviderMetadata.php` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.4802%)
- `wp-includes/php-ai-client/src/Results/DTO/GenerativeAiResult.php` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.9999%)
- `wp-includes/php-ai-client/src/Builders/PromptBuilder.php` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.9997%)
...
- `wp-includes/php-ai-client/src/Common/AbstractEnum.php` -> **Severity: 0.989** (Embedded: 0.0118 * Error Risk: 84.1026%)
- `wp-includes/php-ai-client/src/Common/AbstractDataTransferObject.php` -> **Severity: 0.634** (Embedded: 0.0142 * Error Risk: 44.6276%)
- `wp-includes/php-ai-client/src/Messages/DTO/Message.php` -> **Severity: 0.576** (Embedded: 0.0076 * Error Risk: 75.5335%)
- `wp-includes/php-ai-client/src/Results/DTO/GenerativeAiResult.php` -> **Severity: 0.495** (Embedded: 0.0056 * Error Risk: 87.7636%)
- `wp-includes/php-ai-client/src/Providers/Models/DTO/ModelMetadata.php` -> **Severity: 0.475** (Embedded: 0.0072 * Error Risk: 66.0499%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `wp-includes/js/jquery/ui/tabs.js` -> **Severity: 62.4** (Blast Radius: 0.624 * Doc Risk: 100.0%)
- `wp-includes/js/underscore.js` -> **Severity: 62.4** (Blast Radius: 0.624 * Doc Risk: 100.0%)
- `wp-includes/Requests/src/Hooks.php` -> **Severity: 42.733** (Blast Radius: 1.282 * Doc Risk: 33.3333%)
- `wp-admin/admin-header.php` -> **Severity: 33.7** (Blast Radius: 0.337 * Doc Risk: 100.0%)
- `wp-admin/includes/class-ftp.php` -> **Severity: 33.7** (Blast Radius: 0.337 * Doc Risk: 100.0%)
