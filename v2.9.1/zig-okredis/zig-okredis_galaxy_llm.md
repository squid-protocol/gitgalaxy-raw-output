...
## 1. EXECUTIVE SUMMARY
- **Scope:** 96 analyzed artifact(s), 6476 LOC.
- **Load-bearing artifact:** `src/serializer.zig` -- 36 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/commands/strings.zig` -- pulls in 22 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/parser/t_map.zig` at magnitude 379.48 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.666`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.67; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 27%, Generic / Templated Code Files 16%, Large Core Modules (2) 15%, Large Core Modules (3) 15%, Data / Markup / Trivial 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 57.0 | 64.3 | 100.0 |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 7.611; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (85.6%), Guard Balance (formerly Safety Score) (75.8%), Connectivity (formerly Api Exposure) (38.6%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 6.262; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (99.7%), Complexity Load (formerly Cognitive Load) (58.4%), Connectivity (formerly Api Exposure) (47.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `transactionImpl` **(Generic / Templated Code)** (Impact: 7.6)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **14**; blast radius 30.008; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (45.4%), Mutation Surface (formerly State Flux) (37.1%), Complexity Load (formerly Cognitive Load) (29.5%), Dead Code Surface (formerly Dead Code) (23.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `ifSupported` **(Generic / Templated Code)** (Impact: 16.6)
  * `parseAllocFromTag` **(Generic / Templated Code)** (Impact: 2.6)
  * `parseAlloc` **(Generic / Templated Code)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 10.846; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Complexity Load (formerly Cognitive Load) (60.2%), Guard Balance (formerly Safety Score) (50.5%), Connectivity (formerly Api Exposure) (45.2%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 8.324; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (64.9%), Mutation Surface (formerly State Flux) (22.5%), Guard Balance (formerly Safety Score) (20.2%), Debt Markers (formerly Tech Debt) (9.7%)
...
- **Blast Radius:** changing it is visible to **36** in-repo importer(s); it depends on **2**; blast radius 167.938; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (69.4%), Connectivity (formerly Api Exposure) (45.0%), Debt Markers (formerly Tech Debt) (40.1%), Mutation Surface (formerly State Flux) (36.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 7.611; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.7%), Guard Balance (formerly Safety Score) (50.9%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 6.933; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (57.3%), Guard Balance (formerly Safety Score) (30.8%), Mutation Surface (formerly State Flux) (20.4%), Debt Markers (formerly Tech Debt) (12.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `validate` **(Compute Cores)** (Impact: 4.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.933; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (61.5%), Guard Balance (formerly Safety Score) (33.4%), Debt Markers (formerly Tech Debt) (22.0%), Mutation Surface (formerly State Flux) (21.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `validate` **(Parameter Forwarders)** (Impact: 3.0)
    * *Intent:* /// Validates if the command is syntactically correct.
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.611; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Connectivity (formerly Api Exposure) (38.0%), Debt Markers (formerly Tech Debt) (13.6%), Guard Balance (formerly Safety Score) (8.9%)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **1**; blast radius 17.0; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.7%), Connectivity (formerly Api Exposure) (62.7%), Guard Balance (formerly Safety Score) (39.1%), Complexity Load (formerly Cognitive Load) (10.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `toSlice` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.933; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (59.6%), Guard Balance (formerly Safety Score) (31.8%), Mutation Surface (formerly State Flux) (14.6%), Complexity Load (formerly Cognitive Load) (6.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `count` **(Compute Cores)** (Impact: 4.5)
  * `count` **(Parameter Forwarders)** (Impact: 3.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.933; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (59.4%), Guard Balance (formerly Safety Score) (38.5%), Mutation Surface (formerly State Flux) (26.5%), Debt Markers (formerly Tech Debt) (19.4%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 5.761; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (56.7%), Mutation Surface (formerly State Flux) (35.9%), Guard Balance (formerly Safety Score) (29.0%), Complexity Load (formerly Cognitive Load) (4.0%)
- **Documentation Coverage:** 71.4286% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.611; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (62.9%), Connectivity (formerly Api Exposure) (44.8%), Debt Markers (formerly Tech Debt) (41.0%), Guard Balance (formerly Safety Score) (27.8%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **3**; blast radius 14.389; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Connectivity (formerly Api Exposure) (52.1%), Mutation Surface (formerly State Flux) (40.5%), Guard Balance (formerly Safety Score) (11.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `destroy` **(Defensive Guards)** (Impact: 9.3)
  * `parseAlloc` **(Generic / Templated Code)** (Impact: 2.5)
  * `parse` **(Generic / Templated Code)** (Impact: 2.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 12.666; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (48.3%), Mutation Surface (formerly State Flux) (47.0%), Guard Balance (formerly Safety Score) (28.3%), Debt Markers (formerly Tech Debt) (11.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parseAlloc` **(Many-Argument Workhorses)** (Impact: 14.1)
  * `destroy` **(Generic / Templated Code)** (Impact: 2.4)
  * `parse` **(Generic / Templated Code)** (Impact: 2.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 6.55; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (89.0%), Connectivity (formerly Api Exposure) (48.3%), Guard Balance (formerly Safety Score) (18.0%), Complexity Load (formerly Cognitive Load) (8.4%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 5.847; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (59.8%), Guard Balance (formerly Safety Score) (31.5%), Mutation Surface (formerly State Flux) (25.2%), Debt Markers (formerly Tech Debt) (13.2%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 6.45; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (55.2%), Complexity Load (formerly Cognitive Load) (6.7%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 6.45; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (55.6%), Complexity Load (formerly Cognitive Load) (6.8%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `serialize` **(Defensive Guards)** (Impact: 13.2)
  * `count` **(Defensive Guards)** (Impact: 7.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 7.611; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (73.1%), Connectivity (formerly Api Exposure) (28.5%), Guard Balance (formerly Safety Score) (27.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 5.485; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (74.3%), Mutation Surface (formerly State Flux) (33.0%), Complexity Load (formerly Cognitive Load) (17.7%), Guard Balance (formerly Safety Score) (5.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 5.761; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (57.2%), Guard Balance (formerly Safety Score) (34.0%), Mutation Surface (formerly State Flux) (20.6%), Complexity Load (formerly Cognitive Load) (5.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 5.485; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (73.4%), Complexity Load (formerly Cognitive Load) (29.1%), Debt Markers (formerly Tech Debt) (29.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Defensive Guards)** (Impact: 4.5)
  * `toDigit` **(Parameter Forwarders)** (Impact: 3.0)
