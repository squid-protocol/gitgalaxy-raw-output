...
- **Heaviest artifact:** `Getting Started with COBOL.cobol` at magnitude 10.52 (structural weight, not risk).
...
### `Getting Started with COBOL.cobol` (COBOL | Tier 2 | AI Safe: 0.0%)
