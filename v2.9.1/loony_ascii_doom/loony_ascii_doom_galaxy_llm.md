...
## 1. EXECUTIVE SUMMARY
- **Scope:** 181 analyzed artifact(s), 35379 LOC.
- **Load-bearing artifact:** `src/doomtype.h` -- 49 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/d_main.c` -- pulls in 42 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/g_game.c` at magnitude 1855.24 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.326`
> **Composition Archetype:** `Small Flat Repo (2)` (z +3.33; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 47%, Large Core Modules (3) 13%, Data / Markup / Trivial 10%, Compute Cores Files 9%, Large Core Modules 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 42.6 | 0.0 | 0.0 |
...
- `P_TouchSpecialThing` **(Many-Argument Workhorses)** (@ `src/p_inter.c`) -> Impact: **180.9** | LOC: 328
...
- `D_DoomMain` **(I/O & Config Routines)** (@ `src/d_main.c`) -> Impact: **100.0** | LOC: 680
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 2.491; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.7%), Complexity Load (formerly Cognitive Load) (35.6%), Connectivity (formerly Api Exposure) (7.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_FindNextHighestFloor` **(Many-Argument Workhorses)** (Impact: 20.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 2.491; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Dead Code Surface (formerly Dead Code) (97.0%), Complexity Load (formerly Cognitive Load) (83.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 2.491; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `D_DoomMain` **(I/O & Config Routines)** (Impact: 100.0)
    * *Intent:* #endif // // D_DoomMain //
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.491; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.491; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `EV_VerticalDoor` **(Many-Argument Workhorses)** (Impact: 92.0)
  ...
  * `EV_DoDoor` **(Many-Argument Workhorses)** (Impact: 28.2)
  * `P_SpawnDoorRaiseIn5Mins` **(Compute Cores)** (Impact: 2.9)
