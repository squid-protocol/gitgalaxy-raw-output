...
## 1. EXECUTIVE SUMMARY
- **Scope:** 6 analyzed artifact(s), 4 LOC.
...
- **Top orchestrator:** `package/UI/UI.d.ts` -- pulls in 1 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/README.md` at magnitude 3.06 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 4.3 | 2.2 | 2.2 | 0.0 |
...
|---|---|---|---|---|
| memory | 1 | 1 | 0 | `package/sidecar/sidecar.d.ts` |
| cleanup | 0 | 0 | 0 | - |
| guards | 0 | 0 | 0 | - |
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 2 | 2 | 1 | `package/UI/UI.d.ts` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| `package/sidecar` | 2 | 1.63 | 2.17% | 0.0% |
| `package/UI` | 2 | 1.58 | 0.0% | 0.0% |
...
### `package/sidecar/sidecar.d.ts` (TYPESCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 0.63 | **LOC:** 6 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 0.0%
...
### `package/UI/UI.d.ts` (TYPESCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 0.58 | **LOC:** 1 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 166.667; role: Isolated/Orphan
