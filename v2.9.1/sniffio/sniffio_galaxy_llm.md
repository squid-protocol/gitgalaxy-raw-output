...
## 1. EXECUTIVE SUMMARY
- **Scope:** 10 analyzed artifact(s), 148 LOC.
- **Load-bearing artifact:** `sniffio-1.3.1/sniffio/_impl.py` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `sniffio-1.3.1/sniffio/_impl.py` -- pulls in 8 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `sniffio-1.3.1/sniffio/_impl.py` at magnitude 73.34 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 60%, Declarative / Non-Code 20%, Large Core Modules 10%, Large Core Modules (2) 10%
...
- `test_asyncio` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **2.0** | LOC: 19
- `test_curio` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **2.0** | LOC: 19
- `test_basics_cvar` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.6** | LOC: 12
- `test_basics_tlocal` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.6** | LOC: 12
- `this_is_asyncio` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.2** | LOC: 5
- `this_is_curio` **(Defensive Guards)** (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.2** | LOC: 5
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **8**; blast radius 131.337; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.8%), Complexity Load (formerly Cognitive Load) (80.0%)
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (99.5%), Mutation Surface (formerly State Flux) (85.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_asyncio` **(Defensive Guards)** (Impact: 2.0)
  * `test_curio` **(Defensive Guards)** (Impact: 2.0)
  * `test_basics_cvar` **(Defensive Guards)** (Impact: 1.6)
  * `test_basics_tlocal` **(Defensive Guards)** (Impact: 1.6)
  * `this_is_asyncio` **(Defensive Guards)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (68.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (17.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 131.337; role: Pure Producer (Foundation)
