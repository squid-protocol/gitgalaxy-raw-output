...
## 1. EXECUTIVE SUMMARY
- **Scope:** 8 analyzed artifact(s), 176 LOC.
- **Load-bearing artifact:** `package/src/config.js` -- 3 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/src/server.js` -- pulls in 6 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/server.js` at magnitude 37.92 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 50%, Large Core Modules (2) 12%, Many-Argument Workhorses Files 12%, Parameter Forwarders Files 12%, State Mutators Files 12%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 58.3 | 75.0 | 100.0 |
...
- `constructor` **(Compute Cores)** (@ `package/src/server.js`) -> Impact: **3.7** | LOC: 18
- `respond` **(Compute Cores)** (@ `package/types.d.ts`) -> Impact: **3.5** | LOC: 1
- `getRecording` **(Parameter Forwarders)** (@ `package/src/api.js`) -> Impact: **3.3** | LOC: 9
- `deleteRecording` **(Parameter Forwarders)** (@ `package/src/api.js`) -> Impact: **3.3** | LOC: 9
- `prependSlash` **(Parameter Forwarders)** (@ `package/src/express/register-api.js`) -> Impact: **3.2** | LOC: 7
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 106.835; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.6%), Complexity Load (formerly Cognitive Load) (53.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `listen` **(Defensive Guards)** (Impact: 15.3)
  * `constructor` **(Compute Cores)** (Impact: 3.7)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 171.537; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (54.5%), Guard Balance (formerly Safety Score) (52.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getRecording` **(Parameter Forwarders)** (Impact: 3.3)
  * `deleteRecording` **(Parameter Forwarders)** (Impact: 3.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 88.111; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (8.2%), Complexity Load (formerly Cognitive Load) (6.4%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 152.24; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `registerAPI` **(Many-Argument Workhorses)** (Impact: 7.3)
  * `prependSlash` **(Parameter Forwarders)** (Impact: 3.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 216.942; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (3.6%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 88.111; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (60.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (10.6%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `listen` **(Compute Cores)** (Impact: 5.2)
  * `respond` **(Compute Cores)** (Impact: 3.5)
