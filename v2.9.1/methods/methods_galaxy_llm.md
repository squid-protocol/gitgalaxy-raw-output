...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 38 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 11.06 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 4.3 | 4.3 | 4.3 | 4.3 | 4.3 |
| Guard Balance (formerly Error & Exception Exposure) | 66.9 | 66.9 | 66.9 | 66.9 | 66.9 |
| Debt Markers (formerly Tech Debt Exposure) | 73.1 | 73.1 | 73.1 | 73.1 | 73.1 |
| Test Surface (formerly Testing Exposure) | 2.4 | 2.4 | 2.4 | 2.4 | 2.4 |
| Connectivity (formerly API Exposure) | 3.3 | 3.3 | 3.3 | 3.3 | 3.3 |
...
| guards | 0 | 0 | 0 | - |
| danger | 0 | 0 | 0 | - |
| concurrency | 1 | 1 | 1 | `package/index.js` |
| connectivity | 1 | 1 | 1 | `package/index.js` |
| io | 1 | 1 | 1 | `package/index.js` |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
| regex | 0 | 0 | 0 | - |
| events | 1 | 1 | 1 | `package/index.js` |
| tests | 0 | 0 | 0 | - |
| docs | 4 | 1 | 4 | `package/index.js` |
| debt | 0 | 0 | 0 | - |
| mutation | 2 | 1 | 2 | `package/index.js` |
...
3. **HISTORY.md** (`package/HISTORY.md`) — 0 outbound dependencies
4. **package.json** (`package/package.json`) — 0 outbound dependencies

## 8. CORE FUNCTION HITLIST (Heaviest Functions)
> *Note: The 'Impact' metric below represents Structural Magnitude (complexity, arguments, and length), NOT operational risk. These are the load-bearing pillars of the logic.*

- `getBasicNodeMethods` **(I/O & Config Routines)** (@ `package/index.js`) -> Impact: **2.5** | LOC: 30
  * *Intent:* /** * Get the "basic" Node.js methods, a snapshot from Node.js 0.10. */
- `getCurrentNodeMethods` **(Interface Declarations)** (@ `package/index.js`) -> Impact: **2.2** | LOC: 5
  * *Intent:* /** * Get the current Node.js methods. */
- `lowerCaseMethod` **(Parameter Forwarders)** (@ `package/index.js`) -> Impact: **1.6** | LOC: 3
...
- **Magnitude:** 11.06 | **LOC:** 70 | **CtrlFlow:** 5.3% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (66.9%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getBasicNodeMethods` **(I/O & Config Routines)** (Impact: 2.5)
    * *Intent:* /** * Get the "basic" Node.js methods, a snapshot from Node.js 0.10. */
  * `getCurrentNodeMethods` **(Interface Declarations)** (Impact: 2.2)
    * *Intent:* /** * Get the current Node.js methods. */
  * `lowerCaseMethod` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 2`, `structural_boundaries: 5`, `args: 3`, `func_start: 3`
