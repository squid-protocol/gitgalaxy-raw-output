...
## 1. EXECUTIVE SUMMARY
- **Scope:** 880 analyzed artifact(s), 268917 LOC.
- **Load-bearing artifact:** `benches/src/iter.rs` -- 14 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `wgpu/src/lib.rs` -- pulls in 140 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `naga/src/back/msl/writer.rs` at magnitude 5464.92 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.975`
> **Composition Archetype:** `Mid Flat Project` (z +1.98; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 20%, Large Core Modules (3) 19%, Generic / Templated Code Files 15%, State Mutators Files 15%, Data / Markup / Trivial 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 53.7 | 52.3 | 100.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (74.2%), Guard Balance (formerly Safety Score) (55.6%), Connectivity (formerly Api Exposure) (26.4%)
- **Documentation Coverage:** 61.6822% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **44**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.2%), Guard Balance (formerly Safety Score) (54.9%), Connectivity (formerly Api Exposure) (33.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (86.5%), Mutation Surface (formerly State Flux) (81.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **117**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (53.8%), Connectivity (formerly Api Exposure) (44.3%)
- **Documentation Coverage:** 76.5766% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **58**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (88.0%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (65.9%), Guard Balance (formerly Safety Score) (64.6%)
- **Documentation Coverage:** 74.6032% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **103**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.7%), Guard Balance (formerly Safety Score) (54.1%), Mutation Surface (formerly State Flux) (39.6%)
- **Documentation Coverage:** 93.8931% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (72.8%), Guard Balance (formerly Safety Score) (55.9%), Mutation Surface (formerly State Flux) (44.1%)
- **Documentation Coverage:** 64.8649% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (53.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.6%), Mutation Surface (formerly State Flux) (45.0%), Complexity Load (formerly Cognitive Load) (14.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.3%), Guard Balance (formerly Safety Score) (62.2%), Mutation Surface (formerly State Flux) (36.3%)
- **Documentation Coverage:** 64.0351% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (93.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (68.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (94.7%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (73.9%), Guard Balance (formerly Safety Score) (73.6%)
- **Documentation Coverage:** 75.4717% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.3%), Mutation Surface (formerly State Flux) (70.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (50.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.4%), Complexity Load (formerly Cognitive Load) (15.3%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **55**; blast radius 3.787; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (83.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (68.2%), Guard Balance (formerly Safety Score) (44.3%)
- **Documentation Coverage:** 97.205% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (77.0%), Guard Balance (formerly Safety Score) (62.7%)
- **Documentation Coverage:** 91.8519% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **56**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.4%), Guard Balance (formerly Safety Score) (62.9%)
- **Documentation Coverage:** 95.7983% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `begin_render_pass` **(Many-Argument Workhorses)** (Impact: 29.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (87.3%), Guard Balance (formerly Safety Score) (51.4%), Dead Code Surface (formerly Dead Code) (5.2%), Complexity Load (formerly Cognitive Load) (3.3%)
- **Documentation Coverage:** 92.6829% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bad_for_initializer` **(I/O & Config Routines)** (Impact: 189.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (75.7%), Mutation Surface (formerly State Flux) (74.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (68.1%)
- **Documentation Coverage:** 99.0291% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (17.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.9%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `merger` **(Parameter Forwarders)** (Impact: 4.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 1.067; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (82.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (43.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (80.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (63.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `write_candidate_intersection_function` **(Many-Argument Workhorses)** (Impact: 79.5)
  * `write_committed_intersection_function` **(Many-Argument Workhorses)** (Impact: 73.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (67.5%), Mutation Surface (formerly State Flux) (60.4%), Guard Balance (formerly Safety Score) (55.6%)
- **Documentation Coverage:** 54.902% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 1.067; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (52.7%), Mutation Surface (formerly State Flux) (39.7%), Connectivity (formerly Api Exposure) (30.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
