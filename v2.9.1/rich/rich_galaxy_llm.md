...
## 1. EXECUTIVE SUMMARY
- **Scope:** 404 analyzed artifact(s), 25601 LOC.
- **Load-bearing artifact:** `rich/console.py` -- 110 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `rich/console.py` -- pulls in 53 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `rich/console.py` at magnitude 2260.42 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.452`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.45; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 58%, Generic / Templated Code Files 14%, Large Core Modules (2) 9%, Declarative / Non-Code 7%, Many-Argument Workhorses Files 3%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 27.6 | 0.0 | 0.0 |
...
- `__init__` **(Stateful Encapsulated Methods)** (@ `rich/style.py`) -> Impact: **247.8** | LOC: 75
...
- **Blast Radius:** changing it is visible to **110** in-repo importer(s); it depends on **53**; blast radius 104.524; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (74.5%)
...
- **Blast Radius:** changing it is visible to **55** in-repo importer(s); it depends on **22**; blast radius 44.176; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Connectivity (formerly Api Exposure) (88.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **31**; blast radius 5.052; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (78.5%)
...
- **Blast Radius:** changing it is visible to **19** in-repo importer(s); it depends on **18**; blast radius 9.329; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.9%)
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **25**; blast radius 7.265; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** changing it is visible to **45** in-repo importer(s); it depends on **10**; blast radius 36.76; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (66.1%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **25**; blast radius 6.401; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **27**; blast radius 6.696; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (42.4%)
...
- **Blast Radius:** changing it is visible to **30** in-repo importer(s); it depends on **13**; blast radius 26.14; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.6%), Connectivity (formerly Api Exposure) (81.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 49.0196% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **22**; blast radius 2.083; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (72.7%)
- **Documentation Coverage:** 76.1364% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_flatten_tokens` **(Stateful Encapsulated Methods)** (Impact: 10.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 1.087; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (36.2%), Complexity Load (formerly Cognitive Load) (32.7%), Connectivity (formerly Api Exposure) (13.2%)
- **Documentation Coverage:** 94.6188% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_tty_compatible` **(Defensive Guards)** (Impact: 4.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.087; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (33.5%), Complexity Load (formerly Cognitive Load) (20.0%), Connectivity (formerly Api Exposure) (12.9%), Guard Balance (formerly Safety Score) (7.4%)
- **Documentation Coverage:** 86.9565% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_highlight_regex` **(Defensive Guards)** (Impact: 4.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.087; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (49.1%), Complexity Load (formerly Cognitive Load) (30.3%), Connectivity (formerly Api Exposure) (12.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (6.5%)
- **Documentation Coverage:** 88.7218% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_attrs_broken_310` **(Annotated & Test Methods)** (Impact: 3.7)
  * `test_pretty_namedtuple` **(I/O & Config Routines)** (Impact: 2.2)
  * `test_reference_cycle_custom_repr` **(Defensive Guards)** (Impact: 2.2)
  * `test_deque` **(Defensive Guards)** (Impact: 2.2)
  * `test_ipy_display_hook__special_repr_raises_exception` **(Encapsulated Accessors)** (Impact: 2.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **19**; blast radius 1.387; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (57.3%)
- **Documentation Coverage:** 47.0588% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__rich_console__` **(Stateful Encapsulated Methods)** (Impact: 15.1)
  ...
  * `_make_region_map` **(Stateful Encapsulated Methods)** (Impact: 11.0)
...
- **Blast Radius:** changing it is visible to **14** in-repo importer(s); it depends on **14**; blast radius 27.618; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.0%), Connectivity (formerly Api Exposure) (72.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `parse` **(Type Conversions)** (Impact: 30.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.087; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.2%), Complexity Load (formerly Cognitive Load) (32.4%), Connectivity (formerly Api Exposure) (11.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.2%)
- **Documentation Coverage:** 97.7011% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_columns` **(I/O & Config Routines)** (Impact: 4.2)
  * `test_using_default_columns` **(Defensive Guards)** (Impact: 4.2)
...
- **Blast Radius:** changing it is visible to **15** in-repo importer(s); it depends on **12**; blast radius 11.0; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__rich_console__` **(Many-Argument Workhorses)** (Impact: 70.5)
  * `__init__` **(Many-Argument Workhorses)** (Impact: 25.3)
  * `generate_segments` **(I/O & Config Routines)** (Impact: 17.9)
  * `__rich_console__` **(Compute Cores)** (Impact: 17.3)
...
- **Blast Radius:** changing it is visible to **11** in-repo importer(s); it depends on **26**; blast radius 6.199; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (45.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `stop` **(Stateful Encapsulated Methods)** (Impact: 24.5)
    * *Intent:* """Stop live rendering display."""
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 19.3)
  * `refresh` **(Defensive Guards)** (Impact: 17.2)
    * *Intent:* """Update the display of the Live Render."""
  * `start` **(Stateful Encapsulated Methods)** (Impact: 12.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 1.78; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Concurrency Surface (formerly Concurrency) (55.3%), Complexity Load (formerly Cognitive Load) (49.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `_get_signature` **(Stateful Encapsulated Methods)** (Impact: 18.1)
    * *Intent:* """Get a signature for a callable."""
  * `_make_title` **(Stateful Encapsulated Methods)** (Impact: 9.1)
    * *Intent:* """Make a default title."""
  * `_get_formatted_doc` **(Stateful Encapsulated Methods)** (Impact: 6.2)
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **5**; blast radius 16.562; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 31.25% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `split_graphemes` **(Many-Argument Workhorses)** (Impact: 29.6)
  * `_cell_len` **(Stateful Encapsulated Methods)** (Impact: 21.4)
    * *Intent:* """Get the cell length of a string (length as it appears in the terminal). Args: text: String to mea...
  * `_split_text` **(Stateful Encapsulated Methods)** (Impact: 20.1)
  ...
  * `chop_cells` **(Generic / Templated Code)** (Impact: 13.3)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **7**; blast radius 9.392; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.7%), Connectivity (formerly Api Exposure) (48.7%), Complexity Load (formerly Cognitive Load) (41.4%)
- **Documentation Coverage:** 28.0702% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `GetConsoleMode` **(Type Conversions)** (Impact: 3.8)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **13**; blast radius 1.717; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (52.4%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 1.631; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.8%)
- **Documentation Coverage:** 71.4286% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__rich_console__` **(Many-Argument Workhorses)** (Impact: 56.1)
  * `_get_pulse_segments` **(Many-Argument Workhorses)** (Impact: 34.0)
  * `_render_pulse` **(Stateful Encapsulated Methods)** (Impact: 8.2)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **13**; blast radius 3.536; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (64.0%)
...
- **Blast Radius:** changing it is visible to **26** in-repo importer(s); it depends on **11**; blast radius 10.536; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (61.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_title` **(Stateful Encapsulated Methods)** (Impact: 6.4)
  * `_subtitle` **(Stateful Encapsulated Methods)** (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
