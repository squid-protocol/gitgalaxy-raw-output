...
## 1. EXECUTIVE SUMMARY
- **Scope:** 13192 analyzed artifact(s), 1065223 LOC.
- **Load-bearing artifact:** `Tests/LibWeb/Text/input/include.js` -- 685 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `Ports/AvailablePorts.md` -- pulls in 358 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `Userland/Libraries/LibWeb/CSS/Parser/Parser.cpp` at magnitude 5670.68 (structural weight, not risk).
...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +5.29; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 34%, Declarative / Non-Code 18%, Large Core Modules (3) 12%, Interface Declarations Files 8%, Parameter Forwarders Files 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 63.8 | 100.0 | 100.0 |
...
| connectivity | 16765 | 3758 | 3 | `Userland/Libraries/LibWeb/CSS/ComputedValues.h` |
...
- `Parser::parse_css_value` **(Many-Argument Workhorses)** (@ `Userland/Libraries/LibWeb/CSS/Parser/Parser.cpp`) -> Impact: **456.0** | LOC: 360
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **78**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.6%), Mutation Surface (formerly State Flux) (93.2%), Guard Balance (formerly Safety Score) (68.8%), Complexity Load (formerly Cognitive Load) (40.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Parser::parse_css_value` **(Many-Argument Workhorses)** (Impact: 456.0)
  ...
  * `Parser::parse_position_value` **(Many-Argument Workhorses)** (Impact: 126.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (89.1%), Guard Balance (formerly Safety Score) (86.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.9%), Debt Markers (formerly Tech Debt) (85.4%), Complexity Load (formerly Cognitive Load) (76.0%), Guard Balance (formerly Safety Score) (75.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `Parser::parse_binding_pattern` **(Many-Argument Workhorses)** (Impact: 155.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 91.9118% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **130**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (94.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (73.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Document::shared_declarative_refresh_steps` **(Many-Argument Workhorses)** (Impact: 70.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (93.5%), Complexity Load (formerly Cognitive Load) (92.7%), Guard Balance (formerly Safety Score) (90.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `decode_symbol_dictionary` **(Many-Argument Workhorses)** (Impact: 83.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (98.3%), Complexity Load (formerly Cognitive Load) (91.1%), Guard Balance (formerly Safety Score) (89.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Painter::draw_line` **(Many-Argument Workhorses)** (Impact: 155.6)
  * `Painter::split_text_into_directional_runs` **(Many-Argument Workhorses)** (Impact: 98.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (78.6%), Guard Balance (formerly Safety Score) (66.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Execute::for_each_entry` **(Many-Argument Workhorses)** (Impact: 86.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.9%), Mutation Surface (formerly State Flux) (95.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (71.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **75**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.5%), Mutation Surface (formerly State Flux) (90.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (73.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.4%), Guard Balance (formerly Safety Score) (92.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.9%), Mutation Surface (formerly State Flux) (44.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Debt Markers (formerly Tech Debt) (89.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ECMA262Parser::parse_nonempty_class_ranges` **(Compute Cores)** (Impact: 136.9)
  * `PosixExtendedParser::parse_sub_expression` **(Many-Argument Workhorses)** (Impact: 136.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.2%), Guard Balance (formerly Safety Score) (92.0%), Debt Markers (formerly Tech Debt) (86.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Editor::handle_read_event` **(I/O & Config Routines)** (Impact: 170.8)
  * `actual_rendered_string_length_step` **(Many-Argument Workhorses)** (Impact: 112.9)
  * `Editor::refresh_display` **(I/O & Config Routines)** (Impact: 67.5)
  * `merge` **(Many-Argument Workhorses)** (Impact: 60.3)
  * `Editor::vt_dsr` **(I/O & Config Routines)** (Impact: 59.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (80.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.1%), Guard Balance (formerly Safety Score) (95.8%), Debt Markers (formerly Tech Debt) (14.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `serialize_ipv6_address` **(Many-Argument Workhorses)** (Impact: 32.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (93.7%), Mutation Surface (formerly State Flux) (86.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `MemoryOrRegisterReference::to_byte_string_a16` **(I/O & Config Routines)** (Impact: 26.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.0%), Debt Markers (formerly Tech Debt) (91.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.7%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (81.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.5%), Mutation Surface (formerly State Flux) (84.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `constant_fold_binary_expression` **(Compute Cores)** (Impact: 58.5)
  * `TryStatement::generate_bytecode` **(Many-Argument Workhorses)** (Impact: 57.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.3%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `cpu_feature_to_name` **(Compute Cores)** (Impact: 357.9)
    * *Intent:* // https://developer.arm.com/downloads/-/exploration-tools/feature-names-for-a-profile
  * `detect_cpu_features` **(I/O & Config Routines)** (Impact: 268.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (93.2%), Guard Balance (formerly Safety Score) (89.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `convert_to_bitmap` **(Compute Cores)** (Impact: 127.3)
  * `read_one_packet_header` **(Many-Argument Workhorses)** (Impact: 107.0)
  * `decode_jpeg2000_header` **(Many-Argument Workhorses)** (Impact: 75.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.028; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Complexity Load (formerly Cognitive Load) (92.8%), Guard Balance (formerly Safety Score) (87.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `Terminal::set_size` **(Many-Argument Workhorses)** (Impact: 88.8)
