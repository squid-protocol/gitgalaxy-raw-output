# ARCHITECTURAL_BRIEF: node-fetch-retry
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 24 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 40.48 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 60.8 | 60.8 | 60.8 | 60.8 | 60.8 |
| Guard Balance (formerly Error & Exception Exposure) | 62.6 | 62.6 | 62.6 | 62.6 | 62.6 |
...
| Concurrency Surface (formerly Concurrency Exposure) | 98.8 | 98.8 | 98.8 | 98.8 | 98.8 |
| Mutation Surface (formerly State Flux Exposure) | 91.7 | 91.7 | 91.7 | 91.7 | 91.7 |
...
| memory | 0 | 0 | 0 | - |
| cleanup | 0 | 0 | 0 | - |
| guards | 3 | 1 | 3 | `package/index.js` |
| danger | 1 | 1 | 1 | `package/index.js` |
| concurrency | 9 | 1 | 9 | `package/index.js` |
...
| mutation | 4 | 1 | 4 | `package/index.js` |
...
- `exports` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **25.4** | LOC: 23
- `sleep` **(Parameter Forwarders)** (@ `package/index.js`) -> Impact: **1.6** | LOC: 3
...
- **Magnitude:** 40.48 | **LOC:** 29 | **CtrlFlow:** 54.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 333.333; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.8%), Mutation Surface (formerly State Flux) (91.7%), Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (62.6%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 25.4)
  * `sleep` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 6
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 13`, `structural_boundaries: 9`, `args: 4`, `func_start: 2`
* *Risk/State:* `state_mutation: 2`, `unreferenced_by_name: 1`
* *Architecture:* `io: 3`, `api: 1`, `concurrency: 6`, `import: 1`
* *Defense:* `safety: 3`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 333.333
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` node-fetch
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `package/README.md` (MARKDOWN | Tier 1 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 1.14 | **LOC:** 57 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- `package/index.js` -> **Severity: 16666.65** (Blast Radius: 333.333 * Doc Risk: 50.0%)
