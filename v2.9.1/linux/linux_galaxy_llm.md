...
## 1. EXECUTIVE SUMMARY
- **Scope:** 81613 analyzed artifact(s), 24774820 LOC.
- **Load-bearing artifact:** `include/linux/platform_device.h` -- 6402 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `rust/syn/lib.rs` -- pulls in 221 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `kernel/bpf/verifier.c` at magnitude 23984.26 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 81613 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 11398 |
| Total LOC | 24774820 |
...
|---|---|---|
| Modularity | 0.7473 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +5.05; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 31%, Large Core Modules (3) 26%, Data / Markup / Trivial 16%, Encapsulated Accessors Files 13%, Compute Cores Files 3%
...
*Total Excluded Artifacts: 11398*

**Composition by Extension & Reason:**
- `.rst`: 3864x Excluded (Unsupported Extension: '.rst'), 18x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
- `no_extension`: 3000x Unsupported Format (.undeterminable), 567x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 208x Unresolved Ambiguity (No Retainable Structure)
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 100.0 | 28.2 | 9.3 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 49.5 | 65.7 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 51.5 | 74.2 | 100.0 |
...
| cleanup | 12401 | 2642 | 0 | `tools/testing/selftests/namespaces/ns_active_ref_test.c` |
| guards | 1337129 | 47828 | 43 | `lib/zstd/compress/zstd_compress.c` |
| danger | 137252 | 15501 | 2 | `tools/perf/arch/x86/tests/insn-x86-dat-src.c` |
| concurrency | 9353 | 2178 | 0 | `tools/testing/selftests/net/fcnal-test.sh` |
| connectivity | 518599 | 51280 | 15 | `drivers/gpu/drm/amd/include/vega10_enum.h` |
| io | 35666 | 3451 | 0 | `tools/testing/selftests/cgroup/test_cpuset_prs.sh` |
| crypto | 8 | 6 | 0 | `scripts/crypto/gen-fips-testvecs.py` |
| ipc | 33371 | 3985 | 0 | `drivers/staging/media/atomisp/pci/sh_css.c` |
...
| regex | 7728 | 980 | 0 | `scripts/checkpatch.pl` |
| events | 20048 | 4956 | 0 | `tools/testing/selftests/filesystems/epoll/epoll_wakeup_test.c` |
...
| debt | 55125 | 12161 | 1 | `arch/powerpc/xmon/xmon.c` |
| mutation | 5648528 | 56695 | 182 | `drivers/gpu/drm/amd/include/navi10_enum.h` |
...
| threat | 335144 | 30607 | 11 | `drivers/media/dvb-frontends/drxk_hard.c` |
| ml_ai | 20815 | 2849 | 0 | `drivers/comedi/drivers/ni_routing/ni_route_values/ni_mseries.c` |
| ui | 302 | 44 | 0 | `tools/net/sunrpc/xdrgen/generators/union.py` |

**Relations (repo medians):**
- `guard_balance_ratio` (guards / (danger + 1)): **1.9524**
...
- `wm5110_readable_register` **(Many-Argument Workhorses)** (@ `drivers/mfd/wm5110-tables.c`) -> Impact: **2026.4** | LOC: 1142
- `wm5102_readable_register` **(Many-Argument Workhorses)** (@ `drivers/mfd/wm5102-tables.c`) -> Impact: **1479.2** | LOC: 832
- `wm5100_readable_register` **(Many-Argument Workhorses)** (@ `sound/soc/codecs/wm5100-tables.c`) -> Impact: **1372.0** | LOC: 767
- `cs47l24_readable_register` **(Many-Argument Workhorses)** (@ `drivers/mfd/cs47l24-tables.c`) -> Impact: **1240.6** | LOC: 701
...
- `wm8998_readable_register` **(Many-Argument Workhorses)** (@ `drivers/mfd/wm8998-tables.c`) -> Impact: **1208.5** | LOC: 683
...
- **Unknown Dependencies:** `417658` packages imported that bypass the Zero-Trust whitelist.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (95.3%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `do_misc_fixups` **(Many-Argument Workhorses)** (Impact: 339.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.8%), Complexity Load (formerly Cognitive Load) (85.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.9103% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **64**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.6%), Complexity Load (formerly Cognitive Load) (82.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.3812% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.4%)
- **Documentation Coverage:** 98.2922% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CalculateOutputLink` **(Many-Argument Workhorses)** (Impact: 464.1)
  * `CalculateDCCConfiguration` **(Many-Argument Workhorses)** (Impact: 428.6)
  * `dml_core_mode_support` **(Many-Argument Workhorses)** (Impact: 331.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (88.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 79.0816% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.7%)
- **Documentation Coverage:** 10.4418% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `lpfc_sli4_hba_setup` **(Many-Argument Workhorses)** (Impact: 168.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **54**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.6%), Guard Balance (formerly Safety Score) (96.2%), Debt Markers (formerly Tech Debt) (11.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ctx_statement_block` **(Many-Argument Workhorses)** (Impact: 8495.0)
  * `process` **(Compute Cores)** (Impact: 910.3)
  * `annotate_values` **(Many-Argument Workhorses)** (Impact: 200.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Complexity Load (formerly Cognitive Load) (80.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.005; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (83.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_chk_btc_report` **(Many-Argument Workhorses)** (Impact: 526.4)
  * `rtw89_btc_set_policy_v1` **(Many-Argument Workhorses)** (Impact: 226.8)
  * `rtw89_btc_set_policy` **(Many-Argument Workhorses)** (Impact: 147.1)
  ...
  * `rtw89_btc_fw_rpt_ver` **(Many-Argument Workhorses)** (Impact: 142.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.6%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CalculatePrefetchSchedule` **(Many-Argument Workhorses)** (Impact: 2554.9)
  * `dml314_ModeSupportAndSystemConfigurationFull` **(Many-Argument Workhorses)** (Impact: 568.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.6%), Guard Balance (formerly Safety Score) (98.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CalculatePrefetchSchedule` **(Many-Argument Workhorses)** (Impact: 2554.8)
  * `dml31_ModeSupportAndSystemConfigurationFull` **(Many-Argument Workhorses)** (Impact: 583.2)
  * `CalculateDCCConfiguration` **(Many-Argument Workhorses)** (Impact: 545.4)
  * `CalculateStutterEfficiency` **(Many-Argument Workhorses)** (Impact: 381.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (56.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **66**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.7%), Guard Balance (formerly Safety Score) (93.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.1982% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `kvm_set_msr_common` **(Many-Argument Workhorses)** (Impact: 272.8)
  * `kvm_arch_vcpu_ioctl` **(Many-Argument Workhorses)** (Impact: 243.9)
  * `kvm_get_msr_common` **(Many-Argument Workhorses)** (Impact: 217.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **66**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.4%), Complexity Load (formerly Cognitive Load) (81.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 84.949% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **48**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.5%)
- **Documentation Coverage:** 93.9048% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bnx2x_get_hwinfo` **(Compute Cores)** (Impact: 103.1)
  * `bnx2x_check_blocks_with_parity1` **(Many-Argument Workhorses)** (Impact: 100.2)
  * `bnx2x_init_hw_common` **(Many-Argument Workhorses)** (Impact: 92.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.0%)
- **Documentation Coverage:** 10.3718% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `lpfc_sli4_driver_resource_setup` **(Many-Argument Workhorses)** (Impact: 112.5)
  ...
  * `lpfc_sli4_queue_setup` **(Many-Argument Workhorses)** (Impact: 85.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.9%)
- **Documentation Coverage:** 7.4627% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_scsih_determine_disposition` **(Many-Argument Workhorses)** (Impact: 106.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ath12k_wmi_op_rx` **(Many-Argument Workhorses)** (Impact: 99.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.7%)
- **Documentation Coverage:** 99.4681% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `hclge_init_ae_dev` **(Many-Argument Workhorses)** (Impact: 62.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (81.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mii_init_common` **(Compute Cores)** (Impact: 80.2)
  * `niu_add_ethtool_tcam_entry` **(Many-Argument Workhorses)** (Impact: 75.4)
  * `walk_phys` **(Many-Argument Workhorses)** (Impact: 70.5)
  * `link_status_mii` **(Many-Argument Workhorses)** (Impact: 69.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `dml30_ModeSupportAndSystemConfigurationFull` **(Many-Argument Workhorses)** (Impact: 533.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.005; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `include/linux/minmax.h` -> **Severity: 6.489** (Embedded: 0.0807 * Error Risk: 80.4327%)
- `include/linux/alloc_tag.h` -> **Severity: 5.591** (Embedded: 0.0867 * Error Risk: 64.5005%)
...
- `include/linux/platform_device.h` -> **Severity: 466.457** (Blast Radius: 7.256 * Doc Risk: 64.2857%)
