...
| **Git Remote** | `https://github.com/exiftool/exiftool` |
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 363 analyzed artifact(s), 191871 LOC.
- **Load-bearing artifact:** `exiftool` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `exiftool` -- pulls in 84 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `exiftool` at magnitude 5680.7 (structural weight, not risk).
...
> **Composition Archetype:** `Mid Flat Project` (z +4.96; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 67%, Declarative / Non-Code 32%, Large Core Modules (3) 1%, Compute Cores Files 0%, Interface Declarations Files 0%
...
- `.html`: 1x Excluded (Lexical Monotony: High structural repetition detected in 2086 LOC), 1x Excluded (Lexical Monotony: High structural repetition detected in 15764 LOC), 1x Excluded (Machine-Generated Source Code Signature: 692 LOC)
- `.pdf`: 7x Excluded (Explicitly Denied Extension: '.pdf')
- `.pod`: 4x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
- `no_extension`: 2x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 1x Excluded (Machine-Generated Source Code Signature: 11924 LOC)
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 6.2 | 0.5 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 5.4 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 2.4 | 0.0 | 0.0 |
...
| connectivity | 2872 | 127 | 13 | `html/ancient_history.html` |
| io | 20682 | 184 | 58 | `html/makernote_types.html` |
| crypto | 0 | 0 | 0 | - |
| ipc | 14 | 4 | 0 | `validate` |
| time | 58 | 6 | 0 | `exiftool` |
| serialization | 0 | 0 | 0 | - |
| regex | 791 | 12 | 0 | `exiftool` |
| events | 85 | 11 | 0 | `t/images/HTML.html` |
| tests | 0 | 0 | 0 | - |
| docs | 340 | 175 | 1 | `exiftool` |
| debt | 1547 | 135 | 6 | `html/ancient_history.html` |
| mutation | 75572 | 292 | 392 | `html/makernote_types.html` |
| dead_code | 50 | 5 | 0 | `windows_exiftool` |
| credential | 5 | 5 | 0 | `exiftool` |
| threat | 267 | 122 | 2 | `html/examples.html` |
| ml_ai | 47 | 7 | 0 | `exiftool` |
| ui | 2713 | 171 | 3 | `html/ancient_history.html` |
...
- `GetImageInfo` **(Many-Argument Workhorses)** (@ `exiftool`) -> Impact: **892.5** | LOC: 1015
  * *Intent:* #------------------------------------------------------------------------------ # Get image information from EXIF data in file (or write file if writi...
- `GetImageInfo` **(Many-Argument Workhorses)** (@ `windows_exiftool`) -> Impact: **892.5** | LOC: 1015
  * *Intent:* #------------------------------------------------------------------------------ # Get image information from EXIF data in file (or write file if writi...
- `SetImageInfo` **(Many-Argument Workhorses)** (@ `exiftool`) -> Impact: **445.3** | LOC: 546
  * *Intent:* #------------------------------------------------------------------------------ # Set information in file # Inputs: 0) ExifTool object reference, 1) s...
- `SetImageInfo` **(Many-Argument Workhorses)** (@ `windows_exiftool`) -> Impact: **445.3** | LOC: 546
  * *Intent:* #------------------------------------------------------------------------------ # Set information in file # Inputs: 0) ExifTool object reference, 1) s...
- `nearEnough` **(Compute Cores)** (@ `t/TestLib.pm`) -> Impact: **187.2** | LOC: 106
  * *Intent:* #------------------------------------------------------------------------------ # Return true if two test lines are close enough # Inputs: 0) line1, 1...
- `ScanDir` **(Many-Argument Workhorses)** (@ `exiftool`) -> Impact: **130.4** | LOC: 129
  * *Intent:* #------------------------------------------------------------------------------ # Scan directory for image files # Inputs: 0) ExifTool ref, 1) directo...
- `ScanDir` **(Many-Argument Workhorses)** (@ `windows_exiftool`) -> Impact: **130.4** | LOC: 129
  * *Intent:* #------------------------------------------------------------------------------ # Scan directory for image files # Inputs: 0) ExifTool ref, 1) directo...
- `FilenameSPrintf` **(Compute Cores)** (@ `exiftool`) -> Impact: **84.8** | LOC: 57
  * *Intent:* #------------------------------------------------------------------------------ # A sort of sprintf for filenames # Inputs: 0) format string (%d=dir, ...
- `FilenameSPrintf` **(Compute Cores)** (@ `windows_exiftool`) -> Impact: **84.8** | LOC: 57
  * *Intent:* #------------------------------------------------------------------------------ # A sort of sprintf for filenames # Inputs: 0) format string (%d=dir, ...
- `NextUnusedFilename` **(Compute Cores)** (@ `exiftool`) -> Impact: **78.8** | LOC: 51
...
|---|---|---|---|---|
| `__monolith__` | 11 | 11945.16 | 39.04% | 1.72% |
| `t` | 114 | 4413.78 | 39.12% | 0.21% |
| `config_files` | 20 | 210.4 | 0.0% | 0.0% |
| `t/images` | 22 | 153.6 | 0.0% | 0.0% |
| `html` | 36 | 76.83 | 3.19% | 9.25% |
...
- `html/history.html` -> **29.9087%** Exposure
...
- **Magnitude:** 5680.7 | **LOC:** 8139 | **CtrlFlow:** 46.1% | **Authorship Centralization:** 100.0%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **84**; blast radius 5.049; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Guard Balance (formerly Safety Score) (94.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GetImageInfo` **(Many-Argument Workhorses)** (Impact: 892.5)
    * *Intent:* #------------------------------------------------------------------------------ # Get image informat...
  * `SetImageInfo` **(Many-Argument Workhorses)** (Impact: 445.3)
    * *Intent:* #------------------------------------------------------------------------------ # Set information in...
  * `ScanDir` **(Many-Argument Workhorses)** (Impact: 130.4)
    * *Intent:* #------------------------------------------------------------------------------ # Scan directory for...
  * `FilenameSPrintf` **(Compute Cores)** (Impact: 84.8)
    * *Intent:* #------------------------------------------------------------------------------ # A sort of sprintf ...
  * `NextUnusedFilename` **(Compute Cores)** (Impact: 78.8)
    * *Intent:* #------------------------------------------------------------------------------ # Expand '%c' and '%...
...
* *State Mutation (weighted view):* 3055
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 3051`, `structural_boundaries: 1103`, `args: 195`, `func_start: 100`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 8`, `high_risk_execution: 7`, `state_mutation: 1053`, `dead_code: 22`, `fragile_debt: 7`
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 5574.52 | **LOC:** 5069 | **CtrlFlow:** 50.3% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 2.729; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Complexity Load (formerly Cognitive Load) (98.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GetImageInfo` **(Many-Argument Workhorses)** (Impact: 892.5)
    * *Intent:* #------------------------------------------------------------------------------ # Get image informat...
...
* *Amplified Cascading Flux:* 981 instances
* *High Risk Execution (weighted view):* 1
* *Memory Alloc (weighted view):* 16
* *State Mutation (weighted view):* 2993
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 2154`, `structural_boundaries: 1043`, `args: 184`, `func_start: 101`, `class_start: 1`
* *Risk/State:* `safety_bypasses: 7`, `high_risk_execution: 3`, `state_mutation: 1031`, `dead_code: 22`, `fragile_debt: 4`, `unreferenced_by_name: 2`
...
- **Global Archetype:** `file_cluster_6` (Drift: 0.0 IQR)
- **Magnitude:** 609.78 | **LOC:** 479 | **CtrlFlow:** 53.8% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `nearEnough` **(Compute Cores)** (Impact: 187.2)
    * *Intent:* #------------------------------------------------------------------------------ # Return true if two...
  * `testCompare` **(Many-Argument Workhorses)** (Impact: 77.4)
    * *Intent:* #------------------------------------------------------------------------------ # Compare 2 files an...
  * `check` **(Many-Argument Workhorses)** (Impact: 39.6)
    * *Intent:* #------------------------------------------------------------------------------ # Compare extracted ...
  * `writeInfo` **(Many-Argument Workhorses)** (Impact: 27.9)
    * *Intent:* #------------------------------------------------------------------------------ # Call Image::ExifTo...
  * `writeCheck` **(Many-Argument Workhorses)** (Impact: 18.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (87.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GetFileSize` **(Parameter Forwarders)** (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.8%), Complexity Load (formerly Cognitive Load) (71.5%), Debt Markers (formerly Tech Debt) (9.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.3%), Complexity Load (formerly Cognitive Load) (70.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.3%), Complexity Load (formerly Cognitive Load) (73.5%), Debt Markers (formerly Tech Debt) (14.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.3%), Complexity Load (formerly Cognitive Load) (76.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.8%), Guard Balance (formerly Safety Score) (75.7%), Complexity Load (formerly Cognitive Load) (34.1%), Connectivity (formerly Api Exposure) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CryptTest` **(Compute Cores)** (Impact: 25.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.7%), Complexity Load (formerly Cognitive Load) (47.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (81.0%), Complexity Load (formerly Cognitive Load) (76.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (7.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 15 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (90.0%), Connectivity (formerly Api Exposure) (2.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Warn` **(Interface Declarations)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
...
- **Magnitude:** 59.5 | **LOC:** 2975 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.2%), Complexity Load (formerly Cognitive Load) (65.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.8%), Complexity Load (formerly Cognitive Load) (72.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (77.3%), Complexity Load (formerly Cognitive Load) (54.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.2%), Complexity Load (formerly Cognitive Load) (65.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (16.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.8%), Complexity Load (formerly Cognitive Load) (60.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Complexity Load (formerly Cognitive Load) (82.5%), Dead Code Surface (formerly Dead Code) (13.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Guard Balance (formerly Safety Score) (80.6%), Complexity Load (formerly Cognitive Load) (47.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.4%), Complexity Load (formerly Cognitive Load) (66.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
* *State Mutation (weighted view):* 24
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (80.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
* *State Mutation (weighted view):* 24
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.8%), Complexity Load (formerly Cognitive Load) (61.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.729; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.6%), Complexity Load (formerly Cognitive Load) (78.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
...
- `exiftool` -> Churn: **100.0%** | Cog Load: 73.479% | Debt: 8.8674%
- `windows_exiftool` -> Churn: **100.0%** | Cog Load: 98.1448% | Debt: 10.0344%
- `t/TestLib.pm` -> Churn: **55.68%** | Cog Load: 88.0797% | Debt: 0.0%

### 👤 Key Person Dependencies (High Impact + Siloed Knowledge)
These are massive, load-bearing files written almost entirely by a single developer. They represent severe 'Bus Factor' risk.

- `exiftool` -> **exiftool** (100.0% isolated ownership) | Magnitude: 5680.7
- `windows_exiftool` -> **exiftool** (100.0% isolated ownership) | Magnitude: 5574.52
- `t/TestLib.pm` -> **exiftool** (100.0% isolated ownership) | Magnitude: 609.78
...
- `exiftool` -> **Severity: 0.259** (Embedded: 0.0028 * Error Risk: 94.0278%)
