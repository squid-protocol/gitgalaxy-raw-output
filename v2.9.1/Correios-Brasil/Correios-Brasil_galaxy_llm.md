...
## 1. EXECUTIVE SUMMARY
- **Scope:** 17 analyzed artifact(s), 443 LOC.
- **Load-bearing artifact:** `lib/utils/URL.ts` -- 3 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `tests/utils.spec.ts` -- pulls in 6 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `tests/utils.spec.ts` at magnitude 57.53 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 41%, Declarative / Non-Code 29%, Callbacks & Closures Files 12%, Parameter Forwarders Files 12%, Large Core Modules (3) 6%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 80.2 | 29.7 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 50.0 | 50.0 | 100.0 |
...
- `gerarTokenApp` **(I/O & Config Routines)** (@ `lib/features/rastreio.ts`) -> Impact: **6.6** | LOC: 52
- `convertJsonToPrazoPrecoResponse` **(Type Conversions)** (@ `lib/features/precos.ts`) -> Impact: **3.2** | LOC: 7
- `sanitization` **(Parameter Forwarders)** (@ `lib/utils/validation.ts`) -> Impact: **3.1** | LOC: 6
...
- `formatDateTime` **(Parameter Forwarders)** (@ `lib/utils/formatter.ts`) -> Impact: **2.2** | LOC: 15
- `rastrearEncomendas` **(Parameter Forwarders)** (@ `lib/features/rastreio.ts`) -> Impact: **2.0** | LOC: 11
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 43.816; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (53.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 56.231; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (83.8%), Guard Balance (formerly Safety Score) (80.2%), Complexity Load (formerly Cognitive Load) (39.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `gerarTokenApp` **(I/O & Config Routines)** (Impact: 6.6)
  * `fetchTrackingService` **(Callbacks & Closures)** (Impact: 2.8)
  * `rastrearEncomendas` **(Parameter Forwarders)** (Impact: 2.0)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 56.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.8%), Concurrency Surface (formerly Concurrency) (79.1%), Mutation Surface (formerly State Flux) (33.0%), Connectivity (formerly Api Exposure) (17.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fetchPrecoPrazo` **(Compute Cores)** (Impact: 16.1)
  * `convertJsonToPrazoPrecoResponse` **(Type Conversions)** (Impact: 3.2)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 65.325; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (52.4%), Complexity Load (formerly Cognitive Load) (10.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 43.816; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Dead Code Surface (formerly Dead Code) (23.1%), Complexity Load (formerly Cognitive Load) (5.5%), Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Connectivity (formerly Api Exposure) (8.5%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `formatDateTime` **(Parameter Forwarders)** (Impact: 2.2)
  * `formatStatus` **(Parameter Forwarders)** (Impact: 2.0)
  * `formatLocal` **(Parameter Forwarders)** (Impact: 2.0)
  * `formatOrigin` **(Parameter Forwarders)** (Impact: 2.0)
  * `formatDestiny` **(Parameter Forwarders)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 89.223; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (5.4%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 43.816; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 56.231; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.8%), Concurrency Surface (formerly Concurrency) (53.3%), Connectivity (formerly Api Exposure) (20.1%), Complexity Load (formerly Cognitive Load) (4.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **3**; blast radius 89.223; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.4%), Concurrency Surface (formerly Concurrency) (53.3%), Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (11.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 71.998; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.6%), Connectivity (formerly Api Exposure) (21.5%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `convertArrayBufferToString` **(Parameter Forwarders)** (Impact: 2.0)
  * `convertXMLStringToJson` **(Parameter Forwarders)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 83.947; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (5.4%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sanitization` **(Parameter Forwarders)** (Impact: 3.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 81.06; role: Pure Producer (Foundation)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- `lib/utils/request.ts` -> **Severity: 13.677** (Embedded: 0.2 * Error Risk: 68.383%)
- `lib/utils/parser.ts` -> **Severity: 8.515** (Embedded: 0.1406 * Error Risk: 60.5532%)
- `lib/features/rastreio.ts` -> **Severity: 5.012** (Embedded: 0.0625 * Error Risk: 80.1893%)
- `lib/features/precos.ts` -> **Severity: 4.985** (Embedded: 0.0625 * Error Risk: 79.7611%)
- `lib/features/cep.ts` -> **Severity: 3.861** (Embedded: 0.0625 * Error Risk: 61.7748%)
