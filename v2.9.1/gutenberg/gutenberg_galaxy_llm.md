...
## 1. EXECUTIVE SUMMARY
- **Scope:** 11103 analyzed artifact(s), 791725 LOC.
- **Load-bearing artifact:** `packages/eslint-plugin/configs/i18n.js` -- 1348 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `packages/block-library/src/index.js` -- pulls in 133 dependencies, the widest assembly point in the scan.
...
> **Composition Archetype:** `Flat Modular Platform` (z +4.60; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 38%, Declarative / Non-Code 18%, Large Core Modules (2) 12%, Callbacks & Closures Files 9%, Large Core Modules 5%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 20.7 | 0.0 | 0.0 |
...
- `Image` **(Many-Argument Workhorses)** (@ `packages/block-library/src/image/image.js`) -> Impact: **351.4** | LOC: 1032
...
- `save` **(Many-Argument Workhorses)** (@ `packages/block-editor/src/store/test/selectors.js`) -> Impact: **283.6** | LOC: 3551
- `Navigation` **(Many-Argument Workhorses)** (@ `packages/block-library/src/navigation/edit/index.js`) -> Impact: **227.5** | LOC: 929
...
- `CoverEdit` **(Defensive Guards)** (@ `packages/block-library/src/cover/edit/index.js`) -> Impact: **204.8** | LOC: 645
...
- `GalleryEdit` **(Many-Argument Workhorses)** (@ `packages/block-library/src/gallery/edit.js`) -> Impact: **197.9** | LOC: 875
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 0.113; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (95.6%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **63**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (64.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `get_styles_for_block` **(Many-Argument Workhorses)** (Impact: 81.0)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 0.097; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.6%), Guard Balance (formerly Safety Score) (82.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 21.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (91.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (21.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.1%), Guard Balance (formerly Safety Score) (19.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **13**; blast radius 0.113; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (84.7%), Connectivity (formerly Api Exposure) (82.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (64.8%), Guard Balance (formerly Safety Score) (52.9%)
- **Documentation Coverage:** 13.5922% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `selection` **(Defensive Guards)** (Impact: 44.4)
    * *Intent:* /** * Reducer returning the selection state. * * */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (58.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (21.4%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `writingFlowUtils` **(Many-Argument Workhorses)** (Impact: 59.0)
  * `addDemoContent` **(I/O & Config Routines)** (Impact: 3.0)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **14**; blast radius 0.169; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (74.1%), Complexity Load (formerly Cognitive Load) (46.0%), Connectivity (formerly Api Exposure) (44.4%)
- **Documentation Coverage:** 58.8235% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `transformToStyles` **(Many-Argument Workhorses)** (Impact: 192.7)
  * `getNodesWithStyles` **(Many-Argument Workhorses)** (Impact: 128.3)
  * `getStylesDeclarations` **(Many-Argument Workhorses)** (Impact: 83.7)
    * *Intent:* /** * Transform given style tree into a set of style declarations. * */
  * `getLayoutStyles` **(Defensive Guards)** (Impact: 77.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (25.2%), Guard Balance (formerly Safety Score) (15.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (98.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.8%), Guard Balance (formerly Safety Score) (36.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `addPage` **(Compute Cores)** (Impact: 6.1)
  ...
  * `useLinkControlSearch` **(Parameter Forwarders)** (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (86.2%), Guard Balance (formerly Safety Score) (40.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (7.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `gutenberg_restore_group_inner_container` **(Many-Argument Workhorses)** (Impact: 25.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.8%), Complexity Load (formerly Cognitive Load) (35.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_inner_blocks` **(Stateful Encapsulated Methods)** (Impact: 19.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (30.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (25.7%), Guard Balance (formerly Safety Score) (23.7%), Complexity Load (formerly Cognitive Load) (10.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Mutation Surface (formerly State Flux) (63.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (55.7%), Guard Balance (formerly Safety Score) (39.5%)
- **Documentation Coverage:** 7.8652% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `canRemoveBlock` **(Defensive Guards)** (Impact: 38.6)
    * *Intent:* /** * Determines if the given block is allowed to be deleted. * * */
  ...
  * `__unstableIsSelectionMergeable` **(Defensive Guards)** (Impact: 28.0)
    * *Intent:* /** * Check whether the selection is mergeable. * * */
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **2**; blast radius 0.211; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (96.6%), Mutation Surface (formerly State Flux) (89.6%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (64.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.6%)
- **Documentation Coverage:** 28.2051% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bundlePackage` **(Many-Argument Workhorses)** (Impact: 84.1)
    * *Intent:* /** * Bundle a package for WordPress using esbuild. * */
  * `transformPhpContent` **(Many-Argument Workhorses)** (Impact: 44.6)
  * `buildAll` **(Compute Cores)** (Impact: 36.5)
    * *Intent:* /** * Main build function. * */
  * `transpilePackage` **(Compute Cores)** (Impact: 36.1)
    * *Intent:* /** * Transpile a single package's source files and copy JSON files. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Concurrency Surface (formerly Concurrency) (98.9%), Guard Balance (formerly Safety Score) (80.3%), Complexity Load (formerly Cognitive Load) (49.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **70**; blast radius 0.071; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (98.5%), Guard Balance (formerly Safety Score) (85.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.1525% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getPackages` **(Annotated & Test Methods)** (Impact: 62.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (78.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (7.9%), Complexity Load (formerly Cognitive Load) (3.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (3.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (53.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (35.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.071; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (40.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.0%)
- **Documentation Coverage:** 80.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `LinkUtils` **(Many-Argument Workhorses)** (Impact: 75.7)
  * `toggleFixedToolbar` **(Defensive Guards)** (Impact: 3.4)
  * `createLink` **(I/O & Config Routines)** (Impact: 2.5)
  * `constructor` **(State Mutators)** (Impact: 1.7)
...
- `packages/e2e-test-utils-playwright/src/test.ts` -> **Severity: 0.434** (Embedded: 0.0092 * Error Risk: 47.0248%)
...
- `packages/block-editor/src/components/block-edit/context.js` -> **Severity: 0.136** (Embedded: 0.0021 * Error Risk: 63.7774%)
