...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 278 LOC.
...
- **Top orchestrator:** `jaraco_context-6.1.2/jaraco/context/__init__.py` -- pulls in 23 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `jaraco_context-6.1.2/jaraco/context/__init__.py` at magnitude 156.3 (structural weight, not risk).
...
> **File Composition:** Generic / Templated Code Files 50%, Data / Markup / Trivial 25%, Parameter Forwarders Files 25%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 33.3 | 81.4 | 60.5 | 66.7 | 33.3 |
...
- `repo_context` **(Many-Argument Workhorses)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **12.5** | LOC: 27
- `__exit__` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **9.5** | LOC: 11
- `remove_readonly` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **8.8** | LOC: 16
- `__exit__` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **5.6** | LOC: 9
- `tarball` **(Defensive Guards)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **5.5** | LOC: 41
...
- `_compose` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **3.6** | LOC: 43
- `robust_remover` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **3.5** | LOC: 10
- `make_tarball_with` **(Parameter Forwarders)** (@ `jaraco_context-6.1.2/tests/test_safety.py`) -> Impact: **3.4** | LOC: 11
- `raises` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **3.2** | LOC: 23
- `passes` **(Generic / Templated Code)** (@ `jaraco_context-6.1.2/jaraco/context/__init__.py`) -> Impact: **2.5** | LOC: 15
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.2%), Debt Markers (formerly Tech Debt) (59.7%)
- **Documentation Coverage:** 81.3953% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `repo_context` **(Many-Argument Workhorses)** (Impact: 12.5)
  * `__exit__` **(Generic / Templated Code)** (Impact: 9.5)
  * `remove_readonly` **(Generic / Templated Code)** (Impact: 8.8)
  * `__exit__` **(Generic / Templated Code)** (Impact: 5.6)
  * `tarball` **(Defensive Guards)** (Impact: 5.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (11.1%), Connectivity (formerly Api Exposure) (6.4%)
- **Documentation Coverage:** 66.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `make_tarball_with` **(Parameter Forwarders)** (Impact: 3.4)
  * `test_zipslip_exploit` **(Parameter Forwarders)** (Impact: 2.2)
    * *Intent:* """ Ensure that protections from the default tarfile filter are applied. """
  * `tarfile_case` **(Parameter Forwarders)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 250.0; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.6%), Debt Markers (formerly Tech Debt) (92.4%), Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (68.0%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `log_message` **(Generic / Templated Code)** (Impact: 2.1)
  * `tarfile_served` **(Generic / Templated Code)** (Impact: 2.1)
    * *Intent:* """ Start an HTTP server serving a tarfile. """
  * `start_server` **(Generic / Templated Code)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
