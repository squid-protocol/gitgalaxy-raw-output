...
- **Heaviest artifact:** `package/hook.mjs` at magnitude 14.12 (structural weight, not risk).
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 1 | 1 | 1 | `package/hook.mjs` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
2. **hook.mjs** (`package/hook.mjs`) — 1 outbound dependencies
...
### `package/hook.mjs` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
