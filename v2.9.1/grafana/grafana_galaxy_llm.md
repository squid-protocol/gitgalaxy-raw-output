...
## 1. EXECUTIVE SUMMARY
- **Scope:** 17875 analyzed artifact(s), 2254614 LOC.
- **Load-bearing artifact:** `public/img/icons/unicons/react.svg` -- 3353 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `pkg/util/xorm/dialect_postgres.go` -- pulls in 754 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `packages/grafana-prometheus/src/datasource.test.ts` at magnitude 7052.8 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 17875 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 3598 |
| Total LOC | 2254614 |
...
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.27; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 24%, Callbacks & Closures Files 17%, Declarative / Non-Code 14%, Large Core Modules (2) 10%, Large Core Modules 8%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 24.9 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 55.1 | 77.8 | 100.0 |
...
| connectivity | 73180 | 11062 | 10 | `packages/grafana-api-clients/src/clients/rtkq/legacy/endpoints.gen.ts` |
...
- `query` **(Many-Argument Workhorses)** (@ `packages/grafana-api-clients/src/clients/rtkq/legacy/endpoints.gen.ts`) -> Impact: **2244.4** | LOC: 4300
...
- `query` **(I/O & Config Routines)** (@ `packages/grafana-api-clients/src/clients/rtkq/provisioning/v0alpha1/endpoints.gen.ts`) -> Impact: **519.5** | LOC: 1671
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (52.8%), Guard Balance (formerly Safety Score) (26.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.1%), Mutation Surface (formerly State Flux) (21.8%)
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (33.3%), Complexity Load (formerly Cognitive Load) (24.1%), Mutation Surface (formerly State Flux) (12.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.7%), Concurrency Surface (formerly Concurrency) (64.5%), Guard Balance (formerly Safety Score) (56.4%), Complexity Load (formerly Cognitive Load) (12.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (40.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (35.0%), Mutation Surface (formerly State Flux) (10.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.031; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (49.1%), Concurrency Surface (formerly Concurrency) (12.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `query` **(Many-Argument Workhorses)** (Impact: 2244.4)
  * `query` **(Generic / Templated Code)** (Impact: 2.5)
  * `query` **(Generic / Templated Code)** (Impact: 2.4)
  * `query` **(Generic / Templated Code)** (Impact: 2.4)
  * `query` **(Generic / Templated Code)** (Impact: 2.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.0%), Complexity Load (formerly Cognitive Load) (26.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.1%), Mutation Surface (formerly State Flux) (12.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.0%), Dead Code Surface (formerly Dead Code) (7.4%), Complexity Load (formerly Cognitive Load) (5.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (84.8%), Guard Balance (formerly Safety Score) (40.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **62**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (90.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (40.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.031; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (19.7%), Complexity Load (formerly Cognitive Load) (7.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.031; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (86.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (44.2%), Mutation Surface (formerly State Flux) (35.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- `packages/grafana-i18n/src/i18n.tsx` -> **Severity: 4.745** (Embedded: 0.1187 * Error Risk: 39.9812%)
- `public/app/core/services/context_srv.ts` -> **Severity: 3.746** (Embedded: 0.0455 * Error Risk: 82.3354%)
- `public/app/features/dashboard/state/DashboardModel.ts` -> **Severity: 3.14** (Embedded: 0.0345 * Error Risk: 91.0337%)
- `public/app/features/dashboard/state/PanelModel.ts` -> **Severity: 2.899** (Embedded: 0.0327 * Error Risk: 88.5385%)
...
- `public/app/types/unified-alerting-dto.ts` -> **Severity: 357.36** (Blast Radius: 4.467 * Doc Risk: 80.0%)
