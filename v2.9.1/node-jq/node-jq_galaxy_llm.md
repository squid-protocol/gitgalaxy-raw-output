...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 10 LOC.
...
- **Heaviest artifact:** `package/node-jq` at magnitude 15.2 (structural weight, not risk).
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 5.1 | 5.1 | 5.1 | 5.1 | 5.1 |
...
| memory | 0 | 0 | 0 | - |
| cleanup | 0 | 0 | 0 | - |
| guards | 1 | 1 | 1 | `package/node-jq` |
| danger | 2 | 1 | 2 | `package/node-jq` |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 0 | 0 | 0 | - |
| io | 3 | 1 | 3 | `package/node-jq` |
| crypto | 0 | 0 | 0 | - |
| ipc | 1 | 1 | 1 | `package/node-jq` |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
| regex | 0 | 0 | 0 | - |
| events | 2 | 1 | 2 | `package/node-jq` |
| tests | 0 | 0 | 0 | - |
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 3 | 1 | 3 | `package/node-jq` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
3. **node-jq** (`package/node-jq`) — 0 inbound connections
...
2. **node-jq** (`package/node-jq`) — 2 outbound dependencies
...
### `package/node-jq` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 15.2 | **LOC:** 15 | **CtrlFlow:** 10.0% | **Authorship Centralization:** 0.0%
...
- **Magnitude:** 7.32 | **LOC:** 366 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` LICENSE.md, lodash.com
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)

### `package/package.json` (PLAINTEXT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 1.88 | **LOC:** 94 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
