...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1054 analyzed artifact(s), 6809 LOC.
- **Load-bearing artifact:** `scripts/locales.ts` -- 13 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `scripts/generate-play.ts` -- pulls in 11 dependencies, the widest assembly point in the scan.
...
| Avg Path Length | 1.6197 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `5.101`
> **Composition Archetype:** `Mid Flat Project` (z +5.10; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 83%, Declarative / Non-Code 14%, Compute Cores Files 1%, Large Core Modules (3) 0%, Parameter Forwarders Files 0%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 97.6 | 21.2 | 0.0 | 0.0 |
...
- `action` **(Many-Argument Workhorses)** (@ `scripts/actions/issue-pr.ts`) -> Impact: **52.1** | LOC: 122
- `action` **(Many-Argument Workhorses)** (@ `scripts/actions/toggle-pr-with-issue.ts`) -> Impact: **29.2** | LOC: 64
- `action` **(Many-Argument Workhorses)** (@ `scripts/actions/labeling.ts`) -> Impact: **27.1** | LOC: 62
- `insertInfoReadme` **(Many-Argument Workhorses)** (@ `scripts/readme.ts`) -> Impact: **26.6** | LOC: 41
- `generatePlayground` **(I/O & Config Routines)** (@ `scripts/generate-play.ts`) -> Impact: **24.3** | LOC: 86
- `resolveInfo` **(Defensive Guards)** (@ `scripts/loader.ts`) -> Impact: **17.9** | LOC: 11
- `updateIndexREADME` **(Compute Cores)** (@ `scripts/readme.ts`) -> Impact: **15.4** | LOC: 53
- `translateMarkdown` **(Compute Cores)** (@ `scripts/translate.ts`) -> Impact: **15.4** | LOC: 29
- `toInfoHeader` **(Defensive Guards)** (@ `scripts/actions/utils/toInfoHeader.ts`) -> Impact: **14.4** | LOC: 10
- `toQuizREADME` **(Compute Cores)** (@ `scripts/toUrl.ts`) -> Impact: **12.3** | LOC: 6
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **7**; blast radius 1.345; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.2%), Guard Balance (formerly Safety Score) (97.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `insertInfoReadme` **(Many-Argument Workhorses)** (Impact: 26.6)
  * `updateIndexREADME` **(Compute Cores)** (Impact: 15.4)
  * `quizToBadge` **(Defensive Guards)** (Impact: 11.6)
  * `updateREADMEs` **(Compute Cores)** (Impact: 9.3)
  * `getAllTags` **(Defensive Guards)** (Impact: 9.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-06 | `Ripple Effect (Closeness):` 0.002135
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 1.121; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (94.9%), Complexity Load (formerly Cognitive Load) (81.0%), Guard Balance (formerly Safety Score) (76.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `action` **(Many-Argument Workhorses)** (Impact: 52.1)
  * `createMessageBody` **(Compute Cores)** (Impact: 10.7)
  * `getCodeBlock` **(Compute Cores)** (Impact: 10.4)
  * `updateComment` **(Many-Argument Workhorses)** (Impact: 9.4)
  * `getCommentRange` **(Compute Cores)** (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3e-06 | `Ripple Effect (Closeness):` 0.000949
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.925; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (99.4%), Complexity Load (formerly Cognitive Load) (96.4%), Guard Balance (formerly Safety Score) (76.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `generatePlayground` **(I/O & Config Routines)** (Impact: 24.3)
  * `takeSnapshot` **(Compute Cores)** (Impact: 6.8)
  * `isQuizWritable` **(Compute Cores)** (Impact: 6.3)
  * `calculateOverridableFiles` **(Compute Cores)** (Impact: 5.7)
  * `readPlaygroundCache` **(Defensive Guards)** (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.925; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (98.8%), Guard Balance (formerly Safety Score) (84.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolveInfo` **(Defensive Guards)** (Impact: 17.9)
  * `loadInfo` **(Generic / Templated Code)** (Impact: 9.6)
  * `loadQuiz` **(Generic / Templated Code)** (Impact: 4.8)
  * `loadQuizByNo` **(Parameter Forwarders)** (Impact: 3.4)
  * `loadFile` **(Parameter Forwarders)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **4**; blast radius 2.358; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (84.3%), Complexity Load (formerly Cognitive Load) (22.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `toQuizREADME` **(Compute Cores)** (Impact: 12.3)
  * `toRawREADME` **(Compute Cores)** (Impact: 9.0)
  * `toShareAnswerFull` **(Compute Cores)** (Impact: 9.0)
  * `toNearborREADME` **(Compute Cores)** (Impact: 8.9)
  * `toQuestionsRawREADME` **(Compute Cores)** (Impact: 5.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 1.187; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (98.3%), Complexity Load (formerly Cognitive Load) (97.3%), Guard Balance (formerly Safety Score) (70.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `translateMarkdown` **(Compute Cores)** (Impact: 15.4)
  * `translateAllQuizzes` **(Compute Cores)** (Impact: 7.6)
  * `translateQuiz` **(Compute Cores)** (Impact: 4.7)
  * `translateQuizByNo` **(Parameter Forwarders)** (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-06 | `Ripple Effect (Closeness):` 0.000949
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.8%), Complexity Load (formerly Cognitive Load) (62.9%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.925; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (98.2%), Guard Balance (formerly Safety Score) (91.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `build` **(I/O & Config Routines)** (Impact: 8.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
* *Amplified Cascading Flux:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Guard Balance (formerly Safety Score) (87.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (90.6%), Guard Balance (formerly Safety Score) (56.4%), Debt Markers (formerly Tech Debt) (50.0%), Complexity Load (formerly Cognitive Load) (25.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `action` **(Many-Argument Workhorses)** (Impact: 29.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (95.5%), Guard Balance (formerly Safety Score) (52.0%), Debt Markers (formerly Tech Debt) (45.4%), Complexity Load (formerly Cognitive Load) (25.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `action` **(Many-Argument Workhorses)** (Impact: 27.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.6%), Guard Balance (formerly Safety Score) (66.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **5**; blast radius 6.417; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (75.6%), Complexity Load (formerly Cognitive Load) (6.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `t` **(Compute Cores)** (Impact: 9.0)
  * `f` **(Parameter Forwarders)** (Impact: 4.2)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5.9e-05 | `Ripple Effect (Closeness):` 0.012334
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.4%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (8.0%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.2%), Guard Balance (formerly Safety Score) (64.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 4`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (5.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.1%), Mutation Surface (formerly State Flux) (31.0%), Complexity Load (formerly Cognitive Load) (5.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (6.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.925; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.1%), Complexity Load (formerly Cognitive Load) (5.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- `scripts/readme.ts` -> **Severity: 0.208** (Embedded: 0.0021 * Error Risk: 97.5742%)
- `scripts/actions/issue-pr.ts` -> **Severity: 0.073** (Embedded: 0.0009 * Error Risk: 76.8525%)
