...
## 1. EXECUTIVE SUMMARY
- **Scope:** 35118 analyzed artifact(s), 5638511 LOC.
- **Load-bearing artifact:** `test/fixtures/test-runner/shards/h.cjs` -- 2632 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `deps/v8/src/api/api.cc` -- pulls in 157 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `deps/v8/test/mjsunit/regress/regress-1200351.js` at magnitude 65308.52 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 35118 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 12276 |
| Total LOC | 5638511 |
...
|---|---|---|
| Modularity | 0.7449 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| Avg Path Length | 4.8885 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 732 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| JAVASCRIPT | 19257 | 1226330 | 54.8% |
| CPP | 7114 | 2363950 | 20.3% |
| C | 2966 | 866961 | 8.4% |
| PLAINTEXT | 2120 | 276 | 6.0% |
| HTML | 720 | 34085 | 2.1% |
...
> **Architectural Drift Z-Score:** `4.823`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.82; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 24%, Data / Markup / Trivial 22%, Parameter Forwarders Files 9%, Large Core Modules (3) 8%, State Mutators Files 8%
...
|---|---|---|
| Unclassified | 32635 | 92.9% |
| Unknown | 273 | 0.8% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 2206 | 6.3% |
| Static: Minified & Vendor Opaque Mass | 4 | 0.0% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 12276*
...
- `.js`: 1338x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 20x Excluded: Neighborhood Micro-Mass Limit Exceeded, 10x Excluded (Machine-Generated Source Code Signature: 106 LOC)
...
- `.html`: 89x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 27x Excluded (Saturation: Line 1 exceeds 500 chars), 4x Excluded (Binary Format Detected)

## 6. STRUCTURAL SURFACE PROFILE (formerly Risk Exposure) ANALYSIS (0-100%)
| Structural Surface Vector | Min | Max | Mean | Med | Mode |
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 100.0 | 17.6 | 4.3 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 42.0 | 55.8 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 10.1 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 9.3 | 0.0 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 7.0 | 0.0 | 0.0 |
| Concurrency Surface (formerly Concurrency Exposure) | 0.0 | 100.0 | 10.3 | 0.0 | 0.0 |
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 16.0 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 59.9 | 100.0 | 100.0 |
...
|---|---|---|---|---|
| memory | 802159 | 10875 | 39 | `deps/ngtcp2/ngtcp2/lib/ngtcp2_conn.c` |
| cleanup | 7993 | 3084 | 0 | `deps/undici/undici.js` |
| guards | 365586 | 14983 | 23 | `deps/v8/src/maglev/maglev-ir.h` |
| danger | 68482 | 8690 | 3 | `deps/v8/test/mjsunit/asm/embenchen/box2d.js` |
| concurrency | 52060 | 5387 | 2 | `deps/v8/test/mjsunit/harmony/async-generators-basic.js` |
| connectivity | 92265 | 10292 | 6 | `deps/v8/test/mjsunit/harmony/modules-skip-large2.mjs` |
| io | 23962 | 4973 | 1 | `deps/ngtcp2/ngtcp2/third-party/libev/ev.pod` |
| crypto | 942 | 577 | 0 | `lib/internal/crypto/webcrypto.js` |
| ipc | 10653 | 2109 | 0 | `deps/openssl/openssl/crypto/bn/asm/ppc64-mont.pl` |
| time | 4611 | 1385 | 0 | `deps/ngtcp2/ngtcp2/third-party/libev/ev.pod` |
| serialization | 2302 | 653 | 0 | `deps/v8/test/mjsunit/json.js` |
| regex | 11279 | 1786 | 0 | `deps/openssl/openssl/crypto/chacha/asm/chacha-loongarch64.pl` |
...
| debt | 31030 | 5814 | 1 | `deps/v8/src/maglev/maglev-ir.h` |
| mutation | 1036253 | 26104 | 54 | `deps/v8/test/mjsunit/asm/embenchen/box2d.js` |
| dead_code | 83522 | 9197 | 4 | `deps/v8/src/api/api.cc` |
| credential | 3314 | 126 | 0 | `src/node_root_certs.h` |
| threat | 87311 | 9946 | 3 | `deps/openssl/openssl/include/openssl/cryptoerr_legacy.h` |
| ml_ai | 2003 | 222 | 0 | `deps/ngtcp2/ngtcp2/lib/ngtcp2_log.c` |
...
- `msvcp110_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcp110_dll_lookup.hpp`) -> Impact: **3574.8** | LOC: 559
- `msvcp120_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcp120_dll_lookup.hpp`) -> Impact: **3566.3** | LOC: 559
- `msvcr100_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcr100_dll_lookup.hpp`) -> Impact: **2206.4** | LOC: 1108
- `msvcr120_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcr120_dll_lookup.hpp`) -> Impact: **2188.0** | LOC: 1023
- `msvcr110_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcr110_dll_lookup.hpp`) -> Impact: **2180.4** | LOC: 1011
- `decLnOp` **(Many-Argument Workhorses)** (@ `deps/icu-small/source/i18n/decNumber.cpp`) -> Impact: **1576.7** | LOC: 2421
...
- `ntdll_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/ntdll_dll_lookup.hpp`) -> Impact: **1574.0** | LOC: 1075
- `Verifier::Visitor::Check` **(Many-Argument Workhorses)** (@ `deps/v8/src/compiler/verifier.cc`) -> Impact: **1398.3** | LOC: 1569
  * *Intent:* #endif // DEBUG
- `kernel32_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/kernel32_dll_lookup.hpp`) -> Impact: **1392.6** | LOC: 954
- `msvcrt_dll_lookup` **(Compute Cores)** (@ `deps/LIEF/src/PE/utils/ordinals_lookup_tables/msvcrt_dll_lookup.hpp`) -> Impact: **1351.3** | LOC: 835
...
| `deps/openssl/openssl/apps` | 81 | 152023.76 | 63.34% | 8.95% |
| `deps/icu-small/source/i18n` | 432 | 132091.76 | 29.85% | 53.92% |
| `deps/icu-small/source/common` | 305 | 127805.88 | 42.66% | 42.53% |
| `test/parallel` | 4076 | 109042.62 | 7.8% | 0.0% |
| `deps/v8/test/mjsunit/regress` | 2843 | 99381.16 | 8.6% | 0.0% |
| `deps/v8/test/mjsunit/wasm/embenchen` | 9 | 94552.48 | 88.89% | 0.0% |
| `deps/v8/test/mjsunit/asm/embenchen` | 8 | 94551.16 | 100.0% | 0.0% |
| `deps/LIEF/third-party/mbedtls/library` | 162 | 74581.78 | 45.2% | 20.66% |
...
- `deps/v8/src/api/api.cc` -> **896** Orphaned Functions | **0** Duplicates
...
- **Unknown Dependencies:** `88462` packages imported that bypass the Zero-Trust whitelist.
...
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Connectivity (formerly Api Exposure) (8.3%), Guard Balance (formerly Safety Score) (1.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.015; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Concurrency Surface (formerly Concurrency) (14.8%), Dead Code Surface (formerly Dead Code) (5.5%)
- **Documentation Coverage:** 99.5842% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_malloc` **(Many-Argument Workhorses)** (Impact: 609.8)
    * *Intent:* // EMSCRIPTEN_START_FUNCS
  * `__ZN12b2EPCollider7CollideEP10b2ManifoldPK11b2EdgeShapeRK11b2TransformPK14b2PolygonShapeS7_` **(Many-Argument Workhorses)** (Impact: 310.2)
  * `__formatString` **(Many-Argument Workhorses)** (Impact: 298.3)
  * `__ZN7b2World8SolveTOIERK10b2TimeStep` **(Many-Argument Workhorses)** (Impact: 248.0)
  * `_free` **(Many-Argument Workhorses)** (Impact: 230.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (94.4%), Guard Balance (formerly Safety Score) (37.7%), Complexity Load (formerly Cognitive Load) (17.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.015; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Connectivity (formerly Api Exposure) (71.9%), Concurrency Surface (formerly Concurrency) (15.0%)
- **Documentation Coverage:** 99.3827% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_inflate` **(Many-Argument Workhorses)** (Impact: 807.3)
    * *Intent:* // EMSCRIPTEN_START_FUNCS
  * `_malloc` **(Many-Argument Workhorses)** (Impact: 609.8)
  * `_deflate` **(Many-Argument Workhorses)** (Impact: 448.3)
  * `__formatString` **(Many-Argument Workhorses)** (Impact: 298.3)
  * `_inflate_table` **(Many-Argument Workhorses)** (Impact: 232.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (92.2%), Guard Balance (formerly Safety Score) (89.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.6132% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `conn_write_pkt` **(Many-Argument Workhorses)** (Impact: 800.5)
    * *Intent:* * * If |require_padding| is nonzero, padding bytes are added to occupy * the remaining packet payloa...
  * `conn_recv_pkt` **(Many-Argument Workhorses)** (Impact: 549.9)
    * *Intent:* * NGTCP2_ERR_ACK_FRAME * ACK frame is malformed. * NGTCP2_ERR_STREAM_STATE * Frame is received to th...
  * `conn_recv_handshake_pkt` **(Many-Argument Workhorses)** (Impact: 393.6)
    * *Intent:* * NGTCP2_ERR_FRAME_FORMAT * Frame is badly formatted * NGTCP2_ERR_ACK_FRAME * ACK frame is malformed...
  * `ngtcp2_conn_write_vmsg` **(Many-Argument Workhorses)** (Impact: 298.3)
  * `conn_write_handshake_pkt` **(Many-Argument Workhorses)** (Impact: 286.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decLnOp` **(Many-Argument Workhorses)** (Impact: 1576.7)
    * *Intent:* /* would certainly save at least one if it were made ten times */ /* bigger, too (for truncated frac...
  * `decDivideOp` **(Many-Argument Workhorses)** (Impact: 486.8)
    * *Intent:* /* exp=exp-1 */ /* end outer_loop */ /* exp=exp+1 -- set the proper exponent */ /* if have=0 then ge...
  * `decAddOp` **(Many-Argument Workhorses)** (Impact: 279.2)
    * *Intent:* /* overlap the A or B coefficient */ /* then the result must be calculated into a temporary buffer. ...
  * `uprv_decNumberPower` **(Many-Argument Workhorses)** (Impact: 266.7)
    * *Intent:* /* Mathematical function restrictions apply (see above); a NaN is */ /* returned with Invalid_operat...
  * `decCompareOp` **(Many-Argument Workhorses)** (Impact: 240.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.015; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Concurrency Surface (formerly Concurrency) (18.0%), Dead Code Surface (formerly Dead Code) (6.6%)
- **Documentation Coverage:** 99.262% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_malloc` **(Many-Argument Workhorses)** (Impact: 609.8)
    * *Intent:* // EMSCRIPTEN_START_FUNCS
  * `__formatString` **(Many-Argument Workhorses)** (Impact: 298.3)
  * `_free` **(Many-Argument Workhorses)** (Impact: 230.2)
  * `_sysconf` **(Compute Cores)** (Impact: 182.3)
  * `demangle` **(Defensive Guards)** (Impact: 82.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
* *Amplified Race Conditions:* 6 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.015; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Concurrency Surface (formerly Concurrency) (18.1%), Dead Code Surface (formerly Dead Code) (6.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `_free` **(Many-Argument Workhorses)** (Impact: 230.2)
  * `_sysconf` **(Compute Cores)** (Impact: 182.3)
  * `__Z15fannkuch_workerPv` **(Compute Cores)** (Impact: 88.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
* *Amplified Race Conditions:* 6 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.015; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Concurrency Surface (formerly Concurrency) (18.4%), Dead Code Surface (formerly Dead Code) (6.6%)
- **Documentation Coverage:** 99.1597% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_malloc` **(Many-Argument Workhorses)** (Impact: 609.8)
    * *Intent:* // EMSCRIPTEN_START_FUNCS
  * `__formatString` **(Many-Argument Workhorses)** (Impact: 298.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **76**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.6%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (68.0%), Guard Balance (formerly Safety Score) (61.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MaglevGraphBuilder::TryBuildPolymorphicPropertyAccess` **(Many-Argument Workhorses)** (Impact: 190.8)
  * `MaglevGraphBuilder::TryBuildPolymorphicElementAccess` **(Many-Argument Workhorses)** (Impact: 112.6)
  * `MaglevGraphBuilder::TryReadBoilerplateForFastLiteral` **(Many-Argument Workhorses)** (Impact: 111.4)
  * `MaglevGraphBuilder::TryBuildNamedAccess` **(Many-Argument Workhorses)** (Impact: 109.8)
  * `MaglevGraphBuilder::TryReduceArrayIteratingBuiltin` **(Many-Argument Workhorses)** (Impact: 107.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.3%), Complexity Load (formerly Cognitive Load) (84.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.8073% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Simulator::DecodeTypeImmediate` **(I/O & Config Routines)** (Impact: 318.6)
    * *Intent:* // Type 2: instructions using a 16, 21 or 26 bits immediate. (e.g. beq, beqc).
  * `Simulator::Msa3RInstrHelper` **(Many-Argument Workhorses)** (Impact: 306.7)
  * `Simulator::DecodeTypeRegisterSPECIAL` **(I/O & Config Routines)** (Impact: 262.8)
  * `Msa3RFInstrHelper` **(Many-Argument Workhorses)** (Impact: 228.5)
  * `Msa2RFInstrHelper` **(Many-Argument Workhorses)** (Impact: 224.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.6%), Mutation Surface (formerly State Flux) (38.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MacroAssembler::TruncateDoubleToI` **(Many-Argument Workhorses)** (Impact: 1311.4)
  * `MacroAssembler::CallRecordWriteStub` **(Many-Argument Workhorses)** (Impact: 1104.7)
  * `MacroAssembler::BranchShortHelperR6` **(Many-Argument Workhorses)** (Impact: 333.9)
  * `MacroAssembler::BranchAndLinkShortHelperR6` **(Many-Argument Workhorses)** (Impact: 193.1)
  * `MacroAssembler::li_optimized` **(Many-Argument Workhorses)** (Impact: 140.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.3%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (65.6%), Guard Balance (formerly Safety Score) (58.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CodeStubAssembler::EmitElementStore` **(Many-Argument Workhorses)** (Impact: 197.9)
  * `CodeStubAssembler::CopyFixedArrayElements` **(Many-Argument Workhorses)** (Impact: 131.8)
  * `CodeStubAssembler::RelationalComparison` **(Many-Argument Workhorses)** (Impact: 121.0)
  * `CodeStubAssembler::BuildFastLoop` **(Many-Argument Workhorses)** (Impact: 72.1)
  * `CodeStubAssembler::BranchIfNumberRelationalComparison` **(Many-Argument Workhorses)** (Impact: 66.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **28**; blast radius 0.099; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (69.6%), Guard Balance (formerly Safety Score) (66.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (59.5%)
- **Documentation Coverage:** 88.6364% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parseURL` **(Defensive Guards)** (Impact: 49.0)
  * `assertRequestHandler` **(Defensive Guards)** (Impact: 31.6)
  * `add` **(Defensive Guards)** (Impact: 29.6)
    * *Intent:* /** */
  * `wrapRequestBody` **(Defensive Guards)** (Impact: 23.8)
  * `removeChars` **(Defensive Guards)** (Impact: 20.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2.8e-05 | `Ripple Effect (Closeness):` 0.005946
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (83.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 94.4444% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ucnv_MBCSFromUnicodeWithOffsets` **(Many-Argument Workhorses)** (Impact: 435.6)
  * `ucnv_MBCSToUnicodeWithOffsets` **(Many-Argument Workhorses)** (Impact: 226.7)
  * `ucnv_MBCSGetFilteredUnicodeSetForUnicode` **(Many-Argument Workhorses)** (Impact: 218.6)
  * `ucnv_MBCSLoad` **(Many-Argument Workhorses)** (Impact: 168.3)
    * *Intent:* /* MBCS setup functions ----------------------------------------------------- */
  * `ucnv_DBCSFromUTF8` **(Many-Argument Workhorses)** (Impact: 163.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.2%), Mutation Surface (formerly State Flux) (60.3%), Complexity Load (formerly Cognitive Load) (48.3%)
- **Documentation Coverage:** 95.8333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `WasmBytecodeGenerator::DoEncodeInstruction` **(Many-Argument Workhorses)** (Impact: 1076.2)
  * `WasmBytecodeGenerator::HasSideEffects` **(Compute Cores)** (Impact: 708.3)
    * *Intent:* #ifdef DEBUG // static
  * `WasmBytecodeGenerator::DecodeInstruction` **(Many-Argument Workhorses)** (Impact: 212.1)
  * `WasmBytecodeGenerator::DecodeGCOp` **(Many-Argument Workhorses)** (Impact: 120.3)
  * `WasmBytecodeGenerator::DoEncodeSuperInstruction` **(Many-Argument Workhorses)** (Impact: 103.7)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.4%), Guard Balance (formerly Safety Score) (86.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.5932% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `SSL_CTX_new_ex` **(Many-Argument Workhorses)** (Impact: 127.2)
    * *Intent:* #endif
  * `SSL_CTX_ctrl` **(Many-Argument Workhorses)** (Impact: 124.4)
  * `ossl_ctrl_internal` **(Many-Argument Workhorses)** (Impact: 123.9)
  * `dane_tlsa_add` **(Many-Argument Workhorses)** (Impact: 109.5)
  * `ossl_bytes_to_cipher_list` **(Many-Argument Workhorses)** (Impact: 83.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **51**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.1%), Complexity Load (formerly Cognitive Load) (72.0%)
- **Documentation Coverage:** 90.2574% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mbedtls_to_psa_error` **(Compute Cores)** (Impact: 177.3)
    * *Intent:* PSA_WANT_KEY_TYPE_DH_KEY_PAIR_GENERATE */
  * `psa_hkdf_input` **(Many-Argument Workhorses)** (Impact: 92.1)
    * *Intent:* #if defined(BUILTIN_ALG_ANY_HKDF)
  * `psa_key_policy_algorithm_intersection` **(Many-Argument Workhorses)** (Impact: 62.9)
    * *Intent:* /** Calculate the intersection of two algorithm usage policies. * * Return 0 (which allows no operat...
  * `psa_key_derivation_set_maximum_capacity` **(Many-Argument Workhorses)** (Impact: 61.4)
  * `psa_export_public_key_internal` **(Many-Argument Workhorses)** (Impact: 58.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.015; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Complexity Load (formerly Cognitive Load) (95.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `DisassemblingDecoder::VisitNEON2RegMisc` **(Compute Cores)** (Impact: 225.8)
  * `DisassemblingDecoder::VisitNEONLoadStoreSingleStruct` **(Compute Cores)** (Impact: 147.1)
  * `DisassemblingDecoder::VisitNEONLoadStoreSingleStructPostIndex` **(Compute Cores)** (Impact: 146.6)
  * `DisassemblingDecoder::SubstituteImmediateField` **(Many-Argument Workhorses)** (Impact: 135.8)
  * `DisassemblingDecoder::SubstituteRegisterField` **(Many-Argument Workhorses)** (Impact: 121.6)
**Contextual Mitigations & Amplifications:**
...
- `deps/v8/src/objects/lookup-inl.h` -> **Severity: 0.008** (Bridge: 0.0001 * Flux: 98.7914%)
- `lib/internal/errors.js` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 99.9691%)
- `lib/internal/util.js` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 99.9723%)
- `deps/undici/undici.js` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.9843%)
- `lib/internal/process/pre_execution.js` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.971%)

### 🃏 House of Cards (Closeness * Error Risk)
These files are deeply embedded (1 or 2 hops from the entire codebase) but possess high error exposure. A runtime exception here will cascade instantly across the application.

- `deps/LIEF/third-party/frozen/include/frozen/algorithm.h` -> **Severity: 4.991** (Embedded: 0.053 * Error Risk: 94.1152%)
- `deps/v8/src/base/hashing.h` -> **Severity: 4.606** (Embedded: 0.0513 * Error Risk: 89.7035%)
- `deps/v8/src/base/bits.h` -> **Severity: 3.759** (Embedded: 0.0463 * Error Risk: 81.2251%)
- `deps/v8/src/base/vector.h` -> **Severity: 3.422** (Embedded: 0.0645 * Error Risk: 53.0471%)
- `deps/v8/src/base/macros.h` -> **Severity: 3.253** (Embedded: 0.064 * Error Risk: 50.8042%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `deps/v8/src/base/macros.h` -> **Severity: 831.0** (Blast Radius: 8.31 * Doc Risk: 100.0%)
- `deps/v8/src/common/globals.h` -> **Severity: 641.5** (Blast Radius: 6.415 * Doc Risk: 100.0%)
- `deps/v8/src/base/logging.h` -> **Severity: 633.9** (Blast Radius: 6.339 * Doc Risk: 100.0%)
- `deps/v8/src/base/vector.h` -> **Severity: 506.2** (Blast Radius: 5.062 * Doc Risk: 100.0%)
- `lib/internal/errors.js` -> **Severity: 418.744** (Blast Radius: 6.002 * Doc Risk: 69.7674%)
