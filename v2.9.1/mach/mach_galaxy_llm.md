...
## 1. EXECUTIVE SUMMARY
- **Scope:** 132 analyzed artifact(s), 58175 LOC.
- **Load-bearing artifact:** `src/sysgpu/sysgpu/interface.zig` -- 25 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/sysgpu/sysgpu/main.zig` -- pulls in 28 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/sysgpu/shader/AstGen.zig` at magnitude 1874.88 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.68`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.68; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (3) 26%, Large Core Modules (2) 22%, State Mutators Files 19%, Data / Markup / Trivial 8%, Many-Argument Workhorses Files 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 75.5 | 94.4 | 100.0 |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 9.165; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (70.5%), Guard Balance (formerly Safety Score) (24.7%), Connectivity (formerly Api Exposure) (18.7%), Complexity Load (formerly Cognitive Load) (13.9%)
- **Documentation Coverage:** 97.9592% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.0%), Guard Balance (formerly Safety Score) (67.8%), Debt Markers (formerly Tech Debt) (45.5%), Complexity Load (formerly Cognitive Load) (20.2%)
- **Documentation Coverage:** 91.075% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **2**; blast radius 10.177; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.6%), Debt Markers (formerly Tech Debt) (14.1%)
...
- **Blast Radius:** changing it is visible to **25** in-repo importer(s); it depends on **2**; blast radius 71.988; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Guard Balance (formerly Safety Score) (87.5%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (8.2%)
- **Documentation Coverage:** 99.0751% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `bufferMapAsync` **(Parameter Forwarders)** (Impact: 3.1)
  * `commandEncoderCopyBufferToBuffer` **(Parameter Forwarders)** (Impact: 3.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 11.574; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (82.9%), Mutation Surface (formerly State Flux) (77.8%), Guard Balance (formerly Safety Score) (57.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (27.7%)
- **Documentation Coverage:** 91.075% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `init` **(Type Conversions)** (Impact: 25.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 7 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (78.8%), Guard Balance (formerly Safety Score) (62.7%), Debt Markers (formerly Tech Debt) (59.2%), Complexity Load (formerly Cognitive Load) (20.4%)
- **Documentation Coverage:** 91.075% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (84.1%), Mutation Surface (formerly State Flux) (74.0%), Guard Balance (formerly Safety Score) (48.0%), Complexity Load (formerly Cognitive Load) (20.1%)
- **Documentation Coverage:** 91.075% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 4.151; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `loadVersion` **(Type Conversions)** (Impact: 49.0)
  * `removeOptional` **(Generic / Templated Code)** (Impact: 4.5)
  * `load` **(Type Conversions)** (Impact: 1.7)
  * `getProcAddress` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **5**; blast radius 6.372; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (23.1%), Mutation Surface (formerly State Flux) (17.8%), Debt Markers (formerly Tech Debt) (11.0%), Guard Balance (formerly Safety Score) (10.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 7.716; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (66.5%), Connectivity (formerly Api Exposure) (17.6%), Complexity Load (formerly Cognitive Load) (14.4%), Dead Code Surface (formerly Dead Code) (7.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (14.6%)
- **Documentation Coverage:** 91.075% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deviceCreateShaderModule` **(Defensive Guards)** (Impact: 26.5)
  * `instanceRequestAdapter` **(Type Conversions)** (Impact: 5.1)
  * `createInstance` **(Type Conversions)** (Impact: 4.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 4.151; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (68.6%), Guard Balance (formerly Safety Score) (60.2%), Mutation Surface (formerly State Flux) (59.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.372; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (21.2%), Debt Markers (formerly Tech Debt) (19.0%), Connectivity (formerly Api Exposure) (11.1%), Complexity Load (formerly Cognitive Load) (10.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.372; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (19.9%), Mutation Surface (formerly State Flux) (19.0%), Connectivity (formerly Api Exposure) (11.1%), Complexity Load (formerly Cognitive Load) (10.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (94.6%), Mutation Surface (formerly State Flux) (82.7%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (33.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `writeThread` **(Type Conversions)** (Impact: 18.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 10 instances
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **14**; blast radius 6.146; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.4%), Guard Balance (formerly Safety Score) (83.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (70.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **4**; blast radius 38.75; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (94.3%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (42.0%), Mutation Surface (formerly State Flux) (16.4%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 6.372; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (18.3%), Mutation Surface (formerly State Flux) (15.8%), Connectivity (formerly Api Exposure) (11.6%), Complexity Load (formerly Cognitive Load) (10.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 4.151; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.8%), Guard Balance (formerly Safety Score) (80.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (70.3%)
- **Documentation Coverage:** 88.678% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 7.716; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (63.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `peek` **(Compute Cores)** (Impact: 96.5)
  * `init` **(Compute Cores)** (Impact: 4.5)
  * `next` **(Parameter Forwarders)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.4%), Mutation Surface (formerly State Flux) (51.3%), Concurrency Surface (formerly Concurrency) (50.1%), Debt Markers (formerly Tech Debt) (20.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 4.341; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (53.2%), Guard Balance (formerly Safety Score) (34.6%)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **5**; blast radius 26.016; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (95.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (50.1%), Mutation Surface (formerly State Flux) (11.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Guard Balance (formerly Safety Score) (35.5%), Complexity Load (formerly Cognitive Load) (13.1%), Debt Markers (formerly Tech Debt) (11.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 3.636; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (82.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.9%), Debt Markers (formerly Tech Debt) (31.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `refresh` **(Many-Argument Workhorses)** (Impact: 40.9)
