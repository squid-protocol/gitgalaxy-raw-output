...
## 1. EXECUTIVE SUMMARY
- **Scope:** 9 analyzed artifact(s), 1639 LOC.
...
- **Heaviest artifact:** `old/pillman0.asm` at magnitude 127.74 (structural weight, not risk).
...
> **File Composition:** Parameter Forwarders Files 67%, Data / Markup / Trivial 22%, Large Core Modules 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 87.5 | 100.0 | 100.0 |
...
- `move_sprite` **(Many-Argument Workhorses)** (@ `pillman.asm`) -> Impact: **11.7** | LOC: 39
- `move_sprite` **(Many-Argument Workhorses)** (@ `old/pillman2.asm`) -> Impact: **11.5** | LOC: 34
- `move_sprite` **(Many-Argument Workhorses)** (@ `old/pillman3.asm`) -> Impact: **11.5** | LOC: 35
- `move_sprite` **(Many-Argument Workhorses)** (@ `old/pillman4.asm`) -> Impact: **11.5** | LOC: 35
- `move_sprite` **(Many-Argument Workhorses)** (@ `old/pillman1.asm`) -> Impact: **11.4** | LOC: 32
  * *Intent:* ; ; DI = address on screen ; BL = wanted direction ;
- `move_ghost` **(Many-Argument Workhorses)** (@ `old/pillman0.asm`) -> Impact: **10.9** | LOC: 22
  * *Intent:* ; ; Move ghost ;
- `g9` **(Many-Argument Workhorses)** (@ `old/pillman0.asm`) -> Impact: **8.4** | LOC: 22
- `g4` **(Parameter Forwarders)** (@ `old/pillman0.asm`) -> Impact: **7.5** | LOC: 29
- `in0` **(Parameter Forwarders)** (@ `old/pillman0.asm`) -> Impact: **7.4** | LOC: 13
- `in2` **(Parameter Forwarders)** (@ `old/pillman1.asm`) -> Impact: **7.4** | LOC: 13
...
### `old/pillman0.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 127.74 | **LOC:** 339 | **CtrlFlow:** 7.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.1%), Mutation Surface (formerly State Flux) (48.1%), Debt Markers (formerly Tech Debt) (38.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_ghost` **(Many-Argument Workhorses)** (Impact: 10.9)
    * *Intent:* ; ; Move ghost ;
  * `g9` **(Many-Argument Workhorses)** (Impact: 8.4)
  * `g4` **(Parameter Forwarders)** (Impact: 7.5)
  * `in0` **(Parameter Forwarders)** (Impact: 7.4)
  * `clock_wait` **(Parameter Forwarders)** (Impact: 5.8)
...
### `old/pillman2.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 126.52 | **LOC:** 346 | **CtrlFlow:** 8.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (61.4%), Mutation Surface (formerly State Flux) (18.9%), Debt Markers (formerly Tech Debt) (12.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_sprite` **(Many-Argument Workhorses)** (Impact: 11.5)
  * `ds4` **(Parameter Forwarders)** (Impact: 7.4)
  * `clock_wait` **(Parameter Forwarders)** (Impact: 5.8)
  * `ms9` **(Parameter Forwarders)** (Impact: 5.5)
  * `dm2` **(Parameter Forwarders)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
### `pillman.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 117.32 | **LOC:** 388 | **CtrlFlow:** 6.9% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.0%), Debt Markers (formerly Tech Debt) (33.4%), Mutation Surface (formerly State Flux) (13.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_sprite` **(Many-Argument Workhorses)** (Impact: 11.7)
  * `ds4` **(Parameter Forwarders)** (Impact: 7.4)
  * `game_loop` **(Parameter Forwarders)** (Impact: 5.8)
    * *Intent:* ; ; Main game loop ;
  * `dm2` **(Parameter Forwarders)** (Impact: 5.1)
  * `ms9` **(Compute Cores)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
### `old/pillman3.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 117.1 | **LOC:** 332 | **CtrlFlow:** 7.2% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (61.9%), Mutation Surface (formerly State Flux) (20.7%), Debt Markers (formerly Tech Debt) (13.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_sprite` **(Many-Argument Workhorses)** (Impact: 11.5)
  * `ds4` **(Parameter Forwarders)** (Impact: 7.4)
  * `game_loop` **(Parameter Forwarders)** (Impact: 7.0)
  * `dm2` **(Parameter Forwarders)** (Impact: 5.0)
  * `ms9` **(Compute Cores)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
* *State Mutation (weighted view):* 15
...
### `old/pillman1.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 114.48 | **LOC:** 337 | **CtrlFlow:** 6.9% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (14.9%), Debt Markers (formerly Tech Debt) (12.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_sprite` **(Many-Argument Workhorses)** (Impact: 11.4)
    * *Intent:* ; ; DI = address on screen ; BL = wanted direction ;
  * `in2` **(Parameter Forwarders)** (Impact: 7.4)
  * `clock_wait` **(Parameter Forwarders)** (Impact: 5.8)
  * `g9` **(Parameter Forwarders)** (Impact: 5.8)
  * `ms9` **(Parameter Forwarders)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
### `old/pillman4.asm` (ASSEMBLY | Tier 1.5 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_15` (Drift: 0.0 IQR)
- **Magnitude:** 113.56 | **LOC:** 336 | **CtrlFlow:** 6.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.4%), Debt Markers (formerly Tech Debt) (13.7%), Mutation Surface (formerly State Flux) (13.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `move_sprite` **(Many-Argument Workhorses)** (Impact: 11.5)
  * `ds4` **(Parameter Forwarders)** (Impact: 7.4)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (9.9%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pillman.com` **(I/O & Config Routines)** (Impact: 1.2)
  * `clean` **(I/O & Config Routines)** (Impact: 1.2)
  * `rundosbox` **(I/O & Config Routines)** (Impact: 1.2)
  * `all` **(State Mutators)** (Impact: 1.1)
  * `pillman.img` **(I/O & Config Routines)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
