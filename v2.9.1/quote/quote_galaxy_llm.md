...
## 1. EXECUTIVE SUMMARY
- **Scope:** 24 analyzed artifact(s), 2309 LOC.
...
- **Top orchestrator:** `src/runtime.rs` -- pulls in 27 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/runtime.rs` at magnitude 173.62 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 50%, Generic / Templated Code Files 17%, Declarative / Non-Code 8%, Large Core Modules (3) 8%, State Mutators Files 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 80.0 | 95.9 | 100.0 |
...
- `deserialize` **(Generic / Templated Code)** (@ `benches/lib.rs`) -> Impact: **30.0** | LOC: 176
- `visit_map` **(Defensive Guards)** (@ `benches/lib.rs`) -> Impact: **14.8** | LOC: 54
- `append_separated` **(Generic / Templated Code)** (@ `src/ext.rs`) -> Impact: **7.2** | LOC: 24
- `visit_seq` **(Generic / Templated Code)** (@ `benches/lib.rs`) -> Impact: **6.8** | LOC: 33
- `do_append_separated` **(Generic / Templated Code)** (@ `src/ext.rs`) -> Impact: **6.8** | LOC: 15
- `rustc_minor_version` **(Compute Cores)** (@ `build.rs`) -> Impact: **6.5** | LOC: 10
- `respan_token_tree` **(Compute Cores)** (@ `src/runtime.rs`) -> Impact: **5.9** | LOC: 14
  * *Intent:* // Token tree with every span replaced by the given one.
- `main` **(I/O & Config Routines)** (@ `build.rs`) -> Impact: **5.8** | LOC: 17
- `test_advanced` **(Generic / Templated Code)** (@ `tests/test.rs`) -> Impact: **5.7** | LOC: 54
- `fmt` **(Defensive Guards)** (@ `src/ident_fragment.rs`) -> Impact: **5.6** | LOC: 8
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.8%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.0%), Mutation Surface (formerly State Flux) (62.4%)
- **Documentation Coverage:** 49.1803% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `respan_token_tree` **(Compute Cores)** (Impact: 5.9)
    * *Intent:* // Token tree with every span replaced by the given one.
  * `ident_maybe_raw` **(Defensive Guards)** (Impact: 5.5)
  * `parse_spanned` **(Parameter Forwarders)** (Impact: 4.3)
  * `push_group_spanned` **(Parameter Forwarders)** (Impact: 2.8)
  * `push_lifetime_spanned` **(Parameter Forwarders)** (Impact: 2.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (95.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.4%)
- **Documentation Coverage:** 91.8919% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `to_tokens` **(Compute Cores)** (Impact: 5.4)
  * `to_tokens` **(Defensive Guards)** (Impact: 3.7)
  * `to_tokens` **(Parameter Forwarders)** (Impact: 1.9)
  * `to_tokens` **(Parameter Forwarders)** (Impact: 1.9)
  * `to_tokens` **(Parameter Forwarders)** (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (26.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (22.3%), Concurrency Surface (formerly Concurrency) (15.8%), Complexity Load (formerly Cognitive Load) (4.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_advanced` **(Generic / Templated Code)** (Impact: 5.7)
  * `test_type_inference_for_span` **(Annotated & Test Methods)** (Impact: 4.3)
  * `test_quote_impl` **(Annotated & Test Methods)** (Impact: 4.0)
  * `test_quote_spanned_impl` **(Annotated & Test Methods)** (Impact: 4.0)
  * `test_array` **(Annotated & Test Methods)** (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (71.1%), Guard Balance (formerly Safety Score) (46.7%), Mutation Surface (formerly State Flux) (10.8%)
- **Documentation Coverage:** 88.1% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deserialize` **(Generic / Templated Code)** (Impact: 30.0)
  * `visit_map` **(Defensive Guards)** (Impact: 14.8)
  * `visit_seq` **(Generic / Templated Code)** (Impact: 6.8)
  * `visit_u64` **(Generic / Templated Code)** (Impact: 4.1)
  * `visit_bytes` **(Generic / Templated Code)** (Impact: 4.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Dead Code Surface (formerly Dead Code) (49.5%), Guard Balance (formerly Safety Score) (47.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (45.5%), Mutation Surface (formerly State Flux) (33.6%)
- **Documentation Coverage:** 63.6364% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `append_separated` **(Generic / Templated Code)** (Impact: 7.2)
  * `do_append_separated` **(Generic / Templated Code)** (Impact: 6.8)
  * `append_terminated` **(Generic / Templated Code)** (Impact: 5.0)
  * `do_append_terminated` **(Generic / Templated Code)** (Impact: 4.5)
  * `append_all` **(Generic / Templated Code)** (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Dead Code Surface (formerly Dead Code) (30.1%), Guard Balance (formerly Safety Score) (28.8%), Mutation Surface (formerly State Flux) (11.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (11.3%), Complexity Load (formerly Cognitive Load) (6.6%), Connectivity (formerly Api Exposure) (3.1%)
- **Documentation Coverage:** 81.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `fmt` **(Defensive Guards)** (Impact: 5.6)
  * `fmt` **(Parameter Forwarders)** (Impact: 1.9)
  * `fmt` **(Parameter Forwarders)** (Impact: 1.9)
  * `fmt` **(Parameter Forwarders)** (Impact: 1.9)
  * `fmt` **(Parameter Forwarders)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Dead Code Surface (formerly Dead Code) (96.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (27.7%), Complexity Load (formerly Cognitive Load) (5.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 2`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Debt Markers (formerly Tech Debt) (37.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (16.0%), Complexity Load (formerly Cognitive Load) (9.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `rustc_minor_version` **(Compute Cores)** (Impact: 6.5)
  * `main` **(I/O & Config Routines)** (Impact: 5.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (9.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.8%), Connectivity (formerly Api Exposure) (5.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (4.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `join_spans` **(Defensive Guards)** (Impact: 3.4)
  * `__span` **(State Mutators)** (Impact: 1.6)
  * `__span` **(State Mutators)** (Impact: 1.6)
  * `__span` **(State Mutators)** (Impact: 1.6)
  * `__span` **(State Mutators)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Documentation Coverage:** 88.1% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `time` **(Generic / Templated Code)** (Impact: 4.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (37.8%), Connectivity (formerly Api Exposure) (3.7%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 88.1% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `quote` **(Interface Declarations)** (Impact: 1.2)
  * `main` **(State Mutators)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ui` **(Annotated & Test Methods)** (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 41.667; role: Isolated/Orphan
- **Top Surface Vectors:** None above 0%
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Interface Declarations)** (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
