...
## 1. EXECUTIVE SUMMARY
- **Scope:** 16224 analyzed artifact(s), 2929498 LOC.
- **Load-bearing artifact:** `headers/os/kernel/OS.h` -- 868 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/libs/iconv/converters.h` -- pulls in 145 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/add-ons/kernel/drivers/network/wlan/idualwifi7260/dev/pci/if_iwm.c` at magnitude 10870.86 (structural weight, not risk).
...
|---|---|---|
| Modularity | 0.7152 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Architectural Drift Z-Score:** `4.305`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.30; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 32%, Large Core Modules (3) 19%, Interface Declarations Files 9%, Parameter Forwarders Files 8%, Large Core Modules 7%
...
|---|---|---|
| Unclassified | 16105 | 99.3% |
| Unknown | 9 | 0.1% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 109 | 0.7% |
...
- `no_extension`: 1613x Unsupported Format (.undeterminable), 769x Excluded (Binary Format Detected), 203x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 62.1 | 100.0 | 100.0 |
...
| guards | 158544 | 11488 | 24 | `src/libs/glut/glut_8x13.c` |
...
| connectivity | 47821 | 8261 | 6 | `src/system/libroot/stubbed/libroot_stubs.c` |
| io | 4836 | 607 | 0 | `3rdparty/mmu_man/scripts/HardwareChecker.sh` |
...
| events | 3644 | 693 | 0 | `src/add-ons/kernel/file_systems/userlandfs/kernel_add_on/Volume.cpp` |
| tests | 750 | 145 | 0 | `src/tests/system/libroot/posix/realtime_sem_test1.cpp` |
| docs | 14308 | 1616 | 0 | `src/libs/x86emu/ops.c` |
| debt | 26941 | 3995 | 4 | `src/tests/system/libroot/posix/wcs_test.cpp` |
| mutation | 616509 | 10542 | 95 | `src/libs/x86emu/ops.c` |
...
| threat | 105446 | 8934 | 5 | `src/add-ons/kernel/drivers/network/ether/broadcom570x/dev/bce/if_bcereg.h` |
| ml_ai | 1240 | 451 | 0 | `src/tests/kits/opengl/demos/gears/gears.c` |
| ui | 341 | 14 | 0 | `src/add-ons/kernel/drivers/graphics/nvidia/README.html` |
...
- `OutlineView::Draw` **(Many-Argument Workhorses)** (@ `src/kits/interface/ColumnListView.cpp`) -> Impact: **737.0** | LOC: 1956
- `em_if_attach_pre` **(Many-Argument Workhorses)** (@ `src/add-ons/kernel/drivers/network/ether/ipro1000/dev/e1000/if_em.c`) -> Impact: **723.0** | LOC: 2326
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (81.6%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (81.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `iwx_rx_pkt` **(Many-Argument Workhorses)** (Impact: 244.2)
  * `iwx_attach` **(Many-Argument Workhorses)** (Impact: 221.8)
    * *Intent:* #ifdef __FreeBSD_version
  * `iwx_read_firmware` **(Many-Argument Workhorses)** (Impact: 170.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (47.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `x86emuOp_opcF7_word_RM` **(Many-Argument Workhorses)** (Impact: 172.5)
    * *Intent:* ****************************************************************************/
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Complexity Load (formerly Cognitive Load) (96.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 40.6015% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **59**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (91.1%), Guard Balance (formerly Safety Score) (86.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `BPoseView::KeyDown` **(Many-Argument Workhorses)** (Impact: 167.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (99.2%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `iwn_config_specific` **(Many-Argument Workhorses)** (Impact: 405.0)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (84.7%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **55**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.6%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (67.3%)
- **Documentation Coverage:** 90.6344% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (80.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.2812% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **64**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.9%)
- **Documentation Coverage:** 89.7059% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (56.1%), Connectivity (formerly Api Exposure) (19.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **43**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (80.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run_read_eeprom` **(Many-Argument Workhorses)** (Impact: 106.4)
  * `run_init_locked` **(Many-Argument Workhorses)** (Impact: 90.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **44**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.8889% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Complexity Load (formerly Cognitive Load) (80.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.7%), Complexity Load (formerly Cognitive Load) (80.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `bge_attach` **(Many-Argument Workhorses)** (Impact: 269.8)
  * `bge_blockinit` **(Many-Argument Workhorses)** (Impact: 211.3)
  * `bge_ioctl` **(Many-Argument Workhorses)** (Impact: 105.9)
  * `bge_reset` **(Many-Argument Workhorses)** (Impact: 91.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Complexity Load (formerly Cognitive Load) (92.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.5%), Complexity Load (formerly Cognitive Load) (86.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 82.7957% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ABSApp::ProcessScriptingMessage` **(Many-Argument Workhorses)** (Impact: 366.8)
    * *Intent:* with an "error" number and an "message" string with a description. */
  * `ABSApp::LoadSaveDatabase` **(Many-Argument Workhorses)** (Impact: 139.6)
    * *Intent:* */
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Complexity Load (formerly Cognitive Load) (92.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 62.8099% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `em_if_attach_pre` **(Many-Argument Workhorses)** (Impact: 723.0)
  ...
  * `em_initialize_receive_unit` **(Many-Argument Workhorses)** (Impact: 99.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **32**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (97.5%), Guard Balance (formerly Safety Score) (92.7%), Complexity Load (formerly Cognitive Load) (86.8%)
- **Documentation Coverage:** 93.75% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `BTextView::_HandleArrowKey` **(Many-Argument Workhorses)** (Impact: 164.5)
    * *Intent:* //! Handles when an arrow key is pressed.
  * `BTextView::_HandlePageKey` **(Many-Argument Workhorses)** (Impact: 124.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.2%)
- **Documentation Coverage:** 1.0811% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.022; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.6%)
- **Documentation Coverage:** 94.0639% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `headers/os/support/SupportDefs.h` -> **Severity: 13.073** (Embedded: 0.2439 * Error Risk: 53.602%)
- `headers/os/kernel/OS.h` -> **Severity: 11.963** (Embedded: 0.1762 * Error Risk: 67.897%)
- `headers/os/storage/StorageDefs.h` -> **Severity: 8.031** (Embedded: 0.1326 * Error Risk: 60.5532%)
- `headers/os/support/DataIO.h` -> **Severity: 6.469** (Embedded: 0.0704 * Error Risk: 91.9441%)
- `headers/os/app/Message.h` -> **Severity: 5.807** (Embedded: 0.0835 * Error Risk: 69.5122%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `headers/os/support/SupportDefs.h` -> **Severity: 7255.9** (Blast Radius: 72.559 * Doc Risk: 100.0%)
- `headers/os/interface/Rect.h` -> **Severity: 582.4** (Blast Radius: 5.824 * Doc Risk: 100.0%)
- `headers/os/interface/GraphicsDefs.h` -> **Severity: 547.2** (Blast Radius: 5.472 * Doc Risk: 100.0%)
- `headers/os/support/Referenceable.h` -> **Severity: 528.7** (Blast Radius: 5.287 * Doc Risk: 100.0%)
- `headers/os/support/Archivable.h` -> **Severity: 524.2** (Blast Radius: 5.242 * Doc Risk: 100.0%)
