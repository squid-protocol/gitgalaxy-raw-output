...
## 1. EXECUTIVE SUMMARY
- **Scope:** 155 analyzed artifact(s), 9882 LOC.
- **Load-bearing artifact:** `Tests/Tests/AFTestCase.h` -- 21 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `Framework/AFNetworking.h` -- pulls in 19 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `Example/Certificates/adn.cer` at magnitude 5000.0 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.13`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.13; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 55%, Type Conversions Files 25%, Large Core Modules 14%, Declarative / Non-Code 4%, Large Core Modules (3) 1%
