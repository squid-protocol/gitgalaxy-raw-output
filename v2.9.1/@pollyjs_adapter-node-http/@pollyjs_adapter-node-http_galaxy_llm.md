...
## 1. EXECUTIVE SUMMARY
- **Scope:** 7 analyzed artifact(s), 290 LOC.
- **Load-bearing artifact:** `package/src/utils/get-url-from-options.js` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/src/index.js` -- pulls in 11 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/index.js` at magnitude 131.32 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 43%, Large Core Modules (2) 43%, Large Core Modules (3) 14%
...
- `getUrlFromOptions` **(Defensive Guards)** (@ `package/src/utils/get-url-from-options.js`) -> Impact: **18.2** | LOC: 25
  * *Intent:* /** * Generate an absolute url from options passed into `new http.ClientRequest`. * */
- `onRespond` **(Compute Cores)** (@ `package/src/index.js`) -> Impact: **13.0** | LOC: 52
- `getChunksFromBody` **(Compute Cores)** (@ `package/src/index.js`) -> Impact: **11.1** | LOC: 22
- `urlToOptions` **(Defensive Guards)** (@ `package/src/utils/url-to-options.js`) -> Impact: **11.1** | LOC: 24
...
- `getBodyFromChunks` **(Defensive Guards)** (@ `package/src/index.js`) -> Impact: **10.4** | LOC: 34
- `onRequest` **(Compute Cores)** (@ `package/src/index.js`) -> Impact: **9.3** | LOC: 16
- `mergeChunks` **(Defensive Guards)** (@ `package/src/utils/merge-chunks.js`) -> Impact: **6.4** | LOC: 14
  * *Intent:* /** * Merge an array of strings into a single string or concat an array * of buffers into a single buffer. * */
- `patchOverriddenMethods` **(I/O & Config Routines)** (@ `package/src/index.js`) -> Impact: **6.1** | LOC: 61
- `pollyRequest[ABORT_HANDLER]` **(Callbacks & Closures)** (@ `package/src/index.js`) -> Impact: **4.5** | LOC: 10
- `parseArgs` **(I/O & Config Routines)** (@ `package/src/index.js`) -> Impact: **3.9** | LOC: 17
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 127.389; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.4%), Mutation Surface (formerly State Flux) (91.3%), Debt Markers (formerly Tech Debt) (83.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onRespond` **(Compute Cores)** (Impact: 13.0)
  * `getChunksFromBody` **(Compute Cores)** (Impact: 11.1)
  * `getBodyFromChunks` **(Defensive Guards)** (Impact: 10.4)
  * `onRequest` **(Compute Cores)** (Impact: 9.3)
  * `patchOverriddenMethods` **(I/O & Config Routines)** (Impact: 6.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 163.482; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (69.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getUrlFromOptions` **(Defensive Guards)** (Impact: 18.2)
    * *Intent:* /** * Generate an absolute url from options passed into `new http.ClientRequest`. * */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 163.482; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (62.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `urlToOptions` **(Defensive Guards)** (Impact: 11.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 163.482; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.1%), Complexity Load (formerly Cognitive Load) (5.4%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mergeChunks` **(Defensive Guards)** (Impact: 6.4)
...
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.3%), Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
