...
## 1. EXECUTIVE SUMMARY
- **Scope:** 15 analyzed artifact(s), 724 LOC.
- **Load-bearing artifact:** `markupsafe-3.0.3/src/markupsafe/_native.py` -- 1 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `markupsafe-3.0.3/src/markupsafe/__init__.py` -- pulls in 10 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `markupsafe-3.0.3/src/markupsafe/__init__.py` at magnitude 263.36 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 33%, Generic / Templated Code Files 27%, Encapsulated Accessors Files 13%, Large Core Modules (2) 13%, Interface Declarations Files 7%
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 79.3 | 8.0 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 7.4 | 0.0 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 82.7 | 12.2 | 6.3 | 3.5 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 64.9 | 75.9 | 100.0 |
...
| concurrency | 0 | 0 | 0 | - |
| connectivity | 89 | 11 | 26 | `markupsafe-3.0.3/src/markupsafe/__init__.py` |
...
| dead_code | 34 | 8 | 4 | `markupsafe-3.0.3/tests/test_markupsafe.py` |
| credential | 0 | 0 | 0 | - |
...
- `escape_unicode` **(Stateful Encapsulated Methods)** (@ `markupsafe-3.0.3/src/markupsafe/_speedups.c`) -> Impact: **13.2** | LOC: 21
- `__mod__` **(Defensive Guards)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **11.0** | LOC: 12
- `format_field` **(Defensive Guards)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **10.8** | LOC: 16
- `striptags` **(Compute Cores)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **8.6** | LOC: 30
...
- `__new__` **(Defensive Guards)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **7.2** | LOC: 10
- `escape_unicode_kind1` **(Stateful Encapsulated Methods)** (@ `markupsafe-3.0.3/src/markupsafe/_speedups.c`) -> Impact: **6.9** | LOC: 25
- `__getattr__` **(Generic / Templated Code)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **6.4** | LOC: 15
- `test_ext_init` **(Defensive Guards)** (@ `markupsafe-3.0.3/tests/test_ext_init.py`) -> Impact: **5.7** | LOC: 14
...
- `__html_format__` **(Generic / Templated Code)** (@ `markupsafe-3.0.3/tests/test_markupsafe.py`) -> Impact: **5.6** | LOC: 9
- `__add__` **(Defensive Guards)** (@ `markupsafe-3.0.3/src/markupsafe/__init__.py`) -> Impact: **5.4** | LOC: 5
...
|---|---|---|---|---|
| `markupsafe-3.0.3/src/markupsafe` | 4 | 446.48 | 30.91% | 4.02% |
...
- `markupsafe-3.0.3/src/markupsafe/_speedups.c` -> **16.0766%** Exposure
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 63.091; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.7%), Connectivity (formerly Api Exposure) (82.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__mod__` **(Defensive Guards)** (Impact: 11.0)
  * `format_field` **(Defensive Guards)** (Impact: 10.8)
  * `striptags` **(Compute Cores)** (Impact: 8.6)
    * *Intent:* """:meth:`unescape` the markup, remove tags, and normalize whitespace to single spaces. >>> Markup("...
  * `__new__` **(Defensive Guards)** (Impact: 7.2)
  * `__getattr__` **(Generic / Templated Code)** (Impact: 6.4)
...
- **Magnitude:** 177.64 | **LOC:** 201 | **CtrlFlow:** 15.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (70.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `escape_unicode` **(Stateful Encapsulated Methods)** (Impact: 13.2)
  * `escape_unicode_kind1` **(Stateful Encapsulated Methods)** (Impact: 6.9)
  * `escape_unicode_kind2` **(Stateful Encapsulated Methods)** (Impact: 5.4)
  * `escape_unicode_kind4` **(Stateful Encapsulated Methods)** (Impact: 5.4)
  * `PyInit__speedups` **(Interface Declarations)** (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 6`, `state_mutation: 47`, `unreferenced_by_name: 1`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (15.7%), Connectivity (formerly Api Exposure) (12.3%), Guard Balance (formerly Safety Score) (7.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__html_format__` **(Generic / Templated Code)** (Impact: 5.6)
  * `test_complex_custom_formatting` **(Generic / Templated Code)** (Impact: 4.2)
  * `test_string_interpolation` **(Generic / Templated Code)** (Impact: 2.1)
  * `__init__` **(Generic / Templated Code)** (Impact: 2.1)
  * `__html_format__` **(Generic / Templated Code)** (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (79.3%), Guard Balance (formerly Safety Score) (53.2%), Mutation Surface (formerly State Flux) (51.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 63.84% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run_setup` **(Compute Cores)** (Impact: 4.5)
  * `build_extension` **(Defensive Guards)** (Impact: 4.0)
  * `show_message` **(Parameter Forwarders)** (Impact: 3.1)
  * `run` **(Defensive Guards)** (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (32.7%), Connectivity (formerly Api Exposure) (7.0%)
- **Documentation Coverage:** 60.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_escape` **(Generic / Templated Code)** (Impact: 1.8)
  * `__init__` **(Encapsulated Accessors)** (Impact: 1.8)
  * `__class__` **(Generic / Templated Code)** (Impact: 1.6)
    * *Intent:* # Make o.__class__ and isinstance(o, str) see the proxied object. return self.__value.__class__ # ty...
  * `__str__` **(Generic / Templated Code)** (Impact: 1.6)
    * *Intent:* # This should return a str, but it returns the subclass instead. return self def test_subclass() -> ...
  * `__str__` **(Type Conversions)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.3%), Connectivity (formerly Api Exposure) (1.8%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pytest_report_header` **(Generic / Templated Code)** (Impact: 2.3)
    * *Intent:* """Return a list of strings to be displayed in the header of the report."""
  * `_mod` **(Encapsulated Accessors)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.3%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_markup_leaks` **(I/O & Config Routines)** (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (33.1%), Complexity Load (formerly Cognitive Load) (6.1%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_ext_init` **(Defensive Guards)** (Impact: 5.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 63.091; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.6%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_exception_custom_html` **(Annotated & Test Methods)** (Impact: 1.6)
    * *Intent:* """Checks whether exceptions in custom __html__ implementations are propagated correctly. There was ...
  * `__html__` **(Generic / Templated Code)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 116.719; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (10.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_escape_inner` **(Encapsulated Accessors)** (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (10.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_escape_inner` **(Encapsulated Accessors)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
