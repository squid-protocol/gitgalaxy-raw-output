...
## 1. EXECUTIVE SUMMARY
- **Scope:** 9 analyzed artifact(s), 308 LOC.
...
- **Top orchestrator:** `package/src/node-range.ts` -- pulls in 6 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/node-range.ts` at magnitude 108.78 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 44%, Callbacks & Closures Files 11%, Large Core Modules 11%, Large Core Modules (3) 11%, Many-Argument Workhorses Files 11%
...
- `mousedown` **(Compute Cores)** (@ `package/src/node-range.ts`) -> Impact: **30.2** | LOC: 49
- `addProseMirrorPlugins` **(I/O & Config Routines)** (@ `package/src/node-range.ts`) -> Impact: **27.6** | LOC: 112
- `constructor` **(Many-Argument Workhorses)** (@ `package/src/helpers/NodeRangeSelection.ts`) -> Impact: **25.7** | LOC: 23
- `getSelectionRanges` **(Many-Argument Workhorses)** (@ `package/src/helpers/getSelectionRanges.ts`) -> Impact: **21.6** | LOC: 31
- `decorations` **(Compute Cores)** (@ `package/src/node-range.ts`) -> Impact: **10.5** | LOC: 41
- `addKeyboardShortcuts` **(I/O & Config Routines)** (@ `package/src/node-range.ts`) -> Impact: **6.2** | LOC: 64
- `getNodeRangeDecorations` **(Callbacks & Closures)** (@ `package/src/helpers/getNodeRangeDecorations.ts`) -> Impact: **5.5** | LOC: 25
- `create` **(Parameter Forwarders)** (@ `package/src/helpers/NodeRangeSelection.ts`) -> Impact: **5.0** | LOC: 3
- `eq` **(Compute Cores)** (@ `package/src/helpers/NodeRangeSelection.ts`) -> Impact: **4.4** | LOC: 3
- `extendBackwards` **(I/O & Config Routines)** (@ `package/src/helpers/NodeRangeSelection.ts`) -> Impact: **3.8** | LOC: 16
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (85.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (65.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mousedown` **(Compute Cores)** (Impact: 30.2)
  * `addProseMirrorPlugins` **(I/O & Config Routines)** (Impact: 27.6)
  * `decorations` **(Compute Cores)** (Impact: 10.5)
  * `addKeyboardShortcuts` **(I/O & Config Routines)** (Impact: 6.2)
  * `attributes` **(Callbacks & Closures)** (Impact: 2.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (63.4%), Connectivity (formerly Api Exposure) (61.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Many-Argument Workhorses)** (Impact: 25.7)
  * `create` **(Parameter Forwarders)** (Impact: 5.0)
  * `eq` **(Compute Cores)** (Impact: 4.4)
  * `extendBackwards` **(I/O & Config Routines)** (Impact: 3.8)
  * `extendForwards` **(I/O & Config Routines)** (Impact: 3.8)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (72.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (31.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getSelectionRanges` **(Many-Argument Workhorses)** (Impact: 21.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (9.9%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (46.6%), Mutation Surface (formerly State Flux) (35.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(State Mutators)** (Impact: 1.9)
  * `resolve` **(Parameter Forwarders)** (Impact: 1.7)
  * `map` **(Parameter Forwarders)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 111.111; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (57.5%), Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getNodeRangeDecorations` **(Callbacks & Closures)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `isNodeRangeSelection` **(Defensive Guards)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
