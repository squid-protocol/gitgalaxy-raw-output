...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 69 LOC.
...
- **Top orchestrator:** `package/index.js` -- pulls in 1 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/index.js` at magnitude 89.96 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 80%, Callbacks & Closures Files 20%
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 99.3 | 33.1 | 0.0 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 96.0 | 51.5 | 58.5 | 96.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 56.9 | 19.0 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 2.3 | 2.5 | 2.4 | 2.3 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 6.4 | 4.0 | 5.6 | 6.4 |
| Concurrency Surface (formerly Concurrency Exposure) | 0.0 | 100.0 | 33.3 | 0.0 | 0.0 |
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 43.7 | 31.0 | 100.0 |
...
| memory | 0 | 0 | 0 | - |
| cleanup | 0 | 0 | 0 | - |
| guards | 8 | 2 | 6 | `package/index.js` |
| danger | 1 | 1 | 1 | `package/index.js` |
| concurrency | 5 | 1 | 5 | `package/index.js` |
| connectivity | 5 | 2 | 3 | `package/index.js` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 2 | 1 | 2 | `package/index.js` |
| serialization | 0 | 0 | 0 | - |
| regex | 0 | 0 | 0 | - |
| events | 0 | 0 | 0 | - |
| tests | 0 | 0 | 0 | - |
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 42 | 2 | 40 | `package/index.js` |
| dead_code | 1 | 1 | 1 | `package/index.js` |
| credential | 0 | 0 | 0 | - |
| threat | 2 | 1 | 2 | `package/index.js` |
| ml_ai | 0 | 0 | 0 | - |
| ui | 0 | 0 | 0 | - |
...
- `raf` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **7.1** | LOC: 29
- `caf` **(Defensive Guards)** (@ `package/index.js`) -> Impact: **4.6** | LOC: 7
- `polyfill` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **3.2** | LOC: 7
- `exports` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **1.7** | LOC: 6
- `cancel` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **1.1** | LOC: 3
...
|---|---|---|---|---|
| `package` | 5 | 119.76 | 19.85% | 11.38% |

## 10. TARGETED STRUCTURAL SURFACE VECTORS (formerly Risk Vectors, Top 5 by Surface)
### Highest Debt Markers (formerly Tech Debt; Fragile/Planned)
- `package/index.js` -> **56.9001%** Exposure
### Highest Mutation Surface (formerly State Flux; Mutation/Volatility)
- `package/index.js` -> **100.0%** Exposure
- `package/window.js` -> **31.0026%** Exposure
...
- **Magnitude:** 89.96 | **LOC:** 76 | **CtrlFlow:** 20.6% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 200.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (99.3%), Guard Balance (formerly Safety Score) (96.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `raf` **(Defensive Guards)** (Impact: 7.1)
  * `caf` **(Defensive Guards)** (Impact: 4.6)
  * `polyfill` **(Callbacks & Closures)** (Impact: 3.2)
  * `exports` **(Callbacks & Closures)** (Impact: 1.7)
  * `cancel` **(Callbacks & Closures)** (Impact: 1.1)
...
* *Structure:* `branch: 13`, `structural_boundaries: 9`, `args: 7`, `func_start: 5`
* *Risk/State:* `state_mutation: 18`, `unreferenced_by_name: 1`
...
### `package/window.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 16.6 | **LOC:** 6 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (31.0%), Connectivity (formerly Api Exposure) (5.6%)
...
- `package/index.js` -> **Severity: 10000.0** (Blast Radius: 200.0 * Doc Risk: 50.0%)
