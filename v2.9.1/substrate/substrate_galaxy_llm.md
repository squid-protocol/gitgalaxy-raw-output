...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2042 analyzed artifact(s), 411055 LOC.
- **Load-bearing artifact:** `frame/bags-list/src/benchmarks.rs` -- 18 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `frame/support/src/lib.rs` -- pulls in 190 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `client/network/sync/src/lib.rs` at magnitude 1650.9 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.147`
> **Composition Archetype:** `Flat Modular Platform` (z +3.15; from the repo's file-archetype mix)
> **File Composition:** State Mutators Files 28%, Generic / Templated Code Files 26%, Data / Markup / Trivial 15%, Large Core Modules (3) 12%, Declarative / Non-Code 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 56.0 | 60.0 | 100.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **120**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (73.3%), Guard Balance (formerly Safety Score) (61.6%), Connectivity (formerly Api Exposure) (55.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **96**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (85.4%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (62.6%), Connectivity (formerly Api Exposure) (61.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **61**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (63.1%), Concurrency Surface (formerly Concurrency) (55.6%), Mutation Surface (formerly State Flux) (49.3%), Guard Balance (formerly Safety Score) (40.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **120**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (75.2%), Guard Balance (formerly Safety Score) (52.8%), Mutation Surface (formerly State Flux) (52.4%)
- **Documentation Coverage:** 68.3099% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **50**; blast radius 0.871; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.2%), Guard Balance (formerly Safety Score) (29.7%), Mutation Surface (formerly State Flux) (8.8%)
- **Documentation Coverage:** 14.9123% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.9%), Mutation Surface (formerly State Flux) (38.7%), Guard Balance (formerly Safety Score) (31.2%)
- **Documentation Coverage:** 22.5352% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **96**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.8%), Debt Markers (formerly Tech Debt) (26.7%), Mutation Surface (formerly State Flux) (13.6%), Connectivity (formerly Api Exposure) (7.7%)
- **Documentation Coverage:** 58.2418% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **58**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (65.2%), Guard Balance (formerly Safety Score) (50.7%), Debt Markers (formerly Tech Debt) (21.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `message_allowed` **(Defensive Guards)** (Impact: 25.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.7%), Connectivity (formerly Api Exposure) (59.7%)
- **Documentation Coverage:** 60.241% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (32.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **98**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.9%), Debt Markers (formerly Tech Debt) (35.3%), Mutation Surface (formerly State Flux) (9.5%), Connectivity (formerly Api Exposure) (8.6%)
- **Documentation Coverage:** 98.5915% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `call` **(Generic / Templated Code)** (Impact: 14.1)
  * `lazy_removal_partial_remove_works` **(I/O & Config Routines)** (Impact: 12.6)
  * `lazy_removal_does_not_use_all_weight` **(I/O & Config Routines)** (Impact: 10.0)
  * `add_remove_delegate_dependency_works` **(I/O & Config Routines)** (Impact: 9.7)
  * `native_dependency_deposit_works` **(I/O & Config Routines)** (Impact: 9.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **50**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (67.6%), Guard Balance (formerly Safety Score) (27.0%), Mutation Surface (formerly State Flux) (18.0%), Debt Markers (formerly Tech Debt) (9.2%)
- **Documentation Coverage:** 88.2353% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `do_phragmen` **(I/O & Config Routines)** (Impact: 24.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **102**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (96.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.7%), Guard Balance (formerly Safety Score) (47.7%)
- **Documentation Coverage:** 58.1081% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (56.6%), Guard Balance (formerly Safety Score) (37.8%), Mutation Surface (formerly State Flux) (12.7%), Dead Code Surface (formerly Dead Code) (7.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_payout_stakers` **(I/O & Config Routines)** (Impact: 15.7)
  * `chill_other_works` **(I/O & Config Routines)** (Impact: 9.5)
  * `proportional_ledger_slash_works` **(I/O & Config Routines)** (Impact: 9.5)
  * `payout_stakers_handles_weight_refund` **(I/O & Config Routines)** (Impact: 9.3)
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (76.2%), Connectivity (formerly Api Exposure) (58.4%), Complexity Load (formerly Cognitive Load) (34.5%)
- **Documentation Coverage:** 87.0588% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sync_cycle_from_offline_to_syncing_to_offline` **(I/O & Config Routines)** (Impact: 13.8)
  ...
  * `syncs_state` **(I/O & Config Routines)** (Impact: 11.7)
  * `can_sync_small_non_best_forks` **(Annotated & Test Methods)** (Impact: 9.2)
  * `can_sync_explicit_forks` **(Annotated & Test Methods)** (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **100**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (78.7%), Debt Markers (formerly Tech Debt) (68.0%), Guard Balance (formerly Safety Score) (41.0%)
- **Documentation Coverage:** 49.6% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **83**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.0%), Connectivity (formerly Api Exposure) (62.2%), Mutation Surface (formerly State Flux) (55.7%)
- **Documentation Coverage:** 50.495% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `child_read_compact_stress_test` **(Type Conversions)** (Impact: 18.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **151**; blast radius 0.594; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (92.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (49.2%), Debt Markers (formerly Tech Debt) (13.7%)
- **Documentation Coverage:** 95.7317% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dispatch_benchmark` **(Generic / Templated Code)** (Impact: 11.7)
  ...
  * `on_unbalanceds` **(Generic / Templated Code)** (Impact: 4.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **71**; blast radius 0.471; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (46.2%), Mutation Surface (formerly State Flux) (36.7%)
- **Documentation Coverage:** 58.0153% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `try_trigger_new_era` **(Stateful Encapsulated Methods)** (Impact: 18.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (47.4%), Guard Balance (formerly Safety Score) (39.4%), Mutation Surface (formerly State Flux) (24.5%)
- **Documentation Coverage:** 12.069% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (60.6%), Mutation Surface (formerly State Flux) (37.7%), Guard Balance (formerly Safety Score) (33.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (80.8%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (44.2%), Guard Balance (formerly Safety Score) (34.3%)
- **Documentation Coverage:** 6.5574% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `can_increase` **(Stateful Encapsulated Methods)** (Impact: 30.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **97**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (54.5%), Connectivity (formerly Api Exposure) (48.7%), Mutation Surface (formerly State Flux) (41.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `report_equivocation` **(Stateful Encapsulated Methods)** (Impact: 26.9)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **70**; blast radius 1.271; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.7%), Guard Balance (formerly Safety Score) (49.2%), Concurrency Surface (formerly Concurrency) (27.9%)
- **Documentation Coverage:** 38.5542% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.471; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (80.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (59.0%), Connectivity (formerly Api Exposure) (44.8%)
