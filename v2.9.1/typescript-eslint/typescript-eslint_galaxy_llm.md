...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2886 analyzed artifact(s), 260790 LOC.
- **Load-bearing artifact:** `packages/ast-spec/src/ast-node-types.ts` -- 171 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `packages/ast-spec/src/unions/Node.ts` -- pulls in 168 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `packages/eslint-plugin/tests/rules/no-floating-promises.test.ts` at magnitude 193447.7 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `8.465`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +8.46; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 59%, Declarative / Non-Code 21%, Compute Cores Files 5%, Large Core Modules (3) 3%, Large Core Modules (2) 3%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.0 | 13.8 | 0.0 | 0.0 |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 71.0 | 2.3 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 26.7 | 0.0 | 0.0 |
...
- `nullishTypeTest` **(Many-Argument Workhorses)** (@ `packages/eslint-plugin/tests/rules/prefer-nullish-coalescing.test.ts`) -> Impact: **2152.8** | LOC: 6315
...
- `isValidEscape` **(Many-Argument Workhorses)** (@ `packages/typescript-estree/src/convert.ts`) -> Impact: **418.9** | LOC: 1590
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (28.8%), Guard Balance (formerly Safety Score) (17.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (42.6%), Concurrency Surface (formerly Concurrency) (12.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.0%), Dead Code Surface (formerly Dead Code) (4.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.7%), Connectivity (formerly Api Exposure) (6.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Complexity Load (formerly Cognitive Load) (5.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (51.0%), Complexity Load (formerly Cognitive Load) (17.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (17.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (62.4%), Guard Balance (formerly Safety Score) (54.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.3%), Complexity Load (formerly Cognitive Load) (4.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.8%), Connectivity (formerly Api Exposure) (12.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (4.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.3%), Connectivity (formerly Api Exposure) (2.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (24.1%), Guard Balance (formerly Safety Score) (21.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (52.5%), Complexity Load (formerly Cognitive Load) (24.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.0%), Complexity Load (formerly Cognitive Load) (12.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (6.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.1%), Concurrency Surface (formerly Concurrency) (21.6%), Connectivity (formerly Api Exposure) (6.6%), Complexity Load (formerly Cognitive Load) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.3%), Concurrency Surface (formerly Concurrency) (12.4%), Connectivity (formerly Api Exposure) (4.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (6.1%), Complexity Load (formerly Cognitive Load) (5.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (67.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (62.7%), Concurrency Surface (formerly Concurrency) (30.0%), Complexity Load (formerly Cognitive Load) (9.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.7%), Concurrency Surface (formerly Concurrency) (28.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.9%), Complexity Load (formerly Cognitive Load) (7.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.8%), Concurrency Surface (formerly Concurrency) (18.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (47.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.3%), Complexity Load (formerly Cognitive Load) (3.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (51.2%), Complexity Load (formerly Cognitive Load) (18.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (4.8%), Connectivity (formerly Api Exposure) (4.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (70.0%), Guard Balance (formerly Safety Score) (50.6%), Connectivity (formerly Api Exposure) (6.8%), Complexity Load (formerly Cognitive Load) (4.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (44.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.3%), Complexity Load (formerly Cognitive Load) (2.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.7%), Guard Balance (formerly Safety Score) (33.1%), Complexity Load (formerly Cognitive Load) (8.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.218; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (48.8%), Concurrency Surface (formerly Concurrency) (14.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.0%), Connectivity (formerly Api Exposure) (9.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- `packages/typescript-estree/src/version-check.ts` -> **Severity: 0.999** (Embedded: 0.0177 * Error Risk: 56.3934%)
- `packages/typescript-estree/src/create-program/shared.ts` -> **Severity: 0.821** (Embedded: 0.0174 * Error Risk: 47.083%)
