...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1324 analyzed artifact(s), 77104 LOC.
- **Load-bearing artifact:** `packages/puppeteer/src/puppeteer.ts` -- 51 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `website/versioned_docs/version-24.40.0/api/index.md` -- pulls in 223 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `test/src/network.spec.ts` at magnitude 8343.78 (structural weight, not risk).
...
> **Composition Archetype:** `Hub-Coupled App` (z +5.26; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 69%, Declarative / Non-Code 11%, Large Core Modules (3) 5%, Callbacks & Closures Files 4%, Large Core Modules (2) 3%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 98.2 | 29.7 | 28.3 | 0.0 |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 89.8 | 4.6 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 32.1 | 0.0 | 0.0 |
...
- `getEscapedText` **(Many-Argument Workhorses)** (@ `tools/docgen/src/custom_markdown_documenter.ts`) -> Impact: **390.9** | LOC: 1538
...
- `SearchPageContent` **(I/O & Config Routines)** (@ `website/src/theme/SearchPage/index.js`) -> Impact: **61.5** | LOC: 390
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (59.0%), Complexity Load (formerly Cognitive Load) (49.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (11.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.4%), Guard Balance (formerly Safety Score) (29.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (6.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.0%), Guard Balance (formerly Safety Score) (40.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (6.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (58.0%), Complexity Load (formerly Cognitive Load) (45.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (5.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_12` (Drift: 0.0 IQR)
- **Magnitude:** 1568.19 | **LOC:** 1014 | **CtrlFlow:** 1.5% | **Authorship Centralization:** 60.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (42.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (23.1%), Complexity Load (formerly Cognitive Load) (19.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (40.9%), Concurrency Surface (formerly Concurrency) (27.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (24.5%), Complexity Load (formerly Cognitive Load) (9.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (83.5%), Complexity Load (formerly Cognitive Load) (38.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (6.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.4%), Guard Balance (formerly Safety Score) (44.9%), Connectivity (formerly Api Exposure) (2.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.4%), Guard Balance (formerly Safety Score) (35.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (34.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `task` **(Callbacks & Closures)** (Impact: 5.5)
  * `onResponse` **(Callbacks & Closures)** (Impact: 4.2)
  * `checkMetrics` **(I/O & Config Routines)** (Impact: 4.0)
  * `onResponse` **(Callbacks & Closures)** (Impact: 3.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (80.0%), Complexity Load (formerly Cognitive Load) (47.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (45.4%), Guard Balance (formerly Safety Score) (41.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (31.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 8 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.1%), Guard Balance (formerly Safety Score) (44.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (45.9%), Guard Balance (formerly Safety Score) (16.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (85.3%), Connectivity (formerly Api Exposure) (71.8%), Guard Balance (formerly Safety Score) (63.8%)
- **Documentation Coverage:** 11.5789% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `select` **(Compute Cores)** (Impact: 16.3)
    * *Intent:* * * * ```ts * handle.select('blue'); // single selection * handle.select('red', 'green', 'blue'); //...
  ...
  * `drag` **(Defensive Guards)** (Impact: 11.8)
    * *Intent:* /** * Drags an element over the given element or point. * * returned. */
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (86.7%), Complexity Load (formerly Cognitive Load) (81.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.1%)
- **Documentation Coverage:** 90.0709% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `emulateNetworkConditions` **(Defensive Guards)** (Impact: 43.0)
  * `setViewport` **(Defensive Guards)** (Impact: 37.7)
  * `setUserAgent` **(Defensive Guards)** (Impact: 31.7)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (49.9%), Complexity Load (formerly Cognitive Load) (47.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (5.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (88.8%), Guard Balance (formerly Safety Score) (57.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (51.1%)
- **Documentation Coverage:** 3.0612% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `on` **(Generic / Templated Code)** (Impact: 6.5)
    * *Intent:* /** * Listen to page events. * * This method exists to define event typings and handle proper wireup...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **50**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (80.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (66.3%), Connectivity (formerly Api Exposure) (65.2%)
- **Documentation Coverage:** 89.6774% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onConsoleAPI` **(Stateful Encapsulated Methods)** (Impact: 17.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (39.7%), Complexity Load (formerly Cognitive Load) (29.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (6.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.436; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (63.9%), Complexity Load (formerly Cognitive Load) (49.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `queryOne` **(Type Conversions)** (Impact: 7.3)
  * `queryOne` **(Callbacks & Closures)** (Impact: 4.6)
  * `queryOne` **(Defensive Guards)** (Impact: 3.2)
    * *Intent:* // Register.
  * `queryAll` **(Callbacks & Closures)** (Impact: 2.8)
  * `makeQuad` **(Parameter Forwarders)** (Impact: 2.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (25.2%), Guard Balance (formerly Safety Score) (24.4%), Dead Code Surface (formerly Dead Code) (9.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.436; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (47.2%), Guard Balance (formerly Safety Score) (46.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (21.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pathToFileURL` **(Compute Cores)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- `packages/puppeteer-core/src/cdp/Page.ts` -> Churn: **66.34%** | Cog Load: 80.7936% | Debt: 8.6961%
- `packages/puppeteer-core/Herebyfile.mjs` -> Churn: **63.57%** | Cog Load: 82.7828% | Debt: 0.0%
- `packages/puppeteer-core/src/bidi/Page.ts` -> Churn: **57.11%** | Cog Load: 81.3266% | Debt: 10.1521%
