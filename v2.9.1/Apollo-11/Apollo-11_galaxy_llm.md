...
## 1. EXECUTIVE SUMMARY
- **Scope:** 246 analyzed artifact(s), 74054 LOC.
...
- **Top orchestrator:** `Comanche055/P32-P33_P72-P73.agc` -- pulls in 31 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `Comanche055/PINBALL_GAME_BUTTONS_AND_LIGHTS.agc` at magnitude 1585.62 (structural weight, not risk).
...
> **Composition Archetype:** `Mid Flat Project` (z +1.96; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 33%, Large Core Modules (3) 19%, Interface Declarations Files 18%, Large Core Modules 17%, Declarative / Non-Code 7%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 50.0 | 38.4 | 43.6 | 50.0 |
...
- `CSISTEP` **(I/O & Config Routines)** (@ `Comanche055/P32-P33_P72-P73.agc`) -> Impact: **21.9** | LOC: 297
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.6%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (77.5%)
- **Documentation Coverage:** 45.0649% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.0%), Concurrency Surface (formerly Concurrency) (81.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.6%)
- **Documentation Coverage:** 44.1281% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `R61LEM2` **(Defensive Guards)** (Impact: 11.9)
  * `CHKSRCH` **(I/O & Config Routines)** (Impact: 11.7)
  ...
  * `RENDRAD` **(Compute Cores)** (Impact: 9.1)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.3%)
- **Documentation Coverage:** 40.2406% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `BHIZ` **(Compute Cores)** (Impact: 11.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (49.3%)
- **Documentation Coverage:** 40.5585% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `MAXDV` **(I/O & Config Routines)** (Impact: 15.4)
    * *Intent:* # Page 1170 # IF THE MAJOR PARTS OF THE DIVISOR AND DIVIDEND ARE EQUAL, BUT THE MINOR PARTS ARE SUCH...
  * `BHIZ` **(Compute Cores)** (Impact: 11.6)
  * `UNIT` **(Compute Cores)** (Impact: 8.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.9%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (75.3%), Guard Balance (formerly Safety Score) (66.0%)
- **Documentation Coverage:** 45.2941% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Mutation Surface (formerly State Flux) (97.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (70.7%)
- **Documentation Coverage:** 42.0635% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ENDV97E` **(I/O & Config Routines)** (Impact: 14.5)
  * `TOGETHER` **(Compute Cores)** (Impact: 14.5)
  * `RATEZRO` **(I/O & Config Routines)** (Impact: 12.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Concurrency Surface (formerly Concurrency) (80.8%), Guard Balance (formerly Safety Score) (80.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 43.0435% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (96.3%), Mutation Surface (formerly State Flux) (95.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.7%), Concurrency Surface (formerly Concurrency) (81.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 42.9577% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `EXDAP2` **(Compute Cores)** (Impact: 12.1)
  * `COMPAT` **(Compute Cores)** (Impact: 11.5)
  * `NOTYET` **(Many-Argument Workhorses)** (Impact: 11.0)
  * `BIASEDZ` **(Compute Cores)** (Impact: 9.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.3%)
- **Documentation Coverage:** 45.7831% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Concurrency Surface (formerly Concurrency) (83.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.9%)
- **Documentation Coverage:** 42.963% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (33.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (44.2%)
- **Documentation Coverage:** 46.3636% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.5%), Concurrency Surface (formerly Concurrency) (56.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.1%), Concurrency Surface (formerly Concurrency) (83.2%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (63.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.5%), Complexity Load (formerly Cognitive Load) (48.3%)
- **Documentation Coverage:** 45.4955% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Debt Markers (formerly Tech Debt) (97.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `MAKEMARK` **(Compute Cores)** (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Debt Markers (formerly Tech Debt) (96.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.5%)
- **Documentation Coverage:** 44.0789% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `NORMRET` **(Defensive Guards)** (Impact: 9.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (67.7%), Concurrency Surface (formerly Concurrency) (17.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.8%), Guard Balance (formerly Safety Score) (66.9%), Concurrency Surface (formerly Concurrency) (61.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.9%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (56.8%)
- **Documentation Coverage:** 36.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.9%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (57.1%)
- **Documentation Coverage:** 35.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GSELECT` **(Compute Cores)** (Impact: 8.0)
  * `8192AUG` **(Compute Cores)** (Impact: 5.2)
  * `IMUZEROA` **(Compute Cores)** (Impact: 5.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (99.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.7%)
- **Documentation Coverage:** 43.6047% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P40AUTO` **(Compute Cores)** (Impact: 6.4)
  * `CLOKJOB` **(Compute Cores)** (Impact: 6.0)
  * `IGNITE` **(Defensive Guards)** (Impact: 4.1)
  * `TIG-35` **(Compute Cores)** (Impact: 4.0)
    * *Intent:* # ********************************
  * `TIG-30` **(Compute Cores)** (Impact: 4.0)
    * *Intent:* # ********************************
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
* *Amplified Race Conditions:* 17 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 4.049; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (48.1%)
