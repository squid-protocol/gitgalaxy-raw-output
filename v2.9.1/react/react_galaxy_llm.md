...
## 1. EXECUTIVE SUMMARY
- **Scope:** 6335 analyzed artifact(s), 588053 LOC.
- **Load-bearing artifact:** `compiler/packages/snap/src/sprout/shared-runtime.ts` -- 550 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `packages/react-reconciler/src/ReactFiberWorkLoop.js` -- pulls in 59 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `packages/react-devtools-shared/src/backend/fiber/renderer.js` at magnitude 6545.86 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `6.22`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +6.22; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 44%, Callbacks & Closures Files 12%, Large Core Modules (2) 9%, Parameter Forwarders Files 8%, Declarative / Non-Code 7%
...
- `.map`: 68x Excluded (Saturation: Line 1 exceeds 500 chars)
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.9 | 38.4 | 51.9 | 0.0 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 25.8 | 2.8 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 3.1 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 51.7 | 50.0 | 50.0 |
...
- `create` **(Many-Argument Workhorses)** (@ `packages/eslint-plugin-react-hooks/src/rules/ExhaustiveDeps.ts`) -> Impact: **528.0** | LOC: 1453
- `createChildReconciler` **(Many-Argument Workhorses)** (@ `packages/react-reconciler/src/ReactChildFiber.js`) -> Impact: **510.7** | LOC: 1672
...
- **Magnitude:** 6545.86 | **LOC:** 8154 | **CtrlFlow:** 24.8% | **Authorship Centralization:** 51.2%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **25**; blast radius 0.132; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (60.7%), Guard Balance (formerly Safety Score) (59.3%)
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **26**; blast radius 0.552; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (73.2%), Connectivity (formerly Api Exposure) (71.8%)
- **Documentation Coverage:** 99.1071% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **46** in-repo importer(s); it depends on **23**; blast radius 2.104; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (81.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (81.7%), Guard Balance (formerly Safety Score) (64.8%)
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 4367.24 | **LOC:** 6652 | **CtrlFlow:** 23.8% | **Authorship Centralization:** 45.0%
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **42**; blast radius 0.364; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Connectivity (formerly Api Exposure) (87.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (80.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 99.7585% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **22** in-repo importer(s); it depends on **24**; blast radius 1.021; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (74.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (73.3%), Connectivity (formerly Api Exposure) (59.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **15** in-repo importer(s); it depends on **19**; blast radius 0.559; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.7%)
- **Documentation Coverage:** 99.2647% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Magnitude:** 3216.3 | **LOC:** 5350 | **CtrlFlow:** 25.1% | **Authorship Centralization:** 25.0%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **30**; blast radius 0.119; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.7%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (50.9%), Guard Balance (formerly Safety Score) (48.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 3112.02 | **LOC:** 5622 | **CtrlFlow:** 19.9% | **Authorship Centralization:** 70.6%
- **Blast Radius:** changing it is visible to **25** in-repo importer(s); it depends on **59**; blast radius 0.69; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (81.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (76.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.109; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (65.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `App` **(I/O & Config Routines)** (Impact: 11.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **25**; blast radius 0.194; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (74.9%), Guard Balance (formerly Safety Score) (53.4%), Connectivity (formerly Api Exposure) (34.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_8` (Drift: 0.0 IQR)
- **Magnitude:** 2692.64 | **LOC:** 4556 | **CtrlFlow:** 23.2% | **Authorship Centralization:** 55.6%
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 0.135; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (67.2%), Guard Balance (formerly Safety Score) (46.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (43.3%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **45**; blast radius 0.134; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (58.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 0.133; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (68.1%), Complexity Load (formerly Cognitive Load) (52.5%)
...
**Top Internal Functions/Classes:**
  * `visitFunctionWithDependencies` **(Many-Argument Workhorses)** (Impact: 737.2)
    * *Intent:* /** * Visitor for both function expressions and arrow function expressions. */
  * `create` **(Many-Argument Workhorses)** (Impact: 528.0)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **18**; blast radius 0.126; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (62.1%), Guard Balance (formerly Safety Score) (58.2%), Connectivity (formerly Api Exposure) (32.2%)
- **Documentation Coverage:** 97.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createChildReconciler` **(Many-Argument Workhorses)** (Impact: 510.7)
...
- **Global Archetype:** `file_cluster_8` (Drift: 0.0 IQR)
- **Magnitude:** 2141.82 | **LOC:** 2976 | **CtrlFlow:** 25.2% | **Authorship Centralization:** 75.0%
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **10**; blast radius 0.205; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.7%), Complexity Load (formerly Cognitive Load) (64.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.109; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (100.0%), Complexity Load (formerly Cognitive Load) (89.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dispatchMouseEvent` **(Many-Argument Workhorses)** (Impact: 11.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 0.125; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (55.4%)
- **Documentation Coverage:** 50.9615% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **34**; blast radius 0.366; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `useMemoCache` **(Defensive Guards)** (Impact: 29.6)
  * `areHookInputsEqual` **(Many-Argument Workhorses)** (Impact: 19.7)
  * `updateWorkInProgressHook` **(I/O & Config Routines)** (Impact: 17.5)
  * `warnOnHookMismatchInDev` **(Compute Cores)** (Impact: 13.6)
  * `requestFormReset` **(I/O & Config Routines)** (Impact: 12.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **15**; blast radius 0.146; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (73.7%), Complexity Load (formerly Cognitive Load) (61.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `codegenInstructionNullable` **(Many-Argument Workhorses)** (Impact: 85.6)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **1**; blast radius 0.484; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.6%), Guard Balance (formerly Safety Score) (93.9%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (39.4%)
- **Documentation Coverage:** 95.5801% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `scryptSync` **(Compute Cores)** (Impact: 23.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.109; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (99.5%), Complexity Load (formerly Cognitive Load) (89.3%), Mutation Surface (formerly State Flux) (83.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dispatchMouseEvent` **(Many-Argument Workhorses)** (Impact: 11.2)
  * `Child` **(Defensive Guards)** (Impact: 7.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.109; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Debt Markers (formerly Tech Debt) (99.9%), Mutation Surface (formerly State Flux) (99.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.109; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (50.5%), Complexity Load (formerly Cognitive Load) (27.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `packages/react-client/src/ReactFlightClient.js` -> Churn: **83.98%** | Cog Load: 66.1086% | Debt: 23.0916%
- `packages/react-devtools-shared/src/devtools/store.js` -> Churn: **81.68%** | Cog Load: 82.6728% | Debt: 11.1189%
- `packages/react-server/src/ReactFlightServer.js` -> Churn: **81.68%** | Cog Load: 81.7465% | Debt: 23.1855%
- `packages/react-dom-bindings/src/client/ReactFiberConfigDOM.js` -> Churn: **80.45%** | Cog Load: 71.1909% | Debt: 14.9235%
...
- `compiler/packages/snap/src/sprout/shared-runtime.ts` -> **Severity: 7.359** (Embedded: 0.0868 * Error Risk: 84.7517%)
