...
## 1. EXECUTIVE SUMMARY
- **Scope:** 41 analyzed artifact(s), 3213 LOC.
- **Load-bearing artifact:** `defusedxml-0.7.1/defusedxml/common.py` -- 8 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `defusedxml-0.7.1/tests.py` -- pulls in 14 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `defusedxml-0.7.1/README.html` at magnitude 658.7 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.177`
> **Composition Archetype:** `Small Flat Repo` (z +3.18; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 51%, Parameter Forwarders Files 22%, Declarative / Non-Code 12%, Many-Argument Workhorses Files 7%, Interface Declarations Files 2%
...
|---|---|---|
| Unclassified | 35 | 85.4% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 6 | 14.6% |
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 80.2 | 16.5 | 0.0 | 0.0 |
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 98.9 | 53.3 | 64.6 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 99.8 | 21.5 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 2.3 | 80.0 | 6.8 | 2.3 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 62.1 | 10.6 | 0.0 | 0.0 |
| Concurrency Surface (formerly Concurrency Exposure) | 0.0 | 99.8 | 2.9 | 0.0 | 0.0 |
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 48.3 | 50.0 | 0.0 |
| Dead Code Surface (formerly Commented Logic Exposure) | 0.0 | 64.6 | 3.0 | 0.0 | 0.0 |
...
| guards | 42 | 7 | 4 | `defusedxml-0.7.1/tests.py` |
| danger | 55 | 14 | 4 | `defusedxml-0.7.1/defusedxml/xmlrpc.py` |
| concurrency | 3 | 1 | 0 | `defusedxml-0.7.1/defusedxml/lxml.py` |
| connectivity | 273 | 16 | 11 | `defusedxml-0.7.1/README.html` |
| io | 361 | 12 | 3 | `defusedxml-0.7.1/README.html` |
| crypto | 0 | 0 | 0 | - |
| ipc | 22 | 4 | 0 | `defusedxml-0.7.1/tests.py` |
| time | 0 | 0 | 0 | - |
| serialization | 2 | 2 | 0 | `defusedxml-0.7.1/Makefile` |
| regex | 1 | 1 | 0 | `defusedxml-0.7.1/Makefile` |
| events | 15 | 4 | 0 | `defusedxml-0.7.1/other/python_external.py` |
| tests | 42 | 1 | 0 | `defusedxml-0.7.1/tests.py` |
| docs | 41 | 16 | 3 | `defusedxml-0.7.1/defusedxml/common.py` |
| debt | 22 | 11 | 1 | `defusedxml-0.7.1/README.html` |
| mutation | 1028 | 24 | 55 | `defusedxml-0.7.1/README.html` |
| dead_code | 49 | 10 | 3 | `defusedxml-0.7.1/tests.py` |
| credential | 3 | 1 | 0 | `defusedxml-0.7.1/README.html` |
| threat | 3 | 2 | 0 | `defusedxml-0.7.1/defusedxml/common.py` |
| ml_ai | 4 | 3 | 0 | `defusedxml-0.7.1/setup.py` |
| ui | 73 | 1 | 0 | `defusedxml-0.7.1/README.html` |
...
- `defusedxml-0.7.1/README.html` (Hits: 324)
...
- `_generate_etree_functions` **(Stateful Encapsulated Methods)** (@ `defusedxml-0.7.1/defusedxml/common.py`) -> Impact: **8.8** | LOC: 42
...
|---|---|---|---|---|
| `defusedxml-0.7.1` | 10 | 1118.13 | 9.09% | 30.19% |
...
### `defusedxml-0.7.1/README.html` (HTML | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_13` (Drift: 0.0 IQR)
- **Magnitude:** 658.7 | **LOC:** 1445 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.3%), Debt Markers (formerly Tech Debt) (8.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 434`, `args: 82`, `func_start: 1`, `class_start: 173`
* *Risk/State:* `planned_debt: 5`
* *Architecture:* `io: 324`, `api: 124`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (85.0%), Complexity Load (formerly Cognitive Load) (80.2%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decode_response` **(Compute Cores)** (Impact: 7.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (56.1%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.8%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_filter` **(Stateful Encapsulated Methods)** (Impact: 5.5)
  * `parse` **(Parameter Forwarders)** (Impact: 5.2)
  * `fromstring` **(Parameter Forwarders)** (Impact: 5.2)
  * `createDefaultParser` **(Parameter Forwarders)** (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **6**; blast radius 31.345; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.4%), Complexity Load (formerly Cognitive Load) (70.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (98.4%), Guard Balance (formerly Safety Score) (94.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **2**; blast radius 145.853; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.4%), Connectivity (formerly Api Exposure) (62.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 90.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_generate_etree_functions` **(Stateful Encapsulated Methods)** (Impact: 8.8)
    * *Intent:* """Factory for functions needed by etree, dependent on whether cElementTree or ElementTree is used."...
  * `_apply_defusing` **(Stateful Encapsulated Methods)** (Impact: 6.2)
  * `iterparse` **(Many-Argument Workhorses)** (Impact: 6.1)
  * `parse` **(Parameter Forwarders)** (Impact: 5.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (98.9%), Guard Balance (formerly Safety Score) (87.4%), Complexity Load (formerly Cognitive Load) (50.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (89.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `startElement` **(Compute Cores)** (Impact: 6.2)
  * `weatherResponse` **(Compute Cores)** (Impact: 4.6)
  * `characters` **(Parameter Forwarders)** (Impact: 3.6)
  * `endElement` **(Parameter Forwarders)** (Impact: 1.9)
  * `__init__` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (43.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 20.007; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 20.007; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **4**; blast radius 62.523; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (44.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parseString` **(Many-Argument Workhorses)** (Impact: 6.4)
  * `parse` **(Many-Argument Workhorses)** (Impact: 3.4)
  * `make_parser` **(Parameter Forwarders)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 20.007; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (92.4%), Guard Balance (formerly Safety Score) (59.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.3%), Guard Balance (formerly Safety Score) (82.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (9.6%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.0%), Guard Balance (formerly Safety Score) (66.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (3.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 20.007; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (31.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Dead Code Surface (formerly Dead Code) (64.6%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 20.007; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.4%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 20.007; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.9%), Guard Balance (formerly Safety Score) (91.1%), Mutation Surface (formerly State Flux) (77.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run` **(Parameter Forwarders)** (Impact: 1.6)
  * `initialize_options` **(Parameter Forwarders)** (Impact: 1.5)
  * `finalize_options` **(Parameter Forwarders)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
