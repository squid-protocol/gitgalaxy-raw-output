...
## 1. EXECUTIVE SUMMARY
- **Scope:** 18049 analyzed artifact(s), 5870697 LOC.
- **Load-bearing artifact:** `sdk/include/psdk/windef.h` -- 1691 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `sdk/lib/drivers/wdf/shared/inc/private/common/fxmin.hpp` -- pulls in 151 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `sdk/lib/3rdparty/libxml2/xmlschemas.c` at magnitude 21949.04 (structural weight, not risk).
...
|---|---|---|---|
| C | 12996 | 5145539 | 72.0% |
| CPP | 2846 | 654904 | 15.8% |
| PLAINTEXT | 1566 | 0 | 8.7% |
| ASSEMBLY | 331 | 30943 | 1.8% |
| MAKEFILE | 65 | 3857 | 0.4% |
| XML | 59 | 0 | 0.3% |
| MARKDOWN | 39 | 0 | 0.2% |
| BATCH | 25 | 2643 | 0.1% |
| SHELL | 19 | 2980 | 0.1% |
...
> **Architectural Drift Z-Score:** `4.569`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +4.57; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 28%, Data / Markup / Trivial 16%, Many-Argument Workhorses Files 15%, Large Core Modules (3) 11%, Compute Cores Files 7%
...
|---|---|---|
| Unclassified | 16426 | 91.0% |
| Unknown | 18 | 0.1% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 1605 | 8.9% |
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 50.7 | 67.3 | 0.0 |
...
| Mutation Surface (formerly State Flux Exposure) | 0.0 | 100.0 | 50.8 | 55.6 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 56.3 | 100.0 | 100.0 |
...
|---|---|---|---|---|
| memory | 1458031 | 12458 | 201 | `modules/rostests/winetests/uiautomationcore/uiautomation.c` |
...
| connectivity | 166591 | 11619 | 21 | `sdk/include/wine/winternl.h` |
| io | 4623 | 533 | 0 | `modules/rosapps/applications/net/dhcpd/configure` |
| crypto | 0 | 0 | 0 | - |
...
| docs | 48106 | 3814 | 4 | `sdk/include/reactos/x86x64/Intel/ArchitecturalMsr.h` |
| debt | 40892 | 4797 | 4 | `dll/win32/dbgeng/dbgeng.c` |
| mutation | 1409669 | 10780 | 199 | `modules/rostests/winetests/msxml3/domdoc.c` |
...
| ui | 516 | 137 | 0 | `modules/rosapps/applications/net/ncftp/sio/sio.html` |
...
- `sdk/lib/ucrt/string/amd64/strncat.s` -> **100.0%** Exposure
- `sdk/lib/ucrt/string/amd64/strncpy.s` -> **100.0%** Exposure
...
- **Unknown Dependencies:** `53944` packages imported that bypass the Zero-Trust whitelist.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.026; role: Pure Consumer (Orchestrator)
...
- **Documentation Coverage:** 50.0693% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.9%)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Complexity Load (formerly Cognitive Load) (83.0%), Debt Markers (formerly Tech Debt) (13.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.3%)
- **Documentation Coverage:** 3.0501% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (57.0%)
- **Documentation Coverage:** 6.1966% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `xmlXPathCmpNodesExt` **(Many-Argument Workhorses)** (Impact: 180.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (61.8%)
- **Documentation Coverage:** 0.5181% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `xmlRelaxNGParsePattern` **(Many-Argument Workhorses)** (Impact: 189.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Complexity Load (formerly Cognitive Load) (89.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 87.4644% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.9%)
- **Documentation Coverage:** 34.0909% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.2%)
- **Documentation Coverage:** 24.5658% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (64.4%), Connectivity (formerly Api Exposure) (36.8%)
- **Documentation Coverage:** 33.0097% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.5%), Complexity Load (formerly Cognitive Load) (87.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 91.3183% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.026; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Complexity Load (formerly Cognitive Load) (93.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.0%), Complexity Load (formerly Cognitive Load) (92.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 88.169% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.3%)
- **Documentation Coverage:** 12.6638% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `compare_uris` **(Many-Argument Workhorses)** (Impact: 130.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Debt Markers (formerly Tech Debt) (86.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 94.8649% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 0.069; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (39.6%), Connectivity (formerly Api Exposure) (25.2%), Complexity Load (formerly Cognitive Load) (6.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (83.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 18.7302% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `xmlSchemaCompareDates` **(Many-Argument Workhorses)** (Impact: 192.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (80.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (30.8%)
- **Documentation Coverage:** 98.3936% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_PeekMessage` **(I/O & Config Routines)** (Impact: 86.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Complexity Load (formerly Cognitive Load) (86.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 5.098% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `drv_cleanup` **(Many-Argument Workhorses)** (Impact: 117.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.026; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.7%), Complexity Load (formerly Cognitive Load) (84.9%), Debt Markers (formerly Tech Debt) (10.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `ClassDispatchPnp` **(Many-Argument Workhorses)** (Impact: 265.2)
    * *Intent:* --*/
  * `ClassPnpStartDevice` **(Many-Argument Workhorses)** (Impact: 143.6)
    * *Intent:* --*/
**Contextual Mitigations & Amplifications:**
...
- `base/applications/network/netsh/context.c` -> Churn: **79.57%** | Cog Load: 62.2166% | Debt: 15.5838%
