# ARCHITECTURAL_BRIEF: @devlikeapro_n8n-openapi-node
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2 analyzed artifact(s), 429 LOC.
...
- **Top orchestrator:** `package/README.md` -- pulls in 5 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/README.md` at magnitude 7.56 (structural weight, not risk).
...
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 2 | 100.0% |
...
1. **README.md** (`package/README.md`) — 5 outbound dependencies
...
- **Magnitude:** 7.56 | **LOC:** 378 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 500.0; role: Isolated/Orphan
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` n8n.png, node.png, openapi.png, OperationParser.ts, ResourceParser.ts
