# ARCHITECTURAL_BRIEF: node-opcua-pki
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 13 LOC.
...
- **Heaviest artifact:** `package/bin/pki_config.example.js` at magnitude 17.26 (structural weight, not risk).
...
- `.ts`: 2x Unsupported Format (.undeterminable)
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 1 | 1 | 1 | `package/bin/pki_config.example.js` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| docs | 0 | 0 | 0 | - |
| debt | 0 | 0 | 0 | - |
| mutation | 1 | 1 | 1 | `package/bin/pki_config.example.js` |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
| threat | 0 | 0 | 0 | - |
| ml_ai | 0 | 0 | 0 | - |
...
- `package/bin/pki_config.example.js` (Hits: 0)
...
2. **pki_config.example.js** (`package/bin/pki_config.example.js`) — 0 outbound dependencies
...
|---|---|---|---|---|
| `package/bin` | 1 | 17.26 | 0.0% | 0.0% |
| `package` | 2 | 6.1 | 0.0% | 0.0% |

## 10. TARGETED STRUCTURAL SURFACE VECTORS (formerly Risk Vectors, Top 5 by Surface)
### Highest Mutation Surface (formerly State Flux; Mutation/Volatility)
- `package/bin/pki_config.example.js` -> **16.7982%** Exposure
...
### `package/bin/pki_config.example.js` (JAVASCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_2` (Drift: 0.0 IQR)
- **Magnitude:** 17.26 | **LOC:** 17 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
- **Magnitude:** 5.0 | **LOC:** 250 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 333.333
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` certificate-authority.md, certificate-manager.md
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
