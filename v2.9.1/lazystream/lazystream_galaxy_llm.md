# ARCHITECTURAL_BRIEF: lazystream
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2 analyzed artifact(s), 162 LOC.
...
- **Heaviest artifact:** `package/README.md` at magnitude 2.3 (structural weight, not risk).
