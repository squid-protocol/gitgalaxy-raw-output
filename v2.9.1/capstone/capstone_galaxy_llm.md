...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2035 analyzed artifact(s), 208636 LOC.
- **Load-bearing artifact:** `include/capstone/capstone.h` -- 166 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `suite/auto-sync/src/autosync/cpptranslator/CppTranslator.py` -- pulls in 77 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `arch/ARM/ARMDisassembler.c` at magnitude 6158.32 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `5.869`
> **Composition Archetype:** `Hub-Coupled App` (z +5.87; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 46%, Declarative / Non-Code 36%, Generic / Templated Code Files 3%, Large Core Modules (3) 3%, Compute Cores Files 3%
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.1%), Complexity Load (formerly Cognitive Load) (62.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.3%), Mutation Surface (formerly State Flux) (30.8%), Complexity Load (formerly Cognitive Load) (25.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `decode_alu` **(Many-Argument Workhorses)** (Impact: 124.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (81.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (44.1%)
- **Documentation Coverage:** 54.9451% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Complexity Load (formerly Cognitive Load) (93.2%), Guard Balance (formerly Safety Score) (90.7%)
- **Documentation Coverage:** 99.7319% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `update_am_reg_list` **(Stateful Encapsulated Methods)** (Impact: 35.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.1%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (66.7%)
- **Documentation Coverage:** 10.3448% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **35**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (87.7%), Complexity Load (formerly Cognitive Load) (73.0%)
- **Documentation Coverage:** 49.4624% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.5%), Complexity Load (formerly Cognitive Load) (89.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.5507% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.4%), Complexity Load (formerly Cognitive Load) (51.3%)
- **Documentation Coverage:** 97.541% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (80.6%), Complexity Load (formerly Cognitive Load) (80.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.2301% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `printInst` **(Many-Argument Workhorses)** (Impact: 403.3)
  * `getNextVectorRegister` **(Many-Argument Workhorses)** (Impact: 159.9)
  * `printVectorList` **(Many-Argument Workhorses)** (Impact: 93.9)
  * `printSysAlias` **(Many-Argument Workhorses)** (Impact: 93.7)
  * `printMemExtendImpl` **(Stateful Encapsulated Methods)** (Impact: 27.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.2%), Complexity Load (formerly Cognitive Load) (46.4%)
- **Documentation Coverage:** 54.878% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (52.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `translateRMMemory` **(Many-Argument Workhorses)** (Impact: 78.3)
  ...
  * `translateOperand` **(Many-Argument Workhorses)** (Impact: 46.6)
    * *Intent:* /// translateOperand - Translates an operand stored in an internal instruction /// to LLVM's format ...
  * `translateRM` **(Stateful Encapsulated Methods)** (Impact: 41.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.0%), Complexity Load (formerly Cognitive Load) (85.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 83.92% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_cs_disasm` **(Many-Argument Workhorses)** (Impact: 428.8)
  * `ocaml_cs_disasm` **(Many-Argument Workhorses)** (Impact: 117.9)
  * `ocaml_open` **(Many-Argument Workhorses)** (Impact: 85.3)
  * `ocaml_option` **(Compute Cores)** (Impact: 19.7)
  * `list_count` **(Stateful Encapsulated Methods)** (Impact: 5.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (54.7%), Complexity Load (formerly Cognitive Load) (26.9%), Debt Markers (formerly Tech Debt) (8.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (71.1%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **25**; blast radius 0.318; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (50.3%), Guard Balance (formerly Safety Score) (48.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (39.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.5%), Guard Balance (formerly Safety Score) (89.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_varuint64` **(Stateful Encapsulated Methods)** (Impact: 15.4)
    * *Intent:* // input | code : code pointer start from varuint64 // | code_len : real code len count from varint ...
  * `get_varuint32` **(Stateful Encapsulated Methods)** (Impact: 15.3)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (75.6%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 20 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.0%), Complexity Load (formerly Cognitive Load) (32.7%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **14**; blast radius 0.305; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Debt Markers (formerly Tech Debt) (90.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `printopaquemem` **(Many-Argument Workhorses)** (Impact: 64.8)
  * `printMemReference` **(Many-Argument Workhorses)** (Impact: 55.9)
  * `_printOperand` **(Stateful Encapsulated Methods)** (Impact: 38.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Debt Markers (formerly Tech Debt) (88.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (77.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `printopaquemem` **(Many-Argument Workhorses)** (Impact: 85.8)
  * `printMemReference` **(Many-Argument Workhorses)** (Impact: 54.1)
  * `printanymem` **(Stateful Encapsulated Methods)** (Impact: 31.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Debt Markers (formerly Tech Debt) (94.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (78.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `decodeBranchOperand` **(Stateful Encapsulated Methods)** (Impact: 25.8)
  * `readInstruction24` **(Stateful Encapsulated Methods)** (Impact: 12.9)
    * *Intent:* /// Read three bytes from the ArrayRef and return 24 bit data
  * `DecodeSRRegisterClass` **(Stateful Encapsulated Methods)** (Impact: 12.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.231; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (59.3%), Mutation Surface (formerly State Flux) (48.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `printRegImmShift` **(Stateful Encapsulated Methods)** (Impact: 23.1)
    * *Intent:* /// Prints the shift value with an immediate value.
  * `printModImmOperand` **(Stateful Encapsulated Methods)** (Impact: 18.3)
  * `printOperandAddr` **(Stateful Encapsulated Methods)** (Impact: 14.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 0.355; role: Transceiver (Middle-Tier)
...
**Top Internal Functions/Classes:**
  ...
  * `write_to_build_dir` **(Many-Argument Workhorses)** (Impact: 34.9)
