...
## 1. EXECUTIVE SUMMARY
- **Scope:** 6 analyzed artifact(s), 619 LOC.
...
- **Top orchestrator:** `package/boot.js` -- pulls in 13 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/boot.js` at magnitude 647.62 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 50%, Large Core Modules (2) 17%, Large Core Modules (3) 17%, State Mutators Files 17%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 47.4 | 44.8 | 44.5 |
...
- `Boot` **(Many-Argument Workhorses)** (@ `package/boot.js`) -> Impact: **38.6** | LOC: 93
- `avvio` **(Generic / Templated Code)** (@ `package/index.d.ts`) -> Impact: **34.5** | LOC: 90
- `closeWithCbOrNextTick` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **27.6** | LOC: 32
- `encapsulateThreeParam` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **27.6** | LOC: 33
- `_encapsulateThreeParam` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **27.4** | LOC: 28
- `encapsulateTwoParam` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **20.5** | LOC: 28
- `_encapsulateTwoParam` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **20.3** | LOC: 25
- `_addPlugin` **(Many-Argument Workhorses)** (@ `package/boot.js`) -> Impact: **19.8** | LOC: 35
- `_loadPlugin` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **19.6** | LOC: 45
  * *Intent:* /** */ /** * Load a plugin * */
- `_expose` **(Defensive Guards)** (@ `package/boot.js`) -> Impact: **18.8** | LOC: 75
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 166.667; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.9%), Complexity Load (formerly Cognitive Load) (85.5%), Guard Balance (formerly Safety Score) (81.1%)
- **Documentation Coverage:** 44.5455% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Boot` **(Many-Argument Workhorses)** (Impact: 38.6)
  * `closeWithCbOrNextTick` **(Defensive Guards)** (Impact: 27.6)
  * `encapsulateThreeParam` **(Defensive Guards)** (Impact: 27.6)
  * `_encapsulateThreeParam` **(Defensive Guards)** (Impact: 27.4)
  * `encapsulateTwoParam` **(Defensive Guards)** (Impact: 20.5)
...
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (97.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `a` **(Callbacks & Closures)** (Impact: 6.2)
  * `b` **(Callbacks & Closures)** (Impact: 6.2)
  * `c` **(Callbacks & Closures)** (Impact: 6.2)
  * `duplicate` **(State Mutators)** (Impact: 4.3)
  * `a` **(State Mutators)** (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 166.667; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.0%), Guard Balance (formerly Safety Score) (50.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Concurrency Surface (formerly Concurrency) (41.7%)
- **Documentation Coverage:** 45.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `avvio` **(Generic / Templated Code)** (Impact: 34.5)
  * `avvio` **(Parameter Forwarders)** (Impact: 2.9)
  * `override` **(Generic / Templated Code)** (Impact: 2.4)
  * `on` **(Callbacks & Closures)** (Impact: 1.8)
  * `on` **(Callbacks & Closures)** (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
