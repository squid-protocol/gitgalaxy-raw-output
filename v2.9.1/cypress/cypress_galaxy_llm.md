...
## 1. EXECUTIVE SUMMARY
- **Scope:** 6120 analyzed artifact(s), 426294 LOC.
- **Load-bearing artifact:** `packages/driver/src/config/lodash.ts` -- 409 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `CONTRIBUTING.md` -- pulls in 64 dependencies, the widest assembly point in the scan.
...
|---|---|---|
| Modularity | 0.74 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Architectural Drift Z-Score:** `7.528`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +7.53; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 46%, Declarative / Non-Code 23%, Callbacks & Closures Files 14%, Large Core Modules (2) 4%, Large Core Modules (3) 3%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.9 | 25.5 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 6.6 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 3.4 | 2.3 | 2.3 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 10.1 | 1.5 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 53.8 | 2.0 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 36.2 | 0.0 | 0.0 |
...
- `addAll` **(Many-Argument Workhorses)** (@ `cli/types/cypress.d.ts`) -> Impact: **356.0** | LOC: 1785
  * *Intent:* /** * Add one or more custom commands that validate their prevSubject */
- `startListening` **(Many-Argument Workhorses)** (@ `packages/server/lib/socket-base.ts`) -> Impact: **265.3** | LOC: 603
- `click` **(I/O & Config Routines)** (@ `packages/driver/cypress/e2e/commands/actions/click.cy.ts`) -> Impact: **220.0** | LOC: 2639
...
- `origin` **(Many-Argument Workhorses)** (@ `cli/types/cypress.d.ts`) -> Impact: **153.7** | LOC: 753
  * *Intent:* /** * Enables running Cypress commands in a secondary origin. * cy.origin('example.com', () => { * cy.get('h1').should('equal', 'Example Domain') * })...
...
- **Magnitude:** 4983.17 | **LOC:** 723 | **CtrlFlow:** 7.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.5%), Guard Balance (formerly Safety Score) (10.8%), Complexity Load (formerly Cognitive Load) (9.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (36.5%), Complexity Load (formerly Cognitive Load) (33.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 2698.31 | **LOC:** 459 | **CtrlFlow:** 8.9% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (85.0%), Guard Balance (formerly Safety Score) (23.9%), Complexity Load (formerly Cognitive Load) (19.8%), Mutation Surface (formerly State Flux) (9.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (93.0%), Guard Balance (formerly Safety Score) (51.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (8.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (92.5%), Guard Balance (formerly Safety Score) (60.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (11.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 0.13; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (37.2%), Complexity Load (formerly Cognitive Load) (6.8%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (36.4%), Complexity Load (formerly Cognitive Load) (29.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (8.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 0.13; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (49.4%), Guard Balance (formerly Safety Score) (45.5%), Complexity Load (formerly Cognitive Load) (8.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (65.1%), Complexity Load (formerly Cognitive Load) (49.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (76.5%), Guard Balance (formerly Safety Score) (23.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (8.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 1278.14 | **LOC:** 243 | **CtrlFlow:** 5.8% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (57.8%), Complexity Load (formerly Cognitive Load) (50.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (16.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **12**; blast radius 0.146; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (91.8%), Guard Balance (formerly Safety Score) (90.8%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `case` **(I/O & Config Routines)** (Impact: 36.6)
  * `maybeHandleRetryOnFailure` **(Many-Argument Workhorses)** (Impact: 32.8)
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 1138.45 | **LOC:** 301 | **CtrlFlow:** 6.2% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (49.1%), Guard Balance (formerly Safety Score) (31.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (7.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (78.8%), Complexity Load (formerly Cognitive Load) (34.5%), Mutation Surface (formerly State Flux) (17.3%), Guard Balance (formerly Safety Score) (4.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (30.2%), Concurrency Surface (formerly Concurrency) (14.4%), Complexity Load (formerly Cognitive Load) (12.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `file_cluster_10` (Drift: 0.0 IQR)
- **Magnitude:** 985.33 | **LOC:** 419 | **CtrlFlow:** 1.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (48.4%), Guard Balance (formerly Safety Score) (47.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Complexity Load (formerly Cognitive Load) (28.4%), Guard Balance (formerly Safety Score) (21.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (8.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.9%), Guard Balance (formerly Safety Score) (29.0%), Complexity Load (formerly Cognitive Load) (18.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (16.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `matches` **(Many-Argument Workhorses)** (Impact: 150.5)
  * `write` **(Callbacks & Closures)** (Impact: 86.2)
  * `onmessage` **(Callbacks & Closures)** (Impact: 21.8)
  * `use` **(Callbacks & Closures)** (Impact: 19.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.3%), Guard Balance (formerly Safety Score) (37.5%), Complexity Load (formerly Cognitive Load) (8.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.107; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (45.8%), Complexity Load (formerly Cognitive Load) (33.8%), Mutation Surface (formerly State Flux) (14.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 8 instances
* *Amplified Cascading Flux:* 1 instances
...
- `packages/app/src/runner/event-manager.ts` -> Churn: **53.76%** | Cog Load: 53.4201% | Debt: 14.4446%

### 👤 Key Person Dependencies (High Impact + Siloed Knowledge)
These are massive, load-bearing files written almost entirely by a single developer. They represent severe 'Bus Factor' risk.

- `cli/test/lib/tasks/state.spec.ts` -> **Cacie Prins** (100.0% isolated ownership) | Magnitude: 2698.31
...
- `cli/test/lib/exec/run.spec.ts` -> **Cacie Prins** (100.0% isolated ownership) | Magnitude: 1278.14
...
- `scripts/debug.js` -> **Severity: 6.629** (Embedded: 0.088 * Error Risk: 75.2927%)
- `packages/server/lib/util/child_process.js` -> **Severity: 4.338** (Embedded: 0.0672 * Error Risk: 64.5656%)
- `packages/server/lib/util/fs.ts` -> **Severity: 2.873** (Embedded: 0.0346 * Error Risk: 83.1567%)
- `system-tests/lib/system-tests.ts` -> **Severity: 2.48** (Embedded: 0.0291 * Error Risk: 85.3623%)
- `packages/driver/src/cypress/error_utils.ts` -> **Severity: 1.641** (Embedded: 0.0197 * Error Risk: 83.3656%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `scripts/debug.js` -> **Severity: 1396.55** (Blast Radius: 27.931 * Doc Risk: 50.0%)
- `system-tests/lib/system-tests.ts` -> **Severity: 1238.325** (Blast Radius: 13.035 * Doc Risk: 95.0%)
- `packages/server/lib/util/fs.ts` -> **Severity: 1089.9** (Blast Radius: 10.899 * Doc Risk: 100.0%)
- `packages/rewriter/lib/js.ts` -> **Severity: 701.0** (Blast Radius: 7.01 * Doc Risk: 100.0%)
