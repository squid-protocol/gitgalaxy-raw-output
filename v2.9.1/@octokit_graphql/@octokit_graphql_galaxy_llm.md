# ARCHITECTURAL_BRIEF: @octokit_graphql
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2 analyzed artifact(s), 465 LOC.
...
- **Heaviest artifact:** `package/README.md` at magnitude 8.18 (structural weight, not risk).
