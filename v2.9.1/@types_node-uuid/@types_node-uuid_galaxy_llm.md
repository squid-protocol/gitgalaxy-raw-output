...
- **Heaviest artifact:** `node-uuid/index.d.ts` at magnitude 5.11 (structural weight, not risk).
...
| Guard Balance (formerly Error & Exception Exposure) | 48.8 | 48.8 | 48.8 | 48.8 | 48.8 |
...
| Connectivity (formerly API Exposure) | 13.1 | 13.1 | 13.1 | 13.1 | 13.1 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 48.1 | 48.1 | 48.1 | 48.1 | 48.1 |
...
| cleanup | 0 | 0 | 0 | - |
| guards | 0 | 0 | 0 | - |
| danger | 1 | 1 | 1 | `node-uuid/index.d.ts` |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 13 | 1 | 13 | `node-uuid/index.d.ts` |
| io | 0 | 0 | 0 | - |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
...
| events | 0 | 0 | 0 | - |
| tests | 0 | 0 | 0 | - |
| docs | 4 | 1 | 4 | `node-uuid/index.d.ts` |
| debt | 0 | 0 | 0 | - |
| mutation | 0 | 0 | 0 | - |
| dead_code | 0 | 0 | 0 | - |
| credential | 0 | 0 | 0 | - |
...
- `v1` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `v4` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `v1` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `v1` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `v4` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `v4` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **8.1** | LOC: 1
- `parse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **6.0** | LOC: 1
- `parse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **6.0** | LOC: 1
- `parse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **6.0** | LOC: 1
- `unparse` **(Compute Cores)** (@ `node-uuid/index.d.ts`) -> Impact: **3.5** | LOC: 1
...
### `node-uuid/index.d.ts` (TYPESCRIPT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 5.11 | **LOC:** 56 | **CtrlFlow:** 140.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (48.8%), Connectivity (formerly Api Exposure) (13.1%)
- **Documentation Coverage:** 48.0769% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `v1` **(Compute Cores)** (Impact: 8.1)
  * `v4` **(Compute Cores)** (Impact: 8.1)
  * `v1` **(Compute Cores)** (Impact: 8.1)
  * `v1` **(Compute Cores)** (Impact: 8.1)
  * `v4` **(Compute Cores)** (Impact: 8.1)
...
- `node-uuid/index.d.ts` -> **Severity: 16025.617** (Blast Radius: 333.333 * Doc Risk: 48.0769%)
