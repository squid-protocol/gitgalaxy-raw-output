...
## 1. EXECUTIVE SUMMARY
- **Scope:** 22 analyzed artifact(s), 408 LOC.
- **Load-bearing artifact:** `translations/ru-russian/CONTRIBUTING.md` -- 4 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `irrelevant/obsolete/initial.md` -- pulls in 4 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `irrelevant/notebook_generator.py` at magnitude 356.8 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 73%, Declarative / Non-Code 14%, Generic / Templated Code Files 5%, Interface Declarations Files 5%, Large Core Modules (3) 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 94.0 | 21.8 | 0.0 | 0.0 |
...
- `is_interactive_statement` **(Compute Cores)** (@ `irrelevant/notebook_generator.py`) -> Impact: **4.5** | LOC: 5
- `square` **(Parameter Forwarders)** (@ `mixed_tabs_and_spaces.py`) -> Impact: **3.1** | LOC: 5
...
- `generate_markdown_block` **(Parameter Forwarders)** (@ `irrelevant/notebook_generator.py`) -> Impact: **2.0** | LOC: 12
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 35.032; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (47.4%)
- **Documentation Coverage:** 23.5083% of unit weight undocumented
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (37.6%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 35.032; role: Pure Consumer (Orchestrator)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 35.032; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 35.032; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Complexity Load (formerly Cognitive Load) (46.9%), Debt Markers (formerly Tech Debt) (40.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (45.7%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 35.032; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Complexity Load (formerly Cognitive Load) (31.9%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 94.033% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); blast radius 94.587; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Mutation Surface (formerly State Flux) (50.0%), Connectivity (formerly Api Exposure) (23.3%), Complexity Load (formerly Cognitive Load) (8.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `square` **(Parameter Forwarders)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 35.032; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.0%), Guard Balance (formerly Safety Score) (66.5%), Debt Markers (formerly Tech Debt) (62.2%), Complexity Load (formerly Cognitive Load) (9.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 35.032; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **1**; blast radius 94.587; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
- **Magnitude:** 1.0 | **LOC:** 43 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 145.209; role: Pure Producer (Foundation)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
