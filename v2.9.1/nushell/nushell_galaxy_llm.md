...
## 1. EXECUTIVE SUMMARY
- **Scope:** 1781 analyzed artifact(s), 295398 LOC.
- **Load-bearing artifact:** `crates/nu_plugin_polars/src/dataframe/command/data/col.rs` -- 16 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `crates/nu-cli/src/repl.rs` -- pulls in 95 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `crates/nu-parser/src/parser.rs` at magnitude 4073.4 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 1781 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 446 |
| Total LOC | 295398 |
...
> **Architectural Drift Z-Score:** `2.282`
> **Composition Archetype:** `Mid Flat Project` (z +2.28; from the repo's file-archetype mix)
> **File Composition:** State Mutators Files 35%, Declarative / Non-Code 18%, Data / Markup / Trivial 14%, Large Core Modules (3) 14%, Generic / Templated Code Files 8%
...
*Total Excluded Artifacts: 446*

**Composition by Extension & Reason:**
- `.nu`: 157x Unsupported Format (.nu), 1x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 39.1 | 29.2 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 19.4 | 2.4 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 77.3 | 100.0 | 100.0 |
...
| debt | 1225 | 391 | 2 | `crates/nu-parser/tests/test_parser.rs` |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **51**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (97.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (66.7%)
- **Documentation Coverage:** 90.8571% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (93.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (69.9%), Guard Balance (formerly Safety Score) (69.2%), Complexity Load (formerly Cognitive Load) (25.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **61**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (61.4%), Guard Balance (formerly Safety Score) (40.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (21.6%)
- **Documentation Coverage:** 52.7586% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **79**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (77.8%), Mutation Surface (formerly State Flux) (48.5%), Guard Balance (formerly Safety Score) (47.7%)
- **Documentation Coverage:** 85.9155% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **60**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (75.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (69.9%), Guard Balance (formerly Safety Score) (52.7%)
- **Documentation Coverage:** 21.2121% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.3%), Complexity Load (formerly Cognitive Load) (23.5%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (65.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.7%), Guard Balance (formerly Safety Score) (54.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.2%), Connectivity (formerly Api Exposure) (54.6%)
- **Documentation Coverage:** 85.2632% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **50**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (92.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (58.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (45.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (72.9%), Complexity Load (formerly Cognitive Load) (36.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (65.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (44.1%), Connectivity (formerly Api Exposure) (10.4%), Dead Code Surface (formerly Dead Code) (5.3%)
- **Documentation Coverage:** 97.9899% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `parse_cell_path_optional` **(Defensive Guards)** (Impact: 12.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **72**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.7%), Guard Balance (formerly Safety Score) (40.2%), Debt Markers (formerly Tech Debt) (17.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_any_value_to_value` **(I/O & Config Routines)** (Impact: 30.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **40**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.1%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (74.7%), Guard Balance (formerly Safety Score) (62.0%)
- **Documentation Coverage:** 77.2455% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `hide_decl` **(Many-Argument Workhorses)** (Impact: 16.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **77**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.6%), Mutation Surface (formerly State Flux) (89.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.3%)
- **Documentation Coverage:** 68.1564% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (96.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (64.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `read_entire_sqlite_db` **(Compute Cores)** (Impact: 15.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **56**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (51.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (44.1%), Debt Markers (formerly Tech Debt) (43.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **95**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (90.3%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (69.4%), Guard Balance (formerly Safety Score) (63.6%)
- **Documentation Coverage:** 60.5263% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `loop_iteration` **(Many-Argument Workhorses)** (Impact: 77.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **36**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.4%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (68.4%), Guard Balance (formerly Safety Score) (66.5%)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **2**; blast radius 2.616; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.8%), Complexity Load (formerly Cognitive Load) (67.0%)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 2.616
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **57**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (53.7%), Mutation Surface (formerly State Flux) (43.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 0.542; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.5%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (76.2%), Guard Balance (formerly Safety Score) (63.3%)
- **Documentation Coverage:** 93.829% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `parse_experimental_options` **(Defensive Guards)** (Impact: 30.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (84.5%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (77.4%), Guard Balance (formerly Safety Score) (56.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.5%), Guard Balance (formerly Safety Score) (64.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (60.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (56.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.542; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (96.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (53.1%), Mutation Surface (formerly State Flux) (47.6%)
...
- `crates/nu-explore/src/explore/commands/nu.rs` -> **Severity: 0.214** (Embedded: 0.0034 * Error Risk: 63.3642%)
...
- `crates/nu_plugin_polars/src/dataframe/command/data/col.rs` -> **Severity: 745.4** (Blast Radius: 7.454 * Doc Risk: 100.0%)
- `crates/nu_plugin_polars/src/dataframe/command/data/lit.rs` -> **Severity: 422.8** (Blast Radius: 4.228 * Doc Risk: 100.0%)
- `crates/nu-explore/src/explore/commands/nu.rs` -> **Severity: 287.187** (Blast Radius: 3.307 * Doc Risk: 86.8421%)
- `crates/nu-protocol/src/did_you_mean.rs` -> **Severity: 284.6** (Blast Radius: 2.846 * Doc Risk: 100.0%)
- `crates/nu-protocol/src/errors/shell_error/io.rs` -> **Severity: 189.641** (Blast Radius: 3.698 * Doc Risk: 51.2821%)
