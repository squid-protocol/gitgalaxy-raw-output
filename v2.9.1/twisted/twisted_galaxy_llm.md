...
## 1. EXECUTIVE SUMMARY
- **Scope:** 894 analyzed artifact(s), 197664 LOC.
- **Load-bearing artifact:** `src/twisted/application/internet.py` -- 293 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/twisted/internet/test/test_endpoints.py` -- pulls in 42 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/twisted/mail/imap4.py` at magnitude 5281.02 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.866`
> **Composition Archetype:** `Hub-Coupled App` (z +1.87; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 35%, Generic / Templated Code Files 24%, Large Core Modules (3) 15%, Data / Markup / Trivial 12%, Declarative / Non-Code 5%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 4.3 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 36.1 | 29.3 | 0.0 |
...
| connectivity | 26775 | 778 | 74 | `src/twisted/mail/test/test_imap.py` |
...
| threat | 1084 | 297 | 4 | `src/twisted/names/test/test_dns.py` |
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **25**; blast radius 0.356; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (57.1%)
- **Documentation Coverage:** 65.5118% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (17.2%), Connectivity (formerly Api Exposure) (13.7%), Complexity Load (formerly Cognitive Load) (13.5%)
- **Documentation Coverage:** 60.1173% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_parenParser` **(I/O & Config Routines)** (Impact: 11.0)
  * `requestStatus` **(Compute Cores)** (Impact: 11.0)
  * `_fetchWork` **(Stateful Encapsulated Methods)** (Impact: 10.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **21**; blast radius 0.408; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (62.9%)
- **Documentation Coverage:** 29.5872% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `dccDescribe` **(Defensive Guards)** (Impact: 18.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.6%), Guard Balance (formerly Safety Score) (93.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 55.5024% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **31**; blast radius 0.359; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.0%), Connectivity (formerly Api Exposure) (74.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (29.7%), Complexity Load (formerly Cognitive Load) (16.2%)
- **Documentation Coverage:** 20.3209% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **34**; blast radius 11.095; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (50.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `lineReceived` **(Stateful Encapsulated Methods)** (Impact: 31.0)
  ...
  * `_maybeChooseTransferDecoder` **(Stateful Encapsulated Methods)** (Impact: 21.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.6%), Connectivity (formerly Api Exposure) (13.7%), Complexity Load (formerly Cognitive Load) (13.5%)
- **Documentation Coverage:** 38.1974% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_Normalizer` **(I/O & Config Routines)** (Impact: 14.8)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **42**; blast radius 0.407; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (83.9%), Guard Balance (formerly Safety Score) (73.1%), Complexity Load (formerly Cognitive Load) (13.3%)
- **Documentation Coverage:** 26.161% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_ssl` **(Compute Cores)** (Impact: 8.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **26**; blast radius 1.053; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (38.6%)
- **Documentation Coverage:** 66.805% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 50.5)
  * `sendmail` **(Many-Argument Workhorses)** (Impact: 33.8)
  * `dataLineReceived` **(Stateful Encapsulated Methods)** (Impact: 28.0)
  * `authenticate` **(Stateful Encapsulated Methods)** (Impact: 24.3)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **14**; blast radius 2.985; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (73.2%)
- **Documentation Coverage:** 58.6873% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **39**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (63.1%), Complexity Load (formerly Cognitive Load) (19.8%), Connectivity (formerly Api Exposure) (13.1%)
- **Documentation Coverage:** 25.6018% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_testRedirectDefault` **(Many-Argument Workhorses)** (Impact: 45.4)
  * `integrationTest` **(Many-Argument Workhorses)** (Impact: 16.4)
  * `test_connectHTTPSCustomConnectionCreator` **(Compute Cores)** (Impact: 6.3)
    * *Intent:* """ If a custom L{WebClientConnectionCreator}-like object is passed to L{Agent.__init__} it will be ...
  * `test_cacheRemovesOldest` **(I/O & Config Routines)** (Impact: 6.3)
    * *Intent:* """ Verify that when the cache is full, and a new entry is added, the oldest entry is removed. """
  * `_sensitiveHeadersTest` **(Stateful Encapsulated Methods)** (Impact: 6.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **34**; blast radius 0.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (90.6%), Guard Balance (formerly Safety Score) (84.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.6%), Complexity Load (formerly Cognitive Load) (19.7%)
- **Documentation Coverage:** 47.9757% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `exhaust` **(Stateful Encapsulated Methods)** (Impact: 9.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (75.1%), Concurrency Surface (formerly Concurrency) (59.3%), Connectivity (formerly Api Exposure) (12.9%), Complexity Load (formerly Cognitive Load) (10.1%)
- **Documentation Coverage:** 47.6268% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `testQueue` **(Type Conversions)** (Impact: 11.7)
  * `_count` **(Stateful Encapsulated Methods)** (Impact: 10.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.5%), Connectivity (formerly Api Exposure) (13.7%), Complexity Load (formerly Cognitive Load) (7.0%)
- **Documentation Coverage:** 4.955% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **25**; blast radius 0.532; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (92.3%), Guard Balance (formerly Safety Score) (85.9%), Complexity Load (formerly Cognitive Load) (20.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.8%)
- **Documentation Coverage:** 43.7071% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.5%), Complexity Load (formerly Cognitive Load) (16.4%), Connectivity (formerly Api Exposure) (13.8%)
- **Documentation Coverage:** 33.8912% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_basicLiteralEmit` **(I/O & Config Routines)** (Impact: 7.0)
    * *Intent:* """ Verify that the command dictionaries for a callRemoteN look correct after being serialized and p...
  * `test_basicStructuredEmit` **(Type Conversions)** (Impact: 6.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (88.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (29.7%), Concurrency Surface (formerly Concurrency) (16.2%), Complexity Load (formerly Cognitive Load) (14.8%)
- **Documentation Coverage:** 41.8773% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_dataAndRstStream` **(Defensive Guards)** (Impact: 15.4)
  ...
  * `test_sendAccordingToPriority` **(I/O & Config Routines)** (Impact: 12.0)
  ...
  * `test_producerBlockingUnblocking` **(I/O & Config Routines)** (Impact: 9.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.9%), Concurrency Surface (formerly Concurrency) (25.6%), Complexity Load (formerly Cognitive Load) (20.7%), Connectivity (formerly Api Exposure) (12.3%)
- **Documentation Coverage:** 52.9563% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_lookup` **(Stateful Encapsulated Methods)** (Impact: 10.2)
  * `testMethods` **(Type Conversions)** (Impact: 9.8)
  * `test_mailbox` **(I/O & Config Routines)** (Impact: 9.1)
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **35**; blast radius 0.399; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Connectivity (formerly Api Exposure) (79.8%), Guard Balance (formerly Safety Score) (78.0%), Credential Material (formerly Secrets Risk) (17.2%)
- **Documentation Coverage:** 33.4184% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 0.338; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.3%), Complexity Load (formerly Cognitive Load) (17.5%), Connectivity (formerly Api Exposure) (13.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (9.9%)
- **Documentation Coverage:** 19.8347% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_runClientServer` **(Stateful Encapsulated Methods)** (Impact: 11.4)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.6%)
- **Documentation Coverage:** 82.3171% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 23.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **25**; blast radius 1.492; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (59.3%)
- **Documentation Coverage:** 35.7759% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__new__` **(Many-Argument Workhorses)** (Impact: 36.0)
  ...
  * `_commandReceived` **(Stateful Encapsulated Methods)** (Impact: 15.7)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **9**; blast radius 0.492; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (79.3%), Guard Balance (formerly Safety Score) (65.8%), Complexity Load (formerly Cognitive Load) (9.8%)
- **Documentation Coverage:** 17.5676% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_parseModeChange` **(Stateful Encapsulated Methods)** (Impact: 8.7)
