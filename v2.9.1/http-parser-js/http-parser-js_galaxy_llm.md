...
## 1. EXECUTIVE SUMMARY
- **Scope:** 5 analyzed artifact(s), 534 LOC.
...
- **Heaviest artifact:** `package/http-parser.js` at magnitude 425.32 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 60%, Large Core Modules (2) 20%, State Mutators Files 20%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 34.4 | 50.0 | 42.2 | 42.2 | 34.4 |
...
- `HEADER` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **37.7** | LOC: 94
- `execute` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **21.8** | LOC: 36
- `parseHeader` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **14.9** | LOC: 20
- `HTTPParser` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **9.0** | LOC: 11
- `shouldKeepAlive` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **8.7** | LOC: 13
- `RESPONSE_LINE` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **7.0** | LOC: 19
- `initialize` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **6.1** | LOC: 19
- `REQUEST_LINE` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **6.0** | LOC: 19
- `BODY_CHUNKTRAILERS` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **5.7** | LOC: 14
- `finish` **(Defensive Guards)** (@ `package/http-parser.js`) -> Impact: **5.5** | LOC: 11
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.2%), Complexity Load (formerly Cognitive Load) (93.4%), Debt Markers (formerly Tech Debt) (82.1%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `HEADER` **(Defensive Guards)** (Impact: 37.7)
  * `execute` **(Defensive Guards)** (Impact: 21.8)
  * `parseHeader` **(Defensive Guards)** (Impact: 14.9)
  * `HTTPParser` **(Defensive Guards)** (Impact: 9.0)
  * `shouldKeepAlive` **(Defensive Guards)** (Impact: 8.7)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 316.239; role: Pure Producer (Foundation)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (81.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.6%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 34.375% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `onMessageComplete` **(I/O & Config Routines)** (Impact: 4.5)
  * `HEADER` **(Encapsulated Accessors)** (Impact: 1.1)
    * *Intent:* /** * For older versions of node (v6.x and older?), that return `skipBody=1` or `skipBody=true`, nee...
  * `BODY_CHUNKHEAD` **(Encapsulated Accessors)** (Impact: 1.1)
  * `BODY_CHUNK` **(Encapsulated Accessors)** (Impact: 1.1)
  * `BODY_CHUNKEMPTYLINE` **(Encapsulated Accessors)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 170.94; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
