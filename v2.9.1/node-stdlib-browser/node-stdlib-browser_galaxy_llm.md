...
## 1. EXECUTIVE SUMMARY
- **Scope:** 30 analyzed artifact(s), 3329 LOC.
...
- **Top orchestrator:** `package/README.md` -- pulls in 8 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/cjs/proxy/url.js` at magnitude 1267.28 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.883`
> **Composition Archetype:** `Small Flat Repo` (z +1.88; from the repo's file-archetype mix)
> **File Composition:** Large Core Modules (2) 33%, Data / Markup / Trivial 27%, State Mutators Files 13%, Callbacks & Closures Files 10%, Declarative / Non-Code 7%
...
- `.map`: 10x Excluded (Saturation: Line 1 exceeds 500 chars), 10x Unresolved Ambiguity (No Retainable Structure), 2x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 68.2 | 93.8 | 100.0 |
...
- `resolveObject` **(Defensive Guards)** (@ `package/cjs/proxy/url.js`) -> Impact: **175.0** | LOC: 275
- `resolveObject` **(Defensive Guards)** (@ `package/esm/proxy/url.js`) -> Impact: **175.0** | LOC: 275
...
- `formatImportWithOverloads` **(Defensive Guards)** (@ `package/cjs/proxy/url.js`) -> Impact: **22.2** | LOC: 28
  * *Intent:* /** * ((urlObject: URL, options?: URLFormatOptions) => string) & * ((urlObject: UrlObject | string, options?: never) => string) * )} */
- `formatImportWithOverloads` **(Defensive Guards)** (@ `package/esm/proxy/url.js`) -> Impact: **22.2** | LOC: 28
  * *Intent:* /** * ((urlObject: URL, options?: URLFormatOptions) => string) & * ((urlObject: UrlObject | string, options?: never) => string) * )} */
- `resolvePath` **(I/O & Config Routines)** (@ `package/cjs/index.js`) -> Impact: **21.2** | LOC: 112
  * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.9%)
- **Documentation Coverage:** 74.1935% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolveObject` **(Defensive Guards)** (Impact: 175.0)
  ...
  * `formatImportWithOverloads` **(Defensive Guards)** (Impact: 22.2)
    * *Intent:* /** * ((urlObject: URL, options?: URLFormatOptions) => string) & * ((urlObject: UrlObject | string, ...
...
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 25.0
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.4%)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (97.9%), Guard Balance (formerly Safety Score) (92.3%)
...
- **Magnitude:** 313.4 | **LOC:** 283 | **CtrlFlow:** 10.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (92.3%), Complexity Load (formerly Cognitive Load) (84.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `runClearTimeout` **(Defensive Guards)** (Impact: 8.4)
  * `runTimeout` **(Defensive Guards)** (Impact: 8.3)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Connectivity (formerly Api Exposure) (85.7%), Complexity Load (formerly Cognitive Load) (83.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `runClearTimeout` **(Defensive Guards)** (Impact: 8.4)
  * `runTimeout` **(Defensive Guards)** (Impact: 8.3)
...
- **Magnitude:** 225.04 | **LOC:** 262 | **CtrlFlow:** 11.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (83.5%), Guard Balance (formerly Safety Score) (79.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `runClearTimeout` **(Defensive Guards)** (Impact: 8.4)
  * `runTimeout` **(Defensive Guards)** (Impact: 8.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (50.6%), Guard Balance (formerly Safety Score) (50.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Debt Markers (formerly Tech Debt) (23.6%)
- **Documentation Coverage:** 87.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolvePath` **(I/O & Config Routines)** (Impact: 21.2)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (44.7%), Debt Markers (formerly Tech Debt) (24.4%)
- **Documentation Coverage:** 85.7143% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `resolvePath` **(I/O & Config Routines)** (Impact: 14.1)
    * *Intent:* /** */
  * `_globalThis` **(Defensive Guards)** (Impact: 8.1)
  * `get` **(Interface Declarations)** (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (65.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (81.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (45.3%)
- **Documentation Coverage:** 66.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `qsEscape` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** */ /** */
  * `qsUnescape` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (19.5%), Connectivity (formerly Api Exposure) (3.5%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_globalThis` **(Defensive Guards)** (Impact: 8.1)
  * `get` **(Interface Declarations)** (Impact: 2.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (19.3%), Complexity Load (formerly Cognitive Load) (4.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 25.0; role: Isolated/Orphan
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (36.9%), Complexity Load (formerly Cognitive Load) (2.6%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `qsEscape` **(Parameter Forwarders)** (Impact: 1.6)
    * *Intent:* /** */ /** */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (35.7%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (18.4%), Complexity Load (formerly Cognitive Load) (4.2%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 25.0; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (98.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (17.3%), Complexity Load (formerly Cognitive Load) (12.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createObjectURL` **(State Mutators)** (Impact: 1.5)
  * `revokeObjectURL` **(Parameter Forwarders)** (Impact: 1.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (6.3%), Complexity Load (formerly Cognitive Load) (4.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- `package/cjs/proxy/process.d.ts` -> **Severity: 2500.0** (Blast Radius: 25.0 * Doc Risk: 100.0%)
- `package/cjs/proxy/querystring.d.ts` -> **Severity: 2500.0** (Blast Radius: 25.0 * Doc Risk: 100.0%)
- `package/cjs/proxy/url.d.ts` -> **Severity: 2500.0** (Blast Radius: 25.0 * Doc Risk: 100.0%)
- `package/esm/proxy/process.d.ts` -> **Severity: 2500.0** (Blast Radius: 25.0 * Doc Risk: 100.0%)
- `package/esm/proxy/querystring.d.ts` -> **Severity: 2500.0** (Blast Radius: 25.0 * Doc Risk: 100.0%)
