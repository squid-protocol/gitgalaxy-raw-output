...
## 1. EXECUTIVE SUMMARY
- **Scope:** 107 analyzed artifact(s), 6050 LOC.
- **Load-bearing artifact:** `soupsieve-2.8.3/soupsieve/__meta__.py` -- 2 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `soupsieve-2.8.3/soupsieve/css_match.py` -- pulls in 7 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `soupsieve-2.8.3/soupsieve/css_match.py` at magnitude 2526.46 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `1.043`
> **Composition Archetype:** `Small Flat Repo` (z +1.04; from the repo's file-archetype mix)
> **File Composition:** Parameter Forwarders Files 49%, Large Core Modules 24%, Data / Markup / Trivial 16%, Compute Cores Files 4%, Generic / Templated Code Files 3%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 77.8 | 1.7 | 0.0 | 0.0 |
...
- `match_dir` **(Many-Argument Workhorses)** (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **66.9** | LOC: 58
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 9.128; role: Isolated/Orphan
...
**Top Internal Functions/Classes:**
  ...
  * `parse_value` **(Many-Argument Workhorses)** (Impact: 70.7)
    * *Intent:* """Parse the input value."""
  * `match_dir` **(Many-Argument Workhorses)** (Impact: 66.9)
    * *Intent:* """Check directionality."""
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (20.3%), Connectivity (formerly Api Exposure) (12.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_match` **(I/O & Config Routines)** (Impact: 5.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.128; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.1%), Mutation Surface (formerly State Flux) (99.0%), Guard Balance (formerly Safety Score) (86.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 13.0435% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_validate` **(Stateful Encapsulated Methods)** (Impact: 12.5)
    * *Intent:* """Validate arguments."""
  * `_validate` **(Stateful Encapsulated Methods)** (Impact: 10.8)
    * *Intent:* """Validate arguments."""
  * `_validate` **(Stateful Encapsulated Methods)** (Impact: 10.8)
    * *Intent:* """Validate arguments."""
  * `__init__` **(Type Conversions)** (Impact: 7.4)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 24.646; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.9%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 33.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__new__` **(Many-Argument Workhorses)** (Impact: 50.0)
  * `parse_version` **(Type Conversions)** (Impact: 25.7)
    * *Intent:* """Parse version into a comparable Version tuple."""
  * `_get_canonical` **(Stateful Encapsulated Methods)** (Impact: 9.3)
    * *Intent:* """Get the canonical output string."""
  * `_is_pre` **(Encapsulated Accessors)** (Impact: 1.6)
    * *Intent:* """Is prerelease."""
  * `_is_dev` **(Encapsulated Accessors)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (44.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (93.8%), Connectivity (formerly Api Exposure) (65.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (22.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `skip_no_lxml` **(Parameter Forwarders)** (Impact: 4.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (41.0%), Connectivity (formerly Api Exposure) (11.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_attribute` **(Parameter Forwarders)** (Impact: 1.9)
    * *Intent:* """Test attribute."""
  * `test_attribute_with_spaces` **(Parameter Forwarders)** (Impact: 1.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (10.7%), Complexity Load (formerly Cognitive Load) (5.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_contains_escapes` **(I/O & Config Routines)** (Impact: 2.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (16.0%), Connectivity (formerly Api Exposure) (9.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_root_iframe` **(Compute Cores)** (Impact: 4.7)
    * *Intent:* """Test root."""
  * `test_root_whitespace` **(Compute Cores)** (Impact: 3.4)
    * *Intent:* """Test when there is root and white space."""
  * `test_root_preprocess` **(Compute Cores)** (Impact: 3.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 16.887; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (46.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (38.5%), Connectivity (formerly Api Exposure) (10.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 9.128; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.4%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (76.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (43.6%), Connectivity (formerly Api Exposure) (9.8%), Complexity Load (formerly Cognitive Load) (1.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_namespace_no_default` **(I/O & Config Routines)** (Impact: 2.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (9.5%), Complexity Load (formerly Cognitive Load) (5.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_dir_auto_root` **(I/O & Config Routines)** (Impact: 2.3)
    * *Intent:* """Test that the root is assumed left to right if auto used."""
  * `test_dir_bidi_detect` **(I/O & Config Routines)** (Impact: 2.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (92.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (15.4%), Connectivity (formerly Api Exposure) (7.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_scope_is_select_target` **(Compute Cores)** (Impact: 9.7)
    * *Intent:* """Test that scope is the element which scope is called on."""
  * `test_scope_cannot_select_target` **(Compute Cores)** (Impact: 3.3)
    * *Intent:* """Test that scope, the element which scope is called on, cannot be selected."""
  * `test_scope_is_root` **(I/O & Config Routines)** (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  ...
  * `test_amp_cannot_select_target` **(Compute Cores)** (Impact: 3.3)
    * *Intent:* """Test that ampersand, the element which scope is called on, cannot be selected."""
  * `test_amp_is_root` **(I/O & Config Routines)** (Impact: 2.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.5%), Complexity Load (formerly Cognitive Load) (4.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_nth_child_no_parent` **(I/O & Config Routines)** (Impact: 5.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (47.9%), Connectivity (formerly Api Exposure) (10.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_custom_selectors` **(I/O & Config Routines)** (Impact: 2.9)
    * *Intent:* """Test custom selectors."""
  * `test_custom_dependency` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* """Test custom selector dependency on other custom selectors."""
  * `test_custom_dependency_out_of_order` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* """Test custom selector out of order dependency."""
  * `test_custom_escapes` **(Parameter Forwarders)** (Impact: 2.1)
    * *Intent:* """Test custom selectors with escapes."""
  * `test_custom_selectors_exotic` **(Parameter Forwarders)** (Impact: 2.0)
    * *Intent:* """Test custom selectors."""
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (11.3%), Connectivity (formerly Api Exposure) (9.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_contains_own_cdata_lxml_html` **(Compute Cores)** (Impact: 5.1)
    * *Intent:* """Test contains CDATA in `lxml` HTML."""
  * `test_contains_own_cdata_html5` **(Parameter Forwarders)** (Impact: 2.1)
    * *Intent:* """Test contains CDATA in HTML5."""
  * `test_contains_own_cdata_py_html` **(Parameter Forwarders)** (Impact: 2.1)
    * *Intent:* """Test contains CDATA in Python HTML parser."""
  * `test_contains_own_cdata_xml` **(Parameter Forwarders)** (Impact: 2.1)
    * *Intent:* """Test contains-own CDATA in XML."""
  * `test_contains_own_with_broken_text` **(Parameter Forwarders)** (Impact: 2.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (35.6%), Connectivity (formerly Api Exposure) (10.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_has_mixed` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* """Test has mixed."""
  * `test_has_nested_pseudo` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* """Test has with nested pseudo."""
  * `test_has_descendant` **(Parameter Forwarders)** (Impact: 1.9)
    * *Intent:* """Test has descendant."""
  * `test_has_next_sibling` **(Parameter Forwarders)** (Impact: 1.9)
    * *Intent:* """Test has next sibling."""
  * `test_has_subsequent_sibling` **(Parameter Forwarders)** (Impact: 1.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (49.6%), Connectivity (formerly Api Exposure) (8.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (35.6%), Connectivity (formerly Api Exposure) (10.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_multiple_is` **(I/O & Config Routines)** (Impact: 2.4)
    * *Intent:* """Test `:is()` behavior when paired with `:not()`."""
  * `test_nested_is` **(I/O & Config Routines)** (Impact: 2.2)
    * *Intent:* """Test multiple nested selectors."""
  * `test_is_with_other_pseudo` **(Parameter Forwarders)** (Impact: 2.0)
    * *Intent:* """Test `:is()` behavior when paired with `:not()`."""
  * `test_is` **(Parameter Forwarders)** (Impact: 1.9)
    * *Intent:* """Test multiple selectors with "is"."""
  * `test_is_multi_comma` **(Parameter Forwarders)** (Impact: 1.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 9.128; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (57.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.3%), Complexity Load (formerly Cognitive Load) (6.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
