...
## 1. EXECUTIVE SUMMARY
- **Scope:** 26 analyzed artifact(s), 2367 LOC.
- **Load-bearing artifact:** `python_dotenv-1.2.2/src/dotenv/main.py` -- 4 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `python_dotenv-1.2.2/src/dotenv/main.py` -- pulls in 13 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `python_dotenv-1.2.2/src/dotenv/main.py` at magnitude 363.68 (structural weight, not risk).
...
| Avg Path Length | 2.0238 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **File Composition:** Data / Markup / Trivial 35%, Large Core Modules (2) 23%, Generic / Templated Code Files 15%, Large Core Modules (3) 12%, Type Conversions Files 8%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 65.8 | 97.7 | 100.0 |
...
- `set_key` **(Many-Argument Workhorses)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **39.4** | LOC: 53
- `find_dotenv` **(Stateful Encapsulated Methods)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **28.4** | LOC: 49
- `get_cli_string` **(Many-Argument Workhorses)** (@ `python_dotenv-1.2.2/src/dotenv/__init__.py`) -> Impact: **21.0** | LOC: 28
- `run` **(Generic / Templated Code)** (@ `python_dotenv-1.2.2/src/dotenv/cli.py`) -> Impact: **16.9** | LOC: 18
  * *Intent:* """Run command with environment variables present."""
- `rewrite` **(Defensive Guards)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **16.6** | LOC: 52
- `unset_key` **(Many-Argument Workhorses)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **16.6** | LOC: 39
- `list_values` **(Compute Cores)** (@ `python_dotenv-1.2.2/src/dotenv/cli.py`) -> Impact: **14.7** | LOC: 17
  * *Intent:* """Display all the stored key/value."""
- `read_regex` **(Compute Cores)** (@ `python_dotenv-1.2.2/src/dotenv/parser.py`) -> Impact: **14.2** | LOC: 6
- `resolve_variables` **(Generic / Templated Code)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **13.3** | LOC: 23
- `load_dotenv` **(Many-Argument Workhorses)** (@ `python_dotenv-1.2.2/src/dotenv/main.py`) -> Impact: **12.9** | LOC: 47
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **13**; blast radius 121.975; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.7%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 70.2703% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `set_key` **(Many-Argument Workhorses)** (Impact: 39.4)
  * `find_dotenv` **(Stateful Encapsulated Methods)** (Impact: 28.4)
  * `rewrite` **(Defensive Guards)** (Impact: 16.6)
  * `unset_key` **(Many-Argument Workhorses)** (Impact: 16.6)
  * `resolve_variables` **(Generic / Templated Code)** (Impact: 13.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 24.587; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (16.0%), Complexity Load (formerly Cognitive Load) (13.9%), Connectivity (formerly Api Exposure) (11.6%)
- **Documentation Coverage:** 97.6744% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_set_key_permission_error` **(Defensive Guards)** (Impact: 7.9)
  * `test_rewrite_closes_file_handle_on_lstat_failure` **(Defensive Guards)** (Impact: 3.7)
  * `test_set_key` **(Defensive Guards)** (Impact: 3.1)
  * `test_dotenv_values_string_io` **(Type Conversions)** (Impact: 2.6)
  * `test_get_key_no_file` **(Defensive Guards)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 80.045; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `read_regex` **(Compute Cores)** (Impact: 14.2)
  * `parse_value` **(Generic / Templated Code)** (Impact: 7.7)
  * `parse_binding` **(Defensive Guards)** (Impact: 7.4)
  * `parse_key` **(Generic / Templated Code)** (Impact: 6.1)
  * `decode_escapes` **(Generic / Templated Code)** (Impact: 5.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 85.308; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (51.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run` **(Generic / Templated Code)** (Impact: 16.9)
    * *Intent:* """Run command with environment variables present."""
  * `list_values` **(Compute Cores)** (Impact: 14.7)
    * *Intent:* """Display all the stored key/value."""
  * `set_value` **(Generic / Templated Code)** (Impact: 6.8)
    * *Intent:* """ Store the given key/value. This doesn't follow symlinks, to avoid accidentally modifying a file ...
  * `run_command` **(Generic / Templated Code)** (Impact: 6.8)
    * *Intent:* """Replace the current process with the specified command. Replaces the current process with the spe...
  * `unset` **(Generic / Templated Code)** (Impact: 5.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 24.587; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (25.3%), Connectivity (formerly Api Exposure) (11.5%), Complexity Load (formerly Cognitive Load) (10.4%)
- **Documentation Coverage:** 92.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_list` **(Defensive Guards)** (Impact: 5.5)
  * `test_set_quote_options` **(Many-Argument Workhorses)** (Impact: 3.5)
  * `test_set_export` **(Many-Argument Workhorses)** (Impact: 3.5)
  * `test_run_without_cmd` **(Defensive Guards)** (Impact: 3.1)
  * `test_run_with_invalid_cmd` **(Defensive Guards)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 24.587; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (48.6%), Complexity Load (formerly Cognitive Load) (24.2%), Connectivity (formerly Api Exposure) (7.0%)
- **Documentation Coverage:** 21.9512% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_remove_ps_attributes` **(Stateful Encapsulated Methods)** (Impact: 5.5)
    * *Intent:* """Helper to remove ps1/ps2 attributes if they exist."""
  * `_mock_main_import` **(Stateful Encapsulated Methods)** (Impact: 4.5)
    * *Intent:* """Helper to mock __main__ module import."""
  * `mock_import` **(Parameter Forwarders)** (Impact: 4.2)
  * `mock_import` **(Parameter Forwarders)** (Impact: 4.2)
  * `_mock_main_import_error` **(Stateful Encapsulated Methods)** (Impact: 4.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 80.045; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.8%), Complexity Load (formerly Cognitive Load) (76.6%), Connectivity (formerly Api Exposure) (59.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `parse_variables` **(Compute Cores)** (Impact: 12.2)
  * `resolve` **(Generic / Templated Code)** (Impact: 8.9)
  * `__ne__` **(Generic / Templated Code)** (Impact: 3.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 24.587; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (15.5%), Connectivity (formerly Api Exposure) (7.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setup_zipfile` **(Type Conversions)** (Impact: 7.6)
  * `test_load_dotenv_outside_zip_file_when_called_in_zipfile` **(I/O & Config Routines)** (Impact: 6.5)
  * `walk_to_root` **(Parameter Forwarders)** (Impact: 3.2)
  * `test_load_dotenv_gracefully_handles_zip_imports_when_no_env_file` **(Type Conversions)** (Impact: 2.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 24.587; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.8%), Complexity Load (formerly Cognitive Load) (50.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_cli_string` **(Many-Argument Workhorses)** (Impact: 21.0)
  * `load_ipython_extension` **(Generic / Templated Code)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 24.587; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (52.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_load_dotenv_from_fifo` **(Defensive Guards)** (Impact: 2.7)
  * `writer` **(Interface Declarations)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 24.587; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (37.4%), Complexity Load (formerly Cognitive Load) (9.3%), Connectivity (formerly Api Exposure) (6.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_ipython_existing_variable_no_override` **(Defensive Guards)** (Impact: 2.1)
  * `test_ipython_existing_variable_override` **(Defensive Guards)** (Impact: 2.1)
  * `test_ipython_new_variable` **(Defensive Guards)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 24.587; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (2.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_parse_stream` **(Type Conversions)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (95.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (7.1%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `clean-build` **(I/O & Config Routines)** (Impact: 1.4)
  * `clean-pyc` **(I/O & Config Routines)** (Impact: 1.2)
  * `test` **(I/O & Config Routines)** (Impact: 1.2)
  * `clean` **(State Mutators)** (Impact: 1.1)
  * `sdist` **(I/O & Config Routines)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 59.146; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (4.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 71.295; role: Pure Producer (Foundation)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 35.036; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.0%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (39.9%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dotenv` **(Defensive Guards)** (Impact: 2.3)
  * `load_ipython_extension` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 24.587; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (52.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (5.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dotenv_path` **(Parameter Forwarders)** (Impact: 1.6)
  * `cli` **(Interface Declarations)** (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 24.587; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (3.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_parse_variables` **(Type Conversions)** (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 24.587; role: Isolated/Orphan
...
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_to_cli_string` **(Defensive Guards)** (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
