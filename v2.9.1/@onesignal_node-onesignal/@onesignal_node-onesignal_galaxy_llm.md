# ARCHITECTURAL_BRIEF: @onesignal_node-onesignal
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2 analyzed artifact(s), 636 LOC.
...
- **Heaviest artifact:** `package/README.md` at magnitude 11.8 (structural weight, not risk).
...
- **Magnitude:** 11.8 | **LOC:** 590 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 500.0; role: Isolated/Orphan
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` DefaultApi.MD
