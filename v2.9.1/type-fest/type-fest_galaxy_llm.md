...
## 1. EXECUTIVE SUMMARY
- **Scope:** 427 analyzed artifact(s), 18857 LOC.
- **Load-bearing artifact:** `source/internal/index.d.ts` -- 78 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `readme.md` -- pulls in 189 dependencies, the widest assembly point in the scan.
...
| Avg Path Length | 3.2439 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `6.334`
> **Composition Archetype:** `Small Flat Repo (2)` (z +6.33; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 67%, Data / Markup / Trivial 20%, Generic / Templated Code Files 3%, Interface Declarations Files 2%, Parameter Forwarders Files 2%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 11.5 | 0.0 | 0.0 |
...
- `incorrectTwoslashFormatErrorAt` **(Many-Argument Workhorses)** (@ `lint-rules/validate-jsdoc-codeblocks.test.js`) -> Impact: **122.8** | LOC: 1778
- `create` **(Defensive Guards)** (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **38.7** | LOC: 95
- `create` **(Defensive Guards)** (@ `lint-rules/require-exported-types.js`) -> Impact: **38.1** | LOC: 111
- `TSTypeAliasDeclaration` **(Defensive Guards)** (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **36.4** | LOC: 78
- `writeFixture` **(Defensive Guards)** (@ `lint-rules/test-utils.js`) -> Impact: **34.9** | LOC: 40
- `validateTwoslashTypes` **(Many-Argument Workhorses)** (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **31.0** | LOC: 84
- `postprocess` **(Defensive Guards)** (@ `lint-processors/jsdoc-codeblocks.js`) -> Impact: **27.3** | LOC: 61
  * *Intent:* /** */
- `preprocess` **(Defensive Guards)** (@ `lint-processors/jsdoc-codeblocks.js`) -> Impact: **21.8** | LOC: 54
  * *Intent:* /** */
- `extractTypeFromQuickInfo` **(Defensive Guards)** (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **21.4** | LOC: 32
- `normalizeType` **(Compute Cores)** (@ `lint-rules/validate-jsdoc-codeblocks.js`) -> Impact: **20.4** | LOC: 62
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (41.6%), Concurrency Surface (formerly Concurrency) (16.9%), Connectivity (formerly Api Exposure) (11.9%)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 1.783; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (73.7%), Guard Balance (formerly Safety Score) (51.5%), Connectivity (formerly Api Exposure) (32.5%)
- **Documentation Coverage:** 88.2353% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `create` **(Defensive Guards)** (Impact: 38.7)
  * `TSTypeAliasDeclaration` **(Defensive Guards)** (Impact: 36.4)
  * `validateTwoslashTypes` **(Many-Argument Workhorses)** (Impact: 31.0)
  * `extractTypeFromQuickInfo` **(Defensive Guards)** (Impact: 21.4)
  * `normalizeType` **(Compute Cores)** (Impact: 20.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (48.8%), Connectivity (formerly Api Exposure) (11.7%), Mutation Surface (formerly State Flux) (9.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `incorrectTwoslashFormatErrorAt` **(Many-Argument Workhorses)** (Impact: 122.8)
  * `invalidCodeblockErrorAt` **(Parameter Forwarders)** (Impact: 1.5)
  * `incorrectTwoslashTypeErrorAt` **(Parameter Forwarders)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 2.266; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (74.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (41.6%), Complexity Load (formerly Cognitive Load) (38.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `postprocess` **(Defensive Guards)** (Impact: 27.3)
    * *Intent:* /** */
  * `preprocess` **(Defensive Guards)** (Impact: 21.8)
    * *Intent:* /** */
  * `indentsUptoIndex` **(Many-Argument Workhorses)** (Impact: 9.1)
    * *Intent:* /** */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **7**; blast radius 4.523; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (65.4%), Guard Balance (formerly Safety Score) (40.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (14.7%)
- **Documentation Coverage:** 15.7895% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `writeFixture` **(Defensive Guards)** (Impact: 34.9)
  * `errorAt` **(Defensive Guards)** (Impact: 8.8)
    * *Intent:* */
  * `createRuleTester` **(I/O & Config Routines)** (Impact: 3.6)
  * `exportOption` **(I/O & Config Routines)** (Impact: 3.4)
    * *Intent:* */
  * `fixturePath` **(I/O & Config Routines)** (Impact: 3.3)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.3%), Debt Markers (formerly Tech Debt) (10.0%), Complexity Load (formerly Cognitive Load) (5.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `function_` **(I/O & Config Routines)** (Impact: 8.1)
  * `function_` **(Type Conversions)** (Impact: 5.2)
  * `function_` **(I/O & Config Routines)** (Impact: 4.5)
  * `function_` **(I/O & Config Routines)** (Impact: 4.5)
  * `function_` **(I/O & Config Routines)** (Impact: 4.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 1.783; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (75.6%), Guard Balance (formerly Safety Score) (54.7%), Connectivity (formerly Api Exposure) (34.0%), Complexity Load (formerly Cognitive Load) (18.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `create` **(Defensive Guards)** (Impact: 38.1)
  * `checkExportedType` **(Compute Cores)** (Impact: 10.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (13.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `invalidImport` **(Many-Argument Workhorses)** (Impact: 8.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 1.783; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.2%), Connectivity (formerly Api Exposure) (60.4%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (9.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `create` **(Compute Cores)** (Impact: 11.4)
  * `ExportNamedDeclaration` **(Defensive Guards)** (Impact: 6.0)
  * `fix` **(Parameter Forwarders)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (97.5%), Mutation Surface (formerly State Flux) (42.7%), Complexity Load (formerly Cognitive Load) (17.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.9%), Guard Balance (formerly Safety Score) (56.5%), Mutation Surface (formerly State Flux) (24.8%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 88.8889% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Parameter Forwarders)** (Impact: 2.0)
    * *Intent:* // This should be alright since `barMethod` is implemented.
  * `withBar` **(Generic / Templated Code)** (Impact: 1.8)
  * `constructor` **(Parameter Forwarders)** (Impact: 1.6)
  * `functionReceivingAbsClass` **(Generic / Templated Code)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.9%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (46.5%), Complexity Load (formerly Cognitive Load) (7.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (97.6%), Complexity Load (formerly Cognitive Load) (55.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.3%), Mutation Surface (formerly State Flux) (37.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (76.9%), Guard Balance (formerly Safety Score) (66.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.9%), Guard Balance (formerly Safety Score) (54.0%), Connectivity (formerly Api Exposure) (6.4%), Complexity Load (formerly Cognitive Load) (2.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **189**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (91.7%), Guard Balance (formerly Safety Score) (66.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (60.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.9%), Complexity Load (formerly Cognitive Load) (6.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (3.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.3%), Debt Markers (formerly Tech Debt) (69.3%), Complexity Load (formerly Cognitive Load) (16.1%), Test Surface (formerly Verification) (2.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `narrowingTest2` **(Compute Cores)** (Impact: 7.2)
  * `narrowingTest3` **(Compute Cores)** (Impact: 5.5)
  * `narrowingTest` **(Generic / Templated Code)** (Impact: 5.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (18.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (12.4%), Complexity Load (formerly Cognitive Load) (5.8%), Connectivity (formerly Api Exposure) (2.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.3%), Debt Markers (formerly Tech Debt) (11.4%), Connectivity (formerly Api Exposure) (7.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `toJSON` **(Interface Declarations)** (Impact: 1.4)
  * `toJSON` **(Interface Declarations)** (Impact: 1.2)
  * `toJSON` **(Interface Declarations)** (Impact: 1.2)
  * `toJSON` **(Interface Declarations)** (Impact: 1.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (62.2%), Complexity Load (formerly Cognitive Load) (11.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (9.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (3.1%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 1.138; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (95.3%), Mutation Surface (formerly State Flux) (50.0%), Complexity Load (formerly Cognitive Load) (37.3%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
