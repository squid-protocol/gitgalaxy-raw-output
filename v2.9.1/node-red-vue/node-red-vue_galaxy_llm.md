...
## 1. EXECUTIVE SUMMARY
- **Scope:** 10 analyzed artifact(s), 251 LOC.
- **Load-bearing artifact:** `package/resources/client/ems-config.js` -- 3 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `package/node-red-vue.js` -- pulls in 8 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/node-red-vue.js` at magnitude 210.12 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 80%, Large Core Modules (2) 10%, Many-Argument Workhorses Files 10%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 50.0 | 14.3 | 0.0 | 0.0 |
...
- `exports` **(Defensive Guards)** (@ `package/node-red-vue.js`) -> Impact: **70.0** | LOC: 213
- `setNodeTypeConfig` **(Compute Cores)** (@ `package/node-red-vue.js`) -> Impact: **23.5** | LOC: 30
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 74.627; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.8%), Complexity Load (formerly Cognitive Load) (81.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `exports` **(Defensive Guards)** (Impact: 70.0)
  * `setNodeTypeConfig` **(Compute Cores)** (Impact: 23.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 138.06; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.3%), Complexity Load (formerly Cognitive Load) (64.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); blast radius 264.925; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.4%), Mutation Surface (formerly State Flux) (50.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (8.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 74.627; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
