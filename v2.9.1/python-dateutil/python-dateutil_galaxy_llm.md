...
## 1. EXECUTIVE SUMMARY
- **Scope:** 19 analyzed artifact(s), 3796 LOC.
- **Load-bearing artifact:** `python-dateutil-2.6.1/dateutil/tz/tz.py` -- 3 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `python-dateutil-2.6.1/dateutil/tz/tz.py` -- pulls in 14 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `python-dateutil-2.6.1/dateutil/rrule.py` at magnitude 2316.7 (structural weight, not risk).
...
> **File Composition:** Data / Markup / Trivial 37%, Large Core Modules (3) 37%, Large Core Modules (2) 11%, Compute Cores Files 5%, Declarative / Non-Code 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 37.2 | 47.1 | 0.0 |
...
- `__init__` **(Stateful Encapsulated Methods)** (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **466.0** | LOC: 254
...
- `_iter` **(Stateful Encapsulated Methods)** (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **162.7** | LOC: 255
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 21.668; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (80.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 69.0476% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 466.0)
  * `_parse_rfc` **(Many-Argument Workhorses)** (Impact: 166.8)
  * `_iter` **(Stateful Encapsulated Methods)** (Impact: 162.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 21.668; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Complexity Load (formerly Cognitive Load) (85.3%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **14**; blast radius 76.922; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Debt Markers (formerly Tech Debt) (82.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 78.0488% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_read_tzfile` **(Many-Argument Workhorses)** (Impact: 82.0)
  * `_parse_rfc` **(Many-Argument Workhorses)** (Impact: 80.3)
  * `gettz` **(Defensive Guards)** (Impact: 44.6)
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 39.1)
  * `_delta` **(Stateful Encapsulated Methods)** (Impact: 30.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 54.36; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.1%), Complexity Load (formerly Cognitive Load) (91.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 93.1034% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 159.7)
  * `__add__` **(Many-Argument Workhorses)** (Impact: 70.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 21.668; role: Isolated/Orphan
...
**Top Internal Functions/Classes:**
  ...
  * `_isdst` **(Stateful Encapsulated Methods)** (Impact: 13.1)
  * `_fromutc` **(Stateful Encapsulated Methods)** (Impact: 8.7)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **7**; blast radius 262.26; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.8%)
- **Documentation Coverage:** 58.6207% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__eq__` **(Defensive Guards)** (Impact: 23.4)
  ...
  * `name_from_string` **(Defensive Guards)** (Impact: 4.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 21.668; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.7%), Debt Markers (formerly Tech Debt) (90.3%), Connectivity (formerly Api Exposure) (55.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 21.668; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (35.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 21.668; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (77.8%), Debt Markers (formerly Tech Debt) (62.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `_print_on_nosuchfile` **(Stateful Encapsulated Methods)** (Impact: 6.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 21.668; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Complexity Load (formerly Cognitive Load) (61.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `main` **(Defensive Guards)** (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (68.0%), Connectivity (formerly Api Exposure) (60.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__eq__` **(Defensive Guards)** (Impact: 5.5)
  * `__call__` **(Compute Cores)** (Impact: 5.4)
  * `__repr__` **(Compute Cores)** (Impact: 4.5)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 58.504; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.2%), Guard Balance (formerly Safety Score) (68.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* `state_mutation: 5`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 21.668; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (81.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (2.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 21.668; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (22.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `file_cluster_14` (Drift: 0.0 IQR)
- **Magnitude:** 10.52 | **LOC:** 3 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 244.597; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 2`
* *Risk/State:* `safety_bypasses: 1`
