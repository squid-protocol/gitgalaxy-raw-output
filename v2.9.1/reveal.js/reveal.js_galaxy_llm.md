...
## 1. EXECUTIVE SUMMARY
- **Scope:** 161 analyzed artifact(s), 19970 LOC.
- **Load-bearing artifact:** `js/reveal.js` -- 28 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `js/reveal.js` -- pulls in 25 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `js/reveal.js` at magnitude 1438.6 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.944`
> **Composition Archetype:** `Small Flat Repo (2)` (z +3.94; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 37%, Declarative / Non-Code 29%, Large Core Modules (3) 8%, State Mutators Files 6%, Callbacks & Closures Files 6%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 97.4 | 32.9 | 22.3 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 27.5 | 0.0 | 0.0 |
...
- `onDocumentKeyDown` **(Defensive Guards)** (@ `js/controllers/keyboard.js`) -> Impact: **194.7** | LOC: 273
  * *Intent:* /** * Handler for the document level 'keydown' event. * */
- `slide` **(Many-Argument Workhorses)** (@ `js/reveal.js`) -> Impact: **94.7** | LOC: 194
  * *Intent:* /** * Steps from the current point in the presentation to the * slide which matches the specified horizontal and vertical * indices. * * target slide ...
- `autoAnimateElements` **(Many-Argument Workhorses)** (@ `js/controllers/autoanimate.js`) -> Impact: **57.6** | LOC: 123
  * *Intent:* /** * Creates a FLIP animation where the `to` element starts out * in the `from` element position and animates to its original * state. * * auto-anima...
...
- `onTouchMove` **(Compute Cores)** (@ `js/controllers/touch.js`) -> Impact: **52.6** | LOC: 90
  * *Intent:* /** * Handler for the 'touchmove' event. * */
- `update` **(Compute Cores)** (@ `js/controllers/backgrounds.js`) -> Impact: **52.1** | LOC: 136
  * *Intent:* /** * Updates the background elements to reflect the current * slide. * * all vertical slides (not just the present) will be updated. */
- `updateSlides` **(Many-Argument Workhorses)** (@ `js/reveal.js`) -> Impact: **50.9** | LOC: 117
  * *Intent:* /** * Updates one dimension of slides by showing the slide * with the specified index. * * the group of slides we are working with * shown * * might d...
- `escapeForHTML` **(Defensive Guards)** (@ `react/src/utils/markdown.ts`) -> Impact: **48.1** | LOC: 141
...
- **Blast Radius:** changing it is visible to **28** in-repo importer(s); it depends on **25**; blast radius 101.405; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.5%), Connectivity (formerly Api Exposure) (46.2%)
- **Documentation Coverage:** 25.2336% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `updateSlides` **(Many-Argument Workhorses)** (Impact: 50.9)
    * *Intent:* /** * Updates one dimension of slides by showing the slide * with the specified index. * * the group...
...
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (81.4%), Complexity Load (formerly Cognitive Load) (3.8%), Connectivity (formerly Api Exposure) (3.5%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (47.4%)
- **Documentation Coverage:** 39.5833% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (50.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (38.5%), Connectivity (formerly Api Exposure) (9.6%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (50.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `run` **(Many-Argument Workhorses)** (Impact: 36.1)
    * *Intent:* /** * Runs an auto-animation between the given slides. * */
  * `findAutoAnimateMatches` **(Many-Argument Workhorses)** (Impact: 29.0)
    * *Intent:* /** * Finds matching elements between two slides. * * a stringified ID based on its contents */...
  * `getAutoAnimateOptions` **(Compute Cores)** (Impact: 12.0)
    * *Intent:* /** * Returns the auto-animate options for the given element. * * from, either a slide or an animati...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Concurrency Surface (formerly Concurrency) (99.3%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (62.8%)
...
**Top Internal Functions/Classes:**
  ...
  * `startEmbeddedContent` **(Defensive Guards)** (Impact: 32.5)
    * *Intent:* /** * Start playback of any embedded content inside of * the given element. * */
  * `stopEmbeddedContent` **(Defensive Guards)** (Impact: 26.9)
    * *Intent:* /** * Stop playback of any embedded content inside of * the targeted slide. * */
  ...
  * `startEmbeddedIframe` **(Defensive Guards)** (Impact: 17.4)
    * *Intent:* /** * "Starts" the content of an embedded iframe using the * postMessage API. * */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 3.599; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.1%), Concurrency Surface (formerly Concurrency) (90.0%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (26.1%), Guard Balance (formerly Safety Score) (25.0%), Mutation Surface (formerly State Flux) (23.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (19.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (12.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (71.0%), Guard Balance (formerly Safety Score) (42.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (19.5%), Complexity Load (formerly Cognitive Load) (5.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Guard Balance (formerly Safety Score) (83.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (39.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setupTimer` **(I/O & Config Routines)** (Impact: 21.1)
  ...
  * `handleStateMessage` **(I/O & Config Routines)** (Impact: 8.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (67.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (13.4%), Complexity Load (formerly Cognitive Load) (9.9%), Connectivity (formerly Api Exposure) (2.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.3%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (56.5%)
- **Documentation Coverage:** 25.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `update` **(Compute Cores)** (Impact: 52.1)
    * *Intent:* /** * Updates the background elements to reflect the current * slide. * * all vertical slides (not j...
  * `sync` **(I/O & Config Routines)** (Impact: 35.5)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Complexity Load (formerly Cognitive Load) (57.9%), Connectivity (formerly Api Exposure) (45.3%), Guard Balance (formerly Safety Score) (19.7%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 4.445; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.0%), Complexity Load (formerly Cognitive Load) (68.1%), Connectivity (formerly Api Exposure) (56.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `escapeForHTML` **(Defensive Guards)** (Impact: 48.1)
  * `addAttributes` **(Many-Argument Workhorses)** (Impact: 47.1)
  * `addAttributeInElement` **(Many-Argument Workhorses)** (Impact: 25.4)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 7.19; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `previewMedia` **(Many-Argument Workhorses)** (Impact: 28.4)
    * *Intent:* /** * Opens a lightbox window that provides a larger view of the * given image/video. * */
  * `setState` **(Defensive Guards)** (Impact: 12.4)
  * `toggleHelp` **(Defensive Guards)** (Impact: 9.2)
    * *Intent:* /** * Open or close help overlay window. * * toggle logic and forcibly sets the desired state. True ...
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (96.4%), Guard Balance (formerly Safety Score) (96.2%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `to` **(Defensive Guards)** (Impact: 16.4)
    * *Intent:* /** * Zooms in on either a rectangle or HTML element. * * - element: HTML element to zoom in on * OR...
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (52.5%), Complexity Load (formerly Cognitive Load) (49.1%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Complexity Load (formerly Cognitive Load) (77.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `isActive` **(Defensive Guards)** (Impact: 1.2)
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); blast radius 53.034; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.3%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (73.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deserialize` **(Compute Cores)** (Impact: 15.2)
    * *Intent:* /** * Utility for deserializing a value. * */
  * `enterFullscreen` **(Compute Cores)** (Impact: 12.8)
    * *Intent:* /** * Handling the fullscreen functionality via the fullscreen API * */
  ...
  * `closest` **(Compute Cores)** (Impact: 10.0)
    * *Intent:* /** * Find the closest parent that matches the given * selector. * * the parents against * * if no m...
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 7.19; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (98.7%), Guard Balance (formerly Safety Score) (88.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 53.8462% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getIndicesFromHash` **(Many-Argument Workhorses)** (Impact: 28.8)
    * *Intent:* /** * Returns the slide indices for the given hash link. * * find the indices for * */
  * `getHash` **(Compute Cores)** (Impact: 24.4)
    * *Intent:* /** * Return a hash URL that will resolve to the given slide location. * */
  * `writeURL` **(Defensive Guards)** (Impact: 15.0)
    * *Intent:* /** * Updates the page URL (hash) to reflect the current * state. * * writing the hash */
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `configure` **(Defensive Guards)** (Impact: 9.3)
    * *Intent:* /** * Called when the reveal.js config is updated. */
  * `onNavigateLeftClicked` **(Defensive Guards)** (Impact: 4.9)
    * *Intent:* /** * Event handlers for navigation control buttons. */
  * `onNavigateRightClicked` **(Defensive Guards)** (Impact: 4.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 3.599; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (10.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **1**; blast radius 7.19; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (34.4%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `goto` **(Compute Cores)** (Impact: 19.4)
    * *Intent:* /** * Navigate to the specified slide fragment. * * should be shown, -1 means all are invisible * fr...
  * `sort` **(Many-Argument Workhorses)** (Impact: 11.0)
  ...
  * `availableRoutes` **(Interface Declarations)** (Impact: 4.8)
    * *Intent:* /** * Returns an object describing the available fragment * directions. * */
...
- `js/utils/util.ts` -> **Severity: 15.514** (Embedded: 0.1627 * Error Risk: 95.3399%)
