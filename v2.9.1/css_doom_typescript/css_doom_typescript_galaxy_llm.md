...
## 1. EXECUTIVE SUMMARY
- **Scope:** 138 analyzed artifact(s), 3633 LOC.
- **Load-bearing artifact:** `src/State/State.ts` -- 11 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/levels/level_1/level.ts` -- pulls in 12 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `src/utils/ResourceLoader/models/AudioLoader.ts` at magnitude 45.38 (structural weight, not risk).
...
| Avg Path Length | 3.2264 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `4.337`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.34; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 49%, Declarative / Non-Code 18%, Generic / Templated Code Files 8%, Callbacks & Closures Files 7%, Large Core Modules 7%
...
| Connectivity (formerly API Exposure) | 0.0 | 80.0 | 14.1 | 5.6 | 3.5 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 33.1 | 0.0 | 0.0 |
...
- `getCharClassName` **(Compute Cores)** (@ `src/ui/components/Text/getCharClassName.ts`) -> Impact: **27.4** | LOC: 39
- `render` **(Generic / Templated Code)** (@ `src/ui/UserInterface.tsx`) -> Impact: **10.0** | LOC: 20
- `load` **(Compute Cores)** (@ `src/utils/ResourceLoader/ResourceLoader.ts`) -> Impact: **8.6** | LOC: 31
- `handleUrl` **(Callbacks & Closures)** (@ `src/utils/ResourceLoader/models/AudioLoader.ts`) -> Impact: **8.6** | LOC: 34
- `setLevel` **(I/O & Config Routines)** (@ `src/levels/level_1/level.ts`) -> Impact: **7.4** | LOC: 48
- `setLevel` **(I/O & Config Routines)** (@ `src/levels/level_2/level.ts`) -> Impact: **7.4** | LOC: 48
- `load` **(Compute Cores)** (@ `src/utils/ResourceLoader/models/UrlLoader.ts`) -> Impact: **7.4** | LOC: 9
- `render` **(I/O & Config Routines)** (@ `src/ui/screens/Game/HUD/HealthColorFilter/HealthColorFilter.tsx`) -> Impact: **6.9** | LOC: 18
- `handler` **(Callbacks & Closures)** (@ `src/utils/ResourceLoader/ResourceLoader.ts`) -> Impact: **6.7** | LOC: 20
- `isAngleBetween` **(Compute Cores)** (@ `src/helpers/angle.ts`) -> Impact: **6.5** | LOC: 10
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 13.417; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (70.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handleUrl` **(Callbacks & Closures)** (Impact: 8.6)
  * `onEnd` **(Callbacks & Closures)** (Impact: 5.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 6.876; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (57.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `applyBrightness` **(Parameter Forwarders)** (Impact: 2.5)
  * `createImageElement` **(Stateful Encapsulated Methods)** (Impact: 2.1)
  * `createImageCanvasContext` **(Encapsulated Accessors)** (Impact: 1.9)
  * `getImageData` **(Encapsulated Accessors)** (Impact: 1.8)
  * `getUrlFromImageData` **(Encapsulated Accessors)** (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 13.417; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Concurrency Surface (formerly Concurrency) (99.6%), Guard Balance (formerly Safety Score) (73.5%), Complexity Load (formerly Cognitive Load) (73.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handleUrl` **(Callbacks & Closures)** (Impact: 6.1)
  * `onEnd` **(Callbacks & Closures)** (Impact: 3.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **3**; blast radius 10.814; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (72.0%), Complexity Load (formerly Cognitive Load) (62.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getFaceState` **(Encapsulated Accessors)** (Impact: 3.6)
  * `startIteration` **(Encapsulated Accessors)** (Impact: 3.5)
  * `render` **(Interface Declarations)** (Impact: 1.2)
  * `componentDidMount` **(State Mutators)** (Impact: 1.1)
  * `componentWillUnmount` **(State Mutators)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 35.069; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (20.1%), Complexity Load (formerly Cognitive Load) (16.2%), Test Surface (formerly Verification) (2.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getCharClassName` **(Compute Cores)** (Impact: 27.4)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **5**; blast radius 40.683; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (96.6%), Guard Balance (formerly Safety Score) (60.6%), Mutation Surface (formerly State Flux) (57.5%), Complexity Load (formerly Cognitive Load) (29.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `load` **(Compute Cores)** (Impact: 8.6)
  * `handler` **(Callbacks & Closures)** (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 7.402; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (72.9%), Guard Balance (formerly Safety Score) (62.0%), Concurrency Surface (formerly Concurrency) (44.9%), Complexity Load (formerly Cognitive Load) (19.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `render` **(Generic / Templated Code)** (Impact: 4.0)
  * `startMenu` **(Callbacks & Closures)** (Impact: 2.5)
  * `onClick` **(Callbacks & Closures)** (Impact: 1.4)
  * `onClick` **(Callbacks & Closures)** (Impact: 1.4)
  * `onClick` **(Encapsulated Accessors)** (Impact: 1.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 38.527; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (64.0%), Connectivity (formerly Api Exposure) (60.2%), Guard Balance (formerly Safety Score) (58.5%), Mutation Surface (formerly State Flux) (26.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `loadResources` **(Callbacks & Closures)** (Impact: 5.8)
  * `onUpdate` **(Callbacks & Closures)** (Impact: 4.8)
  * `addLoadedItem` **(State Mutators)** (Impact: 1.6)
  * `setLoadingStatus` **(State Mutators)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Connectivity (formerly Api Exposure) (10.6%), Complexity Load (formerly Cognitive Load) (6.9%), Test Surface (formerly Verification) (2.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `isAngleBetween` **(Compute Cores)** (Impact: 6.5)
  * `getAngleBetween` **(Parameter Forwarders)** (Impact: 2.1)
  * `normalize` **(Parameter Forwarders)** (Impact: 1.7)
  * `normalize180` **(Parameter Forwarders)** (Impact: 1.7)
  * `toRad` **(Parameter Forwarders)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **4**; blast radius 9.269; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (76.9%), Complexity Load (formerly Cognitive Load) (39.0%), Connectivity (formerly Api Exposure) (34.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `render` **(I/O & Config Routines)** (Impact: 6.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
* *State Mutation (weighted view):* 12
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 3.717; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (94.4%), Guard Balance (formerly Safety Score) (67.7%), Connectivity (formerly Api Exposure) (29.6%), Complexity Load (formerly Cognitive Load) (15.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setLevel` **(I/O & Config Routines)** (Impact: 7.4)
  * `start` **(State Mutators)** (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
* *State Mutation (weighted view):* 9
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.717; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (95.8%), Guard Balance (formerly Safety Score) (68.5%), Connectivity (formerly Api Exposure) (29.9%), Complexity Load (formerly Cognitive Load) (16.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setLevel` **(I/O & Config Routines)** (Impact: 7.4)
  * `start` **(State Mutators)** (Impact: 1.1)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 26.531; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (59.0%), Concurrency Surface (formerly Concurrency) (53.3%), Connectivity (formerly Api Exposure) (49.9%), Complexity Load (formerly Cognitive Load) (11.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `load` **(Compute Cores)** (Impact: 7.4)
  * `handleUrl` **(Parameter Forwarders)** (Impact: 3.7)
  * `getExactPath` **(Parameter Forwarders)** (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 3.717; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (7.1%), Test Surface (formerly Verification) (2.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 3.717; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (61.8%), Mutation Surface (formerly State Flux) (14.1%), Complexity Load (formerly Cognitive Load) (5.6%), Connectivity (formerly Api Exposure) (3.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1`
* *Risk/State:* `state_mutation: 1`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 3.717; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (53.3%), Complexity Load (formerly Cognitive Load) (8.0%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Connectivity (formerly Api Exposure) (8.2%), Complexity Load (formerly Cognitive Load) (6.3%), Test Surface (formerly Verification) (2.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `generateCoordinateNoiseValue` **(Compute Cores)** (Impact: 4.5)
  * `to` **(Callbacks & Closures)** (Impact: 3.0)
  * `Distance` **(Callbacks & Closures)** (Impact: 2.0)
  * `generateTranslate3d` **(Callbacks & Closures)** (Impact: 1.8)
  * `chance` **(Parameter Forwarders)** (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 6.876; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (19.8%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 3.717; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (21.5%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 3.717; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 7.402; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (21.5%), Complexity Load (formerly Cognitive Load) (5.5%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **5**; blast radius 7.402; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (21.5%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 1`, `structural_boundaries: 7`, `args: 1`
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **2**; blast radius 12.364; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (33.5%), Connectivity (formerly Api Exposure) (21.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `load` **(Defensive Guards)** (Impact: 2.7)
  * `handleOperation` **(Encapsulated Accessors)** (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 3.717; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (22.5%), Complexity Load (formerly Cognitive Load) (5.1%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
