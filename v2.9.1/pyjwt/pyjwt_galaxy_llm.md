...
## 1. EXECUTIVE SUMMARY
- **Scope:** 45 analyzed artifact(s), 5394 LOC.
- **Load-bearing artifact:** `pyjwt-2.12.1/jwt/exceptions.py` -- 12 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `pyjwt-2.12.1/jwt/algorithms.py` -- pulls in 22 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `pyjwt-2.12.1/tests/test_algorithms.py` at magnitude 812.82 (structural weight, not risk).
...
| Avg Path Length | 1.274 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
> **Architectural Drift Z-Score:** `4.051`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.05; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 53%, Generic / Templated Code Files 27%, Declarative / Non-Code 4%, Large Core Modules 4%, Large Core Modules (3) 4%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 37.4 | 0.0 | 0.0 |
...
| credential | 67 | 11 | 3 | `pyjwt-2.12.1/tests/test_algorithms.py` |
...
- `encode` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jws.py`) -> Impact: **70.5** | LOC: 89
- `__init__` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jwk.py`) -> Impact: **47.1** | LOC: 63
...
- `_validate_aud` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jwt.py`) -> Impact: **44.9** | LOC: 49
- `_validate_claims` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jwt.py`) -> Impact: **44.5** | LOC: 41
- `from_jwk` **(Defensive Guards)** (@ `pyjwt-2.12.1/jwt/algorithms.py`) -> Impact: **41.8** | LOC: 72
- `decode_complete` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jws.py`) -> Impact: **39.3** | LOC: 50
- `decode_complete` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jwt.py`) -> Impact: **37.9** | LOC: 109
- `_verify_signature` **(Many-Argument Workhorses)** (@ `pyjwt-2.12.1/jwt/api_jws.py`) -> Impact: **33.6** | LOC: 37
- `from_jwk` **(Defensive Guards)** (@ `pyjwt-2.12.1/jwt/algorithms.py`) -> Impact: **30.4** | LOC: 70
- `to_jwk` **(Defensive Guards)** (@ `pyjwt-2.12.1/jwt/algorithms.py`) -> Impact: **24.6** | LOC: 42
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.5%), Connectivity (formerly Api Exposure) (12.7%)
- **Documentation Coverage:** 81.8182% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_ec_to_jwk_with_valid_curves` **(Defensive Guards)** (Impact: 11.7)
  * `test_rsa_to_jwk_returns_correct_values_for_private_key` **(Many-Argument Workhorses)** (Impact: 8.2)
  * `test_ec_jwk_fails_on_invalid_json` **(I/O & Config Routines)** (Impact: 7.2)
  * `test_rsa_to_jwk_returns_correct_values_for_public_key` **(Defensive Guards)** (Impact: 6.5)
  * `test_okp_ed25519_to_jwk_works_with_from_jwk` **(Type Conversions)** (Impact: 6.4)
...
- **Blast Radius:** changing it is visible to **9** in-repo importer(s); it depends on **22**; blast radius 72.273; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Connectivity (formerly Api Exposure) (83.6%), Guard Balance (formerly Safety Score) (81.7%), Complexity Load (formerly Cognitive Load) (68.7%)
- **Documentation Coverage:** 80.3922% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `from_jwk` **(Defensive Guards)** (Impact: 41.8)
  * `from_jwk` **(Defensive Guards)** (Impact: 30.4)
  * `to_jwk` **(Defensive Guards)** (Impact: 24.6)
  * `to_jwk` **(Defensive Guards)** (Impact: 23.0)
  * `prepare_key` **(Defensive Guards)** (Impact: 20.1)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003612 | `Ripple Effect (Closeness):` 0.225936
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Credential Material (formerly Secrets Risk) (100.0%), Guard Balance (formerly Safety Score) (53.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (27.3%)
- **Documentation Coverage:** 91.5663% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_decode_with_expiration_with_leeway` **(Generic / Templated Code)** (Impact: 6.9)
  * `test_decode_strict_aud_does_not_match` **(Generic / Templated Code)** (Impact: 6.8)
  * `test_decode_warns_on_unsupported_kwarg` **(Defensive Guards)** (Impact: 6.7)
  * `test_decode_complete_warns_on_unsupported_kwarg` **(Defensive Guards)** (Impact: 6.7)
  * `test_decode_strict_aud_forbids_list_claim` **(Generic / Templated Code)** (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (26.8%), Complexity Load (formerly Cognitive Load) (21.5%), Connectivity (formerly Api Exposure) (12.6%)
- **Documentation Coverage:** 98.7654% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_decode_warns_on_unsupported_kwarg` **(Defensive Guards)** (Impact: 7.0)
  * `test_decode_complete_warns_on_unuspported_kwarg` **(Defensive Guards)** (Impact: 7.0)
  * `test_rsa_related_algorithms` **(Defensive Guards)** (Impact: 6.1)
  * `test_ecdsa_related_algorithms` **(Defensive Guards)** (Impact: 5.9)
  * `test_decode_rejects_unknown_crit_extension` **(Generic / Templated Code)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **12**; blast radius 22.611; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.7%), Complexity Load (formerly Cognitive Load) (60.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 58.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `encode` **(Many-Argument Workhorses)** (Impact: 70.5)
  * `decode_complete` **(Many-Argument Workhorses)** (Impact: 39.3)
  * `_verify_signature` **(Many-Argument Workhorses)** (Impact: 33.6)
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 12.9)
  * `_validate_crit` **(Stateful Encapsulated Methods)** (Impact: 12.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000529 | `Ripple Effect (Closeness):` 0.081169
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **16**; blast radius 23.493; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.7%), Guard Balance (formerly Safety Score) (82.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (30.8%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_validate_aud` **(Many-Argument Workhorses)** (Impact: 44.9)
  * `_validate_claims` **(Many-Argument Workhorses)** (Impact: 44.5)
  * `decode_complete` **(Many-Argument Workhorses)** (Impact: 37.9)
  * `encode` **(Many-Argument Workhorses)** (Impact: 20.2)
  * `_validate_iss` **(Stateful Encapsulated Methods)** (Impact: 19.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (39.2%), Guard Balance (formerly Safety Score) (17.3%), Connectivity (formerly Api Exposure) (11.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_from_dict_should_throw_exception_if_arg_is_invalid` **(I/O & Config Routines)** (Impact: 3.5)
  * `test_keyset_iterator` **(Defensive Guards)** (Impact: 3.4)
  * `test_keyset_should_index_by_kid` **(Defensive Guards)** (Impact: 2.5)
  * `test_should_load_key_from_jwk_data_dict` **(Defensive Guards)** (Impact: 2.4)
  * `test_should_load_key_from_jwk_data_json_string` **(Defensive Guards)** (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **8**; blast radius 52.354; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.2%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (69.3%)
- **Documentation Coverage:** 56.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 47.1)
  ...
  * `__getitem__` **(Generic / Templated Code)** (Impact: 7.2)
  * `from_json` **(Generic / Templated Code)** (Impact: 2.3)
    * *Intent:* """Create a :class:`PyJWK` object from a JSON string. Implicitly calls :meth:`PyJWK.from_dict()`. :p...
  * `from_dict` **(Generic / Templated Code)** (Impact: 2.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003171 | `Ripple Effect (Closeness):` 0.181818
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **11**; blast radius 17.577; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 14.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `__init__` **(Many-Argument Workhorses)** (Impact: 22.8)
  * `get_signing_keys` **(Generic / Templated Code)** (Impact: 9.9)
    * *Intent:* """Return all signing keys from the JWK Set. Filters the JWK Set to keys whose ``use`` is ``"sig"`` ...
  * `get_jwk_set` **(Defensive Guards)** (Impact: 9.8)
    * *Intent:* """Return the JWK Set, using the cache when available. :param refresh: Force a fresh fetch from the ...
  * `fetch_data` **(Defensive Guards)** (Impact: 7.1)
    * *Intent:* """Fetch the JWK Set from the JWKS endpoint. Makes an HTTP request to the configured ``uri`` and ret...
  * `get_signing_key` **(Compute Cores)** (Impact: 6.5)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **6**; blast radius 42.66; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.2%), Connectivity (formerly Api Exposure) (63.1%), Complexity Load (formerly Cognitive Load) (52.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `force_bytes` **(Defensive Guards)** (Impact: 6.0)
  * `to_base64url_uint` **(Generic / Templated Code)** (Impact: 5.7)
  * `raw_to_der_signature` **(Type Conversions)** (Impact: 4.0)
  * `bytes_from_int` **(Generic / Templated Code)** (Impact: 3.8)
  * `base64url_decode` **(Generic / Templated Code)** (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 15.396; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (98.9%), Guard Balance (formerly Safety Score) (84.3%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `info` **(I/O & Config Routines)** (Impact: 7.2)
    * *Intent:* """ Generate information for a bug report. Based on the requests package help utility module. """
  * `main` **(Generic / Templated Code)** (Impact: 1.1)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **3**; blast radius 19.131; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.1%), Guard Balance (formerly Safety Score) (72.0%), Connectivity (formerly Api Exposure) (51.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `put` **(Generic / Templated Code)** (Impact: 5.5)
  * `is_expired` **(Generic / Templated Code)** (Impact: 4.6)
  * `get` **(Generic / Templated Code)** (Impact: 4.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (98.0%), Guard Balance (formerly Safety Score) (73.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (20.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); blast radius 104.541; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.2%), Connectivity (formerly Api Exposure) (98.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **1**; blast radius 69.18; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (73.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (44.2%), Mutation Surface (formerly State Flux) (31.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.5%), Connectivity (formerly Api Exposure) (55.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (5.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `decode_value` **(Generic / Templated Code)** (Impact: 1.6)
  * `load_ec_pub_key_p_521` **(Interface Declarations)** (Impact: 1.4)
  * `load_hmac_key` **(Generic / Templated Code)** (Impact: 1.2)
  * `load_rsa_pub_key` **(Generic / Templated Code)** (Impact: 1.1)
  * `load_rsa_pub_key` **(Generic / Templated Code)** (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 15.396; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Credential Material (formerly Secrets Risk) (100.0%), Dead Code Surface (formerly Dead Code) (81.8%), Guard Balance (formerly Safety Score) (69.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_ghsa_ffqj_6fqr_9h24` **(I/O & Config Routines)** (Impact: 3.9)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); blast radius 37.323; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (69.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (40.2%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- `pyjwt-2.12.1/jwt/algorithms.py` -> **Severity: 0.361** (Bridge: 0.0036 * Flux: 99.9961%)
- `pyjwt-2.12.1/jwt/api_jwk.py` -> **Severity: 0.317** (Bridge: 0.0032 * Flux: 99.9998%)
- `pyjwt-2.12.1/jwt/api_jwt.py` -> **Severity: 0.272** (Bridge: 0.0027 * Flux: 99.7159%)
- `pyjwt-2.12.1/jwt/api_jws.py` -> **Severity: 0.053** (Bridge: 0.0005 * Flux: 100.0%)
