...
## 1. EXECUTIVE SUMMARY
- **Scope:** 295 analyzed artifact(s), 34254 LOC.
- **Load-bearing artifact:** `test/data/iframeTest.js` -- 44 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `src/selector.js` -- pulls in 23 dependencies, the widest assembly point in the scan.
...
> **Architectural Drift Z-Score:** `4.339`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.34; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 55%, Callbacks & Closures Files 15%, Large Core Modules (2) 13%, Declarative / Non-Code 8%, Many-Argument Workhorses Files 3%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 69.9 | 2.0 | 0.0 | 0.0 |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `matcherFromGroupMatchers` **(Many-Argument Workhorses)** (Impact: 68.4)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (74.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (69.9%), Guard Balance (formerly Safety Score) (39.0%), Connectivity (formerly Api Exposure) (19.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `success` **(Callbacks & Closures)** (Impact: 8.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.6%), Guard Balance (formerly Safety Score) (95.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.4%), Complexity Load (formerly Cognitive Load) (80.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `dispatch` **(Defensive Guards)** (Impact: 30.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 120 instances
...
- **Magnitude:** 807.66 | **LOC:** 3227 | **CtrlFlow:** 6.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (74.1%), Guard Balance (formerly Safety Score) (45.3%), Complexity Load (formerly Cognitive Load) (34.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `testAppendForObject` **(Many-Argument Workhorses)** (Impact: 31.6)
  * `testAppend` **(Many-Argument Workhorses)** (Impact: 21.1)
  * `testReplaceWith` **(Many-Argument Workhorses)** (Impact: 6.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (79.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (73.1%), Guard Balance (formerly Safety Score) (43.2%), Complexity Load (formerly Cognitive Load) (24.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (8.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (50.0%), Guard Balance (formerly Safety Score) (42.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `onRejected` **(Callbacks & Closures)** (Impact: 4.8)
  * `createDeferred` **(Parameter Forwarders)** (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (51.7%), Guard Balance (formerly Safety Score) (39.0%), Complexity Load (formerly Cognitive Load) (21.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `progress` **(Callbacks & Closures)** (Impact: 7.5)
  * `step` **(Defensive Guards)** (Impact: 7.4)
  * `step` **(Defensive Guards)** (Impact: 7.3)
  * `progress` **(State Mutators)** (Impact: 6.5)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (56.5%), Complexity Load (formerly Cognitive Load) (32.0%), Concurrency Surface (formerly Concurrency) (17.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (35.5%), Concurrency Surface (formerly Concurrency) (33.6%), Guard Balance (formerly Safety Score) (33.5%), Connectivity (formerly Api Exposure) (27.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.7%), Guard Balance (formerly Safety Score) (32.3%), Concurrency Surface (formerly Concurrency) (22.1%), Complexity Load (formerly Cognitive Load) (10.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (89.8%), Complexity Load (formerly Cognitive Load) (81.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `set` **(Defensive Guards)** (Impact: 15.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 3.131; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Guard Balance (formerly Safety Score) (84.6%), Connectivity (formerly Api Exposure) (44.7%), Complexity Load (formerly Cognitive Load) (35.9%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (32.4%), Concurrency Surface (formerly Concurrency) (13.1%), Complexity Load (formerly Cognitive Load) (10.1%), Dead Code Surface (formerly Dead Code) (5.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `testVal` **(Compute Cores)** (Impact: 14.0)
  * `testAddClass` **(Compute Cores)** (Impact: 9.2)
  * `testToggleClass` **(Compute Cores)** (Impact: 8.4)
  * `testFalseSetter` **(Callbacks & Closures)** (Impact: 6.0)
  * `testRemoveClass` **(Compute Cores)** (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 51 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (75.7%), Concurrency Surface (formerly Concurrency) (74.1%), Guard Balance (formerly Safety Score) (62.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.0%), Connectivity (formerly Api Exposure) (85.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (19.4%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.197; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.5%), Guard Balance (formerly Safety Score) (56.7%), Complexity Load (formerly Cognitive Load) (20.5%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.7%)
- **Documentation Coverage:** 89.4737% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `jsonp` **(Defensive Guards)** (Impact: 21.2)
  * `script` **(Many-Argument Workhorses)** (Impact: 15.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `clone` **(Many-Argument Workhorses)** (Impact: 32.4)
  * `html` **(Defensive Guards)** (Impact: 18.9)
  * `remove` **(Defensive Guards)** (Impact: 17.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Complexity Load (formerly Cognitive Load) (97.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.197; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (64.0%), Connectivity (formerly Api Exposure) (30.6%), Complexity Load (formerly Cognitive Load) (23.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (15.7%)
- **Documentation Coverage:** 98.3051% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `script` **(Stateful Encapsulated Methods)** (Impact: 12.7)
  * `jsonp` **(Stateful Encapsulated Methods)** (Impact: 10.6)
  * `json` **(Stateful Encapsulated Methods)** (Impact: 7.8)
  * `etag` **(Stateful Encapsulated Methods)** (Impact: 6.5)
  * `ims` **(Stateful Encapsulated Methods)** (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (96.4%), Guard Balance (formerly Safety Score) (95.8%), Complexity Load (formerly Cognitive Load) (91.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.197; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.5%), Complexity Load (formerly Cognitive Load) (81.8%), Debt Markers (formerly Tech Debt) (23.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `offset` **(Compute Cores)** (Impact: 8.8)
...
- `test/data/mock.php` -> **Apoorv Darshan** (100.0% isolated ownership) | Magnitude: 236.2
