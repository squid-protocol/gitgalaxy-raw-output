...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3708 analyzed artifact(s), 1183107 LOC.
- **Load-bearing artifact:** `frame/module_configure.F` -- 201 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `phys/module_physics_init.F` -- pulls in 117 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `phys/module_mp_nssl_2mom.F` at magnitude 50203.82 (structural weight, not risk).
...
|---|---|---|
| Modularity | 0.6851 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.1686 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.0% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.0925 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
| Articulation Pts | 82 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| FORTRAN | 2929 | 1084647 | 79.0% |
| C | 339 | 68809 | 9.1% |
| MAKEFILE | 163 | 7858 | 4.4% |
| PLAINTEXT | 116 | 7 | 3.1% |
| SHELL | 85 | 14030 | 2.3% |
| MARKDOWN | 26 | 0 | 0.7% |
| PYTHON | 13 | 2243 | 0.4% |
...
> **Architectural Drift Z-Score:** `4.042`
> **Composition Archetype:** `Flat Modular Platform` (z +4.04; from the repo's file-archetype mix)
> **File Composition:** Many-Argument Workhorses Files 32%, Declarative / Non-Code 31%, Data / Markup / Trivial 15%, Large Core Modules (2) 8%, Large Core Modules 5%
...
|---|---|---|
| Unclassified | 3560 | 96.0% |
| Unknown | 12 | 0.3% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 136 | 3.7% |
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 63.3 | 82.3 | 0.0 |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 7.9 | 3.1 | 0.0 |
...
| cleanup | 4975 | 655 | 2 | `wrftladj/module_adtl_grid_utilities.F` |
| guards | 100642 | 1604 | 52 | `phys/module_ra_rrtmg_swf.F` |
| danger | 20884 | 1441 | 8 | `tools/regtest_hwrf.csh` |
| concurrency | 7660 | 233 | 0 | `phys/module_mp_wdm7.F` |
| connectivity | 14771 | 2553 | 9 | `arch/md_calls.inc` |
| io | 26827 | 1195 | 13 | `tools/regtest.csh` |
| crypto | 0 | 0 | 0 | - |
...
| events | 276 | 54 | 0 | `var/da/da_statistics/da_analysis_stats.inc` |
| tests | 34 | 16 | 0 | `configure` |
| docs | 2613 | 233 | 0 | `frame/module_io.F` |
| debt | 13796 | 717 | 5 | `chem/chemics_init.F` |
| mutation | 631718 | 3044 | 327 | `chem/module_isofwd.F` |
| dead_code | 11869 | 1693 | 6 | `wrftladj/module_em_ad.F` |
...
| ui | 126 | 4 | 0 | `external/io_phdf5/INSTALL.htm` |
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); blast radius 0.217; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Complexity Load (formerly Cognitive Load) (89.2%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **4**; blast radius 0.23; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (76.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **35**; blast radius 0.222; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (88.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (61.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 0.217; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **25**; blast radius 0.375; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.3e-05 | `Ripple Effect (Closeness):` 0.002211
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.21; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ISRP4F2p1` **(Many-Argument Workhorses)** (Impact: 216.3)
  * `ISRP3F2p1` **(Many-Argument Workhorses)** (Impact: 110.6)
  * `FUNCP52p1` **(I/O & Config Routines)** (Impact: 62.9)
  * `FUNCP42p1` **(I/O & Config Routines)** (Impact: 62.9)
  * `FUNCP32p1` **(I/O & Config Routines)** (Impact: 62.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **4**; blast radius 0.236; role: Transceiver (Middle-Tier)
...
- **Blast Radius:** changing it is visible to **5** in-repo importer(s); it depends on **3**; blast radius 0.264; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2e-06 | `Ripple Effect (Closeness):` 0.002342
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **7**; blast radius 0.232; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (88.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `map_mosaic_species` **(Many-Argument Workhorses)** (Impact: 1416.0)
  * `equilibrium` **(Many-Argument Workhorses)** (Impact: 156.4)
  * `load_kappa_nonelectro` **(I/O & Config Routines)** (Impact: 112.5)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 0.217; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (90.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **8**; blast radius 0.217; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `FAST_HUCMINIT` **(Many-Argument Workhorses)** (Impact: 302.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **117**; blast radius 0.217; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.4%), Guard Balance (formerly Safety Score) (52.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **39**; blast radius 0.274; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Complexity Load (formerly Cognitive Load) (88.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `RRTMG_LWRAD_FAST` **(Many-Argument Workhorses)** (Impact: 1939.1)
  * `deallocateGPUrtrnmcg` **(Many-Argument Workhorses)** (Impact: 704.9)
  * `copyGPUcldprmcg` **(Many-Argument Workhorses)** (Impact: 209.6)
  * `rrtmg_lw_part` **(Many-Argument Workhorses)** (Impact: 165.2)
  * `copyGPUSetCoef` **(I/O & Config Routines)** (Impact: 58.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **37**; blast radius 0.274; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **4**; blast radius 0.22; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Complexity Load (formerly Cognitive Load) (87.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **10**; blast radius 0.218; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.21; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ISRP3R` **(Many-Argument Workhorses)** (Impact: 124.3)
  * `ISRP3F` **(Many-Argument Workhorses)** (Impact: 110.5)
  * `CALCR1` **(I/O & Config Routines)** (Impact: 86.7)
...
- **Blast Radius:** changing it is visible to **12** in-repo importer(s); it depends on **5**; blast radius 0.501; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (64.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-06 | `Ripple Effect (Closeness):` 0.003213
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.21; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ISRP4R2p1` **(Many-Argument Workhorses)** (Impact: 212.8)
  * `ISRP3R2p1` **(Many-Argument Workhorses)** (Impact: 124.2)
  * `CALCR12p1` **(I/O & Config Routines)** (Impact: 86.7)
  * `CALCU12p1` **(I/O & Config Routines)** (Impact: 86.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 0.21; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Complexity Load (formerly Cognitive Load) (81.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (78.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `chem_init` **(Many-Argument Workhorses)** (Impact: 11599.5)
  * `print_chem_species_index` **(I/O & Config Routines)** (Impact: 52.3)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **35**; blast radius 0.226; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 0.22; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **15**; blast radius 0.31; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (81.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 0.31
  * `Choke Point (Betweenness):` 1.9e-05 | `Ripple Effect (Closeness):` 0.001703
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **1**; blast radius 0.239; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Complexity Load (formerly Cognitive Load) (93.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `frame/module_configure.F` -> **Severity: 4.024** (Embedded: 0.0517 * Error Risk: 77.7661%)
- `frame/module_domain.F` -> **Severity: 2.866** (Embedded: 0.0324 * Error Risk: 88.35%)
- `frame/module_wrf_error.F` -> **Severity: 2.747** (Embedded: 0.0525 * Error Risk: 52.3512%)
- `external/RSL_LITE/module_dm.F` -> **Severity: 2.294** (Embedded: 0.0238 * Error Risk: 96.3431%)
- `frame/module_machine.F` -> **Severity: 2.193** (Embedded: 0.0229 * Error Risk: 95.7646%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `frame/module_wrf_error.F` -> **Severity: 2263.1** (Blast Radius: 22.631 * Doc Risk: 100.0%)
- `frame/module_configure.F` -> **Severity: 1291.6** (Blast Radius: 12.916 * Doc Risk: 100.0%)
- `frame/module_driver_constants.F` -> **Severity: 1237.0** (Blast Radius: 12.37 * Doc Risk: 100.0%)
- `share/module_model_constants.F` -> **Severity: 1201.5** (Blast Radius: 12.015 * Doc Risk: 100.0%)
- `frame/module_domain.F` -> **Severity: 676.161** (Blast Radius: 6.888 * Doc Risk: 98.1651%)
