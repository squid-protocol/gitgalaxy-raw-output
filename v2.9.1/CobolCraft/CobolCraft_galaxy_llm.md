...
## 1. EXECUTIVE SUMMARY
- **Scope:** 273 analyzed artifact(s), 23449 LOC.
- **Load-bearing artifact:** `src/_copybooks/state/DD-PLAYERS.cpy` -- 57 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `cpp/cobolcraft_util.cpp` -- pulls in 15 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `codegen/generators/blocks_loot_table.cob` at magnitude 686.04 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `4.594`
> **Composition Archetype:** `Small Flat Repo (2)` (z +4.59; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 46%, Data / Markup / Trivial 23%, Large Core Modules 19%, Interface Declarations Files 6%, State Mutators Files 3%
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 92.8 | 20.5 | 5.5 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 31.1 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 503 | 84 | 2 | `cpp/cobolcraft_util.cpp` |
...
| dead_code | 289 | 71 | 2 | `tests/encoding/json-parse.test.cob` |
| credential | 0 | 0 | 0 | - |
...
- `OpenFile` **(I/O & Config Routines)** (@ `src/region.cob`) -> Impact: **82.5** | LOC: 511
- `LoadChunkEntities` **(I/O & Config Routines)** (@ `src/world/chunk-io.cob`) -> Impact: **69.6** | LOC: 392
- `CHAR-ALPHA` **(I/O & Config Routines)** (@ `src/encoding/json-parse.cob`) -> Impact: **57.5** | LOC: 251
...
- `InsertEntry` **(I/O & Config Routines)** (@ `src/datapack.cob`) -> Impact: **47.2** | LOC: 205
- `AssertOk` **(I/O & Config Routines)** (@ `codegen/generators/blocks_loot_table.cob`) -> Impact: **43.7** | LOC: 214
- `CHAR-ALPHA` **(I/O & Config Routines)** (@ `src/encoding/json-parse.cob`) -> Impact: **40.8** | LOC: 196
- `PARTS` **(I/O & Config Routines)** (@ `src/commands.cob`) -> Impact: **38.8** | LOC: 235
...
|---|---|---|---|---|
| `src` | 17 | 2562.8 | 47.84% | 21.78% |
| `src/encoding` | 8 | 1637.56 | 62.2% | 18.32% |
| `tests/encoding` | 8 | 1216.06 | 4.36% | 0.0% |
| `codegen/generators` | 4 | 939.68 | 41.49% | 7.64% |
| `src/packets/clientbound/play` | 37 | 921.14 | 7.97% | 32.64% |
| `src/items` | 14 | 769.1 | 51.28% | 28.59% |
| `src/world` | 6 | 733.33 | 61.53% | 23.55% |
| `src/packets/serverbound/play` | 22 | 523.66 | 18.13% | 37.46% |
...
- `tests/encoding/json-parse.test.cob` -> **26** Orphaned Functions | **0** Duplicates
...
- **Magnitude:** 686.04 | **LOC:** 1527 | **CtrlFlow:** 18.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (47.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `AssertOk` **(I/O & Config Routines)** (Impact: 43.7)
  * `GenerateFunctions` **(Compute Cores)** (Impact: 38.1)
  * `AssertOk` **(I/O & Config Routines)** (Impact: 31.9)
  * `ReplaceBody` **(Compute Cores)** (Impact: 17.8)
...
* *Structure:* `branch: 207`, `structural_boundaries: 329`, `args: 512`, `func_start: 21`, `class_start: 24`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.1%), Debt Markers (formerly Tech Debt) (88.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.8%), Complexity Load (formerly Cognitive Load) (65.7%), Dead Code Surface (formerly Dead Code) (11.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `CHAR-ALPHA` **(I/O & Config Routines)** (Impact: 57.5)
  * `CHAR-ALPHA` **(I/O & Config Routines)** (Impact: 40.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Complexity Load (formerly Cognitive Load) (62.8%), Dead Code Surface (formerly Dead Code) (8.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `OpenFile` **(I/O & Config Routines)** (Impact: 82.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.4%), Debt Markers (formerly Tech Debt) (84.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `InsertEntry` **(I/O & Config Routines)** (Impact: 47.2)
...
- **Magnitude:** 332.96 | **LOC:** 934 | **CtrlFlow:** 11.7% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (87.6%), Guard Balance (formerly Safety Score) (81.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ServerLoop` **(I/O & Config Routines)** (Impact: 29.4)
  * `HandleClientError` **(I/O & Config Routines)** (Impact: 28.6)
  * `ReceivePacket` **(I/O & Config Routines)** (Impact: 13.9)
  * `NetworkRead` **(Compute Cores)** (Impact: 10.5)
  * `RegisterItems` **(I/O & Config Routines)** (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 79`, `structural_boundaries: 149`, `args: 202`, `func_start: 28`, `class_start: 6`
* *Risk/State:* `high_risk_execution: 1`, `state_mutation: 82`, `dead_code: 4`, `planned_debt: 5`, `unreferenced_by_name: 17`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.4%), Complexity Load (formerly Cognitive Load) (72.2%), Debt Markers (formerly Tech Debt) (38.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `INT32-BYTES` **(I/O & Config Routines)** (Impact: 15.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Complexity Load (formerly Cognitive Load) (66.9%), Dead Code Surface (formerly Dead Code) (40.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Magnitude:** 264.26 | **LOC:** 651 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (77.3%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `EscapedUnicodeChar` **(Interface Declarations)** (Impact: 1.5)
  * `Simple` **(State Mutators)** (Impact: 1.4)
  * `Missing` **(Interface Declarations)** (Impact: 1.4)
  * `Simple` **(State Mutators)** (Impact: 1.4)
  * `Missing` **(Interface Declarations)** (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 68`, `args: 195`, `func_start: 57`, `class_start: 14`
* *Risk/State:* `state_mutation: 173`, `planned_debt: 1`, `unreferenced_by_name: 26`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (79.5%), Complexity Load (formerly Cognitive Load) (34.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `NotAtEnd` **(I/O & Config Routines)** (Impact: 2.5)
  * `AtEnd` **(I/O & Config Routines)** (Impact: 2.4)
...
- **Global Archetype:** `file_cluster_8` (Drift: 0.0 IQR)
- **Magnitude:** 242.36 | **LOC:** 360 | **CtrlFlow:** 26.5% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.7%), Complexity Load (formerly Cognitive Load) (92.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 75`, `structural_boundaries: 75`, `args: 66`, `func_start: 8`, `class_start: 1`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (95.6%), Complexity Load (formerly Cognitive Load) (83.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `LK-ENTITY` **(I/O & Config Routines)** (Impact: 12.6)
  * `LK-ENTITY` **(I/O & Config Routines)** (Impact: 11.1)
  * `LK-ENTITY` **(I/O & Config Routines)** (Impact: 7.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (66.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Simple` **(I/O & Config Routines)** (Impact: 1.6)
  * `HelloWorld` **(Interface Declarations)** (Impact: 1.5)
  * `WikiVgExample` **(Interface Declarations)** (Impact: 1.5)
  * `Empty` **(I/O & Config Routines)** (Impact: 1.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.4%), Complexity Load (formerly Cognitive Load) (43.3%), Connectivity (formerly Api Exposure) (13.0%)
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 201.7 | **LOC:** 377 | **CtrlFlow:** 22.5% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `LK-ITEM` **(Compute Cores)** (Impact: 10.2)
  * `FindEmptySlot` **(Compute Cores)** (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 24 instances
* *State Mutation (weighted view):* 98
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 64`, `structural_boundaries: 91`, `args: 26`, `func_start: 14`, `class_start: 6`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (67.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `NegativeMax` **(I/O & Config Routines)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Complexity Load (formerly Cognitive Load) (60.7%), Debt Markers (formerly Tech Debt) (34.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `LK-BLOCK-ENTITIES` **(I/O & Config Routines)** (Impact: 32.0)
  * `LK-SECTIONS` **(Interface Declarations)** (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (87.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 181.52 | **LOC:** 419 | **CtrlFlow:** 8.0% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.5%), Complexity Load (formerly Cognitive Load) (56.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (32.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `BYTE-ALPHA` **(I/O & Config Routines)** (Impact: 10.5)
  * `LK-VALUE` **(I/O & Config Routines)** (Impact: 6.4)
  * `LK-SLOT` **(I/O & Config Routines)** (Impact: 5.8)
  * `VALUE-BYTES` **(I/O & Config Routines)** (Impact: 5.2)
  * `VALUE-BYTES` **(Annotated & Test Methods)** (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 26 instances
* *State Mutation (weighted view):* 112
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 25`, `structural_boundaries: 92`, `args: 64`, `func_start: 12`, `class_start: 13`
...
- **Global Archetype:** `file_cluster_7` (Drift: 0.0 IQR)
- **Magnitude:** 171.3 | **LOC:** 413 | **CtrlFlow:** 9.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.3%), Complexity Load (formerly Cognitive Load) (47.6%), Debt Markers (formerly Tech Debt) (20.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `BYTE-ALPHA` **(I/O & Config Routines)** (Impact: 14.8)
  * `LK-VALUE-IN` **(I/O & Config Routines)** (Impact: 8.7)
  * `VALUE-BYTES` **(Annotated & Test Methods)** (Impact: 3.8)
  * `VALUE-BYTES` **(Annotated & Test Methods)** (Impact: 2.8)
  * `VALUE-BYTES` **(Annotated & Test Methods)** (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 28`, `structural_boundaries: 93`, `args: 57`, `func_start: 13`, `class_start: 15`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.9%), Complexity Load (formerly Cognitive Load) (61.9%), Debt Markers (formerly Tech Debt) (35.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.8%), Complexity Load (formerly Cognitive Load) (62.8%), Dead Code Surface (formerly Dead Code) (11.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `LK-POSITION` **(I/O & Config Routines)** (Impact: 16.1)
  * `LK-POSITION` **(I/O & Config Routines)** (Impact: 9.2)
  * `LK-POSITION` **(Interface Declarations)** (Impact: 6.5)
  * `LK-BLOCK-ENTITY` **(I/O & Config Routines)** (Impact: 4.2)
  * `LK-POSITION` **(I/O & Config Routines)** (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.5%), Complexity Load (formerly Cognitive Load) (34.0%), Connectivity (formerly Api Exposure) (10.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 32 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 2.224; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Complexity Load (formerly Cognitive Load) (65.1%), Debt Markers (formerly Tech Debt) (15.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- `src/encoding/decode.cob` -> **Simon Sobisch** (100.0% isolated ownership) | Magnitude: 181.52
