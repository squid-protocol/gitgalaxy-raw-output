# ARCHITECTURAL_BRIEF: hash_table_zos_asm
...
| **Git Remote** | `https://github.com/tobiaslinke/hash_table_zos_asm.git` |
...
- `no_extension`: 31x Unsupported Format (.undeterminable), 5x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
