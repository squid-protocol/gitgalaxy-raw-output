...
## 1. EXECUTIVE SUMMARY
- **Scope:** 682 analyzed artifact(s), 85489 LOC.
- **Load-bearing artifact:** `crates/tauri/mobile/android/src/main/java/app/tauri/annotation/TauriPlugin.kt` -- 21 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `crates/tauri-runtime-wry/src/lib.rs` -- pulls in 136 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `crates/tauri-runtime-wry/src/lib.rs` at magnitude 1936.08 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.249`
> **Composition Archetype:** `Mid Flat Project` (z +2.25; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 41%, Generic / Templated Code Files 14%, Large Core Modules (3) 10%, Large Core Modules (2) 9%, Declarative / Non-Code 7%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 34.0 | 45.2 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 48.7 | 50.0 | 0.0 |
...
| connectivity | 4737 | 356 | 15 | `crates/tauri-utils/src/config.rs` |
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **136**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.6%), Guard Balance (formerly Safety Score) (67.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.2%)
- **Documentation Coverage:** 93.3824% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (85.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (81.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (39.4%)
- **Documentation Coverage:** 75.1515% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `fmt` **(Generic / Templated Code)** (Impact: 11.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **64**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (99.9%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (56.6%), Guard Balance (formerly Safety Score) (50.1%)
- **Documentation Coverage:** 6.8047% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **62**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (88.1%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (70.7%), Guard Balance (formerly Safety Score) (61.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **71**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Concurrency Surface (formerly Concurrency) (94.9%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.9%)
- **Documentation Coverage:** 2.8205% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `on_download` **(Generic / Templated Code)** (Impact: 6.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **93**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.8%), Concurrency Surface (formerly Concurrency) (93.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (42.5%), Debt Markers (formerly Tech Debt) (31.9%), Mutation Surface (formerly State Flux) (25.8%)
- **Documentation Coverage:** 75.5319% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **83**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (76.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (57.2%), Guard Balance (formerly Safety Score) (56.7%)
- **Documentation Coverage:** 9.816% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `emit_js` **(Stateful Encapsulated Methods)** (Impact: 8.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (77.3%), Guard Balance (formerly Safety Score) (48.3%)
- **Documentation Coverage:** 3.4091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `emitTo` **(Generic / Templated Code)** (Impact: 10.9)
    * *Intent:* /** * * ```typescript * await getCurrentWindow().emit('main', 'window-loaded', { loggedIn: true, tok...
  * `setSizeConstraints` **(Defensive Guards)** (Impact: 10.7)
    * *Intent:* /** * Sets the window inner size constraints. * ```typescript * await getCurrentWindow().setSizeCons...
  * `constructor` **(Defensive Guards)** (Impact: 9.7)
    * *Intent:* * ```typescript * const appWindow = new Window('my-label'); * appWindow.once('tauri://created', func...
  * `emit` **(Generic / Templated Code)** (Impact: 9.4)
    * *Intent:* /** * ```typescript * await getCurrentWindow().emit('window-loaded', { loggedIn: true, token: 'authT...
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **34**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (47.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (68.8%), Connectivity (formerly Api Exposure) (49.4%), Complexity Load (formerly Cognitive Load) (37.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (10.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `process_security` **(Defensive Guards)** (Impact: 25.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (71.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.7%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (76.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (32.3%), Complexity Load (formerly Cognitive Load) (6.5%), Connectivity (formerly Api Exposure) (6.4%)
- **Documentation Coverage:** 97.561% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run` **(Many-Argument Workhorses)** (Impact: 25.9)
  * `create_window` **(Many-Argument Workhorses)** (Impact: 8.2)
    * *Intent:* /// Create a new webview window.
  * `create_window` **(Generic / Templated Code)** (Impact: 8.2)
  * `create_window` **(Many-Argument Workhorses)** (Impact: 8.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (67.8%), Guard Balance (formerly Safety Score) (50.7%), Connectivity (formerly Api Exposure) (45.1%), Complexity Load (formerly Cognitive Load) (15.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `new` **(Many-Argument Workhorses)** (Impact: 37.1)
  * `insert` **(Many-Argument Workhorses)** (Impact: 21.0)
  * `popup` **(Generic / Templated Code)** (Impact: 20.0)
...
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (100.0%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (61.1%), Guard Balance (formerly Safety Score) (36.1%)
- **Documentation Coverage:** 0.7194% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `copy_binaries` **(Generic / Templated Code)** (Impact: 7.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **37**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (62.8%), Guard Balance (formerly Safety Score) (60.6%), Debt Markers (formerly Tech Debt) (38.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **35**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (58.5%), Mutation Surface (formerly State Flux) (51.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (39.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **27**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.1%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (64.6%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **61**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (64.2%), Mutation Surface (formerly State Flux) (63.1%), Debt Markers (formerly Tech Debt) (49.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `emit_filter` **(Stateful Encapsulated Methods)** (Impact: 15.1)
  * `replace_csp_nonce` **(Generic / Templated Code)** (Impact: 13.6)
  * `emit` **(Stateful Encapsulated Methods)** (Impact: 13.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 21 instances
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (49.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (20.4%), Complexity Load (formerly Cognitive Load) (10.7%), Connectivity (formerly Api Exposure) (9.9%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **47**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (47.2%), Mutation Surface (formerly State Flux) (36.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (32.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **42**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (70.1%), Guard Balance (formerly Safety Score) (65.9%), Connectivity (formerly Api Exposure) (53.3%)
- **Documentation Coverage:** 78.2609% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 1.225; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Concurrency Surface (formerly Concurrency) (92.6%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.8%)
- **Documentation Coverage:** 2.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `find_class` **(Generic / Templated Code)** (Impact: 2.6)
    * *Intent:* /// Finds an Android class in the project scope.
  * `remove_data_store` **(Generic / Templated Code)** (Impact: 2.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **110**; blast radius 1.225; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Concurrency Surface (formerly Concurrency) (82.3%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (40.8%)
- **Documentation Coverage:** 28.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_webview_window` **(Generic / Templated Code)** (Impact: 5.7)
    * *Intent:* /// Fetch a single webview window from the manager.
  * `features_are_documented` **(Annotated & Test Methods)** (Impact: 5.5)
...
- `packages/api/src/menu/base.ts` -> **Severity: 0.707** (Embedded: 0.0094 * Error Risk: 75.3298%)
