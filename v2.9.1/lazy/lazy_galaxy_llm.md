...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 296 LOC.
...
- **Top orchestrator:** `package/lazy.js` -- pulls in 3 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/lazy.js` at magnitude 317.82 (structural weight, not risk).
...
- `Lazy` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **67.2** | LOC: 235
- `range` **(Compute Cores)** (@ `package/lazy.js`) -> Impact: **38.4** | LOC: 87
- `mergeBuffers` **(Defensive Guards)** (@ `package/lazy.js`) -> Impact: **10.7** | LOC: 17
- `newLazy` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **9.1** | LOC: 22
- `bucket` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **4.8** | LOC: 26
- `takeWhile` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **4.7** | LOC: 9
- `skip` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **3.3** | LOC: 9
- `take` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **3.1** | LOC: 6
- `tail` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **2.5** | LOC: 10
- `foldr` **(Callbacks & Closures)** (@ `package/lazy.js`) -> Impact: **2.5** | LOC: 10
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.5%), Complexity Load (formerly Cognitive Load) (95.5%), Debt Markers (formerly Tech Debt) (81.3%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Lazy` **(Callbacks & Closures)** (Impact: 67.2)
  * `range` **(Compute Cores)** (Impact: 38.4)
  * `mergeBuffers` **(Defensive Guards)** (Impact: 10.7)
  * `newLazy` **(Callbacks & Closures)** (Impact: 9.1)
  * `bucket` **(Callbacks & Closures)** (Impact: 4.8)
