# ARCHITECTURAL_BRIEF: cross-fetch
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 11 LOC.
...
- **Top orchestrator:** `package/README.md` -- pulls in 6 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/README.md` at magnitude 3.3 (structural weight, not risk).
...
| Connectivity (formerly API Exposure) | 9.1 | 9.1 | 9.1 | 9.1 | 9.1 |
...
| danger | 0 | 0 | 0 | - |
| concurrency | 0 | 0 | 0 | - |
| connectivity | 5 | 1 | 5 | `package/index.d.ts` |
| io | 4 | 1 | 4 | `package/index.d.ts` |
| crypto | 0 | 0 | 0 | - |
| ipc | 0 | 0 | 0 | - |
| time | 0 | 0 | 0 | - |
| serialization | 0 | 0 | 0 | - |
...
1. **README.md** (`package/README.md`) — 6 outbound dependencies
2. **index.d.ts** (`package/index.d.ts`) — 0 outbound dependencies
3. **package.json** (`package/package.json`) — 0 outbound dependencies
4. **package.json** (`package/polyfill/package.json`) — 0 outbound dependencies
...
|---|---|---|---|---|
| `package` | 3 | 6.91 | 1.45% | 0.0% |
| `package/polyfill` | 1 | 1.0 | 0.0% | 0.0% |
...
- **Magnitude:** 3.3 | **LOC:** 165 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` logo-apollo.png, logo-facebook.png, logo-graphql-request.png, logo-nytimes.png, logo-swagger.png, logo-vulcanjs.png
...
- **Magnitude:** 1.01 | **LOC:** 15 | **CtrlFlow:** 9.1% | **Authorship Centralization:** 0.0%
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (9.1%), Complexity Load (formerly Cognitive Load) (4.3%), Test Surface (formerly Verification) (2.3%)
...
### `package/polyfill/package.json` (PLAINTEXT | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Static: Literature & Documentation` (Drift: N/A IQR)
