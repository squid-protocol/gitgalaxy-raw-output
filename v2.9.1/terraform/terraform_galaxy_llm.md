...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2397 analyzed artifact(s), 492438 LOC.
- **Load-bearing artifact:** `internal/command/fmt.go` -- 818 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `internal/command/test_test.go` -- pulls in 194 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `internal/terraform/context_apply_test.go` at magnitude 5128.96 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `3.585`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +3.58; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 27%, Callbacks & Closures Files 14%, Large Core Modules 13%, Compute Cores Files 11%, Large Core Modules (3) 8%
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 5.8 | 0.5 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 5.1 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 50.1 | 50.0 | 0.0 |
...
| connectivity | 17618 | 1664 | 18 | `internal/providers/provider.go` |
...
- `TestContextPlan_actions` **(Many-Argument Workhorses)** (@ `internal/terraform/context_plan_actions_test.go`) -> Impact: **259.7** | LOC: 1800
...
- `TestContextApply_actions` **(Many-Argument Workhorses)** (@ `internal/terraform/context_apply_action_test.go`) -> Impact: **186.3** | LOC: 1803
...
- `backendFromConfig` **(Many-Argument Workhorses)** (@ `internal/command/meta_backend.go`) -> Impact: **174.7** | LOC: 440
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **134**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.6%), Guard Balance (formerly Safety Score) (73.7%), Debt Markers (formerly Tech Debt) (63.9%), Complexity Load (formerly Cognitive Load) (23.6%)
- **Documentation Coverage:** 84.1629% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `TestContext2Apply_taintedDestroyFailure` **(I/O & Config Routines)** (Impact: 29.3)
...
- **Global Archetype:** `file_cluster_2` (Drift: N/A IQR)
- **Magnitude:** 5000.0 | **LOC:** 1 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 0.273; role: Pure Producer (Foundation)
- **Top Surface Vectors:** None above 0%
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* None
* *Risk/State:* None
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **115**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (66.9%), Mutation Surface (formerly State Flux) (64.9%), Guard Balance (formerly Safety Score) (54.2%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (23.2%)
- **Documentation Coverage:** 92.5094% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **126**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (83.8%), Guard Balance (formerly Safety Score) (60.7%), Debt Markers (formerly Tech Debt) (37.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (34.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `TestContext2Plan_resourcePreconditionPostcondition` **(Many-Argument Workhorses)** (Impact: 67.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (82.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 42.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `backendFromConfig` **(Many-Argument Workhorses)** (Impact: 174.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (92.2%), Guard Balance (formerly Safety Score) (89.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 80.3571% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Magnitude:** 1744.84 | **LOC:** 5411 | **CtrlFlow:** 4.6% | **Authorship Centralization:** 92.9%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **103**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.2%), Guard Balance (formerly Safety Score) (71.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (66.9%), Debt Markers (formerly Tech Debt) (34.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `TestContext2Validate_deprecatedAttr` **(Many-Argument Workhorses)** (Impact: 54.5)
  * `TestContext2Validate_queryList` **(I/O & Config Routines)** (Impact: 37.2)
  * `TestContext2Validate_action` **(I/O & Config Routines)** (Impact: 29.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **194**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (89.4%), Guard Balance (formerly Safety Score) (59.7%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (52.3%), Concurrency Surface (formerly Concurrency) (22.9%)
- **Documentation Coverage:** 87.7193% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `TestTest_Runs` **(I/O & Config Routines)** (Impact: 69.3)
  * `TestTest_ParallelTeardown` **(Many-Argument Workhorses)** (Impact: 57.8)
  * `TestTest_Parallel_Divided_Order` **(Compute Cores)** (Impact: 39.2)
  * `TestTest_SkipCleanup_FileLevelFlag` **(I/O & Config Routines)** (Impact: 27.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **28**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (92.8%), Debt Markers (formerly Tech Debt) (90.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.4802% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **110**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.5%), Guard Balance (formerly Safety Score) (73.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (54.4%), Debt Markers (formerly Tech Debt) (39.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `TestContext2Apply_deprecatedOutputsAndVariables` **(I/O & Config Routines)** (Impact: 32.8)
  ...
  * `TestApply_updateDependencies` **(I/O & Config Routines)** (Impact: 22.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **88**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (90.9%), Mutation Surface (formerly State Flux) (50.2%), Guard Balance (formerly Safety Score) (48.1%), Debt Markers (formerly Tech Debt) (42.5%)
- **Documentation Coverage:** 73.3766% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `TestInit_stateStore_configChanges` **(Many-Argument Workhorses)** (Impact: 78.2)
    * *Intent:* // Testing init's behaviors with `state_store` when run in a working directory where the configurati...
  * `TestInit_stateStore_newWorkingDir` **(Many-Argument Workhorses)** (Impact: 65.4)
    * *Intent:* // Testing init's behaviors with `state_store` when run in an empty working directory
  * `TestInit_backendCloudInvalidOptions` **(I/O & Config Routines)** (Impact: 48.4)
  * `TestInit_backend_to_stateStore_multipleWorkspaces` **(I/O & Config Routines)** (Impact: 45.0)
  * `TestInit_backend_to_stateStore_singleWorkspace` **(I/O & Config Routines)** (Impact: 35.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.1%), Debt Markers (formerly Tech Debt) (88.4%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `ApplyResourceChange` **(Defensive Guards)** (Impact: 33.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 0.213; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.0%), Complexity Load (formerly Cognitive Load) (32.2%)
- **Documentation Coverage:** 60.6557% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `internalValidate` **(Many-Argument Workhorses)** (Impact: 136.2)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **18**; blast radius 0.239; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (90.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (51.5%)
...
**Top Internal Functions/Classes:**
  ...
  * `resourceChangeFromTfplan` **(Many-Argument Workhorses)** (Impact: 60.4)
...
- `internal/terraform/context_validate_test.go` -> **Daniel Schmidt** (92.9% isolated ownership) | Magnitude: 1744.84
