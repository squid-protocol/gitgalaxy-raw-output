...
## 1. EXECUTIVE SUMMARY
- **Scope:** 2058 analyzed artifact(s), 480313 LOC.
- **Load-bearing artifact:** `crates/c-api/include/wasm.h` -- 47 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `crates/wasmtime/src/runtime/component/concurrent.rs` -- pulls in 114 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `pulley/src/interp.rs` at magnitude 2682.1 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 2058 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 4389 |
| Total LOC | 480313 |
...
|---|---|---|
| Modularity | 0.6726 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
> **Architectural Drift Z-Score:** `2.848`
> **Composition Archetype:** `Flat Modular Platform` (z +2.85; from the repo's file-archetype mix)
> **File Composition:** State Mutators Files 18%, Large Core Modules (3) 18%, Generic / Templated Code Files 16%, Declarative / Non-Code 10%, Large Core Modules 10%
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 9.1 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 64.1 | 84.1 | 100.0 |
...
|---|---|---|---|---|
| memory | 34304 | 1649 | 44 | `pulley/src/interp.rs` |
...
| dead_code | 10370 | 1291 | 12 | `pulley/src/interp.rs` |
...
- `guard_balance_ratio` (guards / (danger + 1)): **0.1812**
...
- **Unknown Dependencies:** `20994` packages imported that bypass the Zero-Trust whitelist.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (72.4%), Guard Balance (formerly Safety Score) (62.2%)
- **Documentation Coverage:** 92.341% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **114**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (100.0%), Concurrency Surface (formerly Concurrency) (93.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (45.7%)
- **Documentation Coverage:** 32.9218% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **92**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (94.2%), Test Surface (formerly Verification) (80.0%), Debt Markers (formerly Tech Debt) (69.8%)
- **Documentation Coverage:** 38.4937% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 0.409; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.6%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (71.3%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **84**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (97.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (53.4%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.3%)
...
**Top Internal Functions/Classes:**
  ...
  * `visit_memory_copy` **(Compute Cores)** (Impact: 17.2)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **80**; blast radius 0.409; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (61.5%), Guard Balance (formerly Safety Score) (56.2%), Mutation Surface (formerly State Flux) (48.8%)
- **Documentation Coverage:** 80.6818% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **60**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (84.7%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (67.0%), Guard Balance (formerly Safety Score) (54.1%)
- **Documentation Coverage:** 55.2% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (74.1%), Guard Balance (formerly Safety Score) (72.2%), Complexity Load (formerly Cognitive Load) (9.9%), Debt Markers (formerly Tech Debt) (7.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_s390x_binemit` **(I/O & Config Routines)** (Impact: 2.5)
  * `simm20_zero` **(Annotated & Test Methods)** (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **85**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (97.2%), Debt Markers (formerly Tech Debt) (91.7%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.6%)
- **Documentation Coverage:** 81.1798% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **96**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (94.5%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (54.4%), Mutation Surface (formerly State Flux) (15.2%)
- **Documentation Coverage:** 95.302% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (83.1%), Concurrency Surface (formerly Concurrency) (70.3%), Guard Balance (formerly Safety Score) (52.6%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (49.6%)
- **Documentation Coverage:** 91.8919% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `integers` **(I/O & Config Routines)** (Impact: 93.6)
  * `test_many_results` **(Many-Argument Workhorses)** (Impact: 92.3)
  * `test_many_parameters` **(Many-Argument Workhorses)** (Impact: 63.4)
  * `option` **(I/O & Config Routines)** (Impact: 42.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **56**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (80.2%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.9%), Debt Markers (formerly Tech Debt) (31.0%)
- **Documentation Coverage:** 78.626% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Mutation Surface (formerly State Flux) (96.4%), Test Surface (formerly Verification) (80.0%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **66**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (93.8%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (12.4%)
- **Documentation Coverage:** 21.372% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (82.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (36.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (97.4%), Connectivity (formerly Api Exposure) (94.0%), Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (67.9%)
- **Documentation Coverage:** 26.9147% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **36**; blast radius 0.757; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (83.1%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (41.6%), Complexity Load (formerly Cognitive Load) (31.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `extractlanes` **(Stateful Encapsulated Methods)** (Impact: 19.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (95.4%), Debt Markers (formerly Tech Debt) (94.4%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (60.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **31**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (87.2%), Concurrency Surface (formerly Concurrency) (85.6%), Guard Balance (formerly Safety Score) (52.4%), Complexity Load (formerly Cognitive Load) (7.3%)
- **Documentation Coverage:** 96.1039% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `preview2_stdin` **(I/O & Config Routines)** (Impact: 27.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **72**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.3%), Connectivity (formerly Api Exposure) (91.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (87.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 51.5625% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (78.8%), Debt Markers (formerly Tech Debt) (75.9%), Guard Balance (formerly Safety Score) (44.7%)
- **Documentation Coverage:** 67.5497% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **56**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (51.0%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (26.3%), Mutation Surface (formerly State Flux) (19.8%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Guard Balance (formerly Safety Score) (82.6%), Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (53.2%)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (55.2%)
- **Documentation Coverage:** 41.3043% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_magic_generators_give_correct_numbers` **(I/O & Config Routines)** (Impact: 77.2)
  * `test_magic_generators_dont_panic` **(I/O & Config Routines)** (Impact: 37.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.409; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (84.6%), Guard Balance (formerly Safety Score) (52.3%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (41.6%), Complexity Load (formerly Cognitive Load) (6.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `func_constructors` **(Compute Cores)** (Impact: 84.9)
  * `wrap_multiple_results` **(Compute Cores)** (Impact: 77.5)
  * `calls_with_funcref_and_externref` **(Compute Cores)** (Impact: 41.3)
  * `get_from_wrapper` **(Generic / Templated Code)** (Impact: 37.8)
...
- `crates/c-api/include/wasm.h` -> **Severity: 1.918** (Embedded: 0.0309 * Error Risk: 62.1628%)
- `crates/c-api/include/wasmtime/store.h` -> **Severity: 1.862** (Embedded: 0.0217 * Error Risk: 85.6108%)
- `crates/c-api/include/wasi.h` -> **Severity: 1.404** (Embedded: 0.0185 * Error Risk: 75.8792%)
- `crates/c-api/include/wasmtime/module.h` -> **Severity: 1.146** (Embedded: 0.0174 * Error Risk: 65.7332%)
...
- `crates/c-api/include/wasm.h` -> **Severity: 1739.422** (Blast Radius: 18.09 * Doc Risk: 96.1538%)
- `crates/wasi/src/cli/stdout.rs` -> **Severity: 440.9** (Blast Radius: 4.409 * Doc Risk: 100.0%)
- `cranelift/codegen/meta/src/cdsl/isa.rs` -> **Severity: 197.4** (Blast Radius: 1.974 * Doc Risk: 100.0%)
- `cranelift/assembler-x64/src/vex.rs` -> **Severity: 180.225** (Blast Radius: 4.806 * Doc Risk: 37.5%)
