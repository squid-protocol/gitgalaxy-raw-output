...
## 1. EXECUTIVE SUMMARY
- **Scope:** 4 analyzed artifact(s), 1 LOC.
...
- **Heaviest artifact:** `package/index.js` at magnitude 12.52 (structural weight, not risk).
