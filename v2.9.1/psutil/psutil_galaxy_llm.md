...
## 1. EXECUTIVE SUMMARY
- **Scope:** 138 analyzed artifact(s), 32725 LOC.
- **Load-bearing artifact:** `psutil-7.2.2/psutil/arch/all/init.h` -- 83 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `psutil-7.2.2/tests/__init__.py` -- pulls in 33 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `psutil-7.2.2/psutil/_pslinux.py` at magnitude 1855.76 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `0.486`
> **Composition Archetype:** `Small Flat Repo (2)` (z +0.49; from the repo's file-archetype mix)
> **File Composition:** Many-Argument Workhorses Files 28%, Compute Cores Files 19%, Large Core Modules (2) 17%, Large Core Modules (3) 12%, Declarative / Non-Code 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 81.3 | 100.0 | 100.0 |
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **16**; blast radius 5.34; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.1%), Connectivity (formerly Api Exposure) (54.6%), Complexity Load (formerly Cognitive Load) (50.1%)
- **Documentation Coverage:** 56.9697% of unit weight undocumented
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (60.4%)
- **Documentation Coverage:** 21.393% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (30.4%), Guard Balance (formerly Safety Score) (18.6%), Connectivity (formerly Api Exposure) (13.4%)
- **Documentation Coverage:** 86.0369% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **33**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (78.1%), Connectivity (formerly Api Exposure) (65.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Concurrency Surface (formerly Concurrency) (23.3%)
- **Documentation Coverage:** 50.0783% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `copyload_shared_lib` **(Defensive Guards)** (Impact: 17.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (32.2%), Guard Balance (formerly Safety Score) (22.2%), Connectivity (formerly Api Exposure) (12.4%)
- **Documentation Coverage:** 88.924% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **12**; blast radius 5.34; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.7%), Connectivity (formerly Api Exposure) (65.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `convert_dos_path` **(Compute Cores)** (Impact: 8.0)
    * *Intent:* # ===================================================================== # --- utils # ==============...
  * `net_connections` **(Type Conversions)** (Impact: 8.0)
    * *Intent:* # ===================================================================== # --- network # ============...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (30.7%), Connectivity (formerly Api Exposure) (12.0%), Dead Code Surface (formerly Dead Code) (9.4%)
- **Documentation Coverage:** 88.924% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.8%), Complexity Load (formerly Cognitive Load) (88.2%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `psutil_proc_memory_uss` **(Many-Argument Workhorses)** (Impact: 39.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Guard Balance (formerly Safety Score) (81.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (58.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `psutil_proc_exe` **(Many-Argument Workhorses)** (Impact: 39.9)
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **13**; blast radius 47.853; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Connectivity (formerly Api Exposure) (78.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_infodict` **(Stateful Encapsulated Methods)** (Impact: 9.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.9%), Guard Balance (formerly Safety Score) (92.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 60.177% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (39.6%), Guard Balance (formerly Safety Score) (30.7%), Connectivity (formerly Api Exposure) (13.0%)
- **Documentation Coverage:** 86.5527% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (86.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.8%), Complexity Load (formerly Cognitive Load) (84.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **9**; blast radius 3.891; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.0%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (55.4%)
- **Documentation Coverage:** 65.5914% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_get_unix_sockets` **(Stateful Encapsulated Methods)** (Impact: 19.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Complexity Load (formerly Cognitive Load) (93.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `psutil_net_if_stats` **(Many-Argument Workhorses)** (Impact: 50.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.5%), Complexity Load (formerly Cognitive Load) (86.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `psutil_proc_cmdline` **(Many-Argument Workhorses)** (Impact: 18.0)
    * *Intent:* // ============================================================================ // APIS // =========...
  * `psutil_proc_cwd` **(Compute Cores)** (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.408; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (70.0%), Concurrency Surface (formerly Concurrency) (59.8%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (23.8%)
- **Documentation Coverage:** 88.924% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.9%), Complexity Load (formerly Cognitive Load) (81.6%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (79.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `psutil_net_if_addrs` **(Many-Argument Workhorses)** (Impact: 33.8)
    * *Intent:* /* * Return NICs information a-la ifconfig as a list of tuples. * TODO: on Solaris we won't get any ...
  * `psutil_net_if_duplex_speed` **(Compute Cores)** (Impact: 17.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 3.408; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (51.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.7%), Connectivity (formerly Api Exposure) (13.0%)
- **Documentation Coverage:** 85.8577% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_ctx_switches` **(Defensive Guards)** (Impact: 9.4)
  * `test_cpu_times` **(Defensive Guards)** (Impact: 9.4)
  * `test_disks` **(Type Conversions)** (Impact: 8.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.5%), Complexity Load (formerly Cognitive Load) (90.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `psutil_gather_inet` **(Many-Argument Workhorses)** (Impact: 117.0)
    * *Intent:* // Reference: // https://github.com/freebsd/freebsd/blob/master/usr.bin/sockstat/sockstat.c
  * `psutil_gather_unix` **(Many-Argument Workhorses)** (Impact: 50.5)
  * `psutil_net_connections` **(Many-Argument Workhorses)** (Impact: 37.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (27.6%), Connectivity (formerly Api Exposure) (12.5%), Guard Balance (formerly Safety Score) (10.7%)
- **Documentation Coverage:** 83.0447% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 3.408; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (85.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (40.3%), Connectivity (formerly Api Exposure) (11.5%)
- **Documentation Coverage:** 85.9599% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `ps` **(Many-Argument Workhorses)** (Impact: 22.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (58.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (28.4%), Connectivity (formerly Api Exposure) (11.1%)
- **Documentation Coverage:** 82.2128% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 3.408; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `psutil_search_tcplist` **(Many-Argument Workhorses)** (Impact: 40.6)
    * *Intent:* #else
  * `psutil_fetch_tcplist` **(Stateful Encapsulated Methods)** (Impact: 6.2)
