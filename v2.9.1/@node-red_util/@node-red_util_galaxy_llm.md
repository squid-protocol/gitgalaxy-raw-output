# ARCHITECTURAL_BRIEF: @node-red_util
...
## 1. EXECUTIVE SUMMARY
- **Scope:** 3 analyzed artifact(s), 18 LOC.
...
- **Top orchestrator:** `package/index.js` -- pulls in 6 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/index.js` at magnitude 3.96 (structural weight, not risk).
...
| Guard Balance (formerly Error & Exception Exposure) | 61.4 | 61.4 | 61.4 | 61.4 | 61.4 |
...
1. **index.js** (`package/index.js`) — 6 outbound dependencies
...
- `init` **(Callbacks & Closures)** (@ `package/index.js`) -> Impact: **1.6** | LOC: 4
  * *Intent:* /** * Initialise the module with the runtime settings */
...
- **Magnitude:** 3.96 | **LOC:** 82 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 333.333; role: Isolated/Orphan
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (73.1%), Guard Balance (formerly Safety Score) (61.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (16.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `init` **(Callbacks & Closures)** (Impact: 1.6)
    * *Intent:* /** * Initialise the module with the runtime settings */
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `args: 1`, `func_start: 1`
...
* *Network Topology:*
  ...
  * `Imports (Out-Degree: 0):` events, exec, hooks, i18n, log, util
