...
## 1. EXECUTIVE SUMMARY
- **Scope:** 77 analyzed artifact(s), 6699 LOC.
...
- **Top orchestrator:** `package/src/index.ts` -- pulls in 30 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `package/src/client/ClientApplication.ts` at magnitude 217.8 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.115`
> **Composition Archetype:** `Small Flat Repo` (z +2.12; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 22%, Data / Markup / Trivial 19%, Large Core Modules (3) 16%, Many-Argument Workhorses Files 12%, Generic / Templated Code Files 8%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 87.9 | 27.5 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 17.0 | 0.0 | 0.0 |
...
- `getServerTokenResponseAsync` **(Many-Argument Workhorses)** (@ `package/src/client/ManagedIdentitySources/AzureArc.ts`) -> Impact: **30.4** | LOC: 117
  * *Intent:* * * * - WWW-Authenticate header is missing or has unsupported format * - Platform is not supported (not Windows or Linux) * - Secret file has invalid ...
- `continuePolling` **(Many-Argument Workhorses)** (@ `package/src/client/DeviceCodeClient.ts`) -> Impact: **30.1** | LOC: 42
  * *Intent:* /** * Breaks the polling with specific conditions */
...
- `listenForAuthCode` **(Compute Cores)** (@ `package/src/network/LoopbackClient.ts`) -> Impact: **25.1** | LOC: 52
  * *Intent:* /** * Spins up a loopback server which returns the server response when the localhost redirectUri is hit */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.8%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (45.6%)
...
**Top Internal Functions/Classes:**
  ...
  * `initializeBaseRequest` **(Stateful Encapsulated Methods)** (Impact: 12.9)
    * *Intent:* /** * Generates a request with the default scopes & generates a correlationId. */
  ...
  * `createAuthority` **(Stateful Encapsulated Methods)** (Impact: 10.5)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.8%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (77.2%), Guard Balance (formerly Safety Score) (62.0%)
- **Documentation Coverage:** 11.1111% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mergeUpdates` **(Stateful Encapsulated Methods)** (Impact: 19.0)
    * *Intent:* /** * Deep update of oldState based on newState values */
  * `removeAccount` **(Defensive Guards)** (Impact: 13.2)
    * *Intent:* /** * API to remove a specific account and the relevant data from cache */
  * `mergeRemovals` **(Stateful Encapsulated Methods)** (Impact: 12.5)
    * *Intent:* /** * Removes entities in oldState that the were removed from newState. If there are any unknown val...
  * `getAccountByHomeId` **(Generic / Templated Code)** (Impact: 9.2)
    * *Intent:* /** * Returns the signed in account matching homeAccountId. * (the account object is created at the ...
  * `getAccountByLocalId` **(Generic / Templated Code)** (Impact: 9.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (57.4%), Connectivity (formerly Api Exposure) (55.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 11.5942% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `cacheToInMemoryCache` **(Type Conversions)** (Impact: 19.9)
    * *Intent:* /** * Converts cacheKVStore to InMemoryCache */
  ...
  * `removeItem` **(Compute Cores)** (Impact: 5.2)
    * *Intent:* /** * Removes the cache item from memory with the given key. */
  * `getServerTelemetry` **(Type Conversions)** (Impact: 5.1)
    * *Intent:* /** * fetch server telemetry entity from the platform cache */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.1%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (51.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getCachedAuthenticationResult` **(Many-Argument Workhorses)** (Impact: 55.3)
    * *Intent:* /** * looks up cache if the tokens are cached already */
  * `createTokenRequestBody` **(I/O & Config Routines)** (Impact: 16.8)
    * *Intent:* /** * generate the request to the server in the acceptable format */
  * `executeTokenRequest` **(Many-Argument Workhorses)** (Impact: 12.9)
    * *Intent:* /** * Makes a network call to request the token from the service */
  * `readAccessTokenFromCache` **(Stateful Encapsulated Methods)** (Impact: 11.3)
    * *Intent:* /** * Reads access token from the cache */
  * `acquireToken` **(Compute Cores)** (Impact: 10.6)
    * *Intent:* /** * Public API to acquire a token with ClientCredential Flow for Confidential clients */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (93.3%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (74.9%), Guard Balance (formerly Safety Score) (52.8%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `constructor` **(State Mutators)** (Impact: 3.1)
    * *Intent:* /** * Creates an instance of BaseManagedIdentitySource. * */
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
* *Amplified Cascading Flux:* 6 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (47.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `waitForRedirectUri` **(Stateful Encapsulated Methods)** (Impact: 7.6)
    * *Intent:* /** * Attempts to retrieve the redirectUri from the loopback server. If the loopback server does not...
  * `constructor` **(I/O & Config Routines)** (Impact: 6.7)
  ...
  * `signOut` **(Compute Cores)** (Impact: 6.5)
    * *Intent:* /** * Removes cache artifacts associated with the given account */
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (51.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getCachedAuthenticationResult` **(I/O & Config Routines)** (Impact: 19.9)
    * *Intent:* /** * look up cache for tokens * Find idtoken in the cache * Find accessToken based on user assertio...
  * `createTokenRequestBody` **(I/O & Config Routines)** (Impact: 15.8)
    * *Intent:* /** * generate a server request in accepable format */
  * `readAccessTokenFromCacheForOBO` **(Stateful Encapsulated Methods)** (Impact: 14.3)
    * *Intent:* /** * Fetches the cached access token based on incoming assertion */
  * `acquireToken` **(Defensive Guards)** (Impact: 7.1)
    * *Intent:* /** * Public API to acquire tokens with on behalf of flow */
  * `executeTokenRequest` **(Many-Argument Workhorses)** (Impact: 5.0)
    * *Intent:* /** * Make a network call to the server requesting credentials */
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Test Surface (formerly Verification) (80.0%), Concurrency Surface (formerly Concurrency) (72.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (12.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `createTokenRequestBody` **(Many-Argument Workhorses)** (Impact: 13.0)
    * *Intent:* /** * Creates query parameters and converts to string. */
  * `createQueryString` **(Stateful Encapsulated Methods)** (Impact: 8.6)
    * *Intent:* /** * Create device code endpoint query parameters and returns string */
  * `executePostRequestToDeviceCodeEndpoint` **(Stateful Encapsulated Methods)** (Impact: 4.2)
    * *Intent:* /** * Executes POST request to device code endpoint */
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Credential Material (formerly Secrets Risk) (100.0%), Guard Balance (formerly Safety Score) (87.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getJwt` **(Many-Argument Workhorses)** (Impact: 17.4)
    * *Intent:* /** * Update JWT for certificate based clientAssertion, if passed by the user, uses it as is */
  ...
  * `fromCertificate` **(Compute Cores)** (Impact: 6.8)
    * *Intent:* /** * Initialize the ClientAssertion class from the certificate passed by the user */
  * `fromCertificateWithSha256Thumbprint` **(Compute Cores)** (Impact: 6.8)
    * *Intent:* /** * Initialize the ClientAssertion class from the certificate passed by the user */
  * `parseCertificate` **(Compute Cores)** (Impact: 5.2)
    * *Intent:* /** * Extracts the raw certs from a given certificate string and returns them in an array. */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (86.9%), Test Surface (formerly Verification) (80.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (43.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `getServerTokenResponseAsync` **(Many-Argument Workhorses)** (Impact: 30.4)
    * *Intent:* * * * - WWW-Authenticate header is missing or has unsupported format * - Platform is not supported (...
  ...
  * `constructor` **(Many-Argument Workhorses)** (Impact: 3.5)
    * *Intent:* /** * Creates a new instance of the AzureArc managed identity source. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.2%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (78.9%), Guard Balance (formerly Safety Score) (54.5%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `SetAppTokenProvider` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Test Surface (formerly Verification) (80.0%), Mutation Surface (formerly State Flux) (79.2%), Guard Balance (formerly Safety Score) (50.9%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `getHeaderDict` **(Generic / Templated Code)** (Impact: 1.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Complexity Load (formerly Cognitive Load) (92.5%), Mutation Surface (formerly State Flux) (87.3%), Guard Balance (formerly Safety Score) (65.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `sendNetworkRequestAsync` **(Stateful Encapsulated Methods)** (Impact: 9.6)
  * `sendNetworkRequestAsyncHelper` **(Stateful Encapsulated Methods)** (Impact: 8.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (72.7%), Guard Balance (formerly Safety Score) (58.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (45.2%)
- **Documentation Coverage:** 62.5% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `selectManagedIdentitySource` **(Many-Argument Workhorses)** (Impact: 21.6)
    * *Intent:* /** * Tries to create a managed identity source for all sources */
  ...
  * `constructor` **(State Mutators)** (Impact: 3.1)
  * `allEnvironmentVariablesAreDefined` **(Encapsulated Accessors)** (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 1 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (69.3%), Guard Balance (formerly Safety Score) (61.6%), Concurrency Surface (formerly Concurrency) (53.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 16.6667% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `acquireToken` **(Compute Cores)** (Impact: 20.6)
    * *Intent:* /** * Acquire an access token from the cache or the managed identity */
  * `constructor` **(I/O & Config Routines)** (Impact: 8.2)
  * `acquireTokenFromManagedIdentity` **(Stateful Encapsulated Methods)** (Impact: 5.2)
    * *Intent:* /** * Acquires a token from a managed identity endpoint. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (83.6%), Complexity Load (formerly Cognitive Load) (65.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constructor` **(Defensive Guards)** (Impact: 26.0)
  * `id` **(Encapsulated Accessors)** (Impact: 1.6)
  * `idType` **(Encapsulated Accessors)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (53.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (46.4%), Mutation Surface (formerly State Flux) (33.1%)
...
**Top Internal Functions/Classes:**
  ...
  * `buildAppConfiguration` **(Defensive Guards)** (Impact: 12.9)
    * *Intent:* /** * Sets the default options when not explicitly configured from app developer * * */
  * `loggerCallback` **(Generic / Templated Code)** (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **4**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (100.0%), Debt Markers (formerly Tech Debt) (98.2%), Mutation Surface (formerly State Flux) (84.9%), Guard Balance (formerly Safety Score) (74.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `afterCacheAccess` **(Type Conversions)** (Impact: 7.0)
    * *Intent:* /** * Serializes the cache after accessing it */
  * `constructor` **(State Mutators)** (Impact: 1.9)
  * `beforeCacheAccess` **(Parameter Forwarders)** (Impact: 1.8)
    * *Intent:* /** * Deserializes the cache before accessing it */
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
* *Amplified Cascading Flux:* 3 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (98.0%), Guard Balance (formerly Safety Score) (54.9%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Debt Markers (formerly Tech Debt) (26.7%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `getRedirectUri` **(I/O & Config Routines)** (Impact: 7.8)
    * *Intent:* /** * Get the port that the loopback server is running on */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **30**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (14.4%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Concurrency Surface (formerly Concurrency) (99.6%), Mutation Surface (formerly State Flux) (75.0%), Guard Balance (formerly Safety Score) (62.6%), Debt Markers (formerly Tech Debt) (57.7%)
- **Documentation Coverage:** 83.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pauseForRetry` **(Many-Argument Workhorses)** (Impact: 20.8)
    * *Intent:* /** * Pauses execution for a calculated delay before retrying a request. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.2%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (26.7%), Debt Markers (formerly Tech Debt) (23.2%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `deserializeAllCache` **(Compute Cores)** (Impact: 9.4)
    * *Intent:* /** * Deserialize an inMemory Cache */
  * `deserializeAccounts` **(Callbacks & Closures)** (Impact: 5.9)
    * *Intent:* /** * Deserializes accounts to AccountEntity objects */
  * `deserializeAccessTokens` **(Type Conversions)** (Impact: 4.5)
    * *Intent:* /** * Deserializes access tokens to AccessTokenEntity objects */
  * `deserializeRefreshTokens` **(Callbacks & Closures)** (Impact: 4.1)
    * *Intent:* /** * Deserializes refresh tokens to RefreshTokenEntity objects */
  * `deserializeIdTokens` **(Callbacks & Closures)** (Impact: 3.9)
    * *Intent:* /** * Deserializes id tokens to IdTokenEntity objects */
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 7
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (12.9%), Test Surface (formerly Verification) (2.3%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Structural Signatures (Net Mitigated Signals):**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (55.1%), Mutation Surface (formerly State Flux) (52.5%), Debt Markers (formerly Tech Debt) (51.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `constructor` **(Many-Argument Workhorses)** (Impact: 3.8)
    * *Intent:* /** * Creates a new MachineLearning managed identity source instance. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 12.987; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (54.1%), Debt Markers (formerly Tech Debt) (52.0%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Mutation Surface (formerly State Flux) (45.6%)
- **Documentation Coverage:** 0.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `createRequest` **(Compute Cores)** (Impact: 5.1)
  ...
  * `getEnvironmentVariables` **(I/O & Config Routines)** (Impact: 1.9)
