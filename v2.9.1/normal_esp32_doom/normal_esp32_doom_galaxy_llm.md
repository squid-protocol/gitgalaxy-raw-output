...
## 1. EXECUTIVE SUMMARY
- **Scope:** 186 analyzed artifact(s), 48192 LOC.
- **Load-bearing artifact:** `components/prboom/include/doomstat.h` -- 61 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `components/prboom/g_game.c` -- pulls in 41 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `components/prboom/p_spec.c` at magnitude 2826.24 (structural weight, not risk).
...
> **Composition Archetype:** `Small Flat Repo (2)` (z +3.40; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 41%, Large Core Modules (3) 17%, Data / Markup / Trivial 15%, Compute Cores Files 10%, Large Core Modules 5%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 44.9 | 0.0 | 0.0 |
...
| concurrency | 0 | 0 | 0 | - |
| connectivity | 2620 | 158 | 24 | `components/prboom/include/d_deh.h` |
...
- `M_Responder` **(Many-Argument Workhorses)** (@ `components/prboom/m_menu.c`) -> Impact: **470.2** | LOC: 1088
  * *Intent:* ///////////////////////////////////////////////////////////////////////////// // // M_Responder // // Examines incoming keystrokes and button pushes a...
- `P_TouchSpecialThing` **(Many-Argument Workhorses)** (@ `components/prboom/p_inter.c`) -> Impact: **182.2** | LOC: 318
...
- `HU_Drawer` **(I/O & Config Routines)** (@ `components/prboom/hu_stuff.c`) -> Impact: **157.1** | LOC: 541
...
- `D_DoomMainSetup` **(I/O & Config Routines)** (@ `components/prboom/d_main.c`) -> Impact: **144.6** | LOC: 492
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **19**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (43.8%), Connectivity (formerly Api Exposure) (6.0%)
- **Documentation Coverage:** 93.5065% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_CrossSpecialLine` **(Many-Argument Workhorses)** (Impact: 658.0)
    * *Intent:* ///////////////////////////////////////////////////////////////////////// // // P_CrossSpecialLine -...
  * `P_ShootSpecialLine` **(Many-Argument Workhorses)** (Impact: 136.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.1%)
- **Documentation Coverage:** 93.3333% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `M_Responder` **(Many-Argument Workhorses)** (Impact: 470.2)
    * *Intent:* ///////////////////////////////////////////////////////////////////////////// // // M_Responder // /...
  ...
  * `M_DrawScreenItems` **(Stateful Encapsulated Methods)** (Impact: 17.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **41**; blast radius 2.207; role: Pure Consumer (Orchestrator)
...
**Top Internal Functions/Classes:**
  ...
  * `G_Ticker` **(I/O & Config Routines)** (Impact: 75.0)
  ...
  * `G_CheckSpot` **(Many-Argument Workhorses)** (Impact: 48.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (97.4%), Guard Balance (formerly Safety Score) (97.3%), Complexity Load (formerly Cognitive Load) (94.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_DoNewChaseDir` **(Many-Argument Workhorses)** (Impact: 68.7)
  ...
  * `P_Move` **(Many-Argument Workhorses)** (Impact: 48.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (78.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_GetMoveFactor` **(Many-Argument Workhorses)** (Impact: 39.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **15**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (80.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (46.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.5%)
- **Documentation Coverage:** 89.2857% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_CreateBlockMap` **(I/O & Config Routines)** (Impact: 79.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **38**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.3%), Complexity Load (formerly Cognitive Load) (93.4%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `D_DoomMainSetup` **(I/O & Config Routines)** (Impact: 144.6)
  ...
  * `D_Display` **(Stateful Encapsulated Methods)** (Impact: 47.8)
  ...
  * `IdentifyVersion` **(I/O & Config Routines)** (Impact: 33.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.207; role: Pure Consumer (Orchestrator)
...
**Top Internal Functions/Classes:**
  ...
  * `WRAP_V_DrawLine` **(Stateful Encapsulated Methods)** (Impact: 40.2)
    * *Intent:* // // WRAP_V_DrawLine() // // Draw a line in the frame buffer. // Classic Bresenham w/ whatever opti...
  * `FUNC_V_DrawBackground` **(Many-Argument Workhorses)** (Impact: 37.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Complexity Load (formerly Cognitive Load) (82.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_SetMobjState` **(Stateful Encapsulated Methods)** (Impact: 23.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `HU_Drawer` **(I/O & Config Routines)** (Impact: 157.1)
    * *Intent:* // // HU_Drawer() // // Draw all the pieces of the heads-up display // // Passed nothing, returns no...
  * `HU_Responder` **(Stateful Encapsulated Methods)** (Impact: 76.5)
  ...
  * `HU_Ticker` **(I/O & Config Routines)** (Impact: 31.2)
  * `HU_Init` **(I/O & Config Routines)** (Impact: 28.1)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.1%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `WI_updateNetgameStats` **(I/O & Config Routines)** (Impact: 56.8)
    * *Intent:* // ==================================================================== // WI_updateNetgameStats // ...
  * `WI_updateStats` **(I/O & Config Routines)** (Impact: 41.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.2%), Complexity Load (formerly Cognitive Load) (93.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (66.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (75.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (82.5%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_TouchSpecialThing` **(Many-Argument Workhorses)** (Impact: 182.2)
    * *Intent:* // // P_TouchSpecialThing //
  ...
  * `P_KillMobj` **(Many-Argument Workhorses)** (Impact: 71.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (73.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `R_ScaleFromGlobalAngle` **(Stateful Encapsulated Methods)** (Impact: 6.2)
    * *Intent:* // // R_ScaleFromGlobalAngle // Returns the texture mapping scale // for the current line (horizonta...
  * `R_PointToDist` **(Stateful Encapsulated Methods)** (Impact: 4.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (76.0%), Complexity Load (formerly Cognitive Load) (60.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_InitSwitchList` **(I/O & Config Routines)** (Impact: 15.2)
    * *Intent:* // when activated, and in the case of buttons, change back after a timeout. // // This routine modif...
  * `P_StartButton` **(Stateful Encapsulated Methods)** (Impact: 14.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **10**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.9%), Debt Markers (formerly Tech Debt) (84.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `P_ArchiveSpecials` **(I/O & Config Routines)** (Impact: 47.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (74.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `createTextureCompositePatch` **(Many-Argument Workhorses)** (Impact: 90.1)
    * *Intent:* //---------------------------------------------------------------------------
  * `createPatch` **(Many-Argument Workhorses)** (Impact: 53.5)
    * *Intent:* //---------------------------------------------------------------------------
  * `getPatchIsNotTileable` **(Stateful Encapsulated Methods)** (Impact: 28.2)
    * *Intent:* //---------------------------------------------------------------------------
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `TWriteVarLen` **(Stateful Encapsulated Methods)** (Impact: 13.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `P_BlockLinesIterator` **(Compute Cores)** (Impact: 19.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **9**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `T_VerticalDoor` **(Compute Cores)** (Impact: 112.7)
    * *Intent:* // Door action routines, called once per tick // ///////////////////////////////////////////////////...
  * `EV_VerticalDoor` **(Many-Argument Workhorses)** (Impact: 108.3)
  ...
  * `EV_DoDoor` **(Many-Argument Workhorses)** (Impact: 28.4)
    * *Intent:* // // EV_DoDoor // // Handle opening a tagged door // // Passed the line activating the door and the...
  * `P_SpawnDoorRaiseIn5Mins` **(Compute Cores)** (Impact: 3.0)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **11**; blast radius 2.207; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.3%), Debt Markers (formerly Tech Debt) (93.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `A_Saw` **(Compute Cores)** (Impact: 19.5)
    * *Intent:* // // A_Saw //
  * `P_SetPsprite` **(Stateful Encapsulated Methods)** (Impact: 15.9)
    * *Intent:* // // P_SetPsprite //
**Contextual Mitigations & Amplifications:**
