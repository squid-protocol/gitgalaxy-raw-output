...
## 1. EXECUTIVE SUMMARY
- **Scope:** 401 analyzed artifact(s), 47971 LOC.
- **Load-bearing artifact:** `Server/src/main/java/net/simon987/server/assembly/Status.java` -- 91 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `Server/src/main/resources/static/js/ace/ace.js` -- pulls in 87 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `Server/src/main/resources/static/js/ace/ace.js` at magnitude 13787.44 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.051`
> **Composition Archetype:** `Hub-Coupled App` (z +2.05; from the repo's file-archetype mix)
> **File Composition:** Data / Markup / Trivial 20%, State Mutators Files 16%, Declarative / Non-Code 15%, Type Conversions Files 13%, Large Core Modules (3) 11%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 60.4 | 76.6 | 100.0 |
...
- `renderChanges` **(Many-Argument Workhorses)** (@ `Server/src/main/resources/static/js/ace/ace.js`) -> Impact: **83.3** | LOC: 107
...
- `setcc` **(Stateful Encapsulated Methods)** (@ `Server/src/main/java/net/simon987/server/assembly/instruction/SetccInstruction.java`) -> Impact: **73.3** | LOC: 34
...
- `separateZ` **(Many-Argument Workhorses)** (@ `Server/src/main/resources/static/js/phaser-plugin-isometric.js`) -> Impact: **68.8** | LOC: 97
  * *Intent:* /** * The core separation function to separate two physics bodies on the z axis. * */
...
- `separateX` **(Many-Argument Workhorses)** (@ `Server/src/main/resources/static/js/phaser-plugin-isometric.js`) -> Impact: **64.2** | LOC: 84
  * *Intent:* /** * The core separation function to separate two physics bodies on the x axis. * */
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **87**; blast radius 1.141; role: Pure Consumer (Orchestrator)
...
- **Documentation Coverage:** 99.0859% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `escapeHTML` **(Compute Cores)** (Impact: 479.7)
  * `onMouseDown` **(Compute Cores)** (Impact: 97.5)
  * `renderChanges` **(Many-Argument Workhorses)** (Impact: 83.3)
...
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (54.2%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Complexity Load (formerly Cognitive Load) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.3%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `MarGame` **(I/O & Config Routines)** (Impact: 24.6)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.3%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 85.8824% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `updateObject` **(Compute Cores)** (Impact: 20.1)
  * `createObject` **(Compute Cores)** (Impact: 19.7)
    * *Intent:* /** * Factory method for GameObjects */
  * `updateHologram` **(Stateful Encapsulated Methods)** (Impact: 19.6)
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); blast radius 1.465; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.7%), Complexity Load (formerly Cognitive Load) (74.6%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **31** in-repo importer(s); it depends on **11**; blast radius 11.901; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.2%), Complexity Load (formerly Cognitive Load) (72.0%), Connectivity (formerly Api Exposure) (52.5%)
- **Documentation Coverage:** 95.3488% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `executeInstruction` **(Many-Argument Workhorses)** (Impact: 66.0)
  * `executeImmediateValue` **(Stateful Encapsulated Methods)** (Impact: 23.7)
  * `executeSourceIsRegister` **(Stateful Encapsulated Methods)** (Impact: 23.6)
  * `executeImmediateValueMem` **(Stateful Encapsulated Methods)** (Impact: 23.6)
  * `execute` **(I/O & Config Routines)** (Impact: 9.7)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Guard Balance (formerly Safety Score) (80.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (20.5%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (61.7%)
...
- **Blast Radius:** changing it is visible to **6** in-repo importer(s); it depends on **19**; blast radius 2.326; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.7%), Connectivity (formerly Api Exposure) (66.0%), Complexity Load (formerly Cognitive Load) (43.0%)
- **Documentation Coverage:** 93.578% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `hardwareInterrupt` **(Compute Cores)** (Impact: 5.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.141; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.4%), Complexity Load (formerly Cognitive Load) (84.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `generateVaultWorld` **(Many-Argument Workhorses)** (Impact: 123.2)
  * `hasTileAdjacent` **(Stateful Encapsulated Methods)** (Impact: 9.6)
  * `compare` **(Annotated & Test Methods)** (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **11**; blast radius 1.41; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (69.9%), Complexity Load (formerly Cognitive Load) (29.5%)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (56.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `handleObjectsUpdate` **(I/O & Config Routines)** (Impact: 22.5)
    * *Intent:* /** * Update, create or delete the current objects based on a list received from the server */
  * `setTerrain` **(Stateful Encapsulated Methods)** (Impact: 8.5)
    * *Intent:* /** * Load terrain data from array and create Tiles */
  * `constructor` **(Many-Argument Workhorses)** (Impact: 6.2)
  * `updateTerrain` **(State Mutators)** (Impact: 5.9)
    * *Intent:* /** * Delete current ojects and tiles and replace them with provided terrain */
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (81.8%), Debt Markers (formerly Tech Debt) (80.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 77.0833% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handle` **(I/O & Config Routines)** (Impact: 27.5)
  * `onDownCallback` **(Compute Cores)** (Impact: 12.1)
    * *Intent:* //Handle keypresses
  * `connectToGameServer` **(I/O & Config Routines)** (Impact: 11.9)
    * *Intent:* /** * Connect to the game server */
  * `handle` **(Compute Cores)** (Impact: 10.7)
...
- **Blast Radius:** changing it is visible to **19** in-repo importer(s); it depends on **16**; blast radius 15.404; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.6%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (68.7%)
- **Documentation Coverage:** 64.5161% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 1.141; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (70.8%), Guard Balance (formerly Safety Score) (65.2%), Debt Markers (formerly Tech Debt) (24.4%), Complexity Load (formerly Cognitive Load) (16.5%)
- **Documentation Coverage:** 22.2222% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `setcc` **(Stateful Encapsulated Methods)** (Impact: 73.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 1.141; role: Isolated/Orphan
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (88.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `init` **(Callbacks & Closures)** (Impact: 12.3)
  * `updateCounter` **(I/O & Config Routines)** (Impact: 11.6)
  * `setSearchRange` **(Callbacks & Closures)** (Impact: 6.1)
  * `find` **(Many-Argument Workhorses)** (Impact: 4.8)
  * `syncOptions` **(Callbacks & Closures)** (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 33 instances
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.141; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `detachHardware` **(Generic / Templated Code)** (Impact: 9.1)
  * `jsonSerialise` **(Type Conversions)** (Impact: 7.0)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **2**; blast radius 1.734; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Complexity Load (formerly Cognitive Load) (49.3%), Connectivity (formerly Api Exposure) (28.9%)
...
- **Blast Radius:** changing it is visible to **66** in-repo importer(s); it depends on **23**; blast radius 34.702; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (90.6%), Guard Balance (formerly Safety Score) (89.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **10**; blast radius 1.273; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (96.9%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `Settlement` **(Compute Cores)** (Impact: 26.3)
  * `Settlement` **(Type Conversions)** (Impact: 9.9)
  * `mongoSerialise` **(I/O & Config Routines)** (Impact: 6.2)
  * `addNpc` **(Parameter Forwarders)** (Impact: 1.6)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 1.141; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (96.3%), Debt Markers (formerly Tech Debt) (96.2%), Test Surface (formerly Verification) (80.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `worldExists` **(Encapsulated Accessors)** (Impact: 2.0)
  * `coordinatesOf` **(Parameter Forwarders)** (Impact: 1.7)
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **16**; blast radius 4.622; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (55.4%)
- **Documentation Coverage:** 76.087% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `loadWorld` **(Stateful Encapsulated Methods)** (Impact: 6.8)
...
- **Blast Radius:** isolated in the scanned graph -- no in-repo artifact imports it and it imports none
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (98.2%), Complexity Load (formerly Cognitive Load) (49.1%), Debt Markers (formerly Tech Debt) (37.5%)
- **Documentation Coverage:** 55.5556% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `handleConsoleBufferUpdate` **(Compute Cores)** (Impact: 19.5)
    * *Intent:* /** * Handles a consoleBuffer update */
...
- **Blast Radius:** changing it is visible to **28** in-repo importer(s); it depends on **10**; blast radius 14.743; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (97.5%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (79.7%), Guard Balance (formerly Safety Score) (70.8%)
- **Documentation Coverage:** 80.0% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 1.141; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Debt Markers (formerly Tech Debt) (100.0%), Mutation Surface (formerly State Flux) (95.9%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (75.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `heal` **(Annotated & Test Methods)** (Impact: 3.3)
  * `damage` **(Annotated & Test Methods)** (Impact: 3.3)
  * `update` **(Annotated & Test Methods)** (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
