...
## 1. EXECUTIVE SUMMARY
- **Scope:** 213 analyzed artifact(s), 61159 LOC.
- **Load-bearing artifact:** `pytest-9.0.2/src/_pytest/pytester.py` -- 54 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `pytest-9.0.2/testing/test_assertrewrite.py` -- pulls in 49 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `pytest-9.0.2/src/_pytest/terminal.py` at magnitude 1767.64 (structural weight, not risk).
...
> **Architectural Drift Z-Score:** `2.091`
> **Composition Archetype:** `Small Flat Repo (2)` (z +2.09; from the repo's file-archetype mix)
> **File Composition:** Generic / Templated Code Files 31%, Data / Markup / Trivial 22%, Large Core Modules (2) 18%, Large Core Modules (3) 14%, Parameter Forwarders Files 6%
...
| Doc Surface (formerly Documentation Exposure) _(coverage)_ | 0.0 | 100.0 | 66.9 | 83.6 | 100.0 |
...
- `_check_exceptions` **(Stateful Encapsulated Methods)** (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **97.1** | LOC: 142
...
- `matches` **(Stateful Encapsulated Methods)** (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **70.2** | LOC: 122
...
- **Blast Radius:** changing it is visible to **14** in-repo importer(s); it depends on **29**; blast radius 30.078; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.9%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.3%)
- **Documentation Coverage:** 90.9574% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `pytest_runtest_logreport` **(Many-Argument Workhorses)** (Impact: 52.2)
  * `short_test_summary` **(Generic / Templated Code)** (Impact: 37.9)
  * `report_collect` **(Stateful Encapsulated Methods)** (Impact: 31.2)
  * `summary_warnings` **(Stateful Encapsulated Methods)** (Impact: 30.9)
  * `_printcollecteditems` **(Stateful Encapsulated Methods)** (Impact: 29.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **48**; blast radius 1.5; role: Pure Consumer (Orchestrator)
...
- **Documentation Coverage:** 65.3179% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `parse` **(Stateful Encapsulated Methods)** (Impact: 33.4)
    * *Intent:* # Parse given cmdline arguments into this config object. assert self.args == [], ( "can only parse c...
  * `_set_initial_conftests` **(Stateful Encapsulated Methods)** (Impact: 24.6)
...
- **Blast Radius:** changing it is visible to **13** in-repo importer(s); it depends on **25**; blast radius 19.308; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.3%), Connectivity (formerly Api Exposure) (80.1%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
**Top Internal Functions/Classes:**
  ...
  * `_evaluate` **(Stateful Encapsulated Methods)** (Impact: 26.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **27** in-repo importer(s); it depends on **30**; blast radius 16.22; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.9%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (68.0%)
- **Documentation Coverage:** 68.9474% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `reorder_items_atscope` **(Many-Argument Workhorses)** (Impact: 47.9)
  * `_showfixtures_main` **(Many-Argument Workhorses)** (Impact: 28.7)
...
- **Blast Radius:** changing it is visible to **10** in-repo importer(s); it depends on **36**; blast radius 4.965; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (53.4%)
...
**Top Internal Functions/Classes:**
  ...
  * `_validate_if_using_arg_names` **(Stateful Encapsulated Methods)** (Impact: 23.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **16** in-repo importer(s); it depends on **22**; blast radius 13.903; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.2%), Connectivity (formerly Api Exposure) (82.1%), Complexity Load (formerly Cognitive Load) (50.3%)
- **Documentation Coverage:** 66.4865% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `get_source` **(Many-Argument Workhorses)** (Impact: 41.6)
  * `_group_contains` **(Stateful Encapsulated Methods)** (Impact: 41.1)
  * `cut` **(Many-Argument Workhorses)** (Impact: 40.9)
  * `repr_traceback_entry` **(Many-Argument Workhorses)** (Impact: 38.5)
  * `repr_excinfo` **(Many-Argument Workhorses)** (Impact: 31.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **54** in-repo importer(s); it depends on **39**; blast radius 26.541; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (94.3%), Connectivity (formerly Api Exposure) (85.7%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
- **Documentation Coverage:** 60.5634% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_match_lines` **(Many-Argument Workhorses)** (Impact: 40.0)
  * `_makefile` **(Stateful Encapsulated Methods)** (Impact: 28.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **23**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (41.7%), Concurrency Surface (formerly Concurrency) (17.3%), Connectivity (formerly Api Exposure) (14.3%)
- **Documentation Coverage:** 99.4764% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_visit_breadthfirst` **(Defensive Guards)** (Impact: 10.9)
  * `test_make_numbered_dir` **(Defensive Guards)** (Impact: 9.4)
  * `test_chmod_rec_int` **(Type Conversions)** (Impact: 7.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (23.8%), Connectivity (formerly Api Exposure) (13.2%), Complexity Load (formerly Cognitive Load) (9.8%)
- **Documentation Coverage:** 80.8696% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `test_type_errors` **(Many-Argument Workhorses)** (Impact: 32.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **24**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Connectivity (formerly Api Exposure) (71.4%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (28.2%), Complexity Load (formerly Cognitive Load) (6.8%)
- **Documentation Coverage:** 78.9976% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `test_funcarg_lookup_error` **(Compute Cores)** (Impact: 5.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (34.4%), Connectivity (formerly Api Exposure) (12.8%), Complexity Load (formerly Cognitive Load) (7.2%)
- **Documentation Coverage:** 92.7978% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **4** in-repo importer(s); it depends on **18**; blast radius 2.906; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (85.5%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.3%)
- **Documentation Coverage:** 92.5926% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_check_exceptions` **(Stateful Encapsulated Methods)** (Impact: 97.1)
  * `__init__` **(Defensive Guards)** (Impact: 72.5)
  * `matches` **(Stateful Encapsulated Methods)** (Impact: 70.2)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (26.0%), Guard Balance (formerly Safety Score) (14.0%), Connectivity (formerly Api Exposure) (12.5%)
- **Documentation Coverage:** 90.6615% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **3** in-repo importer(s); it depends on **36**; blast radius 2.106; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (60.7%)
...
**Top Internal Functions/Classes:**
  ...
  * `_get_assertion_exprs` **(Stateful Encapsulated Methods)** (Impact: 30.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **49**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Connectivity (formerly Api Exposure) (13.4%), Complexity Load (formerly Cognitive Load) (13.3%), Guard Balance (formerly Safety Score) (11.2%)
- **Documentation Coverage:** 92.3684% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **18**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (33.8%), Concurrency Surface (formerly Concurrency) (15.4%), Complexity Load (formerly Cognitive Load) (13.3%)
- **Documentation Coverage:** 91.4062% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (53.6%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Complexity Load (formerly Cognitive Load) (18.3%), Connectivity (formerly Api Exposure) (12.1%)
- **Documentation Coverage:** 93.7824% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `assert_attr` **(Generic / Templated Code)** (Impact: 9.2)
...
- **Blast Radius:** changing it is visible to **20** in-repo importer(s); it depends on **26**; blast radius 36.425; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (92.1%), Test Surface (formerly Verification) (80.0%), Connectivity (formerly Api Exposure) (58.9%)
...
**Top Internal Functions/Classes:**
  ...
  * `perform_collect` **(Stateful Encapsulated Methods)** (Impact: 38.8)
  * `pytest_addoption` **(I/O & Config Routines)** (Impact: 30.8)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **16**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (38.9%), Connectivity (formerly Api Exposure) (13.2%), Complexity Load (formerly Cognitive Load) (9.1%)
- **Documentation Coverage:** 80.7947% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **26**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (26.6%), Connectivity (formerly Api Exposure) (12.1%), Complexity Load (formerly Cognitive Load) (6.3%)
- **Documentation Coverage:** 52.5346% of unit weight undocumented
**Top Internal Functions/Classes:**
  ...
  * `get_reported_items` **(Generic / Templated Code)** (Impact: 7.4)
    * *Intent:* """Return pytest.Item instances reported by the pytest_collectreport hook"""
  * `test_collect_short_file_windows` **(Defensive Guards)** (Impact: 6.8)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **15**; blast radius 19.359; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.1%)
- **Documentation Coverage:** 88.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `assertrepr_compare` **(Many-Argument Workhorses)** (Impact: 67.1)
  * `_compare_eq_any` **(Stateful Encapsulated Methods)** (Impact: 50.9)
...
- **Blast Radius:** changing it is visible to **46** in-repo importer(s); it depends on **34**; blast radius 50.385; role: Pure Producer (Foundation)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.8%), Connectivity (formerly Api Exposure) (84.5%), Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%)
...
- **Blast Radius:** changing it is visible to **7** in-repo importer(s); it depends on **22**; blast radius 4.529; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (79.0%), Connectivity (formerly Api Exposure) (70.4%), Debt Markers (formerly Tech Debt) (59.0%)
- **Documentation Coverage:** 86.0465% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_windowsconsoleio_workaround` **(Stateful Encapsulated Methods)** (Impact: 16.8)
    * *Intent:* """Workaround for Windows Unicode console handling. Python 3.6 implemented Unicode console handling ...
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 14.1)
  * `__init__` **(Stateful Encapsulated Methods)** (Impact: 12.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **20**; blast radius 1.5; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Historical Stability (predictive layer, promotion pending #2987) (formerly Stability) (50.0%), Guard Balance (formerly Safety Score) (18.6%), Connectivity (formerly Api Exposure) (12.7%), Complexity Load (formerly Cognitive Load) (9.7%)
- **Documentation Coverage:** 90.099% of unit weight undocumented
**Top Internal Functions/Classes:**
...
- **Blast Radius:** changing it is visible to **1** in-repo importer(s); it depends on **17**; blast radius 1.642; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (97.6%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (59.2%)
