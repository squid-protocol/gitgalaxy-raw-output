...
## 1. EXECUTIVE SUMMARY
- **Scope:** 7145 analyzed artifact(s), 398704 LOC.
- **Load-bearing artifact:** `py/runtime.h` -- 867 in-repo importer(s) depend on it. Changes here propagate furthest.
- **Top orchestrator:** `ports/stm/hal_conf/stm32h7xx_hal_conf.h` -- pulls in 60 dependencies, the widest assembly point in the scan.
- **Heaviest artifact:** `lib/oofatfs/ff.c` at magnitude 9415.88 (structural weight, not risk).
...
| Analyzed Artifacts (Scanned) | 7145 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 1229 |
| Total LOC | 398704 |
...
|---|---|---|
| Modularity | 0.5761 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
| Assortativity | -0.24 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
| Cyclic Density | 0.1% | % of files trapped in dependency loops (Static Friction). |
| Avg Path Length | 2.7824 | Mean import hops from a file to each file it transitively depends on. Higher = Longer dependency chains. |
...
|---|---|---|---|
| C | 4897 | 327865 | 68.5% |
| EMBEDDED_PYTHON | 949 | 24711 | 13.3% |
| MAKEFILE | 657 | 14103 | 9.2% |
| PYTHON | 500 | 28664 | 7.0% |
| MARKDOWN | 55 | 0 | 0.8% |
| PLAINTEXT | 22 | 1 | 0.3% |
| CSV | 21 | 668 | 0.3% |
| HTML | 10 | 598 | 0.1% |
...
> **Architectural Drift Z-Score:** `6.965`
> **Composition Archetype:** `Hub-Coupled Monorepo` (z +6.96; from the repo's file-archetype mix)
> **File Composition:** Declarative / Non-Code 44%, Data / Markup / Trivial 27%, Parameter Forwarders Files 7%, Encapsulated Accessors Files 5%, Large Core Modules (3) 4%
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 24.6 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 11.7 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 7.2 | 2.3 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 10.1 | 0.0 | 0.0 |
...
| Dead Code Surface (formerly Commented Logic Exposure) | 0.0 | 99.9 | 1.1 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 121287 | 3799 | 46 | `lib/littlefs/lfs2.c` |
| cleanup | 247 | 98 | 0 | `tools/pyboard.py` |
| guards | 33533 | 3343 | 12 | `py/obj.h` |
| danger | 5421 | 1204 | 1 | `ports/raspberrypi/Makefile` |
| concurrency | 1162 | 157 | 0 | `tests/extmod/asyncio_wait_for.py` |
| connectivity | 20172 | 2918 | 8 | `py/obj.h` |
| io | 1489 | 284 | 0 | `tests/run-tests.py` |
| crypto | 5 | 5 | 0 | `ports/unix/variants/manifest.py` |
| ipc | 711 | 68 | 0 | `ports/raspberrypi/common-hal/socketpool/Socket.c` |
| time | 74 | 22 | 0 | `tests/run-multitests.py` |
| serialization | 9 | 5 | 0 | `tools/pyboard.py` |
| regex | 174 | 72 | 0 | `tools/board_stubs/build_board_specific_stubs/board_stub_builder.py` |
| events | 415 | 113 | 0 | `shared-module/atexit/__init__.c` |
| tests | 338 | 54 | 0 | `ports/zephyr-cp/tests/zephyr_display/test_zephyr_display.py` |
| docs | 15312 | 356 | 0 | `lib/cmsis/inc/core_armv81mml.h` |
| debt | 10265 | 1612 | 4 | `tools/mpy-tool.py` |
| mutation | 84388 | 3155 | 26 | `lib/oofatfs/ff.c` |
| dead_code | 7006 | 1471 | 3 | `ports/zephyr-cp/common-hal/wifi/Radio.c` |
| credential | 4 | 3 | 0 | `ports/zephyr-cp/cptools/zephyr2cp.py` |
| threat | 2771 | 488 | 0 | `py/obj.h` |
| ml_ai | 569 | 194 | 0 | `tests/basics/struct1.py` |
| ui | 96 | 21 | 0 | `ports/zephyr-cp/tests/zephyr_display/test_zephyr_display.py` |
...
- `dir_alloc` **(Many-Argument Workhorses)** (@ `lib/oofatfs/ff.c`) -> Impact: **1259.2** | LOC: 1940
  * *Intent:* #if !FF_FS_READONLY /*-----------------------------------------------------------------------*/ /* Directory handling - Reserve a block of directory e...
- `lfs2_file_rawopencfg` **(Many-Argument Workhorses)** (@ `lib/littlefs/lfs2.c`) -> Impact: **838.0** | LOC: 1868
  * *Intent:* /// Top level file operations ///
- `do_all_the_things` **(Many-Argument Workhorses)** (@ `tools/analyze_heap_dump.py`) -> Impact: **686.4** | LOC: 675
- `f_mkfs` **(Many-Argument Workhorses)** (@ `lib/oofatfs/ff.c`) -> Impact: **507.4** | LOC: 498
  * *Intent:* #endif /* FF_USE_FORWARD */ #if FF_USE_MKFS && !FF_FS_READONLY /*-----------------------------------------------------------------------*/ /* Create a...
- `mp_obj_str_format_helper` **(Many-Argument Workhorses)** (@ `py/objstr.c`) -> Impact: **440.6** | LOC: 452
  * *Intent:* #else // define to nothing to improve coverage #define terse_str_format_value_error() #endif
- `parse_compile_execute` **(Many-Argument Workhorses)** (@ `shared/runtime/pyexec.c`) -> Impact: **416.2** | LOC: 767
...
- `emit_inline_thumb_op` **(Many-Argument Workhorses)** (@ `py/emitinlinethumb.c`) -> Impact: **405.2** | LOC: 411
  * *Intent:* // shorthand alias for whether we allow ARMv7-M instructions #define ARMV7M asm_thumb_allow_armv7m(&emit->as)
- `common_hal_busio_uart_construct` **(Many-Argument Workhorses)** (@ `ports/atmel-samd/common-hal/busio/UART.c`) -> Impact: **290.3** | LOC: 286
  * *Intent:* // shared-bindings validates that the tx and rx are not both missing, // and that the pins are distinct.
- `common_hal_terminalio_terminal_write` **(Many-Argument Workhorses)** (@ `shared-module/terminalio/Terminal.c`) -> Impact: **277.8** | LOC: 279
- `common_hal_busio_uart_construct` **(Many-Argument Workhorses)** (@ `ports/mimxrt10xx/common-hal/busio/UART.c`) -> Impact: **273.1** | LOC: 261
...
- **Unknown Dependencies:** `16707` packages imported that bypass the Zero-Trust whitelist.
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (84.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `dir_alloc` **(Many-Argument Workhorses)** (Impact: 1259.2)
    * *Intent:* #if !FF_FS_READONLY /*-----------------------------------------------------------------------*/ /* D...
  * `f_mkfs` **(Many-Argument Workhorses)** (Impact: 507.4)
    * *Intent:* #endif /* FF_USE_FORWARD */ #if FF_USE_MKFS && !FF_FS_READONLY /*-----------------------------------...
  * `create_name` **(Many-Argument Workhorses)** (Impact: 189.9)
    * *Intent:* #endif /* FF_USE_FIND && FF_FS_MINIMIZE <= 1 */ /*--------------------------------------------------...
  * `find_volume` **(Many-Argument Workhorses)** (Impact: 168.6)
    * *Intent:* /*-----------------------------------------------------------------------*/ /* Determine logical dri...
  * `f_open` **(Many-Argument Workhorses)** (Impact: 156.7)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **2**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (93.3%), Complexity Load (formerly Cognitive Load) (89.8%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 67.031% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `lfs2_file_rawopencfg` **(Many-Argument Workhorses)** (Impact: 838.0)
    * *Intent:* /// Top level file operations ///
  * `lfs2_dir_fetchmatch` **(Many-Argument Workhorses)** (Impact: 208.9)
    * *Intent:* #endif
  * `lfs2_dir_relocatingcommit` **(Many-Argument Workhorses)** (Impact: 124.8)
    * *Intent:* #endif #ifndef LFS2_READONLY
  * `lfs2_dir_traverse` **(Many-Argument Workhorses)** (Impact: 106.9)
  * `lfs2_dir_orphaningcommit` **(Many-Argument Workhorses)** (Impact: 96.7)
    * *Intent:* #endif #ifndef LFS2_READONLY
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (84.7%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (67.4%)
- **Documentation Coverage:** 98.4733% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_compile_to_raw_code` **(Many-Argument Workhorses)** (Impact: 126.4)
    * *Intent:* #if !MICROPY_EXPOSE_MP_COMPILE_TO_RAW_CODE
  * `compile_scope_inline_asm` **(Many-Argument Workhorses)** (Impact: 100.7)
    * *Intent:* #if MICROPY_EMIT_INLINE_ASM // requires 3 passes: SCOPE, CODE_SIZE, EMIT
  * `compile_expr_stmt` **(Many-Argument Workhorses)** (Impact: 76.7)
    * *Intent:* #endif
  * `compile_atom_brace_helper` **(Many-Argument Workhorses)** (Impact: 75.0)
  * `compile_scope` **(Many-Argument Workhorses)** (Impact: 72.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **7**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.2%), Guard Balance (formerly Safety Score) (86.6%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 98.3193% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_obj_str_format_helper` **(Many-Argument Workhorses)** (Impact: 440.6)
    * *Intent:* #else // define to nothing to improve coverage #define terse_str_format_value_error() #endif
  * `str_modulo_format` **(Many-Argument Workhorses)** (Impact: 173.5)
    * *Intent:* #if MICROPY_PY_BUILTINS_STR_OP_MODULO
  * `mp_obj_str_binary_op` **(Many-Argument Workhorses)** (Impact: 68.0)
    * *Intent:* // Note: this function is used to check if an object is a str or bytes, which // works because both ...
  * `bytes_make_new` **(Many-Argument Workhorses)** (Impact: 56.2)
  * `mp_str_print_quoted` **(Many-Argument Workhorses)** (Impact: 55.6)
    * *Intent:* /******************************************************************************/ /* str */...
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (95.2%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (72.2%)
- **Documentation Coverage:** 79.3207% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `lfs1_dir_commit` **(Many-Argument Workhorses)** (Impact: 72.3)
  * `lfs1_file_opencfg` **(Many-Argument Workhorses)** (Impact: 70.8)
    * *Intent:* /// Top level file operations ///
  * `lfs1_dir_find` **(Many-Argument Workhorses)** (Impact: 65.7)
  * `lfs1_ctz_extend` **(Many-Argument Workhorses)** (Impact: 58.6)
  * `lfs1_rename` **(Many-Argument Workhorses)** (Impact: 55.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (100.0%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (77.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `jd_prepare` **(Many-Argument Workhorses)** (Impact: 174.0)
    * *Intent:* /*-----------------------------------------------------------------------*/ /* Analyze the JPEG imag...
  * `mcu_output` **(Many-Argument Workhorses)** (Impact: 124.6)
    * *Intent:* /*-----------------------------------------------------------------------*/ /* Output an MCU: Conver...
  * `huffext` **(Many-Argument Workhorses)** (Impact: 78.7)
    * *Intent:* /*-----------------------------------------------------------------------*/ /* Extract a huffman dec...
  * `create_huffman_tbl` **(Many-Argument Workhorses)** (Impact: 54.0)
    * *Intent:* /*-----------------------------------------------------------------------*/ /* Create huffman code t...
  * `mcu_load` **(Compute Cores)** (Impact: 44.9)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **3**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (69.9%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mpz_as_str_inpl` **(Many-Argument Workhorses)** (Impact: 51.7)
    * *Intent:* #endif // assumes enough space in str as calculated by mp_int_format_size // base must be between 2 ...
  * `mpn_div` **(Many-Argument Workhorses)** (Impact: 49.2)
    * *Intent:* */
  * `mpz_as_bytes` **(Many-Argument Workhorses)** (Impact: 44.0)
  * `mpz_set_from_str` **(Many-Argument Workhorses)** (Impact: 36.0)
    * *Intent:* #endif // returns number of bytes from str that were processed
  * `mpz_set_from_float` **(Many-Argument Workhorses)** (Impact: 32.2)
...
- **Blast Radius:** changing it is visible to **8** in-repo importer(s); it depends on **7**; blast radius 0.263; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (96.2%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (64.1%), Complexity Load (formerly Cognitive Load) (50.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `emit_native_binary_op` **(Many-Argument Workhorses)** (Impact: 146.3)
  * `emit_native_start_pass` **(Many-Argument Workhorses)** (Impact: 127.2)
  * `emit_native_store_subscr` **(Compute Cores)** (Impact: 98.6)
  * `emit_native_load_subscr` **(Compute Cores)** (Impact: 77.1)
  * `emit_native_call_function` **(Many-Argument Workhorses)** (Impact: 45.2)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 4e-06 | `Ripple Effect (Closeness):` 0.001117
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 1520.68 | **LOC:** 1537 | **CtrlFlow:** 20.8% | **Authorship Centralization:** 0.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **17**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (91.4%), Guard Balance (formerly Safety Score) (88.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_transfer` **(Many-Argument Workhorses)** (Impact: 232.0)
  * `rp2pio_statemachine_construct` **(Many-Argument Workhorses)** (Impact: 226.6)
  * `common_hal_rp2pio_statemachine_construct` **(Many-Argument Workhorses)** (Impact: 108.0)
  * `consider_instruction` **(Many-Argument Workhorses)** (Impact: 87.3)
  * `common_hal_rp2pio_statemachine_background_write` **(Many-Argument Workhorses)** (Impact: 44.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.1%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (71.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `common_hal_bitmaptools_rotozoom` **(Many-Argument Workhorses)** (Impact: 135.4)
    * *Intent:* #include "shared-module/displayio/Bitmap.h" #include "py/mperrno.h" #include "py/runtime.h" #include...
  * `common_hal_bitmaptools_alphablend` **(Many-Argument Workhorses)** (Impact: 117.4)
  * `common_hal_bitmaptools_blit` **(Many-Argument Workhorses)** (Impact: 86.3)
  * `common_hal_bitmaptools_readinto` **(Many-Argument Workhorses)** (Impact: 72.3)
  * `draw_line` **(Many-Argument Workhorses)** (Impact: 48.8)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **21**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (97.4%), Concurrency Surface (formerly Concurrency) (57.2%), Complexity Load (formerly Cognitive Load) (46.6%), Connectivity (formerly Api Exposure) (8.5%)
- **Documentation Coverage:** 50.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `run_tests` **(Many-Argument Workhorses)** (Impact: 269.2)
  * `run_micropython` **(Many-Argument Workhorses)** (Impact: 124.0)
  * `run_one_test` **(Compute Cores)** (Impact: 89.7)
  * `get_test_instance` **(Many-Argument Workhorses)** (Impact: 25.8)
  * `prepare_script_for_target` **(Many-Argument Workhorses)** (Impact: 24.4)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (92.1%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 96.162% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `GIFParseInfo` **(Many-Argument Workhorses)** (Impact: 111.4)
    * *Intent:* } /* GIFInit() */ // // Parse the GIF header, gather the size and palette info // If called with bIn...
  * `GIF_getInfo` **(Many-Argument Workhorses)** (Impact: 71.7)
    * *Intent:* } /* GIFParseInfo() */ // // Gather info about an animated GIF file //
  * `GIFMakePels` **(Many-Argument Workhorses)** (Impact: 44.7)
    * *Intent:* } /* ConvertNewPixels() */ // // GIFMakePels //
  * `DecodeLZW` **(Many-Argument Workhorses)** (Impact: 25.0)
    * *Intent:* // // Decode LZW into an image //
  * `GIF_playFrame` **(Compute Cores)** (Impact: 17.4)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **29**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (94.0%), Guard Balance (formerly Safety Score) (84.0%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `_reply` **(Many-Argument Workhorses)** (Impact: 211.0)
  * `_process_request` **(Many-Argument Workhorses)** (Impact: 120.1)
  * `_write_file_and_reply` **(Many-Argument Workhorses)** (Impact: 56.6)
  * `_reply_with_file` **(Many-Argument Workhorses)** (Impact: 45.4)
  * `supervisor_start_web_workflow` **(I/O & Config Routines)** (Impact: 41.5)
    * *Intent:* #endif
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **14**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (97.7%), Guard Balance (formerly Safety Score) (81.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_parse` **(Many-Argument Workhorses)** (Impact: 185.0)
  * `fold_constants` **(Many-Argument Workhorses)** (Impact: 129.0)
  * `push_result_rule` **(Many-Argument Workhorses)** (Impact: 59.7)
    * *Intent:* #endif
  * `mp_parse_node_print` **(Many-Argument Workhorses)** (Impact: 44.6)
    * *Intent:* #if MICROPY_DEBUG_PRINTERS
  * `fold_logical_constants` **(Many-Argument Workhorses)** (Impact: 42.8)
    * *Intent:* #endif
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **22**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (93.6%), Debt Markers (formerly Tech Debt) (90.1%), Guard Balance (formerly Safety Score) (82.7%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_unary_op` **(Compute Cores)** (Impact: 68.1)
  * `mp_convert_member_lookup` **(Many-Argument Workhorses)** (Impact: 61.8)
    * *Intent:* #endif // MICROPY_BUILTIN_METHOD_CHECK_SELF_ARG // Given a member that was extracted from an instanc...
  * `mp_resume` **(Many-Argument Workhorses)** (Impact: 44.5)
  * `mp_store_attr` **(Many-Argument Workhorses)** (Impact: 36.6)
  * `mp_init` **(I/O & Config Routines)** (Impact: 34.6)
...
- **Global Archetype:** `file_cluster_4` (Drift: 0.0 IQR)
- **Magnitude:** 1018.04 | **LOC:** 1329 | **CtrlFlow:** 22.8% | **Authorship Centralization:** 100.0%
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **25**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (91.4%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (68.7%)
- **Documentation Coverage:** 97.2222% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `common_hal_socketpool_socket_connect` **(Many-Argument Workhorses)** (Impact: 53.3)
  * `lwip_tcp_receive` **(Many-Argument Workhorses)** (Impact: 44.0)
    * *Intent:* // Helper function for recv/recvfrom to handle TCP packets
  * `socketpool_socket_accept` **(Many-Argument Workhorses)** (Impact: 42.4)
  * `socketpool_socket` **(Many-Argument Workhorses)** (Impact: 40.1)
  * `lwip_tcp_send` **(Many-Argument Workhorses)** (Impact: 40.0)
...
* *Risk/State:* `safety_bypasses: 18`, `state_mutation: 139`, `dead_code: 1`, `unreferenced_by_name: 17`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (87.8%), Test Surface (formerly Verification) (80.0%), Complexity Load (formerly Cognitive Load) (65.8%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `att_process_data` **(Many-Argument Workhorses)** (Impact: 56.6)
  * `process_read_or_read_blob_req` **(Many-Argument Workhorses)** (Impact: 54.9)
  * `process_read_type_req` **(Many-Argument Workhorses)** (Impact: 54.2)
  * `process_write_req_or_cmd` **(Many-Argument Workhorses)** (Impact: 40.1)
    * *Intent:* // Handles BT_ATT_OP_WRITE_REQ or BT_ATT_OP_WRITE_
  * `process_find_info_req` **(Many-Argument Workhorses)** (Impact: 38.1)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** changing it is visible to **2** in-repo importer(s); it depends on **6**; blast radius 0.102; role: Transceiver (Middle-Tier)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Historical Churn (predictive layer, promotion pending #2987) (formerly Churn) (89.2%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 42.8571% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `zephyr_dts_to_cp_board` **(Many-Argument Workhorses)** (Impact: 225.7)
  * `find_flash_devices` **(Compute Cores)** (Impact: 35.0)
    * *Intent:* """ Find all flash devices from a device tree. Args: device_tree: Parsed device tree (dtlib.DT objec...
  * `find_ram_regions` **(Compute Cores)** (Impact: 24.5)
    * *Intent:* """ Find all RAM regions from a device tree. Includes the zephyr,sram node and any zephyr,memory-reg...
  * `_label_to_end` **(Encapsulated Accessors)** (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.000279
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **6**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (99.8%), Test Surface (formerly Verification) (80.0%), Guard Balance (formerly Safety Score) (74.7%), Complexity Load (formerly Cognitive Load) (47.1%)
- **Documentation Coverage:** 90.9091% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_obj_new_type` **(Many-Argument Workhorses)** (Impact: 60.3)
  * `mp_obj_instance_store_attr` **(Many-Argument Workhorses)** (Impact: 60.2)
  * `mp_obj_class_lookup` **(Many-Argument Workhorses)** (Impact: 57.0)
  * `type_attr` **(Many-Argument Workhorses)** (Impact: 52.5)
  * `mp_obj_instance_load_attr` **(Many-Argument Workhorses)** (Impact: 47.3)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **5**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.6%), Complexity Load (formerly Cognitive Load) (86.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 95.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `mp_prof_opcode_decode` **(Many-Argument Workhorses)** (Impact: 198.9)
  * `frame_attr` **(Stateful Encapsulated Methods)** (Impact: 19.4)
  * `mp_prof_instr_tick` **(Defensive Guards)** (Impact: 16.6)
  * `mp_prof_frame_enter` **(Compute Cores)** (Impact: 11.9)
  * `mp_prof_print_instr` **(Compute Cores)** (Impact: 10.5)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **13**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Complexity Load (formerly Cognitive Load) (96.9%), Guard Balance (formerly Safety Score) (88.7%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `gc_alloc` **(Many-Argument Workhorses)** (Impact: 89.3)
  * `gc_realloc` **(Many-Argument Workhorses)** (Impact: 69.1)
  * `gc_dump_alloc_table` **(Compute Cores)** (Impact: 59.0)
  * `gc_info` **(Compute Cores)** (Impact: 31.9)
  * `gc_free` **(Compute Cores)** (Impact: 25.3)
...
* *Risk/State:* `safety_bypasses: 25`, `state_mutation: 161`, `dead_code: 6`, `planned_debt: 3`, `fragile_debt: 1`, `unreferenced_by_name: 12`
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **1**; blast radius 0.064; role: Isolated/Orphan
- **Top Surface Vectors:** Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (29.3%), Connectivity (formerly Api Exposure) (11.2%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `constraint_pass` **(Compute Cores)** (Impact: 78.3)
    * *Intent:* ##################################
  * `solved` **(Compute Cores)** (Impact: 33.9)
  * `solve_step` **(Many-Argument Workhorses)** (Impact: 28.3)
  * `print_pos` **(Compute Cores)** (Impact: 23.9)
  * `read_file` **(Compute Cores)** (Impact: 19.3)
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **8**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Debt Markers (formerly Tech Debt) (99.8%), Guard Balance (formerly Safety Score) (98.9%), Complexity Load (formerly Cognitive Load) (92.4%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `displayio_tilegrid_fill_area` **(Many-Argument Workhorses)** (Impact: 112.0)
  * `common_hal_displayio_tilegrid_construct` **(Many-Argument Workhorses)** (Impact: 61.2)
    * *Intent:* #include "shared-bindings/displayio/TileGrid.h" #include "py/runtime.h" #include "shared-bindings/di...
  * `displayio_tilegrid_get_refresh_areas` **(Compute Cores)** (Impact: 49.8)
  * `displayio_tilegrid_finish_refresh` **(Compute Cores)** (Impact: 19.7)
  * `common_hal_displayio_tilegrid_set_all_tiles` **(Compute Cores)** (Impact: 18.9)
**Contextual Mitigations & Amplifications:**
...
- **Blast Radius:** nothing in-repo imports it (entrypoint or orphan); it depends on **12**; blast radius 0.064; role: Pure Consumer (Orchestrator)
- **Top Surface Vectors:** Mutation Surface (formerly State Flux) (100.0%), Guard Balance (formerly Safety Score) (99.8%), Complexity Load (formerly Cognitive Load) (90.3%), Test Surface (formerly Verification) (80.0%)
- **Documentation Coverage:** 100.0% of unit weight undocumented
**Top Internal Functions/Classes:**
  * `compute_huffman_coding` **(Many-Argument Workhorses)** (Impact: 161.8)
    * *Intent:* # possible future improvement: some languages are better when consider len(k) > 2. try both? qstrs =...
  * `decompress` **(Many-Argument Workhorses)** (Impact: 24.3)
  * `compress` **(Many-Argument Workhorses)** (Impact: 21.8)
  * `compute_unicode_offset` **(Compute Cores)** (Impact: 13.7)
  * `parse_input_headers` **(Compute Cores)** (Impact: 12.0)
**Contextual Mitigations & Amplifications:**
...
- `ports/zephyr-cp/cptools/zephyr2cp.py` -> Churn: **89.15%** | Cog Load: 63.3589% | Debt: 0.0%
...
- `ports/raspberrypi/common-hal/socketpool/Socket.c` -> **Scott Shawcroft** (100.0% isolated ownership) | Magnitude: 1018.04
...
- `py/bc.h` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 99.9999%)
- `py/objstr.h` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 63.026%)

### 🃏 House of Cards (Closeness * Error Risk)
These files are deeply embedded (1 or 2 hops from the entire codebase) but possess high error exposure. A runtime exception here will cascade instantly across the application.

- `py/mpprint.h` -> **Severity: 7.896** (Embedded: 0.14 * Error Risk: 56.3934%)
- `py/obj.h` -> **Severity: 7.665** (Embedded: 0.2081 * Error Risk: 36.8231%)
- `supervisor/shared/translate/translate_impl.h` -> **Severity: 7.401** (Embedded: 0.0928 * Error Risk: 79.7611%)
- `py/runtime.h` -> **Severity: 3.741** (Embedded: 0.1078 * Error Risk: 34.6892%)
- `py/misc.h` -> **Severity: 3.367** (Embedded: 0.1442 * Error Risk: 23.3439%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `py/obj.h` -> **Severity: 8365.7** (Blast Radius: 83.657 * Doc Risk: 100.0%)
- `py/misc.h` -> **Severity: 3639.8** (Blast Radius: 36.398 * Doc Risk: 100.0%)
- `supervisor/shared/translate/translate_impl.h` -> **Severity: 1443.6** (Blast Radius: 14.436 * Doc Risk: 100.0%)
- `py/runtime.h` -> **Severity: 1278.0** (Blast Radius: 12.78 * Doc Risk: 100.0%)
- `py/objarray.h` -> **Severity: 463.4** (Blast Radius: 4.634 * Doc Risk: 100.0%)
