...
- `P_UseSpecialLine` (@ `src/p_switch.c`) -> Impact: **262.9** | LOC: 379
  * *Intent:* // // P_UseSpecialLine // Called when a thing uses a special line. // Only the front sides of lines are usable. //
- `M_Responder` (@ `src/m_menu.c`) -> Impact: **216.2** | LOC: 477
  * *Intent:* // // CONTROL PANEL // // // M_Responder //
- `P_CrossSpecialLine` (@ `src/p_spec.c`) -> Impact: **211.0** | LOC: 460
...
- `P_TouchSpecialThing` (@ `src/p_inter.c`) -> Impact: **180.9** | LOC: 328
  * *Intent:* // // P_TouchSpecialThing //
- `G_BuildTiccmd` (@ `src/g_game.c`) -> Impact: **145.4** | LOC: 276
...
- `R_StoreWallRange` (@ `src/r_segs.c`) -> Impact: **138.1** | LOC: 372
  * *Intent:* // // R_StoreWallRange // A wall segment will be drawn // between start and stop pixels (inclusive). //
- `ST_Responder` (@ `src/st_stuff.c`) -> Impact: **108.8** | LOC: 224
  * *Intent:* // Respond to keyboard input events, // intercept cheats.
- `D_DoomMain` (@ `src/d_main.c`) -> Impact: **100.0** | LOC: 680
  * *Intent:* #endif // // D_DoomMain //
- `AM_Responder` (@ `src/am_map.c`) -> Impact: **94.8** | LOC: 143
  * *Intent:* // // Handle events (user inputs) in automap mode //
- `P_DamageMobj` (@ `src/p_inter.c`) -> Impact: **94.4** | LOC: 144
...
- **Heaviest Functions:** `HUlib_drawTextLine` (Impact: 19.4), `HUlib_eraseTextLine` (Impact: 14.2), `HUlib_keyInIText` (Impact: 13.1)
...
- **Heaviest Functions:** `STlib_drawNum` (Impact: 25.5), `STlib_updateBinIcon` (Impact: 13.6), `STlib_updateMultIcon` (Impact: 13.5)
...
- **Heaviest Functions:** `P_XYMovement` (Impact: 68.6), `P_ZMovement` (Impact: 50.6), `P_SpawnMapThing` (Impact: 43.1)
...
- **Heaviest Functions:** `M_StringReplace` (Impact: 16.9), `M_StringJoin` (Impact: 12.7), `M_ExtractFileBase` (Impact: 12.2)
