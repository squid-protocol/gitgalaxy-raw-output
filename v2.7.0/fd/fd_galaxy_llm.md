...
- `get_absolute_root_path` (@ `tests/tests.rs`) -> Impact: **128.3** | LOC: 2044
- `spawn_senders` (@ `src/walk.rs`) -> Impact: **95.1** | LOC: 182
  * *Intent:* /// Spawn the sender threads.
- `should_ignore` (@ `src/filetypes.rs`) -> Impact: **47.9** | LOC: 22
- `absolute_path` (@ `src/filesystem.rs`) -> Impact: **33.5** | LOC: 133
...
- `parse_opt` (@ `src/filter/size.rs`) -> Impact: **27.2** | LOC: 34
- `print_entry_colorized` (@ `src/output.rs`) -> Impact: **27.1** | LOC: 50
  * *Intent:* // TODO: this function is performance critical and can probably be optimized
- `poll` (@ `src/walk.rs`) -> Impact: **25.2** | LOC: 52
...
- `build_walker` (@ `src/walk.rs`) -> Impact: **23.7** | LOC: 58
...
- **Heaviest Functions:** `parse` (Impact: 15.2), `replace_separator` (Impact: 14.6), `fmt` (Impact: 14.4)
...
- **Heaviest Functions:** `print_entry` (Impact: 31.4), `print_entry_colorized` (Impact: 27.1), `print_entry_uncolorized` (Impact: 10.8)
...
- **Heaviest Functions:** `augment_args` (Impact: 20.5), `search_paths` (Impact: 12.6), `normalize_path` (Impact: 9.2)
...
- **Heaviest Functions:** `spawn_senders` (Impact: 95.1), `poll` (Impact: 25.2), `build_walker` (Impact: 23.7)
...
- **Heaviest Functions:** `stripped_path` (Impact: 5.5), `into_stripped_path` (Impact: 5.5), `file_name` (Impact: 5.0)
...
- **Heaviest Functions:** `exit` (Impact: 4.9), `from` (Impact: 3.2), `merge_exitcodes` (Impact: 3.1)
...
- **Heaviest Functions:** `from_str` (Impact: 16.5), `is_time_filter_applicable` (Impact: 6.4), `applies_to` (Impact: 3.8)
...
- **Heaviest Functions:** `execute_commands` (Impact: 18.0), `write` (Impact: 8.4), `handle_cmd_error` (Impact: 7.7)
...
- **Heaviest Functions:** `job` (Impact: 11.7), `batch` (Impact: 7.0)
...
**Top Internal Functions/Classes:**
  * `get_absolute_root_path` (Impact: 128.3)
  * `test_exec_batch` (Impact: 7.0)
  * `test_exec_batch_multi` (Impact: 5.3)
  * `test_exec_batch_with_limit` (Impact: 4.8)
  * `test_max_results` (Impact: 3.7)
...
**Top Internal Functions/Classes:**
  * `augment_args` (Impact: 20.5)
  * `search_paths` (Impact: 12.6)
  * `normalize_path` (Impact: 9.2)
  * `ensure_current_directory_exists` (Impact: 6.1)
  * `strip_cwd_prefix` (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `token_from_pattern_id` (Impact: 3.4)
...
**Top Internal Functions/Classes:**
  * `create_working_directory` (Impact: 24.3)
    * *Intent:* /// Create the working directory and the test files.
  * `create_broken_symlink` (Impact: 9.6)
...
**Top Internal Functions/Classes:**
  * `print_entry` (Impact: 31.4)
    * *Intent:* // TODO: this function is performance critical and can probably be optimized
  * `print_entry_colorized` (Impact: 27.1)
    * *Intent:* // TODO: this function is performance critical and can probably be optimized
  * `print_entry_uncolorized` (Impact: 10.8)
  * `print_trailing_slash` (Impact: 7.7)
    * *Intent:* // Display a trailing slash if the path is a directory and the config option is enabled. // If the p...
  * `print_entry_uncolorized_base` (Impact: 6.7)
    * *Intent:* // TODO: this function is performance critical and can probably be optimized
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `stripped_path` (Impact: 5.5)
    * *Intent:* /// Returns the path as it should be presented to the user.
  * `into_stripped_path` (Impact: 5.5)
    * *Intent:* /// Returns the path as it should be presented to the user.
  * `file_name` (Impact: 5.0)
  * `metadata` (Impact: 4.6)
  * `style` (Impact: 3.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `absolute_path` (Impact: 33.5)
  * `path_absolute_form` (Impact: 3.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `from_str` (Impact: 16.5)
  * `is_time_filter_applicable` (Impact: 6.4)
...
**Top Internal Functions/Classes:**
  * `parse_opt` (Impact: 27.2)
  * `is_within` (Impact: 3.8)
  * `from_string` (Impact: 3.0)
  * `is_within_less_than` (Impact: 1.2)
  * `is_within_less_than_equal` (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `from` (Impact: 3.2)
  * `merge_exitcodes` (Impact: 3.1)
  * `is_error` (Impact: 1.6)
  * `general_error_if_at_least_one_error` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
