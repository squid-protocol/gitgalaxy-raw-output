...
| Avg Path Length | 2.3333 | Hops between files. Lower = Tighter coupling. |
...
- `runForWindows` (@ `package/index.js`) -> Impact: **22.0** | LOC: 73
- `chcpError` (@ `package/index.js`) -> Impact: **15.2** | LOC: 27
- `printInstalledVersion` (@ `package/cli.js`) -> Impact: **15.0** | LOC: 22
- `runVersionCommand` (@ `package/index.js`) -> Impact: **12.4** | LOC: 40
- `run` (@ `package/index.js`) -> Impact: **12.0** | LOC: 42
- `check` (@ `package/index.js`) -> Impact: **10.0** | LOC: 26
  * *Intent:* ;
- `printVersions` (@ `package/cli.js`) -> Impact: **8.2** | LOC: 25
  * *Intent:* //
- `callback` (@ `package/index.js`) -> Impact: **5.1** | LOC: 18
  * *Intent:* // reset codepage before exiting
- `optionsFromPackage` (@ `package/cli.js`) -> Impact: **4.2** | LOC: 24
- `normalizeWanted` (@ `package/index.js`) -> Impact: **3.6** | LOC: 16
...
- **Heaviest Functions:** `runForWindows` (Impact: 22.0), `chcpError` (Impact: 15.2), `runVersionCommand` (Impact: 12.4)
...
- **Heaviest Functions:** `getInstallInstructions` (Impact: 3.2), `hasNvm` (Impact: 1.7), `getInstallInstructions` (Impact: 1.6)
...
- **Heaviest Functions:** `printInstalledVersion` (Impact: 15.0), `printVersions` (Impact: 8.2), `optionsFromPackage` (Impact: 4.2)
...
- **Heaviest Functions:** `check` (Impact: 1.8), `check` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  * `runForWindows` (Impact: 22.0)
  * `chcpError` (Impact: 15.2)
...
**Top Internal Functions/Classes:**
  * `printInstalledVersion` (Impact: 15.0)
  * `printVersions` (Impact: 8.2)
    * *Intent:* //
  * `optionsFromPackage` (Impact: 4.2)
  * `optionsFromVolta` (Impact: 3.2)
  * `unknown` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
