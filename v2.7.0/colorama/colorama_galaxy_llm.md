...
- `extract_params` (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **24.8** | LOC: 16
- `__init__` (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **24.0** | LOC: 39
...
- `init` (@ `colorama-0.4.6/colorama/initialise.py`) -> Impact: **19.2** | LOC: 26
- `call_win32` (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **17.0** | LOC: 20
...
- `convert_osc` (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **14.6** | LOC: 14
...
- `write_and_convert` (@ `colorama-0.4.6/colorama/ansitowin32.py`) -> Impact: **9.4** | LOC: 14
...
- **Heaviest Functions:** `extract_params` (Impact: 24.8), `__init__` (Impact: 24.0), `call_win32` (Impact: 17.0)
...
- **Heaviest Functions:** `erase_screen` (Impact: 15.6), `erase_line` (Impact: 13.2), `fore` (Impact: 9.4)
...
- **Heaviest Functions:** `__init__` (Impact: 4.6), `POS` (Impact: 2.1), `UP` (Impact: 1.8)
...
- **Heaviest Functions:** `init` (Impact: 19.2), `just_fix_windows_console` (Impact: 8.1), `wrap_stream` (Impact: 7.7)
...
- **Heaviest Functions:** `SetConsoleCursorPosition` (Impact: 8.8), `SetConsoleMode` (Impact: 3.7), `GetConsoleMode` (Impact: 3.1)
...
- **Heaviest Functions:** `main` (Impact: 3.7)
...
- **Heaviest Functions:** `find` (Impact: 1.8), `format` (Impact: 1.5)
...
- **Heaviest Functions:** `replace_by` (Impact: 1.8), `replace_original_by` (Impact: 1.8), `osname` (Impact: 1.7)
...
**Top Internal Functions/Classes:**
  * `extract_params` (Impact: 24.8)
  * `__init__` (Impact: 24.0)
    * *Intent:* # The wrapped stream (normally sys.stdout or sys.stderr) self.wrapped = wrapped # should we reset co...
  * `call_win32` (Impact: 17.0)
  * `convert_osc` (Impact: 14.6)
  * `write_and_convert` (Impact: 9.4)
...
**Top Internal Functions/Classes:**
  ...
  * `fore` (Impact: 9.4)
  * `back` (Impact: 9.4)
  * `enable_vt_processing` (Impact: 6.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `init` (Impact: 19.2)
  * `just_fix_windows_console` (Impact: 8.1)
...
**Top Internal Functions/Classes:**
  ...
  * `GetConsoleMode` (Impact: 3.1)
  * `FillConsoleOutputCharacter` (Impact: 2.7)
  * `FillConsoleOutputAttribute` (Impact: 2.7)
...
**Top Internal Functions/Classes:**
  * `replace_by` (Impact: 1.8)
  * `replace_original_by` (Impact: 1.8)
  * `osname` (Impact: 1.7)
  * `isatty` (Impact: 1.5)
  * `isatty` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
