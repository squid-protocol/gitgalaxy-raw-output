...
| Avg Path Length | 4.0863 | Hops between files. Lower = Tighter coupling. |
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 97.9 | 15.6 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 15.6 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 2.6 | 2.3 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 15.8 | 3.5 | 0.0 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 5.0 | 1.0 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 64.7 | 5.0 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 49.9 | 50.0 | 0.0 |
...
| dead_code | 1301 | 1081 | 1 | `components/form/__tests__/index.test.tsx` |
...
- `defaultSearchRender` (@ `components/cascader/index.tsx`) -> Impact: **151.9** | LOC: 399
- `copyTest` (@ `components/typography/__tests__/index.test.tsx`) -> Impact: **126.7** | LOC: 99
  * *Intent:* /** * @param name Test case name * @param text Origin text context * @param target Copy to clipboard text * @param icon Icon * @param tooltips Tooltip...
- `InternalFormItem` (@ `components/form/FormItem/index.tsx`) -> Impact: **125.4** | LOC: 331
- `useResize` (@ `components/splitter/hooks/useResize.ts`) -> Impact: **106.1** | LOC: 164
  * *Intent:* /** * Handle user drag resize logic. */
- `onEdit` (@ `components/tabs/index.tsx`) -> Impact: **105.9** | LOC: 143
- `InternalSelect` (@ `components/select/index.tsx`) -> Impact: **102.9** | LOC: 325
- `renderInternalItem` (@ `components/list/index.tsx`) -> Impact: **93.7** | LOC: 211
- `ProviderChildren` (@ `components/config-provider/index.tsx`) -> Impact: **93.5** | LOC: 400
- `getSize` (@ `components/progress/utils.ts`) -> Impact: **88.5** | LOC: 50
- `useItems` (@ `components/timeline/useItems.tsx`) -> Impact: **83.7** | LOC: 91
...
### 1. `tests/shared/imageTest.tsx` (TYPESCRIPT) -> Cumulative Risk: **681.48**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 271.5 | **LOC:** 357 | **CtrlFlow:** 15.4% | **Authorship Centralization:** 37.5%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9969%)
- **Heaviest Functions:** `imageTest` (Impact: 59.5), `requestListener` (Impact: 40.3), `imageDemoTest` (Impact: 25.2)

### 2. `scripts/print-changelog.ts` (TYPESCRIPT) -> Cumulative Risk: **629.37**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 267.7 | **LOC:** 392 | **CtrlFlow:** 17.1% | **Authorship Centralization:** 40.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9991%), State Flux (99.9106%)
- **Heaviest Functions:** `printLog` (Impact: 66.8), `validate` (Impact: 25.3), `validate` (Impact: 13.6)

### 3. `components/notification/__tests__/util.ts` (TYPESCRIPT) -> Cumulative Risk: **617.07**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 49.8 | **LOC:** 31 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `triggerMotionEnd` (Impact: 8.2), `awaitPromise` (Impact: 2.2)

### 4. `components/message/__tests__/util.ts` (TYPESCRIPT) -> Cumulative Risk: **616.35**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 45.16 | **LOC:** 25 | **CtrlFlow:** 11.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `triggerMotionEnd` (Impact: 3.6), `awaitPromise` (Impact: 2.2)

### 5. `scripts/pre-publish.ts` (TYPESCRIPT) -> Cumulative Risk: **611.61**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 126.4 | **LOC:** 285 | **CtrlFlow:** 10.9% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9992%), Tech Debt (89.1124%)
- **Heaviest Functions:** `showMessage` (Impact: 28.2), `runPrePublish` (Impact: 20.1), `downloadArtifact` (Impact: 7.9)

### 6. `.dumi/theme/utils/index.ts` (TYPESCRIPT) -> Cumulative Risk: **609.36**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 263.26 | **LOC:** 217 | **CtrlFlow:** 32.8% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (92.1082%), Documentation (87.5%)
- **Heaviest Functions:** `getMenuItems` (Impact: 60.5), `sortFn` (Impact: 44.9), `getLocalizedPathname` (Impact: 39.5)

### 7. `scripts/generate-cssinjs.ts` (TYPESCRIPT) -> Cumulative Risk: **606.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 41.76 | **LOC:** 53 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9828%), State Flux (99.1837%)
- **Heaviest Functions:** `useStyle` (Impact: 6.0), `useStyle` (Impact: 5.5), `Demo` (Impact: 3.4)

### 8. `components/typography/hooks/useCopyClick.ts` (TYPESCRIPT) -> Cumulative Risk: **593.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 40.84 | **LOC:** 68 | **CtrlFlow:** 21.2% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.1785%)
- **Heaviest Functions:** `cleanCopyId` (Impact: 13.3), `useCopyClick` (Impact: 3.5)

### 9. `scripts/post-publish.ts` (TYPESCRIPT) -> Cumulative Risk: **592.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 76.98 | **LOC:** 167 | **CtrlFlow:** 21.0% | **Authorship Centralization:** 20.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.5997%), State Flux (99.5236%)
- **Heaviest Functions:** `process` (Impact: 31.8), `matchDeprecated` (Impact: 4.7)

### 10. `components/upload/demo/transform-file.tsx` (TYPESCRIPT) -> Cumulative Risk: **589.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 23.72 | **LOC:** 40 | **CtrlFlow:** 2.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Tech Debt (88.0797%)
- **Heaviest Functions:** `beforeUpload` (Impact: 2.5), `App` (Impact: 2.4), `onload` (Impact: 1.9)
...
- **Risk Profile:** Cognitive Load (7.7008%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 681.75 | **LOC:** 122 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (5.5148%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (14.4509%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `App` (Impact: 17.8)
    * *Intent:* // base size
  * `App` (Impact: 15.4)
    * *Intent:* // base size
  * `validator` (Impact: 10.1)
  * `App` (Impact: 8.8)
  * `changeValue` (Impact: 8.2)
...
- **Risk Profile:** Cognitive Load (3.6703%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `filter` (Impact: 32.5)
  * `filterSearch` (Impact: 30.2)
  * `sorter` (Impact: 21.9)
  * `onFilter` (Impact: 20.8)
  * `onFilter` (Impact: 20.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (27.323%), Tech Debt (8.4423%)
**Top Internal Functions/Classes:**
  * `useSelection` (Impact: 68.5)
  * `renderCell` (Impact: 48.8)
  * `renderSelectionCell` (Impact: 41.5)
  * `onClick` (Impact: 23.6)
  * `renderCell` (Impact: 15.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (41.8392%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `mockActionFn` (Impact: 8.0)
  * `error` (Impact: 5.8)
  * `open` (Impact: 4.7)
  * `configWarp` (Impact: 4.1)
  * `holderRender` (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Risk Profile:** Cognitive Load (28.8578%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (29.6068%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `injectSorter` (Impact: 66.8)
  * `getSortData` (Impact: 28.5)
  * `onKeyDown` (Impact: 19.7)
  * `pushState` (Impact: 19.5)
  * `title` (Impact: 8.8)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 298.84 | **LOC:** 772 | **CtrlFlow:** 23.9% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (19.5691%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `InternalTable` (Impact: 55.7)
  * `normalizePlacement` (Impact: 55.5)
  * `internalRowClassName` (Impact: 40.6)
  * `triggerOnChange` (Impact: 23.3)
  * `onPaginationChange` (Impact: 20.7)
    * *Intent:* // ========================== Pagination ==========================
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (63.7816%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `generateReport` (Impact: 48.1)
  * `generateLineReport` (Impact: 34.7)
  * `boot` (Impact: 27.4)
  * `compareScreenshots` (Impact: 10.8)
  * `getMdImageTag` (Impact: 7.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (4.4696%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `allElement` (Impact: 12.3)
  * `getIndeterminateSelection` (Impact: 11.4)
  * `renderedNames` (Impact: 10.4)
  * `getCheckboxProps` (Impact: 10.4)
  * `onRow` (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
- **Risk Profile:** Cognitive Load (4.4108%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `compare` (Impact: 26.0)
  * `getNameColumn` (Impact: 23.1)
  * `getIcon` (Impact: 20.6)
  * `getIcon` (Impact: 20.4)
  * `sorter` (Impact: 16.0)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 271.5 | **LOC:** 357 | **CtrlFlow:** 15.4% | **Authorship Centralization:** 37.5%
- **Risk Profile:** Cognitive Load (88.469%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `imageTest` (Impact: 59.5)
    * *Intent:* // eslint-disable-next-line jest/no-export
  * `requestListener` (Impact: 40.3)
  * `imageDemoTest` (Impact: 25.2)
    * *Intent:* // eslint-disable-next-line jest/no-export
  * `getTestOption` (Impact: 17.8)
  * `onRequestHandle` (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (37.2446%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `InternalFormItem` (Impact: 125.4)
  * `[eventName]` (Impact: 19.4)
  * `onMetaChange` (Impact: 17.0)
  * `renderLayout` (Impact: 12.1)
    * *Intent:* // ======================== Render ========================
  * `onSubItemMetaChange` (Impact: 10.6)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 267.7 | **LOC:** 392 | **CtrlFlow:** 17.1% | **Authorship Centralization:** 40.0%
- **Risk Profile:** Cognitive Load (85.4978%), Tech Debt (33.5038%)
**Top Internal Functions/Classes:**
  * `printLog` (Impact: 66.8)
  * `validate` (Impact: 25.3)
  * `validate` (Impact: 13.6)
  * `printPR` (Impact: 13.5)
  * `fetchPullRequest` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 263.26 | **LOC:** 217 | **CtrlFlow:** 32.8% | **Authorship Centralization:** 33.3%
- **Risk Profile:** Cognitive Load (83.9934%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getMenuItems` (Impact: 60.5)
  * `sortFn` (Impact: 44.9)
  * `getLocalizedPathname` (Impact: 39.5)
  * `getMetaDescription` (Impact: 11.1)
  * `matchDeprecated` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (15.449%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getFilterComponent` (Impact: 22.6)
  * `renderFilterItems` (Impact: 15.4)
  * `onVisibleChange` (Impact: 14.9)
  * `triggerVisible` (Impact: 14.6)
  * `internalTriggerFilter` (Impact: 13.6)
    * *Intent:* // ======================= Submit ========================
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 11 instances
...
- **Risk Profile:** Cognitive Load (9.1715%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `copyTest` (Impact: 126.7)
    * *Intent:* /** * @param name Test case name * @param text Origin text context * @param target Copy to clipboard...
  * `testStep` (Impact: 65.3)
  * `getComputedStyle` (Impact: 4.4)
  * `DynamicPropsTestCase` (Impact: 3.7)
  * `fn` (Impact: 1.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (29.7127%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `symbol` (Impact: 8.2)
  * `getContentHeight` (Impact: 7.3)
  * `getTooltipContent` (Impact: 5.3)
  * `App` (Impact: 4.2)
  * `get` (Impact: 4.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 13 instances
...
- **Risk Profile:** Cognitive Load (63.042%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `useResize` (Impact: 106.1)
    * *Intent:* /** * Handle user drag resize logic. */
  * `onOffsetUpdate` (Impact: 34.3)
  * `onCollapse` (Impact: 30.4)
    * *Intent:* // ======================= Collapse =======================
  * `getLimitSize` (Impact: 7.2)
    * *Intent:* // ======================== Resize ========================
  * `onOffsetStart` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 15 instances
...
- **Risk Profile:** Cognitive Load (24.6321%), Tech Debt (10.932%)
**Top Internal Functions/Classes:**
  * `InternalUpload` (Impact: 24.3)
  * `onInternalChange` (Impact: 22.4)
  * `renderUploadList` (Impact: 21.8)
  * `onFileDrop` (Impact: 14.9)
  * `handleRemove` (Impact: 14.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 21 instances
...
- **Risk Profile:** Cognitive Load (16.1353%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getLocale` (Impact: 27.3)
  * `Transfer` (Impact: 21.2)
  * `onItemSelect` (Impact: 19.2)
  * `setPrevSelectedIndex` (Impact: 11.4)
  * `onItemSelectAll` (Impact: 11.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (12.6496%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `defaultSearchRender` (Impact: 151.9)
  * `highlightKeyword` (Impact: 9.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
...
- **Risk Profile:** Cognitive Load (15.5157%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `onChange` (Impact: 15.2)
  * `onChange` (Impact: 12.6)
  * `onChange` (Impact: 7.5)
  * `onChange` (Impact: 4.7)
  * `onChange` (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
...
- `eslint.config.mjs` -> Churn: **64.69%** | Cog Load: 3.2425% | Debt: 71.1436%
...
- `components/table/__tests__/empty.test.tsx` -> **thinkasany** (100.0% isolated ownership) | Magnitude: 134.51
...
- `components/theme/util/genStyleUtils.ts` -> **Severity: 0.059** (Bridge: 0.0006 * Flux: 100.0%)
- `components/radio/radio.tsx` -> **Severity: 0.043** (Bridge: 0.0004 * Flux: 100.0%)
- `components/theme/useToken.ts` -> **Severity: 0.035** (Bridge: 0.0005 * Flux: 63.3705%)
- `components/_util/responsiveObserver.ts` -> **Severity: 0.021** (Bridge: 0.0002 * Flux: 100.0%)
- `tests/shared/demoTest.tsx` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 100.0%)
