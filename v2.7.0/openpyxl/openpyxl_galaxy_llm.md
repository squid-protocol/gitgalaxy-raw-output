...
| Avg Path Length | 2.5347 | Hops between files. Lower = Tighter coupling. |
...
- `translate_range` (@ `openpyxl-3.1.5/openpyxl/formula/translate.py`) -> Impact: **48.6** | LOC: 33
...
- `from_tree` (@ `openpyxl-3.1.5/openpyxl/descriptors/serialisable.py`) -> Impact: **39.2** | LOC: 57
  * *Intent:* """ Create object from XML """
- `parse_cell` (@ `openpyxl-3.1.5/openpyxl/worksheet/_reader.py`) -> Impact: **37.4** | LOC: 56
- `_cells_by_row` (@ `openpyxl-3.1.5/openpyxl/worksheet/_read_only.py`) -> Impact: **36.5** | LOC: 43
  * *Intent:* """ The source worksheet file may have columns or rows missing. Missing cells will be created. """
- `from_ISO8601` (@ `openpyxl-3.1.5/openpyxl/utils/datetime.py`) -> Impact: **36.1** | LOC: 44
...
- `lxml_write_cell` (@ `openpyxl-3.1.5/openpyxl/cell/_writer.py`) -> Impact: **35.6** | LOC: 42
- `etree_write_cell` (@ `openpyxl-3.1.5/openpyxl/cell/_writer.py`) -> Impact: **31.2** | LOC: 42
- `__init__` (@ `openpyxl-3.1.5/openpyxl/styles/fonts.py`) -> Impact: **29.6** | LOC: 30
...
- **Heaviest Functions:** `to_tree` (Impact: 49.6), `from_tree` (Impact: 39.2), `__add__` (Impact: 16.3)
...
- **Heaviest Functions:** `__init__` (Impact: 20.1), `to_tree` (Impact: 7.0), `_guess_operator` (Impact: 6.4)
...
- **Heaviest Functions:** `__init__` (Impact: 10.7), `__init__` (Impact: 8.4), `__init__` (Impact: 7.9)
...
- **Heaviest Functions:** `__set__` (Impact: 18.9), `__set__` (Impact: 8.5), `__get__` (Impact: 6.4)
...
- **Heaviest Functions:** `__init__` (Impact: 18.8), `__set__` (Impact: 10.4), `__iter__` (Impact: 4.5)
...
- **Heaviest Functions:** `avoid_duplicate_name` (Impact: 18.3), `title` (Impact: 17.1), `__init__` (Impact: 4.2)
...
- **Heaviest Functions:** `__init__` (Impact: 18.1), `__init__` (Impact: 12.4), `by_priority` (Impact: 7.9)
...
- **Heaviest Functions:** `__init__` (Impact: 4.3), `__init__` (Impact: 3.8), `__init__` (Impact: 3.8)
...
- **Heaviest Functions:** `__init__` (Impact: 8.5), `__init__` (Impact: 7.8), `__init__` (Impact: 6.2)
...
- **Heaviest Functions:** `parse_cell` (Impact: 37.4), `parse_row` (Impact: 16.7), `parse_formula` (Impact: 13.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.026232 | `Ripple Effect (Closeness):` 0.052074
...
**Top Internal Functions/Classes:**
  * `parse_cell` (Impact: 37.4)
  * `parse_row` (Impact: 16.7)
  * `parse_formula` (Impact: 13.4)
    * *Intent:* """ possible formulae types: shared, array, datatable """
  * `bind_hyperlinks` (Impact: 12.2)
  * `parse` (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001532 | `Ripple Effect (Closeness):` 0.014035
...
**Top Internal Functions/Classes:**
  ...
  * `to_tree` (Impact: 7.0)
  * `_guess_operator` (Impact: 6.4)
  * `convert` (Impact: 4.8)
    * *Intent:* """Convert to more specific filter"""
  * `_get_subtype` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000272 | `Ripple Effect (Closeness):` 0.04941
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.01289 | `Ripple Effect (Closeness):` 0.584563
...
**Top Internal Functions/Classes:**
  * `write_row` (Impact: 14.3)
  * `write_tables` (Impact: 11.0)
  * `get_stream` (Impact: 7.8)
  * `write_formatting` (Impact: 7.5)
  * `write_hyperlinks` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00055 | `Ripple Effect (Closeness):` 0.06281
...
**Top Internal Functions/Classes:**
  * `read_worksheets` (Impact: 29.1)
  * `_validate_archive` (Impact: 12.9)
    * *Intent:* """ Does a first check whether filename is a string or a file-like object. If it is a string represe...
  * `read_chartsheet` (Impact: 9.0)
  * `_find_workbook_part` (Impact: 7.8)
  * `read_workbook` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `get` (Impact: 8.3)
  * `_initialise_columns` (Impact: 6.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.007949 | `Ripple Effect (Closeness):` 0.04812
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003006 | `Ripple Effect (Closeness):` 0.039528
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0011 | `Ripple Effect (Closeness):` 0.045687
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001304 | `Ripple Effect (Closeness):` 0.046093
...
**Top Internal Functions/Classes:**
  * `_write_worksheets` (Impact: 17.9)
  * `_write_comment` (Impact: 8.0)
  * `write_data` (Impact: 7.8)
  * `_merge_vba` (Impact: 7.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000599 | `Ripple Effect (Closeness):` 0.051982
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003528 | `Ripple Effect (Closeness):` 0.280147
...
- `openpyxl-3.1.5/openpyxl/chart/_chart.py` -> **Severity: 3.058** (Bridge: 0.0306 * Flux: 100.0%)
- `openpyxl-3.1.5/openpyxl/worksheet/worksheet.py` -> **Severity: 2.623** (Bridge: 0.0262 * Flux: 100.0%)
- `openpyxl-3.1.5/openpyxl/chart/reference.py` -> **Severity: 2.185** (Bridge: 0.0219 * Flux: 100.0%)
- `openpyxl-3.1.5/openpyxl/drawing/spreadsheet_drawing.py` -> **Severity: 1.625** (Bridge: 0.0162 * Flux: 100.0%)
- `openpyxl-3.1.5/openpyxl/descriptors/serialisable.py` -> **Severity: 1.289** (Bridge: 0.0129 * Flux: 100.0%)
