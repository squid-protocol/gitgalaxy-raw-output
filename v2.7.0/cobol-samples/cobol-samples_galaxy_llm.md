...
| Avg Path Length | 1.8417 | Hops between files. Lower = Tighter coupling. |
...
| ml_ai | 3 | 1 | 0 | `src/main/cobol/ATTRACT.CBL` |
| ui | 0 | 0 | 0 | - |
...
- `FILE-CONTROL` (@ `src/main/cobol/CPSEQVR.CBL`) -> Impact: **13.2** | LOC: 64
- `FILE-CONTROL` (@ `src/main/cobol/CPSEQFR.CBL`) -> Impact: **10.3** | LOC: 67
- `PRINT-INVOICE-DETAILS` (@ `src/main/cobol/INVCALC.CBL`) -> Impact: **8.2** | LOC: 44
- `Anonymous_Block` (@ `compile`) -> Impact: **4.7** | LOC: 9
- `Anonymous_Block` (@ `compile`) -> Impact: **4.6** | LOC: 7
- `Anonymous_Block` (@ `compile`) -> Impact: **4.4** | LOC: 3
  * *Intent:* # remove existing output file, if any
- `__global_context__` (@ `compile`) -> Impact: **4.3** | LOC: 30
- `Anonymous_Block` (@ `compile-all`) -> Impact: **4.3** | LOC: 6
- `Anonymous_Block` (@ `compile`) -> Impact: **3.4** | LOC: 7
- `ComputeAttraction` (@ `src/main/cobol/ATTRACT.CBL`) -> Impact: **2.5** | LOC: 9
...
- **Heaviest Functions:** `PRINT-INVOICE-DETAILS` (Impact: 8.2), `INVALID-INVOICE-DATA` (Impact: 1.1)
...
- **Heaviest Functions:** `FILE-CONTROL` (Impact: 13.2)
...
- **Heaviest Functions:** `FILE-CONTROL` (Impact: 10.3)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 4.7), `Anonymous_Block` (Impact: 4.6), `Anonymous_Block` (Impact: 4.4)
...
- **Heaviest Functions:** `ComputeAttraction` (Impact: 2.5), `SolicitAttributesOfBody` (Impact: 2.2), `VerifyAttributesOfBody` (Impact: 1.4)
...
**Top Internal Functions/Classes:**
  * `PRINT-INVOICE-DETAILS` (Impact: 8.2)
