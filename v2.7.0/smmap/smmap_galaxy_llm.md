...
- `_obtain_region` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **55.2** | LOC: 98
...
- `use_region` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **19.8** | LOC: 39
...
- `_collect_lru_region` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **17.6** | LOC: 40
...
- `begin_access` (@ `smmap-5.0.3/smmap/buf.py`) -> Impact: **16.0** | LOC: 27
...
- `_obtain_region` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **15.1** | LOC: 37
...
- `__init__` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **12.8** | LOC: 32
...
- `__init__` (@ `smmap-5.0.3/smmap/util.py`) -> Impact: **11.7** | LOC: 38
...
- `force_map_handle_removal_win` (@ `smmap-5.0.3/smmap/mman.py`) -> Impact: **10.0** | LOC: 26
...
- **Heaviest Functions:** `__getslice__` (Impact: 19.6), `begin_access` (Impact: 16.0), `__getitem__` (Impact: 10.9)
...
- **Heaviest Functions:** `__init__` (Impact: 11.7), `increment_client_count` (Impact: 7.5), `file_size` (Impact: 6.2)
...
- **Heaviest Functions:** `_obtain_region` (Impact: 55.2), `use_region` (Impact: 19.8), `_collect_lru_region` (Impact: 17.6)
