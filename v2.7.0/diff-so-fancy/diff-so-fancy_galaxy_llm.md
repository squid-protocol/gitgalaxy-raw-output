...
- `do_dsf_stuff` (@ `diff-so-fancy`) -> Impact: **118.6** | LOC: 312
  * *Intent:* ################################################################################# ####################################################################...
- `highlight_pair` (@ `lib/DiffHighlight.pm`) -> Impact: **37.5** | LOC: 57
- `handle_line` (@ `lib/DiffHighlight.pm`) -> Impact: **31.0** | LOC: 54
- `git_ansi_color` (@ `test/git_ansi_color.pl`) -> Impact: **25.1** | LOC: 83
  * *Intent:* # https://www.git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_colors_in_git
- `color` (@ `diff-so-fancy`) -> Impact: **22.2** | LOC: 29
...
- `is_pair_interesting` (@ `lib/DiffHighlight.pm`) -> Impact: **17.1** | LOC: 24
...
- `git_ansi_color` (@ `diff-so-fancy`) -> Impact: **17.0** | LOC: 60
  * *Intent:* # https://www.git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_colors_in_git
- `set_ansi_color` (@ `diff-so-fancy`) -> Impact: **16.9** | LOC: 25
- `get_diff_chunks` (@ `diff-so-fancy`) -> Impact: **16.6** | LOC: 49
...
- **Heaviest Functions:** `highlight_pair` (Impact: 37.5), `handle_line` (Impact: 31.0), `is_pair_interesting` (Impact: 17.1)
...
- **Heaviest Functions:** `do_dsf_stuff` (Impact: 118.6), `color` (Impact: 22.2), `show_debug_info` (Impact: 19.6)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 2.5), `__global_context__` (Impact: 1.5), `setup_file` (Impact: 1.4)
...
- **Heaviest Functions:** `git_ansi_color` (Impact: 25.1), `color` (Impact: 12.4), `git_ansi_color2` (Impact: 12.2)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 1.6), `__global_context__` (Impact: 1.5), `Anonymous_Block` (Impact: 1.4)
...
- **Heaviest Functions:** `setup_dsf_git_config` (Impact: 4.7), `ansi_color` (Impact: 4.2), `rgb_color` (Impact: 2.2)
...
- **Heaviest Functions:** `setup_default_dsf_git_config` (Impact: 4.0), `teardown_default_dsf_git_config` (Impact: 3.3), `load_fixture` (Impact: 1.6)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 2.1), `__global_context__` (Impact: 1.4)
...
**Top Internal Functions/Classes:**
  * `do_dsf_stuff` (Impact: 118.6)
    * *Intent:* ################################################################################# ##################...
  * `color` (Impact: 22.2)
    * *Intent:* # Borrowed from: https://www.perturb.org/display/1167_Perl_ANSI_colors.html # String format: '115', ...
  * `show_debug_info` (Impact: 19.6)
  * `git_ansi_color` (Impact: 17.0)
    * *Intent:* # https://www.git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_colors_in_git
  * `set_ansi_color` (Impact: 16.9)
...
**Top Internal Functions/Classes:**
  * `Anonymous_Block` (Impact: 2.5)
    * *Intent:* # see https://git.io/vrOF4
  * `__global_context__` (Impact: 1.5)
  * `setup_file` (Impact: 1.4)
  * `Anonymous_Block` (Impact: 1.4)
  * `Anonymous_Block` (Impact: 1.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `setup_default_dsf_git_config` (Impact: 4.0)
    * *Intent:* # applying colors so ANSI color values will match # FIXME: not everyone will have these set, so we n...
  * `teardown_default_dsf_git_config` (Impact: 3.3)
  * `load_fixture` (Impact: 1.6)
  * `__global_context__` (Impact: 1.5)
  * `set_env` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
