...
| Avg Path Length | 2.2404 | Hops between files. Lower = Tighter coupling. |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 65.8 | 84.6 | 100.0 |
...
- `tokeniter` (@ `jinja2-3.1.6/src/jinja2/lexer.py`) -> Impact: **134.9** | LOC: 200
- `urlize` (@ `jinja2-3.1.6/src/jinja2/utils.py`) -> Impact: **108.9** | LOC: 121
- `visit_For` (@ `jinja2-3.1.6/src/jinja2/compiler.py`) -> Impact: **90.9** | LOC: 138
- `parse` (@ `jinja2-3.1.6/src/jinja2/ext.py`) -> Impact: **58.0** | LOC: 121
  * *Intent:* """Parse a translatable tag."""
- `visit_Template` (@ `jinja2-3.1.6/src/jinja2/compiler.py`) -> Impact: **56.0** | LOC: 121
  * *Intent:* # -- Statement Visitors
- `visit_Output` (@ `jinja2-3.1.6/src/jinja2/compiler.py`) -> Impact: **53.9** | LOC: 78
...
- `_filter_test_common` (@ `jinja2-3.1.6/src/jinja2/environment.py`) -> Impact: **50.6** | LOC: 53
- `test_error_messages` (@ `jinja2-3.1.6/tests/test_lexnparse.py`) -> Impact: **50.2** | LOC: 35
- `signature` (@ `jinja2-3.1.6/src/jinja2/compiler.py`) -> Impact: **45.3** | LOC: 56
- `do_filesizeformat` (@ `jinja2-3.1.6/src/jinja2/filters.py`) -> Impact: **43.1** | LOC: 31
...
### 1. `jinja2-3.1.6/src/jinja2/filters.py` (PYTHON) -> Cumulative Risk: **711.81**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1105.84 | **LOC:** 1874 | **CtrlFlow:** 18.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Safety Score (97.9139%), Concurrency (94.0641%)
- **Heaviest Functions:** `do_filesizeformat` (Impact: 43.1), `do_urlize` (Impact: 35.0), `do_indent` (Impact: 26.9)

### 2. `jinja2-3.1.6/src/jinja2/environment.py` (PYTHON) -> Cumulative Risk: **707.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 975.4 | **LOC:** 1673 | **CtrlFlow:** 13.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9984%), Concurrency (99.4279%), Safety Score (94.5621%)
- **Heaviest Functions:** `_filter_test_common` (Impact: 50.6), `overlay` (Impact: 42.7), `compile_templates` (Impact: 32.3)

### 3. `jinja2-3.1.6/src/jinja2/runtime.py` (PYTHON) -> Cumulative Risk: **703.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 787.24 | **LOC:** 1063 | **CtrlFlow:** 14.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Concurrency (99.9608%), Safety Score (98.3624%)
- **Heaviest Functions:** `__call__` (Impact: 37.8), `new_context` (Impact: 26.8), `call` (Impact: 22.4)

### 4. `jinja2-3.1.6/src/jinja2/async_utils.py` (PYTHON) -> Cumulative Risk: **681.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 88.26 | **LOC:** 100 | **CtrlFlow:** 17.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Safety Score (95.0914%)
- **Heaviest Functions:** `async_variant` (Impact: 10.6), `decorator` (Impact: 10.4), `wrapper` (Impact: 5.7)

### 5. `jinja2-3.1.6/src/jinja2/compiler.py` (PYTHON) -> Cumulative Risk: **678.18**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1747.9 | **LOC:** 1999 | **CtrlFlow:** 25.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9995%), Safety Score (90.5574%), Verification (80.0%)
- **Heaviest Functions:** `visit_For` (Impact: 90.9), `visit_Template` (Impact: 56.0), `visit_Output` (Impact: 53.9)

### 6. `jinja2-3.1.6/src/jinja2/parser.py` (PYTHON) -> Cumulative Risk: **645.46**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1244.84 | **LOC:** 1050 | **CtrlFlow:** 25.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.3957%), Documentation (84.4828%)
- **Heaviest Functions:** `_fail_ut_eof` (Impact: 33.3), `parse_tuple` (Impact: 32.5), `subparse` (Impact: 26.6)

### 7. `jinja2-3.1.6/src/jinja2/idtracking.py` (PYTHON) -> Cumulative Risk: **637.23**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 353.78 | **LOC:** 319 | **CtrlFlow:** 22.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.3605%), Documentation (84.6154%)
- **Heaviest Functions:** `visit_For` (Impact: 23.3), `visit_Name` (Impact: 11.7), `branch_update` (Impact: 11.5)

### 8. `jinja2-3.1.6/src/jinja2/ext.py` (PYTHON) -> Cumulative Risk: **635.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 648.06 | **LOC:** 871 | **CtrlFlow:** 19.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.134%), Documentation (88.6076%)
- **Heaviest Functions:** `parse` (Impact: 58.0), `_make_node` (Impact: 42.0), `_parse_block` (Impact: 28.3)

### 9. `jinja2-3.1.6/src/jinja2/nativetypes.py` (PYTHON) -> Cumulative Risk: **615.46**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 97.42 | **LOC:** 131 | **CtrlFlow:** 16.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9993%), Concurrency (99.9595%), Safety Score (97.9633%)
- **Heaviest Functions:** `native_concat` (Impact: 11.5), `_output_child_to_const` (Impact: 7.3), `render_async` (Impact: 6.7)

### 10. `jinja2-3.1.6/src/jinja2/utils.py` (PYTHON) -> Cumulative Risk: **599.08**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 549.44 | **LOC:** 767 | **CtrlFlow:** 22.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.2543%), Verification (80.0%)
- **Heaviest Functions:** `urlize` (Impact: 108.9), `generate_lorem_ipsum` (Impact: 29.5), `select_autoescape` (Impact: 16.1)
...
- **Magnitude:** 1747.9 | **LOC:** 1999 | **CtrlFlow:** 25.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (61.6935%), Tech Debt (15.1684%)
**Top Internal Functions/Classes:**
  * `visit_For` (Impact: 90.9)
  * `visit_Template` (Impact: 56.0)
    * *Intent:* # -- Statement Visitors
  * `visit_Output` (Impact: 53.9)
    * *Intent:* # If an extends is active, don't render outside a block. if frame.require_output_check: # A top-leve...
  * `signature` (Impact: 45.3)
  * `pop_assign_tracking` (Impact: 38.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.038988 | `Ripple Effect (Closeness):` 0.282353
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1244.84 | **LOC:** 1050 | **CtrlFlow:** 25.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (59.7517%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_fail_ut_eof` (Impact: 33.3)
  * `parse_tuple` (Impact: 32.5)
  * `subparse` (Impact: 26.6)
...
**Top Internal Functions/Classes:**
  * `do_filesizeformat` (Impact: 43.1)
    * *Intent:* """Format the value like a 'human-readable' file size (i.e. 13 kB, 4.1 MB, 102 Bytes, etc). Per defa...
  * `do_urlize` (Impact: 35.0)
  * `do_indent` (Impact: 26.9)
  * `sync_do_join` (Impact: 22.9)
  * `do_xmlattr` (Impact: 18.9)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 975.4 | **LOC:** 1673 | **CtrlFlow:** 13.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (29.7137%), Tech Debt (9.2475%)
**Top Internal Functions/Classes:**
  * `_filter_test_common` (Impact: 50.6)
  * `overlay` (Impact: 42.7)
  * `compile_templates` (Impact: 32.3)
  * `dump` (Impact: 26.5)
  * `_load_template` (Impact: 19.1)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.152341 | `Ripple Effect (Closeness):` 0.428571
...
- **Risk Profile:** Cognitive Load (21.5819%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_error_messages` (Impact: 50.2)
  * `test_tuple_expr` (Impact: 9.3)
  * `test_grouping` (Impact: 8.9)
  * `test_function_calls` (Impact: 8.1)
  * `test_lineno_with_strip` (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 787.24 | **LOC:** 1063 | **CtrlFlow:** 14.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.7346%), Tech Debt (10.9602%)
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 37.8)
    * *Intent:* # This requires a bit of explanation, In the past we used to # decide largely based on compile-time ...
  * `new_context` (Impact: 26.8)
  * `call` (Impact: 22.4)
  * `__init__` (Impact: 14.0)
...
- **Risk Profile:** Cognitive Load (33.4392%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_scoped_loop_var` (Impact: 9.2)
  * `test_recursive_loop_filter` (Impact: 6.4)
  * `test_nonrecursive_loop_filter` (Impact: 6.3)
  * `test_recursive_depth0` (Impact: 5.9)
  * `test_recursive_depth` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 648.06 | **LOC:** 871 | **CtrlFlow:** 19.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (63.3265%), Tech Debt (8.9416%)
**Top Internal Functions/Classes:**
  * `parse` (Impact: 58.0)
    * *Intent:* """Parse a translatable tag."""
  * `_make_node` (Impact: 42.0)
  * `_parse_block` (Impact: 28.3)
  * `_install_callables` (Impact: 14.4)
...
- **Risk Profile:** Cognitive Load (17.9705%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_filter_undefined_in_condexpr` (Impact: 12.6)
  * `test_filter_undefined_in_elif` (Impact: 9.1)
  * `test_filter_undefined_in_nested_if` (Impact: 9.1)
  * `test_filter_undefined_in_else` (Impact: 7.3)
  * `test_filter_undefined_in_if` (Impact: 7.2)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 549.44 | **LOC:** 767 | **CtrlFlow:** 22.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (48.0614%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `urlize` (Impact: 108.9)
  * `generate_lorem_ipsum` (Impact: 29.5)
  * `select_autoescape` (Impact: 16.1)
  * `url_quote` (Impact: 13.1)
    * *Intent:* """Quote a string for use in a URL using the given charset. :param obj: String or bytes to quote. Ot...
  * `import_string` (Impact: 9.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.040851 | `Ripple Effect (Closeness):` 0.4
...
- **Risk Profile:** Cognitive Load (45.5672%), Tech Debt (9.6612%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 32.2)
  * `get_source` (Impact: 15.7)
  * `load` (Impact: 15.5)
  * `list_templates` (Impact: 12.8)
  * `split_template_path` (Impact: 12.1)
...
- **Risk Profile:** Cognitive Load (19.4254%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_context_vars` (Impact: 17.4)
  * `test_elif_deep` (Impact: 10.7)
  * `test_scoped_loop_var` (Impact: 9.2)
  * `test_complete` (Impact: 8.9)
  * `test_namespace_loop` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (27.7133%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `interpolate` (Impact: 18.4)
  * `filter_stream` (Impact: 7.2)
  * `parse` (Impact: 5.9)
  * `test_basic_scope_behavior` (Impact: 5.7)
    * *Intent:* # This is what the old with statement compiled down to class ScopeExt(Extension): tags = {"scope"} d...
  * `npgettext` (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (17.8513%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_double_caller_no_default` (Impact: 13.1)
  * `test_empty_if_condition_fails` (Impact: 9.0)
  * `test_call_with_args` (Impact: 8.9)
  * `test_variable_reuse` (Impact: 7.4)
  * `test_nested_for_else` (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 353.78 | **LOC:** 319 | **CtrlFlow:** 22.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.658%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `visit_For` (Impact: 23.3)
  * `visit_Name` (Impact: 11.7)
...
- **Risk Profile:** Cognitive Load (37.869%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `visit_Const` (Impact: 6.3)
    * *Intent:* # This method is pure nonsense, but works fine for testing... if node.value == "foo": self.write(rep...
  * `test_autoescape_autoselect` (Impact: 6.0)
  * `test_find_undeclared_variables` (Impact: 6.0)
  * `test_finalize` (Impact: 5.9)
  * `test_custom_code_generator` (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (36.8692%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `compile_down` (Impact: 6.5)
  * `teardown_method` (Impact: 6.1)
  * `find_spec` (Impact: 5.0)
  * `test_pep_451_import_hook` (Impact: 3.5)
  * `test_error_includes_paths` (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (32.4952%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_custom_async_iteratable_filter` (Impact: 7.0)
  * `customfilter` (Impact: 4.6)
  * `test_groupby_case` (Impact: 4.5)
  * `closing` (Impact: 3.2)
  * `make_aiter` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (39.2665%), Tech Debt (11.6493%)
**Top Internal Functions/Classes:**
  * `_get_default_cache_dir` (Impact: 17.9)
  * `dump_bytecode` (Impact: 7.5)
  * `load_bytecode` (Impact: 6.1)
    * *Intent:* """Loads bytecode from a file or file like object."""
  * `load_bytecode` (Impact: 5.6)
  * `get_cache_key` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (11.8105%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_invalid_required` (Impact: 12.0)
  * `test_duplicate_required_or_scoped` (Impact: 9.7)
  * `test_required_with_scope` (Impact: 6.3)
  * `test_multi_inheritance` (Impact: 6.1)
  * `test_level3_required` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (52.4297%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `fake_traceback` (Impact: 21.5)
  * `rewrite_traceback_stack` (Impact: 17.1)
    * *Intent:* """Rewrite the current exception to replace any tracebacks from within compiled template code with t...
  * `get_template_locals` (Impact: 16.2)
...
- **Risk Profile:** Cognitive Load (31.9546%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_top_level_set_vars_unpacking_deterministic` (Impact: 6.8)
  * `test_loop_set_vars_unpacking_deterministic` (Impact: 6.5)
  * `test_filters_deterministic` (Impact: 6.2)
  * `test_block_set_vars_unpacking_deterministic` (Impact: 5.0)
  * `test_import_as_with_context_deterministic` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (33.878%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_restricted` (Impact: 5.8)
  * `test_binary_operator_intercepting` (Impact: 4.1)
  * `test_unary_operator_intercepting` (Impact: 4.1)
  * `test_unsafe` (Impact: 2.7)
  * `test_template_data` (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
...
- `jinja2-3.1.6/src/jinja2/environment.py` -> **Severity: 15.234** (Bridge: 0.1523 * Flux: 99.9984%)
- `jinja2-3.1.6/src/jinja2/runtime.py` -> **Severity: 4.231** (Bridge: 0.0423 * Flux: 100.0%)
- `jinja2-3.1.6/src/jinja2/utils.py` -> **Severity: 4.085** (Bridge: 0.0409 * Flux: 100.0%)
- `jinja2-3.1.6/src/jinja2/compiler.py` -> **Severity: 3.899** (Bridge: 0.039 * Flux: 99.9995%)
