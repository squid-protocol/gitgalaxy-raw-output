...
- `executeFlush` (@ `package/index.js`) -> Impact: **29.5** | LOC: 110
...
- `run` (@ `package/cli.js`) -> Impact: **21.0** | LOC: 73
- `constructor` (@ `package/index.d.ts`) -> Impact: **18.8** | LOC: 15
...
- `constructor` (@ `package/index.js`) -> Impact: **13.2** | LOC: 24
  * *Intent:* /** * Initialize a new `Analytics` instance with your RudderStack project's `writeKey` and an * optional dictionary of options. */
- `done` (@ `package/index.js`) -> Impact: **12.8** | LOC: 59
...
- `toObject` (@ `package/cli.js`) -> Impact: **8.1** | LOC: 49
- `validate` (@ `package/index.js`) -> Impact: **5.8** | LOC: 12
- `group` (@ `package/index.d.ts`) -> Impact: **5.5** | LOC: 6
  * *Intent:* /** * Sends a "group" message that identifies this user with a group. */
- `alias` (@ `package/index.d.ts`) -> Impact: **5.5** | LOC: 6
...
- **Heaviest Functions:** `executeFlush` (Impact: 29.5), `constructor` (Impact: 13.2), `done` (Impact: 12.8)
...
- **Heaviest Functions:** `run` (Impact: 21.0), `toObject` (Impact: 8.1)
...
- **Heaviest Functions:** `constructor` (Impact: 18.8), `group` (Impact: 5.5), `alias` (Impact: 5.5)
