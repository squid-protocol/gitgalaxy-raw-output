...
| Avg Path Length | 2.7168 | Hops between files. Lower = Tighter coupling. |
...
- `P_UseSpecialLine` (@ `doomgeneric/p_switch.c`) -> Impact: **262.9** | LOC: 379
  * *Intent:* // // P_UseSpecialLine // Called when a thing uses a special line. // Only the front sides of lines are usable. //
- `M_Responder` (@ `doomgeneric/m_menu.c`) -> Impact: **216.2** | LOC: 477
  * *Intent:* // // CONTROL PANEL // // // M_Responder //
- `P_TouchSpecialThing` (@ `doomgeneric/p_inter.c`) -> Impact: **180.9** | LOC: 328
  * *Intent:* // // P_TouchSpecialThing //
- `G_BuildTiccmd` (@ `doomgeneric/g_game.c`) -> Impact: **145.4** | LOC: 276
...
- `R_StoreWallRange` (@ `doomgeneric/r_segs.c`) -> Impact: **138.1** | LOC: 372
  * *Intent:* // // R_StoreWallRange // A wall segment will be drawn // between start and stop pixels (inclusive). //
- `DG_GetKey` (@ `doomgeneric/doomgeneric_allegro.c`) -> Impact: **123.9** | LOC: 261
- `convertToDoomKey` (@ `doomgeneric/doomgeneric_linuxvt.c`) -> Impact: **123.6** | LOC: 153
- `ST_Responder` (@ `doomgeneric/st_stuff.c`) -> Impact: **108.8** | LOC: 224
  * *Intent:* // Respond to keyboard input events, // intercept cheats.
- `D_DoomMain` (@ `doomgeneric/d_main.c`) -> Impact: **100.1** | LOC: 682
  * *Intent:* #endif // // D_DoomMain //
- `AM_Responder` (@ `doomgeneric/am_map.c`) -> Impact: **94.8** | LOC: 143
...
- **Heaviest Functions:** `P_UnArchiveSpecials` (Impact: 18.9), `P_ArchiveSpecials` (Impact: 17.2), `saveg_read_player_t` (Impact: 16.3)
...
- **Heaviest Functions:** `cmap_to_fb` (Impact: 18.4), `I_InitGraphics` (Impact: 15.6), `I_FinishUpdate` (Impact: 10.5)
...
- **Heaviest Functions:** `DG_GetKey` (Impact: 123.9), `DG_DrawFrame` (Impact: 13.6), `DG_Init` (Impact: 4.6)
...
- **Heaviest Functions:** `P_CheckAmmo` (Impact: 52.1), `A_WeaponReady` (Impact: 23.5), `P_SetPsprite` (Impact: 16.2)
...
- **Heaviest Functions:** `convertToDoomKey` (Impact: 123.6), `addKeyToQueue` (Impact: 14.8), `isKeyboard` (Impact: 11.7)
...
- **Heaviest Functions:** `P_NewChaseDir` (Impact: 54.4), `A_Chase` (Impact: 50.5), `A_BossDeath` (Impact: 43.1)
...
- **Heaviest Functions:** `convertToDoomKey` (Impact: 45.0), `handleKeyInput` (Impact: 7.0), `DG_GetKey` (Impact: 6.1)
...
- **Heaviest Functions:** `convertToDoomKey` (Impact: 45.1), `handleKeyInput` (Impact: 7.1), `DG_GetKey` (Impact: 6.2)
...
- **Heaviest Functions:** `Z_Malloc` (Impact: 35.4), `Z_DumpHeap` (Impact: 17.3), `Z_Free` (Impact: 13.7)
...
**Top Internal Functions/Classes:**
  * `M_Responder` (Impact: 216.2)
    * *Intent:* // // CONTROL PANEL // // // M_Responder //
  * `M_DrawReadThis1` (Impact: 17.6)
...
**Top Internal Functions/Classes:**
  * `WI_updateNetgameStats` (Impact: 52.6)
  * `WI_loadUnloadData` (Impact: 40.0)
    * *Intent:* // Common load/unload function. Iterates over all the graphics // lumps to be loaded/unloaded into m...
  * `WI_updateDeathmatchStats` (Impact: 34.0)
  * `WI_updateStats` (Impact: 33.2)
  * `WI_drawOnLnode` (Impact: 24.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 224 instances
...
**Top Internal Functions/Classes:**
  * `P_UnArchiveSpecials` (Impact: 18.9)
    * *Intent:* // // P_UnArchiveSpecials //
  * `P_ArchiveSpecials` (Impact: 17.2)
    * *Intent:* // // Things to handle: // // T_MoveCeiling, (ceiling_t: sector_t * swizzle), - active list // T_Ver...
  * `saveg_read_player_t` (Impact: 16.3)
    * *Intent:* // // player_t //
  * `saveg_write_player_t` (Impact: 16.3)
  * `P_UnArchiveThinkers` (Impact: 11.7)
...
**Top Internal Functions/Classes:**
  * `D_DoomMain` (Impact: 100.1)
    * *Intent:* #endif // // D_DoomMain //
  * `D_Display` (Impact: 52.0)
  * `InitGameVersion` (Impact: 30.1)
    * *Intent:* // Initialize the game version
  * `D_DoAdvanceDemo` (Impact: 27.1)
    * *Intent:* // // This cycles through the demo sequences. // FIXME - version dependend demo numbers? //
  * `D_SetGameDescription` (Impact: 21.9)
...
**Top Internal Functions/Classes:**
  * `ST_Responder` (Impact: 108.8)
    * *Intent:* // Respond to keyboard input events, // intercept cheats.
  * `ST_updateFaceWidget` (Impact: 42.5)
    * *Intent:* // // This is a not-very-pretty routine which handles // the face states and their timing. // the pr...
  * `ST_doPaletteStuff` (Impact: 19.2)
  * `ST_updateWidgets` (Impact: 15.2)
  * `ST_loadUnloadGraphics` (Impact: 12.5)
...
**Top Internal Functions/Classes:**
  * `R_StoreWallRange` (Impact: 138.1)
    * *Intent:* // // R_StoreWallRange // A wall segment will be drawn // between start and stop pixels (inclusive)....
  * `R_RenderMaskedSegRange` (Impact: 38.5)
    * *Intent:* // // R_RenderMaskedSegRange //
  * `R_RenderSegLoop` (Impact: 36.1)
...
**Top Internal Functions/Classes:**
  * `F_CastTicker` (Impact: 52.0)
    * *Intent:* // // F_CastTicker //
  * `F_Ticker` (Impact: 15.2)
    * *Intent:* // // F_Ticker //
  * `F_CastPrint` (Impact: 15.2)
  * `F_TextWrite` (Impact: 14.3)
  * `F_BunnyScroll` (Impact: 12.7)
