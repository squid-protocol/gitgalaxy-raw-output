...
- `run` (@ `src/gui.rs`) -> Impact: **55.6** | LOC: 108
- `run` (@ `src/mapper.rs`) -> Impact: **50.9** | LOC: 83
- `run` (@ `src/controller.rs`) -> Impact: **24.4** | LOC: 37
- `draw_frame` (@ `src/doom.rs`) -> Impact: **12.9** | LOC: 34
- `main` (@ `src/main.rs`) -> Impact: **7.9** | LOC: 58
- `convert_key` (@ `src/controller.rs`) -> Impact: **6.6** | LOC: 19
- `gamepad_button_to_action` (@ `src/mapper.rs`) -> Impact: **6.5** | LOC: 16
- `run` (@ `src/updater.rs`) -> Impact: **5.6** | LOC: 8
- `convert_key` (@ `src/gui.rs`) -> Impact: **4.3** | LOC: 42
- `convert_gamepad_button` (@ `src/controller.rs`) -> Impact: **3.7** | LOC: 18
...
- **Heaviest Functions:** `run` (Impact: 50.9), `gamepad_button_to_action` (Impact: 6.5), `key_to_action` (Impact: 3.7)
...
- **Heaviest Functions:** `draw_frame` (Impact: 12.9), `convert_action` (Impact: 3.6), `get_key` (Impact: 3.4)
...
- **Heaviest Functions:** `run` (Impact: 55.6), `convert_key` (Impact: 4.3), `convert_mouse_button` (Impact: 3.2)
...
- **Heaviest Functions:** `run` (Impact: 24.4), `convert_key` (Impact: 6.6), `convert_gamepad_button` (Impact: 3.7)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 2.2)
...
**Top Internal Functions/Classes:**
  * `run` (Impact: 50.9)
  * `gamepad_button_to_action` (Impact: 6.5)
  * `key_to_action` (Impact: 3.7)
  * `movement_dir_to_action` (Impact: 3.2)
  * `camera_dir_to_action` (Impact: 3.2)
...
**Top Internal Functions/Classes:**
  * `run` (Impact: 55.6)
  * `convert_key` (Impact: 4.3)
  * `convert_mouse_button` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `run` (Impact: 24.4)
  * `convert_key` (Impact: 6.6)
  * `convert_gamepad_button` (Impact: 3.7)
  * `convert_mouse_button` (Impact: 3.2)
  * `convert_gamepad_axis2d` (Impact: 3.2)
**Structural Signatures (Net Mitigated Signals):**
