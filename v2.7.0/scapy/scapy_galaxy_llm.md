...
| Avg Path Length | 2.2212 | Hops between files. Lower = Tighter coupling. |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 2.4 | 0.2 | 0.0 | 0.0 |
...
- `p0f_impersonate` (@ `scapy/modules/p0f.py`) -> Impact: **287.4** | LOC: 204
- `_run` (@ `scapy/sendrecv.py`) -> Impact: **287.2** | LOC: 219
- `__init__` (@ `scapy/layers/kerberos.py`) -> Impact: **278.6** | LOC: 208
- `p0f_impersonate` (@ `scapy/modules/p0fv2.py`) -> Impact: **276.1** | LOC: 204
- `bind` (@ `scapy/layers/ldap.py`) -> Impact: **200.7** | LOC: 281
- `tcpdump` (@ `scapy/utils.py`) -> Impact: **181.8** | LOC: 269
- `from_cli_arguments` (@ `scapy/layers/spnego.py`) -> Impact: **179.5** | LOC: 182
- `parse_options` (@ `scapy/layers/dns.py`) -> Impact: **179.0** | LOC: 138
- `__init__` (@ `scapy/sendrecv.py`) -> Impact: **150.9** | LOC: 133
- `_bind` (@ `scapy/layers/msrpce/rpcclient.py`) -> Impact: **150.0** | LOC: 207
...
- **Heaviest Functions:** `answers` (Impact: 59.9), `NDP_Attack_NA_Spoofing` (Impact: 50.9), `NDP_Attack_Kill_Default_Router` (Impact: 47.6)
...
- **Heaviest Functions:** `in_pkt` (Impact: 82.3), `out_pkt` (Impact: 38.2), `_up_pkt` (Impact: 36.7)
...
- **Heaviest Functions:** `__setattr__` (Impact: 68.0), `__setattr__` (Impact: 35.9), `__new__` (Impact: 23.8)
...
- **Heaviest Functions:** `getfield` (Impact: 51.1), `__init__` (Impact: 37.3), `_build_config_representation` (Impact: 33.3)
...
- **Heaviest Functions:** `set_endianness` (Impact: 20.0), `set_endianness` (Impact: 5.4), `e_flags` (Impact: 4.5)
...
- **Heaviest Functions:** `__init__` (Impact: 37.5), `__init__` (Impact: 33.7), `__init__` (Impact: 29.7)
...
- **Heaviest Functions:** `parse_options` (Impact: 179.0), `make_reply` (Impact: 121.8), `dns_resolve` (Impact: 69.9)
...
- **Heaviest Functions:** `verify` (Impact: 45.5), `fill_and_store` (Impact: 43.0), `sign` (Impact: 36.5)
...
- **Heaviest Functions:** `make_graph` (Impact: 115.1), `trace3D_notebook` (Impact: 53.9), `traceroute` (Impact: 44.8)
...
- **Heaviest Functions:** `build` (Impact: 30.9), `tls_session_update` (Impact: 30.7), `post_dissection` (Impact: 25.6)
...
**Top Internal Functions/Classes:**
  * `tcpdump` (Impact: 181.8)
  * `hexdiff` (Impact: 112.1)
  * `AutoArgparse` (Impact: 78.6)
  * `do_graph` (Impact: 72.1)
  * `pretty_list` (Impact: 57.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.063743 | `Ripple Effect (Closeness):` 0.440086
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 278.6)
  * `GSS_Init_sec_context` (Impact: 118.1)
  * `kpasswd` (Impact: 109.5)
  * `GSS_Accept_sec_context` (Impact: 106.8)
  * `GSS_WrapEx` (Impact: 100.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.012982 | `Ripple Effect (Closeness):` 0.153191
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.024948 | `Ripple Effect (Closeness):` 0.495995
...
**Top Internal Functions/Classes:**
  * `answers` (Impact: 59.9)
  * `NDP_Attack_NA_Spoofing` (Impact: 50.9)
  * `NDP_Attack_Kill_Default_Router` (Impact: 47.6)
  * `in6_pseudoheader` (Impact: 40.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.005001 | `Ripple Effect (Closeness):` 0.291357
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.024665 | `Ripple Effect (Closeness):` 0.59671
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.055588 | `Ripple Effect (Closeness):` 0.323042
...
**Top Internal Functions/Classes:**
  ...
  * `addfield` (Impact: 26.1)
  * `tcp_reassemble` (Impact: 20.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.004055 | `Ripple Effect (Closeness):` 0.130388
...
**Top Internal Functions/Classes:**
  * `build` (Impact: 30.9)
  * `tls_session_update` (Impact: 30.7)
    * *Intent:* """ Either for parsing or building, we store the server_random along with the raw string representin...
  * `post_dissection` (Impact: 25.6)
  * `tls_session_update` (Impact: 23.6)
    * *Intent:* """ Either for parsing or building, we store the server_random along with the raw string representin...
  * `post_build` (Impact: 23.1)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.011465 | `Ripple Effect (Closeness):` 0.169959
...
**Top Internal Functions/Classes:**
  * `_run` (Impact: 287.2)
  * `__init__` (Impact: 150.9)
  * `__sr_loop` (Impact: 90.1)
    * *Intent:* # SEND/RECV LOOP METHODS
  * `__gen_send` (Impact: 62.8)
  * `bridge_and_sniff` (Impact: 61.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001542 | `Ripple Effect (Closeness):` 0.336983
...
**Top Internal Functions/Classes:**
  * `_build_ticket` (Impact: 91.9)
  * `add_cred` (Impact: 68.3)
  * `edit_ticket` (Impact: 60.0)
    * *Intent:* """ Edit a Kerberos ticket using the GUI """
  * `import_krb` (Impact: 52.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000354 | `Ripple Effect (Closeness):` 0.1134
...
**Top Internal Functions/Classes:**
  * `bind` (Impact: 200.7)
  * `search` (Impact: 89.5)
  * `dclocator` (Impact: 87.3)
  * `from_rfc2254_string` (Impact: 79.0)
...
**Top Internal Functions/Classes:**
  * `verify` (Impact: 45.5)
  * `fill_and_store` (Impact: 43.0)
  * `sign` (Impact: 36.5)
  * `fill_and_store` (Impact: 28.4)
  * `import_from_asn1pkt` (Impact: 23.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001039 | `Ripple Effect (Closeness):` 0.16705
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000347 | `Ripple Effect (Closeness):` 0.111548
...
- `scapy/utils.py` -> **Severity: 6.374** (Bridge: 0.0637 * Flux: 100.0%)
- `scapy/layers/inet.py` -> **Severity: 5.559** (Bridge: 0.0556 * Flux: 100.0%)
- `scapy/config.py` -> **Severity: 5.166** (Bridge: 0.0517 * Flux: 100.0%)
- `scapy/layers/tls/session.py` -> **Severity: 5.051** (Bridge: 0.0505 * Flux: 100.0%)
- `scapy/layers/http.py` -> **Severity: 4.59** (Bridge: 0.0459 * Flux: 100.0%)
