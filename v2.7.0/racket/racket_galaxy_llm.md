...
| Analyzed Artifacts (Scanned) | 4208 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 1620 |
| Total LOC | 931847 |
...
|---|---|---|
| Modularity | 0.8993 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| Avg Path Length | 9.1825 | Hops between files. Lower = Tighter coupling. |
| Articulation Pts | 218 | Number of single files that, if removed, shatter the network. |

## 4. COMPOSITION
| Lang | Files | LOC | Share |
|---|---|---|---|
| SCHEME | 2771 | 540391 | 65.9% |
| C | 717 | 318770 | 17.0% |
| MAKEFILE | 188 | 19512 | 4.5% |
| PLAINTEXT | 141 | 1 | 3.4% |
| M4 | 80 | 17102 | 1.9% |
...
- `.rkt`: 146x Excluded: Neighborhood Micro-Mass Limit Exceeded, 6x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 5x Unsupported Format (.undeterminable)
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 3.7 | 0.0 | 0.0 |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 74.5 | 1.3 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 56.8 | 96.6 | 100.0 |
...
|---|---|---|---|---|
| memory | 111324 | 1319 | 20 | `racket/src/bc/src/optimize.c` |
| cleanup | 1641 | 351 | 0 | `racket/src/zuo/zuo.c` |
| guards | 20265 | 1080 | 6 | `racket/src/zuo/zuo.c` |
| danger | 14753 | 1349 | 5 | `racket/src/bc/src/optimize.c` |
| concurrency | 409 | 130 | 0 | `pkgs/racket-test/tests/future/future.rkt` |
| connectivity | 13805 | 1005 | 4 | `racket/src/bc/src/schpriv.h` |
| io | 7481 | 967 | 3 | `racket/src/bc/foreign/foreign.rktc` |
| crypto | 2 | 2 | 0 | `racket/src/ChezScheme/lz4/tests/test-lz4-speed.py` |
| ipc | 419 | 56 | 0 | `racket/src/bc/src/portfun.c` |
| time | 135 | 30 | 0 | `racket/src/ChezScheme/c/stats.c` |
| serialization | 33 | 12 | 0 | `racket/src/bc/foreign/libffi/man/Makefile.in` |
| regex | 240 | 37 | 0 | `racket/src/ChezScheme/configure` |
...
| debt | 5335 | 918 | 2 | `racket/src/bc/foreign/libffi/testsuite/libffi.bhaible/test-callback.c` |
| mutation | 127772 | 1629 | 32 | `racket/src/bc/src/fun.c` |
| dead_code | 4515 | 1000 | 2 | `racket/src/ChezScheme/mats/foreign2.c` |
| credential | 19 | 13 | 0 | `pkgs/net-test/tests/net/base64.rkt` |
| threat | 14117 | 885 | 4 | `racket/src/bc/src/lightning/arm/asm.h` |
| ml_ai | 2202 | 283 | 0 | `racket/src/ChezScheme/zlib/examples/gzlog.c` |
...
- `scheme_generate_arith_for` (@ `racket/src/bc/src/jitarith.c`) -> Impact: **1666.2** | LOC: 1003
- `print` (@ `racket/src/bc/src/print.c`) -> Impact: **1616.3** | LOC: 1582
- `scheme_generate_inlined_nary` (@ `racket/src/bc/src/jitinline.c`) -> Impact: **1542.6** | LOC: 1212
- `scheme_generate_inlined_binary` (@ `racket/src/bc/src/jitinline.c`) -> Impact: **1510.5** | LOC: 1230
- `scheme_generate_inlined_unary` (@ `racket/src/bc/src/jitinline.c`) -> Impact: **1443.0** | LOC: 1321
- `scheme_read_number` (@ `racket/src/bc/src/numstr.c`) -> Impact: **1436.9** | LOC: 1143
  * *Intent:* */
- `install-packages` (@ `racket/collects/pkg/private/install.rkt`) -> Impact: **1276.0** | LOC: 1110
- `validate_expr` (@ `racket/src/bc/src/validate.c`) -> Impact: **1020.1** | LOC: 796
...
- `get-ffi-lib` (@ `racket/collects/ffi/unsafe.rkt`) -> Impact: **908.1** | LOC: 1430
- `scheme_generate` (@ `racket/src/bc/src/jit.c`) -> Impact: **875.0** | LOC: 1481

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `racket/src/bc/src` | 153 | 196090.83 | 45.32% | 11.84% |
| `racket/src/ChezScheme/s` | 121 | 40334.04 | 10.19% | 4.21% |
| `racket/src/ChezScheme/c` | 55 | 28475.54 | 54.56% | 26.27% |
...
| `racket/collects/racket/private` | 113 | 11070.22 | 11.03% | 3.73% |
| `racket/src/cs/rumble` | 66 | 10327.52 | 11.41% | 32.63% |
| `racket/collects/racket` | 103 | 9121.51 | 9.43% | 1.9% |
...
- **Unknown Dependencies:** `3508` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `racket/src/bc/src/mzrt.c` (C) -> Cumulative Risk: **702.03**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 604.04 | **LOC:** 754 | **CtrlFlow:** 12.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Safety Score (92.9855%)
- **Heaviest Functions:** `rwlock_wrlock` (Impact: 14.9), `rwlock_rdlock` (Impact: 14.8), `mzrt_rwlock_wrlock_worker` (Impact: 14.8)

### 2. `racket/src/bc/src/rational.c` (C) -> Cumulative Risk: **684.01**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 488.82 | **LOC:** 586 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9998%), Cognitive Load (98.4034%)
- **Heaviest Functions:** `scheme_rational_divide` (Impact: 36.8), `scheme_rational_eq` (Impact: 30.7), `scheme_rational_round` (Impact: 27.6)

### 3. `racket/src/ChezScheme/c/schlib.c` (C) -> Cumulative Risk: **680.5**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 228.98 | **LOC:** 322 | **CtrlFlow:** 16.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9983%), Tech Debt (99.9841%)
- **Heaviest Functions:** `S_call_help` (Impact: 39.6), `Ssymbol_to_string` (Impact: 7.6), `S_put_arg` (Impact: 6.3)

### 4. `racket/src/ChezScheme/zlib/contrib/iostream/zfstream.cpp` (CPP) -> Cumulative Risk: **679.45**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2.05 | **LOC:** 330 | **CtrlFlow:** 20.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9998%), Cognitive Load (99.8647%)
- **Heaviest Functions:** `gzfilebuf::open` (Impact: 17.6), `gzfilebuf::attach` (Impact: 17.6), `gzfilebuf::overflow` (Impact: 15.7)

### 5. `racket/src/rktio/rktio_file.c` (C) -> Cumulative Risk: **678.94**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 683.04 | **LOC:** 719 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9991%), Concurrency (97.111%), Safety Score (89.289%)
- **Heaviest Functions:** `open_write` (Impact: 107.1), `finish_unix_fd_creation` (Impact: 76.6), `open_read` (Impact: 58.2)

### 6. `pkgs/racket-index/scribblings/main/private/search.js` (JAVASCRIPT) -> Cumulative Risk: **673.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1314.62 | **LOC:** 1214 | **CtrlFlow:** 30.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `SanitizeHTML` (Impact: 406.3), `UpdateResults` (Impact: 131.3), `Search` (Impact: 67.8)

### 7. `racket/src/ChezScheme/c/schsig.c` (C) -> Cumulative Risk: **672.76**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 639.16 | **LOC:** 945 | **CtrlFlow:** 15.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (94.8954%)
- **Heaviest Functions:** `handle_signal` (Impact: 30.6), `do_error` (Impact: 26.4), `S_overflow` (Impact: 23.2)

### 8. `racket/src/ChezScheme/zlib/zutil.c` (C) -> Cumulative Risk: **671.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `zlibCompileFlags` (Impact: 30.1), `zcalloc` (Impact: 13.2), `zcfree` (Impact: 9.8)

### 9. `racket/src/ChezScheme/mats/foreign2.c` (C) -> Cumulative Risk: **667.76**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 556.1 | **LOC:** 586 | **CtrlFlow:** 6.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9952%)
- **Heaviest Functions:** `check_types` (Impact: 67.2), `ppcfltest2` (Impact: 5.2), `ppcfltest` (Impact: 4.6)

### 10. `racket/src/rktio/rktio_convert.c` (C) -> Cumulative Risk: **665.55**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 720.58 | **LOC:** 799 | **CtrlFlow:** 20.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.8688%), Cognitive Load (92.4069%)
- **Heaviest Functions:** `rktio_locale_recase` (Impact: 40.0), `init_iconv` (Impact: 34.0), `rktio_system_language_country` (Impact: 32.3)
...
- **Risk Profile:** Cognitive Load (95.2631%), Tech Debt (9.0712%)
**Top Internal Functions/Classes:**
  * `optimize_lets` (Impact: 542.9)
  * `scheme_optimize_linklet` (Impact: 423.4)
  * `scheme_omittable_expr` (Impact: 356.8)
  * `finish_optimize_application3` (Impact: 343.9)
  * `scheme_is_simple_make_struct_type` (Impact: 309.8)
...
- **Risk Profile:** Cognitive Load (93.6549%), Tech Debt (20.1347%)
**Top Internal Functions/Classes:**
  * `restore_continuation` (Impact: 331.6)
  * `get_or_check_arity` (Impact: 324.9)
  * `continuation_marks` (Impact: 291.0)
  * `scheme_apply_chaperone` (Impact: 270.5)
    * *Intent:* /* must be at least 3: */ #define MAX_QUICK_CHAP_ARGV 5 #define CHAPERONE_KIND_STR(px) (!(SCHEME_CHA...
  * `grab_continuation` (Impact: 183.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (15.6771%), Tech Debt (9.894%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (95.3297%), Tech Debt (10.0852%)
**Top Internal Functions/Classes:**
  * `translate` (Impact: 573.8)
  * `regexec` (Impact: 432.0)
    * *Intent:* */
  * `regmatch` (Impact: 430.9)
    * *Intent:* * * Conceptually the strategy is simple: check to see whether the current * node matches, call self ...
  * `gen_compare` (Impact: 399.2)
  * `regatom` (Impact: 363.5)
...
- **Risk Profile:** Cognitive Load (91.481%), Tech Debt (24.7828%)
**Top Internal Functions/Classes:**
  * `scheme_thread_block` (Impact: 135.9)
  * `do_sync` (Impact: 120.3)
  * `check_sleep` (Impact: 88.4)
  * `current_stats` (Impact: 84.8)
  * `set_sync_target` (Impact: 82.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
- **Risk Profile:** Cognitive Load (94.034%), Tech Debt (8.384%)
**Top Internal Functions/Classes:**
  * `scheme_generate_inlined_nary` (Impact: 1542.6)
  * `scheme_generate_inlined_binary` (Impact: 1510.5)
  * `scheme_generate_inlined_unary` (Impact: 1443.0)
  * `generate_vector_op` (Impact: 386.9)
  * `generate_inlined_struct_op` (Impact: 255.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (94.6919%), Tech Debt (15.2916%)
**Top Internal Functions/Classes:**
  * `zuo_in` (Impact: 361.1)
  * `zuo_out` (Impact: 227.2)
  * `zuo_process` (Impact: 170.5)
  * `zuo_main` (Impact: 110.8)
    * *Intent:* /*======================================================================*/ /* main */ /*============...
  * `zuo_fd_open_output` (Impact: 69.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (91.7873%), Tech Debt (14.9494%)
**Top Internal Functions/Classes:**
  * `_make_struct_type` (Impact: 338.2)
  * `do_chaperone_struct` (Impact: 253.6)
    * *Intent:* /**********************************************************************/
  * `make_struct_type` (Impact: 158.5)
  * `scheme_init_struct` (Impact: 112.0)
  * `make_struct_type_property_from_c` (Impact: 108.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (91.5372%), Tech Debt (42.1096%)
**Top Internal Functions/Classes:**
  * `scheme_get_byte_string_unless` (Impact: 490.9)
  * `do_file_position` (Impact: 206.0)
  * `scheme_do_open_output_file` (Impact: 170.1)
  * `subprocess` (Impact: 168.8)
  * `scheme_peeked_read_via_get` (Impact: 99.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (88.6063%), Tech Debt (16.9415%)
**Top Internal Functions/Classes:**
  * `utf8_decode_x` (Impact: 513.8)
    * *Intent:* /**********************************************************************/ /* utf8 converter */ /*****...
  * `scheme_do_format` (Impact: 367.6)
    * *Intent:* /********************************************************************/ /* format */ /***************...
  * `do_convert` (Impact: 266.8)
  * `utf8_encode_x` (Impact: 222.8)
  * `convert_one` (Impact: 175.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (91.6196%), Tech Debt (36.7931%)
**Top Internal Functions/Classes:**
  * `sch_vsprintf` (Impact: 393.7)
    * *Intent:* */
  * `make_arity_expect_string` (Impact: 190.6)
  * `apply_one_adjuster` (Impact: 118.7)
    * *Intent:* #define adjust_CONTRACT_MODE 0 #define adjust_MESSAGE_MODE 1 #define adjust_NAME_MODE 2
  * `scheme_log_name_pfx_message` (Impact: 102.2)
  * `do_wrong_syntax` (Impact: 94.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (93.7738%), Tech Debt (14.2811%)
**Top Internal Functions/Classes:**
  * `do_simplify_path` (Impact: 385.1)
  * `do_build_path` (Impact: 381.6)
    * *Intent:* #define PATH_EXTRA_SPACE 4
  * `do_split_path` (Impact: 361.9)
  * `do_expand_filename` (Impact: 219.2)
  * `check_dos_slashslash_qm` (Impact: 190.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 9 instances
...
- **Risk Profile:** Cognitive Load (85.0976%), Tech Debt (7.8722%)
**Top Internal Functions/Classes:**
  * `garbage_collect` (Impact: 335.1)
    * *Intent:* /*****************************************************************************/ /* Garbage collectio...
  * `GC_dump_with_traces` (Impact: 239.2)
    * *Intent:* #define SUMMARY_SUFFIX "/BT" #define BT_ALLOC_COUNTS alloc_counts #else #define SUMMARY_SUFFIX "" #d...
  * `repair_heap` (Impact: 166.9)
  * `GC_mark2` (Impact: 134.5)
    * *Intent:* /* This is the first mark routine. It's a bit complicated. */
  * `mark_backpointers` (Impact: 62.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.35
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Risk Profile:** Cognitive Load (96.621%), Tech Debt (14.2177%)
**Top Internal Functions/Classes:**
  * `print` (Impact: 1616.3)
  * `check_cycles` (Impact: 223.5)
    * *Intent:* #endif #define CHECK_CHECK_HAS_UNQUOTE 0x1 #define CHECK_CHECK_HAS_CYCLE 0x2
  * `print_pair` (Impact: 199.9)
  * `print_to_string` (Impact: 135.8)
  * `setup_graph_table` (Impact: 134.4)
    * *Intent:* #endif
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (6.6571%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (72.6126%), Tech Debt (13.689%)
**Top Internal Functions/Classes:**
  * `mpn_tdiv_qr` (Impact: 168.2)
  * `mpn_kara_mul_n` (Impact: 126.1)
    * *Intent:* /*-- mpn_kara_mul_n ---------------------------------------------------------------*/ /* Multiplies ...
  * `mpn_gcd` (Impact: 125.6)
    * *Intent:* #endif
  * `mpn_kara_sqr_n` (Impact: 116.0)
  * `mpn_set_str` (Impact: 104.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (92.1755%), Tech Debt (10.6701%)
**Top Internal Functions/Classes:**
  * `resolve_lambda` (Impact: 336.6)
  * `compute_possible_lifts` (Impact: 186.1)
  * `unresolve_expr` (Impact: 175.8)
  * `scheme_resolve_lets` (Impact: 160.4)
  * `maybe_unresolve_app_refs` (Impact: 95.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (91.4931%), Tech Debt (28.6212%)
**Top Internal Functions/Classes:**
  * `scheme_expt` (Impact: 136.8)
  * `scheme_init_number` (Impact: 98.1)
  * `sch_pow` (Impact: 94.1)
    * *Intent:* #else # define protected_pow pow # ifdef MZ_LONG_DOUBLE # define protected_powl long_double_pow # en...
  * `sch_powl` (Impact: 90.4)
    * *Intent:* #ifdef MZ_LONG_DOUBLE
  * `atan_prim` (Impact: 89.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (88.9241%), Tech Debt (26.9302%)
**Top Internal Functions/Classes:**
  * `do_malloc` (Impact: 230.8)
    * *Intent:* #else # define ALLOC_STATISTIC(x) /* empty */ #endif #if KEEP_SET_NO || KEEP_CHUNK_SET_NO #define SE...
  * `do_GC_gcollect` (Impact: 129.3)
    * *Intent:* #endif
  * `register_finalizer` (Impact: 77.0)
    * *Intent:* #endif
  * `sgc_fprintf` (Impact: 72.0)
    * *Intent:* # endif #endif #include <stdarg.h> #include <ctype.h> #define NP_BUFSIZE 512 /* Non-allocating print...
  * `collect_finish_common` (Impact: 68.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (93.9618%), Tech Debt (17.5744%)
**Top Internal Functions/Classes:**
  * `user_read_result` (Impact: 227.9)
    * *Intent:* #define MAX_USER_INPUT_REUSE_SIZE 1024 /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * ...
  * `do_general_read_bytes` (Impact: 180.3)
  * `do_read_char` (Impact: 159.3)
  * `user_write_result` (Impact: 134.5)
  * `make_output_port` (Impact: 126.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (94.9496%), Tech Debt (11.1548%)
**Top Internal Functions/Classes:**
  * `read_inner` (Impact: 371.8)
  * `read_compact` (Impact: 361.5)
    * *Intent:* /* never a valid symtab value: */ #define SYMTAB_IN_PROGRESS SCHEME_MULTIPLE_VALUES
  * `read_string` (Impact: 232.7)
    * *Intent:* /*========================================================================*/ /* string reader */ /*=...
  * `resolve_references` (Impact: 225.6)
    * *Intent:* #endif
  * `read_list` (Impact: 133.8)
...
- **Risk Profile:** Cognitive Load (53.7426%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (94.6138%), Tech Debt (46.1017%)
**Top Internal Functions/Classes:**
  * `equal_hash_key` (Impact: 231.8)
  * `equal_hash_key2` (Impact: 215.5)
    * *Intent:* #undef OVERFLOW_HASH #define OVERFLOW_HASH() overflow_equal_hash_key2(o, hi)
  * `do_hash` (Impact: 156.7)
  * `get_bucket` (Impact: 137.1)
  * `scheme_hash_tree_set_w_key_wraps` (Impact: 106.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (97.7778%), Tech Debt (8.7997%)
**Top Internal Functions/Classes:**
  * `scheme_generate_arith_for` (Impact: 1666.2)
  * `generate_float_point_arith` (Impact: 845.1)
  * `scheme_generate_nary_arith` (Impact: 328.2)
  * `is_inline_unboxable_op` (Impact: 199.0)
  * `generate_arith_slow_path` (Impact: 83.4)
**Contextual Mitigations & Amplifications:**
...
- `racket/collects/racket/place.rkt` -> **Severity: 577.7** (Blast Radius: 5.777 * Doc Risk: 100.0%)
- `racket/collects/racket/cmdline.rkt` -> **Severity: 432.7** (Blast Radius: 4.327 * Doc Risk: 100.0%)
- `racket/src/bc/include/scheme.h` -> **Severity: 309.9** (Blast Radius: 3.099 * Doc Risk: 100.0%)
- `racket/collects/setup/dirs.rkt` -> **Severity: 251.9** (Blast Radius: 2.519 * Doc Risk: 100.0%)
- `racket/collects/ffi/unsafe.rkt` -> **Severity: 235.8** (Blast Radius: 2.358 * Doc Risk: 100.0%)
