...
- `color` (@ `flamegraph.pl`) -> Impact: **143.7** | LOC: 153
- `header` (@ `flamegraph.pl`) -> Impact: **42.7** | LOC: 14
- `flow` (@ `flamegraph.pl`) -> Impact: **37.5** | LOC: 35
  * *Intent:* # flow() merges two stacks, storing the merged frames and value data in %Node.
- `search` (@ `flamegraph.pl`) -> Impact: **29.5** | LOC: 80
- `flow` (@ `dev/hotcoldgraph.pl`) -> Impact: **26.1** | LOC: 32
- `header` (@ `dev/hotcoldgraph.pl`) -> Impact: **20.4** | LOC: 8
- `group_start` (@ `flamegraph.pl`) -> Impact: **20.1** | LOC: 21
- `zoom` (@ `flamegraph.pl`) -> Impact: **19.5** | LOC: 51
- `stringTTF` (@ `dev/hotcoldgraph.pl`) -> Impact: **16.9** | LOC: 6
- `zoom_child` (@ `flamegraph.pl`) -> Impact: **14.9** | LOC: 19
...
- **Heaviest Functions:** `flow` (Impact: 26.1), `header` (Impact: 20.4), `stringTTF` (Impact: 16.9)
...
- **Heaviest Functions:** `color` (Impact: 143.7), `header` (Impact: 42.7), `flow` (Impact: 37.5)
...
- **Heaviest Functions:** `load_stack_identifiers` (Impact: 12.3), `save_stack` (Impact: 10.8), `get_trace_events` (Impact: 9.2)
...
- **Heaviest Functions:** `remember_stack` (Impact: 1.9)
...
- **Heaviest Functions:** `wanted` (Impact: 7.8), `usage` (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  * `load_stack_identifiers` (Impact: 12.3)
  * `save_stack` (Impact: 10.8)
  * `get_trace_events` (Impact: 9.2)
  * `load_events` (Impact: 4.7)
  * `__init__` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Anonymous_Block` (Impact: 12.7)
  * `Anonymous_Block` (Impact: 3.2)
  * `Anonymous_Block` (Impact: 3.2)
  * `Anonymous_Block` (Impact: 3.2)
  * `Anonymous_Block` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
