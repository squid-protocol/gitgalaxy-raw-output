...
| Avg Path Length | 1.8758 | Hops between files. Lower = Tighter coupling. |
...
- `main` (@ `py/Sudoku.java`) -> Impact: **55.0** | LOC: 26
  * *Intent:* /** Parse command line args and solve puzzles in files. **/
- `main` (@ `ipynb/Sudoku.java`) -> Impact: **50.7** | LOC: 25
  * *Intent:* /** Parse command line args and solve puzzles in files. **/
- `expand` (@ `py/lispy.py`) -> Impact: **49.3** | LOC: 51
  * *Intent:* ################ expand
- `copyblock` (@ `py/yaptu.py`) -> Impact: **44.4** | LOC: 48
- `editsR` (@ `py/ngrams.py`) -> Impact: **39.3** | LOC: 25
- `eval` (@ `py/lispy.py`) -> Impact: **31.2** | LOC: 36
  * *Intent:* ################ eval (tail recursive)
- `edits` (@ `py/ngrams.py`) -> Impact: **31.0** | LOC: 31
- `creport` (@ `py/ibol.py`) -> Impact: **29.9** | LOC: 43
- `test` (@ `py/testaccum.py`) -> Impact: **25.9** | LOC: 37
- `eliminate` (@ `py/sudoku.py`) -> Impact: **25.1** | LOC: 23
...
- **Heaviest Functions:** `editsR` (Impact: 39.3), `edits` (Impact: 31.0), `neighboring_msgs` (Impact: 13.4)
...
- **Heaviest Functions:** `eval` (Impact: 21.9), `read_from_tokens` (Impact: 10.6), `repl` (Impact: 4.5)
...
- **Heaviest Functions:** `creport` (Impact: 29.9), `closure` (Impact: 12.6), `near` (Impact: 11.4)
...
- **Heaviest Functions:** `copyblock` (Impact: 44.4), `preproc` (Impact: 15.2), `repl` (Impact: 14.5)
...
- **Heaviest Functions:** `check` (Impact: 16.0), `__init__` (Impact: 10.7), `search` (Impact: 9.5)
...
- **Heaviest Functions:** `_k_startingwith` (Impact: 20.9), `search` (Impact: 19.8), `consider_candidates` (Impact: 9.5)
...
- **Heaviest Functions:** `stats` (Impact: 16.3), `columns` (Impact: 15.9), `getcount` (Impact: 13.9)
...
- **Heaviest Functions:** `tally_game_play` (Impact: 10.6), `show` (Impact: 9.2), `tally_initial_layout_no_prior_sets` (Impact: 7.5)
...
- **Heaviest Functions:** `convert_files` (Impact: 19.9), `num_cmp` (Impact: 5.5), `num` (Impact: 4.4)
...
- **Heaviest Functions:** `__init__` (Impact: 11.5), `search` (Impact: 10.9), `extend` (Impact: 10.8)
...
**Top Internal Functions/Classes:**
  * `convert_files` (Impact: 19.9)
  * `num_cmp` (Impact: 5.5)
  * `num` (Impact: 4.4)
  * `modulelink` (Impact: 3.7)
...
**Top Internal Functions/Classes:**
  * `tally_game_play` (Impact: 10.6)
  * `show` (Impact: 9.2)
  * `tally_initial_layout_no_prior_sets` (Impact: 7.5)
    * *Intent:* """Simulate N initial deals for each size, keeping tallies for Sets and NoSets, but only when there ...
  * `is_set` (Impact: 7.4)
  * `tally_initial_layout` (Impact: 7.4)
...
**Top Internal Functions/Classes:**
  * `eval` (Impact: 21.9)
    * *Intent:* ################ eval
  * `read_from_tokens` (Impact: 10.6)
  * `repl` (Impact: 4.5)
    * *Intent:* ################ Interaction: A REPL
  * `lispstr` (Impact: 4.5)
  * `standard_env` (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  * `edits1` (Impact: 16.0)
  * `spelltest` (Impact: 7.8)
  * `candidates` (Impact: 7.2)
  * `Testset` (Impact: 5.9)
  * `known` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test` (Impact: 25.9)
  * `test1` (Impact: 5.5)
  * `expand_accumulations` (Impact: 1.9)
