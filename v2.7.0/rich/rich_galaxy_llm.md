...
| Avg Path Length | 2.4404 | Hops between files. Lower = Tighter coupling. |
...
- `__init__` (@ `rich/style.py`) -> Impact: **247.8** | LOC: 75
- `__init__` (@ `rich/console.py`) -> Impact: **225.7** | LOC: 133
- `traverse` (@ `rich/pretty.py`) -> Impact: **184.7** | LOC: 296
- `extract` (@ `rich/traceback.py`) -> Impact: **158.6** | LOC: 192
- `_traverse` (@ `rich/pretty.py`) -> Impact: **156.6** | LOC: 252
  * *Intent:* """Walk the object depth first."""
- `_render` (@ `rich/table.py`) -> Impact: **152.2** | LOC: 181
- `export_svg` (@ `rich/console.py`) -> Impact: **122.8** | LOC: 250
- `print` (@ `rich/console.py`) -> Impact: **91.7** | LOC: 102
- `__rich_console__` (@ `rich/columns.py`) -> Impact: **79.5** | LOC: 110
- `__rich_console__` (@ `rich/markdown.py`) -> Impact: **77.9** | LOC: 118
...
- **Heaviest Functions:** `__rich_console__` (Impact: 77.9), `__rich_console__` (Impact: 15.2), `__rich_console__` (Impact: 14.7)
...
- **Heaviest Functions:** `time_wrapping_unicode_heavy_warm_cache` (Impact: 3.0), `_print_table` (Impact: 2.9), `setup` (Impact: 1.9)
...
- **Heaviest Functions:** `__init__` (Impact: 225.7), `export_svg` (Impact: 122.8), `print` (Impact: 91.7)
...
- **Heaviest Functions:** `justify` (Impact: 46.9), `__rich_measure__` (Impact: 10.6), `__init__` (Impact: 5.5)
...
- **Heaviest Functions:** `wrap` (Impact: 42.1), `divide` (Impact: 35.1), `split` (Impact: 33.5)
...
- **Heaviest Functions:** `split_graphemes` (Impact: 29.6), `_cell_len` (Impact: 21.4), `_split_text` (Impact: 20.1)
...
- **Heaviest Functions:** `extract` (Impact: 158.6), `install` (Impact: 60.4), `__init__` (Impact: 58.0)
...
- **Heaviest Functions:** `__call__` (Impact: 69.2), `__init__` (Impact: 3.6)
...
- **Heaviest Functions:** `update` (Impact: 47.3), `open` (Impact: 40.3), `track` (Impact: 27.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.035186 | `Ripple Effect (Closeness):` 0.288239
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0074 | `Ripple Effect (Closeness):` 0.215584
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001603 | `Ripple Effect (Closeness):` 0.019851
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002932 | `Ripple Effect (Closeness):` 0.129137
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001447 | `Ripple Effect (Closeness):` 0.166681
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0011 | `Ripple Effect (Closeness):` 0.210368
...
**Top Internal Functions/Classes:**
  * `extract` (Impact: 158.6)
  * `install` (Impact: 60.4)
  * `__init__` (Impact: 58.0)
  * `_render_stack` (Impact: 44.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001382 | `Ripple Effect (Closeness):` 0.163546
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001287 | `Ripple Effect (Closeness):` 0.136932
...
**Top Internal Functions/Classes:**
  * `divide` (Impact: 33.4)
  * `adjust_line_length` (Impact: 29.1)
  * `split_and_crop_lines` (Impact: 28.7)
  * `apply_style` (Impact: 26.5)
  * `_split_cells` (Impact: 22.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003045 | `Ripple Effect (Closeness):` 0.189026
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 77.9)
  * `__rich_console__` (Impact: 15.2)
  * `__rich_console__` (Impact: 14.7)
  * `create` (Impact: 12.8)
  * `_flatten_tokens` (Impact: 10.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001005 | `Ripple Effect (Closeness):` 0.113911
...
**Top Internal Functions/Classes:**
  * `test_size_can_fall_back_to_std_descriptors` (Impact: 7.0)
  * `test_console_options_update` (Impact: 6.1)
  * `test_brokenpipeerror` (Impact: 4.8)
    * *Intent:* """Test BrokenPipe works as expected."""
  * `test_tty_compatible` (Impact: 4.2)
    * *Intent:* """Check TTY_COMPATIBLE environment var."""
  * `get_terminal_size_mock_impl` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_highlight_regex` (Impact: 4.3)
    * *Intent:* # As a string text = Text("peek-a-boo") count = text.highlight_regex(r"NEVER_MATCH", "red") assert c...
  * `test_divide` (Impact: 3.1)
  * `test_indentation_guides` (Impact: 3.0)
  * `test_highlight_regex_callable` (Impact: 2.7)
  * `test_tabs_to_spaces_spans` (Impact: 2.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_attrs_broken_310` (Impact: 3.7)
  * `test_pretty_namedtuple` (Impact: 2.2)
  * `test_reference_cycle_custom_repr` (Impact: 2.2)
  * `test_deque` (Impact: 2.2)
  * `test_ipy_display_hook__special_repr_raises_exception` (Impact: 2.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002611 | `Ripple Effect (Closeness):` 0.175071
...
**Top Internal Functions/Classes:**
  * `test_columns` (Impact: 4.2)
  * `test_using_default_columns` (Impact: 4.2)
    * *Intent:* # can only check types, as the instances do not '==' each other expected_default_types = [ TextColum...
  * `test_progress_max_refresh` (Impact: 3.9)
    * *Intent:* """Test max_refresh argument."""
  * `test_track` (Impact: 3.4)
  * `test_progress_track` (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 70.5)
  * `__init__` (Impact: 25.3)
  * `generate_segments` (Impact: 17.9)
  * `__rich_console__` (Impact: 17.3)
  * `blank_lines` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001832 | `Ripple Effect (Closeness):` 0.173904
...
**Top Internal Functions/Classes:**
  ...
  * `process_renderables` (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00251 | `Ripple Effect (Closeness):` 0.168839
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` (Impact: 18.6)
  * `_get_signature` (Impact: 18.1)
    * *Intent:* """Get a signature for a callable."""
  * `_make_title` (Impact: 9.1)
    * *Intent:* """Make a default title."""
  * `_get_formatted_doc` (Impact: 6.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000256 | `Ripple Effect (Closeness):` 0.004963
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00111 | `Ripple Effect (Closeness):` 0.164578
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 72.5)
  * `add` (Impact: 20.0)
  * `make_guide` (Impact: 16.0)
    * *Intent:* """Make a Segment for a level of the guide lines."""
  * `__rich_measure__` (Impact: 9.3)
  * `__init__` (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000282 | `Ripple Effect (Closeness):` 0.008862
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 56.1)
  * `_get_pulse_segments` (Impact: 34.0)
  * `_render_pulse` (Impact: 8.2)
  * `update` (Impact: 6.5)
    * *Intent:* """Update progress with new values. Args: completed (float): Number of steps completed. total (float...
  * `__rich_measure__` (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 79.5)
  * `iter_renderables` (Impact: 18.6)
  * `__init__` (Impact: 7.7)
  * `add_renderable` (Impact: 2.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000646 | `Ripple Effect (Closeness):` 0.118302
...
**Top Internal Functions/Classes:**
  * `__rich_console__` (Impact: 60.8)
  * `align_text` (Impact: 17.0)
  * `__rich_measure__` (Impact: 11.1)
  * `_title` (Impact: 6.4)
  * `_subtitle` (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00201 | `Ripple Effect (Closeness):` 0.139495
...
- `rich/console.py` -> **Severity: 3.519** (Bridge: 0.0352 * Flux: 100.0%)
- `rich/text.py` -> **Severity: 0.74** (Bridge: 0.0074 * Flux: 100.0%)
- `rich/segment.py` -> **Severity: 0.304** (Bridge: 0.003 * Flux: 100.0%)
- `rich/__main__.py` -> **Severity: 0.296** (Bridge: 0.003 * Flux: 99.6316%)
- `rich/table.py` -> **Severity: 0.293** (Bridge: 0.0029 * Flux: 100.0%)
