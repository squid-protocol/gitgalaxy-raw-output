...
- `convertBaseSchema` (@ `packages/zod/src/v4/classic/from-json-schema.ts`) -> Impact: **284.7** | LOC: 394
- `validateOpenAPI30Schema` (@ `packages/zod/src/v4/classic/tests/to-json-schema.test.ts`) -> Impact: **234.0** | LOC: 1202
  * *Intent:* /** @see https://github.com/colinhacks/zod/issues/5147 */
- `getSizing` (@ `packages/zod/src/v4/locales/he.ts`) -> Impact: **163.7** | LOC: 192
- `_parse` (@ `packages/zod/src/v3/types.ts`) -> Impact: **137.1** | LOC: 309
- `errorMap` (@ `packages/zod/src/v3/locales/en.ts`) -> Impact: **132.5** | LOC: 121
- `finalize` (@ `packages/zod/src/v4/core/to-json-schema.ts`) -> Impact: **117.0** | LOC: 158
- `flattenRef` (@ `packages/zod/src/v4/core/to-json-schema.ts`) -> Impact: **95.2** | LOC: 150
  * *Intent:* // flatten refs - inherit properties from parent schemas
- `errorMap` (@ `packages/zod/src/v3/tests/error.test.ts`) -> Impact: **82.0** | LOC: 197
- `errorMap` (@ `packages/zod/src/v4/classic/tests/error.test.ts`) -> Impact: **76.0** | LOC: 304
- `check` (@ `packages/zod/src/v4/core/schemas.ts`) -> Impact: **74.8** | LOC: 308
...
- **Heaviest Functions:** `check` (Impact: 74.8), `parse` (Impact: 71.8), `runChecks` (Impact: 44.2)
...
- **Heaviest Functions:** `finite` (Impact: 20.6), `_function` (Impact: 18.9), `addIssue` (Impact: 17.1)
...
- **Heaviest Functions:** `finalizeIssue` (Impact: 43.4), `getParsedType` (Impact: 39.7), `partial` (Impact: 24.6)
...
- **Heaviest Functions:** `metabench` (Impact: 19.8), `run` (Impact: 16.2), `benchWithData` (Impact: 11.3)
...
- **Heaviest Functions:** `for_in_no_symbols` (Impact: 3.2), `reflect_no_symbols` (Impact: 3.2), `for_in_with_symbols` (Impact: 3.2)
...
- **Heaviest Functions:** `nullChainCheckTag` (Impact: 20.3), `keyin` (Impact: 4.4), `typeofThenCheckSymbol` (Impact: 4.3)
...
- **Heaviest Functions:** `numberProcessor` (Impact: 53.5), `literalProcessor` (Impact: 51.2), `tupleProcessor` (Impact: 43.0)
...
- **Heaviest Functions:** `mergeObjectSync` (Impact: 18.5), `makeIssue` (Impact: 11.8), `mergeArray` (Impact: 7.4)
...
- **Heaviest Functions:** `_parse` (Impact: 18.2), `_parseAsync` (Impact: 12.1), `Parse` (Impact: 11.6)
...
- **Heaviest Functions:** `processError` (Impact: 42.0), `treeifyError` (Impact: 40.4), `processError` (Impact: 37.6)
...
**Top Internal Functions/Classes:**
  * `check` (Impact: 74.8)
  * `parse` (Impact: 71.8)
  * `runChecks` (Impact: 44.2)
  * `handleIntersectionResults` (Impact: 42.2)
  * `parse` (Impact: 38.1)
...
**Top Internal Functions/Classes:**
  ...
  * `_function` (Impact: 18.9)
  * `addIssue` (Impact: 17.1)
  * `processJSONSchema` (Impact: 14.4)
  * `hash` (Impact: 12.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `numberProcessor` (Impact: 53.5)
  * `literalProcessor` (Impact: 51.2)
  * `tupleProcessor` (Impact: 43.0)
  * `stringProcessor` (Impact: 39.8)
    * *Intent:* // ==================== SIMPLE TYPE PROCESSORS ====================
  * `recordProcessor` (Impact: 29.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `finalizeIssue` (Impact: 43.4)
  * `getParsedType` (Impact: 39.7)
  * `partial` (Impact: 24.6)
  * `createTransparentProxy` (Impact: 23.0)
...
**Top Internal Functions/Classes:**
  * `validateOpenAPI30Schema` (Impact: 234.0)
    * *Intent:* /** @see https://github.com/colinhacks/zod/issues/5147 */
  * `override` (Impact: 13.2)
  * `override` (Impact: 4.5)
  * `override` (Impact: 4.2)
  * `override` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
