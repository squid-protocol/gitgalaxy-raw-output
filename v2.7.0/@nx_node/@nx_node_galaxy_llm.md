...
- `e2eProjectGeneratorInternal` (@ `package/src/generators/e2e-project/e2e-project.js`) -> Impact: **82.2** | LOC: 190
...
- `waitForPortOpen` (@ `package/src/utils/wait-for-port-open.js`) -> Impact: **24.4** | LOC: 37
  * *Intent:* /** * Waits for the given port to be open * @param port * @param options */
- `installTask` (@ `package/src/generators/setup-docker/setup-docker.js`) -> Impact: **17.2** | LOC: 45
- `addVSCodeDebugConfiguration` (@ `package/src/utils/vscode-debug-config.js`) -> Impact: **16.5** | LOC: 53
- `normalizeOptions` (@ `package/src/generators/setup-docker/setup-docker.js`) -> Impact: **16.0** | LOC: 9
- `normalizeOptions` (@ `package/src/generators/e2e-project/e2e-project.js`) -> Impact: **15.2** | LOC: 27
- `findFreeDebugPort` (@ `package/src/utils/vscode-debug-config.js`) -> Impact: **12.6** | LOC: 25
- `cleanupClient` (@ `package/src/utils/wait-for-port-open.js`) -> Impact: **10.6** | LOC: 31
...
- **Heaviest Functions:** `applicationGeneratorInternal` (Impact: 53.8), `updateTsConfigOptions` (Impact: 8.3), `applicationGenerator` (Impact: 2.1)
...
- **Heaviest Functions:** `addDocker` (Impact: 28.3), `installTask` (Impact: 17.2), `normalizeOptions` (Impact: 16.0)
...
- **Heaviest Functions:** `initGenerator` (Impact: 5.7), `installTask` (Impact: 4.5), `updateDependencies` (Impact: 2.0)
...
- **Heaviest Functions:** `e2eProjectGeneratorInternal` (Impact: 82.2), `normalizeOptions` (Impact: 15.2), `e2eProjectGenerator` (Impact: 2.1)
...
- **Heaviest Functions:** `killPort` (Impact: 9.9)
...
- **Heaviest Functions:** `addVSCodeDebugConfiguration` (Impact: 16.5), `findFreeDebugPort` (Impact: 12.6)
...
- **Heaviest Functions:** `waitForPortOpen` (Impact: 24.4), `cleanupClient` (Impact: 10.6), `checkPort` (Impact: 4.4)
...
- **Heaviest Functions:** `applicationGenerator` (Impact: 1.8), `applicationGeneratorInternal` (Impact: 1.8)

### 9. `package/src/generators/e2e-project/e2e-project.d.ts` (TYPESCRIPT) -> Cumulative Risk: **369.54**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.43 | **LOC:** 6 | **CtrlFlow:** 20.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (53.3284%), Tech Debt (50.0%)
- **Heaviest Functions:** `e2eProjectGenerator` (Impact: 1.8), `e2eProjectGeneratorInternal` (Impact: 1.8)
...
- **Heaviest Functions:** `updateProjectConfig` (Impact: 1.8), `setupDockerGenerator` (Impact: 1.8)
...
**Top Internal Functions/Classes:**
  * `e2eProjectGeneratorInternal` (Impact: 82.2)
  * `normalizeOptions` (Impact: 15.2)
...
**Top Internal Functions/Classes:**
  * `addVSCodeDebugConfiguration` (Impact: 16.5)
  * `findFreeDebugPort` (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 7 instances
* *State Mutation (weighted view):* 23
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `waitForPortOpen` (Impact: 24.4)
    * *Intent:* /** * Waits for the given port to be open * @param port * @param options */
  * `cleanupClient` (Impact: 10.6)
  * `checkPort` (Impact: 4.4)
**Structural Signatures (Net Mitigated Signals):**
