...
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc2985.py`) -> Impact: **35.3** | LOC: 113
- `testOpenTypes` (@ `pyasn1_modules-0.4.2/tests/test_rfc2985.py`) -> Impact: **33.8** | LOC: 82
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc3114.py`) -> Impact: **26.6** | LOC: 108
...
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc5752.py`) -> Impact: **16.6** | LOC: 77
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc7229.py`) -> Impact: **16.3** | LOC: 44
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc3852.py`) -> Impact: **13.7** | LOC: 76
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc4073.py`) -> Impact: **13.7** | LOC: 48
- `testDerCodec` (@ `pyasn1_modules-0.4.2/tests/test_rfc5280.py`) -> Impact: **13.7** | LOC: 48
- `testExtensionsMap` (@ `pyasn1_modules-0.4.2/tests/test_rfc3739.py`) -> Impact: **11.7** | LOC: 37
...
- **Heaviest Functions:** `readPemBlocksFromFile` (Impact: 20.5), `readPemFromFile` (Impact: 2.2), `readBase64fromText` (Impact: 1.5)
...
- **Heaviest Functions:** `mkOcspRequest` (Impact: 4.0), `parseOcspResponse` (Impact: 2.6), `encodeTag` (Impact: 1.8)
...
- **Heaviest Functions:** `_OID` (Impact: 6.1)
...
**Top Internal Functions/Classes:**
  ...
  * `testOpenTypes` (Impact: 6.0)
  * `testDerCodec` (Impact: 5.6)
  * `testOpenTypes` (Impact: 5.2)
...
**Top Internal Functions/Classes:**
  * `testDerCodec` (Impact: 13.7)
  * `testDerCodec` (Impact: 8.7)
  * `testExtensionsMap` (Impact: 5.3)
  * `testDecodeOpenTypes` (Impact: 2.1)
  * `testDerCodec` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 1 instances
* *Amplified Cascading Flux:* 6 instances
* *Sec Tainted Injection (weighted view):* 1
...
**Top Internal Functions/Classes:**
  * `testDerCodec` (Impact: 35.3)
  * `testOpenTypes` (Impact: 33.8)
  * `setUp` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
