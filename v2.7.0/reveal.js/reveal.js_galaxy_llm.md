...
| Avg Path Length | 2.4722 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 84.7 | 18.8 | 10.2 | 0.0 |
...
- `onDocumentKeyDown` (@ `js/controllers/keyboard.js`) -> Impact: **194.7** | LOC: 273
  * *Intent:* /** * Handler for the document level 'keydown' event. * * @param {object} event */
- `slide` (@ `js/reveal.js`) -> Impact: **94.7** | LOC: 194
...
- `autoAnimateElements` (@ `js/controllers/autoanimate.js`) -> Impact: **57.6** | LOC: 123
...
- `load` (@ `js/controllers/slidecontent.js`) -> Impact: **56.0** | LOC: 150
...
- `onTouchMove` (@ `js/controllers/touch.js`) -> Impact: **52.6** | LOC: 90
  * *Intent:* /** * Handler for the 'touchmove' event. * * @param {object} event */
- `update` (@ `js/controllers/backgrounds.js`) -> Impact: **52.1** | LOC: 136
...
- `updateSlides` (@ `js/reveal.js`) -> Impact: **50.9** | LOC: 117
...
- `escapeForHTML` (@ `react/src/utils/markdown.ts`) -> Impact: **48.1** | LOC: 141
- `Code` (@ `react/src/components/code.tsx`) -> Impact: **47.1** | LOC: 94
- `addAttributes` (@ `react/src/utils/markdown.ts`) -> Impact: **47.1** | LOC: 61
...
- **Heaviest Functions:** `magnify` (Impact: 23.7), `to` (Impact: 16.4), `init` (Impact: 9.5)
...
- **Heaviest Functions:** `runTests` (Impact: 13.0), `startServer` (Impact: 4.8)
...
- **Heaviest Functions:** `addAttributes` (Impact: 46.0), `slidify` (Impact: 24.1), `getSlidifyOptions` (Impact: 20.4)
...
- **Heaviest Functions:** `getIndicesFromHash` (Impact: 28.8), `getHash` (Impact: 24.4), `writeURL` (Impact: 15.0)
...
- **Heaviest Functions:** `Hilitor` (Impact: 46.2), `hiliteWords` (Impact: 26.4), `doSearch` (Impact: 10.4)
...
- **Heaviest Functions:** `init` (Impact: 5.6), `loadScript` (Impact: 4.4), `onload` (Impact: 2.6)
...
- **Heaviest Functions:** `init` (Impact: 5.4), `loadScript` (Impact: 4.4), `onload` (Impact: 2.6)
...
- **Heaviest Functions:** `render` (Impact: 8.0), `setPlaying` (Impact: 6.4), `animate` (Impact: 5.0)
...
- **Heaviest Functions:** `load` (Impact: 56.0), `startEmbeddedContent` (Impact: 32.5), `stopEmbeddedContent` (Impact: 26.9)
...
- **Heaviest Functions:** `createPageElement` (Impact: 38.4), `syncPages` (Impact: 25.9), `activate` (Impact: 24.4)
...
**Top Internal Functions/Classes:**
  * `onDocumentKeyDown` (Impact: 194.7)
    * *Intent:* /** * Handler for the document level 'keydown' event. * * @param {object} event */
  ...
  * `registerKeyboardShortcut` (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `escapeForHTML` (Impact: 48.1)
  * `addAttributes` (Impact: 47.1)
  * `addAttributeInElement` (Impact: 25.4)
  * `normalizeMarkdownSource` (Impact: 19.3)
  * `serializeSignatureValue` (Impact: 12.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `onSlidesClicked` (Impact: 29.2)
  * `previewMedia` (Impact: 28.4)
    * *Intent:* /** * Opens a lightbox window that provides a larger view of the * given image/video. * * @param {st...
  * `setState` (Impact: 12.4)
  * `toggleHelp` (Impact: 9.2)
...
**Top Internal Functions/Classes:**
  ...
  * `hiliteWords` (Impact: 26.4)
    * *Intent:* // recursively apply word highlighting
  * `doSearch` (Impact: 10.4)
  * `init` (Impact: 8.2)
  * `render` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `createSingletonNode` (Impact: 8.4)
...
**Top Internal Functions/Classes:**
  * `getIndicesFromHash` (Impact: 28.8)
  ...
  * `debouncedReplaceState` (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
**Top Internal Functions/Classes:**
  ...
  * `configure` (Impact: 9.3)
    * *Intent:* /** * Called when the reveal.js config is updated. */
  * `onNavigateLeftClicked` (Impact: 4.9)
    * *Intent:* /** * Event handlers for navigation control buttons. */
  * `onNavigateRightClicked` (Impact: 4.9)
  * `render` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 19 instances
