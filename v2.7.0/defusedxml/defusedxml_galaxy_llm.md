...
- `__init__` (@ `defusedxml-0.7.1/defusedxml/ElementTree.py`) -> Impact: **27.3** | LOC: 37
- `check_docinfo` (@ `defusedxml-0.7.1/defusedxml/lxml.py`) -> Impact: **21.0** | LOC: 20
...
- `parseString` (@ `defusedxml-0.7.1/defusedxml/minidom.py`) -> Impact: **8.4** | LOC: 22
- `parseString` (@ `defusedxml-0.7.1/defusedxml/expatbuilder.py`) -> Impact: **8.0** | LOC: 14
...
- **Heaviest Functions:** `check_docinfo` (Impact: 21.0), `_filter` (Impact: 5.5), `parse` (Impact: 5.2)
...
- **Heaviest Functions:** `__init__` (Impact: 16.8), `defused_gzip_decode` (Impact: 13.3), `__init__` (Impact: 10.4)
...
- **Heaviest Functions:** `reset` (Impact: 6.2), `__init__` (Impact: 3.2), `defused_entity_decl` (Impact: 3.2)
...
- **Heaviest Functions:** `parse` (Impact: 13.3), `parseString` (Impact: 8.0), `install` (Impact: 7.5)
...
- **Heaviest Functions:** `decode_response` (Impact: 7.2), `parse` (Impact: 6.4), `parseString` (Impact: 6.4)
...
- **Heaviest Functions:** `startElement` (Impact: 6.2), `weatherResponse` (Impact: 4.6), `characters` (Impact: 3.6)
...
- **Heaviest Functions:** `__init__` (Impact: 27.3), `_get_py3_cls` (Impact: 6.7), `defused_entity_decl` (Impact: 3.2)
...
- **Heaviest Functions:** `_generate_etree_functions` (Impact: 8.8), `_apply_defusing` (Impact: 6.2), `iterparse` (Impact: 6.1)
...
- **Heaviest Functions:** `parseString` (Impact: 6.4), `parse` (Impact: 3.4), `make_parser` (Impact: 1.5)
...
- **Heaviest Functions:** `parse` (Impact: 6.0), `parseString` (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  * `decode_response` (Impact: 7.2)
  * `parse` (Impact: 6.4)
  * `parseString` (Impact: 6.4)
  * `get_content` (Impact: 5.4)
  * `test_external_file_ref` (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  ...
  * `defused_gzip_decode` (Impact: 13.3)
  ...
  * `read` (Impact: 7.5)
  * `defused_entity_decl` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `createDefaultParser` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_generate_etree_functions` (Impact: 8.8)
    * *Intent:* """Factory for functions needed by etree, dependent on whether cElementTree or ElementTree is used."...
  * `_apply_defusing` (Impact: 6.2)
  * `iterparse` (Impact: 6.1)
  * `parse` (Impact: 5.3)
  * `__init__` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `black` (Impact: 2.1)
  * `README.md` (Impact: 1.2)
  * `README.html` (Impact: 1.2)
  * `clean` (Impact: 1.2)
  * `distclean` (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `run` (Impact: 1.6)
  * `initialize_options` (Impact: 1.5)
  * `finalize_options` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 1 instances
* *Sec Tainted Injection (weighted view):* 1
**Structural Signatures (Net Mitigated Signals):**
