...
- `pbkdf2` (@ `package/crypto.d.ts`) -> Impact: **2.9** | LOC: 9
- `pipeline` (@ `package/stream.d.ts`) -> Impact: **2.8** | LOC: 8
- `pipeline` (@ `package/stream.d.ts`) -> Impact: **2.6** | LOC: 7
- `scrypt` (@ `package/crypto.d.ts`) -> Impact: **2.5** | LOC: 6
- `randomFill` (@ `package/crypto.d.ts`) -> Impact: **2.4** | LOC: 7
- `scrypt` (@ `package/crypto.d.ts`) -> Impact: **2.3** | LOC: 6
- `pipeline` (@ `package/stream.d.ts`) -> Impact: **2.3** | LOC: 6
- `pipeline` (@ `package/stream.d.ts`) -> Impact: **2.2** | LOC: 5
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **2.0** | LOC: 5
- `generateKeyPair` (@ `package/crypto.d.ts`) -> Impact: **2.0** | LOC: 5
...
- **Heaviest Functions:** `pipeline` (Impact: 2.8), `pipeline` (Impact: 2.6), `pipeline` (Impact: 2.3)
...
- **Heaviest Functions:** `pbkdf2` (Impact: 2.9), `scrypt` (Impact: 2.5), `randomFill` (Impact: 2.4)
...
- **Heaviest Functions:** `decode` (Impact: 1.5), `encode` (Impact: 1.5)
...
- **Heaviest Functions:** `hrtime` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `pbkdf2` (Impact: 2.9)
  * `scrypt` (Impact: 2.5)
  * `randomFill` (Impact: 2.4)
  * `scrypt` (Impact: 2.3)
  * `generateKeyPair` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
