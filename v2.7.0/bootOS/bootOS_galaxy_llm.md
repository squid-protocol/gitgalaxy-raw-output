...
- `.after_al` (@ `patch/sokoban.asm`) -> Impact: **22.5** | LOC: 59
- `.loop` (@ `patch/sokoban.asm`) -> Impact: **10.5** | LOC: 15
- `ClearScreen` (@ `patch/mine.asm`) -> Impact: **9.6** | LOC: 13
- `.loop` (@ `os.asm`) -> Impact: **9.4** | LOC: 9
- `.mainloop` (@ `patch/sokoban.asm`) -> Impact: **9.4** | LOC: 19
- `Flood` (@ `patch/mine.asm`) -> Impact: **9.2** | LOC: 42
  * *Intent:* ;; Flood fill empty cells ;; ;; Parameters: ;; * BP - Cell index ;; Clobbered registers: ;; * Yes [TODO]
- `check_collisions` (@ `patch/snake.asm`) -> Impact: **9.2** | LOC: 11
- `no_exit` (@ `patch/snake.asm`) -> Impact: **7.5** | LOC: 9
- `os6` (@ `os.asm`) -> Impact: **6.6** | LOC: 12
- `PopulateMines` (@ `patch/mine.asm`) -> Impact: **6.4** | LOC: 8
...
- **Heaviest Functions:** `ClearScreen` (Impact: 9.6), `Flood` (Impact: 9.2), `PopulateMines` (Impact: 6.4)
...
- **Heaviest Functions:** `check_collisions` (Impact: 9.2), `no_exit` (Impact: 7.5), `check_collisions_self` (Impact: 5.5)
...
- **Heaviest Functions:** `.after_al` (Impact: 22.5), `.loop` (Impact: 10.5), `.mainloop` (Impact: 9.4)
...
- **Heaviest Functions:** `.loop` (Impact: 9.4), `os6` (Impact: 6.6), `restart` (Impact: 4.8)
...
- **Heaviest Functions:** `.1` (Impact: 5.9), `start` (Impact: 3.9), `.2` (Impact: 3.2)
...
- **Heaviest Functions:** `os.img` (Impact: 1.2), `clean` (Impact: 1.2), `all` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `check_collisions` (Impact: 9.2)
  * `no_exit` (Impact: 7.5)
  * `check_collisions_self` (Impact: 5.5)
  * `no_collision` (Impact: 5.2)
  * `update_body` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
