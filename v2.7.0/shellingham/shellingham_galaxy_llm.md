...
- `iter_process_parents` (@ `shellingham-1.5.4/src/shellingham/posix/ps.py`) -> Impact: **15.9** | LOC: 40
  * *Intent:* """Try to look up the process tree via the output of `ps`."""
- `_get_interpreter_shell` (@ `shellingham-1.5.4/src/shellingham/posix/__init__.py`) -> Impact: **13.0** | LOC: 18
...
- `get_shell` (@ `shellingham-1.5.4/src/shellingham/nt.py`) -> Impact: **12.0** | LOC: 32
- `_get_shell` (@ `shellingham-1.5.4/src/shellingham/posix/__init__.py`) -> Impact: **11.2** | LOC: 16
- `detect_shell` (@ `shellingham-1.5.4/src/shellingham/__init__.py`) -> Impact: **7.7** | LOC: 15
- `get_shell` (@ `shellingham-1.5.4/src/shellingham/posix/__init__.py`) -> Impact: **7.3** | LOC: 8
...
- `iter_process_parents` (@ `shellingham-1.5.4/src/shellingham/posix/proc.py`) -> Impact: **6.0** | LOC: 17
  * *Intent:* """Try to look up the process tree via the /proc interface."""
- `_iter_process_parents` (@ `shellingham-1.5.4/src/shellingham/posix/__init__.py`) -> Impact: **5.8** | LOC: 13
...
- `_iter_process_parents` (@ `shellingham-1.5.4/src/shellingham/posix/proc.py`) -> Impact: **5.6** | LOC: 8
...
- **Heaviest Functions:** `iter_process_parents` (Impact: 6.0), `_iter_process_parents` (Impact: 5.6), `_get_ppid` (Impact: 3.9)
...
- **Heaviest Functions:** `get_shell` (Impact: 12.0), `check` (Impact: 6.3), `_check_expected` (Impact: 4.7)
...
- **Heaviest Functions:** `iter_process_parents` (Impact: 15.9)
...
- **Heaviest Functions:** `detect_shell` (Impact: 7.7)
...
- **Heaviest Functions:** `_get_interpreter_shell` (Impact: 13.0), `_get_shell` (Impact: 11.2), `get_shell` (Impact: 7.3)
...
- **Heaviest Functions:** `patch` (Impact: 5.5), `unpatch` (Impact: 4.6), `test_get_shell` (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  * `get_shell` (Impact: 12.0)
  * `check` (Impact: 6.3)
  * `_check_expected` (Impact: 4.7)
  * `_get_full_path` (Impact: 4.6)
  * `check` (Impact: 4.2)
...
**Top Internal Functions/Classes:**
  * `_get_interpreter_shell` (Impact: 13.0)
...
**Top Internal Functions/Classes:**
  * `iter_process_parents` (Impact: 6.0)
    * *Intent:* """Try to look up the process tree via the /proc interface."""
...
**Top Internal Functions/Classes:**
  * `iter_process_parents` (Impact: 15.9)
    * *Intent:* """Try to look up the process tree via the output of `ps`."""
**Contextual Mitigations & Amplifications:**
