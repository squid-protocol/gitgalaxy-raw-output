...
| Avg Path Length | 2.0364 | Hops between files. Lower = Tighter coupling. |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 58.3 | 62.2 | 100.0 |
...
- `__init__` (@ `sse_starlette-3.3.4/sse_starlette/sse.py`) -> Impact: **46.2** | LOC: 72
- `encode` (@ `sse_starlette-3.3.4/sse_starlette/event.py`) -> Impact: **14.1** | LOC: 28
- `test_response_send_whenValidInput_thenGeneratesExpectedOutput` (@ `sse_starlette-3.3.4/tests/test_sse.py`) -> Impact: **13.8** | LOC: 32
- `test_shutdownGracePeriod_whenGeneratorExitsInTime_thenCleanShutdown` (@ `sse_starlette-3.3.4/tests/test_issue167.py`) -> Impact: **13.0** | LOC: 63
  * *Intent:* """Generator that sees shutdown_event and exits within grace period should complete without CancelledError."""
- `test_eventSourceResponse_whenUsingMemoryChannel_thenHandlesAsyncQueueCorrectly` (@ `sse_starlette-3.3.4/tests/test_sse.py`) -> Impact: **12.8** | LOC: 56
- `app` (@ `sse_starlette-3.3.4/tests/test_sse.py`) -> Impact: **11.6** | LOC: 32
...
- `app` (@ `sse_starlette-3.3.4/tests/test_sse.py`) -> Impact: **10.8** | LOC: 16
  * *Intent:* # Arrange
- `stream_numbers` (@ `sse_starlette-3.3.4/tests/test_sse.py`) -> Impact: **10.8** | LOC: 15
  * *Intent:* # Producer function that writes to the channel
- `mock_send` (@ `sse_starlette-3.3.4/tests/test_issue167.py`) -> Impact: **10.7** | LOC: 6
- `_stream_response` (@ `sse_starlette-3.3.4/sse_starlette/sse.py`) -> Impact: **10.0** | LOC: 27
...
### 1. `sse_starlette-3.3.4/sse_starlette/sse.py` (PYTHON) -> Cumulative Risk: **640.47**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 387.6 | **LOC:** 438 | **CtrlFlow:** 16.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Safety Score (94.0715%)
- **Heaviest Functions:** `__init__` (Impact: 46.2), `_stream_response` (Impact: 10.0), `_ping` (Impact: 10.0)

### 2. `sse_starlette-3.3.4/sse_starlette/event.py` (PYTHON) -> Cumulative Risk: **522.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 67.94 | **LOC:** 97 | **CtrlFlow:** 20.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9982%), Safety Score (88.7041%)
- **Heaviest Functions:** `encode` (Impact: 14.1), `__init__` (Impact: 9.3), `__init__` (Impact: 7.7)

### 3. `sse_starlette-3.3.4/tests/test_sse.py` (PYTHON) -> Cumulative Risk: **461.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 338.44 | **LOC:** 335 | **CtrlFlow:** 7.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (52.4549%)
- **Heaviest Functions:** `test_response_send_whenValidInput_thenGeneratesExpectedOutput` (Impact: 13.8), `test_eventSourceResponse_whenUsingMemoryChannel_thenHandlesAsyncQueueCorrectly` (Impact: 12.8), `app` (Impact: 11.6)

### 4. `sse_starlette-3.3.4/tests/test_issue167.py` (PYTHON) -> Cumulative Risk: **447.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 385.9 | **LOC:** 286 | **CtrlFlow:** 6.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (84.6154%), Safety Score (71.1809%)
- **Heaviest Functions:** `test_shutdownGracePeriod_whenGeneratorExitsInTime_thenCleanShutdown` (Impact: 13.0), `mock_send` (Impact: 10.7), `test_shutdownGracePeriod_whenGeneratorIgnoresEvent_thenForceCancelAfterTimeout` (Impact: 6.9)

### 5. `sse_starlette-3.3.4/tests/conftest.py` (PYTHON) -> Cumulative Risk: **430.52**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 89.98 | **LOC:** 114 | **CtrlFlow:** 3.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (77.7778%), Safety Score (56.9249%)
- **Heaviest Functions:** `reset_shutdown_state` (Impact: 4.0), `app` (Impact: 3.9), `endless` (Impact: 3.6)

### 6. `sse_starlette-3.3.4/tests/anyio_compat.py` (PYTHON) -> Cumulative Risk: **395.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `collapse_excgroups` (Impact: 4.5)

### 7. `sse_starlette-3.3.4/tests/test_multi_loop.py` (PYTHON) -> Cumulative Risk: **391.17**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 474.1 | **LOC:** 280 | **CtrlFlow:** 4.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Safety Score (59.0568%), Stability (50.0%)
- **Heaviest Functions:** `test_thread_isolation` (Impact: 7.4), `test_handle_exit_wakes_multiple_waiting_tasks` (Impact: 5.8), `test_all_tasks_share_same_shutdown_state` (Impact: 5.3)

### 8. `sse_starlette-3.3.4/tests/test_issue152.py` (PYTHON) -> Cumulative Risk: **378.1**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 222.78 | **LOC:** 212 | **CtrlFlow:** 8.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Safety Score (69.5059%), Stability (50.0%)
- **Heaviest Functions:** `test_watcher_broadcasts_to_all_events` (Impact: 8.7), `test_single_watcher_per_thread` (Impact: 6.3), `test_event_removal_during_broadcast_is_safe` (Impact: 5.6)

### 9. `sse_starlette-3.3.4/tests/test_issue132.py` (PYTHON) -> Cumulative Risk: **326.07**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 154.92 | **LOC:** 171 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Stability (50.0%), Safety Score (40.5462%)
- **Heaviest Functions:** `test_detects_uvicorn_server_should_exit` (Impact: 2.7), `test_detects_appstatus_should_exit` (Impact: 2.4), `test_fallback_when_no_uvicorn_server` (Impact: 2.4)

### 10. `sse_starlette-3.3.4/tests/test_event.py` (PYTHON) -> Cumulative Risk: **289.66**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 27.64 | **LOC:** 132 | **CtrlFlow:** 1.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Stability (50.0%), Safety Score (27.6177%)
- **Heaviest Functions:** `test_server_sent_event` (Impact: 5.5), `test_multiline_data` (Impact: 2.2), `test_json_server_sent_event` (Impact: 1.8)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 387.6 | **LOC:** 438 | **CtrlFlow:** 16.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.8685%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 46.2)
  * `_stream_response` (Impact: 10.0)
    * *Intent:* """Send out SSE data to the client as it becomes available in the iterator."""
  * `_ping` (Impact: 10.0)
    * *Intent:* """Periodically send ping messages to keep the connection alive on proxies. - frequenccy ca every 15...
  * `_shutdown_watcher` (Impact: 8.7)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 385.9 | **LOC:** 286 | **CtrlFlow:** 6.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (29.4872%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_shutdownGracePeriod_whenGeneratorExitsInTime_thenCleanShutdown` (Impact: 13.0)
  ...
  * `test_shutdownGracePeriod_whenGeneratorIgnoresEvent_thenForceCancelAfterTimeout` (Impact: 6.9)
  * `test_shutdownEvent_whenGracePeriodZero_thenEventSetButImmediateCancel` (Impact: 5.2)
  * `test_noShutdownEvent_whenShutdownDetected_thenImmediateCancel` (Impact: 4.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 338.44 | **LOC:** 335 | **CtrlFlow:** 7.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (47.5237%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_response_send_whenValidInput_thenGeneratesExpectedOutput` (Impact: 13.8)
  * `test_eventSourceResponse_whenUsingMemoryChannel_thenHandlesAsyncQueueCorrectly` (Impact: 12.8)
  * `app` (Impact: 11.6)
    * *Intent:* # Arrange # Create bounded memory channel for producer-consumer communication send_chan, recv_chan =...
  * `app` (Impact: 10.8)
    * *Intent:* # Arrange
  * `stream_numbers` (Impact: 10.8)
    * *Intent:* # Producer function that writes to the channel
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_detects_uvicorn_server_should_exit` (Impact: 2.7)
    * *Intent:* """Should detect when uvicorn Server.should_exit is set (Issue #132)."""
  * `test_detects_appstatus_should_exit` (Impact: 2.4)
    * *Intent:* """Should detect when AppStatus.should_exit is set (monkey-patch worked)."""
  * `test_fallback_when_no_uvicorn_server` (Impact: 2.4)
    * *Intent:* """Should work when _get_uvicorn_server returns None."""
  * `test_returns_server_when_handler_is_bound_method` (Impact: 2.0)
    * *Intent:* """Should extract Server from bound method handler."""
  * `test_returns_none_when_self_lacks_should_exit` (Impact: 2.0)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 89.98 | **LOC:** 114 | **CtrlFlow:** 3.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (37.079%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `reset_shutdown_state` (Impact: 4.0)
    * *Intent:* """Reset shutdown state before/after each test. It ensures clean state for tests involving AppStatus...
  * `app` (Impact: 3.9)
  * `endless` (Impact: 3.6)
  * `event_publisher` (Impact: 2.6)
  * `httpx_client` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 67.94 | **LOC:** 97 | **CtrlFlow:** 20.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (44.9554%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `encode` (Impact: 14.1)
  * `__init__` (Impact: 9.3)
  * `__init__` (Impact: 7.7)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 27.64 | **LOC:** 132 | **CtrlFlow:** 1.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (4.0875%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_server_sent_event` (Impact: 5.5)
  * `test_multiline_data` (Impact: 2.2)
  * `test_json_server_sent_event` (Impact: 1.8)
  * `test_ensure_bytes` (Impact: 1.8)
  * `test_custom_sep` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
