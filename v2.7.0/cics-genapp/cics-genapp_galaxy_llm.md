...
| Avg Path Length | 2.037 | Hops between files. Lower = Tighter coupling. |
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 98.8 | 41.5 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 60.9 | 11.4 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 5.4 | 2.3 | 2.3 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 50.0 | 41.1 | 50.0 | 50.0 |
...
| cleanup | 49 | 7 | 0 | `base/src/lgsetup.cbl` |
| guards | 14 | 5 | 0 | `base/cntl/db2cre.jcl` |
| danger | 125 | 33 | 1 | `base/src/lgtestp1.cbl` |
| concurrency | 12 | 5 | 0 | `base/cntl/asmmap.jcl` |
| connectivity | 28 | 28 | 1 | `base/cntl/cobol.jcl` |
| io | 518 | 51 | 11 | `base/src/lgsetup.cbl` |
| crypto | 0 | 0 | 0 | - |
| ipc | 238 | 31 | 7 | `base/src/lgipdb01.cbl` |
| time | 0 | 0 | 0 | - |
| serialization | 25 | 1 | 0 | `base/src/lgwebst5.cbl` |
| regex | 4 | 1 | 0 | `base/src/lgtestc1.cbl` |
| events | 48 | 38 | 1 | `base/src/lgtestc1.cbl` |
| tests | 0 | 0 | 0 | - |
| docs | 0 | 0 | 0 | - |
| debt | 60 | 16 | 1 | `base/src/lgwebst5.cbl` |
| mutation | 2315 | 61 | 66 | `base/src/lgwebst5.cbl` |
| dead_code | 101 | 31 | 3 | `base/src/lgipdb01.cbl` |
| credential | 1 | 1 | 0 | `base/src/lgacdb01.cbl` |
| threat | 581 | 32 | 13 | `base/src/lgsetup.cbl` |
| ml_ai | 1 | 1 | 0 | `base/src/lgicvs01.cbl` |
| ui | 43 | 5 | 0 | `base/src/lgtestp1.cbl` |
...
- `base/src/lgsetup.cbl` (Hits: 62)
- `base/src/lgicvs01.cbl` (Hits: 35)
- `base/cntl/db2cre.jcl` (Hits: 32)
...
- `A-GAIN` (@ `base/src/lgtestp4.cbl`) -> Impact: **24.0** | LOC: 199
- `UPDATE-POLICY-DB2-INFO` (@ `base/src/lgupdb01.cbl`) -> Impact: **22.5** | LOC: 110
  * *Intent:* *================================================================* * 1) Use SELECT FOR UPDATE to obtain a lock on the row in the * * policy table, che...
- `MAINLINE` (@ `base/src/lgapdb01.cbl`) -> Impact: **20.2** | LOC: 105
  * *Intent:* *----------------------------------------------------------------*
- `MAINLINE` (@ `base/src/lgicvs01.cbl`) -> Impact: **19.6** | LOC: 133
  * *Intent:* *---------------------------------------------------------------*
- `A-GAIN` (@ `base/src/lgtestp1.cbl`) -> Impact: **18.0** | LOC: 204
- `A-GAIN` (@ `base/src/lgtestp2.cbl`) -> Impact: **18.0** | LOC: 191
- `A-GAIN` (@ `base/src/lgtestp3.cbl`) -> Impact: **18.0** | LOC: 187
- `GET-ENDOW-DB2-INFO` (@ `base/src/lgipdb01.cbl`) -> Impact: **16.3** | LOC: 106
  * *Intent:* *----------------------------------------------------------------* *================================================================* * Use Select on ...
- `A-GAIN` (@ `base/src/lgtestc1.cbl`) -> Impact: **15.5** | LOC: 159
- `MAINLINE` (@ `base/src/lgipdb01.cbl`) -> Impact: **15.2** | LOC: 84
  * *Intent:* *----------------------------------------------------------------*

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `base/src` | 45 | 3251.17 | 58.35% | 18.42% |
...
- `base/src/lgtestp3.cbl` -> **100.0%** Exposure
...
### 1. `base/src/lgicvs01.cbl` (COBOL) -> Cumulative Risk: **552.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 88.3 | **LOC:** 231 | **CtrlFlow:** 6.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9868%), Cognitive Load (90.2227%), Concurrency (89.0666%)
- **Heaviest Functions:** `MAINLINE` (Impact: 19.6), `A-EXIT` (Impact: 1.1)

### 2. `base/src/lgupdb01.cbl` (COBOL) -> Cumulative Risk: **543.9**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 173.78 | **LOC:** 536 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9982%), Safety Score (87.5827%), Cognitive Load (84.2774%)
- **Heaviest Functions:** `UPDATE-POLICY-DB2-INFO` (Impact: 22.5), `CLOSE-PCURSOR` (Impact: 6.0), `UPDATE-MOTOR-DB2-INFO` (Impact: 5.8)

### 3. `base/src/lgacdb01.cbl` (COBOL) -> Cumulative Risk: **542.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 90.56 | **LOC:** 329 | **CtrlFlow:** 5.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9859%), Secrets Risk (99.0093%), Safety Score (83.863%)
- **Heaviest Functions:** `INSERT-CUSTOMER` (Impact: 8.7), `MAINLINE` (Impact: 6.2), `WRITE-ERROR-MESSAGE` (Impact: 5.7)

### 4. `base/src/lgapdb01.cbl` (COBOL) -> Cumulative Risk: **527.92**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 186.96 | **LOC:** 596 | **CtrlFlow:** 6.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9942%), Safety Score (85.7465%), Verification (80.0%)
- **Heaviest Functions:** `MAINLINE` (Impact: 20.2), `INSERT-POLICY` (Impact: 8.1), `INSERT-ENDOW` (Impact: 7.0)

### 5. `base/src/lgipdb01.cbl` (COBOL) -> Cumulative Risk: **525.78**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 436.08 | **LOC:** 1031 | **CtrlFlow:** 8.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (92.4556%), Verification (80.0%)
- **Heaviest Functions:** `GET-ENDOW-DB2-INFO` (Impact: 16.3), `MAINLINE` (Impact: 15.2), `GET-MOTOR-DB2-INFO` (Impact: 13.7)

### 6. `base/src/lgstsq.cbl` (COBOL) -> Cumulative Risk: **508.68**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 43.8 | **LOC:** 127 | **CtrlFlow:** 4.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9997%), Cognitive Load (90.9363%), Safety Score (88.6667%)
- **Heaviest Functions:** `MAINLINE` (Impact: 8.0), `A-EXIT` (Impact: 1.1)

### 7. `base/src/lgtestc1.cbl` (COBOL) -> Cumulative Risk: **493.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 163.04 | **LOC:** 348 | **CtrlFlow:** 5.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Cognitive Load (99.3398%), Safety Score (95.8476%)
- **Heaviest Functions:** `A-GAIN` (Impact: 15.5), `WRITE-GENACNTL` (Impact: 8.2), `MAINLINE` (Impact: 2.8)

### 8. `base/src/lgapol01.cbl` (COBOL) -> Cumulative Risk: **489.45**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 46.88 | **LOC:** 170 | **CtrlFlow:** 5.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9994%), Cognitive Load (89.3175%), Safety Score (87.8857%)
- **Heaviest Functions:** `WRITE-ERROR-MESSAGE` (Impact: 5.7), `MAINLINE` (Impact: 5.3), `MAINLINE-EXIT` (Impact: 1.1)

### 9. `base/src/lgacus01.cbl` (COBOL) -> Cumulative Risk: **483.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 50.4 | **LOC:** 180 | **CtrlFlow:** 5.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9993%), Safety Score (87.8959%), Cognitive Load (87.7441%)
- **Heaviest Functions:** `WRITE-ERROR-MESSAGE` (Impact: 5.7), `MAINLINE` (Impact: 5.3), `INSERT-CUSTOMER` (Impact: 1.4)

### 10. `base/src/lgicus01.cbl` (COBOL) -> Cumulative Risk: **482.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 50.82 | **LOC:** 167 | **CtrlFlow:** 5.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9992%), Safety Score (87.7129%), Cognitive Load (87.1766%)
- **Heaviest Functions:** `WRITE-ERROR-MESSAGE` (Impact: 5.6), `MAINLINE` (Impact: 4.7), `GET-CUSTOMER-INFO` (Impact: 1.4)
...
**Top Internal Functions/Classes:**
  * `GET-ENDOW-DB2-INFO` (Impact: 16.3)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `MAINLINE` (Impact: 15.2)
    * *Intent:* *----------------------------------------------------------------*
  * `GET-MOTOR-DB2-INFO` (Impact: 13.7)
    * *Intent:* *================================================================* * Use Select on join of Policy an...
  * `GET-HOUSE-DB2-INFO` (Impact: 13.2)
    * *Intent:* *================================================================* * Use Select on join of Policy an...
  * `GET-Commercial-DB2-INFO-1` (Impact: 11.5)
    * *Intent:* *================================================================* * Use Select on join of Policy an...
...
* *Architecture:* `io: 11`, `api: 1`, `concurrency: 1`
* *Defense:* None
* *Network Topology:*
...
**Top Internal Functions/Classes:**
  * `MAINLINE` (Impact: 20.2)
    * *Intent:* *----------------------------------------------------------------*
  * `INSERT-POLICY` (Impact: 8.1)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `INSERT-ENDOW` (Impact: 7.0)
    * *Intent:* *================================================================* * Issue INSERT on endowment table...
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `INSERT-MOTOR` (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  * `UPDATE-POLICY-DB2-INFO` (Impact: 22.5)
    * *Intent:* *================================================================* * 1) Use SELECT FOR UPDATE to obt...
  * `CLOSE-PCURSOR` (Impact: 6.0)
  * `UPDATE-MOTOR-DB2-INFO` (Impact: 5.8)
    * *Intent:* *================================================================* * Update row in Motor table which...
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `UPDATE-ENDOW-DB2-INFO` (Impact: 5.6)
...
**Top Internal Functions/Classes:**
  * `INSERT-CUSTOMER` (Impact: 8.7)
    * *Intent:* *================================================================*
  * `MAINLINE` (Impact: 6.2)
    * *Intent:* *----------------------------------------------------------------*
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* *================================...
  * `Obtain-CUSTOMER-Number` (Impact: 3.6)
    * *Intent:* *----------------------------------------------------------------*
...
**Top Internal Functions/Classes:**
  * `MAINLINE` (Impact: 13.2)
    * *Intent:* *----------------------------------------------------------------*
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `UPDATE-POLICY-DB2-INFO` (Impact: 1.4)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `MAINLINE-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `DELETE-POLICY-DB2-INFO` (Impact: 3.0)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `MAINLINE-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 15 instances
...
**Top Internal Functions/Classes:**
  ...
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `INSERT-CUSTOMER-PASSWORD` (Impact: 3.2)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `MAINLINE-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 13 instances
...
**Top Internal Functions/Classes:**
  ...
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `DELETE-POLICY-DB2-INFO` (Impact: 1.4)
    * *Intent:* *----------------------------------------------------------------*
  * `MAINLINE-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `WRITE-ERROR-MESSAGE` (Impact: 5.7)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `UPDATE-CUSTOMER-INFO` (Impact: 5.5)
    * *Intent:* *----------------------------------------------------------------* *================================...
  * `MAINLINE` (Impact: 4.2)
    * *Intent:* *----------------------------------------------------------------*
  * `MAINLINE-EXIT` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `WRITE-ERROR-MESSAGE` (Impact: 5.6)
    * *Intent:* *================================================================* * Procedure to write error messag...
  * `MAINLINE` (Impact: 4.7)
    * *Intent:* *----------------------------------------------------------------*
  * `GET-CUSTOMER-INFO` (Impact: 1.4)
    * *Intent:* *----------------------------------------------------------------*
  * `MAINLINE-END` (Impact: 1.1)
    * *Intent:* *----------------------------------------------------------------* * END PROGRAM and return to calle...
  * `MAINLINE-EXIT` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  ...
  * `MAINLINE` (Impact: 4.9)
    * *Intent:* *----------------------------------------------------------------*
  * `UPDATE-CUSTOMER-INFO` (Impact: 1.4)
    * *Intent:* *----------------------------------------------------------------*
  * `MAINLINE-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
### `base/src/lgapol01.cbl` (COBOL | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 46.88 | **LOC:** 170 | **CtrlFlow:** 5.6% | **Authorship Centralization:** 0.0%
...
- `base/bin/install.sh` -> **Severity: 1.282** (Embedded: 0.0187 * Error Risk: 68.383%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `base/cntl/adef121.jcl` -> **Severity: 304.1** (Blast Radius: 6.082 * Doc Risk: 50.0%)
- `base/cntl/asmmap.jcl` -> **Severity: 304.1** (Blast Radius: 6.082 * Doc Risk: 50.0%)
- `base/cntl/cdef121.jcl` -> **Severity: 304.1** (Blast Radius: 6.082 * Doc Risk: 50.0%)
- `base/cntl/cdef122.jcl` -> **Severity: 304.1** (Blast Radius: 6.082 * Doc Risk: 50.0%)
- `base/cntl/cdef123.jcl` -> **Severity: 304.1** (Blast Radius: 6.082 * Doc Risk: 50.0%)
