...
| Avg Path Length | 5.2608 | Hops between files. Lower = Tighter coupling. |
...
- `platform_specific::put_image` (@ `matplotlib-3.10.8/extern/agg24-svn/src/platform/X11/agg_platform_support.cpp`) -> Impact: **449.5** | LOC: 221
  * *Intent:* //------------------------------------------------------------------------
- `platform_specific::load_pmap` (@ `matplotlib-3.10.8/extern/agg24-svn/src/platform/win32/agg_platform_support.cpp`) -> Impact: **387.4** | LOC: 267
  * *Intent:* //------------------------------------------------------------------------
- `markers` (@ `matplotlib-3.10.8/extern/agg24-svn/include/agg_renderer_markers.h`) -> Impact: **213.4** | LOC: 26
  * *Intent:* //--------------------------------------------------------------------
- `window_proc` (@ `matplotlib-3.10.8/extern/agg24-svn/src/platform/win32/agg_platform_support.cpp`) -> Impact: **212.5** | LOC: 360
  * *Intent:* //------------------------------------------------------------------------
- `handle_idcmp` (@ `matplotlib-3.10.8/extern/agg24-svn/src/platform/AmigaOS/agg_platform_support.cpp`) -> Impact: **204.2** | LOC: 204
  * *Intent:* //------------------------------------------------------------------------
- `markers` (@ `matplotlib-3.10.8/extern/agg24-svn/include/agg_renderer_markers.h`) -> Impact: **199.7** | LOC: 26
  * *Intent:* //--------------------------------------------------------------------
- `markers` (@ `matplotlib-3.10.8/extern/agg24-svn/include/agg_renderer_markers.h`) -> Impact: **193.0** | LOC: 38
  * *Intent:* //--------------------------------------------------------------------
- `markers` (@ `matplotlib-3.10.8/extern/agg24-svn/include/agg_renderer_markers.h`) -> Impact: **185.0** | LOC: 26
  * *Intent:* //--------------------------------------------------------------------
- `platform_support::load_img` (@ `matplotlib-3.10.8/extern/agg24-svn/src/platform/X11/agg_platform_support.cpp`) -> Impact: **168.7** | LOC: 221
  * *Intent:* //------------------------------------------------------------------------
- `curve4_div::recursive_bezier` (@ `matplotlib-3.10.8/extern/agg24-svn/src/agg_curves.cpp`) -> Impact: **165.5** | LOC: 210
  * *Intent:* //------------------------------------------------------------------------
...
- **Heaviest Functions:** `quick_sort` (Impact: 46.7), `binary_search_pos` (Impact: 15.2), `deserialize` (Impact: 13.4)
...
- **Heaviest Functions:** `rgba::from_wavelength` (Impact: 38.5), `add` (Impact: 17.1), `add` (Impact: 17.1)
...
- **Heaviest Functions:** `intersect_rectangles` (Impact: 9.5), `unite_rectangles` (Impact: 9.2), `clip` (Impact: 8.9)
...
- **Heaviest Functions:** `render_scanlines_compound` (Impact: 104.5), `render_scanlines_compound_layered` (Impact: 82.6), `render_scanlines_aa_solid` (Impact: 20.3)
...
- **Heaviest Functions:** `platform_specific::platform_specific` (Impact: 65.7), `platform_support::run` (Impact: 64.0), `platform_support::init` (Impact: 21.6)
...
- **Heaviest Functions:** `cbox_ctrl_impl::vertex` (Impact: 33.3), `cbox_ctrl_impl::rewind` (Impact: 15.9), `cbox_ctrl_impl::on_mouse_button_down` (Impact: 9.2)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `gamma_ctrl_impl::vertex` (Impact: 53.1), `gamma_ctrl_impl::rewind` (Impact: 36.0), `gamma_ctrl_impl::on_arrow_keys` (Impact: 28.1)
...
- **Heaviest Functions:** `sweep_scanline` (Impact: 14.6), `sweep_scanline` (Impact: 14.4), `render` (Impact: 13.0)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `rbox_ctrl_impl::vertex` (Impact: 56.3), `rbox_ctrl_impl::rewind` (Impact: 23.5), `rbox_ctrl_impl::on_arrow_keys` (Impact: 19.2)
...
- **Heaviest Functions:** `span` (Impact: 10.6), `span` (Impact: 10.6), `pixel` (Impact: 5.5)
...
**Top Internal Functions/Classes:**
  * `markers` (Impact: 213.4)
    * *Intent:* //--------------------------------------------------------------------
  * `markers` (Impact: 199.7)
    * *Intent:* //--------------------------------------------------------------------
  * `markers` (Impact: 193.0)
    * *Intent:* //--------------------------------------------------------------------
  * `markers` (Impact: 185.0)
    * *Intent:* //--------------------------------------------------------------------
  * `marker` (Impact: 86.2)
    * *Intent:* //--------------------------------------------------------------------
...
**Top Internal Functions/Classes:**
  * `stack_blur_rgba32` (Impact: 60.4)
    * *Intent:* //=======================================================stack_blur_rgba32
  * `stack_blur_rgb24` (Impact: 58.5)
    * *Intent:* //========================================================stack_blur_rgb24
  * `stack_blur_gray8` (Impact: 54.0)
...
**Top Internal Functions/Classes:**
  * `line_interpolator_aa3` (Impact: 69.8)
    * *Intent:* //---------------------------------------------------------------------
  * `line_interpolator_aa1` (Impact: 59.8)
    * *Intent:* //---------------------------------------------------------------------
  * `line3` (Impact: 32.1)
    * *Intent:* //-------------------------------------------------------------------------
  * `pie_hline` (Impact: 27.1)
    * *Intent:* //-------------------------------------------------------------------------
  * `line1` (Impact: 20.1)
    * *Intent:* //-------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.001034
...
**Top Internal Functions/Classes:**
  * `TrapezoidMapTriFinder::add_edge_to_tree` (Impact: 85.7)
  * `TrapezoidMapTriFinder::Node::search` (Impact: 59.1)
  * `TriContourGenerator::follow_boundary` (Impact: 57.0)
  * `Triangulation::Triangulation` (Impact: 52.9)
  * `TriContourGenerator::follow_interior` (Impact: 38.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `platform_specific::put_image` (Impact: 449.5)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::load_img` (Impact: 168.7)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::save_img` (Impact: 130.8)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::init` (Impact: 110.8)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::run` (Impact: 95.0)
    * *Intent:* //------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `blend_hline` (Impact: 33.9)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_vline` (Impact: 33.7)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_color_hspan` (Impact: 31.0)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_color_vspan` (Impact: 30.8)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from` (Impact: 27.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.00698
...
**Top Internal Functions/Classes:**
  * `platform_specific::load_pmap` (Impact: 387.4)
    * *Intent:* //------------------------------------------------------------------------
  * `window_proc` (Impact: 212.5)
    * *Intent:* //------------------------------------------------------------------------
  * `convert_pmap` (Impact: 134.6)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::platform_specific` (Impact: 93.3)
    * *Intent:* //------------------------------------------------------------------------
  * `tokenizer::next_token` (Impact: 40.4)
    * *Intent:* //-----------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `convertKeyEvent` (Impact: 83.4)
  * `FigureCanvas_set_cursor` (Impact: 23.7)
  * `flagsChanged` (Impact: 21.0)
    * *Intent:* // flagsChanged gets called whenever a modifier key is pressed OR released // so we need to handle b...
  * `FigureCanvas_init` (Impact: 20.1)
  * `Timer__timer_start` (Impact: 19.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `point_in_path_impl` (Impact: 72.5)
    * *Intent:* // Related work by Samosky is in: // // Samosky, Joseph, "SectionView: A system for interactively sp...
  * `segments_intersect` (Impact: 62.2)
  * `clip_path_to_rect` (Impact: 37.0)
  * `point_in_path_collection` (Impact: 36.1)
  * `__convert_to_string` (Impact: 35.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `generate` (Impact: 83.6)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 42.7)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 42.4)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 42.4)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 20.2)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.003232
...
**Top Internal Functions/Classes:**
  * `line_interpolator_image` (Impact: 101.5)
    * *Intent:* //---------------------------------------------------------------------
  * `line3` (Impact: 32.3)
    * *Intent:* //-------------------------------------------------------------------------
  * `step_hor` (Impact: 19.1)
    * *Intent:* //---------------------------------------------------------------------
  * `step_ver` (Impact: 19.1)
    * *Intent:* //---------------------------------------------------------------------
  * `pixel` (Impact: 17.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `rgba::from_wavelength` (Impact: 38.5)
    * *Intent:* //------------------------------------------------------------------------
  * `add` (Impact: 17.1)
    * *Intent:* //--------------------------------------------------------------------
  * `add` (Impact: 17.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000109 | `Ripple Effect (Closeness):` 0.027554
...
**Top Internal Functions/Classes:**
  * `generate` (Impact: 83.4)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 38.0)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 37.7)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 37.7)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 17.6)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `blend_from_color` (Impact: 30.0)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from_lut` (Impact: 30.0)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from` (Impact: 27.9)
    * *Intent:* //--------------------------------------------------------------------
  * `clip_rect_area` (Impact: 26.7)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_color_hspan` (Impact: 22.4)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 114 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.1e-05 | `Ripple Effect (Closeness):` 0.012887
...
**Top Internal Functions/Classes:**
  ...
  * `vertex` (Impact: 79.6)
  * `vertex` (Impact: 59.2)
  * `should_snap` (Impact: 30.1)
  * `draw_clipped_line` (Impact: 18.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5.2e-05 | `Ripple Effect (Closeness):` 0.004137
...
**Top Internal Functions/Classes:**
  * `handle_idcmp` (Impact: 204.2)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::load_img` (Impact: 54.0)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::platform_specific` (Impact: 45.1)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::init` (Impact: 30.5)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::handle_input` (Impact: 12.7)
    * *Intent:* //------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `blend_from` (Impact: 33.8)
    * *Intent:* //-------------------------------------------------------------------- // Blend from an RGBA surface...
  * `blend_color_hspan` (Impact: 31.1)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_color_vspan` (Impact: 30.8)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from_lut` (Impact: 25.9)
    * *Intent:* //-------------------------------------------------------------------- // Blend from color table, us...
  * `blend_hline` (Impact: 23.5)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.002068
...
**Top Internal Functions/Classes:**
  * `platform_specific::load_pmap` (Impact: 163.3)
    * *Intent:* //------------------------------------------------------------------------
  * `DoKeyDown` (Impact: 47.8)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::save_pmap` (Impact: 34.5)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::platform_specific` (Impact: 31.0)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_specific::display_pmap` (Impact: 30.2)
    * *Intent:* //------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `quick_sort` (Impact: 46.7)
    * *Intent:* //--------------------------------------------------------------quick_sort
  * `binary_search_pos` (Impact: 15.2)
    * *Intent:* //------------------------------------------------------binary_search_pos
  * `deserialize` (Impact: 13.4)
  * `allocate` (Impact: 10.1)
  * `remove_duplicates` (Impact: 7.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.3e-05 | `Ripple Effect (Closeness):` 0.053423
...
**Top Internal Functions/Classes:**
  * `render_scanlines_compound` (Impact: 104.5)
    * *Intent:* //=============================================render_scanlines_compound
  * `render_scanlines_compound_layered` (Impact: 82.6)
    * *Intent:* //=======================================render_scanlines_compound_layered
  * `render_scanlines_aa_solid` (Impact: 20.3)
    * *Intent:* //===============================================render_scanlines_aa_solid
  * `render_scanlines_bin_solid` (Impact: 17.7)
    * *Intent:* //==============================================render_scanlines_bin_solid
  * `render_scanline_aa` (Impact: 14.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 6.2e-05 | `Ripple Effect (Closeness):` 0.012249
...
**Top Internal Functions/Classes:**
  * `generate` (Impact: 80.8)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 28.6)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 28.2)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 28.1)
    * *Intent:* //--------------------------------------------------------------------
  * `generate` (Impact: 12.4)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `FT2Font::load_char` (Impact: 33.7)
  * `FT2Font::load_char_with_fallback` (Impact: 30.2)
  * `FT2Font::set_text` (Impact: 22.1)
  * `FT2Image::draw_bitmap` (Impact: 21.8)
  * `FT2Font::get_glyph_name` (Impact: 19.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `platform_specific::platform_specific` (Impact: 65.7)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::run` (Impact: 64.0)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::init` (Impact: 21.6)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::load_img` (Impact: 16.8)
    * *Intent:* //------------------------------------------------------------------------
  * `platform_support::create_img` (Impact: 11.7)
    * *Intent:* //------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `blend_from` (Impact: 24.7)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_hline` (Impact: 21.0)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_vline` (Impact: 21.0)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from_color` (Impact: 13.4)
    * *Intent:* //--------------------------------------------------------------------
  * `blend_from_lut` (Impact: 13.4)
    * *Intent:* //--------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
- `matplotlib-3.10.8/extern/agg24-svn/include/agg_basics.h` -> **Severity: 0.022** (Bridge: 0.0002 * Flux: 96.2713%)
- `matplotlib-3.10.8/extern/agg24-svn/include/ctrl/agg_polygon_ctrl.h` -> **Severity: 0.017** (Bridge: 0.0002 * Flux: 88.7383%)
- `matplotlib-3.10.8/extern/agg24-svn/include/agg_color_rgba.h` -> **Severity: 0.011** (Bridge: 0.0001 * Flux: 99.9999%)
- `matplotlib-3.10.8/extern/agg24-svn/include/ctrl/agg_ctrl.h` -> **Severity: 0.01** (Bridge: 0.0001 * Flux: 99.8989%)
- `matplotlib-3.10.8/extern/agg24-svn/include/agg_math_stroke.h` -> **Severity: 0.009** (Bridge: 0.0001 * Flux: 99.9955%)
