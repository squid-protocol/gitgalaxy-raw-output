...
- `file-control` (@ `cow.cbl`) -> Impact: **31.6** | LOC: 252
- `start-readfile` (@ `cowtemplate.cbl`) -> Impact: **6.7** | LOC: 53
- `file-control` (@ `cowtemplate.cbl`) -> Impact: **4.1** | LOC: 42
- `web-header` (@ `cow.cbl`) -> Impact: **2.3** | LOC: 26
- `RUN` (@ `Dockerfile`) -> Impact: **2.1** | LOC: 2
- `RUN` (@ `Dockerfile`) -> Impact: **2.1** | LOC: 3
- `start-checkfilestatus` (@ `cowtemplate.cbl`) -> Impact: **2.1** | LOC: 3
- `RUN` (@ `Dockerfile`) -> Impact: **1.1** | LOC: 3
- `CMD` (@ `Dockerfile`) -> Impact: **1.1** | LOC: 1
- `ENTRYPOINT` (@ `Dockerfile`) -> Impact: **1.1** | LOC: 1
...
- **Heaviest Functions:** `start-readfile` (Impact: 6.7), `file-control` (Impact: 4.1), `start-checkfilestatus` (Impact: 2.1)
...
- **Heaviest Functions:** `file-control` (Impact: 31.6), `web-header` (Impact: 2.3), `bad-query-error` (Impact: 1.1)
...
- **Heaviest Functions:** `RUN` (Impact: 2.1), `RUN` (Impact: 2.1), `RUN` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `start-readfile` (Impact: 6.7)
  * `file-control` (Impact: 4.1)
  * `start-checkfilestatus` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  * `file-control` (Impact: 31.6)
  * `web-header` (Impact: 2.3)
  * `bad-query-error` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
