...
| Avg Path Length | 2.0237 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 21.3 | 9.5 | 0.0 |
...
| dead_code | 1078 | 43 | 4 | `src/deps/cimport.zig` |
...
- `UserPassSession` (@ `src/http_auth.zig`) -> Impact: **70.7** | LOC: 237
  * *Intent:* /// /// Comptime Parameters: /// /// - `Lookup` must implement .get([]const u8) -> []const u8 for user password retrieval /// - `lockedPwLookups` : if...
- `fio_risky_hash` (@ `src/deps/cimport.zig`) -> Impact: **60.1** | LOC: 282
- `Handler` (@ `src/websockets.zig`) -> Impact: **55.4** | LOC: 232
...
- `main` (@ `facil.io/tests/slowloris.c`) -> Impact: **55.3** | LOC: 102
  * *Intent:* ***************************************************************************** */
- `parseBinfilesFrom` (@ `src/request.zig`) -> Impact: **49.5** | LOC: 124
- `_internal_authenticateRequest` (@ `src/http_auth.zig`) -> Impact: **47.8** | LOC: 89
- `fio_risky_hash2` (@ `facil.io/tests/collisions.c`) -> Impact: **42.5** | LOC: 90
  * *Intent:* /* Computes a facil.io Risky Hash. */
- `Basic` (@ `src/http_auth.zig`) -> Impact: **41.1** | LOC: 129
...
- **Heaviest Functions:** `fio_risky_hash` (Impact: 60.1), `fiobj_iseq` (Impact: 12.6), `fiobj_obj2cstr` (Impact: 12.4)
...
- **Heaviest Functions:** `Bind` (Impact: 37.0), `call` (Impact: 19.0), `callDetached` (Impact: 13.0)
...
- **Heaviest Functions:** `fiobj_obj2cstr` (Impact: 12.4), `fiobj_type_is` (Impact: 9.8), `fiobj_type` (Impact: 8.9)
...
- **Heaviest Functions:** `onRequest` (Impact: 7.8), `main` (Impact: 3.1), `onRequest` (Impact: 2.9)
...
- **Heaviest Functions:** `get` (Impact: 8.8), `main` (Impact: 3.5), `onRequest` (Impact: 2.9)
...
- **Heaviest Functions:** `main` (Impact: 8.0), `on_request` (Impact: 1.6)
...
- **Heaviest Functions:** `%.o` (Impact: 5.0), `remove/bearssl` (Impact: 3.6), `libdump` (Impact: 3.4)
...
- **Heaviest Functions:** `sendToDiscord` (Impact: 34.7), `command_update_readme` (Impact: 11.1), `get_tag_annotation` (Impact: 9.9)
...
- **Heaviest Functions:** `makeRequest` (Impact: 11.6), `makeRequestThread` (Impact: 2.1), `unauthorized` (Impact: 2.1)
...
- **Heaviest Functions:** `parseBinfilesFrom` (Impact: 49.5), `setCookie` (Impact: 30.6), `parseAcceptHeaders` (Impact: 28.2)
...
**Top Internal Functions/Classes:**
  * `fio_risky_hash` (Impact: 60.1)
  * `fiobj_iseq` (Impact: 12.6)
  * `fiobj_obj2cstr` (Impact: 12.4)
  * `fiobj_type_is` (Impact: 9.8)
  * `fiobj_type` (Impact: 8.9)
...
**Top Internal Functions/Classes:**
  * `fio_risky_hash2` (Impact: 42.5)
    * *Intent:* /* Computes a facil.io Risky Hash. */
  * `fio_risky_hash_old` (Impact: 33.2)
    * *Intent:* #undef fio_risky_consume
  * `load_words` (Impact: 14.3)
  * `add_bad4xxhash` (Impact: 14.3)
    * *Intent:* * U64 v4 = seed - PRIME64_1; * * do { * v1 += XXH_get64bits(p) * PRIME64_2; * p += 8; * v1 = XXH_rot...
  * `test_hash_function` (Impact: 11.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `fiobj_type_is` (Impact: 9.8)
  * `fiobj_type` (Impact: 8.9)
  * `fiobj_obj2num` (Impact: 7.5)
  * `fiobj_type_vtable` (Impact: 6.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `scan_batch` (Impact: 26.3)
    * *Intent:* significant digit is the most recent trit. n is the batch size. */ #if HWD_BITS == 32
  * `main` (Impact: 23.1)
  * `run_test` (Impact: 21.5)
  * `compute_pvalue` (Impact: 18.8)
    * *Intent:* #endif
  * `scan_batch` (Impact: 13.3)
    * *Intent:* #else
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `checkEndpointType` (Impact: 25.2)
  * `onRequest` (Impact: 21.4)
  * `onRequest` (Impact: 20.2)
  * `Authenticating` (Impact: 18.1)
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 55.3)
    * *Intent:* ***************************************************************************** */
  * `test_server` (Impact: 28.4)
    * *Intent:* ***************************************************************************** */
  * `attack_server` (Impact: 25.4)
    * *Intent:* ***************************************************************************** */
  * `wait__internal` (Impact: 18.6)
    * *Intent:* ***************************************************************************** */ /** Waits for socke...
  * `test_server_task` (Impact: 15.5)
...
**Top Internal Functions/Classes:**
  * `checkEndpointType` (Impact: 26.8)
  * `Authenticating` (Impact: 18.1)
    * *Intent:* /// Wrap an endpoint with an Authenticator
  * `onRequest` (Impact: 16.6)
  * `Bind` (Impact: 15.0)
  * `onRequest` (Impact: 14.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 4.4e-05 | `Ripple Effect (Closeness):` 0.207971
...
**Top Internal Functions/Classes:**
  * `mustache_test_callback` (Impact: 37.3)
  * `mustache_print_instructions` (Impact: 21.9)
  * `mustache_on_section_test` (Impact: 12.1)
  * `mustache_test` (Impact: 10.0)
...
**Top Internal Functions/Classes:**
  ...
  * `internal_subscription_on_message` (Impact: 7.2)
  * `internal_on_message` (Impact: 6.5)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.037163 | `Ripple Effect (Closeness):` 0.393336
...
**Top Internal Functions/Classes:**
  * `initialize_cli` (Impact: 31.8)
    * *Intent:* ***************************************************************************** */
  * `on_http_upgrade` (Impact: 23.6)
    * *Intent:* /* HTTP upgrade callback */
  * `main` (Impact: 8.5)
  * `initialize_redis` (Impact: 4.8)
    * *Intent:* ***************************************************************************** */
  * `ws_on_message` (Impact: 2.6)
    * *Intent:* ***************************************************************************** */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 22.6)
    * *Intent:* */
  * `answer_http_upgrade` (Impact: 14.4)
  * `handle_websocket_messages` (Impact: 11.2)
  * `redis_initialize` (Impact: 5.8)
  * `logger_publish` (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 32.6)
    * *Intent:* ***************************************************************************** */
  * `on_connect` (Impact: 4.4)
  * `on_data` (Impact: 4.2)
    * *Intent:* ***************************************************************************** */
  * `repl_on_data` (Impact: 4.0)
    * *Intent:* ***************************************************************************** */
  * `on_shutdown` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  ...
  * `fiobj_mustache_build2` (Impact: 2.0)
  * `fiobj_mustache_build` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- `src/zap.zig` -> **Severity: 2.638** (Bridge: 0.0372 * Flux: 70.9739%)
- `src/endpoint.zig` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 14.2145%)
