...
- `__init__` (@ `google_cloud_core-2.5.1/google/cloud/client/__init__.py`) -> Impact: **49.4** | LOC: 49
- `api_request` (@ `google_cloud_core-2.5.1/google/cloud/_http/__init__.py`) -> Impact: **32.0** | LOC: 117
- `_name_from_project_path` (@ `google_cloud_core-2.5.1/google/cloud/_helpers/__init__.py`) -> Impact: **24.1** | LOC: 41
...
- `_make_request` (@ `google_cloud_core-2.5.1/google/cloud/_http/__init__.py`) -> Impact: **19.2** | LOC: 68
- `get_api_base_url_for_mtls` (@ `google_cloud_core-2.5.1/google/cloud/_http/__init__.py`) -> Impact: **17.5** | LOC: 39
...
- `build_api_url` (@ `google_cloud_core-2.5.1/google/cloud/_http/__init__.py`) -> Impact: **17.1** | LOC: 48
- `from_service_account_info` (@ `google_cloud_core-2.5.1/google/cloud/client/__init__.py`) -> Impact: **10.3** | LOC: 28
...
- `_rfc3339_nanos_to_datetime` (@ `google_cloud_core-2.5.1/google/cloud/_helpers/__init__.py`) -> Impact: **10.1** | LOC: 33
...
- `_to_bytes` (@ `google_cloud_core-2.5.1/google/cloud/_helpers/__init__.py`) -> Impact: **9.9** | LOC: 24
...
- **Heaviest Functions:** `__init__` (Impact: 8.3), `__exit__` (Impact: 4.6), `__exit__` (Impact: 2.4)
...
- **Heaviest Functions:** `api_request` (Impact: 32.0), `_make_request` (Impact: 19.2), `get_api_base_url_for_mtls` (Impact: 17.5)
...
- **Heaviest Functions:** `_name_from_project_path` (Impact: 24.1), `_rfc3339_nanos_to_datetime` (Impact: 10.1), `_to_bytes` (Impact: 9.9)
...
- **Heaviest Functions:** `__init__` (Impact: 49.4), `__init__` (Impact: 19.6), `from_service_account_info` (Impact: 10.3)
...
- **Heaviest Functions:** `_update_state` (Impact: 9.6), `register_type` (Impact: 7.9), `_get_operation` (Impact: 4.7)
...
- **Heaviest Functions:** `_from_service_account_json_helper` (Impact: 8.7), `_from_service_account_info_helper` (Impact: 6.5), `_explicit_ctor_helper` (Impact: 5.9)
...
- **Heaviest Functions:** `_call_fut` (Impact: 4.3), `test_from_dict` (Impact: 2.8), `test_from_pb_w_metadata_and_kwargs` (Impact: 2.7)
...
- **Heaviest Functions:** `test_w_truncated_nanos` (Impact: 4.6), `_helper` (Impact: 3.5), `test_w_naonseconds` (Impact: 2.8)
...
- **Heaviest Functions:** `test_api_request_w_query_params` (Impact: 3.2), `test_api_request_w_extra_headers` (Impact: 2.9), `test_api_request_defaults` (Impact: 2.8)
...
- **Heaviest Functions:** `test_namespace_package_compat` (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  * `test_w_truncated_nanos` (Impact: 4.6)
  * `_helper` (Impact: 3.5)
  * `test_w_naonseconds` (Impact: 2.8)
  * `test_it` (Impact: 2.8)
  * `test_w_microseconds` (Impact: 2.7)
...
**Top Internal Functions/Classes:**
  * `_from_service_account_json_helper` (Impact: 8.7)
  * `_from_service_account_info_helper` (Impact: 6.5)
  * `_explicit_ctor_helper` (Impact: 5.9)
  * `test_from_service_account_json_with_posarg` (Impact: 3.1)
  * `test_ctor__http_property_new` (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_api_request_w_query_params` (Impact: 3.2)
  * `test_api_request_w_extra_headers` (Impact: 2.9)
  * `test_api_request_defaults` (Impact: 2.8)
  * `test_api_request_w_timeout` (Impact: 2.8)
  * `test__make_request_no_data_no_content_type_no_headers` (Impact: 2.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `api_request` (Impact: 32.0)
  * `_make_request` (Impact: 19.2)
  * `get_api_base_url_for_mtls` (Impact: 17.5)
    * *Intent:* """Return the api base url for mutual TLS. Typically, you shouldn't need to use this method. The log...
  * `build_api_url` (Impact: 17.1)
  * `_do_request` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_from_dict` (Impact: 2.8)
  * `test_from_pb_w_metadata_and_kwargs` (Impact: 2.7)
  * `test_from_pb_w_unknown_metadata` (Impact: 2.6)
  * `test_poll_http` (Impact: 2.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_namespace_package_compat` (Impact: 2.3)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_complain_noop` (Impact: 1.2)
  * `test_complain` (Impact: 1.2)
**Structural Signatures (Net Mitigated Signals):**
