...
- `_siblings` (@ `lib/Mojo/DOM.pm`) -> Impact: **421.8** | LOC: 807
- `parse` (@ `lib/Mojo/Template.pm`) -> Impact: **128.6** | LOC: 112
- `attr` (@ `lib/Mojo/Base.pm`) -> Impact: **89.2** | LOC: 69
- `_compile` (@ `lib/Mojo/DOM/CSS.pm`) -> Impact: **89.2** | LOC: 58
- `_pc` (@ `lib/Mojo/DOM/CSS.pm`) -> Impact: **88.6** | LOC: 57
- `run` (@ `lib/Mojolicious/Command/get.pm`) -> Impact: **72.8** | LOC: 70
- `parse` (@ `lib/Mojo/DOM/HTML.pm`) -> Impact: **68.7** | LOC: 73
- `proxy` (@ `t/mojo/lib/Mojo/TestConnectProxy.pm`) -> Impact: **65.8** | LOC: 76
  * *Intent:* # CONNECT proxy server for testing
- `build_frame` (@ `lib/Mojo/WebSocket.pm`) -> Impact: **64.2** | LOC: 39
- `_listen` (@ `lib/Mojo/Server/Daemon.pm`) -> Impact: **63.7** | LOC: 49
...
- **Heaviest Functions:** `proxy` (Impact: 65.8)
...
- **Heaviest Functions:** `_all` (Impact: 22.6), `_settle` (Impact: 18.9), `map` (Impact: 14.9)
...
- **Heaviest Functions:** `_expand` (Impact: 23.6), `_tls` (Impact: 14.6), `negotiate` (Impact: 9.0)
...
- **Heaviest Functions:** `listen` (Impact: 57.8), `_accept` (Impact: 11.0), `DESTROY` (Impact: 10.1)
...
- **Heaviest Functions:** `_listen` (Impact: 63.7), `_build_tx` (Impact: 28.9), `_write` (Impact: 21.5)
...
- **Heaviest Functions:** `_url` (Impact: 39.1), `app` (Impact: 11.0), `nb_url` (Impact: 1.5)
...
- **Heaviest Functions:** `connect` (Impact: 29.2), `_connect` (Impact: 25.7), `_try_socks` (Impact: 11.1)
...
- **Heaviest Functions:** `_remove` (Impact: 18.1), `_stream` (Impact: 14.0), `server` (Impact: 8.3)
...
- **Heaviest Functions:** `_read` (Impact: 13.4), `timeout` (Impact: 11.3), `_write` (Impact: 10.7)
...
- **Heaviest Functions:** `punycode_encode` (Impact: 32.0), `network_contains` (Impact: 27.0), `_entity` (Impact: 24.8)
...
**Top Internal Functions/Classes:**
  * `_message` (Impact: 25.4)
  * `new` (Impact: 18.5)
  * `_request_ok` (Impact: 17.3)
  * `json_is` (Impact: 11.6)
  * `json_message_is` (Impact: 11.6)
...
**Top Internal Functions/Classes:**
  * `_siblings` (Impact: 421.8)
  * `val` (Impact: 26.4)
  * `_text` (Impact: 20.9)
  * `_wrap` (Impact: 19.2)
  * `namespace` (Impact: 16.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `punycode_encode` (Impact: 32.0)
    * *Intent:* # Direct translation of RFC 3492
  * `network_contains` (Impact: 27.0)
  * `_entity` (Impact: 24.8)
  * `_header` (Impact: 22.1)
  * `punycode_decode` (Impact: 21.3)
    * *Intent:* # Direct translation of RFC 3492
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_compile` (Impact: 89.2)
  * `_pc` (Impact: 88.6)
  * `_equation` (Impact: 34.7)
  * `_value` (Impact: 33.1)
  * `_selector` (Impact: 32.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_connect` (Impact: 44.7)
  * `_connection` (Impact: 41.5)
  * `_start` (Impact: 25.9)
  * `_dequeue` (Impact: 25.4)
  * `_finish` (Impact: 25.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `parse` (Impact: 39.7)
  * `_parse_chunked` (Impact: 29.8)
  * `_decompress` (Impact: 14.8)
  * `generate_body_chunk` (Impact: 14.4)
  * `write_chunk` (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `render` (Impact: 27.5)
  * `url_for` (Impact: 24.4)
  * `rendered` (Impact: 22.2)
  * `every_signed_cookie` (Impact: 18.6)
  * `send` (Impact: 16.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_settle` (Impact: 18.9)
  * `map` (Impact: 14.9)
  * `_finally` (Impact: 12.0)
  * `AWAIT_GET` (Impact: 10.2)
**Contextual Mitigations & Amplifications:**
