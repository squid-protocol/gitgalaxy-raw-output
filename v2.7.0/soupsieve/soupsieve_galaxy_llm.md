...
- `parse_selectors` (@ `soupsieve-2.8.3/soupsieve/css_parser.py`) -> Impact: **127.6** | LOC: 182
- `match_lang` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **114.2** | LOC: 85
  * *Intent:* """Match languages."""
- `parse_pseudo_class` (@ `soupsieve-2.8.3/soupsieve/css_parser.py`) -> Impact: **110.9** | LOC: 101
- `match_nth` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **103.0** | LOC: 100
  * *Intent:* """Match `nth` elements."""
- `match_selectors` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **92.2** | LOC: 83
  * *Intent:* """Check if element matches one of the selectors."""
- `parse_attribute_selector` (@ `soupsieve-2.8.3/soupsieve/css_parser.py`) -> Impact: **77.2** | LOC: 69
  * *Intent:* """Create attribute selector from the returned regex match."""
- `parse_value` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **70.7** | LOC: 53
  * *Intent:* """Parse the input value."""
- `match_dir` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **66.9** | LOC: 58
  * *Intent:* """Check directionality."""
- `parse_pseudo_nth` (@ `soupsieve-2.8.3/soupsieve/css_parser.py`) -> Impact: **66.9** | LOC: 64
- `match_indeterminate` (@ `soupsieve-2.8.3/soupsieve/css_match.py`) -> Impact: **56.7** | LOC: 61
...
- **Heaviest Functions:** `_validate` (Impact: 12.5), `_validate` (Impact: 10.8), `_validate` (Impact: 10.8)
...
- **Heaviest Functions:** `compile` (Impact: 23.3), `match` (Impact: 8.5), `select` (Impact: 3.5)
...
- **Heaviest Functions:** `__new__` (Impact: 50.0), `parse_version` (Impact: 25.7), `_get_canonical` (Impact: 9.3)
...
- **Heaviest Functions:** `parse_selectors` (Impact: 127.6), `parse_pseudo_class` (Impact: 110.9), `parse_attribute_selector` (Impact: 77.2)
...
- **Heaviest Functions:** `match_lang` (Impact: 114.2), `match_nth` (Impact: 103.0), `match_selectors` (Impact: 92.2)
...
- **Heaviest Functions:** `get_pattern_context` (Impact: 19.3), `__init__` (Impact: 7.4), `lower` (Impact: 6.1)
...
- **Heaviest Functions:** `pretty` (Impact: 18.9)
...
- **Heaviest Functions:** `assert_selector` (Impact: 12.3), `available_parsers` (Impact: 12.3), `get_parsers` (Impact: 11.2)
...
- **Heaviest Functions:** `test_scope_is_select_target` (Impact: 9.7), `test_scope_cannot_select_target` (Impact: 3.3), `test_scope_is_root` (Impact: 2.3)

### 10. `soupsieve-2.8.3/tests/test_nesting_1/test_amp.py` (PYTHON) -> Cumulative Risk: **265.53**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 51.06 | **LOC:** 81 | **CtrlFlow:** 15.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (92.7861%), Stability (50.0%), Cognitive Load (15.4437%)
- **Heaviest Functions:** `test_amp_is_select_target` (Impact: 9.7), `test_amp_cannot_select_target` (Impact: 3.3), `test_amp_is_root` (Impact: 2.3)
...
**Top Internal Functions/Classes:**
  * `parse_selectors` (Impact: 127.6)
  * `parse_pseudo_class` (Impact: 110.9)
  * `parse_attribute_selector` (Impact: 77.2)
    * *Intent:* """Create attribute selector from the returned regex match."""
  * `parse_pseudo_nth` (Impact: 66.9)
  * `parse_combinator` (Impact: 37.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_select` (Impact: 4.0)
    * *Intent:* """Test select."""
  * `test_select_order` (Impact: 4.0)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_language_list` (Impact: 2.9)
    * *Intent:* """Test language list."""
  * `test_xml_style_language` (Impact: 2.9)
    * *Intent:* """Test XML style language."""
  * `test_language_in_xhtml` (Impact: 2.9)
    * *Intent:* """Test language in XHTML."""
  * `test_language_in_xhtml_without_html_style_lang` (Impact: 2.9)
    * *Intent:* """ Test language in XHTML. HTML namespace elements must use HTML style language. """
  * `test_language_in_header` (Impact: 2.7)
...
**Top Internal Functions/Classes:**
  * `test_nth_child_no_parent` (Impact: 5.5)
    * *Intent:* """Test `nth` child with no parent."""
  * `test_nth_child` (Impact: 2.9)
    * *Intent:* """Test `nth` child."""
  * `test_nth_child_odd` (Impact: 2.9)
    * *Intent:* """Test `nth` child odd."""
  * `test_nth_child_even` (Impact: 2.9)
    * *Intent:* """Test `nth` child even."""
  * `test_nth_child_complex` (Impact: 2.9)
...
**Top Internal Functions/Classes:**
  * `test_contains_own_cdata_lxml_html` (Impact: 5.1)
    * *Intent:* """Test contains CDATA in `lxml` HTML."""
  * `test_contains_own_cdata_html5` (Impact: 2.1)
    * *Intent:* """Test contains CDATA in HTML5."""
  * `test_contains_own_cdata_py_html` (Impact: 2.1)
    * *Intent:* """Test contains CDATA in Python HTML parser."""
  * `test_contains_own_cdata_xml` (Impact: 2.1)
    * *Intent:* """Test contains-own CDATA in XML."""
  * `test_contains_own_with_broken_text` (Impact: 2.1)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_has_mixed` (Impact: 2.2)
    * *Intent:* """Test has mixed."""
  * `test_has_nested_pseudo` (Impact: 2.2)
    * *Intent:* """Test has with nested pseudo."""
  * `test_has_descendant` (Impact: 1.9)
    * *Intent:* """Test has descendant."""
  * `test_has_next_sibling` (Impact: 1.9)
    * *Intent:* """Test has next sibling."""
  * `test_has_subsequent_sibling` (Impact: 1.9)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_in_range_number` (Impact: 2.9)
    * *Intent:* """Test in range number."""
  * `test_in_range_range` (Impact: 2.9)
    * *Intent:* """Test in range range."""
  * `test_in_range_month` (Impact: 2.9)
    * *Intent:* """Test in range month."""
  * `test_in_range_week` (Impact: 2.9)
    * *Intent:* """Test in range week."""
  * `test_in_range_date` (Impact: 2.9)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_out_of_range_number` (Impact: 2.9)
    * *Intent:* """Test in range number."""
  * `test_out_of_range_range` (Impact: 2.9)
    * *Intent:* """Test in range range."""
  * `test_out_of_range_month` (Impact: 2.9)
    * *Intent:* """Test in range month."""
  * `test_out_of_range_week` (Impact: 2.9)
    * *Intent:* """Test in range week."""
  * `test_out_of_range_date` (Impact: 2.9)
    * *Intent:* """Test in range date."""
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `structural_boundaries: 10`, `args: 7`, `func_start: 7`, `class_start: 1`
* *Risk/State:* `state_mutation: 7`, `unreferenced_by_name: 7`
