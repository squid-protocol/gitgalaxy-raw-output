...
- `get_docs_for_click` (@ `typer-0.24.1/typer/cli.py`) -> Impact: **80.8** | LOC: 82
- `_print_options_panel` (@ `typer-0.24.1/typer/rich_utils.py`) -> Impact: **64.2** | LOC: 109
- `get_help_record` (@ `typer-0.24.1/typer/core.py`) -> Impact: **61.9** | LOC: 94
...
- `_main` (@ `typer-0.24.1/typer/core.py`) -> Impact: **61.6** | LOC: 92
- `get_click_type` (@ `typer-0.24.1/typer/main.py`) -> Impact: **60.5** | LOC: 101
- `rich_format_help` (@ `typer-0.24.1/typer/rich_utils.py`) -> Impact: **55.0** | LOC: 140
- `_get_parameter_help` (@ `typer-0.24.1/typer/rich_utils.py`) -> Impact: **50.4** | LOC: 87
- `get_click_param` (@ `typer-0.24.1/typer/main.py`) -> Impact: **46.2** | LOC: 161
- `_get_default_string` (@ `typer-0.24.1/typer/core.py`) -> Impact: **42.6** | LOC: 47
- `__init__` (@ `typer-0.24.1/typer/models.py`) -> Impact: **40.2** | LOC: 125
...
### 1. `typer-0.24.1/typer/_completion_classes.py` (PYTHON) -> Cumulative Risk: **787.17**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 183.12 | **LOC:** 200 | **CtrlFlow:** 16.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9999%), Safety Score (98.4759%)
- **Heaviest Functions:** `complete` (Impact: 10.7), `get_completion_args` (Impact: 6.2), `get_completion_args` (Impact: 6.2)

### 2. `typer-0.24.1/typer/core.py` (PYTHON) -> Cumulative Risk: **753.21**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 691.78 | **LOC:** 822 | **CtrlFlow:** 20.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (97.6355%), Safety Score (96.8091%)
- **Heaviest Functions:** `get_help_record` (Impact: 61.9), `_main` (Impact: 61.6), `_get_default_string` (Impact: 42.6)

### 3. `typer-0.24.1/typer/utils.py` (PYTHON) -> Cumulative Risk: **716.73**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 135.3 | **LOC:** 198 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Safety Score (93.9204%)
- **Heaviest Functions:** `get_params_from_function` (Impact: 25.2), `__str__` (Impact: 7.6), `parse_boolean_env_var` (Impact: 7.4)

### 4. `typer-0.24.1/typer/cli.py` (PYTHON) -> Cumulative Risk: **656.9**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 372.18 | **LOC:** 318 | **CtrlFlow:** 27.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.0566%)
- **Heaviest Functions:** `get_docs_for_click` (Impact: 80.8), `get_typer_from_module` (Impact: 22.1), `docs` (Impact: 21.9)

### 5. `typer-0.24.1/typer/models.py` (PYTHON) -> Cumulative Risk: **630.93**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 232.74 | **LOC:** 652 | **CtrlFlow:** 1.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9331%), Safety Score (94.6737%), Documentation (87.5%)
- **Heaviest Functions:** `__init__` (Impact: 40.2), `__init__` (Impact: 29.9), `__init__` (Impact: 11.2)

### 6. `typer-0.24.1/typer/main.py` (PYTHON) -> Cumulative Risk: **620.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1081.96 | **LOC:** 2014 | **CtrlFlow:** 15.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9997%), Safety Score (95.7223%)
- **Heaviest Functions:** `get_click_type` (Impact: 60.5), `get_click_param` (Impact: 46.2), `solve_typer_info_help` (Impact: 32.9)

### 7. `typer-0.24.1/typer/completion.py` (PYTHON) -> Cumulative Risk: **618.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 102.88 | **LOC:** 147 | **CtrlFlow:** 19.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9995%), Safety Score (95.941%)
- **Heaviest Functions:** `shell_complete` (Impact: 14.3), `show_callback` (Impact: 12.9), `install_callback` (Impact: 10.5)

### 8. `typer-0.24.1/typer/_completion_shared.py` (PYTHON) -> Cumulative Risk: **615.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 165.82 | **LOC:** 253 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.7665%), Documentation (92.3077%)
- **Heaviest Functions:** `install` (Impact: 21.8), `install_powershell` (Impact: 14.1), `install_zsh` (Impact: 9.3)

### 9. `typer-0.24.1/typer/rich_utils.py` (PYTHON) -> Cumulative Risk: **584.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 584.4 | **LOC:** 754 | **CtrlFlow:** 17.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.597%), Verification (80.0%)
- **Heaviest Functions:** `_print_options_panel` (Impact: 64.2), `rich_format_help` (Impact: 55.0), `_get_parameter_help` (Impact: 50.4)

### 10. `typer-0.24.1/docs_src/options_autocompletion/tutorial003_an_py310.py` (PYTHON) -> Cumulative Risk: **533.85**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 20.58 | **LOC:** 30 | **CtrlFlow:** 15.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9254%), Safety Score (83.5974%)
- **Heaviest Functions:** `complete_name` (Impact: 4.5), `main` (Impact: 1.7)
...
- **Magnitude:** 1081.96 | **LOC:** 2014 | **CtrlFlow:** 15.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (35.115%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `get_click_type` (Impact: 60.5)
  * `get_click_param` (Impact: 46.2)
  * `solve_typer_info_help` (Impact: 32.9)
    * *Intent:* # Priority 1: Explicit value was set in app.add_typer() if not isinstance(typer_info.help, DefaultPl...
  * `get_param_callback` (Impact: 31.9)
  * `get_param_completion` (Impact: 28.0)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 584.4 | **LOC:** 754 | **CtrlFlow:** 17.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (62.695%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_print_options_panel` (Impact: 64.2)
  * `rich_format_help` (Impact: 55.0)
  * `_get_parameter_help` (Impact: 50.4)
  * `_print_commands_panel` (Impact: 30.6)
  * `_get_help_text` (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 372.18 | **LOC:** 318 | **CtrlFlow:** 27.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (76.1813%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `get_docs_for_click` (Impact: 80.8)
  * `get_typer_from_module` (Impact: 22.1)
    * *Intent:* # Try to get defined app if state.app: obj = getattr(module, state.app, None) if not isinstance(obj,...
  * `docs` (Impact: 21.9)
  * `maybe_update_state` (Impact: 13.7)
  * `maybe_add_run_to_cli` (Impact: 9.0)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 232.74 | **LOC:** 652 | **CtrlFlow:** 1.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (40.3435%), Tech Debt (13.088%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 40.2)
  * `__init__` (Impact: 29.9)
  * `__init__` (Impact: 11.2)
  * `__init__` (Impact: 6.6)
  * `__init__` (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (20.0927%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_markup_mode_newline_mixed` (Impact: 15.4)
  * `test_markup_mode_newline_pr815` (Impact: 11.8)
  * `test_markup_mode_bullets_double_newline` (Impact: 11.8)
  * `test_markup_mode_newline_issue447` (Impact: 11.7)
  * `test_markup_mode_bullets_single_newline` (Impact: 11.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 183.12 | **LOC:** 200 | **CtrlFlow:** 16.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (61.6073%), Tech Debt (99.9999%)
**Top Internal Functions/Classes:**
  * `complete` (Impact: 10.7)
  * `get_completion_args` (Impact: 6.2)
  * `get_completion_args` (Impact: 6.2)
  * `complete` (Impact: 6.1)
  * `format_completion` (Impact: 6.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 2 instances
...
- **Risk Profile:** Cognitive Load (17.178%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `names_callback` (Impact: 6.2)
  * `test_callback_4_list_none` (Impact: 6.1)
  * `main` (Impact: 4.6)
  * `test_too_many_parsers` (Impact: 4.1)
  * `test_forward_references` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 135.3 | **LOC:** 198 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (73.1059%), Tech Debt (80.6679%)
**Top Internal Functions/Classes:**
  * `get_params_from_function` (Impact: 25.2)
  * `__str__` (Impact: 7.6)
  * `parse_boolean_env_var` (Impact: 7.4)
  * `_split_annotation_from_typer_annotations` (Impact: 6.2)
  * `_param_type_to_user_string` (Impact: 4.7)
...
- **Risk Profile:** Cognitive Load (28.1826%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `opt` (Impact: 4.5)
  * `opt` (Impact: 4.5)
  * `opt` (Impact: 4.5)
  * `test_optional` (Impact: 3.9)
  * `test_union_type_optional` (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (25.315%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_help_table_alignment_with_styled_text` (Impact: 10.2)
  * `test_rich_markup_import_regression` (Impact: 3.8)
    * *Intent:* # Remove rich.markup if it was imported by other tests if "rich" in sys.modules: rich_module = sys.m...
  * `test_metavar_highlighter` (Impact: 2.8)
    * *Intent:* """ Test that the MetavarHighlighter works correctly. cf PR 1508 """
  * `main` (Impact: 2.6)
  * `test_rich_utils_click_rewrapp` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (2.3846%), Tech Debt (14.5799%)
**Top Internal Functions/Classes:**
  * `Option` (Impact: 31.2)
    * *Intent:* # Parameter default: Annotated[ Any | None, Doc( """
  * `Argument` (Impact: 26.0)
    * *Intent:* # Parameter default: Annotated[ Any | None, Doc( """
  * `Option` (Impact: 9.7)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 102.88 | **LOC:** 147 | **CtrlFlow:** 19.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (66.961%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `shell_complete` (Impact: 14.3)
  ...
  * `_install_completion_placeholder_function` (Impact: 7.8)
    * *Intent:* # Create a fake command function to extract the completion parameters
  * `_install_completion_no_auto_placeholder_function` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (21.7947%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_scripts` (Impact: 3.8)
  * `test_help` (Impact: 1.8)
  * `test_help_items` (Impact: 1.8)
  * `test_items_create` (Impact: 1.8)
  * `test_items_sell` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
**Top Internal Functions/Classes:**
  * `test_forbid_default_factory_and_default_value_in_annotated` (Impact: 2.6)
  * `test_forbid_default_and_default_factory_with_default_param` (Impact: 2.6)
  * `test_forbid_annotated_param_and_default_param` (Impact: 2.4)
  * `test_allow_default_factory_with_default_param` (Impact: 2.1)
  * `test_forbid_default_value_in_annotated_argument` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (16.9149%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_completion_install_zsh` (Impact: 4.9)
  * `test_completion_install_bash` (Impact: 3.9)
  * `test_completion_install_powershell` (Impact: 3.5)
  * `test_completion_install_fish` (Impact: 2.4)
  * `test_completion_install_no_shell` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (38.4913%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `cmd` (Impact: 4.5)
  * `test_annotated_option_with_argname_doesnt_mutate_multiple_calls` (Impact: 3.9)
  * `test_annotated_custom_path` (Impact: 2.9)
  * `test_annotated_argument_with_default_factory` (Impact: 1.9)
  * `test_annotated_argument_with_default` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_completion_complete_subcommand_fish` (Impact: 2.3)
  * `test_completion_complete_subcommand_bash` (Impact: 2.2)
  * `test_completion_complete_subcommand_zsh` (Impact: 2.2)
  * `test_completion_complete_subcommand_powershell` (Impact: 2.2)
  * `test_completion_complete_subcommand_pwsh` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (28.4877%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_help_delete_all` (Impact: 3.3)
  * `test_help` (Impact: 2.0)
  * `test_help_delete` (Impact: 1.8)
  * `test_script` (Impact: 1.8)
  * `test_help_create` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
* *High Risk Execution (weighted view):* 0
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_completion_colon_bash_all` (Impact: 1.8)
  * `test_completion_colon_bash_partial` (Impact: 1.8)
  * `test_completion_colon_bash_single` (Impact: 1.8)
  * `test_completion_colon_powershell_all` (Impact: 1.8)
  * `test_completion_colon_powershell_partial` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (25.4001%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_scripts` (Impact: 3.5)
  * `test_help` (Impact: 1.8)
  * `test_help_items` (Impact: 1.8)
  * `test_help_users` (Impact: 1.8)
  * `mod` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
- **Risk Profile:** Cognitive Load (7.87%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_typo_suggestion_multiple_matches` (Impact: 2.9)
    * *Intent:* """Test that multiple suggestions are shown when there are multiple close matches"""
  * `test_typo_suggestion_exact_match_works` (Impact: 2.0)
    * *Intent:* """Test that exact matches still work normally"""
  * `test_typo_suggestion_enabled` (Impact: 1.8)
    * *Intent:* """Test that typo suggestions work when enabled"""
  * `test_typo_suggestion_no_matches` (Impact: 1.8)
    * *Intent:* """Test that no suggestions are shown when there are no close matches"""
  * `test_typo_suggestion_disabled` (Impact: 1.8)
...
- **Risk Profile:** Cognitive Load (9.6614%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_install_completion` (Impact: 3.0)
  * `test_completion_source_bash` (Impact: 1.7)
  * `test_completion_source_powershell` (Impact: 1.7)
  * `test_completion_source_pwsh` (Impact: 1.7)
  * `test_show_completion` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 10 instances
* *Amplified Rce:* 10 instances
* *Amplified Cascading Flux:* 3 instances
...
- **Risk Profile:** Cognitive Load (45.4157%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_invalid_score` (Impact: 3.8)
  * `test_invalid_id` (Impact: 3.1)
  * `test_invalid_age` (Impact: 3.1)
  * `test_help_no_rich` (Impact: 2.1)
  * `test_help` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
- `typer-0.24.1/typer/main.py` -> **Severity: 0.48** (Bridge: 0.0048 * Flux: 99.9997%)
- `typer-0.24.1/typer/completion.py` -> **Severity: 0.178** (Bridge: 0.0018 * Flux: 99.9995%)
- `typer-0.24.1/typer/testing.py` -> **Severity: 0.089** (Bridge: 0.0053 * Flux: 16.7982%)
- `typer-0.24.1/typer/core.py` -> **Severity: 0.045** (Bridge: 0.0005 * Flux: 100.0%)
- `typer-0.24.1/typer/cli.py` -> **Severity: 0.012** (Bridge: 0.0001 * Flux: 100.0%)
