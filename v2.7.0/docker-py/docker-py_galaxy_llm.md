...
| Avg Path Length | 3.567 | Hops between files. Lower = Tighter coupling. |
...
- `build` (@ `docker/api/build.py`) -> Impact: **309.5** | LOC: 264
- `__init__` (@ `docker/types/services.py`) -> Impact: **189.9** | LOC: 93
- `__init__` (@ `docker/types/containers.py`) -> Impact: **130.1** | LOC: 102
- `_check_api_features` (@ `docker/api/service.py`) -> Impact: **119.7** | LOC: 92
- `logs` (@ `docker/api/container.py`) -> Impact: **113.5** | LOC: 81
- `__init__` (@ `docker/types/swarm.py`) -> Impact: **108.8** | LOC: 84
- `update_service` (@ `docker/api/service.py`) -> Impact: **103.2** | LOC: 118
- `__init__` (@ `docker/types/services.py`) -> Impact: **85.3** | LOC: 60
- `run` (@ `docker/models/containers.py`) -> Impact: **75.4** | LOC: 378
...
- **Heaviest Functions:** `create_api_error_from_http_exception` (Impact: 10.8), `__str__` (Impact: 9.4), `__init__` (Impact: 8.5)
...
- **Heaviest Functions:** `__init__` (Impact: 28.6), `_load_certs` (Impact: 15.4), `_load_meta` (Impact: 10.0)
...
- **Heaviest Functions:** `split_port` (Impact: 25.4), `port_range` (Impact: 11.6), `add_port` (Impact: 10.4)
...
- **Heaviest Functions:** `parse_host` (Impact: 68.5), `convert_volume_binds` (Impact: 30.9), `parse_bytes` (Impact: 21.7)
...
- **Heaviest Functions:** `__init__` (Impact: 1116.7), `__init__` (Impact: 130.1), `__init__` (Impact: 20.8)
...
- **Heaviest Functions:** `create_archive` (Impact: 41.7), `walk` (Impact: 26.0), `matches` (Impact: 21.7)
...
- **Heaviest Functions:** `__init__` (Impact: 189.9), `__init__` (Impact: 85.3), `__init__` (Impact: 38.3)
...
- **Heaviest Functions:** `recv_into` (Impact: 11.1), `settimeout` (Impact: 9.1), `makefile` (Impact: 8.3)
...
- **Heaviest Functions:** `_create_paramiko_client` (Impact: 17.1), `get_connection` (Impact: 11.3), `__init__` (Impact: 8.9)
...
- **Heaviest Functions:** `exec_create` (Impact: 43.3), `exec_start` (Impact: 22.7), `exec_resize` (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  * `test_remove_link` (Impact: 10.4)
    * *Intent:* # Create containers container1 = self.client.create_container( TEST_IMG, 'cat', detach=True, stdin_o...
  * `test_port` (Impact: 7.4)
  * `test_get_container_stats_no_stream` (Impact: 7.0)
  * `test_run_shlex_commands` (Impact: 6.6)
  * `test_remove` (Impact: 6.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_update_service_with_defaults_endpoint_spec` (Impact: 18.4)
  * `_update_service` (Impact: 12.1)
    * *Intent:* # service update tests seem to be a bit flaky # give them a chance to retry the update with a new ve...
  * `get_service_container` (Impact: 10.6)
  * `test_create_service_with_endpoint_spec` (Impact: 9.9)
  * `test_service_logs` (Impact: 8.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `logs` (Impact: 113.5)
  * `update_container` (Impact: 55.5)
  * `containers` (Impact: 49.8)
  * `create_container` (Impact: 37.0)
  * `attach` (Impact: 33.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `convert_volume_binds` (Impact: 30.9)
  * `parse_bytes` (Impact: 21.7)
  * `_convert_port_binding` (Impact: 18.3)
  * `compare_version` (Impact: 15.2)
...
**Top Internal Functions/Classes:**
  ...
  * `update_service` (Impact: 103.2)
  * `create_service` (Impact: 33.5)
  * `_merge_task_template` (Impact: 14.5)
  * `services` (Impact: 11.4)
...
**Top Internal Functions/Classes:**
  * `test_create_container_with_device_requests` (Impact: 4.4)
  * `test_create_container_with_port_binds` (Impact: 3.5)
  * `test_inspect_container_undefined_id` (Impact: 3.1)
  * `test_create_container_with_devices` (Impact: 2.8)
  * `test_create_container_with_named_volume` (Impact: 2.6)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `request` (Impact: 11.8)
  * `early_response_sending_handler` (Impact: 9.7)
  * `fake_resp` (Impact: 9.4)
  * `response` (Impact: 9.1)
  * `test_early_stream_response` (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
**Top Internal Functions/Classes:**
  * `run` (Impact: 75.4)
  * `_create_container_args` (Impact: 31.3)
    * *Intent:* """ Convert arguments to create() to arguments to create_container(). """
  * `list` (Impact: 21.4)
  * `exec_run` (Impact: 14.5)
  * `_host_volume_from_bind` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_build_with_cache_from` (Impact: 10.2)
  * `test_build_squash` (Impact: 6.8)
  * `build_squashed` (Impact: 6.2)
  * `test_build_with_dockerignore` (Impact: 6.0)
  * `test_build_with_extra_hosts` (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `build_squashed` (Impact: 6.2)
  * `test_build_with_extra_hosts` (Impact: 5.6)
  * `test_build_with_dockerignore` (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 57 instances
* *State Mutation (weighted view):* 242
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_list_sparse` (Impact: 6.6)
  * `test_list` (Impact: 6.5)
  * `test_ports_target_none` (Impact: 5.2)
  * `test_ports_target_tuple` (Impact: 5.2)
  * `test_ports_target_list` (Impact: 5.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_archive` (Impact: 41.7)
  * `walk` (Impact: 26.0)
  * `matches` (Impact: 21.7)
  * `rec_walk` (Impact: 21.4)
  * `tar` (Impact: 13.1)
**Contextual Mitigations & Amplifications:**
