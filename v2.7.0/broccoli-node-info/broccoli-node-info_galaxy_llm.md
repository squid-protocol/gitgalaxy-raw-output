...
- `getNodeInfo` (@ `package/index.js`) -> Impact: **30.5** | LOC: 72
- `InvalidNodeError` (@ `package/index.js`) -> Impact: **1.9** | LOC: 9
- `instantiationStack` (@ `package/index.js`) -> Impact: **1.1** | LOC: 3
...
- **Heaviest Functions:** `getNodeInfo` (Impact: 30.5), `InvalidNodeError` (Impact: 1.9), `instantiationStack` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `getNodeInfo` (Impact: 30.5)
  * `InvalidNodeError` (Impact: 1.9)
  * `instantiationStack` (Impact: 1.1)
