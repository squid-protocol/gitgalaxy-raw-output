...
| Avg Path Length | 2.5122 | Hops between files. Lower = Tighter coupling. |
...
- `pattern_to_regex` (@ `pathspec-1.0.4/benchmarks/gitwildmatch_v1.py`) -> Impact: **90.8** | LOC: 188
- `__normalize_segments` (@ `pathspec-1.0.4/pathspec/patterns/gitignore/basic.py`) -> Impact: **44.4** | LOC: 91
- `_init_db` (@ `pathspec-1.0.4/pathspec/_backends/hyperscan/gitignore.py`) -> Impact: **40.9** | LOC: 103
- `pattern_to_regex` (@ `pathspec-1.0.4/pathspec/patterns/gitignore/basic.py`) -> Impact: **38.8** | LOC: 117
- `debug_results` (@ `pathspec-1.0.4/tests/util.py`) -> Impact: **36.5** | LOC: 71
...
- `_init_set` (@ `pathspec-1.0.4/pathspec/_backends/re2/gitignore.py`) -> Impact: **35.7** | LOC: 88
- `_translate_segment_glob` (@ `pathspec-1.0.4/pathspec/patterns/gitignore/base.py`) -> Impact: **33.8** | LOC: 111
...
- `__on_match` (@ `pathspec-1.0.4/benchmarks/hyperscan_gitignore_r1.py`) -> Impact: **33.5** | LOC: 36
- `__on_match` (@ `pathspec-1.0.4/benchmarks/hyperscan_gitignore_r1.py`) -> Impact: **33.5** | LOC: 36
- `_translate_segment_glob` (@ `pathspec-1.0.4/benchmarks/gitwildmatch_v1.py`) -> Impact: **33.3** | LOC: 100
...
### 1. `pathspec-1.0.4/benchmarks/hyperscan_gitignore_r1.py` (PYTHON) -> Cumulative Risk: **695.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 358.82 | **LOC:** 299 | **CtrlFlow:** 26.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.7679%)
- **Heaviest Functions:** `__on_match` (Impact: 33.5), `__on_match` (Impact: 33.5), `on_match` (Impact: 30.9)

### 2. `pathspec-1.0.4/benchmarks/hyperscan_pathspec_r1.py` (PYTHON) -> Cumulative Risk: **688.17**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 166.68 | **LOC:** 250 | **CtrlFlow:** 7.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9289%)
- **Heaviest Functions:** `_init_db` (Impact: 13.2), `match_file` (Impact: 6.3), `match_file` (Impact: 6.2)

### 3. `pathspec-1.0.4/benchmarks/hyperscan_gitignore_r2.py` (PYTHON) -> Cumulative Risk: **660.17**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 305.88 | **LOC:** 299 | **CtrlFlow:** 20.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.1478%)
- **Heaviest Functions:** `_init_db` (Impact: 32.5), `__on_match` (Impact: 25.3), `on_match` (Impact: 23.3)

### 4. `pathspec-1.0.4/benchmarks/gitwildmatch_v1.py` (PYTHON) -> Cumulative Risk: **629.81**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 325.62 | **LOC:** 343 | **CtrlFlow:** 43.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.5868%)
- **Heaviest Functions:** `pattern_to_regex` (Impact: 90.8), `_translate_segment_glob` (Impact: 33.3), `escape` (Impact: 15.1)

### 5. `pathspec-1.0.4/benchmarks/bench_gitwildmatch_150p_to_6500f.py` (PYTHON) -> Cumulative Risk: **581.93**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 25.8 | **LOC:** 197 | **CtrlFlow:** 1.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.3307%), State Flux (83.2018%)
- **Heaviest Functions:** `run_match` (Impact: 3.6), `bench_sm_gitignore_v1` (Impact: 2.5), `bench_sm_gitignore_v2` (Impact: 2.5)

### 6. `pathspec-1.0.4/pathspec/util.py` (PYTHON) -> Cumulative Risk: **578.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 411.68 | **LOC:** 848 | **CtrlFlow:** 25.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Safety Score (90.5251%), Verification (80.0%)
- **Heaviest Functions:** `_iter_tree_entries_next` (Impact: 30.8), `detailed_match_files` (Impact: 30.2), `_iter_tree_files_next` (Impact: 22.6)

### 7. `pathspec-1.0.4/pathspec/patterns/gitignore/basic.py` (PYTHON) -> Cumulative Risk: **572.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 224.78 | **LOC:** 318 | **CtrlFlow:** 35.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.8093%), Verification (80.0%)
- **Heaviest Functions:** `__normalize_segments` (Impact: 44.4), `pattern_to_regex` (Impact: 38.8), `__translate_segments` (Impact: 27.6)

### 8. `pathspec-1.0.4/pathspec/pathspec.py` (PYTHON) -> Cumulative Risk: **570.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 174.46 | **LOC:** 461 | **CtrlFlow:** 13.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9596%), Verification (80.0%), Safety Score (77.8629%)
- **Heaviest Functions:** `from_lines` (Impact: 16.6), `__init__` (Impact: 13.3), `match_files` (Impact: 13.1)

### 9. `pathspec-1.0.4/pathspec/_backends/hyperscan/gitignore.py` (PYTHON) -> Cumulative Risk: **549.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 165.76 | **LOC:** 246 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.4429%), Verification (80.0%)
- **Heaviest Functions:** `_init_db` (Impact: 40.9), `__on_match` (Impact: 25.6), `match_file` (Impact: 6.5)

### 10. `pathspec-1.0.4/pathspec/_backends/re2/gitignore.py` (PYTHON) -> Cumulative Risk: **548.84**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 135.2 | **LOC:** 180 | **CtrlFlow:** 21.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (95.6127%), Verification (80.0%)
- **Heaviest Functions:** `_init_set` (Impact: 35.7), `match_file` (Impact: 21.4)
...
- **Risk Profile:** Cognitive Load (8.3741%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `parameterize_from_lines` (Impact: 17.1)
  * `test_01_match_file_2_exclude` (Impact: 6.5)
    * *Intent:* """ Test matching a single file that is excluded. """
  * `test_01_match_file_3_unmatch` (Impact: 6.5)
    * *Intent:* """ Test match a single file that is unmatched. """
  * `test_05_match_tree_entries` (Impact: 4.6)
    * *Intent:* """ Test matching a file tree. """
  * `test_05_match_tree_files` (Impact: 4.6)
    * *Intent:* """ Test matching a file tree. """
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 411.68 | **LOC:** 848 | **CtrlFlow:** 25.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (40.4571%), Tech Debt (10.0529%)
**Top Internal Functions/Classes:**
  * `_iter_tree_entries_next` (Impact: 30.8)
  * `detailed_match_files` (Impact: 30.2)
  * `_iter_tree_files_next` (Impact: 22.6)
  * `check_match_file` (Impact: 20.1)
  * `register_pattern` (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 358.82 | **LOC:** 299 | **CtrlFlow:** 26.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (43.6783%), Tech Debt (99.7679%)
**Top Internal Functions/Classes:**
  * `__on_match` (Impact: 33.5)
  * `__on_match` (Impact: 33.5)
  * `on_match` (Impact: 30.9)
  * `on_match` (Impact: 30.9)
  * `match_file` (Impact: 24.7)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 325.62 | **LOC:** 343 | **CtrlFlow:** 43.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (78.5137%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `pattern_to_regex` (Impact: 90.8)
  * `_translate_segment_glob` (Impact: 33.3)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 305.88 | **LOC:** 299 | **CtrlFlow:** 20.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (49.3089%), Tech Debt (58.2988%)
**Top Internal Functions/Classes:**
  * `_init_db` (Impact: 32.5)
  * `__on_match` (Impact: 25.3)
  * `on_match` (Impact: 23.3)
  * `on_match` (Impact: 23.3)
  * `match_file` (Impact: 19.3)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 224.78 | **LOC:** 318 | **CtrlFlow:** 35.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (57.2223%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__normalize_segments` (Impact: 44.4)
  * `pattern_to_regex` (Impact: 38.8)
  * `__translate_segments` (Impact: 27.6)
...
- **Risk Profile:** Cognitive Load (3.1981%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_02_many` (Impact: 5.7)
    * *Intent:* """ Test matching files individually. """
  * `test_02_link_1_check_symlink` (Impact: 3.8)
    * *Intent:* """ Tests whether links can be created. """
  * `require_symlink` (Impact: 3.1)
    * *Intent:* """ Skips the test if `os.symlink` is not supported. """
  * `test_01_files_1_entries` (Impact: 2.9)
    * *Intent:* """ Tests to make sure all files are found. """
  * `test_02_link_2_links_1_entries` (Impact: 2.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 174.46 | **LOC:** 461 | **CtrlFlow:** 13.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (22.6137%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `from_lines` (Impact: 16.6)
  * `__init__` (Impact: 13.3)
  * `match_files` (Impact: 13.1)
  * `match_entries` (Impact: 13.0)
  * `__eq__` (Impact: 7.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 166.68 | **LOC:** 250 | **CtrlFlow:** 7.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (34.5525%), Tech Debt (99.9289%)
**Top Internal Functions/Classes:**
  * `_init_db` (Impact: 13.2)
  * `match_file` (Impact: 6.3)
  * `match_file` (Impact: 6.2)
  * `__on_match` (Impact: 6.0)
  * `__on_match` (Impact: 6.0)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 165.76 | **LOC:** 246 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (35.2328%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_init_db` (Impact: 40.9)
  * `__on_match` (Impact: 25.6)
  * `match_file` (Impact: 6.5)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 135.2 | **LOC:** 180 | **CtrlFlow:** 21.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (46.0548%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_init_set` (Impact: 35.7)
  * `match_file` (Impact: 21.4)
    * *Intent:* """ Check the file against the patterns. *file* (:class:`str`) is the normalized file path to check....
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (34.2975%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_init_db` (Impact: 21.6)
  * `__init__` (Impact: 16.7)
  * `match_file` (Impact: 6.5)
    * *Intent:* """ Check the file against the patterns. *file* (:class:`str`) is the normalized file path to check....
  * `__on_match` (Impact: 6.4)
  * `_make_db` (Impact: 1.4)
...
**Top Internal Functions/Classes:**
  * `_translate_segment_glob` (Impact: 33.8)
...
- **Risk Profile:** Cognitive Load (29.9855%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_init_set` (Impact: 16.3)
  * `__init__` (Impact: 11.3)
  * `match_file` (Impact: 6.3)
    * *Intent:* """ Check the file against the patterns. *file* (:class:`str`) is the normalized file path to check....
  * `_make_set` (Impact: 1.4)
...
- **Risk Profile:** Cognitive Load (11.0017%), Tech Debt (99.4824%)
**Top Internal Functions/Classes:**
  * `run_match` (Impact: 3.6)
  * `bench_hs_r1_block_closure` (Impact: 2.5)
    * *Intent:* # Hyperscan backend.
  * `bench_hs_r1_block_state` (Impact: 2.5)
  * `bench_hs_r1_stream_closure` (Impact: 2.5)
  * `bench_hs_r2_block_closure` (Impact: 2.5)
...
- **Risk Profile:** Cognitive Load (11.0528%), Tech Debt (99.505%)
**Top Internal Functions/Classes:**
  * `run_match` (Impact: 3.6)
  * `bench_hs_r1_block_closure` (Impact: 2.5)
    * *Intent:* # Hyperscan backend.
...
- **Risk Profile:** Cognitive Load (2.7354%), Tech Debt (100.0%)
**Top Internal Functions/Classes:**
  * `cpython_gi_lines_all` (Impact: 5.9)
  * `cpython_gi_lines_5` (Impact: 1.8)
  * `cpython_gi_lines_15` (Impact: 1.7)
  * `cpython_gi_lines_25` (Impact: 1.7)
  * `cpython_gi_lines_50` (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (12.1755%), Tech Debt (99.6377%)
**Top Internal Functions/Classes:**
  * `run_match` (Impact: 3.6)
  * `bench_hs_gitignore_v1` (Impact: 2.5)
    * *Intent:* # Hyperscan backend.
  * `bench_hs_gitignore_v2` (Impact: 2.5)
  * `bench_hs_pathspec_v1` (Impact: 2.5)
  * `bench_hs_pathspec_v2` (Impact: 2.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (99.6743%)
**Top Internal Functions/Classes:**
  * `bench_hs_v1_end` (Impact: 2.5)
    * *Intent:* # Hyperscan backend.
  * `bench_hs_v1_middle` (Impact: 2.5)
  * `bench_hs_v1_none` (Impact: 2.5)
  * `bench_hs_v1_start` (Impact: 2.5)
  * `bench_re2_v1_end` (Impact: 2.5)
    * *Intent:* # Re2 backend.
**Structural Signatures (Net Mitigated Signals):**
