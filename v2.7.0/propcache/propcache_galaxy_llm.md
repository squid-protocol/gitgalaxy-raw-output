...
- `maybe_prebuild_c_extensions` (@ `propcache-0.4.1/packaging/pep517_backend/_backend.py`) -> Impact: **19.1** | LOC: 62
- `pytest_collection_modifyitems` (@ `propcache-0.4.1/tests/conftest.py`) -> Impact: **11.1** | LOC: 22
- `get_requires_for_build_wheel` (@ `propcache-0.4.1/packaging/pep517_backend/_backend.py`) -> Impact: **9.8** | LOC: 27
- `_exclude_dir_path` (@ `propcache-0.4.1/packaging/pep517_backend/_backend.py`) -> Impact: **9.1** | LOC: 21
...
- `test_under_cached_property_no_refcount_leak` (@ `propcache-0.4.1/tests/test_under_cached_property.py`) -> Impact: **8.1** | LOC: 78
  * *Intent:* """Test that under_cached_property does not leak references."""
- `test_cached_property_no_refcount_leak` (@ `propcache-0.4.1/tests/test_cached_property.py`) -> Impact: **8.0** | LOC: 75
  * *Intent:* """Test that cached_property does not leak references."""
- `_get_setting_value` (@ `propcache-0.4.1/packaging/pep517_backend/_backend.py`) -> Impact: **7.7** | LOC: 19
- `__get__` (@ `propcache-0.4.1/src/propcache/_helpers_c.pyx`) -> Impact: **6.5** | LOC: 10
...
- **Heaviest Functions:** `__get__` (Impact: 4.5), `__get__` (Impact: 2.1), `__set__` (Impact: 2.1)
...
- **Heaviest Functions:** `maybe_prebuild_c_extensions` (Impact: 19.1), `get_requires_for_build_wheel` (Impact: 9.8), `_exclude_dir_path` (Impact: 9.1)
...
- **Heaviest Functions:** `_emit_opt_pairs` (Impact: 6.1), `sanitize_rst_roles` (Impact: 5.3), `get_enabled_cli_flags_from_config` (Impact: 4.4)
...
- **Heaviest Functions:** `patched_env` (Impact: 6.3), `_configure_cython_line_tracing` (Impact: 3.9), `get_local_cython_config` (Impact: 2.5)
...
- **Heaviest Functions:** `_import_facade` (Impact: 3.2), `_dir_facade` (Impact: 1.1)
...
- **Heaviest Functions:** `run_main_program` (Impact: 5.7)
...
- **Heaviest Functions:** `test_under_cached_property_cache_miss` (Impact: 3.8), `test_under_cached_property_cache_hit` (Impact: 3.7), `test_cached_property_cache_hit` (Impact: 3.7)
...
- **Heaviest Functions:** `test_under_cached_property_no_refcount_leak` (Impact: 8.1), `test_under_cached_property_typeddict` (Impact: 5.5), `test_under_cached_property` (Impact: 5.2)
...
**Top Internal Functions/Classes:**
  * `maybe_prebuild_c_extensions` (Impact: 19.1)
  * `get_requires_for_build_wheel` (Impact: 9.8)
  * `_exclude_dir_path` (Impact: 9.1)
  * `_get_setting_value` (Impact: 7.7)
  * `build_wheel` (Impact: 3.2)
...
**Top Internal Functions/Classes:**
  * `test_cached_property_no_refcount_leak` (Impact: 8.0)
    * *Intent:* """Test that cached_property does not leak references."""
  * `test_set_name` (Impact: 6.4)
    * *Intent:* """Test that the __set_name__ method is called and checked."""
  * `test_get_without_set_name` (Impact: 6.2)
    * *Intent:* """Test that get without __set_name__ fails."""
  * `test_cached_property_class_docstring` (Impact: 4.9)
  * `test_cached_property` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_under_cached_property_no_refcount_leak` (Impact: 8.1)
    * *Intent:* """Test that under_cached_property does not leak references."""
  * `test_under_cached_property_typeddict` (Impact: 5.5)
    * *Intent:* """Test static typing passes with TypedDict."""
  * `test_under_cached_property` (Impact: 5.2)
  * `test_under_cached_property_class_docstring` (Impact: 5.1)
  * `count_sentinels` (Impact: 3.4)
...
**Top Internal Functions/Classes:**
  * `test_under_cached_property_cache_miss` (Impact: 3.8)
    * *Intent:* """Benchmark for under_cached_property cache miss."""
  * `test_under_cached_property_cache_hit` (Impact: 3.7)
    * *Intent:* """Benchmark for under_cached_property cache hit."""
  * `test_cached_property_cache_hit` (Impact: 3.7)
    * *Intent:* """Benchmark for cached_property cache hit."""
  * `test_cached_property_cache_miss` (Impact: 3.7)
...
**Top Internal Functions/Classes:**
  ...
  * `get_cli_kwargs_from_config` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
...
**Top Internal Functions/Classes:**
  ...
  * `get_local_cython_config` (Impact: 2.5)
