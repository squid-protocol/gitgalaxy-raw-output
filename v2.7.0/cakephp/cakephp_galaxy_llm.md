...
| Avg Path Length | 3.3353 | Hops between files. Lower = Tighter coupling. |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 85.5 | 100.0 | 100.0 |
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 3.4 | 0.5 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 6.7 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 9.7 | 0.0 | 0.0 |
...
| threat | 255 | 94 | 0 | `contrib/git-filter-repo` |
...
- `date` (@ `src/Validation/Validation.php`) -> Impact: **277.3** | LOC: 66
...
- `testCreditCard` (@ `tests/TestCase/Validation/ValidationTest.php`) -> Impact: **143.4** | LOC: 448
  * *Intent:* /** * testCreditCard method */
- `_compute_metadata` (@ `contrib/git-filter-repo`) -> Impact: **129.6** | LOC: 192
...
- `calculate` (@ `src/I18n/PluralRules.php`) -> Impact: **120.4** | LOC: 53
...
- `testNumbers` (@ `tests/TestCase/View/Helper/PaginatorHelperTest.php`) -> Impact: **114.1** | LOC: 262
  * *Intent:* /** * testNumbers method */
- `columnDefinitionSql` (@ `src/Database/Schema/MysqlSchemaDialect.php`) -> Impact: **109.8** | LOC: 217
- `_tweak_commit` (@ `contrib/git-filter-repo`) -> Impact: **106.3** | LOC: 207
- `match` (@ `src/Routing/Route/Route.php`) -> Impact: **104.1** | LOC: 142
...
- `assertHtml` (@ `src/TestSuite/TestCase.php`) -> Impact: **101.6** | LOC: 152
  * *Intent:* * [ * ['input' => ['name', 'id' => 'preg:/FieldName\d+/']], * 'preg:/My\s+field/' * ] * ``` * * Important: This function is very forgiving about white...
- `sanity_check` (@ `contrib/git-filter-repo`) -> Impact: **98.1** | LOC: 122
...
### 1. `src/Collection/CollectionTrait.php` (PHP) -> Cumulative Risk: **598.98**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 838.1 | **LOC:** 1244 | **CtrlFlow:** 17.8% | **Authorship Centralization:** 45.5%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.7713%), Verification (80.0%)
- **Heaviest Functions:** `combine` (Impact: 33.4), `cartesianProduct` (Impact: 25.2), `nest` (Impact: 18.3)

### 2. `src/Database/Statement/Statement.php` (PHP) -> Cumulative Risk: **574.25**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 179.44 | **LOC:** 306 | **CtrlFlow:** 16.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.708%), Safety Score (89.5617%), State Flux (85.0%)
- **Heaviest Functions:** `lastInsertId` (Impact: 12.7), `bind` (Impact: 9.5), `bindValue` (Impact: 6.5)

### 3. `contrib/git-filter-repo` (PYTHON) -> Cumulative Risk: **573.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 49.28 | **LOC:** 4990 | **CtrlFlow:** 34.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.9003%), Verification (80.0%)
- **Heaviest Functions:** `_compute_metadata` (Impact: 129.6), `_tweak_commit` (Impact: 106.3), `sanity_check` (Impact: 98.1)

### 4. `src/Database/Schema/MysqlSchemaDialect.php` (PHP) -> Cumulative Risk: **565.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 892.64 | **LOC:** 1077 | **CtrlFlow:** 24.8% | **Authorship Centralization:** 36.4%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (93.9959%), Tech Debt (86.3377%), State Flux (85.0%)
- **Heaviest Functions:** `columnDefinitionSql` (Impact: 109.8), `_convertColumn` (Impact: 61.4), `convertIndexDescription` (Impact: 27.0)

### 5. `src/Datasource/EntityTrait.php` (PHP) -> Cumulative Risk: **531.41**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 730.06 | **LOC:** 1501 | **CtrlFlow:** 20.4% | **Authorship Centralization:** 30.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (91.8433%), Verification (80.0%)
- **Heaviest Functions:** `patch` (Impact: 31.7), `_nestedErrors` (Impact: 25.4), `_accessor` (Impact: 19.1)

### 6. `src/Core/ObjectRegistry.php` (PHP) -> Cumulative Risk: **530.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 173.94 | **LOC:** 407 | **CtrlFlow:** 19.8% | **Authorship Centralization:** 66.7%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Tech Debt (99.9533%), Safety Score (80.0406%)
- **Heaviest Functions:** `load` (Impact: 21.0), `_checkDuplicate` (Impact: 19.0), `set` (Impact: 7.6)

### 7. `src/Console/BaseCommand.php` (PHP) -> Cumulative Risk: **522.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 119.14 | **LOC:** 355 | **CtrlFlow:** 10.9% | **Authorship Centralization:** 66.7%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.988%), Tech Debt (99.9249%), Verification (80.0%)
- **Heaviest Functions:** `executeCommand` (Impact: 14.9), `run` (Impact: 8.7), `setOutputLevel` (Impact: 5.8)

### 8. `src/Http/Response.php` (PHP) -> Cumulative Risk: **509.4**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 564.9 | **LOC:** 1281 | **CtrlFlow:** 14.7% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (95.5022%), Safety Score (92.2822%)
- **Heaviest Functions:** `_fileRange` (Impact: 19.2), `withFile` (Impact: 15.8), `__construct` (Impact: 15.5)

### 9. `src/Validation/Validation.php` (PHP) -> Cumulative Risk: **506.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1781.6 | **LOC:** 1977 | **CtrlFlow:** 49.1% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.1492%), Tech Debt (82.4738%)
- **Heaviest Functions:** `date` (Impact: 277.3), `creditCard` (Impact: 81.5), `_populateIp` (Impact: 38.4)

### 10. `src/ORM/Table.php` (PHP) -> Cumulative Risk: **504.5**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1447.62 | **LOC:** 3325 | **CtrlFlow:** 19.1% | **Authorship Centralization:** 55.6%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Churn (96.03%), Safety Score (92.6505%)
- **Heaviest Functions:** `invokeFinder` (Impact: 60.5), `_processSave` (Impact: 40.0), `get` (Impact: 33.0)
...
- **Risk Profile:** Cognitive Load (36.1029%), Tech Debt (91.0367%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (9.9746%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `providerForTestGetWithCache` (Impact: 10.1)
  * `testHasManyWithClassName` (Impact: 7.6)
    * *Intent:* /** * testHasManyWithClassName */
  * `setUp` (Impact: 7.0)
  * `testCallbackArgumentTypes` (Impact: 6.1)
    * *Intent:* /** * Tests that the callbacks receive the expected types of arguments. */
  * `testSaveManyResultSet` (Impact: 5.1)
...
- **Risk Profile:** Cognitive Load (37.0687%), Tech Debt (26.7728%)
**Top Internal Functions/Classes:**
  * `control` (Impact: 59.6)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1556.32 | **LOC:** 3712 | **CtrlFlow:** 11.2% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (49.7809%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testNumbers` (Impact: 114.1)
    * *Intent:* /** * testNumbers method */
  * `testNumbersModulus` (Impact: 79.2)
    * *Intent:* /** * Test modulus option for numbers() */
  * `dataMetaProvider` (Impact: 25.0)
    * *Intent:* /** * Test data for meta() * * @return array */
  * `testSortLinks` (Impact: 19.3)
    * *Intent:* /** * testSortLinks method */
  * `testNumbersWithUrlOptions` (Impact: 17.4)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1467.66 | **LOC:** 4456 | **CtrlFlow:** 1.7% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (15.4038%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testSQLFunctions` (Impact: 10.8)
    * *Intent:* /** * Tests that functions are correctly transformed and their parameters are bound */
  * `testIdentifierCollation` (Impact: 10.8)
    * *Intent:* /** * Tests setting identifier collation. */
  * `testStringExpression` (Impact: 10.7)
    * *Intent:* /** * Tests creating StringExpression. */
  * `testSelectWhereOperatorMethods` (Impact: 9.8)
    * *Intent:* /** * Tests using where conditions with operator methods */
  * `testSelectAliasedFieldsFromTable` (Impact: 9.6)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1447.62 | **LOC:** 3325 | **CtrlFlow:** 19.1% | **Authorship Centralization:** 55.6%
- **Risk Profile:** Cognitive Load (44.6542%), Tech Debt (63.1363%)
**Top Internal Functions/Classes:**
  * `invokeFinder` (Impact: 60.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.009744 | `Ripple Effect (Closeness):` 0.0
...
- **Risk Profile:** Cognitive Load (40.406%), Tech Debt (43.2841%)
**Top Internal Functions/Classes:**
  * `_matches` (Impact: 74.0)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1088.9 | **LOC:** 4176 | **CtrlFlow:** 0.6% | **Authorship Centralization:** 25.0%
- **Risk Profile:** Cognitive Load (8.5864%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testWith` (Impact: 6.3)
    * *Intent:* /** * Tests ORM query using with CTE. */
  * `testFormatResultsBelongsToMany` (Impact: 6.1)
    * *Intent:* /** * Tests that belongsToMany associations are also correctly hydrated */
  * `testBelongsToManyEagerLoadingNoHydration` (Impact: 5.9)
    * *Intent:* /** * Tests that BelongsToMany associations are correctly eager loaded. * Also that the query object...
  * `testSelectLargeNumbers` (Impact: 5.0)
    * *Intent:* /** * Tests that it is possible to find large numeric values. */
  * `testFormatDeepDistantAssociationRecords` (Impact: 4.5)
...
- **Risk Profile:** Cognitive Load (13.2665%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testExtensionParsing` (Impact: 8.0)
    * *Intent:* /** * testExtensionParsing method */
  * `testUrlGenerationWithQueryStrings` (Impact: 7.3)
    * *Intent:* /** * Test generation of routes with query string parameters. */
  * `testUrlGenerationWithPrefix` (Impact: 6.5)
    * *Intent:* /** * Test URL generation with an admin prefix */
  * `testUrlGenerationWithExtensions` (Impact: 5.0)
    * *Intent:* /** * testUrlGenerationWithExtensions method */
  * `testUrlGenerationNamedRoute` (Impact: 5.0)
...
- **Risk Profile:** Cognitive Load (58.0207%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testLink` (Impact: 37.5)
    * *Intent:* /** * testLink method */
  * `testScript` (Impact: 16.6)
    * *Intent:* /** * test that scripts added with uses() are only ever included once. * test script tag generation ...
  * `testCssLink` (Impact: 12.4)
    * *Intent:* /** * testCssLink method */
  * `testNestedList` (Impact: 11.4)
    * *Intent:* /** * testNestedList method */
  * `testPluginCssTimestamping` (Impact: 8.2)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 974.38 | **LOC:** 1322 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 58.3%
- **Risk Profile:** Cognitive Load (37.5177%), Tech Debt (21.1184%)
**Top Internal Functions/Classes:**
  * `sort` (Impact: 60.1)
  ...
  * `prepareLimitOptions` (Impact: 17.6)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 943.74 | **LOC:** 1551 | **CtrlFlow:** 17.8% | **Authorship Centralization:** 44.4%
- **Risk Profile:** Cognitive Load (33.5556%), Tech Debt (30.6463%)
**Top Internal Functions/Classes:**
  * `_diffLinks` (Impact: 55.4)
    * *Intent:* /** * Helper method used to delete the difference between the links passed in * `$existing` and `$jo...
  * `_saveTarget` (Impact: 28.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000463 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 933.7 | **LOC:** 3666 | **CtrlFlow:** 0.4% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (8.8127%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testMergeBelongsToManyJoinData` (Impact: 5.0)
    * *Intent:* /** * Test merging the _joinData entity for belongstomany associations. */
  * `testBeforeMarshalEventOnAssociations` (Impact: 4.8)
    * *Intent:* /** * Test Model.beforeMarshal event on associated tables. */
  * `testMergeAssociationWithfields` (Impact: 4.7)
    * *Intent:* /** * Tests merging associated data with a fields */
  * `testMergeMultipleAssociations` (Impact: 4.5)
    * *Intent:* /** * Tests merging one to many associations */
  * `testAfterMarshalEventOnPatchEntity` (Impact: 4.5)
...
- **Risk Profile:** Cognitive Load (42.9789%), Tech Debt (8.5015%)
**Top Internal Functions/Classes:**
...
**Top Internal Functions/Classes:**
  * `testCartesianProduct` (Impact: 7.2)
    * *Intent:* /** * Tests cartesianProduct */
  * `testNestObjects` (Impact: 3.7)
    * *Intent:* /** * Tests the nest method with more than one level */
  * `testNestObjectsAlternateNestingKey` (Impact: 3.7)
    * *Intent:* /** * Tests the nest method with more than one level */
  * `testSample` (Impact: 3.3)
    * *Intent:* /** * Tests sample */
  * `testCombine` (Impact: 3.3)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 892.64 | **LOC:** 1077 | **CtrlFlow:** 24.8% | **Authorship Centralization:** 36.4%
- **Risk Profile:** Cognitive Load (53.0734%), Tech Debt (86.3377%)
**Top Internal Functions/Classes:**
  * `columnDefinitionSql` (Impact: 109.8)
  * `_convertColumn` (Impact: 61.4)
    * *Intent:* /** * Convert a MySQL column type into an abstract type. *
  * `convertIndexDescription` (Impact: 27.0)
  * `parseDefault` (Impact: 22.7)
    * *Intent:* /**
  * `describeColumns` (Impact: 16.6)
...
- **Risk Profile:** Cognitive Load (44.888%), Tech Debt (89.7963%)
**Top Internal Functions/Classes:**
  * `__construct` (Impact: 31.0)
    * *Intent:* /** * Constructor * * @param \Cake\Http\ServerRequest|null $request Request instance. * @param \Cake...
  * `_getTemplateFileName` (Impact: 29.2)
...
- **Risk Profile:** Cognitive Load (27.6129%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `filesizes` (Impact: 19.1)
  * `slugInputProvider` (Impact: 19.1)
  * `testTruncate` (Impact: 8.8)
  * `transliterateInputProvider` (Impact: 7.8)
  * `testTail` (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
...
- `src/Database/Schema/PostgresSchemaDialect.php` -> Churn: **65.77%** | Cog Load: 38.0938% | Debt: 54.1355%

### 👤 Key Person Dependencies (High Impact + Siloed Knowledge)
These are massive, load-bearing files written almost entirely by a single developer. They represent severe 'Bus Factor' risk.

- `tests/TestCase/ORM/MarshallerTest.php` -> **ADmad** (100.0% isolated ownership) | Magnitude: 933.7
...
- `src/TestSuite/TestCase.php` -> **Severity: 1.2** (Bridge: 0.012 * Flux: 100.0%)
- `src/ORM/Table.php` -> **Severity: 0.974** (Bridge: 0.0097 * Flux: 100.0%)
- `src/Datasource/ConnectionManager.php` -> **Severity: 0.772** (Bridge: 0.0077 * Flux: 100.0%)
- `src/TestSuite/Fixture/TestFixture.php` -> **Severity: 0.378** (Bridge: 0.0038 * Flux: 100.0%)
- `src/ORM/Locator/LocatorAwareTrait.php` -> **Severity: 0.33** (Bridge: 0.0033 * Flux: 100.0%)
