...
- `daemonize` (@ `t/local/http.t`) -> Impact: **371.5** | LOC: 213
- `_test` (@ `t/local/http.t`) -> Impact: **177.6** | LOC: 431
- `daemonize` (@ `t/robot/ua-get.t`) -> Impact: **41.5** | LOC: 46
- `daemonize` (@ `t/robot/ua.t`) -> Impact: **41.5** | LOC: 46
- `_test` (@ `t/robot/ua-get.t`) -> Impact: **36.0** | LOC: 60
- `request` (@ `t/local/protosub.t`) -> Impact: **21.9** | LOC: 15
- `_test` (@ `t/robot/ua.t`) -> Impact: **19.8** | LOC: 56
- `get_basic_credentials` (@ `bin/lwp-request`) -> Impact: **19.1** | LOC: 23
- `show` (@ `bin/lwp-request`) -> Impact: **12.5** | LOC: 8
- `usage` (@ `bin/lwp-request`) -> Impact: **10.4** | LOC: 29
...
- **Heaviest Functions:** `get_basic_credentials` (Impact: 2.5)
...
- **Heaviest Functions:** `daemonize` (Impact: 371.5), `_test` (Impact: 177.6), `get_basic_credentials` (Impact: 7.1)
...
- **Heaviest Functions:** `fduration` (Impact: 6.6), `fbytes` (Impact: 6.3), `show` (Impact: 5.6)
...
- **Heaviest Functions:** `daemonize` (Impact: 41.5), `_test` (Impact: 36.0), `url` (Impact: 2.2)
...
- **Heaviest Functions:** `get_basic_credentials` (Impact: 19.1), `show` (Impact: 12.5), `usage` (Impact: 10.4)
...
- **Heaviest Functions:** `daemonize` (Impact: 41.5), `_test` (Impact: 19.8), `url` (Impact: 2.2)
...
- **Heaviest Functions:** `data` (Impact: 5.8)
...
- **Heaviest Functions:** `usage` (Impact: 2.4)
...
- **Heaviest Functions:** `ua` (Impact: 2.5)
