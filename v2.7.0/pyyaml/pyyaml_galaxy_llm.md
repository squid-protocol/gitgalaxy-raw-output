...
| Avg Path Length | 2.0212 | Hops between files. Lower = Tighter coupling. |
...
- `_object_to_event` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **145.1** | LOC: 182
- `_serialize_node` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **109.3** | LOC: 128
- `_event_to_object` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **77.1** | LOC: 122
- `_token_to_object` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **63.5** | LOC: 93
- `__init__` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **48.8** | LOC: 38
- `test_implicit_resolver` (@ `pyyaml-6.0.3/tests/legacy_tests/test_schema.py`) -> Impact: **46.6** | LOC: 93
...
- `_compose_node` (@ `pyyaml-6.0.3/yaml/_yaml.pyx`) -> Impact: **30.1** | LOC: 41
- `display` (@ `pyyaml-6.0.3/tests/legacy_tests/test_appliance.py`) -> Impact: **29.7** | LOC: 39
- `run` (@ `pyyaml-6.0.3/tests/legacy_tests/test_appliance.py`) -> Impact: **29.2** | LOC: 29
- `scan` (@ `pyyaml-6.0.3/tests/legacy_tests/canonical.py`) -> Impact: **27.6** | LOC: 43
...
- **Heaviest Functions:** `__init__` (Impact: 12.1), `finalize_options` (Impact: 11.1), `run` (Impact: 11.0)
...
- **Heaviest Functions:** `_object_to_event` (Impact: 145.1), `_serialize_node` (Impact: 109.3), `_event_to_object` (Impact: 77.1)
...
- **Heaviest Functions:** `_expose_config_settings` (Impact: 6.7), `_bridge_build_meta` (Impact: 3.6), `__exit__` (Impact: 2.3)
...
- **Heaviest Functions:** `_make_objects` (Impact: 25.9), `_serialize_value` (Impact: 12.2), `test_constructor_types` (Impact: 11.4)
...
- **Heaviest Functions:** `scan` (Impact: 27.6), `scan_scalar` (Impact: 17.5), `parse_node` (Impact: 15.1)
...
- **Heaviest Functions:** `display` (Impact: 29.7), `run` (Impact: 29.2), `execute` (Impact: 17.2)
...
- **Heaviest Functions:** `_compare_emitters` (Impact: 22.3), `_compare_scanners` (Impact: 13.2), `wrap_ext` (Impact: 12.0)
...
- **Heaviest Functions:** `highlight` (Impact: 25.0), `__init__` (Impact: 22.2), `__init__` (Impact: 9.2)
...
- **Heaviest Functions:** `test_emitter_styles` (Impact: 19.2), `construct_event` (Impact: 13.0), `_compare_events` (Impact: 11.0)
...
**Top Internal Functions/Classes:**
  * `_object_to_event` (Impact: 145.1)
  * `_serialize_node` (Impact: 109.3)
  * `_event_to_object` (Impact: 77.1)
  * `_token_to_object` (Impact: 63.5)
...
**Top Internal Functions/Classes:**
  * `scan` (Impact: 27.6)
  * `scan_scalar` (Impact: 17.5)
  * `parse_node` (Impact: 15.1)
...
**Top Internal Functions/Classes:**
  * `_make_objects` (Impact: 25.9)
  * `_serialize_value` (Impact: 12.2)
  * `test_constructor_types` (Impact: 11.4)
  * `test_subclass_blacklist_types` (Impact: 5.7)
  * `__eq__` (Impact: 5.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_compare_emitters` (Impact: 22.3)
  * `_compare_scanners` (Impact: 13.2)
  * `wrap_ext` (Impact: 12.0)
  * `_compare_parsers` (Impact: 10.9)
  * `test_large_file` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 12.1)
  * `finalize_options` (Impact: 11.1)
  * `run` (Impact: 11.0)
  * `get_source_files` (Impact: 10.6)
  * `__init__` (Impact: 9.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `run` (Impact: 29.2)
  * `execute` (Impact: 17.2)
  * `parse_arguments` (Impact: 12.4)
  * `find_test_functions` (Impact: 10.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_convert_structure` (Impact: 18.4)
  * `test_structure` (Impact: 11.2)
  * `_compare_nodes` (Impact: 11.0)
  * `test_composer` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `collect` (Impact: 16.7)
  * `pytest_ignore_collect` (Impact: 10.7)
  * `pytest_pycollect_makeitem` (Impact: 8.9)
  * `__init__` (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_unicode_output` (Impact: 17.2)
  * `test_unicode_transfer` (Impact: 13.1)
  * `test_unicode_input_errors` (Impact: 11.5)
  * `test_unicode_input` (Impact: 6.1)
  * `test_file_output` (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_implicit_resolver` (Impact: 46.6)
...
**Top Internal Functions/Classes:**
  * `test_emitter_styles` (Impact: 19.2)
  * `construct_event` (Impact: 13.0)
  * `_compare_events` (Impact: 11.0)
  * `test_emitter_on_canonical` (Impact: 5.7)
  * `test_emitter_on_data` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 23 instances
...
**Top Internal Functions/Classes:**
  * `_convert_node` (Impact: 9.1)
  * `test_implicit_resolver` (Impact: 8.9)
  * `test_path_resolver_dumper` (Impact: 8.7)
  * `test_path_resolver_loader` (Impact: 6.7)
  * `_make_path_loader_and_dumper` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 16 instances
...
**Top Internal Functions/Classes:**
  * `test_dumper_error` (Impact: 5.8)
  * `test_emitter_error` (Impact: 5.7)
  * `test_loader_error` (Impact: 5.6)
  * `test_loader_error_string` (Impact: 5.6)
  * `test_loader_error_single` (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
**Top Internal Functions/Classes:**
  * `test_canonical_error` (Impact: 6.5)
  * `test_canonical_scanner` (Impact: 5.6)
  * `test_canonical_parser` (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_multi_constructor` (Impact: 7.3)
  * `myconstructor2` (Impact: 4.7)
  * `myconstructor1` (Impact: 2.1)
  * `_load_code` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_tokens` (Impact: 10.8)
  * `test_scanner` (Impact: 8.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
...
**Top Internal Functions/Classes:**
  * `_expose_config_settings` (Impact: 6.7)
  * `_bridge_build_meta` (Impact: 3.6)
  * `__exit__` (Impact: 2.3)
  * `__init__` (Impact: 1.8)
  * `__enter__` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_recursive` (Impact: 4.5)
  * `__init__` (Impact: 2.1)
  * `__setstate__` (Impact: 1.8)
  * `__repr__` (Impact: 1.7)
  * `__getstate__` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_representer_types` (Impact: 12.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 5 instances
...
**Top Internal Functions/Classes:**
  * `_run_reader` (Impact: 7.4)
  * `test_stream_error` (Impact: 6.0)
**Contextual Mitigations & Amplifications:**
