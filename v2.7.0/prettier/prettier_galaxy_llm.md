...
| Analyzed Artifacts (Scanned) | 7043 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 2153 |
| Total LOC | 129267 |
...
| connectivity | 3803 | 1527 | 1 | `tests/format/flow/flow-repo/type-printer/types.js` |
...
| debt | 1000 | 385 | 0 | `tests/format/js/function/dangling-comments.js` |
| mutation | 17853 | 2748 | 6 | `website/playground/Playground.jsx` |
| dead_code | 1894 | 806 | 1 | `tests/format/flow/flow-repo/logical/logical.js` |
| credential | 6 | 6 | 0 | `eslint.config.js` |
...
- `needsParentheses` (@ `src/language-js/parentheses/needs-parentheses.js`) -> Impact: **768.1** | LOC: 848
  * *Intent:* /** * @import AstPath from "../../common/ast-path.js" */ /** * @param {AstPath} path * @returns {boolean} */
- `genericPrint` (@ `src/language-css/printer-postcss.js`) -> Impact: **418.4** | LOC: 529
- `printCommaSeparatedValueGroup` (@ `src/language-css/print/comma-separated-value-group.js`) -> Impact: **406.6** | LOC: 493
...
- `printEstree` (@ `src/language-js/print/estree.js`) -> Impact: **287.9** | LOC: 258
  * *Intent:* /** * @import AstPath from "../../common/ast-path.js" * @import {Doc} from "../../document/index.js" */ /** * @param {AstPath} path * @param {*} optio...
- `print` (@ `src/language-handlebars/printer-glimmer.js`) -> Impact: **231.2** | LOC: 385
...
- `printMdast` (@ `src/language-markdown/print/mdast.js`) -> Impact: **224.8** | LOC: 336
- `printTernary` (@ `src/language-js/print/ternary.js`) -> Impact: **212.8** | LOC: 276
...
- `tokenizeHtmlText` (@ `src/language-markdown/parse/micromark/micromark-extension-html-text.js`) -> Impact: **204.1** | LOC: 762
  * *Intent:* /** * @this {TokenizeContext} * Context. * @type {Tokenizer} */
- `parseNestedCSS` (@ `src/language-css/parser-postcss.js`) -> Impact: **196.3** | LOC: 428
...
| `website/playground` | 17 | 1113.62 | 16.44% | 1.27% |
...
- **Heaviest Functions:** `coreFormat` (Impact: 59.8), `formatWithCursor` (Impact: 29.9), `formatRange` (Impact: 22.2)
...
- **Heaviest Functions:** `main` (Impact: 42.2), `run` (Impact: 9.2)
...
- **Heaviest Functions:** `getMdxFiles` (Impact: 29.1), `llmsTxtPlugin` (Impact: 23.1), `loadContent` (Impact: 16.4)
...
- **Heaviest Functions:** `toDts` (Impact: 17.4), `getRelativePath` (Impact: 5.0)
...
- **Heaviest Functions:** `debugApis[name]` (Impact: 6.4), `prettier[name]` (Impact: 3.6), `get` (Impact: 1.6)
...
- **Heaviest Functions:** `callPluginPrintFunction` (Impact: 36.3), `printAstToDoc` (Impact: 29.5), `mainPrintInternal` (Impact: 11.0)
...
- **Heaviest Functions:** `parse` (Impact: 4.6), `handleParseError` (Impact: 4.1)
...
- **Heaviest Functions:** `runSpellcheck` (Impact: 11.3), `updateConfig` (Impact: 1.6)
...
- **Heaviest Functions:** `embed` (Impact: 66.8)
...
- **Heaviest Functions:** `embed` (Impact: 36.9), `validateImportExport` (Impact: 7.8), `__onHtmlBindingRoot` (Impact: 3.5)
...
**Top Internal Functions/Classes:**
  * `needsParentheses` (Impact: 768.1)
    * *Intent:* /** * @import AstPath from "../../common/ast-path.js" */ /** * @param {AstPath} path * @returns {boo...
  * `isFollowedByRightBracket` (Impact: 24.2)
    * *Intent:* /** * @param {AstPath} path * @returns {boolean} */
  * `isPathInForStatementInitializer` (Impact: 7.7)
    * *Intent:* /** * @param {AstPath} path * @returns {boolean} */
  * `endsWithRightBracket` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
* *State Mutation (weighted view):* 18
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `clean` (Impact: 38.8)
  * `runCliWithoutGitignore` (Impact: 5.2)
  * `resolveDir` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `printJsxOpeningElement` (Impact: 35.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `isElseIfBlock` (Impact: 14.5)
  * `isPathExpressionPartNeedBrackets` (Impact: 12.8)
  * `printParams` (Impact: 9.6)
  * `printInverse` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `handleLastFunctionParameterComments` (Impact: 67.5)
  * `handleClassComments` (Impact: 32.4)
  * `handleMethodNameComments` (Impact: 29.7)
  * `handleCommentInEmptyParens` (Impact: 23.2)
  * `handleModuleSpecifiersComments` (Impact: 21.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 10 instances
...
**Top Internal Functions/Classes:**
  ...
  * `shouldPreserveContent` (Impact: 24.4)
  * `inferParserByTypeAttribute` (Impact: 24.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `printMdast` (Impact: 224.8)
  * `processor` (Impact: 30.7)
  * `printRoot` (Impact: 29.1)
  * `printTitle` (Impact: 28.3)
  * `prevOrNextWord` (Impact: 14.7)
    * *Intent:* /** * @import AstPath from "../../common/ast-path.js"; * @import {Doc} from "../../document/index.js...
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `formatFiles` (Impact: 100.7)
  * `format` (Impact: 45.5)
  * `handleError` (Impact: 44.0)
  * `stringify` (Impact: 22.3)
  * `formatStdin` (Impact: 12.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `splitTextIntoSentences` (Impact: 39.0)
  * `markAlignedList` (Impact: 35.2)
  * `markAlignedListLegacy` (Impact: 27.9)
  * `getBracketContent` (Impact: 19.6)
...
**Top Internal Functions/Classes:**
  * `coreFormat` (Impact: 59.8)
  * `formatWithCursor` (Impact: 29.9)
  * `formatRange` (Impact: 22.2)
  * `ensureIndexInText` (Impact: 10.6)
  * `normalizeInputAndOptions` (Impact: 9.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `chooseLayout` (Impact: 77.9)
  * `shouldBreakAfterOperator` (Impact: 61.5)
  * `printAssignment` (Impact: 31.8)
    * *Intent:* /** * @import AstPath from "../../common/ast-path.js" */
  * `isPoorlyBreakableMemberOrCallChain` (Impact: 28.9)
...
**Top Internal Functions/Classes:**
  * `handleFormatMessage` (Impact: 29.0)
    * *Intent:* /** */
  * `formatCode` (Impact: 9.4)
    * *Intent:* /** */
  * `createPlugin` (Impact: 8.2)
    * *Intent:* // Similar to `createParsersAndPrinters` in `src/plugins/builtin-plugins-proxy.js`
  * `stringifyError` (Impact: 8.1)
  * `serializeAst` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `extractWhitespaces` (Impact: 36.6)
    * *Intent:* /** * - add `hasLeadingSpaces` field * - add `hasTrailingSpaces` field * - add `hasDanglingSpaces` f...
  * `mergeSimpleElementIntoText` (Impact: 27.7)
  * `isSimpleElement` (Impact: 27.6)
  * `extractInterpolation` (Impact: 20.4)
  * `mergeNodeIntoText` (Impact: 17.6)
**Contextual Mitigations & Amplifications:**
...
- `src/language-js/parse/postprocess/index.js` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.485%)
...
- `src/language-css/print/sequence.js` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 99.9932%)
