...
| Avg Path Length | 2.3329 | Hops between files. Lower = Tighter coupling. |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 66.4 | 75.0 | 100.0 |
...
- `urlopen` (@ `urllib3-2.6.3/src/urllib3/connectionpool.py`) -> Impact: **142.1** | LOC: 369
- `_ssl_wrap_socket_and_match_hostname` (@ `urllib3-2.6.3/src/urllib3/connection.py`) -> Impact: **109.2** | LOC: 123
- `increment` (@ `urllib3-2.6.3/src/urllib3/util/retry.py`) -> Impact: **81.2** | LOC: 96
- `create_urllib3_context` (@ `urllib3-2.6.3/src/urllib3/util/ssl_.py`) -> Impact: **78.2** | LOC: 150
- `request` (@ `urllib3-2.6.3/src/urllib3/connection.py`) -> Impact: **74.4** | LOC: 96
...
- `match_hostname` (@ `urllib3-2.6.3/src/urllib3/util/ssl_match_hostname.py`) -> Impact: **55.2** | LOC: 65
- `ssl_wrap_socket` (@ `urllib3-2.6.3/src/urllib3/util/ssl_.py`) -> Impact: **52.2** | LOC: 72
- `read` (@ `urllib3-2.6.3/src/urllib3/response.py`) -> Impact: **51.7** | LOC: 95
- `_make_request` (@ `urllib3-2.6.3/src/urllib3/connectionpool.py`) -> Impact: **46.4** | LOC: 180
- `read1` (@ `urllib3-2.6.3/src/urllib3/response.py`) -> Impact: **45.5** | LOC: 69
...
### 1. `urllib3-2.6.3/dummyserver/app.py` (PYTHON) -> Cumulative Risk: **782.02**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 790.14 | **LOC:** 484 | **CtrlFlow:** 15.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Safety Score (97.4925%)
- **Heaviest Functions:** `pyodide_upload` (Impact: 10.0), `encodingrequest` (Impact: 7.0), `upload` (Impact: 6.4)

### 2. `urllib3-2.6.3/dummyserver/testcase.py` (PYTHON) -> Cumulative Risk: **767.66**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 286.78 | **LOC:** 354 | **CtrlFlow:** 9.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9973%), Concurrency (99.9866%), Safety Score (87.5501%)
- **Heaviest Functions:** `start_response_handler` (Impact: 19.7), `assert_header_received` (Impact: 14.3), `socket_handler` (Impact: 12.6)

### 3. `urllib3-2.6.3/src/urllib3/contrib/emscripten/fetch.py` (PYTHON) -> Cumulative Risk: **765.69**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 5.16 | **LOC:** 727 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (97.8154%), Safety Score (96.2416%)
- **Heaviest Functions:** `send_request` (Impact: 22.1), `send_jspi_request` (Impact: 21.1), `send` (Impact: 19.1)

### 4. `urllib3-2.6.3/src/urllib3/exceptions.py` (PYTHON) -> Cumulative Risk: **724.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 133.5 | **LOC:** 336 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9593%), Tech Debt (97.6035%)
- **Heaviest Functions:** `__init__` (Impact: 10.9), `__init__` (Impact: 4.2), `pool` (Impact: 3.3)

### 5. `urllib3-2.6.3/src/urllib3/response.py` (PYTHON) -> Cumulative Risk: **687.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1266.04 | **LOC:** 1481 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (92.651%), Documentation (89.2617%)
- **Heaviest Functions:** `read` (Impact: 51.7), `read1` (Impact: 45.5), `read_chunked` (Impact: 44.1)

### 6. `urllib3-2.6.3/src/urllib3/http2/connection.py` (PYTHON) -> Cumulative Risk: **684.36**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 306.84 | **LOC:** 357 | **CtrlFlow:** 21.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (93.9719%), Documentation (88.2353%)
- **Heaviest Functions:** `request` (Impact: 36.7), `send` (Impact: 28.2), `putrequest` (Impact: 19.4)

### 7. `urllib3-2.6.3/dummyserver/asgi_proxy.py` (PYTHON) -> Cumulative Risk: **682.56**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `absolute_uri` (Impact: 11.0), `__call__` (Impact: 9.4), `connect` (Impact: 7.2)

### 8. `urllib3-2.6.3/dummyserver/hypercornserver.py` (PYTHON) -> Cumulative Risk: **664.34**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 105.32 | **LOC:** 147 | **CtrlFlow:** 10.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (95.2574%)
- **Heaviest Functions:** `run_hypercorn_in_thread` (Impact: 11.4), `_create_urllib3_sockets` (Impact: 8.2), `_retry_create_urllib3_sockets` (Impact: 6.2)

### 9. `urllib3-2.6.3/src/urllib3/util/ssltransport.py` (PYTHON) -> Cumulative Risk: **657.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 257.06 | **LOC:** 272 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (96.2264%), Safety Score (92.4634%)
- **Heaviest Functions:** `makefile` (Impact: 42.2), `_ssl_io_loop` (Impact: 26.4), `_wrap_ssl_read` (Impact: 8.4)

### 10. `urllib3-2.6.3/src/urllib3/http2/probe.py` (PYTHON) -> Cumulative Risk: **637.79**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 83.7 | **LOC:** 88 | **CtrlFlow:** 8.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Safety Score (96.0646%)
- **Heaviest Functions:** `set_and_release` (Impact: 9.6), `acquire_and_get` (Impact: 5.6), `_values` (Impact: 3.0)
...
- **Magnitude:** 1266.04 | **LOC:** 1481 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (75.9744%), Tech Debt (39.7315%)
**Top Internal Functions/Classes:**
  * `read` (Impact: 51.7)
  * `read1` (Impact: 45.5)
  * `read_chunked` (Impact: 44.1)
  * `_fp_read` (Impact: 42.8)
  * `_raw_read` (Impact: 34.5)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 790.14 | **LOC:** 484 | **CtrlFlow:** 15.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (85.9943%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `pyodide_upload` (Impact: 10.0)
  * `encodingrequest` (Impact: 7.0)
  * `upload` (Impact: 6.4)
  * `_get_pyodide_template` (Impact: 5.6)
    * *Intent:* # serve code to run pyodide in a webworker, or html template # these are included in pytest_pyodide,...
  * `successful_retry` (Impact: 4.8)
...
- **Risk Profile:** Cognitive Load (70.5474%), Tech Debt (10.2581%)
**Top Internal Functions/Classes:**
  * `_ssl_wrap_socket_and_match_hostname` (Impact: 109.2)
  * `request` (Impact: 74.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.011011 | `Ripple Effect (Closeness):` 0.045455
...
- **Risk Profile:** Cognitive Load (41.7772%), Tech Debt (9.4041%)
**Top Internal Functions/Classes:**
  * `urlopen` (Impact: 142.1)
  * `_make_request` (Impact: 46.4)
  * `__init__` (Impact: 24.6)
  * `is_same_host` (Impact: 14.9)
    * *Intent:* """ Check if the given ``url`` is a member of the same host as this connection pool. """
  * `_get_conn` (Impact: 14.0)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.143869 | `Ripple Effect (Closeness):` 0.3126
...
- **Risk Profile:** Cognitive Load (38.2467%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `urlopen` (Impact: 43.2)
  * `__init__` (Impact: 21.9)
  * `_default_key_normalizer` (Impact: 18.2)
  * `_new_pool` (Impact: 16.5)
  * `connection_from_host` (Impact: 11.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (46.1866%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `increment` (Impact: 81.2)
  * `__init__` (Impact: 28.5)
  * `is_retry` (Impact: 16.7)
  * `from_int` (Impact: 14.3)
  * `parse_retry_after` (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (47.8917%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `extend` (Impact: 29.6)
  ...
  * `ensure_can_construct_http_header_dict` (Impact: 10.8)
...
- **Risk Profile:** Cognitive Load (63.6292%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `create_urllib3_context` (Impact: 78.2)
  * `ssl_wrap_socket` (Impact: 52.2)
  * `assert_fingerprint` (Impact: 15.5)
    * *Intent:* """ Checks if given fingerprint matches the supplied certificate. :param cert: Certificate as bytes ...
  * `_is_bpo_43522_fixed` (Impact: 13.2)
  * `_ssl_wrap_socket_impl` (Impact: 9.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (60.173%), Tech Debt (10.4072%)
**Top Internal Functions/Classes:**
  * `parse_url` (Impact: 41.9)
    * *Intent:* """ Given a url, return a parsed :class:`.Url` namedtuple. Best-effort is performed to parse incompl...
  * `_normalize_host` (Impact: 29.1)
  * `_encode_invalid_chars` (Impact: 17.3)
  * `_remove_path_dot_segments` (Impact: 14.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.026735 | `Ripple Effect (Closeness):` 0.356364
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 306.84 | **LOC:** 357 | **CtrlFlow:** 21.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (72.3055%), Tech Debt (20.8716%)
**Top Internal Functions/Classes:**
  * `request` (Impact: 36.7)
  * `send` (Impact: 28.2)
    * *Intent:* """Send data to the server. `data` can be: `str`, `bytes`, an iterable, or file-like objects that su...
  * `putrequest` (Impact: 19.4)
  * `getresponse` (Impact: 17.6)
  * `putheader` (Impact: 16.6)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 286.78 | **LOC:** 354 | **CtrlFlow:** 9.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (83.0678%), Tech Debt (71.198%)
**Top Internal Functions/Classes:**
  * `start_response_handler` (Impact: 19.7)
  * `assert_header_received` (Impact: 14.3)
  * `socket_handler` (Impact: 12.6)
  * `consume_socket` (Impact: 10.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 257.06 | **LOC:** 272 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (71.8476%), Tech Debt (12.112%)
**Top Internal Functions/Classes:**
  * `makefile` (Impact: 42.2)
  * `_ssl_io_loop` (Impact: 26.4)
  * `_wrap_ssl_read` (Impact: 8.4)
  * `recv_into` (Impact: 7.3)
  * `sendall` (Impact: 6.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `format_header_param_rfc2231` (Impact: 14.4)
    * *Intent:* """ Helper function to format and quote a single header parameter using the strategy defined in RFC ...
  * `from_tuples` (Impact: 13.3)
  * `_render_parts` (Impact: 10.2)
  * `render_headers` (Impact: 9.4)
...
- **Risk Profile:** Cognitive Load (58.1148%), Tech Debt (14.2366%)
**Top Internal Functions/Classes:**
  * `make_headers` (Impact: 30.5)
  * `body_to_chunks` (Impact: 27.4)
  * `rewind_body` (Impact: 13.5)
    * *Intent:* """ Attempt to rewind body to a certain position. Primarily used for request redirects and retries. ...
  * `set_file_position` (Impact: 6.1)
  * `chunk_readable` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000458 | `Ripple Effect (Closeness):` 0.228438
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 157.3 | **LOC:** 115 | **CtrlFlow:** 12.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.9816%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `absolute_uri` (Impact: 11.0)
  * `__call__` (Impact: 9.4)
  * `connect` (Impact: 7.2)
  * `_read_body` (Impact: 6.2)
  * `start_forward` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 9 instances
...
- **Risk Profile:** Cognitive Load (54.4201%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ssl_options_to_context` (Impact: 18.0)
  * `_start_server` (Impact: 8.1)
  * `_has_ipv6` (Impact: 5.3)
    * *Intent:* """Returns True if the system can bind an IPv6 address."""
  * `_resolves_to_ipv6` (Impact: 4.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001762 | `Ripple Effect (Closeness):` 0.022727
...
- **Risk Profile:** Cognitive Load (46.9455%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `match_hostname` (Impact: 55.2)
  * `_dnsname_match` (Impact: 22.7)
  * `_ipaddress_match` (Impact: 2.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 133.5 | **LOC:** 336 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (31.051%), Tech Debt (97.6035%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 10.9)
...
- **Risk Profile:** Cognitive Load (34.4515%), Tech Debt (23.0251%)
**Top Internal Functions/Classes:**
  * `request` (Impact: 36.9)
  * `request_encode_body` (Impact: 28.8)
  * `request_encode_url` (Impact: 9.7)
  * `urlopen` (Impact: 3.7)
  * `__init__` (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 105.32 | **LOC:** 147 | **CtrlFlow:** 10.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (86.2693%), Tech Debt (16.8108%)
**Top Internal Functions/Classes:**
  * `run_hypercorn_in_thread` (Impact: 11.4)
  * `_create_urllib3_sockets` (Impact: 8.2)
  * `_retry_create_urllib3_sockets` (Impact: 6.2)
    * *Intent:* # When we request a socket with host localhost and port zero, Hypercorn # only binds to IPv4. But we...
  * `create_sockets` (Impact: 4.7)
  * `_start_server` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (51.2455%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `select_wait_for_socket` (Impact: 16.8)
    * *Intent:* # # Now, how do we choose between select() and poll()? On traditional Unixes, # select() has a stran...
  * `poll_wait_for_socket` (Impact: 14.6)
  * `wait_for_socket` (Impact: 7.5)
  * `do_poll` (Impact: 3.0)
    * *Intent:* # For some reason, poll() takes timeout in milliseconds
  * `_have_working_poll` (Impact: 2.5)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 83.7 | **LOC:** 88 | **CtrlFlow:** 8.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (66.2758%), Tech Debt (50.0%)
**Top Internal Functions/Classes:**
  * `set_and_release` (Impact: 9.6)
  * `acquire_and_get` (Impact: 5.6)
...
- `urllib3-2.6.3/src/urllib3/connectionpool.py` -> **Severity: 14.387** (Bridge: 0.1439 * Flux: 99.9995%)
...
- `urllib3-2.6.3/src/urllib3/util/url.py` -> **Severity: 2.673** (Bridge: 0.0267 * Flux: 100.0%)
