...
- `unicode_at_default_boundary` (@ `regex-2026.4.4/src/_regex.c`) -> Impact: **142.6** | LOC: 219
...
- `_compile` (@ `regex-2026.4.4/regex/_main.py`) -> Impact: **116.5** | LOC: 224
- `test_properties` (@ `regex-2026.4.4/regex/tests/test_regex.py`) -> Impact: **111.0** | LOC: 183
- `re_compile` (@ `regex-2026.4.4/src/_regex.c`) -> Impact: **95.9** | LOC: 256
...
- `test_hg_bugs` (@ `regex-2026.4.4/regex/tests/test_regex.py`) -> Impact: **87.3** | LOC: 616
...
- `unicode_at_grapheme_boundary` (@ `regex-2026.4.4/src/_regex.c`) -> Impact: **87.1** | LOC: 148
...
- `parse_escape` (@ `regex-2026.4.4/regex/_regex_core.py`) -> Impact: **66.1** | LOC: 82
- `parse_sequence` (@ `regex-2026.4.4/regex/_regex_core.py`) -> Impact: **64.9** | LOC: 85
- `pattern_findall` (@ `regex-2026.4.4/src/_regex.c`) -> Impact: **64.4** | LOC: 128
  * *Intent:* /* PatternObject's 'findall' method. */
- `lookup_property` (@ `regex-2026.4.4/regex/_regex_core.py`) -> Impact: **64.3** | LOC: 69
...
- **Heaviest Functions:** `parse_escape` (Impact: 66.1), `parse_sequence` (Impact: 64.9), `lookup_property` (Impact: 64.3)
...
- **Heaviest Functions:** `_compile` (Impact: 116.5), `escape` (Impact: 35.8), `_compile_replacement_helper` (Impact: 26.8)
...
- **Heaviest Functions:** `unicode_at_default_boundary` (Impact: 142.6), `re_compile` (Impact: 95.9), `unicode_at_grapheme_boundary` (Impact: 87.1)
...
- **Heaviest Functions:** `generate_code` (Impact: 62.0), `write_summary` (Impact: 49.4), `generate_all_cases` (Impact: 31.9)
...
- **Heaviest Functions:** `test_properties` (Impact: 111.0), `test_hg_bugs` (Impact: 87.3), `test_repeat_minmax` (Impact: 45.6)
...
**Top Internal Functions/Classes:**
  * `parse_escape` (Impact: 66.1)
  * `parse_sequence` (Impact: 64.9)
  * `lookup_property` (Impact: 64.3)
  * `_compile_replacement` (Impact: 45.5)
  * `parse_paren` (Impact: 37.5)
...
**Top Internal Functions/Classes:**
  * `test_properties` (Impact: 111.0)
  * `test_hg_bugs` (Impact: 87.3)
    * *Intent:* # Hg issue 28: regex.compile("(?>b)") causes "TypeError: 'Character' # object is not subscriptable" ...
  * `test_repeat_minmax` (Impact: 45.6)
  * `test_partial` (Impact: 40.8)
  * `test_branch_reset` (Impact: 36.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `generate_code` (Impact: 62.0)
  * `write_summary` (Impact: 49.4)
  * `generate_all_cases` (Impact: 31.9)
  * `generate_script_extensions_lookup` (Impact: 27.6)
  * `generate_full_case_folding` (Impact: 25.6)
**Contextual Mitigations & Amplifications:**
