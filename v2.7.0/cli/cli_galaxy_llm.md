...
| Avg Path Length | 5.4962 | Hops between files. Lower = Tighter coupling. |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 19.8 | 0.0 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 19.2 | 0.0 | 0.0 |
...
| credential | 2043 | 50 | 0 | `workspaces/arborist/test/fixtures/reify-cases/audit-fix-old-tap.js` |
...
- `exports` (@ `workspaces/arborist/test/fixtures/reify-cases/tap-with-yarn-lock.js`) -> Impact: **1013.2** | LOC: 20581
  * *Intent:* // generated from test/fixtures/tap-with-yarn-lock
- `errorMessage` (@ `lib/utils/error-message.js`) -> Impact: **184.7** | LOC: 369
- `exports` (@ `workspaces/arborist/test/fixtures/reify-cases/audit-fix-old-tap.js`) -> Impact: **167.4** | LOC: 13387
  * *Intent:* // generated from test/fixtures/audit-fix-old-tap
- `logHandler` (@ `workspaces/config/test/index.js`) -> Impact: **153.4** | LOC: 947
- `exports` (@ `workspaces/arborist/test/fixtures/reify-cases/dep-installed-without-bin-link.js`) -> Impact: **144.9** | LOC: 523
  * *Intent:* // generated from test/fixtures/dep-installed-without-bin-link
- `buildLegacyLockfile` (@ `workspaces/arborist/lib/shrinkwrap.js`) -> Impact: **119.8** | LOC: 156
- `filter` (@ `workspaces/arborist/lib/arborist/reify.js`) -> Impact: **114.6** | LOC: 318
- `root` (@ `workspaces/arborist/lib/node.js`) -> Impact: **112.5** | LOC: 271
- `extract` (@ `workspaces/arborist/test/arborist/build-ideal-tree.js`) -> Impact: **108.7** | LOC: 1293
- `apply` (@ `workspaces/arborist/test/isolated-mode.js`) -> Impact: **106.0** | LOC: 1839
...
### 1. `mock-registry/lib/index.js` (JAVASCRIPT) -> Cumulative Risk: **863.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 543.62 | **LOC:** 674 | **CtrlFlow:** 14.4% | **Authorship Centralization:** 25.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9956%), Secrets Risk (99.9943%), Concurrency (99.7139%)
- **Heaviest Functions:** `tnock` (Impact: 35.6), `noMatch` (Impact: 23.3), `putPackagePayload` (Impact: 15.9)

### 2. `workspaces/arborist/lib/arborist/isolated-reifier.js` (JAVASCRIPT) -> Cumulative Risk: **797.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 486.58 | **LOC:** 473 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 57.1%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Cognitive Load (96.1471%)
- **Heaviest Functions:** `assignCommonProperties` (Impact: 63.5), `processDeps` (Impact: 21.2), `createBundledTree` (Impact: 20.4)

### 3. `workspaces/arborist/lib/arborist/index.js` (JAVASCRIPT) -> Cumulative Risk: **775.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 256.66 | **LOC:** 311 | **CtrlFlow:** 25.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9999%), State Flux (99.997%)
- **Heaviest Functions:** `constructor` (Impact: 33.2), `workspaceDependencySet` (Impact: 25.6), `audit` (Impact: 11.9)

### 4. `lib/commands/pkg.js` (JAVASCRIPT) -> Cumulative Risk: **757.48**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 5. `lib/commands/team.js` (JAVASCRIPT) -> Cumulative Risk: **752.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 181.08 | **LOC:** 159 | **CtrlFlow:** 33.8% | **Authorship Centralization:** 50.0%
...
### 6. `workspaces/arborist/lib/arborist/reify.js` (JAVASCRIPT) -> Cumulative Risk: **744.4**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1143.88 | **LOC:** 1627 | **CtrlFlow:** 27.9% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9889%)
- **Heaviest Functions:** `filter` (Impact: 114.6), `reify` (Impact: 67.0), `updateNodes` (Impact: 61.1)

### 7. `workspaces/arborist/lib/audit-report.js` (JAVASCRIPT) -> Cumulative Risk: **740.19**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 237.6 | **LOC:** 331 | **CtrlFlow:** 20.8% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9974%)
- **Heaviest Functions:** `init` (Impact: 26.2), `shouldAudit` (Impact: 17.7), `toJSON` (Impact: 9.1)

### 8. `workspaces/arborist/lib/query-selector-all.js` (JAVASCRIPT) -> Cumulative Risk: **738.61**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 558.68 | **LOC:** 959 | **CtrlFlow:** 21.5% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.2239%), State Flux (99.1449%)
- **Heaviest Functions:** `nodeMatches` (Impact: 54.6), `hasParent` (Impact: 45.9), `semverPseudo` (Impact: 37.5)

### 9. `workspaces/arborist/lib/arborist/build-ideal-tree.js` (JAVASCRIPT) -> Cumulative Risk: **736.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1095.3 | **LOC:** 1595 | **CtrlFlow:** 30.7% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9998%), State Flux (99.9434%)
- **Heaviest Functions:** `buildDepStep` (Impact: 70.8), `nodeFromSpec` (Impact: 57.4), `applyUserRequestsToNode` (Impact: 52.0)

### 10. `lib/commands/fund.js` (JAVASCRIPT) -> Cumulative Risk: **730.07**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 154.36 | **LOC:** 216 | **CtrlFlow:** 17.9% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.8318%), Tech Debt (99.386%)
- **Heaviest Functions:** `openFundingUrl` (Impact: 25.5), `retrievePackageMetadata` (Impact: 18.7), `exec` (Impact: 13.8)
...
- **Risk Profile:** Cognitive Load (21.4712%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `checkPackageLock` (Impact: 42.7)
  * `extract` (Impact: 23.7)
  * `abbrevpj` (Impact: 19.6)
  * `onTime` (Impact: 18.9)
  * `extract` (Impact: 14.2)
...
- **Risk Profile:** Cognitive Load (94.4998%), Tech Debt (15.2738%)
**Top Internal Functions/Classes:**
  * `buildLegacyLockfile` (Impact: 119.8)
  * `metaFromLock` (Impact: 74.2)
  * `assertNoNewer` (Impact: 56.5)
    * *Intent:* // check to make sure that there are no packages newer than or missing from the hidden lockfile
  * `metaFromNode` (Impact: 51.1)
  * `add` (Impact: 49.6)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1143.88 | **LOC:** 1627 | **CtrlFlow:** 27.9% | **Authorship Centralization:** 33.3%
- **Risk Profile:** Cognitive Load (97.088%), Tech Debt (11.6438%)
**Top Internal Functions/Classes:**
  * `filter` (Impact: 114.6)
  * `reify` (Impact: 67.0)
    * *Intent:* // public method
  * `updateNodes` (Impact: 61.1)
  * `filterDirectDependencies` (Impact: 34.6)
  * `buildLinkedActualForDiff` (Impact: 28.6)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1095.3 | **LOC:** 1595 | **CtrlFlow:** 30.7% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (93.184%), Tech Debt (34.1213%)
**Top Internal Functions/Classes:**
  * `buildDepStep` (Impact: 70.8)
  * `nodeFromSpec` (Impact: 57.4)
  * `applyUserRequestsToNode` (Impact: 52.0)
  * `visit` (Impact: 40.2)
  * `loadPeerSet` (Impact: 37.4)
...
- **Risk Profile:** Cognitive Load (20.2354%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `extract` (Impact: 108.7)
  * `warn` (Impact: 85.5)
  * `rootAndWs` (Impact: 78.6)
    * *Intent:* // The following trees caused an infinite loop in a workspace // https://github.com/npm/cli/issues/3...
  * `printIdeal` (Impact: 29.9)
  * `pj` (Impact: 23.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (95.0094%), Tech Debt (9.8531%)
**Top Internal Functions/Classes:**
  * `root` (Impact: 112.5)
  * `constructor` (Impact: 69.3)
    * *Intent:* #global #meta #root #workspaces
  * `canReplaceWith` (Impact: 30.2)
    * *Intent:* // is it safe to replace one node with another? check the edges to // make sure no one will get upse...
  * `fsParent` (Impact: 28.1)
  * `canDedupe` (Impact: 26.7)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 908.16 | **LOC:** 2473 | **CtrlFlow:** 18.8% | **Authorship Centralization:** 36.4%
- **Risk Profile:** Cognitive Load (25.0916%), Tech Debt (26.2135%)
**Top Internal Functions/Classes:**
  * `flatten` (Impact: 40.6)
  * `flatten` (Impact: 33.7)
    * *Intent:* // basic flattening function, just copy it over camelCase
  * `buildOmitList` (Impact: 30.5)
  * `flatten` (Impact: 17.6)
  * `flatten` (Impact: 17.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (62.6964%), Tech Debt (11.6757%)
**Top Internal Functions/Classes:**
  * `loadObject` (Impact: 42.8)
  * `validate` (Impact: 33.2)
  * `loadLocalPrefix` (Impact: 23.4)
  * `setCredentialsByURI` (Impact: 22.5)
  * `invalidHandler` (Impact: 21.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (62.4484%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `logHandler` (Impact: 153.4)
  * `logHandler` (Impact: 33.3)
  * `readFile` (Impact: 21.9)
  * `logHandler` (Impact: 10.8)
  * `logHandler` (Impact: 9.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (39.4905%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (49.8688%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `password` (Impact: 16.2)
  * `set` (Impact: 13.6)
  * `password` (Impact: 10.6)
  * `set` (Impact: 7.9)
  * `set` (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 558.68 | **LOC:** 959 | **CtrlFlow:** 21.5% | **Authorship Centralization:** 33.3%
- **Risk Profile:** Cognitive Load (85.9517%), Tech Debt (10.8459%)
**Top Internal Functions/Classes:**
  * `nodeMatches` (Impact: 54.6)
  * `hasParent` (Impact: 45.9)
    * *Intent:* // checks if a given node has a direct parent in any of the nodes provided in // the compare nodes a...
  * `semverPseudo` (Impact: 37.5)
  * `vulnPseudo` (Impact: 26.4)
  * `attributeMatch` (Impact: 26.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 8 instances
...
**Top Internal Functions/Classes:**
  * `utimes` (Impact: 5.9)
  * `rmdirSync` (Impact: 5.9)
  * `mkdir` (Impact: 5.8)
  * `stat` (Impact: 5.8)
  * `mockRmdirSync` (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 543.62 | **LOC:** 674 | **CtrlFlow:** 14.4% | **Authorship Centralization:** 25.0%
- **Risk Profile:** Cognitive Load (92.5995%), Tech Debt (11.6854%)
**Top Internal Functions/Classes:**
  * `tnock` (Impact: 35.6)
  * `noMatch` (Impact: 23.3)
  * `putPackagePayload` (Impact: 15.9)
  * `publish` (Impact: 13.0)
  * `mocks` (Impact: 12.7)
...
- **Risk Profile:** Cognitive Load (87.0383%), Tech Debt (9.7241%)
**Top Internal Functions/Classes:**
  * `exec` (Impact: 61.8)
  * `getHumanOutputItem` (Impact: 41.3)
  * `getJsonOutputItem` (Impact: 37.8)
  * `filterBySelectedWorkspaces` (Impact: 24.7)
  * `mapEdgesToNodes` (Impact: 14.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (80.1156%), Tech Debt (31.6646%)
**Top Internal Functions/Classes:**
  * `errorMessage` (Impact: 184.7)
  * `getError` (Impact: 29.6)
  * `getExitCodeFromError` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 486.58 | **LOC:** 473 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 57.1%
- **Risk Profile:** Cognitive Load (96.1471%), Tech Debt (74.6632%)
**Top Internal Functions/Classes:**
  * `assignCommonProperties` (Impact: 63.5)
  * `processDeps` (Impact: 21.2)
  * `createBundledTree` (Impact: 20.4)
  * `processEdges` (Impact: 19.9)
  * `makeIdealGraph` (Impact: 19.4)
...
- **Risk Profile:** Cognitive Load (18.8237%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `getData` (Impact: 93.1)
  * `cleanSnapshot` (Impact: 14.1)
  * `loadAndReset` (Impact: 8.4)
  * `normalizePath` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 26 instances
* *Amplified Cascading Flux:* 7 instances
...
- **Risk Profile:** Cognitive Load (22.9765%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `apply` (Impact: 106.0)
  * `apply` (Impact: 21.9)
  * `apply` (Impact: 17.4)
...
- **Risk Profile:** Cognitive Load (49.7229%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `chdir` (Impact: 20.0)
  * `globals` (Impact: 16.5)
  * `config` (Impact: 10.0)
  * `load` (Impact: 5.9)
  * `cleanSnapshot` (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 37 instances
* *Amplified Cascading Flux:* 3 instances
...
- **Risk Profile:** Cognitive Load (19.6741%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `cleanSnapshot` (Impact: 20.7)
  * `getTarget` (Impact: 19.9)
  * `verify` (Impact: 9.7)
  * `verify` (Impact: 2.8)
  * `manifestWithValidSigs` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (49.714%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `read` (Impact: 11.4)
  * `read` (Impact: 9.3)
  * `read` (Impact: 7.0)
...
**Top Internal Functions/Classes:**
  * `globals` (Impact: 18.2)
  * `globals` (Impact: 4.9)
  * `loadMockCompletionComp` (Impact: 2.8)
  * `loadMockCompletion` (Impact: 2.0)
  * `globals` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
- `workspaces/arborist/bin/lib/logging.js` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 99.1943%)
- `workspaces/arborist/lib/arborist/index.js` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 99.997%)
- `workspaces/arborist/lib/shrinkwrap.js` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 100.0%)
