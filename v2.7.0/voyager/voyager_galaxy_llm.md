...
- `fds_cpu_step` (@ `src/fds_cpu.c`) -> Impact: **224.2** | LOC: 570
  * *Intent:* /* ============================================================================ * INSTRUCTION EXECUTION * ============================================...
- `fds_disassemble` (@ `src/fds_cpu.c`) -> Impact: **154.9** | LOC: 179
  * *Intent:* /* Disassemble a single instruction */
- `assemble_line` (@ `src/fds_asm.c`) -> Impact: **93.5** | LOC: 207
  * *Intent:* /* ============================================================================ * ASSEMBLER CORE * ===================================================...
- `main` (@ `src/main.c`) -> Impact: **68.5** | LOC: 122
- `run_interactive` (@ `src/main.c`) -> Impact: **36.8** | LOC: 58
- `parse_number` (@ `src/fds_asm.c`) -> Impact: **32.0** | LOC: 40
  * *Intent:* /* Parse number (hex or decimal) */
- `run_test_program` (@ `src/main.c`) -> Impact: **29.4** | LOC: 68
- `fds_dma_service` (@ `src/fds_cpu.c`) -> Impact: **28.1** | LOC: 42
...
- `fds_assemble` (@ `src/fds_asm.c`) -> Impact: **23.5** | LOC: 55
  * *Intent:* /* ============================================================================ * PUBLIC API * =======================================================...
- `fds_cpu_run` (@ `src/fds_cpu.c`) -> Impact: **20.0** | LOC: 40
...
- **Heaviest Functions:** `fds_cpu_step` (Impact: 224.2), `fds_disassemble` (Impact: 154.9), `fds_dma_service` (Impact: 28.1)
...
- **Heaviest Functions:** `assemble_line` (Impact: 93.5), `parse_number` (Impact: 32.0), `fds_assemble` (Impact: 23.5)
...
- **Heaviest Functions:** `main` (Impact: 68.5), `run_interactive` (Impact: 36.8), `run_test_program` (Impact: 29.4)
...
- **Heaviest Functions:** `all` (Impact: 1.5), `test` (Impact: 1.1), `clean` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `fds_cpu_step` (Impact: 224.2)
    * *Intent:* /* ============================================================================ * INSTRUCTION EXECUT...
  * `fds_disassemble` (Impact: 154.9)
    * *Intent:* /* Disassemble a single instruction */
  * `fds_dma_service` (Impact: 28.1)
    * *Intent:* /* * Service pending DMA requests. * Called during instruction execution "access windows". * Process...
  * `fds_cpu_run` (Impact: 20.0)
    * *Intent:* /* Run for up to max_cycles, or until halted */
  * `fds_load_file` (Impact: 13.3)
...
**Top Internal Functions/Classes:**
  * `assemble_line` (Impact: 93.5)
    * *Intent:* /* ============================================================================ * ASSEMBLER CORE * =...
  * `parse_number` (Impact: 32.0)
    * *Intent:* /* Parse number (hex or decimal) */
  * `fds_assemble` (Impact: 23.5)
    * *Intent:* /* ============================================================================ * PUBLIC API * =====...
  * `fds_asm_error_str` (Impact: 16.3)
  * `add_label` (Impact: 12.7)
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 68.5)
  * `run_interactive` (Impact: 36.8)
  * `run_test_program` (Impact: 29.4)
  * `write_binary` (Impact: 6.1)
    * *Intent:* /* Write assembled program to binary file */
  * `print_usage` (Impact: 5.3)
