...
| Connectivity (formerly API Exposure) | 0.0 | 71.8 | 3.0 | 0.0 | 0.0 |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 60.7 | 100.0 | 100.0 |
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 2.5 | 0.5 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 3.9 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 8.9 | 0.0 | 0.0 |
...
| connectivity | 8954 | 762 | 10 | `wp-content/themes/twentytwentyone/style-rtl.css` |
...
| dead_code | 5540 | 804 | 5 | `wp-includes/deprecated.php` |
...
- `encoding` (@ `wp-includes/SimplePie/src/Misc.php`) -> Impact: **1212.5** | LOC: 1312
...
- `QuicktimeParseAtom` (@ `wp-includes/ID3/module.audio-video.quicktime.php`) -> Impact: **1168.4** | LOC: 1037
...
- `map_meta_cap` (@ `wp-includes/capabilities.php`) -> Impact: **679.8** | LOC: 836
...
- `parseEBML` (@ `wp-includes/ID3/module.audio-video.matroska.php`) -> Impact: **563.0** | LOC: 738
  * *Intent:* /** * @param array $info */
- `redirect_canonical` (@ `wp-includes/canonical.php`) -> Impact: **509.8** | LOC: 808
...
- `ParseID3v2Frame` (@ `wp-includes/ID3/module.tag.id3v2.php`) -> Impact: **500.7** | LOC: 1161
  * *Intent:* /** * @param array $parsedFrame * * @return bool */
- `get_posts` (@ `wp-includes/class-wp-query.php`) -> Impact: **470.7** | LOC: 1774
...
- `init` (@ `wp-includes/js/codemirror/csslint.js`) -> Impact: **420.1** | LOC: 1751
  * *Intent:* // initialization
- `xmlEncode` (@ `wp-includes/js/plupload/plupload.js`) -> Impact: **367.6** | LOC: 1695
  * *Intent:* /** * Encodes the specified string. * * @method xmlEncode * @static * @param {String} s String to encode. * @return {String} Encoded string. */
- `wp_insert_post` (@ `wp-includes/post.php`) -> Impact: **349.4** | LOC: 707
...
|---|---|---|---|---|
| `wp-includes` | 250 | 136609.02 | 31.24% | 49.83% |
| `wp-admin/includes` | 104 | 55872.0 | 38.07% | 52.12% |
| `wp-includes/js` | 47 | 33516.61 | 46.26% | 22.91% |
| `wp-admin/js` | 49 | 21849.1 | 37.38% | 18.4% |
...
| `wp-includes/SimplePie/src` | 22 | 13069.72 | 35.64% | 58.24% |
| `wp-includes/js/jquery/ui` | 36 | 12070.22 | 58.85% | 30.59% |
...
### 1. `wp-includes/js/backbone.js` (JAVASCRIPT) -> Cumulative Risk: **728.63**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1808.12 | **LOC:** 2158 | **CtrlFlow:** 32.4% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (98.4778%)
- **Heaviest Functions:** `set` (Impact: 87.1), `sync` (Impact: 45.0), `offApi` (Impact: 44.9)

### 2. `wp-includes/js/tinymce/plugins/paste/plugin.js` (JAVASCRIPT) -> Cumulative Risk: **714.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2207.04 | **LOC:** 2368 | **CtrlFlow:** 19.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9817%)
- **Heaviest Functions:** `isWordContent` (Impact: 165.5), `registerEventHandlers` (Impact: 85.5), `setup` (Impact: 47.0)

### 3. `wp-includes/js/jquery/ui/mouse.js` (JAVASCRIPT) -> Cumulative Risk: **710.42**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_mouseMove` (Impact: 32.1), `_mouseDown` (Impact: 21.6), `_mouseUp` (Impact: 6.9)

### 4. `wp-includes/js/quicktags.js` (JAVASCRIPT) -> Cumulative Risk: **674.89**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_escape` (Impact: 208.1), `QTags` (Impact: 40.7), `_domReady` (Impact: 19.5)
...
- **Heaviest Functions:** `hoverIntent` (Impact: 29.4), `handleHover` (Impact: 13.7), `compare` (Impact: 7.7)
...
- **Heaviest Functions:** `doNextErasure` (Impact: 21.1), `onErasureDoneSuccess` (Impact: 13.2), `doNextExport` (Impact: 12.3)

### 7. `wp-includes/js/underscore.js` (JAVASCRIPT) -> Cumulative Risk: **650.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1237.3 | **LOC:** 2064 | **CtrlFlow:** 29.6% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (98.5565%)
- **Heaviest Functions:** `isEqual` (Impact: 107.4), `collectNonEnumProps` (Impact: 16.4), `restArguments` (Impact: 15.0)

### 8. `wp-includes/js/tinymce/utils/form_utils.js` (JAVASCRIPT) -> Cumulative Risk: **644.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `selectByValue` (Impact: 31.0), `addClassesToList` (Impact: 9.9), `setBrowserDisabled` (Impact: 9.6)

### 9. `wp-admin/includes/class-ftp.php` (PHP) -> Cumulative Risk: **635.86**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1213.22 | **LOC:** 923 | **CtrlFlow:** 36.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.7777%)
- **Heaviest Functions:** `mget` (Impact: 35.9), `mput` (Impact: 35.6), `parselisting` (Impact: 29.9)

### 10. `wp-includes/js/tinymce/plugins/wordpress/plugin.js` (JAVASCRIPT) -> Cumulative Risk: **625.72**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 841.36 | **LOC:** 1207 | **CtrlFlow:** 28.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `create` (Impact: 128.9), `reposition` (Impact: 45.2), `toggleToolbars` (Impact: 35.4)
...
**Top Internal Functions/Classes:**
  * `init` (Impact: 420.1)
    * *Intent:* // initialization
  * `prototype` (Impact: 297.2)
  * `PropertyValuePart` (Impact: 280.8)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 6527.46 | **LOC:** 9608 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.4794%), Tech Debt (10.1998%)
**Top Internal Functions/Classes:**
  * `recalc` (Impact: 94.9)
  * `recalc` (Impact: 67.4)
  * `addContextualToolbars` (Impact: 62.7)
  * `createMenu` (Impact: 33.5)
  * `render` (Impact: 33.0)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 2`, `high_risk_execution: 8`, `state_mutation: 1410`, `duplicate_logic: 12`
* *Architecture:* `api: 8`, `concurrency: 12`
...
**Top Internal Functions/Classes:**
  ...
  * `parseClassElement` (Impact: 65.5)
    * *Intent:* // https://tc39.github.io/ecma262/#sec-class-definitions
  * `parseObjectProperty` (Impact: 59.4)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 6193.94 | **LOC:** 9793 | **CtrlFlow:** 16.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.2552%), Tech Debt (10.1477%)
**Top Internal Functions/Classes:**
  * `recalc` (Impact: 94.9)
  * `recalc` (Impact: 67.4)
  * `createFormatMenu` (Impact: 32.7)
  * `init` (Impact: 30.3)
  * `showMenu` (Impact: 28.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
* *Risk/State:* `safety_bypasses: 7`, `high_risk_execution: 8`, `state_mutation: 1409`, `duplicate_logic: 12`
* *Architecture:* `api: 5`, `concurrency: 15`
...
**Top Internal Functions/Classes:**
  * `XMLHttpRequest` (Impact: 132.0)
  * `HTML5Image` (Impact: 98.4)
  * `XMLHttpRequest` (Impact: 93.0)
  * `Runtime` (Impact: 85.1)
    * *Intent:* */
  * `send` (Impact: 81.0)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 5478.56 | **LOC:** 9285 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 34.8%
- **Risk Profile:** Cognitive Load (37.9506%), Tech Debt (85.3231%)
**Top Internal Functions/Classes:**
  * `wp_unique_filename` (Impact: 88.2)
    * *Intent:* * If the filename is not unique, then a number will be added to the filename * before the extension,...
  * `wp_timezone_choice` (Impact: 75.3)
  * `wp_check_filetype_and_ext` (Impact: 73.5)
    * *Intent:* * @since 3.0.0 * * @param string $file Full path to the file. * @param string $filename The name of ...
  * `recurse_dirsize` (Impact: 69.8)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 4142.36 | **LOC:** 6297 | **CtrlFlow:** 24.5% | **Authorship Centralization:** 44.4%
- **Risk Profile:** Cognitive Load (45.9488%), Tech Debt (75.3455%)
**Top Internal Functions/Classes:**
  * `sanitize_option` (Impact: 249.4)
    * *Intent:* /** * Sanitizes various option values based on the nature of the option. *
  * `wptexturize` (Impact: 132.9)
  ...
  * `wptexturize_primes` (Impact: 51.8)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 3804.66 | **LOC:** 10605 | **CtrlFlow:** 12.9% | **Authorship Centralization:** 66.7%
- **Risk Profile:** Cognitive Load (28.657%), Tech Debt (29.6093%)
**Top Internal Functions/Classes:**
  * `createToolbar` (Impact: 55.2)
  * `toggleSelectionHandler` (Impact: 32.2)
    * *Intent:* /** * @param {Object} event */
  * `toggleSelection` (Impact: 31.9)
...
* *Risk/State:* `state_mutation: 862`, `dead_code: 1`, `planned_debt: 9`, `fragile_debt: 1`, `duplicate_logic: 23`
* *Architecture:* `io: 5`, `api: 80`, `concurrency: 6`
...
**Top Internal Functions/Classes:**
  ...
  * `_publish_changeset_values` (Impact: 46.6)
...
- `wp-includes/php-ai-client/src/Operations/DTO/GenerativeAiOperation.php` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 99.9999%)
- `wp-includes/php-ai-client/src/Providers/DTO/ProviderMetadata.php` -> **Severity: 0.006** (Bridge: 0.0001 * Flux: 99.4802%)
- `wp-includes/php-ai-client/src/Results/DTO/GenerativeAiResult.php` -> **Severity: 0.005** (Bridge: 0.0 * Flux: 99.9999%)
- `wp-includes/Requests/src/Cookie/Jar.php` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 100.0%)
- `wp-includes/php-ai-client/src/Messages/DTO/Message.php` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.8439%)
