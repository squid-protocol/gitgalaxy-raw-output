...
| Avg Path Length | 3.0846 | Hops between files. Lower = Tighter coupling. |
...
| credential | 4 | 4 | 0 | `google_cloud_storage-3.10.1/google/cloud/_storage_v2/services/storage/async_client.py` |
...
- `_initiate_resumable_helper` (@ `google_cloud_storage-3.10.1/tests/unit/test_blob.py`) -> Impact: **158.4** | LOC: 203
- `__init__` (@ `google_cloud_storage-3.10.1/google/cloud/storage/client.py`) -> Impact: **118.5** | LOC: 157
- `generate_signed_url_v4` (@ `google_cloud_storage-3.10.1/google/cloud/storage/_signing.py`) -> Impact: **109.9** | LOC: 219
- `generate_signed_url` (@ `google_cloud_storage-3.10.1/google/cloud/storage/blob.py`) -> Impact: **96.2** | LOC: 225
- `_generate_signed_url_helper` (@ `google_cloud_storage-3.10.1/tests/unit/test_blob.py`) -> Impact: **88.5** | LOC: 121
- `_download_as_text_helper` (@ `google_cloud_storage-3.10.1/tests/unit/test_blob.py`) -> Impact: **83.4** | LOC: 99
- `_do_multipart_success` (@ `google_cloud_storage-3.10.1/tests/unit/test_blob.py`) -> Impact: **83.2** | LOC: 143
- `open` (@ `google_cloud_storage-3.10.1/google/cloud/storage/blob.py`) -> Impact: **80.0** | LOC: 161
- `generate_signed_post_policy_v4` (@ `google_cloud_storage-3.10.1/google/cloud/storage/client.py`) -> Impact: **76.8** | LOC: 166
- `_initiate_resumable_upload` (@ `google_cloud_storage-3.10.1/google/cloud/storage/blob.py`) -> Impact: **75.1** | LOC: 229
...
- **Heaviest Functions:** `__aiter__` (Impact: 4.6), `__aiter__` (Impact: 4.6), `__init__` (Impact: 4.5)
...
- **Heaviest Functions:** `create_bucket` (Impact: 56.1), `test_iam_permissions` (Impact: 55.4), `restore_object` (Impact: 47.8)
...
- **Heaviest Functions:** `download_ranges` (Impact: 70.4), `send_ranges_and_get_bytes` (Impact: 42.0), `open` (Impact: 33.9)
...
- **Heaviest Functions:** `__init__` (Impact: 57.6), `intercept_unary_unary` (Impact: 41.1), `restore_object` (Impact: 5.3)
...
- **Heaviest Functions:** `append` (Impact: 41.9), `open` (Impact: 34.0), `send_and_recv_generator` (Impact: 27.2)
...
- **Heaviest Functions:** `seek` (Impact: 26.2), `read` (Impact: 14.3), `__init__` (Impact: 14.3)
...
- **Heaviest Functions:** `open` (Impact: 35.0), `__init__` (Impact: 13.2), `recv` (Impact: 11.0)
...
- **Heaviest Functions:** `upload` (Impact: 10.2), `initiate` (Impact: 6.7), `transmit_next_chunk` (Impact: 6.0)
...
- **Heaviest Functions:** `__init__` (Impact: 57.6), `intercept_unary_unary` (Impact: 43.3), `restore_object` (Impact: 5.3)
...
- **Heaviest Functions:** `open` (Impact: 28.8), `__init__` (Impact: 12.2), `recv` (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `test_storage_client_get_mtls_endpoint_and_cert_source` (Impact: 19.4)
  * `test_use_client_cert_effective` (Impact: 17.9)
    * *Intent:* # Test case 1: Test when `should_use_client_cert` returns True. # We mock the `should_use_client_cer...
  * `test_storage_client_mtls_env_auto` (Impact: 16.2)
  * `test_storage_client_client_api_endpoint` (Impact: 14.9)
  * `test_storage_client_client_options` (Impact: 9.8)
...
**Top Internal Functions/Classes:**
  * `_initiate_resumable_helper` (Impact: 158.4)
  * `_generate_signed_url_helper` (Impact: 88.5)
  * `_download_as_text_helper` (Impact: 83.4)
  * `_do_multipart_success` (Impact: 83.2)
  * `_create_resumable_upload_session_helper` (Impact: 46.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_generate_signed_url_helper` (Impact: 55.2)
  * `_rename_blob_helper` (Impact: 19.0)
  * `_make_one` (Impact: 14.2)
  * `_generate_upload_policy_helper` (Impact: 10.4)
  * `_make_public_w_future_helper` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_iam_permissions` (Impact: 61.1)
  * `create_bucket` (Impact: 56.0)
  * `get_iam_policy` (Impact: 47.7)
  * `restore_object` (Impact: 47.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_bucket` (Impact: 56.1)
  * `test_iam_permissions` (Impact: 55.4)
  * `restore_object` (Impact: 47.8)
  * `move_object` (Impact: 46.4)
  * `delete_object` (Impact: 46.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `generate_signed_url` (Impact: 96.2)
  * `open` (Impact: 80.0)
  * `_initiate_resumable_upload` (Impact: 75.1)
  * `_do_multipart_upload` (Impact: 62.9)
  * `_do_download` (Impact: 46.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001498 | `Ripple Effect (Closeness):` 0.052322
...
**Top Internal Functions/Classes:**
  * `_download_blob_to_file_helper` (Impact: 30.2)
  * `_create_hmac_key_helper` (Impact: 28.5)
  * `_prepare_conditions` (Impact: 5.2)
    * *Intent:* """Helper for V4 POST policy generation conformance tests. Convert conformance test data conditions ...
  * `test_conformance_post_policy` (Impact: 5.0)
  * `test_list_blobs_w_explicit_w_user_project` (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `generate_signed_url` (Impact: 61.7)
  * `__init__` (Impact: 55.1)
  * `delete_blobs` (Impact: 44.6)
  * `copy_blob` (Impact: 29.0)
  * `make_public` (Impact: 25.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001544 | `Ripple Effect (Closeness):` 0.047339
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 118.5)
  * `generate_signed_post_policy_v4` (Impact: 76.8)
  * `list_blobs` (Impact: 61.8)
  * `create_bucket` (Impact: 57.7)
  * `list_buckets` (Impact: 42.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001562 | `Ripple Effect (Closeness):` 0.041176
...
**Top Internal Functions/Classes:**
  * `_consume_helper` (Impact: 20.1)
  * `_consume_helper` (Impact: 20.1)
  * `test__write_to_stream_with_hash_check_fail` (Impact: 12.4)
  * `test__write_to_stream_with_hash_check_fail` (Impact: 12.3)
...
**Top Internal Functions/Classes:**
  * `run_test_case` (Impact: 23.0)
    * *Intent:* ####################################################################################################...
  * `blob_upload_from_filename` (Impact: 7.2)
  * `blob_upload_from_file` (Impact: 7.0)
  * `bucket_set_iam_policy` (Impact: 6.7)
  * `bucket_rename_blob` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_prepare_request_helper` (Impact: 37.3)
  * `_prepare_initiate_request_helper` (Impact: 8.4)
  * `test__validate_checksum_header_no_match` (Impact: 7.0)
  * `test_xml_mpu_part` (Impact: 4.9)
  * `test__prepare_request_invalid` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_bucket_list_blobs_w_match_glob` (Impact: 9.4)
  * `test_bucket_get_set_iam_policy` (Impact: 8.6)
  * `test_list_buckets_with_ip_filter` (Impact: 6.6)
    * *Intent:* """Test that listing buckets returns a summarized IP filter."""
  * `test_bucket_list_blobs_include_managed_folders` (Impact: 6.4)
  * `test_bucket_lifecycle_rules` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_read_unfinalized_appendable_object_with_generation` (Impact: 4.8)
  * `test_wrd_with_non_default_flush_interval` (Impact: 4.7)
  * `test_wrd_open_with_write_handle` (Impact: 4.6)
  * `test_basic_wrd` (Impact: 4.5)
  * `test_basic_wrd_x_region` (Impact: 4.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `upload_many` (Impact: 61.9)
  * `download_many` (Impact: 55.4)
  * `download_chunks_concurrently` (Impact: 54.0)
  * `download_many_to_path` (Impact: 41.2)
  * `upload_chunks_concurrently` (Impact: 36.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_passthrough_methods` (Impact: 4.0)
  * `test_save_predefined_w_defaults` (Impact: 3.0)
  * `test_clear_w_defaults` (Impact: 3.0)
  * `test_save_w_acl_w_user_project` (Impact: 2.9)
  * `test_save_w_acl_w_preconditions` (Impact: 2.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_download_many_to_path_skips_download` (Impact: 9.6)
  * `test_upload_chunks_concurrently_with_metadata_and_encryption` (Impact: 6.9)
  * `test_download_many_to_path` (Impact: 5.3)
  * `test_upload_many_with_filenames` (Impact: 5.2)
  * `test_upload_many_with_file_objs` (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
...
**Top Internal Functions/Classes:**
  * `_generate_helper` (Impact: 68.2)
  * `_generate_helper` (Impact: 31.6)
  * `test_conformance_blob` (Impact: 8.0)
  * `test_conformance_bucket` (Impact: 6.3)
  * `_make_credentials` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_blob_crud_w_user_project` (Impact: 12.0)
  * `test_blob_acl_upload_predefined` (Impact: 8.3)
  * `test_blob_crud_w_generation_match` (Impact: 5.4)
  * `test_blob_rewrite_w_generation_match` (Impact: 5.3)
  * `test_blob_crud_w_etag_match` (Impact: 4.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_methods_require_open_stream_raises` (Impact: 5.8)
  * `test_append_recovery_reopens_stream` (Impact: 5.6)
    * *Intent:* """Verifies re-opening logic on retry."""
  * `mock_execute` (Impact: 4.1)
  * `test_standard_transient_errors` (Impact: 3.9)
    * *Intent:* # TODO: remove `mock_appendable_writer` param.
  * `test_append` (Impact: 3.9)
...
**Top Internal Functions/Classes:**
  * `append` (Impact: 41.9)
  * `open` (Impact: 34.0)
  * `send_and_recv_generator` (Impact: 27.2)
  * `_is_write_retryable` (Impact: 17.9)
...
**Top Internal Functions/Classes:**
  * `test_download_ranges_resumption_logging` (Impact: 7.4)
  * `test_download_ranges_via_async_gather` (Impact: 5.2)
  * `test_download_ranges` (Impact: 4.2)
  * `test_on_open_error_logs_warning` (Impact: 4.2)
    * *Intent:* # Arrange mock_client = mock.MagicMock() mrd = AsyncMultiRangeDownloader( mock_client, _TEST_BUCKET_...
  * `test_download_ranges_raises_on_checksum_mismatch` (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
- `google_cloud_storage-3.10.1/google/cloud/storage/client.py` -> **Severity: 0.156** (Bridge: 0.0016 * Flux: 100.0%)
- `google_cloud_storage-3.10.1/google/cloud/storage/bucket.py` -> **Severity: 0.154** (Bridge: 0.0015 * Flux: 99.9989%)
