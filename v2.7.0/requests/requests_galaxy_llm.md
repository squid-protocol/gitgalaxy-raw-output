...
| Avg Path Length | 2.4033 | Hops between files. Lower = Tighter coupling. |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 56.8 | 77.5 | 100.0 |
...
- `resolve_redirects` (@ `requests-2.33.1/src/requests/sessions.py`) -> Impact: **59.2** | LOC: 122
- `build_digest_header` (@ `requests-2.33.1/src/requests/auth.py`) -> Impact: **57.5** | LOC: 109
  * *Intent:* """ :rtype: str """
- `_encode_files` (@ `requests-2.33.1/src/requests/models.py`) -> Impact: **48.4** | LOC: 67
...
- `send` (@ `requests-2.33.1/src/requests/adapters.py`) -> Impact: **47.8** | LOC: 107
- `prepare_body` (@ `requests-2.33.1/src/requests/models.py`) -> Impact: **46.3** | LOC: 77
  * *Intent:* """Prepares the given HTTP body data."""
- `cert_verify` (@ `requests-2.33.1/src/requests/adapters.py`) -> Impact: **44.4** | LOC: 55
...
- `__init__` (@ `requests-2.33.1/src/requests/models.py`) -> Impact: **43.2** | LOC: 33
- `prepare_url` (@ `requests-2.33.1/src/requests/models.py`) -> Impact: **37.6** | LOC: 73
  * *Intent:* """Prepares the given HTTP URL."""
- `should_bypass_proxies` (@ `requests-2.33.1/src/requests/utils.py`) -> Impact: **34.1** | LOC: 59
  * *Intent:* """ Returns whether we should bypass proxies or not. :rtype: bool """
- `super_len` (@ `requests-2.33.1/src/requests/utils.py`) -> Impact: **27.5** | LOC: 69
...
### 1. `requests-2.33.1/src/requests/auth.py` (PYTHON) -> Cumulative Risk: **783.22**
...
### 2. `requests-2.33.1/src/requests/cookies.py` (PYTHON) -> Cumulative Risk: **676.01**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 423.94 | **LOC:** 562 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Concurrency (89.6973%), Safety Score (86.5476%)
- **Heaviest Functions:** `_find_no_duplicates` (Impact: 21.5), `remove_cookie_by_name` (Impact: 18.7), `_find` (Impact: 16.6)

### 3. `requests-2.33.1/src/requests/sessions.py` (PYTHON) -> Cumulative Risk: **577.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 592.26 | **LOC:** 835 | **CtrlFlow:** 21.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.6192%), Verification (80.0%)
- **Heaviest Functions:** `resolve_redirects` (Impact: 59.2), `send` (Impact: 25.8), `merge_environment_settings` (Impact: 25.3)

### 4. `requests-2.33.1/src/requests/adapters.py` (PYTHON) -> Cumulative Risk: **559.85**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 485.08 | **LOC:** 698 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.7469%), Verification (80.0%)
- **Heaviest Functions:** `send` (Impact: 47.8), `cert_verify` (Impact: 44.4), `_urllib3_request_context` (Impact: 21.9)

### 5. `requests-2.33.1/src/requests/structures.py` (PYTHON) -> Cumulative Risk: **537.51**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 58.1 | **LOC:** 100 | **CtrlFlow:** 12.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9849%), Documentation (91.6667%), Safety Score (82.6353%)
- **Heaviest Functions:** `__eq__` (Impact: 5.5), `__init__` (Impact: 4.2), `lower_items` (Impact: 3.0)

### 6. `requests-2.33.1/tests/testserver/server.py` (PYTHON) -> Cumulative Risk: **535.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 156.94 | **LOC:** 177 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9768%), Safety Score (90.7656%)
- **Heaviest Functions:** `__exit__` (Impact: 9.6), `__init__` (Impact: 8.2), `consume_socket_content` (Impact: 7.7)

### 7. `requests-2.33.1/src/requests/help.py` (PYTHON) -> Cumulative Risk: **499.08**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 89.36 | **LOC:** 132 | **CtrlFlow:** 13.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.0248%), Tech Debt (93.0993%)
- **Heaviest Functions:** `info` (Impact: 8.8), `_implementation` (Impact: 8.5), `main` (Impact: 1.1)

### 8. `requests-2.33.1/src/requests/hooks.py` (PYTHON) -> Cumulative Risk: **491.07**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 36.38 | **LOC:** 35 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9994%), Safety Score (84.2905%), Stability (50.0%)
- **Heaviest Functions:** `dispatch_hook` (Impact: 14.0), `default_hooks` (Impact: 2.1)

### 9. `requests-2.33.1/src/requests/utils.py` (PYTHON) -> Cumulative Risk: **490.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 754.46 | **LOC:** 1084 | **CtrlFlow:** 26.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.8038%), Api Exposure (67.487%)
- **Heaviest Functions:** `should_bypass_proxies` (Impact: 34.1), `super_len` (Impact: 27.5), `get_netrc_auth` (Impact: 22.9)

### 10. `requests-2.33.1/src/requests/models.py` (PYTHON) -> Cumulative Risk: **482.25**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 895.7 | **LOC:** 1042 | **CtrlFlow:** 27.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.0591%), Stability (50.0%)
- **Heaviest Functions:** `_encode_files` (Impact: 48.4), `prepare_body` (Impact: 46.3), `__init__` (Impact: 43.2)
...
- **Risk Profile:** Cognitive Load (35.552%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_https_warnings` (Impact: 13.3)
    * *Intent:* """warnings are emitted with requests.get"""
  * `test_POSTBIN_SEEKED_OBJECT_WITH_NO_ITER` (Impact: 12.4)
  * `test_custom_redirect_mixin` (Impact: 9.1)
    * *Intent:* """Tests a custom mixin to overwrite ``get_redirect_target``. Ensures a subclassed ``requests.Sessio...
  * `seek` (Impact: 8.3)
  * `get_redirect_target` (Impact: 7.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 895.7 | **LOC:** 1042 | **CtrlFlow:** 27.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (42.6186%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 754.46 | **LOC:** 1084 | **CtrlFlow:** 26.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (37.8002%), Tech Debt (20.3328%)
**Top Internal Functions/Classes:**
  * `should_bypass_proxies` (Impact: 34.1)
    * *Intent:* """ Returns whether we should bypass proxies or not. :rtype: bool """
  * `super_len` (Impact: 27.5)
  * `get_netrc_auth` (Impact: 22.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 592.26 | **LOC:** 835 | **CtrlFlow:** 21.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (36.0472%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `resolve_redirects` (Impact: 59.2)
  * `send` (Impact: 25.8)
    * *Intent:* """Send a given PreparedRequest. :rtype: requests.Response """
  * `merge_environment_settings` (Impact: 25.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001949 | `Ripple Effect (Closeness):` 0.040816
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 423.94 | **LOC:** 562 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (48.9893%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_find_no_duplicates` (Impact: 21.5)
    * *Intent:* """Both ``__get_item__`` and ``get`` call this function: it's never used elsewhere in Requests. :par...
  * `remove_cookie_by_name` (Impact: 18.7)
...
- **Risk Profile:** Cognitive Load (5.3404%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_should_bypass_proxies_win_registry` (Impact: 12.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 313.6 | **LOC:** 315 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (55.008%), Tech Debt (99.9792%)
**Top Internal Functions/Classes:**
  * `build_digest_header` (Impact: 57.5)
    * *Intent:* """ :rtype: str """
  * `_basic_auth_str` (Impact: 14.2)
    * *Intent:* """Returns a Basic Auth string."""
  * `handle_401` (Impact: 12.2)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 156.94 | **LOC:** 177 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (43.7007%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__exit__` (Impact: 9.6)
  * `__init__` (Impact: 8.2)
  * `consume_socket_content` (Impact: 7.7)
  * `__init__` (Impact: 6.3)
  * `_handle_requests` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 89.36 | **LOC:** 132 | **CtrlFlow:** 13.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (42.5443%), Tech Debt (93.0993%)
**Top Internal Functions/Classes:**
  * `info` (Impact: 8.8)
    * *Intent:* """Generate information for a bug report."""
  * `_implementation` (Impact: 8.5)
...
- **Risk Profile:** Cognitive Load (20.7419%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_multiple_requests` (Impact: 3.6)
    * *Intent:* """multiple requests can be served"""
  * `test_request_recovery` (Impact: 2.5)
    * *Intent:* """can check the requests content"""
  * `test_basic` (Impact: 2.3)
    * *Intent:* """messages are sent and received properly"""
  * `test_basic_waiting_server` (Impact: 2.1)
    * *Intent:* """the server waits for the block_server event to be set before closing"""
  * `test_request_recovery_with_bigger_timeout` (Impact: 2.1)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 58.1 | **LOC:** 100 | **CtrlFlow:** 12.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (42.5489%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__eq__` (Impact: 5.5)
  * `__init__` (Impact: 4.2)
  * `lower_items` (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  ...
  * `test_get` (Impact: 2.1)
  * `test_delitem` (Impact: 1.9)
  * `test_getitem` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (51.9989%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (22.5986%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `check_compatibility` (Impact: 15.7)
  * `_check_cryptography` (Impact: 3.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 36.38 | **LOC:** 35 | **CtrlFlow:** 42.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (40.8812%), Tech Debt (37.7541%)
**Top Internal Functions/Classes:**
  * `dispatch_hook` (Impact: 14.0)
    * *Intent:* # TODO: response is the only one """Dispatches a hook dictionary on a given piece of data."""
  * `default_hooks` (Impact: 2.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
* *State Mutation (weighted view):* 18
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (37.7516%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_resolve_char_detection` (Impact: 3.5)
...
- **Risk Profile:** Cognitive Load (20.3366%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_init` (Impact: 8.8)
  * `doc` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- `requests-2.33.1/src/requests/sessions.py` -> **Severity: 0.195** (Bridge: 0.0019 * Flux: 100.0%)
