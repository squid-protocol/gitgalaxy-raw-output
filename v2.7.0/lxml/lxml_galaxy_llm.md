...
| Avg Path Length | 2.859 | Hops between files. Lower = Tighter coupling. |
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 23.2 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 18.7 | 2.3 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 10.7 | 1.1 | 0.0 |
...
| connectivity | 3945 | 131 | 31 | `lxml-6.0.2/src/lxml/tests/test_etree.py` |
...
| dead_code | 2367 | 119 | 16 | `lxml-6.0.2/src/lxml/tests/test_etree.py` |
...
- `_annotate_element` (@ `lxml-6.0.2/src/lxml/objectify.pyx`) -> Impact: **158.6** | LOC: 120
- `ext_modules` (@ `lxml-6.0.2/setupinfo.py`) -> Impact: **136.5** | LOC: 136
- `DataElement` (@ `lxml-6.0.2/src/lxml/objectify.pyx`) -> Impact: **129.6** | LOC: 104
- `_mdiff` (@ `lxml-6.0.2/src/lxml/html/_difflib.py`) -> Impact: **111.4** | LOC: 268
- `_replaceSlice` (@ `lxml-6.0.2/src/lxml/apihelpers.pxi`) -> Impact: **110.1** | LOC: 138
- `build_libs` (@ `lxml-6.0.2/buildlibxml.py`) -> Impact: **103.8** | LOC: 116
- `index` (@ `lxml-6.0.2/src/lxml/etree.pyx`) -> Impact: **93.7** | LOC: 86
...
- `_checkNumber` (@ `lxml-6.0.2/src/lxml/objectify.pyx`) -> Impact: **88.6** | LOC: 74
- `tostring` (@ `lxml-6.0.2/src/lxml/etree.pyx`) -> Impact: **84.8** | LOC: 110
- `write` (@ `lxml-6.0.2/src/lxml/etree.pyx`) -> Impact: **81.5** | LOC: 109

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `lxml-6.0.2/src/lxml` | 47 | 21308.02 | 43.88% | 57.79% |
| `lxml-6.0.2/src/lxml/tests` | 39 | 15156.96 | 19.65% | 0.0% |
| `lxml-6.0.2/doc` | 29 | 5683.3 | 8.25% | 2.18% |
| `lxml-6.0.2/src/lxml/html` | 15 | 5426.68 | 38.69% | 34.42% |
...
- **Heaviest Functions:** `_start` (Impact: 79.3), `_writeDtdToBuffer` (Impact: 72.1), `_writeNodeToBuffer` (Impact: 69.3)
...
- **Heaviest Functions:** `_linkDtdAttribute` (Impact: 22.3), `__init__` (Impact: 21.4), `type` (Impact: 18.2)
...
- **Heaviest Functions:** `__call__` (Impact: 39.5), `_find_form` (Impact: 21.3), `_insert_error` (Impact: 20.8)
...
- **Heaviest Functions:** `bench_elementmaker` (Impact: 4.0), `bench_attributes_deep_cached` (Impact: 3.8), `bench_objectpath_deep_cached` (Impact: 3.8)
...
- **Heaviest Functions:** `__init__` (Impact: 47.8), `_unpackNodeSetEntry` (Impact: 38.5), `_unwrapXPathObject` (Impact: 27.4)
...
- **Heaviest Functions:** `bench_setget_attributes` (Impact: 5.4), `bench_tag_repeat` (Impact: 5.4), `bench_text_repeat` (Impact: 5.4)

### 7. `lxml-6.0.2/src/lxml/doctestcompare.py` (PYTHON) -> Cumulative Risk: **673.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `compare_docs` (Impact: 35.4), `collect_diff_tag` (Impact: 31.3), `collect_diff` (Impact: 31.2)

### 8. `lxml-6.0.2/src/lxml/nsclasses.pxi` (PYTHON) -> Cumulative Risk: **673.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_find_nselement_class` (Impact: 21.7), `update` (Impact: 11.2), `__setitem__` (Impact: 8.3)

### 9. `lxml-6.0.2/doc/html/apidoc/_static/searchtools.js` (JAVASCRIPT) -> Cumulative Risk: **671.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `performTermsSearch` (Impact: 46.8), `_performSearch` (Impact: 46.3), `objectSearchCallback` (Impact: 27.2)

### 10. `lxml-6.0.2/src/lxml/objectify.pyx` (PYTHON) -> Cumulative Risk: **666.42**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2241.82 | **LOC:** 2150 | **CtrlFlow:** 29.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.1442%), Tech Debt (80.1858%)
- **Heaviest Functions:** `_annotate_element` (Impact: 158.6), `DataElement` (Impact: 129.6), `_checkNumber` (Impact: 88.6)
...
**Top Internal Functions/Classes:**
  * `test_parse_error_logging` (Impact: 16.6)
  * `_test_python_error_logging` (Impact: 14.1)
    * *Intent:* """This can't really be tested as long as there isn't a way to reset the logging setup ... """
  * `test_very_large_sourceline_iterparse` (Impact: 11.8)
  * `test_attrib_order` (Impact: 11.7)
  * `test_html_prefix_nsmap` (Impact: 11.1)
...
**Top Internal Functions/Classes:**
  * `_start` (Impact: 79.3)
  * `_writeDtdToBuffer` (Impact: 72.1)
  * `_writeNodeToBuffer` (Impact: 69.3)
  * `_tostring` (Impact: 60.4)
  * `write` (Impact: 56.5)
...
**Top Internal Functions/Classes:**
  * `_annotate_element` (Impact: 158.6)
  * `DataElement` (Impact: 129.6)
  * `_checkNumber` (Impact: 88.6)
  * `__call__` (Impact: 51.4)
  * `_setSlice` (Impact: 45.5)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1827.08 | **LOC:** 1928 | **CtrlFlow:** 35.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (43.7459%), Tech Debt (96.5352%)
**Top Internal Functions/Classes:**
  * `iterlinks` (Impact: 73.7)
    * *Intent:* """ Yield (element, attribute, link, pos), where attribute may be None (indicating the link is in th...
  * `fromstring` (Impact: 63.7)
    * *Intent:* """ Parse the html, returning a single element/document. This tries to minimally parse the chunk of ...
  * `fragments_fromstring` (Impact: 33.7)
  * `rewrite_links` (Impact: 31.5)
  * `fragment_fromstring` (Impact: 29.3)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 13`, `state_mutation: 270`, `dead_code: 1`, `planned_debt: 1`, `fragile_debt: 11`, `duplicate_logic: 6`, `unreferenced_by_name: 10`
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` (Impact: 69.2)
  * `__init__` (Impact: 41.5)
  * `__init__` (Impact: 25.8)
  * `copyToBuffer` (Impact: 24.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 307 instances
...
**Top Internal Functions/Classes:**
  * `test_standard_lookup_fuzz` (Impact: 13.7)
  * `test_getslice_partial` (Impact: 10.7)
  * `test_setslice_elements` (Impact: 9.8)
  * `test_getslice_partial_neg` (Impact: 9.2)
  * `test_setslice_partial` (Impact: 8.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 47.8)
  * `_unpackNodeSetEntry` (Impact: 38.5)
  * `_unwrapXPathObject` (Impact: 27.4)
  * `match` (Impact: 23.2)
  * `_buildElementStringResult` (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
* *Amplified Sql Injection:* 37 instances
...
**Top Internal Functions/Classes:**
  * `xmlSetGenericErrorFunc` (Impact: 1.8)
  * `xmlSetStructuredErrorFunc` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `build_libs` (Impact: 103.8)
  * `download_library` (Impact: 42.0)
  * `unpack_tarball` (Impact: 32.0)
  * `download_and_extract_windows_binaries` (Impact: 28.7)
  * `find_max_version` (Impact: 16.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ext_modules` (Impact: 136.5)
  * `find_dependencies` (Impact: 19.8)
  * `option_value` (Impact: 18.4)
  * `get_library_versions` (Impact: 17.1)
  * `cflags` (Impact: 12.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `runBench` (Impact: 51.0)
  * `benchmarks` (Impact: 26.9)
...
**Top Internal Functions/Classes:**
  * `_receiveGenericError` (Impact: 64.7)
  * `_setError` (Impact: 22.3)
  * `_receiveGeneric` (Impact: 15.0)
  * `_buildParseException` (Impact: 14.9)
  * `_buildExceptionMessage` (Impact: 14.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `collect_diff_tag` (Impact: 31.3)
  * `collect_diff` (Impact: 31.2)
  * `format_doc` (Impact: 23.7)
