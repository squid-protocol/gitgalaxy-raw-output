...
- `distinct_permutations` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **57.6** | LOC: 148
...
- `set_partitions` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **53.1** | LOC: 79
...
- `minmax` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **35.1** | LOC: 75
...
- `replace` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **27.8** | LOC: 66
...
- `sample` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **26.1** | LOC: 81
...
- `zip_broadcast` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **24.6** | LOC: 53
...
- `constrained_batches` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **24.4** | LOC: 48
- `nth_combination_with_replacement` (@ `more_itertools-11.0.1/more_itertools/more.py`) -> Impact: **24.1** | LOC: 41
...
- **Heaviest Functions:** `_islice_helper` (Impact: 72.8), `distinct_permutations` (Impact: 57.6), `set_partitions` (Impact: 53.1)
...
- **Heaviest Functions:** `zip_broadcast` (Impact: 3.7), `zip_offset` (Impact: 3.3), `zip_offset` (Impact: 3.3)
...
- **Heaviest Functions:** `iter_index` (Impact: 22.1), `is_prime` (Impact: 20.7), `grouper` (Impact: 17.6)
...
- **Heaviest Functions:** `grouper` (Impact: 2.5), `iter_index` (Impact: 2.5), `unique` (Impact: 2.2)
...
- **Heaviest Functions:** `test_elements_lifecycle` (Impact: 14.0), `test_concurrent_consumers` (Impact: 13.5), `test_concurrent_calls` (Impact: 13.0)
...
- **Heaviest Functions:** `test_vs_statistics_median_windowed` (Impact: 9.0), `test_vs_statistics_median` (Impact: 8.0), `test_multiple` (Impact: 6.8)
...
- **Heaviest Functions:** `check` (Impact: 1.3), `coverage` (Impact: 1.3), `requirements` (Impact: 1.2)
...
**Top Internal Functions/Classes:**
  * `test_elements_lifecycle` (Impact: 14.0)
    * *Intent:* # CPython does reference counting. # GC is not required when ref counting is supported. refCountSupp...
  * `test_concurrent_consumers` (Impact: 13.5)
  * `test_concurrent_calls` (Impact: 13.0)
  * `_target` (Impact: 11.8)
  * `test_concurrent_calls` (Impact: 9.8)
...
**Top Internal Functions/Classes:**
  * `test_vs_statistics_median_windowed` (Impact: 9.0)
  * `test_vs_statistics_median` (Impact: 8.0)
  * `test_multiple` (Impact: 6.8)
    * *Intent:* """ensure can catch multiple exceptions"""
  * `test_basics` (Impact: 6.8)
  * `test_multidimensional` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `grouper` (Impact: 2.5)
  * `iter_index` (Impact: 2.5)
  * `unique` (Impact: 2.2)
  * `iter_except` (Impact: 2.2)
  * `iter_except` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
