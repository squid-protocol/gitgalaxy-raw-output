...
| Avg Path Length | 1.8929 | Hops between files. Lower = Tighter coupling. |
...
- `parse_example_parts` (@ `irrelevant/notebook_generator.py`) -> Impact: **57.1** | LOC: 103
...
- `convert_to_cells` (@ `irrelevant/notebook_generator.py`) -> Impact: **16.2** | LOC: 81
...
- `convert_to_notebook` (@ `irrelevant/notebook_generator.py`) -> Impact: **9.6** | LOC: 32
  * *Intent:* """ Convert a JSON file containing the examples to a Jupyter Notebook. """
- `inspect_and_sanitize_code_lines` (@ `irrelevant/notebook_generator.py`) -> Impact: **6.6** | LOC: 18
...
- `is_interactive_statement` (@ `irrelevant/notebook_generator.py`) -> Impact: **4.5** | LOC: 5
- `square` (@ `mixed_tabs_and_spaces.py`) -> Impact: **3.1** | LOC: 5
- `generate_code_block` (@ `irrelevant/notebook_generator.py`) -> Impact: **2.5** | LOC: 16
...
- `generate_markdown_block` (@ `irrelevant/notebook_generator.py`) -> Impact: **2.0** | LOC: 12
  * *Intent:* """ Generates a markdown block from a list of lines. """
- `tests` (@ `noxfile.py`) -> Impact: **1.5** | LOC: 2
...
- **Heaviest Functions:** `parse_example_parts` (Impact: 57.1), `convert_to_cells` (Impact: 16.2), `convert_to_notebook` (Impact: 9.6)
...
- **Heaviest Functions:** `generate_random_id_comment` (Impact: 1.1)
...
- **Heaviest Functions:** `tests` (Impact: 1.5)
...
- **Heaviest Functions:** `square` (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  * `generate_random_id_comment` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
