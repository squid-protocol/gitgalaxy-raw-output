...
- `getErrorResponseBody` (@ `package/core/fetcher/getErrorResponseBody.js`) -> Impact: **32.7** | LOC: 31
- `chooseStreamWrapper` (@ `package/core/fetcher/stream-wrappers/chooseStreamWrapper.js`) -> Impact: **12.0** | LOC: 13
- `getFetchFn` (@ `package/core/fetcher/getFetchFn.js`) -> Impact: **8.9** | LOC: 19
  * *Intent:* /** * Returns a fetch function based on the runtime */
- `customObjectClassesCustomObjectsAssociationsUpdate` (@ `package/api/resources/crm/resources/associations/client/Client.d.ts`) -> Impact: **8.5** | LOC: 1
...
- `constructor` (@ `package/errors/MergeError.d.ts`) -> Impact: **7.4** | LOC: 6
- `verb` (@ `package/core/pagination/Page.js`) -> Impact: **7.0** | LOC: 1
- `_a` (@ `package/core/pagination/Page.js`) -> Impact: **6.9** | LOC: 18
- `customObjectClassesAssociationTypesRetrieve` (@ `package/api/resources/crm/resources/associationTypes/client/Client.d.ts`) -> Impact: **6.8** | LOC: 1
...
- `customObjectClassesCustomObjectsAssociationsList` (@ `package/api/resources/crm/resources/associations/client/Client.d.ts`) -> Impact: **6.8** | LOC: 1
...
- `customObjectClassesCustomObjectsRetrieve` (@ `package/api/resources/crm/resources/customObjects/client/Client.d.ts`) -> Impact: **6.8** | LOC: 1
...
- **Heaviest Functions:** `chooseStreamWrapper` (Impact: 12.0), `ownKeys` (Impact: 6.1), `adopt` (Impact: 2.9)
...
- **Heaviest Functions:** `ownKeys` (Impact: 6.1)
...
**Top Internal Functions/Classes:**
  * `verb` (Impact: 7.0)
  * `_a` (Impact: 6.9)
  * `iterMessages` (Impact: 4.7)
  * `iterMessages_1` (Impact: 4.5)
  * `settle` (Impact: 3.5)
...
**Top Internal Functions/Classes:**
  * `chooseStreamWrapper` (Impact: 12.0)
  * `ownKeys` (Impact: 6.1)
  * `adopt` (Impact: 2.9)
  * `step` (Impact: 2.9)
  * `fulfilled` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `getErrorResponseBody` (Impact: 32.7)
  * `adopt` (Impact: 2.9)
  * `step` (Impact: 2.9)
  * `fulfilled` (Impact: 1.5)
  * `rejected` (Impact: 1.5)
