...
- `__call__` (@ `deprecated-1.3.1/deprecated/sphinx.py`) -> Impact: **30.0** | LOC: 46
...
- `get_deprecated_msg` (@ `deprecated-1.3.1/deprecated/classic.py`) -> Impact: **25.2** | LOC: 25
...
- `__call__` (@ `deprecated-1.3.1/deprecated/classic.py`) -> Impact: **18.2** | LOC: 52
...
- `deprecated` (@ `deprecated-1.3.1/deprecated/classic.py`) -> Impact: **15.0** | LOC: 93
...
- `test_has_sphinx_docstring` (@ `deprecated-1.3.1/tests/test_sphinx.py`) -> Impact: **14.0** | LOC: 36
...
- `test_cls_has_sphinx_docstring` (@ `deprecated-1.3.1/tests/test_sphinx.py`) -> Impact: **14.0** | LOC: 36
...
- `__init__` (@ `deprecated-1.3.1/deprecated/classic.py`) -> Impact: **10.0** | LOC: 42
...
- `area` (@ `deprecated-1.3.1/tests/deprecated_params/test_demo_area.py`) -> Impact: **9.4** | LOC: 15
...
- **Heaviest Functions:** `get_deprecated_msg` (Impact: 25.2), `__call__` (Impact: 18.2), `deprecated` (Impact: 15.0)
...
- **Heaviest Functions:** `__call__` (Impact: 30.0), `__init__` (Impact: 9.1), `deprecated` (Impact: 4.7)
...
- **Heaviest Functions:** `__call__` (Impact: 4.2), `test_with_singleton_metaclass` (Impact: 3.4), `with_metaclass` (Impact: 2.5)
...
- **Heaviest Functions:** `test_pow2` (Impact: 4.3), `pow2` (Impact: 2.1)
...
- **Heaviest Functions:** `test_has_sphinx_docstring` (Impact: 14.0), `test_cls_has_sphinx_docstring` (Impact: 14.0), `test_sphinx_deprecated_class_method__warns` (Impact: 6.3)
...
- **Heaviest Functions:** `test_sphinx_adapter` (Impact: 3.0), `test_sphinx_adapter__empty_docstring` (Impact: 2.7), `test_decorator_accept_line_length` (Impact: 2.7)
...
- **Heaviest Functions:** `test_classic_deprecated_class_method__warns` (Impact: 7.7), `classic_deprecated_static_method` (Impact: 5.2), `classic_deprecated_class_method` (Impact: 5.2)
...
- **Heaviest Functions:** `paragraph` (Impact: 8.4), `test_paragraph` (Impact: 4.3)
...
**Top Internal Functions/Classes:**
  * `test_has_sphinx_docstring` (Impact: 14.0)
    * *Intent:* # The function: def foo(x, y): return x + y # with docstring: foo.__doc__ = docstring # is decorated...
  * `test_cls_has_sphinx_docstring` (Impact: 14.0)
    * *Intent:* # The class: class Foo(object): pass # with docstring: Foo.__doc__ = docstring # is decorated with: ...
  * `test_sphinx_deprecated_class_method__warns` (Impact: 6.3)
    * *Intent:* # noinspection PyShadowingNames
  * `test_sphinx_deprecated_function__warns` (Impact: 3.2)
    * *Intent:* # noinspection PyShadowingNames
  * `test_sphinx_deprecated_static_method__warns` (Impact: 3.2)
    * *Intent:* # noinspection PyShadowingNames
...
**Top Internal Functions/Classes:**
  * `get_deprecated_msg` (Impact: 25.2)
...
**Top Internal Functions/Classes:**
  * `test_classic_deprecated_class_method__warns` (Impact: 7.7)
    * *Intent:* # noinspection PyShadowingNames
  * `classic_deprecated_static_method` (Impact: 5.2)
  * `classic_deprecated_class_method` (Impact: 5.2)
  * `classic_deprecated_method` (Impact: 5.1)
  * `classic_deprecated_function` (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 4.2)
  * `test_with_singleton_metaclass` (Impact: 3.4)
  * `with_metaclass` (Impact: 2.5)
...
**Top Internal Functions/Classes:**
  * `test_class_deprecation_using_a_simple_decorator` (Impact: 2.4)
    * *Intent:* # stream is used to store the deprecation message for testing stream = io.StringIO() # To deprecated...
  * `wrapped_new` (Impact: 2.1)
  * `simple_decorator` (Impact: 1.9)
    * *Intent:* # To deprecated the class, we use a simple decorator # which patches the original ``__new__`` method...
  * `test_subclass_deprecation_using_deprecated_decorator` (Impact: 1.9)
  * `test_class_deprecation_using_deprecated_decorator` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `paragraph` (Impact: 8.4)
    * *Intent:* """Create a styled HTML paragraphe."""
  * `test_paragraph` (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_sphinx_adapter` (Impact: 3.0)
  * `test_sphinx_adapter__empty_docstring` (Impact: 2.7)
  * `test_decorator_accept_line_length` (Impact: 2.7)
  * `foo` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  ...
  * `test_only_one_warning_for_each_parameter` (Impact: 2.8)
