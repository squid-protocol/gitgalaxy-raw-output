...
- `__init__` (@ `tenacity-9.1.4/tenacity/retry.py`) -> Impact: **31.5** | LOC: 30
- `retry` (@ `tenacity-9.1.4/tenacity/__init__.py`) -> Impact: **22.5** | LOC: 35
...
- `before_sleep_log` (@ `tenacity-9.1.4/tenacity/before_sleep.py`) -> Impact: **22.3** | LOC: 43
- `__call__` (@ `tenacity-9.1.4/tenacity/asyncio/__init__.py`) -> Impact: **19.1** | LOC: 24
- `__call__` (@ `tenacity-9.1.4/tenacity/__init__.py`) -> Impact: **14.6** | LOC: 23
- `__call__` (@ `tenacity-9.1.4/tenacity/tornadoweb.py`) -> Impact: **14.6** | LOC: 23
- `log_it` (@ `tenacity-9.1.4/tenacity/before_sleep.py`) -> Impact: **14.4** | LOC: 33
- `wrap` (@ `tenacity-9.1.4/tenacity/__init__.py`) -> Impact: **13.8** | LOC: 22
- `make_retry_state` (@ `tenacity-9.1.4/tests/test_tenacity.py`) -> Impact: **12.7** | LOC: 31
- `test_wait_chain` (@ `tenacity-9.1.4/tests/test_tenacity.py`) -> Impact: **12.2** | LOC: 17
...
- **Heaviest Functions:** `__call__` (Impact: 19.1), `__anext__` (Impact: 9.1), `_run_wait` (Impact: 5.5)
...
- **Heaviest Functions:** `__init__` (Impact: 31.5), `__call__` (Impact: 9.3), `__call__` (Impact: 9.2)
...
- **Heaviest Functions:** `retry` (Impact: 22.5), `__call__` (Impact: 14.6), `wrap` (Impact: 13.8)
...
- **Heaviest Functions:** `find_ordinal` (Impact: 10.6), `is_coroutine_callable` (Impact: 7.5), `get_callback_name` (Impact: 6.8)
...
- **Heaviest Functions:** `__call__` (Impact: 5.6), `__radd__` (Impact: 3.7), `__call__` (Impact: 3.6)
...
- **Heaviest Functions:** `__call__` (Impact: 14.6), `__init__` (Impact: 2.4)
...
- **Heaviest Functions:** `test_issue` (Impact: 10.8), `test_async` (Impact: 10.8), `do_retry` (Impact: 6.5)
...
- **Heaviest Functions:** `before_sleep_log` (Impact: 22.3), `log_it` (Impact: 14.4), `before_sleep_nothing` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  * `make_retry_state` (Impact: 12.7)
  * `test_wait_chain` (Impact: 12.2)
  * `_make_unset_exception` (Impact: 7.3)
  * `test_wait_random_exponential` (Impact: 7.1)
  * `test_random_sleep` (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `test_retry_with_async_result_or` (Impact: 7.1)
  * `test_retry_with_async_result_ror` (Impact: 7.1)
  * `test_retry_with_async_exc` (Impact: 7.0)
  * `test_retry_function_attributes` (Impact: 5.5)
    * *Intent:* """Test that the wrapped function attributes are exposed as intended. - statistics contains the valu...
  * `test_retry_with_async_result` (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `__anext__` (Impact: 9.1)
  * `_run_wait` (Impact: 5.5)
  * `__init__` (Impact: 5.2)
  * `_portable_async_sleep` (Impact: 5.0)
...
**Top Internal Functions/Classes:**
  * `test_issue` (Impact: 10.8)
  * `test_async` (Impact: 10.8)
  * `do_retry` (Impact: 6.5)
  * `do_retry` (Impact: 6.5)
  * `_do_work` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `log_it` (Impact: 14.4)
  * `before_sleep_nothing` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  * `test_01_default` (Impact: 5.5)
    * *Intent:* """Test log formatting."""
  * `test_02_custom_sec_format` (Impact: 5.4)
...
**Top Internal Functions/Classes:**
  * `test_old_tornado` (Impact: 2.1)
  * `test_stop_after_attempt` (Impact: 1.8)
  * `test_retry` (Impact: 1.7)
  * `_retryable_coroutine` (Impact: 1.6)
  * `_retryable_coroutine_with_2_attempts` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  * `after_log` (Impact: 7.0)
  * `log_it` (Impact: 4.8)
  * `after_nothing` (Impact: 1.5)
...
- **Risk Profile:** Cognitive Load (8.5111%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `before_log` (Impact: 6.1)
  * `log_it` (Impact: 4.8)
  * `before_nothing` (Impact: 1.5)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_is_coroutine_callable` (Impact: 2.8)
  * `__call__` (Impact: 1.5)
  * `__call__` (Impact: 1.5)
  * `async_func` (Impact: 1.1)
  * `sync_func` (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
