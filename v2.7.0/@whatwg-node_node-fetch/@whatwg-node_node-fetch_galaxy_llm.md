...
- `fetchNodeHttp` (@ `package/cjs/fetchNodeHttp.js`) -> Impact: **74.5** | LOC: 133
- `fetchNodeHttp` (@ `package/esm/fetchNodeHttp.js`) -> Impact: **66.0** | LOC: 133
- `fetchCurl` (@ `package/cjs/fetchCurl.js`) -> Impact: **56.2** | LOC: 134
- `fetchCurl` (@ `package/esm/fetchCurl.js`) -> Impact: **56.2** | LOC: 134
- `json` (@ `package/cjs/Response.js`) -> Impact: **47.8** | LOC: 55
- `json` (@ `package/esm/Response.js`) -> Impact: **47.8** | LOC: 55
- `formData` (@ `package/cjs/Body.js`) -> Impact: **40.6** | LOC: 105
- `formData` (@ `package/esm/Body.js`) -> Impact: **40.6** | LOC: 105
...
- **Heaviest Functions:** `constructor` (Impact: 31.7), `createController` (Impact: 15.9), `destroy` (Impact: 9.6)
...
- **Heaviest Functions:** `getStreamFromFormData` (Impact: 32.6), `handleNextEntry` (Impact: 12.8), `pull` (Impact: 9.5)
...
- **Heaviest Functions:** `formData` (Impact: 40.6), `processBodyInit` (Impact: 28.2), `complete` (Impact: 24.5)
...
- **Heaviest Functions:** `buffer` (Impact: 17.8), `constructor` (Impact: 16.0), `stream` (Impact: 13.1)
...
- **Heaviest Functions:** `fetchNodeHttp` (Impact: 74.5), `onError` (Impact: 23.7), `getRequestFnForProtocol` (Impact: 7.5)
...
- **Heaviest Functions:** `fetchNodeHttp` (Impact: 66.0), `onError` (Impact: 23.7), `getRequestFnForProtocol` (Impact: 7.5)
...
**Top Internal Functions/Classes:**
  * `formData` (Impact: 40.6)
  * `processBodyInit` (Impact: 28.2)
  * `complete` (Impact: 24.5)
  * `handleContentLengthHeader` (Impact: 15.3)
  * `buffer` (Impact: 11.2)
...
**Top Internal Functions/Classes:**
  * `buffer` (Impact: 17.8)
  * `constructor` (Impact: 16.0)
  * `stream` (Impact: 13.1)
  * `getBlobPartAsBuffer` (Impact: 10.6)
  * `pull` (Impact: 10.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `fetchNodeHttp` (Impact: 74.5)
  * `onError` (Impact: 23.7)
  * `getRequestFnForProtocol` (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
* *Amplified Cascading Flux:* 13 instances
...
**Top Internal Functions/Classes:**
  * `fetchCurl` (Impact: 56.2)
  * `streamListener` (Impact: 21.6)
  * `errorListener` (Impact: 9.3)
  * `onAbort` (Impact: 2.5)
  * `endListener` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
**Top Internal Functions/Classes:**
  * `pipeThrough` (Impact: 14.9)
  * `getHeadersObj` (Impact: 9.0)
  * `getSupportedFormats` (Impact: 7.5)
  * `shouldRedirect` (Impact: 7.2)
  * `isArrayBufferView` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `getHeadersObj` (Impact: 9.0)
  * `shouldRedirect` (Impact: 7.2)
  * `getSupportedFormats` (Impact: 6.5)
  * `isArrayBufferView` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
