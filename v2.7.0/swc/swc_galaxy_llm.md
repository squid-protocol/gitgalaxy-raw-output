...
| Analyzed Artifacts (Scanned) | 57784 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 24802 |
| Total LOC | 3510495 |
...
| Assortativity | -0.2958 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
...
*Total Excluded Artifacts: 24802*
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 4.0 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 14945 | 1718 | 0 | `crates/swc_ecma_parser/src/parser/typescript.rs` |
| cleanup | 755 | 157 | 0 | `crates/swc_ecma_minifier/tests/benches-full/three.js` |
| guards | 70592 | 6367 | 1 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
| danger | 39582 | 5617 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
| concurrency | 15399 | 2453 | 0 | `crates/swc_ecma_transforms_compat/tests/es2017_async_to_generator.rs` |
| connectivity | 40444 | 10321 | 1 | `crates/swc_ecma_minifier/benches/full/d3.js` |
| io | 3340 | 558 | 0 | `crates/swc_bundler/tests/fixture/deno-9591/output/entry.inlined.ts` |
| crypto | 2 | 2 | 0 | `crates/swc/tests/fixture/issues-1xxx/1545/case1/input/index.js` |
| ipc | 132 | 41 | 0 | `crates/swc_ecma_minifier/tests/fixture/issues/quagga2/1.4.2/1/input.js` |
| time | 1637 | 343 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| serialization | 616 | 261 | 0 | `crates/hstr/src/wtf8_atom.rs` |
| regex | 2921 | 310 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| events | 4706 | 410 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| tests | 12032 | 1718 | 0 | `crates/swc_ecma_minifier/tests/exec.rs` |
| docs | 25187 | 2092 | 0 | `crates/swc_ecma_minifier/tests/fixture/issues/quagga2/1.4.2/1/input.js` |
| debt | 21653 | 8996 | 1 | `crates/swc_ecma_minifier/tests/benches-full/three.js` |
| mutation | 339480 | 21641 | 5 | `crates/swc_ecma_minifier/tests/fixture/next/asmjs/1/input.js` |
| dead_code | 20257 | 7332 | 1 | `crates/swc_ecma_minifier/tests/benches-full/d3.js` |
| credential | 31 | 18 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-ace/chunks/8a28b14e.d8fbda268ed281a1/input.js` |
| threat | 20176 | 3625 | 0 | `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js` |
| ml_ai | 887 | 181 | 0 | `crates/swc_ecma_minifier/tests/benches-full/three.js` |
| ui | 7822 | 793 | 0 | `crates/swc_ecma_minifier/tests/benches-full/terser.js` |
...
- `r1` (@ `crates/swc_ecma_minifier/tests/fixture/next/react-pdf-renderer/output.js`) -> Impact: **1400.7** | LOC: 873
- `Yd` (@ `crates/swc_ecma_minifier/tests/fixture/next/asmjs/1/output.js`) -> Impact: **1027.5** | LOC: 850
- `patchOuterDeco` (@ `crates/swc_ecma_minifier/tests/fixture/next/31077/static/chunks/1606726a.10299989c08cb523/output.js`) -> Impact: **1025.2** | LOC: 692
- `dispatchKey` (@ `crates/swc_ecma_minifier/tests/fixture/next/feedback-2/codemirror/input.js`) -> Impact: **885.3** | LOC: 1651
- `t` (@ `crates/swc_ecma_minifier/tests/fixture/next/feedback-3/579-dcac359116b2707c/output.js`) -> Impact: **875.1** | LOC: 806
- `Yd` (@ `crates/swc_ecma_minifier/tests/fixture/next/asmjs/1/input.js`) -> Impact: **857.8** | LOC: 1038
- `baseCreateRenderer` (@ `crates/swc/benches/assets/renderer.ts`) -> Impact: **841.1** | LOC: 2065
  * *Intent:* // implementation
- `parse` (@ `crates/swc_ecma_minifier/tests/benches-full/terser.js`) -> Impact: **806.7** | LOC: 823
- `OutputStream` (@ `crates/swc_ecma_minifier/tests/benches-full/terser.js`) -> Impact: **802.3** | LOC: 772
- `loadChunk` (@ `crates/swc_ecma_minifier/tests/terser/compress/if_return/issue_11736/input.js`) -> Impact: **764.4** | LOC: 524
...
- `crates/swc_ecma_minifier/benches/full/d3.js` -> **50** Orphaned Functions | **113** Duplicates
- `crates/swc_ecma_lexer/src/common/lexer/token.rs` -> **139** Orphaned Functions | **0** Duplicates
...
- **Unknown Dependencies:** `24930` packages imported that bypass the Zero-Trust whitelist.
...
- **Heaviest Functions:** `eq` (Impact: 96.1), `template` (Impact: 30.8), `foldr` (Impact: 25.8)
...
- **Heaviest Functions:** `set` (Impact: 87.6), `sync` (Impact: 47.0), `save` (Impact: 46.7)
...
- **Heaviest Functions:** `merge` (Impact: 63.4), `report_assign` (Impact: 42.1), `declare_decl` (Impact: 40.3)
...
- **Heaviest Functions:** `_async_generator_delegate` (Impact: 13.3), `next` (Impact: 3.2), `throw` (Impact: 3.2)
...
- **Heaviest Functions:** `_async_generator_delegate` (Impact: 13.7), `next` (Impact: 3.3), `throw` (Impact: 3.2)
...
- **Heaviest Functions:** `brush$1` (Impact: 235.6), `started` (Impact: 176.3), `clipRectangle` (Impact: 133.1)
...
- **Heaviest Functions:** `matchNode` (Impact: 498.1), `search` (Impact: 278.7), `parser` (Impact: 174.6)
...
**Top Internal Functions/Classes:**
  * `brush$1` (Impact: 235.6)
  * `started` (Impact: 176.3)
...
**Top Internal Functions/Classes:**
  * `WebGLTextures` (Impact: 657.8)
  * `WebGLRenderer` (Impact: 407.2)
  * `WebGLProgram` (Impact: 398.2)
  * `earcutLinked` (Impact: 290.7)
  * `ObjectLoader` (Impact: 230.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `clipRectangle` (Impact: 208.9)
    * *Intent:* // TODO Use d3-polygon’s polygonContains here for the ring check? // TODO Eliminate duplicate buffer...
  * `brush$1` (Impact: 204.7)
  * `started` (Impact: 155.6)
  * `zoom` (Impact: 104.8)
  * `formatLocale` (Impact: 101.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `getterFn` (Impact: 628.3)
  * `$CompileProvider` (Impact: 539.6)
  * `applyDirectivesToNode` (Impact: 352.5)
...
**Top Internal Functions/Classes:**
  * `getterFn` (Impact: 619.6)
  * `$CompileProvider` (Impact: 548.6)
  * `applyDirectivesToNode` (Impact: 343.8)
    * *Intent:* * @param {function(angular.Scope[, cloneAttachFn]} transcludeFn A linking function, where the * scop...
  * `link` (Impact: 238.3)
  * `minErr` (Impact: 180.1)
    * *Intent:* * * If fewer arguments are specified than necessary for interpolation, the extra * interpolation mar...
...
**Top Internal Functions/Classes:**
  * `createPatchFunction` (Impact: 351.2)
  * `parseHTML` (Impact: 149.4)
  * `patchVnode` (Impact: 98.9)
  * `enter` (Impact: 97.6)
    * *Intent:* /* */
  * `addHandler` (Impact: 97.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `parse` (Impact: 806.7)
  * `OutputStream` (Impact: 802.3)
  * `statement1` (Impact: 282.5)
  * `run_cli` (Impact: 187.0)
  * `helpInformation` (Impact: 121.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 9 instances
...
**Top Internal Functions/Classes:**
  ...
  * `patch` (Impact: 296.5)
  * `createComponent` (Impact: 199.1)
  * `patchVnode` (Impact: 144.8)
  * `genData$2` (Impact: 133.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `q` (Impact: 384.1)
  * `formatAttributes` (Impact: 195.3)
  * `parse` (Impact: 142.1)
  * `h` (Impact: 106.7)
  * `transform` (Impact: 55.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `addModule` (Impact: 159.5)
    * *Intent:* * @param {Array} [config.lang] Array of BCP 47 language tags of languages for which this module has ...
  * `parseUA` (Impact: 130.6)
    * *Intent:* * these fields can have. * @class UA * @static */ /** * Static method on `YUI.Env` for parsing a UA ...
  * `getRequires` (Impact: 116.9)
    * *Intent:* /** * Returns an object containing properties for all modules required * in order to load the reques...
  * `_use` (Impact: 113.2)
    * *Intent:* **/
  * `resolve` (Impact: 112.8)
    * *Intent:* * @return {Object} Object hash (js and css) of two arrays of file lists * @example This method can b...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `matchNode` (Impact: 506.4)
  * `search` (Impact: 281.4)
  * `parser` (Impact: 175.6)
  * `setDocument` (Impact: 98.5)
  * `send` (Impact: 54.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `matchNode` (Impact: 498.1)
  * `search` (Impact: 278.7)
  * `parser` (Impact: 174.6)
  * `setDocument` (Impact: 96.0)
  * `send` (Impact: 53.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 11 instances
* *Amplified Race Conditions:* 3 instances
...
**Top Internal Functions/Classes:**
  ...
  * `parse_jsx_element_expr` (Impact: 112.4)
  * `parse_class_expr` (Impact: 109.2)
  * `parse_postfix_expr` (Impact: 94.9)
  * `parse_ts_primary_type` (Impact: 92.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 6 instances
...
- **Risk Profile:** Cognitive Load (62.7494%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `process_token` (Impact: 396.6)
  * `process_token_in_foreign_content` (Impact: 89.6)
  * `run_the_adoption_agency_algorithm` (Impact: 85.6)
    * *Intent:* // // 17. Append that new element to furthest block. // // 18. Remove formatting element from the li...
  * `get_appropriate_place_for_inserting_node` (Impact: 75.5)
    * *Intent:* // These steps are involved in part because it's possible for elements, the // table element in this...
  * `reset_insertion_mode` (Impact: 68.2)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 23`, `high_risk_execution: 36`, `state_mutation: 483`, `dead_code: 11`
