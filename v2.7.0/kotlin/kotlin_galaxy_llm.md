...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 33.8 | 44.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 3.6 | 2.3 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 3.4 | 0.0 | 0.0 |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 92.7 | 100.0 | 100.0 |
...
| connectivity | 91890 | 18509 | 2 | `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java` |
...
| dead_code | 99264 | 46484 | 2 | `kotlin-native/performance/ring/src/commonMain/kotlin/org/jetbrains/ring/InheritanceBenchmark.kt` |
| credential | 159 | 91 | 0 | `generators/tests/org/jetbrains/kotlin/generators/arguments/GenerateGradleOptions.kt` |
| threat | 67697 | 16344 | 1 | `libraries/tools/kotlin-gradle-plugin-integration-tests/src/test/resources/testProject/commonizeSQLiteAndCurlInterop/libs/sqlite3.h` |
...
- `elf_add` (@ `kotlin-native/runtime/src/libbacktrace/c/elf.c`) -> Impact: **724.7** | LOC: 806
  * *Intent:* base_address is determined. */
- `PrintStack` (@ `kotlin-native/tools/minidump-analyzer/src/main/cpp/main.cc`) -> Impact: **543.8** | LOC: 638
...
- `createModuleArtifact` (@ `compiler/ir/backend.js/src/org/jetbrains/kotlin/ir/backend/js/ic/CacheUpdater.kt`) -> Impact: **321.6** | LOC: 750
- `irSetSlotUncertain` (@ `plugins/compose/compiler-hosted/src/main/java/androidx/compose/compiler/plugins/kotlin/lower/ComposableFunctionBodyTransformer.kt`) -> Impact: **320.9** | LOC: 1610
- `lower` (@ `kotlin-native/backend.native/compiler/ir/backend.native/src/org/jetbrains/kotlin/backend/konan/optimizations/CastsOptimization.kt`) -> Impact: **311.0** | LOC: 885
- `elf_uncompress_lzma_block` (@ `kotlin-native/runtime/src/libbacktrace/c/elf.c`) -> Impact: **308.6** | LOC: 685
  * *Intent:* decompression. */
- `elf_zlib_inflate` (@ `kotlin-native/runtime/src/libbacktrace/c/elf.c`) -> Impact: **296.7** | LOC: 693
  * *Intent:* /* Inflate a zlib stream from PIN/SIN to POUT/SOUT. Return 1 on success, 0 on some error parsing the stream. */
- `translateExtensions` (@ `native/objcexport-header-generator/impl/k1/src/org/jetbrains/kotlin/backend/konan/objcexport/ObjCExportTranslator.kt`) -> Impact: **276.8** | LOC: 1067
- `singleExpressionImpl` (@ `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java`) -> Impact: **259.6** | LOC: 724
- `importFromBlock` (@ `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java`) -> Impact: **244.8** | LOC: 176

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `compiler/ir/serialization.common/src/org/jetbrains/kotlin/backend/common/serialization/proto` | 171 | 28728.9 | 17.28% | 88.67% |
| `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated` | 6 | 11224.84 | 8.49% | 66.66% |
| `kotlin-native/runtime/src/libbacktrace/c` | 13 | 10413.78 | 65.31% | 25.25% |
| `kotlin-native/runtime/src/main/cpp` | 131 | 9209.2 | 21.51% | 36.33% |
| `compiler/frontend/src/org/jetbrains/kotlin/resolve` | 89 | 8708.32 | 15.35% | 28.48% |
| `compiler/ir/backend.jvm/lower/src/org/jetbrains/kotlin/backend/jvm/lower` | 90 | 7777.7 | 48.33% | 51.71% |
| `compiler/psi/psi-api/src/org/jetbrains/kotlin/psi` | 195 | 7257.2 | 7.07% | 45.16% |
...
- `js/js.parser/src/org/jetbrains/kotlin/js/parser/antlr/generated/JavaScriptParser.java` -> **0** Orphaned Functions | **483** Duplicates
...
- **Unknown Dependencies:** `148611` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `compiler/testData/codegen/box/inlineClasses/jvmInline.kt` (KOTLIN) -> Cumulative Risk: **774.34**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.96 | **LOC:** 1013 | **CtrlFlow:** 27.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Tech Debt (100.0%), Concurrency (100.0%), Spec Match (100.0%)
- **Heaviest Functions:** `test` (Impact: 217.1), `ordinaryNoninlineAcceptsVCString` (Impact: 1.9), `ordinaryNoninlineAcceptsVCStringNullable` (Impact: 1.9)

### 2. `compiler/testData/codegen/box/coroutines/suspendFunctionAsCoroutine/operators.kt` (KOTLIN) -> Cumulative Risk: **765.99**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.09 | **LOC:** 141 | **CtrlFlow:** 12.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `foo9` (Impact: 4.2), `minusAssign` (Impact: 3.1), `foo2` (Impact: 2.2)

### 3. `js/js.translator/testData/typescript-export/js/implementable-interfaces/implementable-interfaces__main.ts` (TYPESCRIPT) -> Cumulative Risk: **735.42**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.37 | **LOC:** 325 | **CtrlFlow:** 24.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%)
- **Heaviest Functions:** `testFoo` (Impact: 81.2), `box` (Impact: 12.7), `testFunInterface` (Impact: 5.7)

### 4. `compiler/frontend/src/org/jetbrains/kotlin/util/slicedMap/TrackingSlicedMap.java` (JAVA) -> Cumulative Risk: **734.34**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 97.76 | **LOC:** 163 | **CtrlFlow:** 16.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9702%), Concurrency (99.6074%)
- **Heaviest Functions:** `equals` (Impact: 9.0), `computeValue` (Impact: 6.9), `printStackTrace` (Impact: 6.3)

### 5. `compiler/testData/codegen/boxJvm/coroutines/localFunctions/named/rec.kt` (KOTLIN) -> Cumulative Risk: **726.5**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.12 | **LOC:** 89 | **CtrlFlow:** 27.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `fooCallableReferenceIndirectRecursion` (Impact: 7.6), `foo` (Impact: 7.5), `foo2` (Impact: 7.5)

### 6. `compiler/testData/ir/irText/expressions/callableReferences/caoWithAdaptationForSuspend.kt` (KOTLIN) -> Cumulative Risk: **716.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.04 | **LOC:** 46 | **CtrlFlow:** 2.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9994%), Concurrency (99.8548%)
- **Heaviest Functions:** `test4` (Impact: 3.1), `set` (Impact: 1.8), `set` (Impact: 1.8)

### 7. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda1.kt` (KOTLIN) -> Cumulative Risk: **713.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.04 | **LOC:** 96 | **CtrlFlow:** 14.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.5128%)
- **Heaviest Functions:** `runControllers` (Impact: 12.9), `box` (Impact: 4.5), `builder` (Impact: 1.9)

### 8. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda3.kt` (KOTLIN) -> Cumulative Risk: **710.72**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.04 | **LOC:** 96 | **CtrlFlow:** 13.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.8679%), State Flux (99.368%)
- **Heaviest Functions:** `runControllers` (Impact: 12.9), `box` (Impact: 4.5), `builder` (Impact: 1.9)

### 9. `compiler/testData/codegen/box/coroutines/multipleInvokeCallsInsideInlineLambda2.kt` (KOTLIN) -> Cumulative Risk: **709.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.04 | **LOC:** 98 | **CtrlFlow:** 13.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.8679%), State Flux (99.368%)
- **Heaviest Functions:** `runControllers` (Impact: 12.9), `box` (Impact: 4.5), `builder` (Impact: 1.9)

### 10. `compiler/testData/codegen/box/contextParameters/explicitPassing.kt` (KOTLIN) -> Cumulative Risk: **703.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 0.11 | **LOC:** 142 | **CtrlFlow:** 48.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.5693%)
- **Heaviest Functions:** `box` (Impact: 53.5), `local` (Impact: 3.3), `contextAndValue2` (Impact: 1.9)
...
- **Risk Profile:** Cognitive Load (41.5293%), Tech Debt (99.9636%)
**Top Internal Functions/Classes:**
  * `singleExpressionImpl` (Impact: 259.6)
  * `importFromBlock` (Impact: 244.8)
  * `arrayElement` (Impact: 167.1)
  * `classElementName` (Impact: 132.8)
  * `propertyName` (Impact: 131.5)
...
* *Risk/State:* `safety_bypasses: 537`, `state_mutation: 335`, `duplicate_logic: 483`
...
**Top Internal Functions/Classes:**
  * `elf_add` (Impact: 724.7)
    * *Intent:* base_address is determined. */
  * `elf_uncompress_lzma_block` (Impact: 308.6)
    * *Intent:* decompression. */
  * `elf_zlib_inflate` (Impact: 296.7)
    * *Intent:* /* Inflate a zlib stream from PIN/SIN to POUT/SOUT. Return 1 on success, 0 on some error parsing the...
  * `elf_zlib_inflate_table` (Impact: 100.4)
    * *Intent:* Returns 1 on success, 0 on error. */
  * `elf_uncompress_lzma` (Impact: 76.4)
...
- **Risk Profile:** Cognitive Load (82.2885%), Tech Debt (8.5937%)
**Top Internal Functions/Classes:**
  * `visitNamedFunction` (Impact: 67.6)
  * `extractSuperTypeListEntriesTo` (Impact: 66.3)
  * `toFirProperty` (Impact: 49.1)
  * `visitWhenExpression` (Impact: 48.1)
  * `visitClassOrObject` (Impact: 46.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (60.037%), Tech Debt (8.8882%)
**Top Internal Functions/Classes:**
  * `irSetSlotUncertain` (Impact: 320.9)
  * `buildPreambleStatementsAndReturnIfSkippingPossible` (Impact: 137.5)
  * `visitNonRestartableComposableFunction` (Impact: 67.7)
    * *Intent:* // At a high level, without useNonSkippingGroupOptimization, a non-restartable composable // functio...
  * `visitWhen` (Impact: 54.7)
  * `visitComposableLambda` (Impact: 54.6)
...
- **Risk Profile:** Cognitive Load (64.7293%), Tech Debt (8.3871%)
**Top Internal Functions/Classes:**
  * `convertPrimaryConstructor` (Impact: 90.6)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinParsing.parseClassOrObject * primaryConstructor branch...
  * `convertPropertyDeclaration` (Impact: 71.2)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinParsing.parseProperty */
  * `convertFunctionDeclaration` (Impact: 71.2)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinParsing.parseFunction */
  * `convertGetterOrSetter` (Impact: 68.2)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinParsing.parsePropertyComponent */
  * `convertClass` (Impact: 63.0)
    * *Intent:* /***** DECLARATIONS *****/ /** * @see org.jetbrains.kotlin.parsing.KotlinParsing.parseClassOrObject ...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (87.9499%), Tech Debt (10.45%)
**Top Internal Functions/Classes:**
  ...
  * `getRendererForDiagnostic` (Impact: 6.2)
  * `render` (Impact: 4.7)
  * `getMap` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (72.5876%), Tech Debt (8.7021%)
**Top Internal Functions/Classes:**
  * `compute` (Impact: 7.3)
  * `render` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (43.1735%), Tech Debt (59.9813%)
**Top Internal Functions/Classes:**
  * `wrapException` (Impact: 237.1)
    * *Intent:* /** * Called, when exception is caught in this block. Result expception would be rethrown instead. *...
  * `overrideRuntimeGlobals` (Impact: 33.0)
  * `evaluateConstantValueImpl` (Impact: 31.6)
  * `evaluateOperatorCall` (Impact: 25.4)
...
- **Risk Profile:** Cognitive Load (85.8478%), Tech Debt (9.7757%)
**Top Internal Functions/Classes:**
  * `devirtualize` (Impact: 113.0)
  * `analyze` (Impact: 55.6)
  * `visitCall` (Impact: 48.2)
  * `dfgNodeToConstraintNode` (Impact: 41.0)
    * *Intent:* /** * Takes a function DFG's node and creates a constraint graph node corresponding to it. * Also cr...
  * `writeField` (Impact: 35.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (85.7439%), Tech Debt (9.0963%)
**Top Internal Functions/Classes:**
  * `lower` (Impact: 311.0)
  * `and` (Impact: 44.7)
    * *Intent:* // TODO: Support type hierarchy here (KT-77671).
  * `buildEqEq` (Impact: 37.6)
  * `setVariable` (Impact: 36.2)
  * `or` (Impact: 33.9)
    * *Intent:* // TODO: Support type hierarchy here (KT-77671).
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (54.1367%), Tech Debt (8.6541%)
**Top Internal Functions/Classes:**
  * `transformQualifiedAccessExpression` (Impact: 55.3)
  * `transformFunctionCallInternal` (Impact: 46.2)
  * `transformSuperReceiver` (Impact: 41.4)
  * `transformDelegatedConstructorCall` (Impact: 35.0)
  * `prepareContextSensitiveAlternativeIfNeeded` (Impact: 29.0)
...
- **Risk Profile:** Cognitive Load (29.016%), Tech Debt (15.7052%)
**Top Internal Functions/Classes:**
  * `parseClassOrObject` (Impact: 83.5)
    * *Intent:* * primaryConstructor? * (":" annotations delegationSpecifier{","})? * typeConstraints * (classBody? ...
  * `parseCommonDeclaration` (Impact: 51.5)
  * `parseMultiDeclarationEntry` (Impact: 47.2)
    * *Intent:* /* * (SimpleName (":" type){","}) */
  * `parseProperty` (Impact: 37.1)
    * *Intent:* * variableDeclarationEntry * : SimpleName (":" type)? * ; * * property * : modifiers ("val" | "var")...
  * `parsePropertyComponent` (Impact: 37.1)
...
- **Risk Profile:** Cognitive Load (18.1271%), Tech Debt (7.8455%)
**Top Internal Functions/Classes:**
  * `parseClassOrObject` (Impact: 83.1)
    * *Intent:* * primaryConstructor? * (":" annotations delegationSpecifier{","})? * typeConstraints * (classBody? ...
  * `parseProperty` (Impact: 50.0)
    * *Intent:* * variableDeclarationEntry * : SimpleName (":" type)? * ; * * property * : modifiers ("val" | "var")...
  * `doParseModifierListBody` (Impact: 49.0)
  * `parseTypeRefContents` (Impact: 47.5)
    * *Intent:* // The extraRecoverySet is needed for the foo(bar<x, 1, y>(z)) case, to tell whether we should stop ...
  * `parseMultiDeclarationEntry` (Impact: 45.3)
    * *Intent:* /* * (SimpleName (":" type){","}) */
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (60.7703%), Tech Debt (10.29%)
**Top Internal Functions/Classes:**
  * `convertCallExpression` (Impact: 33.8)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinExpressionParsing.parseCallSuffix */
  * `convertQualifiedExpression` (Impact: 33.2)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinExpressionParsing.parsePostfixExpression * @see org.je...
  * `convertWhenExpression` (Impact: 28.9)
    * *Intent:* /** * @see org.jetbrains.kotlin.parsing.KotlinExpressionParsing.parseWhen * @see org.jetbrains.kotli...
  * `wrapExpressionIfNeeded` (Impact: 28.5)
  * `convertBinaryExpressionFallback` (Impact: 24.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (28.6713%), Tech Debt (8.8864%)
**Top Internal Functions/Classes:**
  * `convertMethod` (Impact: 106.6)
  * `extractMethodSignatureTypes` (Impact: 105.5)
  * `convertClass` (Impact: 87.7)
    * *Intent:* /** * Returns false for the inner classes or if the origin for the class was not found. */
  * `checkIfAnnotationValueMatches` (Impact: 56.3)
  * `getCallableDeclaration` (Impact: 42.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (48.2694%), Tech Debt (8.4862%)
**Top Internal Functions/Classes:**
  * `processConditionalContract` (Impact: 84.6)
  * `processEq` (Impact: 75.2)
  * `exitVariableInitialization` (Impact: 61.9)
  * `mapElement` (Impact: 40.7)
  * `addTypeOperatorStatements` (Impact: 32.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (23.9399%), Tech Debt (9.0905%)
**Top Internal Functions/Classes:**
  * `checkLValue` (Impact: 73.4)
    * *Intent:* /** * @return {@code true} iff expression can be assigned to */
  * `checkPossiblyQualifiedSuper` (Impact: 67.7)
  * `visitBinaryExpression` (Impact: 49.9)
  * `visitUnaryExpression` (Impact: 41.8)
  * `resolveArrayAccessSpecialMethod` (Impact: 34.0)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 130`, `state_mutation: 60`, `dead_code: 1`, `planned_debt: 6`
...
- **Risk Profile:** Cognitive Load (59.8761%), Tech Debt (14.8705%)
**Top Internal Functions/Classes:**
  * `init` (Impact: 54.9)
  * `analyze` (Impact: 43.0)
  * `paintNodes` (Impact: 43.0)
  * `buildDrains` (Impact: 41.4)
  * `computeLifetimes` (Impact: 28.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (30.6267%)
**Top Internal Functions/Classes:**
  * `timesTenToTheEHighPrecision` (Impact: 68.8)
  * `toDoubleHighPrecision` (Impact: 65.9)
  * `addHighPrecision` (Impact: 35.7)
  * `compareHighPrecision` (Impact: 34.7)
  * `highestSetBit` (Impact: 33.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (20.8733%), Tech Debt (12.5142%)
**Top Internal Functions/Classes:**
  * `buildKaCall` (Impact: 118.3)
    * *Intent:* /** * Core call construction logic. Assumes the caller has already handled compound access. */
  * `toKaResolutionAttempt` (Impact: 57.2)
  * `createKtPartiallyAppliedSymbolForImplicitInvoke` (Impact: 43.4)
  * `createCompoundArrayAccessCall` (Impact: 27.8)
  * `createKaCallForVariableAccessConvention` (Impact: 27.5)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `generateComponentAccess` (Impact: 42.3)
  * `generateIncrementOrDecrementBlockForArrayAccess` (Impact: 32.7)
    * *Intent:* * * given: * ++a[b, c] * * result: * { * val <array> = a * val <index0> = b * val <index1> = c * <ar...
  * `generateConstantExpressionByLiteral` (Impact: 30.4)
  * `createDataClassCopyFunction` (Impact: 26.2)
  * `generateIndexedAccessAugmentedAssignment` (Impact: 26.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (23.4376%), Tech Debt (11.2054%)
**Top Internal Functions/Classes:**
  * `updateLvtAccordingToLiveness` (Impact: 83.3)
    * *Intent:* /* * Before ApiVersion 2.2. * We do not want to spill dead variables, thus, we shrink its LVT record...
  * `min` (Impact: 61.3)
  * `calculateVariablesToSpill` (Impact: 54.7)
    * *Intent:* // We consider variable liveness to avoid problems with inline suspension functions: // <spill varia...
  * `transformCallAndReturnStateLabel` (Impact: 39.5)
  * `spillVariables` (Impact: 36.9)
...
- `compiler/arguments/src/org/jetbrains/kotlin/arguments/description/CommonCompilerArguments.kt` -> Churn: **63.09%** | Cog Load: 68.2956% | Debt: 8.8438%
- `compiler/arguments/src/org/jetbrains/kotlin/arguments/description/JvmCompilerArguments.kt` -> Churn: **63.09%** | Cog Load: 89.5148% | Debt: 8.2441%
...
- `compiler/cli/cli-base/src/org/jetbrains/kotlin/cli/jvm/compiler/KotlinCoreEnvironment.kt` -> **Severity: 0.003** (Bridge: 0.0001 * Flux: 61.1368%)
- `compiler/frontend/src/org/jetbrains/kotlin/resolve/deprecation/DeprecationResolver.kt` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 66.0274%)
- `compiler/fir/fir2ir/src/org/jetbrains/kotlin/fir/backend/Fir2IrVisitor.kt` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 83.0963%)
- `compiler/frontend/src/org/jetbrains/kotlin/analyzer/AnalysisResult.kt` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 35.2298%)
- `compiler/frontend/src/org/jetbrains/kotlin/resolve/calls/tower/KotlinResolutionCallbacksImpl.kt` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 39.6858%)
