...
| guards | 14 | 5 | 0 | `cics-genapp/base/cntl/db2cre.jcl` |
...
| io | 518 | 51 | 11 | `cics-genapp/base/src/lgsetup.cbl` |
| crypto | 0 | 0 | 0 | - |
...
| ml_ai | 1 | 1 | 0 | `cics-genapp/base/src/lgicvs01.cbl` |
| ui | 43 | 5 | 0 | `cics-genapp/base/src/lgtestp1.cbl` |
...
- `cics-genapp/base/src/lgsetup.cbl` (Hits: 62)
- `cics-genapp/base/src/lgicvs01.cbl` (Hits: 35)
- `cics-genapp/base/cntl/db2cre.jcl` (Hits: 32)
...
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp4.cbl`) -> Impact: **24.0** | LOC: 199
- `UPDATE-POLICY-DB2-INFO` (@ `cics-genapp/base/src/lgupdb01.cbl`) -> Impact: **22.5** | LOC: 110
  * *Intent:* *================================================================* * 1) Use SELECT FOR UPDATE to obtain a lock on the row in the * * policy table, che...
- `MAINLINE` (@ `cics-genapp/base/src/lgapdb01.cbl`) -> Impact: **20.2** | LOC: 105
  * *Intent:* *----------------------------------------------------------------*
- `MAINLINE` (@ `cics-genapp/base/src/lgicvs01.cbl`) -> Impact: **19.6** | LOC: 133
  * *Intent:* *---------------------------------------------------------------*
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp1.cbl`) -> Impact: **18.0** | LOC: 204
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp2.cbl`) -> Impact: **18.0** | LOC: 191
- `A-GAIN` (@ `cics-genapp/base/src/lgtestp3.cbl`) -> Impact: **18.0** | LOC: 187
- `GET-ENDOW-DB2-INFO` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **16.3** | LOC: 106
  * *Intent:* *----------------------------------------------------------------* *================================================================* * Use Select on ...
- `A-GAIN` (@ `cics-genapp/base/src/lgtestc1.cbl`) -> Impact: **15.5** | LOC: 159
- `MAINLINE` (@ `cics-genapp/base/src/lgipdb01.cbl`) -> Impact: **15.2** | LOC: 84
  * *Intent:* *----------------------------------------------------------------*
...
### 1. `cics-genapp/base/src/lgicvs01.cbl` (COBOL) -> Cumulative Risk: **652.64**
...
### 2. `cics-genapp/base/src/lgupdb01.cbl` (COBOL) -> Cumulative Risk: **643.9**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 173.78 | **LOC:** 536 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9982%), Safety Score (87.5827%)
- **Heaviest Functions:** `UPDATE-POLICY-DB2-INFO` (Impact: 22.5), `CLOSE-PCURSOR` (Impact: 6.0), `UPDATE-MOTOR-DB2-INFO` (Impact: 5.8)

### 3. `cics-genapp/base/src/lgacdb01.cbl` (COBOL) -> Cumulative Risk: **642.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 4. `cics-genapp/base/src/lgapdb01.cbl` (COBOL) -> Cumulative Risk: **627.92**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 186.96 | **LOC:** 596 | **CtrlFlow:** 6.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9942%), Safety Score (85.7465%)
- **Heaviest Functions:** `MAINLINE` (Impact: 20.2), `INSERT-POLICY` (Impact: 8.1), `INSERT-ENDOW` (Impact: 7.0)

### 5. `cics-genapp/base/src/lgipdb01.cbl` (COBOL) -> Cumulative Risk: **625.78**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 436.08 | **LOC:** 1031 | **CtrlFlow:** 8.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (92.4556%)
- **Heaviest Functions:** `GET-ENDOW-DB2-INFO` (Impact: 16.3), `MAINLINE` (Impact: 15.2), `GET-MOTOR-DB2-INFO` (Impact: 13.7)

### 6. `cics-genapp/base/src/lgstsq.cbl` (COBOL) -> Cumulative Risk: **608.68**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 7. `cics-genapp/base/src/lgtestc1.cbl` (COBOL) -> Cumulative Risk: **593.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 8. `cics-genapp/base/src/lgapol01.cbl` (COBOL) -> Cumulative Risk: **589.45**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 9. `cics-genapp/base/src/lgacus01.cbl` (COBOL) -> Cumulative Risk: **583.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `cics-genapp/base/src/lgicus01.cbl` (COBOL) -> Cumulative Risk: **582.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
