...
- `resolve` (@ `src/objects/core/zcl_abapgit_dependencies.clas.abap`) -> Impact: **114.2** | LOC: 138
- `render_repo_top` (@ `src/ui/lib/zcl_abapgit_gui_chunk_lib.clas.abap`) -> Impact: **79.6** | LOC: 137
- `any_to_abap` (@ `src/json/zcl_abapgit_ajson.clas.locals_imp.abap`) -> Impact: **78.7** | LOC: 154
- `test` (@ `src/diff/diff3/zcl_abapgit_diff3.clas.testclasses.abap`) -> Impact: **77.7** | LOC: 633
- `convert_value` (@ `src/json/zcl_abapgit_ajson.clas.locals_imp.abap`) -> Impact: **66.9** | LOC: 78
- `serialize_type` (@ `src/objects/tabl/zcl_abapgit_object_tabl_ddl.clas.abap`) -> Impact: **62.8** | LOC: 78
- `render_field` (@ `src/ui/lib/zcl_abapgit_html_form.clas.abap`) -> Impact: **62.8** | LOC: 130
- `prioritize_deser` (@ `src/objects/core/zcl_abapgit_file_deserialize.clas.abap`) -> Impact: **58.2** | LOC: 125
- `find_up_to_date` (@ `src/ui/flow/zcl_abapgit_flow_git.clas.abap`) -> Impact: **53.6** | LOC: 93
- `check_report_status` (@ `src/git/zcl_abapgit_git_transport.clas.abap`) -> Impact: **51.9** | LOC: 77
...
- **Heaviest Functions:** `submitSapeventForm` (Impact: 38.3), `mousedownEventListener` (Impact: 33.2), `enumerateUiActions` (Impact: 26.9)
...
- **Heaviest Functions:** `is_program_locked` (Impact: 7.0), `is_objtype_locked` (Impact: 5.4), `get_field_rules` (Impact: 2.9)
...
- **Heaviest Functions:** `zif_abapgit_ajson_mapping~rename_node` (Impact: 11.8), `zif_abapgit_ajson_mapping~to_json` (Impact: 6.8), `zif_abapgit_ajson_mapping~rename_node` (Impact: 5.3)
...
- **Heaviest Functions:** `shortlist` (Impact: 13.8), `map_beacons` (Impact: 12.8), `calculate_stats` (Impact: 6.8)
...
- **Heaviest Functions:** `get_messages_status` (Impact: 21.9), `zif_abapgit_log~get_status` (Impact: 12.2), `zif_abapgit_log~add` (Impact: 7.2)
...
- **Heaviest Functions:** `study_line` (Impact: 42.0), `indent_line` (Impact: 38.5), `zif_abapgit_html~a` (Impact: 20.6)
...
- **Heaviest Functions:** `deserialize_oo_transaction` (Impact: 38.9), `split_parameters` (Impact: 35.1), `zif_abapgit_object~deserialize` (Impact: 27.6)
...
- **Heaviest Functions:** `serialize_texts` (Impact: 10.0), `zif_abapgit_object~deserialize` (Impact: 7.0), `zif_abapgit_object~delete` (Impact: 5.5)
...
- **Heaviest Functions:** `zif_abapgit_object~deserialize` (Impact: 19.8), `zif_abapgit_object~serialize` (Impact: 19.2), `delete_intervals` (Impact: 9.3)
...
- **Heaviest Functions:** `zif_abapgit_object~deserialize` (Impact: 4.0), `zif_abapgit_object~serialize` (Impact: 4.0), `zif_abapgit_object~delete` (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  ...
  * `enumerateUiActions` (Impact: 26.9)
  * `hintActivate` (Impact: 25.2)
  * `handleKey` (Impact: 24.9)
...
**Top Internal Functions/Classes:**
  * `any_to_abap` (Impact: 78.7)
  * `convert_value` (Impact: 66.9)
  * `value_to_abap` (Impact: 44.6)
  * `get_node_type` (Impact: 44.0)
  * `stringify_node` (Impact: 43.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test` (Impact: 77.7)
  * `diff_comm` (Impact: 34.0)
  * `test_invert_patch` (Impact: 33.3)
  * `test` (Impact: 32.6)
  * `test_diff_patch` (Impact: 31.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `set_with_type_slice` (Impact: 16.0)
  * `array_to_string_table` (Impact: 6.5)
  * `to_abap_compressed_hash` (Impact: 5.8)
  * `to_abap_negative` (Impact: 5.5)
  * `set_array` (Impact: 5.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `render_repo_top` (Impact: 79.6)
  * `render_branch_name` (Impact: 40.3)
  * `render_table_header` (Impact: 32.3)
  * `render_label_list` (Impact: 30.0)
  * `render_item_state` (Impact: 28.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `serialize_type` (Impact: 62.8)
  * `serialize_extend` (Impact: 40.3)
  * `serialize_field_foreign_key` (Impact: 38.8)
  * `serialize_top` (Impact: 37.8)
  * `serialize` (Impact: 36.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 4 instances
...
**Top Internal Functions/Classes:**
  * `repository_services` (Impact: 45.8)
  * `general_page_routing` (Impact: 41.9)
  * `zip_services` (Impact: 34.4)
  * `git_services` (Impact: 21.1)
  * `jump_object` (Impact: 18.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `zif_abapgit_diff3~lcs` (Impact: 45.4)
  * `zif_abapgit_diff3~diff3_merge_regions` (Impact: 29.6)
  * `zif_abapgit_diff3~diff_comm` (Impact: 23.1)
  * `zif_abapgit_diff3~diff_indices` (Impact: 10.9)
  * `zif_abapgit_diff3~patch` (Impact: 10.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `deserialize` (Impact: 46.3)
  * `delete` (Impact: 36.8)
  * `create_object` (Impact: 30.1)
  * `deserialize_step` (Impact: 26.8)
  * `update_original_system` (Impact: 26.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `append_diff` (Impact: 44.0)
  * `render_lines` (Impact: 26.4)
  * `render_diff_head` (Impact: 25.0)
  * `calculate_diff` (Impact: 22.8)
  * `render_line_split` (Impact: 22.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `add_objects_and_files_from_tr` (Impact: 35.3)
  * `try_matching_transports` (Impact: 35.2)
  * `check_files` (Impact: 26.2)
  * `consolidate_files` (Impact: 25.6)
  * `update_all_branches` (Impact: 18.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `zif_abapgit_gui_renderable~render` (Impact: 28.4)
  * `apply_order_by` (Impact: 24.0)
  * `zif_abapgit_gui_event_handler~on_event` (Impact: 17.4)
  * `render_item` (Impact: 16.4)
  * `build_main_toolbar` (Impact: 15.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `deserialize_functions` (Impact: 35.8)
  * `includes` (Impact: 34.6)
  * `deserialize_xml` (Impact: 19.5)
  * `get_abap_version` (Impact: 15.6)
  * `serialize_functions` (Impact: 15.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 4 instances
...
**Top Internal Functions/Classes:**
  * `validate_form` (Impact: 32.6)
  * `zif_abapgit_gui_event_handler~on_event` (Impact: 25.6)
  * `get_form_schema` (Impact: 25.0)
  * `choose_tag` (Impact: 15.8)
  * `zif_abapgit_gui_hotkeys~get_hotkey_actions` (Impact: 14.3)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `render_field` (Impact: 62.8)
  * `render` (Impact: 40.8)
  * `render_field_table` (Impact: 23.6)
  * `render_field_text` (Impact: 20.2)
  * `render_field_radio` (Impact: 18.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `decode` (Impact: 32.7)
  * `decode_commit` (Impact: 25.7)
  * `decode_tag` (Impact: 25.5)
  * `type_and_length` (Impact: 24.4)
  * `get_type` (Impact: 15.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `deserialize_oo_transaction` (Impact: 38.9)
  * `split_parameters` (Impact: 35.1)
  * `zif_abapgit_object~deserialize` (Impact: 27.6)
  * `shift_param` (Impact: 25.0)
  * `set_oo_parameters` (Impact: 18.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `deserialize_dynpros` (Impact: 39.9)
  * `serialize_program` (Impact: 36.4)
  * `serialize_dynpros` (Impact: 32.7)
  * `deserialize_textpool` (Impact: 31.6)
  * `update_program` (Impact: 17.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 8 instances
...
**Top Internal Functions/Classes:**
  * `map_distance` (Impact: 36.4)
  * `map_length` (Impact: 35.3)
  * `decompress` (Impact: 19.4)
  * `dynamic` (Impact: 14.6)
  * `fixed` (Impact: 7.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 8 instances
...
**Top Internal Functions/Classes:**
  * `zif_abapgit_ajson~set` (Impact: 15.5)
  * `zif_abapgit_ajson~setx` (Impact: 15.5)
  * `create_from` (Impact: 15.1)
  * `delete_subtree` (Impact: 15.0)
  * `prove_path_exists` (Impact: 14.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 8 instances
...
**Top Internal Functions/Classes:**
  * `popup_decisions` (Impact: 25.7)
  * `popup_data_loss_overwrite` (Impact: 18.7)
  * `popup_delete_tabl_data` (Impact: 18.7)
  * `purge` (Impact: 17.6)
  * `popup_objects_overwrite` (Impact: 15.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `receive_pack_push` (Impact: 37.2)
  * `push` (Impact: 29.8)
  * `walk` (Impact: 18.4)
  * `walk_tree` (Impact: 17.8)
  * `create_tag` (Impact: 14.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 8 instances
...
**Top Internal Functions/Classes:**
  * `zif_abapgit_popups~branch_list_popup` (Impact: 38.9)
  * `_popup_3_get_values` (Impact: 20.4)
  * `zif_abapgit_popups~popup_to_select_labels` (Impact: 11.9)
  * `zif_abapgit_popups~tag_list_popup` (Impact: 11.6)
  * `center` (Impact: 11.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `set_abapgit_descriptions` (Impact: 23.5)
  * `get_methods` (Impact: 8.7)
  * `deserialize_translation` (Impact: 7.5)
  * `serialize_translations` (Impact: 6.2)
  * `set_methods` (Impact: 5.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
* *Amplified Cascading Flux:* 65 instances
