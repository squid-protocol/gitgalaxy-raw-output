...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 75.0 | 32.0 | 26.5 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 36.1 | 22.2 | 0.0 |
...
- `poll` (@ `package/src/listenDevices.ts`) -> Impact: **10.9** | LOC: 39
- `listen` (@ `package/src/TransportNodeHid.ts`) -> Impact: **5.3** | LOC: 22
  * *Intent:* /** */
- `onRemove` (@ `package/src/TransportNodeHid.ts`) -> Impact: **4.9** | LOC: 13
- `onAdd` (@ `package/src/TransportNodeHid.ts`) -> Impact: **4.8** | LOC: 12
...
- `listenDevicesPollingSkip` (@ `package/src/TransportNodeHid.ts`) -> Impact: **3.2** | LOC: 24
- `attachDetected` (@ `package/src/listenDevices.ts`) -> Impact: **1.9** | LOC: 9
- `setListenDevicesDebounce` (@ `package/src/TransportNodeHid.ts`) -> Impact: **1.8** | LOC: 8
  * *Intent:* /** * */
- `setListenDevicesPollingSkip` (@ `package/src/TransportNodeHid.ts`) -> Impact: **1.8** | LOC: 8
  * *Intent:* /** * */
- `detachDetected` (@ `package/src/listenDevices.ts`) -> Impact: **1.8** | LOC: 8
...
### 1. `package/src/listenDevices.ts` (TYPESCRIPT) -> Cumulative Risk: **505.66**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 37.86 | **LOC:** 89 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.7039%), Safety Score (74.9655%)
- **Heaviest Functions:** `poll` (Impact: 10.9), `attachDetected` (Impact: 1.9), `detachDetected` (Impact: 1.8)

### 2. `package/src/TransportNodeHid.ts` (TYPESCRIPT) -> Cumulative Risk: **457.41**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 38.98 | **LOC:** 127 | **CtrlFlow:** 10.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (97.7023%), Concurrency (71.8246%), Safety Score (52.9771%)
- **Heaviest Functions:** `listen` (Impact: 5.3), `onRemove` (Impact: 4.9), `onAdd` (Impact: 4.8)

### 3. `package/jest.config.ts` (TYPESCRIPT) -> Cumulative Risk: **77.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Magnitude:** 38.98 | **LOC:** 127 | **CtrlFlow:** 10.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (7.6304%), Tech Debt (97.7023%)
**Top Internal Functions/Classes:**
  ...
  * `open` (Impact: 4.8)
    * *Intent:* /** * if path="" is not provided, the library will take the first device */
  * `listenDevicesPollingSkip` (Impact: 3.2)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 37.86 | **LOC:** 89 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (50.6849%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `poll` (Impact: 10.9)
  * `attachDetected` (Impact: 1.9)
  * `detachDetected` (Impact: 1.8)
  * `flatDevice` (Impact: 1.7)
  * `getDeviceByPaths` (Impact: 1.7)
