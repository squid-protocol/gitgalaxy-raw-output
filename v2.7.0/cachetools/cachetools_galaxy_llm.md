...
- `__get__` (@ `cachetools-7.0.5/src/cachetools/_cachedmethod.py`) -> Impact: **21.9** | LOC: 39
- `__init__` (@ `cachetools-7.0.5/src/cachetools/_cachedmethod.py`) -> Impact: **17.4** | LOC: 9
- `expire` (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **16.7** | LOC: 23
  * *Intent:* """Remove expired items from the cache and return an iterable of the expired `(key, value)` pairs. """
- `cached` (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **16.1** | LOC: 29
  * *Intent:* """Decorator to wrap a function with a memoizing callable that saves results in a cache. """
- `cachedmethod` (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **15.8** | LOC: 23
  * *Intent:* """Decorator to wrap a method with a memoizing callable that saves results in a cache. """
- `test_missing` (@ `cachetools-7.0.5/tests/__init__.py`) -> Impact: **15.6** | LOC: 58
- `__setitem__` (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **14.8** | LOC: 15
- `decorator` (@ `cachetools-7.0.5/src/cachetools/__init__.py`) -> Impact: **9.5** | LOC: 20
...
- **Heaviest Functions:** `expire` (Impact: 16.7), `cached` (Impact: 16.1), `cachedmethod` (Impact: 15.8)
...
- **Heaviest Functions:** `_wrapper` (Impact: 46.5), `_condition_info` (Impact: 4.7), `_locked_info` (Impact: 4.2)
...
- **Heaviest Functions:** `_wrapper` (Impact: 41.0), `__get__` (Impact: 21.9), `__init__` (Impact: 17.4)
...
- **Heaviest Functions:** `ttl_cache` (Impact: 9.5), `rr_cache` (Impact: 8.6), `fifo_cache` (Impact: 7.5)
...
- **Heaviest Functions:** `test_cached_stampede` (Impact: 6.3), `test_cachedmethod_stampede` (Impact: 6.3), `func` (Impact: 3.4)
...
- **Heaviest Functions:** `typedkey` (Impact: 9.2), `hashkey` (Impact: 5.5), `__hash__` (Impact: 3.7)
...
- **Heaviest Functions:** `test` (Impact: 2.7), `test_typed` (Impact: 2.6), `test_locked` (Impact: 2.0)
...
- **Heaviest Functions:** `test_lfu` (Impact: 5.3), `test_lfu_clear` (Impact: 2.6), `test_lfu_getsizeof` (Impact: 2.5)
...
- **Heaviest Functions:** `test_missing` (Impact: 15.6), `test_pickle` (Impact: 6.9), `test_insert` (Impact: 6.5)
...
- **Heaviest Functions:** `test_ttu` (Impact: 5.2), `test_ttu_heap_cleanup` (Impact: 4.2), `test_ttu_expire` (Impact: 3.9)
...
**Top Internal Functions/Classes:**
  ...
  * `cached` (Impact: 16.1)
    * *Intent:* """Decorator to wrap a function with a memoizing callable that saves results in a cache. """
  * `cachedmethod` (Impact: 15.8)
    * *Intent:* """Decorator to wrap a method with a memoizing callable that saves results in a cache. """
  * `__setitem__` (Impact: 14.8)
  * `decorator` (Impact: 9.5)
...
**Top Internal Functions/Classes:**
  ...
  * `__get__` (Impact: 21.9)
  * `__init__` (Impact: 17.4)
  * `__set_name__` (Impact: 8.4)
  * `_condition_info` (Impact: 4.9)
...
**Top Internal Functions/Classes:**
  * `test_decorator_cond_info` (Impact: 6.7)
  * `test_decorator_lock_cond_info` (Impact: 6.7)
  * `test_decorator_lock_info` (Impact: 6.3)
  * `test_decorator_info` (Impact: 5.5)
  * `test_decorator_immutable_dict` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_condition_info` (Impact: 4.7)
    * *Intent:* # At least for now, the implementation prefers clarity and performance # over ease of maintenance, t...
  * `_locked_info` (Impact: 4.2)
  * `_condition` (Impact: 4.0)
  * `_unlocked_info` (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 16 instances
...
**Top Internal Functions/Classes:**
  * `test_missing` (Impact: 15.6)
  * `test_pickle` (Impact: 6.9)
  * `test_insert` (Impact: 6.5)
  * `test_pickle_maxsize` (Impact: 4.8)
  * `_test_getsizeof` (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `func` (Impact: 6.3)
  * `test_decorator_typed` (Impact: 2.9)
  * `test_decorator` (Impact: 2.7)
  * `test_decorator_lock_condition_info` (Impact: 2.7)
  * `test_decorator_lock_info` (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_ttu` (Impact: 5.2)
  * `test_ttu_heap_cleanup` (Impact: 4.2)
  * `test_ttu_expire` (Impact: 3.9)
  * `__call__` (Impact: 3.0)
  * `test_ttu_lru` (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_ttl` (Impact: 4.2)
  * `test_ttl_expire` (Impact: 3.9)
  * `__call__` (Impact: 3.0)
  * `test_ttl_lru` (Impact: 2.8)
  * `test_ttl_clear` (Impact: 2.8)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test` (Impact: 2.7)
  * `test_typed` (Impact: 2.6)
  * `test_locked` (Impact: 2.0)
  * `test_condition` (Impact: 2.0)
  * `test_clear` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_cached_stampede` (Impact: 6.3)
  * `test_cachedmethod_stampede` (Impact: 6.3)
  * `func` (Impact: 3.4)
  * `meth` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_lfu` (Impact: 5.3)
  * `test_lfu_clear` (Impact: 2.6)
  * `test_lfu_getsizeof` (Impact: 2.5)
  * `test_lfu_update_existing` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_rr` (Impact: 2.6)
  * `test_rr_getsizeof` (Impact: 2.5)
  * `test_rr_bad_choice` (Impact: 2.1)
  * `test_rr_update_existing` (Impact: 2.0)
  * `test_rr_default_choice` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_lru` (Impact: 2.6)
  * `test_lru_getsizeof` (Impact: 2.5)
  * `test_lru_clear` (Impact: 2.4)
  * `test_lru_update_existing` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_fifo` (Impact: 2.6)
  * `test_fifo_getsizeof` (Impact: 2.5)
  * `test_fifo_update_existing` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `test_methodkey` (Impact: 2.6)
    * *Intent:* # similar to hashkey(), but ignores its first positional argument self.assertEqual(key("x"), key("y"...
  * `test_hashkey` (Impact: 2.5)
  * `test_typedkey` (Impact: 2.5)
  * `test_typedmethodkey` (Impact: 2.5)
