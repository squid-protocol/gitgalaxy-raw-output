...
| Avg Path Length | 3.7928 | Hops between files. Lower = Tighter coupling. |
...
| connectivity | 14771 | 2551 | 9 | `arch/md_calls.inc` |
...
| dead_code | 11875 | 1700 | 6 | `wrftladj/module_em_ad.F` |
...
- `surface_driver` (@ `phys/module_surface_driver.F`) -> Impact: **22820.7** | LOC: 4497
- `nssl_2mom_gs` (@ `phys/module_mp_nssl_2mom.F`) -> Impact: **17591.0** | LOC: 12531
- `chem_init` (@ `chem/chemics_init.F`) -> Impact: **11599.5** | LOC: 2090
- `radiation_driver` (@ `phys/module_radiation_driver.F`) -> Impact: **11596.8** | LOC: 3272
- `microphysics_driver` (@ `phys/module_microphysics_driver.F`) -> Impact: **10346.7** | LOC: 2925
- `lsm_mosaic` (@ `phys/module_sf_noahdrv.F`) -> Impact: **6059.1** | LOC: 2592
- `pbl_driver` (@ `phys/module_pbl_driver.F`) -> Impact: **5441.1** | LOC: 2274
- `bio_emissions_megan2` (@ `chem/module_bioemi_megan2.F`) -> Impact: **5429.6** | LOC: 1821
- `phy_init` (@ `phys/module_physics_init.F`) -> Impact: **5032.9** | LOC: 1712
- `deng_shcu` (@ `phys/module_shcu_deng.F`) -> Impact: **4821.8** | LOC: 3143
...
- **Heaviest Functions:** `calc_ts_locations` (Impact: 87.8), `write_ts` (Impact: 87.7), `calc_p8w` (Impact: 13.1)
...
- **Heaviest Functions:** `MPP_CHANNEL_COM_REAL` (Impact: 87.8), `MPP_CHANNEL_COM_REAL8` (Impact: 87.8), `MPP_CHANNEL_COM_INT` (Impact: 87.8)
...
- **Heaviest Functions:** `patch_domain_rsl_lite` (Impact: 789.6), `compute_memory_dims_rsl_lite` (Impact: 430.4), `rsl_comm_iter` (Impact: 372.8)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `TONODE2RSL8` (Impact: 54.2), `TONODE2RSL` (Impact: 54.0), `pack_decomp_int` (Impact: 39.8)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `read_wps` (Impact: 409.2), `inventory_wrf_binary_file` (Impact: 166.5), `count_recs_wrf_binary_file` (Impact: 72.8)
...
- **Heaviest Functions:** `interp_domain_em_small_part1` (Impact: 45.4), `interp_domain_em_small_part2` (Impact: 33.8), `feedback_nest_prep` (Impact: 5.9)
...
- **Heaviest Functions:** `CMP_INIT` (Impact: 25.5), `CMP_gnr_RECV` (Impact: 24.1), `CMP_RECV` (Impact: 21.3)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `gwstep` (Impact: 364.7), `sub_n_form` (Impact: 187.1), `parxsolv1` (Impact: 98.1)
...
- **Heaviest Functions:** `da_proc_stats_combine` (Impact: 53.2)
...
- **Heaviest Functions:** `init_domain_rk` (Impact: 494.9), `get_sounding_b_wave` (Impact: 65.4), `calc_jet_sounding` (Impact: 62.1)
...
**Top Internal Functions/Classes:**
  * `nssl_2mom_gs` (Impact: 17591.0)
  * `nssl_2mom_driver` (Impact: 4581.7)
  * `NUCOND` (Impact: 2434.8)
  * `setvtz` (Impact: 2155.8)
  * `ziegfall1d` (Impact: 1680.0)
...
**Top Internal Functions/Classes:**
  * `advect_v` (Impact: 2629.8)
  * `advect_scalar_pd` (Impact: 2552.0)
    * *Intent:* #endif
  * `advect_u` (Impact: 2535.3)
  * `advect_w` (Impact: 2441.6)
  * `advect_scalar` (Impact: 2211.6)
    * *Intent:* #endif
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `surface_driver` (Impact: 22820.7)
  * `sfclayrev_seaice_wrapper` (Impact: 248.2)
  * `sfclay_seaice_wrapper` (Impact: 239.1)
  * `mynn_seaice_wrapper` (Impact: 178.2)
  * `myjsfc_seaice_wrapper` (Impact: 171.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `SBM` (Impact: 3179.0)
  * `ONECOND3` (Impact: 745.9)
  * `ONECOND2` (Impact: 369.4)
  * `ONECOND1` (Impact: 299.1)
  * `COAL_BOTT_NEW` (Impact: 288.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 6 instances
...
**Top Internal Functions/Classes:**
  * `radiation_driver` (Impact: 11596.8)
  * `toposhad` (Impact: 461.7)
  * `cal_cldfra1` (Impact: 244.5)
  * `toposhad_init` (Impact: 225.8)
  * `find_cloudLayers` (Impact: 218.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ISRP4F2p1` (Impact: 216.3)
  * `ISRP3F2p1` (Impact: 110.6)
  * `FUNCP52p1` (Impact: 62.9)
  * `FUNCP42p1` (Impact: 62.9)
  * `FUNCP32p1` (Impact: 62.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `cal_deform_and_div` (Impact: 1973.4)
  * `vertical_diffusion_implicit` (Impact: 1791.2)
  * `cal_helicity` (Impact: 653.0)
  * `nonlocal_flux` (Impact: 592.3)
  * `vertical_diffusion_2` (Impact: 583.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `map_mosaic_species` (Impact: 1416.0)
  * `equilibrium` (Impact: 156.4)
  * `load_kappa_nonelectro` (Impact: 112.5)
  * `ASTEM_flux_mix` (Impact: 77.8)
  * `ASTEM_non_volatiles` (Impact: 68.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 2 instances
...
**Top Internal Functions/Classes:**
  * `LARGE_DT` (Impact: 2816.2)
  * `NTU_MICRO` (Impact: 1626.0)
  * `SMALL_DT` (Impact: 1289.8)
  * `SOLVE_AFAI` (Impact: 246.4)
  * `SOLVE_AFAS` (Impact: 181.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `FAST_SBM` (Impact: 2439.3)
  * `ONECOND2` (Impact: 384.4)
  * `COAL_BOTT_NEW` (Impact: 366.8)
  * `ONECOND3` (Impact: 363.1)
  * `FAST_HUCMINIT` (Impact: 302.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `phy_init` (Impact: 5032.9)
  * `bl_init` (Impact: 4490.9)
  * `mp_init` (Impact: 643.7)
  * `ra_init` (Impact: 619.8)
  * `landuse_init` (Impact: 369.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `RRTMG_LWRAD_FAST` (Impact: 1939.1)
  * `deallocateGPUrtrnmcg` (Impact: 704.9)
  * `copyGPUcldprmcg` (Impact: 209.6)
  * `rrtmg_lw_part` (Impact: 165.2)
  * `copyGPUSetCoef` (Impact: 58.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `RRTMG_LWRAD` (Impact: 2245.0)
  * `generate_stochastic_clouds` (Impact: 344.3)
  * `setcoef` (Impact: 256.3)
  * `rtrnmc` (Impact: 190.0)
  * `inatm` (Impact: 147.3)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
...
**Top Internal Functions/Classes:**
  * `MSKF_eta_PARA` (Impact: 2512.1)
  * `mskf_mphy` (Impact: 1685.6)
  * `MSKF_CPS` (Impact: 792.0)
  * `MSKF_CMT` (Impact: 681.1)
  * `mskf_nucleati` (Impact: 122.3)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
**Top Internal Functions/Classes:**
  * `lsm_mosaic` (Impact: 6059.1)
  * `lsm` (Impact: 3048.1)
  * `lsm_mosaic_init` (Impact: 488.0)
  * `LSMINIT` (Impact: 225.1)
    * *Intent:* #if defined(wrfmodel)
  * `SOIL_VEG_GEN_PARM` (Impact: 107.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `rhs_ph` (Impact: 1218.5)
  * `phy_prep_part2` (Impact: 934.0)
  * `curvature` (Impact: 596.8)
  * `horizontal_diffusion` (Impact: 395.0)
  * `sixth_order_diffusion` (Impact: 376.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ISRP4R2p1` (Impact: 212.8)
  * `ISRP3R2p1` (Impact: 124.2)
  * `CALCR12p1` (Impact: 86.7)
  * `CALCU12p1` (Impact: 86.7)
  * `ISRP2R2p1` (Impact: 64.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `chem_init` (Impact: 11599.5)
  * `print_chem_species_index` (Impact: 52.3)
    * *Intent:* #ifdef CHEM_DBG_I
  * `termite_initialize` (Impact: 13.7)
  * `VPRM_par_initialize` (Impact: 7.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `RRTMG_SWRAD_FAST` (Impact: 2421.2)
  * `rrtmg_sw_sub` (Impact: 632.2)
  * `spcvmc_sw` (Impact: 386.6)
  * `cldprmc_sw` (Impact: 305.0)
  * `mcica_sw` (Impact: 198.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
**Top Internal Functions/Classes:**
  * `sascnvn` (Impact: 2273.1)
  * `SASCNV` (Impact: 1995.8)
  * `shalcnv` (Impact: 1416.7)
  * `CU_SAS` (Impact: 474.0)
  * `OLD_ARW_SHALCV` (Impact: 134.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 1 instances
...
**Top Internal Functions/Classes:**
  * `init_data_mosaic_ptr` (Impact: 3414.3)
  * `mapaer_tofrom_host` (Impact: 3108.7)
  * `mosaic_aerchem_driver` (Impact: 168.9)
  * `init_data_mosaic_asect` (Impact: 87.1)
  * `aerchem_debug_dump` (Impact: 45.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `deng_shcu` (Impact: 4821.8)
  * `deng_shcu_driver` (Impact: 666.6)
  * `TPMIXBG` (Impact: 105.5)
  * `TPMIX` (Impact: 91.0)
  * `deng_shcu_init` (Impact: 64.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- `external/RSL_LITE/module_dm.F` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 100.0%)
- `frame/module_configure.F` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.9985%)
- `frame/module_io.F` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.3372%)
- `chem/module_cam_mam_initmixrats.F` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 100.0%)
