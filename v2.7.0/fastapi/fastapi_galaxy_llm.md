...
| Avg Path Length | 2.7697 | Hops between files. Lower = Tighter coupling. |
...
- `get_request_handler` (@ `fastapi/routing.py`) -> Impact: **254.0** | LOC: 379
- `__init__` (@ `fastapi/routing.py`) -> Impact: **191.3** | LOC: 165
- `analyze_param` (@ `fastapi/dependencies/utils.py`) -> Impact: **126.9** | LOC: 167
- `get_openapi_path` (@ `fastapi/openapi/utils.py`) -> Impact: **121.2** | LOC: 219
- `get_openapi` (@ `fastapi/openapi/utils.py`) -> Impact: **117.0** | LOC: 93
- `jsonable_encoder` (@ `fastapi/encoders.py`) -> Impact: **116.2** | LOC: 236
- `include_router` (@ `fastapi/routing.py`) -> Impact: **113.1** | LOC: 252
- `__init__` (@ `fastapi/applications.py`) -> Impact: **110.7** | LOC: 960
- `test_openapi` (@ `tests/test_include_router_defaults_overrides.py`) -> Impact: **98.5** | LOC: 6866
- `app` (@ `fastapi/routing.py`) -> Impact: **90.8** | LOC: 346
...
- **Heaviest Functions:** `analyze_param` (Impact: 126.9), `solve_dependencies` (Impact: 89.1), `get_dependant` (Impact: 46.1)
...
- **Heaviest Functions:** `get_request_handler` (Impact: 254.0), `__init__` (Impact: 191.3), `include_router` (Impact: 113.1)
...
- **Heaviest Functions:** `__call__` (Impact: 16.3), `__call__` (Impact: 16.3), `__call__` (Impact: 11.3)
...
- **Heaviest Functions:** `body` (Impact: 4.6), `get_route_handler` (Impact: 1.8), `custom_route_handler` (Impact: 1.6)
...
- **Heaviest Functions:** `authenticate_user` (Impact: 6.4), `create_access_token` (Impact: 5.6), `get_current_user` (Impact: 5.1)
...
**Top Internal Functions/Classes:**
  * `get_request_handler` (Impact: 254.0)
  * `__init__` (Impact: 191.3)
  * `include_router` (Impact: 113.1)
  * `app` (Impact: 90.8)
  * `__init__` (Impact: 81.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000229 | `Ripple Effect (Closeness):` 0.013175
...
**Top Internal Functions/Classes:**
  * `analyze_param` (Impact: 126.9)
  * `solve_dependencies` (Impact: 89.1)
  * `get_dependant` (Impact: 46.1)
  * `request_params_to_args` (Impact: 40.5)
  * `get_body_field` (Impact: 30.6)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 9.7e-05 | `Ripple Effect (Closeness):` 0.009822
...
**Top Internal Functions/Classes:**
  * `get_openapi_path` (Impact: 121.2)
  * `get_openapi` (Impact: 117.0)
  * `_get_openapi_operation_parameters` (Impact: 32.6)
  * `get_openapi_operation_metadata` (Impact: 17.1)
  * `get_fields_from_routes` (Impact: 14.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5.4e-05 | `Ripple Effect (Closeness):` 0.002305
...
**Top Internal Functions/Classes:**
  * `check_translation` (Impact: 29.8)
    * *Intent:* # All checks # -------------------------------------------------------------------------------------...
  * `extract_header_permalinks` (Impact: 23.7)
    * *Intent:* # Header permalinks # ------------------------------------------------------------------------------...
  * `replace_multiline_code_block` (Impact: 22.6)
  * `extract_multiline_code_blocks` (Impact: 21.8)
  * `replace_header_permalinks` (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `add_permalinks_page` (Impact: 51.5)
    * *Intent:* """ Add or update header permalinks in specific page of En docs. """
  * `remove_unused_docs_src` (Impact: 38.4)
    * *Intent:* """ Delete .py files in docs_src that are not included in any .md file under docs/. """
  * `generate_docs_src_versions_for_file` (Impact: 21.3)
  * `remove_header_permalinks` (Impact: 10.3)
  * `ensure_non_translated` (Impact: 10.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.000864
...
**Top Internal Functions/Classes:**
  * `make_pr` (Impact: 32.6)
  * `translate_page` (Impact: 30.3)
  * `translate_lang` (Impact: 11.2)
  * `update_and_add` (Impact: 9.1)
  * `commands_json` (Impact: 8.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 75.3)
  * `__init__` (Impact: 73.0)
  * `__init__` (Impact: 15.4)
  * `__init__` (Impact: 15.4)
  * `__init__` (Impact: 15.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-05 | `Ripple Effect (Closeness):` 0.00385
...
**Top Internal Functions/Classes:**
  * `get_schema_from_model_field` (Impact: 26.0)
  * `get_flat_models_from_annotation` (Impact: 12.8)
  * `serialize_sequence_value` (Impact: 12.7)
  * `get_flat_models_from_field` (Impact: 9.4)
  * `get_model_fields` (Impact: 7.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1.7e-05 | `Ripple Effect (Closeness):` 0.012061
...
**Top Internal Functions/Classes:**
  * `get_sync_context_b_bg` (Impact: 2.2)
  * `get_context_b_bg` (Impact: 2.0)
  * `asyncgen_state_try` (Impact: 1.9)
  * `generator_state_try` (Impact: 1.9)
  * `middleware` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_path_param_ge_2` (Impact: 2.7)
  * `test_path_param_le_42` (Impact: 2.7)
  * `test_path_param_le_ge_4` (Impact: 2.7)
  * `test_path_param_le_int_42` (Impact: 2.7)
  * `test_path_param_ge_int_2` (Impact: 2.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `get_discussions_experts` (Impact: 26.0)
  * `get_top_users` (Impact: 10.0)
  * `get_graphql_response` (Impact: 8.1)
  * `__enter__` (Impact: 7.0)
  * `get_users_to_write` (Impact: 7.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_openapi_schema` (Impact: 7.5)
  * `test_response_model_none_annotation_return_submodel_with_extra_data` (Impact: 1.5)
  * `test_invalid_response_model_field` (Impact: 1.5)
  * `test_response_model_none_annotation_return_dict_with_extra_data` (Impact: 1.4)
  * `test_response_model_list_of_model_no_annotation` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_callback_override_generate_unique_id` (Impact: 15.7)
  * `test_subrouter_top_level_include_overrides_generate_unique_id` (Impact: 15.2)
  * `test_app_path_operation_overrides_generate_unique_id` (Impact: 11.8)
  * `test_router_path_operation_overrides_generate_unique_id` (Impact: 11.6)
  * `test_top_level_generate_unique_id` (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.00673
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_router_events` (Impact: 4.4)
  * `test_router_nested_lifespan_state` (Impact: 4.3)
  * `test_startup_shutdown_handlers_as_parameters` (Impact: 4.3)
    * *Intent:* """Test that startup/shutdown handlers passed as parameters to FastAPI are called correctly."""
  * `test_router_sync_generator_lifespan` (Impact: 2.7)
    * *Intent:* """Test that a sync generator lifespan works via _wrap_gen_lifespan_context."""
  * `test_app_lifespan_state` (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 6 instances
...
**Top Internal Functions/Classes:**
  * `test_async_generator_with_model` (Impact: 9.4)
  * `test_sync_generator_with_model` (Impact: 4.7)
  * `test_async_generator_no_annotation` (Impact: 4.7)
  * `test_sync_generator_no_annotation` (Impact: 4.7)
  * `test_post_method_sse` (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  * `on_page_markdown` (Impact: 19.9)
  * `resolve_files` (Impact: 16.8)
  * `generate_renamed_section_items` (Impact: 13.3)
  * `on_config` (Impact: 9.1)
  * `on_files` (Impact: 7.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 44.1)
  * `get_graphql_response` (Impact: 10.9)
  * `get_graphql_translation_discussion_comments` (Impact: 6.1)
  * `get_graphql_translation_discussion_comments_edges` (Impact: 2.5)
  * `create_comment` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 1 instances
* *Amplified Cascading Flux:* 24 instances
* *Sec Tainted Injection (weighted view):* 1
...
**Top Internal Functions/Classes:**
  * `wrapped_app` (Impact: 4.5)
  * `make_app` (Impact: 3.8)
  * `websocket_middleware` (Impact: 3.8)
    * *Intent:* """ Helper to create a Starlette pure websocket middleware """
  * `middleware_constructor` (Impact: 3.5)
  * `routerindexparams` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_bench_post_json` (Impact: 2.8)
  * `_bench_get` (Impact: 2.5)
  * `test_sync_receiving_validated_pydantic_model` (Impact: 2.2)
  * `test_sync_receiving_large_payload` (Impact: 2.2)
  * `test_async_receiving_large_payload` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `jsonable_encoder` (Impact: 116.2)
  * `decimal_encoder` (Impact: 6.8)
    * *Intent:* # Adapted from Pydantic v1 # TODO: pv2 should this return strings instead? """ Encodes a Decimal as ...
  * `generate_encoders_by_class_tuples` (Impact: 3.3)
  * `isoformat` (Impact: 1.5)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2e-06 | `Ripple Effect (Closeness):` 0.017073
...
**Top Internal Functions/Classes:**
  ...
  * `__call__` (Impact: 16.3)
  * `__call__` (Impact: 11.3)
  * `__call__` (Impact: 10.8)
  * `__init__` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
* *Amplified Cascading Flux:* 18 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.005186
...
- `fastapi/routing.py` -> **Severity: 0.023** (Bridge: 0.0002 * Flux: 99.7525%)
- `fastapi/dependencies/utils.py` -> **Severity: 0.01** (Bridge: 0.0001 * Flux: 100.0%)
- `fastapi/openapi/utils.py` -> **Severity: 0.005** (Bridge: 0.0001 * Flux: 100.0%)
- `fastapi/responses.py` -> **Severity: 0.004** (Bridge: 0.0001 * Flux: 31.0026%)
- `fastapi/security/oauth2.py` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 90.5298%)
