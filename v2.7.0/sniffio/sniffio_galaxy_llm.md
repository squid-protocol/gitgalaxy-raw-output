...
- `current_async_library` (@ `sniffio-1.3.1/sniffio/_impl.py`) -> Impact: **11.6** | LOC: 71
  * *Intent:* """Detect which async library is currently running. The following libraries are currently supported: ================ =========== ====================...
- `Anonymous_Block` (@ `sniffio-1.3.1/ci.sh`) -> Impact: **5.7** | LOC: 34
- `__global_context__` (@ `sniffio-1.3.1/ci.sh`) -> Impact: **2.1** | LOC: 22
- `test_asyncio` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **2.0** | LOC: 19
- `test_curio` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **2.0** | LOC: 19
- `test_basics_cvar` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.6** | LOC: 12
- `test_basics_tlocal` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.6** | LOC: 12
- `this_is_asyncio` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.2** | LOC: 5
- `this_is_curio` (@ `sniffio-1.3.1/sniffio/_tests/test_sniffio.py`) -> Impact: **1.2** | LOC: 5
...
- **Heaviest Functions:** `test_asyncio` (Impact: 2.0), `test_curio` (Impact: 2.0), `test_basics_cvar` (Impact: 1.6)
...
- **Heaviest Functions:** `current_async_library` (Impact: 11.6)
...
- **Heaviest Functions:** `Anonymous_Block` (Impact: 5.7), `__global_context__` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  * `current_async_library` (Impact: 11.6)
    * *Intent:* """Detect which async library is currently running. The following libraries are currently supported:...
...
**Top Internal Functions/Classes:**
  * `test_asyncio` (Impact: 2.0)
  * `test_curio` (Impact: 2.0)
  * `test_basics_cvar` (Impact: 1.6)
  * `test_basics_tlocal` (Impact: 1.6)
  * `this_is_asyncio` (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
