...
- `__init__` (@ `ruamel.yaml-0.19.1/main.py`) -> Impact: **105.2** | LOC: 145
- `analyze_scalar` (@ `ruamel.yaml-0.19.1/emitter.py`) -> Impact: **104.1** | LOC: 177
...
- `construct_mapping` (@ `ruamel.yaml-0.19.1/constructor.py`) -> Impact: **99.0** | LOC: 102
  * *Intent:* # RoundTrip
- `expect_node` (@ `ruamel.yaml-0.19.1/emitter.py`) -> Impact: **94.7** | LOC: 81
  * *Intent:* # Node handlers.
- `parse_node` (@ `ruamel.yaml-0.19.1/parser.py`) -> Impact: **91.9** | LOC: 158
- `write_double_quoted` (@ `ruamel.yaml-0.19.1/emitter.py`) -> Impact: **91.2** | LOC: 104
...
- `scan_block_scalar` (@ `ruamel.yaml-0.19.1/scanner.py`) -> Impact: **90.2** | LOC: 124
...
- `represent_scalar_float` (@ `ruamel.yaml-0.19.1/representer.py`) -> Impact: **81.5** | LOC: 72
  * *Intent:* """ this is way more complicated """
- `represent_mapping` (@ `ruamel.yaml-0.19.1/representer.py`) -> Impact: **76.4** | LOC: 97
- `construct_yaml_int` (@ `ruamel.yaml-0.19.1/constructor.py`) -> Impact: **67.3** | LOC: 98
...
- **Heaviest Functions:** `get_snippet` (Impact: 17.6), `__str__` (Impact: 15.4), `__str__` (Impact: 15.4)
...
- **Heaviest Functions:** `yaml_set_comment_before_after_key` (Impact: 47.0), `dump_comments` (Impact: 30.0), `__contains__` (Impact: 27.0)
...
- **Heaviest Functions:** `move_old_comment` (Impact: 29.6), `move_new_comment` (Impact: 21.5), `add_comment_eol` (Impact: 8.6)
...
- **Heaviest Functions:** `walk_tree` (Impact: 26.1), `yaml_anchor` (Impact: 7.2), `__new__` (Impact: 4.3)
...
- **Heaviest Functions:** `update` (Impact: 18.8), `forward_1_1` (Impact: 12.9), `forward` (Impact: 12.8)
...
- **Heaviest Functions:** `create_timestamp` (Impact: 60.9), `load_yaml_guess_indent` (Impact: 39.4), `_walk_section` (Impact: 18.8)
...
- **Heaviest Functions:** `__repr__` (Impact: 18.5), `compact_repr` (Impact: 12.1), `compact_repr` (Impact: 10.1)
...
- **Heaviest Functions:** `serialize_node` (Impact: 44.4), `anchor_node` (Impact: 16.5), `__init__` (Impact: 12.6)
...
**Top Internal Functions/Classes:**
  * `construct_mapping` (Impact: 99.0)
    * *Intent:* # RoundTrip
  * `construct_yaml_int` (Impact: 67.3)
  * `construct_setting` (Impact: 51.6)
  * `construct_scalar` (Impact: 51.4)
  * `construct_yaml_object` (Impact: 48.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `represent_scalar_float` (Impact: 81.5)
    * *Intent:* """ this is way more complicated """
  * `represent_mapping` (Impact: 76.4)
  * `represent_omap` (Impact: 47.9)
  * `represent_sequence` (Impact: 45.3)
  * `represent_object` (Impact: 44.8)
...
**Top Internal Functions/Classes:**
  * `yaml_set_comment_before_after_key` (Impact: 47.0)
  * `dump_comments` (Impact: 30.0)
...
**Top Internal Functions/Classes:**
  * `parse_node` (Impact: 91.9)
  * `parse_flow_mapping_key` (Impact: 24.3)
  * `process_directives` (Impact: 23.4)
  ...
  * `parse_flow_sequence_entry` (Impact: 17.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 161 instances
...
**Top Internal Functions/Classes:**
  ...
  * `check_resolver_prefix` (Impact: 43.5)
  * `resolve` (Impact: 32.5)
  * `resolve` (Impact: 32.5)
...
**Top Internal Functions/Classes:**
  * `update` (Impact: 18.8)
  * `forward_1_1` (Impact: 12.9)
  * `forward` (Impact: 12.8)
  * `determine_encoding` (Impact: 12.0)
  * `stream` (Impact: 11.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__repr__` (Impact: 18.5)
  * `compact_repr` (Impact: 12.1)
  * `compact_repr` (Impact: 10.1)
  * `compact_repr` (Impact: 10.1)
  * `__init__` (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `compose_sequence_node` (Impact: 17.2)
...
**Top Internal Functions/Classes:**
  ...
  * `insert` (Impact: 11.8)
  * `check_namespace_char` (Impact: 9.0)
...
- `ruamel.yaml-0.19.1/main.py` -> **Severity: 11.131** (Bridge: 0.1113 * Flux: 99.9999%)
- `ruamel.yaml-0.19.1/util.py` -> **Severity: 9.735** (Bridge: 0.0974 * Flux: 100.0%)
...
- `ruamel.yaml-0.19.1/representer.py` -> **Severity: 2.206** (Bridge: 0.0221 * Flux: 100.0%)
