...
- `parse` (@ `mdurl-0.1.2/src/mdurl/_parse.py`) -> Impact: **112.5** | LOC: 169
- `repl_func_with_cache` (@ `mdurl-0.1.2/src/mdurl/_decode.py`) -> Impact: **32.7** | LOC: 66
- `encode` (@ `mdurl-0.1.2/src/mdurl/_encode.py`) -> Impact: **32.0** | LOC: 41
...
- `format` (@ `mdurl-0.1.2/src/mdurl/_format.py`) -> Impact: **22.2** | LOC: 19
- `get_encode_cache` (@ `mdurl-0.1.2/src/mdurl/_encode.py`) -> Impact: **9.5** | LOC: 20
  * *Intent:* # Create a lookup array where anything but characters in `chars` string # and alphanumeric chars is percent-encoded.
- `parse_host` (@ `mdurl-0.1.2/src/mdurl/_parse.py`) -> Impact: **7.4** | LOC: 9
- `get_decode_cache` (@ `mdurl-0.1.2/src/mdurl/_decode.py`) -> Impact: **6.5** | LOC: 16
- `url_parse` (@ `mdurl-0.1.2/src/mdurl/_parse.py`) -> Impact: **3.9** | LOC: 8
- `decode` (@ `mdurl-0.1.2/src/mdurl/_decode.py`) -> Impact: **1.9** | LOC: 4
  * *Intent:* # Decode percent-encoded string. #
- `__init__` (@ `mdurl-0.1.2/src/mdurl/_parse.py`) -> Impact: **1.9** | LOC: 9
...
- **Heaviest Functions:** `parse` (Impact: 112.5), `parse_host` (Impact: 7.4), `url_parse` (Impact: 3.9)
...
- **Heaviest Functions:** `repl_func_with_cache` (Impact: 32.7), `get_decode_cache` (Impact: 6.5), `decode` (Impact: 1.9)
...
- **Heaviest Functions:** `encode` (Impact: 32.0), `get_encode_cache` (Impact: 9.5)
...
- **Heaviest Functions:** `format` (Impact: 22.2)
...
**Top Internal Functions/Classes:**
  * `parse` (Impact: 112.5)
  * `parse_host` (Impact: 7.4)
  * `url_parse` (Impact: 3.9)
  * `__init__` (Impact: 1.9)
...
**Top Internal Functions/Classes:**
  * `repl_func_with_cache` (Impact: 32.7)
  * `get_decode_cache` (Impact: 6.5)
  * `decode` (Impact: 1.9)
    * *Intent:* # Decode percent-encoded string. #
**Contextual Mitigations & Amplifications:**
