...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 35.1 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 6033 | 593 | 10 | `tests/test_files/cicsGenApp/copybooks/ssmap.cpy` |
| cleanup | 1194 | 428 | 1 | `tests/test_files/cicsGenApp/positive/lgsetup.cbl` |
| guards | 13148 | 1527 | 11 | `server/engine/src/test/java/org/eclipse/lsp/cobol/usecases/TestCicsSysSetStatement.java` |
| danger | 29957 | 1115 | 28 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2184.2.cbl` |
...
| io | 66082 | 701 | 66 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2154.2.cbl` |
| crypto | 0 | 0 | 0 | - |
| ipc | 972 | 332 | 1 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IC2224.2.cbl` |
| time | 232 | 113 | 0 | `server/engine/src/test/resources/CM101M.CBL` |
...
| credential | 16 | 13 | 0 | `server/dialect-daco/src/main/java/org/eclipse/lsp/cobol/dialects/daco/DaCoMaidProcessor.java` |
| threat | 6557 | 519 | 10 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2524.2.cbl` |
| ml_ai | 708 | 47 | 0 | `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IF1174.2.cbl` |
| ui | 81 | 24 | 0 | `clients/sample-dialect-support/src/statements.ts` |
...
- `definition` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2154.2.cbl`) -> Impact: **628.2** | LOC: 3224
- `checkOptions` (@ `server/engine/src/main/java/org/eclipse/lsp/cobol/implicitDialects/cics/utility/CICSInquireSPOptionsCheckUtility.java`) -> Impact: **305.5** | LOC: 707
...
- `definition` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1084.2.cbl`) -> Impact: **231.6** | LOC: 1771
- `checkOptions` (@ `server/engine/src/main/java/org/eclipse/lsp/cobol/implicitDialects/cics/utility/CICSSysSetOptionsCheckUtility.java`) -> Impact: **202.6** | LOC: 205
...
- `phrase` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2534.2.cbl`) -> Impact: **182.7** | LOC: 2053
- `definition` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1094.2.cbl`) -> Impact: **178.4** | LOC: 1289
- `phrase` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/NC2024.2.cbl`) -> Impact: **173.1** | LOC: 2022
- `definition` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX2054.2.cbl`) -> Impact: **166.3** | LOC: 1127
- `definition` (@ `tests/test_files/Cobol85PositiveTestsSuite/compileListing/IX1054.2.cbl`) -> Impact: **164.9** | LOC: 1079
- `traverse` (@ `server/engine/src/main/java/org/eclipse/lsp/cobol/cfg/CFASTBuilderImpl.java`) -> Impact: **151.6** | LOC: 191
...
- **Heaviest Functions:** `initializeExternalAPIs` (Impact: 31.6), `constructor` (Impact: 20.1), `explorerAppeared` (Impact: 5.6)
...
- **Heaviest Functions:** `provideCompletionItems` (Impact: 13.9), `pickSnippet` (Impact: 6.7), `findPosition` (Impact: 5.7)
...
- **Heaviest Functions:** `postMessage` (Impact: 3.2), `constructor` (Impact: 3.1), `lastWorkerErrorTrigger` (Impact: 3.1)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `provideCompletionItems` (Impact: 34.3), `isDefaultCopyStatement` (Impact: 16.5)
...
- **Heaviest Functions:** `execute` (Impact: 5.3), `constructor` (Impact: 3.0), `generateKey` (Impact: 1.6)
...
- **Heaviest Functions:** `finishTask` (Impact: 39.2), `finishTaskWithError` (Impact: 27.5), `start` (Impact: 21.8)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `provideCompletionItems` (Impact: 30.3)
...
- **Heaviest Functions:** `visitCicsExecBlock` (Impact: 22.2), `getCheckParams` (Impact: 20.8), `visitVariableNameUsage` (Impact: 7.9)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `locked` (Impact: 7.8), `constructor` (Impact: 4.4)
...
- **Heaviest Functions:** `prepareReplacements` (Impact: 26.2), `addCopybook` (Impact: 14.2), `validateCopybookName` (Impact: 8.7)
...
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` (Impact: 8.3)
  * `WRITE-LINE` (Impact: 6.8)
  * `PRINT-DETAIL` (Impact: 5.6)
  * `HEAD-ROUTINE` (Impact: 5.2)
  * `ADD-TEST-F1-19` (Impact: 5.0)
...
**Top Internal Functions/Classes:**
  ...
  * `PRINT-DETAIL` (Impact: 5.6)
  * `HEAD-ROUTINE` (Impact: 5.2)
  * `COLUMN-NAMES-ROUTINE` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `START-TEST-GF-27` (Impact: 25.0)
  * `START-TEST-GF-09` (Impact: 24.9)
  * `START-TEST-GF-18` (Impact: 24.9)
  * `START-TEST-GF-06` (Impact: 19.7)
  * `START-TEST-GF-25` (Impact: 19.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `XXXXX055` (Impact: 74.3)
  * `IF--TEST-71` (Impact: 9.8)
  * `IF--TEST-120` (Impact: 9.8)
  * `IF--TEST-121` (Impact: 9.8)
  * `IF--TEST-47` (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ERROR-HOLD` (Impact: 8.3)
  * `XXXXX055` (Impact: 8.0)
  * `START-TEST-GF-42` (Impact: 7.9)
  * `START-TEST-GF-06` (Impact: 7.7)
  * `START-TEST-GF-24` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `START-TEST-GF-37` (Impact: 9.6)
  * `START-TEST-GF-09` (Impact: 8.4)
  * `START-TEST-GF-27` (Impact: 8.4)
  * `ERROR-HOLD` (Impact: 8.3)
  * `START-TEST-GF-07` (Impact: 8.3)
**Contextual Mitigations & Amplifications:**
...
- `server/dialect-idms/src/main/java/org/eclipse/lsp/cobol/dialects/idms/IdmsDialect.java` -> **Severity: 0.027** (Bridge: 0.0003 * Flux: 95.0734%)
...
- `server/dialect-daco/src/main/java/org/eclipse/lsp/cobol/dialects/daco/DaCoDialect.java` -> **Severity: 0.017** (Bridge: 0.0004 * Flux: 38.9651%)
- `clients/cobol-lsp-vscode-extension/src/services/ExternalAPIsService.ts` -> **Severity: 0.016** (Bridge: 0.0002 * Flux: 99.1837%)
