...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 52.9 | 100.0 | 100.0 |
...
| connectivity | 50495 | 9400 | 5 | `addons/web/static/lib/pdfjs/web/viewer.css` |
...
| dead_code | 32897 | 7215 | 3 | `odoo/addons/test_orm/tests/test_fields.py` |
| credential | 218 | 109 | 0 | `addons/auth_passkey/tests/test_passkey_demo.py` |
| threat | 8629 | 2813 | 1 | `addons/web/static/lib/ace/ace.js` |
...
- `makeActionManager` (@ `addons/web/static/src/webclient/actions/action_service.js`) -> Impact: **668.2** | LOC: 1483
- `findLinkAt` (@ `addons/web/static/lib/ace/ace.js`) -> Impact: **564.2** | LOC: 1238
- `DateTime` (@ `addons/web/static/lib/luxon/luxon.js`) -> Impact: **505.9** | LOC: 2284
...
- `createRelatedModels` (@ `addons/point_of_sale/static/src/app/models/related_models/index.js`) -> Impact: **446.5** | LOC: 890
- `TextInput` (@ `addons/web/static/lib/ace/ace.js`) -> Impact: **431.0** | LOC: 688
- `Lame` (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **413.4** | LOC: 1827
- `PsyModel` (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **380.2** | LOC: 1704
  * *Intent:* */ //package mp3; //import java.util.Arrays;
- `createDOMPurify` (@ `addons/web/static/lib/dompurify/DOMpurify.js`) -> Impact: **366.9** | LOC: 1259
- `Quantize` (@ `addons/mail/static/lib/lame/lame.js`) -> Impact: **345.6** | LOC: 1432
...
- `attachmentThumbnailToLinkImg` (@ `addons/mail/static/src/views/web/fields/html_mail_field/convert_inline.js`) -> Impact: **341.2** | LOC: 941
...
|---|---|---|---|---|
| `addons/account/models` | 52 | 31480.06 | 45.77% | 58.25% |
...
### 1. `addons/web/static/src/core/tree_editor/tree_editor.js` (JAVASCRIPT) -> Cumulative Risk: **777.87**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 193.32 | **LOC:** 233 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.999%)
- **Heaviest Functions:** `onPropsUpdated` (Impact: 10.8), `_delete` (Impact: 5.8), `_addNewCondition` (Impact: 5.6)

### 2. `addons/iot_drivers/webrtc_client.py` (PYTHON) -> Cumulative Risk: **773.55**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 161.94 | **LOC:** 121 | **CtrlFlow:** 12.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9997%)
- **Heaviest Functions:** `_offer` (Impact: 22.8), `on_datachannel` (Impact: 16.9), `on_message` (Impact: 16.5)

### 3. `addons/website/static/src/builder/plugins/customize_website_plugin.js` (JAVASCRIPT) -> Cumulative Risk: **769.45**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 864.6 | **LOC:** 991 | **CtrlFlow:** 16.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), State Flux (99.8386%)
- **Heaviest Functions:** `_toggleTheme` (Impact: 54.8), `prepareRecord` (Impact: 45.7), `customizeWebsiteColors` (Impact: 24.3)

### 4. `addons/iot_drivers/interface.py` (PYTHON) -> Cumulative Risk: **762.56**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 110.28 | **LOC:** 91 | **CtrlFlow:** 31.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (96.4544%)
- **Heaviest Functions:** `add_device` (Impact: 21.3), `update_iot_devices` (Impact: 11.1), `remove_device` (Impact: 7.3)

### 5. `addons/point_of_sale/static/src/app/services/barcode_reader_service.js` (JAVASCRIPT) -> Cumulative Risk: **757.68**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 145.88 | **LOC:** 201 | **CtrlFlow:** 14.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9806%)
- **Heaviest Functions:** `_scan` (Impact: 21.8), `start` (Impact: 12.8), `register` (Impact: 9.4)

### 6. `odoo/service/server.py` (PYTHON) -> Cumulative Risk: **757.27**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1653.58 | **LOC:** 1648 | **CtrlFlow:** 25.4% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Concurrency (98.3369%), Safety Score (97.0197%)
- **Heaviest Functions:** `run` (Impact: 38.9), `start` (Impact: 37.8), `cron_thread` (Impact: 35.0)

### 7. `addons/web/static/src/views/fields/x2many/x2many_field.js` (JAVASCRIPT) -> Cumulative Risk: **754.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 266.98 | **LOC:** 353 | **CtrlFlow:** 14.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `rendererProps` (Impact: 16.1), `setup` (Impact: 16.0), `switchToForm` (Impact: 12.8)

### 8. `addons/website/static/src/builder/website_builder.js` (JAVASCRIPT) -> Cumulative Risk: **748.75**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 177.36 | **LOC:** 286 | **CtrlFlow:** 10.4% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9996%), State Flux (97.9541%)
- **Heaviest Functions:** `builderProps` (Impact: 12.3), `discard` (Impact: 7.9), `setup` (Impact: 7.0)

### 9. `addons/stock/static/src/fields/stock_move_line_x2_many_field.js` (JAVASCRIPT) -> Cumulative Risk: **747.62**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 127.78 | **LOC:** 191 | **CtrlFlow:** 14.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9718%)
- **Heaviest Functions:** `updateDirtyQuantsData` (Impact: 18.1), `onAdd` (Impact: 14.8), `selectRecord` (Impact: 6.8)

### 10. `addons/website/static/src/builder/plugins/options/facebook_option_plugin.js` (JAVASCRIPT) -> Cumulative Risk: **746.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 146.58 | **LOC:** 164 | **CtrlFlow:** 29.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9997%), Concurrency (95.3975%)
- **Heaviest Functions:** `idFromFacebookLink` (Impact: 23.7), `normalize` (Impact: 13.7), `loadAndSetEmptyLink` (Impact: 8.5)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (22.2005%)
**Top Internal Functions/Classes:**
  * `findLinkAt` (Impact: 564.2)
  * `TextInput` (Impact: 431.0)
  * `Folding` (Impact: 267.4)
  * `escapeHTML` (Impact: 196.0)
  * `addTouchListeners` (Impact: 157.2)
...
- **Risk Profile:** Cognitive Load (62.7595%), Tech Debt (67.984%)
**Top Internal Functions/Classes:**
  * `decodeRow` (Impact: 193.9)
  * `decodeTextCompaction` (Impact: 131.8)
    * *Intent:* * (i.e. values from 32 to 126) and three ASCII control characters: HT or tab * (9: e), LF or line fe...
  * `guessEncoding` (Impact: 129.2)
    * *Intent:* /** * @param bytes bytes encoding a string, whose encoding should be guessed * @param hints decode h...
  * `lookAheadTestIntern` (Impact: 101.6)
  * `constructor` (Impact: 98.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (64.9039%), Tech Debt (11.451%)
**Top Internal Functions/Classes:**
  * `Lame` (Impact: 413.4)
  * `PsyModel` (Impact: 380.2)
    * *Intent:* */ //package mp3; //import java.util.Arrays;
  * `Quantize` (Impact: 345.6)
...
- **Risk Profile:** Cognitive Load (73.1874%), Tech Debt (17.5286%)
**Top Internal Functions/Classes:**
  * `drawPointLegend` (Impact: 99.5)
    * *Intent:* // eslint-disable-next-line complexity
  * `_computeLabelItems` (Impact: 93.1)
  * `updateElements` (Impact: 46.6)
  * `generateTicks$1` (Impact: 45.0)
  * `_computeGridLineItems` (Impact: 42.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (81.0473%), Tech Debt (11.5469%)
**Top Internal Functions/Classes:**
  * `onKeyDown` (Impact: 191.9)
  * `constructor` (Impact: 117.7)
  * `setDocument` (Impact: 81.2)
  * `onAfterDraw` (Impact: 65.7)
  * `_getPageAdvance` (Impact: 65.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Risk Profile:** Cognitive Load (79.3314%), Tech Debt (81.0813%)
**Top Internal Functions/Classes:**
  * `constructor` (Impact: 98.6)
  * `getExtendedRtpCapabilities` (Impact: 87.3)
    * *Intent:* /** * Generate extended RTP capabilities for sending and receiving. * * Resulting codecs keep order ...
  * `requireMs` (Impact: 79.2)
  * `parse` (Impact: 79.2)
    * *Intent:* /** * Parse the given `str` and return milliseconds. * * @param {String} str * @return {Number} * @a...
  * `setup` (Impact: 62.3)
...
**Top Internal Functions/Classes:**
  * `clickFieldDropdownItem` (Impact: 102.8)
  * `callback` (Impact: 99.6)
  * `doActionButton` (Impact: 83.1)
  * `extractProps` (Impact: 67.7)
  * `getServerValue` (Impact: 35.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (42.1302%), Tech Debt (9.6962%)
**Top Internal Functions/Classes:**
  * `_export_rows` (Impact: 178.1)
    * *Intent:* """ Export fields of the records in ``self``. :param list fields: list of lists of fields to travers...
  * `read_group` (Impact: 153.9)
    * *Intent:* """Deprecated - Get the list of records in list view grouped by the given ``groupby`` fields. :param...
  * `_read_grouping_sets` (Impact: 152.6)
  * `_read_group_fill_temporal` (Impact: 118.6)
  * `_read_group_format_result_properties` (Impact: 95.3)
...
- **Risk Profile:** Cognitive Load (52.3228%), Tech Debt (37.7917%)
**Top Internal Functions/Classes:**
  * `DateTime` (Impact: 505.9)
    * *Intent:* * * Configuration properties that effect how output strings are formatted, such as `locale`, `number...
  * `Duration` (Impact: 210.8)
    * *Intent:* /** * A Duration object represents a period of time, like "2 months" or "1 day, 1 hour". Conceptuall...
  * `Interval` (Impact: 171.6)
    * *Intent:* /** * An Interval object represents a half-open interval of time, where each endpoint is a {@link Da...
  * `formatDateTimeFromString` (Impact: 167.4)
  * `Formatter` (Impact: 140.5)
    * *Intent:* /** * @private */
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (60.6391%), Tech Debt (71.1779%)
**Top Internal Functions/Classes:**
  * `_post` (Impact: 157.1)
    * *Intent:* """Post/Validate the documents. Posting the documents will give it a number, and check that the docu...
  * `_sync_tax_lines` (Impact: 115.8)
  * `write` (Impact: 114.3)
  * `_sync_dynamic_line` (Impact: 105.3)
  * `_prepare_invoice_aggregated_taxes` (Impact: 71.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `name` (Impact: 44.4)
  * `p` (Impact: 40.2)
  * `doActionButton` (Impact: 35.0)
  * `getServerValue` (Impact: 31.8)
  * `add` (Impact: 16.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (96.999%), Tech Debt (21.51%)
**Top Internal Functions/Classes:**
  * `compileTDomNode` (Impact: 120.1)
  * `parseDOMNode` (Impact: 80.2)
  * `parseComponent` (Impact: 78.8)
  * `buildTree` (Impact: 72.9)
  * `compileComponent` (Impact: 65.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (45.0452%)
**Top Internal Functions/Classes:**
  * `clipRectangle` (Impact: 130.8)
    * *Intent:* // TODO Use d3-polygon’s polygonContains here for the ring check? // TODO Eliminate duplicate buffer...
  * `clipLine` (Impact: 106.1)
  * `clipCircle` (Impact: 77.8)
  * `clipRejoin` (Impact: 55.1)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `selectRecord` (Impact: 127.5)
  * `selectRecord` (Impact: 67.7)
  * `createRecord` (Impact: 63.5)
  * `createRecord` (Impact: 55.9)
  * `createRecord` (Impact: 29.7)
**Contextual Mitigations & Amplifications:**
...
- `odoo/http.py` -> **Severity: 0.005** (Bridge: 0.0 * Flux: 100.0%)
- `odoo/tools/misc.py` -> **Severity: 0.005** (Bridge: 0.0001 * Flux: 100.0%)
