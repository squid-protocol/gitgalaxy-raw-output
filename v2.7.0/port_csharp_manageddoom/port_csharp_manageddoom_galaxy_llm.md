...
- `DrawPassWallRange` (@ `ManagedDoom/src/Video/ThreeDRenderer.cs`) -> Impact: **220.5** | LOC: 491
- `ToString` (@ `ManagedDoom/src/UserInput/DoomKeyEx.cs`) -> Impact: **157.6** | LOC: 210
- `Parse` (@ `ManagedDoom/src/UserInput/DoomKeyEx.cs`) -> Impact: **157.6** | LOC: 210
- `SilkToDoom` (@ `ManagedDoom/src/Silk/SilkUserInput.cs`) -> Impact: **150.6** | LOC: 128
- `DoomToSilk` (@ `ManagedDoom/src/Silk/SilkUserInput.cs`) -> Impact: **145.4** | LOC: 108
- `GetChar` (@ `ManagedDoom/src/UserInput/DoomKeyEx.cs`) -> Impact: **97.0** | LOC: 130
- `DoLocalDoor` (@ `ManagedDoom/src/Doom/World/SectorAction.cs`) -> Impact: **96.3** | LOC: 160
...
- **Heaviest Functions:** `SendEvents` (Impact: 56.1), `ReadSingleEvent` (Impact: 27.4), `OnGetData` (Impact: 14.7)
...
- **Heaviest Functions:** `CheckAmmo` (Impact: 38.4), `RecursiveSound` (Impact: 29.5), `WeaponReady` (Impact: 14.7)
...
- **Heaviest Functions:** `RenderGame` (Impact: 26.6), `GetPaletteNumber` (Impact: 18.1), `Render` (Impact: 15.6)
...
- **Heaviest Functions:** `CheckFunctionKey` (Impact: 51.3), `Update` (Impact: 28.5), `Doom` (Impact: 19.5)
...
- **Heaviest Functions:** `Update` (Impact: 62.3), `OpeningSequence` (Impact: 4.4), `StartTitleScreen` (Impact: 3.7)
...
- **Heaviest Functions:** `BossDeath` (Impact: 80.8), `NewChaseDir` (Impact: 54.0), `SpawnFly` (Impact: 38.2)
...
- **Heaviest Functions:** `DoEvent` (Impact: 68.7), `Update` (Impact: 20.3), `AutoMap` (Impact: 11.0)
...
- **Heaviest Functions:** `SilkToDoom` (Impact: 150.6), `DoomToSilk` (Impact: 145.4), `BuildTicCmd` (Impact: 49.8)
...
- **Heaviest Functions:** `UpdateCast` (Impact: 71.8), `Finale` (Impact: 67.1), `Update` (Impact: 16.1)
...
- **Heaviest Functions:** `LoadThings` (Impact: 18.8), `DoEvent` (Impact: 14.7), `World` (Impact: 13.8)
...
**Top Internal Functions/Classes:**
  * `DrawPassWallRange` (Impact: 220.5)
  * `DrawSprite` (Impact: 70.2)
  * `DrawSolidWallRange` (Impact: 56.0)
  * `DrawPlayerSprite` (Impact: 37.5)
  * `ProjectSprite` (Impact: 35.9)
...
**Top Internal Functions/Classes:**
  * `BossDeath` (Impact: 80.8)
  * `NewChaseDir` (Impact: 54.0)
  * `SpawnFly` (Impact: 38.2)
  * `Chase` (Impact: 37.3)
  * `Look` (Impact: 30.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ArchiveSpecials` (Impact: 40.9)
  * `ArchivePlayer` (Impact: 35.4)
  * `UnArchiveSpecials` (Impact: 33.9)
  * `UnArchivePlayer` (Impact: 21.3)
  * `UnArchiveThinkers` (Impact: 18.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `UpdateNetGameStats` (Impact: 59.6)
  * `UpdateSinglePlayerStats` (Impact: 32.9)
  * `UpdateDeathmatchStats` (Impact: 32.9)
  * `Update` (Impact: 22.1)
    * *Intent:* //////////////////////////////////////////////////////////// // Update /////////////////////////////...
  * `Intermission` (Impact: 12.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `SilkToDoom` (Impact: 150.6)
  * `DoomToSilk` (Impact: 145.4)
  * `BuildTicCmd` (Impact: 49.8)
  * `IsPressed` (Impact: 11.5)
  * `SilkUserInput` (Impact: 6.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `UpdateCast` (Impact: 71.8)
  * `Finale` (Impact: 67.1)
  * `Update` (Impact: 16.1)
  * `BunnyScroll` (Impact: 8.8)
  * `DoEvent` (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `SendEvents` (Impact: 56.1)
  * `ReadSingleEvent` (Impact: 27.4)
  * `OnGetData` (Impact: 14.7)
  * `ReadData` (Impact: 13.7)
  * `ReadSingleEventGroup` (Impact: 10.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `SilkSound` (Impact: 17.1)
  * `Update` (Impact: 16.4)
  * `SetParam` (Impact: 14.1)
  * `GetPitch` (Impact: 13.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `DoCompleted` (Impact: 50.0)
  * `InitNew` (Impact: 17.8)
    * *Intent:* //////////////////////////////////////////////////////////// // Miscellaneous things ///////////////...
  * `DoReborn` (Impact: 12.4)
  * `DoEvent` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 64 instances
...
**Top Internal Functions/Classes:**
  * `ProcessBlock` (Impact: 54.5)
  * `GetBlockType` (Impact: 38.1)
  * `ProcessBexStringsBlock` (Impact: 14.8)
  * `ProcessBexParsBlock` (Impact: 14.6)
  * `ProcessLines` (Impact: 13.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `PlayerThink` (Impact: 57.1)
    * *Intent:* //////////////////////////////////////////////////////////// // Player movement ////////////////////...
  * `PlayerInSpecialSector` (Impact: 36.2)
...
**Top Internal Functions/Classes:**
  * `CheckFunctionKey` (Impact: 51.3)
  * `Update` (Impact: 28.5)
  * `Doom` (Impact: 19.5)
  * `DoEvents` (Impact: 17.1)
  * `CheckGameArgs` (Impact: 16.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `NightmareTest` (Impact: 5.5)
  * `BarrelTest` (Impact: 5.5)
  * `ZombiemanTest` (Impact: 5.5)
  * `ZombiemanTest2` (Impact: 5.5)
  * `ShotgunguyTest` (Impact: 5.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `Render` (Impact: 18.4)
  * `DrawSuitablePatch` (Impact: 17.7)
  * `DrawDeathmatchStats` (Impact: 17.5)
  * `DrawTime` (Impact: 15.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Render` (Impact: 31.8)
  * `DrawNumber` (Impact: 18.9)
  * `Patches` (Impact: 12.5)
  * `StatusBarRenderer` (Impact: 6.0)
  * `DrawPercent` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `DoPowerUp` (Impact: 21.0)
  * `CheckBuffer` (Impact: 12.2)
  * `ChangeMusic` (Impact: 10.0)
  * `ChangeLevel` (Impact: 9.9)
  * `GiveWeapons` (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
