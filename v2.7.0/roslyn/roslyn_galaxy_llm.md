...
| Analyzed Artifacts (Scanned) | 14430 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 6211 |
| Total LOC | 4055105 |
...
| Assortativity | -0.238 | Positive = Resilient core. Negative = Fragile single-points-of-failure. |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 15.5 | 1.6 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 70637 | 3721 | 3 | `src/Compilers/CSharp/Test/Semantic/Semantics/NativeIntegerTests.cs` |
| cleanup | 3843 | 1051 | 0 | `src/ExpressionEvaluator/CSharp/Test/ExpressionCompiler/LocalsTests.cs` |
| guards | 255882 | 13210 | 36 | `src/Compilers/CSharp/Test/Syntax/Parsing/ParsingErrorRecoveryTests.cs` |
| danger | 33822 | 3601 | 3 | `src/Compilers/CSharp/Test/WinRT/Metadata/WinMdEventTests.cs` |
| concurrency | 112160 | 4325 | 14 | `src/Compilers/CSharp/Test/Emit/CodeGen/CodeGenAsyncSpillTests.cs` |
| connectivity | 281666 | 13908 | 31 | `src/Compilers/CSharp/Test/Symbol/Symbols/SymbolErrorTests.cs` |
...
| serialization | 103 | 50 | 0 | `src/Compilers/CSharp/Test/Semantic/Semantics/DynamicTests.cs` |
| regex | 301 | 71 | 0 | `.github/skills/vmr-codeflow-status/scripts/Get-CodeflowStatus.ps1` |
| events | 14794 | 1461 | 1 | `src/Compilers/CSharp/Test/Emit3/Symbols/UserDefinedCompoundAssignmentOperatorsTests.cs` |
| tests | 149005 | 2352 | 11 | `src/Compilers/CSharp/Test/Symbol/Compilation/SemanticModelGetSemanticInfoTests.cs` |
| docs | 125283 | 5810 | 20 | `src/Compilers/CSharp/Portable/Compilation/CSharpSemanticModel.cs` |
| debt | 38848 | 1969 | 1 | `src/Compilers/CSharp/Test/CSharp15/UnionsTests.cs` |
| mutation | 640652 | 11196 | 81 | `src/Features/CSharpTest/EditAndContinue/TopLevelEditingTests.cs` |
| dead_code | 128658 | 10178 | 15 | `src/Compilers/CSharp/Test/Symbol/Symbols/SymbolErrorTests.cs` |
| credential | 461 | 64 | 0 | `src/Compilers/CSharp/Test/Emit/CodeGen/CodeGenReadOnlySpanConstructionTest.cs` |
| threat | 4542 | 1271 | 0 | `src/Compilers/CSharp/Test/Emit3/Attributes/InternalsVisibleToAndStrongNameTests.cs` |
...
4. **Metadata.cs** (`src/Compilers/Core/Portable/MetadataReference/Metadata.cs`) — 286 inbound connections
...
- `IsBuildOnlyDiagnostic` (@ `src/Compilers/CSharp/Portable/Errors/ErrorFacts.cs`) -> Impact: **1328.5** | LOC: 917
...
- `Parse` (@ `src/Compilers/CSharp/Portable/CommandLine/CSharpCommandLineParser.cs`) -> Impact: **1039.1** | LOC: 1150
...
- `VisitConversion` (@ `src/Compilers/CSharp/Portable/FlowAnalysis/NullableWalker.cs`) -> Impact: **867.3** | LOC: 620
...
- `AnalyzeSemanticsAsync` (@ `src/Features/Core/Portable/EditAndContinue/AbstractEditAndContinueAnalyzer.cs`) -> Impact: **838.2** | LOC: 1013
- `GetFlowGraph` (@ `src/Compilers/Test/Core/Compilation/ControlFlowGraphVerifier.cs`) -> Impact: **620.5** | LOC: 1039
- `MakeBinaryOperator` (@ `src/Compilers/CSharp/Portable/Lowering/LocalRewriter/LocalRewriter_BinaryOperator.cs`) -> Impact: **557.8** | LOC: 348
- `GetWarningLevel` (@ `src/Compilers/CSharp/Portable/Errors/ErrorFacts.cs`) -> Impact: **508.5** | LOC: 384
- `IsWarning` (@ `src/Compilers/CSharp/Portable/Generated/ErrorFacts.Generated.cs`) -> Impact: **505.5** | LOC: 351
- `EmitNumericConversion` (@ `src/Compilers/Core/Portable/CodeGen/ILBuilderConversions.cs`) -> Impact: **501.1** | LOC: 343
- `DoUncheckedConversion` (@ `src/Compilers/CSharp/Portable/Binder/Binder_Conversions.cs`) -> Impact: **408.3** | LOC: 302

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `src/Compilers/CSharp/Test/Emit/CodeGen` | 71 | 740802.11 | 19.03% | 0.0% |
| `src/Compilers/CSharp/Test/Emit3` | 7 | 646401.71 | 21.28% | 0.0% |
| `src/Compilers/CSharp/Test/Emit3/Semantics` | 21 | 226061.96 | 15.96% | 0.0% |
| `src/Compilers/CSharp/Test/Emit2/CodeGen` | 4 | 132784.49 | 7.04% | 0.0% |
...
- `src/EditorFeatures/CSharpTest/QuickInfo/SemanticQuickInfoSourceTests.cs` -> **501** Orphaned Functions | **50** Duplicates
...
- **Unknown Dependencies:** `84108` packages imported that bypass the Zero-Trust whitelist.

## 11. CUMULATIVE RISK HITLIST (Top 10 Highest Risk Files)
> Cumulative Risk is the sum of all individual risk exposures. These files represent the highest multi-dimensional technical debt and architectural fragility.

### 1. `src/VisualStudio/CSharp/Impl/SemanticSearch/SemanticSearchQueryExecutor.cs` (CSHARP) -> Cumulative Risk: **798.79**
...
- **Heaviest Functions:** `ExecuteAsync` (Impact: 19.1), `ReportTelemetry` (Impact: 12.4), `GetUpdatedSolutionAsync` (Impact: 8.3)

### 2. `src/Features/Core/Portable/CodeFixes/Suppression/AbstractSuppressionCodeFixProvider.cs` (CSHARP) -> Cumulative Risk: **788.92**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `GetSuppressionsAsync` (Impact: 40.1), `GetSuppressionTargetInfoAsync` (Impact: 26.1), `GetScopeString` (Impact: 13.7)

### 3. `src/Features/Core/Portable/Completion/Providers/ImportCompletionProvider/AbstractImportCompletionProvider.cs` (CSHARP) -> Cumulative Risk: **775.07**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `GetChangeAsync` (Impact: 15.5), `GetImportedNamespaces` (Impact: 10.1), `ProvideCompletionsAsync` (Impact: 7.0)
...
- **Heaviest Functions:** `ShowHotReloadDialog` (Impact: 31.2), `ShowMessageBox` (Impact: 11.6), `QueryService` (Impact: 6.8)

### 5. `src/VisualStudio/Core/Impl/ProjectSystem/CPS/CPSProject_IWorkspaceProjectContext.cs` (CSHARP) -> Cumulative Risk: **759.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `SetProperty` (Impact: 35.8), `CPSProject` (Impact: 10.5), `GetAbsolutePath` (Impact: 6.6)

### 6. `src/LanguageServer/Protocol/RoslynLanguageServer.cs` (CSHARP) -> Cumulative Risk: **756.54**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `TryGetLanguageForRequest` (Impact: 29.9), `GetBaseServices` (Impact: 28.9), `AddBaseService` (Impact: 13.0)

### 7. `src/VisualStudio/Xaml/Impl/Features/InlineRename/XamlEditorInlineRenameService.cs` (CSHARP) -> Cumulative Risk: **751.74**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `FromSymbolKind` (Impact: 15.2), `GetReplacementsAsync` (Impact: 4.7), `GetReplacements` (Impact: 3.0)

### 8. `src/LanguageServer/Microsoft.CodeAnalysis.LanguageServer.UnitTests/Utilities/AbstractLanguageServerClientTests.TestLspClient.cs` (CSHARP) -> Cumulative Risk: **750.88**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `CreateAsync` (Impact: 33.3), `CreateLspStartInfo` (Impact: 13.3), `ApplyWorkspaceEdit` (Impact: 8.4)

### 9. `src/LanguageServer/Protocol.TestUtilities/LanguageServer/AbstractLanguageServerProtocolTests.cs` (CSHARP) -> Cumulative Risk: **750.66**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `CreateWorkspaceAsync` (Impact: 19.0), `CreateCompletionItemAsync` (Impact: 13.8), `CompareLocations` (Impact: 9.4)

### 10. `src/Features/CSharpTest/GenerateFromMembers/AddConstructorParametersFromMembers/AddConstructorParametersFromMembersTests.cs` (CSHARP) -> Cumulative Risk: **744.16**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `TestMultipleConstructors_OneMustBeOptional2` (Impact: 7.5), `TestAddMultipleParametersWithWrapping` (Impact: 3.9), `TestPartialClass2` (Impact: 3.8)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 175515.35 | **LOC:** 15181 | **CtrlFlow:** 3.0% | **Authorship Centralization:** 60.0%
...
* *Risk/State:* `safety_bypasses: 4`, `state_mutation: 453`, `dead_code: 13`, `planned_debt: 9`
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 70410.27 | **LOC:** 15189 | **CtrlFlow:** 1.3% | **Authorship Centralization:** 66.7%
...
* *Risk/State:* `safety_bypasses: 151`, `state_mutation: 814`, `dead_code: 5`
...
### `src/Compilers/CSharp/Test/Emit2/CodeGen/CodeGenSpanBasedStringConcatTests.cs` (CSHARP | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 56119.83 | **LOC:** 5907 | **CtrlFlow:** 4.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (7.3989%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
* *State Mutation (weighted view):* 32
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 240`, `structural_boundaries: 944`, `args: 480`, `func_start: 472`, `class_start: 186`
* *Risk/State:* `state_mutation: 26`
* *Architecture:* `api: 348`, `concurrency: 66`, `import: 63`
* *Defense:* `safety: 6`, `immutability_locks: 239`
* *Network Topology:*
  * `Ecosystem Role:` Isolated/Orphan | `Dependency Blast Radius (PageRank):` 0.053
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 0):` Microsoft.CodeAnalysis.CSharp.Test.Utilities, Microsoft.CodeAnalysis.Test.Utilities, Roslyn.Test.Utilities, System, System.Threading.Tasks, Xunit
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
### `src/Compilers/CSharp/Test/Emit2/Emit/LocalStateTracing/LocalStateTracingTests.cs` (CSHARP | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 18269.33 | **LOC:** 7449 | **CtrlFlow:** 1.2% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (8.4563%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 82`, `structural_boundaries: 646`, `args: 346`, `func_start: 341`, `class_start: 90`
* *Risk/State:* `safety_bypasses: 23`, `state_mutation: 163`, `dead_code: 2`, `planned_debt: 7`
* *Architecture:* `api: 162`, `concurrency: 93`, `import: 46`
* *Defense:* `safety: 172`, `doc: 4`, `test: 60`, `sync_locks: 1`, `immutability_locks: 84`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.053
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` Microsoft.CodeAnalysis.CSharp.EditAndContinue.UnitTests, Microsoft.CodeAnalysis.CSharp.Symbols, Microsoft.CodeAnalysis.CSharp.Test.Utilities, Microsoft.CodeAnalysis.Emit, Microsoft.CodeAnalysis.Test.Utilities, Roslyn.Test.Utilities, System, System.Collections...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `VisitConversion` (Impact: 867.3)
    * *Intent:* /// If <see langword="true"/>, the incoming conversion is assumed to be from binding /// and will be...
  * `VisitArgumentsCore` (Impact: 228.4)
  * `Scan` (Impact: 183.1)
  * `visitArgumentsCore` (Impact: 181.6)
  * `TrackNullableStateOfTupleConversion` (Impact: 150.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ParseNamespaceBodyWorker` (Impact: 183.3)
  * `ParseVariableDeclarator` (Impact: 179.8)
  * `GetPrecedence` (Impact: 153.6)
  * `ParsePrimaryExpression` (Impact: 140.9)
  * `ParseMemberDeclarationOrStatementCore` (Impact: 113.3)
...
### `src/Compilers/CSharp/Test/Emit/CodeGen/CodeGenAsyncEHTests.cs` (CSHARP | Tier 2 | AI Safe: 0.0%)
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 8969.33 | **LOC:** 4981 | **CtrlFlow:** 0.9% | **Authorship Centralization:** 66.7%
- **Risk Profile:** Cognitive Load (80.1786%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 191 instances
* *Amplified Cascading Flux:* 19 instances
* *Concurrency (weighted view):* 1390
* *State Mutation (weighted view):* 258
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 41`, `structural_boundaries: 464`, `args: 200`, `func_start: 159`, `class_start: 38`
* *Risk/State:* `safety_bypasses: 19`, `state_mutation: 220`, `dead_code: 2`
* *Architecture:* `api: 62`, `concurrency: 435`, `import: 79`
* *Defense:* `safety: 317`, `test: 25`, `sync_locks: 16`, `immutability_locks: 28`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 0.053
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
  * `Imports (Out-Degree: 1):` Microsoft.CodeAnalysis.CSharp.Test.Utilities, Microsoft.CodeAnalysis.Test.Utilities, Roslyn.Test.Utilities, Roslyn.Utilities, System, System.Collections.Generic, System.Console, System.Diagnostics...
  * `Imported By (In-Degree: 0):` None (Orphan / Entrypoint)
...
**Top Internal Functions/Classes:**
  * `BindExpressionInternal` (Impact: 275.1)
  * `bindExpressionInternal` (Impact: 269.7)
  * `CheckAndCoerceArguments` (Impact: 238.9)
    * *Intent:* #nullable enable
  * `ResolveExtension` (Impact: 208.4)
    * *Intent:* #nullable enable
  * `BindMemberAccessWithBoundLeft` (Impact: 144.6)
...
**Top Internal Functions/Classes:**
  * `NonBoxingUnionMatching_56_TryGetValue` (Impact: 59.0)
  * `NonBoxingUnionMatching_55_TryGetValue` (Impact: 54.6)
  * `NonBoxingUnionMatching_54_TryGetValue` (Impact: 48.1)
  * `NonBoxingUnionMatching_53_TryGetValue` (Impact: 42.4)
  * `Exhaustiveness_01` (Impact: 39.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `ParameterCapturing_055_ColorColor_Query_Method` (Impact: 70.6)
  * `Handle` (Impact: 48.6)
  * `Handle` (Impact: 48.0)
  * `Handle11` (Impact: 48.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `DefaultLiteral_ReturningAsync` (Impact: 35.7)
  * `ObjectCreation_ReturningAsync` (Impact: 34.3)
  * `Local_ReturningAsync` (Impact: 32.6)
  * `Conditional_ReturningAsync` (Impact: 31.1)
  * `Cast_ReturningAsync` (Impact: 28.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CS0464WRN_CmpAlwaysFalse` (Impact: 90.2)
  * `CS0472WRN_NubExprIsConstBool` (Impact: 37.7)
  * `CS0458WRN_AlwaysNull` (Impact: 35.6)
  * `CS1720WRN_DotOnDefault02` (Impact: 33.6)
  * `CS0165ERR_UseDefViolation03` (Impact: 33.1)
**Contextual Mitigations & Amplifications:**
...
- `src/Compilers/CSharp/Portable/Errors/ErrorFacts.cs` -> Churn: **74.01%** | Cog Load: 55.4798% | Debt: 10.87%
- `src/LanguageServer/Microsoft.CodeAnalysis.LanguageServer/FileBasedPrograms/FileBasedProgramsProjectSystem.cs` -> Churn: **73.88%** | Cog Load: 52.0215% | Debt: 46.1017%
- `src/LanguageServer/Microsoft.CodeAnalysis.LanguageServer/HostWorkspace/LanguageServerProjectSystem.cs` -> Churn: **67.93%** | Cog Load: 93.5253% | Debt: 74.4868%
- `src/Workspaces/CoreTestUtilities/Workspaces/TestWorkspace`1.cs` -> Churn: **65.89%** | Cog Load: 25.8807% | Debt: 93.4119%
- `src/LanguageServer/Protocol.TestUtilities/LanguageServer/AbstractLanguageServerProtocolTests.cs` -> Churn: **65.6%** | Cog Load: 59.8434% | Debt: 93.2821%
...
- `src/Compilers/CSharp/Test/Emit2/Emit/LocalStateTracing/LocalStateTracingTests.cs` -> **Fred Silberberg** (100.0% isolated ownership) | Magnitude: 18269.33
...
- `src/Tools/ExternalAccess/Razor/Features/Cohost/Handlers/Diagnostics.cs` -> **Severity: 14413.6** (Blast Radius: 144.136 * Doc Risk: 100.0%)
- `src/Tools/ExternalAccess/Razor/Features/Cohost/Handlers/CodeActions.cs` -> **Severity: 2298.9** (Blast Radius: 22.989 * Doc Risk: 100.0%)
- `src/Tools/ExternalAccess/Razor/Features/Cohost/Handlers/Completion.cs` -> **Severity: 613.0** (Blast Radius: 6.13 * Doc Risk: 100.0%)
- `src/Tools/ExternalAccess/Razor/Features/Cohost/Handlers/Rename.cs` -> **Severity: 185.8** (Blast Radius: 1.858 * Doc Risk: 100.0%)
- `src/Compilers/Core/Portable/MetadataReference/Metadata.cs` -> **Severity: 182.78** (Blast Radius: 9.139 * Doc Risk: 20.0%)
