...
- `P_UseSpecialLine` (@ `linuxdoom-1.10/p_switch.c`) -> Impact: **262.9** | LOC: 379
  * *Intent:* // // P_UseSpecialLine // Called when a thing uses a special line. // Only the front sides of lines are usable. //
- `P_TouchSpecialThing` (@ `linuxdoom-1.10/p_inter.c`) -> Impact: **180.7** | LOC: 324
  * *Intent:* // // P_TouchSpecialThing //
- `M_Responder` (@ `linuxdoom-1.10/m_menu.c`) -> Impact: **164.1** | LOC: 368
  * *Intent:* // // CONTROL PANEL // // // M_Responder //
- `R_StoreWallRange` (@ `linuxdoom-1.10/r_segs.c`) -> Impact: **138.1** | LOC: 372
  * *Intent:* // // R_StoreWallRange // A wall segment will be drawn // between start and stop pixels (inclusive). //
- `ST_Responder` (@ `linuxdoom-1.10/st_stuff.c`) -> Impact: **99.5** | LOC: 209
  * *Intent:* // Respond to keyboard input events, // intercept cheats.
- `D_DoomMain` (@ `linuxdoom-1.10/d_main.c`) -> Impact: **96.8** | LOC: 376
  * *Intent:* // // D_DoomMain //
- `G_BuildTiccmd` (@ `linuxdoom-1.10/g_game.c`) -> Impact: **94.9** | LOC: 201
...
- `P_DamageMobj` (@ `linuxdoom-1.10/p_inter.c`) -> Impact: **94.4** | LOC: 144
...
- `EV_VerticalDoor` (@ `linuxdoom-1.10/p_doors.c`) -> Impact: **83.6** | LOC: 147
  * *Intent:* // // EV_VerticalDoor : open a door manually, no tag value //
- `T_MovePlane` (@ `linuxdoom-1.10/p_floor.c`) -> Impact: **81.9** | LOC: 156
...
- **Heaviest Functions:** `addsfx` (Impact: 50.6), `I_UpdateSound` (Impact: 20.8), `I_InitSound` (Impact: 17.4)
...
- **Heaviest Functions:** `A_BossDeath` (Impact: 71.0), `P_NewChaseDir` (Impact: 54.4), `A_Chase` (Impact: 50.5)
...
- **Heaviest Functions:** `M_LoadDefaults` (Impact: 21.2), `M_DrawText` (Impact: 17.3), `WritePCXfile` (Impact: 15.1)
...
- **Heaviest Functions:** `Z_Malloc` (Impact: 35.4), `Z_DumpHeap` (Impact: 17.3), `Z_Free` (Impact: 12.4)
...
- **Heaviest Functions:** `R_FillBackScreen` (Impact: 15.1), `R_DrawFuzzColumn` (Impact: 14.2), `R_DrawTranslatedColumn` (Impact: 10.2)
...
- **Heaviest Functions:** `R_MakeSpans` (Impact: 23.5), `R_MapPlane` (Impact: 22.9), `R_CheckPlane` (Impact: 19.0)
...
- **Heaviest Functions:** `EV_LightTurnOn` (Impact: 14.0), `EV_TurnTagLightsOff` (Impact: 9.9), `T_Glow` (Impact: 9.7)
...
- **Heaviest Functions:** `S_StartSoundAtVolume` (Impact: 65.1), `S_StartSound` (Impact: 32.9), `S_AdjustSoundParams` (Impact: 30.3)
...
- **Heaviest Functions:** `W_AddFile` (Impact: 19.9), `W_ReadLump` (Impact: 14.0), `W_Profile` (Impact: 13.7)
...
**Top Internal Functions/Classes:**
  ...
  * `WI_loadData` (Impact: 30.5)
  * `WI_drawOnLnode` (Impact: 23.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `AM_Responder` (Impact: 72.6)
    * *Intent:* // // Handle events (user inputs) in automap mode //
  * `AM_clipMline` (Impact: 66.9)
...
**Top Internal Functions/Classes:**
  ...
  * `P_ZMovement` (Impact: 44.8)
    * *Intent:* // // P_ZMovement //
  * `P_SpawnMapThing` (Impact: 41.3)
...
**Top Internal Functions/Classes:**
  * `I_InitGraphics` (Impact: 47.2)
  * `xlatekey` (Impact: 44.3)
    * *Intent:* // // Translates the key currently in X_event //
  * `I_FinishUpdate` (Impact: 33.5)
    * *Intent:* // // I_FinishUpdate //
  * `I_GetEvent` (Impact: 32.3)
  * `grabsharedmemory` (Impact: 30.3)
...
**Top Internal Functions/Classes:**
  * `PIT_CheckThing` (Impact: 32.9)
    * *Intent:* // // PIT_CheckThing //
  * `PTR_ShootTraverse` (Impact: 32.8)
...
**Top Internal Functions/Classes:**
  ...
  * `ST_doPaletteStuff` (Impact: 15.7)
  * `ST_updateWidgets` (Impact: 15.2)
  * `ST_drawWidgets` (Impact: 10.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `PIT_AddLineIntercepts` (Impact: 18.0)
...
**Top Internal Functions/Classes:**
  * `TryRunTics` (Impact: 39.6)
  * `D_ArbitrateNetStart` (Impact: 24.6)
    * *Intent:* // // D_ArbitrateNetStart //
  * `GetPackets` (Impact: 21.9)
  * `HGetPacket` (Impact: 18.1)
    * *Intent:* // // HGetPacket // Returns false if no packet is waiting //
  * `NetUpdate` (Impact: 16.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 146 instances
* *State Mutation (weighted view):* 441
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `R_DrawColumnInCache` (Impact: 12.9)
