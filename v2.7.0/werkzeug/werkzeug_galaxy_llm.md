...
| Avg Path Length | 3.2048 | Hops between files. Lower = Tighter coupling. |
...
- `send_file` (@ `werkzeug-3.1.8/src/werkzeug/utils.py`) -> Impact: **158.7** | LOC: 217
- `match` (@ `werkzeug-3.1.8/src/werkzeug/routing/matcher.py`) -> Impact: **121.8** | LOC: 134
- `match` (@ `werkzeug-3.1.8/src/werkzeug/routing/map.py`) -> Impact: **82.7** | LOC: 173
- `build` (@ `werkzeug-3.1.8/src/werkzeug/routing/map.py`) -> Impact: **78.6** | LOC: 101
- `_match` (@ `werkzeug-3.1.8/src/werkzeug/routing/matcher.py`) -> Impact: **76.4** | LOC: 88
- `dump_cookie` (@ `werkzeug-3.1.8/src/werkzeug/http.py`) -> Impact: **76.2** | LOC: 153
- `__init__` (@ `werkzeug-3.1.8/src/werkzeug/serving.py`) -> Impact: **71.1** | LOC: 102
- `is_resource_modified` (@ `werkzeug-3.1.8/src/werkzeug/sansio/http.py`) -> Impact: **70.3** | LOC: 77
- `proxy_to` (@ `werkzeug-3.1.8/src/werkzeug/middleware/http_proxy.py`) -> Impact: **66.4** | LOC: 121
- `_compile_builder` (@ `werkzeug-3.1.8/src/werkzeug/routing/rules.py`) -> Impact: **58.6** | LOC: 99
...
- **Heaviest Functions:** `pop` (Impact: 10.7), `update` (Impact: 6.5), `setdefault` (Impact: 6.3)
...
- **Heaviest Functions:** `to_header` (Impact: 11.0), `from_header` (Impact: 8.4), `__setitem__` (Impact: 8.4)
...
- **Heaviest Functions:** `range_for_length` (Impact: 12.9), `__init__` (Impact: 12.6), `to_header` (Impact: 8.9)
...
- **Heaviest Functions:** `_find_stat_paths` (Impact: 19.8), `_get_args_for_reloading` (Impact: 18.9), `__init__` (Impact: 14.2)
...
- **Heaviest Functions:** `_value_matches` (Impact: 31.9), `best_match` (Impact: 21.4), `best_match` (Impact: 18.4)
...
- **Heaviest Functions:** `match` (Impact: 121.8), `_match` (Impact: 76.4), `add` (Impact: 12.9)
...
- **Heaviest Functions:** `__init__` (Impact: 13.1), `to_python` (Impact: 12.6), `__init__` (Impact: 6.0)
...
- **Heaviest Functions:** `__init__` (Impact: 20.6), `__eq__` (Impact: 16.8), `iter_multi_items` (Impact: 12.4)
...
- **Heaviest Functions:** `next_event` (Impact: 50.9), `_parse_data` (Impact: 37.6), `send_event` (Impact: 29.3)
...
- **Heaviest Functions:** `__init__` (Impact: 71.1), `run_wsgi` (Impact: 45.5), `run_simple` (Impact: 45.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000239 | `Ripple Effect (Closeness):` 0.015957
...
**Top Internal Functions/Classes:**
  * `test_basic_routing` (Impact: 22.6)
  * `test_path` (Impact: 19.9)
  * `test_strict_slashes_redirect` (Impact: 17.6)
  * `test_merge_slashes_match` (Impact: 14.1)
  * `test_complex_routing_rules` (Impact: 14.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `run_wsgi` (Impact: 45.5)
  * `run_simple` (Impact: 45.4)
  * `make_environ` (Impact: 26.6)
  * `make_server` (Impact: 21.1)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003847 | `Ripple Effect (Closeness):` 0.085106
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000941 | `Ripple Effect (Closeness):` 0.053635
...
**Top Internal Functions/Classes:**
  * `_compile_builder` (Impact: 58.6)
  * `__init__` (Impact: 47.8)
  * `_parse_rule` (Impact: 46.2)
  * `suitable_for` (Impact: 25.6)
...
**Top Internal Functions/Classes:**
  * `match` (Impact: 82.7)
  * `build` (Impact: 78.6)
  * `bind_to_environ` (Impact: 45.6)
  * `_partial_build` (Impact: 26.5)
  * `bind` (Impact: 24.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_basic_interface` (Impact: 10.4)
  * `test_mime_accept` (Impact: 7.5)
  * `test_pickle` (Impact: 6.9)
  * `test_ordered_interface` (Impact: 6.1)
  * `create_instance` (Impact: 4.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_new_response_iterator_behavior` (Impact: 4.8)
  * `test_base_response` (Impact: 4.3)
  * `test_common_response_descriptors` (Impact: 4.3)
  * `test_base_request` (Impact: 3.2)
  * `test_type_forcing` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `send_file` (Impact: 158.7)
  * `__init__` (Impact: 23.4)
  * `find_modules` (Impact: 15.6)
  * `__get__` (Impact: 15.0)
  * `send_from_directory` (Impact: 10.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002332 | `Ripple Effect (Closeness):` 0.06516
...
**Top Internal Functions/Classes:**
  * `test_basic_local` (Impact: 5.3)
  * `test_proxy_aiter` (Impact: 4.3)
  * `test_proxy_numeric` (Impact: 4.0)
  * `test_proxy_attributes` (Impact: 4.0)
  * `__round__` (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.7e-05 | `Ripple Effect (Closeness):` 0.088053
...
**Top Internal Functions/Classes:**
  ...
  * `_clean_status` (Impact: 10.1)
  * `www_authenticate` (Impact: 9.7)
  * `retry_after` (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 9.5)
  * `get_headers` (Impact: 8.9)
  * `get_response` (Impact: 7.2)
  * `__init__` (Impact: 7.1)
  * `get_description` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.005623 | `Ripple Effect (Closeness):` 0.102128
...
**Top Internal Functions/Classes:**
  * `_find_stat_paths` (Impact: 19.8)
  * `_get_args_for_reloading` (Impact: 18.9)
  ...
  * `_find_common_roots` (Impact: 11.1)
  * `__init__` (Impact: 9.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
**Top Internal Functions/Classes:**
  * `next_event` (Impact: 50.9)
  * `_parse_data` (Impact: 37.6)
  * `send_event` (Impact: 29.3)
  * `_last_partial_boundary_index` (Impact: 9.8)
    * *Intent:* # Find the last index following which a partial boundary # could be present in the data. This will b...
  * `receive_data` (Impact: 9.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `get_input_stream` (Impact: 21.3)
  * `readinto` (Impact: 16.2)
  * `get_current_url` (Impact: 11.6)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000417 | `Ripple Effect (Closeness):` 0.02896
...
**Top Internal Functions/Classes:**
  * `test_cache_control_header` (Impact: 9.8)
  * `test_cookie_maxsize` (Impact: 4.7)
  * `test_accept_invalid_float` (Impact: 4.7)
  * `test_authorization_header` (Impact: 4.2)
  * `test_if_range_parsing` (Impact: 4.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `check_start_response` (Impact: 45.0)
  * `close` (Impact: 25.0)
  * `__call__` (Impact: 18.7)
  * `check_environ` (Impact: 17.7)
  * `check_headers` (Impact: 16.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `best_match` (Impact: 21.4)
  * `best_match` (Impact: 18.4)
  * `_best_single_match` (Impact: 9.0)
  * `__init__` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `parse` (Impact: 30.1)
  * `parse` (Impact: 16.6)
  * `_parse_urlencoded` (Impact: 10.8)
  * `default_stream_factory` (Impact: 9.6)
  * `__init__` (Impact: 9.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 41 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002498 | `Ripple Effect (Closeness):` 0.125423
...
- `werkzeug-3.1.8/src/werkzeug/_internal.py` -> **Severity: 0.65** (Bridge: 0.0065 * Flux: 100.0%)
- `werkzeug-3.1.8/src/werkzeug/exceptions.py` -> **Severity: 0.562** (Bridge: 0.0056 * Flux: 100.0%)
- `werkzeug-3.1.8/src/werkzeug/wrappers/request.py` -> **Severity: 0.487** (Bridge: 0.0049 * Flux: 99.9962%)
- `werkzeug-3.1.8/src/werkzeug/wsgi.py` -> **Severity: 0.401** (Bridge: 0.004 * Flux: 100.0%)
- `werkzeug-3.1.8/src/werkzeug/serving.py` -> **Severity: 0.385** (Bridge: 0.0038 * Flux: 100.0%)
