...
- `bind_alv_ole2` (@ `src/not_cloud/zcl_excel_ole.clas.abap`) -> Impact: **926.4** | LOC: 1981
- `change_cell_style` (@ `src/zcl_excel_worksheet.clas.abap`) -> Impact: **638.0** | LOC: 378
- `create_ax` (@ `src/zcl_excel_graph_bars.clas.abap`) -> Impact: **249.1** | LOC: 146
- `create_ax` (@ `src/zcl_excel_graph_line.clas.abap`) -> Impact: **249.1** | LOC: 146
- `load_worksheet` (@ `src/zcl_excel_reader_2007.clas.abap`) -> Impact: **241.9** | LOC: 857
- `set_cell` (@ `src/zcl_excel_worksheet.clas.abap`) -> Impact: **227.3** | LOC: 306
- `create_xl_styles` (@ `src/zcl_excel_writer_2007.clas.abap`) -> Impact: **162.9** | LOC: 912
- `bind_table` (@ `src/zcl_excel_worksheet.clas.abap`) -> Impact: **150.9** | LOC: 299
- `convert_to_table` (@ `src/zcl_excel_worksheet.clas.abap`) -> Impact: **150.0** | LOC: 285
- `shift_formula` (@ `src/zcl_excel_common.clas.abap`) -> Impact: **143.8** | LOC: 372
...
- **Heaviest Functions:** `zif_excel_style_changer~apply` (Impact: 109.2), `move_supplied_borders` (Impact: 14.4), `zif_excel_style_changer~set_complete_borders` (Impact: 12.6)
...
- **Heaviest Functions:** `load_worksheet` (Impact: 241.9), `load_workbook` (Impact: 99.3), `load_styles` (Impact: 63.1)
...
- **Heaviest Functions:** `shift_formula` (Impact: 143.8), `convert_range2column_a_row` (Impact: 46.6), `convert_column2int` (Impact: 31.2)
...
- **Heaviest Functions:** `change_cell_style` (Impact: 638.0), `set_cell` (Impact: 227.3), `bind_table` (Impact: 150.9)
...
- **Heaviest Functions:** `bind_alv_ole2` (Impact: 926.4), `close_document` (Impact: 7.2), `error_doi` (Impact: 2.7)
...
- **Heaviest Functions:** `loop_subtotal` (Impact: 120.9), `convert` (Impact: 47.6), `loop_normal` (Impact: 29.6)
...
- **Heaviest Functions:** `add_conditional_formatting` (Impact: 65.3), `add_sheet_views` (Impact: 35.0), `add_cols` (Impact: 28.4)
...
- **Heaviest Functions:** `create_ax` (Impact: 249.1), `set_show_cat_name` (Impact: 1.6), `set_show_legend_key` (Impact: 1.6)
...
- **Heaviest Functions:** `create_csv` (Impact: 77.2), `create` (Impact: 2.0), `set_active_sheet_index` (Impact: 1.6)
...
**Top Internal Functions/Classes:**
  * `change_cell_style` (Impact: 638.0)
  * `set_cell` (Impact: 227.3)
  * `bind_table` (Impact: 150.9)
  * `convert_to_table` (Impact: 150.0)
  * `get_table` (Impact: 68.7)
...
**Top Internal Functions/Classes:**
  * `load_worksheet` (Impact: 241.9)
  * `load_workbook` (Impact: 99.3)
  * `load_styles` (Impact: 63.1)
  * `load_drawing_anchor` (Impact: 54.6)
  * `load_style_fills` (Impact: 46.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_xl_styles` (Impact: 162.9)
  * `create_xl_charts` (Impact: 114.4)
  * `create_xl_sheet_sheet_data` (Impact: 106.8)
  * `create_dxf_style` (Impact: 40.6)
  * `create_xl_table` (Impact: 39.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `bind_alv_ole2` (Impact: 926.4)
  * `close_document` (Impact: 7.2)
  * `error_doi` (Impact: 2.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `zif_excel_style_changer~apply` (Impact: 109.2)
  * `move_supplied_borders` (Impact: 14.4)
  * `zif_excel_style_changer~set_complete_borders` (Impact: 12.6)
  * `zif_excel_style_changer~set_complete_font` (Impact: 10.1)
  * `clear_initial_colorxfields` (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `loop_subtotal` (Impact: 120.9)
  * `convert` (Impact: 47.6)
  * `loop_normal` (Impact: 29.6)
  * `execute_converter` (Impact: 29.5)
  * `get_color_style` (Impact: 27.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `shift_formula` (Impact: 143.8)
  * `convert_range2column_a_row` (Impact: 46.6)
  * `convert_column2int` (Impact: 31.2)
  * `recursive_struct_to_class` (Impact: 25.1)
  * `get_fieldcatalog` (Impact: 19.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 18 instances
...
**Top Internal Functions/Classes:**
  * `add_conditional_formatting` (Impact: 65.3)
  * `add_sheet_views` (Impact: 35.0)
  * `add_cols` (Impact: 28.4)
  * `add_data_validations` (Impact: 24.6)
  * `add_page_setup` (Impact: 24.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `load_chart_attributes` (Impact: 111.2)
  * `set_position2` (Impact: 15.3)
  * `get_media` (Impact: 10.1)
  * `set_media` (Impact: 9.6)
  * `set_position` (Impact: 8.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `update_catalog` (Impact: 64.5)
  * `get_color` (Impact: 33.9)
  * `get_filter` (Impact: 23.9)
  * `apply_sort` (Impact: 10.3)
  * `class_constructor` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `assert` (Impact: 13.2)
  * `delete_merge3` (Impact: 9.1)
  * `delete_merge4` (Impact: 9.1)
  * `assert` (Impact: 8.8)
  * `assert` (Impact: 8.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_xl_sheet` (Impact: 104.0)
  * `create_xl_sharedstrings` (Impact: 7.8)
  * `get_cells` (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `create_ax` (Impact: 249.1)
  * `set_show_cat_name` (Impact: 1.6)
  * `set_show_legend_key` (Impact: 1.6)
  * `set_show_percent` (Impact: 1.6)
  * `set_show_ser_name` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `fill_range` (Impact: 73.9)
  * `find_var` (Impact: 20.3)
  * `validate_range` (Impact: 12.1)
  * `fill_sheet` (Impact: 10.7)
  * `discard_overlapped` (Impact: 6.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `macro_calculate_cell_distance` (Impact: 4.3)
  * `macro_shift_formula` (Impact: 4.0)
  * `simple` (Impact: 3.4)
  * `describe_structure` (Impact: 2.8)
  * `excel_string_to_date` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `get_style_index_in_styles` (Impact: 13.3)
  * `add_new_drawing` (Impact: 10.8)
  * `get_drawings_iterator` (Impact: 9.2)
  * `fill_template` (Impact: 7.0)
  * `delete_worksheet` (Impact: 6.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
**Top Internal Functions/Classes:**
  * `build_xml` (Impact: 44.5)
  * `modify_lec_fonts` (Impact: 33.1)
  * `load` (Impact: 29.9)
  * `modify_font` (Impact: 17.2)
  * `modify_cs_font` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 7 instances
...
**Top Internal Functions/Classes:**
  * `build_xml` (Impact: 66.1)
  * `set_color` (Impact: 49.1)
  * `load` (Impact: 24.6)
  * `get_color` (Impact: 11.3)
  * `set_name` (Impact: 4.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 12 instances
...
**Top Internal Functions/Classes:**
  * `get_header_footer_string` (Impact: 71.7)
  * `set_page_margins` (Impact: 32.2)
  * `process_header_footer` (Impact: 20.6)
  * `set_header_footer` (Impact: 6.0)
  * `get_header_footer` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
* *Amplified Cascading Flux:* 33 instances
* *Memory Alloc (weighted view):* 0
...
**Top Internal Functions/Classes:**
  * `is_row_hidden` (Impact: 14.2)
  * `is_row_hidden_single_values` (Impact: 13.1)
  * `is_row_hidden_text_pattern` (Impact: 10.5)
  * `validate_area` (Impact: 9.9)
  * `set_text_filter` (Impact: 8.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
**Top Internal Functions/Classes:**
  * `create_csv` (Impact: 77.2)
  * `create` (Impact: 2.0)
  * `set_active_sheet_index` (Impact: 1.6)
  * `set_active_sheet_index_by_name` (Impact: 1.6)
  * `set_delimiter` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 7 instances
...
**Top Internal Functions/Classes:**
  * `get_type_r` (Impact: 45.5)
  * `get_types` (Impact: 11.8)
  * `get_file_path` (Impact: 8.7)
    * *Intent:* *&---------------------------------------------------------------------* *& Form Get_file_path *&---...
  * `load_smw0` (Impact: 5.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `build_gradient` (Impact: 19.6)
  * `check_filltype_is_gradient` (Impact: 5.1)
  * `get_structure` (Impact: 1.9)
