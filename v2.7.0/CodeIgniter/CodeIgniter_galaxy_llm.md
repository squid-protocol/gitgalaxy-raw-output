...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 4.0 | 0.0 | 0.0 |
...
| connectivity | 1034 | 86 | 9 | `user_guide_src/source/_themes/sphinx_rtd_theme/layout_old.html` |
...
- `protect_identifiers` (@ `system/database/DB_driver.php`) -> Impact: **95.4** | LOC: 164
...
- `create_captcha` (@ `system/helpers/captcha_helper.php`) -> Impact: **93.8** | LOC: 321
  * *Intent:* /** * Create CAPTCHA * * @param array $data Data for the CAPTCHA * @return array */
- `set_cookie` (@ `system/core/Input.php`) -> Impact: **89.8** | LOC: 88
...
- `xss_clean` (@ `system/core/Security.php`) -> Impact: **89.0** | LOC: 222
...
- `hash_pbkdf2` (@ `system/core/compat/hash.php`) -> Impact: **70.1** | LOC: 132
...
- `query` (@ `system/database/DB_driver.php`) -> Impact: **63.0** | LOC: 140
...
- `model` (@ `system/core/Loader.php`) -> Impact: **58.5** | LOC: 129
...
- `load` (@ `system/core/Lang.php`) -> Impact: **55.9** | LOC: 90
  * *Intent:* // -------------------------------------------------------------------- /** * Load a language file * * @param mixed $langfile Language file name * @pa...
- `password_hash` (@ `system/core/compat/password.php`) -> Impact: **54.6** | LOC: 93
...
### 1. `system/database/DB_driver.php` (PHP) -> Cumulative Risk: **515.32**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1016.14 | **LOC:** 1941 | **CtrlFlow:** 21.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (95.8592%), Tech Debt (94.5029%), State Flux (85.0%)
- **Heaviest Functions:** `protect_identifiers` (Impact: 95.4), `query` (Impact: 63.0), `escape_identifiers` (Impact: 32.1)

### 2. `system/core/Exceptions.php` (PHP) -> Cumulative Risk: **512.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 183.18 | **LOC:** 288 | **CtrlFlow:** 16.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.2345%), Verification (80.0%)
- **Heaviest Functions:** `show_php_error` (Impact: 19.9), `show_error` (Impact: 19.6), `show_exception` (Impact: 11.8)

### 3. `system/database/drivers/mssql/mssql_driver.php` (PHP) -> Cumulative Risk: **509.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 228.6 | **LOC:** 508 | **CtrlFlow:** 16.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9077%), Safety Score (97.8611%), State Flux (85.0%)
- **Heaviest Functions:** `_limit` (Impact: 19.0), `db_connect` (Impact: 12.9), `field_data` (Impact: 6.9)

### 4. `system/database/drivers/oci8/oci8_driver.php` (PHP) -> Cumulative Risk: **504.04**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 276.56 | **LOC:** 618 | **CtrlFlow:** 20.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9914%), Safety Score (96.2772%), State Flux (85.0%)
- **Heaviest Functions:** `__construct` (Impact: 35.0), `field_data` (Impact: 15.1), `_limit` (Impact: 6.4)

### 5. `system/database/drivers/mysqli/mysqli_driver.php` (PHP) -> Cumulative Risk: **502.79**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 227.78 | **LOC:** 549 | **CtrlFlow:** 18.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9988%), Safety Score (89.1784%), State Flux (85.0%)
- **Heaviest Functions:** `db_connect` (Impact: 47.0), `field_data` (Impact: 5.5), `db_select` (Impact: 5.0)

### 6. `system/database/DB_query_builder.php` (PHP) -> Cumulative Risk: **502.27**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1807.88 | **LOC:** 2882 | **CtrlFlow:** 19.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Safety Score (98.2618%), Tech Debt (93.8549%), State Flux (85.0%)
- **Heaviest Functions:** `_like` (Impact: 53.0), `_wh` (Impact: 41.8), `join` (Impact: 41.7)

### 7. `system/database/drivers/pdo/subdrivers/pdo_pgsql_driver.php` (PHP) -> Cumulative Risk: **502.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 194.5 | **LOC:** 386 | **CtrlFlow:** 16.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.6183%), Safety Score (96.6873%), State Flux (85.0%)
- **Heaviest Functions:** `order_by` (Impact: 13.2), `_update_batch` (Impact: 11.4), `field_data` (Impact: 6.9)

### 8. `system/database/drivers/pdo/subdrivers/pdo_dblib_driver.php` (PHP) -> Cumulative Risk: **501.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 194.62 | **LOC:** 355 | **CtrlFlow:** 21.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (98.2134%), Safety Score (97.8779%), State Flux (85.0%)
- **Heaviest Functions:** `_limit` (Impact: 19.0), `__construct` (Impact: 12.7), `db_connect` (Impact: 8.2)

### 9. `system/core/Input.php` (PHP) -> Cumulative Risk: **500.74**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 515.16 | **LOC:** 705 | **CtrlFlow:** 25.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.1534%), Verification (80.0%)
- **Heaviest Functions:** `set_cookie` (Impact: 89.8), `ip_address` (Impact: 35.4), `_fetch_from_array` (Impact: 28.6)

### 10. `system/core/URI.php` (PHP) -> Cumulative Risk: **499.02**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 362.28 | **LOC:** 663 | **CtrlFlow:** 21.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.3809%), Verification (80.0%)
- **Heaviest Functions:** `_uri_to_assoc` (Impact: 24.9), `__construct` (Impact: 21.7), `_set_uri_string` (Impact: 20.2)
...
- **Magnitude:** 1807.88 | **LOC:** 2882 | **CtrlFlow:** 19.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (34.9142%), Tech Debt (93.8549%)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1016.14 | **LOC:** 1941 | **CtrlFlow:** 21.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (45.7747%), Tech Debt (94.5029%)
**Top Internal Functions/Classes:**
  * `protect_identifiers` (Impact: 95.4)
  ...
  * `escape_identifiers` (Impact: 32.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Escape the SQL Identif...
  * `display_error` (Impact: 22.2)
    * *Intent:* // -------------------------------------------------------------------- /** * Display an error messa...
  * `compile_binds` (Impact: 20.1)
...
- **Risk Profile:** Cognitive Load (6.413%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (38.0295%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `form_dropdown` (Impact: 46.5)
...
- **Risk Profile:** Cognitive Load (36.8035%), Tech Debt (28.025%)
**Top Internal Functions/Classes:**
  * `_process_fields` (Impact: 47.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Process fields * * @pa...
  * `create_table` (Impact: 26.4)
    * *Intent:* // -------------------------------------------------------------------- /** * Create Table * * @para...
  * `_attr_default` (Impact: 22.5)
    * *Intent:* // -------------------------------------------------------------------- /** * Field attribute DEFAUL...
  * `_create_table` (Impact: 18.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Create Table * * @para...
  * `_attr_unsigned` (Impact: 17.1)
...
**Top Internal Functions/Classes:**
  ...
  * `get_request_header` (Impact: 11.6)
...
- **Risk Profile:** Cognitive Load (5.8143%), Tech Debt (15.256%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (34.4662%), Tech Debt (15.2032%)
**Top Internal Functions/Classes:**
  * `load_class` (Impact: 22.9)
...
- **Risk Profile:** Cognitive Load (66.786%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `create_captcha` (Impact: 93.8)
    * *Intent:* /** * Create CAPTCHA * * @param array $data Data for the CAPTCHA * @return array */
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (33.3818%), Tech Debt (83.0971%)
**Top Internal Functions/Classes:**
  * `custom_result_object` (Impact: 15.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Custom query result. *...
  * `set_row` (Impact: 11.5)
    * *Intent:* // -------------------------------------------------------------------- /** * Assigns an item into a...
  * `row` (Impact: 9.7)
    * *Intent:* // -------------------------------------------------------------------- /** * Row * * A wrapper meth...
  * `result_object` (Impact: 7.7)
    * *Intent:* // -------------------------------------------------------------------- /** * Query result. "object"...
  * `result_array` (Impact: 7.7)
...
- **Risk Profile:** Cognitive Load (38.9913%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (34.2692%), Tech Debt (99.2916%)
**Top Internal Functions/Classes:**
  * `db_connect` (Impact: 14.2)
    * *Intent:* // -------------------------------------------------------------------- /** * Database connection * ...
  * `order_by` (Impact: 13.2)
    * *Intent:* // -------------------------------------------------------------------- /** * ORDER BY * * @param st...
  * `insert_id` (Impact: 11.8)
    * *Intent:* // -------------------------------------------------------------------- /** * Insert ID * * @return ...
  * `_update_batch` (Impact: 11.4)
    * *Intent:* // -------------------------------------------------------------------- /** * Update_Batch statement...
  * `_build_dsn` (Impact: 11.3)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 276.56 | **LOC:** 618 | **CtrlFlow:** 20.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (34.5663%), Tech Debt (99.9914%)
**Top Internal Functions/Classes:**
  * `__construct` (Impact: 35.0)
    * *Intent:* // -------------------------------------------------------------------- /** * Class constructor * * ...
  * `field_data` (Impact: 15.1)
...
- **Risk Profile:** Cognitive Load (24.8279%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ci_vfs_create` (Impact: 32.4)
    * *Intent:* // -------------------------------------------------------------------- /** * Create VFS content * *...
  * `ci_vfs_clone` (Impact: 10.1)
    * *Intent:* // -------------------------------------------------------------------- /** * Clone a real file into...
  * `ci_set_config` (Impact: 9.8)
    * *Intent:* // --------------------------------------------------------------------
  * `setExpectedException` (Impact: 8.7)
  * `ci_core_class` (Impact: 8.4)
...
- **Risk Profile:** Cognitive Load (33.9956%), Tech Debt (99.6969%)
**Top Internal Functions/Classes:**
  * `_limit` (Impact: 20.8)
    * *Intent:* // -------------------------------------------------------------------- /** * LIMIT * * Generates a ...
  * `db_connect` (Impact: 17.2)
    * *Intent:* // -------------------------------------------------------------------- /** * Database connection * ...
  * `error` (Impact: 7.3)
    * *Intent:* // -------------------------------------------------------------------- /** * Error * * Returns an a...
  * `field_data` (Impact: 6.9)
    * *Intent:* // -------------------------------------------------------------------- /** * Returns an object with...
  * `_insert_batch` (Impact: 6.5)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 228.6 | **LOC:** 508 | **CtrlFlow:** 16.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (43.9135%), Tech Debt (99.9077%)
**Top Internal Functions/Classes:**
  * `_limit` (Impact: 19.0)
    * *Intent:* // -------------------------------------------------------------------- /** * LIMIT * * Generates a ...
  * `db_connect` (Impact: 12.9)
    * *Intent:* // -------------------------------------------------------------------- /** * Non-persistent databas...
  * `field_data` (Impact: 6.9)
    * *Intent:* // -------------------------------------------------------------------- /** * Returns an object with...
  * `_insert_batch` (Impact: 6.5)
    * *Intent:* // -------------------------------------------------------------------- /** * Insert batch statement...
  * `db_select` (Impact: 5.1)
