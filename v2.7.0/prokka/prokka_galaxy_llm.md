...
- `usage` (@ `bin/prokka`) -> Impact: **28.2** | LOC: 27
- `cleanup_product` (@ `bin/prokka`) -> Impact: **22.7** | LOC: 30
  * *Intent:* #EXIT #----------------------------------------------------------------------
- `setup_db` (@ `bin/prokka`) -> Impact: **16.9** | LOC: 39
  * *Intent:* #----------------------------------------------------------------------
- `check_tool` (@ `bin/prokka`) -> Impact: **12.6** | LOC: 26
- `clean_db` (@ `bin/prokka`) -> Impact: **11.8** | LOC: 10
  * *Intent:* #----------------------------------------------------------------------
- `setOptions` (@ `bin/prokka-genbank_to_fasta_db`) -> Impact: **10.3** | LOC: 27
  * *Intent:* #---------------------------------------------------------------------- # Option setting routines
- `show_citation` (@ `bin/prokka`) -> Impact: **8.9** | LOC: 18
  * *Intent:* #----------------------------------------------------------------------
- `setOptions` (@ `bin/prokka-hamap_to_hmm`) -> Impact: **8.4** | LOC: 28
  * *Intent:* #---------------------------------------------------------------------- # Option setting routines
- `setOptions` (@ `bin/prokka-uniprot_to_fasta_db`) -> Impact: **8.3** | LOC: 27
...
- **Heaviest Functions:** `setOptions` (Impact: 28.5), `usage` (Impact: 28.2), `cleanup_product` (Impact: 22.7)
...
- **Heaviest Functions:** `setOptions` (Impact: 8.3), `usage` (Impact: 6.4)
...
- **Heaviest Functions:** `setOptions` (Impact: 8.4), `usage` (Impact: 6.4), `get_file` (Impact: 5.7)
...
- **Heaviest Functions:** `setOptions` (Impact: 7.1), `usage` (Impact: 6.4)
...
- **Heaviest Functions:** `setOptions` (Impact: 8.1), `usage` (Impact: 6.4)
...
- **Heaviest Functions:** `usage` (Impact: 6.4), `setOptions` (Impact: 6.2), `get_file` (Impact: 5.7)
...
- **Heaviest Functions:** `setOptions` (Impact: 10.3), `usage` (Impact: 6.4), `TAG` (Impact: 3.9)
...
- **Heaviest Functions:** `install` (Impact: 1.3), `all` (Impact: 1.1), `HAMAP.hmm.gz` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `setOptions` (Impact: 28.5)
    * *Intent:* #---------------------------------------------------------------------- # Option setting routines
  * `usage` (Impact: 28.2)
  * `cleanup_product` (Impact: 22.7)
    * *Intent:* #EXIT #----------------------------------------------------------------------
  * `setup_db` (Impact: 16.9)
    * *Intent:* #----------------------------------------------------------------------
  * `check_tool` (Impact: 12.6)
...
**Top Internal Functions/Classes:**
  * `install` (Impact: 1.3)
  * `all` (Impact: 1.1)
  * `HAMAP.hmm.gz` (Impact: 1.1)
    * *Intent:* # $(CP) sprot_m $(DIR_M)/sprot
  * `HAMAP.hmm` (Impact: 1.1)
  * `hamap_rules.dat` (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
