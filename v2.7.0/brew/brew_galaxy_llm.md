...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 12.1 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 14.1 | 2.3 | 0.0 |
| Connectivity (formerly API Exposure) | 0.0 | 71.7 | 12.8 | 3.0 | 0.0 |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 62.4 | 100.0 | 100.0 |
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 3.3 | 0.6 | 0.1 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 74.5 | 14.9 | 6.7 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 28.6 | 0.0 | 0.0 |
...
| connectivity | 328 | 68 | 6 | `Library/Homebrew/rust/brew-rs/src/commands/fetch.rs` |
...
| dead_code | 90 | 28 | 1 | `Library/Homebrew/rust/brew-rs/src/homebrew.rs` |
...
- `update_python_resources!` (@ `Library/Homebrew/utils/pypi.rb`) -> Impact: **259.8** | LOC: 292
- `curl_check_http_content` (@ `Library/Homebrew/utils/curl.rb`) -> Impact: **147.6** | LOC: 131
- `Anonymous_Block` (@ `Library/Homebrew/test/utils/curl_spec.rb`) -> Impact: **130.4** | LOC: 827
- `update_perl_resources!` (@ `Library/Homebrew/utils/cpan.rb`) -> Impact: **61.5** | LOC: 104
- `fetch_bottle` (@ `Library/Homebrew/rust/brew-rs/src/commands/fetch.rs`) -> Impact: **59.5** | LOC: 71
- `create_bump_pr` (@ `Library/Homebrew/utils/github.rb`) -> Impact: **59.3** | LOC: 112
...
- `Anonymous_Block` (@ `Library/Homebrew/test/utils/backtrace_spec.rb`) -> Impact: **58.0** | LOC: 86
- `odeprecated` (@ `Library/Homebrew/utils/output.rb`) -> Impact: **56.8** | LOC: 78
- `install_bundler_gems!` (@ `Library/Homebrew/utils/gems.rb`) -> Impact: **54.4** | LOC: 128
- `table_output` (@ `Library/Homebrew/utils/analytics.rb`) -> Impact: **45.9** | LOC: 86

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `Library/Homebrew/utils` | 49 | 6227.86 | 30.57% | 11.04% |
...
| `Library/Homebrew/rust/brew-rs/src` | 6 | 136.16 | 5.53% | 51.7% |
| `Library/Homebrew/rust/brew-rs/src/utils` | 3 | 113.78 | 10.36% | 0.0% |
...
- `Library/Homebrew/rust/brew-rs/src/commands/list.rs` -> **5** Orphaned Functions | **0** Duplicates
...
### 1. `Library/Homebrew/utils/shfmt.sh` (SHELL) -> Cumulative Risk: **679.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 322.12 | **LOC:** 453 | **CtrlFlow:** 23.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (90.6948%)
- **Heaviest Functions:** `wrap_then_do` (Impact: 31.9), `format` (Impact: 31.8), `no_forbidden_pattern` (Impact: 17.1)

### 2. `Library/Homebrew/utils/ruby.sh` (SHELL) -> Cumulative Risk: **658.51**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 124.9 | **LOC:** 205 | **CtrlFlow:** 21.9% | **Authorship Centralization:** 20.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Concurrency (96.5555%), Safety Score (89.5321%)
- **Heaviest Functions:** `setup-ruby-path` (Impact: 24.5), `need_vendored_ruby` (Impact: 5.5), `can_use_ruby_from_path` (Impact: 4.4)

### 3. `Library/Homebrew/utils/helpers.sh` (SHELL) -> Cumulative Risk: **605.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 65.44 | **LOC:** 107 | **CtrlFlow:** 29.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9975%), Concurrency (92.3153%), Documentation (83.3333%)
- **Heaviest Functions:** `opoo` (Impact: 10.6), `onoe` (Impact: 10.6), `ohai` (Impact: 7.5)

### 4. `Library/Homebrew/utils/gems.rb` (RUBY) -> Cumulative Risk: **602.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 224.04 | **LOC:** 334 | **CtrlFlow:** 20.2% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (94.8582%)
- **Heaviest Functions:** `install_bundler_gems!` (Impact: 54.4), `install_gem!` (Impact: 15.3), `setup_gem_environment!` (Impact: 10.2)

### 5. `Library/Homebrew/utils/github.rb` (RUBY) -> Cumulative Risk: **601.01**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 862.98 | **LOC:** 1040 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 30.8%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (93.9028%), Verification (80.0%)
- **Heaviest Functions:** `create_bump_pr` (Impact: 59.3), `check_for_duplicate_pull_requests` (Impact: 34.9), `fetch_pull_requests` (Impact: 23.0)

### 6. `Library/Homebrew/utils/curl.rb` (RUBY) -> Cumulative Risk: **594.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 728.06 | **LOC:** 776 | **CtrlFlow:** 28.1% | **Authorship Centralization:** 37.5%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.7564%), Verification (80.0%)
- **Heaviest Functions:** `curl_check_http_content` (Impact: 147.6), `curl_http_content_headers_and_checksum` (Impact: 43.9), `curl_with_workarounds` (Impact: 35.6)

### 7. `bin/brew` (SHELL) -> Cumulative Risk: **535.59**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 217.86 | **LOC:** 333 | **CtrlFlow:** 24.8% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Safety Score (82.7419%)
- **Heaviest Functions:** `export_homebrew_env_file` (Impact: 9.6), `symlink_target_directory` (Impact: 9.4), `Anonymous_Block` (Impact: 9.1)

### 8. `Library/Homebrew/rust/brew-rs/src/homebrew.rs` (RUST) -> Cumulative Risk: **521.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 81.44 | **LOC:** 217 | **CtrlFlow:** 11.0% | **Authorship Centralization:** 75.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.4472%), Verification (80.0%)
- **Heaviest Functions:** `print_sections` (Impact: 15.0), `list_directories` (Impact: 9.6), `env_bool` (Impact: 5.1)

### 9. `Library/Homebrew/utils/github/api.rb` (RUBY) -> Cumulative Risk: **518.02**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 281.46 | **LOC:** 477 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 20.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (82.9953%), Verification (80.0%)
- **Heaviest Functions:** `open_rest` (Impact: 31.9), `raise_error` (Impact: 19.2), `credentials_error_message` (Impact: 15.1)

### 10. `Library/Homebrew/rust/brew-rs/src/commands/list.rs` (RUST) -> Cumulative Risk: **517.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 99.66 | **LOC:** 217 | **CtrlFlow:** 20.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Verification (80.0%), Safety Score (77.0621%)
- **Heaviest Functions:** `run` (Impact: 31.1), `current_keg_path` (Impact: 19.1), `list_formula_paths` (Impact: 12.8)
...
- **Magnitude:** 862.98 | **LOC:** 1040 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 30.8%
- **Risk Profile:** Cognitive Load (46.1299%), Tech Debt (8.4703%)
**Top Internal Functions/Classes:**
  * `create_bump_pr` (Impact: 59.3)
    * *Intent:* # --write-only without --commit means don't take any git actions at all. return if args.write_only? ...
  * `check_for_duplicate_pull_requests` (Impact: 34.9)
  * `fetch_pull_requests` (Impact: 23.0)
  * `repo_commits_for_user` (Impact: 20.8)
  * `organisation_repositories` (Impact: 19.4)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 728.06 | **LOC:** 776 | **CtrlFlow:** 28.1% | **Authorship Centralization:** 37.5%
- **Risk Profile:** Cognitive Load (39.6374%), Tech Debt (14.3914%)
**Top Internal Functions/Classes:**
  * `curl_check_http_content` (Impact: 147.6)
  * `curl_http_content_headers_and_checksum` (Impact: 43.9)
  * `curl_with_workarounds` (Impact: 35.6)
  * `curl_headers` (Impact: 30.2)
  * `curl_download` (Impact: 15.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (16.0487%), Tech Debt (14.9576%)
**Top Internal Functions/Classes:**
  * `fetch_bottle` (Impact: 59.5)
  * `load_formula_json` (Impact: 35.3)
  * `resolve_bottle` (Impact: 30.4)
  * `download_http_url` (Impact: 26.1)
  * `download_formula_json` (Impact: 24.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (54.821%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `update_python_resources!` (Impact: 259.8)
  * `pypi_info` (Impact: 17.7)
  * `basic_metadata` (Impact: 17.7)
  * `resource_blocks_from_formula` (Impact: 16.5)
  * `update_pypi_url` (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 381.42 | **LOC:** 516 | **CtrlFlow:** 18.9% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (36.3143%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `table_output` (Impact: 45.9)
  * `output_analytics` (Impact: 18.5)
  * `output_github_packages_downloads` (Impact: 17.4)
  * `report_command_run` (Impact: 12.7)
  * `report_package_event` (Impact: 8.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Rce:* 1 instances
...
- **Risk Profile:** Cognitive Load (41.2713%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `bitbucket` (Impact: 31.9)
  * `github` (Impact: 19.2)
  * `forgejo` (Impact: 19.2)
  * `gitlab` (Impact: 17.1)
  * `gitlab_release` (Impact: 12.8)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 322.12 | **LOC:** 453 | **CtrlFlow:** 23.9% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (76.8979%), Tech Debt (10.6943%)
**Top Internal Functions/Classes:**
  * `wrap_then_do` (Impact: 31.9)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 281.46 | **LOC:** 477 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 20.0%
- **Risk Profile:** Cognitive Load (34.9717%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `open_rest` (Impact: 31.9)
  * `raise_error` (Impact: 19.2)
  * `credentials_error_message` (Impact: 15.1)
  * `open_graphql` (Impact: 9.5)
  * `paginate_rest` (Impact: 8.2)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (32.4848%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `resolve_formula_names` (Impact: 15.1)
  * `load_tab` (Impact: 13.9)
  * `tag` (Impact: 9.1)
  * `add` (Impact: 8.2)
  * `from_symbol` (Impact: 7.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (38.1921%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `odeprecated` (Impact: 56.8)
  * `odebug` (Impact: 12.6)
  * `oh1_title` (Impact: 10.9)
  * `ohai_title` (Impact: 7.6)
  * `pretty_duration` (Impact: 6.5)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 224.04 | **LOC:** 334 | **CtrlFlow:** 20.2% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (94.8582%), Tech Debt (25.2939%)
**Top Internal Functions/Classes:**
  * `install_bundler_gems!` (Impact: 54.4)
  * `install_gem!` (Impact: 15.3)
  * `setup_gem_environment!` (Impact: 10.2)
  * `write_user_gem_groups` (Impact: 6.7)
  * `odie_if_defined` (Impact: 4.6)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 217.86 | **LOC:** 333 | **CtrlFlow:** 24.8% | **Authorship Centralization:** 33.3%
- **Risk Profile:** Cognitive Load (70.2694%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `export_homebrew_env_file` (Impact: 9.6)
    * *Intent:* # Load Homebrew's variable configuration files from disk.
  * `symlink_target_directory` (Impact: 9.4)
  * `Anonymous_Block` (Impact: 9.1)
...
- **Risk Profile:** Cognitive Load (39.2204%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `license_expression_to_string` (Impact: 19.9)
  * `string_to_license_expression` (Impact: 18.8)
  * `licenses_forbid_installation?` (Impact: 18.2)
  * `forbidden_licenses_include?` (Impact: 11.1)
  * `parse_license_expression` (Impact: 9.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (12.9979%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Anonymous_Block` (Impact: 130.4)
...
- **Risk Profile:** Cognitive Load (36.6927%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `add_stanza` (Impact: 23.6)
  * `stanza_text` (Impact: 16.4)
  * `call_node_match?` (Impact: 10.6)
  * `remove_stanza` (Impact: 10.2)
  * `formula_component_before_target?` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (49.053%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `update_perl_resources!` (Impact: 61.5)
  * `install` (Impact: 6.9)
  * `latest_cpan_info` (Impact: 6.1)
  * `extract_version_from_url` (Impact: 2.4)
  * `initialize` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (46.755%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `columns` (Impact: 19.4)
  * `format_help_text` (Impact: 9.1)
  * `prefix` (Impact: 4.5)
  * `number_readable` (Impact: 4.5)
  * `truncate` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (15.2057%), Tech Debt (24.6642%)
**Top Internal Functions/Classes:**
  * `pour_bottle` (Impact: 36.4)
  * `basic_install_delegate_reason` (Impact: 33.6)
  * `run` (Impact: 22.4)
  * `cleanup_failed_pour` (Impact: 14.7)
  * `display_bottle_basename` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *High Risk Execution (weighted view):* 1
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (33.0027%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `set_name_email!` (Impact: 14.9)
  * `last_revision_commit_of_files` (Impact: 7.0)
  * `last_revision_commit_of_file` (Impact: 6.5)
  * `version` (Impact: 5.3)
  * `ensure_installed!` (Impact: 5.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (36.943%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `set_variable_in_profile` (Impact: 9.4)
  * `profile` (Impact: 9.0)
  * `export_value` (Impact: 8.8)
  * `prepend_path_in_profile` (Impact: 6.4)
  * `shell_with_prompt` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- **Risk Profile:** Cognitive Load (36.4867%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `inreplace` (Impact: 28.0)
  * `inreplace_pairs` (Impact: 7.5)
...
- `bin/brew` -> Churn: **74.49%** | Cog Load: 70.2694% | Debt: 0.0%
- `Library/Homebrew/utils/wrapper.sh` -> Churn: **52.07%** | Cog Load: 55.8305% | Debt: 62.6502%
- `Library/Homebrew/rust/brew-rs/src/homebrew.rs` -> Churn: **52.07%** | Cog Load: 10.3844% | Debt: 99.4472%
...
- `Library/Homebrew/utils/git.rb` -> **Michael Cho** (100.0% isolated ownership) | Magnitude: 131.64
