...
- `queryUser` (@ `package/src/main.js`) -> Impact: **340.5** | LOC: 1060
- `handleKeypress` (@ `package/src/main.js`) -> Impact: **143.2** | LOC: 265
- `render` (@ `package/src/main.js`) -> Impact: **53.6** | LOC: 292
- `run` (@ `package/bin/cli.js`) -> Impact: **30.1** | LOC: 103
- `trimOnIndexes` (@ `package/src/main.js`) -> Impact: **29.6** | LOC: 108
- `ansiRegex` (@ `package/src/main.js`) -> Impact: **15.5** | LOC: 10
  * *Intent:* // https://github.com/chalk/ansi-regex/blob/f338e1814144efb950276aac84135ff86b72dc8e/index.js#L1C16-L10C2
- `colorIndexesOnText` (@ `package/src/main.js`) -> Impact: **13.8** | LOC: 35
- `getList` (@ `package/src/main.js`) -> Impact: **10.7** | LOC: 13
  * *Intent:* // get matched list based on the search mode
- `getMatches` (@ `package/src/main.js`) -> Impact: **10.6** | LOC: 12
  * *Intent:* // get matches based on the search mode
- `fuzzyMatches` (@ `package/src/main.js`) -> Impact: **10.0** | LOC: 26
...
- **Heaviest Functions:** `queryUser` (Impact: 340.5), `handleKeypress` (Impact: 143.2), `render` (Impact: 53.6)
...
- **Heaviest Functions:** `run` (Impact: 30.1), `throttleUpdateList` (Impact: 6.1)
...
**Top Internal Functions/Classes:**
  * `queryUser` (Impact: 340.5)
  * `handleKeypress` (Impact: 143.2)
  * `render` (Impact: 53.6)
  * `trimOnIndexes` (Impact: 29.6)
  * `ansiRegex` (Impact: 15.5)
