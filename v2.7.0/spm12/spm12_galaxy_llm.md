...
- `addcolouredblobs` (@ `spm_orthviews.m`) -> Impact: **807.9** | LOC: 1659
  * *Intent:* %========================================================================== % function addcolouredblobs(handle, xyz, t, mat, colour, name) %==========...
- `addtruecolourimage` (@ `spm_orthviews.m`) -> Impact: **786.6** | LOC: 1604
  * *Intent:* %========================================================================== % function addtruecolourimage(handle,fname,colourmap,prop,mx,mn) %========...
- `addblobs` (@ `spm_orthviews.m`) -> Impact: **768.6** | LOC: 1704
  * *Intent:* %========================================================================== % function addblobs(handle, xyz, t, mat, name) %==========================...
- `writeCTFds` (@ `external/ctf/writeCTFds.m`) -> Impact: **722.8** | LOC: 1711
  * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % % % This program creates datasets that can be analyzed by CTF sof...
- `ConvertSpectroscopy` (@ `spm_dicom_convert.m`) -> Impact: **713.0** | LOC: 1228
  * *Intent:* %========================================================================== % function fnames = ConvertSpectroscopy(Headers, RootDirectory, format, Ou...
- `specify_image` (@ `spm_orthviews.m`) -> Impact: **650.4** | LOC: 1749
  * *Intent:* %========================================================================== % function H = specify_image(img, h) %====================================...
- `spm_sp` (@ `spm_sp.m`) -> Impact: **637.8** | LOC: 1415
...
- `Anonymous_Block_[Truncated]` (@ `spm_eeg_review_callbacks.m`) -> Impact: **626.4** | LOC: 1527
- `addcolouredimage` (@ `spm_orthviews.m`) -> Impact: **623.5** | LOC: 1629
  * *Intent:* %========================================================================== % function addcolouredimage(handle, fname,colour) %=======================...
- `addCTFtrial` (@ `external/ctf/addCTFtrial.m`) -> Impact: **608.7** | LOC: 1273
  * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % % % This program creates datasets that can be analyzed by CTF sof...
...
- **Heaviest Functions:** `dimlength` (Impact: 80.6), `__global_context__` (Impact: 35.5), `Anonymous_Block` (Impact: 4.3)
...
- **Heaviest Functions:** `sfactorization_wilson` (Impact: 36.7), `Anonymous_Block` (Impact: 8.0), `Anonymous_Block` (Impact: 7.1)
...
- **Heaviest Functions:** `ft_selectdata` (Impact: 192.1), `makeselection` (Impact: 136.6), `cellmatselect` (Impact: 77.2)
...
- **Heaviest Functions:** `harvest` (Impact: 72.2)
...
- **Heaviest Functions:** `spm_jobman` (Impact: 78.8), `load_jobs` (Impact: 64.1), `fill_run_job` (Impact: 44.5)
...
- **Heaviest Functions:** `mexFunction` (Impact: 73.8)
...
- **Heaviest Functions:** `ft_databrowser` (Impact: 239.9), `__global_context__` (Impact: 45.2), `select_range_cb` (Impact: 38.8)
...
**Top Internal Functions/Classes:**
  * `addcolouredblobs` (Impact: 807.9)
    * *Intent:* %========================================================================== % function addcolouredbl...
  * `addtruecolourimage` (Impact: 786.6)
    * *Intent:* %========================================================================== % function addtruecolour...
  * `addblobs` (Impact: 768.6)
    * *Intent:* %========================================================================== % function addblobs(hand...
  * `specify_image` (Impact: 650.4)
    * *Intent:* %========================================================================== % function H = specify_i...
  * `addcolouredimage` (Impact: 623.5)
...
**Top Internal Functions/Classes:**
  * `tinfl_decompress` (Impact: 357.1)
  * `mz_zip_writer_add_mem_ex_v2` (Impact: 331.8)
  * `mz_zip_writer_add_cfile` (Impact: 278.2)
    * *Intent:* #ifndef MINIZ_NO_STDIO
  * `mz_zip_writer_add_from_zip_reader` (Impact: 142.1)
    * *Intent:* /* TODO: This func is now pretty freakin complex due to zip64, split it up? */
  * `mz_zip_reader_extract_to_callback` (Impact: 134.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ConvertSpectroscopy` (Impact: 713.0)
    * *Intent:* %========================================================================== % function fnames = Conv...
  * `WriteSpectroscopyVolume` (Impact: 604.7)
    * *Intent:* %========================================================================== % function fname = Write...
  * `SelectLastGuff` (Impact: 371.4)
    * *Intent:* %========================================================================== % function [standard, gu...
  * `CheckFields` (Impact: 369.1)
    * *Intent:* %========================================================================== % function ok = CheckFie...
  * `SelectTomographicImages` (Impact: 339.2)
...
**Top Internal Functions/Classes:**
  * `click_dir_box` (Impact: 283.8)
    * *Intent:* %======================================================================= %==========================...
  * `select_rec1` (Impact: 256.4)
    * *Intent:* %======================================================================= %==========================...
  * `click_file_box` (Impact: 248.3)
    * *Intent:* %======================================================================= %==========================...
  * `select` (Impact: 238.7)
    * *Intent:* %======================================================================= %==========================...
  * `listfiles` (Impact: 238.4)
    * *Intent:* %======================================================================= %==========================...
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `myMenuCallback` (Impact: 221.8)
    * *Intent:* %==========================================================================
  * `getOptions` (Impact: 211.6)
    * *Intent:* %==========================================================================
  * `myPostCallback` (Impact: 208.2)
    * *Intent:* %==========================================================================
  * `myInflate` (Impact: 196.1)
    * *Intent:* %==========================================================================
  * `myCCLabel` (Impact: 189.8)
    * *Intent:* %==========================================================================
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `dartel_mexFunction` (Impact: 107.4)
  * `iteration` (Impact: 71.0)
  * `exp_mexFunction` (Impact: 54.9)
  * `smalldef_objfun_mn` (Impact: 50.4)
  * `initialise_objfun_mn` (Impact: 41.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `local_addtojob` (Impact: 229.3)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `local_cd` (Impact: 105.6)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `local_delfromjob` (Impact: 105.0)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `local_compactjob` (Impact: 101.8)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
  * `local_gencode` (Impact: 76.2)
    * *Intent:* %----------------------------------------------------------------------- %--------------------------...
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `spm_eeg_inv_visu3D_api` (Impact: 130.2)
    * *Intent:* % SPM_EEG_INV_VISU3D_API M-file for spm_eeg_inv_visu3D_api.fig % - FIG = SPM_EEG_INV_VISU3D_API laun...
  * `UpDate_Display_SRCS` (Impact: 100.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%...
  * `UpDate_Display_SENS` (Impact: 79.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % UPDATE SENSOR LEVEL DI...
  * `DataFile_Callback` (Impact: 72.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % LOAD DATA FILE %%%%%%%...
  * `LoadData_Callback` (Impact: 72.0)
...
**Top Internal Functions/Classes:**
  * `pushpull` (Impact: 76.0)
    * *Intent:* #define TINY 5e-2f
  * `pushc_grads` (Impact: 74.6)
...
**Top Internal Functions/Classes:**
  * `pm_segment` (Impact: 195.2)
    * *Intent:* % Segment an MR image into Gray, White & CSF. % % FORMAT VO = pm_segment(PF,PG,flags) % PF - name(s)...
  * `display_graphics` (Impact: 136.0)
    * *Intent:* %======================================================================= %==========================...
  * `affine_transform` (Impact: 133.5)
    * *Intent:* %======================================================================= %==========================...
  * `get_affine_mapping` (Impact: 104.5)
    * *Intent:* %======================================================================= %==========================...
  * `get_bp` (Impact: 58.2)
    * *Intent:* %======================================================================= %==========================...
**Contextual Mitigations & Amplifications:**
