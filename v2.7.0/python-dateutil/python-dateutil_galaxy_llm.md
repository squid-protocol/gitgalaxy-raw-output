...
- `__init__` (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **466.0** | LOC: 254
- `_parse` (@ `python-dateutil-2.6.1/dateutil/parser.py`) -> Impact: **382.1** | LOC: 446
- `_parse_rfc` (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **166.8** | LOC: 111
- `_iter` (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **162.7** | LOC: 255
- `__init__` (@ `python-dateutil-2.6.1/dateutil/relativedelta.py`) -> Impact: **159.7** | LOC: 125
- `parse` (@ `python-dateutil-2.6.1/dateutil/parser.py`) -> Impact: **113.3** | LOC: 152
- `rebuild` (@ `python-dateutil-2.6.1/dateutil/rrule.py`) -> Impact: **94.5** | LOC: 129
...
- `parse` (@ `python-dateutil-2.6.1/dateutil/parser.py`) -> Impact: **93.7** | LOC: 127
...
- `resolve_ymd` (@ `python-dateutil-2.6.1/dateutil/parser.py`) -> Impact: **90.9** | LOC: 73
- `_read_tzfile` (@ `python-dateutil-2.6.1/dateutil/tz/tz.py`) -> Impact: **82.0** | LOC: 219
...
- **Heaviest Functions:** `_read_tzfile` (Impact: 82.0), `_parse_rfc` (Impact: 80.3), `gettz` (Impact: 44.6)
...
- **Heaviest Functions:** `__init__` (Impact: 159.7), `__add__` (Impact: 70.1), `__eq__` (Impact: 46.3)
...
- **Heaviest Functions:** `_parse` (Impact: 382.1), `parse` (Impact: 113.3), `parse` (Impact: 93.7)
...
- **Heaviest Functions:** `__init__` (Impact: 466.0), `_parse_rfc` (Impact: 166.8), `_iter` (Impact: 162.7)
...
- **Heaviest Functions:** `__init__` (Impact: 17.1), `gettz` (Impact: 7.5), `get_zonefile_instance` (Impact: 7.0)
...
- **Heaviest Functions:** `fromutc` (Impact: 13.7), `_isdst` (Impact: 13.1), `_fromutc` (Impact: 8.7)
...
- **Heaviest Functions:** `__eq__` (Impact: 23.4), `valuestodict` (Impact: 12.5), `picknthweekday` (Impact: 5.9)
...
- **Heaviest Functions:** `__eq__` (Impact: 5.5), `__call__` (Impact: 5.4), `__repr__` (Impact: 4.5)
...
- **Heaviest Functions:** `rebuild` (Impact: 11.2), `_print_on_nosuchfile` (Impact: 6.2)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 466.0)
  * `_parse_rfc` (Impact: 166.8)
  * `_iter` (Impact: 162.7)
  * `rebuild` (Impact: 94.5)
...
**Top Internal Functions/Classes:**
  ...
  * `resolve_ymd` (Impact: 90.9)
  * `get_token` (Impact: 64.8)
...
**Top Internal Functions/Classes:**
  * `_read_tzfile` (Impact: 82.0)
  * `_parse_rfc` (Impact: 80.3)
  * `gettz` (Impact: 44.6)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 159.7)
  * `__add__` (Impact: 70.1)
  * `__eq__` (Impact: 46.3)
  * `__sub__` (Impact: 34.3)
  * `__bool__` (Impact: 23.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_print_on_nosuchfile` (Impact: 6.2)
