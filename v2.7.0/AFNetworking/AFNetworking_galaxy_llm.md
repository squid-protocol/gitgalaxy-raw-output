...
| Avg Path Length | 2.6416 | Hops between files. Lower = Tighter coupling. |
...
- `downloadImageForURLRequest` (@ `UIKit+AFNetworking/AFImageDownloader.m`) -> Impact: **57.2** | LOC: 115
- `evaluateServerTrust` (@ `AFNetworking/AFSecurityPolicy.m`) -> Impact: **47.0** | LOC: 74
  * *Intent:* #pragma mark -
- `URLSession` (@ `AFNetworking/AFURLSessionManager.m`) -> Impact: **45.8** | LOC: 75
  * *Intent:* #pragma mark - NSURLSessionTaskDelegate
- `AFInflatedImageFromResponseWithDataAtScale` (@ `AFNetworking/AFURLResponseSerialization.m`) -> Impact: **44.5** | LOC: 91
- `URLSession` (@ `AFNetworking/AFURLSessionManager.m`) -> Impact: **42.5** | LOC: 46
- `setImageWithURLRequest` (@ `UIKit+AFNetworking/UIImageView+AFNetworking.m`) -> Impact: **36.9** | LOC: 68
- `requestBySerializingRequest` (@ `AFNetworking/AFURLRequestSerialization.m`) -> Impact: **36.6** | LOC: 53
  * *Intent:* #pragma mark - AFURLRequestSerialization
- `setImageForState` (@ `UIKit+AFNetworking/UIButton+AFNetworking.m`) -> Impact: **34.8** | LOC: 60
- `setBackgroundImageForState` (@ `UIKit+AFNetworking/UIButton+AFNetworking.m`) -> Impact: **34.8** | LOC: 60
- `validateResponse` (@ `AFNetworking/AFURLResponseSerialization.m`) -> Impact: **32.5** | LOC: 50
  * *Intent:* #pragma mark -
...
- **Heaviest Functions:** `updateCurrentStateForNetworkActivityChange` (Impact: 11.2), `setCurrentState` (Impact: 11.1), `setNetworkActivityIndicatorVisible` (Impact: 6.3)
...
- **Heaviest Functions:** `requestBySerializingRequest` (Impact: 36.6), `multipartFormRequestWithMethod` (Impact: 26.3), `requestWithMultipartFormRequest` (Impact: 22.6)
...
- **Heaviest Functions:** `loadRequest` (Impact: 30.5), `loadRequest` (Impact: 10.9), `sessionManager` (Impact: 2.5)
...
- **Heaviest Functions:** `AFInflatedImageFromResponseWithDataAtScale` (Impact: 44.5), `validateResponse` (Impact: 32.5), `AFJSONObjectByRemovingKeysWithNullValues` (Impact: 25.5)
...
- **Heaviest Functions:** `addImage` (Impact: 10.4), `initWithMemoryCapacity` (Impact: 4.4), `initWithImage` (Impact: 4.1)
...
- **Heaviest Functions:** `AFNetworkReachabilityStatusForFlags` (Impact: 15.2), `AFStringFromNetworkReachabilityStatus` (Impact: 10.5), `manager` (Impact: 6.8)
...
- **Heaviest Functions:** `downloadImageForURLRequest` (Impact: 57.2), `cancelTaskForImageDownloadReceipt` (Impact: 7.0), `enqueueMergedTask` (Impact: 6.2)
...
- **Heaviest Functions:** `observeValueForKeyPath` (Impact: 26.6), `setProgressWithUploadProgressOfTask` (Impact: 4.1), `setProgressWithDownloadProgressOfTask` (Impact: 4.1)
...
- **Heaviest Functions:** `dataTaskWithHTTPMethod` (Impact: 29.1), `POST` (Impact: 27.4), `setSecurityPolicy` (Impact: 10.6)
...
- **Heaviest Functions:** `URLSession` (Impact: 45.8), `URLSession` (Impact: 42.5), `respondsToSelector` (Impact: 16.5)
