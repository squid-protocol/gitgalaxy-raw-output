...
| Avg Path Length | 4.0777 | Hops between files. Lower = Tighter coupling. |
...
- `_PSIComputePositionExtents` (@ `src/algo/blast/core/blast_psi_priv.c`) -> Impact: **627.5** | LOC: 1791
- `Blast_RedoAlignmentCore_MT` (@ `src/algo/blast/core/blast_kappa.c`) -> Impact: **503.1** | LOC: 942
  * *Intent:* /** * Recompute alignments for each match found by the gapped BLAST * algorithm. */
- `_PSIGetAlignedSequencesForPosition` (@ `src/algo/blast/core/blast_psi_priv.c`) -> Impact: **479.7** | LOC: 1274
- `s_OutOfFrameAlignWithTraceback` (@ `src/algo/blast/core/blast_gapalign.c`) -> Impact: **431.7** | LOC: 598
...
- `BlastNaExtendJumper` (@ `src/algo/blast/core/jumper.c`) -> Impact: **410.0** | LOC: 568
  * *Intent:* /* for mapping this may only work if we hash genome and scan reads */
- `x_ProcessOneOption` (@ `src/algo/blast/api/blast_options_builder.cpp`) -> Impact: **380.5** | LOC: 405
- `Blast_TracebackFromHSPList` (@ `src/algo/blast/core/blast_traceback.c`) -> Impact: **362.2** | LOC: 466
  * *Intent:* */
- `s_BlastEvenGapLinkHSPs` (@ `src/algo/blast/core/link_hsps.c`) -> Impact: **353.5** | LOC: 678
...
- `BLAST_GetGappedScore` (@ `src/algo/blast/core/blast_gapalign.c`) -> Impact: **337.0** | LOC: 455
- `CIgBlast::x_FindDJAln` (@ `src/algo/blast/igblast/igblast.cpp`) -> Impact: **303.8** | LOC: 195
  * *Intent:* */
...
- **Heaviest Functions:** `NON_CONST_ITERATE` (Impact: 38.9), `CBlastNodeInputReader::GetQueryBatch` (Impact: 27.9), `CBlastMasterNode::Processing` (Impact: 21.1)
...
- **Heaviest Functions:** `LocalMaxStatUtil::descendingLadderEpochRepeat` (Impact: 138.2), `LocalMaxStatUtil::flatten` (Impact: 49.3), `LocalMaxStatUtil::isLogarithmic` (Impact: 10.7)
...
- **Heaviest Functions:** `CIgBlastArgs::ExtractAlgorithmOptions` (Impact: 106.2), `CBlastDatabaseArgs::ExtractAlgorithmOptions` (Impact: 106.1), `s_SetCompositionBasedStats` (Impact: 97.1)
...
- **Heaviest Functions:** `CCddInputData::CHit::Subtract` (Impact: 38.0), `CCddInputData::CHit::IntersectWith` (Impact: 32.1), `CCddInputData::x_ValidateMsa` (Impact: 13.8)
...
- **Heaviest Functions:** `LookupTableOptionsValidate` (Impact: 131.5), `BlastScoringOptionsValidate` (Impact: 62.6), `s_BlastExtensionScoringOptionsValidate` (Impact: 52.0)
...
- **Heaviest Functions:** `CCmdLineBlastXMLReportData::x_Init` (Impact: 39.6), `CCmdLineBlastXMLReportData::x_FillScoreMatrix` (Impact: 39.3), `CCmdLineBlastXMLReportData::GetLambda` (Impact: 7.9)
...
- **Heaviest Functions:** `x_ProcessOneOption` (Impact: 380.5), `CBlastOptionsBuilder::ComputeProgram` (Impact: 61.0), `CBlastOptionsBuilder::AdjustProgram` (Impact: 37.0)
...
- **Heaviest Functions:** `Nlm_SolveLtriangPosDef` (Impact: 11.3), `Nlm_DenseMatrixNew` (Impact: 9.8), `Nlm_FactorLtriangPosDef` (Impact: 9.8)
...
- **Heaviest Functions:** `VDBSRC_FormatErrorMsg` (Impact: 65.2), `VDBSRC_InitErrorMsgWithContext` (Impact: 10.1), `VDBSRC_InitErrorMsg` (Impact: 4.8)
...
- **Heaviest Functions:** `Blast_GetOneQueryStructs` (Impact: 30.0), `BSearchContextInfo` (Impact: 15.1), `BlastQueryInfoGetQueryLength` (Impact: 14.9)
...
**Top Internal Functions/Classes:**
  * `BlastNaExtendJumper` (Impact: 410.0)
    * *Intent:* /* for mapping this may only work if we hash genome and scan reads */
  * `JumperExtendRightCompressedWithTracebackOptimal` (Impact: 243.9)
    * *Intent:* } /* JumperExtendRightCompressedWithTraceback */
  * `JumperExtendLeftCompressedWithTracebackOptimal` (Impact: 214.1)
    * *Intent:* } /* JumperExtendLeftCompressedWithTraceback */
  * `JumperExtendRightCompressedWithTraceback` (Impact: 210.9)
    * *Intent:* } /* JumperExtendRightCompressed */
  * `DoAnchoredScan` (Impact: 192.9)
...
**Top Internal Functions/Classes:**
  * `Blast_HSPListsMerge` (Impact: 128.9)
  * `Blast_HSPReevaluateWithAmbiguitiesGapped` (Impact: 98.5)
  * `Blast_HSPListReevaluateUngapped` (Impact: 89.6)
  * `s_Blast_HSPGetOOFNumIdentitiesAndPositives` (Impact: 82.5)
    * *Intent:* /** Calculate number of identities in an HSP for an out-of-frame alignment. * @param query The query...
  * `s_Blast_HSPGetNumIdentitiesAndPositives` (Impact: 81.0)
...
**Top Internal Functions/Classes:**
  * `_PSIComputePositionExtents` (Impact: 627.5)
  * `_PSIGetAlignedSequencesForPosition` (Impact: 479.7)
  * `_PSISaveDiagnostics` (Impact: 83.5)
    * *Intent:* /****************************************************************************/
  * `_PSIScaleMatrix` (Impact: 66.2)
    * *Intent:* */
  * `_PSIComputeFreqRatios` (Impact: 65.0)
...
**Top Internal Functions/Classes:**
  * `CIgBlast::x_FindDJAln` (Impact: 303.8)
    * *Intent:* */
...
**Top Internal Functions/Classes:**
  * `alp_sim::calculate_main_parameters2m` (Impact: 198.0)
  * `alp_sim::alp_sim` (Impact: 175.8)
  * `alp_sim::get_minimal_simulation` (Impact: 101.5)
  * `alp_sim::calculate_FSC` (Impact: 95.4)
  * `alp_sim::calculate_C` (Impact: 56.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CIgBlastArgs::ExtractAlgorithmOptions` (Impact: 106.2)
  * `CBlastDatabaseArgs::ExtractAlgorithmOptions` (Impact: 106.1)
  ...
  * `CFormattingArgs::ParseFormattingString` (Impact: 70.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 6 instances
...
**Top Internal Functions/Classes:**
  * `Blast_TracebackFromHSPList` (Impact: 362.2)
    * *Intent:* */
  * `BLAST_ComputeTraceback_MT` (Impact: 230.3)
  * `s_RPSComputeTraceback` (Impact: 157.7)
    * *Intent:* * @param rps_info Extra information about RPS database. [in] * @param results Results structure cont...
  * `s_PHITracebackFromHSPList` (Impact: 50.4)
    * *Intent:* /** Performs traceback alignment for one HSP list in a PHI BLAST search. * @param program_number eBl...
  * `Blast_RunTracebackSearchWithInterrupt` (Impact: 37.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `handle_megablast` (Impact: 154.7)
  * `handle_blastpgp` (Impact: 128.7)
  * `handle_blastall` (Impact: 128.2)
    * *Intent:* # Handle the conversion from blastall arguments to the corresponding C++ # binaries
  * `handle_bl2seq` (Impact: 91.5)
    * *Intent:* # Tested: all conversions should work
  * `handle_seedtop` (Impact: 76.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CBlastFormat::PrintOneResultSet` (Impact: 207.8)
  * `CBlastFormat::PrintOneResultSet` (Impact: 107.0)
  * `CBlastFormat::PrintPhiResult` (Impact: 83.5)
  * `CBlastFormat::CBlastFormat` (Impact: 75.1)
  * `CBlastFormat::PrintEpilog` (Impact: 48.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `BLAST_TranslateCompressedSequence` (Impact: 120.2)
    * *Intent:* */
  * `BLAST_GetAllTranslations` (Impact: 61.3)
  * `BlastProgram2Number` (Impact: 45.0)
  * `Blast_GetPartialTranslation` (Impact: 40.2)
  * `BLAST_ContextToFrame` (Impact: 36.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `LookupTableOptionsValidate` (Impact: 131.5)
  * `BlastScoringOptionsValidate` (Impact: 62.6)
  * `s_BlastExtensionScoringOptionsValidate` (Impact: 52.0)
    * *Intent:* /** Checks that the extension and scoring options are consistent with each other * @param program_nu...
  * `BLAST_ValidateOptions` (Impact: 51.3)
  * `BLAST_GetSuggestedThreshold` (Impact: 43.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `GiListOidRange` (Impact: 38.1)
  * `OidRanges` (Impact: 32.6)
  * `s_TestMaskingLimits` (Impact: 31.2)
  * `s_MaskingTest` (Impact: 29.7)
  * `ComplexComputedList` (Impact: 28.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `BLAST_PreliminarySearchEngine` (Impact: 213.1)
  * `s_BlastSearchEngineCore` (Impact: 204.7)
    * *Intent:* * @param word_params Initial word finding and ungapped extension * parameters [in] * @param ext_para...
  * `s_BlastSearchEngineOneContext` (Impact: 132.7)
    * *Intent:* * @param word_params Initial word finding and ungapped extension * parameters [in] * @param ext_para...
  * `s_BlastSetUpAuxStructures` (Impact: 83.0)
    * *Intent:* /** Setup of the auxiliary BLAST structures; * also calculates internally used parameters from optio...
  * `s_RPSPreliminarySearchEngine` (Impact: 49.6)
...
**Top Internal Functions/Classes:**
  * `SetupQueries_OMF` (Impact: 96.1)
  * `SetupQueryInfo_OMF` (Impact: 82.1)
  * `s_SeqLoc2MaskedSubjRanges` (Impact: 72.9)
  * `SetupSubjects_OMF` (Impact: 53.5)
  * `CBlastQueryFilteredFrames::x_VerifyFrame` (Impact: 44.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 2 instances
...
**Top Internal Functions/Classes:**
  * `ITERATE` (Impact: 37.5)
  * `CRemoteBlast::x_PollUntilDone` (Impact: 34.2)
    * *Intent:* // not know how long it has been since the request was submitted. In // this case, we check the resu...
  * `CRemoteBlast::x_SearchErrors` (Impact: 29.3)
  * `ExtractBlast4Request` (Impact: 29.2)
  * `CRemoteBlast::GetResultSet` (Impact: 23.8)
...
- `src/algo/blast/gumbel_params/sls_alp_data.hpp` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 99.9992%)
- `src/algo/blast/gumbel_params/njn_matrix.hpp` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.9996%)
- `src/algo/blast/gumbel_params/njn_root.hpp` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.9665%)
