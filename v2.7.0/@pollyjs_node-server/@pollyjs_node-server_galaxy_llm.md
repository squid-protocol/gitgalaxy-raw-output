...
- `listen` (@ `package/types.d.ts`) -> Impact: **5.2** | LOC: 1
- `constructor` (@ `package/src/server.js`) -> Impact: **3.7** | LOC: 18
- `respond` (@ `package/types.d.ts`) -> Impact: **3.5** | LOC: 1
- `getRecording` (@ `package/src/api.js`) -> Impact: **3.3** | LOC: 9
- `deleteRecording` (@ `package/src/api.js`) -> Impact: **3.3** | LOC: 9
- `prependSlash` (@ `package/src/express/register-api.js`) -> Impact: **3.2** | LOC: 7
- `constructor` (@ `package/types.d.ts`) -> Impact: **2.9** | LOC: 1
...
- **Heaviest Functions:** `listen` (Impact: 15.3), `constructor` (Impact: 3.7)
...
- **Heaviest Functions:** `registerAPI` (Impact: 7.3), `prependSlash` (Impact: 3.2)
...
- **Heaviest Functions:** `listen` (Impact: 5.2), `respond` (Impact: 3.5), `constructor` (Impact: 2.9)
...
**Top Internal Functions/Classes:**
  ...
  * `registerExpressAPI` (Impact: 1.9)
  * `saveRecording` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
