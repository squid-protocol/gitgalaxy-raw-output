...
- `.map`: 270x Excluded (Unsupported Extension: '.map'), 3x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir)
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 18.2 | 0.0 | 0.0 |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 20.1 | 21.5 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 62.2 | 100.0 | 100.0 |
...
| connectivity | 46402 | 17688 | 3 | `packages/next/src/compiled/@vercel/og/index.edge.js` |
...
| dead_code | 6789 | 3141 | 1 | `test/e2e/app-dir/monaco-editor/components/editor/monaco.ts` |
| credential | 137 | 67 | 0 | `packages/font/src/google/loader.test.ts` |
| threat | 8410 | 673 | 0 | `packages/next/src/compiled/@vercel/og/index.node.js` |
...
- `exports` (@ `packages/next/src/compiled/@vercel/og/index.node.js`) -> Impact: **4884.2** | LOC: 13091
- `exports` (@ `packages/next/src/compiled/@vercel/og/index.edge.js`) -> Impact: **4188.0** | LOC: 12087
- `Md` (@ `packages/next/src/compiled/@vercel/og/index.edge.js`) -> Impact: **1748.6** | LOC: 1031
- `_l` (@ `packages/next/src/compiled/@vercel/og/index.node.js`) -> Impact: **1748.6** | LOC: 1031
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom-experimental/cjs/react-dom-server.edge.production.js`) -> Impact: **1287.5** | LOC: 1084
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom/cjs/react-dom-server.edge.production.js`) -> Impact: **1287.5** | LOC: 1084
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom-experimental/cjs/react-dom-server.node.production.js`) -> Impact: **1286.7** | LOC: 1068
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom/cjs/react-dom-server.node.production.js`) -> Impact: **1286.7** | LOC: 1068
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom-experimental/cjs/react-dom-server-legacy.node.production.js`) -> Impact: **1286.5** | LOC: 1065
- `pushStartInstance` (@ `packages/next/src/compiled/react-dom/cjs/react-dom-server-legacy.node.production.js`) -> Impact: **1286.5** | LOC: 1065
...
### 1. `packages/next/src/server/app-render/create-flight-router-state-from-loader-tree.ts` (TYPESCRIPT) -> Cumulative Risk: **783.62**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 163.42 | **LOC:** 196 | **CtrlFlow:** 19.9% | **Authorship Centralization:** 80.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9987%), Tech Debt (92.7788%)
- **Heaviest Functions:** `createFlightRouterStateFromLoaderTreeImpl` (Impact: 93.9), `createFlightRouterStateFromLoaderTree` (Impact: 3.9), `createRouteTreePrefetch` (Impact: 3.8)

### 2. `packages/next/src/compiled/@babel/runtime/helpers/wrapAsyncGenerator.js` (JAVASCRIPT) -> Cumulative Risk: **759.61**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 93.88 | **LOC:** 69 | **CtrlFlow:** 23.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `AsyncGenerator` (Impact: 22.4), `resume` (Impact: 13.1), `settle` (Impact: 11.3)

### 3. `packages/next/src/server/dev/hot-reloader-turbopack.ts` (TYPESCRIPT) -> Cumulative Risk: **757.84**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1796.66 | **LOC:** 1874 | **CtrlFlow:** 17.1% | **Authorship Centralization:** 28.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (99.995%), Cognitive Load (97.6893%), Documentation (97.4359%)
- **Heaviest Functions:** `createHotReloaderTurbopack` (Impact: 700.0), `onHMR` (Impact: 112.4), `clearRequireCache` (Impact: 61.3)

### 4. `packages/next/src/compiled/react-dom-experimental/cjs/react-dom-server.node.production.js` (JAVASCRIPT) -> Cumulative Risk: **754.75**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `pushStartInstance` (Impact: 1286.7), `renderElement` (Impact: 505.7), `pushAttribute` (Impact: 240.9)

### 5. `packages/next/src/compiled/react-dom/cjs/react-dom-server.node.production.js` (JAVASCRIPT) -> Cumulative Risk: **753.53**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 8318.06 | **LOC:** 7927 | **CtrlFlow:** 25.5% | **Authorship Centralization:** 91.2%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%)
- **Heaviest Functions:** `pushStartInstance` (Impact: 1286.7), `renderElement` (Impact: 482.5), `pushAttribute` (Impact: 232.4)

### 6. `packages/next/src/compiled/@babel/runtime/helpers/esm/wrapAsyncGenerator.js` (JAVASCRIPT) -> Cumulative Risk: **751.53**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 87.88 | **LOC:** 69 | **CtrlFlow:** 23.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `AsyncGenerator` (Impact: 22.4), `resume` (Impact: 13.1), `settle` (Impact: 11.3)

### 7. `packages/next/src/server/next.ts` (TYPESCRIPT) -> Cumulative Risk: **749.71**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 466.82 | **LOC:** 623 | **CtrlFlow:** 19.6% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (96.2963%), State Flux (93.8911%)
- **Heaviest Functions:** `render404` (Impact: 57.5), `createServer` (Impact: 50.2), `setupWebSocketHandler` (Impact: 14.6)

### 8. `packages/next/src/server/lib/router-utils/filesystem.ts` (TYPESCRIPT) -> Cumulative Risk: **747.09**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 577.28 | **LOC:** 746 | **CtrlFlow:** 19.0% | **Authorship Centralization:** 80.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.8343%), Concurrency (99.5124%)
- **Heaviest Functions:** `setupFsCheck` (Impact: 183.2), `getItem` (Impact: 109.7), `middlewareMatcher` (Impact: 46.2)

### 9. `packages/next/src/server/lib/router-server.ts` (TYPESCRIPT) -> Cumulative Risk: **744.75**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 845.26 | **LOC:** 935 | **CtrlFlow:** 24.7% | **Authorship Centralization:** 30.8%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.957%)
- **Heaviest Functions:** `initialize` (Impact: 298.6), `handleRequest` (Impact: 165.4), `invokeRender` (Impact: 41.6)

### 10. `packages/next/src/bundles/webpack/packages/HotModuleReplacement.runtime.js` (JAVASCRIPT) -> Cumulative Risk: **744.22**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 512.16 | **LOC:** 408 | **CtrlFlow:** 18.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9999%)
- **Heaviest Functions:** `exports` (Impact: 85.5), `createModuleHotObject` (Impact: 57.3), `accept` (Impact: 22.6)
...
- **Risk Profile:** Cognitive Load (92.9801%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `setProp` (Impact: 559.7)
  * `diffHydratedProperties` (Impact: 504.0)
  * `updateClassComponent` (Impact: 497.8)
  * `dispatchEventForPluginEventSystem` (Impact: 487.9)
  * `completeWork` (Impact: 484.6)
...
* *Network Topology:*
  * `Ecosystem Role:` Pure Producer (Foundation) | `Dependency Blast Radius (PageRank):` 0.321
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (14.2975%)
**Top Internal Functions/Classes:**
  * `exports` (Impact: 4884.2)
  * `_l` (Impact: 1748.6)
  * `ci` (Impact: 266.4)
  * `tr` (Impact: 152.8)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (14.8988%)
**Top Internal Functions/Classes:**
  * `exports` (Impact: 4188.0)
  * `Md` (Impact: 1748.6)
  * `Ji` (Impact: 266.4)
  * `zr` (Impact: 152.8)
  * `exports` (Impact: 150.1)
...
- **Risk Profile:** Cognitive Load (79.4195%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dispatchEventForPluginEventSystem` (Impact: 484.1)
  * `setProp` (Impact: 432.0)
  * `updateProperties` (Impact: 372.6)
  * `commitMutationEffectsOnFiber` (Impact: 350.1)
  * `setInitialProperties` (Impact: 281.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (81.3747%), Tech Debt (8.3268%)
**Top Internal Functions/Classes:**
  * `dispatchEventForPluginEventSystem` (Impact: 484.1)
  * `setProp` (Impact: 432.0)
  * `updateProperties` (Impact: 372.6)
  * `commitMutationEffectsOnFiber` (Impact: 303.2)
  * `setInitialProperties` (Impact: 281.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 13 instances
...
- **Risk Profile:** Cognitive Load (80.8146%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dispatchEventForPluginEventSystem` (Impact: 484.1)
  * `setProp` (Impact: 432.0)
  * `updateProperties` (Impact: 372.6)
...
- **Risk Profile:** Cognitive Load (78.6039%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dispatchEventForPluginEventSystem` (Impact: 465.4)
  * `setProp` (Impact: 418.2)
  * `updateProperties` (Impact: 372.6)
  * `commitMutationEffectsOnFiber` (Impact: 345.9)
  * `commitPassiveMountOnFiber` (Impact: 254.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (80.0294%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dispatchEventForPluginEventSystem` (Impact: 465.4)
  * `setProp` (Impact: 418.2)
  * `updateProperties` (Impact: 372.6)
  * `commitMutationEffectsOnFiber` (Impact: 299.0)
  * `setInitialProperties` (Impact: 221.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 12 instances
...
- **Risk Profile:** Cognitive Load (11.8701%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (10.2736%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (17.8702%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1261.4)
  * `renderElement` (Impact: 852.1)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 258.1)
  * `flushCompletedQueues` (Impact: 172.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.8912%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1261.4)
  * `renderElement` (Impact: 821.9)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 258.1)
  * `flushCompletedQueues` (Impact: 171.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 19 instances
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.3462%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1255.2)
  * `renderElement` (Impact: 852.1)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 258.5)
  * `flushCompletedQueues` (Impact: 172.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 19 instances
* *Amplified Race Conditions:* 29 instances
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.369%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1255.2)
  * `renderElement` (Impact: 852.1)
  * `validateProperty` (Impact: 327.4)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (18.386%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1261.4)
  * `renderElement` (Impact: 859.0)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 249.7)
  * `flushCompletedQueues` (Impact: 138.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.7373%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1255.2)
  * `renderElement` (Impact: 859.0)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 250.1)
  * `flushCompletedQueues` (Impact: 138.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 18 instances
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.7564%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1255.2)
  * `renderElement` (Impact: 859.0)
  * `validateProperty` (Impact: 327.4)
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.3202%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1261.4)
  * `renderElement` (Impact: 798.4)
  * `validateProperty` (Impact: 327.4)
  * `pushAttribute` (Impact: 249.7)
  * `flushCompletedQueues` (Impact: 133.2)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 18 instances
...
- **Risk Profile:** Cognitive Load (15.8497%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 8676.96 | **LOC:** 8249 | **CtrlFlow:** 25.5% | **Authorship Centralization:** 91.2%
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (37.3169%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1286.7)
  * `renderElement` (Impact: 505.7)
  * `pushAttribute` (Impact: 240.9)
  * `flushCompletedQueues` (Impact: 137.0)
  * `retryNode` (Impact: 115.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (22.8685%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1287.5)
  * `renderElement` (Impact: 505.7)
  * `pushAttribute` (Impact: 241.3)
  * `flushCompletedQueues` (Impact: 137.0)
  * `retryNode` (Impact: 115.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 16 instances
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 8318.06 | **LOC:** 7927 | **CtrlFlow:** 25.5% | **Authorship Centralization:** 91.2%
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (39.2094%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1286.7)
  * `renderElement` (Impact: 482.5)
  * `pushAttribute` (Impact: 232.4)
  * `flushCompletedQueues` (Impact: 112.8)
  * `finishedTask` (Impact: 102.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (100.0%), Tech Debt (15.6873%)
**Top Internal Functions/Classes:**
  * `pushStartInstance` (Impact: 1286.5)
  * `renderElement` (Impact: 445.1)
  * `flushCompletedBoundary` (Impact: 202.6)
  * `flushCompletedQueues` (Impact: 141.9)
  * `retryNode` (Impact: 113.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 16 instances
* *Amplified Race Conditions:* 22 instances
* *Amplified Cascading Flux:* 1108 instances
...
- `packages/next/src/server/route-modules/app-page/module.ts` -> **Severity: 0.063** (Bridge: 0.0007 * Flux: 96.4325%)
- `packages/next/src/shared/lib/router/router.ts` -> **Severity: 0.056** (Bridge: 0.0006 * Flux: 100.0%)
- `packages/next/src/server/base-server.ts` -> **Severity: 0.042** (Bridge: 0.0004 * Flux: 99.396%)
- `packages/next/src/server/route-modules/route-module.ts` -> **Severity: 0.041** (Bridge: 0.0004 * Flux: 90.5956%)
- `packages/next/src/shared/lib/router/utils/get-dynamic-param.ts` -> **Severity: 0.041** (Bridge: 0.0004 * Flux: 100.0%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `test/lib/next-test-utils.ts` -> **Severity: 2408.933** (Blast Radius: 26.164 * Doc Risk: 92.0705%)
- `turbopack/crates/turbo-tasks-fs/src/embed/fs.rs` -> **Severity: 1479.7** (Blast Radius: 14.797 * Doc Risk: 100.0%)
- `packages/next/src/server/request/draft-mode.ts` -> **Severity: 641.507** (Blast Radius: 7.402 * Doc Risk: 86.6667%)
- `packages/next/src/server/web/spec-extension/user-agent.ts` -> **Severity: 633.1** (Blast Radius: 6.331 * Doc Risk: 100.0%)
- `test/lib/next-webdriver.ts` -> **Severity: 468.428** (Blast Radius: 10.93 * Doc Risk: 42.8571%)
