...
| Avg Path Length | 3.9494 | Hops between files. Lower = Tighter coupling. |
...
|---|---|---|---|---|
| memory | 487 | 81 | 2 | `cpp/cobolcraft_util.cpp` |
...
| ml_ai | 55 | 17 | 0 | `src/world/blocks.cob` |
| ui | 0 | 0 | 0 | - |
...
- `OpenFile` (@ `src/region.cob`) -> Impact: **82.5** | LOC: 511
- `LoadChunkEntities` (@ `src/world/chunk-io.cob`) -> Impact: **69.6** | LOC: 392
- `CHAR-ALPHA` (@ `src/encoding/json-parse.cob`) -> Impact: **57.5** | LOC: 251
- `INVENTORY-SLOT` (@ `src/players/player-io.cob`) -> Impact: **56.5** | LOC: 189
- `PATTERN-SLOTS` (@ `src/parsers/recipe/shaped.cob`) -> Impact: **52.5** | LOC: 149
- `InsertEntry` (@ `src/datapack.cob`) -> Impact: **47.2** | LOC: 205
- `AssertOk` (@ `codegen/generators/blocks_loot_table.cob`) -> Impact: **43.7** | LOC: 214
- `CHAR-ALPHA` (@ `src/encoding/json-parse.cob`) -> Impact: **40.8** | LOC: 196
- `PARTS` (@ `src/commands.cob`) -> Impact: **38.8** | LOC: 235
- `GenerateFunctions` (@ `codegen/generators/blocks_loot_table.cob`) -> Impact: **38.1** | LOC: 103
...
- **Heaviest Functions:** `LK-ENTITY` (Impact: 12.6), `LK-ENTITY` (Impact: 11.1), `LK-ENTITY` (Impact: 7.0)
...
- **Heaviest Functions:** `InsertEntry` (Impact: 47.2), `ExpandTag` (Impact: 10.2), `ExpandOtherTag` (Impact: 3.5)
...
- **Heaviest Functions:** `SocketRead` (Impact: 21.5), `ZlibCompress` (Impact: 19.9), `ZlibDecompress` (Impact: 19.9)
...
- **Heaviest Functions:** `ServerLoop` (Impact: 29.4), `HandleServerError` (Impact: 28.9), `ReceivePacket` (Impact: 13.9)
...
- **Heaviest Functions:** `INGREDIENT-CHOICE-COMBINED-IDS` (Impact: 27.6), `ParseIngredients` (Impact: 25.7), `INGREDIENT-IDS` (Impact: 2.4)
...
- **Heaviest Functions:** `MatchShapedRecipes` (Impact: 19.6), `LK-INVENTORY` (Impact: 14.0), `TEMP-SLOT` (Impact: 12.6)
...
- **Heaviest Functions:** `LoadChunkEntities` (Impact: 69.6), `SaveChunkRegion` (Impact: 34.5), `LoadChunkRegion` (Impact: 27.7)
...
- **Heaviest Functions:** `PATTERN-SLOTS` (Impact: 52.5), `ParseKey` (Impact: 26.4), `ParsePattern` (Impact: 7.2)
...
- **Heaviest Functions:** `CURSOR-POS` (Impact: 13.7), `LOCATION` (Impact: 1.2)
...
- **Heaviest Functions:** `INVENTORY-SLOT` (Impact: 56.5)
...
**Top Internal Functions/Classes:**
  * `AssertOk` (Impact: 43.7)
  * `GenerateFunctions` (Impact: 38.1)
  * `AssertOk` (Impact: 31.9)
  * `ReplaceBody` (Impact: 17.8)
  * `AssertOk` (Impact: 17.4)
...
**Top Internal Functions/Classes:**
  * `SocketRead` (Impact: 21.5)
  * `ZlibCompress` (Impact: 19.9)
  * `ZlibDecompress` (Impact: 19.9)
  * `GzipCompress` (Impact: 19.9)
  * `GzipDecompress` (Impact: 19.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CHAR-ALPHA` (Impact: 57.5)
  * `CHAR-ALPHA` (Impact: 40.8)
  * `CHAR-ALPHA` (Impact: 7.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `InsertEntry` (Impact: 47.2)
  * `ExpandTag` (Impact: 10.2)
  * `ExpandOtherTag` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ServerLoop` (Impact: 29.4)
  * `HandleServerError` (Impact: 28.9)
  * `ReceivePacket` (Impact: 13.9)
  * `NetworkRead` (Impact: 10.5)
  * `RegisterItems` (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
**Top Internal Functions/Classes:**
  ...
  * `AtEnd` (Impact: 2.4)
  * `Basic` (Impact: 1.6)
  * `WithinCompound` (Impact: 1.5)
  * `NestedCompound` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `PATTERN-SLOTS` (Impact: 52.5)
  * `ParseKey` (Impact: 26.4)
  * `ParsePattern` (Impact: 7.2)
  * `PATTERN-KEYS` (Impact: 3.4)
    * *Intent:* *> key
  * `PATTERN-TEXT` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  * `LK-ENTITY` (Impact: 12.6)
  * `LK-ENTITY` (Impact: 11.1)
  * `LK-ENTITY` (Impact: 7.0)
    * *Intent:* *> The entity data. ID, UUID, and some internal data will be set by this program.
  * `SendMetadata` (Impact: 6.8)
  * `LK-VELOCITY` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Simple` (Impact: 1.6)
  * `HelloWorld` (Impact: 1.5)
  * `WikiVgExample` (Impact: 1.5)
  * `Empty` (Impact: 1.5)
  * `ByteMin` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `MatchShapedRecipes` (Impact: 19.6)
  * `LK-INVENTORY` (Impact: 14.0)
  * `TEMP-SLOT` (Impact: 12.6)
  * `LK-ITEM` (Impact: 10.2)
  * `FindEmptySlot` (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `NegativeMax` (Impact: 1.6)
  * `ByteNegative128` (Impact: 1.4)
  * `ShortMax` (Impact: 1.4)
  * `ShortMin` (Impact: 1.4)
  * `IntMax` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `LK-BLOCK-ENTITIES` (Impact: 32.0)
  * `LK-SECTIONS` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `NamedString` (Impact: 1.6)
  * `NamedByte` (Impact: 1.5)
  * `NamedShort` (Impact: 1.5)
  * `NamedInt` (Impact: 1.5)
  * `Basic` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `BYTE-ALPHA` (Impact: 10.5)
  * `LK-VALUE` (Impact: 6.4)
  * `LK-SLOT` (Impact: 5.8)
  * `VALUE-BYTES` (Impact: 4.2)
  * `VALUE-BYTES` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `HandleHitGround` (Impact: 15.9)
  * `LK-FLAGS` (Impact: 11.7)
  * `BuildDeathMessage` (Impact: 6.7)
  * `PickDamageSound` (Impact: 5.7)
  * `TickPlayer` (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 30 instances
...
**Top Internal Functions/Classes:**
  * `LK-POSITION` (Impact: 16.1)
  * `LK-POSITION` (Impact: 9.2)
  * `LK-POSITION` (Impact: 6.5)
  * `LK-BLOCK-ENTITY` (Impact: 4.2)
  * `LK-POSITION` (Impact: 3.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `AppendKeyValue` (Impact: 1.7)
  * `AppendNewline` (Impact: 1.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 32 instances
...
**Top Internal Functions/Classes:**
  * `BYTE-ALPHA` (Impact: 14.8)
  * `LK-VALUE-IN` (Impact: 8.7)
  * `VALUE-BYTES` (Impact: 2.8)
  * `LK-SLOT` (Impact: 2.8)
  * `VALUE-BYTES` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
