...
- `stringify` (@ `force-app/main/default/staticresources/highlight/prism.js`) -> Impact: **86.6** | LOC: 243
...
- `insertBefore` (@ `force-app/main/default/staticresources/highlight/prism.js`) -> Impact: **24.1** | LOC: 35
...
- `DFS` (@ `force-app/main/default/staticresources/highlight/prism.js`) -> Impact: **23.8** | LOC: 28
  * *Intent:* // Traverse a language definition with Depth First Search
- `highlightElement` (@ `force-app/main/default/staticresources/highlight/prism.js`) -> Impact: **23.8** | LOC: 76
...
- `handleMethodCall` (@ `force-app/tests/Shared Code/ConnectApiWrapperMock.cls`) -> Impact: **18.3** | LOC: 49
- `createSObjectList` (@ `force-app/tests/Shared Code/TestFactory.cls`) -> Impact: **14.1** | LOC: 42
...
- `reduceErrors` (@ `force-app/main/default/lwc/ldsUtils/ldsUtils.js`) -> Impact: **12.9** | LOC: 32
...
- `toggleExpandNode` (@ `force-app/main/default/lwc/recipeTreeView/recipeTreeView.js`) -> Impact: **11.1** | LOC: 14
...
- **Heaviest Functions:** `toggleExpandNode` (Impact: 11.1), `isTreeNode` (Impact: 11.0), `handleTreeItemSelect` (Impact: 3.8)
...
- **Heaviest Functions:** `recipeFunc` (Impact: 6.2), `extractDescription` (Impact: 6.0), `highlightCodeSegment` (Impact: 4.5)
...
- **Heaviest Functions:** `loadDocumentation` (Impact: 3.8), `formatMarkdown` (Impact: 3.8), `clearMarkdown` (Impact: 2.2)
...
- **Heaviest Functions:** `stringify` (Impact: 86.6), `insertBefore` (Impact: 24.1), `DFS` (Impact: 23.8)
...
- **Heaviest Functions:** `mockFetch` (Impact: 3.6), `flushPromises` (Impact: 1.1)
...
- **Heaviest Functions:** `relatedClassesWireFunc` (Impact: 1.6), `testClassName` (Impact: 1.1)
...
- **Heaviest Functions:** `flushPromises` (Impact: 1.1)
...
- **Heaviest Functions:** `testQueueableWithCalloutRecipesPositive` (Impact: 3.4), `testQueuableWithCalloutNegativeDMLError` (Impact: 2.0), `makeData` (Impact: 1.2)
...
- **Heaviest Functions:** `mockFetch` (Impact: 1.8), `flushPromises` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `httpPatchUpdateAccountRecordsPositive` (Impact: 4.5)
  * `httpPutUpsertContactRecordsPositive` (Impact: 3.0)
  * `httpPatchUpdateAccountRecordsNegative` (Impact: 3.0)
  * `httpPatchUpdateAccountRecordsNegativeCatchException` (Impact: 3.0)
  * `httpPatchUpdateAccountRecordsNegativeNoAccess` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testDeleteAccountViaKeywordInSystemModePositive` (Impact: 3.0)
  * `testDeleteAccountViaKeywordInUserModePositive` (Impact: 3.0)
  * `testDeleteAccountViaDatabaseMethodInUserModePositive` (Impact: 3.0)
  * `testDeleteAccountViaDatabaseMethodInSystemModePositive` (Impact: 3.0)
  * `testInsertInSystemModePositive` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `testDoUpsertMethodsNoThrowPositive` (Impact: 5.8)
  * `testMarketingProfileGeneratesInsertExceptionPositive` (Impact: 3.0)
  * `testMarketingProfileGeneratesUpdateExceptionPositive` (Impact: 3.0)
  * `testMarketingProfileGeneratesUpsertExceptionPositive` (Impact: 3.0)
  * `testDoQueryThrowsRemovedFieldsException` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testGetAccountsAndContactsPositive` (Impact: 7.1)
  * `testProfileDeniesAccountAccessNegative` (Impact: 3.0)
  * `testQueryWithFilterNegativeNoPermsToAccountNegative` (Impact: 3.0)
  * `testGetAccountFilterByStatePositive` (Impact: 3.0)
  * `testgetSumOfOpportunityRecordsPositive` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testStripInaccessibleFromSubQueryMinAccessWithPermsetNegative` (Impact: 7.5)
  * `testStripInaccessibleFromQueryMinAccessWithPermsetNegative` (Impact: 6.0)
  * `testStripInaccessibleFromSubQueryMinAccessWithpermsetPositive` (Impact: 5.8)
  * `testStripInaccessibleFromUntrustedDataMinAccessWithPermSetPositive` (Impact: 4.5)
  * `testStripInaccessibleBeforeDMLMinAccessProfileNegative` (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `recipeFunc` (Impact: 6.2)
  * `extractDescription` (Impact: 6.0)
  * `highlightCodeSegment` (Impact: 4.5)
  * `loadPrism` (Impact: 4.0)
  * `githubUrl` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testBypassAPI` (Impact: 4.5)
    * *Intent:* // test bypass api
  * `testLoopCount` (Impact: 3.0)
    * *Intent:* // instance method tests
  * `testBeforeInsert` (Impact: 1.5)
    * *Intent:* /*************************************** * unit tests ***************************************/ // co...
  * `testBeforeUpdate` (Impact: 1.5)
  * `testBeforeDelete` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `loadDocumentation` (Impact: 3.8)
  * `formatMarkdown` (Impact: 3.8)
  * `clearMarkdown` (Impact: 2.2)
  * `applyStyleTo` (Impact: 2.1)
  * `renderedCallback` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `afterUpdateTestPositive` (Impact: 4.5)
  * `testBeforeUpdatePositive` (Impact: 3.5)
  * `afterInsertBulkTestPositive` (Impact: 3.4)
  * `testAfterInsertPositive` (Impact: 3.0)
  * `afterUpdateTestNegativeDMLException` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testRawCalloutNegative` (Impact: 3.5)
  * `insertAccountAndContactsFromUntypedResponsePositive` (Impact: 3.0)
  * `testRawCalloutPositive` (Impact: 2.0)
  * `httpGetCalloutToSecondSalesforceOrgPositive` (Impact: 2.0)
  * `httpGetCalloutToSecondSalesforceOrgNegative` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testEventPublishNegativeMinAccessUser` (Impact: 4.5)
  * `testEventPublishCallbackFailsWhenNoEventUuid` (Impact: 3.0)
  * `testEventPublishPositive` (Impact: 1.5)
  * `testEventPublishNegativeInvalidFields` (Impact: 1.5)
  * `testEventPublishCallbackSuccess` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 16
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `testQueueableWithCalloutRecipesPositive` (Impact: 3.4)
  * `testQueuableWithCalloutNegativeDMLError` (Impact: 2.0)
  * `makeData` (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
...
**Top Internal Functions/Classes:**
  * `testRemoveKeyFromSessionCacheNegativeNoKey` (Impact: 2.9)
  * `testRemoveKeyFromOrgCacheNegativeNoKey` (Impact: 2.9)
  * `testStoreValueInSessionCachePositive` (Impact: 1.5)
  * `testStoreValueInSessionCacheWithTTLPositive` (Impact: 1.5)
  * `testGetValueFromSessionCachePositive` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
**Top Internal Functions/Classes:**
  * `__global_context__` (Impact: 21.4)
...
**Top Internal Functions/Classes:**
  * `testGetWithPathAndQueryPositive` (Impact: 3.0)
    * *Intent:* /** * Convience, Instance Methods * These 6 methods are not utilized by our API service * class. */ ...
  * `testStaticMakeApiCallFullParamsPositive` (Impact: 2.4)
    * *Intent:* /** * Note: we do not have a constructor test for the no param * constructor. Because it's access mo...
  * `testStaticMakeApiCallNoHeadersoOrBodyParamsPositive` (Impact: 2.2)
  * `testStaticMakeApiCallNoHeadersoOrBodyOrQueryParamsPositive` (Impact: 2.2)
  * `testDelWithPathPositive` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `testMapFromCollectionWithListOfValuesPostive` (Impact: 6.0)
  * `testDemonstrateIdMapFromCollectionByKeyPositiveWithList` (Impact: 4.5)
  * `testDemonstrateStringMapFromCollectionByKeyPositiveWithList` (Impact: 4.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testGetCurrentDataPositive200` (Impact: 3.5)
  * `testGetCurrentDataNegative500TriggersWhenElse` (Impact: 3.5)
  * `testGetCurrentDataNegativeJSONExceptionThrown` (Impact: 3.4)
  * `testGetCurrentDataNegative404` (Impact: 3.4)
  * `testConstructorAssignsNamedCredentialPositive` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
**Top Internal Functions/Classes:**
  ...
  * `genContactForAccount` (Impact: 1.8)
...
**Top Internal Functions/Classes:**
  * `getBulkFLSAccessibleWithAccountPositive` (Impact: 2.7)
  * `getBulkFLSUpdatableWithAccountPositive` (Impact: 2.7)
  * `getBulkFLSAccessibleWithAccountPositiveWithNegativeResults` (Impact: 1.5)
  * `getBulkFLSUpdatableWithAccountPositiveWithNegativeResults` (Impact: 1.5)
  * `memoizedFLSMDCcomparesAccesibleToUpdatable` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
