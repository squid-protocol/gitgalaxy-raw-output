...
- `__call__` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **368.9** | LOC: 357
- `indefLenValueDecoder` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **226.7** | LOC: 234
- `valueDecoder` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **219.7** | LOC: 220
- `valueDecoder` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **103.3** | LOC: 105
- `encodeValue` (@ `pyasn1-0.6.3/pyasn1/codec/ber/encoder.py`) -> Impact: **101.3** | LOC: 116
  * *Intent:* # TODO: handling three flavors of input is too much -- split over codecs
- `encodeValue` (@ `pyasn1-0.6.3/pyasn1/codec/ber/encoder.py`) -> Impact: **93.2** | LOC: 100
- `setComponentByPosition` (@ `pyasn1-0.6.3/pyasn1/type/univ.py`) -> Impact: **87.3** | LOC: 106
- `setComponentByPosition` (@ `pyasn1-0.6.3/pyasn1/type/univ.py`) -> Impact: **79.6** | LOC: 110
- `indefLenValueDecoder` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **70.1** | LOC: 74
- `valueDecoder` (@ `pyasn1-0.6.3/pyasn1/codec/ber/decoder.py`) -> Impact: **64.0** | LOC: 79
...
- **Heaviest Functions:** `__init__` (Impact: 23.6), `__init__` (Impact: 9.8), `setLogger` (Impact: 9.0)
...
- **Heaviest Functions:** `__call__` (Impact: 15.9), `encode` (Impact: 14.1), `__init__` (Impact: 11.3)
...
- **Heaviest Functions:** `__init__` (Impact: 30.5), `__repr__` (Impact: 4.6), `getValues` (Impact: 3.9)
...
- **Heaviest Functions:** `subtype` (Impact: 15.3), `__new__` (Impact: 13.8), `isSameTypeWith` (Impact: 12.3)
...
- **Heaviest Functions:** `setComponentByPosition` (Impact: 87.3), `setComponentByPosition` (Impact: 79.6), `prettyIn` (Impact: 42.7)
...
- **Heaviest Functions:** `encodeValue` (Impact: 101.3), `encodeValue` (Impact: 93.2), `encode` (Impact: 62.6)
...
- **Heaviest Functions:** `asDateTime` (Impact: 33.0), `fromDateTime` (Impact: 17.0), `__init__` (Impact: 2.1)
...
- **Heaviest Functions:** `__init__` (Impact: 29.0), `__computeTagMaps` (Impact: 14.9), `__computeAmbiguousTypes` (Impact: 10.5)
...
- **Heaviest Functions:** `__getitem__` (Impact: 9.1), `tagExplicitly` (Impact: 6.3), `__repr__` (Impact: 6.1)
...
- **Heaviest Functions:** `valueDecoder` (Impact: 23.5), `__getattr__` (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 368.9)
  * `indefLenValueDecoder` (Impact: 226.7)
  * `valueDecoder` (Impact: 219.7)
  * `valueDecoder` (Impact: 103.3)
  * `indefLenValueDecoder` (Impact: 70.1)
...
**Top Internal Functions/Classes:**
  * `setComponentByPosition` (Impact: 87.3)
  * `setComponentByPosition` (Impact: 79.6)
  * `prettyIn` (Impact: 42.7)
  * `prettyIn` (Impact: 38.3)
  * `getComponentByPosition` (Impact: 29.2)
...
**Top Internal Functions/Classes:**
  * `testBooleanEvaluation` (Impact: 6.2)
  * `testGetItem` (Impact: 5.4)
  * `testSetItem` (Impact: 5.4)
  * `testComponentConstraintsMatching` (Impact: 5.1)
  * `testComponentConstraintsMatching` (Impact: 5.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `encodeValue` (Impact: 101.3)
    * *Intent:* # TODO: handling three flavors of input is too much -- split over codecs
  * `encodeValue` (Impact: 93.2)
  * `encode` (Impact: 62.6)
  * `__call__` (Impact: 43.1)
  * `encodeValue` (Impact: 39.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testEmpty` (Impact: 3.3)
  * `testEmpty` (Impact: 3.3)
  * `testImpossible1` (Impact: 3.2)
  * `testImpossible2` (Impact: 3.2)
  * `testImpossible3` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testLocalTimezone` (Impact: 3.3)
    * *Intent:* # def testExtraZeroInSeconds(self): # try: # assert encoder.encode( # useful.GeneralizedTime('201505...
  * `testMissingTimezone` (Impact: 3.3)
  * `testDecimalCommaPoint` (Impact: 3.3)
  * `testFractionOfSecond` (Impact: 3.3)
  * `testMissingTimezone` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `setUp` (Impact: 2.6)
  * `setUp` (Impact: 2.6)
  * `testWithUntaggedChoice` (Impact: 2.4)
  * `testWithTaggedChoice` (Impact: 2.4)
  * `setUp` (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  ...
  * `__computeTagMaps` (Impact: 14.9)
  * `__computeAmbiguousTypes` (Impact: 10.5)
  * `__computeTagToPosMap` (Impact: 9.2)
  * `__computeMinTagSet` (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_testValue` (Impact: 10.5)
  * `_testValue` (Impact: 8.6)
  * `_testValue` (Impact: 8.3)
  * `_setValues` (Impact: 7.4)
...
**Top Internal Functions/Classes:**
  * `testConst2` (Impact: 5.3)
  * `testContains` (Impact: 4.6)
  * `testBadVal` (Impact: 3.5)
  * `testBadValExtraFields` (Impact: 3.5)
  * `testConst1` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  * `testDefiniteLenNesting` (Impact: 8.0)
    * *Intent:* """Deeply nested definite-length SEQUENCEs must raise PyAsn1Error."""
  * `testNoRecursionError` (Impact: 6.6)
    * *Intent:* """Must raise PyAsn1Error, not RecursionError."""
  * `testDecodeOpenTypesUnknownType` (Impact: 3.4)
  * `testDecodeOpenTypesUnknownType` (Impact: 3.4)
  * `testIndefMode` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 11 instances
...
**Top Internal Functions/Classes:**
  * `__getitem__` (Impact: 9.1)
  * `tagExplicitly` (Impact: 6.3)
...
**Top Internal Functions/Classes:**
  * `testDecodeOpenTypesUnknownType` (Impact: 3.4)
  * `testDecodeOpenTypesUnknownType` (Impact: 3.4)
  * `testIndefLenNesting` (Impact: 3.3)
...
**Top Internal Functions/Classes:**
  ...
  * `setLogger` (Impact: 9.0)
  * `hexdump` (Impact: 5.9)
  * `registerLoggee` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testSizeConstraint` (Impact: 3.5)
  * `testEmpty` (Impact: 3.2)
  * `testSchemaPickling` (Impact: 1.8)
  * `setUp` (Impact: 1.7)
  * `testInit` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
