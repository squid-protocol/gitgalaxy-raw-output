...
| Avg Path Length | 4.6744 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 23.5 | 20.1 | 0.0 |
...
- `transform` (@ `code/core/src/csf-tools/CsfFile.test.ts`) -> Impact: **377.9** | LOC: 3123
- `removeField` (@ `code/core/src/csf-tools/ConfigFile.test.ts`) -> Impact: **352.9** | LOC: 1897
- `parse` (@ `code/core/src/csf-tools/CsfFile.ts`) -> Impact: **193.3** | LOC: 546
- `storyToCsfFactory` (@ `code/lib/cli-storybook/src/codemod/helpers/story-to-csf-factory.ts`) -> Impact: **184.0** | LOC: 494
- `onModuleGraphChange` (@ `code/core/src/types/modules/core-common.ts`) -> Impact: **181.8** | LOC: 497
- `getCodeSnippet` (@ `code/renderers/react/src/componentManifest/generateCodeSnippet.ts`) -> Impact: **163.6** | LOC: 272
- `TestProviderRender` (@ `code/addons/vitest/src/components/TestProviderRender.tsx`) -> Impact: **148.3** | LOC: 393
- `esmWalker` (@ `code/core/src/mocking-utils/esmWalker.ts`) -> Impact: **145.8** | LOC: 180
  * *Intent:* /** Same logic from @vue/compiler-core & @vue/compiler-sfc Except this is using acorn AST */
- `configToCsfFactory` (@ `code/lib/cli-storybook/src/codemod/helpers/config-to-csf-factory.ts`) -> Impact: **142.9** | LOC: 259
- `generateDocgen` (@ `code/frameworks/svelte-vite/src/plugins/generateDocgen.ts`) -> Impact: **132.9** | LOC: 268
...
- **Heaviest Functions:** `loaderTransform` (Impact: 58.4), `pitch` (Impact: 16.0), `swcLoader` (Impact: 4.7)
...
- **Heaviest Functions:** `buildDevStandalone` (Impact: 110.9), `send` (Impact: 52.1), `setHandler` (Impact: 1.1)
...
- **Heaviest Functions:** `swc` (Impact: 17.9), `webpack` (Impact: 9.9), `webpackFinal` (Impact: 8.5)
...
- **Heaviest Functions:** `useSharedState` (Impact: 32.0), `useArgs` (Impact: 7.9), `[SET_STORIES]` (Impact: 6.8)
...
- **Heaviest Functions:** `getStoryHrefs` (Impact: 5.4), `ManagerDecorator` (Impact: 3.8), `play` (Impact: 1.9)
...
- **Heaviest Functions:** `buildStaticStandalone` (Impact: 62.2)
...
- **Heaviest Functions:** `log` (Impact: 12.4), `multiselect` (Impact: 7.9), `message` (Impact: 6.3)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `constructor` (Impact: 8.9), `parseSetData` (Impact: 8.2), `setMany` (Impact: 7.1)
...
- **Heaviest Functions:** `emit` (Impact: 11.4), `constructor` (Impact: 9.3), `removeAllListeners` (Impact: 7.4)

### 10. `code/builders/builder-vite/src/index.ts` (TYPESCRIPT) -> Cumulative Risk: **690.97**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `startChangeDetection` (Impact: 15.6), `bail` (Impact: 5.8), `watcherChangeHandler` (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  * `gatedImportFn` (Impact: 8.9)
  * `createAndRenderPreview` (Impact: 4.9)
  * `play` (Impact: 4.3)
  * `text` (Impact: 4.2)
  * `serializeError` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
- `code/addons/vitest/src/node/test-manager.ts` -> **Severity: 0.031** (Bridge: 0.0003 * Flux: 99.486%)
- `code/core/src/bin/core.ts` -> **Severity: 0.019** (Bridge: 0.0002 * Flux: 100.0%)
- `code/core/src/manager-api/root.tsx` -> **Severity: 0.019** (Bridge: 0.0003 * Flux: 72.4199%)
- `code/core/src/telemetry/telemetry.ts` -> **Severity: 0.015** (Bridge: 0.0002 * Flux: 83.759%)
- `code/addons/vitest/src/node/vitest-manager.ts` -> **Severity: 0.013** (Bridge: 0.0002 * Flux: 86.3867%)
