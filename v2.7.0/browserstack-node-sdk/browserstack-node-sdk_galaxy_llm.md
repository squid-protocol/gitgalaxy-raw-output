...
- `executeLoadTest` (@ `package/src/bin/load/load/index.js`) -> Impact: **35.7** | LOC: 120
- `getLoadConfigPath` (@ `package/src/bin/load/load/loadUtils.js`) -> Impact: **23.4** | LOC: 44
...
- `sleep` (@ `package/src/bin/load/load/loadUtils.js`) -> Impact: **1.1** | LOC: 3
...
- **Heaviest Functions:** `executeLoadTest` (Impact: 35.7)
...
- **Heaviest Functions:** `getLoadConfigPath` (Impact: 23.4), `sleep` (Impact: 1.1)
