...
- `run_test` (@ `t/request.t`) -> Impact: **61.1** | LOC: 242
- `all_tests` (@ `t/cookie.t`) -> Impact: **46.1** | LOC: 182
- `run_test` (@ `t/request_upload.t`) -> Impact: **39.4** | LOC: 168
- `test_app` (@ `t/dsl/uri_for_route.t`) -> Impact: **29.7** | LOC: 109
- `dancer_bake` (@ `tools/cookie_perf.pl`) -> Impact: **10.6** | LOC: 14
- `plack_crush` (@ `tools/cookie_perf.pl`) -> Impact: **9.1** | LOC: 12
- `check_app` (@ `tools/perf.pl`) -> Impact: **5.8** | LOC: 12
- `write_file` (@ `t/file_utils.t`) -> Impact: **5.6** | LOC: 8
- `throw` (@ `t/error.t`) -> Impact: **5.5** | LOC: 7
- `_normalize` (@ `t/plugin_syntax.t`) -> Impact: **4.7** | LOC: 10
...
- **Heaviest Functions:** `my_after` (Impact: 1.1)
...
- **Heaviest Functions:** `validate_id` (Impact: 2.2), `generate_id` (Impact: 1.1)
...
- **Heaviest Functions:** `hook_aliases` (Impact: 1.1), `supported_hooks` (Impact: 1.1)
...
- **Heaviest Functions:** `dancer_bake` (Impact: 10.6), `plack_crush` (Impact: 9.1), `xscookies_bake` (Impact: 2.1)
...
- **Heaviest Functions:** `test_app` (Impact: 29.7)
...
- **Heaviest Functions:** `run_test` (Impact: 61.1)
...
- **Heaviest Functions:** `check_app` (Impact: 5.8)
...
- **Heaviest Functions:** `log` (Impact: 2.2)
...
- **Heaviest Functions:** `throw` (Impact: 5.5), `MyApp::Censor::censor` (Impact: 1.1), `new` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `throw` (Impact: 5.5)
  * `MyApp::Censor::censor` (Impact: 1.1)
  * `new` (Impact: 1.1)
  * `as_str` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
