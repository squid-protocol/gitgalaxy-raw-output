...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 43.9 | 56.4 | 0.0 |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 16.1 | 4.2 | 0.0 |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 79.4 | 100.0 | 100.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 63.6 | 98.0 | 100.0 |
...
| connectivity | 54927 | 5359 | 16 | `src/vscode-dts/vscode.d.ts` |
| io | 17274 | 1789 | 4 | `extensions/terminal-suggest/src/completions/git.ts` |
...
| debt | 8097 | 1613 | 2 | `src/vs/workbench/contrib/extensions/test/electron-browser/extensionsActions.test.ts` |
| mutation | 312089 | 6249 | 102 | `extensions/vscode-colorize-tests/producticons/index.html` |
| dead_code | 11121 | 2399 | 4 | `src/vscode-dts/vscode.d.ts` |
| credential | 84 | 29 | 0 | `src/vs/workbench/contrib/notebook/test/browser/diff/notebookDiffService.test.ts` |
...
- `postProcess` (@ `extensions/terminal-suggest/src/completions/git.ts`) -> Impact: **1609.2** | LOC: 3570
- `_showOutput` (@ `src/vs/workbench/contrib/tasks/browser/abstractTaskService.ts`) -> Impact: **920.0** | LOC: 1361
- `postProcess` (@ `extensions/terminal-suggest/src/completions/git.ts`) -> Impact: **690.7** | LOC: 5383
- `webviewPreloads` (@ `src/vs/workbench/contrib/notebook/browser/view/renderers/webviewPreloads.ts`) -> Impact: **604.7** | LOC: 1741
- `link` (@ `src/vs/base/browser/markdownRenderer.ts`) -> Impact: **469.0** | LOC: 996
- `constructor` (@ `src/vs/workbench/contrib/chat/browser/widget/chatContentParts/chatMarkdownContentPart.ts`) -> Impact: **410.7** | LOC: 582
- `constructor` (@ `src/vs/workbench/contrib/inlineChat/browser/inlineChatController.ts`) -> Impact: **409.5** | LOC: 357
- `constructor` (@ `src/vs/editor/contrib/inlineCompletions/browser/controller/inlineCompletionsController.ts`) -> Impact: **409.3** | LOC: 292
- `invoke` (@ `src/vs/workbench/contrib/terminalContrib/chatAgentTools/browser/tools/runInTerminalTool.ts`) -> Impact: **397.6** | LOC: 529
- `constructor` (@ `src/vs/workbench/contrib/chat/browser/widget/chatContentParts/toolInvocationParts/chatTerminalToolConfirmationSubPart.ts`) -> Impact: **368.8** | LOC: 315
...
| `extensions/git/src` | 46 | 11249.84 | 48.63% | 9.74% |
...
### 1. `extensions/html-language-features/server/src/modes/languageModes.ts` (TYPESCRIPT) -> Cumulative Risk: **841.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 150.88 | **LOC:** 192 | **CtrlFlow:** 26.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9439%)
- **Heaviest Functions:** `getLanguageModes` (Impact: 28.5), `isCompletionItemData` (Impact: 5.8), `getAllModesInDocument` (Impact: 4.7)

### 2. `src/vs/workbench/browser/parts/editor/editorParts.ts` (TYPESCRIPT) -> Cumulative Risk: **802.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 621.08 | **LOC:** 991 | **CtrlFlow:** 20.5% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9302%)
- **Heaviest Functions:** `findGroup` (Impact: 32.0), `createModalEditorPart` (Impact: 30.5), `applyWorkingSet` (Impact: 24.2)

### 3. `extensions/terminal-suggest/src/fig/autocomplete/state/generators.ts` (TYPESCRIPT) -> Cumulative Risk: **787.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 135.92 | **LOC:** 203 | **CtrlFlow:** 30.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%), Dead Code (95.9099%)
- **Heaviest Functions:** `triggerGenerators` (Impact: 20.3), `getGeneratorContext` (Impact: 11.5), `triggerGenerator` (Impact: 10.7)

### 4. `src/vs/base/parts/storage/common/storage.ts` (TYPESCRIPT) -> Cumulative Risk: **787.08**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 383.24 | **LOC:** 437 | **CtrlFlow:** 22.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `set` (Impact: 13.5), `acceptExternal` (Impact: 11.7), `delete` (Impact: 8.1)

### 5. `src/vs/workbench/contrib/chat/browser/widget/chatContentParts/chatCollections.ts` (TYPESCRIPT) -> Cumulative Risk: **783.19**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2.09 | **LOC:** 255 | **CtrlFlow:** 22.8% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.5511%), Concurrency (95.8418%)
- **Heaviest Functions:** `release` (Impact: 11.7), `get` (Impact: 9.7), `_scheduleTrim` (Impact: 8.8)

### 6. `src/vs/workbench/api/common/extHostQuickOpen.ts` (TYPESCRIPT) -> Cumulative Risk: **779.32**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 729.04 | **LOC:** 742 | **CtrlFlow:** 17.6% | **Authorship Centralization:** 75.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.4836%)
- **Heaviest Functions:** `createExtHostQuickOpen` (Impact: 223.2), `showQuickPick` (Impact: 53.3), `_fireDidTriggerItemButton` (Impact: 16.8)

### 7. `src/vs/workbench/contrib/chat/browser/chatEditing/chatEditingServiceImpl.ts` (TYPESCRIPT) -> Cumulative Risk: **769.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 4.23 | **LOC:** 522 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 44.4%
- **Primary Risk Drivers:** Spec Match (100.0%), Concurrency (99.5217%), State Flux (98.4331%), Documentation (96.1538%)
- **Heaviest Functions:** `observerEditsInResponse` (Impact: 116.5), `constructor` (Impact: 39.8), `handleResponseParts` (Impact: 37.8)

### 8. `src/vs/sessions/services/workspace/browser/workspaceContextService.ts` (TYPESCRIPT) -> Cumulative Risk: **768.27**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 141.34 | **LOC:** 166 | **CtrlFlow:** 14.5% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `_doUpdateFolders` (Impact: 26.9), `updateFolders` (Impact: 10.8), `doUpdateFolders` (Impact: 4.2)

### 9. `src/vs/workbench/contrib/notebook/browser/diff/diffElementViewModel.ts` (TYPESCRIPT) -> Cumulative Risk: **767.22**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 7.29 | **LOC:** 1104 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.6772%), Tech Debt (99.1075%), Documentation (98.4%)
- **Heaviest Functions:** `_layout` (Impact: 43.3), `constructor` (Impact: 28.6), `constructor` (Impact: 27.5)

### 10. `src/vs/platform/webWorker/browser/webWorkerServiceImpl.ts` (TYPESCRIPT) -> Cumulative Risk: **761.63**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 248.16 | **LOC:** 190 | **CtrlFlow:** 22.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `getWorkerBootstrapUrl` (Impact: 34.0), `createBlobWorker` (Impact: 7.2), `constructor` (Impact: 6.6)
...
- **Risk Profile:** Cognitive Load (49.852%), Tech Debt (0.0%)
...
- **Risk Profile:** Cognitive Load (67.9624%), Tech Debt (8.2837%)
**Top Internal Functions/Classes:**
  * `postProcess` (Impact: 1609.2)
  * `postProcess` (Impact: 690.7)
  * `message` (Impact: 42.0)
  * `postProcessBranches` (Impact: 34.8)
  * `postProcess` (Impact: 32.7)
**Contextual Mitigations & Amplifications:**
...
- `extensions/typescript-language-features/src/typeScriptServiceClientHost.ts` -> **Severity: 0.016** (Bridge: 0.0002 * Flux: 93.0862%)
- `extensions/typescript-language-features/src/commands/tsserverRequests.ts` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 78.6458%)
- `extensions/typescript-language-features/src/typescriptServiceClient.ts` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 96.9026%)
- `extensions/typescript-language-features/src/tsServer/server.ts` -> **Severity: 0.003** (Bridge: 0.0001 * Flux: 27.4089%)
- `extensions/typescript-language-features/src/tsServer/bufferSyncSupport.ts` -> **Severity: 0.002** (Bridge: 0.0 * Flux: 99.8339%)
