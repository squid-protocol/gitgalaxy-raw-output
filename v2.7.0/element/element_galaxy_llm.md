...
| Avg Path Length | 5.1803 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 14.0 | 3.5 | 0.0 |
...
| credential | 3 | 1 | 0 | `examples/components/footer.vue` |
...
- `fromHSV` (@ `packages/color-picker/src/color.js`) -> Impact: **69.5** | LOC: 71
- `orderBy` (@ `packages/table/src/util.js`) -> Impact: **66.5** | LOC: 56
- `fromHSV` (@ `examples/components/theme-configurator/editor/color-picker/src/color.js`) -> Impact: **65.5** | LOC: 70
- `created` (@ `packages/tree/src/tree.vue`) -> Impact: **61.1** | LOC: 163
- `wrappedRowRender` (@ `packages/table/src/table-body.js`) -> Impact: **56.5** | LOC: 90
- `fromString` (@ `packages/color-picker/src/color.js`) -> Impact: **52.1** | LOC: 81
- `fromString` (@ `examples/components/theme-configurator/editor/color-picker/src/color.js`) -> Impact: **49.3** | LOC: 80
- `setChecked` (@ `packages/tree/src/model/node.js`) -> Impact: **40.6** | LOC: 52
- `constructor` (@ `packages/tree/src/model/node.js`) -> Impact: **37.5** | LOC: 71
- `openModal` (@ `src/utils/popup/popup-manager.js`) -> Impact: **36.4** | LOC: 42
...
- **Heaviest Functions:** `openModal` (Impact: 36.4), `closeModal` (Impact: 19.0), `getModal` (Impact: 6.1)
...
- **Heaviest Functions:** `doOpen` (Impact: 26.5), `open` (Impact: 9.6), `visible` (Impact: 9.2)
...
- **Heaviest Functions:** `isEmpty` (Impact: 18.5), `getPropByPath` (Impact: 17.2), `valueEquals` (Impact: 12.8)
...
- **Heaviest Functions:** `node` (Impact: 18.2), `mounted` (Impact: 14.6), `render` (Impact: 12.8)
...
- **Heaviest Functions:** `wrappedRowRender` (Impact: 56.5), `traverse` (Impact: 35.3), `getRowClass` (Impact: 22.5)
...
- **Heaviest Functions:** `bind` (Impact: 9.1), `clear` (Impact: 3.9), `handler` (Impact: 1.1)
...
- **Heaviest Functions:** `defaultCallback` (Impact: 19.6), `MessageBox` (Impact: 19.0), `callback` (Impact: 11.6)
...
- **Heaviest Functions:** `updateColumnsWidth` (Impact: 32.4), `updateElsHeight` (Impact: 21.4), `setHeight` (Impact: 14.7)
...
**Top Internal Functions/Classes:**
  * `getMonthLabel` (Impact: 8.5)
  * `testWeek` (Impact: 4.2)
  * `keyDown` (Impact: 3.1)
  * `numberOfHighlightRows` (Impact: 2.8)
  * `clickAndWait` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `tableRowClassName` (Impact: 6.1)
  * `sortMethod` (Impact: 5.7)
  * `getSummary` (Impact: 5.1)
  * `createInstance` (Impact: 4.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `value` (Impact: 21.8)
  * `handleOptionSelect` (Impact: 20.5)
  * `emptyText` (Impact: 14.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `wrappedRowRender` (Impact: 56.5)
  * `traverse` (Impact: 35.3)
  * `getRowClass` (Impact: 22.5)
  * `handleCellMouseEnter` (Impact: 20.8)
  * `getCellClass` (Impact: 12.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
...
**Top Internal Functions/Classes:**
  * `handleSuggestionKeyDown` (Impact: 13.7)
  * `mounted` (Impact: 13.5)
  * `handleInput` (Impact: 10.9)
  * `genTag` (Impact: 9.9)
  * `filterMethod` (Impact: 9.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
**Top Internal Functions/Classes:**
  * `getSelectVm` (Impact: 11.5)
  * `getSelectComponentVm` (Impact: 8.4)
  * `filterMethod` (Impact: 7.5)
  * `data` (Impact: 4.9)
  * `remoteMethod` (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `orderBy` (Impact: 66.5)
  * `toggleRowStatus` (Impact: 21.4)
  * `walkTreeNode` (Impact: 14.8)
  * `getRowIdentity` (Impact: 13.0)
  * `removeRow` (Impact: 11.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `setCheckedNodes` (Impact: 3.7)
  * `setCheckedKeys` (Impact: 3.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 32 instances
...
**Top Internal Functions/Classes:**
  * `clearFilter` (Impact: 15.0)
  * `updateAllSelected` (Impact: 14.9)
  * `_toggleAllSelection` (Impact: 11.4)
  * `updateColumns` (Impact: 9.2)
    * *Intent:* // 更新列
  * `toggleRowSelection` (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.9e-05 | `Ripple Effect (Closeness):` 0.001314
...
**Top Internal Functions/Classes:**
  * `checkName` (Impact: 6.8)
  * `checkName` (Impact: 6.8)
  * `checkName` (Impact: 6.8)
  * `validator` (Impact: 4.5)
  * `keyDown` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 15 instances
...
**Top Internal Functions/Classes:**
  * `filterMethod` (Impact: 3.7)
  * `getCloseButton` (Impact: 3.0)
  * `getOptions` (Impact: 1.9)
  * `getMenus` (Impact: 1.5)
  * `data` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `getRangeMinutes` (Impact: 25.5)
  * `limitTimeRange` (Impact: 11.2)
  * `getRangeHours` (Impact: 9.6)
  * `extractDateFormat` (Impact: 8.8)
  * `extractTimeFormat` (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
...
- `packages/table/src/store/watcher.js` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 84.9999%)
