...
| Avg Path Length | 2.7597 | Hops between files. Lower = Tighter coupling. |
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 38.3 | 29.2 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 26.0 | 2.4 | 80.0 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 18.0 | 5.7 | 100.0 |
...
| connectivity | 2064 | 132 | 46 | `psutil-7.2.2/tests/test_linux.py` |
...
| dead_code | 1001 | 110 | 23 | `psutil-7.2.2/tests/test_linux.py` |
| credential | 0 | 0 | 0 | - |
...
- `psutil_net_connections` (@ `psutil-7.2.2/psutil/arch/windows/socks.c`) -> Impact: **139.4** | LOC: 363
  * *Intent:* /* * Return a list of network connections opened by a process */
- `psutil_net_connections` (@ `psutil-7.2.2/psutil/arch/sunos/net.c`) -> Impact: **134.8** | LOC: 306
...
- `psutil_get_process_data` (@ `psutil-7.2.2/psutil/arch/windows/proc_info.c`) -> Impact: **126.4** | LOC: 336
...
- `psutil_search_tcplist` (@ `psutil-7.2.2/psutil/arch/freebsd/proc_socks.c`) -> Impact: **120.9** | LOC: 305
  * *Intent:* #if __FreeBSD_version >= 1200026
- `psutil_gather_inet` (@ `psutil-7.2.2/psutil/arch/freebsd/sys_socks.c`) -> Impact: **117.0** | LOC: 171
  * *Intent:* // Reference: // https://github.com/freebsd/freebsd/blob/master/usr.bin/sockstat/sockstat.c
- `psutil_get_nic_speed` (@ `psutil-7.2.2/psutil/arch/posix/net.c`) -> Impact: **101.6** | LOC: 137
  * *Intent:* // net_if_stats() macOS/BSD implementation. #ifdef PSUTIL_HAS_NET_IF_DUPLEX_SPEED
- `psutil_proc_environ` (@ `psutil-7.2.2/psutil/arch/bsd/proc.c`) -> Impact: **96.2** | LOC: 226
- `psutil_net_if_flags` (@ `psutil-7.2.2/psutil/arch/posix/net.c`) -> Impact: **95.8** | LOC: 183
  * *Intent:* /* * Get all of the NIC flags and return them. */
- `psutil_proc_net_connections` (@ `psutil-7.2.2/psutil/arch/osx/proc.c`) -> Impact: **84.2** | LOC: 229
...
- `psutil_disk_partitions` (@ `psutil-7.2.2/psutil/arch/bsd/disk.c`) -> Impact: **80.9** | LOC: 163
...
| `psutil-7.2.2/psutil` | 16 | 7813.38 | 35.89% | 29.11% |
| `psutil-7.2.2/psutil/arch/windows` | 19 | 3544.98 | 56.31% | 45.04% |
| `psutil-7.2.2/psutil/arch/freebsd` | 9 | 1590.8 | 60.28% | 45.4% |
| `psutil-7.2.2/psutil/arch/osx` | 11 | 1555.96 | 59.13% | 42.95% |
| `psutil-7.2.2/psutil/arch/sunos` | 8 | 1317.48 | 57.41% | 41.17% |
| `psutil-7.2.2/psutil/arch/posix` | 7 | 856.4 | 45.88% | 45.22% |
| `psutil-7.2.2/psutil/arch/bsd` | 9 | 744.94 | 47.39% | 54.72% |
...
- **Heaviest Functions:** `psutil_proc_threads` (Impact: 26.2), `psutil_proc_cmdline` (Impact: 26.1), `psutil_proc_cwd` (Impact: 13.8)
...
- **Heaviest Functions:** `psutil_proc_environ` (Impact: 96.2), `psutil_proc_oneshot_info` (Impact: 39.9), `psutil_proc_open_files` (Impact: 38.9)
...
- **Heaviest Functions:** `psutil_winservice_enumerate` (Impact: 28.6), `psutil_winservice_query_descr` (Impact: 28.2), `psutil_winservice_query_config` (Impact: 25.4)
...
- **Heaviest Functions:** `psutil_proc_threads` (Impact: 28.0), `psutil_proc_cmdline` (Impact: 16.1), `psutil_proc_num_fds` (Impact: 15.5)
...
- **Heaviest Functions:** `str_append` (Impact: 23.4), `str_format` (Impact: 14.6), `str_copy` (Impact: 10.7)
...
- **Heaviest Functions:** `psutil_net_connections` (Impact: 134.8), `psutil_net_if_stats` (Impact: 50.2), `psutil_net_io_counters` (Impact: 43.7)
...
- **Heaviest Functions:** `psutil_proc_memory_maps` (Impact: 55.1), `psutil_proc_setrlimit` (Impact: 24.7), `psutil_proc_exe` (Impact: 21.2)
...
- **Heaviest Functions:** `exe` (Impact: 15.5), `net_connections` (Impact: 11.6), `open_files` (Impact: 9.7)
...
- **Heaviest Functions:** `psutil_proc_cpu_affinity_get` (Impact: 25.7), `psutil_proc_cpu_affinity_set` (Impact: 19.6), `psutil_proc_ioprio_set` (Impact: 5.9)

### 10. `psutil-7.2.2/psutil/arch/windows/sys.c` (C) -> Cumulative Risk: **659.0**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 121.06 | **LOC:** 201 | **CtrlFlow:** 17.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9998%), Safety Score (89.8309%)
- **Heaviest Functions:** `psutil_users` (Impact: 51.1), `psutil_uptime` (Impact: 6.0)
...
**Top Internal Functions/Classes:**
  ...
  * `test_emulate_multi_cpu` (Impact: 29.3)
  * `test_flags` (Impact: 25.4)
    * *Intent:* # first line looks like this: # "eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST> mtu 1500" matches_...
  * `open_mock` (Impact: 18.9)
  * `test_emulate_data` (Impact: 17.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_memory_maps` (Impact: 25.0)
  * `test_nice` (Impact: 20.2)
  * `test_pid_0` (Impact: 19.2)
    * *Intent:* # Process(0) is supposed to work on all platforms except Linux if 0 not in psutil.pids(): with pytes...
  * `test_open_files` (Impact: 18.8)
    * *Intent:* # TODO: #595
  * `test_cmdline` (Impact: 16.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `wait` (Impact: 17.6)
  * `cpu_affinity_set` (Impact: 11.6)
  * `send_signal` (Impact: 9.2)
  * `convert_dos_path` (Impact: 8.0)
    * *Intent:* # ===================================================================== # --- utils # ==============...
  * `net_connections` (Impact: 8.0)
    * *Intent:* # ===================================================================== # --- network # ============...
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 5.34
  * `Choke Point (Betweenness):` 0.000169 | `Ripple Effect (Closeness):` 0.014388
...
**Top Internal Functions/Classes:**
  * `test_net_if_addrs` (Impact: 32.0)
  * `test_disk_partitions` (Impact: 26.9)
  * `test_os_constants` (Impact: 16.5)
  * `test_wait_procs` (Impact: 14.2)
  * `test_cpu_freq` (Impact: 12.3)
...
**Top Internal Functions/Classes:**
  * `psutil_proc_memory_maps` (Impact: 55.1)
  * `psutil_proc_setrlimit` (Impact: 24.7)
    * *Intent:* /* * An emulation of Linux prlimit() (set). */
  * `psutil_proc_exe` (Impact: 21.2)
    * *Intent:* /* * Return process pathname executable. * Thanks to Robert N. M. Watson: * http://fxr.googlebit.com...
  * `psutil_proc_cmdline` (Impact: 18.0)
    * *Intent:* // ============================================================================ // APIS // =========...
  * `psutil_proc_cwd` (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_it` (Impact: 23.8)
  * `memory_maps` (Impact: 23.2)
  * `exe` (Impact: 20.9)
  * `open_files` (Impact: 15.2)
  * `check` (Impact: 14.1)
...
**Top Internal Functions/Classes:**
  * `test_ctx_switches` (Impact: 9.4)
  * `test_cpu_times` (Impact: 9.4)
  * `test_disks` (Impact: 8.4)
    * *Intent:* # test psutil.disk_usage() and psutil.disk_partitions() # against "df -a" def df(path): out = sh(f'd...
  * `test_sensors_battery` (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `psutil_gather_inet` (Impact: 117.0)
    * *Intent:* // Reference: // https://github.com/freebsd/freebsd/blob/master/usr.bin/sockstat/sockstat.c
  * `psutil_gather_unix` (Impact: 50.5)
  * `psutil_net_connections` (Impact: 37.5)
  ...
  * `psutil_get_file_from_sock` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test__all__` (Impact: 14.4)
  * `test_serialization` (Impact: 12.3)
  * `test_cache_clear_public_apis` (Impact: 9.4)
  * `test_original` (Impact: 7.5)
...
**Top Internal Functions/Classes:**
  * `test_count` (Impact: 28.3)
  * `test_unix` (Impact: 21.0)
  * `check_conn` (Impact: 16.5)
  * `check_socket` (Impact: 13.6)
    * *Intent:* """Given a socket, makes sure it matches the one obtained via psutil. It assumes this process create...
  * `compare_procsys_connections` (Impact: 12.1)
...
**Top Internal Functions/Classes:**
  * `psutil_search_tcplist` (Impact: 120.9)
    * *Intent:* #if __FreeBSD_version >= 1200026
  * `psutil_proc_net_connections` (Impact: 79.9)
  * `psutil_search_tcplist` (Impact: 40.6)
    * *Intent:* #else
  * `psutil_fetch_tcplist` (Impact: 6.2)
...
- `psutil-7.2.2/psutil/_pswindows.py` -> **Severity: 0.017** (Bridge: 0.0002 * Flux: 100.0%)
- `psutil-7.2.2/psutil/_pslinux.py` -> **Severity: 0.006** (Bridge: 0.0001 * Flux: 100.0%)
- `psutil-7.2.2/psutil/_pssunos.py` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 100.0%)
