...
- `fetchPrecoPrazo` (@ `lib/features/precos.ts`) -> Impact: **16.1** | LOC: 44
- `gerarTokenApp` (@ `lib/features/rastreio.ts`) -> Impact: **6.6** | LOC: 52
- `convertJsonToPrazoPrecoResponse` (@ `lib/features/precos.ts`) -> Impact: **3.2** | LOC: 7
- `sanitization` (@ `lib/utils/validation.ts`) -> Impact: **3.1** | LOC: 6
- `fetchTrackingService` (@ `lib/features/rastreio.ts`) -> Impact: **2.8** | LOC: 28
- `consultarCep` (@ `lib/features/cep.ts`) -> Impact: **2.5** | LOC: 22
- `request` (@ `lib/utils/request.ts`) -> Impact: **2.3** | LOC: 11
- `calcularPrecoPrazo` (@ `lib/features/precos.ts`) -> Impact: **2.2** | LOC: 16
- `formatDateTime` (@ `lib/utils/formatter.ts`) -> Impact: **2.2** | LOC: 15
- `rastrearEncomendas` (@ `lib/features/rastreio.ts`) -> Impact: **2.0** | LOC: 11
...
- **Heaviest Functions:** `gerarTokenApp` (Impact: 6.6), `fetchTrackingService` (Impact: 2.8), `rastrearEncomendas` (Impact: 2.0)
...
- **Heaviest Functions:** `fetchPrecoPrazo` (Impact: 16.1), `convertJsonToPrazoPrecoResponse` (Impact: 3.2), `calcularPrecoPrazo` (Impact: 2.2)
...
- **Heaviest Functions:** `request` (Impact: 2.3)
...
- **Heaviest Functions:** `consultarCep` (Impact: 2.5)
...
- **Heaviest Functions:** `formatDateTime` (Impact: 2.2), `formatStatus` (Impact: 2.0), `formatLocal` (Impact: 2.0)
...
- **Heaviest Functions:** `convertArrayBufferToString` (Impact: 2.0), `convertXMLStringToJson` (Impact: 1.6)
...
- **Heaviest Functions:** `sanitization` (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  * `gerarTokenApp` (Impact: 6.6)
  * `fetchTrackingService` (Impact: 2.8)
  * `rastrearEncomendas` (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `fetchPrecoPrazo` (Impact: 16.1)
  * `convertJsonToPrazoPrecoResponse` (Impact: 3.2)
  * `calcularPrecoPrazo` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  * `formatDateTime` (Impact: 2.2)
  * `formatStatus` (Impact: 2.0)
  * `formatLocal` (Impact: 2.0)
  * `formatOrigin` (Impact: 2.0)
  * `formatDestiny` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `convertArrayBufferToString` (Impact: 2.0)
  * `convertXMLStringToJson` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
