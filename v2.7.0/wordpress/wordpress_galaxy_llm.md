...
| connectivity | 8939 | 759 | 10 | `wp-content/themes/twentytwentyone/style-rtl.css` |
...
| dead_code | 5525 | 803 | 5 | `wp-includes/deprecated.php` |
...
- `QuicktimeParseAtom` (@ `wp-includes/ID3/module.audio-video.quicktime.php`) -> Impact: **1165.5** | LOC: 1033
...
- `parseEBML` (@ `wp-includes/ID3/module.audio-video.matroska.php`) -> Impact: **559.9** | LOC: 733
...
|---|---|---|---|---|
| `wp-includes` | 250 | 136072.58 | 31.06% | 49.71% |
| `wp-admin/includes` | 104 | 55758.66 | 38.07% | 52.16% |
| `wp-includes/js` | 47 | 33501.59 | 46.1% | 22.85% |
| `wp-admin/js` | 49 | 21834.32 | 37.56% | 18.41% |
...
### 1. `wp-includes/js/backbone.js` (JAVASCRIPT) -> Cumulative Risk: **733.77**
...
### 8. `wp-includes/js/underscore.js` (JAVASCRIPT) -> Cumulative Risk: **634.23**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `deepEq` (Impact: 110.2), `eq` (Impact: 20.8), `collectNonEnumProps` (Impact: 16.4)
...
**Top Internal Functions/Classes:**
  ...
  * `wp_get_loading_optimization_attributes` (Impact: 86.7)
  ...
  * `wp_prepare_attachment_for_js` (Impact: 81.3)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 3799.56 | **LOC:** 10605 | **CtrlFlow:** 12.9% | **Authorship Centralization:** 66.7%
- **Risk Profile:** Cognitive Load (28.5823%), Tech Debt (29.6093%)
**Top Internal Functions/Classes:**
...
- `wp-includes/Requests/src/Requests.php` -> **Severity: 0.008** (Bridge: 0.0001 * Flux: 100.0%)
- `wp-includes/php-ai-client/src/Operations/DTO/GenerativeAiOperation.php` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 99.9999%)
- `wp-includes/php-ai-client/src/Providers/DTO/ProviderMetadata.php` -> **Severity: 0.006** (Bridge: 0.0001 * Flux: 99.9928%)
- `wp-includes/php-ai-client/src/Results/DTO/GenerativeAiResult.php` -> **Severity: 0.005** (Bridge: 0.0 * Flux: 99.9999%)
- `wp-includes/php-ai-client/src/Providers/Models/DTO/ModelMetadata.php` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 98.474%)
