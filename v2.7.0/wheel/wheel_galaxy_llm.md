...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 65.4 | 89.0 | 100.0 |
...
- `tags` (@ `wheel-0.46.3/src/wheel/_commands/tags.py`) -> Impact: **56.0** | LOC: 115
- `calculate_macosx_platform_tag` (@ `wheel-0.46.3/src/wheel/macosx_libfile.py`) -> Impact: **50.8** | LOC: 80
...
- `__init__` (@ `wheel-0.46.3/src/wheel/_commands/convert.py`) -> Impact: **39.6** | LOC: 29
- `test_pack` (@ `wheel-0.46.3/tests/commands/test_pack.py`) -> Impact: **32.6** | LOC: 64
- `pack` (@ `wheel-0.46.3/src/wheel/_commands/pack.py`) -> Impact: **30.9** | LOC: 59
...
- `open` (@ `wheel-0.46.3/src/wheel/wheelfile.py`) -> Impact: **30.7** | LOC: 33
- `get_tag` (@ `wheel-0.46.3/src/wheel/_bdist_wheel.py`) -> Impact: **28.3** | LOC: 57
...
- `egg2dist` (@ `wheel-0.46.3/src/wheel/_bdist_wheel.py`) -> Impact: **25.5** | LOC: 70
  * *Intent:* """Convert an .egg-info directory into a .dist-info directory"""
- `license_paths` (@ `wheel-0.46.3/src/wheel/_bdist_wheel.py`) -> Impact: **24.8** | LOC: 43
- `convert` (@ `wheel-0.46.3/src/wheel/_commands/convert.py`) -> Impact: **24.6** | LOC: 51
...
### 1. `wheel-0.46.3/src/wheel/_commands/convert.py` (PYTHON) -> Cumulative Risk: **652.71**
...
### 2. `wheel-0.46.3/src/wheel/wheelfile.py` (PYTHON) -> Cumulative Risk: **619.39**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 234.34 | **LOC:** 242 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.0616%), Verification (80.0%)
- **Heaviest Functions:** `open` (Impact: 30.7), `__init__` (Impact: 20.7), `write_files` (Impact: 16.6)

### 3. `wheel-0.46.3/src/wheel/macosx_libfile.py` (PYTHON) -> Cumulative Risk: **607.39**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 302.22 | **LOC:** 487 | **CtrlFlow:** 21.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.577%), Documentation (85.7143%)
- **Heaviest Functions:** `calculate_macosx_platform_tag` (Impact: 50.8), `extract_macosx_min_system_version` (Impact: 22.6), `read_mach_header` (Impact: 18.0)

### 4. `wheel-0.46.3/src/wheel/_commands/tags.py` (PYTHON) -> Cumulative Risk: **557.24**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 131.46 | **LOC:** 141 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.7278%), Verification (80.0%)
- **Heaviest Functions:** `tags` (Impact: 56.0), `_compute_tags` (Impact: 7.5)

### 5. `wheel-0.46.3/src/wheel/_bdist_wheel.py` (PYTHON) -> Cumulative Risk: **538.34**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 512.2 | **LOC:** 617 | **CtrlFlow:** 22.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.1061%), Documentation (67.4419%)
- **Heaviest Functions:** `get_tag` (Impact: 28.3), `egg2dist` (Impact: 25.5), `license_paths` (Impact: 24.8)

### 6. `wheel-0.46.3/src/wheel/_commands/__init__.py` (PYTHON) -> Cumulative Risk: **507.59**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 64.46 | **LOC:** 154 | **CtrlFlow:** 9.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9276%), Safety Score (75.1429%)
- **Heaviest Functions:** `parser` (Impact: 7.2), `parse_build_tag` (Impact: 6.0), `tags_f` (Impact: 5.1)

### 7. `wheel-0.46.3/src/wheel/_metadata.py` (PYTHON) -> Cumulative Risk: **489.65**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 141.82 | **LOC:** 185 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (97.6427%), Stability (50.0%)
- **Heaviest Functions:** `generate_requirements` (Impact: 14.2), `pkginfo_to_metadata` (Impact: 14.0), `split_sections` (Impact: 12.6)

### 8. `wheel-0.46.3/src/wheel/__main__.py` (PYTHON) -> Cumulative Risk: **440.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 9.74 | **LOC:** 26 | **CtrlFlow:** 16.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (91.6827%), Safety Score (82.1378%)
- **Heaviest Functions:** `main` (Impact: 2.5)

### 9. `wheel-0.46.3/src/wheel/_commands/pack.py` (PYTHON) -> Cumulative Risk: **423.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 74.1 | **LOC:** 85 | **CtrlFlow:** 32.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.1685%), Stability (50.0%)
- **Heaviest Functions:** `pack` (Impact: 30.9), `compute_tagline` (Impact: 6.2)

### 10. `wheel-0.46.3/tests/commands/test_pack.py` (PYTHON) -> Cumulative Risk: **378.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 89.1 | **LOC:** 93 | **CtrlFlow:** 14.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (93.0181%), Stability (50.0%)
- **Heaviest Functions:** `test_pack` (Impact: 32.6)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 340.86 | **LOC:** 338 | **CtrlFlow:** 31.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (69.0827%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 39.6)
  * `convert` (Impact: 24.6)
  * `__init__` (Impact: 18.1)
  * `convert_pkg_info` (Impact: 17.0)
  * `generate_contents` (Impact: 14.0)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 302.22 | **LOC:** 487 | **CtrlFlow:** 21.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (34.9627%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `calculate_macosx_platform_tag` (Impact: 50.8)
    * *Intent:* """ Calculate proper macosx platform tag basing on files which are included to wheel Example platfor...
  * `extract_macosx_min_system_version` (Impact: 22.6)
  * `read_mach_header` (Impact: 18.0)
  * `get_base_class_and_magic_number` (Impact: 13.4)
  * `swap32` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 234.34 | **LOC:** 242 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (55.1638%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `open` (Impact: 30.7)
  * `__init__` (Impact: 20.7)
  * `write_files` (Impact: 16.6)
  * `writestr` (Impact: 14.9)
  * `close` (Impact: 7.8)
...
**Top Internal Functions/Classes:**
  * `bdist_wininst_path` (Impact: 14.2)
    * *Intent:* # As bdist_wininst is no longer present in Python, and carrying .exe files in the # tarball is risky...
  * `test_convert_egg_directory` (Impact: 9.6)
  * `expected_wheel_filename` (Impact: 9.0)
  * `test_convert_bdist_wininst` (Impact: 8.3)
  * `test_convert_egg_file` (Impact: 8.1)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 141.82 | **LOC:** 185 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (37.4599%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `generate_requirements` (Impact: 14.2)
  * `pkginfo_to_metadata` (Impact: 14.0)
    * *Intent:* """ Convert .egg-info directory with PKG-INFO to the Metadata 2.1 format """
  * `split_sections` (Impact: 12.6)
  * `requires_to_requires_dist` (Impact: 7.7)
    * *Intent:* """Return the version specifier for a requirement in PEP 345/566 fashion."""
  * `convert_requirements` (Impact: 6.2)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 131.46 | **LOC:** 141 | **CtrlFlow:** 21.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (55.8785%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `tags` (Impact: 56.0)
  * `_compute_tags` (Impact: 7.5)
...
- **Risk Profile:** Cognitive Load (16.513%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_timestamp` (Impact: 7.0)
  * `test_attributes` (Impact: 6.2)
    * *Intent:* # With the change from ZipFile.write() to .writestr(), we need to manually # set member attributes. ...
  * `test_testzip_bad_hash` (Impact: 4.8)
  * `test_testzip_missing_hash` (Impact: 4.6)
  * `test_weak_hash_algorithm` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (30.2699%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_permission_bits` (Impact: 6.7)
  * `test_plat_tags` (Impact: 3.4)
  * `test_multi_tags` (Impact: 2.8)
  * `test_python_tags` (Impact: 2.5)
  * `test_abi_tags` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 89.1 | **LOC:** 93 | **CtrlFlow:** 14.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (32.13%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_pack` (Impact: 32.6)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 64.46 | **LOC:** 154 | **CtrlFlow:** 9.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (26.9697%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `parser` (Impact: 7.2)
  * `parse_build_tag` (Impact: 6.0)
  * `tags_f` (Impact: 5.1)
  * `main` (Impact: 3.6)
  * `unpack_f` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (20.548%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `run_command` (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_compare_sdists` (Impact: 6.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_unpack` (Impact: 2.6)
  * `test_chmod_outside_unpack_tree` (Impact: 2.3)
  * `test_unpack_executable_bit` (Impact: 2.1)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (2.9925%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_pkginfo_to_metadata` (Impact: 4.3)
  * `test_metadata_deprecated` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_import_bdist_wheel` (Impact: 2.1)
**Structural Signatures (Net Mitigated Signals):**
