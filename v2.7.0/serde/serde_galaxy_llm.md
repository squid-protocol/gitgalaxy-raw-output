...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 95.2 | 100.0 | 100.0 |
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 4.0 | 0.7 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 5.8 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 85.6 | 100.0 | 100.0 |
...
- `from_ast` (@ `serde_derive/src/internals/attr.rs`) -> Impact: **216.1** | LOC: 248
...
- `deserialize_map` (@ `serde_derive/src/de/struct_.rs`) -> Impact: **113.9** | LOC: 221
- `deserialize` (@ `serde_derive/src/de/enum_adjacently.rs`) -> Impact: **110.8** | LOC: 306
...
- `deserialize_identifier` (@ `serde_derive/src/de/identifier.rs`) -> Impact: **88.2** | LOC: 293
- `with_bound` (@ `serde_derive/src/bound.rs`) -> Impact: **83.0** | LOC: 228
...
- `deserialize_map_in_place` (@ `serde_derive/src/de/struct_.rs`) -> Impact: **59.9** | LOC: 158
- `serialize_adjacently_tagged_variant` (@ `serde_derive/src/ser.rs`) -> Impact: **56.4** | LOC: 123
- `deserialize` (@ `serde_derive/src/de/struct_.rs`) -> Impact: **51.5** | LOC: 181
...
### 1. `serde_derive/src/internals/attr.rs` (RUST) -> Cumulative Risk: **515.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1064.14 | **LOC:** 1819 | **CtrlFlow:** 21.8% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (90.3448%), Tech Debt (86.3702%), Verification (80.0%)
- **Heaviest Functions:** `from_ast` (Impact: 216.1), `from_ast` (Impact: 180.0), `from_ast` (Impact: 105.4)

### 2. `serde_derive/src/bound.rs` (RUST) -> Cumulative Risk: **497.16**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 227.68 | **LOC:** 426 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Verification (80.0%), State Flux (63.4749%)
- **Heaviest Functions:** `with_bound` (Impact: 83.0), `visit_type` (Impact: 14.3), `with_where_predicates_from_variants` (Impact: 13.2)

### 3. `serde/src/private/de.rs` (RUST) -> Cumulative Risk: **495.41**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 965.92 | **LOC:** 3502 | **CtrlFlow:** 6.6% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.2004%), Documentation (93.8567%), Verification (80.0%)
- **Heaviest Functions:** `deserialize_enum` (Impact: 11.2), `deserialize_enum` (Impact: 11.0), `borrow_cow_str` (Impact: 10.7)

### 4. `serde_core/src/de/value.rs` (RUST) -> Cumulative Risk: **486.77**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 369.92 | **LOC:** 1896 | **CtrlFlow:** 7.0% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.6402%), Documentation (83.5366%), Verification (80.0%)
- **Heaviest Functions:** `next_element_seed` (Impact: 9.3), `size_hint` (Impact: 7.5), `deserialize_tuple` (Impact: 6.6)

### 5. `serde_derive/src/de.rs` (RUST) -> Cumulative Risk: **452.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 317.2 | **LOC:** 977 | **CtrlFlow:** 11.6% | **Authorship Centralization:** 71.1%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Verification (80.0%), Documentation (71.4286%)
- **Heaviest Functions:** `deserialize_seq` (Impact: 39.5), `deserialize_seq_in_place` (Impact: 26.8), `deserialize_body` (Impact: 20.3)

### 6. `serde/src/private/ser.rs` (RUST) -> Cumulative Risk: **447.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 355.34 | **LOC:** 1383 | **CtrlFlow:** 2.4% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (97.2222%), Verification (80.0%), Api Exposure (53.5441%)
- **Heaviest Functions:** `serialize` (Impact: 17.8), `fmt` (Impact: 4.3), `serialize_tagged_newtype` (Impact: 3.6)

### 7. `serde_core/src/ser/impossible.rs` (RUST) -> Cumulative Risk: **442.74**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 58.38 | **LOC:** 217 | **CtrlFlow:** 15.8% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Tech Debt (100.0%), Spec Match (100.0%), Documentation (100.0%), Verification (80.0%)
- **Heaviest Functions:** `serialize_field` (Impact: 4.4), `serialize_field` (Impact: 4.4), `serialize_element` (Impact: 3.8)

### 8. `serde_derive/src/de/struct_.rs` (RUST) -> Cumulative Risk: **438.18**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 284.68 | **LOC:** 698 | **CtrlFlow:** 15.9% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (89.6897%), Verification (80.0%), Documentation (47.619%)
- **Heaviest Functions:** `deserialize_map` (Impact: 113.9), `deserialize_map_in_place` (Impact: 59.9), `deserialize` (Impact: 51.5)

### 9. `serde_derive/src/de/identifier.rs` (RUST) -> Cumulative Risk: **435.93**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 222.9 | **LOC:** 478 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Verification (80.0%), Api Exposure (48.8903%)
- **Heaviest Functions:** `deserialize_identifier` (Impact: 88.2), `deserialize_custom` (Impact: 31.5), `deserialize_generated` (Impact: 20.1)

### 10. `serde_core/src/de/impls.rs` (RUST) -> Cumulative Risk: **435.62**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 829.2 | **LOC:** 3174 | **CtrlFlow:** 8.5% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (99.505%), Verification (80.0%), Tech Debt (62.1131%)
- **Heaviest Functions:** `deserialize` (Impact: 29.6), `deserialize` (Impact: 28.0), `deserialize` (Impact: 17.7)
...
- **Magnitude:** 1064.14 | **LOC:** 1819 | **CtrlFlow:** 21.8% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (18.5682%), Tech Debt (86.3702%)
**Top Internal Functions/Classes:**
  * `from_ast` (Impact: 216.1)
    * *Intent:* /// Extract out the `#[serde(...)]` attributes from a struct field.
  * `from_ast` (Impact: 180.0)
    * *Intent:* /// Extract out the `#[serde(...)]` attributes from an item.
  * `from_ast` (Impact: 105.4)
  * `get_ser_and_de` (Impact: 38.0)
  * `parse_lit_into_lifetimes` (Impact: 20.9)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 965.92 | **LOC:** 3502 | **CtrlFlow:** 6.6% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (8.5919%), Tech Debt (99.2004%)
**Top Internal Functions/Classes:**
  * `deserialize_enum` (Impact: 11.2)
  * `deserialize_enum` (Impact: 11.0)
  * `borrow_cow_str` (Impact: 10.7)
  * `visit_map` (Impact: 10.1)
  * `deserialize_unit_struct` (Impact: 9.4)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 829.2 | **LOC:** 3174 | **CtrlFlow:** 8.5% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (7.1047%), Tech Debt (62.1131%)
**Top Internal Functions/Classes:**
  * `deserialize` (Impact: 29.6)
  * `deserialize` (Impact: 28.0)
  * `deserialize` (Impact: 17.7)
  * `deserialize` (Impact: 17.7)
  * `visit_map` (Impact: 14.0)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 490.78 | **LOC:** 1370 | **CtrlFlow:** 11.8% | **Authorship Centralization:** 57.1%
- **Risk Profile:** Cognitive Load (8.4992%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `serialize_adjacently_tagged_variant` (Impact: 56.4)
  * `serialize_struct_visitor` (Impact: 43.6)
  * `serialize_struct_variant` (Impact: 28.7)
  * `serialize_tuple_struct_visitor` (Impact: 24.8)
  * `serialize_struct_variant_with_flatten` (Impact: 20.0)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 369.92 | **LOC:** 1896 | **CtrlFlow:** 7.0% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (6.7019%), Tech Debt (99.6402%)
**Top Internal Functions/Classes:**
  * `next_element_seed` (Impact: 9.3)
  * `size_hint` (Impact: 7.5)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 355.34 | **LOC:** 1383 | **CtrlFlow:** 2.4% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (4.4544%), Tech Debt (40.2791%)
**Top Internal Functions/Classes:**
  * `serialize` (Impact: 17.8)
  * `fmt` (Impact: 4.3)
  * `serialize_tagged_newtype` (Impact: 3.6)
    * *Intent:* /// Not public API.
  * `serialize_tuple_variant` (Impact: 3.3)
  * `serialize_struct_variant` (Impact: 3.3)
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 317.2 | **LOC:** 977 | **CtrlFlow:** 11.6% | **Authorship Centralization:** 71.1%
- **Risk Profile:** Cognitive Load (6.3476%), Tech Debt (16.4516%)
**Top Internal Functions/Classes:**
  * `deserialize_seq` (Impact: 39.5)
  * `deserialize_seq_in_place` (Impact: 26.8)
  * `deserialize_body` (Impact: 20.3)
  * `deserialize_in_place_body` (Impact: 16.1)
  * `deserialize_transparent` (Impact: 12.4)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 291.54 | **LOC:** 3577 | **CtrlFlow:** 1.1% | **Authorship Centralization:** 80.0%
- **Risk Profile:** Cognitive Load (2.707%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `deserialize_string_as_variant` (Impact: 8.1)
  * `flatten_any_after_flatten_struct` (Impact: 8.0)
  * `test_partially_untagged_enum_desugared` (Impact: 7.2)
  * `deserialize` (Impact: 6.9)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 284.68 | **LOC:** 698 | **CtrlFlow:** 15.9% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (13.5731%), Tech Debt (89.6897%)
**Top Internal Functions/Classes:**
  * `deserialize_map` (Impact: 113.9)
  * `deserialize_map_in_place` (Impact: 59.9)
  * `deserialize` (Impact: 51.5)
    * *Intent:* /// Generates `Deserialize::deserialize` body for a `struct Struct {...}`
  * `deserialize_in_place` (Impact: 14.4)
    * *Intent:* /// Generates `Deserialize::deserialize_in_place` body for a `struct Struct {...}`
  * `deserialize_field_identifier` (Impact: 11.2)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 227.68 | **LOC:** 426 | **CtrlFlow:** 12.3% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (13.5595%), Tech Debt (36.5832%)
**Top Internal Functions/Classes:**
  * `with_bound` (Impact: 83.0)
  ...
  * `with_where_predicates_from_variants` (Impact: 13.2)
  * `visit_path` (Impact: 13.0)
  * `with_where_predicates_from_fields` (Impact: 10.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (1.6068%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test` (Impact: 5.9)
  * `test_atomics` (Impact: 4.7)
  * `deserialize` (Impact: 3.2)
  * `assert_de_tokens_ignore` (Impact: 2.6)
  * `test` (Impact: 2.3)
    * *Intent:* //////////////////////////////////////////////////////////////////////////
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 222.9 | **LOC:** 478 | **CtrlFlow:** 10.2% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (10.3932%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `deserialize_identifier` (Impact: 88.2)
  * `deserialize_custom` (Impact: 31.5)
    * *Intent:* // Generates `Deserialize::deserialize` body for an enum with // `serde(field_identifier)` or `serde...
  * `deserialize_generated` (Impact: 20.1)
...
- **Risk Profile:** Cognitive Load (7.4102%), Tech Debt (78.0448%)
**Top Internal Functions/Classes:**
  * `serialize` (Impact: 9.7)
  * `format_u8` (Impact: 9.7)
  * `serialize` (Impact: 9.7)
  * `serialize` (Impact: 7.9)
  * `serialize` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (11.3103%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (1.7628%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_gen` (Impact: 40.4)
    * *Intent:* //////////////////////////////////////////////////////////////////////////
  * `serialize_some_other_variant` (Impact: 2.3)
  * `vec_first_element` (Impact: 2.1)
  * `ser_x` (Impact: 1.9)
  * `serialize_with` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (17.4395%), Tech Debt (20.5776%)
**Top Internal Functions/Classes:**
  * `deserialize` (Impact: 110.8)
...
- **Risk Profile:** Cognitive Load (12.1213%), Tech Debt (10.719%)
**Top Internal Functions/Classes:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 132.78 | **LOC:** 2011 | **CtrlFlow:** 1.3% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (3.1319%), Tech Debt (100.0%)
**Top Internal Functions/Classes:**
  * `iterator_len_hint` (Impact: 4.7)
  * `serialize_newtype_variant` (Impact: 2.9)
    * *Intent:* /// } /// /// impl Serialize for E { /// fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::E...
  * `serialize_tuple_variant` (Impact: 2.8)
    * *Intent:* /// tv.serialize_field(b)?; /// tv.end() /// } /// E::U(ref a, ref b, ref c) => { /// let mut tv = s...
  * `serialize_struct_variant` (Impact: 2.8)
    * *Intent:* /// ref r, /// ref g, /// ref b, /// } => { /// let mut sv = serializer.serialize_struct_variant("E"...
  * `serialize_unit_variant` (Impact: 2.5)
    * *Intent:* /// } /// /// impl Serialize for E { /// fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::E...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_enum_skipped` (Impact: 2.2)
  * `test_system_time` (Impact: 1.9)
  * `test_cannot_serialize_paths` (Impact: 1.6)
  * `test_result` (Impact: 1.5)
  * `test_slice` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 80.1 | **LOC:** 226 | **CtrlFlow:** 7.4% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (3.5253%), Tech Debt (12.1994%)
**Top Internal Functions/Classes:**
  * `from_ast` (Impact: 18.4)
    * *Intent:* /// Convert the raw Syn ast into a parsed container object, collecting errors in `cx`.
  * `enum_from_ast` (Impact: 10.9)
  * `fields_from_ast` (Impact: 8.7)
  * `struct_from_ast` (Impact: 8.5)
  * `all_fields` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
* *State Mutation (weighted view):* 3
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (8.2611%), Tech Debt (45.9882%)
**Top Internal Functions/Classes:**
  * `fmt` (Impact: 14.5)
  * `apply_to_field` (Impact: 13.5)
    * *Intent:* /// Apply a renaming rule to a struct field, returning the version expected in the source.
  * `apply_to_variant` (Impact: 9.8)
...
- **Risk Profile:** Cognitive Load (3.8973%), Tech Debt (0.0%)
**Structural Signatures (Net Mitigated Signals):**
...
- `serde/src/private/de.rs` -> **David Tolnay** (100.0% isolated ownership) | Magnitude: 965.92
- `serde_core/src/de/impls.rs` -> **David Tolnay** (100.0% isolated ownership) | Magnitude: 829.2
- `serde_core/src/de/value.rs` -> **David Tolnay** (100.0% isolated ownership) | Magnitude: 369.92
- `serde/src/private/ser.rs` -> **David Tolnay** (100.0% isolated ownership) | Magnitude: 355.34
