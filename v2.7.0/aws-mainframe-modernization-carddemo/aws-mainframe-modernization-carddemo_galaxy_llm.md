...
| Avg Path Length | 3.343 | Hops between files. Lower = Tighter coupling. |
...
|---|---|---|---|---|---|
| Complexity Load (formerly Cognitive Load Exposure) | 0.0 | 94.9 | 18.3 | 0.0 | 0.0 |
...
|---|---|---|---|---|
| memory | 746 | 52 | 12 | `app/app-authorization-ims-db2-mq/cpy-bms/COPAU00.cpy` |
| cleanup | 98 | 39 | 2 | `app/app-transaction-type-db2/cbl/COTRTLIC.cbl` |
| guards | 58 | 21 | 1 | `app/asm/COBDATFT.asm` |
| danger | 354 | 52 | 2 | `app/cbl/COACTUPC.cbl` |
| concurrency | 58 | 24 | 1 | `samples/jcl/IMSMQCMP.jcl` |
| connectivity | 202 | 47 | 1 | `app/cbl/CBEXPORT.cbl` |
| io | 1565 | 108 | 22 | `app/cbl/CBSTM03A.CBL` |
| crypto | 0 | 0 | 0 | - |
| ipc | 179 | 44 | 3 | `app/app-transaction-type-db2/cbl/COTRTLIC.cbl` |
| time | 86 | 36 | 2 | `app/cbl/CBIMPORT.cbl` |
| serialization | 267 | 26 | 2 | `app/cbl/COACTUPC.cbl` |
| regex | 83 | 18 | 0 | `app/cbl/COACTUPC.cbl` |
| events | 108 | 79 | 2 | `app/app-vsam-mq/cbl/COACCT01.cbl` |
| tests | 0 | 0 | 0 | - |
...
| threat | 1100 | 68 | 18 | `app/cbl/COACTUPC.cbl` |
| ml_ai | 4 | 2 | 0 | `scripts/upld_module.sh` |
| ui | 26 | 21 | 1 | `app/app-authorization-ims-db2-mq/cbl/COPAUS0C.cbl` |
...
- `1100-RECEIVE-MAP` (@ `app/cbl/COACTUPC.cbl`) -> Impact: **117.3** | LOC: 387
- `3300-SETUP-SCREEN-ATTRS` (@ `app/cbl/COACTUPC.cbl`) -> Impact: **116.5** | LOC: 451
- `0000-MAIN` (@ `app/app-transaction-type-db2/cbl/COTRTLIC.cbl`) -> Impact: **61.0** | LOC: 401
- `VALIDATE-INPUT-DATA-FIELDS` (@ `app/cbl/COTRN02C.cbl`) -> Impact: **56.1** | LOC: 203
  * *Intent:* *----------------------------------------------------------------* * VALIDATE-INPUT-DATA-FIELDS *-----------------------------------------------------...
- `3300-SETUP-SCREEN-ATTRS` (@ `app/cbl/COCRDUPC.cbl`) -> Impact: **47.5** | LOC: 151
- `PROCESS-ENTER-KEY` (@ `app/cbl/CORPT00C.cbl`) -> Impact: **41.5** | LOC: 249
  * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *--------------------------------------------------------------...
- `3300-SETUP-SCREEN-ATTRS` (@ `app/app-transaction-type-db2/cbl/COTRTUPC.cbl`) -> Impact: **38.8** | LOC: 95
- `0000-MAIN` (@ `app/cbl/COCRDLIC.cbl`) -> Impact: **38.2** | LOC: 305
- `0000-MAIN` (@ `app/app-transaction-type-db2/cbl/COTRTUPC.cbl`) -> Impact: **36.7** | LOC: 214
- `YYYY-STORE-PFKEY` (@ `app/cpy/CSSTRPFY.cpy`) -> Impact: **33.1** | LOC: 63
...
| `app/app-authorization-ims-db2-mq/cbl` | 8 | 2118.86 | 49.97% | 18.77% |
| `app/app-transaction-type-db2/cbl` | 3 | 1999.7 | 69.26% | 16.36% |
| `app/app-vsam-mq/cbl` | 2 | 579.98 | 57.97% | 9.73% |
...
- **Heaviest Functions:** `1100-OPEN-FILES` (Impact: 9.2), `2200-CREATE-CUSTOMER-EXP-REC` (Impact: 4.0), `5200-CREATE-TRAN-EXP-REC` (Impact: 3.9)
...
- **Heaviest Functions:** `1100-OPEN-FILES` (Impact: 10.5), `2200-PROCESS-RECORD-BY-TYPE` (Impact: 8.8), `2300-PROCESS-CUSTOMER-RECORD` (Impact: 3.7)

### 3. `app/cbl/COCRDLIC.cbl` (COBOL) -> Cumulative Risk: **590.1**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 735.86 | **LOC:** 1460 | **CtrlFlow:** 13.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Documentation (98.6301%), Safety Score (94.0058%)
- **Heaviest Functions:** `0000-MAIN` (Impact: 38.2), `9000-READ-FORWARD` (Impact: 28.9), `1250-SETUP-ARRAY-ATTRIBS` (Impact: 27.2)

### 4. `app/cbl/COUSR02C.cbl` (COBOL) -> Cumulative Risk: **585.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 291.56 | **LOC:** 415 | **CtrlFlow:** 14.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.4075%)
- **Heaviest Functions:** `UPDATE-USER-INFO` (Impact: 18.4), `MAIN-PARA` (Impact: 17.9), `PROCESS-ENTER-KEY` (Impact: 7.5)

### 5. `app/cbl/COTRN02C.cbl` (COBOL) -> Cumulative Risk: **583.69**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 570.98 | **LOC:** 784 | **CtrlFlow:** 15.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.1563%)
- **Heaviest Functions:** `VALIDATE-INPUT-DATA-FIELDS` (Impact: 56.1), `MAIN-PARA` (Impact: 16.6), `PROCESS-ENTER-KEY` (Impact: 10.2)

### 6. `app/cbl/COMEN01C.cbl` (COBOL) -> Cumulative Risk: **583.35**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 191.56 | **LOC:** 309 | **CtrlFlow:** 17.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (97.2864%)
- **Heaviest Functions:** `BUILD-MENU-OPTIONS` (Impact: 19.1), `PROCESS-ENTER-KEY` (Impact: 15.8), `MAIN-PARA` (Impact: 10.8)

### 7. `app/app-transaction-type-db2/cbl/COTRTLIC.cbl` (COBOL) -> Cumulative Risk: **582.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1163.82 | **LOC:** 2099 | **CtrlFlow:** 11.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Documentation (99.1453%), Safety Score (93.7055%)
- **Heaviest Functions:** `0000-MAIN` (Impact: 61.0), `8000-READ-FORWARD` (Impact: 27.1), `2500-SETUP-MESSAGE` (Impact: 22.9)

### 8. `app/cbl/COACTVWC.cbl` (COBOL) -> Cumulative Risk: **582.38**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 392.66 | **LOC:** 942 | **CtrlFlow:** 8.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.999%), Documentation (94.6429%), Safety Score (91.3214%)
- **Heaviest Functions:** `0000-MAIN` (Impact: 23.6), `1200-SETUP-SCREEN-VARS` (Impact: 11.8), `1300-SETUP-SCREEN-ATTRS` (Impact: 10.6)

### 9. `app/cbl/COACTUPC.cbl` (COBOL) -> Cumulative Risk: **581.88**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2199.06 | **LOC:** 4237 | **CtrlFlow:** 12.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (98.8095%), Safety Score (94.7413%)
- **Heaviest Functions:** `1100-RECEIVE-MAP` (Impact: 117.3), `3300-SETUP-SCREEN-ATTRS` (Impact: 116.5), `2000-DECIDE-ACTION` (Impact: 24.1)

### 10. `app/cbl/CORPT00C.cbl` (COBOL) -> Cumulative Risk: **579.76**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 369.76 | **LOC:** 650 | **CtrlFlow:** 10.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (96.4069%)
- **Heaviest Functions:** `PROCESS-ENTER-KEY` (Impact: 41.5), `SUBMIT-JOB-TO-INTRDR` (Impact: 12.4), `MAIN-PARA` (Impact: 11.0)
...
**Top Internal Functions/Classes:**
  * `1100-RECEIVE-MAP` (Impact: 117.3)
  * `3300-SETUP-SCREEN-ATTRS` (Impact: 116.5)
  * `2000-DECIDE-ACTION` (Impact: 24.1)
  * `0000-MAIN` (Impact: 23.4)
  * `1200-EDIT-MAP-INPUTS` (Impact: 23.4)
...
* *Risk/State:* `safety_bypasses: 51`, `high_risk_execution: 1`, `state_mutation: 700`, `dead_code: 14`, `unreferenced_by_name: 3`
...
**Top Internal Functions/Classes:**
  * `0000-MAIN` (Impact: 61.0)
  * `8000-READ-FORWARD` (Impact: 27.1)
  * `2500-SETUP-MESSAGE` (Impact: 22.9)
  * `2400-SETUP-SCREEN-ATTRS` (Impact: 22.1)
  * `2300-SCREEN-ARRAY-INIT` (Impact: 19.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `3300-SETUP-SCREEN-ATTRS` (Impact: 47.5)
  * `0000-MAIN` (Impact: 29.9)
  * `2000-DECIDE-ACTION` (Impact: 24.1)
  * `1100-RECEIVE-MAP` (Impact: 15.9)
  * `3200-SETUP-SCREEN-VARS` (Impact: 14.7)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 21`, `high_risk_execution: 1`, `state_mutation: 283`, `dead_code: 5`, `unreferenced_by_name: 2`
...
- **Risk Profile:** Cognitive Load (71.6932%), Tech Debt (9.0248%)
**Top Internal Functions/Classes:**
  * `PROCESS-ENTER-KEY` (Impact: 20.9)
    * *Intent:* *****************************************************************
  * `MAIN-PARA` (Impact: 19.0)
    * *Intent:* *****************************************************************
  * `POPULATE-AUTH-LIST` (Impact: 14.2)
    * *Intent:* *****************************************************************
  * `INITIALIZE-AUTH-DATA` (Impact: 12.8)
    * *Intent:* *****************************************************************
  * `PROCESS-PAGE-FORWARD` (Impact: 12.0)
    * *Intent:* *****************************************************************
**Contextual Mitigations & Amplifications:**
...
* *Architecture:* `io: 6`, `api: 1`, `import: 14`
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `3300-SETUP-SCREEN-ATTRS` (Impact: 38.8)
  * `0000-MAIN` (Impact: 36.7)
  * `2000-DECIDE-ACTION` (Impact: 29.2)
  * `3250-SETUP-INFOMSG` (Impact: 21.8)
  * `3200-SETUP-SCREEN-VARS` (Impact: 18.6)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 23`, `high_risk_execution: 2`, `state_mutation: 211`, `dead_code: 2`, `unreferenced_by_name: 2`
...
**Top Internal Functions/Classes:**
  * `0000-MAIN` (Impact: 38.2)
  * `9000-READ-FORWARD` (Impact: 28.9)
  * `1250-SETUP-ARRAY-ATTRIBS` (Impact: 27.2)
  * `9100-READ-BACKWARDS` (Impact: 19.4)
  * `1300-SETUP-SCREEN-ATTRS` (Impact: 18.6)
**Contextual Mitigations & Amplifications:**
...
* *Architecture:* `io: 36`, `api: 1`, `import: 11`
* *Defense:* `doc: 2`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `PROCESS-ENTER-KEY` (Impact: 27.2)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `POPULATE-TRAN-DATA` (Impact: 16.2)
    * *Intent:* *----------------------------------------------------------------* * POPULATE-TRAN-DATA *-----------...
  * `INITIALIZE-TRAN-DATA` (Impact: 15.8)
    * *Intent:* *----------------------------------------------------------------* * INITIALIZE-TRAN-DATA *---------...
  * `PROCESS-PAGE-FORWARD` (Impact: 15.5)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-PAGE-FORWARD *---------...
  * `PROCESS-PAGE-BACKWARD` (Impact: 14.2)
...
**Top Internal Functions/Classes:**
  * `PROCESS-ENTER-KEY` (Impact: 27.2)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `POPULATE-USER-DATA` (Impact: 15.9)
    * *Intent:* *----------------------------------------------------------------* * POPULATE-USER-DATA *-----------...
  * `INITIALIZE-USER-DATA` (Impact: 15.8)
...
**Top Internal Functions/Classes:**
  * `VALIDATE-INPUT-DATA-FIELDS` (Impact: 56.1)
    * *Intent:* *----------------------------------------------------------------* * VALIDATE-INPUT-DATA-FIELDS *---...
  * `MAIN-PARA` (Impact: 16.6)
  * `PROCESS-ENTER-KEY` (Impact: 10.2)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `VALIDATE-INPUT-KEY-FIELDS` (Impact: 8.9)
    * *Intent:* *----------------------------------------------------------------* * VALIDATE-INPUT-KEY-FIELDS *----...
  * `WRITE-TRANSACT-FILE` (Impact: 8.0)
...
* *Architecture:* `io: 9`, `api: 1`, `import: 11`
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 494.32 | **LOC:** 1027 | **CtrlFlow:** 8.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (90.1924%), Tech Debt (11.4453%)
**Top Internal Functions/Classes:**
  * `6000-MAKE-DECISION` (Impact: 23.8)
    * *Intent:* * * ------------------------------------------------------------- *
  * `8400-UPDATE-SUMMARY` (Impact: 10.6)
    * *Intent:* * * ------------------------------------------------------------- *
  * `8500-INSERT-AUTH` (Impact: 8.5)
    * *Intent:* * * ------------------------------------------------------------- *
  * `3100-READ-REQUEST-MQ` (Impact: 8.3)
    * *Intent:* * * ------------------------------------------------------------- *
  * `5100-READ-XREF-RECORD` (Impact: 7.2)
    * *Intent:* * * ------------------------------------------------------------- *
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `state_mutation: 228`, `unreferenced_by_name: 3`
* *Architecture:* `io: 33`, `api: 4`, `import: 16`
* *Defense:* `cleanup: 1`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` (Impact: 17.4)
  * `1000-DALYTRAN-GET-NEXT` (Impact: 10.2)
    * *Intent:* *---------------------------------------------------------------*
  * `2700-UPDATE-TCATBAL` (Impact: 9.8)
    * *Intent:* *---------------------------------------------------------------*
  * `1500-B-LOOKUP-ACCT` (Impact: 8.5)
  * `2700-A-CREATE-TCATBAL-REC` (Impact: 6.1)
    * *Intent:* *---------------------------------------------------------------*
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `0000-MAIN` (Impact: 25.2)
  * `1300-SETUP-SCREEN-ATTRS` (Impact: 18.9)
  * `1200-SETUP-SCREEN-VARS` (Impact: 11.1)
  * `Today` (Impact: 9.5)
  * `9100-GETCARD-BYACCTCARD` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 9`, `high_risk_execution: 1`, `state_mutation: 138`, `dead_code: 2`, `unreferenced_by_name: 4`
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` (Impact: 20.0)
  * `0000-START` (Impact: 8.9)
  * `8500-READTRNX-READ` (Impact: 8.5)
    * *Intent:* *---------------------------------------------------------------*
  * `4000-TRNXFILE-GET` (Impact: 8.1)
  * `8100-TRNXFILE-OPEN` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `0000-MAIN` (Impact: 23.6)
  * `1200-SETUP-SCREEN-VARS` (Impact: 11.8)
  * `1300-SETUP-SCREEN-ATTRS` (Impact: 10.6)
  * `Today` (Impact: 8.5)
  * `9200-GETCARDXREF-BYACCT` (Impact: 8.4)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `safety_bypasses: 9`, `high_risk_execution: 1`, `state_mutation: 153`, `dead_code: 6`, `duplicate_logic: 2`, `unreferenced_by_name: 2`
...
- **Risk Profile:** Cognitive Load (74.7363%), Tech Debt (10.2053%)
**Top Internal Functions/Classes:**
  * `READ-AUTH-RECORD` (Impact: 15.1)
  * `MAIN-PARA` (Impact: 13.5)
  * `POPULATE-AUTH-DETAILS` (Impact: 11.4)
  * `MARK-AUTH-FRAUD` (Impact: 8.8)
  * `UPDATE-AUTH-DETAILS` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
* *Risk/State:* `state_mutation: 120`, `unreferenced_by_name: 1`
* *Architecture:* `io: 6`, `api: 2`, `import: 10`
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `PROCESS-ENTER-KEY` (Impact: 41.5)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `SUBMIT-JOB-TO-INTRDR` (Impact: 12.4)
    * *Intent:* *----------------------------------------------------------------* * SUBMIT-JOB-TO-INTRDR *---------...
  * `MAIN-PARA` (Impact: 11.0)
  * `WIRTE-JOBSUB-TDQ` (Impact: 5.0)
    * *Intent:* *----------------------------------------------------------------* * WIRTE-JOBSUB-TDQ *-------------...
  * `SEND-TRNRPT-SCREEN` (Impact: 4.2)
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` (Impact: 19.3)
  * `1000-TCATBALF-GET-NEXT` (Impact: 10.2)
    * *Intent:* *---------------------------------------------------------------*
  * `1200-GET-INTEREST-RATE` (Impact: 8.3)
    * *Intent:* *---------------------------------------------------------------*
  * `1300-B-WRITE-TX` (Impact: 7.2)
    * *Intent:* *---------------------------------------------------------------*
  * `1100-GET-ACCT-DATA` (Impact: 7.0)
    * *Intent:* *---------------------------------------------------------------*
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 40 instances
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` (Impact: 18.5)
  * `0550-DATEPARM-READ` (Impact: 10.2)
    * *Intent:* * Read the date parameter file.
  * `1000-TRANFILE-GET-NEXT` (Impact: 10.2)
    * *Intent:* ***************************************************************** * I/O ROUTINES TO ACCESS A KSDS, V...
  * `1111-WRITE-REPORT-REC` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
  * `0000-TRANFILE-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `PROCESS-ENTER-KEY` (Impact: 22.6)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `MAIN-PARA` (Impact: 15.6)
  * `WRITE-TRANSACT-FILE` (Impact: 7.9)
    * *Intent:* *----------------------------------------------------------------* * WRITE-TRANSACT-FILE *----------...
  * `READ-ACCTDAT-FILE` (Impact: 6.5)
    * *Intent:* *----------------------------------------------------------------* * READ-ACCTDAT-FILE *------------...
  * `READ-CXACAIX-FILE` (Impact: 6.5)
...
* *Architecture:* `io: 11`, `api: 1`, `import: 10`
* *Defense:* None
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `1000-DALYTRAN-GET-NEXT` (Impact: 10.2)
    * *Intent:* ***************************************************************** * READS FILE * *******************...
  * `MAIN-PARA` (Impact: 9.2)
  * `0000-DALYTRAN-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
  * `0100-CUSTFILE-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
  * `0200-XREFFILE-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 309.22 | **LOC:** 621 | **CtrlFlow:** 7.7% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (57.1244%), Tech Debt (9.5314%)
**Top Internal Functions/Classes:**
  * `4000-PROCESS-REQUEST-REPLY` (Impact: 10.6)
  * `3000-GET-REQUEST` (Impact: 8.8)
  * `4100-PUT-REPLY` (Impact: 7.0)
  * `2100-OPEN-ERROR-QUEUE` (Impact: 6.8)
  * `9000-ERROR` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
* *Architecture:* `io: 21`, `api: 1`, `import: 7`
* *Defense:* `doc: 2`
* *Network Topology:*
  * `Ecosystem Role:` Pure Consumer (Orchestrator) | `Dependency Blast Radius (PageRank):` 3.904
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.0
...
**Top Internal Functions/Classes:**
  * `UPDATE-USER-INFO` (Impact: 18.4)
    * *Intent:* *----------------------------------------------------------------* * UPDATE-USER-INFO *-------------...
  * `MAIN-PARA` (Impact: 17.9)
  * `PROCESS-ENTER-KEY` (Impact: 7.5)
    * *Intent:* *----------------------------------------------------------------* * PROCESS-ENTER-KEY *------------...
  * `READ-USER-SEC-FILE` (Impact: 6.7)
    * *Intent:* *----------------------------------------------------------------* * READ-USER-SEC-FILE *-----------...
  * `UPDATE-USER-SEC-FILE` (Impact: 6.7)
...
**Top Internal Functions/Classes:**
  * `1100-OPEN-FILES` (Impact: 9.2)
    * *Intent:* *****************************************************************
  * `2200-CREATE-CUSTOMER-EXP-REC` (Impact: 4.0)
    * *Intent:* *****************************************************************
  * `5200-CREATE-TRAN-EXP-REC` (Impact: 3.9)
    * *Intent:* *****************************************************************
  * `3200-CREATE-ACCOUNT-EXP-REC` (Impact: 3.8)
    * *Intent:* *****************************************************************
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 270.76 | **LOC:** 525 | **CtrlFlow:** 7.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (58.8126%), Tech Debt (9.9327%)
**Top Internal Functions/Classes:**
  * `3000-GET-REQUEST` (Impact: 8.8)
  * `4100-PUT-REPLY` (Impact: 7.0)
  * `2100-OPEN-ERROR-QUEUE` (Impact: 6.8)
  * `9000-ERROR` (Impact: 6.8)
  * `2300-OPEN-INPUT-QUEUE` (Impact: 6.7)
**Contextual Mitigations & Amplifications:**
...
* *Architecture:* `io: 15`, `api: 1`, `import: 6`
* *Defense:* `doc: 2`
* *Network Topology:*
...
**Top Internal Functions/Classes:**
  * `FILE-CONTROL` (Impact: 13.7)
  * `1000-ACCTFILE-GET-NEXT` (Impact: 10.7)
    * *Intent:* ***************************************************************** * I/O ROUTINES TO ACCESS A KSDS, V...
  * `0000-ACCTFILE-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
  * `2000-OUTFILE-OPEN` (Impact: 5.8)
  * `3000-ARRFILE-OPEN` (Impact: 5.8)
    * *Intent:* *---------------------------------------------------------------*
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 40 instances
