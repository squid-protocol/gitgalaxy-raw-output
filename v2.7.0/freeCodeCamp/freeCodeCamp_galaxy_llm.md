...
| credential | 9 | 5 | 0 | `api/src/routes/protected/settings.test.ts` |
...
- `togglePane` (@ `client/src/templates/Challenges/classic/desktop-layout.tsx`) -> Impact: **98.7** | LOC: 221
- `Scene` (@ `client/src/templates/Challenges/components/scene/scene.tsx`) -> Impact: **84.3** | LOC: 413
- `generateExam` (@ `api/src/exam-environment/utils/exam-environment.ts`) -> Impact: **76.5** | LOC: 314
  * *Intent:* /** * Generates an exam for the user, based on the exam configuration. */
- `createLanguageBlock` (@ `tools/challenge-helper-scripts/create-language-block.ts`) -> Impact: **68.5** | LOC: 73
- `render` (@ `client/src/templates/Introduction/components/block.tsx`) -> Impact: **68.1** | LOC: 462
- `postExamGeneratedExamHandler` (@ `api/src/exam-environment/routes/exam-environment.ts`) -> Impact: **66.8** | LOC: 336
  * *Intent:* /** * Generates an exam for the user. * * Requires token to be validated and TODO: live longer than the exam attempt. */
- `handleSubmit` (@ `client/src/components/profile/components/experience.tsx`) -> Impact: **63.7** | LOC: 201
- `courseCompletionStatus` (@ `client/src/templates/Introduction/components/block.tsx`) -> Impact: **61.5** | LOC: 411
- `sourceChallengesSourceNodes` (@ `tools/client-plugins/gatsby-source-challenges/gatsby-node.js`) -> Impact: **61.1** | LOC: 217
- `transformer` (@ `tools/challenge-parser/parser/plugins/add-video-question.js`) -> Impact: **58.6** | LOC: 132
...
- **Heaviest Functions:** `Scene` (Impact: 84.3), `resetScene` (Impact: 34.7), `updateCurrentTime` (Impact: 15.1)
...
- **Heaviest Functions:** `exports` (Impact: 15.5), `levenshtein` (Impact: 11.2)
...
- **Heaviest Functions:** `parseApiResponseToClientUser` (Impact: 10.6), `getUserProfile` (Impact: 7.9), `getCSRFToken` (Impact: 4.2)
...
- **Heaviest Functions:** `registerTerminal` (Impact: 14.3), `listener` (Impact: 10.0), `interruptCodeExecution` (Impact: 4.0)
...
- **Heaviest Functions:** `embedFilesInHtml` (Impact: 47.9), `embedStylesAndScript` (Impact: 47.7), `transformScript` (Impact: 15.7)
...
- **Primary Risk Drivers:** Concurrency (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `execute` (Impact: 9.2), `_execute` (Impact: 7.3), `_handleTaskEnd` (Impact: 6.5)
...
- **Heaviest Functions:** `createLanguageBlock` (Impact: 68.5), `validate` (Impact: 28.9), `updateIntroJson` (Impact: 24.3)
...
- **Heaviest Functions:** `createTerminal` (Impact: 27.4), `keyListener` (Impact: 15.1), `print` (Impact: 10.4)
...
- **Heaviest Functions:** `extendClient` (Impact: 2.6), `update` (Impact: 1.6), `updateMany` (Impact: 1.6)
...
- **Heaviest Functions:** `createFramer` (Impact: 11.2), `prepTestRunner` (Impact: 8.4), `updateProxyConsole` (Impact: 8.1)
...
**Top Internal Functions/Classes:**
  * `setTabTrapped` (Impact: 23.7)
  * `Editor` (Impact: 21.0)
  * `handleSubmitAndGoButtonBoolean` (Impact: 17.1)
  * `createDescription` (Impact: 15.7)
  * `onChange` (Impact: 14.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
...
**Top Internal Functions/Classes:**
  * `submitExam` (Impact: 2.0)
  * `createMSUsernameRecord` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
