...
| Avg Path Length | 5.7402 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 8.8 | 1.8 | 0.0 |
...
| connectivity | 20890 | 2244 | 10 | `lib/B/Deparse.pm` |
...
| dead_code | 5888 | 1129 | 2 | `lib/B/Deparse.pm` |
...
- `gv_name` (@ `lib/B/Deparse.pm`) -> Impact: **6226.9** | LOC: 1867
- `stash_variable_name` (@ `lib/B/Deparse.pm`) -> Impact: **5932.9** | LOC: 1897
...
- `pp_nextstate` (@ `lib/B/Deparse.pm`) -> Impact: **5930.0** | LOC: 1877
  * *Intent:* # Notice how subs and formats are inserted between statements here; # also $[ assignments and pragmas.
- `opt_o_with` (@ `cpan/Pod-Perldoc/lib/Pod/Perldoc.pm`) -> Impact: **5692.5** | LOC: 1963
- `_read_tar` (@ `cpan/Archive-Tar/lib/Archive/Tar.pm`) -> Impact: **3707.7** | LOC: 1910
- `makeaperl` (@ `cpan/ExtUtils-MakeMaker/lib/ExtUtils/MM_Unix.pm`) -> Impact: **3577.9** | LOC: 1577
- `setupFormat` (@ `cpan/IO-Compress/bin/zipdetails`) -> Impact: **2766.2** | LOC: 2071
- `cmd_wrapper` (@ `lib/perl5db.pl`) -> Impact: **2737.0** | LOC: 1800
- `init` (@ `cpan/CPAN/lib/CPAN/FirstTime.pm`) -> Impact: **2654.5** | LOC: 1386
- `re_dq_disambiguate` (@ `lib/B/Deparse.pm`) -> Impact: **2610.8** | LOC: 1177
  * *Intent:* # Join two components of a double-quoted re, disambiguating # "${foo}bar", "${foo}{bar}", "${foo}[1]".

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `pod` | 147 | 287595.92 | 14.78% | 40.1% |
| `__monolith__` | 153 | 162549.62 | 49.66% | 14.26% |
...
- `toke.c` -> **97** Orphaned Functions | **0** Duplicates
...
- **Heaviest Functions:** `run_multiple_progs` (Impact: 184.1), `watchdog` (Impact: 98.8), `runperl_and_capture` (Impact: 48.2)
...
- **Heaviest Functions:** `cc` (Impact: 18.5), `is_if_taint_supported` (Impact: 9.4), `wrap` (Impact: 7.2)
...
- **Heaviest Functions:** `gv_name` (Impact: 6226.9), `stash_variable_name` (Impact: 5932.9), `pp_nextstate` (Impact: 5930.0)
...
- **Heaviest Functions:** `parse_from_file` (Impact: 39.8), `new` (Impact: 2.0), `tree` (Impact: 1.5)
...
- **Heaviest Functions:** `IO::Compress::Base::Parameters::_checkType` (Impact: 91.9), `IO::Compress::Base::Validator::new` (Impact: 80.1), `IO::Compress::Base::Parameters::parse` (Impact: 39.4)
...
- **Heaviest Functions:** `emit_par` (Impact: 7.0), `start_head1` (Impact: 6.5), `end_Verbatim` (Impact: 5.1)
...
- **Heaviest Functions:** `set_exit` (Impact: 76.0), `_finalize` (Impact: 53.7), `_ipc_wait` (Impact: 43.9)
...
- **Heaviest Functions:** `test_dist` (Impact: 75.6), `watchdog` (Impact: 50.2), `_create_runperl` (Impact: 47.5)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `uncompr` (Impact: 43.0), `mkUncompObject` (Impact: 7.1), `reset` (Impact: 2.0)
...
- **Heaviest Functions:** `run` (Impact: 100.8), `isolate` (Impact: 47.2), `init` (Impact: 26.4)
...
- **Magnitude:** 15109.54 | **LOC:** 14086 | **CtrlFlow:** 29.5% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (94.9707%), Tech Debt (9.7756%)
**Top Internal Functions/Classes:**
  * `store_pipelocs` (Impact: 556.0)
  * `int_tovmsspec` (Impact: 480.9)
    * *Intent:* /*{{{ char *tovmsspec[_ts](char *path, char *buf, int * utf8_flag)*/
  * `posix_to_vmsspec_hardway` (Impact: 445.9)
    * *Intent:* */
  * `int_rmsexpand` (Impact: 346.3)
  * `int_fileify_dirspec` (Impact: 341.0)
...
* *Risk/State:* `safety_bypasses: 168`, `high_risk_execution: 14`, `state_mutation: 2593`, `dead_code: 20`, `planned_debt: 9`, `fragile_debt: 16`
* *Architecture:* `io: 29`, `api: 244`, `import: 42`
...
**Top Internal Functions/Classes:**
  * `Perl_sv_vcatpvfn_flags` (Impact: 1480.1)
  * `Perl_sv_setsv_flags` (Impact: 1012.3)
  * `Perl_sv_clear` (Impact: 790.5)
    * *Intent:* */
  * `S_find_uninit_var` (Impact: 781.0)
    * *Intent:* */
  * `S_format_hexfp` (Impact: 249.9)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 14380.24 | **LOC:** 17650 | **CtrlFlow:** 33.9% | **Authorship Centralization:** 31.0%
- **Risk Profile:** Cognitive Load (82.811%), Tech Debt (9.8361%)
**Top Internal Functions/Classes:**
  * `Perl_newATTRSUB_x` (Impact: 480.2)
    * *Intent:* */ /* _x = extended */
  * `Perl_op_lvalue_flags` (Impact: 456.2)
    * *Intent:* */
  * `S_pmtrans` (Impact: 379.8)
    * *Intent:* * a translation table attached as o->op_pv. * Free expr and repl. * It expects the toker to have alr...
  * `Perl_scalarvoid` (Impact: 308.3)
    * *Intent:* /* apply void context to the optree arg */
  * `Perl_newMYSUB` (Impact: 236.0)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
* *Risk/State:* `safety_bypasses: 203`, `high_risk_execution: 2`, `state_mutation: 1890`, `dead_code: 29`, `planned_debt: 11`, `fragile_debt: 18`
* *Architecture:* `api: 455`, `import: 8`
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 13319.06 | **LOC:** 16628 | **CtrlFlow:** 28.8% | **Authorship Centralization:** 92.0%
- **Risk Profile:** Cognitive Load (96.4397%), Tech Debt (32.3455%)
**Top Internal Functions/Classes:**
  * `S_regclass` (Impact: 1211.9)
  * `S_reg` (Impact: 966.6)
    * *Intent:* * has to add them to its *flagp. This means that it takes extra steps to keep * passing a flag upwar...
  * `S_regatom` (Impact: 929.2)
    * *Intent:* */
  * `S_parse_uniprop_string` (Impact: 811.1)
  * `Perl_re_op_compile` (Impact: 721.5)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 13286.78 | **LOC:** 14900 | **CtrlFlow:** 36.5% | **Authorship Centralization:** 93.1%
- **Risk Profile:** Cognitive Load (83.8528%), Tech Debt (38.6092%)
**Top Internal Functions/Classes:**
  * `yyl_word_or_keyword` (Impact: 863.4)
  * `S_scan_const` (Impact: 455.8)
    * *Intent:* */
  * `yyl_try` (Impact: 388.6)
  * `S_intuit_more` (Impact: 290.2)
    * *Intent:* * { and [ outside a pattern are always subscripts, so return TRUE * if we're outside a pattern and i...
  * `yyl_just_a_word` (Impact: 209.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `cmd_wrapper` (Impact: 2737.0)
  * `sethelp` (Impact: 1662.5)
  * `runman` (Impact: 446.4)
  * `db_complete` (Impact: 154.2)
  * `DB` (Impact: 110.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `opt_o_with` (Impact: 5692.5)
  * `page` (Impact: 271.4)
    * *Intent:* #..........................................................................
  * `grand_search_init` (Impact: 125.2)
    * *Intent:* #..........................................................................
  * `search_perlfunc` (Impact: 94.8)
    * *Intent:* #..........................................................................
  * `search_perlvar` (Impact: 75.7)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `makeaperl` (Impact: 3577.9)
  * `find_perl` (Impact: 92.0)
  * `init_main` (Impact: 89.7)
  * `init_dirscan` (Impact: 82.8)
  * `init_PERL` (Impact: 73.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 5 instances
* *Amplified Rce:* 2 instances
...
**Top Internal Functions/Classes:**
  * `setupFormat` (Impact: 2766.2)
  * `walk_Zip64_in_CD` (Impact: 114.3)
  * `LocalHeader` (Impact: 105.3)
  * `displayMessages` (Impact: 101.5)
  * `walk_Zip64_in_LD` (Impact: 99.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
- `toke.c` -> Churn: **95.37%** | Cog Load: 83.8528% | Debt: 38.6092%
- `pod/perldelta.pod` -> Churn: **88.28%** | Cog Load: 8.1707% | Debt: 100.0%
- `numeric.c` -> Churn: **80.57%** | Cog Load: 86.4884% | Debt: 15.3967%
- `regexec.c` -> Churn: **74.43%** | Cog Load: 97.0404% | Debt: 24.1674%
- `op.c` -> Churn: **74.13%** | Cog Load: 82.811% | Debt: 9.8361%

### 👤 Key Person Dependencies (High Impact + Siloed Knowledge)
These are massive, load-bearing files written almost entirely by a single developer. They represent severe 'Bus Factor' risk.

- `pod/perlre.pod` -> **Karl Williamson** (100.0% isolated ownership) | Magnitude: 21504.82
- `vms/vms.c` -> **Karl Williamson** (100.0% isolated ownership) | Magnitude: 15109.54
- `pod/perlebcdic.pod` -> **Karl Williamson** (100.0% isolated ownership) | Magnitude: 14380.2
- `regcomp.c` -> **Karl Williamson** (92.0% isolated ownership) | Magnitude: 13319.06
- `toke.c` -> **Karl Williamson** (93.1% isolated ownership) | Magnitude: 13286.78
...
- `cpan/CPAN/lib/CPAN.pm` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 97.6867%)
- `cpan/Test-Harness/t/errors.t` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 95.8808%)
