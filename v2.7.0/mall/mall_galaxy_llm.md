...
|---|---|
| Total Artifacts | 719 |
| Analyzed Artifacts (Scanned) | 666 |
...
|---|---|---|
| Unclassified | 655 | 98.3% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 11 | 1.7% |
...
- `.yml`: 1x Zero-Density Threshold (LOC: 59, Signals: 0), 1x Zero-Density Threshold (LOC: 51, Signals: 0), 1x Zero-Density Threshold (LOC: 52, Signals: 0)
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 99.3 | 28.7 | 0.0 | 0.0 |
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 19.2 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 13.1 | 2.4 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 97.1 | 28.1 | 10.6 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 53.2 | 93.8 | 100.0 |
...
| docs | 770 | 292 | 3 | `mall-common/src/main/java/com/macro/mall/common/service/RedisService.java` |
...
| credential | 1 | 1 | 0 | `mall-common/src/main/resources/logback-spring.xml` |
...
- `guard_balance_ratio` (guards / (danger + 1)): **0.0188**
...
- `search` (@ `mall-search/src/main/java/com/macro/mall/search/service/impl/EsProductServiceImpl.java`) -> Impact: **45.4** | LOC: 62
...
- `calcCartPromotion` (@ `mall-portal/src/main/java/com/macro/mall/portal/service/impl/OmsPromotionServiceImpl.java`) -> Impact: **31.0** | LOC: 83
- `search` (@ `mall-portal/src/main/java/com/macro/mall/portal/service/impl/PmsPortalProductServiceImpl.java`) -> Impact: **30.5** | LOC: 28
- `list` (@ `mall-admin/src/main/java/com/macro/mall/service/impl/SmsHomeAdvertiseServiceImpl.java`) -> Impact: **28.6** | LOC: 34
- `getRequestIp` (@ `mall-common/src/main/java/com/macro/mall/common/util/RequestUtil.java`) -> Impact: **22.7** | LOC: 30
  * *Intent:* /** * 获取请求真实IP地址 */
- `convertProductRelatedInfo` (@ `mall-search/src/main/java/com/macro/mall/search/service/impl/EsProductServiceImpl.java`) -> Impact: **17.6** | LOC: 40
  * *Intent:* /** * 将返回结果转换为对象 */
- `list` (@ `mall-admin/src/main/java/com/macro/mall/service/impl/PmsProductServiceImpl.java`) -> Impact: **15.3** | LOC: 26
...
### 1. `mall-admin/src/main/java/com/macro/mall/service/impl/UmsAdminServiceImpl.java` (JAVA) -> Cumulative Risk: **611.75**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 139.1 | **LOC:** 288 | **CtrlFlow:** 9.6% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.3417%), Documentation (93.75%), Tech Debt (88.9273%)
- **Heaviest Functions:** `updateRole` (Impact: 11.4), `update` (Impact: 9.6), `login` (Impact: 8.0)

### 2. `mall-admin/src/main/java/com/macro/mall/service/impl/OmsOrderReturnApplyServiceImpl.java` (JAVA) -> Cumulative Risk: **580.92**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 73.5 | **LOC:** 79 | **CtrlFlow:** 9.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (97.4762%)
- **Heaviest Functions:** `updateStatus` (Impact: 13.7), `list` (Impact: 2.2), `delete` (Impact: 1.7)

### 3. `mall-admin/src/main/java/com/macro/mall/service/impl/OmsOrderServiceImpl.java` (JAVA) -> Cumulative Risk: **574.94**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 83.68 | **LOC:** 154 | **CtrlFlow:** 0.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9997%), Tech Debt (96.9826%)
- **Heaviest Functions:** `close` (Impact: 4.4), `updateNote` (Impact: 2.8), `updateReceiverInfo` (Impact: 2.6)

### 4. `mall-mbg/src/main/java/com/macro/mall/model/UmsAdminRoleRelationExample.java` (JAVA) -> Cumulative Risk: **570.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 5. `mall-mbg/src/main/java/com/macro/mall/model/CmsPrefrenceAreaProductRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 6. `mall-mbg/src/main/java/com/macro/mall/model/CmsSubjectProductRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 7. `mall-mbg/src/main/java/com/macro/mall/model/PmsProductCategoryAttributeRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 8. `mall-mbg/src/main/java/com/macro/mall/model/UmsMemberMemberTagRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 9. `mall-mbg/src/main/java/com/macro/mall/model/UmsMemberProductCategoryRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)

### 10. `mall-mbg/src/main/java/com/macro/mall/model/UmsRoleMenuRelationExample.java` (JAVA) -> Cumulative Risk: **566.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 247.26 | **LOC:** 379 | **CtrlFlow:** 3.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Safety Score (97.7957%), State Flux (97.0859%)
- **Heaviest Functions:** `Criterion` (Impact: 8.6), `addCriterion` (Impact: 7.0), `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (6.5725%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
  * `addCriterion` (Impact: 4.5)
  * `Criterion` (Impact: 2.6)
...
- **Risk Profile:** Cognitive Load (6.8141%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (7.4141%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (8.1686%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (8.9159%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `addCriterionForJDBCDate` (Impact: 8.6)
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterionForJDBCDate` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (8.6546%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (8.8199%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (9.4243%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (9.4778%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (9.7319%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (10.3398%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (10.6295%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (10.7967%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (10.858%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (11.1399%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (11.2203%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (11.425%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (11.5131%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (48.895%), Tech Debt (39.9775%)
**Top Internal Functions/Classes:**
  * `generateOrder` (Impact: 35.9)
  * `getCouponOrderItemByRelation` (Impact: 33.5)
    * *Intent:* /** * 获取与优惠券有关系的下单商品 * * @param couponHistoryDetail 优惠券详情 * @param orderItemList 下单商品 * @param type ...
  * `list` (Impact: 14.1)
  * `cancelOrder` (Impact: 13.1)
  * `getUseIntegrationAmount` (Impact: 12.4)
...
- **Risk Profile:** Cognitive Load (11.7239%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (11.7376%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
...
- **Risk Profile:** Cognitive Load (12.5806%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Criterion` (Impact: 8.6)
  * `addCriterion` (Impact: 7.0)
  * `addCriterion` (Impact: 6.3)
