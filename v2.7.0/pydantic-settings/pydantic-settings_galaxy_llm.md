...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 69.8 | 90.0 | 100.0 |
...
- `_settings_init_sources` (@ `pydantic_settings-2.13.1/pydantic_settings/main.py`) -> Impact: **359.6** | LOC: 181
- `__init__` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py`) -> Impact: **230.8** | LOC: 129
- `_add_parser_args` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py`) -> Impact: **158.9** | LOC: 150
- `_add_parser_submodels` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py`) -> Impact: **116.2** | LOC: 83
- `_serialized_args` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py`) -> Impact: **91.2** | LOC: 77
- `_help_format` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py`) -> Impact: **65.0** | LOC: 26
- `explode_env_vars` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/env.py`) -> Impact: **61.5** | LOC: 67
...
- `__init__` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/providers/nested_secrets.py`) -> Impact: **57.5** | LOC: 111
- `_get_alias_names` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/utils.py`) -> Impact: **51.3** | LOC: 43
- `_annotation_contains_types` (@ `pydantic_settings-2.13.1/pydantic_settings/sources/utils.py`) -> Impact: **49.8** | LOC: 43
...
### 1. `pydantic_settings-2.13.1/pydantic_settings/main.py` (PYTHON) -> Cumulative Risk: **697.05**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 900.28 | **LOC:** 902 | **CtrlFlow:** 22.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.383%), Documentation (96.2963%)
- **Heaviest Functions:** `_settings_init_sources` (Impact: 359.6), `run` (Impact: 45.8), `_settings_restore_init_kwarg_names` (Impact: 30.1)

### 2. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/gcp.py` (PYTHON) -> Cumulative Risk: **637.56**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 206.2 | **LOC:** 242 | **CtrlFlow:** 23.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.3488%), Documentation (90.9091%)
- **Heaviest Functions:** `__init__` (Impact: 43.5), `get_field_value` (Impact: 28.2), `__getitem__` (Impact: 11.1)

### 3. `pydantic_settings-2.13.1/pydantic_settings/sources/base.py` (PYTHON) -> Cumulative Risk: **629.96**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 561.76 | **LOC:** 580 | **CtrlFlow:** 37.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.3111%), Verification (80.0%)
- **Heaviest Functions:** `_extract_field_info` (Impact: 48.6), `_replace_field_names_case_insensitively` (Impact: 41.9), `__init__` (Impact: 40.1)

### 4. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/nested_secrets.py` (PYTHON) -> Cumulative Risk: **627.98**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 133.72 | **LOC:** 167 | **CtrlFlow:** 19.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.987%), Safety Score (90.3438%)
- **Heaviest Functions:** `__init__` (Impact: 57.5), `validate_secrets_path` (Impact: 19.9), `load_secrets` (Impact: 4.5)

### 5. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/cli.py` (PYTHON) -> Cumulative Risk: **615.24**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2198.06 | **LOC:** 1523 | **CtrlFlow:** 37.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.7139%), Documentation (90.3226%)
- **Heaviest Functions:** `__init__` (Impact: 230.8), `_add_parser_args` (Impact: 158.9), `_add_parser_submodels` (Impact: 116.2)

### 6. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/azure.py` (PYTHON) -> Cumulative Risk: **614.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 140.0 | **LOC:** 160 | **CtrlFlow:** 23.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Safety Score (91.6194%)
- **Heaviest Functions:** `__init__` (Impact: 17.9), `_load_remote` (Impact: 16.5), `__getitem__` (Impact: 14.8)

### 7. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/dotenv.py` (PYTHON) -> Cumulative Risk: **600.48**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 118.02 | **LOC:** 171 | **CtrlFlow:** 19.9% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9695%), Safety Score (86.8266%)
- **Heaviest Functions:** `__call__` (Impact: 27.2), `__init__` (Impact: 19.5), `_read_env_files` (Impact: 7.8)

### 8. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/env.py` (PYTHON) -> Cumulative Risk: **562.5**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 298.44 | **LOC:** 311 | **CtrlFlow:** 39.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.9248%), Verification (80.0%)
- **Heaviest Functions:** `explode_env_vars` (Impact: 61.5), `next_field` (Impact: 40.8), `prepare_field_value` (Impact: 36.5)

### 9. `pydantic_settings-2.13.1/pydantic_settings/sources/utils.py` (PYTHON) -> Cumulative Risk: **555.58**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 301.02 | **LOC:** 284 | **CtrlFlow:** 37.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Safety Score (97.9545%), Verification (80.0%)
- **Heaviest Functions:** `_get_alias_names` (Impact: 51.3), `_annotation_contains_types` (Impact: 49.8), `_annotation_is_complex` (Impact: 22.3)

### 10. `pydantic_settings-2.13.1/pydantic_settings/sources/providers/secrets.py` (PYTHON) -> Cumulative Risk: **536.03**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 80.08 | **LOC:** 133 | **CtrlFlow:** 27.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.8788%), Safety Score (88.7015%), Verification (80.0%)
- **Heaviest Functions:** `__call__` (Impact: 16.9), `get_field_value` (Impact: 13.5), `find_case_path` (Impact: 12.1)
...
- **Magnitude:** 2198.06 | **LOC:** 1523 | **CtrlFlow:** 37.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (79.5439%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 230.8)
  * `_add_parser_args` (Impact: 158.9)
  * `_add_parser_submodels` (Impact: 116.2)
  * `_serialized_args` (Impact: 91.2)
  * `_help_format` (Impact: 65.0)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00061 | `Ripple Effect (Closeness):` 0.052632
...
- **Risk Profile:** Cognitive Load (15.3124%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_env_parse_enums` (Impact: 13.9)
  * `test_discriminated_union_with_callable_discriminator` (Impact: 10.3)
  * `get_discriminator_value` (Impact: 9.1)
  * `test_alias_resolution_init_source` (Impact: 8.5)
  * `check_for_deprecated_attributes` (Impact: 7.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (14.7533%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_cli_annotation_exceptions` (Impact: 26.2)
  * `test_cli_metavar_format` (Impact: 24.8)
  * `test_cli_bool_flags` (Impact: 21.9)
  * `test_cli_dict_arg` (Impact: 16.4)
  * `test_cli_user_settings_source` (Impact: 15.1)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 900.28 | **LOC:** 902 | **CtrlFlow:** 22.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (67.2941%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_settings_init_sources` (Impact: 359.6)
  * `run` (Impact: 45.8)
  * `_settings_restore_init_kwarg_names` (Impact: 30.1)
  * `_settings_build_values` (Impact: 23.5)
  * `run_subcommand` (Impact: 22.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 3 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.029291 | `Ripple Effect (Closeness):` 0.479605
...
- **Risk Profile:** Cognitive Load (28.6347%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `mock_secret_client_factory` (Impact: 14.2)
  * `_create_client` (Impact: 14.1)
  * `test_secret_version_annotation` (Impact: 13.6)
  * `test_secret_manager_mapping_collision` (Impact: 10.7)
  * `test_secret_version_no_fallback` (Impact: 10.0)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 301.02 | **LOC:** 284 | **CtrlFlow:** 37.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (53.0188%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_get_alias_names` (Impact: 51.3)
  * `_annotation_contains_types` (Impact: 49.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.007172 | `Ripple Effect (Closeness):` 0.247076
...
- **Risk Profile:** Cognitive Load (12.1174%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_multiple_file_yaml_deep_merge` (Impact: 7.2)
  * `test_yaml_config_section_unusual_literal_keys` (Impact: 5.0)
    * *Intent:* """Test that keys with leading/trailing/consecutive dots can be accessed as literal keys."""
  * `test_invalid_yaml_config_section_nested_path` (Impact: 4.3)
  * `test_yaml_config_section_with_literal_dots` (Impact: 4.3)
    * *Intent:* """Test that keys containing literal dots can be accessed using greedy matching."""
  * `test_yaml_config_section_non_dict_intermediate` (Impact: 4.3)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 206.2 | **LOC:** 242 | **CtrlFlow:** 23.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (88.413%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 43.5)
  * `get_field_value` (Impact: 28.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003533 | `Ripple Effect (Closeness):` 0.078947
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 140.0 | **LOC:** 160 | **CtrlFlow:** 23.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (65.9336%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 17.9)
  * `_load_remote` (Impact: 16.5)
...
- **Risk Profile:** Cognitive Load (9.1043%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_multiple_secrets_dirs` (Impact: 31.4)
  * `test_env_ignore_empty` (Impact: 5.8)
  * `test_invalid_options` (Impact: 3.4)
  * `settings_customise_sources` (Impact: 3.3)
  * `settings_customise_sources` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 133.72 | **LOC:** 167 | **CtrlFlow:** 19.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (61.325%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 57.5)
  * `validate_secrets_path` (Impact: 19.9)
  * `load_secrets` (Impact: 4.5)
  * `__repr__` (Impact: 1.5)
  * `first_not_none` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (11.5152%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_pyproject_toml_file_parent` (Impact: 3.7)
  * `test_pyproject_toml_no_file_too_shallow` (Impact: 3.5)
  * `test_pyproject_toml_file_explicit` (Impact: 3.4)
  * `test_pyproject_toml_file` (Impact: 2.9)
  * `test___init___no_file` (Impact: 2.8)
...
- **Risk Profile:** Cognitive Load (10.2947%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_snake_case_conversion` (Impact: 23.2)
    * *Intent:* """Test that secret names are mapped to snake case in field names."""
  * `test_snake_case_conversion_missing_alias` (Impact: 5.4)
  * `test_azure_key_vault_settings_source` (Impact: 4.1)
    * *Intent:* """Test AzureKeyVaultSettingsSource."""
  * `_raise_resource_not_found_when_getting_parent_secret_name` (Impact: 3.9)
  * `test_dash_to_underscore_translation` (Impact: 3.9)
...
- **Risk Profile:** Cognitive Load (24.8475%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `json_config_path` (Impact: 10.4)
  * `test_multiple_file_json_merge` (Impact: 6.7)
  * `settings_customise_sources` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 27.2)
  * `__init__` (Impact: 19.5)
  * `_read_env_files` (Impact: 7.8)
  * `read_env_file` (Impact: 5.8)
  * `_static_read_env_file` (Impact: 5.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 12.68
  * `Choke Point (Betweenness):` 0.002348 | `Ripple Effect (Closeness):` 0.078947
...
- **Risk Profile:** Cognitive Load (43.9883%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 22.5)
  * `_traverse_nested_section` (Impact: 16.2)
  * `_read_file` (Impact: 3.7)
  * `import_yaml` (Impact: 2.4)
  * `__repr__` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.006212 | `Ripple Effect (Closeness):` 0.105263
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00927 | `Ripple Effect (Closeness):` 0.135338
...
- **Risk Profile:** Cognitive Load (16.548%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_multiple_file_toml_merge` (Impact: 7.2)
  * `test_toml_file` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (8.9031%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_secret_manager_case_insensitive_success` (Impact: 3.2)
    * *Intent:* """Test secret manager getitem case insensitive success."""
  * `settings_customise_sources` (Impact: 3.1)
  * `settings_customise_sources` (Impact: 3.1)
  * `test_aws_secrets_manager_settings_source` (Impact: 3.0)
    * *Intent:* """Test AWSSecretsManagerSettingsSource."""
  * `test___call__` (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  ...
  * `test_precedence_dotenv_over_secrets` (Impact: 2.3)
    * *Intent:* # create dotenv env_file = tmp_path / '.env' env_file.write_text('FOO=from-dotenv\n') # create secre...
  * `test_init_kwargs_override_env_with_alias_and_extra_forbid` (Impact: 2.2)
...
- **Risk Profile:** Cognitive Load (23.3567%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `write` (Impact: 3.7)
  * `clear` (Impact: 3.0)
  * `cd_tmp_path` (Impact: 2.7)
    * *Intent:* """Change directory into the value of the ``tmp_path`` fixture. .. rubric:: Example .. code-block:: ...
  * `set` (Impact: 2.1)
  * `docs_test_env` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 18
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (42.7456%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 7.2)
  * `import_toml` (Impact: 5.7)
  * `_read_file` (Impact: 3.8)
  * `__repr__` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002253 | `Ripple Effect (Closeness):` 0.078947
...
- **Risk Profile:** Cognitive Load (36.1561%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_pick_pyproject_toml_file` (Impact: 11.5)
...
- `pydantic_settings-2.13.1/pydantic_settings/main.py` -> **Severity: 2.929** (Bridge: 0.0293 * Flux: 100.0%)
- `pydantic_settings-2.13.1/pydantic_settings/sources/base.py` -> **Severity: 1.25** (Bridge: 0.0125 * Flux: 100.0%)
- `pydantic_settings-2.13.1/pydantic_settings/sources/providers/secrets.py` -> **Severity: 0.926** (Bridge: 0.0093 * Flux: 99.8788%)
- `pydantic_settings-2.13.1/pydantic_settings/sources/providers/json.py` -> **Severity: 0.885** (Bridge: 0.0089 * Flux: 99.6316%)
- `pydantic_settings-2.13.1/pydantic_settings/sources/providers/env.py` -> **Severity: 0.717** (Bridge: 0.0072 * Flux: 100.0%)
