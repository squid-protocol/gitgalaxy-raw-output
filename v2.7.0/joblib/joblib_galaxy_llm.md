...
| Avg Path Length | 3.3263 | Hops between files. Lower = Tighter coupling. |
...
- `__init__` (@ `joblib-1.5.3/joblib/parallel.py`) -> Impact: **116.0** | LOC: 151
- `filter_args` (@ `joblib-1.5.3/joblib/func_inspect.py`) -> Impact: **78.4** | LOC: 136
...
- `get_reusable_executor` (@ `joblib-1.5.3/joblib/externals/loky/reusable_executor.py`) -> Impact: **77.5** | LOC: 95
- `dump` (@ `joblib-1.5.3/joblib/numpy_pickle.py`) -> Impact: **67.2** | LOC: 137
  * *Intent:* ############################################################################### # Utility functions """Persist an arbitrary Python object into one fil...
- `_process_worker` (@ `joblib-1.5.3/joblib/externals/loky/process_executor.py`) -> Impact: **60.8** | LOC: 136
- `main` (@ `joblib-1.5.3/joblib/externals/loky/backend/resource_tracker.py`) -> Impact: **58.8** | LOC: 137
  * *Intent:* """Run resource tracker."""
- `get_func_name` (@ `joblib-1.5.3/joblib/func_inspect.py`) -> Impact: **56.4** | LOC: 88
...
- `_get_items_to_delete` (@ `joblib-1.5.3/joblib/_store_backends.py`) -> Impact: **49.9** | LOC: 59
  * *Intent:* """ Get items to delete to keep the store under size, file, & age limits. """
- `_feed` (@ `joblib-1.5.3/joblib/externals/loky/backend/queues.py`) -> Impact: **44.4** | LOC: 66
  * *Intent:* # Overload the _feed methods to use our custom pickling strategy.
- `_check_backend` (@ `joblib-1.5.3/joblib/parallel.py`) -> Impact: **38.6** | LOC: 57
...
- **Heaviest Functions:** `get_preparation_data` (Impact: 33.0), `prepare` (Impact: 32.1), `_fixup_main_from_name` (Impact: 6.8)
...
- **Heaviest Functions:** `set_loky_pickler` (Impact: 28.7), `__init__` (Impact: 12.4), `_set_dispatch_table` (Impact: 6.2)
...
- **Heaviest Functions:** `__init__` (Impact: 36.8), `_to_func_args` (Impact: 21.9), `maybe_to_futures` (Impact: 16.2)
...
- **Heaviest Functions:** `cache` (Impact: 35.8), `_check_previous_func_code` (Impact: 32.9), `__init__` (Impact: 29.0)
...
- **Heaviest Functions:** `_cmp` (Impact: 11.0), `make_memmap` (Impact: 10.3), `concurrency_safe_rename` (Impact: 9.8)
...
- **Heaviest Functions:** `_feed` (Impact: 44.4), `_start_thread` (Impact: 6.6), `__setstate__` (Impact: 6.0)
...
- **Heaviest Functions:** `__init__` (Impact: 21.4), `wait_for` (Impact: 14.8), `notify_all` (Impact: 9.6)
...
- **Heaviest Functions:** `__init__` (Impact: 17.4), `__call__` (Impact: 9.2), `pformat` (Impact: 8.6)
...
- **Heaviest Functions:** `_launch` (Impact: 14.8), `poll` (Impact: 13.0), `wait` (Impact: 10.8)
...
- **Heaviest Functions:** `__init__` (Impact: 10.6), `_Popen` (Impact: 4.5), `__init__` (Impact: 3.7)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 116.0)
  * `_check_backend` (Impact: 38.6)
  * `_get_active_backend` (Impact: 38.0)
  * `__call__` (Impact: 32.9)
    * *Intent:* """Main function to dispatch parallel tasks."""
  * `_get_outputs` (Impact: 25.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.020557 | `Ripple Effect (Closeness):` 0.092593
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.036571 | `Ripple Effect (Closeness):` 0.102881
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.016014 | `Ripple Effect (Closeness):` 0.05787
...
**Top Internal Functions/Classes:**
  ...
  * `_to_func_args` (Impact: 21.9)
  * `maybe_to_futures` (Impact: 16.2)
  * `effective_n_jobs` (Impact: 9.9)
  * `_collect` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 11 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000349 | `Ripple Effect (Closeness):` 0.05144
...
**Top Internal Functions/Classes:**
  ...
  * `wait_for` (Impact: 14.8)
  * `notify_all` (Impact: 9.6)
  * `__repr__` (Impact: 9.3)
  * `__repr__` (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.039308 | `Ripple Effect (Closeness):` 0.25161
...
**Top Internal Functions/Classes:**
  * `get_preparation_data` (Impact: 33.0)
...
**Top Internal Functions/Classes:**
  * `get_reusable_executor` (Impact: 77.5)
  * `_resize` (Impact: 19.0)
  * `_wait_job_completion` (Impact: 7.9)
    * *Intent:* """Wait for the cache to be empty before resizing the pool."""
  * `get_reusable_executor` (Impact: 6.6)
  * `__init__` (Impact: 4.7)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
**Top Internal Functions/Classes:**
  * `set_loky_pickler` (Impact: 28.7)
  * `__init__` (Impact: 12.4)
  * `_set_dispatch_table` (Impact: 6.2)
  * `_reduce_method` (Impact: 4.5)
    * *Intent:* ############################################################################### # Registers extra pi...
  * `_reduce_partial` (Impact: 2.9)
...
**Top Internal Functions/Classes:**
  * `_cmp` (Impact: 11.0)
  * `make_memmap` (Impact: 10.3)
  * `concurrency_safe_rename` (Impact: 9.8)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 10.1)
  * `get_command_line` (Impact: 6.8)
...
- `joblib-1.5.3/joblib/externals/loky/process_executor.py` -> **Severity: 3.657** (Bridge: 0.0366 * Flux: 100.0%)
- `joblib-1.5.3/joblib/externals/loky/backend/context.py` -> **Severity: 3.341** (Bridge: 0.0393 * Flux: 85.0%)
...
- `joblib-1.5.3/joblib/parallel.py` -> **Severity: 2.056** (Bridge: 0.0206 * Flux: 100.0%)
