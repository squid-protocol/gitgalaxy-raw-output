...
| Avg Path Length | 2.915 | Hops between files. Lower = Tighter coupling. |
...
- `TagOpenParserToken` (@ `package/js/src/html/beautifier.js`) -> Impact: **303.2** | LOC: 304
- `_set_tag_position` (@ `package/js/src/html/beautifier.js`) -> Impact: **275.2** | LOC: 213
- `handle_word` (@ `package/js/src/javascript/beautifier.js`) -> Impact: **249.0** | LOC: 229
- `beautify` (@ `package/js/src/css/beautifier.js`) -> Impact: **167.3** | LOC: 386
  * *Intent:* /*_____________________--------------------_____________________*/
- `handle_operator` (@ `package/js/src/javascript/beautifier.js`) -> Impact: **121.4** | LOC: 194
- `handle_start_expr` (@ `package/js/src/javascript/beautifier.js`) -> Impact: **103.9** | LOC: 126
- `handle_start_block` (@ `package/js/src/javascript/beautifier.js`) -> Impact: **94.2** | LOC: 103
- `_do_optional_end_element` (@ `package/js/src/html/beautifier.js`) -> Impact: **83.1** | LOC: 106
- `_print_custom_beatifier_text` (@ `package/js/src/html/beautifier.js`) -> Impact: **65.1** | LOC: 102
- `handle_token` (@ `package/js/src/javascript/beautifier.js`) -> Impact: **59.0** | LOC: 37
...
### 1. `package/js/src/unpackers/p_a_c_k_e_r_unpacker.js` (JAVASCRIPT) -> Cumulative Risk: **707.46**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 201.3 | **LOC:** 120 | **CtrlFlow:** 58.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.9997%)
- **Heaviest Functions:** `run_tests` (Impact: 46.9), `unpack_chunk` (Impact: 6.7), `get_chunks` (Impact: 5.9)

### 2. `package/js/src/core/inputscanner.js` (JAVASCRIPT) -> Cumulative Risk: **684.94**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 233.4 | **LOC:** 193 | **CtrlFlow:** 25.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.3819%)
- **Heaviest Functions:** `get_regexp` (Impact: 12.9), `read` (Impact: 12.7), `__match` (Impact: 9.3)

### 3. `package/js/src/core/output.js` (JAVASCRIPT) -> Cumulative Risk: **683.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 486.18 | **LOC:** 420 | **CtrlFlow:** 19.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.513%)
- **Heaviest Functions:** `ensure_empty_line_above` (Impact: 11.1), `trim` (Impact: 9.2), `get_code` (Impact: 8.3)

### 4. `package/js/src/core/templatablepattern.js` (JAVASCRIPT) -> Cumulative Risk: **674.28**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 206.08 | **LOC:** 217 | **CtrlFlow:** 31.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.436%)
- **Heaviest Functions:** `_read_template` (Impact: 33.6), `TemplatablePattern` (Impact: 11.7), `__set_templated_pattern` (Impact: 10.6)

### 5. `package/js/src/html/beautifier.js` (JAVASCRIPT) -> Cumulative Risk: **671.77**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1627.84 | **LOC:** 921 | **CtrlFlow:** 47.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.4382%)
- **Heaviest Functions:** `TagOpenParserToken` (Impact: 303.2), `_set_tag_position` (Impact: 275.2), `_do_optional_end_element` (Impact: 83.1)

### 6. `package/js/src/javascript/beautifier.js` (JAVASCRIPT) -> Cumulative Risk: **647.3**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1771.32 | **LOC:** 1481 | **CtrlFlow:** 56.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.3562%)
- **Heaviest Functions:** `handle_word` (Impact: 249.0), `handle_operator` (Impact: 121.4), `handle_start_expr` (Impact: 103.9)

### 7. `package/js/src/unpackers/myobfuscate_unpacker.js` (JAVASCRIPT) -> Cumulative Risk: **619.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 44.46 | **LOC:** 120 | **CtrlFlow:** 22.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9999%), Tech Debt (93.6355%)
- **Heaviest Functions:** `detect` (Impact: 15.5), `run_tests` (Impact: 3.1), `starts_with` (Impact: 1.9)

### 8. `package/js/src/core/pattern.js` (JAVASCRIPT) -> Cumulative Risk: **610.68**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 69.0 | **LOC:** 95 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.6401%)
- **Heaviest Functions:** `Pattern` (Impact: 4.2), `read` (Impact: 3.4), `until_after` (Impact: 1.8)

### 9. `package/js/src/javascript/tokenizer.js` (JAVASCRIPT) -> Cumulative Risk: **604.55**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 10. `package/js/src/core/tokenstream.js` (JAVASCRIPT) -> Cumulative Risk: **595.81**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 67.62 | **LOC:** 79 | **CtrlFlow:** 12.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.3925%)
- **Heaviest Functions:** `peek` (Impact: 6.1), `add` (Impact: 3.2), `next` (Impact: 2.4)
...
- **Magnitude:** 1771.32 | **LOC:** 1481 | **CtrlFlow:** 56.8% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.3562%), Tech Debt (11.1613%)
**Top Internal Functions/Classes:**
  * `handle_word` (Impact: 249.0)
  * `handle_operator` (Impact: 121.4)
  * `handle_start_expr` (Impact: 103.9)
  * `handle_start_block` (Impact: 94.2)
  * `handle_token` (Impact: 59.0)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1627.84 | **LOC:** 921 | **CtrlFlow:** 47.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.4382%), Tech Debt (10.3629%)
**Top Internal Functions/Classes:**
  * `TagOpenParserToken` (Impact: 303.2)
  * `_set_tag_position` (Impact: 275.2)
  * `_do_optional_end_element` (Impact: 83.1)
  * `_print_custom_beatifier_text` (Impact: 65.1)
...
- **Risk Profile:** Cognitive Load (67.4366%), Tech Debt (14.8047%)
**Top Internal Functions/Classes:**
  * `checkFiles` (Impact: 36.9)
  * `set_file_editorconfig_opts` (Impact: 31.5)
  * `interpret` (Impact: 22.7)
    * *Intent:* // var cli = require('js-beautify/cli'); cli.interpret();
  * `processInputSync` (Impact: 19.9)
    * *Intent:* // main iterator, {cfg} passed as thisArg of forEach call
  * `getOutputType` (Impact: 18.6)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 486.18 | **LOC:** 420 | **CtrlFlow:** 19.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (95.2574%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ensure_empty_line_above` (Impact: 11.1)
  * `trim` (Impact: 9.2)
  * `get_code` (Impact: 8.3)
  * `IndentStringCache` (Impact: 7.8)
  * `add_new_line` (Impact: 7.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (98.3243%), Tech Debt (12.1928%)
**Top Internal Functions/Classes:**
  * `beautify` (Impact: 167.3)
    * *Intent:* /*_____________________--------------------_____________________*/
  * `foundNestedPseudoClass` (Impact: 12.2)
    * *Intent:* // Nested pseudo-class if we are insideRule // and the next special character found opens // a new b...
  * `eatString` (Impact: 9.2)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 354.9 | **LOC:** 587 | **CtrlFlow:** 52.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (94.3589%), Tech Debt (15.4188%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (93.932%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 206.08 | **LOC:** 217 | **CtrlFlow:** 31.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.436%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `_read_template` (Impact: 33.6)
  ...
  * `__set_templated_pattern` (Impact: 10.6)
  * `read` (Impact: 8.2)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 201.3 | **LOC:** 120 | **CtrlFlow:** 58.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (97.8546%), Tech Debt (54.7929%)
**Top Internal Functions/Classes:**
  * `run_tests` (Impact: 46.9)
  * `unpack_chunk` (Impact: 6.7)
  * `get_chunks` (Impact: 5.9)
  * `unpack` (Impact: 3.3)
  * `detect` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (99.2131%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `tokenize` (Impact: 10.2)
...
- **Risk Profile:** Cognitive Load (94.373%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `__split` (Impact: 7.9)
...
- **Risk Profile:** Cognitive Load (68.7858%), Tech Debt (41.5929%)
**Top Internal Functions/Classes:**
  * `_fix_quotes` (Impact: 16.2)
  * `unpack` (Impact: 10.6)
  * `detect` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 69.0 | **LOC:** 95 | **CtrlFlow:** 5.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (99.6401%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `Pattern` (Impact: 4.2)
  * `read` (Impact: 3.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 44.46 | **LOC:** 120 | **CtrlFlow:** 22.6% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (71.2111%), Tech Debt (93.6355%)
**Top Internal Functions/Classes:**
  * `detect` (Impact: 15.5)
...
- **Risk Profile:** Cognitive Load (16.2465%), Tech Debt (73.1059%)
**Top Internal Functions/Classes:**
  * `unpack` (Impact: 7.6)
  * `detect` (Impact: 6.1)
  * `run_tests` (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (42.3971%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `get_beautify` (Impact: 2.9)
    * *Intent:* **/
  * `beautify` (Impact: 1.9)
