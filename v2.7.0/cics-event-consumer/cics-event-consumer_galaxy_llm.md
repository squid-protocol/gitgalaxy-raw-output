...
- `resolveTokensInKey` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java`) -> Impact: **502.0** | LOC: 727
...
- `getFileUsingFTP` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java`) -> Impact: **233.1** | LOC: 170
  * *Intent:* * @param trustmgr * - * @param datatimeout * - * @param proxyserver * - * @param proxyusername * - * @param proxypassword * - * @param anonymouspasswo...
- `addPropertiesFromDFHEP_DESCRIPTOR` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java`) -> Impact: **221.0** | LOC: 367
...
- `evaluateFormula` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/epadapterinterface/EPAPv1.java`) -> Impact: **62.0** | LOC: 96
...
- `evaluateFormula` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/epadapterinterface/EPCXv1.java`) -> Impact: **62.0** | LOC: 96
  * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more arguments, and the first argument refers to a level...
- `evaluateFormula` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/epadapterinterface/EPCXv2.java`) -> Impact: **62.0** | LOC: 96
  * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more arguments, and the first argument refers to a level...
- `evaluateFormula` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/epadapterinterface/EPDEv1.java`) -> Impact: **62.0** | LOC: 96
  * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more arguments, and the first argument refers to a level...
- `evaluateFormula` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/epadapterinterface/Epde_epde__item.java`) -> Impact: **62.0** | LOC: 96
  * *Intent:* * The val function returns the value of a field in the model. The val function takes one * or more arguments, and the first argument refers to a level...
- `callAdapters` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java`) -> Impact: **59.7** | LOC: 147
...
- `emit` (@ `cics-event-consumer-ca1y/src/main/java/com/ibm/cics/ca1y/Emit.java`) -> Impact: **57.7** | LOC: 154
...
- **Heaviest Functions:** `send` (Impact: 22.7), `addAttachments` (Impact: 19.1), `getMessageSummary` (Impact: 11.1)
...
- **Heaviest Functions:** `evaluateFormula` (Impact: 62.0), `wrappedGetNumber` (Impact: 8.8), `match` (Impact: 8.0)
...
- **Heaviest Functions:** `evaluateFormula` (Impact: 62.0), `setEpde__item` (Impact: 9.7), `wrappedGetNumber` (Impact: 8.8)
...
- **Heaviest Functions:** `getHexDump` (Impact: 21.6), `getChunks` (Impact: 13.9), `getChunks` (Impact: 13.9)
...
- **Heaviest Functions:** `send` (Impact: 27.1), `CICSQueue` (Impact: 19.1), `getMessageSummary` (Impact: 14.2)
...
- **Heaviest Functions:** `send` (Impact: 13.8), `CICSFile` (Impact: 13.0), `getMessageSummary` (Impact: 7.6)
...
- **Heaviest Functions:** `getPropertySummary` (Impact: 34.9), `setPropertyMimeDefault` (Impact: 8.0), `setPropertyAttachment` (Impact: 7.6)
...
**Top Internal Functions/Classes:**
  * `send` (Impact: 27.1)
  * `CICSQueue` (Impact: 19.1)
  * `getMessageSummary` (Impact: 14.2)
    * *Intent:* /** * Return a short summary of the contents to be written to the queue. * * @return short summary o...
  * `validForEmission` (Impact: 1.6)
    * *Intent:* /** * Return true if we should attempt to emit * * @return true if the entries in EmitProperties are...
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `send` (Impact: 13.8)
  * `CICSFile` (Impact: 13.0)
  * `getMessageSummary` (Impact: 7.6)
...
**Top Internal Functions/Classes:**
  * `send` (Impact: 10.0)
  * `getMessageSummary` (Impact: 8.4)
  * `XMPP` (Impact: 3.3)
  * `destroy` (Impact: 2.2)
  * `processMessage` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Main-program` (Impact: 2.0)
  * `Main-program-exit` (Impact: 1.1)
    * *Intent:* *
**Structural Signatures (Net Mitigated Signals):**
