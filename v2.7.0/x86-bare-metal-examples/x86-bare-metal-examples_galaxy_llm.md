...
- `CLEAR_LABEL` (@ `intel-protected/startup.asm`) -> Impact: **9.5** | LOC: 141
- `loop` (@ `ps2_keyboard.S`) -> Impact: **9.1** | LOC: 9
- `update_in_progress` (@ `rtc.S`) -> Impact: **8.0** | LOC: 56
- `.loop` (@ `no_bios_hello_world.S`) -> Impact: **7.6** | LOC: 14
  * *Intent:* /* write a string on the screen */
- `.loop` (@ `nasm/protected_mode_so.asm`) -> Impact: **7.4** | LOC: 10
- `do_e820` (@ `bios_detect_memory.S`) -> Impact: **6.8** | LOC: 15
...
- `one_sec` (@ `bios_sleep.S`) -> Impact: **6.5** | LOC: 10
- `loop` (@ `bios_serial.S`) -> Impact: **6.1** | LOC: 8
- `loop` (@ `bios_hello_world.S`) -> Impact: **6.0** | LOC: 6
- `.loop` (@ `nasm/bios_hello_world.asm`) -> Impact: **6.0** | LOC: 6
...
- **Heaviest Functions:** `terminal_putchar` (Impact: 4.7), `terminal_initialize` (Impact: 3.6), `strlen` (Impact: 3.1)
...
- **Heaviest Functions:** `for_each_char` (Impact: 3.3), `stage2` (Impact: 3.2), `gdt` (Impact: 1.5)
...
- **Heaviest Functions:** `puts` (Impact: 5.1), `clear` (Impact: 4.5), `putc` (Impact: 2.6)
...
- **Heaviest Functions:** `main` (Impact: 2.2)
...
- **Heaviest Functions:** `%.efi` (Impact: 1.2), `all` (Impact: 1.1), `hello.so` (Impact: 1.1)
...
- **Heaviest Functions:** `one_sec` (Impact: 6.5), `infinite` (Impact: 1.9)
...
- **Heaviest Functions:** `not_started` (Impact: 2.8), `interrupt_handler` (Impact: 2.2), `init` (Impact: 2.0)
...
- **Heaviest Functions:** `loop` (Impact: 6.0), `_start` (Impact: 2.0), `halt` (Impact: 1.3)
...
**Top Internal Functions/Classes:**
  * `terminal_putchar` (Impact: 4.7)
  * `terminal_initialize` (Impact: 3.6)
  * `strlen` (Impact: 3.1)
  * `terminal_writestring` (Impact: 3.1)
  * `terminal_putentryat` (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  ...
  * `do_e820.jmpin` (Impact: 5.5)
  * `do_e820.notext` (Impact: 3.8)
  * `do_e820.e820lp` (Impact: 2.4)
...
**Top Internal Functions/Classes:**
  * `for_each_char` (Impact: 3.3)
  * `stage2` (Impact: 3.2)
  * `gdt` (Impact: 1.5)
  * `loop_forever` (Impact: 1.2)
  * `end_for_each_char` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
