...
- `_pem_lines` (@ `rsa-4.9.1/rsa/pem.py`) -> Impact: **24.1** | LOC: 43
  * *Intent:* """Generator over PEM lines between pem_start and pem_end."""
- `miller_rabin_primality_testing` (@ `rsa-4.9.1/rsa/prime.py`) -> Impact: **19.9** | LOC: 51
...
- `__eq__` (@ `rsa-4.9.1/rsa/key.py`) -> Impact: **18.2** | LOC: 17
- `find_p_q` (@ `rsa-4.9.1/rsa/key.py`) -> Impact: **15.9** | LOC: 78
- `newkeys` (@ `rsa-4.9.1/rsa/key.py`) -> Impact: **13.9** | LOC: 54
- `keygen` (@ `rsa-4.9.1/rsa/cli.py`) -> Impact: **13.2** | LOC: 65
  * *Intent:* """Key generator."""
- `private_to_public` (@ `rsa-4.9.1/rsa/util.py`) -> Impact: **11.8** | LOC: 75
  * *Intent:* """Reads a private key and outputs the corresponding public key."""
- `compute_hash` (@ `rsa-4.9.1/rsa/pkcs1.py`) -> Impact: **11.7** | LOC: 26
...
- `_pad_for_encryption` (@ `rsa-4.9.1/rsa/pkcs1.py`) -> Impact: **10.8** | LOC: 43
- `_load_pkcs1_der` (@ `rsa-4.9.1/rsa/key.py`) -> Impact: **9.8** | LOC: 57
...
- **Heaviest Functions:** `__eq__` (Impact: 18.2), `find_p_q` (Impact: 15.9), `newkeys` (Impact: 13.9)
...
- **Heaviest Functions:** `compute_hash` (Impact: 11.7), `_pad_for_encryption` (Impact: 10.8), `decrypt` (Impact: 8.7)
...
- **Heaviest Functions:** `keygen` (Impact: 13.2), `write_outfile` (Impact: 6.5), `parse_cli` (Impact: 5.6)
...
- **Heaviest Functions:** `_pem_lines` (Impact: 24.1), `load_pem` (Impact: 6.4), `save_pem` (Impact: 4.7)
...
- **Heaviest Functions:** `extended_gcd` (Impact: 8.0), `__init__` (Impact: 7.6), `crt` (Impact: 6.8)
...
- **Heaviest Functions:** `getprime` (Impact: 8.8), `_find_prime` (Impact: 5.6)
...
- **Heaviest Functions:** `miller_rabin_primality_testing` (Impact: 19.9), `get_primality_testing_rounds` (Impact: 6.9), `is_prime` (Impact: 5.4)
...
- **Heaviest Functions:** `int2bytes` (Impact: 6.7), `bytes2int` (Impact: 2.0)
...
- **Heaviest Functions:** `randint` (Impact: 8.3), `read_random_bits` (Impact: 3.8), `read_random_int` (Impact: 2.0)
...
- **Heaviest Functions:** `private_to_public` (Impact: 11.8)
...
**Top Internal Functions/Classes:**
  * `compute_hash` (Impact: 11.7)
    * *Intent:* """Returns the message digest. :param message: the signed message. Can be an 8-bit string or a file-...
  * `_pad_for_encryption` (Impact: 10.8)
  * `decrypt` (Impact: 8.7)
  * `_pad_for_signing` (Impact: 8.5)
  * `yield_fixedblocks` (Impact: 7.9)
...
**Top Internal Functions/Classes:**
  * `keygen` (Impact: 13.2)
    * *Intent:* """Key generator."""
  * `write_outfile` (Impact: 6.5)
    * *Intent:* """Write the output file"""
  * `parse_cli` (Impact: 5.6)
    * *Intent:* """Parse the CLI options :returns: (cli_opts, cli_args) """
  * `perform_operation` (Impact: 5.0)
  * `read_infile` (Impact: 4.0)
