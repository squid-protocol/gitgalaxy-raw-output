...
- `MAIN-PROCEDURE` (@ `CBL0501v01DeclaracioCondicionIF.cbl`) -> Impact: **9.3** | LOC: 27
- `0000-MAIN` (@ `CBL0604v01PerformVariying.cbl`) -> Impact: **8.0** | LOC: 19
- `MAIN-PROCEDURE` (@ `CBL0503v01CondicionSigno.cbl`) -> Impact: **7.3** | LOC: 27
- `0000-MAIN` (@ `CBL0805v01TableUseIndiceWithSet.cbl`) -> Impact: **6.3** | LOC: 27
- `MAIN-PROCEDURE` (@ `CBL0508v01CondicionVerb.cbl`) -> Impact: **6.1** | LOC: 22
- `0000-MAIN` (@ `CBL0804v01TableUseIndice.cbl`) -> Impact: **6.0** | LOC: 20
- `MAIN-PROCEDURE` (@ `CBL0506v01CondicionNot.cbl`) -> Impact: **5.8** | LOC: 17
- `MAIN-PROCEDURE` (@ `CBL0504v01CondicionClass.cbl`) -> Impact: **5.0** | LOC: 20
- `MAIN-PROCEDURE` (@ `CBL0502v01CondicionRelacion.cbl`) -> Impact: **4.8** | LOC: 16
- `MAIN-PROCEDURE` (@ `CBL0505v01CondicionName.cbl`) -> Impact: **3.9** | LOC: 17
...
- **Heaviest Functions:** `0000-MAIN` (Impact: 6.3), `200-TWO-DIMENSION` (Impact: 3.1), `300-MOSTRAR` (Impact: 1.2)
...
- **Heaviest Functions:** `100-ONE-BUSCAR` (Impact: 3.5), `0000-MAIN` (Impact: 1.8), `050-SHOW-BEFORE` (Impact: 1.4)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (Impact: 4.8)
...
- **Heaviest Functions:** `0000-MAIN` (Impact: 6.0), `200-TWO-DIMENSION` (Impact: 3.1), `300-MOSTRAR` (Impact: 1.2)

### 7. `CBL0207v01DivideVerb.cbl` (COBOL) -> Cumulative Risk: **444.28**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 10.8 | **LOC:** 61 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (96.0834%), Safety Score (83.5974%)
- **Heaviest Functions:** `MAIN-PROCEDURE` (Impact: 2.8)
...
- **Heaviest Functions:** `0000-MAIN` (Impact: 2.8)
...
- **Heaviest Functions:** `MAIN-PROCEDURE` (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `0000-MAIN` (Impact: 6.3)
  * `200-TWO-DIMENSION` (Impact: 3.1)
...
**Top Internal Functions/Classes:**
  * `SPECIAL-NAMES` (Impact: 2.0)
  * `2200-CONCATENA-DATOS` (Impact: 1.4)
  * `0000-PRINCIPAL` (Impact: 1.2)
  * `2000-PROCESO` (Impact: 1.2)
    * *Intent:* *
...
**Top Internal Functions/Classes:**
  ...
  * `SPECIAL-NAMES` (Impact: 1.2)
  * `1000-INICIO` (Impact: 1.2)
    * *Intent:* *
  * `4000-FINAL` (Impact: 1.2)
  * `0000-MAIN` (Impact: 1.1)
    * *Intent:* *************************
**Structural Signatures (Net Mitigated Signals):**
