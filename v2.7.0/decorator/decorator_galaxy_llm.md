...
- `dispatch_on` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **33.4** | LOC: 103
...
- `gen_func_dec` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **31.2** | LOC: 86
  * *Intent:* """Decorator turning a function into a generic function"""
- `create` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **23.4** | LOC: 25
- `decorate` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **23.1** | LOC: 59
...
- `make` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **21.3** | LOC: 35
  * *Intent:* """ Make a new function from a given template and update the signature """
- `decorator` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **17.4** | LOC: 28
  * *Intent:* """ decorator(caller) converts a caller function into a decorator """
- `__call__` (@ `decorator-5.2.1/tests/documentation.py`) -> Impact: **12.8** | LOC: 17
- `_dispatch` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **10.8** | LOC: 17
- `dec` (@ `decorator-5.2.1/src/decorator.py`) -> Impact: **10.4** | LOC: 9
...
- **Heaviest Functions:** `__init__` (Impact: 56.5), `dispatch_on` (Impact: 33.4), `gen_func_dec` (Impact: 31.2)
...
- **Heaviest Functions:** `__call__` (Impact: 12.8), `blocking` (Impact: 9.5), `_memoize` (Impact: 8.4)
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 12.8)
  * `blocking` (Impact: 9.5)
  * `_memoize` (Impact: 8.4)
  * `memoize` (Impact: 7.3)
  * `restricted` (Impact: 7.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 2 instances
