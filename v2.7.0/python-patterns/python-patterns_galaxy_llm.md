...
| Avg Path Length | 2.7144 | Hops between files. Lower = Tighter coupling. |
...
- `find_shortest_path_dfs` (@ `patterns/other/graph_search.py`) -> Impact: **18.7** | LOC: 16
- `find_shortest_path_bfs` (@ `patterns/other/graph_search.py`) -> Impact: **15.8** | LOC: 37
...
- `find_path_dfs` (@ `patterns/other/graph_search.py`) -> Impact: **14.1** | LOC: 13
- `find_all_paths_dfs` (@ `patterns/other/graph_search.py`) -> Impact: **11.8** | LOC: 13
...
- `do_the_job` (@ `patterns/structural/proxy.py`) -> Impact: **9.2** | LOC: 11
...
- `dispatch` (@ `patterns/structural/front_controller.py`) -> Impact: **7.6** | LOC: 13
...
- **Heaviest Functions:** `on_message` (Impact: 5.4), `__init__` (Impact: 2.4), `_next_state` (Impact: 2.0)
...
- **Heaviest Functions:** `resolve` (Impact: 7.2), `show_item_information` (Impact: 5.0), `show_item_list` (Impact: 4.2)
...
- **Heaviest Functions:** `build_size` (Impact: 2.9), `construct_building` (Impact: 1.7), `__init__` (Impact: 1.6)
...
- **Heaviest Functions:** `find_shortest_path_dfs` (Impact: 18.7), `find_shortest_path_bfs` (Impact: 15.8), `find_path_dfs` (Impact: 14.1)
...
- **Heaviest Functions:** `memento` (Impact: 5.6), `rollback` (Impact: 3.0), `commit` (Impact: 2.9)
...
- **Heaviest Functions:** `run_loop` (Impact: 6.2), `is_eager_to_contribute` (Impact: 4.3), `__init__` (Impact: 1.8)
...
- **Heaviest Functions:** `__call__` (Impact: 4.5), `__new__` (Impact: 2.8), `_serialize_params` (Impact: 2.5)
...
- **Heaviest Functions:** `visit` (Impact: 9.5), `generic_visit` (Impact: 2.3), `visit_B` (Impact: 2.3)
...
- **Heaviest Functions:** `__set__` (Impact: 8.2), `validate` (Impact: 5.7), `apply_discount` (Impact: 4.6)
...
**Top Internal Functions/Classes:**
  * `find_shortest_path_dfs` (Impact: 18.7)
  * `find_shortest_path_bfs` (Impact: 15.8)
    * *Intent:* """ Finds the shortest path between two nodes in a graph using breadth-first search. :param start: T...
  * `find_path_dfs` (Impact: 14.1)
  * `find_all_paths_dfs` (Impact: 11.8)
  * `__init__` (Impact: 1.8)
...
**Top Internal Functions/Classes:**
  * `resolve` (Impact: 7.2)
  * `show_item_information` (Impact: 5.0)
  * `show_item_list` (Impact: 4.2)
  * `show_item_information` (Impact: 4.1)
...
**Top Internal Functions/Classes:**
  * `test_car_adapter_shall_make_very_loud_noise` (Impact: 1.8)
  * `setUp` (Impact: 1.7)
  * `test_dog_adapter_shall_make_noise` (Impact: 1.7)
  * `test_cat_adapter_shall_make_noise` (Impact: 1.7)
  * `test_human_adapter_shall_make_noise` (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `is_eager_to_contribute` (Impact: 4.3)
  * `__init__` (Impact: 1.8)
  * `__init__` (Impact: 1.8)
  * `add_expert` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_given_standby_on_message_switchover_shall_call_hsm_methods` (Impact: 2.1)
  * `test_calling_next_state_shall_change_current_state` (Impact: 1.7)
  * `test_method_perform_switchover_shall_return_specifically` (Impact: 1.7)
    * *Intent:* """Exemplary HierachicalStateMachine method test. (here: _perform_switchover()). Add additional test...
  * `test_given_standby_on_message_diagnostics_failed_shall_raise_exception_and_keep_in_state` (Impact: 1.7)
  * `test_given_standby_on_message_diagnostics_passed_shall_raise_exception_and_keep_in_state` (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `build_size` (Impact: 2.9)
  * `construct_building` (Impact: 1.7)
  * `__init__` (Impact: 1.6)
  * `build_floor` (Impact: 1.5)
  * `build_size` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  ...
  * `check_range` (Impact: 3.1)
  * `check_range` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  ...
  * `make_noise` (Impact: 1.8)
  * `original_dict` (Impact: 1.6)
...
**Top Internal Functions/Classes:**
  * `test_consoleview_capitalizer_and_list_and_info` (Impact: 3.8)
  * `test_show_item_information_missing_calls_item_not_found` (Impact: 1.8)
  * `test_productmodel_iteration_and_price_str` (Impact: 1.4)
  * `test_router_register_resolve_and_unknown` (Impact: 1.4)
  * `test_productmodel_get_raises_keyerror` (Impact: 1.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
...
**Top Internal Functions/Classes:**
  * `setUp` (Impact: 1.9)
  * `test_extended_property_values_cloning` (Impact: 1.7)
  * `test_cloning_propperty_innate_values` (Impact: 1.6)
  * `test_cloning_propperty_assigned_values` (Impact: 1.6)
  * `test_particular_properties_retrieving` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` (Impact: 1.8)
  * `set_time_provider` (Impact: 1.8)
  * `get_current_time_as_html_fragment` (Impact: 1.7)
  * `get_current_time_as_html_fragment` (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
