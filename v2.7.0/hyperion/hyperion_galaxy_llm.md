...
| Avg Path Length | 2.8895 | Hops between files. Lower = Tighter coupling. |
...
- `ckddasd_execute_ccw` (@ `ckddasd.c`) -> Impact: **1832.9** | LOC: 2086
  * *Intent:* } /* end function ckd_write_data */ /*-------------------------------------------------------------------*/ /* Execute a Channel Command Word */ /*---...
- `decLnOp` (@ `decNumber/decNumber.c`) -> Impact: **1422.2** | LOC: 2460
...
- `tapedev_execute_ccw` (@ `tapeccws.c`) -> Impact: **1341.3** | LOC: 2855
- `cckd_chkdsk` (@ `cckdutil.c`) -> Impact: **882.8** | LOC: 1618
  * *Intent:* /*------------------------------------------------------------------- * Perform check function on a compressed ckd file * * check levels * -1 devhdr, ...
- `resume_cmd` (@ `sr.c`) -> Impact: **731.4** | LOC: 1068
  * *Intent:* #define SR_NULL_REGS_CHECK(_regs) if ((_regs) == NULL) goto sr_null_regs_exit;
- `commadpt_execute_ccw` (@ `commadpt.c`) -> Impact: **715.5** | LOC: 939
  * *Intent:* /*-------------------------------------------------------------------*/ /* Execute a Channel Command Word */ /*---------------------------------------...
- `panel_display` (@ `panel.c`) -> Impact: **491.8** | LOC: 1376
  * *Intent:* /*-------------------------------------------------------------------*/ /* Panel display thread */ /* */ /* This function runs on the main thread. It ...
- `printer_execute_ccw` (@ `printer.c`) -> Impact: **450.9** | LOC: 497
  * *Intent:* } /* end function printer_close_device */ /*-------------------------------------------------------------------*/ /* Execute a Channel Command Word */...
- `decDivideOp` (@ `decNumber/decNumber.c`) -> Impact: **404.8** | LOC: 582
...
- `w32_init_hostinfo` (@ `w32util.c`) -> Impact: **402.6** | LOC: 726
...
- **Heaviest Functions:** `decContextSetStatusFromString` (Impact: 31.2), `decContextSetStatusFromStringQuiet` (Impact: 31.2), `decContextStatusToString` (Impact: 25.3)
...
- **Heaviest Functions:** `locks_cmd` (Impact: 97.5), `loglock` (Impact: 28.2), `hthread_initialize_rwlock` (Impact: 20.6)
...
- **Heaviest Functions:** `history_add` (Impact: 12.4), `history_absolute_line` (Impact: 9.7), `history_relative_line` (Impact: 6.9)
...
- **Heaviest Functions:** `getopt_long` (Impact: 87.5), `getopt_internal` (Impact: 86.8), `permute_args` (Impact: 13.0)
...
- **Heaviest Functions:** `set_socket_keepalive` (Impact: 77.5), `resolve_symbol_string` (Impact: 60.8), `fmt_memsize_rounded` (Impact: 38.6)
...
- **Heaviest Functions:** `decLnOp` (Impact: 1422.2), `decDivideOp` (Impact: 404.8), `decAddOp` (Impact: 252.6)
...
- **Heaviest Functions:** `decDivide` (Impact: 345.7), `decFloatFMA` (Impact: 192.2), `decFloatAdd` (Impact: 177.6)
...
- **Heaviest Functions:** `decimal32FromNumber` (Impact: 60.9), `decimal32ToString` (Impact: 43.9), `decimal32ToNumber` (Impact: 23.1)
...
- **Heaviest Functions:** `IFC_IOCtl` (Impact: 67.7), `TUNTAP_CreateInterface` (Impact: 39.8), `net_data_trace` (Impact: 37.3)
...
- **Heaviest Functions:** `cache_lookup` (Impact: 58.9), `cache_setflag` (Impact: 32.7), `cachestats_cmd` (Impact: 17.1)
...
**Top Internal Functions/Classes:**
  ...
  * `automount_cmd` (Impact: 156.9)
    * *Intent:* /*-------------------------------------------------------------------*/ /* automount_cmd - show or u...
  * `qeth_cmd` (Impact: 145.2)
    * *Intent:* /*-------------------------------------------------------------------*/ /* qeth command - enable/dis...
  * `fcb_cmd` (Impact: 125.1)
...
**Top Internal Functions/Classes:**
  * `cckd_command` (Impact: 226.5)
    * *Intent:* /*-------------------------------------------------------------------*/ /* cckd command processor */...
  * `cckd_sf_remove` (Impact: 107.2)
    * *Intent:* } /* end function cckd_sf_add */ /*-----------------------------------------------------------------...
  * `cckd_gc_percolate` (Impact: 103.1)
    * *Intent:* } /* end thread cckd_gcol */ /*-------------------------------------------------------------------*/...
  * `cckd_read_trk` (Impact: 98.6)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Read a track image */ /* ...
  * `cckd_gcol` (Impact: 74.6)
...
**Top Internal Functions/Classes:**
  * `ckddasd_execute_ccw` (Impact: 1832.9)
    * *Intent:* } /* end function ckd_write_data */ /*--------------------------------------------------------------...
  * `ckddasd_init_handler` (Impact: 244.2)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Initialize the device han...
  * `ckd_read_count` (Impact: 105.3)
    * *Intent:* } /* end function mt_advance */ /*------------------------------------------------------------------...
  * `ckddasd_hresume` (Impact: 87.3)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Hercules resume */ /*----...
  * `ckd_build_sense` (Impact: 83.8)
...
**Top Internal Functions/Classes:**
  * `osa_adapter_cmd` (Impact: 385.8)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Adapter Command Routine *...
  * `qeth_execute_ccw` (Impact: 378.6)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Execute a Channel Command...
  * `qeth_init_handler` (Impact: 198.4)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Initialize the device han...
  * `write_buffered_packets` (Impact: 109.0)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Write all packets/frames ...
  * `read_L2_packets` (Impact: 59.9)
...
**Top Internal Functions/Classes:**
  * `commadpt_execute_ccw` (Impact: 715.5)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Execute a Channel Command...
  * `commadpt_init_handler` (Impact: 308.1)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Device Initialisation */ ...
  * `commadpt_thread` (Impact: 247.8)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Communication Thread main...
  * `commadpt_read_tty` (Impact: 127.7)
  * `commadpt_initiate_userdial` (Impact: 39.4)
...
**Top Internal Functions/Classes:**
  * `cckd_chkdsk` (Impact: 882.8)
    * *Intent:* /*------------------------------------------------------------------- * Perform check function on a ...
  * `cckd_comp` (Impact: 216.8)
    * *Intent:* /*------------------------------------------------------------------- * Remove all free space from a...
  * `cckd_swapend` (Impact: 94.9)
    * *Intent:* /*-------------------------------------------------------------------*/ /* EXTERNALGUI support */ /*...
  * `cdsk_valid_trk` (Impact: 78.7)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Validate a track image */...
  * `comp_spctab_sort` (Impact: 19.6)
...
**Top Internal Functions/Classes:**
  * `tapedev_execute_ccw` (Impact: 1341.3)
  * `build_sense_3590` (Impact: 121.5)
    * *Intent:* /*-------------------------------------------------------------------*/ /* build_sense_3590 */ /*---...
  * `build_sense_3480_etal` (Impact: 112.3)
    * *Intent:* } /* end function build_sense_3420 */ /*------------------------------------------------------------...
  * `load_display` (Impact: 88.7)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Load Display channel comm...
  * `build_sense_3410_3420` (Impact: 72.6)
...
**Top Internal Functions/Classes:**
  * `w32_init_hostinfo` (Impact: 402.6)
  * `w32_select` (Impact: 77.0)
  * `clock_gettime` (Impact: 54.6)
    * *Intent:* ////////////////////////////////////////////////////////////////////////////////////////// // (PUBLI...
  * `w32_poor_mans_fork` (Impact: 49.9)
  * `w32_nanosleep` (Impact: 47.8)
...
**Top Internal Functions/Classes:**
  * `panel_display` (Impact: 491.8)
    * *Intent:* /*-------------------------------------------------------------------*/ /* Panel display thread */ /...
  * `NP_update` (Impact: 292.6)
    * *Intent:* /*=NP================================================================*/ /* This refreshes the screen...
  * `NP_screen_redraw` (Impact: 72.8)
    * *Intent:* /*=NP================================================================*/ /* This draws the initial sc...
  * `set_console_title` (Impact: 40.8)
  * `copy_regs` (Impact: 13.3)
...
**Top Internal Functions/Classes:**
  * `try_dlopen` (Impact: 138.3)
  * `load_deplibs` (Impact: 65.3)
  * `lt_dlloader_add` (Impact: 36.0)
    * *Intent:* /* --- USER MODULE LOADER API --- */
  * `foreach_dirinpath` (Impact: 32.9)
    * *Intent:* it is appended to each SEARCH_PATH element before FUNC is called. */
  * `canonicalize_path` (Impact: 29.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ecpsvm_do_disp2` (Impact: 127.8)
    * *Intent:* /* DISP2 Core */
  * `ecpsvm_dolctl` (Impact: 117.4)
    * *Intent:* /* B7 - LCTL Instruction Assist */
  * `ecpsvm_dolra` (Impact: 84.4)
    * *Intent:* */
  * `ecpsvm_dosio` (Impact: 53.0)
    * *Intent:* /* operation exception and a trip */ /* through the DMKPRG & DMKPRV code */ /* path. In addition, th...
  * `ecpsvm_check_pswtrans` (Impact: 35.0)
...
**Top Internal Functions/Classes:**
  * `serverRequest` (Impact: 194.2)
    * *Intent:* } /* recvData */ /*------------------------------------------------------------------- * Process a r...
  * `shared_ckd_init` (Impact: 132.2)
    * *Intent:* } /* shared_update_notify */ /*------------------------------------------------------------------- *...
  * `shared_fba_init` (Impact: 100.5)
    * *Intent:* } /* shared_ckd_close */ /*------------------------------------------------------------------- * FBA...
  * `recvData` (Impact: 89.6)
    * *Intent:* } /* clientRecv */ /*------------------------------------------------------------------- * Receive d...
  * `serverConnect` (Impact: 66.7)
...
**Top Internal Functions/Classes:**
  * `stsi_capability` (Impact: 16.9)
  * `MIPSreal` (Impact: 13.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CTCE_ExecuteCCW` (Impact: 199.7)
    * *Intent:* // Hercules PC Host A with IP address 192.168.1.100 : // // 0E40 CTCE 30880 192.168.1.200 30880 // 0...
  * `CTCE_Trace` (Impact: 181.0)
    * *Intent:* // --------------------------------------------------------------------- // CTCE_Trace // ----------...
  * `CTCX_ExecuteCCW` (Impact: 170.9)
    * *Intent:* // ------------------------------------------------------------------- // Execute a Channel Command ...
  * `CTCE_Send` (Impact: 125.9)
    * *Intent:* // // CTCE_Send //
  * `CTCE_RecvThread` (Impact: 96.8)
...
- `feature.h` -> **Severity: 0.117** (Bridge: 0.003 * Flux: 39.5395%)
- `inline.h` -> **Severity: 0.03** (Bridge: 0.0003 * Flux: 99.9999%)
- `opcode.h` -> **Severity: 0.03** (Bridge: 0.0006 * Flux: 51.3182%)
- `hstructs.h` -> **Severity: 0.01** (Bridge: 0.0012 * Flux: 8.7409%)
- `tapedev.h` -> **Severity: 0.004** (Bridge: 0.0002 * Flux: 22.9785%)
