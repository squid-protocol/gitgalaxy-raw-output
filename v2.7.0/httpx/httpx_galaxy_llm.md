...
- `__init__` (@ `httpx-0.28.1/httpx/_config.py`) -> Impact: **60.5** | LOC: 45
- `main` (@ `httpx-0.28.1/httpx/_main.py`) -> Impact: **53.7** | LOC: 55
- `__init__` (@ `httpx-0.28.1/httpx/_models.py`) -> Impact: **42.5** | LOC: 57
- `redirects` (@ `httpx-0.28.1/tests/client/test_redirects.py`) -> Impact: **42.1** | LOC: 106
- `__init__` (@ `httpx-0.28.1/httpx/_urls.py`) -> Impact: **41.9** | LOC: 37
- `__init__` (@ `httpx-0.28.1/httpx/_client.py`) -> Impact: **40.6** | LOC: 78
- `__init__` (@ `httpx-0.28.1/httpx/_client.py`) -> Impact: **40.6** | LOC: 78
- `__init__` (@ `httpx-0.28.1/httpx/_urls.py`) -> Impact: **34.4** | LOC: 48
- `__init__` (@ `httpx-0.28.1/httpx/_transports/default.py`) -> Impact: **32.8** | LOC: 80
...
- **Heaviest Functions:** `auth_flow` (Impact: 15.4), `_parse_challenge` (Impact: 14.9), `_build_auth_header` (Impact: 14.3)
...
- **Heaviest Functions:** `__init__` (Impact: 42.5), `__init__` (Impact: 31.5), `delete` (Impact: 23.5)
...
- **Heaviest Functions:** `handle_async_request` (Impact: 23.5), `send` (Impact: 9.5), `__init__` (Impact: 3.0)
...
- **Heaviest Functions:** `encode_request` (Impact: 21.2), `encode_content` (Impact: 18.3), `encode_response` (Impact: 12.2)
...
- **Heaviest Functions:** `__init__` (Impact: 32.8), `__init__` (Impact: 32.8), `map_httpcore_exceptions` (Impact: 8.2)
...
- **Heaviest Functions:** `__init__` (Impact: 41.9), `__init__` (Impact: 34.4), `__repr__` (Impact: 23.9)
...
- **Heaviest Functions:** `urlparse` (Impact: 96.7), `validate_path` (Impact: 19.1), `normalize_path` (Impact: 15.6)
...
- **Heaviest Functions:** `__init__` (Impact: 6.2), `request_context` (Impact: 3.5), `__init__` (Impact: 3.1)
...
- **Heaviest Functions:** `__init__` (Impact: 40.6), `__init__` (Impact: 40.6), `build_request` (Impact: 24.1)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 42.5)
  * `__init__` (Impact: 31.5)
  * `delete` (Impact: 23.5)
  * `get` (Impact: 23.2)
  * `aiter_bytes` (Impact: 18.5)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 40.6)
  * `__init__` (Impact: 40.6)
  * `build_request` (Impact: 24.1)
  * `_send_handling_redirects` (Impact: 19.7)
  * `_send_handling_redirects` (Impact: 19.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_digest_auth` (Impact: 7.5)
  * `__call__` (Impact: 5.4)
  * `test_digest_auth_no_specified_qop` (Impact: 4.4)
  * `auth_flow` (Impact: 4.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_raise_for_status` (Impact: 7.8)
  * `test_aiter_raw_with_chunksize` (Impact: 4.8)
  * `test_aiter_bytes_with_chunk_size` (Impact: 4.6)
  * `test_aiter_text_with_chunk_size` (Impact: 4.6)
  * `test_cannot_read_after_stream_consumed` (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_raise_for_status` (Impact: 6.3)
  * `test_context_managed_transport_and_mount` (Impact: 2.9)
  * `test_cancellation_during_stream` (Impact: 2.9)
    * *Intent:* """ If any BaseException is raised during streaming the response, then the stream should be closed. ...
  * `test_context_managed_transport` (Impact: 2.5)
  * `response_with_cancel_during_stream` (Impact: 2.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_aiterator_content` (Impact: 5.7)
  * `test_multipart_multiple_files_single_input_content` (Impact: 4.4)
  * `test_bytes_content` (Impact: 4.2)
  * `test_multipart_data_and_files_content` (Impact: 4.2)
  * `test_multipart_files_content` (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `echo_body` (Impact: 4.5)
  * `echo_headers` (Impact: 4.5)
  * `test_asgi_disconnect_after_response_complete` (Impact: 3.6)
  * `hello_world` (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `redirects` (Impact: 42.1)
  * `cookie_sessions` (Impact: 10.0)
  * `test_redirect_cookie_behavior` (Impact: 2.5)
  * `handle_request` (Impact: 1.9)
  * `test_next_request` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `app` (Impact: 18.9)
  * `watch_restarts` (Impact: 4.9)
  * `echo_body` (Impact: 4.8)
  * `echo_binary` (Impact: 4.8)
  * `clean_environ` (Impact: 4.7)
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 53.7)
  * `trace` (Impact: 29.9)
  * `format_certificate` (Impact: 14.9)
  * `format_request_headers` (Impact: 12.7)
  * `print_help` (Impact: 11.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `create_ssl_context` (Impact: 32.4)
  * `__init__` (Impact: 13.4)
  * `__repr__` (Impact: 10.3)
...
**Top Internal Functions/Classes:**
  * `auth_flow` (Impact: 15.4)
  * `_parse_challenge` (Impact: 14.9)
  * `_build_auth_header` (Impact: 14.3)
  * `_get_header_value` (Impact: 9.5)
  * `_resolve_qop` (Impact: 8.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_iter_fields` (Impact: 16.6)
  * `get_multipart_boundary_from_content_type` (Impact: 9.1)
  * `render_headers` (Impact: 6.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_raise_for_status` (Impact: 6.3)
  * `test_stream_iterator` (Impact: 3.3)
  * `test_raw_iterator` (Impact: 3.3)
  * `echo_raw_headers` (Impact: 3.1)
  * `test_context_managed_transport_and_mount` (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
...
**Top Internal Functions/Classes:**
  * `encode_request` (Impact: 21.2)
  * `encode_content` (Impact: 18.3)
  * `encode_response` (Impact: 12.2)
  * `__iter__` (Impact: 10.6)
  * `__aiter__` (Impact: 10.6)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 4 instances
* *Amplified Cascading Flux:* 20 instances
...
**Top Internal Functions/Classes:**
  ...
  * `iterator` (Impact: 2.2)
  * `test_zstd_multiframe` (Impact: 2.0)
    * *Intent:* # test inspired by urllib3 test suite data = ( # Zstandard frame zstd.compress(b"foo") # skippable f...
  * `test_multi_with_identity` (Impact: 2.0)
  * `test_streaming_text_decoder` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` (Impact: 32.8)
  * `map_httpcore_exceptions` (Impact: 8.2)
  * `handle_request` (Impact: 3.2)
  * `handle_async_request` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `get_environment_proxies` (Impact: 16.4)
    * *Intent:* """Gets proxy information from the environment"""
  * `matches` (Impact: 16.2)
  * `primitive_value_to_str` (Impact: 6.3)
...
**Top Internal Functions/Classes:**
  * `test_multipart_invalid_key` (Impact: 3.5)
  * `test_multipart_encode` (Impact: 3.5)
  * `test_multipart_invalid_value` (Impact: 3.2)
  * `test_multipart` (Impact: 3.0)
  * `test_multipart_encode_non_seekable_filelike` (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  * `handle_async_request` (Impact: 23.5)
  * `send` (Impact: 9.5)
  * `__init__` (Impact: 3.0)
  * `is_running_trio` (Impact: 2.6)
  * `receive` (Impact: 2.6)
...
**Top Internal Functions/Classes:**
  * `test_aread_and_stream_data` (Impact: 2.5)
    * *Intent:* # Ensure a request may still be streamed if it has been read. # Needed for cases such as authenticat...
  * `test_ignore_transfer_encoding_header_if_content_length_exists` (Impact: 1.8)
    * *Intent:* """ `Transfer-Encoding` should be ignored if `Content-Length` has been set explicitly. See https://g...
  * `test_request_async_streaming_content_picklable` (Impact: 1.8)
  * `test_request_generator_content_picklable` (Impact: 1.8)
  * `test_url` (Impact: 1.7)
**Contextual Mitigations & Amplifications:**
