...
- `resolveObject` (@ `package/cjs/proxy/url.js`) -> Impact: **175.0** | LOC: 275
- `resolveObject` (@ `package/esm/proxy/url.js`) -> Impact: **175.0** | LOC: 275
- `parse` (@ `package/cjs/proxy/url.js`) -> Impact: **162.1** | LOC: 281
- `parse` (@ `package/esm/proxy/url.js`) -> Impact: **162.1** | LOC: 281
- `format` (@ `package/cjs/proxy/url.js`) -> Impact: **38.8** | LOC: 55
- `format` (@ `package/esm/proxy/url.js`) -> Impact: **38.8** | LOC: 55
...
- `formatImportWithOverloads` (@ `package/esm/proxy/url.js`) -> Impact: **22.2** | LOC: 28
  * *Intent:* /** * @type {( * ((urlObject: URL, options?: URLFormatOptions) => string) & * ((urlObject: UrlObject | string, options?: never) => string) * )} */
- `resolvePath` (@ `package/cjs/index.js`) -> Impact: **21.2** | LOC: 112
  * *Intent:* /** * @param {string} path */
- `normalizeArray` (@ `package/cjs/proxy/url.js`) -> Impact: **16.8** | LOC: 25
...
- **Heaviest Functions:** `runClearTimeout` (Impact: 8.4), `runTimeout` (Impact: 8.3), `nextTick` (Impact: 7.7)
...
- **Heaviest Functions:** `resolveObject` (Impact: 175.0), `parse` (Impact: 162.1), `format` (Impact: 38.8)
...
- **Heaviest Functions:** `qsEscape` (Impact: 1.6), `qsUnescape` (Impact: 1.6), `get` (Impact: 1.1)
...
- **Heaviest Functions:** `setup` (Impact: 2.4), `plugin` (Impact: 1.7)
...
- **Heaviest Functions:** `createObjectURL` (Impact: 1.5), `revokeObjectURL` (Impact: 1.5), `toString` (Impact: 1.1)
...
**Top Internal Functions/Classes:**
  * `resolvePath` (Impact: 21.2)
    * *Intent:* /** * @param {string} path */
  * `_interopDefaultLegacy` (Impact: 8.5)
  * `_globalThis` (Impact: 8.1)
  * `get` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `NodeProtocolUrlPlugin` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `createObjectURL` (Impact: 1.5)
  * `revokeObjectURL` (Impact: 1.5)
  * `toString` (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
