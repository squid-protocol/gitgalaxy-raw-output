...
| Avg Path Length | 2.6942 | Hops between files. Lower = Tighter coupling. |
...
- `P_CrossSpecialLine` (@ `components/prboom/p_spec.c`) -> Impact: **658.0** | LOC: 881
  * *Intent:* ///////////////////////////////////////////////////////////////////////// // // P_CrossSpecialLine - Walkover Trigger Dispatcher // // Called every ti...
- `P_UseSpecialLine` (@ `components/prboom/p_switch.c`) -> Impact: **648.0** | LOC: 920
...
- `M_Responder` (@ `components/prboom/m_menu.c`) -> Impact: **470.2** | LOC: 1088
  * *Intent:* ///////////////////////////////////////////////////////////////////////////// // // M_Responder // // Examines incoming keystrokes and button pushes a...
- `P_TouchSpecialThing` (@ `components/prboom/p_inter.c`) -> Impact: **182.2** | LOC: 318
  * *Intent:* // // P_TouchSpecialThing //
- `R_StoreWallRange` (@ `components/prboom/r_segs.c`) -> Impact: **169.7** | LOC: 380
  * *Intent:* // // R_StoreWallRange // A wall segment will be drawn // between start and stop pixels (inclusive). //
- `HU_Drawer` (@ `components/prboom/hu_stuff.c`) -> Impact: **157.1** | LOC: 541
  * *Intent:* // // HU_Drawer() // // Draw all the pieces of the heads-up display // // Passed nothing, returns nothing //
- `V_DrawMemPatch` (@ `components/prboom/v_video.c`) -> Impact: **156.9** | LOC: 227
...
- `mmus2mid` (@ `components/prboom/mmus2mid.c`) -> Impact: **145.4** | LOC: 224
...
- `D_DoomMainSetup` (@ `components/prboom/d_main.c`) -> Impact: **144.6** | LOC: 492
...
- `P_DamageMobj` (@ `components/prboom/p_inter.c`) -> Impact: **138.1** | LOC: 169
...
- **Heaviest Functions:** `A_Chase` (Impact: 86.8), `A_BossDeath` (Impact: 80.0), `P_DoNewChaseDir` (Impact: 68.7)
...
- **Heaviest Functions:** `STlib_drawNum` (Impact: 45.7), `STlib_updateMultIcon` (Impact: 13.6), `STlib_updateBinIcon` (Impact: 13.6)
...
- **Heaviest Functions:** `R_FakeFlat` (Impact: 65.7), `R_Subsector` (Impact: 60.9), `R_AddLine` (Impact: 29.8)
...
- **Heaviest Functions:** `P_UpdateThinker` (Impact: 12.7), `P_Ticker` (Impact: 10.6), `P_NextThinker` (Impact: 7.3)
...
- **Heaviest Functions:** `P_SwitchWeapon` (Impact: 52.3), `P_WeaponPreferred` (Impact: 28.4), `A_WeaponReady` (Impact: 23.0)
...
- **Heaviest Functions:** `W_AddFile` (Impact: 24.0), `W_CoalesceMarkedResource` (Impact: 22.6), `ExtractFileBase` (Impact: 15.2)
...
- **Heaviest Functions:** `P_XYMovement` (Impact: 122.5), `P_ZMovement` (Impact: 116.8), `P_SpawnMapThing` (Impact: 92.0)
...
- **Heaviest Functions:** `R_MapPlane` (Impact: 32.0), `R_DoDrawPlane` (Impact: 28.4), `R_MakeSpans` (Impact: 24.5)
...
- **Heaviest Functions:** `I_Mmap` (Impact: 17.5), `I_Lseek` (Impact: 12.5), `I_Munmap` (Impact: 9.3)
...
- **Heaviest Functions:** `R_InitTranMap` (Impact: 34.9), `R_InitTextures` (Impact: 33.6), `R_PrecacheLevel` (Impact: 21.8)
...
**Top Internal Functions/Classes:**
  * `G_BuildTiccmd` (Impact: 111.3)
  * `G_ReadDemoHeader` (Impact: 109.2)
  * `G_Ticker` (Impact: 75.0)
    * *Intent:* // // G_Ticker // Make ticcmd_ts for the players. //
  * `G_Responder` (Impact: 60.7)
    * *Intent:* // // G_Responder // Get info needed to make ticcmd_ts for the players. //
  * `G_CheckSpot` (Impact: 48.2)
...
**Top Internal Functions/Classes:**
  * `deh_procMisc` (Impact: 102.0)
    * *Intent:* // ==================================================================== // deh_procMisc // Purpose: ...
  * `deh_procText` (Impact: 76.3)
    * *Intent:* // ==================================================================== // deh_procText // Purpose: ...
  * `deh_procFrame` (Impact: 73.5)
    * *Intent:* // ==================================================================== // deh_procFrame // Purpose:...
  * `deh_procSounds` (Impact: 67.0)
    * *Intent:* // ==================================================================== // deh_procSounds // Purpose...
  * `ProcessDehFile` (Impact: 66.2)
...
**Top Internal Functions/Classes:**
  * `createTextureCompositePatch` (Impact: 90.1)
    * *Intent:* //---------------------------------------------------------------------------
  * `createPatch` (Impact: 53.5)
    * *Intent:* //---------------------------------------------------------------------------
  * `getPatchIsNotTileable` (Impact: 28.2)
    * *Intent:* //---------------------------------------------------------------------------
  * `R_CacheTextureCompositePatchNum` (Impact: 11.5)
    * *Intent:* //---------------------------------------------------------------------------
  * `R_CachePatchNum` (Impact: 11.4)
    * *Intent:* //---------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 5 instances
