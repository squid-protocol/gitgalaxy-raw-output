...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 7.0 | 1.3 | 0.0 | 0.0 |
...
- `_sapp_x11_translate_keysyms` (@ `src/sokol/c/sokol_app.h`) -> Impact: **253.9** | LOC: 159
...
- `_sfetch_channel_thread_func` (@ `src/sokol/c/sokol_fetch.h`) -> Impact: **214.8** | LOC: 647
  * *Intent:* #if _SFETCH_PLATFORM_WINDOWS
- `_sgimgui_capture_item_string` (@ `src/sokol/c/sokol_gfx_imgui.h`) -> Impact: **150.9** | LOC: 419
- `_sapp_win32_wndproc` (@ `src/sokol/c/sokol_app.h`) -> Impact: **134.3** | LOC: 226
- `_sg_validate_shader_desc` (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **113.9** | LOC: 269
- `_sg_d3d11_create_view` (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **113.0** | LOC: 216
- `_sg_d3d11_create_shader` (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **110.5** | LOC: 166
- `_sg_validate_apply_bindings` (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **108.6** | LOC: 220
- `_sgimgui_pixelformat_string` (@ `src/sokol/c/sokol_gfx_imgui.h`) -> Impact: **106.8** | LOC: 72
- `_sg_gl_teximage_internal_format` (@ `src/sokol/c/sokol_gfx.h`) -> Impact: **104.2** | LOC: 76
...
- **Magnitude:** 18140.32 | **LOC:** 26678 | **CtrlFlow:** 23.7% | **Authorship Centralization:** 94.6%
- **Primary Risk Drivers:** Spec Match (100.0%), Churn (100.0%), Documentation (100.0%), State Flux (99.9879%)
- **Heaviest Functions:** `_sg_validate_shader_desc` (Impact: 113.9), `_sg_d3d11_create_view` (Impact: 113.0), `_sg_d3d11_create_shader` (Impact: 110.5)

### 2. `src/sokol/c/sokol_app.h` (C) -> Cumulative Risk: **723.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 8049.24 | **LOC:** 14397 | **CtrlFlow:** 17.2% | **Authorship Centralization:** 95.5%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9862%), Churn (89.21%)
- **Heaviest Functions:** `_sapp_x11_translate_keysyms` (Impact: 253.9), `_sapp_win32_wndproc` (Impact: 134.3), `_sapp_gl_choose_fbconfig` (Impact: 54.0)

### 3. `src/sokol/c/sokol_gfx_imgui.h` (C) -> Cumulative Risk: **664.83**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_sgimgui_capture_item_string` (Impact: 150.9), `_sgimgui_pixelformat_string` (Impact: 106.8), `_sgimgui_draw_shader_panel` (Impact: 99.0)

### 4. `src/sokol/c/sokol_fetch.h` (C) -> Cumulative Risk: **663.45**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_sfetch_channel_thread_func` (Impact: 214.8), `_sfetch_channel_dowork` (Impact: 52.5), `_sfetch_request_handler` (Impact: 49.5)

### 5. `src/sokol/c/sokol_audio.h` (C) -> Cumulative Risk: **642.78**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_saudio_fifo_write` (Impact: 20.4), `_saudio_wasapi_backend_init` (Impact: 16.9), `_saudio_n3ds_cb` (Impact: 15.1)

### 6. `src/sokol/c/sokol_log.h` (C) -> Cumulative Risk: **610.85**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `slog_func` (Impact: 69.2), `_slog_itoa` (Impact: 8.7), `_slog_append` (Impact: 8.5)
...
- **Heaviest Functions:** `sshape_build_box` (Impact: 53.4), `sshape_build_cylinder` (Impact: 22.8), `sshape_build_sphere` (Impact: 22.6)

### 8. `src/sokol/c/sokol_glue.h` (C) -> Cumulative Risk: **530.6**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_sglue_to_sgpixelformat` (Impact: 14.8), `sglue_swapchain` (Impact: 2.5), `sglue_environment` (Impact: 1.9)

### 9. `src/sokol/sgimgui.zig` (ZIG) -> Cumulative Risk: **493.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `cStrToZig` (Impact: 1.6), `setup` (Impact: 1.6), `drawMenu` (Impact: 1.6)
...
- **Heaviest Functions:** `stm_round_to_common_refresh_rate` (Impact: 6.3), `stm_diff` (Impact: 5.6), `stm_now` (Impact: 5.0)
...
**Top Internal Functions/Classes:**
  * `_sg_validate_shader_desc` (Impact: 113.9)
  * `_sg_d3d11_create_view` (Impact: 113.0)
  * `_sg_d3d11_create_shader` (Impact: 110.5)
  * `_sg_validate_apply_bindings` (Impact: 108.6)
  * `_sg_gl_teximage_internal_format` (Impact: 104.2)
...
**Top Internal Functions/Classes:**
  * `_sgimgui_capture_item_string` (Impact: 150.9)
  * `_sgimgui_pixelformat_string` (Impact: 106.8)
  * `_sgimgui_draw_shader_panel` (Impact: 99.0)
  * `_sgimgui_draw_passaction_panel` (Impact: 83.8)
  * `_sgimgui_draw_capture_panel` (Impact: 76.2)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `_sfetch_channel_thread_func` (Impact: 214.8)
    * *Intent:* #if _SFETCH_PLATFORM_WINDOWS
  * `_sfetch_channel_dowork` (Impact: 52.5)
    * *Intent:* /* per-frame channel stuff: move requests in and out of the IO threads, call response callbacks */
  * `_sfetch_request_handler` (Impact: 49.5)
    * *Intent:* #endif /* _SFETCH_PLATFORM_WINDOWS */ // ██████ ██ ██ █████ ███ ██ ███ ██ ███████ ██ ███████ // ██ █...
  * `_sfetch_channel_init` (Impact: 21.0)
  * `_sfetch_validate_request` (Impact: 20.8)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `_saudio_fifo_write` (Impact: 20.4)
    * *Intent:* /* write new data to the write queue, this is called from main thread */
  * `_saudio_wasapi_backend_init` (Impact: 16.9)
  * `_saudio_n3ds_cb` (Impact: 15.1)
    * *Intent:* // ███████ ██████ ███████ // ██ ██ ██ ██ // ██████ ██ ██ ███████ // ██ ██ ██ ██ // ███████ ██████ ██...
  * `_saudio_alsa_backend_init` (Impact: 13.2)
  * `_saudio_log` (Impact: 12.9)
...
**Top Internal Functions/Classes:**
  * `sshape_build_box` (Impact: 53.4)
  * `sshape_build_cylinder` (Impact: 22.8)
  * `sshape_build_sphere` (Impact: 22.6)
    * *Intent:* */
  * `sshape_build_torus` (Impact: 18.7)
    * *Intent:* */
  * `sshape_build_plane` (Impact: 18.0)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `slog_func` (Impact: 69.2)
    * *Intent:* #endif
  * `_slog_itoa` (Impact: 8.7)
...
**Top Internal Functions/Classes:**
  ...
  * `color4b` (Impact: 2.4)
  * `sshape_color_4f` (Impact: 2.3)
    * *Intent:* /// helper functions to build packed color value from floats or bytes
  * `sshape_color_4b` (Impact: 2.3)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `cStrToZig` (Impact: 1.6)
    * *Intent:* // helper function to convert a C string to a Zig string slice
  * `setup` (Impact: 1.6)
  * `drawMenu` (Impact: 1.6)
  * `drawBufferWindow` (Impact: 1.6)
  * `drawImageWindow` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `stm_round_to_common_refresh_rate` (Impact: 6.3)
  * `stm_diff` (Impact: 5.6)
  * `stm_now` (Impact: 5.0)
  * `stm_setup` (Impact: 4.8)
    * *Intent:* #endif
  * `stm_laptime` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `imtextureidWithSampler` (Impact: 1.9)
  * `addMousePosEvent` (Impact: 1.9)
  * `addTouchPosEvent` (Impact: 1.9)
  * `addMouseButtonEvent` (Impact: 1.9)
  * `addMouseWheelEvent` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `frame` (Impact: 8.3)
  * `init` (Impact: 2.5)
  * `computeVsParams` (Impact: 2.1)
  * `rand` (Impact: 1.9)
  * `xorshift32` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `saudio_push` (Impact: 1.8)
    * *Intent:* /// push sample frames from main thread, returns number of frames actually pushed
  * `cStrToZig` (Impact: 1.6)
    * *Intent:* // helper function to convert a C string to a Zig string slice
  * `setup` (Impact: 1.6)
    * *Intent:* /// setup sokol-audio
  * `saudio_setup` (Impact: 1.5)
    * *Intent:* /// setup sokol-audio
**Structural Signatures (Net Mitigated Signals):**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 44.04 | **LOC:** 258 | **CtrlFlow:** 1.9% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (10.6416%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `init` (Impact: 7.8)
  * `drawCubes` (Impact: 2.4)
  * `drawTexCube` (Impact: 2.4)
  * `drawQuad` (Impact: 2.1)
  * `frame` (Impact: 1.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 28.46 | **LOC:** 181 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `init` (Impact: 3.5)
  * `computeVsParams` (Impact: 2.1)
...
- `src/sokol/c/sokol_gfx.h` -> **GH Action** (94.6% isolated ownership) | Magnitude: 18140.32
- `src/sokol/c/sokol_app.h` -> **GH Action** (95.5% isolated ownership) | Magnitude: 8049.24
