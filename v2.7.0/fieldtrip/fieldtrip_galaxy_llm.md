...
| Avg Path Length | 3.8796 | Hops between files. Lower = Tighter coupling. |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 3.2 | 0.1 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 100.0 | 1.2 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 92.6 | 100.0 | 100.0 |
...
- `__global_context__` (@ `fileio/ft_filetype.m`) -> Impact: **681.4** | LOC: 1268
...
- `ft_sourceanalysis` (@ `ft_sourceanalysis.m`) -> Impact: **580.5** | LOC: 1249
...
- `cb_help` (@ `ft_electrodeplacement.m`) -> Impact: **453.8** | LOC: 1213
  * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
- `ft_hastoolbox` (@ `fileio/private/ft_hastoolbox.m`) -> Impact: **453.4** | LOC: 789
...
- `ft_hastoolbox` (@ `forward/private/ft_hastoolbox.m`) -> Impact: **453.4** | LOC: 789
  * *Intent:* % FT_HASTOOLBOX tests whether an external toolbox is installed. Optionally it will % try to determine the path to the toolbox and install it automatic...
- `ft_hastoolbox` (@ `inverse/private/ft_hastoolbox.m`) -> Impact: **453.4** | LOC: 789
  * *Intent:* % FT_HASTOOLBOX tests whether an external toolbox is installed. Optionally it will % try to determine the path to the toolbox and install it automatic...
- `ft_hastoolbox` (@ `plotting/private/ft_hastoolbox.m`) -> Impact: **453.4** | LOC: 789
  * *Intent:* % FT_HASTOOLBOX tests whether an external toolbox is installed. Optionally it will % try to determine the path to the toolbox and install it automatic...
- `ft_hastoolbox` (@ `utilities/ft_hastoolbox.m`) -> Impact: **453.4** | LOC: 789
  * *Intent:* % FT_HASTOOLBOX tests whether an external toolbox is installed. Optionally it will % try to determine the path to the toolbox and install it automatic...
- `ft_read_header` (@ `fileio/ft_read_header.m`) -> Impact: **423.7** | LOC: 1199
...
- `cb_redraw` (@ `ft_electrodeplacement.m`) -> Impact: **422.7** | LOC: 1180
  * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
...
### 1. `realtime/src/acquisition/openbci/java/src/Serial.java` (JAVA) -> Cumulative Risk: **791.34**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 412.3 | **LOC:** 516 | **CtrlFlow:** 17.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Spec Match (100.0%), Documentation (100.0%), State Flux (99.9969%)
- **Heaviest Functions:** `Serial` (Impact: 33.7), `read` (Impact: 23.4), `readBytesUntil` (Impact: 13.9)

### 2. `qsub/qsubcellfun.m` (MATLAB) -> Cumulative Risk: **769.94**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 475.04 | **LOC:** 497 | **CtrlFlow:** 28.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9222%)
- **Heaviest Functions:** `makeuniform` (Impact: 11.3), `Anonymous_Block` (Impact: 10.1), `Anonymous_Block` (Impact: 9.8)

### 3. `utilities/private/fixsource.m` (MATLAB) -> Cumulative Risk: **762.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 303.38 | **LOC:** 422 | **CtrlFlow:** 40.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9792%)
- **Heaviest Functions:** `fixsource` (Impact: 105.4), `__global_context__` (Impact: 2.5), `Anonymous_Block` (Impact: 2.2)

### 4. `realtime/src/acquisition/openbci/java/src/OpenBCI_ADS1299.java` (JAVA) -> Cumulative Risk: **735.91**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1012.74 | **LOC:** 1064 | **CtrlFlow:** 38.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `writeChannelSettings` (Impact: 169.8), `syncWithHardware` (Impact: 80.1), `interpretBinaryStream` (Impact: 55.6)

### 5. `realtime/src/buffer/src/tcpsocket.c` (C) -> Cumulative Risk: **723.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 204.56 | **LOC:** 238 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Concurrency (99.9343%)
- **Heaviest Functions:** `tcpsocket` (Impact: 70.2), `cleanup_tcpsocket` (Impact: 8.0)

### 6. `plotting/private/coordsys2label.m` (MATLAB) -> Cumulative Risk: **704.76**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 255.56 | **LOC:** 183 | **CtrlFlow:** 35.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.967%)
- **Heaviest Functions:** `coordsys2label` (Impact: 87.1), `trim` (Impact: 3.3)

### 7. `private/equidistant_locate.m` (MATLAB) -> Cumulative Risk: **701.82**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 476.1 | **LOC:** 350 | **CtrlFlow:** 17.3% | **Authorship Centralization:** 80.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.9325%)
- **Heaviest Functions:** `equidistant_locate` (Impact: 163.4), `uniformquadrant` (Impact: 2.3)

### 8. `realtime/src/acquisition/openbci/java/src/openBCI2ft.java` (JAVA) -> Cumulative Risk: **700.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 252.86 | **LOC:** 327 | **CtrlFlow:** 32.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Cognitive Load (99.6633%)
- **Heaviest Functions:** `main` (Impact: 106.4), `syncWithHardware` (Impact: 16.8)

### 9. `utilities/ft_selectdata.m` (MATLAB) -> Cumulative Risk: **697.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 1805.7 | **LOC:** 1399 | **CtrlFlow:** 41.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.4615%)
- **Heaviest Functions:** `ft_selectdata` (Impact: 199.9), `makeselection` (Impact: 142.8), `cellmatselect` (Impact: 77.2)

### 10. `preproc/private/nearest.m` (MATLAB) -> Cumulative Risk: **696.32**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 116.56 | **LOC:** 158 | **CtrlFlow:** 41.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (98.3978%)
- **Heaviest Functions:** `nearest` (Impact: 44.8), `Anonymous_Block` (Impact: 10.0), `mbreal` (Impact: 7.7)
...
- **Risk Profile:** Cognitive Load (68.6344%), Tech Debt (17.0919%)
**Top Internal Functions/Classes:**
  * `cb_help` (Impact: 453.8)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw` (Impact: 422.7)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw_volume` (Impact: 421.8)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw_scatter` (Impact: 375.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw_headshape` (Impact: 332.1)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
...
- **Risk Profile:** Cognitive Load (89.9125%), Tech Debt (32.2612%)
**Top Internal Functions/Classes:**
  * `__global_context__` (Impact: 681.4)
    * *Intent:* % FT_FILETYPE determines the filetype of many EEG/MEG/MRI data files by % looking at the name, exten...
  * `Anonymous_Block` (Impact: 121.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % start determining t...
  * `filetype_true` (Impact: 45.8)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION that al...
  * `filetype_check_ced_spike6mat` (Impact: 45.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION that ch...
  * `filetype_check_openvibe_mat` (Impact: 36.9)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION that ch...
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
- **Risk Profile:** Cognitive Load (68.2589%), Tech Debt (31.4927%)
**Top Internal Functions/Classes:**
  * `ft_geometryplot` (Impact: 228.4)
    * *Intent:* % FT_GEOMETRYPLOT plots objects in 3D, such as sensors, headmodels, sourcemodels, % headshapes, mesh...
  * `cb_creategui` (Impact: 221.3)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_redraw` (Impact: 191.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_toggle` (Impact: 187.0)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_camlight` (Impact: 186.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (79.9923%), Tech Debt (17.6252%)
**Top Internal Functions/Classes:**
  * `__global_context__` (Impact: 150.5)
    * *Intent:* % FT_READ_EVENT reads all events from an EEG, MEG or other time series dataset and % returns them in...
  * `Anonymous_Block` (Impact: 36.5)
  * `Anonymous_Block` (Impact: 32.1)
    * *Intent:* % check whether there's an event definition in the fif file
  * `ft_read_event` (Impact: 30.1)
    * *Intent:* % FT_READ_EVENT reads all events from an EEG, MEG or other time series dataset and % returns them in...
  * `Anonymous_Block` (Impact: 29.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (74.2102%), Tech Debt (11.6536%)
**Top Internal Functions/Classes:**
  * `assignweights` (Impact: 400.3)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `ft_volumerealign` (Impact: 325.2)
    * *Intent:* % FT_VOLUMEREALIGN spatially aligns an anatomical MRI with head coordinates based on % external fidu...
  * `cb_help` (Impact: 183.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw` (Impact: 179.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw_ortho` (Impact: 178.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (80.2601%), Tech Debt (18.315%)
**Top Internal Functions/Classes:**
  * `Anonymous_Block` (Impact: 110.3)
  * `freq2raw` (Impact: 105.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % convert between dat...
  * `Anonymous_Block` (Impact: 99.2)
    * *Intent:* % from one bivariate representation to another % nothing to do elseif (strcmp(current, 'full') && st...
  * `timelock2raw` (Impact: 90.7)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % convert between dat...
  * `fixcsd` (Impact: 86.5)
...
- **Risk Profile:** Cognitive Load (77.7937%), Tech Debt (14.1634%)
**Top Internal Functions/Classes:**
  * `sens2lay` (Impact: 349.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION % conve...
  * `opto2lay` (Impact: 200.0)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION % conve...
  * `readlay` (Impact: 182.5)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION % read ...
  * `ft_prepare_layout` (Impact: 148.4)
    * *Intent:* % FT_PREPARE_LAYOUT loads or creates a 2-D layout of the channel locations. This % layout is require...
  * `shiftxy` (Impact: 109.2)
...
- **Risk Profile:** Cognitive Load (80.1484%), Tech Debt (10.2805%)
**Top Internal Functions/Classes:**
  * `cb_redraw` (Impact: 173.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_help` (Impact: 160.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `ft_sourceplot` (Impact: 132.2)
    * *Intent:* % FT_SOURCEPLOT plots functional source reconstruction data on slices or on a surface, % optionally ...
  * `cb_keyboard` (Impact: 62.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `__global_context__` (Impact: 39.5)
    * *Intent:* % FT_SOURCEPLOT plots functional source reconstruction data on slices or on a surface, % optionally ...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (91.6843%), Tech Debt (62.8042%)
**Top Internal Functions/Classes:**
  * `ft_databrowser` (Impact: 253.7)
    * *Intent:* % FT_DATABROWSER can be used for visual inspection of data. Artifacts that were % detected by artifa...
  * `select_range_cb` (Impact: 48.0)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `__global_context__` (Impact: 41.2)
    * *Intent:* % FT_DATABROWSER can be used for visual inspection of data. Artifacts that were % detected by artifa...
  * `Anonymous_Block` (Impact: 35.8)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % add the component to...
  * `Anonymous_Block` (Impact: 34.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (68.2517%), Tech Debt (78.0905%)
**Top Internal Functions/Classes:**
  * `cb_btn_dwn2` (Impact: 173.1)
  * `prepare_mesh_manual` (Impact: 156.7)
    * *Intent:* % PREPARE_MESH_MANUAL is called by PREPARE_MESH and opens a GUI to manually % select points/polygons...
  * `cb_btn_dwn` (Impact: 137.2)
  * `erase_points2d` (Impact: 128.8)
  * `assign_points3d` (Impact: 106.5)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
- **Risk Profile:** Cognitive Load (81.0149%), Tech Debt (20.8204%)
**Top Internal Functions/Classes:**
  * `ft_read_data` (Impact: 288.8)
    * *Intent:* % FT_READ_DATA reads data from a variety of EEG, MEG and other time series data files % and represen...
  * `__global_context__` (Impact: 103.5)
    * *Intent:* % FT_READ_DATA reads data from a variety of EEG, MEG and other time series data files % and represen...
  * `Anonymous_Block` (Impact: 17.1)
  * `Anonymous_Block` (Impact: 12.3)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % convert the channel...
  * `Anonymous_Block` (Impact: 11.3)
...
- **Risk Profile:** Cognitive Load (74.6865%), Tech Debt (22.839%)
**Top Internal Functions/Classes:**
  * `ft_read_headshape` (Impact: 260.4)
    * *Intent:* % FT_READ_HEADSHAPE reads the fiducials and/or the measured headshape and/or meshes % that describe ...
  * `__global_context__` (Impact: 64.5)
    * *Intent:* % FT_READ_HEADSHAPE reads the fiducials and/or the measured headshape and/or meshes % that describe ...
  * `Anonymous_Block` (Impact: 13.2)
...
- **Risk Profile:** Cognitive Load (80.0574%), Tech Debt (33.967%)
**Top Internal Functions/Classes:**
  * `ft_meshrealign` (Impact: 418.2)
    * *Intent:* % FT_MESHREALIGN rotates, translates and optionally scales a surface description of % the head or of...
  * `cb_redraw_surface` (Impact: 234.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_keyboard_surface` (Impact: 225.9)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_redraw` (Impact: 218.1)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cb_keyboard` (Impact: 68.7)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (50.1256%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `sync` (Impact: 6.2)
...
- **Risk Profile:** Cognitive Load (96.5926%), Tech Debt (45.2621%)
**Top Internal Functions/Classes:**
  * `ft_selectdata_new` (Impact: 311.1)
    * *Intent:* % FT_SELECTDATA_NEW is deprecated, please use FT_SELECTDATA instead. %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `makeselection` (Impact: 60.9)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTIONS %%%%%%%%%%%%...
  * `cellmatselect` (Impact: 48.0)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION to make a ...
  * `makeselection_cumtapcnt` (Impact: 31.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  * `getselection_rpt` (Impact: 30.9)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1805.7 | **LOC:** 1399 | **CtrlFlow:** 41.7% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (97.0693%), Tech Debt (64.8329%)
**Top Internal Functions/Classes:**
  * `ft_selectdata` (Impact: 199.9)
    * *Intent:* % FT_SELECTDATA makes a selection in the input data along specific data % dimensions, such as channe...
  * `makeselection` (Impact: 142.8)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTIONS %%%%%%%%%...
  * `cellmatselect` (Impact: 77.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION to make a ...
  * `getselection_spike` (Impact: 32.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % possible specification...
  * `__global_context__` (Impact: 31.1)
    * *Intent:* % FT_SELECTDATA makes a selection in the input data along specific data % dimensions, such as channe...
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 2 instances
...
- **Risk Profile:** Cognitive Load (83.7119%), Tech Debt (83.3201%)
**Top Internal Functions/Classes:**
  * `ft_connectivityanalysis` (Impact: 277.4)
    * *Intent:* % FT_CONNECTIVITYANALYSIS computes various measures of connectivity between % MEG/EEG channels or be...
  * `Anonymous_Block` (Impact: 127.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ...
  * `__global_context__` (Impact: 36.5)
    * *Intent:* % FT_CONNECTIVITYANALYSIS computes various measures of connectivity between % MEG/EEG channels or be...
  * `Anonymous_Block` (Impact: 16.8)
    * *Intent:* % check if jackknife is required % do nothing elseif hasrpt && dojack && ~ismember(cfg.method, {'wpl...
  * `Anonymous_Block` (Impact: 13.7)
...
- **Risk Profile:** Cognitive Load (70.6278%), Tech Debt (27.9771%)
**Top Internal Functions/Classes:**
  * `cb_creategui` (Impact: 188.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_redraw` (Impact: 122.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_camlight` (Impact: 101.1)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_material` (Impact: 100.2)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
  * `cb_cutplane` (Impact: 99.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% % SUBFUNCTION %%%%%...
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
- **Risk Profile:** Cognitive Load (80.0971%), Tech Debt (56.6486%)
**Top Internal Functions/Classes:**
  * `ft_sourceanalysis` (Impact: 580.5)
    * *Intent:* % FT_SOURCEANALYSIS performs beamformer dipole analysis on EEG or MEG data % after preprocessing and...
  * `Anonymous_Block` (Impact: 18.1)
...
- **Risk Profile:** Cognitive Load (70.8427%), Tech Debt (16.2597%)
**Top Internal Functions/Classes:**
  * `ft_artifact_zvalue` (Impact: 352.3)
    * *Intent:* % FT_ARTIFACT_ZVALUE scans data segments of interest for artifacts, by means of % thresholding the z...
  * `artval_cb` (Impact: 156.3)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `keyboard_cb` (Impact: 77.4)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `redraw_cb` (Impact: 45.6)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
  * `cleanup_cb` (Impact: 5.9)
    * *Intent:* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%...
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (64.2767%), Tech Debt (8.9557%)
**Top Internal Functions/Classes:**
  * `read_nervus_header_dynamicpackets` (Impact: 118.8)
  * `read_nervus_header_staticpackets` (Impact: 77.6)
    * *Intent:* % Get StaticPackets structure and Channel IDS fseek(h, 172,'bof'); NrStaticPackets = fread(h,1, 'uin...
  * `compareTsInfoPackets` (Impact: 40.6)
  * `read_nervus_header_events` (Impact: 30.5)
    * *Intent:* %% Get events - Andrei Barborica, Dec 2015 % Find sequence of events, that are stored in the section...
  * `read_nervus_header` (Impact: 29.2)
...
- **Risk Profile:** Cognitive Load (82.0373%), Tech Debt (11.7682%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 372.4)
  * `iniHandler` (Impact: 311.6)
  * `interpret24bitAsInt32` (Impact: 4.9)
    * *Intent:* ; #endif
  * `interpret16bitAsInt32` (Impact: 4.8)
  * `serialWriteSlow` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
...
- `realtime/src/buffer/cpp/OnlineDataManager.h` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 100.0%)
...
- `realtime/src/buffer/cpp/GDF_BackgroundWriter.h` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 99.9969%)
- `realtime/src/buffer/java/bufferserver/network/ConnectionThread.java` -> **Severity: 0.001** (Bridge: 0.0 * Flux: 88.2509%)
