...
- `promisify` (@ `package/implementation.js`) -> Impact: **23.6** | LOC: 77
- `fn` (@ `package/implementation.js`) -> Impact: **8.0** | LOC: 20
- `getPolyfill` (@ `package/polyfill.js`) -> Impact: **3.3** | LOC: 6
- `shimUtilPromisify` (@ `package/shim.js`) -> Impact: **2.6** | LOC: 12
- `promisify` (@ `package/index.js`) -> Impact: **1.6** | LOC: 4
  * *Intent:* /* eslint-disable no-unused-vars */
- `value` (@ `package/implementation.js`) -> Impact: **1.1** | LOC: 3
- `value` (@ `package/implementation.js`) -> Impact: **1.1** | LOC: 3
...
- **Heaviest Functions:** `promisify` (Impact: 23.6), `fn` (Impact: 8.0), `value` (Impact: 1.1)
...
- **Heaviest Functions:** `promisify` (Impact: 1.6)
...
- **Heaviest Functions:** `shimUtilPromisify` (Impact: 2.6)
...
- **Heaviest Functions:** `getPolyfill` (Impact: 3.3)
