...
- `PLUSX` (@ `Luminary099/P40-P47.agc`) -> Impact: **22.8** | LOC: 248
- `SIZETAB` (@ `Comanche055/RESTART_TABLES.agc`) -> Impact: **22.6** | LOC: 423
  * *Intent:* # RESTART 2CADR
- `CSISTEP` (@ `Comanche055/P32-P33_P72-P73.agc`) -> Impact: **21.9** | LOC: 297
- `P23` (@ `Comanche055/P20-P25.agc`) -> Impact: **18.6** | LOC: 112
- `EJSCAN` (@ `Luminary099/EXECUTIVE.agc`) -> Impact: **18.3** | LOC: 54
- `PICAPAR` (@ `Luminary099/P51-P53.agc`) -> Impact: **16.6** | LOC: 133
- `EJSCAN` (@ `Comanche055/EXECUTIVE.agc`) -> Impact: **16.5** | LOC: 48
- `PICAPAR` (@ `Comanche055/P51-P53.agc`) -> Impact: **16.4** | LOC: 129
- `STORCMD` (@ `Comanche055/T4RUPT_PROGRAM.agc`) -> Impact: **15.9** | LOC: 40
- `CHECKALT` (@ `Luminary099/ASCENT_GUIDANCE.agc`) -> Impact: **15.9** | LOC: 120
...
- **Heaviest Functions:** `SETUPDSP` (Impact: 7.7), `ONEORTWO` (Impact: 5.0), `BELOW2` (Impact: 4.9)
...
- **Heaviest Functions:** `CHKCOMED` (Impact: 6.6), `OPTDATA` (Impact: 6.4), `FINETIME` (Impact: 5.1)
...
- **Heaviest Functions:** `LDLOOP72` (Impact: 6.8), `DELTATOK` (Impact: 5.6), `STORLP71` (Impact: 4.8)
...
- **Heaviest Functions:** `LDLOOP72` (Impact: 6.9), `DELTATOK` (Impact: 5.7), `STORLP71` (Impact: 4.8)
...
- **Heaviest Functions:** `PIPJOBB` (Impact: 5.8), `FINETIME` (Impact: 5.1), `CHECKG1` (Impact: 4.3)
...
- **Heaviest Functions:** `ENDV97E` (Impact: 14.5), `TOGETHER` (Impact: 14.5), `RATEZRO` (Impact: 12.5)
...
- **Heaviest Functions:** `HMSOUT` (Impact: 12.2), `NUM` (Impact: 7.2), `HMSIN` (Impact: 6.5)
...
- **Heaviest Functions:** `P40AUTO` (Impact: 6.4), `CLOKJOB` (Impact: 6.0), `IGNITE` (Impact: 4.1)
...
- **Heaviest Functions:** `MARKRUPT` (Impact: 8.4), `MKVAC` (Impact: 6.7), `FINDKEY` (Impact: 6.7)
