...
| Avg Path Length | 3.4736 | Hops between files. Lower = Tighter coupling. |
...
- `LoadModuleManifest` (@ `src/System.Management.Automation/engine/Modules/ModuleCmdletBase.cs`) -> Impact: **886.4** | LOC: 1238
...
- `GetResultHelper` (@ `src/System.Management.Automation/engine/CommandCompletion/CompletionAnalysis.cs`) -> Impact: **566.4** | LOC: 808
- `SetValueImpl` (@ `src/System.Management.Automation/engine/runtime/MutableTuple.cs`) -> Impact: **455.4** | LOC: 135
- `ToString` (@ `src/System.Management.Automation/engine/MshObject.cs`) -> Impact: **429.0** | LOC: 1170
...
- `NativeCommandArgumentCompletion` (@ `src/System.Management.Automation/engine/CommandCompletion/CompletionCompleters.cs`) -> Impact: **417.0** | LOC: 403
- `GetMessage` (@ `src/System.Management.Automation/CoreCLR/EventResource.cs`) -> Impact: **361.5** | LOC: 579
...
- `ScanVariable` (@ `src/System.Management.Automation/engine/parser/tokenizer.cs`) -> Impact: **244.1** | LOC: 309
  * *Intent:* #endregion Strings #region Variables // Scan a variable - the first character ($ or @) has been consumed already.
- `TryGetNumberValue` (@ `src/System.Management.Automation/engine/parser/tokenizer.cs`) -> Impact: **241.3** | LOC: 328
- `LoadModule` (@ `src/System.Management.Automation/engine/Modules/ModuleCmdletBase.cs`) -> Impact: **236.9** | LOC: 493
  * *Intent:* /// <summary> /// Load a module from a file... /// </summary> /// <param name="parentModule">The parent module, if any.</param> /// <param name="fileN...
- `LoadBinaryModule` (@ `src/System.Management.Automation/engine/Modules/ModuleCmdletBase.cs`) -> Impact: **230.9** | LOC: 292
...
- **Heaviest Functions:** `EvtRenderBufferWithContextSystem` (Impact: 120.1), `ConvertToObject` (Impact: 86.2), `EvtSetChannelConfigProperty` (Impact: 60.5)
...
- **Heaviest Functions:** `MakeDelegate` (Impact: 60.7), `GetPrimitiveDefaultValue` (Impact: 42.3), `IsReadWriteAssignment` (Impact: 29.8)
...
- **Heaviest Functions:** `SetSingleClipboardData` (Impact: 22.5), `SetText` (Impact: 17.7), `GetTextImpl` (Impact: 13.6)
...
- **Heaviest Functions:** `EmitLoad` (Impact: 26.6), `EmitNewArrayInit` (Impact: 16.8), `GetInstructionViews` (Impact: 10.5)
...
- **Heaviest Functions:** `GetExportedCommands` (Impact: 38.6), `CacheModuleExports` (Impact: 34.3), `AnalyzeManifestModule` (Impact: 32.6)
...
- **Heaviest Functions:** `EnumObjectItems` (Impact: 37.5), `ReadNextSet` (Impact: 31.0), `TranslateLocalCounterPath` (Impact: 23.5)
...
- **Heaviest Functions:** `IDispatch.Invoke` (Impact: 15.7), `Remove` (Impact: 10.1), `GetVariant` (Impact: 5.1)
...
- **Heaviest Functions:** `GroupStackFrames` (Impact: 11.0), `Goto` (Impact: 7.2), `GetStackTraceDebugInfo` (Impact: 4.5)
...
- **Heaviest Functions:** `VisitVariable` (Impact: 21.5), `VisitBinary` (Impact: 13.9), `CreateDelegate` (Impact: 11.8)
...
- **Heaviest Functions:** `AnalyzeImpl` (Impact: 33.6), `AnalyzeBlock` (Impact: 27.0), `CheckLHSAssignVar` (Impact: 24.4)
...
**Top Internal Functions/Classes:**
  * `NativeCommandArgumentCompletion` (Impact: 417.0)
  * `CompleteHashtableKey` (Impact: 179.4)
  * `CompleteCommandArgument` (Impact: 176.8)
    * *Intent:* #endregion Command Parameters #region Command Arguments
  * `EscapeCharIfNeeded` (Impact: 135.9)
  * `GetDefaultProviderResults` (Impact: 126.5)
...
**Top Internal Functions/Classes:**
  * `SwitchStatementRule` (Impact: 130.0)
  * `ConfigurationStatementRule` (Impact: 120.2)
  * `GetCommandArgument` (Impact: 102.7)
  * `ClassMemberRule` (Impact: 99.6)
  * `DynamicKeywordStatementRule` (Impact: 92.8)
...
**Top Internal Functions/Classes:**
  * `InvokeMethod` (Impact: 130.7)
  * `GetPSMemberInfo` (Impact: 106.9)
  * `FallbackSetMember` (Impact: 105.2)
  * `BinaryNumericOp` (Impact: 85.8)
  * `FallbackInvokeMember` (Impact: 84.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `NewItem` (Impact: 164.3)
    * *Intent:* /// Specify "directory" or "container" to create a directory. /// </param> /// <param name="value"> ...
  * `Dir` (Impact: 148.9)
  * `PerformCopyFileFromRemoteSession` (Impact: 70.9)
  * `CopyFileStreamToRemoteSession` (Impact: 59.2)
  * `NormalizeRelativePath` (Impact: 58.2)
...
**Top Internal Functions/Classes:**
  * `VisitBinaryExpression` (Impact: 106.5)
  * `NewParameterAttribute` (Impact: 43.8)
  * `CompileStatementListWithTraps` (Impact: 42.5)
  * `GetRedirectedExpression` (Impact: 41.8)
    * *Intent:* // A redirected expression requires extra work because there is no CommandProcessor or PipelineProce...
  * `VisitPipeline` (Impact: 40.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `NewItemPluginOrPluginChild` (Impact: 89.8)
...
**Top Internal Functions/Classes:**
  * `FindBestMethodImpl` (Impact: 183.2)
  * `CompareOverloadCandidates` (Impact: 81.0)
    * *Intent:* /// <summary> /// Compare the 2 methods, determining which method is better. /// </summary> /// <ret...
  * `GetMethodInvoker` (Impact: 69.3)
  * `DoBoxingIfNecessary` (Impact: 47.4)
  * `PopulatePropertyReflectionTable` (Impact: 38.0)
...
**Top Internal Functions/Classes:**
  ...
  * `BaseConvertFrom` (Impact: 80.3)
  * `FigureConversion` (Impact: 80.3)
  * `SetObjectProperties` (Impact: 71.0)
  * `IsCustomTypeConversion` (Impact: 43.4)
...
**Top Internal Functions/Classes:**
  * `GetResultHelper` (Impact: 566.4)
  * `GetResultForIdentifier` (Impact: 186.8)
  * `GetResultForEnumPropertyValueOfDSCResource` (Impact: 86.7)
  * `TryGetInferredCompletionsForAssignment` (Impact: 58.7)
  * `CompleteAgainstStatementFlags` (Impact: 43.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `AnalyzePSSnapInAssembly` (Impact: 118.5)
  * `AnalyzeModuleAssemblyWithReflection` (Impact: 77.9)
  * `ProcessModulesToImport` (Impact: 66.0)
  * `ImportPSSnapIn` (Impact: 50.7)
  * `Bind_BindCommands` (Impact: 48.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `GetValueImpl` (Impact: 192.0)
  * `SetValueImpl` (Impact: 118.0)
  * `GetValueImpl` (Impact: 98.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `InferTypeFrom` (Impact: 156.4)
  * `TryGetTypeFromMember` (Impact: 112.1)
  * `ICustomAstVisitor.VisitBinaryExpression` (Impact: 90.7)
  * `InferTypesFrom` (Impact: 89.0)
  * `VisitCommand` (Impact: 69.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `Read_Type` (Impact: 57.5)
  * `Read_Members` (Impact: 52.2)
  * `LoadStandardMembersToTypeData` (Impact: 39.3)
...
**Top Internal Functions/Classes:**
  * `ToXmlQualifiedName` (Impact: 13.5)
  * `UnknownNode` (Impact: 13.4)
  * `CurrentTag` (Impact: 10.0)
  * `ShrinkArray` (Impact: 9.6)
  * `EnsureArrayIndex` (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `GetChildNamesInDir` (Impact: 85.0)
    * *Intent:* /// </exception> /// <exception cref="ProviderInvocationException"> /// If the provider associated w...
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `MapAttributesToMof` (Impact: 54.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CreateMethodGroup` (Impact: 29.5)
  * `GetIntegratedMembers` (Impact: 27.4)
  * `EnsureReservedMemberIsLoaded` (Impact: 24.1)
...
- `src/Microsoft.PowerShell.ConsoleHost/host/msh/Serialization.cs` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 99.999%)
