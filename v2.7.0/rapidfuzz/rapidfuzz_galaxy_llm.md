...
| Analyzed Artifacts (Scanned) | 2462 |
| Excluded Artifacts (Unparsable data, binaries, unsupported formats) | 778 |
| Total LOC | 449462 |
...
|---|---|---|
| Modularity | 0.7679 | High = Clean micro-boundaries. Low = Spaghetti coupling. |
...
| Avg Path Length | 4.975 | Hops between files. Lower = Tighter coupling. |
...
|---|---|---|
| Unclassified | 2360 | 95.9% |

### Inert Structural Mass (Static Categories)
| Category | Count | Repo % |
|---|---|---|
| Static: Literature & Documentation | 92 | 3.7% |
| Static: Minified & Vendor Opaque Mass | 10 | 0.4% |

## 5. EXCLUDED ARTIFACTS (Unparsable or Shielded Files)
*Total Excluded Artifacts: 778*

**Composition by Extension & Reason:**
- `.dox`: 165x Excluded (Unsupported Extension: '.dox')
- `no_extension`: 64x Unsupported Format (.undeterminable), 21x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 2x Excluded (Binary Format Detected)
...
- `.svg`: 40x Excluded (System Exclusion, Hidden Directory, or Dynamic Ignored Dir), 1x Excluded (Machine-Generated Source Code Signature: 163 LOC), 1x Excluded (Machine-Generated Source Code Signature: 203 LOC)
...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 100.0 | 53.5 | 66.6 | 0.0 |
...
| Spec Alignment (formerly Specification Exposure) | 0.0 | 100.0 | 76.8 | 100.0 | 100.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 60.5 | 93.5 | 100.0 |
...
| connectivity | 6821 | 1121 | 8 | `rapidfuzz-3.14.3/extern/taskflow/3rd-party/httplib/httplib.hpp` |
...
| dead_code | 5964 | 1346 | 6 | `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbbmalloc/frontend.cpp` |
...
- `_getopt_internal_r_a` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/ff/platforms/getopt.hpp`) -> Impact: **449.5** | LOC: 350
- `_getopt_internal_r_w` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/ff/platforms/getopt.hpp`) -> Impact: **449.5** | LOC: 350
- `parse_cbor_internal` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/nlohmann/json.hpp`) -> Impact: **447.8** | LOC: 434
  * *Intent:* */
- `EigenFloatContractionKernelInternal` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/eigen-3.3.7/unsupported/Eigen/CXX11/src/Tensor/TensorContractionCuda.h`) -> Impact: **353.2** | LOC: 365
- `ctbmv_` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/eigen-3.3.7/blas/f2c/ctbmv.c`) -> Impact: **345.3** | LOC: 632
  * *Intent:* */ #include "datatypes.h"
- `ztbmv_` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/eigen-3.3.7/blas/f2c/ztbmv.c`) -> Impact: **345.3** | LOC: 632
  * *Intent:* */ #include "datatypes.h"
- `Executor::_wait_for_task` (@ `rapidfuzz-3.14.3/extern/taskflow/taskflow/core/executor.hpp`) -> Impact: **313.2** | LOC: 930
  * *Intent:* // Function: _wait_for_task
- `extract_iter` (@ `rapidfuzz-3.14.3/src/rapidfuzz/process_cpp_impl.pyx`) -> Impact: **307.1** | LOC: 372
- `main` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/examples/graph/logic_sim/test_all.cpp`) -> Impact: **306.6** | LOC: 589
  * *Intent:* #endif // __TBB_FLOW_GRAPH_CPP11_FEATURES
- `parse_msgpack_internal` (@ `rapidfuzz-3.14.3/extern/taskflow/3rd-party/nlohmann/json.hpp`) -> Impact: **293.4** | LOC: 369
  * *Intent:* ///////////// // MsgPack // ///////////// /*! */
...
### 1. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbb/tbb_thread.cpp` (CPP) -> Cumulative Risk: **820.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 151.78 | **LOC:** 193 | **CtrlFlow:** 29.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9998%), Tech Debt (99.9283%)
- **Heaviest Functions:** `tbb_thread_v3::internal_start` (Impact: 23.0), `thread_sleep_v3` (Impact: 15.4), `tbb_thread_v3::join` (Impact: 12.3)

### 2. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/python/tbb/__init__.py` (PYTHON) -> Cumulative Risk: **778.47**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 246.42 | **LOC:** 326 | **CtrlFlow:** 21.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Concurrency (99.948%), Tech Debt (99.9422%)
- **Heaviest Functions:** `__exit__` (Impact: 14.1), `__enter__` (Impact: 9.3), `__init__` (Impact: 8.7)

### 3. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbbproxy/tbbproxy.cpp` (CPP) -> Cumulative Risk: **739.08**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 341.38 | **LOC:** 609 | **CtrlFlow:** 24.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.966%), Cognitive Load (95.2209%)
- **Heaviest Functions:** `_load` (Impact: 50.4), `load` (Impact: 45.4), `error` (Impact: 30.5)

### 4. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/eigen-3.3.7/unsupported/Eigen/src/LevenbergMarquardt/LMpar.h` (CPP) -> Cumulative Risk: **735.8**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 176.02 | **LOC:** 161 | **CtrlFlow:** 18.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.809%)
- **Heaviest Functions:** `lmpar2` (Impact: 57.1)

### 5. `rapidfuzz-3.14.3/extern/taskflow/tfprof/js/index.js` (JAVASCRIPT) -> Cumulative Risk: **733.62**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 414.76 | **LOC:** 996 | **CtrlFlow:** 6.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `main` (Impact: 37.5), `_adjust_tb` (Impact: 9.6), `_render_rankGraph` (Impact: 9.4)

### 6. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/eigen-3.3.7/unsupported/Eigen/CXX11/src/ThreadPool/NonBlockingThreadPool.h` (CPP) -> Cumulative Risk: **733.49**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 169.4 | **LOC:** 275 | **CtrlFlow:** 17.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (91.2365%)
- **Heaviest Functions:** `WorkerLoop` (Impact: 17.4), `NonBlockingThreadPoolTempl` (Impact: 12.3), `WaitForWork` (Impact: 10.7)

### 7. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/perf/time_hash_map.cpp` (CPP) -> Cumulative Risk: **732.31**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 205.28 | **LOC:** 258 | **CtrlFlow:** 20.6% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.6956%), Documentation (95.0%)
- **Heaviest Functions:** `test` (Impact: 31.1), `test` (Impact: 29.5), `main` (Impact: 9.6)

### 8. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbbmalloc/large_objects.cpp` (CPP) -> Cumulative Risk: **728.72**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 646.16 | **LOC:** 1034 | **CtrlFlow:** 19.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9998%), Tech Debt (99.3434%)
- **Heaviest Functions:** `CacheBin::putList` (Impact: 41.8), `OperationPreprocessor::operator()` (Impact: 39.4), `CacheBin::cleanToThreshold` (Impact: 25.9)

### 9. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbb/tbb_misc_ex.cpp` (CPP) -> Cumulative Risk: **721.52**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 243.48 | **LOC:** 402 | **CtrlFlow:** 29.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.999%), Safety Score (89.7557%)
- **Heaviest Functions:** `initialize_hardware_concurrency_info` (Impact: 34.8), `initialize_hardware_concurrency_info` (Impact: 16.6), `FindProcessorGroupIndex` (Impact: 14.2)

### 10. `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbb/concurrent_vector.cpp` (CPP) -> Cumulative Risk: **719.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 547.76 | **LOC:** 611 | **CtrlFlow:** 26.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Tech Debt (99.6433%), Safety Score (96.5098%)
- **Heaviest Functions:** `concurrent_vector_base_v3::internal_compact` (Impact: 50.5), `concurrent_vector_base_v3::internal_assign` (Impact: 38.8), `concurrent_vector_base_v3::helper::enable_segment` (Impact: 27.5)
...
- **Risk Profile:** Cognitive Load (93.4775%), Tech Debt (0.0%)
...
- **Risk Profile:** Cognitive Load (31.3567%), Tech Debt (12.2474%)
**Top Internal Functions/Classes:**
  * `parse_cbor_internal` (Impact: 447.8)
    * *Intent:* */
  * `parse_msgpack_internal` (Impact: 293.4)
    * *Intent:* ///////////// // MsgPack // ///////////// /*! */
  * `scan_string` (Impact: 269.2)
    * *Intent:* */
  * `write_msgpack` (Impact: 155.9)
    * *Intent:* /*! */
  * `write_cbor` (Impact: 146.6)
    * *Intent:* /*! */
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (47.7303%), Tech Debt (98.8921%)
**Top Internal Functions/Classes:**
  * `partial_ratio_impl` (Impact: 64.3)
  * `is_space_impl` (Impact: 55.5)
    * *Intent:* /* * Implementation of is_space for char types that are at least 2 Byte in size */
  * `levenshtein_mbleven2018` (Impact: 50.6)
  * `lcs_seq_mbleven2018` (Impact: 48.5)
  * `uniform_levenshtein_distance` (Impact: 46.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (69.0156%), Tech Debt (9.2855%)
**Top Internal Functions/Classes:**
  * `parse` (Impact: 98.3)
  * `status_message` (Impact: 96.8)
  * `Server::apply_ranges` (Impact: 72.5)
  * `ClientImpl::send_with_content_provider` (Impact: 70.7)
  * `ClientImpl::write_request` (Impact: 69.7)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (50.8892%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ZMAKE` (Impact: 251.6)
  * `ZCHK3` (Impact: 246.2)
  * `ZCHK2` (Impact: 197.3)
...
- **Risk Profile:** Cognitive Load (50.8464%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `CMAKE` (Impact: 251.5)
  * `CCHK3` (Impact: 246.1)
  * `CCHK2` (Impact: 197.2)
...
- **Risk Profile:** Cognitive Load (50.3329%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `DCHK3` (Impact: 245.9)
  * `DMAKE` (Impact: 237.4)
  * `DCHK2` (Impact: 197.1)
...
- **Risk Profile:** Cognitive Load (53.816%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `ZCHK5` (Impact: 207.1)
  * `ZCHK4` (Impact: 185.2)
  * `ZMMCH` (Impact: 181.5)
...
- **Risk Profile:** Cognitive Load (54.0657%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `CCHK5` (Impact: 207.1)
  * `CCHK4` (Impact: 185.2)
  * `CMMCH` (Impact: 181.4)
...
- **Risk Profile:** Cognitive Load (64.3806%), Tech Debt (14.7929%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (50.6659%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `DCHK3` (Impact: 144.5)
  * `DCHK5` (Impact: 142.0)
  * `DMAKE` (Impact: 131.5)
...
- **Risk Profile:** Cognitive Load (74.1943%), Tech Debt (8.0212%)
**Top Internal Functions/Classes:**
  * `extract_iter` (Impact: 307.1)
  * `extractOne_dict_i64` (Impact: 66.5)
  * `extractOne_dict_size_t` (Impact: 66.5)
  * `extractOne_list_f64` (Impact: 66.4)
  * `extractOne_list_i64` (Impact: 66.4)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (61.942%), Tech Debt (29.2173%)
**Top Internal Functions/Classes:**
  * `parse_align` (Impact: 46.1)
    * *Intent:* // Parses fill and alignment.
  * `prettify` (Impact: 45.9)
  * `parse_format_specs` (Impact: 44.4)
    * *Intent:* // Parses standard format specifiers and sends notifications about parsed // components to handler.
  * `parse_arg_id` (Impact: 37.6)
  * `handle_int_type_spec` (Impact: 36.2)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 4.112
  * `Choke Point (Betweenness):` 0.000431 | `Ripple Effect (Closeness):` 0.0
...
- **Risk Profile:** Cognitive Load (91.2155%), Tech Debt (92.8956%)
**Top Internal Functions/Classes:**
  * `thread_map::add_virtual_processors` (Impact: 97.9)
  * `omp_connection_v2::get_threads` (Impact: 35.1)
  * `thread_map::wakeup_tbb_threads` (Impact: 34.1)
  * `connection_scavenger_thread::process_requests` (Impact: 33.1)
  * `thread_map::remove_virtual_processors` (Impact: 32.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (66.3397%), Tech Debt (98.0973%)
**Top Internal Functions/Classes:**
  * `reallocAligned` (Impact: 45.1)
  * `__TBB_malloc_safer_aligned_realloc` (Impact: 45.0)
  * `__TBB_malloc_safer_realloc` (Impact: 44.1)
    * *Intent:* /* * A variant that provides additional memory safety, by checking whether the given address * was o...
  * `getIndexOrObjectSize` (Impact: 40.2)
    * *Intent:* /* * Depending on indexRequest, for a given size return either the index into the bin * for objects ...
  * `scalable_allocation_mode` (Impact: 34.7)
...
- **Risk Profile:** Cognitive Load (70.0979%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (60.6828%), Tech Debt (0.0%)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (81.6924%), Tech Debt (17.9049%)
**Top Internal Functions/Classes:**
  * `_getopt_internal_r_a` (Impact: 449.5)
  * `_getopt_internal_r_w` (Impact: 449.5)
  * `_getopt_initialize_a` (Impact: 15.1)
  * `_getopt_initialize_w` (Impact: 15.1)
...
- **Risk Profile:** Cognitive Load (95.0425%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `mainSort` (Impact: 126.2)
    * *Intent:* */ #define BIGFREQ(b) (ftab[((b)+1) << 8] - ftab[(b) << 8]) #define SETMASK (1 << 21) #define CLEARM...
  * `fallbackSort` (Impact: 103.9)
...
- **Risk Profile:** Cognitive Load (94.7306%), Tech Debt (14.4815%)
**Top Internal Functions/Classes:**
...
- **Risk Profile:** Cognitive Load (79.6812%), Tech Debt (10.2977%)
**Top Internal Functions/Classes:**
  * `EigenFloatContractionKernelInternal` (Impact: 353.2)
  * `EigenFloatContractionKernelInternal16x16` (Impact: 220.7)
  * `EigenContractionKernelInternal` (Impact: 149.9)
  * `evalTo` (Impact: 23.1)
  * `EigenFloatContractionKernel` (Impact: 20.6)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (28.6083%), Tech Debt (96.4712%)
**Top Internal Functions/Classes:**
  * `internal_make_edge` (Impact: 161.2)
    * *Intent:* #endif //variadic max 10 #if __TBB_PREVIEW_ASYNC_MSG
  * `handle_operations_impl` (Impact: 71.7)
  * `internal_remove_edge` (Impact: 61.0)
    * *Intent:* #endif #if __TBB_PREVIEW_ASYNC_MSG
  * `internal_forward_task_impl` (Impact: 16.8)
  * `try_reserve_apply_body` (Impact: 12.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00065 | `Ripple Effect (Closeness):` 0.0
...
- `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/examples/common/utility/utility.h` -> **Severity: 0.456** (Bridge: 0.0046 * Flux: 100.0%)
- `rapidfuzz-3.14.3/extern/taskflow/taskflow/core/observer.hpp` -> **Severity: 0.265** (Bridge: 0.0026 * Flux: 99.9951%)
- `rapidfuzz-3.14.3/extern/taskflow/taskflow/core/executor.hpp` -> **Severity: 0.255** (Bridge: 0.0026 * Flux: 98.5335%)
- `rapidfuzz-3.14.3/extern/taskflow/taskflow/core/nonblocking_notifier.hpp` -> **Severity: 0.225** (Bridge: 0.0023 * Flux: 99.5057%)
- `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/src/tbb/condition_variable.cpp` -> **Severity: 0.218** (Bridge: 0.0022 * Flux: 99.9812%)

### 🙈 Opaque Critical Nodes (Dependency Blast Radius * Doc Risk)
These are 'Core Architecture Nodes' that the entire ecosystem relies upon, but they lack human intent, documentation, or ownership metadata. Modifying them is flying blind.

- `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/examples/common/utility/utility.h` -> **Severity: 1230.7** (Blast Radius: 12.307 * Doc Risk: 100.0%)
- `rapidfuzz-3.14.3/extern/rapidfuzz-cpp/rapidfuzz/details/type_traits.hpp` -> **Severity: 1218.9** (Blast Radius: 12.189 * Doc Risk: 100.0%)
- `rapidfuzz-3.14.3/extern/taskflow/taskflow/core/executor.hpp` -> **Severity: 1155.9** (Blast Radius: 11.559 * Doc Risk: 100.0%)
- `rapidfuzz-3.14.3/extern/taskflow/3rd-party/tbb/include/tbb/tbb_stddef.h` -> **Severity: 1001.85** (Blast Radius: 13.358 * Doc Risk: 75.0%)
- `rapidfuzz-3.14.3/extern/taskflow/taskflow/utility/iterator.hpp` -> **Severity: 707.4** (Blast Radius: 7.074 * Doc Risk: 100.0%)
