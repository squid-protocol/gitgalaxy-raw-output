...
- `__init__` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_formatting.py`) -> Impact: **143.1** | LOC: 142
- `format` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_formatting.py`) -> Impact: **87.1** | LOC: 88
- `split_exception_group` (@ `exceptiongroup-1.3.1/tests/test_exceptions.py`) -> Impact: **63.1** | LOC: 62
...
- `test_split_by_type` (@ `exceptiongroup-1.3.1/tests/test_exceptions.py`) -> Impact: **30.5** | LOC: 100
- `handle_exception` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_catch.py`) -> Impact: **29.9** | LOC: 44
- `__new__` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_exceptions.py`) -> Impact: **29.9** | LOC: 39
- `_compute_suggestion_error` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_formatting.py`) -> Impact: **28.3** | LOC: 47
- `test_split_ExceptionGroup_subclass_derive_and_new_overrides` (@ `exceptiongroup-1.3.1/tests/test_exceptions.py`) -> Impact: **27.1** | LOC: 62
- `catch` (@ `exceptiongroup-1.3.1/src/exceptiongroup/_catch.py`) -> Impact: **21.9** | LOC: 43
...
- **Heaviest Functions:** `__new__` (Impact: 29.9), `subgroup` (Impact: 20.7), `get_condition_filter` (Impact: 13.5)
...
- **Heaviest Functions:** `__exit__` (Impact: 14.9), `__init__` (Impact: 1.8), `__enter__` (Impact: 1.5)
...
- **Heaviest Functions:** `__init__` (Impact: 143.1), `format` (Impact: 87.1), `_levenshtein_distance` (Impact: 47.0)
...
- **Heaviest Functions:** `handle_exception` (Impact: 29.9), `catch` (Impact: 21.9), `__exit__` (Impact: 14.7)
...
- **Heaviest Functions:** `run_script` (Impact: 5.4), `test_apport_excepthook_monkeypatch_interaction` (Impact: 1.9)
...
- **Heaviest Functions:** `test_print_exception` (Impact: 20.4), `test_format_exception` (Impact: 19.1), `test_format_nested` (Impact: 14.4)
...
- **Heaviest Functions:** `split_exception_group` (Impact: 63.1), `test_split_by_type` (Impact: 30.5), `test_split_ExceptionGroup_subclass_derive_and_new_overrides` (Impact: 27.1)
...
- **Heaviest Functions:** `value_key_err_handler` (Impact: 3.0), `runtime_err_handler` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  ...
  * `_compute_suggestion_error` (Impact: 28.3)
  * `format_exception_only` (Impact: 20.8)
...
**Top Internal Functions/Classes:**
  * `split_exception_group` (Impact: 63.1)
    * *Intent:* """Split an EG and do some sanity checks on the result"""
  * `test_split_by_type` (Impact: 30.5)
  * `test_split_ExceptionGroup_subclass_derive_and_new_overrides` (Impact: 27.1)
  * `test_split_ExceptionGroup_subclass_no_derive_no_new_override` (Impact: 14.9)
  * `test_split_BaseExceptionGroup_subclass_no_derive_new_override` (Impact: 14.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_print_exception` (Impact: 20.4)
  * `test_format_exception` (Impact: 19.1)
  * `test_format_nested` (Impact: 14.4)
  * `test_print_exc` (Impact: 14.3)
  * `test_format_exception_only` (Impact: 13.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__new__` (Impact: 29.9)
  * `subgroup` (Impact: 20.7)
  * `get_condition_filter` (Impact: 13.5)
  * `add_note` (Impact: 5.7)
  * `check_direct_subclass` (Impact: 5.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `handle_exception` (Impact: 29.9)
  * `catch` (Impact: 21.9)
  * `__exit__` (Impact: 14.7)
  * `__init__` (Impact: 1.8)
...
**Top Internal Functions/Classes:**
  * `test_async_handler` (Impact: 3.4)
  * `test_catch_ungrouped` (Impact: 3.3)
  * `test_bare_raise_in_handler` (Impact: 3.1)
    * *Intent:* """Test that a bare "raise" "middle" ecxeption group gets discarded."""
  * `test_catch_exceptiongroup` (Impact: 3.0)
  * `test_catch_handler_raises` (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_catch_ungrouped` (Impact: 3.2)
  * `test_catch_handler_raises` (Impact: 2.7)
  * `test_catch_no_match` (Impact: 2.6)
  * `test_catch_group` (Impact: 2.5)
  * `test_catch_single_no_match` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
**Top Internal Functions/Classes:**
  * `run_script` (Impact: 5.4)
  * `test_apport_excepthook_monkeypatch_interaction` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (4.0086%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `value_key_err_handler` (Impact: 3.0)
    * *Intent:* # code snippets from the README
  * `runtime_err_handler` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_suppress_exception` (Impact: 1.3)
**Structural Signatures (Net Mitigated Signals):**
