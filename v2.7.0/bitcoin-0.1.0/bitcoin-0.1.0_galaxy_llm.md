...
| Avg Path Length | 2.0585 | Hops between files. Lower = Tighter coupling. |
...
- `EvalScript` (@ `src/script.cpp`) -> Impact: **807.3** | LOC: 763
...
- `ProcessMessage` (@ `src/main.cpp`) -> Impact: **161.8** | LOC: 357
- `GetOpName` (@ `src/script.h`) -> Impact: **160.8** | LOC: 134
- `CTransaction::ConnectInputs` (@ `src/main.cpp`) -> Impact: **110.0** | LOC: 99
- `CMainFrame::InsertTransaction` (@ `src/ui.cpp`) -> Impact: **109.4** | LOC: 188
- `CTxDetailsDialog::CTxDetailsDialog` (@ `src/ui.cpp`) -> Impact: **86.9** | LOC: 214
  * *Intent:* ////////////////////////////////////////////////////////////////////////////// // // CTxDetailsDialog //
- `HtmlEscape` (@ `src/ui.cpp`) -> Impact: **62.1** | LOC: 29
- `ThreadSocketHandler2` (@ `src/net.cpp`) -> Impact: **57.6** | LOC: 219
- `SelectCoins` (@ `src/main.cpp`) -> Impact: **57.0** | LOC: 100
- `ThreadIRCSeed` (@ `src/irc.cpp`) -> Impact: **52.1** | LOC: 108
...
- **Heaviest Functions:** `WriteCompactSize` (Impact: 13.6), `ReadCompactSize` (Impact: 11.3), `Unserialize_impl` (Impact: 10.9)
...
- **Heaviest Functions:** `CMainFrame::InsertTransaction` (Impact: 109.4), `CTxDetailsDialog::CTxDetailsDialog` (Impact: 86.9), `HtmlEscape` (Impact: 62.1)
...
- **Heaviest Functions:** `ParseMoney` (Impact: 43.6), `FormatMoney` (Impact: 16.2), `strprintf` (Impact: 15.4)
...
- **Heaviest Functions:** `CWalletDB::LoadWallet` (Impact: 31.1), `CRITICAL_BLOCK` (Impact: 30.4), `CDB::CDB` (Impact: 29.7)
...
- **Heaviest Functions:** `IsNewerThan` (Impact: 12.7), `ReadFromDisk` (Impact: 11.4), `ReadFromDisk` (Impact: 11.1)
...
- **Heaviest Functions:** `OutputDebugStringF` (Impact: 18.7), `HexStr` (Impact: 8.5), `HexNumStr` (Impact: 6.5)
...
- **Heaviest Functions:** `AddAtomsAndPropagate` (Impact: 18.4), `CUser::AddAtom` (Impact: 15.5), `CReview::AcceptReview` (Impact: 7.8)
...
- **Heaviest Functions:** `setint64` (Impact: 15.8), `SetHex` (Impact: 12.8), `setuint64` (Impact: 9.8)
...
- **Heaviest Functions:** `EvalScript` (Impact: 807.3), `Solver` (Impact: 34.2), `SignatureHash` (Impact: 32.1)
...
- **Heaviest Functions:** `SetHex` (Impact: 17.2), `Testuint256AdHoc` (Impact: 13.0), `operator<<=` (Impact: 9.3)
...
**Top Internal Functions/Classes:**
  * `ProcessMessage` (Impact: 161.8)
  * `CTransaction::ConnectInputs` (Impact: 110.0)
  * `SelectCoins` (Impact: 57.0)
  * `CTransaction::AcceptTransaction` (Impact: 43.6)
  * `BitcoinMiner` (Impact: 39.0)
...
**Top Internal Functions/Classes:**
  * `CMainFrame::InsertTransaction` (Impact: 109.4)
  * `CTxDetailsDialog::CTxDetailsDialog` (Impact: 86.9)
    * *Intent:* ////////////////////////////////////////////////////////////////////////////// // // CTxDetailsDialo...
  * `HtmlEscape` (Impact: 62.1)
  * `CMyApp::OnInit2` (Impact: 44.8)
  * `CViewProductDialog::UpdateProductDisplay` (Impact: 31.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ThreadSocketHandler2` (Impact: 57.6)
  * `ThreadOpenConnections2` (Impact: 38.6)
  * `foreach` (Impact: 36.5)
  * `StartNode` (Impact: 32.7)
...
**Top Internal Functions/Classes:**
  ...
  * `ReadCompactSize` (Impact: 11.3)
  * `Unserialize_impl` (Impact: 10.9)
  * `GetSizeOfCompactSize` (Impact: 10.2)
...
**Top Internal Functions/Classes:**
  * `IsNewerThan` (Impact: 12.7)
  * `ReadFromDisk` (Impact: 11.4)
  * `ReadFromDisk` (Impact: 11.1)
  * `CheckTransaction` (Impact: 10.2)
  * `operator==` (Impact: 9.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CSendDialogBase::CSendDialogBase` (Impact: 12.4)
  * `CAboutDialogBase::CAboutDialogBase` (Impact: 11.3)
  * `CEditProductDialogBase::CEditProductDialogBase` (Impact: 9.3)
  * `CYourAddressDialogBase::CYourAddressDialogBase` (Impact: 8.5)
  * `CMainFrameBase::CMainFrameBase` (Impact: 6.1)
...
**Top Internal Functions/Classes:**
  * `setint64` (Impact: 15.8)
  * `SetHex` (Impact: 12.8)
  * `setuint64` (Impact: 9.8)
  * `setuint256` (Impact: 9.8)
  * `SetCompact` (Impact: 6.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `GetOpName` (Impact: 160.8)
  * `GetOp` (Impact: 30.6)
  * `operator<<` (Impact: 8.1)
  * `FindAndDelete` (Impact: 7.9)
  * `push_int64` (Impact: 7.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CWalletDB::LoadWallet` (Impact: 31.1)
    * *Intent:* // // CWalletDB //
  * `CRITICAL_BLOCK` (Impact: 30.4)
  * `CDB::CDB` (Impact: 29.7)
  * `CTxDB::ReadOwnerTxes` (Impact: 26.2)
...
**Top Internal Functions/Classes:**
  ...
  * `OnIdle` (Impact: 1.5)
  * `OnMouseEvents` (Impact: 1.5)
  * `OnPaint` (Impact: 1.5)
  * `OnMenuFileExit` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `AddAtomsAndPropagate` (Impact: 18.4)
  * `CUser::AddAtom` (Impact: 15.5)
  * `CReview::AcceptReview` (Impact: 7.8)
  * `AdvertInsert` (Impact: 5.6)
  * `CProduct::CheckProduct` (Impact: 5.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `CGetTextFromUserDialog` (Impact: 6.2)
    * *Intent:* /** Constructor */
  * `OnKeyDown` (Impact: 6.0)
  * `OnKeyDown` (Impact: 1.5)
  * `OnKeyDown` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  * `ByteReverse` (Impact: 4.7)
  * `ByteReverse` (Impact: 4.4)
    * *Intent:* #ifdef WORD64_AVAILABLE
  * `ByteReverse` (Impact: 3.0)
...
**Top Internal Functions/Classes:**
  * `IMPLEMENT_SERIALIZE` (Impact: 4.1)
  * `SetNull` (Impact: 1.4)
  * `CReview` (Impact: 1.4)
  * `CProduct` (Impact: 1.3)
...
**Top Internal Functions/Classes:**
  * `obj/ui_res.o` (Impact: 1.4)
  * `all` (Impact: 1.1)
  * `headers.h.gch` (Impact: 1.1)
  * `obj/util.o` (Impact: 1.1)
  * `obj/script.o` (Impact: 1.1)
**Structural Signatures (Net Mitigated Signals):**
