...
| Avg Path Length | 3.0985 | Hops between files. Lower = Tighter coupling. |
...
- `__init__` (@ `proto_plus-1.27.2/proto/message.py`) -> Impact: **35.0** | LOC: 73
...
- `to_proto` (@ `proto_plus-1.27.2/proto/marshal/marshal.py`) -> Impact: **26.9** | LOC: 46
...
- `descriptor` (@ `proto_plus-1.27.2/proto/fields.py`) -> Impact: **22.0** | LOC: 45
  * *Intent:* """Return the descriptor for the field."""
- `_message_to_map` (@ `proto_plus-1.27.2/proto/message.py`) -> Impact: **21.9** | LOC: 42
- `pytest_runtest_setup` (@ `proto_plus-1.27.2/tests/conftest.py`) -> Impact: **21.8** | LOC: 69
- `generate_file_pb` (@ `proto_plus-1.27.2/proto/_file_info.py`) -> Impact: **19.2** | LOC: 64
...
- `to_python` (@ `proto_plus-1.27.2/proto/marshal/rules/struct.py`) -> Impact: **17.7** | LOC: 34
...
- **Heaviest Functions:** `to_python` (Impact: 6.3), `to_proto` (Impact: 3.7)
...
- **Heaviest Functions:** `__setitem__` (Impact: 32.6), `__eq__` (Impact: 9.1), `_pb_type` (Impact: 8.4)
...
- **Heaviest Functions:** `to_proto` (Impact: 3.7), `to_python` (Impact: 2.1)
...
- **Heaviest Functions:** `generate_file_pb` (Impact: 19.2), `ready` (Impact: 17.6), `_calculate_salt` (Impact: 12.6)
...
- **Heaviest Functions:** `__new__` (Impact: 90.2), `__init__` (Impact: 35.0), `_message_to_map` (Impact: 21.9)
...
- **Heaviest Functions:** `replace` (Impact: 17.6), `from_rfc3339` (Impact: 12.3), `__new__` (Impact: 10.4)
...
- **Heaviest Functions:** `to_python` (Impact: 17.7), `to_proto` (Impact: 14.9), `to_proto` (Impact: 9.5)
...
- **Heaviest Functions:** `to_proto` (Impact: 3.8), `to_python` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  ...
  * `__init__` (Impact: 35.0)
  * `_message_to_map` (Impact: 21.9)
  * `_raise_if_print_fields_values_are_set_and_differ` (Impact: 13.3)
  * `copy_from` (Impact: 11.4)
...
**Top Internal Functions/Classes:**
  * `test_serialize_to_dict_float_precision` (Impact: 12.4)
  * `test_serialize_to_dict` (Impact: 10.7)
  * `test_dir` (Impact: 4.3)
  * `test_copy_from` (Impact: 2.1)
  * `test_unknown_field_deserialize_keep_fields` (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `test_nested_enum_from_string` (Impact: 2.2)
  * `test_unwrapped_enum_fields` (Impact: 2.2)
    * *Intent:* # The dayofweek_pb2 module apparently does some things that are deprecated # in the protobuf API. # ...
  * `test_outer_enum_unset` (Impact: 1.9)
  * `test_outer_enum_write_int` (Impact: 1.9)
  * `test_outer_enum_write_str` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_repeated_composite_marshaled` (Impact: 4.2)
  * `test_repeated_composite_init` (Impact: 1.6)
  * `test_repeated_composite_outer_write` (Impact: 1.6)
  * `test_repeated_composite_append` (Impact: 1.6)
  * `test_repeated_composite_insert` (Impact: 1.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_struct_nested` (Impact: 2.0)
  * `test_value_primitives_rmw` (Impact: 1.8)
  * `test_list_value_pb` (Impact: 1.7)
  * `test_struct_pb` (Impact: 1.6)
  * `test_value_primitives_read` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_json_float_precision` (Impact: 12.5)
  * `test_json_default_values` (Impact: 9.4)
  * `test_json_stringy_enums` (Impact: 2.0)
  * `test_json_default_enums` (Impact: 2.0)
  * `test_json_unknown_field` (Impact: 1.8)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_timestamp_read` (Impact: 1.9)
  * `test_timestamp_write` (Impact: 1.9)
  * `test_timestamp_rmw_nanos` (Impact: 1.9)
  * `test_duration_write_string_nested` (Impact: 1.9)
  * `test_timestamp_write_init` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_replace` (Impact: 2.2)
  * `test_from_rfc3339_test_nanoseconds` (Impact: 2.0)
  * `_to_seconds` (Impact: 2.0)
    * *Intent:* """Convert a datetime to seconds since the unix epoch. Args: value (datetime.datetime): The datetime...
  * `test_from_timestamp_pb_wo_nanos` (Impact: 1.7)
  * `test_from_timestamp_pb_w_nanos` (Impact: 1.7)
...
**Top Internal Functions/Classes:**
  * `descriptor` (Impact: 22.0)
    * *Intent:* """Return the descriptor for the field."""
  * `__init__` (Impact: 14.1)
  * `pb_type` (Impact: 6.4)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_int64_dict_round_trip` (Impact: 3.1)
    * *Intent:* # When converting a message to other types, protobuf turns int64 fields # into decimal coded strings...
  * `test_int_rmw` (Impact: 1.8)
  * `test_int_init` (Impact: 1.6)
  * `test_int_size` (Impact: 1.6)
  * `test_int_unsigned` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_repeated_scalar_append` (Impact: 1.4)
  * `test_repeated_scalar_iadd` (Impact: 1.4)
  * `test_repeated_scalar_setitem` (Impact: 1.4)
  * `test_repeated_scalar_overwrite` (Impact: 1.4)
  * `test_repeated_scalar_eq_ne` (Impact: 1.4)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `pytest_runtest_setup` (Impact: 21.8)
  * `_register_messages` (Impact: 4.5)
    * *Intent:* """Create and register messages from the file descriptor."""
  * `pytest_runtest_teardown` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_enum_append` (Impact: 1.9)
  * `test_enum_map_insert` (Impact: 1.9)
  * `test_to_proto` (Impact: 1.6)
  * `test_to_python` (Impact: 1.5)
  * `test_to_python_unknown_value` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_composite_forward_ref_with_package` (Impact: 2.2)
  * `test_composite_multi_ref` (Impact: 1.9)
  * `test_composite_forward_ref` (Impact: 1.6)
  * `test_composite_backward_ref` (Impact: 1.6)
  * `test_composite_self_ref` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_composite_init` (Impact: 1.6)
  * `test_composite_inner_rmw` (Impact: 1.6)
  * `test_composite_del` (Impact: 1.6)
  * `test_composite_empty_inner_rmw` (Impact: 1.5)
  * `test_composite_outer_rmw` (Impact: 1.5)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `test_module_manifest` (Impact: 2.8)
  * `test_module_package_cross_api` (Impact: 2.5)
  * `test_module_package_explicit_marshal` (Impact: 1.8)
  * `__init__` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_bool_value_rmw` (Impact: 1.7)
  * `test_bool_value_init` (Impact: 1.6)
  * `test_bool_value_init_dict` (Impact: 1.6)
  * `test_bool_value_distinction_from_bool` (Impact: 1.6)
  * `test_bool_value_write_bool_value` (Impact: 1.6)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_composite_map_dict` (Impact: 2.0)
  * `test_composite_map_set` (Impact: 2.0)
  * `test_composite_map` (Impact: 1.9)
  * `test_composite_map_deep_set` (Impact: 1.9)
  * `test_composite_map_del` (Impact: 1.9)
**Structural Signatures (Net Mitigated Signals):**
