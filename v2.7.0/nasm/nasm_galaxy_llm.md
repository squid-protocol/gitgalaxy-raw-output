...
| Avg Path Length | 2.6259 | Hops between files. Lower = Tighter coupling. |
...
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 94.0 | 10.2 | 4.9 | 4.9 |
...
- `byte_code_compile` (@ `x86/insns.pl`) -> Impact: **895.3** | LOC: 599
...
- `do_directive` (@ `asm/preproc.c`) -> Impact: **621.0** | LOC: 1101
...
- `matches` (@ `disasm/disasm.c`) -> Impact: **534.5** | LOC: 811
...
- `process_ea` (@ `asm/assemble.c`) -> Impact: **523.3** | LOC: 466
- `parse_line` (@ `asm/parser.c`) -> Impact: **482.0** | LOC: 720
- `inflate` (@ `zlib/inflate.c`) -> Impact: **414.8** | LOC: 675
  * *Intent:* */
- `disasm` (@ `disasm/disasm.c`) -> Impact: **362.1** | LOC: 401
- `process_arg` (@ `asm/nasm.c`) -> Impact: **333.7** | LOC: 394
- `calcsize` (@ `asm/assemble.c`) -> Impact: **326.0** | LOC: 722
...
- `tokenize` (@ `asm/preproc.c`) -> Impact: **296.2** | LOC: 408
...
### 1. `nasmlib/saa.c` (C) -> Cumulative Risk: **686.2**
...
- **Heaviest Functions:** `saa_wbytes` (Impact: 19.4), `saa_fwrite` (Impact: 14.9), `saa_rbytes` (Impact: 10.1)

### 2. `asm/exprlib.c` (C) -> Cumulative Risk: **678.58**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `expr_class` (Impact: 40.5), `is_simple` (Impact: 14.9), `is_really_simple` (Impact: 13.5)
...
### 4. `asm/nasm.c` (C) -> Cumulative Risk: **671.24**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2082.04 | **LOC:** 2170 | **CtrlFlow:** 31.9% | **Authorship Centralization:** 57.9%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (96.4887%)
- **Heaviest Functions:** `process_arg` (Impact: 333.7), `help` (Impact: 179.0), `main` (Impact: 99.3)

### 5. `asm/preproc.c` (C) -> Cumulative Risk: **671.11**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 8440.58 | **LOC:** 9262 | **CtrlFlow:** 25.5% | **Authorship Centralization:** 46.4%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (98.7507%), Cognitive Load (94.8689%)
- **Heaviest Functions:** `do_directive` (Impact: 621.0), `tokenize` (Impact: 296.2), `if_condition` (Impact: 187.6)

### 6. `nasmlib/file.c` (C) -> Cumulative Risk: **665.77**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `nasm_open_read` (Impact: 22.8), `nasm_open_write` (Impact: 19.2), `nasm_file_size` (Impact: 13.1)

### 7. `x86/insns.pl` (PERL) -> Cumulative Risk: **661.71**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2658.18 | **LOC:** 1672 | **CtrlFlow:** 50.9% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.6383%)
- **Heaviest Functions:** `byte_code_compile` (Impact: 895.3), `format_insn` (Impact: 183.7), `relaxed_forms` (Impact: 52.5)

### 8. `x86/preinsns.pl` (PERL) -> Cumulative Risk: **659.72**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 900.52 | **LOC:** 669 | **CtrlFlow:** 58.7% | **Authorship Centralization:** 45.5%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.2637%)
- **Heaviest Functions:** `func_multisize` (Impact: 289.8), `process_insn` (Impact: 29.4), `substitute` (Impact: 27.7)

### 9. `asm/assemble.c` (C) -> Cumulative Risk: **658.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 4346.72 | **LOC:** 4164 | **CtrlFlow:** 36.5% | **Authorship Centralization:** 47.8%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (97.6268%)
- **Heaviest Functions:** `process_ea` (Impact: 523.3), `calcsize` (Impact: 326.0), `matches` (Impact: 250.7)

### 10. `asm/labels.c` (C) -> Cumulative Risk: **653.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `define_label` (Impact: 72.8), `declare_label_lptr` (Impact: 50.6), `out_symdef` (Impact: 30.3)
...
**Top Internal Functions/Classes:**
  * `process_ea` (Impact: 523.3)
  * `calcsize` (Impact: 326.0)
    * *Intent:* /* Common construct */ #define case3(x) case (x): case (x)+1: case (x)+2 #define case4(x) case3(x): ...
  * `matches` (Impact: 250.7)
  * `gencode` (Impact: 211.2)
  * `prefix_byte` (Impact: 84.1)
...
**Top Internal Functions/Classes:**
  * `elf_deflabel` (Impact: 211.0)
  * `elf_section_attrib` (Impact: 187.4)
    * *Intent:* /* parse section attributes */
  * `elf64_out` (Impact: 156.8)
  * `elfx32_out` (Impact: 129.4)
  * `elf32_out` (Impact: 100.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `obj_deflabel` (Impact: 181.9)
  * `obj_directive` (Impact: 169.6)
  * `obj_segment` (Impact: 153.3)
  * `obj_write_fixup` (Impact: 150.4)
  * `obj_write_file` (Impact: 104.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `append_evex_reg_deco` (Impact: 21.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `process_arg` (Impact: 333.7)
  * `help` (Impact: 179.0)
  * `main` (Impact: 99.3)
  * `assemble_file` (Impact: 79.4)
  * `nasm_set_limit` (Impact: 50.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `macho_output` (Impact: 99.7)
  * `add_reloc` (Impact: 93.0)
  * `macho_symdef` (Impact: 87.3)
  * `macho_section` (Impact: 75.3)
  * `macho_dbg_output` (Impact: 39.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `inflate` (Impact: 414.8)
    * *Intent:* */
  * `inflateInit2_` (Impact: 26.5)
  * `updatewindow` (Impact: 24.2)
    * *Intent:* */
  * `inflateReset2` (Impact: 20.9)
  * `inflateCopy` (Impact: 17.7)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1839.22 | **LOC:** 1475 | **CtrlFlow:** 39.3% | **Authorship Centralization:** 70.0%
- **Risk Profile:** Cognitive Load (88.3232%), Tech Debt (16.4872%)
**Top Internal Functions/Classes:**
  * `parse_line` (Impact: 482.0)
  * `parse_eops` (Impact: 143.7)
    * *Intent:* /* * Parse an extended expression, used by db et al. "elem" is the element * size; initially comes f...
  * `parse_mref` (Impact: 55.3)
  * `process_size_override` (Impact: 52.7)
  * `mref_set_optype` (Impact: 34.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `write_html` (Impact: 92.3)
  * `got_para` (Impact: 49.8)
  * `write_txt` (Impact: 45.8)
  * `word_html` (Impact: 40.7)
  * `word_txt` (Impact: 31.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 2 instances
...
**Top Internal Functions/Classes:**
  * `bin_cleanup` (Impact: 153.2)
  * `bin_assign_attributes` (Impact: 117.5)
  * `bin_read_attribute` (Impact: 92.2)
  * `bin_directive` (Impact: 66.7)
  * `bin_out` (Impact: 49.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `coff_section_names` (Impact: 156.1)
  * `coff_out` (Impact: 87.2)
  * `coff_deflabel` (Impact: 62.6)
  * `coff_directives` (Impact: 52.1)
  * `coff_write` (Impact: 28.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `float_const` (Impact: 165.4)
  * `ieee_flconvert` (Impact: 99.7)
    * *Intent:* /* * --------------------------------------------------------------------------- * convert * -------...
  * `ieee_flconvert_bin` (Impact: 57.8)
    * *Intent:* /* Handle floating-point numbers with radix 2^bits and binary exponent */
  * `to_packed_bcd` (Impact: 41.5)
  * `ieee_round` (Impact: 32.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `expr6` (Impact: 81.6)
  * `evaluate` (Impact: 45.4)
  * `expr5` (Impact: 44.5)
  * `rexp3` (Impact: 44.1)
  * `add_vectors` (Impact: 35.1)
...
**Top Internal Functions/Classes:**
  * `crc32_z` (Impact: 161.8)
    * *Intent:* #endif /* ========================================================================= */
  * `make_crc_table` (Impact: 31.0)
    * *Intent:* */
  * `write_table` (Impact: 12.4)
    * *Intent:* */
  * `write_table32hi` (Impact: 12.4)
    * *Intent:* */
  * `write_table64` (Impact: 12.4)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `inflateBack` (Impact: 217.3)
    * *Intent:* */
  * `inflateBackInit_` (Impact: 33.8)
    * *Intent:* */
  * `fixedtables` (Impact: 13.3)
    * *Intent:* */
  * `inflateBackEnd` (Impact: 6.1)
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 624.2 | **LOC:** 652 | **CtrlFlow:** 32.3% | **Authorship Centralization:** 50.0%
- **Risk Profile:** Cognitive Load (84.1214%), Tech Debt (13.6367%)
**Top Internal Functions/Classes:**
  * `process_directives` (Impact: 192.9)
    * *Intent:* /* * Process a line from the assembler and try to handle it if it * is a directive. Return true if t...
  * `set_cpu` (Impact: 40.7)
  * `parse_directive_line` (Impact: 27.6)
  * `get_bits` (Impact: 12.7)
  * `directive_valid` (Impact: 10.6)
...
**Top Internal Functions/Classes:**
  * `test_run` (Impact: 54.0)
  * `test_update` (Impact: 28.5)
    * *Intent:* # # Compile sources and generate new targets
  * `prepare_desc` (Impact: 26.1)
  * `hexdump` (Impact: 16.8)
  * `exec_nasm` (Impact: 15.0)
**Contextual Mitigations & Amplifications:**
...
- `asm/preproc.c` -> Churn: **93.97%** | Cog Load: 94.8689% | Debt: 13.548%
- `asm/nasm.c` -> Churn: **83.6%** | Cog Load: 95.0777% | Debt: 9.6331%
- `x86/insns.pl` -> Churn: **71.58%** | Cog Load: 97.9819% | Debt: 0.0%
- `asm/assemble.c` -> Churn: **66.95%** | Cog Load: 97.5752% | Debt: 11.2164%
- `nasmlib/file.c` -> Churn: **58.03%** | Cog Load: 60.9412% | Debt: 77.4981%
