...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 16.6 | 0.0 | 0.0 |
...
| connectivity | 371 | 88 | 4 | `apps/qe.c` |
...
| dead_code | 257 | 90 | 3 | `src/arch/snes/main.asm` |
...
- `ansi_parse` (@ `apps/ansiterm.c`) -> Impact: **196.7** | LOC: 313
- `bdos_entry` (@ `tools/cpmemu/biosbdos.c`) -> Impact: **99.7** | LOC: 89
- `consumeToken` (@ `apps/asm.c`) -> Impact: **84.0** | LOC: 201
- `vt52_parse` (@ `apps/ansiterm.c`) -> Impact: **79.1** | LOC: 168
- `main` (@ `apps/ansiterm.c`) -> Impact: **58.6** | LOC: 153
- `consumeExpressionNode` (@ `apps/asm.c`) -> Impact: **49.0** | LOC: 132
- `colon` (@ `apps/qe.c`) -> Impact: **49.0** | LOC: 104
- `main` (@ `tools/img2osi.c`) -> Impact: **47.6** | LOC: 120
- `placeCode` (@ `apps/asm.c`) -> Impact: **46.7** | LOC: 114
- `parseArgs` (@ `tools/mkoricdsk.cc`) -> Impact: **42.4** | LOC: 52

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `apps` | 33 | 5451.2 | 33.59% | 16.41% |
| `src/arch/snes` | 8 | 566.74 | 9.78% | 15.64% |
| `src/arch/neo6502/utils` | 7 | 358.9 | 47.64% | 36.23% |
| `src/arch/nano6502` | 4 | 316.32 | 33.44% | 3.49% |
| `src/bdos` | 11 | 247.36 | 2.19% | 13.95% |
...
- **Heaviest Functions:** `main` (Impact: 38.7), `getrelo` (Impact: 6.4), `print` (Impact: 4.7)
...
- **Heaviest Functions:** `get_rom` (Impact: 7.6), `__global_context__` (Impact: 2.0)
...
- **Heaviest Functions:** `main` (Impact: 39.6), `setattrs` (Impact: 8.1), `getattrs` (Impact: 6.9)

### 4. `apps/sys.c` (C) -> Cumulative Risk: **577.9**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `copy_file` (Impact: 20.1), `copy_reserved_sectors` (Impact: 13.1), `main` (Impact: 12.4)
...
- **Heaviest Functions:** `main` (Impact: 34.1), `life` (Impact: 14.6), `fatal` (Impact: 1.8)
...
- **Heaviest Functions:** `process_byte` (Impact: 28.8), `main` (Impact: 23.6), `printi` (Impact: 7.9)
...
- **Heaviest Functions:** `ansi_parse` (Impact: 196.7), `vt52_parse` (Impact: 79.1), `main` (Impact: 58.6)
...
- **Heaviest Functions:** `colon` (Impact: 49.0), `main` (Impact: 28.7), `insert_mode` (Impact: 24.8)
...
- **Heaviest Functions:** `printattrs` (Impact: 8.9), `print_d32` (Impact: 6.7), `getword` (Impact: 6.1)
...
- **Heaviest Functions:** `consumeToken` (Impact: 84.0), `consumeExpressionNode` (Impact: 49.0), `placeCode` (Impact: 46.7)
...
**Top Internal Functions/Classes:**
  * `consumeToken` (Impact: 84.0)
  * `consumeExpressionNode` (Impact: 49.0)
  * `placeCode` (Impact: 46.7)
  * `parse` (Impact: 36.5)
...
**Top Internal Functions/Classes:**
  ...
  * `insert_mode` (Impact: 24.8)
  * `draw_line` (Impact: 22.9)
  * `compute_length` (Impact: 21.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ansi_parse` (Impact: 196.7)
  * `vt52_parse` (Impact: 79.1)
  * `main` (Impact: 58.6)
  * `xmodem_receive` (Impact: 18.6)
  * `xmodem_send` (Impact: 15.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `get_current_key` (Impact: 9.3)
  * `tty_conout` (Impact: 6.0)
  * `load_font_data` (Impact: 4.5)
  * `fd_wait_until_drive_ready` (Impact: 3.8)
  * `loop` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 195.22 | **LOC:** 315 | **CtrlFlow:** 15.9% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (87.206%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `copy_file` (Impact: 20.1)
  * `copy_reserved_sectors` (Impact: 13.1)
  * `main` (Impact: 12.4)
  * `print_filename` (Impact: 6.5)
  * `copy_system_files` (Impact: 3.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 38 instances
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 20.4)
  * `copy_file` (Impact: 12.7)
  * `parse_cmdline` (Impact: 11.4)
  * `print_fcb` (Impact: 11.3)
  * `getword` (Impact: 7.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `screen_jmptable_hi` (Impact: 16.1)
  * `key_down` (Impact: 6.5)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 108.58 | **LOC:** 1868 | **CtrlFlow:** 1.0% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (5.6549%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `find_first` (Impact: 8.6)
  * `merge_error` (Impact: 7.0)
  * `error$` (Impact: 6.0)
  * `no_more_files` (Impact: 5.0)
  * `eof` (Impact: 4.5)
**Structural Signatures (Net Mitigated Signals):**
* *Structure:* `branch: 13`, `structural_boundaries: 31`, `func_start: 26`
* *Risk/State:* `state_mutation: 15`, `dead_code: 8`
* *Architecture:* `api: 3`
* *Defense:* None
* *Network Topology:*
...
**Top Internal Functions/Classes:**
  ...
  * `screen_getchar_data` (Impact: 4.8)
  * `screen_getchar_wait` (Impact: 4.7)
  * `jmptable_hi` (Impact: 4.0)
...
**Top Internal Functions/Classes:**
  * `jmptable_hi` (Impact: 7.5)
  * `screen_jmptable_hi` (Impact: 7.0)
  * `sector2_start` (Impact: 6.3)
  * `jasmin_start` (Impact: 4.4)
    * *Intent:* ; Jasmin boot code starts here.
  * `banner_end` (Impact: 3.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `no_fill_wildcards` (Impact: 5.5)
  * `no_archived` (Impact: 5.0)
  * `mul128` (Impact: 4.7)
  * `test_nfiles` (Impact: 3.5)
  * `jloop` (Impact: 3.0)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 5 instances
