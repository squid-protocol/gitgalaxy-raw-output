...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 18.9 | 6.0 | 0.0 |
...
| connectivity | 73290 | 11082 | 10 | `packages/grafana-api-clients/src/clients/rtkq/legacy/endpoints.gen.ts` |
...
| dead_code | 15117 | 4704 | 2 | `pkg/plugins/manager/pluginfakes/fakes.go` |
| credential | 283 | 84 | 0 | `pkg/login/social/connectors/generic_oauth_test.go` |
| threat | 2784 | 499 | 0 | `public/emails/ng_alert_notification.html` |
...
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/legacy/endpoints.gen.ts`) -> Impact: **2244.4** | LOC: 4300
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/iam/v0alpha1/endpoints.gen.ts`) -> Impact: **593.7** | LOC: 1465
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/notifications.alerting/v0alpha1/endpoints.gen.ts`) -> Impact: **523.4** | LOC: 1303
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/notifications.alerting/v1beta1/endpoints.gen.ts`) -> Impact: **523.4** | LOC: 1303
- `query` (@ `public/app/api/clients/scope/v0alpha1/endpoints.gen.ts`) -> Impact: **522.5** | LOC: 1173
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/provisioning/v0alpha1/endpoints.gen.ts`) -> Impact: **519.5** | LOC: 1671
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/dashboard/v2beta1/endpoints.gen.ts`) -> Impact: **475.5** | LOC: 1223
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/dashboard/v0alpha1/endpoints.gen.ts`) -> Impact: **419.3** | LOC: 1004
- `updateSchema` (@ `public/app/features/dashboard/state/DashboardMigrator.ts`) -> Impact: **417.4** | LOC: 657
- `query` (@ `packages/grafana-api-clients/src/clients/rtkq/logsdrilldown/v1alpha1/endpoints.gen.ts`) -> Impact: **389.2** | LOC: 1025

## 9. DIRECTORY GROUPS (Top 10 Heaviest Modules)
| Folder Path | Files | Total Impact | Avg Complexity Load | Avg Debt Markers |
|---|---|---|---|---|
| `pkg/storage/unified/resource` | 71 | 12559.66 | 15.77% | 37.16% |
...
| `pkg/api` | 87 | 9167.4 | 12.08% | 30.28% |
| `public/app/plugins/datasource/loki` | 61 | 9008.7 | 22.54% | 1.35% |
| `pkg/util/xorm` | 43 | 8995.72 | 43.16% | 44.08% |
| `apps/dashboard/pkg/migration/conversion` | 35 | 8573.14 | 12.79% | 26.05% |
...
- **Heaviest Functions:** `load` (Impact: 28.7), `renderElement` (Impact: 25.0), `constructor` (Impact: 13.1)
...
- **Heaviest Functions:** `makeStorageService` (Impact: 18.1), `store` (Impact: 9.6), `getBoolean` (Impact: 8.5)
...
- **Heaviest Functions:** `hasRole` (Impact: 4.6), `isAllowedInterval` (Impact: 4.5), `scheduleTokenRotationJob` (Impact: 4.2)
...
- **Heaviest Functions:** `handlePressedKeys` (Impact: 23.8), `onKeyDown` (Impact: 11.3), `onDestroy` (Impact: 7.6)

### 5. `public/app/features/canvas/runtime/frame.tsx` (TYPESCRIPT) -> Cumulative Risk: **717.42**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `doAction` (Impact: 97.9), `constructor` (Impact: 17.2), `doMove` (Impact: 5.7)

### 6. `public/app/plugins/datasource/loki/components/monaco-query-field/getOverrideServices.ts` (TYPESCRIPT) -> Cumulative Risk: **716.02**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `shouldComponentUpdate` (Impact: 43.2), `componentDidMount` (Impact: 14.7), `next` (Impact: 10.4)
...
- **Heaviest Functions:** `runWatchStream` (Impact: 29.8), `runFetchStream` (Impact: 25.9), `runSignalStream` (Impact: 21.9)
...
- **Heaviest Functions:** `TestBatchRunnerStopUnblocksBlockedSend` (Impact: 12.7), `ProcessBulk` (Impact: 11.1), `TestBulkProcessStopsRunnerOnPanic` (Impact: 9.2)
...
- **Heaviest Functions:** `onUp` (Impact: 57.0), `onscroll` (Impact: 33.0), `updatePlotVisible` (Impact: 32.7)
...
**Top Internal Functions/Classes:**
  * `transformSingleQuery` (Impact: 77.9)
  * `transformPanelQueries` (Impact: 58.5)
    * *Intent:* // Panel helper functions
  * `buildAdhocVariable` (Impact: 58.1)
    * *Intent:* // Adhoc Variable
  * `transformVariables` (Impact: 55.6)
  * `convertToRowsLayout` (Impact: 45.6)
**Contextual Mitigations & Amplifications:**
...
- `public/app/features/dashboard-scene/scene/DashboardScene.tsx` -> **Severity: 0.732** (Bridge: 0.0075 * Flux: 97.9827%)
- `public/app/features/variables/query/operators.ts` -> **Severity: 0.299** (Bridge: 0.003 * Flux: 99.7201%)
- `public/app/features/dashboard-scene/panel-edit/PanelEditor.tsx` -> **Severity: 0.281** (Bridge: 0.0028 * Flux: 99.3847%)
- `public/app/features/dashboard-scene/pages/DashboardScenePageStateManager.ts` -> **Severity: 0.192** (Bridge: 0.0019 * Flux: 100.0%)
- `public/app/features/dashboard-scene/panel-edit/PanelDataPane/PanelDataPaneFactory.ts` -> **Severity: 0.089** (Bridge: 0.0018 * Flux: 50.0%)
