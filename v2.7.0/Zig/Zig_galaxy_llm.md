...
- `IntrusiveHashMap` (@ `dataStructures/lruCache.zig`) -> Impact: **117.8** | LOC: 344
- `HashMap` (@ `dataStructures/lruCache.zig`) -> Impact: **91.2** | LOC: 258
- `SkipList` (@ `tiger_style/skip_list.zig`) -> Impact: **71.0** | LOC: 277
  * *Intent:* /// Skip List - ordered map
- `RobinHoodHashMap` (@ `tiger_style/robin_hood_hash.zig`) -> Impact: **69.3** | LOC: 307
  * *Intent:* /// Robin Hood Hash Table
- `BinarySearchTree` (@ `search/binarySearchTree.zig`) -> Impact: **53.0** | LOC: 184
...
- `DoublyLinkedDeque` (@ `dataStructures/lruCache.zig`) -> Impact: **49.1** | LOC: 103
...
- `DoublyLinkedList` (@ `dataStructures/doublyLinkedList.zig`) -> Impact: **37.1** | LOC: 177
...
- `RingBuffer` (@ `tiger_style/ring_buffer.zig`) -> Impact: **31.9** | LOC: 223
  * *Intent:* /// Ring buffer with fixed capacity /// Generic over element type T and capacity
- `getOrPutContext` (@ `dataStructures/lruCache.zig`) -> Impact: **30.9** | LOC: 59
- `knapsack` (@ `tiger_style/knapsack_tiger.zig`) -> Impact: **30.8** | LOC: 135
...
- **Heaviest Functions:** `notifySlow` (Impact: 24.8), `pop` (Impact: 23.6), `steal` (Impact: 15.0)
...
- **Heaviest Functions:** `DoublyLinkedList` (Impact: 37.1), `remove` (Impact: 11.6), `search` (Impact: 7.7)
...
- **Heaviest Functions:** `IntrusiveHashMap` (Impact: 117.8), `HashMap` (Impact: 91.2), `DoublyLinkedDeque` (Impact: 49.1)
...
- **Heaviest Functions:** `Tree` (Impact: 27.0), `insertNode` (Impact: 21.6), `search` (Impact: 11.0)
...
- **Heaviest Functions:** `minDist` (Impact: 19.1)
...
- **Heaviest Functions:** `lowerBound` (Impact: 9.6), `lis` (Impact: 7.8)
...
- **Heaviest Functions:** `chineseRemainder` (Impact: 7.1), `inverseMod` (Impact: 6.5)
...
- **Heaviest Functions:** `firstNPrimes` (Impact: 8.1), `sum` (Impact: 3.2)
...
- **Heaviest Functions:** `gcd` (Impact: 11.6)
...
- **Heaviest Functions:** `knapsack` (Impact: 16.9)
...
**Top Internal Functions/Classes:**
  * `IntrusiveHashMap` (Impact: 117.8)
  * `HashMap` (Impact: 91.2)
  * `DoublyLinkedDeque` (Impact: 49.1)
    * *Intent:* /// A double-ended doubly-linked list (doubly-linked deque). Keeps track of two pointers: one head p...
  * `getOrPutContext` (Impact: 30.9)
  * `getOrPutContext` (Impact: 23.6)
...
**Top Internal Functions/Classes:**
  * `KMeans` (Impact: 15.5)
  * `calculateNearest` (Impact: 5.8)
  * `distanceSquared` (Impact: 2.0)
  * `eq` (Impact: 1.9)
  * `add` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 8 instances
