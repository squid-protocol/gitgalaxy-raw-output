...
- `asPromise` (@ `package/index.js`) -> Impact: **15.5** | LOC: 32
...
- `executor` (@ `package/index.js`) -> Impact: **13.3** | LOC: 24
- `callback` (@ `package/index.js`) -> Impact: **7.8** | LOC: 14
- `fn` (@ `package/tests/index.js`) -> Impact: **3.0** | LOC: 4
- `fn` (@ `package/tests/index.js`) -> Impact: **2.4** | LOC: 7
- `fn` (@ `package/tests/index.js`) -> Impact: **2.4** | LOC: 7
- `fn` (@ `package/tests/index.js`) -> Impact: **2.3** | LOC: 6
- `fn` (@ `package/tests/index.js`) -> Impact: **2.3** | LOC: 6
- `asPromise` (@ `package/index.d.ts`) -> Impact: **2.0** | LOC: 1
...
- `fn` (@ `package/tests/index.js`) -> Impact: **1.6** | LOC: 4
...
- **Heaviest Functions:** `asPromise` (Impact: 15.5), `executor` (Impact: 13.3), `callback` (Impact: 7.8)
...
- **Heaviest Functions:** `fn` (Impact: 3.0), `fn` (Impact: 2.4), `fn` (Impact: 2.4)
...
- **Heaviest Functions:** `asPromise` (Impact: 2.0)
