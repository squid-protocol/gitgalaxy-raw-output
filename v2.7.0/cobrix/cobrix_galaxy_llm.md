...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 8.9 | 0.0 | 0.0 |
...
| dead_code | 402 | 140 | 1 | `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/antlr/copybookParserBaseVisitor.java` |
| credential | 0 | 0 | 0 | - |
...
- `extractRecord` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/extractors/record/RecordExtractors.scala`) -> Impact: **228.9** | LOC: 165
...
- `extractHierarchicalRecord` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/extractors/record/RecordExtractors.scala`) -> Impact: **221.8** | LOC: 195
...
- `validateSparkCobolOptions` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/parameters/CobolParametersParser.scala`) -> Impact: **201.8** | LOC: 235
...
- `sparseIndexGenerator` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/index/IndexGenerator.scala`) -> Impact: **130.2** | LOC: 110
- `pic` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/antlr/copybookParser.java`) -> Impact: **119.2** | LOC: 184
...
- `getIntegralDecoder` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/decoders/DecoderSelector.scala`) -> Impact: **88.1** | LOC: 62
...
- `getBytesCount` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/decoders/BinaryUtils.scala`) -> Impact: **82.3** | LOC: 29
- `encodeBCDNumber` (@ `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/encoding/BCDNumberEncoders.scala`) -> Impact: **77.5** | LOC: 69
...
- `putEncodedNumStrToArray` (@ `examples/examples-collection/src/main/scala/com/example/spark/cobol/examples/parser/generators/utils/GeneratorTools.scala`) -> Impact: **71.5** | LOC: 59
...
|---|---|---|---|---|
| `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/antlr` | 15 | 3774.28 | 11.59% | 51.23% |
...
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/antlr/copybookParser.java` -> **0** Orphaned Functions | **120** Duplicates
...
### 1. `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/antlr/copybookParser.java` (JAVA) -> Cumulative Risk: **642.7**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 2277.46 | **LOC:** 3481 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.852%), Api Exposure (85.9499%)
- **Heaviest Functions:** `pic` (Impact: 119.2), `group` (Impact: 53.1), `identifier` (Impact: 38.1)

### 2. `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/extractors/record/RecordExtractors.scala` (SCALA) -> Cumulative Risk: **624.92**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `extractRecord` (Impact: 228.9), `extractHierarchicalRecord` (Impact: 221.8), `applyRecordPostProcessing` (Impact: 53.0)

### 3. `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/encoding/BinaryEncoders.scala` (SCALA) -> Cumulative Risk: **609.25**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
### 4. `spark-cobol/src/main/scala/za/co/absa/cobrix/spark/cobol/source/streaming/BufferedFSDataInputStream.scala` (SCALA) -> Cumulative Risk: **588.37**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `readFully` (Impact: 36.3), `readFullyHelper` (Impact: 14.8), `openStream` (Impact: 9.3)

### 5. `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/expression/parser/NumExprBuilderImpl.scala` (SCALA) -> Cumulative Risk: **582.39**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `eval` (Impact: 11.5), `closeParen` (Impact: 7.7), `getResult` (Impact: 6.6)

### 6. `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/expression/parser/Parser.scala` (SCALA) -> Cumulative Risk: **581.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `parse` (Impact: 70.7)

### 7. `spark-cobol/src/main/scala/za/co/absa/cobrix/spark/cobol/utils/SparkUtils.scala` (SCALA) -> Cumulative Risk: **580.6**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `copyMetadata` (Impact: 67.1), `flattenSchema` (Impact: 56.2), `splitFieldPath` (Impact: 24.8)
...
- **Heaviest Functions:** `value` (Impact: 21.9), `obj` (Impact: 9.8), `arr` (Impact: 9.8)
...
- **Heaviest Functions:** `findNextLineBreak` (Impact: 16.9), `findNextNonEmptyRecord` (Impact: 8.9), `findNextRecord` (Impact: 7.3)
...
- **Heaviest Functions:** `encodeDisplayNumberSignSeparate` (Impact: 67.9), `encodeDisplayNumberSignOverpunched` (Impact: 62.1), `setPaddedEbcdicNumberWithSignSeparate` (Impact: 50.7)
...
- **Magnitude:** 2277.46 | **LOC:** 3481 | **CtrlFlow:** 18.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (34.3446%), Tech Debt (99.852%)
**Top Internal Functions/Classes:**
  * `pic` (Impact: 119.2)
  * `group` (Impact: 53.1)
  * `identifier` (Impact: 38.1)
  * `specialValues` (Impact: 38.0)
  * `precision9` (Impact: 36.2)
...
* *Risk/State:* `safety_bypasses: 126`, `state_mutation: 126`, `duplicate_logic: 120`
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000277 | `Ripple Effect (Closeness):` 0.01457
...
**Top Internal Functions/Classes:**
  ...
  * `checkBounds` (Impact: 52.0)
  * `visitPrimitive` (Impact: 45.0)
  * `replaceUsage` (Impact: 43.2)
...
**Top Internal Functions/Classes:**
  * `validateSparkCobolOptions` (Impact: 201.8)
    * *Intent:* /** * Validates if all options passed to 'spark-cobol' are recognized. * * @param params Parameters ...
  * `parseVariableLengthParameters` (Impact: 37.8)
  * `getIsEbcdic` (Impact: 25.4)
  * `parse` (Impact: 23.6)
  * `parseBdw` (Impact: 21.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000354 | `Ripple Effect (Closeness):` 0.020649
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 5.8e-05 | `Ripple Effect (Closeness):` 0.057065
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000896 | `Ripple Effect (Closeness):` 0.066336
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00048 | `Ripple Effect (Closeness):` 0.066943
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000101 | `Ripple Effect (Closeness):` 0.067805
...
**Top Internal Functions/Classes:**
  * `parsePrimitive` (Impact: 54.8)
  * `createSparkSchema` (Impact: 24.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000747 | `Ripple Effect (Closeness):` 0.017469
...
**Top Internal Functions/Classes:**
  * `sparseIndexGenerator` (Impact: 130.2)
  * `getSplitCondition` (Impact: 5.9)
    * *Intent:* /** Returns a predicate that returns true when current index entry has reached the required size */
  * `getSegmentId` (Impact: 5.4)
  * `isSegmentGoodForSplit` (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000181 | `Ripple Effect (Closeness):` 0.007226
...
**Top Internal Functions/Classes:**
  ...
  * `getRootSegmentId` (Impact: 10.5)
  * `getRecordHeaderParser` (Impact: 9.2)
**Structural Signatures (Net Mitigated Signals):**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000622 | `Ripple Effect (Closeness):` 0.005072
...
**Top Internal Functions/Classes:**
  * `searchOutOfLookbackBuffer` (Impact: 18.6)
...
**Top Internal Functions/Classes:**
  * `getEncoder` (Impact: 51.5)
  * `getBdcEncoder` (Impact: 30.4)
  * `getDisplayEncoder` (Impact: 30.4)
  * `getBinaryEncoder` (Impact: 24.8)
  * `getStringEncoder` (Impact: 14.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.00016 | `Ripple Effect (Closeness):` 0.066427
...
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/CopybookParser.scala` -> **Severity: 0.047** (Bridge: 0.0021 * Flux: 22.6604%)
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/ast/Primitive.scala` -> **Severity: 0.04** (Bridge: 0.0022 * Flux: 17.886%)
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/parameters/CobolParametersParser.scala` -> **Severity: 0.033** (Bridge: 0.0004 * Flux: 93.457%)
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/processor/CobolProcessor.scala` -> **Severity: 0.029** (Bridge: 0.001 * Flux: 29.0993%)
- `cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/reader/extractors/record/RecordExtractors.scala` -> **Severity: 0.028** (Bridge: 0.0003 * Flux: 99.9993%)
