...
- `exports` (@ `package/node-red-vue.js`) -> Impact: **70.0** | LOC: 213
- `setNodeTypeConfig` (@ `package/node-red-vue.js`) -> Impact: **23.5** | LOC: 30
...
- `createVueComponent` (@ `package/node-red-vue.js`) -> Impact: **19.4** | LOC: 27
  * *Intent:* // ===== createVueComponent // createVueComponent creates a Vue component from a .vue file and pushes it to the flow-editor
- `locateComponents` (@ `package/node-red-vue.js`) -> Impact: **9.7** | LOC: 24
- `_createVueTemplate` (@ `package/node-red-vue.js`) -> Impact: **9.1** | LOC: 22
- `createVueTemplate` (@ `package/node-red-vue.js`) -> Impact: **6.0** | LOC: 17
- `debouncedWatch` (@ `package/node-red-vue.js`) -> Impact: **4.0** | LOC: 11
...
- `fileChanged` (@ `package/node-red-vue.js`) -> Impact: **2.2** | LOC: 4
  * *Intent:* // TODO: check for duplicate registration
- `fileChanged` (@ `package/node-red-vue.js`) -> Impact: **2.0** | LOC: 6
...
- **Heaviest Functions:** `exports` (Impact: 70.0), `setNodeTypeConfig` (Impact: 23.5), `createVueComponent` (Impact: 19.4)
...
**Top Internal Functions/Classes:**
  * `exports` (Impact: 70.0)
  * `setNodeTypeConfig` (Impact: 23.5)
  * `createVueComponent` (Impact: 19.4)
    * *Intent:* // ===== createVueComponent // createVueComponent creates a Vue component from a .vue file and pushe...
  * `locateComponents` (Impact: 9.7)
  * `_createVueTemplate` (Impact: 9.1)
