...
| Avg Path Length | 3.2221 | Hops between files. Lower = Tighter coupling. |
...
- `Field` (@ `pydantic-2.12.5/pydantic/fields.py`) -> Impact: **177.7** | LOC: 226
- `_apply_constraint` (@ `pydantic-2.12.5/pydantic/experimental/pipeline.py`) -> Impact: **165.9** | LOC: 200
- `__new__` (@ `pydantic-2.12.5/pydantic/v1/main.py`) -> Impact: **163.3** | LOC: 180
- `__new__` (@ `pydantic-2.12.5/pydantic/_internal/_model_construction.py`) -> Impact: **138.8** | LOC: 197
- `dataclass` (@ `pydantic-2.12.5/pydantic/dataclasses.py`) -> Impact: **132.0** | LOC: 215
- `_iter` (@ `pydantic-2.12.5/pydantic/deprecated/copy_internals.py`) -> Impact: **111.3** | LOC: 67
- `inspect_namespace` (@ `pydantic-2.12.5/pydantic/_internal/_model_construction.py`) -> Impact: **109.6** | LOC: 135
- `_type_analysis` (@ `pydantic-2.12.5/pydantic/v1/fields.py`) -> Impact: **103.6** | LOC: 176
...
- `collect_model_fields` (@ `pydantic-2.12.5/pydantic/_internal/_fields.py`) -> Impact: **101.5** | LOC: 197
- `traverse_schema` (@ `pydantic-2.12.5/pydantic/_internal/_schema_gather.py`) -> Impact: **100.3** | LOC: 100
...
- **Heaviest Functions:** `__str__` (Impact: 3.0), `__str__` (Impact: 3.0), `__init__` (Impact: 2.5)
...
- **Heaviest Functions:** `validate` (Impact: 24.4), `__new__` (Impact: 16.1), `validate_length_for_brand` (Impact: 13.1)
...
- **Heaviest Functions:** `build` (Impact: 38.6), `validate_host` (Impact: 26.2), `_build_url` (Impact: 24.7)
...
- **Heaviest Functions:** `update_model_forward_refs` (Impact: 23.9), `resolve_annotations` (Impact: 19.0), `update_field_forward_refs` (Impact: 19.0)
...
- **Heaviest Functions:** `make_generic_v1_field_validator` (Impact: 22.4), `make_v1_generic_root_validator` (Impact: 16.0), `_wrapper2` (Impact: 13.1)
...
- **Heaviest Functions:** `_add_pydantic_validation_attributes` (Impact: 51.2), `dataclass` (Impact: 48.2), `create_pydantic_model_from_dataclass` (Impact: 21.9)
...
- **Heaviest Functions:** `create_model` (Impact: 44.4), `__init__` (Impact: 41.4), `build_values` (Impact: 36.1)
...
- **Heaviest Functions:** `__new__` (Impact: 163.3), `_get_value` (Impact: 98.4), `_iter` (Impact: 95.8)
...
- **Heaviest Functions:** `create_model` (Impact: 54.3), `__init__` (Impact: 41.3), `build_values` (Impact: 36.1)
...
- **Heaviest Functions:** `flatten_errors` (Impact: 18.9), `error_dict` (Impact: 10.8), `_get_exc_type` (Impact: 9.1)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.019595 | `Ripple Effect (Closeness):` 0.148876
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.022687 | `Ripple Effect (Closeness):` 0.125207
...
**Top Internal Functions/Classes:**
  * `test_decimal_validation` (Impact: 19.4)
  * `test_decimal_not_finite` (Impact: 14.6)
  * `test_enum_from_json` (Impact: 13.8)
  * `test_uuid_strict` (Impact: 10.6)
  * `test_constraints_arbitrary_type` (Impact: 9.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_callable_type` (Impact: 12.3)
  * `test_advanced_generic_schema` (Impact: 11.2)
  * `test_discriminated_annotated_union_literal_enum` (Impact: 10.0)
  * `test_deeper_nested_discriminated_annotated_union` (Impact: 9.5)
  * `__get_pydantic_core_schema__` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_model_export_exclusion_with_fields_and_config` (Impact: 25.9)
    * *Intent:* """Test that exporting models with fields using the export parameter works."""
  * `test_validate_python_from_attributes` (Impact: 10.2)
  * `test_model_validate_strings` (Impact: 10.2)
  * `test_deferred_core_schema` (Impact: 9.5)
  * `test_model_export_nested_list` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_root_validator_classmethod` (Impact: 9.5)
  * `sixties_validator` (Impact: 6.3)
  * `b_length` (Impact: 6.2)
  * `validate_b` (Impact: 6.2)
  * `check_a_and_b` (Impact: 6.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_type_analysis` (Impact: 103.6)
    * *Intent:* # typing interface is horrible, we have to do some ugly checks if lenient_issubclass(self.type_, Jso...
  * `_validate_sequence_like` (Impact: 56.7)
  * `validate` (Impact: 46.4)
  * `_get_field_info` (Impact: 42.3)
  * `_validate_singleton` (Impact: 39.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `validate_error` (Impact: 14.3)
  * `test_generic` (Impact: 13.4)
  * `test_replace_types_with_user_defined_generic_type_field` (Impact: 8.2)
    * *Intent:* """Test that using user defined generic types as generic model fields are handled correctly."""
  * `model_parametrized_name` (Impact: 7.1)
  * `test_value_validation` (Impact: 6.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `collect_field_or_class_var_from_stmt` (Impact: 78.4)
  * `add_method` (Impact: 52.3)
  * `collect_config` (Impact: 47.6)
    * *Intent:* """Collects the values of the config attributes that are used by the plugin, accounting for parent c...
  * `add_initializer` (Impact: 44.3)
  * `to_argument` (Impact: 36.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_get_value` (Impact: 98.4)
  * `_iter` (Impact: 95.8)
  * `validate_model` (Impact: 65.9)
  * `create_model` (Impact: 54.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.016148 | `Ripple Effect (Closeness):` 0.139859
...
**Top Internal Functions/Classes:**
  * `test_init_vars_call_monkeypatch` (Impact: 9.4)
    * *Intent:* # Parametrizing like this allows us to test that the behavior is the same with or without the monkey...
  * `test_parametrized_generic_dataclass` (Impact: 8.2)
  * `lazy_cases_for_dataclass_equality_checks` (Impact: 8.1)
    * *Intent:* """ The reason for the convoluted structure of this function is to avoid creating the classes while ...
  * `test_init_false_with_post_init` (Impact: 7.5)
  * `test_init_false_with_default` (Impact: 7.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Field` (Impact: 177.7)
  * `computed_field` (Impact: 51.5)
  * `_construct` (Impact: 44.5)
    * *Intent:* """Construct the final `FieldInfo` instance, by merging the possibly existing `FieldInfo` instances ...
  * `from_annotated_attribute` (Impact: 40.8)
  * `__init__` (Impact: 30.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.024525 | `Ripple Effect (Closeness):` 0.126962
...
**Top Internal Functions/Classes:**
  * `field_singleton_schema` (Impact: 94.0)
  * `get_annotation_with_constraints` (Impact: 82.1)
    * *Intent:* """ Get an annotation with used constraints implemented for numbers and strings based on the field_i...
  * `go` (Impact: 67.5)
  * `field_type_schema` (Impact: 62.4)
  * `field_singleton_sub_fields_schema` (Impact: 55.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__get_pydantic_core_schema__` (Impact: 13.7)
  * `test_custom_generic_validators` (Impact: 10.4)
  * `_validate` (Impact: 9.1)
  * `validate` (Impact: 7.7)
  * `test_abstractmethod_missing_for_all_decorators` (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000512 | `Ripple Effect (Closeness):` 0.016101
...
**Top Internal Functions/Classes:**
  * `_convert_schema` (Impact: 39.1)
  * `condecimal` (Impact: 26.7)
    * *Intent:* # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ DECIMAL TYPES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  * `confloat` (Impact: 24.1)
  * `__get_pydantic_core_schema__` (Impact: 19.9)
  * `validate_brand` (Impact: 18.6)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002497 | `Ripple Effect (Closeness):` 0.026415
...
**Top Internal Functions/Classes:**
  * `validate` (Impact: 24.4)
  * `__new__` (Impact: 16.1)
  * `validate_length_for_brand` (Impact: 13.1)
    * *Intent:* """ Validate length based on BIN for major brands: https://en.wikipedia.org/wiki/Payment_card_number...
  * `set_length_validator` (Impact: 11.1)
  * `frozenset_length_validator` (Impact: 11.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__new__` (Impact: 138.8)
  * `inspect_namespace` (Impact: 109.6)
  * `complete_model_class` (Impact: 35.0)
  * `set_model_fields` (Impact: 9.4)
  * `set_deprecated_descriptors` (Impact: 9.3)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001002 | `Ripple Effect (Closeness):` 0.007547
...
**Top Internal Functions/Classes:**
  * `test_forward_ref_for_serializers` (Impact: 11.0)
  * `_serialize` (Impact: 8.9)
  * `test_model_serializer_plain_json_return_type` (Impact: 6.5)
  * `test_serializer_allow_reuse_inheritance_override` (Impact: 6.2)
  * `_serialize` (Impact: 6.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 20 instances
...
**Top Internal Functions/Classes:**
  * `test_discriminated_union_validation` (Impact: 15.5)
  * `test_various_syntax_options_for_callable_union` (Impact: 11.1)
  * `test_callable_discriminated_union_recursive` (Impact: 9.2)
    * *Intent:* # Demonstrate that the errors are very verbose without a callable discriminator: class Model(BaseMod...
  * `filter_discriminator` (Impact: 9.0)
  * `test_callable_discriminated_union_with_type_adapter` (Impact: 8.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_apply_constraint` (Impact: 165.9)
  * `_apply_parse` (Impact: 25.3)
  * `_apply_step` (Impact: 16.4)
  * `_apply_transform` (Impact: 13.1)
  * `_check_func` (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_args` (Impact: 9.4)
  * `test_json_schema` (Impact: 9.1)
  * `test_func_type` (Impact: 6.2)
  * `test_eval_type_backport` (Impact: 5.7)
  * `test_validate_class` (Impact: 5.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_discriminated_union_forward_ref` (Impact: 6.9)
  * `test_self_forward_ref_collection` (Impact: 6.1)
  * `test_forward_ref_auto_update_no_model` (Impact: 4.5)
  * `pytest_raises_user_error_for_undefined_type` (Impact: 4.2)
    * *Intent:* """ Returns a `pytest.raises` context manager that checks the error message when an undefined type i...
  * `test_nested_annotation_priority` (Impact: 4.0)
**Contextual Mitigations & Amplifications:**
...
- `pydantic-2.12.5/pydantic/fields.py` -> **Severity: 2.453** (Bridge: 0.0245 * Flux: 100.0%)
- `pydantic-2.12.5/pydantic/dataclasses.py` -> **Severity: 2.349** (Bridge: 0.0235 * Flux: 100.0%)
- `pydantic-2.12.5/pydantic/_internal/_generate_schema.py` -> **Severity: 2.269** (Bridge: 0.0227 * Flux: 100.0%)
- `pydantic-2.12.5/pydantic/_internal/_fields.py` -> **Severity: 2.103** (Bridge: 0.021 * Flux: 100.0%)
