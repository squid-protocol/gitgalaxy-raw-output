...
| Guard Balance (formerly Error & Exception Exposure) | 0.0 | 74.6 | 26.3 | 22.3 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 6.5 | 0.0 | 0.0 |
...
| cleanup | 0 | 0 | 0 | - |
| guards | 283 | 25 | 14 | `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/rrds/RrdsExampleCommon.java` |
...
| time | 2 | 1 | 0 | `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/StockPartHelper.java` |
| serialization | 2 | 1 | 0 | `src/Cobol/EDUCHAN.cbl` |
| regex | 0 | 0 | 0 | - |
| events | 3 | 2 | 0 | `etc/VSAM/DEFVSAM.jcl` |
| tests | 0 | 0 | 0 | - |
...
- `main` (@ `projects/com.ibm.cicsdev.link/src/com/ibm/cicsdev/link/LinkServEduchan.java`) -> Impact: **19.8** | LOC: 57
...
- `main` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/ksds/KsdsExample5.java`) -> Impact: **11.7** | LOC: 64
...
- `main` (@ `projects/com.ibm.cicsdev.link/src/com/ibm/cicsdev/link/LinkProg3.java`) -> Impact: **11.3** | LOC: 84
...
- `deleteRecord` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/ksds/KsdsExampleCommon.java`) -> Impact: **10.9** | LOC: 76
...
- `deleteRecord` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/rrds/RrdsExampleCommon.java`) -> Impact: **10.7** | LOC: 73
...
- `main` (@ `projects/com.ibm.cicsdev.serialize/src/com/ibm/cicsdev/serialize/SerializeExample1.java`) -> Impact: **10.4** | LOC: 67
  * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the CICS-MainClass entry in * the parent OSGi bundle's...
- `MAIN-PROCESSING` (@ `src/Cobol/EDUCHAN.cbl`) -> Impact: **10.4** | LOC: 87
  * *Intent:* * -----------------------------------------------------------
- `main` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/esds/EsdsExample5.java`) -> Impact: **10.0** | LOC: 58
  * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the CICS-MainClass entry in * the parent OSGi bundle's...
- `browse` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/ksds/KsdsExampleCommon.java`) -> Impact: **9.7** | LOC: 56
...
- `browse` (@ `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/esds/EsdsExampleCommon.java`) -> Impact: **9.5** | LOC: 52
...
### 1. `src/Cobol/EDUCHAN.cbl` (COBOL) -> Cumulative Risk: **476.23**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 31.94 | **LOC:** 173 | **CtrlFlow:** 5.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.0149%), Safety Score (74.5911%)
- **Heaviest Functions:** `MAIN-PROCESSING` (Impact: 10.4), `ABEND-ROUTINE` (Impact: 1.4), `RESP-ERROR` (Impact: 1.2)

### 2. `src/Cobol/EC01.cbl` (COBOL) -> Cumulative Risk: **470.98**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 17.94 | **LOC:** 119 | **CtrlFlow:** 7.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (77.4054%), State Flux (76.5323%)
- **Heaviest Functions:** `A-CONTROL` (Impact: 4.7), `ZZX-CICS-ERROR-ROUTINE` (Impact: 3.8), `ZZX-EXIT` (Impact: 1.1)

### 3. `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/StockPartHelper.java` (JAVA) -> Cumulative Risk: **326.21**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 41.84 | **LOC:** 235 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (96.934%), Safety Score (68.2375%), Api Exposure (58.3804%)
- **Heaviest Functions:** `generate` (Impact: 3.0), `generateDescription` (Impact: 2.1), `getKey` (Impact: 2.0)

### 4. `projects/com.ibm.cicsdev.tsq/src/com/ibm/cicsdev/tsq/TSQExample3.java` (JAVA) -> Cumulative Risk: **325.97**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 41.2 | **LOC:** 161 | **CtrlFlow:** 4.3% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9932%), Safety Score (69.8465%), Tech Debt (25.5132%)
- **Heaviest Functions:** `readFromQueue` (Impact: 4.8), `writeToQueue` (Impact: 3.7), `main` (Impact: 2.7)

### 5. `projects/com.ibm.cicsdev.tdq/src/com/ibm/cicsdev/tdq/TDQExample3.java` (JAVA) -> Cumulative Risk: **325.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 39.96 | **LOC:** 153 | **CtrlFlow:** 4.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9914%), Safety Score (68.8026%), Tech Debt (26.3198%)
- **Heaviest Functions:** `readFromQueue` (Impact: 4.8), `writeToQueue` (Impact: 3.7), `main` (Impact: 2.5)

### 6. `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/ksds/KsdsExample5.java` (JAVA) -> Cumulative Risk: **301.73**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 20.32 | **LOC:** 103 | **CtrlFlow:** 16.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (88.0797%), Safety Score (61.3692%), Tech Debt (37.7541%)
- **Heaviest Functions:** `main` (Impact: 11.7)

### 7. `projects/com.ibm.cicsdev.vsam/src/com/ibm/cicsdev/vsam/esds/EsdsExample5.java` (JAVA) -> Cumulative Risk: **301.16**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 18.64 | **LOC:** 97 | **CtrlFlow:** 12.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (88.0797%), Safety Score (61.3692%), Tech Debt (37.7541%)
- **Heaviest Functions:** `main` (Impact: 10.0)

### 8. `projects/com.ibm.cicsdev.link/src/com/ibm/cicsdev/link/LinkProg3.java` (JAVA) -> Cumulative Risk: **298.74**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 37.9 | **LOC:** 216 | **CtrlFlow:** 4.2% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (97.0538%), Safety Score (62.5112%), Tech Debt (19.0407%)
- **Heaviest Functions:** `main` (Impact: 11.3), `buildChannel` (Impact: 2.2), `linkProg` (Impact: 1.9)

### 9. `projects/com.ibm.cicsdev.terminal/src/com/ibm/cicsdev/terminal/TerminalExample1.java` (JAVA) -> Cumulative Risk: **298.61**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 24.48 | **LOC:** 127 | **CtrlFlow:** 11.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (88.5385%), Safety Score (62.3094%), Tech Debt (34.3407%)
- **Heaviest Functions:** `main` (Impact: 7.0), `getTerminalString` (Impact: 4.8), `parseTerminalString` (Impact: 3.6)

### 10. `projects/com.ibm.cicsdev.link/src/com/ibm/cicsdev/link/LinkProg2.java` (JAVA) -> Cumulative Risk: **294.95**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 19.56 | **LOC:** 128 | **CtrlFlow:** 0.0% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (97.3403%), Safety Score (55.9714%), Tech Debt (37.7541%)
- **Heaviest Functions:** `main` (Impact: 3.3), `linkProg` (Impact: 2.0), `buildCommarea` (Impact: 1.7)
...
- **Risk Profile:** Cognitive Load (5.6165%), Tech Debt (68.1542%)
**Top Internal Functions/Classes:**
  * `deleteRecord` (Impact: 10.7)
...
- **Risk Profile:** Cognitive Load (4.9141%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `deleteRecord` (Impact: 10.9)
...
- **Risk Profile:** Cognitive Load (5.1782%), Tech Debt (66.8188%)
**Top Internal Functions/Classes:**
  * `browse` (Impact: 9.5)
...
**Top Internal Functions/Classes:**
  ...
  * `generateDescription` (Impact: 2.1)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 41.2 | **LOC:** 161 | **CtrlFlow:** 4.3% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (23.2138%), Tech Debt (25.5132%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 4.8)
    * *Intent:* /** * Read of byte[] data from a TSQ. */
  * `writeToQueue` (Impact: 3.7)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 39.96 | **LOC:** 153 | **CtrlFlow:** 4.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (22.6968%), Tech Debt (26.3198%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 4.8)
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 31.94 | **LOC:** 173 | **CtrlFlow:** 5.2% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (61.3943%), Tech Debt (27.816%)
**Top Internal Functions/Classes:**
  * `MAIN-PROCESSING` (Impact: 10.4)
    * *Intent:* * -----------------------------------------------------------
  * `ABEND-ROUTINE` (Impact: 1.4)
    * *Intent:* * ----------------------------------------------------------- * Abnormal end * ---------------------...
  * `RESP-ERROR` (Impact: 1.2)
    * *Intent:* * -----------------------------------------------------------
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 4 instances
* *State Mutation (weighted view):* 17
...
- **Risk Profile:** Cognitive Load (12.8215%), Tech Debt (23.4296%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 10.4)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
  * `acquireLock` (Impact: 2.4)
    * *Intent:* /** * Attempts to acquire the shared resource lock. This method calls the * {@link NameResource#enqu...
  * `randomSleep` (Impact: 1.6)
...
- **Risk Profile:** Cognitive Load (7.9518%), Tech Debt (24.7664%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 3.9)
    * *Intent:* /** * Simple read of string data from a TSQ. */
  * `writeToQueue` (Impact: 3.5)
    * *Intent:* /** * Write of Java string data to a TSQ. */
  * `main` (Impact: 2.7)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
  * `TSQExample2` (Impact: 1.6)
    * *Intent:* /** * Constructor used to pass data to superclass constructor. * * @param tsq - the temporary storag...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
- **Risk Profile:** Cognitive Load (7.427%), Tech Debt (25.5132%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 3.8)
    * *Intent:* /** * Simple read of string data from a TDQ. */
  * `writeToQueue` (Impact: 3.5)
    * *Intent:* /** * Write some sample data to the instance TDQ. */
  * `main` (Impact: 2.5)
    * *Intent:* /** * Main entry point to this CICS Java program. */
  * `TDQExample2` (Impact: 1.6)
    * *Intent:* /** * Constructor used to pass data to superclass constructor. * * @param tdq - the transient data q...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 9
...
- **Risk Profile:** Cognitive Load (8.5611%), Tech Debt (33.5856%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 3.3)
    * *Intent:* /** * Simple read of string data from a TSQ. */
  * `writeToQueue` (Impact: 3.0)
    * *Intent:* /** * Write of Java string data to a TSQ. */
  * `main` (Impact: 2.7)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
  * `TSQExample1` (Impact: 1.6)
    * *Intent:* /** * Constructor used to pass data to superclass constructor. * * @param tsq - the temporary storag...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 8
...
- **Risk Profile:** Cognitive Load (9.6659%), Tech Debt (33.5856%)
**Top Internal Functions/Classes:**
  * `updateQueue` (Impact: 5.2)
    * *Intent:* /** * Browses through a queue created by {@link TSQExample3} and updates each record. * * Each item ...
  * `main` (Impact: 2.8)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
  * `TSQExample4` (Impact: 1.6)
    * *Intent:* /** * Constructor used to pass data to superclass constructor. * * @param tsq - the temporary storag...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 9
...
- **Risk Profile:** Cognitive Load (7.8525%), Tech Debt (35.1328%)
**Top Internal Functions/Classes:**
  * `readFromQueue` (Impact: 3.2)
    * *Intent:* /** * Simple read of string data from a TDQ. */
  * `writeToQueue` (Impact: 3.0)
    * *Intent:* /** * Write some sample data to the instance TDQ. */
  * `main` (Impact: 2.5)
    * *Intent:* /** * Main entry point to this CICS Java program. */
  * `TDQExample1` (Impact: 1.6)
    * *Intent:* /** * Constructor used to pass data to superclass constructor. * * @param tdq - the transient data q...
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
* *State Mutation (weighted view):* 7
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 20.32 | **LOC:** 103 | **CtrlFlow:** 16.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (8.9356%), Tech Debt (37.7541%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 11.7)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 18.64 | **LOC:** 97 | **CtrlFlow:** 12.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (8.3529%), Tech Debt (37.7541%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 10.0)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
**Contextual Mitigations & Amplifications:**
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 17.94 | **LOC:** 119 | **CtrlFlow:** 7.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (45.1644%), Tech Debt (77.4054%)
**Top Internal Functions/Classes:**
  * `A-CONTROL` (Impact: 4.7)
    * *Intent:* ********************
  * `ZZX-CICS-ERROR-ROUTINE` (Impact: 3.8)
    * *Intent:* ********************************
  * `ZZX-EXIT` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
- **Risk Profile:** Cognitive Load (5.1036%), Tech Debt (37.7541%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 8.5)
    * *Intent:* /** * Main entry point to a CICS OSGi program. * * The FQ name of this class should be added to the ...
**Contextual Mitigations & Amplifications:**
