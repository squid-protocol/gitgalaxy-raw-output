...
- `browse_key` (@ `src/browser.c`) -> Impact: **154.1** | LOC: 225
- `argv_parse` (@ `src/main.c`) -> Impact: **116.7** | LOC: 151
  * *Intent:* /* parse command line */
- `dir_scan_item` (@ `src/dir_scan.c`) -> Impact: **61.9** | LOC: 78
...
- `dirlist_cmp` (@ `src/dirlist.c`) -> Impact: **49.2** | LOC: 48
- `formatsize` (@ `src/util.c`) -> Impact: **47.9** | LOC: 22
- `iteminfo` (@ `src/dir_import.c`) -> Impact: **46.5** | LOC: 89
  * *Intent:* /* Reads a JSON object representing a struct dir/dir_ext item. Writes to * ctx->buf_dir, ctx->buf_ext and ctx->buf_name. */
- `rstring_esc` (@ `src/dir_import.c`) -> Impact: **45.3** | LOC: 39
- `delete_key` (@ `src/delete.c`) -> Impact: **45.2** | LOC: 56
- `path_real_rec` (@ `src/path.c`) -> Impact: **42.0** | LOC: 78
...
- `browse_draw_graph` (@ `src/browser.c`) -> Impact: **38.2** | LOC: 37
...
- **Heaviest Functions:** `formatsize` (Impact: 47.9), `fmtmode` (Impact: 26.6), `freedir_hlnk` (Impact: 20.0)
...
- **Heaviest Functions:** `dir_key` (Impact: 16.5), `draw_progress` (Impact: 15.8), `dir_draw` (Impact: 13.4)
...
- **Heaviest Functions:** `item` (Impact: 36.6), `hlink_check` (Impact: 18.5), `final` (Impact: 14.3)
...
- **Heaviest Functions:** `path_real_rec` (Impact: 42.0), `path_split` (Impact: 22.7), `path_absolute` (Impact: 11.4)
...
- **Heaviest Functions:** `delete_key` (Impact: 45.2), `delete_dir` (Impact: 27.6), `delete_draw_confirm` (Impact: 12.2)
...
- **Heaviest Functions:** `dirlist_cmp` (Impact: 49.2), `dirlist_sort` (Impact: 29.2), `dirlist_top` (Impact: 24.6)
...
- **Heaviest Functions:** `output_info` (Impact: 36.8), `output_string` (Impact: 20.7), `item` (Impact: 15.6)
...
- **Heaviest Functions:** `help_key` (Impact: 35.8), `help_draw` (Impact: 13.6), `help_init` (Impact: 1.2)
...
- **Heaviest Functions:** `browse_key` (Impact: 154.1), `browse_draw_graph` (Impact: 38.2), `browse_draw_flag` (Impact: 25.1)
...
- **Heaviest Functions:** `argv_parse` (Impact: 116.7), `input_handle` (Impact: 30.4), `main` (Impact: 22.4)
...
**Top Internal Functions/Classes:**
  * `formatsize` (Impact: 47.9)
  * `fmtmode` (Impact: 26.6)
  * `freedir_hlnk` (Impact: 20.0)
...
**Top Internal Functions/Classes:**
  * `browse_key` (Impact: 154.1)
  * `browse_draw_graph` (Impact: 38.2)
  * `browse_draw_flag` (Impact: 25.1)
  * `browse_draw_info` (Impact: 23.4)
  * `browse_draw_items` (Impact: 22.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `dirlist_cmp` (Impact: 49.2)
  * `dirlist_sort` (Impact: 29.2)
  * `dirlist_top` (Impact: 24.6)
    * *Intent:* * -2 = selected = first item in the list (faster version of '1') * -3 = top should be considered as ...
  * `dirlist_get` (Impact: 15.9)
...
**Top Internal Functions/Classes:**
  * `argv_parse` (Impact: 116.7)
    * *Intent:* /* parse command line */
  * `input_handle` (Impact: 30.4)
...
**Top Internal Functions/Classes:**
  * `delete_key` (Impact: 45.2)
  * `delete_dir` (Impact: 27.6)
  * `delete_draw_confirm` (Impact: 12.2)
  * `delete_process` (Impact: 10.6)
  * `delete_draw` (Impact: 5.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `draw_progress` (Impact: 15.8)
  * `dir_draw` (Impact: 13.4)
  * `curpath_resize` (Impact: 6.0)
    * *Intent:* char *dir_fatalerr; /* Error message on a fatal error. (NULL if there was no fatal error) */ int dir...
  * `dir_curpath_leave` (Impact: 5.5)
...
**Top Internal Functions/Classes:**
  * `help_key` (Impact: 35.8)
  * `help_draw` (Impact: 13.6)
...
**Top Internal Functions/Classes:**
  * `exclude_addfile` (Impact: 10.9)
  * `exclude_match` (Impact: 10.5)
  * `has_cachedir_tag` (Impact: 9.9)
    * *Intent:* /* * Exclusion of directories that contain only cached information. * See http://www.brynosaurus.com...
  * `exclude_add` (Impact: 3.4)
