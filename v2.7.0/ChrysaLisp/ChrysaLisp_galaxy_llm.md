...
- `get_event_timeout` (@ `src/host/gui_fb.c`) -> Impact: **53.0** | LOC: 90
  * *Intent:* /* msec timeout 0 to poll, timeout -1 to block */
- `host_gui_create_texture` (@ `src/host/gui_fb.c`) -> Impact: **49.2** | LOC: 53
  * *Intent:* /* allocate drawable for passed data and return a handle to it */
- `host_gui_create_texture` (@ `src/host/gui_raw.cpp`) -> Impact: **49.1** | LOC: 51
  * *Intent:* //////////////////// // texture functions ////////////////////
- `host_gui_filled_box` (@ `src/host/gui_raw.cpp`) -> Impact: **33.6** | LOC: 50
- `main` (@ `src/host/main.cpp`) -> Impact: **33.3** | LOC: 77
  * *Intent:* #endif
- `open_framebuffer` (@ `src/host/gui_fb.c`) -> Impact: **26.9** | LOC: 98
...
- `host_audio_change_sfx` (@ `src/host/audio_sdl.cpp`) -> Impact: **20.5** | LOC: 28
...
- **Heaviest Functions:** `boot_cpu_gui` (Impact: 19.0), `boot_cpu_tui` (Impact: 19.0), `add_link` (Impact: 10.5)
...
- **Heaviest Functions:** `get_event_timeout` (Impact: 53.0), `host_gui_create_texture` (Impact: 49.2), `open_framebuffer` (Impact: 26.9)
...
- **Heaviest Functions:** `main` (Impact: 11.6), `boot_cpu_gui` (Impact: 11.4), `boot_cpu_tui` (Impact: 11.3)
...
- **Heaviest Functions:** `pii_mprotect` (Impact: 22.9), `pii_munmap` (Impact: 18.8), `pii_dirlist` (Impact: 17.8)
...
- **Heaviest Functions:** `host_gui_blit` (Impact: 79.5), `host_gui_create_texture` (Impact: 49.1), `host_gui_filled_box` (Impact: 33.6)
...
- **Heaviest Functions:** `walk_directory` (Impact: 19.5), `pii_open` (Impact: 17.2), `pii_open_shared` (Impact: 13.0)
...
- **Heaviest Functions:** `vp64` (Impact: 14.9)
...
- **Heaviest Functions:** `main` (Impact: 33.3), `enableRawMode` (Impact: 1.4), `enableRawMode` (Impact: 1.4)
...
- **Heaviest Functions:** `host_audio_change_sfx` (Impact: 20.5), `host_audio_add_sfx` (Impact: 5.1), `host_audio_init` (Impact: 3.8)
...
**Top Internal Functions/Classes:**
  * `get_event_timeout` (Impact: 53.0)
    * *Intent:* /* msec timeout 0 to poll, timeout -1 to block */
  * `host_gui_create_texture` (Impact: 49.2)
    * *Intent:* /* allocate drawable for passed data and return a handle to it */
  * `open_framebuffer` (Impact: 26.9)
    * *Intent:* /* open linux framebuffer*/
  * `read_mouse` (Impact: 21.8)
    * *Intent:* * --------+-----+-----+-----+-----+-----+-----+-----+----- * Byte 0 | 0 0 Neg-Y Neg-X 1 Mid Right Le...
  * `host_gui_filled_box` (Impact: 20.1)
...
**Top Internal Functions/Classes:**
  ...
  * `host_gui_create_texture` (Impact: 49.1)
    * *Intent:* //////////////////// // texture functions ////////////////////
  * `host_gui_filled_box` (Impact: 33.6)
  * `host_gui_flush` (Impact: 11.3)
  * `host_gui_box` (Impact: 9.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 11.6)
  * `boot_cpu_gui` (Impact: 11.4)
  * `boot_cpu_tui` (Impact: 11.3)
  * `add_link` (Impact: 9.6)
  * `zero_pad` (Impact: 6.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 33.3)
    * *Intent:* #endif
  * `enableRawMode` (Impact: 1.4)
  * `enableRawMode` (Impact: 1.4)
  * `disableRawMode` (Impact: 1.2)
  * `disableRawMode` (Impact: 1.1)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `host_audio_add_sfx` (Impact: 5.1)
  * `host_audio_init` (Impact: 3.8)
  * `host_audio_remove_sfx` (Impact: 3.4)
  * `host_audio_play_sfx` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `host_gui_init` (Impact: 4.3)
  * `host_gui_create_texture` (Impact: 2.9)
  * `host_gui_set_texture_color` (Impact: 2.5)
  * `host_gui_set_color` (Impact: 2.4)
  * `host_gui_blit` (Impact: 2.2)
**Structural Signatures (Net Mitigated Signals):**
