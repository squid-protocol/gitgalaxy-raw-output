...
| Avg Path Length | 3.5673 | Hops between files. Lower = Tighter coupling. |
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 37.2 | 21.3 | 0.0 |
...
| connectivity | 2137 | 337 | 10 | `llvm/include/llvm/MC/MCAsmInfo.h` |
...
| dead_code | 1678 | 294 | 5 | `llvm/lib/MC/MCParser/AsmParser.cpp` |
| credential | 0 | 0 | 0 | - |
...
- `AsmParser::parseStatement` (@ `llvm/lib/MC/MCParser/AsmParser.cpp`) -> Impact: **436.2** | LOC: 525
  * *Intent:* /// ParseStatement: /// ::= EndOfStatement /// ::= Label* Directive ...Operands... EndOfStatement /// ::= Label* Identifier OperandList* EndOfStatemen...
- `backref` (@ `llvm/lib/Support/regengine.inc`) -> Impact: **298.3** | LOC: 196
  * *Intent:* */
- `AsmParser::parseMSInlineAsm` (@ `llvm/lib/MC/MCParser/AsmParser.cpp`) -> Impact: **279.3** | LOC: 213
- `MCExpr::evaluateAsRelocatableImpl` (@ `llvm/lib/MC/MCExpr.cpp`) -> Impact: **234.5** | LOC: 165
- `ks_open` (@ `llvm/keystone/ks.cpp`) -> Impact: **203.3** | LOC: 267
- `MCSymbolRefExpr::getVariantKindName` (@ `llvm/lib/MC/MCExpr.cpp`) -> Impact: **189.1** | LOC: 133
- `dissect` (@ `llvm/lib/Support/regengine.inc`) -> Impact: **170.9** | LOC: 184
  * *Intent:* */
- `identify_magic` (@ `llvm/lib/Support/Path.cpp`) -> Impact: **162.1** | LOC: 160
  * *Intent:* /// @brief Identify the magic in magic.
- `step` (@ `llvm/lib/Support/regengine.inc`) -> Impact: **161.7** | LOC: 112
  * *Intent:* */
- `AsmParser::expandMacro` (@ `llvm/lib/MC/MCParser/AsmParser.cpp`) -> Impact: **156.9** | LOC: 121
...
- **Heaviest Functions:** `_read_components_from_parser` (Impact: 11.8), `get_optional_bool` (Impact: 8.4), `get_optional_string` (Impact: 7.3)
...
- **Heaviest Functions:** `SMDiagnostic::print` (Impact: 108.1), `SourceMgr::GetMessage` (Impact: 44.7), `buildFixItLine` (Impact: 34.5)
...
- **Heaviest Functions:** `llvm_ks::ARM::getFPUFeatures` (Impact: 56.0), `llvm_ks::ARM::parseArchVersion` (Impact: 44.5), `llvm_ks::ARM::getCanonicalArchName` (Impact: 30.7)
...
- **Heaviest Functions:** `StringTableBuilder::finalizeStringTable` (Impact: 49.1), `multikey_qsort` (Impact: 17.5), `StringTableBuilder::StringTableBuilder` (Impact: 13.5)
...
- **Heaviest Functions:** `writeFragment` (Impact: 98.6), `MCAssembler::evaluateFixup` (Impact: 82.6), `MCAssembler::computeFragmentSize` (Impact: 52.1)
...
- **Heaviest Functions:** `APFloat::toString` (Impact: 112.1), `APFloat::convert` (Impact: 68.8), `APFloat::convertToSignExtendedInteger` (Impact: 66.3)
...
- **Heaviest Functions:** `SmallPtrSetImplBase::CopyFrom` (Impact: 21.2), `SmallPtrSetImplBase::swap` (Impact: 15.2), `SmallPtrSetImplBase::Grow` (Impact: 14.5)
...
- **Heaviest Functions:** `p_ere_exp` (Impact: 86.3), `p_simp_re` (Impact: 76.6), `findmust` (Impact: 45.3)
...
- **Heaviest Functions:** `identify_magic` (Impact: 162.1), `createUniqueEntity` (Impact: 43.0), `append` (Impact: 33.7)
...
- **Heaviest Functions:** `Regex::sub` (Impact: 69.8), `Regex::match` (Impact: 17.5), `Regex::Regex` (Impact: 7.5)
...
**Top Internal Functions/Classes:**
  * `AsmParser::parseStatement` (Impact: 436.2)
    * *Intent:* /// ParseStatement: /// ::= EndOfStatement /// ::= Label* Directive ...Operands... EndOfStatement //...
  * `AsmParser::parseMSInlineAsm` (Impact: 279.3)
  * `AsmParser::expandMacro` (Impact: 156.9)
  * `AsmParser::parsePrimaryExprAux` (Impact: 118.8)
  * `AsmParser::checkForBadMacro` (Impact: 87.1)
...
**Top Internal Functions/Classes:**
  * `APInt::divide` (Impact: 149.1)
  * `APInt::toString` (Impact: 93.1)
  * `KnuthDiv` (Impact: 80.0)
    * *Intent:* /// Implementation of Knuth's Algorithm D (Division of nonnegative integers) /// from "Art of Comput...
  * `APInt::fromString` (Impact: 63.0)
  * `APInt::tcMultiplyPart` (Impact: 58.1)
    * *Intent:* return one. */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `backref` (Impact: 298.3)
    * *Intent:* */
  * `dissect` (Impact: 170.9)
    * *Intent:* */
  * `step` (Impact: 161.7)
    * *Intent:* */
  * `matcher` (Impact: 142.7)
    * *Intent:* */
  * `fast` (Impact: 84.9)
    * *Intent:* */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `Triple::normalize` (Impact: 105.4)
  * `getDefaultFormat` (Impact: 75.2)
  * `getArchPointerBitWidth` (Impact: 69.3)
  * `Triple::getArchTypeName` (Impact: 69.1)
  * `Triple::get64BitArchVariant` (Impact: 67.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ELFObjectWriter::computeSymbolTable` (Impact: 119.4)
  * `ELFObjectWriter::recordRelocation` (Impact: 76.2)
  * `ELFObjectWriter::shouldRelocateWithSymbol` (Impact: 71.0)
    * *Intent:* // It is always valid to create a relocation with a symbol. It is preferable // to use a relocation ...
  * `ELFObjectWriter::writeSection` (Impact: 46.5)
  * `mergeTypeForSet` (Impact: 43.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `identify_magic` (Impact: 162.1)
    * *Intent:* /// @brief Identify the magic in magic.
  * `createUniqueEntity` (Impact: 43.0)
  * `append` (Impact: 33.7)
  * `make_absolute` (Impact: 28.8)
  * `copy_file` (Impact: 24.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `MCExpr::evaluateAsRelocatableImpl` (Impact: 234.5)
  * `MCSymbolRefExpr::getVariantKindName` (Impact: 189.1)
  * `MCExpr::print` (Impact: 124.4)
    * *Intent:* #define DEBUG_TYPE "mcexpr"
  * `AttemptToFoldSymbolOffsetDifference` (Impact: 54.0)
    * *Intent:* /// \brief Helper method for \see EvaluateSymbolAdd().
  * `EvaluateSymbolicAdd` (Impact: 52.7)
...
**Top Internal Functions/Classes:**
  * `writeFragment` (Impact: 98.6)
    * *Intent:* /// \brief Write the fragment \p F to the output file.
  * `MCAssembler::evaluateFixup` (Impact: 82.6)
  * `MCAssembler::computeFragmentSize` (Impact: 52.1)
  * `MCAssembler::writeSectionData` (Impact: 40.9)
  * `MCAssembler::layout` (Impact: 36.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `ks_open` (Impact: 203.3)
  * `ks_strerror` (Impact: 73.0)
  * `ks_asm` (Impact: 42.7)
    * *Intent:* */
  * `ks_option` (Impact: 37.9)
  * `InitKs` (Impact: 20.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `mapped_file_region::init` (Impact: 45.0)
  * `openFileForWrite` (Impact: 36.3)
  * `getStatus` (Impact: 32.0)
  * `widenPath` (Impact: 31.9)
    * *Intent:* // Convert a UTF-8 path to UTF-16. Also, if the absolute equivalent of the // path is longer than Cr...
  * `detail::directory_iterator_construct` (Impact: 30.2)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 3.9e-05 | `Ripple Effect (Closeness):` 0.014227
...
**Top Internal Functions/Classes:**
  * `ELFAsmParser::ParseSectionArguments` (Impact: 147.8)
  * `parseSectionFlags` (Impact: 49.0)
  * `ELFAsmParser::ParseDirectiveType` (Impact: 28.5)
    * *Intent:* /// ParseDirectiveELFType /// ::= .type identifier , STT_<TYPE_IN_UPPER_CASE> /// ::= .type identifi...
  * `ELFAsmParser::ParseSectionName` (Impact: 20.4)
  * `ELFAsmParser::ParseDirectiveSymbolAttribute` (Impact: 15.5)
...
**Top Internal Functions/Classes:**
  * `llvm_ks::ARM::getFPUFeatures` (Impact: 56.0)
  * `llvm_ks::ARM::parseArchVersion` (Impact: 44.5)
    * *Intent:* // Version number (ex. v7 = 7).
  * `llvm_ks::ARM::getCanonicalArchName` (Impact: 30.7)
    * *Intent:* // MArch is expected to be of the form (arm|thumb)?(eb)?(v.+)?(eb)?, but // (iwmmxt|xscale)(eb)? is ...
  * `llvm_ks::ARM::parseArchProfile` (Impact: 19.4)
    * *Intent:* // Profile A/R/M
  * `llvm_ks::ARM::parseArchEndian` (Impact: 13.6)
...
**Top Internal Functions/Classes:**
  * `MCELFStreamer::fixSymbolsInTLSFixups` (Impact: 94.6)
  * `MCELFStreamer::EmitSymbolAttribute` (Impact: 74.4)
  * `MCELFStreamer::EmitInstToData` (Impact: 48.5)
  * `MCELFStreamer::mergeFragment` (Impact: 14.1)
  * `MCELFStreamer::EmitCommonSymbol` (Impact: 13.8)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 21 instances
...
**Top Internal Functions/Classes:**
  * `COFFAsmParser::ParseSectionFlags` (Impact: 72.7)
  * `COFFAsmParser::ParseDirectiveSection` (Impact: 29.1)
    * *Intent:* // .section name [, "flags"] [, identifier [ identifier ], identifier] // // Supported flags: // a: ...
  * `COFFAsmParser::ParseDirectiveSymbolAttribute` (Impact: 15.3)
    * *Intent:* /// ParseDirectiveSymbolAttribute /// ::= { ".weak", ... } [ identifier ( , identifier )* ]
  * `COFFAsmParser::ParseSEHDirectiveHandler` (Impact: 13.4)
  * `COFFAsmParser::ParseSEHRegisterNumber` (Impact: 13.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 40 instances
* *State Mutation (weighted view):* 121
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `SMDiagnostic::print` (Impact: 108.1)
  * `SourceMgr::GetMessage` (Impact: 44.7)
  * `buildFixItLine` (Impact: 34.5)
  * `SourceMgr::getLineAndColumn` (Impact: 19.5)
  * `printSourceLine` (Impact: 11.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 57 instances
...
**Top Internal Functions/Classes:**
  * `raw_ostream::write_escaped` (Impact: 29.8)
  * `raw_fd_ostream::write_impl` (Impact: 26.6)
  * `raw_ostream::operator<<` (Impact: 23.2)
  * `raw_ostream::operator<<` (Impact: 22.1)
  * `raw_ostream::SetBufferAndMode` (Impact: 20.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `swap` (Impact: 29.0)
  * `copyFrom` (Impact: 18.2)
  * `grow` (Impact: 16.7)
  * `moveFromOldBuckets` (Impact: 11.6)
  * `InsertIntoBucketImpl` (Impact: 10.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.001505 | `Ripple Effect (Closeness):` 0.0469
...
**Top Internal Functions/Classes:**
  * `MCStreamer::visitUsedExpr` (Impact: 18.2)
  * `MCStreamer::EmitIntValue` (Impact: 15.1)
    * *Intent:* /// EmitIntValue - Special case of EmitValue that avoids the client having to /// pass in a MCExpr f...
  * `MCStreamer::SwitchSection` (Impact: 12.8)
  * `MCStreamer::EmitWinEHHandler` (Impact: 12.7)
  * `MCStreamer::EmitCFIStartProc` (Impact: 10.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `MCObjectFileInfo::initELFMCObjectFileInfo` (Impact: 76.9)
  * `MCObjectFileInfo::initMachOMCObjectFileInfo` (Impact: 33.5)
  * `MCObjectFileInfo::InitMCObjectFileInfo` (Impact: 24.8)
  * `MCObjectFileInfo::initCOFFMCObjectFileInfo` (Impact: 16.3)
  * `useCompactUnwind` (Impact: 13.9)
**Contextual Mitigations & Amplifications:**
...
- `llvm/include/llvm/MC/MCSymbol.h` -> **Severity: 0.44** (Bridge: 0.0052 * Flux: 84.1478%)
- `llvm/include/llvm/ADT/DenseMap.h` -> **Severity: 0.146** (Bridge: 0.0015 * Flux: 96.9217%)
- `llvm/include/llvm/ADT/SmallVector.h` -> **Severity: 0.134** (Bridge: 0.0014 * Flux: 98.9168%)
- `llvm/include/llvm/ADT/Hashing.h` -> **Severity: 0.087** (Bridge: 0.001 * Flux: 88.8708%)
- `llvm/include/llvm/ADT/StringMap.h` -> **Severity: 0.081** (Bridge: 0.0009 * Flux: 94.5649%)
