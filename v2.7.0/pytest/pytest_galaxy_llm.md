...
| Avg Path Length | 2.5736 | Hops between files. Lower = Tighter coupling. |
...
- `_check_exceptions` (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **97.1** | LOC: 142
- `parametrize` (@ `pytest-9.0.2/src/_pytest/python.py`) -> Impact: **83.0** | LOC: 189
- `__init__` (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **72.5** | LOC: 51
- `_getini_toml` (@ `pytest-9.0.2/src/_pytest/config/__init__.py`) -> Impact: **70.3** | LOC: 83
- `matches` (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **70.2** | LOC: 122
- `__init__` (@ `pytest-9.0.2/src/_pytest/raises.py`) -> Impact: **68.2** | LOC: 62
- `assertrepr_compare` (@ `pytest-9.0.2/src/_pytest/assertion/util.py`) -> Impact: **67.1** | LOC: 68
- `_getini_ini` (@ `pytest-9.0.2/src/_pytest/config/__init__.py`) -> Impact: **66.5** | LOC: 60
- `make_numbered_dir` (@ `pytest-9.0.2/src/_pytest/_py/path.py`) -> Impact: **57.0** | LOC: 160
- `_safe_repr` (@ `pytest-9.0.2/src/_pytest/_io/pprint.py`) -> Impact: **56.7** | LOC: 57
...
- **Heaviest Functions:** `collect_thread_exception` (Impact: 10.3), `thread_exception_hook` (Impact: 7.1), `cleanup` (Impact: 2.4)
...
- **Heaviest Functions:** `pytest_runtest_logreport` (Impact: 52.2), `short_test_summary` (Impact: 37.9), `report_collect` (Impact: 31.2)
...
- **Heaviest Functions:** `param` (Impact: 21.3), `get_unpacked_marks` (Impact: 20.6), `__getattr__` (Impact: 19.5)
...
- **Heaviest Functions:** `reorder_items_atscope` (Impact: 47.9), `_showfixtures_main` (Impact: 28.7), `_get_active_fixturedef` (Impact: 26.3)
...
- **Heaviest Functions:** `lex` (Impact: 42.4), `single_kwarg` (Impact: 15.7), `not_expr` (Impact: 9.4)
...
- **Heaviest Functions:** `pytest_collection_modifyitems` (Impact: 20.2), `pytest_runtest_logreport` (Impact: 15.0), `pytest_configure` (Impact: 6.0)
...
- **Heaviest Functions:** `pytest_addoption` (Impact: 21.8), `from_item` (Impact: 13.6), `deselect_by_keyword` (Impact: 11.3)
...
- **Heaviest Functions:** `parametrize` (Impact: 83.0), `collect` (Impact: 26.5), `__init__` (Impact: 25.7)
...
- **Heaviest Functions:** `from_item_and_call` (Impact: 29.5), `_report_kwargs_from_json` (Impact: 28.1), `_report_to_json` (Impact: 27.6)
...
- **Heaviest Functions:** `collect` (Impact: 51.4), `resolve_collection_argument` (Impact: 43.0), `perform_collect` (Impact: 38.8)
...
**Top Internal Functions/Classes:**
  * `pytest_runtest_logreport` (Impact: 52.2)
  * `short_test_summary` (Impact: 37.9)
  * `report_collect` (Impact: 31.2)
  * `summary_warnings` (Impact: 30.9)
  * `_printcollecteditems` (Impact: 29.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.010502 | `Ripple Effect (Closeness):` 0.239266
...
**Top Internal Functions/Classes:**
  * `_getini_toml` (Impact: 70.3)
  * `_getini_ini` (Impact: 66.5)
  * `_decide_args` (Impact: 39.0)
  * `parse` (Impact: 33.4)
    * *Intent:* # Parse given cmdline arguments into this config object. assert self.args == [], ( "can only parse c...
  * `_set_initial_conftests` (Impact: 24.6)
...
**Top Internal Functions/Classes:**
  * `make_numbered_dir` (Impact: 57.0)
  * `pyimport` (Impact: 40.4)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.004679 | `Ripple Effect (Closeness):` 0.256754
...
**Top Internal Functions/Classes:**
  * `reorder_items_atscope` (Impact: 47.9)
  * `_showfixtures_main` (Impact: 28.7)
  * `_get_active_fixturedef` (Impact: 26.3)
  * `getfixtureclosure` (Impact: 25.6)
  * `parsefactories` (Impact: 25.2)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.011121 | `Ripple Effect (Closeness):` 0.277996
...
**Top Internal Functions/Classes:**
  * `parametrize` (Impact: 83.0)
  * `collect` (Impact: 26.5)
  * `__init__` (Impact: 25.7)
  * `_genfunctions` (Impact: 24.4)
  * `_validate_if_using_arg_names` (Impact: 23.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.002598 | `Ripple Effect (Closeness):` 0.20554
...
**Top Internal Functions/Classes:**
  * `get_source` (Impact: 41.6)
  * `_group_contains` (Impact: 41.1)
  * `cut` (Impact: 40.9)
  * `repr_traceback_entry` (Impact: 38.5)
  * `repr_excinfo` (Impact: 31.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.003314 | `Ripple Effect (Closeness):` 0.238528
...
**Top Internal Functions/Classes:**
  * `_match_lines` (Impact: 40.0)
  * `_makefile` (Impact: 28.7)
  * `matchreport` (Impact: 28.3)
  * `copy_example` (Impact: 26.5)
    * *Intent:* """Copy file from project's directory into the testdir. :param name: The name of the file to copy. :...
  * `inline_run` (Impact: 24.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.025521 | `Ripple Effect (Closeness):` 0.255042
...
**Top Internal Functions/Classes:**
  * `test_visit_breadthfirst` (Impact: 10.9)
  * `test_make_numbered_dir` (Impact: 9.4)
  * `test_chmod_rec_int` (Impact: 7.7)
    * *Intent:* # XXX fragile test def recfilter(x): return x.check(dotfile=0, link=0) oldmodes = {} for x in path1....
  * `test_visit_sort` (Impact: 7.4)
  * `test_move_file` (Impact: 5.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_type_errors` (Impact: 32.2)
    * *Intent:* """Test all possible TypeError cases in getini."""
  * `test_disable_plugin_autoload` (Impact: 30.7)
  * `test_pytest_plugins_in_non_top_level_conftest_unsupported_pyargs` (Impact: 15.2)
  * `test_missing_required_plugins` (Impact: 13.2)
  * `test_plugin_preparse_prevents_setuptools_loading` (Impact: 11.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_deterministic_fixture_collection` (Impact: 12.2)
  * `test_non_relative_path` (Impact: 8.2)
  * `test_request_subrequest_addfinalizer_exceptions` (Impact: 5.7)
  * `test_funcarg_lookup_error` (Impact: 5.3)
  * `test_request_garbage` (Impact: 5.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_tb_option` (Impact: 13.3)
  * `test_execute_skipped_positive_2` (Impact: 9.6)
    * *Intent:* # expected: one test case per line (with file name), word describing result, full reason p = TestFin...
  * `test_pass_skip_fail` (Impact: 9.4)
  * `test_line_with_reprcrash` (Impact: 8.2)
  * `test_fail_extra_reporting` (Impact: 7.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_check_exceptions` (Impact: 97.1)
  * `__init__` (Impact: 72.5)
  * `matches` (Impact: 70.2)
  * `__init__` (Impact: 68.2)
  * `_parse_exc` (Impact: 31.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000402 | `Ripple Effect (Closeness):` 0.163735
...
**Top Internal Functions/Classes:**
  * `_exceptiongroup_common` (Impact: 21.4)
  * `test_exc_chain_repr` (Impact: 16.6)
  * `test_exc_chain_repr_cycle` (Impact: 13.1)
  * `test_traceback_repr_style` (Impact: 12.3)
  * `test_exc_repr_chain_suppression` (Impact: 10.6)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000358 | `Ripple Effect (Closeness):` 0.014151
...
**Top Internal Functions/Classes:**
  * `test_boolop` (Impact: 26.5)
  * `getmsg` (Impact: 13.2)
  * `test_positions_are_preserved` (Impact: 10.8)
    * *Intent:* """Ensure AST positions are preserved during rewriting (#12818)."""
  * `preserved` (Impact: 10.6)
  * `test_place_initial_imports` (Impact: 10.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_installed_plugin_rewrite` (Impact: 20.2)
  * `test_truncation_with_ini` (Impact: 15.5)
  * `test_comparisons_handle_colors` (Impact: 12.9)
  * `mock_config` (Impact: 7.9)
  * `test_set_extra_item` (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Race Conditions:* 1 instances
...
**Top Internal Functions/Classes:**
  * `test_failure_function` (Impact: 15.5)
  * `test_xfail_captures_output_once` (Impact: 12.5)
  * `test_logging_passing_tests_disabled_logs_output_for_failing_test_issue5430` (Impact: 10.9)
  * `assert_attr` (Impact: 9.2)
  * `test_junit_duration_report` (Impact: 8.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `resolve_collection_argument` (Impact: 43.0)
  * `perform_collect` (Impact: 38.8)
  * `pytest_addoption` (Impact: 30.8)
  * `pytest_ignore_collect` (Impact: 29.5)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 106 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.010693 | `Ripple Effect (Closeness):` 0.294973
...
**Top Internal Functions/Classes:**
  * `test_parametrize_marked_value` (Impact: 7.0)
  * `test_xfail_passing_is_xpass` (Impact: 6.9)
  * `test_parametrize_indirect_wrong_type` (Impact: 6.2)
  * `test_parametrize_request_name` (Impact: 5.8)
    * *Intent:* """Show proper error when 'request' is used as a parameter name in parametrize (#6183)"""
  * `test_parametrize_error_iterator` (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_testpaths_ini` (Impact: 13.8)
  * `test_strict_parametrization_ids` (Impact: 8.7)
  * `test_check_collect_hashes` (Impact: 7.8)
  * `get_reported_items` (Impact: 7.4)
    * *Intent:* """Return pytest.Item instances reported by the pytest_collectreport hook"""
  * `test_collect_short_file_windows` (Impact: 6.8)
...
**Top Internal Functions/Classes:**
  * `assertrepr_compare` (Impact: 67.1)
  * `_compare_eq_any` (Impact: 50.9)
  * `_compare_eq_cls` (Impact: 49.6)
  * `_compare_eq_dict` (Impact: 42.4)
  * `_compare_eq_sequence` (Impact: 29.7)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.005095 | `Ripple Effect (Closeness):` 0.243028
...
**Top Internal Functions/Classes:**
  * `import_path` (Impact: 44.2)
  * `_import_module_using_spec` (Impact: 44.1)
  * `on_rm_rf_error` (Impact: 25.2)
  * `resolve_pkg_root_and_module_name` (Impact: 21.2)
  * `fnmatch_ex` (Impact: 15.6)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.006884 | `Ripple Effect (Closeness):` 0.330269
...
**Top Internal Functions/Classes:**
  * `_windowsconsoleio_workaround` (Impact: 16.8)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000253 | `Ripple Effect (Closeness):` 0.159207
...
**Top Internal Functions/Classes:**
  * `test_disabled_capture_fixture` (Impact: 14.7)
  * `StdCaptureFD` (Impact: 14.4)
    * *Intent:* # note: py.io capture tests where copied from # pylib 1.4.20.dev2 (rev 13d9af95547e)
  * `StdCapture` (Impact: 14.4)
  * `TeeStdCapture` (Impact: 14.4)
  * `test_capturing_basic_api` (Impact: 8.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `pytest_runtest_logreport` (Impact: 38.8)
    * *Intent:* """Handle a setup/call/teardown report, generating the appropriate XML tags as necessary. Note: due ...
  * `write_captured_output` (Impact: 15.0)
  * `record_testreport` (Impact: 13.6)
  * `append_skipped` (Impact: 9.7)
  * `append_failure` (Impact: 9.4)
...
- `pytest-9.0.2/src/_pytest/pytester.py` -> **Severity: 2.552** (Bridge: 0.0255 * Flux: 100.0%)
- `pytest-9.0.2/src/_pytest/warnings.py` -> **Severity: 1.711** (Bridge: 0.0198 * Flux: 86.3867%)
- `pytest-9.0.2/src/_pytest/nodes.py` -> **Severity: 1.291** (Bridge: 0.0129 * Flux: 99.9999%)
- `pytest-9.0.2/src/_pytest/fixtures.py` -> **Severity: 1.112** (Bridge: 0.0111 * Flux: 100.0%)
- `pytest-9.0.2/src/_pytest/main.py` -> **Severity: 1.069** (Bridge: 0.0107 * Flux: 99.9999%)
