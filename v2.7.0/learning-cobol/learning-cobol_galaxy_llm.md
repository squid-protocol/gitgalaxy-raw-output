...
- `check-neighbours` (@ `game-of-life.cob`) -> Impact: **15.2** | LOC: 43
- `print-world` (@ `game-of-life.cob`) -> Impact: **5.2** | LOC: 5
- `PLAY-FIZZBUZZ` (@ `fizzbuzz.cob`) -> Impact: **4.9** | LOC: 18
- `iterate-rows` (@ `game-of-life.cob`) -> Impact: **3.1** | LOC: 2
- `iterate-columns` (@ `game-of-life.cob`) -> Impact: **3.1** | LOC: 2
- `A000-FIRST-PARA` (@ `greet.cob`) -> Impact: **1.5** | LOC: 10
- `display-old-row` (@ `game-of-life.cob`) -> Impact: **1.1** | LOC: 2
- `display-new-row` (@ `game-of-life.cob`) -> Impact: **1.1** | LOC: 2
...
- **Heaviest Functions:** `check-neighbours` (Impact: 15.2), `print-world` (Impact: 5.2), `iterate-rows` (Impact: 3.1)
...
- **Heaviest Functions:** `PLAY-FIZZBUZZ` (Impact: 4.9)
...
**Top Internal Functions/Classes:**
  * `check-neighbours` (Impact: 15.2)
  * `print-world` (Impact: 5.2)
  * `iterate-rows` (Impact: 3.1)
  * `iterate-columns` (Impact: 3.1)
  * `display-old-row` (Impact: 1.1)
