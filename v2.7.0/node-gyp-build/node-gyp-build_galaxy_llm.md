...
- `build` (@ `package/bin.js`) -> Impact: **6.1** | LOC: 22
...
- `verbose` (@ `package/bin.js`) -> Impact: **2.1** | LOC: 3
...
- **Heaviest Functions:** `build` (Impact: 6.1), `exec` (Impact: 5.0), `preinstall` (Impact: 3.4)
