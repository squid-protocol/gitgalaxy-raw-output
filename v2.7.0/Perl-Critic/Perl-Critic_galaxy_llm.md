...
- `print_fail_non_local` (@ `t/Variables/RequireLocalizedPunctuationVars.run.PL`) -> Impact: **53.3** | LOC: 83
- `_get_module_abstract_from_filehandle` (@ `lib/Perl/Critic/Utils/POD.pm`) -> Impact: **48.0** | LOC: 81
  * *Intent:* #-----------------------------------------------------------------------------
- `generate_policy_summary` (@ `inc/Perl/Critic/PolicySummaryGenerator.pm`) -> Impact: **17.6** | LOC: 111
  * *Intent:* #-----------------------------------------------------------------------------
- `is_ppi_constant_element` (@ `lib/Perl/Critic/Utils/PPI.pm`) -> Impact: **16.5** | LOC: 18
  * *Intent:* #-----------------------------------------------------------------------------
- `test_is_unchecked_call` (@ `t/05_utils.t`) -> Impact: **16.2** | LOC: 85
  * *Intent:* #-----------------------------------------------------------------------------
- `test_is_perl_and_shebang_line` (@ `t/05_utils.t`) -> Impact: **16.1** | LOC: 62
  * *Intent:* #-----------------------------------------------------------------------------
- `_count_main_logic_operators_and_keywords` (@ `lib/Perl/Critic/Utils/McCabe.pm`) -> Impact: **15.8** | LOC: 35
  * *Intent:* #-----------------------------------------------------------------------------
- `summarize` (@ `examples/generatestats`) -> Impact: **14.6** | LOC: 50
- `RUN` (@ `extras/Dockerfile`) -> Impact: **13.8** | LOC: 17
- `list_platforms` (@ `inc/Devel/CheckOS.pm`) -> Impact: **13.6** | LOC: 31
...
- **Heaviest Functions:** `print_fail_non_local` (Impact: 53.3), `print_pass_local` (Impact: 11.6), `print_pass_non_local_exception` (Impact: 7.9)
...
- **Heaviest Functions:** `has_theme` (Impact: 1.9)
...
- **Heaviest Functions:** `my_sub` (Impact: 1.2), `my_sub` (Impact: 1.2), `my_sub` (Impact: 1.2)
...
- **Heaviest Functions:** `annotate` (Impact: 6.7), `choose_annotation` (Impact: 1.6)
...
- **Heaviest Functions:** `foo` (Impact: 1.4), `grep` (Impact: 1.1), `grep` (Impact: 1.1)
...
- **Heaviest Functions:** `foo` (Impact: 1.3)
...
- **Heaviest Functions:** `check_version` (Impact: 11.1), `read_content` (Impact: 3.5), `check_asserts` (Impact: 2.4)
...
- **Heaviest Functions:** `match` (Impact: 10.6)
...
**Top Internal Functions/Classes:**
  * `test_is_unchecked_call` (Impact: 16.2)
    * *Intent:* #-----------------------------------------------------------------------------
  * `test_is_perl_and_shebang_line` (Impact: 16.1)
    * *Intent:* #-----------------------------------------------------------------------------
  * `test_is_assignment_operator` (Impact: 6.5)
    * *Intent:* #-----------------------------------------------------------------------------
  * `test_is_perl_bareword` (Impact: 5.8)
    * *Intent:* #-----------------------------------------------------------------------------
  * `test_is_script` (Impact: 5.5)
    * *Intent:* #-----------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `print_fail_non_local` (Impact: 53.3)
  * `print_pass_local` (Impact: 11.6)
  * `print_pass_non_local_exception` (Impact: 7.9)
  * `print_fail_non_local_deref` (Impact: 6.6)
  * `print_footer` (Impact: 6.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `is_ppi_constant_element` (Impact: 16.5)
    * *Intent:* #-----------------------------------------------------------------------------
  * `get_constant_name_element_from_declaring_statement` (Impact: 9.8)
    * *Intent:* #-----------------------------------------------------------------------------
  * `is_subroutine_declaration` (Impact: 8.0)
    * *Intent:* #-----------------------------------------------------------------------------
  * `get_previous_module_used_on_same_line` (Impact: 7.9)
    * *Intent:* #-----------------------------------------------------------------------------
  * `get_next_element_in_same_simple_statement` (Impact: 7.8)
    * *Intent:* #-----------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `summarize` (Impact: 14.6)
  * `report_types` (Impact: 11.0)
  * `report_files` (Impact: 6.5)
  * `report_policies` (Impact: 6.2)
  * `report_totals` (Impact: 4.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
...
**Top Internal Functions/Classes:**
  * `list_platforms` (Impact: 13.6)
  * `os_is` (Impact: 9.2)
  * `list_family_members` (Impact: 4.7)
  * `os_isnt` (Impact: 4.6)
  * `die_if_os_isnt` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
...
**Top Internal Functions/Classes:**
  * `prepare_insert_statement` (Impact: 13.2)
  * `load` (Impact: 11.9)
  * `execute_insert_statement` (Impact: 4.2)
...
**Top Internal Functions/Classes:**
  * `_count_main_logic_operators_and_keywords` (Impact: 15.8)
    * *Intent:* #-----------------------------------------------------------------------------
  * `_count_logic_keywords` (Impact: 3.6)
    * *Intent:* #-----------------------------------------------------------------------------
  * `_count_logic_operators` (Impact: 3.6)
    * *Intent:* #-----------------------------------------------------------------------------
  * `calculate_mccabe_of_sub` (Impact: 1.9)
    * *Intent:* #-----------------------------------------------------------------------------
  * `calculate_mccabe_of_main` (Impact: 1.8)
    * *Intent:* #-----------------------------------------------------------------------------
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 2 instances
...
**Top Internal Functions/Classes:**
  * `check_version` (Impact: 11.1)
  * `read_content` (Impact: 3.5)
  * `check_asserts` (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
* *Amplified Cascading Flux:* 4 instances
* *Memory Alloc (weighted view):* 0
