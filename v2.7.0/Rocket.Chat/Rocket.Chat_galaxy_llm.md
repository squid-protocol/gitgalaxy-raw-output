...
| credential | 90 | 27 | 0 | `packages/message-parser/tests/link.test.ts` |
| threat | 1017 | 400 | 0 | `packages/apps-engine/src/server/managers/AppListenerManager.ts` |
...
- `loadAPI` (@ `apps/meteor/ee/server/apps/communication/rest.ts`) -> Impact: **225.7** | LOC: 1233
- `addManagementRoutes` (@ `apps/meteor/ee/server/apps/communication/rest.ts`) -> Impact: **224.6** | LOC: 1212
- `getCharset` (@ `apps/meteor/server/services/messages/hooks/AfterSaveOEmbed.ts`) -> Impact: **182.6** | LOC: 327
...
- `useComposerBoxPopup` (@ `apps/meteor/client/views/room/composer/hooks/useComposerBoxPopup.ts`) -> Impact: **151.9** | LOC: 237
- `executeTriggerUrl` (@ `apps/meteor/app/integrations/server/lib/triggerHandler.ts`) -> Impact: **151.3** | LOC: 297
- `saveUserProfile` (@ `apps/meteor/server/methods/saveUserProfile.ts`) -> Impact: **127.1** | LOC: 172
- `getInitialValue` (@ `apps/meteor/client/views/admin/integrations/outgoing/EditOutgoingWebhook.tsx`) -> Impact: **115.9** | LOC: 31
- `saveDepartment` (@ `apps/meteor/app/livechat/server/lib/departmentsLib.ts`) -> Impact: **114.2** | LOC: 128
...
- `isSettingRange` (@ `packages/core-typings/src/ISetting.ts`) -> Impact: **111.0** | LOC: 99
- `reducer` (@ `apps/uikit-playground/src/Context/reducer.ts`) -> Impact: **110.3** | LOC: 231
...
- **Heaviest Functions:** `editMessage` (Impact: 20.2), `toPreviousMessage` (Impact: 11.9), `toNextMessage` (Impact: 8.2)
...
- **Heaviest Functions:** `executeTriggerUrl` (Impact: 151.3), `getTriggersToExecute` (Impact: 57.2), `mapEventArgsToData` (Impact: 52.6)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `_validateIfAlreadyJoined` (Impact: 35.1), `_validateAccessToPublicRoomsInTeams` (Impact: 22.3), `_validateAccessToPublicRooms` (Impact: 16.2)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `getMore` (Impact: 28.2), `loadSurroundingMessages` (Impact: 17.6), `processMessage` (Impact: 16.3)
...
- **Heaviest Functions:** `checkNewVersionDocument` (Impact: 27.3), `onReady` (Impact: 22.4), `waitUntilCssLoads` (Impact: 9.8)
...
- **Primary Risk Drivers:** Cognitive Load (100.0%), Concurrency (100.0%), Spec Match (100.0%), Documentation (100.0%)
- **Heaviest Functions:** `decryptMessageContent` (Impact: 23.1), `filterMutation` (Impact: 16.0), `decrypt` (Impact: 14.7)
...
- **Heaviest Functions:** `_computeFromInterval` (Impact: 21.0), `jobCallback` (Impact: 17.3), `run` (Impact: 13.7)
...
- **Heaviest Functions:** `sendMessage` (Impact: 52.9), `validateMessage` (Impact: 23.9), `prepareMessageObject` (Impact: 15.4)
...
- **Heaviest Functions:** `getUserFromParams` (Impact: 30.8), `getUserListFromParams` (Impact: 21.1)
...
- **Heaviest Functions:** `setText` (Impact: 34.9), `replaceText` (Impact: 15.2), `wrapSelection` (Impact: 12.2)
...
**Top Internal Functions/Classes:**
  * `getSubscriptionForRoom` (Impact: 12.0)
**Contextual Mitigations & Amplifications:**
...
- `packages/apps-engine/src/server/managers/UIActionButtonManager.ts` -> **Severity: 0.298** (Bridge: 0.0032 * Flux: 93.9509%)
- `packages/apps-engine/src/server/AppManager.ts` -> **Severity: 0.218** (Bridge: 0.0022 * Flux: 98.6166%)
- `apps/meteor/app/ui-utils/client/lib/LegacyRoomManager.ts` -> **Severity: 0.202** (Bridge: 0.0021 * Flux: 96.9116%)
- `packages/apps-engine/deno-runtime/lib/accessors/mod.ts` -> **Severity: 0.134** (Bridge: 0.0014 * Flux: 99.0446%)
- `apps/meteor/client/components/message/variants/RoomMessage.tsx` -> **Severity: 0.109** (Bridge: 0.0016 * Flux: 66.7681%)
