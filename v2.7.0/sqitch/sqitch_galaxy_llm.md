...
- `report_on` (@ `xt/dependency_report`) -> Impact: **43.9** | LOC: 38
- `run` (@ `xt/dependency_report`) -> Impact: **39.3** | LOC: 59
- `change` (@ `t/plan.t`) -> Impact: **18.5** | LOC: 31
- `prag` (@ `t/plan.t`) -> Impact: **13.7** | LOC: 14
- `SELECT_Statement` (@ `lib/App/Sqitch/Engine/Upgrade/oracle-1.1.sql`) -> Impact: **12.5** | LOC: 10
  * *Intent:* -- Rename the dependencies check constraint.
- `new` (@ `inc/Menlo/Sqitch.pm`) -> Impact: **12.1** | LOC: 16
- `is_build` (@ `xt/dependency_report`) -> Impact: **8.9** | LOC: 9
- `tag` (@ `t/plan.t`) -> Impact: **6.4** | LOC: 15
- `configure` (@ `inc/Menlo/Sqitch.pm`) -> Impact: **6.3** | LOC: 13
- `exp_prompt` (@ `t/change.t`) -> Impact: **5.8** | LOC: 17
...
- **Heaviest Functions:** `report_on` (Impact: 43.9), `run` (Impact: 39.3), `is_build` (Impact: 8.9)
...
- **Heaviest Functions:** `_load` (Impact: 1.2)
...
- **Heaviest Functions:** `puke` (Impact: 1.1)
...
- **Heaviest Functions:** `options` (Impact: 1.4)
...
- **Heaviest Functions:** `change` (Impact: 18.5), `prag` (Impact: 13.7), `tag` (Impact: 6.4)
...
- **Heaviest Functions:** `do` (Impact: 3.7)
...
- **Heaviest Functions:** `current_state` (Impact: 3.0), `begin_work` (Impact: 2.0), `finish_work` (Impact: 2.0)
...
- **Heaviest Functions:** `new` (Impact: 12.1), `configure` (Impact: 6.3), `save_meta` (Impact: 4.4)
...
**Top Internal Functions/Classes:**
  * `current_state` (Impact: 3.0)
  * `begin_work` (Impact: 2.0)
  * `finish_work` (Impact: 2.0)
  * `are_deployed_changes` (Impact: 1.5)
  * `change_id_for` (Impact: 1.5)
...
**Top Internal Functions/Classes:**
  * `CREATE_Statement` (Impact: 3.2)
  * `CREATE_Statement` (Impact: 2.1)
  * `CREATE_Statement` (Impact: 2.1)
  * `CREATE_Statement` (Impact: 1.9)
