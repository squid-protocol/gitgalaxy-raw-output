...
| Avg Path Length | 2.2788 | Hops between files. Lower = Tighter coupling. |
...
- `PyEval_EvalFrameEx` (@ `tests/examplefiles/c/ceval.c`) -> Impact: **901.3** | LOC: 2092
- `ASBeautifier::beautify` (@ `tests/examplefiles/cpp/example.cpp`) -> Impact: **605.1** | LOC: 1155
...
- `psb_zbaseprc_aply` (@ `tests/examplefiles/fortran/zmlrpc.f90`) -> Impact: **380.4** | LOC: 651
- `make-hash-table` (@ `tests/examplefiles/scheme/boot-9.scm`) -> Impact: **273.3** | LOC: 1195
  * *Intent:* ;;; {Trivial Functions}
- `get_tokens_unprocessed` (@ `pygments/lexers/pascal.py`) -> Impact: **224.2** | LOC: 223
- `main_inner` (@ `pygments/cmdline.py`) -> Impact: **170.8** | LOC: 333
- `inspect` (@ `tests/examplefiles/rb/example.rb`) -> Impact: **161.4** | LOC: 767
  * *Intent:* # Returns a string containing a human-readable representation of the # set. ("#<Set: {element1, element2, ...}>")
- `AHCON` (@ `tests/examplefiles/fortranfixed/ahcon.f`) -> Impact: **119.8** | LOC: 339
- `Anonymous_Block_[Truncated]` (@ `tests/examplefiles/tcsh/test.tcsh`) -> Impact: **119.1** | LOC: 788
...
- `get_tokens_unprocessed` (@ `pygments/lexers/data.py`) -> Impact: **112.0** | LOC: 230
...
- **Heaviest Functions:** `onmessage` (Impact: 24.3), `loadPyodideAndPygments` (Impact: 2.5)
...
- **Heaviest Functions:** `get_tokens_unprocessed` (Impact: 36.8), `get_tokens_unprocessed` (Impact: 9.1), `__init__` (Impact: 2.1)
...
- **Heaviest Functions:** `__new__` (Impact: 74.8), `style_for_token` (Impact: 20.5), `colorformat` (Impact: 12.0)
...
- **Heaviest Functions:** `get_content_type_subtokens` (Impact: 30.0), `get_body_tokens` (Impact: 24.9), `get_header_tokens` (Impact: 23.2)
...
- **Heaviest Functions:** `onmessage` (Impact: 18.9), `highlight` (Impact: 13.1), `updateCopyLink` (Impact: 5.0)
...
- **Heaviest Functions:** `popstate_kindtest_callback` (Impact: 30.7), `popstate_callback` (Impact: 18.8), `pushstate_operator_order_callback` (Impact: 18.4)
...
- **Heaviest Functions:** `format_unencoded` (Impact: 25.9), `_setup_styles` (Impact: 18.0), `color_string` (Impact: 16.8)
...
- **Heaviest Functions:** `format_unencoded` (Impact: 27.6), `_make_styles` (Impact: 18.0), `_wrap_line` (Impact: 14.9)
...
- **Heaviest Functions:** `header_callback` (Impact: 31.8), `content_callback` (Impact: 16.8), `continuous_header_callback` (Impact: 14.1)
...
**Top Internal Functions/Classes:**
  * `PyEval_EvalFrameEx` (Impact: 901.3)
  * `Py_MakePendingCalls` (Impact: 8.6)
  * `dump_tsc` (Impact: 6.7)
    * *Intent:* #endif
  * `Py_AddPendingCall` (Impact: 6.5)
  * `_Py_CheckRecursiveCall` (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  * `rb_ary_splice` (Impact: 36.7)
  * `rb_ary_initialize` (Impact: 32.8)
    * *Intent:* * a[1]['cat'] = 'Felix' * a * * # here multiple copies are created * a = Array.new(2) { Hash.new } *...
  * `rb_ary_join` (Impact: 30.0)
  * `rb_get_values_at` (Impact: 21.2)
  * `rb_ary_aref` (Impact: 19.8)
...
**Top Internal Functions/Classes:**
  * `202-Show-And-Change-Switches` (Impact: 45.9)
  * `032-Process` (Impact: 33.5)
  * `232-Build-Command` (Impact: 19.1)
    * *Intent:* ***************************************************************** ** Run the compiled program ** ***...
  * `FILE-CONTROL` (Impact: 16.0)
  * `213-Run-Compiler` (Impact: 15.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `get_tokens_unprocessed` (Impact: 27.6)
    * *Intent:* """ Since ERB doesn't allow "<%" and other tags inside of ruby blocks we have to use a split approac...
  * `analyse_text` (Impact: 10.4)
  * `analyse_text` (Impact: 9.1)
  * `analyse_text` (Impact: 7.5)
  * `analyse_text` (Impact: 7.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `_preprocess_lexer_input` (Impact: 31.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000375 | `Ripple Effect (Closeness):` 0.156532
...
**Top Internal Functions/Classes:**
  * `popstate_kindtest_callback` (Impact: 30.7)
  * `popstate_callback` (Impact: 18.8)
  * `pushstate_operator_order_callback` (Impact: 18.4)
  * `pushstate_operator_map_callback` (Impact: 18.4)
  * `pushstate_operator_root_validate` (Impact: 18.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.001239
...
**Top Internal Functions/Classes:**
  * `get_tokens_unprocessed` (Impact: 112.0)
    * *Intent:* """Parse JSON data."""
...
**Top Internal Functions/Classes:**
  * `psb_zbaseprc_aply` (Impact: 380.4)
  * `mlprec_wrk_free` (Impact: 12.3)
  * `psb_zmlprc_aply` (Impact: 7.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `main_inner` (Impact: 170.8)
  * `main` (Impact: 56.5)
    * *Intent:* """ Main command line entry point. """
  * `_print_list` (Impact: 23.7)
  * `_print_list_as_json` (Impact: 14.9)
  * `_parse_options` (Impact: 9.4)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.001376
...
**Top Internal Functions/Classes:**
  * `_process_declaration` (Impact: 53.9)
  * `get_tokens_unprocessed` (Impact: 18.6)
  * `get_tokens_unprocessed` (Impact: 16.7)
  * `get_tokens_unprocessed` (Impact: 14.4)
    * *Intent:* # Recognizing builtins.
  * `_process_declarations` (Impact: 12.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 1 instances
* *Amplified Rce:* 1 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.002252
...
**Top Internal Functions/Classes:**
  * `_tokenize` (Impact: 22.8)
  * `_tokenize` (Impact: 16.7)
  * `_tokenize` (Impact: 13.7)
  * `_variable_state` (Impact: 12.5)
  * `tokenize` (Impact: 12.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 73 instances
...
**Top Internal Functions/Classes:**
  * `get_tokens_unprocessed` (Impact: 224.2)
  * `__init__` (Impact: 13.1)
  * `__init__` (Impact: 1.9)
  * `get_tokens_unprocessed` (Impact: 1.8)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1.7e-05 | `Ripple Effect (Closeness):` 0.000688
...
**Top Internal Functions/Classes:**
  * `_handle_sourcecode` (Impact: 48.7)
  * `_handle_codeblock` (Impact: 39.4)
  * `_handle_codeblock` (Impact: 27.4)
    * *Intent:* """ match args: 1:backticks, 2:lang_name, 3:newline, 4:code, 5:backticks """
  * `handle_score` (Impact: 25.4)
  * `handle_syntaxhighlight` (Impact: 23.9)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.001549
...
**Top Internal Functions/Classes:**
  ...
  * `_create_mac` (Impact: 21.2)
  * `get_font` (Impact: 21.2)
...
**Top Internal Functions/Classes:**
  * `_make_begin_state` (Impact: 93.4)
  * `get_tokens_unprocessed` (Impact: 41.1)
  * `_make_label_state` (Impact: 23.2)
  * `_make_follow_state` (Impact: 19.9)
  * `get_tokens_unprocessed` (Impact: 12.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  * `Ecosystem Role:` Transceiver (Middle-Tier) | `Dependency Blast Radius (PageRank):` 0.847
  * `Choke Point (Betweenness):` 4e-06 | `Ripple Effect (Closeness):` 0.002202
...
**Top Internal Functions/Classes:**
  * `analyse_text` (Impact: 49.3)
    * *Intent:* """ Perform a structural analysis for basic Easytrieve constructs. """
  * `get_tokens_unprocessed` (Impact: 19.0)
  * `get_tokens_unprocessed` (Impact: 11.0)
  * `__init__` (Impact: 7.9)
  * `analyse_text` (Impact: 7.9)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 1e-05 | `Ripple Effect (Closeness):` 0.002065
...
**Top Internal Functions/Classes:**
  * `language_callback` (Impact: 55.4)
    * *Intent:* """Parse the content of a $-string using a lexer The lexer is chosen looking for a nearby LANGUAGE o...
  * `get_tokens_unprocessed` (Impact: 37.6)
  * `get_tokens_unprocessed` (Impact: 23.9)
  * `_get_lexer` (Impact: 14.9)
  * `analyse_text` (Impact: 14.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 62 instances
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 2.9e-05 | `Ripple Effect (Closeness):` 0.003539
...
- `pygments/lexer.py` -> **Severity: 0.037** (Bridge: 0.0004 * Flux: 100.0%)
- `pygments/lexers/html.py` -> **Severity: 0.006** (Bridge: 0.0001 * Flux: 99.4357%)
- `pygments/lexers/modeling.py` -> **Severity: 0.004** (Bridge: 0.0 * Flux: 99.7739%)
- `pygments/lexers/perl.py` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.9855%)
- `pygments/lexers/sql.py` -> **Severity: 0.003** (Bridge: 0.0 * Flux: 99.9997%)
