...
- `showDoomFire` (@ `src/main.zig`) -> Impact: **23.6** | LOC: 132
- `checkTermSz` (@ `src/main.zig`) -> Impact: **16.4** | LOC: 69
...
- `initTermWin` (@ `src/main.zig`) -> Impact: **11.5** | LOC: 30
  * *Intent:* // Windows specific terminal initialization
- `scrollMarquee` (@ `src/main.zig`) -> Impact: **9.3** | LOC: 67
- `getTermSzLinux` (@ `src/main.zig`) -> Impact: **8.8** | LOC: 35
- `emit` (@ `src/main.zig`) -> Impact: **7.9** | LOC: 17
  * *Intent:* // print
- `show216Colors` (@ `src/main.zig`) -> Impact: **6.8** | LOC: 37
- `showStdColors` (@ `src/main.zig`) -> Impact: **6.5** | LOC: 29
- `paintBuf` (@ `src/main.zig`) -> Impact: **6.2** | LOC: 25
  * *Intent:* //print buffer to string...can be a decent amount of text!
- `getTermSzWin` (@ `src/main.zig`) -> Impact: **4.8** | LOC: 17
...
- **Heaviest Functions:** `showDoomFire` (Impact: 23.6), `checkTermSz` (Impact: 16.4), `initTermWin` (Impact: 11.5)
...
**Top Internal Functions/Classes:**
  * `showDoomFire` (Impact: 23.6)
  * `checkTermSz` (Impact: 16.4)
    * *Intent:* /// Part I - Terminal Size Check /// showTermCap() needs about 120x22; if screen is too small, give ...
  * `initTermWin` (Impact: 11.5)
    * *Intent:* // Windows specific terminal initialization
  * `scrollMarquee` (Impact: 9.3)
  * `getTermSzLinux` (Impact: 8.8)
