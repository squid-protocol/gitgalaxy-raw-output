...
| Avg Path Length | 3.1928 | Hops between files. Lower = Tighter coupling. |
...
- `applyHandlerOptions` (@ `src/Handler/CurlFactory.php`) -> Impact: **122.4** | LOC: 197
- `GuzzleServer` (@ `tests/server.js`) -> Impact: **102.1** | LOC: 206
  * *Intent:* /** * Guzzle node.js server * @class */
- `controlRequest` (@ `tests/server.js`) -> Impact: **67.8** | LOC: 76
- `applyOptions` (@ `src/Client.php`) -> Impact: **61.9** | LOC: 129
  * *Intent:* /** * Applies the array of request options to a request. */
- `createStream` (@ `src/Handler/StreamHandler.php`) -> Impact: **39.0** | LOC: 87
  * *Intent:* /** * @return resource */
- `__invoke` (@ `src/Handler/MockHandler.php`) -> Impact: **31.0** | LOC: 66
- `setCookie` (@ `src/Cookie/CookieJar.php`) -> Impact: **27.0** | LOC: 59
...
- `modifyRequest` (@ `src/RedirectMiddleware.php`) -> Impact: **26.4** | LOC: 48
...
- **Heaviest Functions:** `setCookie` (Impact: 27.0), `clear` (Impact: 23.6), `withCookieHeader` (Impact: 13.9)
...
- **Heaviest Functions:** `tap` (Impact: 9.5), `log` (Impact: 9.3), `httpErrors` (Impact: 6.7)
...
- **Heaviest Functions:** `__construct` (Impact: 9.4), `tick` (Impact: 8.8), `processMessages` (Impact: 7.2)
...
- **Heaviest Functions:** `addExpectHeader` (Impact: 21.8), `__invoke` (Impact: 19.2), `__construct` (Impact: 1.6)
...
- **Heaviest Functions:** `isHostInNoProxy` (Impact: 15.6), `idnUriConvert` (Impact: 15.5), `chooseHandler` (Impact: 12.2)
...
- **Heaviest Functions:** `applyHandlerOptions` (Impact: 122.4), `applyBody` (Impact: 21.9), `createRejection` (Impact: 20.4)
...
- **Heaviest Functions:** `__invoke` (Impact: 31.0), `append` (Impact: 10.6), `__construct` (Impact: 10.5)
...
- **Heaviest Functions:** `splice` (Impact: 14.4), `remove` (Impact: 6.4), `debugCallable` (Impact: 6.4)
...
**Top Internal Functions/Classes:**
  * `applyHandlerOptions` (Impact: 122.4)
  * `applyBody` (Impact: 21.9)
  * `createRejection` (Impact: 20.4)
  * `retryFailedRewind` (Impact: 17.8)
...
**Top Internal Functions/Classes:**
  * `createStream` (Impact: 39.0)
    * *Intent:* /** * @return resource */
  * `__invoke` (Impact: 25.4)
  ...
  * `resolveHost` (Impact: 20.3)
  * `createResponse` (Impact: 18.1)
...
**Top Internal Functions/Classes:**
  * `testCreatesCurlHandle` (Impact: 8.0)
  * `checkNoProxyForHost` (Impact: 6.8)
  * `addDecodeResponse` (Impact: 3.5)
  * `testBodyEofOnWindows` (Impact: 3.2)
    * *Intent:* /** * https://github.com/guzzle/guzzle/issues/2735 */
  * `testCreatesConnectException` (Impact: 3.1)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
**Top Internal Functions/Classes:**
  * `testCanSendMultipartWithExplicitBody` (Impact: 3.2)
  * `testCanSendMultipart` (Impact: 2.9)
  * `testUsesProxyEnvironmentVariables` (Impact: 2.7)
  * `testIdnWithRedirect` (Impact: 2.4)
    * *Intent:* /** * @requires extension idn */
  * `testCanMergeOnBaseUriWithRequest` (Impact: 2.0)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 3 instances
...
**Top Internal Functions/Classes:**
  * `testStreamAttributeKeepsStreamOpen` (Impact: 4.3)
  * `testAutomaticallyDecompressGzip` (Impact: 2.9)
  * `testAutomaticallyDecompressGzipHead` (Impact: 2.9)
  * `testHandlesGarbageHttpServerGracefully` (Impact: 2.9)
  * `testHandlesInvalidStatusCodeGracefully` (Impact: 2.7)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `testRemoveCurlAuthorizationOptionsOnRedirectCrossScheme` (Impact: 8.3)
    * *Intent:* /** * @testWith ["digest"] * ["ntlm"] */
  * `testRemoveCurlAuthorizationOptionsOnRedirectCrossSchemeSamePort` (Impact: 8.3)
    * *Intent:* /** * @testWith ["digest"] * ["ntlm"] */
  * `testNotRemoveCurlAuthorizationOptionsOnRedirect` (Impact: 8.3)
    * *Intent:* /** * @testWith ["digest"] * ["ntlm"] */
  * `testRemoveCurlAuthorizationOptionsOnRedirectCrossHost` (Impact: 6.9)
    * *Intent:* /** * @testWith ["digest"] * ["ntlm"] */
  * `testRemoveCurlAuthorizationOptionsOnRedirectCrossPort` (Impact: 6.9)
    * *Intent:* /** * @testWith ["digest"] * ["ntlm"] */
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `GuzzleServer` (Impact: 102.1)
    * *Intent:* /** * Guzzle node.js server * @class */
  * `controlRequest` (Impact: 67.8)
  * `loadAuthentifier` (Impact: 20.7)
...
**Top Internal Functions/Classes:**
  * `setCookie` (Impact: 27.0)
  * `clear` (Impact: 23.6)
  * `withCookieHeader` (Impact: 13.9)
  * `extractCookies` (Impact: 13.1)
  * `getCookiePathFromRequest` (Impact: 9.4)
...
**Top Internal Functions/Classes:**
  * `testReturnsCookiesMatchingRequests` (Impact: 6.0)
    * *Intent:* /** * @dataProvider getMatchingCookiesDataProvider */
  * `testIgnoresCookiesForMismatchingDomains` (Impact: 4.7)
    * *Intent:* /** * @dataProvider getDomainMatchesProvider */
  * `testDeletesCookiesByName` (Impact: 3.1)
  * `testRemovesSelectively` (Impact: 3.0)
  * `testOverwritesCookiesThatAreOlderOrDiscardable` (Impact: 2.8)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testInvokesOnStatsFunctionForError` (Impact: 2.0)
  * `testRejectsPromiseWhenOnHeadersFails` (Impact: 1.8)
  * `testInvokesOnStatsFunctionForResponse` (Impact: 1.8)
  * `testTransferTime` (Impact: 1.8)
  * `testSinkFilename` (Impact: 1.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  ...
  * `getResponse` (Impact: 2.2)
    * *Intent:* /** * Get the associated response */
  * `getRequest` (Impact: 1.2)
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `testTapsBeforeAndAfter` (Impact: 2.5)
  * `testTracksHistory` (Impact: 2.3)
    * *Intent:* /** * @dataProvider getHistoryUseCases */
  * `testAddsCookiesToRequests` (Impact: 2.0)
  * `testMapsRequest` (Impact: 1.9)
  * `testLogsRequestsAndErrors` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `getClient` (Impact: 3.3)
  * `testUsesYieldedKeyInFulfilledCallback` (Impact: 2.5)
  * `testCanProvideCallablesThatReturnResponses` (Impact: 2.2)
  * `testBatchesResults` (Impact: 2.1)
  * `testExecutesPendingWhenWaiting` (Impact: 2.0)
...
**Top Internal Functions/Classes:**
  * `testParseCookie` (Impact: 15.7)
    * *Intent:* /** * @dataProvider cookieParserDataProvider */
  * `testValidatesCookies` (Impact: 2.7)
    * *Intent:* /** * @dataProvider cookieValidateProvider */
  * `cookieValidateProvider` (Impact: 2.6)
  * `testHoldsValues` (Impact: 2.5)
  * `testMatchesDomain` (Impact: 2.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `addExpectHeader` (Impact: 21.8)
    * *Intent:* /** * Add expect header */
  * `__invoke` (Impact: 19.2)
  * `__construct` (Impact: 1.6)
