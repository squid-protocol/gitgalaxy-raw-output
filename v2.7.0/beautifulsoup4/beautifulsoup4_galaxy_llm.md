...
| Avg Path Length | 2.1355 | Hops between files. Lower = Tighter coupling. |
...
- `__init__` (@ `beautifulsoup4-4.14.3/bs4/__init__.py`) -> Impact: **200.7** | LOC: 283
- `__init__` (@ `beautifulsoup4-4.14.3/bs4/element.py`) -> Impact: **124.8** | LOC: 120
- `_find_all` (@ `beautifulsoup4-4.14.3/bs4/element.py`) -> Impact: **72.2** | LOC: 65
- `decode` (@ `beautifulsoup4-4.14.3/bs4/element.py`) -> Impact: **56.8** | LOC: 108
- `_insert` (@ `beautifulsoup4-4.14.3/bs4/element.py`) -> Impact: **50.3** | LOC: 86
- `decode` (@ `beautifulsoup4-4.14.3/bs4/__init__.py`) -> Impact: **48.6** | LOC: 72
- `linkage_validator` (@ `beautifulsoup4-4.14.3/bs4/tests/__init__.py`) -> Impact: **48.5** | LOC: 130
- `__init__` (@ `beautifulsoup4-4.14.3/bs4/filter.py`) -> Impact: **42.2** | LOC: 60
- `_format_tag` (@ `beautifulsoup4-4.14.3/bs4/element.py`) -> Impact: **38.8** | LOC: 61
- `matches_tag` (@ `beautifulsoup4-4.14.3/bs4/filter.py`) -> Impact: **38.5** | LOC: 77
...
- **Heaviest Functions:** `diagnose` (Impact: 19.7), `lxml_trace` (Impact: 9.1), `rdoc` (Impact: 8.1)
...
- **Heaviest Functions:** `__init__` (Impact: 22.6), `lookup` (Impact: 21.3), `_replace_cdata_list_attribute_values` (Impact: 20.8)
...
- **Heaviest Functions:** `__init__` (Impact: 124.8), `_find_all` (Impact: 72.2), `decode` (Impact: 56.8)
...
- **Heaviest Functions:** `__init__` (Impact: 200.7), `decode` (Impact: 48.6), `_markup_resembles_filename` (Impact: 24.0)
...
- **Heaviest Functions:** `appendChild` (Impact: 30.3), `reparentChildren` (Impact: 23.0), `__init__` (Impact: 16.3)
...
- **Heaviest Functions:** `__init__` (Impact: 42.2), `matches_tag` (Impact: 38.5), `__init__` (Impact: 30.8)
...
- **Heaviest Functions:** `detwingle` (Impact: 37.0), `__init__` (Impact: 36.5), `_populate_class_variables` (Impact: 36.2)
...
- **Heaviest Functions:** `start` (Impact: 26.8), `end` (Impact: 13.2), `__init__` (Impact: 11.0)
...
- **Heaviest Functions:** `match` (Impact: 9.2), `select` (Impact: 7.1), `__init__` (Impact: 6.5)
...
- **Heaviest Functions:** `handle_starttag` (Impact: 34.4), `prepare_markup` (Impact: 20.7), `__init__` (Impact: 12.6)
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 124.8)
  * `_find_all` (Impact: 72.2)
  * `decode` (Impact: 56.8)
  * `_insert` (Impact: 50.3)
  * `_format_tag` (Impact: 38.8)
...
**Top Internal Functions/Classes:**
  * `test_parent_generator` (Impact: 6.0)
  * `test_self_and_parent_generator` (Impact: 6.0)
  * `test_next_generators` (Impact: 4.8)
  * `test_insert_beautifulsoup_object_inserts_children` (Impact: 3.8)
    * *Intent:* """Inserting one BeautifulSoup object into another actually inserts all of its children -- you'll ne...
  * `test_smooth` (Impact: 3.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `__init__` (Impact: 42.2)
  * `matches_tag` (Impact: 38.5)
  ...
  * `allow_tag_creation` (Impact: 28.8)
  * `_make_match_rules` (Impact: 28.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `linkage_validator` (Impact: 48.5)
  * `assert_soup` (Impact: 9.2)
  * `test_python_specific_encodings_not_used_in_charset` (Impact: 6.9)
    * *Intent:* # You can encode an HTML document using a Python-specific # encoding, but that encoding won't be men...
  * `assertConnectedness` (Impact: 5.7)
    * *Intent:* """Ensure that next_element and previous_element are properly set for all descendants of the given e...
  * `test_python_specific_encodings_not_used_in_xml_declaration` (Impact: 5.3)
...
**Top Internal Functions/Classes:**
  ...
  * `_replace_cdata_list_attribute_values` (Impact: 20.8)
  * `warn_if_markup_looks_like_xml` (Impact: 15.7)
  * `set_up_substitutions` (Impact: 13.0)
...
**Top Internal Functions/Classes:**
  * `test_match` (Impact: 10.9)
  * `allow_tag_creation` (Impact: 9.5)
  * `tag_matches` (Impact: 8.8)
  * `test_allow_tag_creation` (Impact: 7.9)
    * *Intent:* # By default, ElementFilter.allow_tag_creation allows everything. filter = ElementFilter() f = filte...
  * `test_default_behavior` (Impact: 6.5)
...
**Top Internal Functions/Classes:**
  * `assert_css_selects` (Impact: 5.1)
  * `test_match` (Impact: 4.5)
  * `test_select_one_returns_none_if_no_match` (Impact: 4.4)
  * `assert_css_select_multiple` (Impact: 3.6)
  * `test_select_duplicate_elements` (Impact: 3.5)
...
**Top Internal Functions/Classes:**
  ...
  * `feed` (Impact: 9.9)
  * `_prefix_for_namespace` (Impact: 9.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_deprecated_renderContents` (Impact: 4.8)
  * `test_formatter_is_run_on_attribute_values` (Impact: 2.2)
  * `test_encode_deeply_nested_document` (Impact: 1.9)
    * *Intent:* # This test verifies that encoding a string doesn't involve # any recursive function calls. If it di...
  * `test_formatter_html` (Impact: 1.9)
  * `test_formatter_html5` (Impact: 1.9)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 2 instances
...
**Top Internal Functions/Classes:**
  * `test_deprecated_member_access` (Impact: 3.3)
  * `test_string_methods_inside_special_string_container_tags` (Impact: 3.0)
    * *Intent:* # Strings inside tags like <script> are generally ignored by # methods like get_text, because they'r...
  * `test__should_pretty_print` (Impact: 2.3)
  ...
  * `test_tag_with_multiple_children_has_no_string` (Impact: 2.1)
...
**Top Internal Functions/Classes:**
  * `test_correctly_nested_tables` (Impact: 2.6)
    * *Intent:* """html5lib inserts <tbody> tags where other parsers don't."""
  * `test_reparented_markup_containing_children` (Impact: 2.3)
  * `test_soupstrainer` (Impact: 2.1)
    * *Intent:* # The html5lib tree builder does not support parse_only. strainer = SoupStrainer("b") markup = "<p>A...
  * `test_xml_declaration_followed_by_doctype` (Impact: 2.1)
  * `test_reparented_markup_containing_identical_whitespace_nodes` (Impact: 1.9)
...
**Top Internal Functions/Classes:**
  * `test_empty_attributes_are_booleans` (Impact: 7.1)
...
**Top Internal Functions/Classes:**
  * `test_namespace_indexing` (Impact: 4.0)
  * `test_namespace_interaction_with_select_and_find` (Impact: 3.4)
    * *Intent:* # Demonstrate how namespaces interact with select* and # find* methods. soup = self.soup( '<?xml ver...
  * `test_huge_tree` (Impact: 2.8)
  ...
  * `test_out_of_range_entity` (Impact: 2.1)
