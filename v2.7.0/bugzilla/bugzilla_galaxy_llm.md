...
| Avg Path Length | 2.3053 | Hops between files. Lower = Tighter coupling. |
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 38.4 | 15.1 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 14.3 | 2.3 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 7.5 | 3.8 | 0.0 |
...
| connectivity | 3519 | 356 | 15 | `Bugzilla/Bug.pm` |
...
| dead_code | 257 | 107 | 1 | `Bugzilla/DB/Schema.pm` |
| credential | 0 | 0 | 0 | - |
...
- `_convert_attachment_statuses_to_flags` (@ `Bugzilla/Install/DB.pm`) -> Impact: **1126.1** | LOC: 1754
- `bz_setup_database` (@ `Bugzilla/DB/MariaDB.pm`) -> Impact: **970.9** | LOC: 993
- `bz_setup_database` (@ `Bugzilla/DB/Mysql.pm`) -> Impact: **966.4** | LOC: 993
- `_add_unique_login_name_index_to_profiles` (@ `Bugzilla/Install/DB.pm`) -> Impact: **756.4** | LOC: 1753
- `_update_bugs_activity_to_only_record_changes` (@ `Bugzilla/Install/DB.pm`) -> Impact: **746.2** | LOC: 1746
- `process_bug` (@ `importxml.pl`) -> Impact: **465.8** | LOC: 864
...
- `create` (@ `Bugzilla/Template.pm`) -> Impact: **462.1** | LOC: 499
...
- `update` (@ `Bugzilla/Bug.pm`) -> Impact: **203.9** | LOC: 336
- `Send` (@ `Bugzilla/BugMail.pm`) -> Impact: **147.4** | LOC: 268
...
- `Bugzilla/Auth/Login/Stack.pm` -> **6** Orphaned Functions | **0** Duplicates
- `Bugzilla/Auth/Verify/Stack.pm` -> **6** Orphaned Functions | **0** Duplicates
...
### 1. `js/bug.js` (JAVASCRIPT) -> Cumulative Risk: **706.51**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 174.0 | **LOC:** 244 | **CtrlFlow:** 14.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9992%), Safety Score (98.6733%)
- **Heaviest Functions:** `set_assign_to` (Impact: 31.8), `formatStatus` (Impact: 7.3), `doBeforeParseData` (Impact: 6.5)

### 2. `extensions/Voting/Extension.pm` (PERL) -> Cumulative Risk: **690.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_update_votes` (Impact: 72.7), `_page_user` (Impact: 40.5), `_remove_votes` (Impact: 25.4)

### 3. `js/comments.js` (JAVASCRIPT) -> Cumulative Risk: **682.57**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 128.34 | **LOC:** 166 | **CtrlFlow:** 19.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (99.125%)
- **Heaviest Functions:** `wrapReplyText` (Impact: 12.2), `toggle_all_comments` (Impact: 9.6), `getText` (Impact: 7.8)

### 4. `Bugzilla/Template.pm` (PERL) -> Cumulative Risk: **667.26**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `create` (Impact: 462.1), `quoteUrls` (Impact: 115.0), `get_format` (Impact: 24.3)

### 5. `contrib/bugzilla-submit/bugzilla-submit` (PYTHON) -> Cumulative Risk: **660.16**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `check_result_POST` (Impact: 34.6), `validate_fields` (Impact: 13.9), `ensure_defaults` (Impact: 12.1)

### 6. `js/expanding-tree.js` (JAVASCRIPT) -> Cumulative Risk: **654.66**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `changeChildren` (Impact: 29.4), `doToggle` (Impact: 15.1), `duplicated` (Impact: 11.0)

### 7. `Bugzilla/Migrate/Gnats.pm` (PERL) -> Cumulative Risk: **646.06**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `_parse_audit_trail` (Impact: 54.4), `_parse_attachments` (Impact: 42.0), `translate_value` (Impact: 39.7)

### 8. `importxml.pl` (PERL) -> Cumulative Risk: **644.47**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
...
- **Heaviest Functions:** `process_bug` (Impact: 465.8), `flag_handler` (Impact: 119.6), `process_attachment` (Impact: 34.7)

### 9. `Bugzilla/Comment.pm` (PERL) -> Cumulative Risk: **640.14**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 324.32 | **LOC:** 647 | **CtrlFlow:** 21.7% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.7708%), State Flux (99.2344%)
- **Heaviest Functions:** `update` (Impact: 38.4), `_check_extra_data` (Impact: 21.5), `_check_bug_when` (Impact: 16.3)

### 10. `email_in.pl` (PERL) -> Cumulative Risk: **636.2**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 389.18 | **LOC:** 708 | **CtrlFlow:** 27.4% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Tech Debt (99.9999%), State Flux (99.9999%), Safety Score (91.9518%)
- **Heaviest Functions:** `parse_mail` (Impact: 60.9), `handle_attachments` (Impact: 22.1), `split_body_and_attachments` (Impact: 17.2)
...
- **Magnitude:** 4038.98 | **LOC:** 5124 | **CtrlFlow:** 30.4% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (46.8839%), Tech Debt (99.9987%)
**Top Internal Functions/Classes:**
  * `update` (Impact: 203.9)
  * `get_activity` (Impact: 129.2)
    * *Intent:* # Get the activity of a bug, starting from $starttime (if given). # This routine assumes Bugzilla::B...
  * `_check_bug_status` (Impact: 76.7)
  * `create` (Impact: 71.2)
    * *Intent:* # C<status_whiteboard> - A string. # C<bug_status> - The initial status of the bug, a string. # C<bu...
  * `check_can_change_field` (Impact: 69.0)
...
* *Risk/State:* `safety_bypasses: 1`, `high_risk_execution: 2`, `state_mutation: 476`, `dead_code: 5`, `fragile_debt: 215`, `unreferenced_by_name: 1`
* *Architecture:* `api: 138`, `import: 40`
...
**Top Internal Functions/Classes:**
  * `_convert_attachment_statuses_to_flags` (Impact: 1126.1)
  * `_add_unique_login_name_index_to_profiles` (Impact: 756.4)
  * `_update_bugs_activity_to_only_record_changes` (Impact: 746.2)
  * `_convert_groups_system_from_groupset` (Impact: 54.5)
  * `_initialize_workflow_for_upgrade` (Impact: 53.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `match_field` (Impact: 112.3)
  * `wants_bug_mail` (Impact: 77.7)
    * *Intent:* # Returns true if the user wants mail for a given bug change. # Note: the "+" signs before the const...
  * `match` (Impact: 48.6)
  * `validate_password_check` (Impact: 48.4)
  * `can_enter_product` (Impact: 44.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `bz_setup_database` (Impact: 970.9)
  * `_fix_defaults` (Impact: 26.7)
    * *Intent:* # When you import a MySQL 3/4 mysqldump into MySQL 5, columns that # aren't supposed to have default...
  * `BUILDARGS` (Impact: 23.9)
  * `sql_fulltext_search` (Impact: 23.7)
  * `bz_index_info_real` (Impact: 17.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `bz_setup_database` (Impact: 966.4)
  * `_fix_defaults` (Impact: 26.7)
    * *Intent:* # When you import a MySQL 3/4 mysqldump into MySQL 5, columns that # aren't supposed to have default...
  * `BUILDARGS` (Impact: 23.9)
  * `sql_fulltext_search` (Impact: 23.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.003185
...
**Top Internal Functions/Classes:**
  * `notify` (Impact: 130.8)
  * `extract_flags_from_cgi` (Impact: 117.3)
  * `set_flag` (Impact: 79.3)
    * *Intent:* ###################################################################### # Creating and Modifying ####...
  * `_check_requestee` (Impact: 75.7)
  * `multi_extract_flags_from_cgi` (Impact: 68.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_bug_to_hash` (Impact: 83.5)
    * *Intent:* ############################## # Private Helper Subroutines # ############################## # A hel...
  * `search` (Impact: 52.3)
  * `_legal_field_values` (Impact: 40.3)
  * `update_attachment` (Impact: 30.8)
  * `update_comment_tags` (Impact: 26.3)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `get_alter_column_ddl` (Impact: 93.1)
  ...
  * `deserialize_abstract` (Impact: 23.5)
...
**Top Internal Functions/Classes:**
  * `bz_check_server_version` (Impact: 37.0)
  * `bz_add_column` (Impact: 29.3)
  ...
  * `bz_add_fks` (Impact: 19.4)
  * `bz_alter_column_raw` (Impact: 19.2)
...
- **Magnitude:** 712.48 | **LOC:** 1117 | **CtrlFlow:** 20.5% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (54.0539%), Tech Debt (9.7803%)
**Top Internal Functions/Classes:**
  * `showEditableField` (Impact: 26.2)
    * *Intent:* /* showEditableField (e, ContainerInputArray) * Function hides the (edit) link and the text and disp...
  * `setFieldFromCalendar` (Impact: 25.9)
    * *Intent:* /* This is the selectEvent for our Calendar objects on our custom * DateTime fields. */
  * `validateEnterBug` (Impact: 23.0)
  * `showHideStatusItems` (Impact: 21.2)
  * `handleVisControllerValueChange` (Impact: 20.4)
...
* *Risk/State:* `safety_bypasses: 35`, `high_risk_execution: 5`, `state_mutation: 112`, `dead_code: 3`, `fragile_debt: 1`
* *Architecture:* `api: 20`
...
**Top Internal Functions/Classes:**
  ...
  * `_do_list_select` (Impact: 37.9)
  * `update` (Impact: 36.1)
  * `_load_from_db` (Impact: 29.2)
...
**Top Internal Functions/Classes:**
  * `datetime_from` (Impact: 36.3)
  * `diff_arrays` (Impact: 36.0)
  * `format_time` (Impact: 29.3)
  * `join_activity_entries` (Impact: 25.6)
  * `html_light_quote` (Impact: 21.3)
**Contextual Mitigations & Amplifications:**
* *Mitigated Memory Allocs:* 1 instances
...
**Top Internal Functions/Classes:**
  * `insert_bugs` (Impact: 64.3)
  * `create_legal_values` (Impact: 41.3)
  * `translate_value` (Impact: 20.1)
  * `_generate_description` (Impact: 16.7)
  * `translate_bug` (Impact: 15.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `_parse_audit_trail` (Impact: 54.4)
  * `_parse_attachments` (Impact: 42.0)
  * `translate_value` (Impact: 39.7)
  * `_get_gnats_field_data` (Impact: 29.4)
  * `translate_bug` (Impact: 18.3)
...
**Top Internal Functions/Classes:**
  * `bug_check_can_change_field` (Impact: 22.8)
  * `email_in_after_parse` (Impact: 17.2)
  * `bug_start_of_update` (Impact: 13.9)
  * `bug_end_of_update` (Impact: 13.9)
  * `error_catch` (Impact: 13.5)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `bz_setup_database` (Impact: 41.8)
    * *Intent:* ##################################################################### # Custom Database Setup ######...
  * `adjust_statement` (Impact: 29.7)
  * `BUILDARGS` (Impact: 13.2)
  * `selectall_arrayref` (Impact: 13.1)
  * `sql_in` (Impact: 11.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `update` (Impact: 55.2)
  * `set_group_controls` (Impact: 37.3)
  * `remove_from_db` (Impact: 21.6)
  * `groups_available` (Impact: 19.6)
  * `group_controls` (Impact: 18.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `get_alter_column_ddl` (Impact: 96.9)
  * `_get_alter_type_sql` (Impact: 59.6)
  * `get_add_column_ddl` (Impact: 18.7)
  * `get_add_fks_sql` (Impact: 15.4)
  * `get_rename_table_sql` (Impact: 13.5)
**Contextual Mitigations & Amplifications:**
...
- `js/field.js` -> **Severity: 347.7** (Blast Radius: 4.275 * Doc Risk: 81.3333%)
