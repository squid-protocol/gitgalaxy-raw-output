...
| Avg Path Length | 3.2042 | Hops between files. Lower = Tighter coupling. |
...
- `prepare_mac_header` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/tokens.py`) -> Impact: **77.9** | LOC: 104
- `sign` (@ `oauthlib-3.3.1/oauthlib/oauth1/rfc5849/__init__.py`) -> Impact: **60.7** | LOC: 103
...
- `prepare_request_body` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/clients/service_application.py`) -> Impact: **60.4** | LOC: 126
- `validate_token_request` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/grant_types/authorization_code.py`) -> Impact: **52.2** | LOC: 109
  * *Intent:* """ :param request: OAuthlib request. :type request: oauthlib.common.Request """
- `validate_metadata` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/endpoints/metadata.py`) -> Impact: **46.5** | LOC: 24
- `collect_parameters` (@ `oauthlib-3.3.1/oauthlib/oauth1/rfc5849/signature.py`) -> Impact: **38.5** | LOC: 85
- `validate_authorization_request` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/grant_types/authorization_code.py`) -> Impact: **35.2** | LOC: 115
...
- `openid_authorization_validator` (@ `oauthlib-3.3.1/oauthlib/openid/connect/core/grant_types/base.py`) -> Impact: **35.1** | LOC: 182
...
- `validate_token_request` (@ `oauthlib-3.3.1/oauthlib/oauth2/rfc6749/grant_types/refresh_token.py`) -> Impact: **34.4** | LOC: 65
  * *Intent:* """ :param request: OAuthlib request. :type request: oauthlib.common.Request """
- `_check_signature` (@ `oauthlib-3.3.1/oauthlib/oauth1/rfc5849/endpoints/base.py`) -> Impact: **33.1** | LOC: 62
...
- **Heaviest Functions:** `_check_signature` (Impact: 33.1), `_create_request` (Impact: 28.8), `_check_mandatory_parameters` (Impact: 20.5)
...
- **Heaviest Functions:** `prepare_mac_header` (Impact: 77.9), `create_token` (Impact: 24.3), `__init__` (Impact: 10.7)
...
- **Heaviest Functions:** `collect_parameters` (Impact: 38.5), `base_string_uri` (Impact: 30.7), `_verify_hmac` (Impact: 12.6)
...
- **Heaviest Functions:** `sign` (Impact: 60.7), `get_oauth_params` (Impact: 20.8), `_render` (Impact: 17.5)
...
- **Heaviest Functions:** `create_authorization_response` (Impact: 9.3), `validate_authorization_request` (Impact: 3.0), `__init__` (Impact: 2.5)
...
- **Heaviest Functions:** `prepare_authorization_response` (Impact: 23.1), `_handle_redirects` (Impact: 13.3), `_create_cors_headers` (Impact: 9.5)
...
- **Heaviest Functions:** `openid_authorization_validator` (Impact: 35.1), `add_id_token` (Impact: 25.6), `__setattr__` (Impact: 6.3)
...
- **Heaviest Functions:** `is_uri` (Impact: 2.9), `is_uri_reference` (Impact: 2.9), `is_absolute_uri` (Impact: 2.9)
...
- **Heaviest Functions:** `__init__` (Impact: 21.2), `headers` (Impact: 6.5), `twotuples` (Impact: 6.1)
...
- **Heaviest Functions:** `add_token` (Impact: 28.1), `prepare_authorization_request` (Impact: 17.7), `populate_token_attributes` (Impact: 16.8)
...
**Top Internal Functions/Classes:**
  * `add_token` (Impact: 28.1)
  * `prepare_authorization_request` (Impact: 17.7)
  * `populate_token_attributes` (Impact: 16.8)
    * *Intent:* """Add attributes from a token exchange response to self."""
  * `prepare_token_request` (Impact: 15.8)
  * `_add_bearer_token` (Impact: 14.0)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_pkce_default_method` (Impact: 3.3)
  * `test_pkce_wrong_method` (Impact: 3.2)
  * `setUp` (Impact: 2.3)
  * `test_create_token_response_without_refresh_token` (Impact: 2.3)
  * `test_create_authorization_response` (Impact: 2.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `validate_timestamp_and_nonce` (Impact: 8.7)
  * `validate_verifier` (Impact: 5.1)
  * `validate_access_token` (Impact: 4.6)
  * `validate_request_token` (Impact: 4.6)
  * `test_signature_method_validation` (Impact: 4.5)
...
**Top Internal Functions/Classes:**
  ...
  * `headers` (Impact: 6.5)
  * `twotuples` (Impact: 6.1)
  * `raise_from_error` (Impact: 5.7)
  * `__init__` (Impact: 2.4)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `prepare_authorization_response` (Impact: 23.1)
    * *Intent:* """Place token according to response mode. Base classes can define a default response mode for their...
  * `_handle_redirects` (Impact: 13.3)
  * `_create_cors_headers` (Impact: 9.5)
    * *Intent:* """If CORS is allowed, create the appropriate headers."""
  * `validate_scopes` (Impact: 9.3)
    * *Intent:* """ :param request: OAuthlib request. :type request: oauthlib.common.Request """
  * `_setup_custom_validators` (Impact: 7.6)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_invalid_request` (Impact: 7.5)
  * `test_invalid_request_method` (Impact: 7.0)
  * `test_invalid_post_request` (Impact: 4.0)
  * `test_server_error` (Impact: 3.4)
  * `test_unauthorized_client` (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `setUp` (Impact: 3.9)
  * `setUp` (Impact: 3.0)
  * `test_authorization_grant` (Impact: 2.9)
  * `test_authorization_grant` (Impact: 2.9)
  * `setUp` (Impact: 2.7)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_generate_token` (Impact: 3.4)
  * `test_generate_client_id` (Impact: 3.4)
  * `test_generate_nonce` (Impact: 3.1)
    * *Intent:* """Ping me (ib-lundgren) when you discover how to test randomness."""
  * `test_urldecode` (Impact: 2.6)
  * `test_non_unicode_params` (Impact: 2.1)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 3 instances
...
**Top Internal Functions/Classes:**
  * `test_parse_token_response_expires_at_types` (Impact: 5.3)
  * `test_add_bearer_token` (Impact: 2.9)
    * *Intent:* """Test a number of bearer token placements"""
  * `test_add_mac_token` (Impact: 2.9)
    * *Intent:* # Missing access token client = Client(self.client_id, token_type="MAC") self.assertRaises(ValueErro...
  * `test_revocation_request` (Impact: 2.9)
  * `test_prepare_refresh_token_request` (Impact: 2.9)
**Structural Signatures (Net Mitigated Signals):**
...
- **Risk Profile:** Cognitive Load (0.0%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `test_custom_auth_validators_unsupported` (Impact: 2.1)
  * `test_authentication_required_populate_client_id` (Impact: 2.1)
    * *Intent:* """ Make sure that request.client_id is populated from request.client.client_id if None. """
  * `setUp` (Impact: 2.0)
  * `test_create_token_response` (Impact: 2.0)
  * `test_create_token_inherit_scope` (Impact: 2.0)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `test_decoding` (Impact: 3.3)
  * `test_sign_get_with_body` (Impact: 3.2)
  * `test_rsa_method` (Impact: 2.9)
  * `test_case_insensitive_headers` (Impact: 2.5)
  * `test_register_method` (Impact: 2.3)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 1 instances
...
**Top Internal Functions/Classes:**
  * `validate_metadata` (Impact: 46.5)
  * `validate_metadata_server` (Impact: 13.0)
    * *Intent:* """ Authorization servers can have metadata describing their configuration. The following authorizat...
  * `validate_metadata_authorization` (Impact: 11.1)
  * `__init__` (Impact: 5.0)
  * `create_metadata_response` (Impact: 2.9)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `prepare_request_body` (Impact: 60.4)
  * `__init__` (Impact: 4.4)
**Contextual Mitigations & Amplifications:**
