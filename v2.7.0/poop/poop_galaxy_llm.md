...
- `main` (@ `src/main.zig`) -> Impact: **59.2** | LOC: 325
- `printMeasurement` (@ `src/main.zig`) -> Impact: **48.4** | LOC: 122
- `printUnit` (@ `src/main.zig`) -> Impact: **41.6** | LOC: 49
- `compute` (@ `src/main.zig`) -> Impact: **22.4** | LOC: 48
- `render` (@ `src/progress.zig`) -> Impact: **14.1** | LOC: 39
  * *Intent:* /// Clears then renders bar if enough time has passed since last render.
- `printNum3SigFigs` (@ `src/main.zig`) -> Impact: **12.7** | LOC: 12
- `getStatScore95` (@ `src/main.zig`) -> Impact: **7.7** | LOC: 12
  * *Intent:* // Gets either the T or Z score for 95% confidence. // If no `df` variable is provided, Z score is provided.
- `parseCmd` (@ `src/main.zig`) -> Impact: **4.2** | LOC: 4
- `lessThan` (@ `src/main.zig`) -> Impact: **2.4** | LOC: 7
- `init` (@ `src/progress.zig`) -> Impact: **2.3** | LOC: 12
...
- **Heaviest Functions:** `main` (Impact: 59.2), `printMeasurement` (Impact: 48.4), `printUnit` (Impact: 41.6)
...
- **Heaviest Functions:** `render` (Impact: 14.1), `init` (Impact: 2.3), `deinit` (Impact: 1.9)
...
**Top Internal Functions/Classes:**
  * `main` (Impact: 59.2)
  * `printMeasurement` (Impact: 48.4)
  * `printUnit` (Impact: 41.6)
  * `compute` (Impact: 22.4)
  * `printNum3SigFigs` (Impact: 12.7)
