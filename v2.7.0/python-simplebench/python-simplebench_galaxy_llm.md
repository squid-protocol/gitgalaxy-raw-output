...
| Avg Path Length | 2.7742 | Hops between files. Lower = Tighter coupling. |
...
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 24.2 | 13.1 | 0.0 |
...
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 48.4 | 33.3 | 0.0 |
...
- `benchmark` (@ `src/simplebench/decorators.py`) -> Impact: **159.0** | LOC: 294
- `render` (@ `src/simplebench/reporters/rich_table/reporter/reporter.py`) -> Impact: **129.9** | LOC: 138
...
- `dispatch_to_targets` (@ `src/simplebench/reporters/reporter/mixins/_orchestration.py`) -> Impact: **127.6** | LOC: 128
- `render` (@ `src/simplebench/reporters/csv/reporter/reporter.py`) -> Impact: **113.2** | LOC: 117
...
- `__init__` (@ `src/simplebench/case.py`) -> Impact: **91.5** | LOC: 221
...
- `_validate_render_by_args` (@ `src/simplebench/reporters/reporter/mixins/_orchestration.py`) -> Impact: **83.2** | LOC: 83
- `report` (@ `src/simplebench/reporters/reporter/reporter.py`) -> Impact: **80.0** | LOC: 101
- `validate_sequence_of_type` (@ `src/simplebench/validators/validate_sequence_of_type.py`) -> Impact: **79.8** | LOC: 125
...
### 1. `documentation/html/_static/copybutton.js` (JAVASCRIPT) -> Cumulative Risk: **656.64**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 164.96 | **LOC:** 248 | **CtrlFlow:** 17.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9872%), Concurrency (99.5071%), Safety Score (89.4721%)
- **Heaviest Functions:** `formatCopyText` (Impact: 56.5), `runWhenDOMLoaded` (Impact: 9.1), `clearSelection` (Impact: 4.8)

### 2. `documentation/html/_static/searchtools.js` (JAVASCRIPT) -> Cumulative Risk: **612.59**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 419.82 | **LOC:** 633 | **CtrlFlow:** 21.1% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9991%), Verification (80.0%), Safety Score (78.8705%)
- **Heaviest Functions:** `_performSearch` (Impact: 46.3), `performTermsSearch` (Impact: 43.2), `objectSearchCallback` (Impact: 27.2)

### 3. `documentation/html/_static/copybutton_funcs.js` (JAVASCRIPT) -> Cumulative Risk: **601.63**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 105.44 | **LOC:** 74 | **CtrlFlow:** 36.5% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (96.7705%), Tech Debt (94.2049%)
- **Heaviest Functions:** `formatCopyText` (Impact: 56.5), `filterText` (Impact: 3.9), `escapeRegExp` (Impact: 3.0)

### 4. `src/simplebench/cli.py` (PYTHON) -> Cumulative Risk: **596.52**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 185.96 | **LOC:** 235 | **CtrlFlow:** 30.8% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (93.4482%), Churn (81.55%)
- **Heaviest Functions:** `main` (Impact: 59.7), `_configure_session_from_args` (Impact: 36.4), `_create_parser` (Impact: 5.0)

### 5. `src/simplebench/runners.py` (PYTHON) -> Cumulative Risk: **593.4**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 340.26 | **LOC:** 544 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9997%), Safety Score (97.8832%), Verification (80.0%)
- **Heaviest Functions:** `default_runner` (Impact: 74.0), `calibrate_rounds` (Impact: 71.0), `_run_timed_iteration` (Impact: 27.9)

### 6. `src/simplebench/case.py` (PYTHON) -> Cumulative Risk: **580.65**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 434.82 | **LOC:** 1016 | **CtrlFlow:** 19.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9834%), Churn (94.64%), Safety Score (87.7441%)
- **Heaviest Functions:** `__init__` (Impact: 91.5), `run` (Impact: 30.4), `validate_action_signature` (Impact: 28.8)

### 7. `src/simplebench/decorators.py` (PYTHON) -> Cumulative Risk: **576.17**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 295.7 | **LOC:** 373 | **CtrlFlow:** 22.2% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9999%), Safety Score (92.2155%), Churn (81.55%)
- **Heaviest Functions:** `benchmark` (Impact: 159.0), `decorator` (Impact: 24.3), `validate_timer` (Impact: 14.9)

### 8. `src/simplebench/stats/stats.py` (PYTHON) -> Cumulative Risk: **559.79**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 262.52 | **LOC:** 614 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (97.7316%), Tech Debt (89.8692%), Verification (80.0%)
- **Heaviest Functions:** `__eq__` (Impact: 26.9), `__eq__` (Impact: 26.7), `from_dict` (Impact: 12.6)

### 9. `src/simplebench/session.py` (PYTHON) -> Cumulative Risk: **555.55**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 364.52 | **LOC:** 607 | **CtrlFlow:** 26.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9938%), Churn (88.56%), Verification (80.0%)
- **Heaviest Functions:** `report` (Impact: 47.4), `__init__` (Impact: 31.5), `run` (Impact: 19.4)

### 10. `src/simplebench/reporters/rich_table/reporter/reporter.py` (PYTHON) -> Cumulative Risk: **529.23**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 198.32 | **LOC:** 226 | **CtrlFlow:** 43.5% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (94.827%), Verification (80.0%)
- **Heaviest Functions:** `render` (Impact: 129.9), `__init__` (Impact: 4.8)
...
- **Risk Profile:** Cognitive Load (11.053%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `validate_string` (Impact: 47.2)
  * `validate_dirpath` (Impact: 43.7)
    * *Intent:* """Validate a directory path for use in the filesystem. It validates that: - The directory path is a...
  * `validate_sequence_of_type` (Impact: 32.8)
  * `validate_frozenset_of_type` (Impact: 30.5)
  * `validate_sequence_of_str` (Impact: 27.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 419.82 | **LOC:** 633 | **CtrlFlow:** 21.1% | **Authorship Centralization:** 0.0%
- **Risk Profile:** Cognitive Load (73.4558%), Tech Debt (9.8274%)
**Top Internal Functions/Classes:**
  * `_performSearch` (Impact: 46.3)
    * *Intent:* /** * execute search (requires search index to be loaded) */
  * `performTermsSearch` (Impact: 43.2)
    * *Intent:* /** * search for full-text terms in the index */
  * `objectSearchCallback` (Impact: 27.2)
  * `_displayItem` (Impact: 26.8)
  * `_orderResultsByScoreThenName` (Impact: 11.5)
...
- **Risk Profile:** Cognitive Load (49.7215%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `dispatch_to_targets` (Impact: 127.6)
  * `_validate_render_by_args` (Impact: 83.2)
  * `render_by_section` (Impact: 55.7)
  * `render_by_case` (Impact: 52.5)
**Contextual Mitigations & Amplifications:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000118 | `Ripple Effect (Closeness):` 0.001244
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 340.26 | **LOC:** 544 | **CtrlFlow:** 24.2% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (39.3805%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `default_runner` (Impact: 74.0)
  * `calibrate_rounds` (Impact: 71.0)
  * `_run_timed_iteration` (Impact: 27.9)
  * `__init__` (Impact: 16.0)
  * `run` (Impact: 11.0)
**Contextual Mitigations & Amplifications:**
...
- **Risk Profile:** Cognitive Load (25.6355%), Tech Debt (34.6243%)
**Top Internal Functions/Classes:**
  * `update` (Impact: 38.1)
  * `__init__` (Impact: 23.0)
  * `__init__` (Impact: 20.6)
...
- **Risk Profile:** Cognitive Load (73.4602%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `stemWord` (Impact: 68.8)
  * `Stemmer` (Impact: 57.9)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 295.7 | **LOC:** 373 | **CtrlFlow:** 22.2% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (39.37%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `benchmark` (Impact: 159.0)
  * `decorator` (Impact: 24.3)
    * *Intent:* """The actual decorator that wraps the user's function."""
  * `validate_timer` (Impact: 14.9)
  * `case_action_wrapper` (Impact: 11.2)
    * *Intent:* """This wrapper becomes the `action` for the `Case`. It calls the user's decorated function inside `...
  * `get_registered_cases` (Impact: 1.4)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 262.52 | **LOC:** 614 | **CtrlFlow:** 18.1% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (43.9751%), Tech Debt (89.8692%)
**Top Internal Functions/Classes:**
  * `__eq__` (Impact: 26.9)
...
- **Risk Profile:** Cognitive Load (46.3646%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `render` (Impact: 113.2)
...
- **Risk Profile:** Cognitive Load (48.9529%), Tech Debt (12.112%)
**Top Internal Functions/Classes:**
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 198.32 | **LOC:** 226 | **CtrlFlow:** 43.5% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (65.0073%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `render` (Impact: 129.9)
...
- **Risk Profile:** Cognitive Load (15.1571%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `choice_factory` (Impact: 26.6)
  * `choices_factory` (Impact: 15.2)
  * `choice_conf_factory` (Impact: 11.9)
  * `reporter_factory` (Impact: 11.8)
  * `choices_conf_factory` (Impact: 9.5)
...
**Top Internal Functions/Classes:**
  ...
  * `_validate_iterations` (Impact: 8.0)
...
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 185.96 | **LOC:** 235 | **CtrlFlow:** 30.8% | **Authorship Centralization:** 100.0%
- **Risk Profile:** Cognitive Load (55.7463%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `main` (Impact: 59.7)
  * `_configure_session_from_args` (Impact: 36.4)
  * `_create_parser` (Impact: 5.0)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000112 | `Ripple Effect (Closeness):` 0.02054
...
- **Risk Profile:** Cognitive Load (2.4384%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `run_report` (Impact: 13.8)
  * `invalid_render_with_extra_return_type` (Impact: 7.6)
  * `invalid_render_case_wrong_type` (Impact: 7.4)
  * `invalid_render_case_missing_type_hint` (Impact: 7.4)
  * `invalid_render_extra_parameter` (Impact: 5.7)
**Contextual Mitigations & Amplifications:**
...
- `src/simplebench/reporters/reporter/mixins/_orchestration.py` -> **Severity: 0.012** (Bridge: 0.0001 * Flux: 99.9302%)
- `src/simplebench/reporters/reporter/mixins/_targets.py` -> **Severity: 0.008** (Bridge: 0.0001 * Flux: 100.0%)
- `src/simplebench/stats/exceptions/memory_usage.py` -> **Severity: 0.007** (Bridge: 0.0001 * Flux: 91.6827%)
- `src/simplebench/stats/exceptions/operations_per_interval.py` -> **Severity: 0.006** (Bridge: 0.0001 * Flux: 83.2018%)
- `src/simplebench/reporters/reporter/mixins/_argparse.py` -> **Severity: 0.005** (Bridge: 0.0001 * Flux: 99.0611%)
