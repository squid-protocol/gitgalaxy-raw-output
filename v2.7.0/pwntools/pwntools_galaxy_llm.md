...
| Avg Path Length | 3.857 | Hops between files. Lower = Tighter coupling. |
...
| Debt Markers (formerly Tech Debt Exposure) | 0.0 | 100.0 | 33.6 | 0.0 | 0.0 |
| Test Surface (formerly Testing Exposure) | 0.0 | 80.0 | 8.3 | 2.3 | 2.3 |
| Connectivity (formerly API Exposure) | 0.0 | 100.0 | 8.4 | 0.0 | 0.0 |
...
| Historical Stability (predictive layer, promotion pending #2987) (formerly Instability Exposure) | 0.0 | 4.0 | 0.1 | 0.0 | 0.0 |
| Historical Churn (predictive layer, promotion pending #2987) (formerly Volatility Exposure) | 0.0 | 65.4 | 3.8 | 0.0 | 0.0 |
| Doc Surface (formerly Documentation Exposure) | 0.0 | 100.0 | 49.7 | 48.5 | 0.0 |
...
| connectivity | 2315 | 188 | 6 | `pwnlib/data/includes/generator/linux/diet/unistd.h` |
...
| dead_code | 606 | 300 | 2 | `pwnlib/data/includes/generator/linux/diet/fcntl.h` |
| credential | 0 | 0 | 0 | - |
...
- `__init__` (@ `pwnlib/tubes/process.py`) -> Impact: **234.9** | LOC: 190
- `attach` (@ `pwnlib/gdb.py`) -> Impact: **224.9** | LOC: 426
- `debug` (@ `pwnlib/gdb.py`) -> Impact: **173.1** | LOC: 320
- `run_in_new_terminal` (@ `pwnlib/util/misc.py`) -> Impact: **161.8** | LOC: 198
...
- `regsort` (@ `pwnlib/regsort.py`) -> Impact: **156.6** | LOC: 327
...
- `process` (@ `pwnlib/tubes/ssh.py`) -> Impact: **138.9** | LOC: 250
- `dd` (@ `pwnlib/util/packing.py`) -> Impact: **138.8** | LOC: 184
- `ret2csu` (@ `pwnlib/rop/ret2csu.py`) -> Impact: **127.3** | LOC: 94
...
- `__init__` (@ `pwnlib/tubes/ssh.py`) -> Impact: **121.7** | LOC: 168
- `hexdump_iter` (@ `pwnlib/util/fiddling.py`) -> Impact: **120.9** | LOC: 163
...
### 1. `pwnlib/shellcraft/internal.py` (PYTHON) -> Cumulative Risk: **786.75**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 240.0 | **LOC:** 161 | **CtrlFlow:** 20.9% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.516%), Concurrency (99.2287%)
- **Heaviest Functions:** `make_function` (Impact: 34.6), `res` (Impact: 25.3), `get_context_from_dirpath` (Impact: 8.3)

### 2. `pwnlib/term/term.py` (PYTHON) -> Cumulative Risk: **743.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 514.8 | **LOC:** 423 | **CtrlFlow:** 24.6% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.2109%)
- **Heaviest Functions:** `update_locked` (Impact: 35.5), `output` (Impact: 28.0), `put` (Impact: 23.2)

### 3. `pwnlib/term/keymap.py` (PYTHON) -> Cumulative Risk: **689.88**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 184.26 | **LOC:** 114 | **CtrlFlow:** 39.8% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Safety Score (98.6227%)
- **Heaviest Functions:** `send` (Impact: 34.1), `register` (Impact: 25.1), `unregister` (Impact: 21.2)

### 4. `pwnlib/encoders/arm/alphanumeric/ARM_Instructions.py` (PYTHON) -> Cumulative Risk: **675.8**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 180.58 | **LOC:** 140 | **CtrlFlow:** 33.7% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.8688%)
- **Heaviest Functions:** `dpimm` (Impact: 32.9), `dpshiftreg` (Impact: 29.3), `dpshiftimm` (Impact: 22.0)

### 5. `pwnlib/rop/srop.py` (PYTHON) -> Cumulative Risk: **675.13**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 164.4 | **LOC:** 470 | **CtrlFlow:** 13.5% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** Spec Match (100.0%), State Flux (99.9997%), Documentation (95.6522%), Safety Score (90.5058%)
- **Heaviest Functions:** `__setitem__` (Impact: 16.4), `__init__` (Impact: 10.5), `__setattr__` (Impact: 6.2)

### 6. `pwnlib/encoders/arm/alphanumeric/alphanum_byte.py` (PYTHON) -> Cumulative Risk: **666.21**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 44.14 | **LOC:** 52 | **CtrlFlow:** 33.3% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** Spec Match (100.0%), Documentation (100.0%), State Flux (99.9994%), Dead Code (98.0604%)
- **Heaviest Functions:** `off_gen` (Impact: 7.5), `alphanumeric_get_byte_ltmax` (Impact: 4.5), `alphanumeric_get_complement` (Impact: 4.5)

### 7. `pwnlib/rop/ret2dlresolve.py` (PYTHON) -> Cumulative Risk: **665.67**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 249.08 | **LOC:** 388 | **CtrlFlow:** 13.8% | **Authorship Centralization:** 0.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Documentation (100.0%), Tech Debt (99.9763%)
- **Heaviest Functions:** `__init__` (Impact: 19.7), `_build_args` (Impact: 14.5), `_build_structures` (Impact: 13.1)

### 8. `pwnlib/term/readline.py` (PYTHON) -> Cumulative Risk: **662.52**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 623.58 | **LOC:** 496 | **CtrlFlow:** 23.0% | **Authorship Centralization:** 50.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Safety Score (99.4953%), Documentation (97.4684%)
- **Heaviest Functions:** `readline` (Impact: 34.1), `redisplay` (Impact: 17.6), `update_search_results` (Impact: 11.0)

### 9. `pwnlib/context/__init__.py` (PYTHON) -> Cumulative Risk: **646.54**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 757.82 | **LOC:** 1785 | **CtrlFlow:** 14.7% | **Authorship Centralization:** 33.3%
- **Primary Risk Drivers:** Spec Match (100.0%), Api Exposure (96.926%), Safety Score (86.3503%), State Flux (84.9999%)
- **Heaviest Functions:** `log_file` (Impact: 18.7), `setter` (Impact: 16.4), `device` (Impact: 16.3)

### 10. `pwnlib/timeout.py` (PYTHON) -> Cumulative Risk: **644.18**
- **Archetype:** `Unclassified` (Distance: N/A IQR)
- **Magnitude:** 128.3 | **LOC:** 209 | **CtrlFlow:** 15.6% | **Authorship Centralization:** 100.0%
- **Primary Risk Drivers:** State Flux (100.0%), Spec Match (100.0%), Tech Debt (99.9896%), Safety Score (97.451%)
- **Heaviest Functions:** `_get_timeout_seconds` (Impact: 11.2), `countdown` (Impact: 9.9), `local` (Impact: 5.6)
...
- **Risk Profile:** Cognitive Load (51.4727%), Tech Debt (31.5542%)
**Top Internal Functions/Classes:**
  * `process` (Impact: 138.9)
  * `__init__` (Impact: 121.7)
  * `__init__` (Impact: 95.8)
  * `interactive` (Impact: 31.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000104 | `Ripple Effect (Closeness):` 0.009078
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000904 | `Ripple Effect (Closeness):` 0.018493
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000683 | `Ripple Effect (Closeness):` 0.016644
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.004426
...
- **Global Archetype:** `Unclassified` (Drift: 0.0 IQR)
- **Local Micro-Species:** `Unclassified` (Drift: 0.0 IQR)
- **Magnitude:** 1090.06 | **LOC:** 1605 | **CtrlFlow:** 29.8% | **Authorship Centralization:** 25.0%
- **Risk Profile:** Cognitive Load (52.7702%), Tech Debt (32.5339%)
**Top Internal Functions/Classes:**
  * `attach` (Impact: 224.9)
  * `debug` (Impact: 173.1)
  * `_gdbserver_args` (Impact: 63.8)
    * *Intent:* """_gdbserver_args(pid=None, path=None, args=None, which=None, env=None) -> list Sets up a listening...
  * `_gdbserver_port` (Impact: 16.3)
  * `find_module_addresses` (Impact: 16.2)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 7.5e-05 | `Ripple Effect (Closeness):` 0.016736
...
- **Risk Profile:** Cognitive Load (55.6788%), Tech Debt (11.4098%)
**Top Internal Functions/Classes:**
  * `dd` (Impact: 138.8)
  * `pack` (Impact: 74.3)
  * `_fit` (Impact: 52.7)
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 6.9e-05 | `Ripple Effect (Closeness):` 0.016263
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.0 | `Ripple Effect (Closeness):` 0.003112
...
- **Risk Profile:** Cognitive Load (39.466%), Tech Debt (0.0%)
**Top Internal Functions/Classes:**
  * `lookup` (Impact: 45.8)
...
- **Risk Profile:** Cognitive Load (41.99%), Tech Debt (9.8295%)
**Top Internal Functions/Classes:**
...
* *Network Topology:*
  ...
  * `Choke Point (Betweenness):` 0.000249 | `Ripple Effect (Closeness):` 0.012178
...
- `pwnlib/tubes/ssh.py` -> Churn: **61.23%** | Cog Load: 51.4727% | Debt: 31.5542%
- `pwnlib/gdb.py` -> Churn: **50.64%** | Cog Load: 52.7702% | Debt: 32.5339%
- `pwnlib/util/packing.py` -> Churn: **50.64%** | Cog Load: 55.6788% | Debt: 11.4098%
...
- `pwnlib/elf/elf.py` -> **Severity: 0.09** (Bridge: 0.0009 * Flux: 100.0%)
- `pwnlib/tubes/process.py` -> **Severity: 0.068** (Bridge: 0.0007 * Flux: 100.0%)
- `pwnlib/util/misc.py` -> **Severity: 0.04** (Bridge: 0.0004 * Flux: 100.0%)
- `pwnlib/elf/corefile.py` -> **Severity: 0.025** (Bridge: 0.0002 * Flux: 100.0%)
- `pwnlib/util/fiddling.py` -> **Severity: 0.022** (Bridge: 0.0002 * Flux: 100.0%)
