...
- `awatch` (@ `watchfiles-1.1.1/watchfiles/main.py`) -> Impact: **70.4** | LOC: 136
- `watch` (@ `watchfiles-1.1.1/watchfiles/main.py`) -> Impact: **53.6** | LOC: 99
- `cli` (@ `watchfiles-1.1.1/watchfiles/cli.py`) -> Impact: **39.0** | LOC: 157
...
- `run_process` (@ `watchfiles-1.1.1/watchfiles/run.py`) -> Impact: **34.3** | LOC: 126
- `arun_process` (@ `watchfiles-1.1.1/watchfiles/run.py`) -> Impact: **33.8** | LOC: 78
- `start_process` (@ `watchfiles-1.1.1/watchfiles/run.py`) -> Impact: **33.5** | LOC: 34
- `build_filter` (@ `watchfiles-1.1.1/watchfiles/cli.py`) -> Impact: **23.9** | LOC: 28
- `__call__` (@ `watchfiles-1.1.1/watchfiles/filters.py`) -> Impact: **17.1** | LOC: 21
...
- `stop` (@ `watchfiles-1.1.1/watchfiles/run.py`) -> Impact: **11.2** | LOC: 23
- `__init__` (@ `watchfiles-1.1.1/watchfiles/filters.py`) -> Impact: **10.0** | LOC: 21
...
- **Heaviest Functions:** `run_process` (Impact: 34.3), `arun_process` (Impact: 33.8), `start_process` (Impact: 33.5)
...
- **Heaviest Functions:** `awatch` (Impact: 70.4), `watch` (Impact: 53.6), `_prep_changes` (Impact: 9.1)
...
- **Heaviest Functions:** `__call__` (Impact: 17.1), `__init__` (Impact: 10.0), `__call__` (Impact: 4.1)
...
- **Heaviest Functions:** `cli` (Impact: 39.0), `build_filter` (Impact: 23.9), `resolve_path` (Impact: 4.5)
...
- **Heaviest Functions:** `test_awatch_interrupt_warning` (Impact: 5.6), `test_awatch_unexpected_signal` (Impact: 4.7), `test_awatch_no_yield` (Impact: 4.2)
...
- **Heaviest Functions:** `__exit__` (Impact: 8.6), `watch` (Impact: 5.3), `test_dir` (Impact: 4.5)
...
- **Heaviest Functions:** `__init__` (Impact: 3.3), `watch` (Impact: 2.8), `__exit__` (Impact: 1.8)
...
- **Heaviest Functions:** `test_move_internal` (Impact: 5.3), `test_default_ignore_permission_denied` (Impact: 4.7), `test_does_not_exist_message` (Impact: 4.4)
...
**Top Internal Functions/Classes:**
  * `run_process` (Impact: 34.3)
  * `arun_process` (Impact: 33.8)
  * `start_process` (Impact: 33.5)
  * `stop` (Impact: 11.2)
  * `detect_target_type` (Impact: 8.6)
...
**Top Internal Functions/Classes:**
  * `awatch` (Impact: 70.4)
  * `watch` (Impact: 53.6)
  * `_prep_changes` (Impact: 9.1)
  * `_log_changes` (Impact: 8.9)
  * `_calc_async_timeout` (Impact: 7.6)
...
**Top Internal Functions/Classes:**
  * `test_awatch_interrupt_warning` (Impact: 5.6)
  * `test_awatch_unexpected_signal` (Impact: 4.7)
  * `test_awatch_no_yield` (Impact: 4.2)
  * `test_watch_timeout` (Impact: 4.2)
  * `test_awatch_timeout` (Impact: 4.2)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  * `test_move_internal` (Impact: 5.3)
    * *Intent:* # can't use tmp_path as it causes problems on Windows (different drive), and macOS (delayed events) ...
  * `test_default_ignore_permission_denied` (Impact: 4.7)
  * `test_does_not_exist_message` (Impact: 4.4)
  * `test_does_not_exist_polling` (Impact: 4.4)
  * `test_wrong_type_event_is_set` (Impact: 3.8)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `build_filter` (Impact: 23.9)
  * `resolve_path` (Impact: 4.5)
  * `import_exit` (Impact: 3.3)
**Contextual Mitigations & Amplifications:**
...
**Top Internal Functions/Classes:**
  ...
  * `test_filter_all` (Impact: 3.0)
  * `test_args_command` (Impact: 3.0)
  * `test_function` (Impact: 2.6)
**Contextual Mitigations & Amplifications:**
* *Mitigated Danger:* 3 instances
* *Amplified Rce:* 3 instances
* *High Risk Execution (weighted view):* 0
...
**Top Internal Functions/Classes:**
  ...
  * `test_watch_polling_not_env` (Impact: 3.2)
**Contextual Mitigations & Amplifications:**
* *Amplified Cascading Flux:* 6 instances
...
**Top Internal Functions/Classes:**
  * `__call__` (Impact: 4.1)
  * `test_web_filter` (Impact: 3.4)
    * *Intent:* # test case from docs class WebFilter(DefaultFilter): allowed_extensions = '.html', '.css', '.js' de...
  * `test_default_filter` (Impact: 1.9)
  * `test_simple_function` (Impact: 1.8)
  * `only_added` (Impact: 1.8)
**Structural Signatures (Net Mitigated Signals):**
...
**Top Internal Functions/Classes:**
  * `.uv` (Impact: 2.2)
  * `.pre-commit` (Impact: 2.2)
  * `clean` (Impact: 1.5)
  * `lint-rust` (Impact: 1.4)
  * `format` (Impact: 1.3)
**Structural Signatures (Net Mitigated Signals):**
